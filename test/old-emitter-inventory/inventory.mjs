...
export const oldEmitterPortInventory = Object.freeze([
  ...
  ...deferredEmitterCases([
    ...
    "classes/inheritance/Inheritance",
    "classes/static-members/MathHelper",
  ], "classes", "TSTS declaration facts + C# declaration planner", "Class fixtures require complete source class declaration planning for fields, methods, constructors, inheritance, static members, generic inheritance substitution, generic methods, and field marker facts."),
  ...deferredEmitterCases([
    "collections/list-initializer/ListInitializer",
    "types/dictionaries/Dictionaries",
