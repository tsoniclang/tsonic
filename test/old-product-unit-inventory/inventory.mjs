...
const oldProductUnitReviewedDeferredCapabilityIdsByOldPath = new Map([
  ...
  ...reviewedOldProductUnitDeferredCapabilityMapping([
    ...
    "source.marker.reference-passing",
  ...
  ...reviewedOldProductUnitDeferredCapabilityMapping([
    ...
    "source-core.lang.portable-intrinsics.read-only-ref",
    "source-core.lang.portable-intrinsics.write-only-ref",
    "source-core.lang.portable-intrinsics.read-write-ref",
    "source-core.contract.attribute-type-evidence-required",
    "source-core.contract.default-value-type-evidence-required",
    "source-core.contract.field-type-evidence-required",
    "source-core.contract.function-pointer-type-marker-evidence",
    "source-core.contract.module-ownership",
    "source-core.contract.non-storage-reference-diagnostics",
    "source-core.contract.pointer-type-marker-evidence",
    "source-core.contract.reference-marker-alias",
    "source-core.contract.reference-marker-no-local-guess",
    "source-core.contract.struct-field-owner-finalization",
    "source-core.contract.target-alias-nonownership",
    ...
    "source.marker.contract.reference-passing-facts",
    ...
    "target.csharp.reference-passing-fact-consumption",
...
function oldProductUnitCapabilityIdsFor(oldPath) {
  ...
  switch (featureArea) {
    ...
    case "source-semantics":
      ...
      ids.add("source.marker.reference-passing");
