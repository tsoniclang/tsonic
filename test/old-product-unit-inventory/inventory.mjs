...
const oldProductUnitReviewedDeferredCapabilityIdsByOldPath = new Map([
  ...
  ...reviewedOldProductUnitDeferredCapabilityMapping([
    ...
    "source-core.contract.defaultof-type-evidence-required",
    ...
    "source-core.contract.non-storage-diagnostics",
    "source-core.contract.ptr-type-marker-evidence",
    "source-core.contract.storage-marker-alias",
    "source-core.contract.storage-marker-no-local-guess",
    ...
    "source.marker.contract.out-ref-inref-facts",
    ...
    "target.csharp.core-lang.out-ref-inref-fact-consumption",
