import { assert, cliPath, existsSync, readFile, resolve, run, runGeneratedProject, runNode, targetCsharpNodejsPackageJson, tempRoot, test, writeProject } from "../../helpers/harness.mjs";
