...
function hasPresentText(text: string): boolean { return text !== undefined && text !== null; }
export function run(): boolean {
  ...
  return hasPresentText("text") && exact && comparisons && ordered && effects === 2 && record.value === null && record.missing === undefined &&
