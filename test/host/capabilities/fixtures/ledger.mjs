  ...
  "runtime.undefined.carrier": Object.freeze({
    ...
    oldEvidenceAbsence: Object.freeze({
      ...
      searchEvidence: Object.freeze([
        ...
        "old emitter inventory has no direct closed Runtime.Undefined/TsValue undefined runtime carrier fixture; current runtime, JS-surface, and provider-package tests provide stronger runtime-carrier proof",
      ]),
      reviewerNotes:
        "No direct historical old-suite runtime undefined carrier exists to map bidirectionally. Current proof is stronger because it covers the closed Runtime.Undefined singleton, TsValue undefined reads/casts/typeof, sparse JSArray holes, Node process.env nullable provider APIs, and fail-closed backend handling for unproven undefined identifiers.",
    }),
    blockers: Object.freeze([]),
    notes:
