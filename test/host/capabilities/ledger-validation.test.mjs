...
test("current TSTS evidence does not point at retired source-tree tests", () => {
  ...
  assert.ok(publicRootArtifact.positiveTests.includes("test/architecture/package-artifacts.test.mjs"));
  assert.ok(publicRootArtifact.positiveTests.includes("test/host/dependencies/surface-composition.test.mjs"));
  assert.ok(publicRootArtifact.negativeTests.includes("test/architecture/package-artifacts.test.mjs"));
  assert.ok(publicRootArtifact.negativeTests.includes("test/host/capabilities/ledger.test.mjs"));
