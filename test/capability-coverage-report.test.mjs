...
test("capability coverage report exposes ledger validation as a gate", () => {
  ...
  assert.equal(report.surfaceEvidenceCoverage.rules.completeSurfaceCapabilitiesRequireGateEvidence, true);
  assert.deepEqual(report.surfaceEvidenceCoverage.rules.gateNames, [...capabilitySurfaceEvidenceGateNames]);
  assert.equal(report.surfaceEvidenceCoverage.summary.proofStatus, "proven");
