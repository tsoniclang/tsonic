...
COMMANDS:
  ...
  add npm <pkg>             Install an npm package with tsonic.package.json or tsonic.bindings.json
...
PROJECT INIT OPTIONS:
  ...
  --surface <name>          Initialize workspace surface profile ("core" or exact npm package name)
