...
import {
  ...
  rewriteAnonymousBindingExportNamespaces,
...
export const writeNamespaceFacadeFiles = (opts: {
  ...
  const anonymousAliasNamespaces = buildAnonymousAliasNamespaceMap(
    opts.sourceAnonymousStructuralAliases
  );
  ...
  for (const sourceAnonymousStructuralAlias of opts.sourceAnonymousStructuralAliases) {
    facadeLines.push(
      `export type { ${sourceAnonymousStructuralAlias.name} } from '${internalSpecifier}';`
    );
    facadeLines.push(
      `export type { ${sourceAnonymousStructuralAlias.name}$instance } from '${internalSpecifier}';`
    );
  }
  ...
  for (const sourceAnonymousStructuralAlias of opts.sourceAnonymousStructuralAliases) {
    localTypeImports.add(sourceAnonymousStructuralAlias.name);
    localTypeImports.add(`${sourceAnonymousStructuralAlias.name}$instance`);
  }
