export type { AddCommandOptions, Exec, ExecResult } from "./add-common/shared.js";
export {
...
export { resolvePackageRoot, resolveTsbindgenDllPath } from "./add-common/package-resolution.js";
export type { DotnetRuntime } from "./add-common/runtime.js";
export { listDotnetRuntimes, resolveTsonicRuntimeDllDir } from "./add-common/runtime.js";
