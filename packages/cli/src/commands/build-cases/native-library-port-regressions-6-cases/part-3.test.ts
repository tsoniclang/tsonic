  ...
  it("builds source-package callback-or-dictionary flows with contextual object literals", () => {
    ...
    try {
      ...
      writeFileSync(
        ...
        [
          "export type TemplateCallback = (error: unknown | undefined, html: string) => void;",
      ...
      expect(tree).to.include("options?.sameSite");
      expect(tree).to.include(
        "global::System.Object.Equals(options?.sameSite, true)"
      );
