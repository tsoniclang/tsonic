    ...
    try {
      ...
      writeFileSync(
        ...
        [
          ...
          "",
          "export type TemplateCallback = (error: JsValue | undefined, html: string) => void;",
          "export type TemplateEngine = (view: string, locals: Record<string, JsValue>, callback: TemplateCallback) => void;",
