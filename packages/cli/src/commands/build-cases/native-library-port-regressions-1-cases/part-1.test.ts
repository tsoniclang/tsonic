    ...
    try {
      ...
      writeFileSync(
        ...
        [
          ...
          "  }",
          "  append_one(field: string, value: string): A {",
          "    return this;",
          "  }",
          "  append_many(field: string, value: readonly string[]): A {",
          "    const values = value as readonly string[];",
          "      for (let index = 0; index < values.length; index += 1) {",
          "        const item = values[index]!;",
          "        this.append_one(field, item);",
          "      }",
          "    return this;",
          "  }",
          "}",
          "",
          "O<A>().method(x => x.append_one).family(x => x.append);",
          "O<A>().method(x => x.append_many).family(x => x.append);",
