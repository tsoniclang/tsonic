...
describe("Binding Resolution in IR", () => {
  describe("Extension Method Binding Resolution — Owner Resolution", () => {
    it("does not let differently-cased globals pollute authored identifiers", () => {
      ...
      bindings.addBindings("/test/globals.json", { schema: "tsonic.bindings", provider: { namespace: "sourceSurface" }, sourceSurface: { bindings: {
          console: {
            kind: "global",
            ownerIdentity: "js",
            type: "js.console",
      ...
      expect(writeLineAccess.object.object.providerQualifiedName).to.equal(
        undefined
      );
    ...
    it("prefers the explicitly requested CLR owner when mixed bindings share a TS alias", () => {
      ...
      bindings.addBindings("/test/nodejs/bindings.json", { schema: "tsonic.bindings", provider: { namespace: "nodejs" }, targetSurface: { types: [
          {
      ...
      bindings.addBindings("/test/system-console/bindings.json", { schema: "tsonic.bindings", provider: { namespace: "System" }, targetSurface: { types: [
          {
