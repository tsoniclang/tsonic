...
import type { IrModule, IrClassDeclaration, IrFunctionDeclaration } from "../types.js";
...
describe("Attribute Collection Pass", () => {
  ...
  describe("A.on(Class).type(Attr) pattern", () => {
    it("should attach attribute to class declaration", () => {
          ...
          expression: {
            ...
            callee: {
              ...
              object: {
                ...
                arguments: [{ kind: "identifier", name: "User" }],
                isOptional: false,
              },
              property: "type",
              isComputed: false,
      ...
      expect(classDecl.attributes![0]!.attributeType.kind).to.equal("referenceType");
    });

    it("should attach attribute with positional arguments", () => {
      // IR representation of:
      // class User {}
      // A.on(User).type(ObsoleteAttribute, "Use NewUser instead");
      const module = createModule([
        {
          kind: "classDeclaration",
          name: "User",
        ...
        } as IrClassDeclaration,
        {
          ...
          expression: {
            ...
            arguments: [
              { kind: "identifier", name: "ObsoleteAttribute" },
  ...
  describe("A.on(fn).type(Attr) pattern", () => {
    it("should attach attribute to function declaration", () => {
      // IR representation of:
      // function greet() {}
      // A.on(greet).type(PureAttribute);
      const module = createModule([
        {
          ...
          expression: {
            ...
            callee: {
              ...
              object: {
                ...
                arguments: [{ kind: "identifier", name: "greet" }],
                isOptional: false,
              },
              property: "type",
              isComputed: false,
            ...
            arguments: [{ kind: "identifier", name: "PureAttribute" }],
            isOptional: false,
          },
        },
      ]);
  ...
  describe("Error cases", () => {
    it("should emit diagnostic when target not found", () => {
      // IR representation of:
      // A.on(NotExist).type(SomeAttribute);
      const module = createModule([
        {
          kind: "expressionStatement",
          expression: {
            ...
            callee: {
              ...
              object: {
                ...
                arguments: [{ kind: "identifier", name: "NotExist" }],
                isOptional: false,
              },
              property: "type",
              isComputed: false,
            ...
            arguments: [{ kind: "identifier", name: "SomeAttribute" }],
            isOptional: false,
          },
        },
      ]);
  ...
  describe("Multiple attributes", () => {
    it("should attach multiple attributes to same declaration", () => {
      ...
      // class User {}
      // A.on(User).type(SerializableAttribute);
      // A.on(User).type(ObsoleteAttribute, "Deprecated");
      const makeMarkerCall = (targetName: string, attrName: string, args: any[] = []) => ({
        ...
        expression: {
          ...
          arguments: [{ kind: "identifier" as const, name: attrName }, ...args],
          isOptional: false,
        },
      });
      ...
      const module = createModule([
        ...
        makeMarkerCall("User", "ObsoleteAttribute", [{ kind: "literal", value: "Deprecated" }]),
      ]);
