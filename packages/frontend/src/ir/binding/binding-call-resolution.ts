/**
 * Binding Layer — Call & Constructor Signature Resolution
 *
 * Contains the complex overload resolution logic for call expressions and
 * new expressions. Operates on a shared BindingContext from binding-registry.ts.
 */
