...
export { getSingleTypeScriptCallSignatureInfo, getTypeScriptArrayElementType, getTypeScriptTypeReferenceInfo, isTypeScriptArrayType, isTypeScriptStringLikeType } from "./extensions/index.js";
