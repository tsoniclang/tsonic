 ...
 */
export const processAliveSupported = true;
/**
...
export function isProcessAlive(pid) {
    const SYNCHRONIZE = 0x00100000;
    const [handle, err] = syscall.OpenProcess(SYNCHRONIZE, false, pid >>> 0);
    if (err !== undefined) {
        return false;
    }
    try {
        const [ret, waitErr] = syscall.WaitForSingleObject(handle, 0);
...
//# sourceMappingURL=isprocessalive_windows.js.map