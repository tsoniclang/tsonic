...
import { Atoi, Itoa, ParseInt, ParseUint, ParseFloat, ParseBool, FormatInt, FormatUint, ErrRange, ErrSyntax, NumError, } from "./strconv.js";
...
test("strconv NumError unwraps to its sentinel", () => {
    ...
    assert.ok(err instanceof NumError);
    assert.equal(err.Unwrap(), ErrSyntax);
});
//# sourceMappingURL=strconv.test.js.map