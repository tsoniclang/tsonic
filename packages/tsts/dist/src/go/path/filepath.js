...
export function VolumeName(path) {
...
export function VolumeNameLen(path) {
...
class LazyBuf {
    ...
    volAndPath;
    volLen;
    constructor(path, volAndPath, volLen) {
        this.path = path;
    ...
    append(c) {
        if (this.buf === undefined) {
            ...
            const newBuf = new Array(this.path.length).fill("");
...
export const SkipAll = new globalThis.Error("HOST-NATIVE go/path/filepath.SkipAll");
...
export function WalkDir(_root, _fn) {
