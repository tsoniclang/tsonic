...
test("maps.Copy copies and overwrites entries", () => {
    const dst = new globalThis.Map([["a", 1]]);
    const src = new globalThis.Map([
        ["a", 10],
        ["b", 2],
    ]);
    Copy(dst, src);
...
test("maps.Equal compares key/value pairs", () => {
    ...
    const m2 = new globalThis.Map([
        ["b", 2],
        ["a", 1],
    ]);
    const m3 = new globalThis.Map([["a", 1]]);
    const m4 = new globalThis.Map([
        ["a", 1],
        ["b", 3],
    ]);
...
test("maps.EqualFunc uses the provided comparator", () => {
    ...
    assert.equal(EqualFunc(m1, m2, (v1, v2) => globalThis.String(v1) === v2), true);
    assert.equal(EqualFunc(m1, m2, (v1, v2) => globalThis.String(v1) !== v2), false);
});
