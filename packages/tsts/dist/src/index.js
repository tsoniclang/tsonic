...
export { TstsSourceProviderContractVersion, argumentPassingFactKey, associatedTypeFactKey, attributeFactKey, canonicalIdentityFactKey, constGenericFactKey, createSourceSemanticsExtension, defaultValueFactKey, defineExtensionFactKey, fieldFactKey, flowStateFactKey, functionPointerFactKey, pointerFactKey, pointerOperationFactKey, providerTypeFamilyFactKey, providerVirtualDeclarationFactKey, sourcePrimitive, sourceSemanticsExtensionId, sourcePrimitiveFactKey, structFactKey, } from "./extensions/index.js";
