 ...
 * )
 */
export declare const logicalOrRegExp: regexp.Regexp;
export declare const whitespaceRegExp: regexp.Regexp;
/**
 ...
 */
export declare const partialRegExp: regexp.Regexp;
/**
 ...
 */
export declare const hyphenRegExp: regexp.Regexp;
/**
 ...
 */
export declare const rangeRegExp: regexp.Regexp;
/**
 ...
 * )
 */
export declare const rangeLessThan: comparatorOperator;
export declare const rangeLessThanEqual: comparatorOperator;
export declare const rangeEqual: comparatorOperator;
export declare const rangeGreaterThanEqual: comparatorOperator;
export declare const rangeGreaterThan: comparatorOperator;
/**
 ...
 * }
 */
export declare function VersionRange_String(receiver: GoPtr<VersionRange>): string;
/**
 ...
 * }
 */
export declare function formatDisjunction(sb: GoPtr<Builder>, alternatives: GoSlice<GoSlice<versionComparator>>): void;
/**
 ...
 * }
 */
export declare function formatAlternative(sb: GoPtr<Builder>, comparators: GoSlice<versionComparator>): void;
/**
 ...
 * }
 */
export declare function formatComparator(sb: GoPtr<Builder>, comparator: versionComparator): void;
/**
 ...
 * }
 */
export declare function VersionRange_Test(receiver: GoPtr<VersionRange>, version: GoPtr<Version>): bool;
/**
 ...
 * }
 */
export declare function testDisjunction(alternatives: GoSlice<GoSlice<versionComparator>>, version: GoPtr<Version>): bool;
/**
 ...
 * }
 */
export declare function testAlternative(alternative: GoSlice<versionComparator>, version: GoPtr<Version>): bool;
/**
 ...
 * }
 */
export declare function testComparator(comparator: versionComparator, version: GoPtr<Version>): bool;
/**
 ...
 * }
 */
export declare function TryParseVersionRange(text: string): [VersionRange, bool];
/**
 ...
 * }
 */
export declare function parseAlternatives(text: string): [GoSlice<GoSlice<versionComparator>>, bool];
/**
 ...
 * }
 */
export declare function parseHyphen(left: string, right: string): [GoSlice<versionComparator>, bool];
/**
 ...
 * }
 */
export declare function parsePartial(text: string): [partialVersion, bool];
/**
 ...
 * }
 */
export declare function parseComparator(op: string, text: string): [GoSlice<versionComparator>, bool];
/**
 ...
 * }
 */
export declare function isWildcard(text: string): bool;
//# sourceMappingURL=version_range.d.ts.map