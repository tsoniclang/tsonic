 ...
 */
export declare const versionRegexp: regexp.Regexp;
/**
 ...
 * )
 */
export declare const prereleaseRegexp: regexp.Regexp;
export declare const prereleasePartRegexp: regexp.Regexp;
/**
 ...
 * )
 */
export declare const buildRegExp: regexp.Regexp;
export declare const buildPartRegExp: regexp.Regexp;
/**
 ...
 */
export declare const numericIdentifierRegExp: regexp.Regexp;
/**
 ...
 * }
 */
export declare const versionZero: Version;
/**
 ...
 * }
 */
export declare function Version_incrementMajor(receiver: GoPtr<Version>): Version;
/**
 ...
 * }
 */
export declare function Version_incrementMinor(receiver: GoPtr<Version>): Version;
/**
 ...
 * }
 */
export declare function Version_incrementPatch(receiver: GoPtr<Version>): Version;
/**
 ...
 * }
 */
export declare function Version_Compare(receiver: GoPtr<Version>, b: GoPtr<Version>): int;
/**
 ...
 * }
 */
export declare function comparePreReleaseIdentifiers(left: GoSlice<string>, right: GoSlice<string>): int;
/**
 ...
 * }
 */
export declare function comparePreReleaseIdentifier(left: string, right: string): int;
/**
 ...
 * }
 */
export declare function Version_String(receiver: GoPtr<Version>): string;
/**
 ...
 * }
 */
export declare function SemverParseError_Error(receiver: GoPtr<SemverParseError>): string;
/**
 ...
 * }
 */
export declare function TryParseVersion(text: string): [Version, GoError];
/**
 ...
 * }
 */
export declare function MustParse(text: string): Version;
/**
 ...
 * }
 */
export declare function getUintComponent(text: string): [uint, GoError];
