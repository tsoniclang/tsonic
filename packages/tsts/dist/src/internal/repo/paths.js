 ...
 * })
 */
export const rootPath = onceValue(() => {
 ...
 * })
 */
export const typeScriptSubmodulePath = onceValue(() => {
 ...
 * }
 */
export function TypeScriptSubmodulePath() {
    return typeScriptSubmodulePath();
}
/**
 ...
 * })
 */
export const testDataPath = onceValue(() => {
 ...
 * })
 */
export const typeScriptSubmoduleExists = onceValue(() => {
 ...
 * }
 */
export function TypeScriptSubmoduleExists() {
    return typeScriptSubmoduleExists();
}
/**
 ...
 * }
 */
export function SkipIfNoTypeScriptSubmodule(t) {
    t.Helper();
    if (!typeScriptSubmoduleExists()) {
        t.Skipf("TypeScript submodule does not exist");
    }
