 ...
 * }
 */
export declare function FailBadSyntaxKind(node: {
    KindString: () => string;
}, ...message: Array<unknown>): void;
/**
 ...
 * }
 */
export declare function AssertNever(member: unknown, ...message: Array<unknown>): void;
/**
 ...
 * }
 */
export declare function Assert(value: bool, ...message: Array<unknown>): void;
/**
 ...
 * }
 */
export declare function assertSlow(...message: Array<unknown>): void;
