...
import { KindArrayLiteralExpression, KindArrowFunction, KindAsExpression, KindBigIntLiteral, KindBinaryExpression, KindBindingElement, KindCallExpression, KindCallSignature, KindClassExpression, KindComputedPropertyName, KindConditionalType, KindConstructSignature, KindConstructor, KindConstructorType, KindElementAccessExpression, KindExportAssignment, KindFalseKeyword, KindFunctionDeclaration, KindFunctionExpression, KindFunctionType, KindGetAccessor, KindIdentifier, KindImportType, KindIndexSignature, KindIndexedAccessType, KindIntersectionType, KindJSDocPropertyTag, KindJSDocSignature, KindMethodDeclaration, KindMethodSignature, KindNoSubstitutionTemplateLiteral, KindNullKeyword, KindNumericLiteral, KindObjectLiteralExpression, KindOmittedExpression, KindOptionalType, KindParameter, KindParenthesizedExpression, KindParenthesizedType, KindPlusToken, KindPrefixUnaryExpression, KindPrivateIdentifier, KindPropertyAccessExpression, KindPropertyAssignment, KindPropertyDeclaration, KindPropertySignature, KindQuestionToken, KindRestType, KindSetAccessor, KindShorthandPropertyAssignment, KindSpreadAssignment, KindSpreadElement, KindStringLiteral, KindTemplateExpression, KindTemplateSpan, KindTrueKeyword, KindTypeAssertionExpression, KindTypeOperator, KindTypePredicate, KindTypeQuery, KindTypeReference, KindUndefinedKeyword, KindUnionType, KindVariableDeclaration, } from "../ast/generated/kinds.js";
import { AsAsExpression, AsExportAssignment, AsGetAccessorDeclaration, AsIdentifier, AsIntersectionTypeNode, AsMethodDeclaration, AsParameterDeclaration, AsParenthesizedExpression, AsParenthesizedTypeNode, AsPropertyAssignment, AsPropertyDeclaration, AsReturnStatement, AsSetAccessorDeclaration, AsTypeAssertion, AsTypeParameterDeclaration, AsUnionTypeNode, AsVariableDeclaration, } from "../ast/generated/casts.js";
import { IsArrowFunction, IsBlock, IsCallExpression, IsConstructorDeclaration, IsFunctionDeclaration, IsFunctionExpression, IsGetAccessorDeclaration, IsIdentifier, IsJsxElement, IsJsxExpression, IsMethodDeclaration, IsParameterDeclaration, IsPropertyDeclaration, IsSatisfiesExpression, IsTemplateExpression, IsTypePredicateNode, IsVariableDeclaration, } from "../ast/generated/predicates.js";
...
import { FindAncestor, ForEachReturnStatement, GetAssignmentDeclarationKind, GetAllAccessorDeclarationsForDeclaration, HasModifier, IsAccessor, IsAssertionExpression, IsConstAssertion, IsConstTypeReference, IsFunctionLike, IsPrimitiveLiteralValue, IsVarConst, IsVariableParameterOrProperty, JSDeclarationKindObjectDefinePropertyExports, JSDeclarationKindObjectDefinePropertyValue, NodeIsMissing, } from "../ast/utilities.js";
import { CountWhere, Some } from "../core/core.js";
import { FailBadSyntaxKind } from "../debug/debug.js";
import { NewPseudoGetAccessor, NewPseudoObjectMethod, NewPseudoParameter, NewPseudoPropertyAssignment, NewPseudoSetAccessor, NewPseudoTypeBigIntLiteral, NewPseudoTypeDirect, NewPseudoTypeInferred, NewPseudoTypeInferredWithErrors, NewPseudoTypeMaybeConstLocation, NewPseudoTypeNoResult, NewPseudoTypeNumericLiteral, NewPseudoTypeObjectLiteral, NewPseudoTypeSingleCallSignature, NewPseudoTypeStringLiteral, NewPseudoTypeTuple, NewPseudoTypeUnion, PseudoType_AsPseudoTypeDirect, PseudoType_AsPseudoTypeInferred, PseudoType_AsPseudoTypeMaybeConstLocation, PseudoType_AsPseudoTypeUnion, PseudoTypeBigInt, PseudoTypeBoolean, PseudoTypeFalse, PseudoTypeKindDirect, PseudoTypeKindInferred, PseudoTypeKindMaybeConstLocation, PseudoTypeKindNoResult, PseudoTypeKindUndefined, PseudoTypeKindUnion, PseudoTypeNull, PseudoTypeNumber, PseudoTypeString, PseudoTypeTrue, PseudoTypeUndefined, } from "./type.js";
/**
 ...
 * }
 */
export function PseudoChecker_GetReturnTypeOfSignature(receiver, signatureNode) {
    switch (signatureNode.Kind) {
 ...
 * }
 */
export function PseudoChecker_GetTypeOfAccessor(receiver, accessor) {
 ...
 * }
 */
export function PseudoChecker_GetTypeOfExpression(receiver, node) {
 ...
 * }
 */
export function PseudoChecker_GetTypeOfDeclaration(receiver, node) {
    switch (node.Kind) {
        case KindParameter:
 ...
 * }
 */
export function PseudoChecker_typeFromPropertyAssignment(receiver, node) {
 ...
 * }
 */
export function PseudoChecker_typeFromExpandoProperty(receiver, node) {
 ...
 * }
 */
export function PseudoChecker_typeFromProperty(receiver, node) {
 ...
 * }
 */
export function PseudoChecker_typeFromVariable(receiver, declaration) {
 ...
 * }
 */
export function PseudoChecker_typeFromAccessor(receiver, accessor) {
    const accessorDeclarations = GetAllAccessorDeclarationsForDeclaration(accessor, Node_Symbol(accessor).Declarations ?? []);
 ...
 * }
 */
export function PseudoChecker_inferAccessorType(receiver, node) {
 ...
 * }
 */
export function PseudoChecker_getTypeAnnotationFromAllAccessorDeclarations(receiver, node, accessors) {
 ...
 * }
 */
export function PseudoChecker_getTypeAnnotationFromAccessor(receiver, node) {
    if (node === undefined) {
        return undefined;
    }
    // !!! TODO: support ripping return type off of .FullSignature
 ...
 * }
 */
export function isValueSignatureDeclaration(node) {
 ...
 * }
 */
export function PseudoChecker_createReturnFromSignature(receiver, fn) {
 ...
 * }
 */
export function PseudoChecker_typeFromSingleReturnExpression(receiver, fn) {
    let candidateExpr = undefined;
 ...
 * }
 */
export function PseudoChecker_typeFromExpression(receiver, node) {
    switch (node.Kind) {
        ...
        case KindPrefixUnaryExpression:
            if (IsPrimitiveLiteralValue(node, true)) {
                return PseudoChecker_typeFromPrimitiveLiteralPrefix(receiver, node);
            }
            break;
        case KindArrayLiteralExpression:
            return PseudoChecker_typeFromArrayLiteral(receiver, node);
        case KindObjectLiteralExpression:
            return PseudoChecker_typeFromObjectLiteral(receiver, node);
 ...
 * }
 */
export function PseudoChecker_typeFromObjectLiteral(receiver, node) {
        ...
        switch (e.Kind) {
            case KindMethodDeclaration: {
                ...
                if (Node_FunctionLikeData(e).FullSignature !== undefined) {
                    results.push(NewPseudoPropertyAssignment(false, Node_Name(e), optional, NewPseudoTypeDirect(Node_FunctionLikeData(e).FullSignature)));
                }
                else {
                    results.push(NewPseudoObjectMethod(e, Node_Name(e), optional, PseudoChecker_cloneTypeParameters(receiver, AsMethodDeclaration(e).TypeParameters), PseudoChecker_cloneParameters(receiver, Node_ParameterList(e)), PseudoChecker_createReturnFromSignature(receiver, e)));
                }
                break;
            }
            case KindPropertyAssignment:
                results.push(NewPseudoPropertyAssignment(false, Node_Name(e), AsPropertyAssignment(e).PostfixToken !== undefined && AsPropertyAssignment(e).PostfixToken.Kind === KindQuestionToken, PseudoChecker_typeFromExpression(receiver, Node_Initializer(e))));
                break;
            case KindSetAccessor:
            case KindGetAccessor: {
 ...
 * }
 */
export function PseudoChecker_getAccessorMember(receiver, accessor, name) {
    const allAccessors = GetAllAccessorDeclarationsForDeclaration(accessor, Node_Symbol(accessor).Declarations ?? []);
    if (allAccessors.GetAccessor !== undefined && allAccessors.GetAccessor.Type !== undefined &&
        ...
        if (IsGetAccessorDeclaration(accessor)) {
            return NewPseudoGetAccessor(accessor, name, false, PseudoChecker_typeFromAccessor(receiver, accessor));
        }
        return NewPseudoSetAccessor(accessor, name, false, PseudoChecker_cloneParameters(receiver, AsSetAccessorDeclaration(accessor).Parameters)[0]);
    }
    if (accessor === allAccessors.FirstAccessor) {
 ...
 * }
 */
export function PseudoChecker_canGetTypeFromObjectLiteral(receiver, node) {
    if (node.Properties === undefined || node.Properties.Nodes.length === 0) {
        return [];
    }
    const errorNodes = [];
    for (const e of node.Properties.Nodes) {
        ...
        if (eName.Kind === KindComputedPropertyName) {
            const expression = Node_Expression(eName);
 ...
 * }
 */
export function PseudoChecker_typeFromArrayLiteral(receiver, node) {
 ...
 * }
 */
export function PseudoChecker_canGetTypeFromArrayLiteral(receiver, node) {
 ...
 * }
 */
export function isConstContextPropagatingKind(kind) {
    switch (kind) {
        case KindArrayLiteralExpression:
        case KindObjectLiteralExpression:
        case KindParenthesizedExpression:
 ...
 * }
 */
export function IsInConstContext(node) {
    const maybeAssertion = FindAncestor(node.Parent, (n) => {
 ...
 * }
 */
export function PseudoChecker_typeFromPrimitiveLiteralPrefix(receiver, node) {
 ...
 * }
 */
export function PseudoChecker_typeFromTypeAssertion(receiver, expression, typeNode) {
 ...
 * }
 */
export function PseudoChecker_typeFromFunctionLikeExpression(receiver, node) {
    ...
    const typeParameters = PseudoChecker_cloneTypeParameters(receiver, Node_FunctionLikeData(node).TypeParameters);
    const parameters = PseudoChecker_cloneParameters(receiver, Node_FunctionLikeData(node).Parameters);
 ...
 * }
 */
export function PseudoChecker_cloneTypeParameters(receiver, nodes) {
    if (nodes === undefined) {
        return [];
    }
 ...
 * }
 */
export function isUndefinedPseudoType(t) {
 ...
 * }
 */
export function typeNodeCouldReferToUndefined(node) {
 ...
 * }
 */
export function couldAlreadyReferToUndefinedType(t) {
    if (t.Kind === PseudoTypeKindNoResult || t.Kind === PseudoTypeKindInferred || isUndefinedPseudoType(t)) {
        return true;
    }
    if (t.Kind === PseudoTypeKindMaybeConstLocation) {
 ...
 * }
 */
export function isOptionalInitializedOrRestParameter(node) {
 ...
 * }
 */
export function lastRequiredParamIndex(params) {
 ...
 * }
 */
export function addUndefinedIfDefinitelyRequired(expr) {
    if (couldAlreadyReferToUndefinedType(expr)) {
        return expr;
    }
 ...
 * }
 */
export function PseudoChecker_typeFromParameter(receiver, node) {
 ...
 * }
 */
export function PseudoChecker_typeFromParameterWorker(receiver, node, selfIdx, lastRequired) {
    const parent = node.Parent;
    if (parent.Kind === KindSetAccessor) {
        return PseudoChecker_GetTypeOfAccessor(receiver, parent);
    }
 ...
 * }
 */
export function PseudoChecker_cloneParameters(receiver, nodes) {
    if (nodes === undefined) {
        return [];
    }
    if (nodes.Nodes.length === 0) {
    ...
    for (let i = 0; i < nodes.Nodes.length; i++) {
        ...
        result.push(NewPseudoParameter(p.DotDotDotToken !== undefined, Node_Name(e), optional, PseudoChecker_typeFromParameterWorker(receiver, p, i, lastRequired)));
    }
    return result;
}
/**
 ...
 * }
 */
export function isContextuallyTyped(node) {
