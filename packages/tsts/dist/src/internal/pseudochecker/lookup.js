...
export function PseudoChecker_cloneParameters(receiver, nodes) {
    ...
    for (const e of nodes.Nodes) {
        ...
        result.push(NewPseudoParameter(p.DotDotDotToken !== undefined, Node_Name(e), p.QuestionToken !== undefined || p.Initializer !== undefined, PseudoChecker_typeFromParameter(receiver, p)));
    }
    return result;
}
/**
