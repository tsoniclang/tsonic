...
import { JsonFieldNames } from "../../go/github.com/go-json-experiment/json.js";
 ...
 */
export declare const allowInvalid: GoSlice<Options>;
/**
 ...
 * }
 */
export declare function Marshal(in_: unknown, ...opts: Array<Options>): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function MarshalEncode(out: GoPtr<Encoder_517f1597>, in_: unknown, ...opts: Array<Options>): GoError;
/**
 ...
 * }
 */
export declare function MarshalWrite(out: Writer, in_: unknown, ...opts: Array<Options>): GoError;
/**
 ...
 * }
 */
export declare function MarshalIndent(in_: unknown, prefix: string, indent: string): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function MarshalIndentWrite(out: Writer, in_: unknown, prefix: string, indent: string): GoError;
/**
 ...
 * }
 */
export declare function Unmarshal(in_: GoSlice<byte>, out: unknown, ...opts: Array<Options>): GoError;
/**
 ...
 * }
 */
export declare function UnmarshalDecode(in_: GoPtr<Decoder_d2f8186c>, out: unknown, ...opts: Array<Options>): GoError;
/**
 ...
 * }
 */
export declare function UnmarshalRead(in_: Reader, out: unknown, ...opts: Array<Options>): GoError;
/**
 ...
 * }
 */
export declare function AllowDuplicateNames(allow: bool): Options;
/**
 ...
 * }
 */
export declare function Deterministic(v: bool): Options;
/**
 ...
 * }
 */
export declare function WithIndent(indent: string): Options;
/**
 ...
 * }
 */
export declare function NewDecoder(r: Reader): GoPtr<Decoder_d2f8186c>;
/**
 ...
 * )
 */
export declare const BeginObject: Kind_c0fe0b38;
export declare const EndObject: Kind_c0fe0b38;
export declare const Null: Kind_c0fe0b38;
export declare const BeginArray: Kind_c0fe0b38;
export declare const EndArray: Kind_c0fe0b38;
