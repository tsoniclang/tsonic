import type { bool, double } from "@tsonic/core/types.js";
 ...
 * }
 */
export declare function Number_String(receiver: Number): string;
/**
 ...
 * }
 */
export declare function FromString(s: string): Number;
/**
 ...
 * }
 */
export declare function isStrWhiteSpace(r: GoRune): bool;
/**
 ...
 */
export declare let errUnknownPrefix: GoError;
/**
 ...
 * }
 */
export declare function tryParseInt(s: string): [Number, bool];
/**
 ...
 * }
 */
export declare function parseFloatString(s: string): double;
/**
 ...
 * }
 */
export declare function cutAny(s: string, cutset: string): [string, string, bool];
/**
 ...
 * }
 */
export declare function trimLeadingZeros(s: string): string;
/**
 ...
 * }
 */
export declare function trimTrailingZeros(s: string): string;
/**
 ...
 * }
 */
export declare function stringToFloat64(s: string): double;
/**
 ...
 * }
 */
export declare function isAllDigits(s: string): bool;
/**
 ...
 * }
 */
export declare function isAllBinaryDigits(s: string): bool;
/**
 ...
 * }
 */
export declare function isAllOctalDigits(s: string): bool;
/**
 ...
 * }
 */
export declare function isAllHexDigits(s: string): bool;
/**
 ...
 * }
 */
export declare function isNumberRune(r: GoRune): bool;
