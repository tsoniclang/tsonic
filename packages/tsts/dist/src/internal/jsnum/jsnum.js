 ...
 * )
 */
export const MaxSafeInteger = (2 ** 53 - 1);
export const MinSafeInteger = -MaxSafeInteger;
/**
 ...
 * }
 */
export function Number_IsNaN(receiver) {
 ...
 * }
 */
export function Number_IsInf(receiver) {
    return math.IsInf(receiver, 0);
}
/**
 ...
 * }
 */
export function Number_toUint32(receiver) {
    // The only difference between ToUint32 and ToInt32 is the interpretation of the bits.
    // `uint32(int32)` reinterprets the same bit pattern as unsigned: `>>> 0`.
    return (Number_toInt32(receiver) >>> 0);
}
/**
 ...
 * }
 */
export function Number_toInt32(receiver) {
    const x = receiver;
    // Fast path: if the number is in the range (-2^31, 2^32), i.e. an SMI,
    // then we don't need to do any special mapping.
 ...
 * }
 */
export function Number_toShiftCount(receiver) {
    return (Number_toUint32(receiver) & 31);
}
/**
 ...
 * }
 */
export function Number_SignedRightShift(receiver, y) {
    return (Number_toInt32(receiver) >> Number_toShiftCount(y));
}
/**
 ...
 * }
 */
export function Number_UnsignedRightShift(receiver, y) {
    // `uint32 >> n` is a logical shift; `>>>` performs the unsigned right shift.
    return (Number_toUint32(receiver) >>> Number_toShiftCount(y));
}
/**
 ...
 * }
 */
export function Number_LeftShift(receiver, y) {
    return (Number_toInt32(receiver) << Number_toShiftCount(y));
}
/**
 ...
 * }
 */
export function Number_BitwiseNOT(receiver) {
    return ~Number_toInt32(receiver);
}
/**
 ...
 * }
 */
export function Number_BitwiseOR(receiver, y) {
    return (Number_toInt32(receiver) | Number_toInt32(y));
}
/**
 ...
 * }
 */
export function Number_BitwiseAND(receiver, y) {
    return (Number_toInt32(receiver) & Number_toInt32(y));
}
/**
 ...
 * }
 */
export function Number_BitwiseXOR(receiver, y) {
    return (Number_toInt32(receiver) ^ Number_toInt32(y));
}
/**
 ...
 * }
 */
export function Number_trunc(receiver) {
    return math.Trunc(receiver);
}
/**
 ...
 * }
 */
export function Number_Floor(receiver) {
 ...
 * }
 */
export function Number_Abs(receiver) {
 ...
 */
export const negativeZero = math.Copysign(0, -1);
/**
 ...
 * }
 */
export function Number_Remainder(receiver, d) {
    switch (true) {
 ...
 * }
 */
export function Number_Exponentiate(receiver, exponent) {
    switch (true) {
        case (receiver === 1 || receiver === -1) && Number_IsInf(exponent):
            return NaN();
        case receiver === 1 && Number_IsNaN(exponent):
            return NaN();
    }
    const b = receiver;
    const e = exponent;
    ...
    if (b >= math.MinInt64 &&
        ...
        e === math.Trunc(e) &&
        !math.IsInf(e, 0)) {
        const magnitude = e * math.Log2(math.Abs(b));
        if (magnitude > 53 && magnitude <= math.Log2(math.MaxFloat64)) {
            ...
            const result = globalThis.Number(riBig);
            return result;
        }
    }
    return math.Pow(b, e);
}
//# sourceMappingURL=jsnum.js.map