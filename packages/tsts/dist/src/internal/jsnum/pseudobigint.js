 ...
 * }
 */
export function NewPseudoBigInt(value, negative) {
 ...
 * }
 */
export function PseudoBigInt_String(receiver) {
 ...
 * }
 */
export function PseudoBigInt_Sign(receiver) {
    if (byteLen(receiver.Base10Value) === 0) {
        return 0;
    }
    if (receiver.Negative) {
 ...
 * }
 */
export function ParseValidBigInt(text) {
    let negative;
 ...
 * }
 */
export function ParsePseudoBigInt(stringValue) {
...
//# sourceMappingURL=pseudobigint.js.map