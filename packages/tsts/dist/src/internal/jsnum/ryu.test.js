...
test("Number.String mirrors upstream Ryu d2s regression cases", () => {
    const cases = [
        ...
        [1.23456789e9, "1234567890"],
        [1.234567895e9, "1234567895"],
        [1.2345678901e10, "12345678901"],
        [1.23456789012e11, "123456789012"],
        [1.234567890123e12, "1234567890123"],
        [1.2345678901234e13, "12345678901234"],
        ...
        [8192.0e3, "8192000"],
        [65536.0e3, "65536000"],
        [524288.0e3, "524288000"],
        [8388608.0e3, "8388608000"],
        [67108864.0e3, "67108864000"],
        [536870912.0e3, "536870912000"],
        [8589934592.0e3, "8589934592000"],
        [68719476736.0e3, "68719476736000"],
        [549755813888.0e3, "549755813888000"],
        [8796093022208.0e3, "8796093022208000"],
    ];
    for (const [number, expected] of cases) {
        assert.equal(Number_String(number), expected, expected);
    }
});
//# sourceMappingURL=ryu.test.js.map