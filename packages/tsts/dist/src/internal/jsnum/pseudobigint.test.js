...
test("ParsePseudoBigInt strips decimal leading zeroes", () => {
    ...
    for (let bits = 0; bits < 53; bits++) {
        const power = 2 ** bits;
        testNumbers.push(power, (power - 1));
    }
...
test("ParsePseudoBigInt parses large literals", () => {
    ...
    assert.equal(ParsePseudoBigInt("0b1100011101110100100001111111101101100001101110011111000001110111001001110001111110000101011010010n"), "123456789012345678901234567890");
...
//# sourceMappingURL=pseudobigint.test.js.map