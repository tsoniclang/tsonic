...
import { Inf, MaxSafeInteger, MinSafeInteger, NaN as JsNaN, negativeZero, } from "./jsnum.js";
...
function ieeeParts2Double(sign, ieeeExponent, ieeeMantissa) {
...
const ryuStringTests = [
    ...
    [1.234567890123456e15, "1234567890123456"],
    [1000000000000001, "1000000000000001"],
    [8796093022208000, "8796093022208000"],
];
const stringTests = [
    [JsNaN(), "NaN"],
    [Inf(1), "Infinity"],
    ...
    [1e308, "1e+308"],
    [-1e308, "-1e+308"],
    [globalThis.Math.PI, "3.141592653589793"],
    [-globalThis.Math.PI, "-3.141592653589793"],
...
const fromStringTests = [
    ...
    [JsNaN(), "0B0.0"],
    [1.231235345083403e91, "12312353450834030486384068034683603046834603806830644850340602384608368034634603680348603864"],
