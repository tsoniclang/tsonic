 ...
 */
export declare const sampleInterval: Duration;
/**
 ...
 */
export declare const traceFileName: string;
/**
 ...
 */
export declare const flushThreshold: int;
/**
 ...
 * )
 */
export declare const PhaseParse: Phase;
export declare const PhaseProgram: Phase;
export declare const PhaseBind: Phase;
export declare const PhaseCheck: Phase;
export declare const PhaseCheckTypes: Phase;
export declare const PhaseEmit: Phase;
export declare const PhaseSession: Phase;
/**
 ...
 * }
 */
export declare function StartTracing(fs: FS, traceDir: string, configFilePath: string, deterministic: bool): [GoPtr<Tracing>, GoError];
/**
 ...
 * }
 */
export declare function Tracing_timestamp(receiver: GoPtr<Tracing>): double;
/**
 ...
 * }
 */
export declare function writeEventTo(buf: GoPtr<Builder>, event: traceEvent): void;
/**
 ...
 * }
 */
export declare function Tracing_writeEvent(receiver: GoPtr<Tracing>, event: traceEvent): void;
/**
 ...
 * }
 */
export declare function Tracing_maybeFlushLocked(receiver: GoPtr<Tracing>): void;
/**
 ...
 * }
 */
export declare function Tracing_Instant(receiver: GoPtr<Tracing>, phase: Phase, name: string, args: GoMap<string, unknown>): void;
/**
 ...
 * }
 */
export declare function Tracing_Push(receiver: GoPtr<Tracing>, phase: Phase, name: string, args: GoMap<string, unknown>, separateBeginAndEnd: bool): () => void;
/**
 ...
 * )
 */
export declare const mainThreadID: int;
export declare const firstSyntheticThreadID: int;
export declare const firstFileThreadID: int;
export declare const fileThreadIDHashRange: int;
/**
 ...
 */
export declare const traceThreadArgKeys: GoArray<string, "...">;
/**
 ...
 * )
 */
export declare const traceThreadKindChecker: traceThreadKind;
export declare const traceThreadKindFile: traceThreadKind;
/**
 ...
 * }
 */
export declare function Tracing_threadIDLocked(receiver: GoPtr<Tracing>, args: GoMap<string, unknown>): int;
/**
 ...
 * }
 */
export declare function Tracing_writeThreadNameEventLocked(receiver: GoPtr<Tracing>, tid: int, name: string): void;
/**
 ...
 * }
 */
export declare function traceThreadKeyFromArgs(args: GoMap<string, unknown>): [traceThreadKey, bool];
/**
 ...
 * }
 */
export declare function traceThreadKey_defaultThreadID(receiver: traceThreadKey): int;
/**
 ...
 * }
 */
export declare function traceThreadKey_displayName(receiver: traceThreadKey): string;
/**
 ...
 * }
 */
export declare function stableTraceThreadID(key: traceThreadKey): int;
/**
 ...
 * }
 */
export declare function Tracing_NewTypeTracer(receiver: GoPtr<Tracing>, checkerIndex: int): Tracer;
/**
 ...
 * }
 */
export declare function Tracing_StopTracing(receiver: GoPtr<Tracing>): GoError;
/**
...
export declare function typeTracer_as_Tracer(receiver: GoPtr<typeTracer>): Tracer;
/**
 ...
 * }
 */
export declare function typeTracer_RecordType(receiver: GoPtr<typeTracer>, typ: TracedType): void;
/**
 ...
 * }
 */
export declare function typeTracer_DumpTypes(receiver: GoPtr<typeTracer>): GoError;
/**
 ...
 * }
 */
export declare function typeTracer_buildTypeDescriptor(receiver: GoPtr<typeTracer>, typ: TracedType, recursionIdentityMap: GoMap<unknown, int>): TypeDescriptor;
/**
 ...
 * }
 */
export declare function mapTypeIds(types: GoSlice<TracedType>): GoSlice<uint>;
/**
 ...
 * }
 */
export declare function getLocation(node: GoPtr<Node>): GoPtr<Location>;
