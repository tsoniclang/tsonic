...
import { AsJSDoc, AsJSDocImportTag, AsJSDocOverloadTag, AsJSDocTypedefTag, AsJSDocParameterOrPropertyTag, AsJSDocTemplateTag, AsJSDocThisTag, AsJSDocSatisfiesTag, AsJSDocImplementsTag, AsJSDocAugmentsTag, AsJSDocVariadicType, AsJSDocTypeLiteral, AsTypeParameterDeclaration, AsQualifiedName, AsVariableStatement, AsVariableDeclarationList, AsBinaryExpression, AsShorthandPropertyAssignment, AsHeritageClause, AsClassDeclaration, AsClassExpression, AsExpressionWithTypeArguments, AsImportClause, AsPropertySignatureDeclaration, AsParameterDeclaration, AsTypeAliasDeclaration, AsJSDocSignature, AsModuleDeclaration, AsIdentifier, } from "../ast/generated/casts.js";
import { IsFunctionDeclaration, IsMethodDeclaration, IsConstructorDeclaration, IsIdentifier, IsJSDocTypedefTag, IsJSDocCallbackTag, IsJSDocTemplateTag, IsModuleDeclaration, IsQualifiedName, } from "../ast/generated/predicates.js";
import { KindJSDocTypedefTag, KindJSDocCallbackTag, KindJSDocImportTag, KindJSDocOverloadTag, KindJSDocTypeTag, KindJSDocSatisfiesTag, KindJSDocTemplateTag, KindJSDocParameterTag, KindJSDocPropertyTag, KindJSDocThisTag, KindJSDocReturnTag, KindJSDocReadonlyTag, KindJSDocPrivateTag, KindJSDocPublicTag, KindJSDocProtectedTag, KindJSDocOverrideTag, KindJSDocImplementsTag, KindJSDocAugmentsTag, KindJSDocVariadicType, KindJSDocOptionalType, KindJSDocTypeLiteral, KindJSDocTypeExpression, KindFunctionDeclaration, KindMethodDeclaration, KindConstructor, KindVariableStatement, KindVariableDeclaration, KindExportAssignment, KindPropertyDeclaration, KindPropertyAssignment, KindShorthandPropertyAssignment, KindParameter, KindExpressionStatement, KindReturnStatement, KindParenthesizedExpression, KindBinaryExpression, KindClassDeclaration, KindClassExpression, KindIdentifier, KindReadonlyKeyword, KindPrivateKeyword, KindPublicKeyword, KindProtectedKeyword, KindOverrideKeyword, KindExportKeyword, KindQuestionToken, KindDotDotDotToken, KindImplementsKeyword, KindExtendsKeyword, KindAnyKeyword, KindModuleDeclaration, KindNamespaceKeyword, KindTypeKeyword, KindThisKeyword, KindGetAccessor, KindSatisfiesExpression, KindSetAccessor, } from "../ast/generated/kinds.js";
import { GetAssignmentDeclarationKind, GetRightMostAssignedExpression, JSDeclarationKindNone, HasSamePropertyAccessName, IsFunctionLike, IsFunctionLikeDeclaration, IsThisIdentifier, } from "../ast/utilities.js";
import { Node_AsMutable, Node_Text, Node_Body, Node_ModifierNodes, MutableNode_SetType, MutableNode_SetInitializer, MutableNode_SetExpression, MutableNode_SetModifiers, Node_TagName, Node_TypeExpression, Node_CommentList, Node_ClassName, Node_Parameters, Node_ParameterList, Node_Type, Node_Initializer, Node_Expression, Node_TypeParameterList, Node_TypeParameters, NodeFactory_NewModifier, } from "../ast/ast.js";
import { Node_Pos, Node_End } from "../ast/spine.js";
import { NewToken, NewIdentifier, NewKeywordTypeNode, NewParameterDeclaration, NewFunctionDeclaration, NewMethodDeclaration, NewConstructorDeclaration, NewFunctionTypeNode, NewPropertySignatureDeclaration, NewTypeLiteralNode, NewArrayTypeNode, NewAsExpression, NewSatisfiesExpression, NewStringLiteral, NewJSTypeAliasDeclaration, NewJSImportDeclaration, NewJSDoc, NewHeritageClause, NewModuleBlock, NewModuleDeclaration, NewTypeParameterDeclaration, } from "../ast/generated/factory.js";
import { NodeFactory_DeepCloneReparse, NodeFactory_DeepCloneReparseModifiers, } from "../ast/deepclone.js";
 ...
 * }
 */
export function Parser_finishReparsedNode(receiver, node, locationNode) {
 ...
 * }
 */
export function Parser_finishMutatedNode(receiver, node) {
    Parser_overrideParentInImmediateChildren(receiver, node);
}
/**
 ...
 * }
 */
export function Parser_addDeepCloneReparse(receiver, node) {
 ...
 * }
 */
export function Parser_addTransformedReparse(receiver, newNode, old) {
 ...
 * }
 */
export function Parser_checkNonIdentifierName(receiver, name) {
 ...
 * }
 */
export function Parser_reparseTags(receiver, parent, jsDoc) {
 ...
 * }
 */
export function Parser_reparseUnhosted(receiver, tag, parent, jsDoc) {
    switch (tag.Kind) {
        case KindJSDocTypedefTag: {
            ...
            AsTypeAliasDeclaration(typeAlias).TypeParameters = Parser_gatherTypeParameters(receiver, jsDoc, true);
            let t;
            switch (typeExpression.Kind) {
        ...
        case KindJSDocImportTag: {
            ...
            const importDeclaration = NewJSImportDeclaration(receiver.factory, NodeFactory_DeepCloneReparseModifiers(receiver.factory, Node_Modifiers(tag)), importClause, Parser_addDeepCloneReparse(receiver, importTag.ModuleSpecifier), Parser_addDeepCloneReparse(receiver, importTag.Attributes));
 ...
 * }
 */
export function Parser_reparseJSDocSignature(receiver, jsSignature, fun, jsDoc, tag, modifiers) {
    let signature;
    ...
    if (tag.Kind !== KindJSDocCallbackTag) {
        Node_FunctionLikeData(signature).TypeParameters = Parser_gatherTypeParameters(receiver, jsDoc, false);
    }
    let parameters = Arena_NewSlice(receiver.nodeSliceArena, 0);
    const jsSignatureParameters = Node_Parameters(jsSignature);
    for (let pi = 0; pi < jsSignatureParameters.length; pi++) {
                ...
                for (;;) {
                    ...
                    if (i === 0) {
                        if (!IsIdentifierStart(ch)) {
                            result.WriteRune("_".charCodeAt(0));
                        }
                        else {
                            result.WriteRune(ch);
                        }
 ...
 * }
 */
export function Parser_reparseJSDocTypeLiteral(receiver, t) {
    if (t === undefined) {
        return undefined;
    }
    if (t.Kind === KindJSDocTypeLiteral) {
        ...
        let result = NewTypeLiteralNode(receiver.factory, Parser_newNodeList(receiver, jstypeliteral.Loc, properties));
        if (isArrayType) {
 ...
 * }
 */
export function Parser_reparseJSDocComment(receiver, node, tag) {
 ...
 * }
 */
export function Parser_gatherTypeParameters(receiver, j, typedefOrCallback) {
    let typeParameters;
    let pos = -1;
    let endPos = -1;
    ...
    for (const tag of AsJSDoc(j).Tags.Nodes) {
        ...
        for (const tp of Node_TypeParameters(tag)) {
            ...
            if (constraint !== undefined && firstTypeParameter) {
                reparse = NewTypeParameterDeclaration(receiver.factory, NodeFactory_DeepCloneReparseModifiers(receiver.factory, Node_Modifiers(tp)), Parser_addDeepCloneReparse(receiver, Parser_checkNonIdentifierName(receiver, Node_Name(tp))), Parser_addDeepCloneReparse(receiver, Node_Type(constraint)), undefined, // expression
 ...
 * }
 */
export function Parser_reparseHosted(receiver, tag, parent, jsDoc) {
    switch (tag.Kind) {
        case KindJSDocTypeTag: {
            switch (parent.Kind) {
                ...
                case KindParenthesizedExpression: {
                    if (Node_Expression(parent) !== undefined && Node_TypeExpression(tag) !== undefined) {
                        MutableNode_SetExpression(Node_AsMutable(parent), Parser_makeNewCast(receiver, Parser_addDeepCloneReparse(receiver, Node_Type(Node_TypeExpression(tag))), Node_Expression(parent), true));
                        Parser_finishMutatedNode(receiver, parent);
                        return;
                    }
                    break;
            ...
            if (fun !== undefined) {
                const noTypedParams = Every(Node_Parameters(fun), (param) => (Node_Type(param) === undefined));
            ...
            switch (parent.Kind) {
                    ...
                    if (AsVariableStatement(parent).DeclarationList !== undefined) {
                        for (const declaration of AsVariableDeclarationList(AsVariableStatement(parent).DeclarationList).Declarations.Nodes) {
                            if (Node_Initializer(declaration) !== undefined && Node_TypeExpression(tag) !== undefined) {
                                MutableNode_SetInitializer(Node_AsMutable(declaration), Parser_makeNewCast(receiver, Parser_addDeepCloneReparse(receiver, Node_Type(Node_TypeExpression(tag))), Node_Initializer(declaration), false));
                                Parser_finishMutatedNode(receiver, declaration);
                                break;
                            }
                        }
                ...
                case KindPropertyAssignment: {
                    if (Node_Initializer(parent) !== undefined && Node_TypeExpression(tag) !== undefined) {
                        MutableNode_SetInitializer(Node_AsMutable(parent), Parser_makeNewCast(receiver, Parser_addDeepCloneReparse(receiver, Node_Type(Node_TypeExpression(tag))), Node_Initializer(parent), false));
                        Parser_finishMutatedNode(receiver, parent);
                    }
                    break;
                }
                case KindShorthandPropertyAssignment: {
                    ...
                    if (shorthand.ObjectAssignmentInitializer !== undefined && AsJSDocSatisfiesTag(tag).TypeExpression !== undefined) {
                        shorthand.ObjectAssignmentInitializer = Parser_makeNewCast(receiver, Parser_addDeepCloneReparse(receiver, Node_Type(AsJSDocSatisfiesTag(tag).TypeExpression)), shorthand.ObjectAssignmentInitializer, false);
                        Parser_finishMutatedNode(receiver, parent);
                    }
                    break;
                }
                ...
                case KindExportAssignment: {
                    if (Node_Expression(parent) !== undefined && Node_TypeExpression(tag) !== undefined) {
                        MutableNode_SetExpression(Node_AsMutable(parent), Parser_makeNewCast(receiver, Parser_addDeepCloneReparse(receiver, Node_Type(Node_TypeExpression(tag))), Node_Expression(parent), false));
                        Parser_finishMutatedNode(receiver, parent);
                    }
                    break;
                }
                case KindExpressionStatement: {
                    if (Node_Expression(parent).Kind === KindBinaryExpression) {
                        const bin = AsBinaryExpression(Node_Expression(parent));
                        if (GetAssignmentDeclarationKind(Node_AsMutable(bin)) !== JSDeclarationKindNone && Node_TypeExpression(tag) !== undefined) {
                            bin.Right = Parser_makeNewCast(receiver, Parser_addDeepCloneReparse(receiver, Node_Type(Node_TypeExpression(tag))), bin.Right, false);
                            Parser_finishMutatedNode(receiver, Node_AsMutable(bin));
                        }
                    }
                    break;
        ...
        case KindJSDocTemplateTag: {
            ...
            if (fun !== undefined) {
                if (Node_TypeParameters(fun) === undefined && Node_FunctionLikeData(fun).FullSignature === undefined) {
                    Node_FunctionLikeData(fun).TypeParameters = Parser_gatherTypeParameters(receiver, jsDoc, false);
                    Parser_finishMutatedNode(receiver, fun);
                }
            }
                ...
                if (cls.TypeParameters === undefined) {
                    cls.TypeParameters = Parser_gatherTypeParameters(receiver, jsDoc, false);
                    Parser_finishMutatedNode(receiver, parent);
                }
            }
        ...
        case KindJSDocThisTag: {
            ...
            if (fun !== undefined) {
                ...
                if (params.length === 0 || (Node_Name(params[0]).Kind !== KindThisKeyword && !IsThisIdentifier(Node_Name(params[0])))) {
                    const thisParam = NewParameterDeclaration(receiver.factory, undefined, // decorators
                    undefined, // modifiers
                    NewIdentifier(receiver.factory, "this"), undefined, // questionToken
                    undefined, // type
                    undefined);
                    ...
                    const newParams = Arena_NewSlice(receiver.nodeSliceArena, (params.length + 1));
                    newParams[0] = thisParam;
            ...
            switch (p.Kind) {
                ...
                case KindBinaryExpression: {
                    ...
                    if (Node_Modifiers(p) === undefined) {
                        nodes = Arena_NewSlice(receiver.nodeSliceArena, 1);
                        nodes[0] = modifier;
                        loc = tag.Loc;
                    }
                    else {
        ...
        case KindJSDocImplementsTag: {
            ...
            if (cls !== undefined) {
                ...
                if (cls.HeritageClauses !== undefined) {
                    const implementsClause = Find(cls.HeritageClauses.Nodes, (node) => (AsHeritageClause(node).Token === KindImplementsKeyword));
        ...
        case KindJSDocAugmentsTag: {
            ...
            if (cls !== undefined && cls.HeritageClauses !== undefined) {
                const extendsClause = Find(cls.HeritageClauses.Nodes, (node) => (AsHeritageClause(node).Token === KindExtendsKeyword));
                if (extendsClause !== undefined && AsHeritageClause(extendsClause).Types.Nodes.length === 1) {
                    ...
                    if (HasSamePropertyAccessName(target.Expression, source.Expression)) {
                        if (target.TypeArguments === undefined && source.TypeArguments !== undefined) {
                            const newArguments = Arena_NewSlice(receiver.nodeSliceArena, source.TypeArguments.Nodes.length);
                            for (let i = 0; i < source.TypeArguments.Nodes.length; i++) {
 ...
 * }
 */
export function Parser_makeQuestionIfOptional(receiver, parameter) {
 ...
 * }
 */
export function findMatchingParameter(fun, parameterTag, jsDoc) {
    let tagIndex = -1;
    let paramCount = -1;
    ...
    for (let parameterIndex = 0; parameterIndex < parameters.length; parameterIndex++) {
        ...
        if (Node_Name(parameter).Kind === KindIdentifier) {
            if (parameterTag.name.Kind === KindIdentifier &&
                ...
                return [AsParameterDeclaration(parameter), true];
            }
        }
        else if (parameterIndex === tagIndex) {
            return [AsParameterDeclaration(parameter), true];
 ...
 * }
 */
export function skipSatisfiesExpressions(node) {
    let current = node;
 ...
 * }
 */
export function getFunctionLikeHost(host) {
    let fun = host;
    switch (host.Kind) {
        case KindVariableStatement: {
 ...
 * }
 */
export function Parser_makeNewCast(receiver, t, e, isAssertion) {
    let assert;
    if (isAssertion) {
 ...
 * }
 */
export function getClassLikeData(parent) {
    let cls = undefined;
    switch (parent.Kind) {
 ...
 * }
 */
export function Parser_createExportModifier(receiver, locationNode) {
 ...
 * }
 */
export function Parser_getInnermostNameOfJSDocNamespace(receiver, fullName) {
 ...
 * }
 */
export function Parser_wrapInJSDocNamespace(receiver, fullName, statement, nested) {
...
//# sourceMappingURL=reparser.js.map