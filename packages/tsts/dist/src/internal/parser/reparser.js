 ...
 * }
 */
export function Parser_gatherTypeParameters(receiver, j, tagWithTypeParameters) {
    let typeParameters;
    let pos = -1;
    let endPos = -1;
    ...
    for (let i = 0; i < jsTags.length; i++) {
        ...
        for (const tp of Node_TypeParameters(tag)) {
            ...
            if (constraint !== undefined && firstTypeParameter) {
                reparse = NewTypeParameterDeclaration(receiver.factory, NodeFactory_DeepCloneReparseModifiers(receiver.factory, Node_Modifiers(tp)), Parser_addDeepCloneReparse(receiver, Node_Name(tp)), Parser_addDeepCloneReparse(receiver, Node_Type(constraint)), undefined, // expression
...
function Parser_createExportModifier(receiver, locationNode) {
...
function Parser_getInnermostNameOfJSDocNamespace(receiver, fullName) {
...
function Parser_wrapInJSDocNamespace(receiver, fullName, statement, nested) {
