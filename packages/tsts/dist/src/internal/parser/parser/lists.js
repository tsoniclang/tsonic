...
import { KindAsteriskToken, KindCaseKeyword, KindCloseBraceToken, KindCloseBracketToken, KindCloseParenToken, KindCommaToken, KindConstKeyword, KindDefaultKeyword, KindDotDotDotToken, KindDotToken, KindEndOfFile, KindEqualsGreaterThanToken, KindExtendsKeyword, KindFromKeyword, KindGreaterThanToken, KindImplementsKeyword, KindInKeyword, KindLessThanToken, KindOfKeyword, KindOpenBraceToken, KindOpenBracketToken, KindOpenParenToken, KindSemicolonToken, KindSlashToken, KindStringLiteral, } from "../../ast/generated/kinds.js";
...
import { Parser_isLiteralPropertyName, Parser_isStartOfExpression, Parser_isStartOfLeftHandSideExpression, Parser_nextTokenIsTokenStringLiteral, Parser_parseArgumentExpression, Parser_scanClassMemberStart, } from "./expressions.js";
import { Parser_canParseSemicolon, Parser_checkJSSyntax, Parser_isStartOfParameter, Parser_lookAhead, Parser_nodePos, Parser_parseOptional, Parser_parseParameterEx, isAsyncModifier, } from "./support.js";
import { Parser_hasPrecedingLineBreak, Parser_isImportAttributeName, Parser_isStartOfStatement, } from "./statements-declarations.js";
import { Parser_isBindingIdentifierOrPrivateIdentifierOrPattern, Parser_isIdentifier, Parser_isInSomeParsingContext, Parser_nextToken, Parser_nextTokenIsSlash, Parser_parseErrorAtCurrentToken, Parser_parseExpected, Parser_parsingContextErrors, Parser_setContextFlags, } from "./tokens-speculation.js";
import { Parser_isHeritageClause, Parser_isHeritageClauseExtendsOrImplementsKeyword, Parser_isStartOfType, Parser_isValidHeritageClauseObjectLiteral, Parser_scanTypeMemberStart, } from "./types.js";
import { missingListNodes, PCArgumentExpressions, PCArrayBindingElements, PCArrayLiteralMembers, PCBlockStatements, PCClassMembers, PCEnumMembers, PCHeritageClauseElement, PCHeritageClauses, PCImportAttributes, PCImportOrExportSpecifiers, PCJSDocComment, PCJSDocParameters, PCJsxAttributes, PCJsxChildren, PCObjectBindingElements, PCObjectLiteralMembers, PCParameters, PCRestProperties, PCSourceElements, PCSwitchClauseStatements, PCSwitchClauses, PCTupleElementTypes, PCTypeArguments, PCTypeMembers, PCTypeParameters, PCVariableDeclarations, } from "./state.js";
/**
 ...
 * }
 */
export function isMissingNodeList(list) {
 ...
 * }
 */
export function Parser_parseListIndex(receiver, kind, parseElement) {
    ...
    return Arena_Clone(receiver.nodeSliceArena, list);
}
/**
 ...
 * }
 */
export function Parser_parseList(receiver, kind, parseElement) {
    const pos = Parser_nodePos(receiver);
    const nodes = Parser_parseListIndex(receiver, kind, (p, _index) => parseElement(p));
 ...
 * }
 */
export function Parser_parseDelimitedList(receiver, kind, parseElement) {
    const pos = Parser_nodePos(receiver);
    const saveParsingContexts = receiver.parsingContexts;
    receiver.parsingContexts |= 1 << kind;
    let list = [];
    ...
    receiver.parsingContexts = saveParsingContexts;
    return Parser_newNodeList(receiver, NewTextRange(pos, Parser_nodePos(receiver)), Arena_Clone(receiver.nodeSliceArena, list));
}
/**
 ...
 * }
 */
export function Parser_parseBracketedList(receiver, kind, parseElement, opening, closing) {
 ...
 * }
 */
export function Parser_parseEmptyNodeList(receiver) {
 ...
 * }
 */
export function Parser_createMissingList(receiver) {
 ...
 * }
 */
export function Parser_abortParsingListOrMoveToNextToken(receiver, kind) {
 ...
 * }
 */
export function Parser_isListElement(receiver, parsingContext, inErrorRecovery) {
    switch (parsingContext) {
 ...
 * }
 */
export function Parser_isListTerminator(receiver, kind) {
 ...
 * }
 */
export function modifierListHasAsync(modifiers) {
 ...
 * }
 */
export function Parser_parseParameters(receiver, flags) {
    // FormalParameters [Yield,Await]: (modified)
    //      [empty]
    //      FormalParameterList[?Yield,Await]
    //
 ...
 * }
 */
export function Parser_parseParametersWorker(receiver, flags, allowAmbiguity) {
    // FormalParameters [Yield,Await]: (modified)
    //      [empty]
    //      FormalParameterList[?Yield,Await]
    //
    ...
    const parameters = Parser_parseDelimitedList(receiver, PCParameters, (p) => {
 ...
 * }
 */
export function Parser_parseArgumentList(receiver) {
 ...
 * }
 */
export function Parser_newNodeList(receiver, loc, nodes) {
 ...
 * }
 */
export function Parser_newModifierList(receiver, loc, nodes) {
