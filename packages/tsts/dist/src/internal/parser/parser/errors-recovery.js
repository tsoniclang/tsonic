 ...
 * }
 */
export function Parser_scanError(receiver, message, pos, length, ...args) {
 ...
 * }
 */
export function Parser_parseErrorAt(receiver, pos, end, message, ...args) {
 ...
 * }
 */
export function Parser_parseErrorAtRange(receiver, loc, message, ...args) {
    // Don't report another error if it would just be at the same location as the last error
 ...
 * }
 */
export function attachFileToDiagnostics(diagnostics, file) {
 ...
 * }
 */
export function Parser_jsErrorAtRange(receiver, loc, message, ...args) {
...
//# sourceMappingURL=errors-recovery.js.map