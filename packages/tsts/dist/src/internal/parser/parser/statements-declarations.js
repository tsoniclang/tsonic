...
import { KindAbstractKeyword, KindAccessorKeyword, KindAsKeyword, KindAssertKeyword, KindAsteriskToken, KindAsyncKeyword, KindAtToken, KindAwaitKeyword, KindBigIntLiteral, KindBreakKeyword, KindCatchKeyword, KindClassDeclaration, KindClassKeyword, KindCloseBraceToken, KindCloseParenToken, KindColonToken, KindCommaToken, KindConstKeyword, KindConstructorKeyword, KindContinueKeyword, KindDebuggerKeyword, KindDeclareKeyword, KindDeferKeyword, KindDefaultKeyword, KindDoKeyword, KindDotToken, KindElseKeyword, KindEndOfFile, KindEnumKeyword, KindEqualsToken, KindExclamationToken, KindExportKeyword, KindExportSpecifier, KindFinallyKeyword, KindForKeyword, KindFromKeyword, KindFunctionKeyword, KindGetKeyword, KindGetAccessor, KindGlobalKeyword, KindIdentifier, KindIfKeyword, KindImportKeyword, KindImportSpecifier, KindInKeyword, KindInterfaceKeyword, KindLessThanToken, KindLetKeyword, KindModuleKeyword, KindNamespaceKeyword, KindNumericLiteral, KindOfKeyword, KindCloseBracketToken, KindOpenBraceToken, KindOpenBracketToken, KindOpenParenToken, KindPrivateIdentifier, KindPrivateKeyword, KindProtectedKeyword, KindPublicKeyword, KindQuestionToken, KindReadonlyKeyword, KindRequireKeyword, KindReturnKeyword, KindSemicolonToken, KindSetKeyword, KindSetAccessor, KindStaticKeyword, KindStringLiteral, KindSwitchKeyword, KindTaggedTemplateExpression, KindThrowKeyword, KindTryKeyword, KindTypeKeyword, KindUnknown, KindUsingKeyword, KindVarKeyword, KindWhileKeyword, KindWithKeyword, KindForOfStatement, KindForInStatement, } from "../../ast/generated/kinds.js";
import { NodeFlagsAmbient, NodeFlagsAwaitContext, NodeFlagsDisallowInContext, NodeFlagsInWithStatement, NodeFlagsThisNodeHasError, NodeFlagsYieldContext, NodeFlagsDecoratorContext, NodeFlagsNone, NodeFlagsLet, NodeFlagsConst, NodeFlagsUsing, NodeFlagsAwaitUsing, NodeFlagsReparsed, } from "../../ast/generated/flags.js";
...
import { NewBlock, NewBreakStatement, NewCaseBlock, NewCatchClause, NewClassStaticBlockDeclaration, NewConstructorDeclaration, NewContinueStatement, NewDebuggerStatement, NewDoStatement, NewEmptyStatement, NewEnumDeclaration, NewExportAssignment, NewExportDeclaration, NewExportSpecifier, NewExternalModuleReference, NewForInOrOfStatement, NewForStatement, NewFunctionDeclaration, NewGetAccessorDeclaration, NewIfStatement, NewImportAttribute, NewImportAttributes, NewImportClause, NewImportDeclaration, NewImportEqualsDeclaration, NewImportSpecifier, NewIndexSignatureDeclaration, NewInterfaceDeclaration, NewMethodDeclaration, NewMissingDeclaration, NewModuleBlock, NewModuleDeclaration, NewNamedExports, NewNamedImports, NewNamespaceExport, NewNamespaceExportDeclaration, NewNamespaceImport, NewPropertyDeclaration, NewReturnStatement, NewSemicolonClassElement, NewSetAccessorDeclaration, NewSwitchStatement, NewThrowStatement, NewTryStatement, NewVariableDeclaration, NewVariableDeclarationList, NewVariableStatement, NewWhileStatement, NewWithStatement, } from "../../ast/generated/factory.js";
...
import { SourceFile_SetDiagnostics, SourceFile_SetJSDocDiagnostics, SourceFile_SetJSDiagnostics, SourceFile_SetJSDocCache, SourceFile_SetHasLazyJSDoc, NodeFactory_NewModifier, NodeFactory_NewSourceFile, AsSourceFile, Node_Text, } from "../../ast/ast.js";
...
import { SkipTrivia, TokenToString, Scanner_Scan, Scanner_HasPrecedingLineBreak, Scanner_TokenStart, Scanner_TokenValue, Scanner_SetSkipJSDocLeadingAsterisks, Scanner_HasPrecedingJSDocLeadingAsterisks, Scanner_TokenFullStart, Scanner_TokenText, Scanner_CommentDirectives, Scanner_ContainsNonASCII, } from "../../scanner/scanner.js";
import { tokenIsIdentifierOrKeyword } from "../utilities.js";
import { ParseFlagsNone, ParseFlagsYield, ParseFlagsAwait, ParseFlagsType, ParseFlagsIgnoreMissingOpenBrace, } from "../types.js";
import { Parser_withJSDoc } from "../jsdoc.js";
import { PCBlockStatements, PCClassMembers, PCEnumMembers, PCImportAttributes, PCImportOrExportSpecifiers, PCParameters, PCSourceElements, PCSwitchClauses, PCVariableDeclarations, viableKeywordSuggestions, } from "./state.js";
import { Parser_canParseSemicolon, Parser_finishNode, Parser_initializeState, Parser_isIndexSignature, Parser_isJavaScript, Parser_lookAhead, Parser_nodePos, Parser_parseCaseOrDefaultClause, Parser_parseEntityName, Parser_parseInitializer, Parser_parseJSONText, Parser_parseModifiersEx, Parser_parseOptional, Parser_parseParameter, Parser_parsePropertyName, Parser_parseSemicolonAfterPropertyName, Parser_parseSemicolon, Parser_checkJSSyntax, Parser_tryParseSemicolon, Parser_mark, Parser_rewind, Parser_canFollowModifier, Parser_overrideParentInImmediateChildren, getCommentPragmas, getParser, getSpaceSuggestion, isDeclareModifier, isReservedWord, Parser_processPragmasIntoFields, putParser, } from "./support.js";
import { Parser_parseAssignmentExpressionOrHigher, Parser_parseExpression, Parser_parseExpressionAllowIn, Parser_parseExpressionOrLabeledStatement, Parser_parseLiteralExpression, Parser_isAwaitUsingDeclaration, Parser_nextIsUsingKeywordThenBindingIdentifierOrStartOfObjectDestructuringOnSameLine, Parser_nextTokenIsIdentifierOrStringLiteralOnSameLine, Parser_parseClassDeclarationOrExpression, Parser_parseArrayBindingPattern, Parser_parseObjectBindingPattern, Parser_parseEnumMember, Parser_isStartOfExpression, Parser_nextTokenIsTokenStringLiteral, Parser_reparseTopLevelAwait, } from "./expressions.js";
import { Parser_createMissingIdentifier, Parser_isBindingIdentifier, Parser_isIdentifier, Parser_parseContextualModifier, Parser_parseErrorAtCurrentToken, Parser_parseExpected, Parser_parseExpectedMatchingBrackets, Parser_parseExpectedToken, Parser_parseOptionalToken, Parser_parseTokenNode, Parser_nextToken, doInContext, Parser_nextTokenIsBindingIdentifierOrStartOfDestructuring, Parser_nextTokenIsBindingIdentifierOrStartOfDestructuringOnSameLineDisallowOf, Parser_nextIsIdentifierAndCloseParen, Parser_nextTokenIsOpenBrace, Parser_nextTokenIsOpenParen, Parser_nextTokenIsIdentifierOrKeywordOnSameLine, Parser_nextTokenIsIdentifierOnSameLine, Parser_nextTokenIsBindingIdentifierOrStartOfDestructuringOnSameLine, Parser_parseBindingIdentifier, Parser_parseIdentifier, Parser_parseIdentifierName, Parser_parsePrivateIdentifier, Parser_parseIdentifierNameErrorOnUnicodeEscapeSequence, Parser_newIdentifier, Parser_internIdentifier, Parser_createIdentifier, Parser_jsdocScannerInfo, Parser_skipRangeTrivia, Parser_setContextFlags, Parser_parseIdentifierUnlessAtSemicolon, Parser_nextTokenIsFromKeywordOrEqualsToken, } from "./tokens-speculation.js";
import { Parser_parseErrorAt, attachFileToDiagnostics, Parser_parseErrorAtRange } from "./errors-recovery.js";
import { Parser_parseList, Parser_parseListIndex, Parser_parseDelimitedList, Parser_parseBracketedList, Parser_parseParameters, Parser_createMissingList, Parser_parseEmptyNodeList, modifierListHasAsync, Parser_newModifierList, Parser_newNodeList, } from "./lists.js";
import { Parser_parseTypeParameters, Parser_parseTypeAnnotation, Parser_parseReturnType, Parser_parseTypeMemberSemicolon, Parser_parseHeritageClauses, Parser_parseObjectTypeMembers, Parser_parseTypeAliasDeclaration, } from "./types.js";
 ...
 * }
 */
export function ParseSourceFile(opts, sourceText, scriptKind) {
    const p = getParser();
    try {
 ...
 * }
 */
export function getErrorSpanForNode(sourceText, node) {
 ...
 * }
 */
export function isDoubleQuotedString(node) {
 ...
 * }
 */
export function Parser_nextTokenWithoutCheck(receiver) {
 ...
 * }
 */
export function Parser_hasPrecedingLineBreak(receiver) {
 ...
 * }
 */
export function Parser_parseSourceFileWorker(receiver) {
    ...
    const eof = Parser_parseTokenNode(receiver);
 ...
 * }
 */
export function Parser_finishSourceFile(receiver, result, isDeclarationFile) {
    ...
    SourceFile_SetJSDocCache(result, Parser_createJSDocCache(receiver));
    // For non-JS files, enable lazy JSDoc parsing on demand
 ...
 * }
 */
export function Parser_parseToplevelStatement(receiver, i) {
 ...
 * }
 */
export function Parser_parseExpectedWithoutAdvancing(receiver, kind) {
 ...
 * }
 */
export function Parser_parseExpectedWithDiagnostic(receiver, kind, message, shouldAdvance) {
 ...
 * }
 */
export function Parser_parseStatement(receiver) {
 ...
 * }
 */
export function Parser_parseDeclaration(receiver) {
    // `parseListElement` attempted to get the reused node at this position,
    // but the ambient context flag was not yet set, so the node appeared
    // not reusable in that context.
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseDeclarationWorker(receiver, pos, jsdoc, modifiers) {
    switch (receiver.token) {
        case KindVarKeyword:
        case KindLetKeyword:
        case KindConstKeyword:
 ...
 * }
 */
export function Parser_isLetDeclaration(receiver) {
    // In ES6 'let' always starts a lexical declaration if followed by an identifier or {
    // or [.
 ...
 * }
 */
export function Parser_parseBlock(receiver, ignoreMissingOpenBrace, diagnosticMessage) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseEmptyStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseIfStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
    ...
    const elseStatement = Parser_parseOptional(receiver, KindElseKeyword) ? Parser_parseStatement(receiver) : undefined;
 ...
 * }
 */
export function Parser_parseDoStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseWhileStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
    Parser_parseExpected(receiver, KindWhileKeyword);
    const openParenPosition = Scanner_TokenStart(receiver.scanner);
 ...
 * }
 */
export function Parser_parseForOrForInOrForOfStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
    ...
    const initializer = receiver.token !== KindSemicolonToken
    ...
    const result = (() => {
        if ((awaitToken !== undefined && Parser_parseExpected(receiver, KindOfKeyword)) || (awaitToken === undefined && Parser_parseOptional(receiver, KindOfKeyword))) {
            ...
            Parser_parseExpected(receiver, KindSemicolonToken);
            const condition = receiver.token !== KindSemicolonToken && receiver.token !== KindCloseParenToken ? Parser_parseExpressionAllowIn(receiver) : undefined;
            Parser_parseExpected(receiver, KindSemicolonToken);
            const incrementor = receiver.token !== KindCloseParenToken ? Parser_parseExpressionAllowIn(receiver) : undefined;
            Parser_parseExpected(receiver, KindCloseParenToken);
 ...
 * }
 */
export function Parser_parseBreakStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseContinueStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseReturnStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
    Parser_parseExpected(receiver, KindReturnKeyword);
    const expression = !Parser_canParseSemicolon(receiver) ? Parser_parseExpressionAllowIn(receiver) : undefined;
    Parser_parseSemicolon(receiver);
 ...
 * }
 */
export function Parser_parseWithStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseCaseBlock(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseSwitchStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseThrowStatement(receiver) {
    // ThrowStatement[Yield] :
    //      throw [no LineTerminator here]Expression[In, ?Yield];
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
    ...
    // Instead, we create a "missing" identifier, but don't report an error. The actual error
    // will be reported in the grammar walker.
    const expression = !Parser_hasPrecedingLineBreak(receiver) ? Parser_parseExpressionAllowIn(receiver) : Parser_createMissingIdentifier(receiver);
 ...
 * }
 */
export function Parser_parseTryStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
    ...
    const catchClause = receiver.token === KindCatchKeyword ? Parser_parseCatchClause(receiver) : undefined;
    // If we don't have a catch clause, then we must have a finally clause.  Try to parse
    // one out no matter what.
    const finallyBlock = (() => {
 ...
 * }
 */
export function Parser_parseCatchClause(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseDebuggerStatement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseVariableStatement(receiver, pos, jsdoc, modifiers) {
 ...
 * }
 */
export function Parser_parseVariableDeclarationList(receiver, inForStatementInitializer) {
    const pos = Parser_nodePos(receiver);
    const flags = (() => {
        switch (receiver.token) {
            case KindVarKeyword:
 ...
 * }
 */
export function Parser_parseVariableDeclaration(receiver) {
 ...
 * }
 */
export function Parser_parseVariableDeclarationAllowExclamation(receiver) {
 ...
 * }
 */
export function Parser_parseVariableDeclarationWorker(receiver, allowExclamation) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
    ...
    const exclamationToken = allowExclamation && name.Kind === KindIdentifier && receiver.token === KindExclamationToken && !Parser_hasPrecedingLineBreak(receiver)
        ? Parser_parseTokenNode(receiver)
        : undefined;
    const typeNode = Parser_parseTypeAnnotation(receiver);
    const initializer = receiver.token !== KindInKeyword && receiver.token !== KindOfKeyword ? Parser_parseInitializer(receiver) : undefined;
 ...
 * }
 */
export function Parser_parseIdentifierOrPatternWithDiagnostic(receiver, privateIdentifierDiagnosticMessage) {
 ...
 * }
 */
export function Parser_parseFunctionDeclaration(receiver, pos, jsdoc, modifiers) {
    ...
    // We don't parse the name here in await context, instead we will report a grammar error in the checker.
    const name = modifiers === undefined || (modifiers.ModifierFlags & ModifierFlagsDefault) === 0 || Parser_isBindingIdentifier(receiver) ? Parser_parseBindingIdentifier(receiver) : undefined;
    const signatureFlags = IfElse(asteriskToken !== undefined, ParseFlagsYield, ParseFlagsNone) |
 ...
 * }
 */
export function Parser_parseClassDeclaration(receiver, pos, jsdoc, modifiers) {
 ...
 * }
 */
export function isExportModifier(modifier) {
 ...
 * }
 */
export function Parser_parseClassElement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseClassStaticBlockDeclaration(receiver, pos, jsdoc, modifiers) {
 ...
 * }
 */
export function Parser_parseClassStaticBlockBody(receiver) {
    const saveContextFlags = receiver.contextFlags;
 ...
 * }
 */
export function Parser_tryParseConstructorDeclaration(receiver, pos, jsdoc, modifiers) {
 ...
 * }
 */
export function Parser_parsePropertyOrMethodDeclaration(receiver, pos, jsdoc, modifiers) {
    const asteriskToken = Parser_parseOptionalToken(receiver, KindAsteriskToken);
 ...
 * }
 */
export function Parser_parseMethodDeclaration(receiver, pos, jsdoc, modifiers, asteriskToken, name, questionToken, diagnosticMessage) {
 ...
 * }
 */
export function Parser_parsePropertyDeclaration(receiver, pos, jsdoc, modifiers, name, questionToken) {
    const postfixToken = questionToken === undefined && !Parser_hasPrecedingLineBreak(receiver) ? Parser_parseOptionalToken(receiver, KindExclamationToken) : questionToken;
    const typeNode = Parser_parseTypeAnnotation(receiver);
 ...
 * }
 */
export function Parser_parseErrorForMissingSemicolonAfter(receiver, node) {
    // Tagged template literals are sometimes used in places where only simple strings are allowed, i.e.:
    //   module `M1` {
    //   ^^^^^^^^^^^ This block is parsed as a template literal like module`M1`.
    ...
    // The user alternatively might have misspelled or forgotten to add a space after a common keyword.
    let suggestion = GetSpellingSuggestionForStrings(expressionText, Values(viableKeywordSuggestions));
    if (suggestion === "") {
        suggestion = getSpaceSuggestion(expressionText);
    }
    if (suggestion !== "") {
 ...
 * }
 */
export function Parser_parseErrorForInvalidName(receiver, nameDiagnostic, blankDiagnostic, tokenIfBlankName) {
 ...
 * }
 */
export function Parser_parseInterfaceDeclaration(receiver, pos, jsdoc, modifiers) {
 ...
 * }
 */
export function Parser_nextIsNotDot(receiver) {
 ...
 * }
 */
export function Parser_parseEnumDeclaration(receiver, pos, jsdoc, modifiers) {
 ...
 * }
 */
export function Parser_parseModuleDeclaration(receiver, pos, jsdoc, modifiers) {
 ...
 * }
 */
export function Parser_parseAmbientExternalModuleDeclaration(receiver, pos, jsdoc, modifiers) {
    const saveHasAwaitIdentifier = receiver.statementHasAwaitIdentifier;
    const [name, keyword] = receiver.token === KindGlobalKeyword
        ? // parse 'global' as name of global scope augmentation
 ...
 * }
 */
export function Parser_parseModuleBlock(receiver) {
    const pos = Parser_nodePos(receiver);
    const statements = (() => {
        if (Parser_parseExpected(receiver, KindOpenBraceToken)) {
 ...
 * }
 */
export function Parser_parseModuleOrNamespaceDeclaration(receiver, pos, jsdoc, modifiers, nested, keyword) {
    const saveHasAwaitIdentifier = receiver.statementHasAwaitIdentifier;
    ...
    if (Parser_parseOptional(receiver, KindDotToken)) {
        ...
        const implicitModifiers = Parser_newModifierList(receiver, implicitExport.Loc, Arena_NewSlice1(receiver.nodeSliceArena, implicitExport));
        body = Parser_parseModuleOrNamespaceDeclaration(receiver, Parser_nodePos(receiver), 0, implicitModifiers, true, keyword);
    }
    else {
 ...
 * }
 */
export function Parser_parseImportDeclarationOrImportEqualsDeclaration(receiver, pos, jsdoc, modifiers) {
    ...
    if (identifier !== undefined && Node_Text(identifier) === "type" &&
        ...
        let shouldParseAsDeferModifier;
    ...
    Parser_parseSemicolon(receiver);
    const result = Parser_finishNode(receiver, NewImportDeclaration(receiver.factory, modifiers, importClause, moduleSpecifier, attributes), pos);
    Parser_withJSDoc(receiver, result, jsdoc);
    Parser_checkJSSyntax(receiver, result);
    return result;
}
 ...
 * }
 */
export function Parser_tokenAfterImportDefinitelyProducesImportDeclaration(receiver) {
 ...
 * }
 */
export function Parser_tokenAfterImportedIdentifierDefinitelyProducesImportDeclaration(receiver) {
    // In `import id ___`, the current token decides whether to produce
    // an ImportDeclaration or ImportEqualsDeclaration.
 ...
 * }
 */
export function Parser_parseImportEqualsDeclaration(receiver, pos, jsdoc, modifiers, identifier, isTypeOnly) {
 ...
 * }
 */
export function Parser_parseModuleReference(receiver) {
 ...
 * }
 */
export function Parser_parseExternalModuleReference(receiver) {
    const saveHasAwaitIdentifier = receiver.statementHasAwaitIdentifier;
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseModuleSpecifier(receiver) {
    if (receiver.token === KindStringLiteral) {
 ...
 * }
 */
export function Parser_tryParseImportClause(receiver, identifier, pos, phaseModifier, skipJSDocLeadingAsterisks) {
    // ImportDeclaration:
    //  import ImportClause from ModuleSpecifier ;
    //  import ModuleSpecifier;
 ...
 * }
 */
export function Parser_parseImportClause(receiver, identifier, pos, phaseModifier, skipJSDocLeadingAsterisks) {
    // ImportClause:
    //  ImportedDefaultBinding
    //  NameSpaceImport
    //  NamedImports
 ...
 * }
 */
export function Parser_parseNamespaceImport(receiver) {
    // NameSpaceImport:
    //  * as ImportedBinding
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseNamedImports(receiver) {
    const pos = Parser_nodePos(receiver);
    // NamedImports:
    //  { }
    //  { ImportsList }
 ...
 * }
 */
export function Parser_parseImportSpecifier(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseImportOrExportSpecifier(receiver, kind) {
 ...
 * }
 */
export function Parser_canParseModuleExportName(receiver) {
 ...
 * }
 */
export function Parser_parseModuleExportName(receiver, disallowKeywords) {
    let nameOk = true;
    if (receiver.token === KindStringLiteral) {
 ...
 * }
 */
export function Parser_tryParseImportAttributes(receiver) {
 ...
 * }
 */
export function Parser_parseExportAssignment(receiver, pos, jsdoc, modifiers) {
    const saveContextFlags = receiver.contextFlags;
    const saveHasAwaitIdentifier = receiver.statementHasAwaitIdentifier;
    Parser_setContextFlags(receiver, NodeFlagsAwaitContext, true);
 ...
 * }
 */
export function Parser_parseNamespaceExportDeclaration(receiver, pos, jsdoc, modifiers) {
    Parser_parseExpected(receiver, KindAsKeyword);
 ...
 * }
 */
export function Parser_parseExportDeclaration(receiver, pos, jsdoc, modifiers) {
    const saveContextFlags = receiver.contextFlags;
    const saveHasAwaitIdentifier = receiver.statementHasAwaitIdentifier;
    Parser_setContextFlags(receiver, NodeFlagsAwaitContext, true);
    const isTypeOnly = Parser_parseOptional(receiver, KindTypeKeyword);
    const namespaceExportPos = Parser_nodePos(receiver);
    const clauseAndSpecifier = (() => {
        if (Parser_parseOptional(receiver, KindAsteriskToken)) {
            const ec = Parser_parseOptional(receiver, KindAsKeyword) ? Parser_parseNamespaceExport(receiver, namespaceExportPos) : undefined;
            Parser_parseExpected(receiver, KindFromKeyword);
 ...
 * }
 */
export function Parser_parseNamespaceExport(receiver, pos) {
 ...
 * }
 */
export function Parser_parseNamedExports(receiver) {
    const pos = Parser_nodePos(receiver);
    // NamedImports:
    //  { }
    //  { ImportsList }
 ...
 * }
 */
export function Parser_parseExportSpecifier(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseRightSideOfDot(receiver, allowIdentifierNames, allowPrivateIdentifiers, allowUnicodeEscapeSequenceInIdentifierName) {
    // Technically a keyword is valid here as all identifiers and keywords are identifier names.
    // However, often we'll encounter this in error situations when the identifier or keyword
    // is actually starting another valid construct.
    //
 ...
 * }
 */
export function Parser_parseImportAttribute(receiver) {
    const pos = Parser_nodePos(receiver);
    const name = tokenIsIdentifierOrKeyword(receiver.token)
 ...
 * }
 */
export function Parser_parseImportAttributes(receiver, token, skipKeyword) {
    const pos = Parser_nodePos(receiver);
    if (!skipKeyword) {
 ...
 * }
 */
export function Parser_parseAccessorDeclaration(receiver, pos, jsdoc, modifiers, kind, flags) {
    const name = Parser_parsePropertyName(receiver);
    const typeParameters = Parser_parseTypeParameters(receiver);
    const parameters = Parser_parseParameters(receiver, ParseFlagsNone);
    const returnType = Parser_parseReturnType(receiver, KindColonToken, false /*isType*/);
    ...
    // Keep track of `typeParameters` (for both) and `type` (for setters) if they were parsed those indicate grammar errors
    const result = kind === KindGetAccessor
 ...
 * }
 */
export function Parser_parseFunctionBlockOrSemicolon(receiver, flags, diagnosticMessage) {
    if (receiver.token !== KindOpenBraceToken) {
        if ((flags & ParseFlagsType) !== 0) {
 ...
 * }
 */
export function Parser_parseFunctionBlock(receiver, flags, diagnosticMessage) {
    const saveContextFlags = receiver.contextFlags;
    const saveHasAwaitIdentifier = receiver.statementHasAwaitIdentifier;
 ...
 * }
 */
export function Parser_parseIndexSignatureDeclaration(receiver, pos, jsdoc, modifiers) {
 ...
 * }
 */
export function Parser_nextTokenIsClassKeywordOnSameLine(receiver) {
 ...
 * }
 */
export function Parser_nextTokenIsFunctionKeywordOnSameLine(receiver) {
 ...
 * }
 */
export function Parser_nextTokenCanFollowExportModifier(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_canFollowExportModifier(receiver) {
    return (receiver.token === KindAtToken ||
 ...
 * }
 */
export function Parser_nextTokenIsDot(receiver) {
    return Parser_nextToken(receiver) === KindDotToken;
}
/**
 ...
 * }
 */
export function Parser_parseBindingIdentifierWithDiagnostic(receiver, privateIdentifierDiagnosticMessage) {
    const saveHasAwaitIdentifier = receiver.statementHasAwaitIdentifier;
 ...
 * }
 */
export function Parser_parseIdentifierNameWithDiagnostic(receiver, diagnosticMessage) {
 ...
 * }
 */
export function Parser_parseIdentifierWithDiagnostic(receiver, diagnosticMessage, privateIdentifierDiagnosticMessage) {
 ...
 * }
 */
export function Parser_createIdentifierWithDiagnostic(receiver, isIdentifier, diagnosticMessage, privateIdentifierDiagnosticMessage) {
    if (isIdentifier) {
 ...
 * }
 */
export function Parser_finishNodeWithEnd(receiver, node, pos, end) {
 ...
 * }
 */
export function Parser_isStartOfStatement(receiver) {
    switch (receiver.token) {
        // 'catch' and 'finally' do not actually indicate that the code is part of a statement,
        // however, we say they are here so that we may gracefully parse them and error later.
        case KindAtToken:
 ...
 * }
 */
export function Parser_isStartOfDeclaration(receiver) {
 ...
 * }
 */
export function Parser_scanStartOfDeclaration(receiver) {
    while (true) {
        switch (receiver.token) {
            case KindVarKeyword:
            case KindLetKeyword:
            ...
            case KindImportKeyword:
                Parser_nextToken(receiver);
                return (receiver.token === KindDeferKeyword ||
                    receiver.token === KindStringLiteral ||
                    receiver.token === KindAsteriskToken ||
 ...
 * }
 */
export function Parser_isNextTokenOpenParenOrLessThanOrDot(receiver) {
 ...
 * }
 */
export function Parser_nextTokenIsOpenParenOrLessThanOrDot(receiver) {
 ...
 * }
 */
export function Parser_isImportAttributeName(receiver) {
    return tokenIsIdentifierOrKeyword(receiver.token) || receiver.token === KindStringLiteral;
}
/**
 ...
 * }
 */
export function Parser_isUsingDeclaration(receiver) {
    // 'using' always starts a lexical declaration if followed by an identifier. We also eagerly parse
    // |ObjectBindingPattern| so that we can report a grammar error during check. We don't parse out
    // |ArrayBindingPattern| since it potentially conflicts with element access (i.e., `using[x]`).
    return Parser_lookAhead(receiver, (p) => {
        return Parser_nextTokenIsBindingIdentifierOrStartOfDestructuringOnSameLine(p, /*disallowOf*/ false);
    });
}
//# sourceMappingURL=statements-declarations.js.map