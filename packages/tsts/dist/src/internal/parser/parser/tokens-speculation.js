...
import { KindAbstractKeyword, KindAsyncKeyword, KindAtToken, KindAwaitKeyword, KindClassKeyword, KindCloseParenToken, KindColonToken, KindConstKeyword, KindDefaultKeyword, KindEnumKeyword, KindEqualsToken, KindExportKeyword, KindFromKeyword, KindFunctionKeyword, KindGetKeyword, KindIdentifier, KindInterfaceKeyword, KindLastReservedWord, KindLessThanToken, KindOfKeyword, KindOpenBraceToken, KindOpenBracketToken, KindOpenParenToken, KindPrivateIdentifier, KindQuestionToken, KindSemicolonToken, KindSetKeyword, KindSlashToken, KindStaticKeyword, KindTypeKeyword, KindYieldKeyword, } from "../../ast/generated/kinds.js";
...
import { An_enum_member_name_must_be_followed_by_a_or, Array_element_destructuring_pattern_expected, Argument_expression_expected, Declaration_or_statement_expected, Enum_member_expected, Expression_expected, Expression_or_comma_expected, Identifier_expected, Identifier_or_string_literal_expected, Keywords_cannot_contain_escape_characters, Parameter_declaration_expected, Property_assignment_expected, Property_destructuring_pattern_expected, Property_or_signature_expected, Statement_expected, The_parser_expected_to_find_a_1_to_match_the_0_token_here, Type_argument_expected, Type_expected, Type_parameter_declaration_expected, Unexpected_token_A_constructor_method_accessor_or_property_was_expected, Unexpected_token_expected, Unicode_escape_sequence_cannot_appear_here, Variable_declaration_expected, X_0_expected, X_0_is_not_allowed_as_a_parameter_name, X_0_is_not_allowed_as_a_variable_declaration_name, X_case_or_default_expected, } from "../../diagnostics/generated/messages.js";
...
import { jsdocScannerInfoHasDeprecated, jsdocScannerInfoHasJSDoc, jsdocScannerInfoHasSeeOrLink, PCArgumentExpressions, PCArrayBindingElements, PCArrayLiteralMembers, PCBlockStatements, PCClassMembers, PCCount, PCEnumMembers, PCHeritageClauseElement, PCHeritageClauses, PCImportAttributes, PCImportOrExportSpecifiers, PCJSDocComment, PCJSDocParameters, PCJsxAttributes, PCJsxChildren, PCObjectBindingElements, PCObjectLiteralMembers, PCParameters, PCRestProperties, PCSourceElements, PCSwitchClauseStatements, PCSwitchClauses, PCTupleElementTypes, PCTypeArguments, PCTypeMembers, PCTypeParameters, PCVariableDeclarations, } from "./state.js";
/**
 ...
 * }
 */
export function Parser_parseErrorAtCurrentToken(receiver, message, ...args) {
 ...
 * }
 */
export function Parser_nextToken(receiver) {
    // if the keyword had an escape
 ...
 * }
 */
export function Parser_jsdocScannerInfo(receiver) {
    if (!Scanner_HasPrecedingJSDocComment(receiver.scanner)) {
        return 0;
    }
    const info0 = jsdocScannerInfoHasJSDoc;
    const info1 = Scanner_HasPrecedingJSDocWithDeprecatedTag(receiver.scanner) ? (info0 | jsdocScannerInfoHasDeprecated) : info0;
    const info2 = Scanner_HasPrecedingJSDocWithSeeOrLink(receiver.scanner) ? (info1 | jsdocScannerInfoHasSeeOrLink) : info1;
    return info2;
}
/**
 ...
 * }
 */
export function Parser_isInSomeParsingContext(receiver) {
    // We should be in at least one parsing context, be it SourceElements while parsing
    // a SourceFile, or JSDocComment when lazily parsing JSDoc.
    debug.Assert((receiver.parsingContexts !== 0), "Missing parsing context");
    for (let kind = 0; kind < PCCount; kind++) {
        if ((receiver.parsingContexts & (1 << kind)) !== 0) {
            if (Parser_isListElement(receiver, kind, true) || Parser_isListTerminator(receiver, kind)) {
                return true;
            }
        }
    }
 ...
 * }
 */
export function Parser_parsingContextErrors(receiver, context) {
    switch (context) {
        case PCSourceElements:
 ...
 * }
 */
export function Parser_parseExpectedMatchingBrackets(receiver, openKind, closeKind, openParsed, openPosition) {
 ...
 * }
 */
export function Parser_parseExpected(receiver, kind) {
    return Parser_parseExpectedWithDiagnostic(receiver, kind, undefined, true);
}
/**
 ...
 * }
 */
export function Parser_parseTokenNode(receiver) {
 ...
 * }
 */
export function Parser_parseExpectedToken(receiver, kind) {
 ...
 * }
 */
export function Parser_parseOptionalToken(receiver, kind) {
 ...
 * }
 */
export function Parser_nextTokenIsBindingIdentifierOrStartOfDestructuring(receiver) {
    Parser_nextToken(receiver);
    return (Parser_isBindingIdentifier(receiver) || receiver.token === KindOpenBraceToken || receiver.token === KindOpenBracketToken);
}
/**
 ...
 * }
 */
export function Parser_parseIdentifierUnlessAtSemicolon(receiver) {
 ...
 * }
 */
export function Parser_nextIsIdentifierAndCloseParen(receiver) {
    return (Parser_nextTokenIsIdentifier(receiver) && Parser_nextToken(receiver) === KindCloseParenToken);
}
/**
 ...
 * }
 */
export function Parser_nextTokenIsIdentifier(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parseIdentifierOrPattern(receiver) {
 ...
 * }
 */
export function Parser_nextTokenIsOpenParen(receiver) {
    return (Parser_nextToken(receiver) === KindOpenParenToken);
}
/**
 ...
 * }
 */
export function Parser_nextTokenIsFromKeywordOrEqualsToken(receiver) {
    Parser_nextToken(receiver);
    return (receiver.token === KindFromKeyword || receiver.token === KindEqualsToken);
}
/**
 ...
 * }
 */
export function Parser_newIdentifier(receiver, text) {
    receiver.identifierCount = (receiver.identifierCount + 1);
    const id = NewIdentifier(receiver.factory, text);
    if (text === "await") {
        receiver.statementHasAwaitIdentifier = true;
    }
    return id;
}
/**
 ...
 * }
 */
export function Parser_createMissingIdentifier(receiver) {
 ...
 * }
 */
export function Parser_parsePrivateIdentifier(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_reScanLessThanToken(receiver) {
 ...
 * }
 */
export function Parser_reScanGreaterThanToken(receiver) {
 ...
 * }
 */
export function Parser_reScanSlashToken(receiver) {
 ...
 * }
 */
export function Parser_nextTokenIsOpenParenOrLessThan(receiver) {
    Parser_nextToken(receiver);
    return (receiver.token === KindOpenParenToken || receiver.token === KindLessThanToken);
}
/**
 ...
 * }
 */
export function Parser_nextTokenIsColonOrQuestionColon(receiver) {
    return (Parser_nextToken(receiver) === KindColonToken || (receiver.token === KindQuestionToken && Parser_nextToken(receiver) === KindColonToken));
}
/**
 ...
 * }
 */
export function Parser_parseContextualModifier(receiver, t) {
 ...
 * }
 */
export function Parser_parseAnyContextualModifier(receiver) {
    const state = Parser_mark(receiver);
 ...
 * }
 */
export function Parser_nextTokenCanFollowModifier(receiver) {
    switch (receiver.token) {
        case KindConstKeyword:
            // 'const' is only a modifier if followed by 'enum'.
            return (Parser_nextToken(receiver) === KindEnumKeyword);
 ...
 * }
 */
export function Parser_nextTokenCanFollowDefaultKeyword(receiver) {
 ...
 * }
 */
export function Parser_nextTokenIsIdentifierOrKeyword(receiver) {
 ...
 * }
 */
export function Parser_nextTokenIsIdentifierOrKeywordOrGreaterThan(receiver) {
 ...
 * }
 */
export function Parser_nextTokenIsIdentifierOrKeywordOnSameLine(receiver) {
    return (Parser_nextTokenIsIdentifierOrKeyword(receiver) && !Parser_hasPrecedingLineBreak(receiver));
}
/**
 ...
 * }
 */
export function Parser_canFollowGetOrSetKeyword(receiver) {
 ...
 * }
 */
export function Parser_nextTokenIsOnSameLineAndCanFollowModifier(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_nextTokenIsOpenBrace(receiver) {
    return (Parser_nextToken(receiver) === KindOpenBraceToken);
}
/**
 ...
 * }
 */
export function Parser_parseOptionalBindingIdentifier(receiver) {
 ...
 * }
 */
export function Parser_parseIdentifierNameErrorOnUnicodeEscapeSequence(receiver) {
 ...
 * }
 */
export function Parser_parseBindingIdentifier(receiver) {
 ...
 * }
 */
export function Parser_parseIdentifierName(receiver) {
 ...
 * }
 */
export function Parser_parseIdentifier(receiver) {
 ...
 * }
 */
export function Parser_createIdentifier(receiver, isIdentifier) {
 ...
 * }
 */
export function Parser_internIdentifier(receiver, text) {
    ...
    if (receiver.identifiers === undefined) {
        receiver.identifiers = new globalThis.Map();
    }
 ...
 * }
 */
export function Parser_nextTokenIsSlash(receiver) {
    return (Parser_nextToken(receiver) === KindSlashToken);
}
/**
 ...
 * }
 */
export function Parser_isBindingIdentifierOrPrivateIdentifierOrPattern(receiver) {
    return (receiver.token === KindOpenBraceToken || receiver.token === KindOpenBracketToken || receiver.token === KindPrivateIdentifier || Parser_isBindingIdentifier(receiver));
}
/**
 ...
 * }
 */
export function Parser_nextTokenIsIdentifierOnSameLine(receiver) {
    Parser_nextToken(receiver);
    return (Parser_isIdentifier(receiver) && !Parser_hasPrecedingLineBreak(receiver));
}
/**
 ...
 * }
 */
export function Parser_isIdentifier(receiver) {
    ...
    return (receiver.token > KindLastReservedWord);
}
/**
 ...
 * }
 */
export function Parser_isBindingIdentifier(receiver) {
    // `let await`/`let yield` in [Yield] or [Await] are allowed here and disallowed in the binder.
    return (receiver.token === KindIdentifier || receiver.token > KindLastReservedWord);
}
/**
 ...
 * }
 */
export function Parser_nextTokenIsEqualsOrSemicolonOrColonToken(receiver) {
    Parser_nextToken(receiver);
    return (receiver.token === KindEqualsToken || receiver.token === KindSemicolonToken || receiver.token === KindColonToken);
}
/**
 ...
 * }
 */
export function Parser_nextTokenIsBindingIdentifierOrStartOfDestructuringOnSameLine(receiver, disallowOf) {
    Parser_nextToken(receiver);
    ...
    return (Parser_isBindingIdentifier(receiver) || (receiver.token === KindOpenBraceToken && !Parser_hasPrecedingLineBreak(receiver)));
}
/**
 ...
 * }
 */
export function Parser_nextTokenIsBindingIdentifierOrStartOfDestructuringOnSameLineDisallowOf(receiver) {
    return Parser_nextTokenIsBindingIdentifierOrStartOfDestructuringOnSameLine(receiver, /*disallowOf*/ true);
}
/**
 ...
 * }
 */
export function Parser_setContextFlags(receiver, flags, value) {
    if (value) {
        receiver.contextFlags = (receiver.contextFlags | flags);
    }
    else {
        receiver.contextFlags = (receiver.contextFlags & ~flags);
    }
 ...
 * }
 */
export function doInContext(p, flags, value, f) {
 ...
 * }
 */
export function Parser_inDisallowInContext(receiver) {
    return ((receiver.contextFlags & NodeFlagsDisallowInContext) !== 0);
}
/**
 ...
 * }
 */
export function Parser_inDecoratorContext(receiver) {
    return ((receiver.contextFlags & NodeFlagsDecoratorContext) !== 0);
}
/**
 ...
 * }
 */
export function Parser_skipRangeTrivia(receiver, textRange) {
    return NewTextRange(SkipTrivia(receiver.sourceText, TextRange_Pos(textRange)), TextRange_End(textRange));
}
//# sourceMappingURL=tokens-speculation.js.map