...
import { NewArrayLiteralExpression, NewCaseOrDefaultClause, NewComputedPropertyName, NewDecorator, NewExpressionStatement, NewMethodSignatureDeclaration, NewParameterDeclaration, NewPropertySignatureDeclaration, NewQualifiedName, } from "../../ast/generated/factory.js";
import { KindAsyncKeyword, KindAsteriskToken, KindAtToken, KindBigIntLiteral, KindCaseClause, KindCaseKeyword, KindCloseBraceToken, KindCloseBracketToken, KindColonToken, KindCommaToken, KindConstKeyword, KindDeclareKeyword, KindDefaultClause, KindDefaultKeyword, KindDotDotDotToken, KindDotToken, KindEndOfFile, KindEqualsToken, KindFirstReservedWord, KindImplementsKeyword, KindLastReservedWord, KindLessThanToken, KindNumericLiteral, KindOpenBraceToken, KindOpenBracketToken, KindOpenParenToken, KindPrivateIdentifier, KindQuestionToken, KindSemicolonToken, KindStaticKeyword, KindStringLiteral, KindThisKeyword, KindUnknown, } from "../../ast/generated/kinds.js";
...
import { Cannot_start_a_function_call_in_a_type_annotation, Decorator_used_before_export_here, Decorators_are_not_valid_here, Decorators_may_not_appear_after_export_or_export_default_if_they_also_appear_before_export, Decorators_must_precede_the_name_and_all_keywords_of_property_declarations, Expected_for_property_initializer, Invalid_reference_directive_syntax, Neither_decorators_nor_modifiers_may_be_applied_to_this_parameters, Non_null_assertions_can_only_be_used_in_TypeScript_files, Parameter_modifiers_can_only_be_used_in_TypeScript_files, Private_identifiers_cannot_be_used_as_parameters, Property_assignment_expected, Property_value_can_only_be_string_literal_numeric_literal_true_false_null_object_literal_or_array_literal, Signature_declarations_can_only_be_used_in_TypeScript_files, String_literal_with_double_quotes_expected, The_0_modifier_can_only_be_used_in_TypeScript_files, Type_aliases_can_only_be_used_in_TypeScript_files, Type_annotations_can_only_be_used_in_TypeScript_files, Type_arguments_can_only_be_used_in_TypeScript_files, Type_assertion_expressions_can_only_be_used_in_TypeScript_files, Type_parameter_declarations_can_only_be_used_in_TypeScript_files, Type_satisfaction_expressions_can_only_be_used_in_TypeScript_files, Unexpected_token, X_0_declarations_can_only_be_used_in_TypeScript_files, X_0_expected, X_export_can_only_be_used_in_TypeScript_files, X_implements_clauses_can_only_be_used_in_TypeScript_files, X_import_can_only_be_used_in_TypeScript_files, X_resolution_mode_should_be_either_require_or_import, } from "../../diagnostics/generated/messages.js";
...
import { KindEnumDeclaration, KindInterfaceDeclaration, KindTypeAliasDeclaration, KindMultiLineCommentTrivia, KindSingleLineCommentTrivia, KindNonNullExpression, KindAsExpression, KindSatisfiesExpression, KindImportDeclaration, KindExportDeclaration, KindImportSpecifier, KindExportSpecifier, KindImportEqualsDeclaration, KindExportAssignment, KindHeritageClause, KindModuleDeclaration, KindParameter, KindPropertyDeclaration, KindMethodDeclaration, KindMethodSignature, KindConstructor, KindGetAccessor, KindSetAccessor, KindFunctionExpression, KindFunctionDeclaration, KindArrowFunction, KindVariableDeclaration, KindIndexSignature, KindClassDeclaration, KindClassExpression, KindVariableStatement, KindCallExpression, KindNewExpression, KindExpressionWithTypeArguments, KindJsxSelfClosingElement, KindJsxOpeningElement, KindTaggedTemplateExpression, KindPrefixUnaryExpression, KindObjectLiteralExpression, KindArrayLiteralExpression, KindDecorator, KindMinusToken, KindTrueKeyword, KindFalseKeyword, KindNullKeyword, } from "../../ast/generated/kinds.js";
import { Parser_parseTypeAnnotation, Parser_parseReturnType, Parser_parseTypeMemberSemicolon, Parser_parseTypeParameters, Parser_isStartOfType, } from "./types.js";
import { Parser_parseArrayLiteralExpression, Parser_parseAssignmentExpressionOrHigher, Parser_parseDecoratorExpression, Parser_parseExpressionAllowIn, Parser_isLiteralPropertyName, Parser_parseLiteralExpression, Parser_parseObjectLiteralExpression, Parser_parsePrefixUnaryExpression, Parser_validateJsonObjectLiteral, } from "./expressions.js";
...
import { Parser_hasPrecedingLineBreak, Parser_finishNodeWithEnd, Parser_finishSourceFile, Parser_parseErrorForMissingSemicolonAfter, Parser_parseIdentifierNameWithDiagnostic, Parser_parseIdentifierOrPatternWithDiagnostic, Parser_parseIdentifierWithDiagnostic, Parser_parseRightSideOfDot, Parser_parseStatement, getErrorSpanForNode, isDoubleQuotedString, isExportModifier, } from "./statements-declarations.js";
import { Parser_createIdentifier, Parser_isBindingIdentifier, Parser_isIdentifier, Parser_isBindingIdentifierOrPrivateIdentifierOrPattern, Parser_jsdocScannerInfo, Parser_nextToken, Parser_nextTokenIsIdentifierOrKeyword, Parser_nextTokenIsOnSameLineAndCanFollowModifier, Parser_nextTokenIsOpenBrace, Parser_parseAnyContextualModifier, Parser_parseExpected, Parser_parseErrorAtCurrentToken, Parser_parseExpectedToken, Parser_parseIdentifierName, Parser_parseIdentifierOrPattern, Parser_parseOptionalToken, Parser_parsePrivateIdentifier, Parser_parseTokenNode, Parser_setContextFlags, doInContext, } from "./tokens-speculation.js";
 ...
 * }
 */
export function Parser_initializeClosures(receiver) {
    receiver.setParentFromContext = (n) => {
 ...
 * }
 */
export function Parser_isJavaScript(receiver) {
 ...
 * }
 */
export function Parser_parseJSONText(receiver) {
    ...
    if (receiver.token === KindEndOfFile) {
        ...
        while (receiver.token !== KindEndOfFile) {
            ...
            switch (receiver.token) {
                ...
                case KindNullKeyword:
                    ...
                    break;
                case KindMinusToken:
                    if (Parser_lookAhead(receiver, (p) => {
                ...
                case KindStringLiteral:
                    if (Parser_lookAhead(receiver, (p) => Parser_nextToken(p) !== KindColonToken)) {
        ...
        let finalExpression;
        if (Array.isArray(expressions)) {
            finalExpression = Parser_finishNode(receiver, NewArrayLiteralExpression(receiver.factory, Parser_newNodeList(receiver, NewTextRange(pos, Parser_nodePos(receiver)), expressions), false), pos);
        }
        else {
 ...
 * }
 */
export function Parser_validateJsonValue(receiver, sourceFile, valueExpression) {
 ...
 * }
 */
export function ParseIsolatedEntityName(text) {
    const p = getParser();
    // defer putParser(p) - handled via finally
    try {
        Parser_initializeState(p, {}, text, ScriptKindJS);
        Parser_nextToken(p);
        const entityName = Parser_parseEntityName(p, true, undefined);
        return (p.token === KindEndOfFile && p.diagnostics.length === 0) ? entityName : undefined;
    }
    finally {
        putParser(p);
    }
 ...
 * }
 */
export function Parser_initializeState(receiver, opts, sourceText, scriptKind) {
    ...
    receiver.identifierCount = 0;
    receiver.notParenthesizedArrow = NewSetWithSizeHint(0);
    receiver.nodeSliceArena = { data: [] };
    receiver.stringSliceArena = { data: [] };
    receiver.jsdocInfos = [];
    ...
    Scanner_SetOnError(receiver.scanner, (message, pos, length, ...args) => Parser_scanError(receiver, message, pos, length, ...args));
 ...
 * }
 */
export function Parser_mark(receiver) {
    return {
 ...
 * }
 */
export function Parser_rewind(receiver, state) {
 ...
 * }
 */
export function Parser_lookAhead(receiver, callback) {
 ...
 * }
 */
export function Parser_nodePos(receiver) {
 ...
 * }
 */
export function Parser_parseOptional(receiver, token) {
 ...
 * }
 */
export function isDeclareModifier(modifier) {
 ...
 * }
 */
export function Parser_parseCaseClause(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseDefaultClause(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseCaseOrDefaultClause(receiver) {
 ...
 * }
 */
export function Parser_parseInitializer(receiver) {
 ...
 * }
 */
export function Parser_isImplementsClause(receiver) {
 ...
 * }
 */
export function isAsyncModifier(modifier) {
 ...
 * }
 */
export function Parser_parseSemicolonAfterPropertyName(receiver, name, typeNode, initializer) {
 ...
 * }
 */
export function getSpaceSuggestion(expressionText) {
 ...
 * }
 */
export function Parser_parseParameter(receiver) {
 ...
 * }
 */
export function Parser_parseParameterEx(receiver, inOuterAwaitContext, allowAmbiguity) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
    // FormalParameter [Yield,Await]:
    //      BindingElement[?Yield,?Await]
    ...
    if (receiver.token === KindThisKeyword) {
        const thisResult = NewParameterDeclaration(receiver.factory, modifiers, undefined, /*dotDotDotToken*/ Parser_createIdentifier(receiver, true /*isIdentifier*/), undefined, /*questionToken*/ Parser_parseTypeAnnotation(receiver), undefined /*initializer*/);
    ...
    const result = NewParameterDeclaration(receiver.factory, modifiers, dotDotDotToken, Parser_parseNameOfParameter(receiver, modifiers), Parser_parseOptionalToken(receiver, KindQuestionToken), Parser_parseTypeAnnotation(receiver), Parser_parseInitializer(receiver));
 ...
 * }
 */
export function Parser_isParameterNameStart(receiver) {
    // Be permissive about await and yield by calling isBindingIdentifier instead of isIdentifier; disallowing
    // them during a speculative parse leads to many more follow-on errors than allowing the function to parse then later
    // complaining about the use of the keywords.
 ...
 * }
 */
export function Parser_parseNameOfParameter(receiver, modifiers) {
    // FormalParameter [Yield,Await]:
    //      BindingElement[?Yield,?Await]
 ...
 * }
 */
export function Parser_parsePropertyName(receiver) {
 ...
 * }
 */
export function Parser_parsePropertyNameWorker(receiver, allowComputedPropertyNames) {
 ...
 * }
 */
export function Parser_parseComputedPropertyName(receiver) {
    // PropertyName [Yield]:
    //      LiteralPropertyName
    //      ComputedPropertyName[?Yield]
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_isIndexSignature(receiver) {
 ...
 * }
 */
export function Parser_nextIsUnambiguouslyIndexSignature(receiver) {
    // The only allowed sequence is:
    //
    //   [id:
    //
 ...
 * }
 */
export function Parser_parsePropertyOrMethodSignature(receiver, pos, jsdoc, modifiers) {
 ...
 * }
 */
export function Parser_skipParameterStart(receiver) {
    if (IsModifierKind(receiver.token)) {
        // Skip modifiers
 ...
 * }
 */
export function Parser_parseModifiers(receiver) {
 ...
 * }
 */
export function Parser_parseModifiersEx(receiver, allowDecorators, permitConstAsModifier, stopOnStartOfClassStaticBlock) {
    ...
    if (list.length !== 0) {
        return Parser_newModifierList(receiver, NewTextRange(pos, Parser_nodePos(receiver)), Arena_Clone(receiver.nodeSliceArena, list));
    }
    return undefined;
}
/**
 ...
 * }
 */
export function Parser_parseDecorator(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_tryParseModifier(receiver, hasSeenStaticModifier, permitConstAsModifier, stopOnStartOfClassStaticBlock) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_canFollowModifier(receiver) {
 ...
 * }
 */
export function Parser_tryReparseOptionalChain(receiver, node) {
 ...
 * }
 */
export function Parser_finishNode(receiver, node, pos) {
 ...
 * }
 */
export function Parser_overrideParentInImmediateChildren(receiver, node) {
 ...
 * }
 */
export function Parser_canParseSemicolon(receiver) {
    // If there's a real semicolon, then we can always parse it out.
    // We can parse out an optional semicolon in ASI cases in the following cases.
 ...
 * }
 */
export function Parser_tryParseSemicolon(receiver) {
 ...
 * }
 */
export function Parser_parseSemicolon(receiver) {
 ...
 * }
 */
export function Parser_isStartOfParameter(receiver, isJSDocParameter) {
 ...
 * }
 */
export function getCommentPragmas(f, sourceText) {
    let pragmas = [];
    GetLeadingCommentRanges(f, sourceText, 0)((commentRange) => {
 ...
 * }
 */
export function extractPragmas(commentRange, text) {
 ...
 * }
 */
export function match(text, pos, s) {
 ...
 * }
 */
export function skipBlanks(text, pos) {
    let p = pos;
 ...
 * }
 */
export function skipNonBlanks(text, pos) {
    let p = pos;
 ...
 * }
 */
export function skipTo(text, pos, s) {
    if (pos >= byteLen(text)) {
        return -1;
    }
 ...
 * }
 */
export function extractName(text, pos) {
    const start = pos;
    let p = pos;
    while (p < byteLen(text)) {
 ...
 * }
 */
export function extractQuotedString(text, pos) {
    if (pos === byteLen(text)) {
        return ["", false];
    }
 ...
 * }
 */
export function Parser_processPragmasIntoFields(receiver, context) {
 ...
 * }
 */
export function Parser_parseResolutionMode(receiver, mode, pos, end) {
    if (mode === "import") {
        const resolutionKind = ModuleKindESNext;
        return resolutionKind;
    }
    if (mode === "require") {
        const resolutionKind = ModuleKindCommonJS;
        return resolutionKind;
    }
    Parser_parseErrorAt(receiver, pos, end, X_resolution_mode_should_be_either_require_or_import);
    const resolutionKind = 0;
    return resolutionKind;
}
/**
 ...
 * }
 */
export function Parser_checkJSDecoratorSyntax(receiver, node) {
    ...
    if (CanHaveIllegalDecorators(node)) {
        ...
        if (decoratorIndex >= 0) {
            if (IsClassDeclaration(node)) {
                ...
                if (exportIndex >= 0) {
                    const defaultIndex = FindIndex(modifiers, (m) => m.Kind === KindDefaultKeyword);
                    if (decoratorIndex > exportIndex && defaultIndex >= 0 && decoratorIndex < defaultIndex) {
                        // Decorator between `export` and `default`
                        ...
                        if (trailingDecoratorIndex >= 0) {
                            const diag = NewDiagnostic(undefined, NewTextRange(SkipTrivia(receiver.sourceText, modifiers[trailingDecoratorIndex].Loc.pos), modifiers[trailingDecoratorIndex].Loc.end), Decorators_may_not_appear_after_export_or_export_default_if_they_also_appear_before_export);
                            Diagnostic_AddRelatedInfo(diag, NewDiagnostic(undefined, NewTextRange(SkipTrivia(receiver.sourceText, modifiers[decoratorIndex].Loc.pos), modifiers[decoratorIndex].Loc.end), Decorator_used_before_export_here));
 ...
 * }
 */
export function Parser_checkJSSyntax(receiver, node) {
    ...
    switch (node.Kind) {
        ...
        case KindArrowFunction: {
            ...
            if (list !== undefined && Some(list.Nodes, (n) => (n.Flags & NodeFlagsReparsed) === 0)) {
