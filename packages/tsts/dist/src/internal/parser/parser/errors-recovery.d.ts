 ...
 * }
 */
export declare function Parser_scanError(receiver: GoPtr<Parser>, message: GoPtr<Message>, pos: int, length: int, ...args: Array<unknown>): void;
/**
 ...
 * }
 */
export declare function Parser_parseErrorAt(receiver: GoPtr<Parser>, pos: int, end: int, message: GoPtr<Message>, ...args: Array<unknown>): GoPtr<Diagnostic>;
/**
 ...
 * }
 */
export declare function Parser_parseErrorAtRange(receiver: GoPtr<Parser>, loc: TextRange, message: GoPtr<Message>, ...args: Array<unknown>): GoPtr<Diagnostic>;
/**
 ...
 * }
 */
export declare function attachFileToDiagnostics(diagnostics: GoSlice<GoPtr<Diagnostic>>, file: GoPtr<SourceFile>): GoSlice<GoPtr<Diagnostic>>;
/**
 ...
 * }
 */
export declare function Parser_jsErrorAtRange(receiver: GoPtr<Parser>, loc: TextRange, message: GoPtr<Message>, ...args: Array<unknown>): void;
//# sourceMappingURL=errors-recovery.d.ts.map