...
import { KindArrayBindingPattern, KindAsKeyword, KindAsteriskAsteriskToken, KindAsteriskToken, KindAsyncKeyword, KindAtToken, KindAwaitKeyword, KindBigIntLiteral, KindClassExpression, KindClassKeyword, KindCallSignature, KindClassDeclaration, KindCloseBraceToken, KindCloseBracketToken, KindCloseParenToken, KindColonToken, KindCommaToken, KindConstKeyword, KindConstructSignature, KindDeleteKeyword, KindDotDotDotToken, KindDotToken, KindEqualsGreaterThanToken, KindEqualsToken, KindEndOfFile, KindExclamationToken, KindExpressionWithTypeArguments, KindExtendsKeyword, KindFalseKeyword, KindFunctionKeyword, KindGetAccessor, KindGetKeyword, KindGreaterThanToken, KindIdentifier, KindImportKeyword, KindInKeyword, KindAssertKeyword, KindWithKeyword, KindLessThanToken, KindMinusMinusToken, KindMinusToken, KindNewKeyword, KindNoSubstitutionTemplateLiteral, KindNullKeyword, KindNumericLiteral, KindObjectBindingPattern, KindOpenBraceToken, KindOpenBracketToken, KindOpenParenToken, KindPlusPlusToken, KindPlusToken, KindConstructorType, KindFunctionType, KindParenthesizedType, KindPrivateIdentifier, KindPropertyAssignment, KindQuestionDotToken, KindQuestionToken, KindTypeReference, KindRegularExpressionLiteral, KindSatisfiesKeyword, KindSemicolonToken, KindSetAccessor, KindSetKeyword, KindSlashEqualsToken, KindSlashToken, KindStringLiteral, KindSuperKeyword, KindTemplateHead, KindTemplateMiddle, KindThisKeyword, KindTildeToken, KindTrueKeyword, KindTypeAssertionExpression, KindTypeOfKeyword, KindUnknown, KindUsingKeyword, KindVoidKeyword, KindYieldKeyword, } from "../../ast/generated/kinds.js";
import { NodeFlagsAwaitContext, NodeFlagsDecoratorContext, NodeFlagsDisallowInContext, NodeFlagsJavaScriptFile, NodeFlagsNone, NodeFlagsOptionalChain, NodeFlagsPossiblyContainsDynamicImport, NodeFlagsPossiblyContainsImportMeta, NodeFlagsYieldContext, } from "../../ast/generated/flags.js";
import { TokenFlagsIsInvalid, TokenFlagsNone, TokenFlagsUnterminated } from "../../ast/tokenflags.js";
import { NewArrayLiteralExpression, NewArrowFunction, NewAsExpression, NewAwaitExpression, NewBigIntLiteral, NewBinaryExpression, NewBindingElement, NewBindingPattern, NewCallExpression, NewCallSignatureDeclaration, NewClassDeclaration, NewClassExpression, NewConditionalExpression, NewConstructSignatureDeclaration, NewDeleteExpression, NewElementAccessExpression, NewEnumMember, NewExpressionStatement, NewExpressionWithTypeArguments, NewFunctionExpression, NewKeywordExpression, NewLabeledStatement, NewMetaProperty, NewMissingDeclaration, NewNewExpression, NewNonNullExpression, NewNoSubstitutionTemplateLiteral, NewNumericLiteral, NewObjectLiteralExpression, NewOmittedExpression, NewParameterDeclaration, NewParenthesizedExpression, NewPostfixUnaryExpression, NewPrefixUnaryExpression, NewPropertyAccessExpression, NewPropertyAssignment, NewRegularExpressionLiteral, NewSatisfiesExpression, NewShorthandPropertyAssignment, NewSpreadAssignment, NewSpreadElement, NewStringLiteral, NewTaggedTemplateExpression, NewTemplateExpression, NewTemplateHead, NewTemplateMiddle, NewTemplateSpan, NewTemplateTail, NewVoidExpression, NewYieldExpression, } from "../../ast/generated/factory.js";
...
import { An_element_access_expression_should_take_an_argument, An_instantiation_expression_cannot_be_followed_by_a_property_access, An_optional_chain_cannot_contain_private_identifiers, An_unary_expression_with_the_0_operator_is_not_allowed_in_the_left_hand_side_of_an_exponentiation_expression_Consider_enclosing_the_expression_in_parentheses, A_type_assertion_expression_is_not_allowed_in_the_left_hand_side_of_an_exponentiation_expression_Consider_enclosing_the_expression_in_parentheses, Expression_expected, Identifier_expected, Invalid_optional_chain_from_new_expression_Did_you_mean_to_call_0, Property_assignment_expected, String_literal_with_double_quotes_expected, X_0_expected, X_super_may_not_use_type_arguments, X_super_must_be_followed_by_an_argument_list_or_member_access, } from "../../diagnostics/generated/messages.js";
...
import { Parser_createMissingList, Parser_newModifierList, Parser_newNodeList, Parser_parseArgumentList, Parser_parseDelimitedList, Parser_parseList, Parser_parseParameters, modifierListHasAsync, } from "./lists.js";
import { Parser_checkJSSyntax, Parser_finishNode, Parser_isImplementsClause, Parser_lookAhead, Parser_mark, Parser_nodePos, Parser_parseInitializer, Parser_parseModifiers, Parser_parseModifiersEx, Parser_parseOptional, Parser_parsePropertyName, Parser_rewind, Parser_tryParseSemicolon, } from "./support.js";
import { Parser_parseHeritageClauses, Parser_parseReturnType, Parser_parseType, Parser_parseTypeAssertion, Parser_parseTypeOfExpression, Parser_parseTypeMemberSemicolon, Parser_parseTypeParameters, Parser_tryParseTypeArgumentsInExpression, Parser_unparseExpressionWithTypeArguments, } from "./types.js";
...
import { isExportModifier, Parser_hasPrecedingLineBreak, Parser_isNextTokenOpenParenOrLessThanOrDot, Parser_isStartOfStatement, Parser_nextTokenIsDot, Parser_nextTokenIsFunctionKeywordOnSameLine, Parser_parseAccessorDeclaration, Parser_parseClassElement, Parser_parseErrorForMissingSemicolonAfter, Parser_parseFunctionBlock, Parser_parseIdentifierWithDiagnostic, Parser_parseMethodDeclaration, Parser_parseRightSideOfDot, Parser_parseStatement, } from "./statements-declarations.js";
import { doInContext, Parser_createIdentifier, Parser_createMissingIdentifier, Parser_internIdentifier, Parser_isBindingIdentifier, Parser_isIdentifier, Parser_jsdocScannerInfo, Parser_nextToken, Parser_nextTokenIsBindingIdentifierOrStartOfDestructuringOnSameLine, Parser_nextTokenIsIdentifier, Parser_nextTokenIsIdentifierOrKeyword, Parser_nextTokenIsIdentifierOrKeywordOrGreaterThan, Parser_nextTokenIsOpenParenOrLessThan, Parser_parseContextualModifier, Parser_parseErrorAtCurrentToken, Parser_parseExpected, Parser_parseExpectedMatchingBrackets, Parser_parseExpectedToken, Parser_parseIdentifierName, Parser_parseIdentifierOrPattern, Parser_parseOptionalBindingIdentifier, Parser_parseOptionalToken, Parser_parsePrivateIdentifier, Parser_parseIdentifier, Parser_parseTokenNode, Parser_reScanGreaterThanToken, Parser_reScanSlashToken, Parser_setContextFlags, Parser_skipRangeTrivia, Parser_inDisallowInContext, Parser_inDecoratorContext, } from "./tokens-speculation.js";
/**
 ...
 * }
 */
export function Parser_validateJsonObjectLiteral(receiver, sourceFile, node) {
 ...
 * }
 */
export function Parser_reparseTopLevelAwait(receiver, sourceFile) {
 ...
 * }
 */
export function Parser_parseExpressionOrLabeledStatement(receiver) {
    // Avoiding having to do the lookahead for a labeled statement by just trying to parse
    // out an expression, seeing if it is identifier and then seeing if it is followed by
    // a colon.
 ...
 * }
 */
export function Parser_parseArrayBindingPattern(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseArrayBindingElement(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseObjectBindingPattern(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseObjectBindingElement(receiver) {
    const pos = Parser_nodePos(receiver);
    ...
    const propertyName = isShorthand ? undefined : propertyNameCandidate;
    const name = (() => {
        if (isShorthand) {
 ...
 * }
 */
export function Parser_parseClassExpression(receiver) {
 ...
 * }
 */
export function Parser_parseClassDeclarationOrExpression(receiver, pos, jsdoc, modifiers, kind) {
    const saveContextFlags = receiver.contextFlags;
    ...
    const result = kind === KindClassDeclaration
 ...
 * }
 */
export function Parser_parseNameOfClassDeclarationOrExpression(receiver) {
    // implements is a future reserved word so
    // 'class implements' might mean either
    // - class expression with omitted name, 'implements' starts heritage clause
    // - class with name 'implements'
 ...
 * }
 */
export function Parser_parseEnumMember(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_reScanTemplateToken(receiver, isTaggedTemplate) {
 ...
 * }
 */
export function Parser_parseSignatureMember(receiver, kind) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
    ...
    const result = kind === KindCallSignature
 ...
 * }
 */
export function Parser_parseTemplateHead(receiver, isTaggedTemplate) {
 ...
 * }
 */
export function Parser_getTemplateLiteralRawText(receiver, endLength) {
 ...
 * }
 */
export function Parser_parseLiteralOfTemplateSpan(receiver, isTaggedTemplate) {
 ...
 * }
 */
export function Parser_parseTemplateMiddleOrTail(receiver) {
    const pos = Parser_nodePos(receiver);
    const result = receiver.token === KindTemplateMiddle
 ...
 * }
 */
export function Parser_nextTokenIsNewKeyword(receiver) {
 ...
 * }
 */
export function Parser_parseDecoratorExpression(receiver) {
 ...
 * }
 */
export function Parser_nextTokenIsIdentifierOrKeywordOrLiteralOnSameLine(receiver) {
 ...
 * }
 */
export function Parser_parseExpression(receiver) {
    // Expression[in]:
    //      AssignmentExpression[in]
    //      Expression[in] , AssignmentExpression[in]
    // clear the decorator context when parsing Expression, as it should be unambiguous when parsing a decorator
 ...
 * }
 */
export function Parser_parseExpressionAllowIn(receiver) {
 ...
 * }
 */
export function Parser_parseAssignmentExpressionOrHigher(receiver) {
 ...
 * }
 */
export function Parser_parseAssignmentExpressionOrHigherWorker(receiver, allowReturnTypeInArrowFunction) {
 ...
 * }
 */
export function Parser_isYieldExpression(receiver) {
 ...
 * }
 */
export function Parser_parseYieldExpression(receiver) {
    const pos = Parser_nodePos(receiver);
    // YieldExpression[In] :
    //      yield
    //      yield [no LineTerminator here] [Lexical goal InputElementRegExp]AssignmentExpression[?In, Yield]
    //      yield [no LineTerminator here] * [Lexical goal InputElementRegExp]AssignmentExpression[?In, Yield]
    Parser_nextToken(receiver);
    const result = !Parser_hasPrecedingLineBreak(receiver) && (receiver.token === KindAsteriskToken || Parser_isStartOfExpression(receiver))
 ...
 * }
 */
export function Parser_isParenthesizedArrowFunctionExpression(receiver) {
 ...
 * }
 */
export function Parser_nextIsParenthesizedArrowFunctionExpression(receiver) {
    ...
    if (first === KindOpenParenToken) {
        ...
        if (receiver.languageVariant === LanguageVariantJSX) {
            const isArrowFunctionInJsx = Parser_lookAhead(receiver, (p) => {
 ...
 * }
 */
export function Parser_tryParseParenthesizedArrowFunctionExpression(receiver, allowReturnTypeInArrowFunction) {
 ...
 * }
 */
export function Parser_parseParenthesizedArrowFunctionExpression(receiver, allowAmbiguity, allowReturnTypeInArrowFunction) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseModifiersForArrowFunction(receiver) {
    if (receiver.token === KindAsyncKeyword) {
        const pos = Parser_nodePos(receiver);
        Parser_nextToken(receiver);
 ...
 * }
 */
export function typeHasArrowFunctionBlockingParseError(node) {
    switch (node.Kind) {
        case KindTypeReference:
            return NodeIsMissing(AsTypeReferenceNode(node).TypeName);
        case KindFunctionType:
        case KindConstructorType:
            return (isMissingNodeList(Node_FunctionLikeData(node).Parameters) || typeHasArrowFunctionBlockingParseError(Node_Type(node)));
 ...
 * }
 */
export function Parser_parseArrowFunctionExpressionBody(receiver, isAsync, allowReturnTypeInArrowFunction) {
 ...
 * }
 */
export function Parser_isStartOfExpressionStatement(receiver) {
    // As per the grammar, none of '{' or 'function' or 'class' can start an expression statement.
 ...
 * }
 */
export function Parser_parsePossibleParenthesizedArrowFunctionExpression(receiver, allowReturnTypeInArrowFunction) {
 ...
 * }
 */
export function Parser_tryParseAsyncSimpleArrowFunctionExpression(receiver, allowReturnTypeInArrowFunction) {
    // We do a check here so that we won't be doing unnecessarily call to "lookAhead"
 ...
 * }
 */
export function Parser_nextIsUnParenthesizedAsyncArrowFunction(receiver) {
    // AsyncArrowFunctionExpression:
    //      1) async[no LineTerminator here]AsyncArrowBindingIdentifier[?Yield][no LineTerminator here]=>AsyncConciseBody[?In]
    //      2) CoverCallExpressionAndAsyncArrowHead[?Yield, ?Await][no LineTerminator here]=>AsyncConciseBody[?In]
    if (receiver.token === KindAsyncKeyword) {
 ...
 * }
 */
export function Parser_parseSimpleArrowFunctionExpression(receiver, pos, identifier, allowReturnTypeInArrowFunction, jsdoc, asyncModifier) {
    ...
    const parameter = Parser_finishNode(receiver, NewParameterDeclaration(receiver.factory, undefined /*modifiers*/, undefined /*dotDotDotToken*/, identifier, undefined /*questionToken*/, undefined /*typeNode*/, undefined /*initializer*/), Node_Pos(identifier));
 ...
 * }
 */
export function Parser_parseConditionalExpressionRest(receiver, leftOperand, pos, allowReturnTypeInArrowFunction) {
    // Note: we are passed in an expression which was produced from parseBinaryExpressionOrHigher.
 ...
 * }
 */
export function Parser_parseBinaryExpressionOrHigher(receiver, precedence) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseBinaryExpressionRest(receiver, precedence, leftOperand, pos) {
    let currentLeft = leftOperand;
    let lastOperand = currentLeft;
    while (true) {
        // We either have a binary operator here, or we're finished.  We call
        // reScanGreaterToken so that we merge token sequences like > and = into >=
        ...
        if (operator === KindAsKeyword || operator === KindSatisfiesKeyword) {
            ...
            if (Parser_hasPrecedingLineBreak(receiver)) {
                ...
                // because continuing would make it impossible to erase the `as` or `satisfies` without changing
                // the meaning of the expression. See https://github.com/microsoft/TypeScript/issues/63527.
                let lastPrecedence = OperatorPrecedenceHighest;
 ...
 * }
 */
export function Parser_makeSatisfiesExpression(receiver, expression, typeNode) {
 ...
 * }
 */
export function Parser_makeAsExpression(receiver, left, right) {
 ...
 * }
 */
export function Parser_makeBinaryExpression(receiver, left, operatorToken, right, pos) {
 ...
 * }
 */
export function Parser_parseUnaryExpressionOrHigher(receiver) {
    // ES7 UpdateExpression:
    //      1) LeftHandSideExpression[?Yield]
    //      2) LeftHandSideExpression[?Yield][no LineTerminator here]++
    //      3) LeftHandSideExpression[?Yield][no LineTerminator here]--
 ...
 * }
 */
export function Parser_isUpdateExpression(receiver) {
 ...
 * }
 */
export function Parser_parseUpdateExpression(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseSimpleUnaryExpression(receiver) {
    switch (receiver.token) {
        case KindPlusToken:
        case KindMinusToken:
        case KindTildeToken:
 ...
 * }
 */
export function Parser_parsePrefixUnaryExpression(receiver) {
    const pos = Parser_nodePos(receiver);
    const operator = receiver.token;
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parseDeleteExpression(receiver) {
    const pos = Parser_nodePos(receiver);
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parseVoidExpression(receiver) {
    const pos = Parser_nodePos(receiver);
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_isAwaitExpression(receiver) {
 ...
 * }
 */
export function Parser_parseAwaitExpression(receiver) {
    const pos = Parser_nodePos(receiver);
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parseLeftHandSideExpressionOrHigher(receiver) {
    const pos = Parser_nodePos(receiver);
    let expression;
 ...
 * }
 */
export function Parser_parseSuperExpression(receiver) {
    const pos = Parser_nodePos(receiver);
    const expression = (() => {
    ...
    // private names will never work with `super` (`super.#foo`), but that's a semantic error, not syntactic
    return Parser_finishNode(receiver, NewPropertyAccessExpression(receiver.factory, expression, undefined /*questionDotToken*/, Parser_parseRightSideOfDot(receiver, true /*allowIdentifierNames*/, true /*allowPrivateIdentifiers*/, true /*allowUnicodeEscapeSequenceInIdentifierName*/), NodeFlagsNone), pos);
}
/**
 ...
 * }
 */
export function Parser_isTemplateStartOfTaggedTemplate(receiver) {
 ...
 * }
 */
export function Parser_parseMemberExpressionOrHigher(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseMemberExpressionRest(receiver, pos, expression, allowOptionalChain) {
    let currentExpr = expression;
    while (true) {
        let questionDotToken = undefined;
        ...
        if (allowOptionalChain && Parser_isStartOfOptionalPropertyOrElementAccessChain(receiver)) {
            ...
            isPropertyAccess = tokenIsIdentifierOrKeyword(receiver.token);
        }
        else {
            isPropertyAccess = Parser_parseOptional(receiver, KindDotToken);
        }
        if (isPropertyAccess) {
 ...
 * }
 */
export function Parser_isStartOfOptionalPropertyOrElementAccessChain(receiver) {
 ...
 * }
 */
export function Parser_nextTokenIsIdentifierOrKeywordOrOpenBracketOrTemplate(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parsePropertyAccessExpressionRest(receiver, pos, expression, questionDotToken) {
 ...
 * }
 */
export function Parser_parseElementAccessExpressionRest(receiver, pos, expression, questionDotToken) {
 ...
 * }
 */
export function Parser_parseCallExpressionRest(receiver, pos, expression) {
    let currentExpr = expression;
    while (true) {
 ...
 * }
 */
export function Parser_parseArgumentExpression(receiver) {
 ...
 * }
 */
export function Parser_parseArgumentOrArrayLiteralElement(receiver) {
    switch (receiver.token) {
 ...
 * }
 */
export function Parser_parseSpreadElement(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseTaggedTemplateRest(receiver, pos, tag, questionDotToken, typeArguments) {
    let template;
 ...
 * }
 */
export function Parser_parseTemplateExpression(receiver, isTaggedTemplate) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseTemplateSpan(receiver, isTaggedTemplate) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parsePrimaryExpression(receiver) {
    switch (receiver.token) {
        case KindNoSubstitutionTemplateLiteral:
 ...
 * }
 */
export function Parser_parseParenthesizedExpression(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseArrayLiteralExpression(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseObjectLiteralExpression(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseObjectLiteralElement(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseFunctionExpression(receiver) {
    // GeneratorExpression:
    //      function* BindingIdentifier [Yield][opt](FormalParameters[Yield]){ GeneratorBody }
    //
    // FunctionExpression:
 ...
 * }
 */
export function Parser_parseDecoratedExpression(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
    const modifiers = Parser_parseModifiersEx(receiver, true /*allowDecorators*/, false /*permitConstAsModifier*/, false /*stopOnStartOfClassStaticBlock*/);
 ...
 * }
 */
export function Parser_parseNewExpressionOrNewDotTarget(receiver) {
    const pos = Parser_nodePos(receiver);
    Parser_parseExpected(receiver, KindNewKeyword);
    ...
    let expression = Parser_parseMemberExpressionRest(receiver, expressionPos, Parser_parsePrimaryExpression(receiver), false /*allowOptionalChain*/);
    let typeArguments = undefined;
    // Absorb type arguments into NewExpression when preceding expression is ExpressionWithTypeArguments
 ...
 * }
 */
export function Parser_parseKeywordExpression(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseLiteralExpression(receiver, intern) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_scanClassMemberStart(receiver) {
    let idToken = KindUnknown;
 ...
 * }
 */
export function Parser_isLiteralPropertyName(receiver) {
 ...
 * }
 */
export function Parser_isStartOfExpression(receiver) {
 ...
 * }
 */
export function Parser_isStartOfLeftHandSideExpression(receiver) {
    switch (receiver.token) {
        case KindThisKeyword:
        case KindSuperKeyword:
        case KindNullKeyword:
 ...
 * }
 */
export function Parser_nextTokenIsNumericOrBigIntLiteral(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_nextTokenIsIdentifierOrStringLiteralOnSameLine(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_isBinaryOperator(receiver) {
 ...
 * }
 */
export function Parser_nextIsStartOfExpression(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_isAwaitUsingDeclaration(receiver) {
 ...
 * }
 */
export function Parser_nextIsUsingKeywordThenBindingIdentifierOrStartOfObjectDestructuringOnSameLine(receiver) {
 ...
 * }
 */
export function Parser_nextTokenIsTokenStringLiteral(receiver) {
 ...
 * }
 */
export function Parser_inYieldContext(receiver) {
 ...
 * }
 */
export function Parser_inAwaitContext(receiver) {
