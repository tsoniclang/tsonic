import { NewArrayTypeNode, NewConditionalTypeNode, NewConstructorTypeNode, NewExpressionWithTypeArguments, NewFunctionTypeNode, NewHeritageClause, NewImportTypeNode, NewIndexedAccessTypeNode, NewInferTypeNode, NewIntersectionTypeNode, NewJSDocNonNullableType, NewJSDocNullableType, NewKeywordTypeNode, NewLiteralTypeNode, NewMappedTypeNode, NewNamedTupleMember, NewParenthesizedTypeNode, NewPrefixUnaryExpression, NewRestTypeNode, NewTemplateLiteralTypeNode, NewTemplateLiteralTypeSpan, NewThisTypeNode, NewTupleTypeNode, NewTypeAliasDeclaration, NewTypeAssertion, NewTypeLiteralNode, NewTypeOfExpression, NewTypeOperatorNode, NewTypeParameterDeclaration, NewTypePredicateNode, NewTypeQueryNode, NewTypeReferenceNode, NewOptionalTypeNode, NewUnionTypeNode, } from "../../ast/generated/factory.js";
 ...
 * }
 */
export function Parser_parseTypeAnnotation(receiver) {
 ...
 * }
 */
export function Parser_parseHeritageClauses(receiver) {
    // ClassTail[Yield,Await] : (Modified) See 14.5
    //      ClassHeritage[?Yield,?Await]opt { ClassBody[?Yield,?Await]opt }
 ...
 * }
 */
export function Parser_parseHeritageClause(receiver) {
 ...
 * }
 */
export function Parser_parseExpressionWithTypeArguments(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseTypeAliasDeclaration(receiver, pos, jsdoc, modifiers) {
 ...
 * }
 */
export function Parser_parseType(receiver) {
 ...
 * }
 */
export function Parser_parseUnionTypeOrHigher(receiver) {
 ...
 * }
 */
export function Parser_parseIntersectionTypeOrHigher(receiver) {
 ...
 * }
 */
export function Parser_parseUnionOrIntersectionType(receiver, operator, parseConstituentType) {
    const pos = Parser_nodePos(receiver);
    ...
    if (receiver.token === operator || hasLeadingOperator) {
        ...
        while (Parser_parseOptional(receiver, operator)) {
            types.push(Parser_parseFunctionOrConstructorTypeToError(receiver, isUnionType, parseConstituentType));
        }
        typeNode = Parser_finishNode(receiver, Parser_createUnionOrIntersectionTypeNode(receiver, operator, Parser_newNodeList(receiver, NewTextRange(pos, Parser_nodePos(receiver)), Arena_Clone(receiver.nodeSliceArena, types))), pos);
    }
    return typeNode;
}
/**
 ...
 * }
 */
export function Parser_createUnionOrIntersectionTypeNode(receiver, operator, types) {
    switch (operator) {
        case KindBarToken:
 ...
 * }
 */
export function Parser_parseTypeOperatorOrHigher(receiver) {
 ...
 * }
 */
export function Parser_parseTypeOperator(receiver, operator) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseInferType(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseTypeParameterOfInferType(receiver) {
    const pos = Parser_nodePos(receiver);
    const name = Parser_parseIdentifier(receiver);
 ...
 * }
 */
export function Parser_tryParseConstraintOfInferType(receiver) {
 ...
 * }
 */
export function Parser_parsePostfixTypeOrHigher(receiver) {
    const pos = Parser_nodePos(receiver);
    const loop = (typeNode) => {
        if (Parser_hasPrecedingLineBreak(receiver)) {
            return typeNode;
 ...
 * }
 */
export function Parser_nextIsStartOfType(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parseNonArrayType(receiver) {
    switch (receiver.token) {
        case KindAnyKeyword:
 ...
 * }
 */
export function Parser_parseKeywordTypeNode(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseThisTypeNode(receiver) {
    const pos = Parser_nodePos(receiver);
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parseThisTypePredicate(receiver, lhs) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parseLiteralTypeNode(receiver, negative) {
    const pos = Parser_nodePos(receiver);
    if (negative) {
        Parser_nextToken(receiver);
    }
 ...
 * }
 */
export function Parser_parseTypeReference(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseEntityNameOfTypeReference(receiver) {
 ...
 * }
 */
export function Parser_parseTypeArgumentsOfTypeReference(receiver) {
 ...
 * }
 */
export function Parser_parseTypeArguments(receiver) {
 ...
 * }
 */
export function Parser_nextIsStartOfTypeOfImportType(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parseImportType(receiver) {
 ...
 * }
 */
export function Parser_parseTypeQuery(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_nextIsStartOfMappedType(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parseMappedType(receiver) {
    const pos = Parser_nodePos(receiver);
    Parser_parseExpected(receiver, KindOpenBraceToken);
 ...
 * }
 */
export function Parser_parseMappedTypeParameter(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseTypeMember(receiver) {
 ...
 * }
 */
export function Parser_parseTypeParameters(receiver) {
    if (receiver.token === KindLessThanToken) {
 ...
 * }
 */
export function Parser_parseTypeParameter(receiver) {
    const pos = Parser_nodePos(receiver);
    ...
    // it out as an expression (so we can recover well), but report that a type is needed
    // instead.
    const constraintAndExpression = Parser_parseOptional(receiver, KindExtendsKeyword)
 ...
 * }
 */
export function Parser_parseReturnType(receiver, returnToken, isType) {
 ...
 * }
 */
export function Parser_shouldParseReturnType(receiver, returnToken, isType) {
 ...
 * }
 */
export function Parser_parseTypeOrTypePredicate(receiver) {
 ...
 * }
 */
export function Parser_parseTypeMemberSemicolon(receiver) {
    // We allow type members to be separated by commas or (possibly ASI) semicolons.
    // First check if it was a comma.  If so, we're done with the member.
    if (Parser_parseOptional(receiver, KindCommaToken)) {
        return;
 ...
 * }
 */
export function Parser_parseTypeLiteral(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseObjectTypeMembers(receiver) {
 ...
 * }
 */
export function Parser_parseTupleType(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseTupleElementNameOrTupleElementType(receiver) {
 ...
 * }
 */
export function Parser_scanStartOfNamedTupleElement(receiver) {
 ...
 * }
 */
export function Parser_parseTupleElementType(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseParenthesizedType(receiver) {
    const pos = Parser_nodePos(receiver);
    Parser_parseExpected(receiver, KindOpenParenToken);
    const typeNode = Parser_parseType(receiver);
    Parser_parseExpected(receiver, KindCloseParenToken);
 ...
 * }
 */
export function Parser_parseAssertsTypePredicate(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseTemplateType(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseTemplateTypeSpans(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseTemplateTypeSpan(receiver) {
    const pos = Parser_nodePos(receiver);
 ...
 * }
 */
export function Parser_parseFunctionOrConstructorTypeToError(receiver, isInUnionType, parseConstituentType) {
    // the function type and constructor type shorthand notation
    // are not allowed directly in unions and intersections, but we'll
    // try to parse them gracefully and issue a helpful message.
    if (Parser_isStartOfFunctionTypeOrConstructorType(receiver)) {
        ...
        const diagnostic = typeNode.Kind === KindFunctionType
            ? IfElse(isInUnionType, Function_type_notation_must_be_parenthesized_when_used_in_a_union_type, Function_type_notation_must_be_parenthesized_when_used_in_an_intersection_type)
            : IfElse(isInUnionType, Constructor_type_notation_must_be_parenthesized_when_used_in_a_union_type, Constructor_type_notation_must_be_parenthesized_when_used_in_an_intersection_type);
 ...
 * }
 */
export function Parser_isStartOfFunctionTypeOrConstructorType(receiver) {
 ...
 * }
 */
export function Parser_parseFunctionOrConstructorType(receiver) {
    const pos = Parser_nodePos(receiver);
    const jsdoc = Parser_jsdocScannerInfo(receiver);
 ...
 * }
 */
export function Parser_parseModifiersForConstructorType(receiver) {
 ...
 * }
 */
export function Parser_nextIsUnambiguouslyStartOfFunctionType(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parseTypeOfExpression(receiver) {
    const pos = Parser_nodePos(receiver);
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_parseTypeAssertion(receiver) {
 ...
 * }
 */
export function Parser_tryParseTypeArgumentsInExpression(receiver) {
    // TypeArguments must not be parsed in JavaScript files to avoid ambiguity with binary operators.
    const state = Parser_mark(receiver);
 ...
 * }
 */
export function Parser_canFollowTypeArgumentsInExpression(receiver) {
    switch (receiver.token) {
        // These tokens can follow a type argument list in a call expression:
        // foo<x>(
        // foo<T> `...`
 ...
 * }
 */
export function Parser_unparseExpressionWithTypeArguments(receiver, expression, typeArguments, result) {
    // force overwrite the `.Parent` of the expression and type arguments to erase the fact that they may have originally been parsed as an ExpressionWithTypeArguments and be parented to such
 ...
 * }
 */
export function Parser_scanTypeMemberStart(receiver) {
    // Return true if we have the start of a signature member
    ...
    // Eat up all modifiers, but hold on to the last one in case it is actually an identifier
    const eatModifiers = (sawModifier) => {
 ...
 * }
 */
export function Parser_isStartOfType(receiver, inStartOfParameter) {
    switch (receiver.token) {
        case KindAnyKeyword:
        case KindUnknownKeyword:
        case KindStringKeyword:
 ...
 * }
 */
export function Parser_nextIsParenthesizedOrFunctionType(receiver) {
    Parser_nextToken(receiver);
 ...
 * }
 */
export function Parser_isValidHeritageClauseObjectLiteral(receiver) {
 ...
 * }
 */
export function Parser_nextIsValidHeritageClauseObjectLiteral(receiver) {
 ...
 * }
 */
export function Parser_isHeritageClause(receiver) {
 ...
 * }
 */
export function Parser_isHeritageClauseExtendsOrImplementsKeyword(receiver) {
 ...
 * }
 */
export function Parser_inDisallowConditionalTypesContext(receiver) {
