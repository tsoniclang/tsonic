 ...
 * }
 */
export function WithLocale(ctx, locale) {
    return WithValue(ctx, 0, locale);
}
/**
 ...
 * }
 */
export function Parse(localeStr) {
    const [tag, err] = language_Parse(localeStr);
    return [tag, (err === undefined)];
}
