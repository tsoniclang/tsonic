 ...
 * var Default Locale
 */
export declare let Default: Locale;
/**
 ...
 * }
 */
export declare function WithLocale(ctx: Context, locale: Locale): Context;
/**
 ...
 * }
 */
export declare function FromContext(ctx: Context): Locale;
/**
 ...
 * }
 */
export declare function Parse(localeStr: string): [Locale, bool];
