 ...
 * }
 */
export declare function SyncMap_Load<K, V>(receiver: GoPtr<SyncMap<K, V>>, key: K): [V, bool];
/**
 ...
 * }
 */
export declare function SyncMap_Store<K, V>(receiver: GoPtr<SyncMap<K, V>>, key: K, value: V): void;
/**
 ...
 * }
 */
export declare function SyncMap_LoadOrStore<K, V>(receiver: GoPtr<SyncMap<K, V>>, key: K, value: V): [V, bool];
/**
 ...
 * }
 */
export declare function SyncMap_Delete<K, V>(receiver: GoPtr<SyncMap<K, V>>, key: K): void;
/**
 ...
 * }
 */
export declare function SyncMap_Clear<K, V>(receiver: GoPtr<SyncMap<K, V>>): void;
/**
 ...
 * }
 */
export declare function SyncMap_Range<K, V>(receiver: GoPtr<SyncMap<K, V>>, f: (key: K, value: V) => bool): void;
/**
 ...
 * }
 */
export declare function SyncMap_Size<K, V>(receiver: GoPtr<SyncMap<K, V>>): int;
/**
 ...
 * }
 */
export declare function SyncMap_ToMap<K, V>(receiver: GoPtr<SyncMap<K, V>>): GoMap<K, V>;
/**
 ...
 * }
 */
export declare function SyncMap_Keys<K, V>(receiver: GoPtr<SyncMap<K, V>>): GoSeq<K>;
/**
 ...
 * }
 */
export declare function SyncMap_Clone<K, V>(receiver: GoPtr<SyncMap<K, V>>): GoPtr<SyncMap<K, V>>;
