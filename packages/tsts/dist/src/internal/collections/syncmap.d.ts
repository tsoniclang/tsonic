 ...
 * }
 */
export declare function SyncMap_Load<K extends GoComparable, V>(receiver: GoPtr<SyncMap<K, V>>, key: K): [V, bool];
/**
 ...
 * }
 */
export declare function SyncMap_Store<K extends GoComparable, V>(receiver: GoPtr<SyncMap<K, V>>, key: K, value: V): void;
/**
 ...
 * }
 */
export declare function SyncMap_LoadOrStore<K extends GoComparable, V>(receiver: GoPtr<SyncMap<K, V>>, key: K, value: V): [V, bool];
/**
 ...
 * }
 */
export declare function SyncMap_Delete<K extends GoComparable, V>(receiver: GoPtr<SyncMap<K, V>>, key: K): void;
/**
 ...
 * }
 */
export declare function SyncMap_Clear<K extends GoComparable, V>(receiver: GoPtr<SyncMap<K, V>>): void;
/**
 ...
 * }
 */
export declare function SyncMap_Range<K extends GoComparable, V>(receiver: GoPtr<SyncMap<K, V>>, f: (key: K, value: V) => bool): void;
/**
 ...
 * }
 */
export declare function SyncMap_Size<K extends GoComparable, V>(receiver: GoPtr<SyncMap<K, V>>): int;
/**
 ...
 * }
 */
export declare function SyncMap_ToMap<K extends GoComparable, V>(receiver: GoPtr<SyncMap<K, V>>): GoMap<K, V>;
/**
 ...
 * }
 */
export declare function SyncMap_Keys<K extends GoComparable, V>(receiver: GoPtr<SyncMap<K, V>>): GoSeq<K>;
/**
 ...
 * }
 */
export declare function SyncMap_Clone<K extends GoComparable, V>(receiver: GoPtr<SyncMap<K, V>>): GoPtr<SyncMap<K, V>>;
