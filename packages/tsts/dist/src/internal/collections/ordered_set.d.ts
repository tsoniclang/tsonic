 ...
 * }
 */
export declare function NewOrderedSetWithSizeHint<T extends GoComparable>(hint: int): GoPtr<OrderedSet<T>>;
/**
 ...
 * }
 */
export declare function OrderedSet_Has<T extends GoComparable>(receiver: GoPtr<OrderedSet<T>>, value: T): bool;
/**
 ...
 * }
 */
export declare function OrderedSet_Delete<T extends GoComparable>(receiver: GoPtr<OrderedSet<T>>, value: T): bool;
/**
 ...
 * }
 */
export declare function OrderedSet_Values<T extends GoComparable>(receiver: GoPtr<OrderedSet<T>>): GoSeq<T>;
/**
 ...
 * }
 */
export declare function OrderedSet_Clear<T extends GoComparable>(receiver: GoPtr<OrderedSet<T>>): void;
/**
 ...
 * }
 */
export declare function OrderedSet_Size<T extends GoComparable>(receiver: GoPtr<OrderedSet<T>>): int;
/**
 ...
 * }
 */
export declare function OrderedSet_Clone<T extends GoComparable>(receiver: GoPtr<OrderedSet<T>>): GoPtr<OrderedSet<T>>;
//# sourceMappingURL=ordered_set.d.ts.map