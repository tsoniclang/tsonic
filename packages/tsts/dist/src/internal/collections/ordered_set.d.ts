 ...
 * }
 */
export declare function OrderedSet_Has<T>(receiver: GoPtr<OrderedSet<T>>, value: T): bool;
/**
 ...
 * }
 */
export declare function OrderedSet_Delete<T>(receiver: GoPtr<OrderedSet<T>>, value: T): bool;
/**
 ...
 * }
 */
export declare function OrderedSet_Values<T>(receiver: GoPtr<OrderedSet<T>>): GoSeq<T>;
/**
 ...
 * }
 */
export declare function OrderedSet_Clear<T>(receiver: GoPtr<OrderedSet<T>>): void;
/**
 ...
 * }
 */
export declare function OrderedSet_Size<T>(receiver: GoPtr<OrderedSet<T>>): int;
/**
 ...
 * }
 */
export declare function OrderedSet_Clone<T>(receiver: GoPtr<OrderedSet<T>>): GoPtr<OrderedSet<T>>;
