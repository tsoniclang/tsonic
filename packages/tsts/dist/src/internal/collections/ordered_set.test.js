...
import { NewOrderedSetWithSizeHint, OrderedSet_Add, OrderedSet_Clear, OrderedSet_Clone, OrderedSet_Delete, OrderedSet_Has, OrderedSet_Size, OrderedSet_Values, } from "./ordered_set.js";
test("OrderedSet mirrors upstream add/delete/clear/clone behavior", () => {
    const set = NewOrderedSetWithSizeHint(0);
...
test("NewOrderedSetWithSizeHint preserves ordered-set behavior", () => {
    const count = 1_024;
    const set = NewOrderedSetWithSizeHint(count);
...
//# sourceMappingURL=ordered_set.test.js.map