 ...
 * }
 */
export function SyncSet_Has(receiver, key) {
 ...
 * }
 */
export function SyncSet_Add(receiver, key) {
 ...
 * }
 */
export function SyncSet_AddIfAbsent(receiver, key) {
 ...
 * }
 */
export function SyncSet_Delete(receiver, key) {
 ...
 * }
 */
export function SyncSet_Range(receiver, fn) {
    SyncMap_Range(receiver.m, (key, _value) => {
        return fn(key);
    });
}
/**
 ...
 * }
 */
export function SyncSet_Size(receiver) {
    const keys = [];
    SyncMap_Range(receiver.m, (key, _value) => {
        keys.push(key);
        return true;
 ...
 * }
 */
export function SyncSet_IsEmpty(receiver) {
 ...
 * }
 */
export function SyncSet_ToSlice(receiver) {
    const arr = [];
    SyncMap_Range(receiver.m, (key, _value) => {
        arr.push(key);
        return true;
 ...
 * }
 */
export function SyncSet_Keys(receiver) {
    return (yield_) => {
        SyncMap_Range(receiver.m, (key, _value) => {
            if (!yield_(key)) {
                return false;
...
//# sourceMappingURL=syncset.js.map