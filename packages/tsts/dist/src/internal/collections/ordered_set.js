import { newMapWithSizeHint, OrderedMap_clone, OrderedMap_Clear, OrderedMap_Delete, OrderedMap_Has, OrderedMap_Keys, OrderedMap_Set, OrderedMap_Size, } from "./ordered_map.js";
/**
 ...
 * }
 */
export function NewOrderedSetWithSizeHint(hint) {
    return {
        m: newMapWithSizeHint(hint),
    };
}
/**
 ...
 * }
 */
export function OrderedSet_Has(receiver, value) {
    const s = receiver;
 ...
 * }
 */
export function OrderedSet_Delete(receiver, value) {
    const s = receiver;
 ...
 * }
 */
export function OrderedSet_Values(receiver) {
    const s = receiver;
 ...
 * }
 */
export function OrderedSet_Clear(receiver) {
    const s = receiver;
 ...
 * }
 */
export function OrderedSet_Size(receiver) {
    const s = receiver;
 ...
 * }
 */
export function OrderedSet_Clone(receiver) {
    const s = receiver;
    return {
