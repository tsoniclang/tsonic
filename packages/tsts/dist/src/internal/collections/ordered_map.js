 ...
 * }
 */
export function NewOrderedMapWithSizeHint(hint) {
    const m = newMapWithSizeHint(hint);
    return m;
}
/**
 ...
 * }
 */
export function newMapWithSizeHint(hint) {
    return {
        __tsgoBlank0: {},
        keys: [],
        mp: new globalThis.Map(),
    };
}
/**
 ...
 * }
 */
export function NewOrderedMapFromList(items) {
    const mp = NewOrderedMapWithSizeHint(items.length);
 ...
 * }
 */
export function OrderedMap_Set(receiver, key, value) {
    const m = receiver;
    if (m.mp === undefined) {
        m.mp = new globalThis.Map();
    }
    if (!m.mp.has(key)) {
        m.keys.push(key);
    }
 ...
 * }
 */
export function OrderedMap_Get(receiver, key) {
    const m = receiver;
 ...
 * }
 */
export function OrderedMap_GetOrZero(receiver, key) {
    const m = receiver;
    return m.mp.get(key);
}
/**
 ...
 * }
 */
export function OrderedMap_EntryAt(receiver, index) {
    const m = receiver;
    if (index < 0 || index >= m.keys.length) {
        const zero = undefined;
        const zeroV = undefined;
        return [zero, zeroV, false];
    }
 ...
 * }
 */
export function OrderedMap_Has(receiver, key) {
    const m = receiver;
    const ok = m.mp.has(key);
    return ok;
}
 ...
 * }
 */
export function OrderedMap_Delete(receiver, key) {
    const m = receiver;
    const v = m.mp.get(key);
    const ok = m.mp.has(key);
    if (!ok) {
 ...
 * }
 */
export function OrderedMap_Keys(receiver) {
    const m = receiver;
    return (yield_) => {
        if (m === undefined) {
            return;
 ...
 * }
 */
export function OrderedMap_Values(receiver) {
    const m = receiver;
    return (yield_) => {
        if (m === undefined) {
            return;
 ...
 * }
 */
export function OrderedMap_Entries(receiver) {
    const m = receiver;
    return (yield_) => {
        if (m === undefined) {
            return;
 ...
 * }
 */
export function OrderedMap_Clear(receiver) {
    const m = receiver;
    m.keys.length = 0;
 ...
 * }
 */
export function OrderedMap_Size(receiver) {
    const m = receiver;
    if (m === undefined) {
        return 0;
    }
 ...
 * }
 */
export function OrderedMap_Clone(receiver) {
    const m = receiver;
    if (m === undefined) {
        return undefined;
    }
 ...
 */
export const __83877ae8_0 = OrderedMap_as_json_MarshalerTo(undefined);
export function OrderedMap_as_json_MarshalerTo(receiver) {
    return {
        MarshalJSONTo: (encoder) => OrderedMap_MarshalJSONTo(receiver, encoder),
    };
}
/**
 ...
 * }
 */
export function OrderedMap_MarshalJSONTo(receiver, enc) {
    if (enc === undefined) {
 ...
 * }
 */
export function resolveKeyName(k) {
 ...
 */
export const __ffc9f882_0 = OrderedMap_as_json_UnmarshalerFrom(undefined);
export function OrderedMap_as_json_UnmarshalerFrom(receiver) {
    return {
        UnmarshalJSONFrom: (decoder) => OrderedMap_UnmarshalJSONFrom(receiver, decoder),
    };
}
/**
 ...
 * }
 */
export function OrderedMap_UnmarshalJSONFrom(receiver, dec) {
    if (dec === undefined) {
    ...
    if (value instanceof globalThis.Map) {
        for (const [key, element] of value.entries()) {
            OrderedMap_Set(receiver, key, element);
        }
        return undefined;
    }
    ...
    for (const [key, element] of globalThis.Object.entries(value)) {
        OrderedMap_Set(receiver, key, element);
    }
    return undefined;
}
 ...
 * }
 */
export function DiffOrderedMaps(m1, m2, onAdded, onRemoved, onModified) {
    DiffOrderedMapsFunc(m1, m2, (a, b) => {
        return a === b;
    }, onAdded, onRemoved, onModified);
}
/**
 ...
 * }
 */
export function DiffOrderedMapsFunc(m1, m2, equalValues, onAdded, onRemoved, onModified) {
    OrderedMap_Entries(m2)((k, v2) => {
