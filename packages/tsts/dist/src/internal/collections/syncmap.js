...
function syncMapBacking(receiver) {
 ...
 * }
 */
export function SyncMap_Load(receiver, key) {
 ...
 * }
 */
export function SyncMap_Store(receiver, key, value) {
 ...
 * }
 */
export function SyncMap_LoadOrStore(receiver, key, value) {
 ...
 * }
 */
export function SyncMap_Delete(receiver, key) {
 ...
 * }
 */
export function SyncMap_Clear(receiver) {
 ...
 * }
 */
export function SyncMap_Range(receiver, f) {
    syncMapBacking(receiver).Range((key, value) => {
        const k = (key !== undefined ? key : undefined);
        const v = (value !== undefined ? value : undefined);
        return f(k, v);
    });
}
/**
 ...
 * }
 */
export function SyncMap_Size(receiver) {
    const entries = [];
    syncMapBacking(receiver).Range((key, _value) => {
        entries.push(key);
        return true;
    });
 ...
 * }
 */
export function SyncMap_ToMap(receiver) {
 ...
 * }
 */
export function SyncMap_Keys(receiver) {
    return (yield_) => {
        syncMapBacking(receiver).Range((key, _value) => {
            if (!yield_(key)) {
                return false;
 ...
 * }
 */
export function SyncMap_Clone(receiver) {
    const clone = {
        __tsgoBlank0: [],
        __tsgoBlank1: [],
        m: new Map(),
