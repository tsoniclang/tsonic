...
import { NewOrderedMapWithSizeHint, OrderedMap_as_json_UnmarshalerFrom, OrderedMap_Clear, OrderedMap_Clone, OrderedMap_Delete, OrderedMap_Entries, OrderedMap_Get, OrderedMap_GetOrZero, OrderedMap_Has, OrderedMap_Keys, OrderedMap_Set, OrderedMap_Size, OrderedMap_UnmarshalJSONFrom, OrderedMap_Values, } from "./ordered_map.js";
...
function collectEntries(map) {
    const entries = [];
    OrderedMap_Entries(map)((key, value) => {
...
test("OrderedMap mirrors upstream insertion, overwrite, iteration, and deletion", () => {
    const map = NewOrderedMapWithSizeHint(0);
...
test("NewOrderedMapWithSizeHint preserves ordered-map behavior", () => {
    const count = 1_024;
    const map = NewOrderedMapWithSizeHint(count);
...
//# sourceMappingURL=ordered_map.test.js.map