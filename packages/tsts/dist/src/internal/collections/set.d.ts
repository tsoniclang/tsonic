 ...
 * }
 */
export declare function NewSetWithSizeHint<T extends GoComparable>(hint: int): GoPtr<Set<T>>;
/**
 ...
 * }
 */
export declare function Set_Has<T extends GoComparable>(receiver: GoPtr<Set<T>>, key: T): bool;
/**
 ...
 * }
 */
export declare function Set_Add<T extends GoComparable>(receiver: GoPtr<Set<T>>, key: T): void;
/**
 ...
 * }
 */
export declare function Set_Delete<T extends GoComparable>(receiver: GoPtr<Set<T>>, key: T): void;
/**
 ...
 * }
 */
export declare function Set_Len<T extends GoComparable>(receiver: GoPtr<Set<T>>): int;
/**
 ...
 * }
 */
export declare function Set_Keys<T extends GoComparable>(receiver: GoPtr<Set<T>>): GoMap<T, {
    readonly __tsgoEmpty?: never;
}>;
/**
 ...
 * }
 */
export declare function Set_Clear<T extends GoComparable>(receiver: GoPtr<Set<T>>): void;
/**
 ...
 * }
 */
export declare function Set_AddIfAbsent<T extends GoComparable>(receiver: GoPtr<Set<T>>, key: T): bool;
/**
 ...
 * }
 */
export declare function Set_Clone<T extends GoComparable>(receiver: GoPtr<Set<T>>): GoPtr<Set<T>>;
/**
 ...
 * }
 */
export declare function Set_Union<T extends GoComparable>(receiver: GoPtr<Set<T>>, other: GoPtr<Set<T>>): void;
/**
 ...
 * }
 */
export declare function Set_UnionedWith<T extends GoComparable>(receiver: GoPtr<Set<T>>, other: GoPtr<Set<T>>): GoPtr<Set<T>>;
/**
 ...
 * }
 */
export declare function Set_Equals<T extends GoComparable>(receiver: GoPtr<Set<T>>, other: GoPtr<Set<T>>): bool;
/**
 ...
 * }
 */
export declare function Set_IsSubsetOf<T extends GoComparable>(receiver: GoPtr<Set<T>>, other: GoPtr<Set<T>>): bool;
/**
 ...
 * }
 */
export declare function Set_Intersects<T extends GoComparable>(receiver: GoPtr<Set<T>>, other: GoPtr<Set<T>>): bool;
/**
 ...
 * }
 */
export declare function NewSetFromItems<T extends GoComparable>(...items: Array<T>): GoPtr<Set<T>>;
