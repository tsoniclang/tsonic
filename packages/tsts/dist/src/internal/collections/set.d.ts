 ...
 * }
 */
export declare function Set_Has<T>(receiver: GoPtr<Set<T>>, key: T): bool;
/**
 ...
 * }
 */
export declare function Set_Add<T>(receiver: GoPtr<Set<T>>, key: T): void;
/**
 ...
 * }
 */
export declare function Set_Delete<T>(receiver: GoPtr<Set<T>>, key: T): void;
/**
 ...
 * }
 */
export declare function Set_Len<T>(receiver: GoPtr<Set<T>>): int;
/**
 ...
 * }
 */
export declare function Set_Keys<T>(receiver: GoPtr<Set<T>>): GoMap<T, {
    readonly __tsgoEmpty?: never;
}>;
/**
 ...
 * }
 */
export declare function Set_Clear<T>(receiver: GoPtr<Set<T>>): void;
/**
 ...
 * }
 */
export declare function Set_AddIfAbsent<T>(receiver: GoPtr<Set<T>>, key: T): bool;
/**
 ...
 * }
 */
export declare function Set_Clone<T>(receiver: GoPtr<Set<T>>): GoPtr<Set<T>>;
/**
 ...
 * }
 */
export declare function Set_Union<T>(receiver: GoPtr<Set<T>>, other: GoPtr<Set<T>>): void;
/**
 ...
 * }
 */
export declare function Set_UnionedWith<T>(receiver: GoPtr<Set<T>>, other: GoPtr<Set<T>>): GoPtr<Set<T>>;
/**
 ...
 * }
 */
export declare function Set_Equals<T>(receiver: GoPtr<Set<T>>, other: GoPtr<Set<T>>): bool;
/**
 ...
 * }
 */
export declare function Set_IsSubsetOf<T>(receiver: GoPtr<Set<T>>, other: GoPtr<Set<T>>): bool;
/**
 ...
 * }
 */
export declare function Set_Intersects<T>(receiver: GoPtr<Set<T>>, other: GoPtr<Set<T>>): bool;
/**
