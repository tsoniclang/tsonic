 ...
 * }
 */
export declare function NewOrderedMapWithSizeHint<K extends GoComparable, V>(hint: int): GoPtr<OrderedMap<K, V>>;
/**
 ...
 * }
 */
export declare function newMapWithSizeHint<K extends GoComparable, V>(hint: int): OrderedMap<K, V>;
/**
 ...
 * }
 */
export declare function NewOrderedMapFromList<K extends GoComparable, V>(items: GoSlice<MapEntry<K, V>>): GoPtr<OrderedMap<K, V>>;
/**
 ...
 * }
 */
export declare function OrderedMap_Set<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>, key: K, value: V): void;
/**
 ...
 * }
 */
export declare function OrderedMap_Get<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>, key: K): [V, bool];
/**
 ...
 * }
 */
export declare function OrderedMap_GetOrZero<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>, key: K): V;
/**
 ...
 * }
 */
export declare function OrderedMap_EntryAt<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>, index: int): [K, V, bool];
/**
 ...
 * }
 */
export declare function OrderedMap_Has<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>, key: K): bool;
/**
 ...
 * }
 */
export declare function OrderedMap_Delete<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>, key: K): [V, bool];
/**
 ...
 * }
 */
export declare function OrderedMap_Keys<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>): GoSeq<K>;
/**
 ...
 * }
 */
export declare function OrderedMap_Values<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>): GoSeq<V>;
/**
 ...
 * }
 */
export declare function OrderedMap_Entries<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>): GoSeq2<K, V>;
/**
 ...
 * }
 */
export declare function OrderedMap_Clear<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>): void;
/**
 ...
 * }
 */
export declare function OrderedMap_Size<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>): int;
/**
 ...
 * }
 */
export declare function OrderedMap_Clone<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>): GoPtr<OrderedMap<K, V>>;
/**
 ...
 * }
 */
export declare function OrderedMap_clone<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>): OrderedMap<K, V>;
/**
 ...
 */
export declare const __83877ae8_0: MarshalerTo;
export declare function OrderedMap_as_json_MarshalerTo<K, V>(receiver: GoPtr<OrderedMap<K, V>>): MarshalerTo;
/**
 ...
 * }
 */
export declare function OrderedMap_MarshalJSONTo<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>, enc: GoPtr<Encoder>): GoError;
/**
 ...
 * }
 */
export declare function resolveKeyName(k: Value): [string, GoError];
/**
 ...
 */
export declare const __ffc9f882_0: UnmarshalerFrom;
export declare function OrderedMap_as_json_UnmarshalerFrom<K, V>(receiver: GoPtr<OrderedMap<K, V>>): UnmarshalerFrom;
/**
 ...
 * }
 */
export declare function OrderedMap_UnmarshalJSONFrom<K extends GoComparable, V>(receiver: GoPtr<OrderedMap<K, V>>, dec: GoPtr<Decoder>): GoError;
/**
 ...
 * }
 */
export declare function DiffOrderedMaps<K extends GoComparable, V extends GoComparable>(m1: GoPtr<OrderedMap<K, V>>, m2: GoPtr<OrderedMap<K, V>>, onAdded: (key: K, value: V) => void, onRemoved: (key: K, value: V) => void, onModified: (key: K, oldValue: V, newValue: V) => void): void;
/**
 ...
 * }
 */
export declare function DiffOrderedMapsFunc<K extends GoComparable, V>(m1: GoPtr<OrderedMap<K, V>>, m2: GoPtr<OrderedMap<K, V>>, equalValues: (a: V, b: V) => bool, onAdded: (key: K, value: V) => void, onRemoved: (key: K, value: V) => void, onModified: (key: K, oldValue: V, newValue: V) => void): void;
