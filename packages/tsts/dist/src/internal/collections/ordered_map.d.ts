 ...
 * }
 */
export declare function OrderedMap_Set<K, V>(receiver: GoPtr<OrderedMap<K, V>>, key: K, value: V): void;
/**
 ...
 * }
 */
export declare function OrderedMap_Get<K, V>(receiver: GoPtr<OrderedMap<K, V>>, key: K): [V, bool];
/**
 ...
 * }
 */
export declare function OrderedMap_GetOrZero<K, V>(receiver: GoPtr<OrderedMap<K, V>>, key: K): V;
/**
 ...
 * }
 */
export declare function OrderedMap_EntryAt<K, V>(receiver: GoPtr<OrderedMap<K, V>>, index: int): [K, V, bool];
/**
 ...
 * }
 */
export declare function OrderedMap_Has<K, V>(receiver: GoPtr<OrderedMap<K, V>>, key: K): bool;
/**
 ...
 * }
 */
export declare function OrderedMap_Delete<K, V>(receiver: GoPtr<OrderedMap<K, V>>, key: K): [V, bool];
/**
 ...
 * }
 */
export declare function OrderedMap_Keys<K, V>(receiver: GoPtr<OrderedMap<K, V>>): GoSeq<K>;
/**
 ...
 * }
 */
export declare function OrderedMap_Values<K, V>(receiver: GoPtr<OrderedMap<K, V>>): GoSeq<V>;
/**
 ...
 * }
 */
export declare function OrderedMap_Entries<K, V>(receiver: GoPtr<OrderedMap<K, V>>): GoSeq2<K, V>;
/**
 ...
 * }
 */
export declare function OrderedMap_Clear<K, V>(receiver: GoPtr<OrderedMap<K, V>>): void;
/**
 ...
 * }
 */
export declare function OrderedMap_Size<K, V>(receiver: GoPtr<OrderedMap<K, V>>): int;
/**
 ...
 * }
 */
export declare function OrderedMap_Clone<K, V>(receiver: GoPtr<OrderedMap<K, V>>): GoPtr<OrderedMap<K, V>>;
/**
 ...
 * }
 */
export declare function OrderedMap_clone<K, V>(receiver: GoPtr<OrderedMap<K, V>>): OrderedMap<K, V>;
/**
 ...
 * }
 */
export declare function OrderedMap_MarshalJSONTo<K, V>(receiver: GoPtr<OrderedMap<K, V>>, enc: GoPtr<Encoder>): GoError;
/**
 ...
 * }
 */
export declare function OrderedMap_UnmarshalJSONFrom<K, V>(receiver: GoPtr<OrderedMap<K, V>>, dec: GoPtr<Decoder>): GoError;
/**
