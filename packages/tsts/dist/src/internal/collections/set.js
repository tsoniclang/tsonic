 ...
 * }
 */
export function NewSetWithSizeHint(hint) {
    return {
 ...
 * }
 */
export function Set_Has(receiver, key) {
 ...
 * }
 */
export function Set_Add(receiver, key) {
 ...
 * }
 */
export function Set_Delete(receiver, key) {
 ...
 * }
 */
export function Set_Len(receiver) {
    if (receiver === undefined) {
        return 0;
    }
 ...
 * }
 */
export function Set_Keys(receiver) {
 ...
 * }
 */
export function Set_Clear(receiver) {
    if (receiver === undefined) {
        return;
    }
    receiver.M?.clear();
 ...
 * }
 */
export function Set_AddIfAbsent(receiver, key) {
 ...
 * }
 */
export function Set_Clone(receiver) {
    if (receiver === undefined) {
        return undefined;
    }
    const clone = { M: maps.Clone(receiver.M ?? new globalThis.Map()) };
    return clone;
}
/**
 ...
 * }
 */
export function Set_Union(receiver, other) {
    ...
    if (receiver.M === undefined) {
        receiver.M = maps.Clone(other?.M ?? new globalThis.Map());
        return;
    }
    maps.Copy(receiver.M, other?.M ?? new globalThis.Map());
}
/**
 ...
 * }
 */
export function Set_UnionedWith(receiver, other) {
    ...
    if (result.M === undefined) {
        result.M = new globalThis.Map();
    }
    maps.Copy(result.M, other.M ?? new globalThis.Map());
    return result;
}
/**
 ...
 * }
 */
export function Set_Equals(receiver, other) {
    if (receiver === other) {
        return true;
    }
    if (receiver === undefined || other === undefined) {
    ...
    return maps.Equal(receiver.M ?? new globalThis.Map(), other.M ?? new globalThis.Map());
}
/**
 ...
 * }
 */
export function Set_IsSubsetOf(receiver, other) {
    if (receiver === undefined) {
        return true;
    }
    for (const key of (receiver.M ?? new globalThis.Map()).keys()) {
 ...
 * }
 */
export function Set_Intersects(receiver, other) {
    if (receiver === undefined || other === undefined) {
        return false;
    }
    for (const key of (receiver.M ?? new globalThis.Map()).keys()) {
 ...
 * }
 */
export function NewSetFromItems(...items) {
    const s = { M: new globalThis.Map() };
