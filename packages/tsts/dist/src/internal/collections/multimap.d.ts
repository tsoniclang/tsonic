 ...
 * }
 */
export declare function NewMultiMapWithSizeHint<K extends GoComparable, V extends GoComparable>(hint: int): GoPtr<MultiMap<K, V>>;
/**
 ...
 * }
 */
export declare function GroupBy<K extends GoComparable, V extends GoComparable>(items: GoSlice<V>, groupId: (arg0: V) => K): GoPtr<MultiMap<K, V>>;
/**
 ...
 * }
 */
export declare function MultiMap_Has<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<MultiMap<K, V>>, key: K): bool;
/**
 ...
 * }
 */
export declare function MultiMap_Get<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<MultiMap<K, V>>, key: K): GoSlice<V>;
/**
 ...
 * }
 */
export declare function MultiMap_Add<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<MultiMap<K, V>>, key: K, value: V): void;
/**
 ...
 * }
 */
export declare function MultiMap_Remove<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<MultiMap<K, V>>, key: K, value: V): void;
/**
 ...
 * }
 */
export declare function MultiMap_RemoveAll<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<MultiMap<K, V>>, key: K): void;
/**
 ...
 * }
 */
export declare function MultiMap_Len<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<MultiMap<K, V>>): int;
/**
 ...
 * }
 */
export declare function MultiMap_Keys<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<MultiMap<K, V>>): GoSeq<K>;
/**
 ...
 * }
 */
export declare function MultiMap_Values<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<MultiMap<K, V>>): GoSeq<GoSlice<V>>;
/**
 ...
 * }
 */
export declare function MultiMap_Clear<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<MultiMap<K, V>>): void;
