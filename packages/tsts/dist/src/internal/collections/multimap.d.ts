 ...
 * }
 */
export declare function MultiMap_Has<K, V>(receiver: GoPtr<MultiMap<K, V>>, key: K): bool;
/**
 ...
 * }
 */
export declare function MultiMap_Get<K, V>(receiver: GoPtr<MultiMap<K, V>>, key: K): GoSlice<V>;
/**
 ...
 * }
 */
export declare function MultiMap_Add<K, V>(receiver: GoPtr<MultiMap<K, V>>, key: K, value: V): void;
/**
 ...
 * }
 */
export declare function MultiMap_Remove<K, V>(receiver: GoPtr<MultiMap<K, V>>, key: K, value: V): void;
/**
 ...
 * }
 */
export declare function MultiMap_RemoveAll<K, V>(receiver: GoPtr<MultiMap<K, V>>, key: K): void;
/**
 ...
 * }
 */
export declare function MultiMap_Len<K, V>(receiver: GoPtr<MultiMap<K, V>>): int;
/**
 ...
 * }
 */
export declare function MultiMap_Keys<K, V>(receiver: GoPtr<MultiMap<K, V>>): GoSeq<K>;
/**
 ...
 * }
 */
export declare function MultiMap_Values<K, V>(receiver: GoPtr<MultiMap<K, V>>): GoSeq<GoSlice<V>>;
/**
 ...
 * }
 */
export declare function MultiMap_Clear<K, V>(receiver: GoPtr<MultiMap<K, V>>): void;
