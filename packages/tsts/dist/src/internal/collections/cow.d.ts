 ...
 * }
 */
export declare function CopyOnWriteMap_Get<K extends GoComparable, V>(receiver: GoPtr<CopyOnWriteMap<K, V>>, k: K): [V, bool];
/**
 ...
 * }
 */
export declare function CopyOnWriteMap_Has<K extends GoComparable, V>(receiver: GoPtr<CopyOnWriteMap<K, V>>, k: K): bool;
/**
 ...
 * }
 */
export declare function CopyOnWriteMap_Set<K extends GoComparable, V>(receiver: GoPtr<CopyOnWriteMap<K, V>>, k: K, v: V): void;
/**
 ...
 * }
 */
export declare function CopyOnWriteMap_ensureOwned<K extends GoComparable, V>(receiver: GoPtr<CopyOnWriteMap<K, V>>): void;
/**
 ...
 * }
 */
export declare function CopyOnWriteMap_EnterScope<K extends GoComparable, V>(receiver: GoPtr<CopyOnWriteMap<K, V>>): () => void;
/**
 ...
 * }
 */
export declare function CopyOnWriteSet_Has<K extends GoComparable>(receiver: GoPtr<CopyOnWriteSet<K>>, k: K): bool;
/**
 ...
 * }
 */
export declare function CopyOnWriteSet_Add<K extends GoComparable>(receiver: GoPtr<CopyOnWriteSet<K>>, k: K): void;
/**
 ...
 * }
 */
export declare function CopyOnWriteSet_EnterScope<K extends GoComparable>(receiver: GoPtr<CopyOnWriteSet<K>>): () => void;
