 ...
 * }
 */
export declare function SyncSet_Has<T>(receiver: GoPtr<SyncSet<T>>, key: T): bool;
/**
 ...
 * }
 */
export declare function SyncSet_Add<T>(receiver: GoPtr<SyncSet<T>>, key: T): void;
/**
 ...
 * }
 */
export declare function SyncSet_AddIfAbsent<T>(receiver: GoPtr<SyncSet<T>>, key: T): bool;
/**
 ...
 * }
 */
export declare function SyncSet_Delete<T>(receiver: GoPtr<SyncSet<T>>, key: T): void;
/**
 ...
 * }
 */
export declare function SyncSet_Range<T>(receiver: GoPtr<SyncSet<T>>, fn: (key: T) => bool): void;
/**
 ...
 * }
 */
export declare function SyncSet_Size<T>(receiver: GoPtr<SyncSet<T>>): int;
/**
 ...
 * }
 */
export declare function SyncSet_IsEmpty<T>(receiver: GoPtr<SyncSet<T>>): bool;
/**
 ...
 * }
 */
export declare function SyncSet_ToSlice<T>(receiver: GoPtr<SyncSet<T>>): GoSlice<T>;
/**
 ...
 * }
 */
export declare function SyncSet_Keys<T>(receiver: GoPtr<SyncSet<T>>): GoSeq<T>;
