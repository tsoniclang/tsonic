 ...
 * }
 */
export declare function SyncSet_Has<T extends GoComparable>(receiver: GoPtr<SyncSet<T>>, key: T): bool;
/**
 ...
 * }
 */
export declare function SyncSet_Add<T extends GoComparable>(receiver: GoPtr<SyncSet<T>>, key: T): void;
/**
 ...
 * }
 */
export declare function SyncSet_AddIfAbsent<T extends GoComparable>(receiver: GoPtr<SyncSet<T>>, key: T): bool;
/**
 ...
 * }
 */
export declare function SyncSet_Delete<T extends GoComparable>(receiver: GoPtr<SyncSet<T>>, key: T): void;
/**
 ...
 * }
 */
export declare function SyncSet_Range<T extends GoComparable>(receiver: GoPtr<SyncSet<T>>, fn: (key: T) => bool): void;
/**
 ...
 * }
 */
export declare function SyncSet_Size<T extends GoComparable>(receiver: GoPtr<SyncSet<T>>): int;
/**
 ...
 * }
 */
export declare function SyncSet_IsEmpty<T extends GoComparable>(receiver: GoPtr<SyncSet<T>>): bool;
/**
 ...
 * }
 */
export declare function SyncSet_ToSlice<T extends GoComparable>(receiver: GoPtr<SyncSet<T>>): GoSlice<T>;
/**
 ...
 * }
 */
export declare function SyncSet_Keys<T extends GoComparable>(receiver: GoPtr<SyncSet<T>>): GoSeq<T>;
//# sourceMappingURL=syncset.d.ts.map