 ...
 * }
 */
export declare function Parse(pattern: string): [GoPtr<Glob>, GoError];
/**
 ...
 * }
 */
export declare function parse(pattern: string, nested: bool): [GoPtr<Glob>, string, GoError];
/**
 ...
 * }
 */
export declare function readRangeRune(input: string): [GoRune, int, GoError];
/**
 ...
 * )
 */
export declare let errBadRange: GoError;
export declare let errInvalidUTF8: GoError;
/**
 ...
 * }
 */
export declare function Glob_parseLiteral(receiver: GoPtr<Glob>, pattern: string, nested: bool): string;
/**
 ...
 * }
 */
export declare function Glob_String(receiver: GoPtr<Glob>): string;
/**
 ...
 */
export declare function slash_String(receiver: slash): string;
/**
 ...
 */
export declare function literal_String(receiver: literal): string;
/**
 ...
 */
export declare function star_String(receiver: star): string;
/**
 ...
 */
export declare function anyChar_String(receiver: anyChar): string;
/**
 ...
 */
export declare function starStar_String(receiver: starStar): string;
/**
 ...
 * }
 */
export declare function group_String(receiver: group): string;
/**
 ...
 * }
 */
export declare function charRange_String(receiver: charRange): string;
/**
 ...
 * }
 */
export declare function Glob_Match(receiver: GoPtr<Glob>, input: string): bool;
/**
 ...
 * }
 */
export declare function match(elems: GoSlice<element>, input: string): bool;
/**
 ...
 * }
 */
export declare function split(input: string): [string, string];
