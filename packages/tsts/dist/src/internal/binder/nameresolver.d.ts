 ...
 * }
 */
export declare function NameResolver_Resolve(receiver: GoPtr<NameResolver>, location: GoPtr<Node>, name: string, meaning: SymbolFlags, nameNotFoundMessage: GoPtr<Message>, isUse: bool, excludeGlobals: bool): GoPtr<Symbol>;
/**
 ...
 * }
 */
export declare function NameResolver_useOuterVariableScopeInParameter(receiver: GoPtr<NameResolver>, result: GoPtr<Symbol>, location: GoPtr<Node>, lastLocation: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function NameResolver_requiresScopeChange(receiver: GoPtr<NameResolver>, node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function NameResolver_requiresScopeChangeWorker(receiver: GoPtr<NameResolver>, node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function NameResolver_error(receiver: GoPtr<NameResolver>, location: GoPtr<Node>, message: GoPtr<Message>, ...args: Array<unknown>): void;
/**
 ...
 * }
 */
export declare function NameResolver_getSymbolOfDeclaration(receiver: GoPtr<NameResolver>, node: GoPtr<Node>): GoPtr<Symbol>;
/**
 ...
 * }
 */
export declare function NameResolver_lookup(receiver: GoPtr<NameResolver>, symbols: SymbolTable | undefined, name: string, meaning: SymbolFlags): GoPtr<Symbol>;
/**
 ...
 * }
 */
export declare function NameResolver_argumentsSymbol(receiver: GoPtr<NameResolver>): GoPtr<Symbol>;
/**
 ...
 * }
 */
export declare function GetLocalSymbolForExportDefault(symbol_: GoPtr<Symbol>): GoPtr<Symbol>;
/**
 ...
 * }
 */
export declare function isExportDefaultSymbol(symbol_: GoPtr<Symbol>): bool;
/**
 ...
 * }
 */
export declare function getIsDeferredContext(location: GoPtr<Node>, lastLocation: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isTypeParameterSymbolDeclaredInContainer(symbol_: GoPtr<Symbol>, container: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isSelfReferenceLocation(node: GoPtr<Node>, lastLocation: GoPtr<Node>): bool;
