...
import { Node_Arguments, Node_Body, Node_Elements, Node_Expression, Node_Initializer, Node_Label, Node_LocalSymbol, Node_Parameters, Node_PostfixToken, Node_Properties, Node_QuestionDotToken, Node_StatementList, Node_Statements, Node_Symbol, Node_Text, Node_Type, Node_TypeArgumentList, AsSourceFile, IsLocalsContainer, SourceFile_BindDiagnostics, SourceFile_BindOnce, SourceFile_Diagnostics, SourceFile_FileName, SourceFile_IsBound, SourceFile_SetBindDiagnostics, } from "../ast/ast.js";
import { AsBinaryExpression, AsBindingElement, AsCallExpression, AsCaseBlock, AsCaseOrDefaultClause, AsCatchClause, AsClassStaticBlockDeclaration, AsConditionalExpression, AsConditionalTypeNode, AsConstructorDeclaration, AsDeleteExpression, AsDoStatement, AsElementAccessExpression, AsExpressionStatement, AsExportAssignment, AsExportDeclaration, AsExportSpecifier, AsForStatement, AsForInOrOfStatement, AsFunctionDeclaration, AsFunctionExpression, AsIdentifier, AsIfStatement, AsImportClause, AsImportEqualsDeclaration, AsKeywordExpression, AsLabeledStatement, AsMetaProperty, AsModuleDeclaration, AsParameterDeclaration, AsPostfixUnaryExpression, AsPrefixUnaryExpression, AsPropertyAccessExpression, AsQualifiedName, AsReturnStatement, AsShorthandPropertyAssignment, AsSwitchStatement, AsTryStatement, AsTypeAliasDeclaration, AsVariableDeclaration, AsWhileStatement, } from "../ast/generated/casts.js";
import { KindAmpersandAmpersandToken, KindAmpersandAmpersandEqualsToken, KindArrowFunction, KindBarBarEqualsToken, KindBinaryExpression, KindBlock, KindCallExpression, KindCallSignature, KindCaseBlock, KindCatchClause, KindClassDeclaration, KindClassExpression, KindClassStaticBlockDeclaration, KindCommaToken, KindConditionalExpression, KindConstructor, KindConstructorType, KindConstructSignature, KindDoStatement, KindElementAccessExpression, KindEnumDeclaration, KindEqualsEqualsEqualsToken, KindEqualsEqualsToken, KindEqualsToken, KindExclamationEqualsEqualsToken, KindExclamationEqualsToken, KindExclamationToken, KindFalseKeyword, KindFirstStatement, KindForInStatement, KindForOfStatement, KindForStatement, KindFunctionDeclaration, KindFunctionExpression, KindFunctionType, KindGetAccessor, KindIdentifier, KindIfStatement, KindIndexSignature, KindInferType, KindInKeyword, KindInstanceOfKeyword, KindInterfaceDeclaration, KindJSTypeAliasDeclaration, KindJsxAttributes, KindLabeledStatement, KindLastStatement, KindLastToken, KindMappedType, KindMetaProperty, KindMethodDeclaration, KindMethodSignature, KindMinusToken, KindMinusMinusToken, KindModuleBlock, KindModuleDeclaration, KindNonNullExpression, KindObjectLiteralExpression, KindParenthesizedExpression, KindPlusToken, KindPlusPlusToken, KindPrefixUnaryExpression, KindPropertyAccessExpression, KindPropertyDeclaration, KindQuestionQuestionEqualsToken, KindQuestionToken, KindSetAccessor, KindSourceFile, KindSuperKeyword, KindThisKeyword, KindTrueKeyword, KindTypeAliasDeclaration, KindTypeLiteral, KindTypeOfExpression, KindArrayLiteralExpression, KindAwaitKeyword, KindBindingElement, KindBreakStatement, KindCaseClause, KindContinueStatement, KindDefaultClause, KindDeleteExpression, KindEndOfFile, KindExportSpecifier, KindExpressionStatement, KindFirstFutureReservedWord, KindImportClause, KindImportEqualsDeclaration, KindImportSpecifier, KindJsxAttribute, KindLastFutureReservedWord, KindNamespaceExportDeclaration, KindNamespaceImport, KindParameter, KindPostfixUnaryExpression, KindPrivateIdentifier, KindPropertyAssignment, KindPropertySignature, KindQualifiedName, KindReturnStatement, KindShorthandPropertyAssignment, KindSpreadAssignment, KindSpreadElement, KindSwitchStatement, KindThisType, KindThrowStatement, KindTryStatement, KindTypeParameter, KindVariableDeclaration, KindVariableDeclarationList, KindWhileStatement, KindWithStatement, KindEnumMember, KindExportDeclaration, KindExportAssignment, KindYieldKeyword, } from "../ast/generated/kinds.js";
import { IsAssignmentOperator, IsBinaryExpression, IsCallExpression, IsClassDeclaration, IsClassStaticBlockDeclaration, IsComputedPropertyName, IsConditionalTypeNode, IsExportAssignment, IsExportDeclaration, IsExportSpecifier, IsExpressionStatement, IsFunctionDeclaration, IsFunctionExpression, IsIdentifier, IsJsxNamespacedName, IsJSTypeAliasDeclaration, IsLogicalOrCoalescingAssignmentOperator, IsModuleBlock, IsModuleDeclaration, IsNamespaceExport, IsNonNullExpression, IsNumericLiteral, IsParenthesizedExpression, IsPrivateIdentifier, IsPrefixUnaryExpression, IsPropertyAccessExpression, IsSourceFile, IsStringLiteral, IsTypeAliasDeclaration, IsTypeOfExpression, IsVariableDeclaration, IsVariableStatement, } from "../ast/generated/predicates.js";
import { Diagnostic_AddRelatedInfo, Diagnostic_SetCategory, NewDiagnostic } from "../ast/diagnostic.js";
import { FlowFlagsArrayMutation, FlowFlagsBranchLabel, FlowFlagsCall, FlowFlagsAssignment, FlowFlagsFalseCondition, FlowFlagsLoopLabel, FlowFlagsReferenced, FlowFlagsReduceLabel, FlowFlagsShared, FlowFlagsStart, FlowFlagsSwitchClause, FlowFlagsTrueCondition, FlowFlagsUnreachable, NewFlowReduceLabelData, NewFlowSwitchClauseData, } from "../ast/flow.js";
import { NodeFlagsAmbient, NodeFlagsAwaitContext, NodeFlagsContainsThis, NodeFlagsConst, NodeFlagsExportContext, NodeFlagsHasAsyncFunctions, NodeFlagsHasExplicitReturn, NodeFlagsHasImplicitReturn, NodeFlagsJSDoc, NodeFlagsOptionalChain, NodeFlagsReachabilityAndEmitFlags, NodeFlagsThisNodeHasError, NodeFlagsThisNodeOrAnySubNodesHasError, NodeFlagsUnreachable, NodeFlagsYieldContext, } from "../ast/nodeflags.js";
import { InternalSymbolNameAssignmentDeclaration, InternalSymbolNameCall, InternalSymbolNameClass, InternalSymbolNameComputed, InternalSymbolNameConstructor, InternalSymbolNameDefault, InternalSymbolNameExportEquals, InternalSymbolNameExportStar, InternalSymbolNameFunction, InternalSymbolNameGlobal, InternalSymbolNameIndex, InternalSymbolNameJSXAttributes, InternalSymbolNameMissing, InternalSymbolNameNew, InternalSymbolNameObject, InternalSymbolNamePrefix, InternalSymbolNameType, SymbolName, } from "../ast/symbol.js";
import { SymbolFlagsAccessor, SymbolFlagsAlias, SymbolFlagsBlockScopedVariable, SymbolFlagsBlockScopedVariableExcludes, SymbolFlagsClass, SymbolFlagsClassExcludes, SymbolFlagsClassMember, SymbolFlagsConstEnum, SymbolFlagsConstEnumExcludes, SymbolFlagsConstEnumOnlyModule, SymbolFlagsConstructor, SymbolFlagsEnum, SymbolFlagsEnumMember, SymbolFlagsEnumMemberExcludes, SymbolFlagsExportStar, SymbolFlagsExportValue, SymbolFlagsFunction, SymbolFlagsFunctionExcludes, SymbolFlagsFunctionScopedVariable, SymbolFlagsFunctionScopedVariableExcludes, SymbolFlagsInterface, SymbolFlagsModuleExports, SymbolFlagsNamespaceModule, SymbolFlagsNamespaceModuleExcludes, SymbolFlagsNone, SymbolFlagsObjectLiteral, SymbolFlagsOptional, SymbolFlagsParameterExcludes, SymbolFlagsProperty, SymbolFlagsPropertyExcludes, SymbolFlagsPrototype, SymbolFlagsRegularEnum, SymbolFlagsReplaceableByMethod, SymbolFlagsSignature, SymbolFlagsTypeAlias, SymbolFlagsTypeAliasExcludes, SymbolFlagsTypeLiteral, SymbolFlagsTypeParameter, SymbolFlagsTypeParameterExcludes, SymbolFlagsValueModule, SymbolFlagsValueModuleExcludes, SymbolFlagsValue, SymbolFlagsAll, SymbolFlagsAliasExcludes, SymbolFlagsAssignment, SymbolFlagsClassifiable, SymbolFlagsVariable, SymbolFlagsGetAccessor, SymbolFlagsGetAccessorExcludes, SymbolFlagsInterfaceExcludes, SymbolFlagsMethod, SymbolFlagsMethodExcludes, SymbolFlagsRegularEnumExcludes, SymbolFlagsSetAccessor, SymbolFlagsSetAccessorExcludes, SymbolFlagsAccessorExcludes, SymbolFlagsType, SymbolFlagsNamespace, } from "../ast/symbolflags.js";
import { ModifierFlagsAsync, ModifierFlagsDefault, ModifierFlagsExport, } from "../ast/modifierflags.js";
import { ExpressionIsAlias, FindAncestor, GetAssignmentDeclarationKind, GetCombinedModifierFlags, GetContainingClass, GetElementOrPropertyAccessName, GetExports, GetLocals, GetMembers, GetModuleInstanceState, GetNameOfDeclaration, GetSymbolId, HasDynamicName, HasSyntacticModifier, IsAccessExpression, IsAmbientModule, IsAsyncFunction, IsAssignmentTarget, IsAutoAccessorPropertyDeclaration, IsBindingPattern, IsBooleanLiteral, IsBlockOrCatchScoped, IsDestructuringAssignment, IsDottedName, IsEntityNameExpression, IsEnumConst, IsExpressionOfOptionalChainRoot, IsExpandoInitializer, IsExternalModule, IsExternalOrCommonJSModule, IsForInOrOfStatement, IsFunctionLike, IsGlobalScopeAugmentation, IsImplicitlyExportedJSTypeAlias, IsInJSFile, IsInTopLevelContext, IsLeftHandSideExpression, IsLogicalExpression, IsLogicalOrCoalescingAssignmentExpression, IsLogicalOrCoalescingBinaryOperator, IsModuleAugmentationExternal, IsNullishCoalesce, IsObjectLiteralMethod, IsObjectLiteralOrClassExpressionMethodOrAccessor, IsOptionalChain, IsOptionalChainRoot, IsOutermostOptionalChain, IsParameterPropertyDeclaration, IsPartOfParameterDeclaration, IsPartOfTypeQuery, IsPotentiallyExecutableNode, IsPrologueDirective, IsPushOrUnshiftIdentifier, IsRequireCall, IsStatic, IsStringLiteralLike, IsStringOrNumericLiteralLike, GetImmediatelyInvokedFunctionExpression, IsDeclarationStatement, IsIdentifierName, IsPropertyNameLiteral, IsVariableDeclarationInitializedToRequire, IsJsonSourceFile, JSDeclarationKindModuleExports, JSDeclarationKindExportsProperty, JSDeclarationKindThisProperty, JSDeclarationKindProperty, JSDeclarationKindObjectDefinePropertyValue, JSDeclarationKindObjectDefinePropertyExports, ModuleExportNameIsDefault, ModuleInstanceStateNonInstantiated, ModuleInstanceStateConstEnumOnly, NodeIsMissing, NodeIsPresent, SkipParentheses, } from "../ast/utilities.js";
import { Set_Add, Set_Has, NewSetWithSizeHint, } from "../collections/set.js";
...
import { A_label_is_not_allowed_here, A_module_cannot_have_multiple_default_exports, Another_export_default_is_here, Cannot_redeclare_block_scoped_variable_0, Code_contained_in_a_class_is_evaluated_in_JavaScript_s_strict_mode_which_does_not_allow_this_use_of_0_For_more_information_see_https_Colon_Slash_Slashdeveloper_mozilla_org_Slashen_US_Slashdocs_SlashWeb_SlashJavaScript_SlashReference_SlashStrict_mode, Did_you_mean_0, Duplicate_identifier_0, Enum_declarations_can_only_merge_with_namespace_or_other_enum_declarations, Function_declarations_are_not_allowed_inside_blocks_in_strict_mode_when_targeting_ES5, Function_declarations_are_not_allowed_inside_blocks_in_strict_mode_when_targeting_ES5_Class_definitions_are_automatically_in_strict_mode, Function_declarations_are_not_allowed_inside_blocks_in_strict_mode_when_targeting_ES5_Modules_are_automatically_in_strict_mode, Global_module_exports_may_only_appear_at_top_level, Global_module_exports_may_only_appear_in_declaration_files, Global_module_exports_may_only_appear_in_module_files, Identifier_expected_0_is_a_reserved_word_at_the_top_level_of_a_module, Identifier_expected_0_is_a_reserved_word_in_strict_mode, Identifier_expected_0_is_a_reserved_word_in_strict_mode_Class_definitions_are_automatically_in_strict_mode, Identifier_expected_0_is_a_reserved_word_in_strict_mode_Modules_are_automatically_in_strict_mode, Identifier_expected_0_is_a_reserved_word_that_cannot_be_used_here, Invalid_use_of_0_in_strict_mode, Invalid_use_of_0_Modules_are_automatically_in_strict_mode, Modifiers_cannot_appear_here, Pattern_0_can_have_at_most_one_Asterisk_character, The_first_export_default_is_here, X_and_here, X_constructor_is_a_reserved_word, X_delete_cannot_be_called_on_an_identifier_in_strict_mode, X_export_modifier_cannot_be_applied_to_ambient_modules_and_module_augmentations_since_they_are_always_visible, X_with_statements_are_not_allowed_in_strict_mode, } from "../diagnostics/generated/messages.js";
import { GetSourceTextOfNodeFromSourceFile, DeclarationNameToString, } from "../scanner/utilities.js";
import { GetErrorRangeForNode, GetIdentifierToken, GetRangeOfTokenAtPosition, TokenToString, } from "../scanner/scanner.js";
 ...
 * )
 */
export const ContainerFlagsNone = 0;
export const ContainerFlagsIsContainer = 1 << 0;
export const ContainerFlagsIsBlockScopedContainer = 1 << 1;
export const ContainerFlagsIsControlFlowContainer = 1 << 2;
export const ContainerFlagsIsFunctionLike = 1 << 3;
export const ContainerFlagsIsFunctionExpression = 1 << 4;
export const ContainerFlagsHasLocals = 1 << 5;
export const ContainerFlagsIsInterface = 1 << 6;
export const ContainerFlagsIsObjectLiteralOrClassExpressionMethodOrAccessor = 1 << 7;
export const ContainerFlagsIsThisContainer = 1 << 8;
export const ContainerFlagsPropagatesThisKeyword = 1 << 9;
/**
 ...
 */
export function ActiveLabel_BreakTarget(receiver) {
 ...
 */
export function ActiveLabel_ContinueTarget(receiver) {
 ...
 * }
 */
export const binderPool = new Pool();
/**
...
export function putBinder(b) {
    ...
    const bAsRecord = b;
    const keys = globalThis.Object.keys(bAsRecord);
 ...
 * }
 */
export function Binder_newSymbol(receiver, flags, name) {
    receiver.symbolCount = (receiver.symbolCount + 1);
 ...
 * }
 */
export function Binder_declareSymbol(receiver, symbolTable, parent, node, includes, excludes) {
 ...
 * }
 */
export function Binder_declareSymbolEx(receiver, symbolTable, parent, node, includes, excludes, isReplaceableByMethod, isComputedName) {
    // debug.Assert(isComputedName || !ast.HasDynamicName(node))
    ...
    if (name === InternalSymbolNameMissing) {
        ...
        if (symbol === undefined) {
            ...
            if (isReplaceableByMethod) {
                symbol.Flags = (symbol.Flags | SymbolFlagsReplaceableByMethod);
            }
        }
            ...
            if ((symbol.Flags & SymbolFlagsReplaceableByMethod) !== 0) {
                ...
                let declarationName = GetNameOfDeclaration(node);
                ...
                if (IsTypeAliasDeclaration(node) && NodeIsMissing(Node_Type(node)) && HasSyntacticModifier(node, ModifierFlagsExport) && (symbol.Flags & (SymbolFlagsAlias | SymbolFlagsType | SymbolFlagsNamespace)) !== 0) {
                    Diagnostic_AddRelatedInfo(diag, Binder_createDiagnosticForNode(receiver, node, Did_you_mean_0, "export type { " + Node_Text(AsTypeAliasDeclaration(node).name) + " }"));
                }
                for (let index = 0; index < (symbol.Declarations ?? []).length; index++) {
                    const declaration = symbol.Declarations[index];
                    let decl = GetNameOfDeclaration(declaration);
                    if (decl === undefined) {
                        decl = declaration;
                    }
                    let d;
                ...
                if ((symbol.Flags & SymbolFlagsAccessor) !== 0 && (symbol.Flags & SymbolFlagsAccessor) !== (includes & SymbolFlagsAccessor)) {
                    symbol.Flags = (symbol.Flags | SymbolFlagsAccessor);
                }
                symbol = Binder_newSymbol(receiver, SymbolFlagsNone, name);
            }
        }
 ...
 * }
 */
export function Binder_getDeclarationName(receiver, node) {
    ...
    if (name !== undefined) {
        ...
        if (IsComputedPropertyName(name)) {
            ...
            if (isSignedNumericLiteral(nameExpression)) {
                ...
                return TokenToString(unaryExpression.Operator) + Node_Text(unaryExpression.Operand);
            }
 ...
 * }
 */
export function Binder_getDisplayName(receiver, node) {
 ...
 * }
 */
export function GetSymbolNameForPrivateIdentifier(containingClassSymbol, description) {
 ...
 * }
 */
export function Binder_declareModuleMember(receiver, node, symbolFlags, symbolExcludes) {
    ...
    if (!IsAmbientModule(node) && (hasExportModifier || (container.Flags & NodeFlagsExportContext) !== 0)) {
        ...
        const exportKind = (symbolFlags & SymbolFlagsValue) !== 0 ? SymbolFlagsExportValue : SymbolFlagsNone;
 ...
 * }
 */
export function Binder_declareClassMember(receiver, node, symbolFlags, symbolExcludes) {
    if (IsStatic(node)) {
 ...
 * }
 */
export function Binder_declareSourceFileMember(receiver, node, symbolFlags, symbolExcludes) {
    if (IsExternalOrCommonJSModule(receiver.file)) {
        return Binder_declareModuleMember(receiver, node, symbolFlags, symbolExcludes);
    }
    return Binder_declareSymbol(receiver, GetLocals(Node_AsNode(receiver.file)), undefined, node, symbolFlags, symbolExcludes);
}
/**
 ...
 * }
 */
export function Binder_declareSymbolAndAddToSymbolTable(receiver, node, symbolFlags, symbolExcludes) {
 ...
 * }
 */
export function Binder_newFlowNode(receiver, flags) {
 ...
 * }
 */
export function Binder_newFlowNodeEx(receiver, flags, node, antecedent) {
 ...
 * }
 */
export function Binder_createLoopLabel(receiver) {
 ...
 * }
 */
export function Binder_createBranchLabel(receiver) {
 ...
 * }
 */
export function Binder_createReduceLabel(receiver, target, antecedents, antecedent) {
 ...
 * }
 */
export function Binder_createFlowCondition(receiver, flags, antecedent, expression) {
 ...
 * }
 */
export function Binder_createFlowMutation(receiver, flags, antecedent, node) {
    setFlowNodeReferenced(antecedent);
 ...
 * }
 */
export function Binder_createFlowSwitchClause(receiver, antecedent, switchStatement, clauseStart, clauseEnd) {
    setFlowNodeReferenced(antecedent);
 ...
 * }
 */
export function Binder_createFlowCall(receiver, antecedent, node) {
    setFlowNodeReferenced(antecedent);
    receiver.hasFlowEffects = true;
 ...
 * }
 */
export function Binder_newFlowList(receiver, head, tail) {
 ...
 * }
 */
export function Binder_combineFlowLists(receiver, head, tail) {
    if (head === undefined) {
        return tail;
    }
 ...
 * }
 */
export function Binder_newSingleDeclaration(receiver, declaration) {
 ...
 * }
 */
export function setFlowNodeReferenced(flow) {
    // On first reference we set the Referenced flag, thereafter we set the Shared flag
    if ((flow.Flags & FlowFlagsReferenced) === 0) {
        flow.Flags = (flow.Flags | FlowFlagsReferenced);
    }
    else {
        flow.Flags = (flow.Flags | FlowFlagsShared);
    }
}
/**
 ...
 * }
 */
export function Binder_addAntecedent(receiver, label, antecedent) {
    if ((antecedent.Flags & FlowFlagsUnreachable) !== 0) {
        return;
    }
    let last = undefined;
 ...
 * }
 */
export function Binder_finishFlowLabel(receiver, label) {
 ...
 * }
 */
export function Binder_bind(receiver, node) {
    if (node === undefined) {
        return false;
    }
    ...
    switch (node.Kind) {
        ...
        case KindMethodDeclaration:
        case KindMethodSignature:
            Binder_bindPropertyOrMethodOrAccessor(receiver, node, (SymbolFlagsMethod | getOptionalSymbolFlagForNode(node)), IfElse(IsObjectLiteralMethod(node), SymbolFlagsPropertyExcludes, SymbolFlagsMethodExcludes));
            break;
        case KindFunctionDeclaration:
    ...
    if (thisNodeOrAnySubnodesHasError) {
        node.Flags = (node.Flags | NodeFlagsThisNodeOrAnySubNodesHasError);
        receiver.seenParseError = true;
    }
    receiver.parent = saveParent;
    return false;
}
function Binder_bindBinaryExpressionNode(receiver, node) {
 ...
 * }
 */
export function Binder_bindPropertyWorker(receiver, node) {
    const isAutoAccessor = IsAutoAccessorPropertyDeclaration(node);
    const includes = IfElse(isAutoAccessor, SymbolFlagsAccessor, SymbolFlagsProperty);
    const excludes = IfElse(isAutoAccessor, SymbolFlagsAccessorExcludes, SymbolFlagsPropertyExcludes);
    Binder_bindPropertyOrMethodOrAccessor(receiver, node, (includes | getOptionalSymbolFlagForNode(node)), excludes);
}
/**
 ...
 * }
 */
export function Binder_bindSourceFileIfExternalModule(receiver) {
    const fileNode = receiver.file;
 ...
 * }
 */
export function Binder_bindSourceFileAsExternalModule(receiver) {
    Binder_bindAnonymousDeclaration(receiver, receiver.file, SymbolFlagsValueModule, "\"" + RemoveFileExtension(SourceFile_FileName(receiver.file)) + "\"");
}
/**
 ...
 * }
 */
export function Binder_bindModuleDeclaration(receiver, node) {
    ...
    if (IsAmbientModule(node)) {
        ...
        if (state !== ModuleInstanceStateNonInstantiated) {
            ...
            if (constEnumOnlyModule) {
                symbol.Flags = (symbol.Flags | SymbolFlagsConstEnumOnlyModule);
            }
            else {
                symbol.Flags = (symbol.Flags & ~SymbolFlagsConstEnumOnlyModule);
 ...
 * }
 */
export function Binder_declareModuleSymbol(receiver, node) {
    const state = GetModuleInstanceState(node);
    const instantiated = state !== ModuleInstanceStateNonInstantiated;
    Binder_declareSymbolAndAddToSymbolTable(receiver, node, IfElse(instantiated, SymbolFlagsValueModule, SymbolFlagsNamespaceModule), IfElse(instantiated, SymbolFlagsValueModuleExcludes, SymbolFlagsNamespaceModuleExcludes));
    return state;
}
/**
 ...
 * }
 */
export function Binder_bindNamespaceExportDeclaration(receiver, node) {
    ...
    if (!IsSourceFile(node.Parent)) {
        ...
        Binder_declareSymbol(receiver, receiver.file.GlobalExports, Node_Symbol(receiver.file), node, SymbolFlagsAlias, SymbolFlagsAliasExcludes);
    }
}
/**
 ...
 * }
 */
export function Binder_bindImportClause(receiver, node) {
 ...
 * }
 */
export function Binder_bindExportDeclaration(receiver, node) {
    ...
    if (Node_Symbol(receiver.container) === undefined) {
        ...
        Binder_declareSymbol(receiver, GetExports(Node_Symbol(receiver.container)), Node_Symbol(receiver.container), decl.ExportClause, SymbolFlagsAlias, SymbolFlagsAliasExcludes);
    }
}
/**
 ...
 * }
 */
export function Binder_bindExportAssignment(receiver, node) {
    const container = receiver.container;
    if (Node_Symbol(container) === undefined && IsExportAssignment(node)) {
        ...
        const flags = IfElse(ExpressionIsAlias(Node_Expression(node)), SymbolFlagsAlias, SymbolFlagsProperty);
 ...
 * }
 */
export function Binder_trackNestedCJSExport(receiver, node) {
 ...
 * }
 */
export function Binder_bindJsxAttributes(receiver, node) {
 ...
 * }
 */
export function Binder_bindJsxAttribute(receiver, node, symbolFlags, symbolExcludes) {
 ...
 * }
 */
export function Binder_setExportContextFlag(receiver, node) {
    if ((node.Flags & NodeFlagsAmbient) !== 0 && !Binder_hasExportDeclarations(receiver, node)) {
        node.Flags = (node.Flags | NodeFlagsExportContext);
    }
    else {
        node.Flags = (node.Flags & ~NodeFlagsExportContext);
    }
 ...
 * }
 */
export function Binder_hasExportDeclarations(receiver, node) {
    let statements = [];
    switch (node.Kind) {
        case KindSourceFile:
 ...
 * }
 */
export function Binder_bindFunctionExpression(receiver, node) {
    if (!receiver.file.IsDeclarationFile && (node.Flags & NodeFlagsAmbient) === 0 && IsAsyncFunction(node)) {
        receiver.emitFlags = (receiver.emitFlags | NodeFlagsHasAsyncFunctions);
    }
    setFlowNode(node, receiver.currentFlow);
    ...
    if (IsFunctionExpression(node) && AsFunctionExpression(node).name !== undefined) {
        ...
        bindingName = Node_Text(AsFunctionExpression(node).name);
    }
 ...
 * }
 */
export function Binder_bindCallExpression(receiver, node) {
 ...
 * }
 */
export function Binder_setCommonJSModuleIndicator(receiver, node) {
    const fileNode = receiver.file;
 ...
 * }
 */
export function Binder_bindClassLikeDeclaration(receiver, node) {
    ...
    const symbol = Node_Symbol(node);
    const prototypeSymbol = Binder_newSymbol(receiver, (SymbolFlagsProperty | SymbolFlagsPrototype), "prototype");
 ...
 * }
 */
export function Binder_bindPropertyOrMethodOrAccessor(receiver, node, symbolFlags, symbolExcludes) {
    if (!receiver.file.IsDeclarationFile && (node.Flags & NodeFlagsAmbient) === 0 && IsAsyncFunction(node)) {
        receiver.emitFlags = (receiver.emitFlags | NodeFlagsHasAsyncFunctions);
    }
 ...
 * }
 */
export function Binder_bindFunctionOrConstructorType(receiver, node) {
    ...
    typeLiteralSymbol.Members = new globalThis.Map();
 ...
 * }
 */
export function Binder_addLateBoundAssignmentDeclarationToSymbol(receiver, node, symbol_) {
 ...
 * }
 */
export function Binder_bindModuleExportsAssignment(receiver, node) {
    if (Binder_setCommonJSModuleIndicator(receiver, node)) {
        Binder_trackNestedCJSExport(receiver, node);
        const container = receiver.file;
        const flags = IfElse(ExpressionIsAlias(AsBinaryExpression(node).Right), SymbolFlagsAlias, SymbolFlagsProperty);
        const symbol = Binder_declareSymbol(receiver, GetExports(Node_Symbol(container)), Node_Symbol(container), node, flags, 0);
        SetValueDeclaration(symbol, node);
    }
}
/**
 ...
 * }
 */
export function Binder_bindExpandoPropertyAssignment(receiver, node) {
 ...
 * }
 */
export function Binder_bindDeferredExpandoAssignments(receiver) {
 ...
 * }
 */
export function Binder_bindCommonJSTypeExports(receiver, moduleSymbol) {
    ...
    if (exportEquals !== undefined) {
        for (const [, symbol_] of moduleExports) {
            if (symbol_.Name !== InternalSymbolNameExportEquals && (symbol_.Flags & (SymbolFlagsType | SymbolFlagsNamespace)) !== 0) {
                ...
                exportEquals.Flags = (exportEquals.Flags | SymbolFlagsNamespaceModule);
            }
        }
    }
}
 ...
 * }
 */
export function Binder_bindDeferredExpandoAssignment(receiver, node) {
    ...
    if (symbol !== undefined) {
        if (HasDynamicName(node)) {
            Binder_bindAnonymousDeclaration(receiver, node, (SymbolFlagsProperty | SymbolFlagsAssignment), InternalSymbolNameComputed);
            ...
            if (existing === undefined || (existing.Flags & SymbolFlagsAssignment) !== 0) {
                Binder_declareSymbol(receiver, exports, symbol, node, (SymbolFlagsProperty | SymbolFlagsAssignment), SymbolFlagsPropertyExcludes);
            }
        }
    }
}
 ...
 * }
 */
export function getParentOfPropertyAssignment(node) {
    switch (node.Kind) {
        case KindBinaryExpression:
 ...
 * }
 */
export function Binder_bindExportsOrObjectDefineProperty(receiver, node) {
    if (Binder_setCommonJSModuleIndicator(receiver, node)) {
        Binder_trackNestedCJSExport(receiver, node);
        const container = receiver.file;
        const flags = IfElse(IsBinaryExpression(node) && ExpressionIsAlias(AsBinaryExpression(node).Right), SymbolFlagsAlias, SymbolFlagsFunctionScopedVariable);
 ...
 * }
 */
export function getInitializerSymbol(symbol_) {
 ...
 * }
 */
export function Binder_bindThisPropertyAssignment(receiver, node) {
    if (!IsInJSFile(node)) {
        return;
    }
    const bin = AsBinaryExpression(node);
    if (IsPropertyAccessExpression(bin.Left) && IsPrivateIdentifier(AsPropertyAccessExpression(bin.Left).name) || receiver.thisContainer === undefined) {
        return;
    }
    ...
    if (symbolTable !== undefined) {
        if (HasDynamicName(node)) {
            ...
            Binder_declareSymbolEx(receiver, symbolTable, classSymbol, node, (SymbolFlagsProperty | SymbolFlagsAssignment), SymbolFlagsNone, true, false);
        }
    }
 ...
 * }
 */
export function Binder_getThisClassAndSymbolTable(receiver) {
 ...
 * }
 */
export function Binder_bindEnumDeclaration(receiver, node) {
    if (IsEnumConst(node)) {
 ...
 * }
 */
export function Binder_bindVariableDeclarationOrBindingElement(receiver, node) {
 ...
 * }
 */
export function Binder_bindParameter(receiver, node) {
    ...
    if (IsBindingPattern(Node_Name(decl))) {
        ...
        Binder_bindAnonymousDeclaration(receiver, node, SymbolFlagsFunctionScopedVariable, "__" + strconv.Itoa(index));
    }
    else {
        Binder_declareSymbolAndAddToSymbolTable(receiver, node, SymbolFlagsFunctionScopedVariable, SymbolFlagsParameterExcludes);
    }
    if (IsParameterPropertyDeclaration(node, node.Parent)) {
        ...
        const flags = (SymbolFlagsProperty | IfElse(decl.QuestionToken !== undefined, SymbolFlagsOptional, SymbolFlagsNone));
 ...
 * }
 */
export function Binder_bindFunctionDeclaration(receiver, node) {
    if (!receiver.file.IsDeclarationFile && (node.Flags & NodeFlagsAmbient) === 0 && IsAsyncFunction(node)) {
        receiver.emitFlags = (receiver.emitFlags | NodeFlagsHasAsyncFunctions);
    }
    Binder_checkStrictModeFunctionName(receiver, node);
 ...
 * }
 */
export function Binder_getInferTypeContainer(receiver, node) {
 ...
 * }
 */
export function Binder_bindAnonymousDeclaration(receiver, node, symbolFlags, name) {
 ...
 * }
 */
export function Binder_bindBlockScopedDeclaration(receiver, node, symbolFlags, symbolExcludes) {
 ...
 * }
 */
export function Binder_bindTypeParameter(receiver, node) {
 ...
 * }
 */
export function Binder_lookupEntity(receiver, node, container) {
 ...
 * }
 */
export function Binder_lookupName(receiver, name, container) {
 ...
 * }
 */
export function Binder_checkContextualIdentifier(receiver, node) {
 ...
 * }
 */
export function Binder_checkPrivateIdentifier(receiver, node) {
 ...
 * }
 */
export function Binder_getStrictModeIdentifierMessage(receiver, node) {
 ...
 * }
 */
export function isUseStrictPrologueDirective(sourceFile, node) {
 ...
 * }
 */
export function FindUseStrictPrologue(sourceFile, statements) {
 ...
 * }
 */
export function Binder_checkStrictModeFunctionName(receiver, node) {
    if ((node.Flags & NodeFlagsAmbient) === 0) {
        Binder_checkStrictModeEvalOrArguments(receiver, node, Node_Name(node));
    }
}
 ...
 * }
 */
export function Binder_getStrictModeBlockScopeFunctionDeclarationMessage(receiver, node) {
    if (GetContainingClass(node) !== undefined) {
 ...
 * }
 */
export function Binder_checkStrictModeBinaryExpression(receiver, node) {
 ...
 * }
 */
export function Binder_checkStrictModeCatchClause(receiver, node) {
 ...
 * }
 */
export function Binder_checkStrictModeDeleteExpression(receiver, node) {
 ...
 * }
 */
export function Binder_checkStrictModePostfixUnaryExpression(receiver, node) {
 ...
 * }
 */
export function Binder_checkStrictModePrefixUnaryExpression(receiver, node) {
 ...
 * }
 */
export function Binder_checkStrictModeWithStatement(receiver, node) {
 ...
 * }
 */
export function Binder_checkStrictModeLabeledStatement(receiver, node) {
 ...
 * }
 */
export function isEvalOrArgumentsIdentifier(node) {
    if (IsIdentifier(node)) {
 ...
 * }
 */
export function Binder_checkStrictModeEvalOrArguments(receiver, contextNode, name) {
 ...
 * }
 */
export function Binder_getStrictModeEvalOrArgumentsMessage(receiver, node) {
    if (GetContainingClass(node) !== undefined) {
 ...
 * }
 */
export function Binder_bindContainer(receiver, node, containerFlags) {
    ...
    if ((containerFlags & ContainerFlagsIsControlFlowContainer) !== 0) {
        ...
        Binder_bindChildren(receiver, node);
        node.Flags = (node.Flags & ~(NodeFlagsReachabilityAndEmitFlags | NodeFlagsContainsThis));
        if ((receiver.currentFlow.Flags & FlowFlagsUnreachable) === 0 && (containerFlags & ContainerFlagsIsFunctionLike) !== 0) {
            ...
            if (bodyData !== undefined && NodeIsPresent(bodyData.Body)) {
                node.Flags = (node.Flags | NodeFlagsHasImplicitReturn);
                if (receiver.hasExplicitReturn) {
                    node.Flags = (node.Flags | NodeFlagsHasExplicitReturn);
                }
        ...
        if (node.Kind === KindSourceFile) {
            node.Flags = (node.Flags | receiver.emitFlags);
 ...
 * }
 */
export function Binder_declareCommonJSVariable(receiver, name) {
    const fileNode = receiver.file;
    const locals = GetLocals(fileNode);
    if (locals !== undefined && locals.get(name) === undefined) {
        const symbol = Binder_newSymbol(receiver, (SymbolFlagsFunctionScopedVariable | SymbolFlagsModuleExports), name);
        symbol.Declarations = Binder_newSingleDeclaration(receiver, fileNode);
        symbol.ValueDeclaration = symbol.Declarations[0];
        if (name === "module") {
            const exportsProperty = Binder_newSymbol(receiver, (SymbolFlagsModuleExports | SymbolFlagsProperty), "exports");
            exportsProperty.Declarations = symbol.Declarations;
            exportsProperty.ValueDeclaration = symbol.ValueDeclaration;
            exportsProperty.Parent = symbol;
            symbol.Members = new globalThis.Map();
 ...
 * }
 */
export function Binder_bindChildren(receiver, node) {
    ...
    if (receiver.currentFlow === receiver.unreachableFlow) {
        ...
        if (IsPotentiallyExecutableNode(node)) {
            node.Flags = (node.Flags | NodeFlagsUnreachable);
        }
    ...
    switch (node.Kind) {
        ...
        case KindSourceFile: {
            ...
            Binder_bind(receiver, sourceFile.EndOfFileToken);
            break;
        }
        case KindBlock:
 ...
 * }
 */
export function Binder_bindEachChild(receiver, node) {
 ...
 * }
 */
export function Binder_bindEach(receiver, nodes) {
 ...
 * }
 */
export function Binder_bindNodeList(receiver, nodeList) {
 ...
 * }
 */
export function Binder_bindModifiers(receiver, modifiers) {
 ...
 * }
 */
export function Binder_bindEachStatementFunctionsFirst(receiver, statements) {
 ...
 * }
 */
export function Binder_setContinueTarget(receiver, node, target) {
 ...
 * }
 */
export function Binder_doWithConditionalBranches(receiver, action, value, trueTarget, falseTarget) {
 ...
 * }
 */
export function Binder_bindCondition(receiver, node, trueTarget, falseTarget) {
 ...
 * }
 */
export function Binder_bindIterativeStatement(receiver, node, breakTarget, continueTarget) {
    const saveBreakTarget = receiver.currentBreakTarget;
    const saveContinueTarget = receiver.currentContinueTarget;
 ...
 * }
 */
export function isLogicalAssignmentExpression(node) {
 ...
 * }
 */
export function Binder_bindAssignmentTargetFlow(receiver, node) {
    switch (node.Kind) {
        case KindArrayLiteralExpression:
            ...
            for (const p of Node_Properties(node)) {
                switch (p.Kind) {
                    case KindPropertyAssignment:
                        ...
                        break;
                    case KindShorthandPropertyAssignment:
                        Binder_bindAssignmentTargetFlow(receiver, AsShorthandPropertyAssignment(p).name);
                        break;
 ...
 * }
 */
export function Binder_bindDestructuringTargetFlow(receiver, node) {
 ...
 * }
 */
export function Binder_bindWhileStatement(receiver, node) {
    ...
    Binder_bindCondition(receiver, stmt.Expression, preBodyLabel, postWhileLabel);
    receiver.currentFlow = Binder_finishFlowLabel(receiver, preBodyLabel);
    Binder_bindIterativeStatement(receiver, stmt.Statement, postWhileLabel, preWhileLabel);
    Binder_addAntecedent(receiver, preWhileLabel, receiver.currentFlow);
 ...
 * }
 */
export function Binder_bindDoStatement(receiver, node) {
    ...
    Binder_bindIterativeStatement(receiver, stmt.Statement, postDoLabel, preConditionLabel);
    ...
    Binder_bindCondition(receiver, stmt.Expression, preDoLabel, postDoLabel);
 ...
 * }
 */
export function Binder_bindForStatement(receiver, node) {
    ...
    Binder_bind(receiver, stmt.Initializer);
    Binder_addAntecedent(receiver, preLoopLabel, receiver.currentFlow);
    receiver.currentFlow = preLoopLabel;
    Binder_bindCondition(receiver, stmt.Condition, preBodyLabel, postLoopLabel);
    receiver.currentFlow = Binder_finishFlowLabel(receiver, preBodyLabel);
    Binder_bindIterativeStatement(receiver, stmt.Statement, postLoopLabel, preIncrementorLabel);
    ...
    Binder_bind(receiver, stmt.Incrementor);
    Binder_addAntecedent(receiver, preLoopLabel, receiver.currentFlow);
 ...
 * }
 */
export function Binder_bindForInOrForOfStatement(receiver, node) {
    const stmt = AsForInOrOfStatement(node);
    const preLoopLabel = Binder_setContinueTarget(receiver, node, Binder_createLoopLabel(receiver));
    const postLoopLabel = Binder_createBranchLabel(receiver);
    Binder_bind(receiver, stmt.Expression);
    Binder_addAntecedent(receiver, preLoopLabel, receiver.currentFlow);
    receiver.currentFlow = preLoopLabel;
    if (node.Kind === KindForOfStatement) {
        Binder_bind(receiver, stmt.AwaitModifier);
    }
    Binder_addAntecedent(receiver, postLoopLabel, receiver.currentFlow);
    Binder_bind(receiver, stmt.Initializer);
    if (stmt.Initializer.Kind !== KindVariableDeclarationList) {
        Binder_bindAssignmentTargetFlow(receiver, stmt.Initializer);
    }
    Binder_bindIterativeStatement(receiver, stmt.Statement, postLoopLabel, preLoopLabel);
    Binder_addAntecedent(receiver, preLoopLabel, receiver.currentFlow);
    receiver.currentFlow = Binder_finishFlowLabel(receiver, postLoopLabel);
}
/**
 ...
 * }
 */
export function Binder_bindIfStatement(receiver, node) {
    ...
    Binder_bindCondition(receiver, stmt.Expression, thenLabel, elseLabel);
    receiver.currentFlow = Binder_finishFlowLabel(receiver, thenLabel);
    Binder_bind(receiver, stmt.ThenStatement);
    ...
    Binder_bind(receiver, stmt.ElseStatement);
    Binder_addAntecedent(receiver, postIfLabel, receiver.currentFlow);
 ...
 * }
 */
export function Binder_bindReturnStatement(receiver, node) {
 ...
 * }
 */
export function Binder_bindThrowStatement(receiver, node) {
    Binder_bind(receiver, Node_Expression(node));
    receiver.currentFlow = receiver.unreachableFlow;
    receiver.hasFlowEffects = true;
}
 ...
 * }
 */
export function Binder_bindBreakStatement(receiver, node) {
 ...
 * }
 */
export function Binder_bindContinueStatement(receiver, node) {
 ...
 * }
 */
export function Binder_bindBreakOrContinueStatement(receiver, label, currentTarget, getTarget) {
    Binder_bind(receiver, label);
    if (label !== undefined) {
        const activeLabel = Binder_findActiveLabel(receiver, Node_Text(label));
        if (activeLabel !== undefined) {
            activeLabel.referenced = true;
            Binder_bindBreakOrContinueFlow(receiver, getTarget(activeLabel));
        }
    }
    else {
        Binder_bindBreakOrContinueFlow(receiver, currentTarget);
    }
}
/**
 ...
 * }
 */
export function Binder_findActiveLabel(receiver, name) {
    let label = receiver.activeLabelList;
 ...
 * }
 */
export function Binder_bindBreakOrContinueFlow(receiver, flowLabel) {
 ...
 * }
 */
export function Binder_bindTryStatement(receiver, node) {
    ...
    Binder_bind(receiver, stmt.TryBlock);
    ...
    if (stmt.CatchClause !== undefined) {
        ...
        Binder_addAntecedent(receiver, exceptionLabel, receiver.currentFlow);
        receiver.currentExceptionTarget = exceptionLabel;
        Binder_bind(receiver, stmt.CatchClause);
        Binder_addAntecedent(receiver, normalExitLabel, receiver.currentFlow);
    }
    receiver.currentReturnTarget = saveReturnTarget;
    receiver.currentExceptionTarget = saveExceptionTarget;
    if (stmt.FinallyBlock !== undefined) {
        ...
        Binder_bind(receiver, stmt.FinallyBlock);
 ...
 * }
 */
export function Binder_bindSwitchStatement(receiver, node) {
    ...
    Binder_bind(receiver, stmt.CaseBlock);
    Binder_addAntecedent(receiver, postSwitchLabel, receiver.currentFlow);
    const hasDefault = Some(AsCaseBlock(stmt.CaseBlock).Clauses.Nodes, (c) => (c.Kind === KindDefaultClause));
    if (!hasDefault) {
        Binder_addAntecedent(receiver, postSwitchLabel, Binder_createFlowSwitchClause(receiver, receiver.preSwitchCaseFlow, node, 0, 0));
    }
    receiver.currentBreakTarget = saveBreakTarget;
 ...
 * }
 */
export function Binder_bindCaseBlock(receiver, node) {
    ...
    let fallthroughFlow = receiver.unreachableFlow;
    let i = 0;
    while (i < clauses.length) {
        ...
        let preCaseFlow = receiver.preSwitchCaseFlow;
        if (isNarrowingSwitch) {
            preCaseFlow = Binder_createFlowSwitchClause(receiver, receiver.preSwitchCaseFlow, switchStatement, clauseStart, (i + 1));
        }
 ...
 * }
 */
export function Binder_bindCaseOrDefaultClause(receiver, node) {
    const clause = AsCaseOrDefaultClause(node);
    if (clause.Expression !== undefined) {
        const saveCurrentFlow = receiver.currentFlow;
        receiver.currentFlow = receiver.preSwitchCaseFlow;
        Binder_bind(receiver, clause.Expression);
        receiver.currentFlow = saveCurrentFlow;
    }
 ...
 * }
 */
export function Binder_bindExpressionStatement(receiver, node) {
    const stmt = AsExpressionStatement(node);
    Binder_bind(receiver, stmt.Expression);
    Binder_maybeBindExpressionFlowIfCall(receiver, stmt.Expression);
}
/**
 ...
 * }
 */
export function Binder_maybeBindExpressionFlowIfCall(receiver, node) {
 ...
 * }
 */
export function Binder_bindLabeledStatement(receiver, node) {
    ...
    receiver.activeLabelList = {
        ...
        name: Node_Text(stmt.Label),
        breakTarget: postStatementLabel,
        continueTarget: undefined,
        referenced: false,
    };
    Binder_bind(receiver, stmt.Label);
    Binder_bind(receiver, stmt.Statement);
    if (!receiver.activeLabelList.referenced) {
        stmt.Label.Flags = (stmt.Label.Flags | NodeFlagsUnreachable);
    }
 ...
 * }
 */
export function Binder_bindPrefixUnaryExpressionFlow(receiver, node) {
    const expr = AsPrefixUnaryExpression(node);
    if (expr.Operator === KindExclamationToken) {
        ...
        Binder_bindEachChild(receiver, node);
        if (expr.Operator === KindPlusPlusToken || expr.Operator === KindMinusMinusToken) {
            Binder_bindAssignmentTargetFlow(receiver, expr.Operand);
        }
    }
}
/**
 ...
 * }
 */
export function Binder_bindPostfixUnaryExpressionFlow(receiver, node) {
 ...
 * }
 */
export function Binder_bindDestructuringAssignmentFlow(receiver, node) {
    const expr = AsBinaryExpression(node);
    if (receiver.inAssignmentPattern) {
        receiver.inAssignmentPattern = false;
        Binder_bind(receiver, expr.OperatorToken);
        Binder_bind(receiver, expr.Right);
        receiver.inAssignmentPattern = true;
        Binder_bind(receiver, expr.Left);
        Binder_bind(receiver, expr.Type);
    }
    else {
        receiver.inAssignmentPattern = true;
        Binder_bind(receiver, expr.Left);
    ...
    Binder_bindAssignmentTargetFlow(receiver, expr.Left);
}
/**
 ...
 * }
 */
export function Binder_bindBinaryExpressionFlow(receiver, node) {
    const expr = AsBinaryExpression(node);
    ...
    if (IsLogicalOrCoalescingBinaryOperator(operator) || IsLogicalOrCoalescingAssignmentOperator(operator)) {
        if (isTopLevelLogicalExpression(node)) {
            ...
            receiver.hasFlowEffects = (receiver.hasFlowEffects || saveHasFlowEffects);
        }
        else {
...
function Binder_bindNonLogicalBinaryExpressionFlow(receiver, node) {
    const binaryChain = [node];
    let leftEdge = AsBinaryExpression(node).Left;
...
function isIterativelyBindableNonLogicalBinaryExpression(node) {
    ...
    return (!IsLogicalOrCoalescingBinaryOperator(operator) && !IsLogicalOrCoalescingAssignmentOperator(operator));
}
function Binder_bindNonLogicalBinaryExpressionTail(receiver, node) {
    const expr = AsBinaryExpression(node);
    const operator = expr.OperatorToken.Kind;
    Binder_bind(receiver, expr.Type);
    if (operator === KindCommaToken) {
        Binder_maybeBindExpressionFlowIfCall(receiver, expr.Left);
    }
    Binder_bind(receiver, expr.OperatorToken);
    Binder_bind(receiver, expr.Right);
    if (operator === KindCommaToken) {
        Binder_maybeBindExpressionFlowIfCall(receiver, expr.Right);
    }
    if (IsAssignmentOperator(operator) && !IsAssignmentTarget(node)) {
        Binder_bindAssignmentTargetFlow(receiver, expr.Left);
        if (operator === KindEqualsToken && expr.Left.Kind === KindElementAccessExpression) {
            const elementAccess = AsElementAccessExpression(expr.Left);
            if (isNarrowableOperand(elementAccess.Expression)) {
 ...
 * }
 */
export function Binder_bindLogicalLikeExpression(receiver, node, trueTarget, falseTarget) {
    const expr = AsBinaryExpression(node);
    ...
    if (expr.OperatorToken.Kind === KindAmpersandAmpersandToken || expr.OperatorToken.Kind === KindAmpersandAmpersandEqualsToken) {
        Binder_bindCondition(receiver, expr.Left, preRightLabel, falseTarget);
    }
    else {
        Binder_bindCondition(receiver, expr.Left, trueTarget, preRightLabel);
    }
    ...
    if (IsLogicalOrCoalescingAssignmentOperator(expr.OperatorToken.Kind)) {
        Binder_doWithConditionalBranches(receiver, Binder_bind, expr.Right, trueTarget, falseTarget);
        Binder_bindAssignmentTargetFlow(receiver, expr.Left);
        Binder_addAntecedent(receiver, trueTarget, Binder_createFlowCondition(receiver, FlowFlagsTrueCondition, receiver.currentFlow, node));
        Binder_addAntecedent(receiver, falseTarget, Binder_createFlowCondition(receiver, FlowFlagsFalseCondition, receiver.currentFlow, node));
    }
    else {
        Binder_bindCondition(receiver, expr.Right, trueTarget, falseTarget);
    }
}
/**
 ...
 * }
 */
export function Binder_bindDeleteExpressionFlow(receiver, node) {
    const expr = AsDeleteExpression(node);
    Binder_bindEachChild(receiver, node);
    if (expr.Expression.Kind === KindPropertyAccessExpression) {
        Binder_bindAssignmentTargetFlow(receiver, expr.Expression);
    }
}
/**
 ...
 * }
 */
export function Binder_bindConditionalExpressionFlow(receiver, node) {
    ...
    const saveHasFlowEffects = receiver.hasFlowEffects;
    receiver.hasFlowEffects = false;
    Binder_bindCondition(receiver, expr.Condition, trueLabel, falseLabel);
    receiver.currentFlow = Binder_finishFlowLabel(receiver, trueLabel);
    Binder_bind(receiver, expr.QuestionToken);
    Binder_bind(receiver, expr.WhenTrue);
    ...
    Binder_bind(receiver, expr.ColonToken);
    Binder_bind(receiver, expr.WhenFalse);
    Binder_addAntecedent(receiver, postExpressionLabel, receiver.currentFlow);
    if (receiver.hasFlowEffects) {
        receiver.currentFlow = Binder_finishFlowLabel(receiver, postExpressionLabel);
    }
 ...
 * }
 */
export function Binder_bindVariableDeclarationFlow(receiver, node) {
    Binder_bindEachChild(receiver, node);
 ...
 * }
 */
export function Binder_bindInitializedVariableFlow(receiver, node) {
    let name;
    switch (node.Kind) {
        case KindVariableDeclaration:
            name = Node_Name(node);
 ...
 * }
 */
export function Binder_bindAccessExpressionFlow(receiver, node) {
 ...
 * }
 */
export function Binder_bindOptionalChainFlow(receiver, node) {
    if (isTopLevelLogicalExpression(node)) {
        const postExpressionLabel = Binder_createBranchLabel(receiver);
        const saveCurrentFlow = receiver.currentFlow;
        const saveHasFlowEffects = receiver.hasFlowEffects;
 ...
 * }
 */
export function Binder_bindOptionalChain(receiver, node, trueTarget, falseTarget) {
    let preChainLabel;
    if (IsOptionalChainRoot(node)) {
        preChainLabel = Binder_createBranchLabel(receiver);
    }
    Binder_bindOptionalExpression(receiver, Node_Expression(node), IfElse(preChainLabel !== undefined, preChainLabel, trueTarget), falseTarget);
 ...
 * }
 */
export function Binder_bindOptionalExpression(receiver, node, trueTarget, falseTarget) {
    Binder_doWithConditionalBranches(receiver, Binder_bind, node, trueTarget, falseTarget);
 ...
 * }
 */
export function Binder_bindOptionalChainRest(receiver, node) {
    switch (node.Kind) {
        case KindPropertyAccessExpression:
        ...
        case KindElementAccessExpression:
            Binder_bind(receiver, Node_QuestionDotToken(node));
            Binder_bind(receiver, AsElementAccessExpression(node).ArgumentExpression);
            break;
        case KindCallExpression:
            Binder_bind(receiver, Node_QuestionDotToken(node));
 ...
 * }
 */
export function Binder_bindCallExpressionFlow(receiver, node) {
    const call = AsCallExpression(node);
    if (IsOptionalChain(node)) {
        Binder_bindOptionalChainFlow(receiver, node);
    }
    else {
        const expr = SkipParentheses(call.Expression);
        if (expr.Kind === KindFunctionExpression || expr.Kind === KindArrowFunction) {
            Binder_bindNodeList(receiver, call.TypeArguments);
            Binder_bindEach(receiver, call.Arguments.Nodes ?? []);
            Binder_bind(receiver, call.Expression);
        }
        else {
            Binder_bindEachChild(receiver, node);
 ...
 * }
 */
export function Binder_bindNonNullExpressionFlow(receiver, node) {
    if (IsOptionalChain(node)) {
        Binder_bindOptionalChainFlow(receiver, node);
    }
    else {
 ...
 * }
 */
export function Binder_bindBindingElementFlow(receiver, node) {
    const elem = AsBindingElement(node);
    Binder_bind(receiver, elem.DotDotDotToken);
    Binder_bind(receiver, elem.PropertyName);
    Binder_bindInitializer(receiver, elem.Initializer);
    Binder_bind(receiver, Node_Name(node));
}
/**
 ...
 * }
 */
export function Binder_bindParameterFlow(receiver, node) {
    const param = AsParameterDeclaration(node);
    Binder_bindModifiers(receiver, Node_Modifiers(node));
    Binder_bind(receiver, param.DotDotDotToken);
    Binder_bind(receiver, param.QuestionToken);
    Binder_bind(receiver, param.Type);
    Binder_bindInitializer(receiver, param.Initializer);
    Binder_bind(receiver, Node_Name(node));
}
/**
 ...
 * }
 */
export function Binder_bindInitializer(receiver, node) {
    if (node === undefined) {
        return;
    }
 ...
 * }
 */
export function setFlowNode(node, flowNode) {
 ...
 * }
 */
export function setReturnFlowNode(node, returnFlowNode) {
    switch (node.Kind) {
        case KindConstructor:
 ...
 * }
 */
export function isGeneratorFunctionExpression(node) {
    return (IsFunctionExpression(node) && AsFunctionExpression(node).AsteriskToken !== undefined);
}
/**
 ...
 * }
 */
export function Binder_addToContainerChain(receiver, next) {
 ...
 * }
 */
export function Binder_addDeclarationToSymbol(receiver, symbol_, node, symbolFlags) {
    symbol_.Flags = (symbol_.Flags | symbolFlags);
    ...
    if ((symbol_.Flags & SymbolFlagsConstEnumOnlyModule) !== 0 && (symbol_.Flags & (SymbolFlagsFunction | SymbolFlagsClass | SymbolFlagsRegularEnum)) !== 0) {
        symbol_.Flags = (symbol_.Flags & ~SymbolFlagsConstEnumOnlyModule);
 ...
 * }
 */
export function SetValueDeclaration(symbol_, node) {
 ...
 * }
 */
export function GetContainerFlags(node) {
    switch (node.Kind) {
        case KindClassExpression:
        case KindClassDeclaration:
        case KindEnumDeclaration:
 ...
 * }
 */
export function isNarrowingExpression(expr) {
    switch (expr.Kind) {
        case KindIdentifier:
        case KindThisKeyword:
            return true;
        ...
        case KindPrefixUnaryExpression:
            return (AsPrefixUnaryExpression(expr).Operator === KindExclamationToken && isNarrowingExpression(AsPrefixUnaryExpression(expr).Operand));
    }
    return false;
}
/**
 ...
 * }
 */
export function containsNarrowableReference(expr) {
    if (isNarrowableReference(expr)) {
        return true;
    }
 ...
 * }
 */
export function isNarrowableReference(node) {
    switch (node.Kind) {
        case KindIdentifier:
        case KindThisKeyword:
        case KindSuperKeyword:
 ...
 * }
 */
export function hasNarrowableArgument(expr) {
 ...
 * }
 */
export function isNarrowingBinaryExpression(expr) {
    switch (expr.OperatorToken.Kind) {
 ...
 * }
 */
export function isNarrowableOperand(expr) {
    switch (expr.Kind) {
        case KindParenthesizedExpression:
 ...
 * }
 */
export function isNarrowingTypeOfOperands(expr1, expr2) {
    return (IsTypeOfExpression(expr1) && isNarrowableOperand(Node_Expression(expr1)) && IsStringLiteralLike(expr2));
}
/**
 ...
 * }
 */
export function Binder_errorOnNode(receiver, node, message, ...args) {
 ...
 * }
 */
export function Binder_errorOnFirstToken(receiver, node, message, ...args) {
 ...
 * }
 */
export function Binder_errorOrSuggestionOnNode(receiver, isError, node, message) {
 ...
 * }
 */
export function Binder_errorOrSuggestionOnRange(receiver, isError, startNode, endNode, message) {
 ...
 * }
 */
export function Binder_createDiagnosticForNode(receiver, node, message, ...args) {
 ...
 * }
 */
export function Binder_addDiagnostic(receiver, diagnostic) {
...
export function isSignedNumericLiteral(node) {
    if (node.Kind === KindPrefixUnaryExpression) {
        ...
        return ((unary.Operator === KindPlusToken || unary.Operator === KindMinusToken) && IsNumericLiteral(unary.Operand));
    }
    return false;
}
/**
 ...
 * }
 */
export function getOptionalSymbolFlagForNode(node) {
    const postfixToken = Node_PostfixToken(node);
    return IfElse((postfixToken !== undefined && postfixToken.Kind === KindQuestionToken), SymbolFlagsOptional, SymbolFlagsNone);
}
/**
 ...
 * }
 */
export function isFunctionSymbol(symbol_) {
 ...
 * }
 */
export function isStatementCondition(node) {
    switch (node.Parent.Kind) {
        case KindIfStatement:
        case KindWhileStatement:
        case KindDoStatement:
            return (Node_Expression(node.Parent) === node);
        case KindForStatement:
            return (AsForStatement(node.Parent).Condition === node);
        case KindConditionalExpression:
            return (AsConditionalExpression(node.Parent).Condition === node);
    }
    return false;
}
/**
...
export function isTopLevelLogicalExpression(node) {
    let current = node;
    while (IsParenthesizedExpression(current.Parent) ||
    ...
    return (!isStatementCondition(current) &&
        ...
        !(IsOptionalChain(current.Parent) && Node_Expression(current.Parent) === current));
}
/**
 ...
 * }
 */
export function isAssignmentDeclaration(decl) {
 ...
 * }
 */
export function isEffectiveModuleDeclaration(node) {
