...
export function Binder_bind(receiver, node) {
    ...
    switch (node.Kind) {
        ...
        case KindMethodDeclaration:
        case KindMethodSignature:
            Binder_bindPropertyOrMethodOrAccessor(receiver, node, (SymbolFlagsMethod | getOptionalSymbolFlagForNode(node)), IfElse(IsObjectLiteralMethod(node), SymbolFlagsValue, SymbolFlagsMethodExcludes));
            break;
        case KindFunctionDeclaration:
