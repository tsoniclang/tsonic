 ...
 */
export const __e8d524b9_0 = referenceResolver_as_ReferenceResolver(undefined);
/**
...
function referenceResolver_as_ReferenceResolver(receiver) {
    const r = receiver;
    return {
        GetReferencedExportContainer: (node, prefixLocals) => referenceResolver_GetReferencedExportContainer(r, node, prefixLocals),
        GetReferencedImportDeclaration: (node) => referenceResolver_GetReferencedImportDeclaration(r, node),
        GetReferencedValueDeclaration: (node) => referenceResolver_GetReferencedValueDeclaration(r, node),
        GetReferencedValueDeclarations: (node) => referenceResolver_GetReferencedValueDeclarations(r, node),
        GetElementAccessExpressionName: (expression) => referenceResolver_GetElementAccessExpressionName(r, expression),
        GetReferencedMemberValueDeclaration: (node) => referenceResolver_GetReferencedMemberValueDeclaration(r, node),
    };
}
export function NewReferenceResolver(options, hooks) {
    const r = {
        resolver: undefined,
        options: options,
        hooks: hooks,
 ...
 * }
 */
export function referenceResolver_getResolvedSymbol(receiver, node) {
    if (node !== undefined) {
 ...
 * }
 */
export function referenceResolver_getMergedSymbol(receiver, symbol_) {
 ...
 * }
 */
export function referenceResolver_getParentOfSymbol(receiver, symbol_) {
    if (symbol_ !== undefined) {
 ...
 * }
 */
export function referenceResolver_getSymbolOfDeclaration(receiver, declaration) {
 ...
 * }
 */
export function referenceResolver_getReferencedValueSymbol(receiver, reference, startInDeclarationContainer) {
 ...
 * }
 */
export function referenceResolver_isTypeOnlyAliasDeclaration(receiver, symbol_) {
    if (symbol_ !== undefined) {
        ...
        let node = referenceResolver_getDeclarationOfAliasSymbol(receiver, symbol_);
 ...
 * }
 */
export function referenceResolver_getDeclarationOfAliasSymbol(receiver, symbol_) {
 ...
 * }
 */
export function referenceResolver_getExportSymbolOfValueSymbolIfExported(receiver, symbol_) {
    if (symbol_ !== undefined) {
 ...
 * }
 */
export function referenceResolver_GetReferencedExportContainer(receiver, node, prefixLocals) {
    const startInDeclarationContainer = (node.Parent !== undefined && (node.Parent.Kind === KindModuleDeclaration || node.Parent.Kind === KindEnumDeclaration) && node === Node_Name(node.Parent));
    ...
    if (symbol_ !== undefined) {
        ...
        if (parentSymbol !== undefined) {
            ...
            const isMatchingContainer = (n) => {
                return ((n.Kind === KindModuleDeclaration || n.Kind === KindEnumDeclaration) && referenceResolver_getSymbolOfDeclaration(receiver, n) === parentSymbol);
            };
 ...
 * }
 */
export function referenceResolver_GetReferencedImportDeclaration(receiver, node) {
 ...
 * }
 */
export function referenceResolver_GetReferencedValueDeclaration(receiver, node) {
    const symbol_ = referenceResolver_getReferencedValueSymbol(receiver, node, false);
    if (symbol_ !== undefined) {
 ...
 * }
 */
export function referenceResolver_GetReferencedValueDeclarations(receiver, node) {
    const declarations = [];
 ...
 * }
 */
export function referenceResolver_GetElementAccessExpressionName(receiver, expression) {
 ...
 * }
 */
export function referenceResolver_GetReferencedMemberValueDeclaration(receiver, node) {
    // member references are `this.something` or `this[something]`, so should always simply have a resolved symbol
