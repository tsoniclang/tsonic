 ...
 * )
 */
export const CategoryWarning = 0;
export const CategoryError = 1;
export const CategorySuggestion = 2;
export const CategoryMessage = 3;
/**
 ...
 * }
 */
export function Category_Name(category) {
    switch (category) {
        case CategoryWarning:
            return "warning";
        case CategoryError:
 ...
 */
export function Message_Code(m) {
    return m.code;
}
/**
 ...
 */
export function Message_Category(m) {
    return m.category;
}
/**
 ...
 */
export function Message_ReportsUnnecessary(m) {
    return (m.reportsUnnecessary ?? false);
}
/**
 ...
 */
export function Message_ElidedInCompatibilityPyramid(m) {
    return (m.elidedInCompatibilityPyramid ?? false);
}
/**
 ...
 */
export function Message_ReportsDeprecated(m) {
    return (m.reportsDeprecated ?? false);
}
/**
 ...
 * }
 */
export function Message_String(m) {
    return m.text;
}
/**
 ...
 * }
 */
export function Message_Localize(m, locale, ...args) {
    return Localize(locale, m, "", ...StringifyArgs(args));
}
/**
 ...
 * }
 */
export function Localize(locale, message, key, ...args) {
 ...
 */
export const localizedMessagesCache = new Map();
/**
 ...
 * }
 */
export function getLocalizedMessages(loc) {
    if (loc === Und) {
        return undefined;
    }
 ...
 */
export const placeholderRegexp = regexp.MustCompile("{(\\d+)}");
/**
...
export function Format(text, args) {
    ...
    // Replace invalid UTF-8 with Unicode replacement character
    args = SameMap(args, (arg) => {
        return ToValidUTF8(arg, "�");
    });
    return placeholderRegexp.ReplaceAllStringFunc(text, (match) => {
        const [index, err] = ParseInt(byteSlice(match, 1, (byteLen(match) - 1)), 10, 0);
        if (err !== undefined || index >= args.length) {
...
export function StringifyArgs(args) {
    ...
    const result = new globalThis.Array(args.length);
...
function byteSlice(s, start, end) {
    ...
    return new globalThis.TextDecoder().decode(bytes.slice(start, end));
}
