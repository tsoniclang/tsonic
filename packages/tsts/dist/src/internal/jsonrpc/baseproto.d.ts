 ...
 * )
 */
export declare const ErrInvalidHeader: GoError;
export declare const ErrInvalidContentLength: GoError;
export declare const ErrNoContentLength: GoError;
/**
 ...
 * }
 */
export declare function NewReader(r: Reader_9d71ca04): GoPtr<Reader>;
/**
 ...
 * }
 */
export declare function Reader_Read(receiver: GoPtr<Reader>): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function NewWriter(w: Writer_51cf46eb): GoPtr<Writer>;
/**
 ...
 * }
 */
export declare function Writer_Write(receiver: GoPtr<Writer>, data: GoSlice<byte>): GoError;
//# sourceMappingURL=baseproto.d.ts.map