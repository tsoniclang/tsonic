 ...
 */
export declare const jsonRPCVersion: string;
/**
 ...
 * }
 */
export declare function JSONRPCVersion_MarshalJSON(receiver: JSONRPCVersion): [GoSlice<byte>, GoError];
/**
 ...
 */
export declare let ErrInvalidJSONRPCVersion: GoError;
/**
 ...
 * }
 */
export declare function JSONRPCVersion_UnmarshalJSON(receiver: GoPtr<JSONRPCVersion>, data: GoSlice<byte>): GoError;
/**
 ...
 * }
 */
export declare function NewID(rawValue: IntegerOrString): GoPtr<ID>;
/**
 ...
 * }
 */
export declare function NewIDString(str: string): GoPtr<ID>;
/**
 ...
 * }
 */
export declare function NewIDInt(i: int): GoPtr<ID>;
/**
 ...
 * }
 */
export declare function ID_String(receiver: GoPtr<ID>): string;
/**
 ...
 * }
 */
export declare function ID_MarshalJSON(receiver: GoPtr<ID>): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function ID_UnmarshalJSON(receiver: GoPtr<ID>, data: GoSlice<byte>): GoError;
/**
 ...
 * }
 */
export declare function ID_TryInt(receiver: GoPtr<ID>): [int, bool];
/**
 ...
 * }
 */
export declare function ID_MustInt(receiver: GoPtr<ID>): int;
/**
 ...
 * }
 */
export declare function ResponseError_String(receiver: GoPtr<ResponseError>): string;
/**
 ...
 * }
 */
export declare function ResponseError_Error(receiver: GoPtr<ResponseError>): string;
/**
 ...
 * )
 */
export declare const CodeParseError: int;
export declare const CodeInvalidRequest: int;
export declare const CodeMethodNotFound: int;
export declare const CodeInvalidParams: int;
export declare const CodeInternalError: int;
/**
 ...
 * )
 */
export declare const MessageKindNotification: MessageKind;
export declare const MessageKindRequest: MessageKind;
export declare const MessageKindResponse: MessageKind;
/**
 ...
 * }
 */
export declare function Message_Kind(receiver: GoPtr<Message>): MessageKind;
/**
 ...
 * }
 */
export declare function Message_IsRequest(receiver: GoPtr<Message>): bool;
/**
 ...
 * }
 */
export declare function Message_IsNotification(receiver: GoPtr<Message>): bool;
/**
 ...
 * }
 */
export declare function Message_IsResponse(receiver: GoPtr<Message>): bool;
/**
