 ...
 * }
 */
export declare function From(fsys: FS, useCaseSensitiveFileNames: bool): FsWithSys;
/**
 ...
 */
export declare const __90decee0_0: FsWithSys;
export declare function ioFS_as_vfs_FS(receiver: GoPtr<ioFS>): FS_f717df58;
export declare function ioFS_as_FsWithSys(receiver: GoPtr<ioFS>): FsWithSys;
/**
 ...
 * }
 */
export declare function ioFS_UseCaseSensitiveFileNames(receiver: GoPtr<ioFS>): bool;
/**
 ...
 * }
 */
export declare function ioFS_DirectoryExists(receiver: GoPtr<ioFS>, path: string): bool;
/**
 ...
 * }
 */
export declare function ioFS_FileExists(receiver: GoPtr<ioFS>, path: string): bool;
/**
 ...
 * }
 */
export declare function ioFS_GetAccessibleEntries(receiver: GoPtr<ioFS>, path: string): Entries;
/**
 ...
 * }
 */
export declare function ioFS_Stat(receiver: GoPtr<ioFS>, path: string): GoPtr<FileInfo>;
/**
 ...
 * }
 */
export declare function ioFS_ReadFile(receiver: GoPtr<ioFS>, path: string): [string, bool];
/**
 ...
 * }
 */
export declare function ioFS_WalkDir(receiver: GoPtr<ioFS>, root: string, walkFn: WalkDirFunc): GoError;
/**
 ...
 * }
 */
export declare function ioFS_Remove(receiver: GoPtr<ioFS>, path: string): GoError;
/**
 ...
 * }
 */
export declare function ioFS_Chtimes(receiver: GoPtr<ioFS>, path: string, aTime: Time, mTime: Time): GoError;
/**
 ...
 * }
 */
export declare function ioFS_Realpath(receiver: GoPtr<ioFS>, path: string): string;
/**
 ...
 * }
 */
export declare function ioFS_writeFileEnsuringDir(receiver: GoPtr<ioFS>, path: string, content: string, write: (path: string, content: string) => GoError): GoError;
/**
 ...
 * }
 */
export declare function ioFS_WriteFile(receiver: GoPtr<ioFS>, path: string, content: string): GoError;
/**
 ...
 * }
 */
export declare function ioFS_AppendFile(receiver: GoPtr<ioFS>, path: string, content: string): GoError;
/**
 ...
 * }
 */
export declare function ioFS_FSys(receiver: GoPtr<ioFS>): FS;
//# sourceMappingURL=iofs.d.ts.map