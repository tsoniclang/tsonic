 ...
 * var _ vfs.FS = &FSMock{}
 */
export let __611a48db_0 = FSMock_as_vfs_FS(undefined);
export function FSMock_as_vfs_FS(receiver) {
    return {
        UseCaseSensitiveFileNames: () => FSMock_UseCaseSensitiveFileNames(receiver),
        FileExists: (path) => FSMock_FileExists(receiver, path),
        ReadFile: (path) => FSMock_ReadFile(receiver, path),
        WriteFile: (path, data) => FSMock_WriteFile(receiver, path, data),
        AppendFile: (path, data) => FSMock_AppendFile(receiver, path, data),
        Remove: (path) => FSMock_Remove(receiver, path),
        Chtimes: (path, aTime, mTime) => FSMock_Chtimes(receiver, path, aTime, mTime),
        DirectoryExists: (path) => FSMock_DirectoryExists(receiver, path),
        GetAccessibleEntries: (path) => FSMock_GetAccessibleEntries(receiver, path),
        Stat: (path) => FSMock_Stat(receiver, path),
        WalkDir: (root, walkFn) => FSMock_WalkDir(receiver, root, walkFn),
        Realpath: (path) => FSMock_Realpath(receiver, path),
    };
}
/**
 ...
 * }
 */
export function FSMock_AppendFile(receiver, path, data) {
 ...
 * }
 */
export function FSMock_AppendFileCalls(receiver) {
 ...
 * }
 */
export function FSMock_Chtimes(receiver, path, aTime, mTime) {
 ...
 * }
 */
export function FSMock_ChtimesCalls(receiver) {
 ...
 * }
 */
export function FSMock_DirectoryExists(receiver, path) {
 ...
 * }
 */
export function FSMock_DirectoryExistsCalls(receiver) {
 ...
 * }
 */
export function FSMock_FileExists(receiver, path) {
 ...
 * }
 */
export function FSMock_FileExistsCalls(receiver) {
 ...
 * }
 */
export function FSMock_GetAccessibleEntries(receiver, path) {
 ...
 * }
 */
export function FSMock_GetAccessibleEntriesCalls(receiver) {
 ...
 * }
 */
export function FSMock_ReadFile(receiver, path) {
 ...
 * }
 */
export function FSMock_ReadFileCalls(receiver) {
 ...
 * }
 */
export function FSMock_Realpath(receiver, path) {
 ...
 * }
 */
export function FSMock_RealpathCalls(receiver) {
 ...
 * }
 */
export function FSMock_Remove(receiver, path) {
 ...
 * }
 */
export function FSMock_RemoveCalls(receiver) {
 ...
 * }
 */
export function FSMock_Stat(receiver, path) {
 ...
 * }
 */
export function FSMock_StatCalls(receiver) {
 ...
 * }
 */
export function FSMock_UseCaseSensitiveFileNames(receiver) {
 ...
 * }
 */
export function FSMock_UseCaseSensitiveFileNamesCalls(receiver) {
 ...
 * }
 */
export function FSMock_WalkDir(receiver, root, walkFn) {
 ...
 * }
 */
export function FSMock_WalkDirCalls(receiver) {
 ...
 * }
 */
export function FSMock_WriteFile(receiver, path, data) {
