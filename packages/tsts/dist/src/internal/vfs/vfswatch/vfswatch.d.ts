 ...
 */
export declare const debounceWait: int;
/**
 ...
 * }
 */
export declare function NewFileWatcher(fs: FS, pollInterval: Duration, testing: bool, callback: () => void): GoPtr<FileWatcher>;
/**
 ...
 * }
 */
export declare function FileWatcher_SetPollInterval(receiver: GoPtr<FileWatcher>, d: Duration): void;
/**
 ...
 * }
 */
export declare function FileWatcher_WatchStateEntry(receiver: GoPtr<FileWatcher>, path: string): [WatchEntry, bool];
/**
 ...
 * }
 */
export declare function FileWatcher_WatchStateUninitialized(receiver: GoPtr<FileWatcher>): bool;
/**
 ...
 * }
 */
export declare function FileWatcher_UpdateWatchState(receiver: GoPtr<FileWatcher>, paths: GoSlice<string>, wildcardDirs: GoMap<string, bool>): void;
/**
 ...
 * }
 */
export declare function FileWatcher_WaitForSettled(receiver: GoPtr<FileWatcher>, now: () => Time): void;
/**
 ...
 * }
 */
export declare function FileWatcher_currentState(receiver: GoPtr<FileWatcher>): GoMap<string, WatchEntry>;
/**
 ...
 * }
 */
export declare function snapshotPaths(fs: FS, paths: GoSlice<string>, wildcardDirs: GoMap<string, bool>): GoMap<string, WatchEntry>;
/**
 ...
 * }
 */
export declare function snapshotDirEntry(fs: FS, state: GoMap<string, WatchEntry>, dir: string): void;
/**
 ...
 * }
 */
export declare function hashEntries(entries: Entries): ulong;
/**
 ...
 * }
 */
export declare function dirChanged(fs: FS, baseline: GoMap<string, WatchEntry>, dir: string): bool;
/**
 ...
 * }
 */
export declare function FileWatcher_hasChanges(receiver: GoPtr<FileWatcher>, baseline: GoMap<string, WatchEntry>, wildcardDirs: GoMap<string, bool>): bool;
/**
 ...
 * }
 */
export declare function FileWatcher_HasChangesFromWatchState(receiver: GoPtr<FileWatcher>): bool;
/**
 ...
 * }
 */
export declare function FileWatcher_Run(receiver: GoPtr<FileWatcher>, now: () => Time): void;
//# sourceMappingURL=vfswatch.d.ts.map