 ...
 * )
 */
export declare const ErrInvalid: GoError;
export declare const ErrPermission: GoError;
export declare const ErrExist: GoError;
export declare const ErrNotExist: GoError;
export declare const ErrClosed: GoError;
/**
...
export declare const SkipDir: GoError;
