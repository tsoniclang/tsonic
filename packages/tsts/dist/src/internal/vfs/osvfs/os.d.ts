 ...
 * )
 */
export declare let blockingOpSema: GoPtr<LimitedSemaphore>;
export declare let readSema: GoPtr<LimitedSemaphore>;
export declare let writeSema: GoPtr<LimitedSemaphore>;
/**
 ...
 * }
 */
export declare function FS(): FS_a37200a9;
/**
 ...
 * }
 */
export declare let osVFS: FS_a37200a9;
/**
 ...
 * }()
 */
export declare let isFileSystemCaseSensitive: bool;
/**
 ...
 * }
 */
export declare function osFS_UseCaseSensitiveFileNames(receiver: GoPtr<osFS>): bool;
/**
 ...
 * }
 */
export declare function osFS_ReadFile(receiver: GoPtr<osFS>, path: string): [string, bool];
/**
 ...
 * }
 */
export declare function osFS_DirectoryExists(receiver: GoPtr<osFS>, path: string): bool;
/**
 ...
 * }
 */
export declare function osFS_FileExists(receiver: GoPtr<osFS>, path: string): bool;
/**
 ...
 * }
 */
export declare function osFS_GetAccessibleEntries(receiver: GoPtr<osFS>, path: string): Entries;
/**
 ...
 * }
 */
export declare function osFS_Stat(receiver: GoPtr<osFS>, path: string): GoPtr<FileInfo>;
/**
 ...
 * }
 */
export declare let limitedWalkDirFuncPool: Pool<limitedWalkDirFunc>;
/**
 ...
 * }
 */
export declare function getLimitedWalkDirFunc(walkFn: WalkDirFunc): GoPtr<limitedWalkDirFunc>;
/**
 ...
 * }
 */
export declare function putLimitedWalkDirFunc(w: GoPtr<limitedWalkDirFunc>): void;
/**
 ...
 * }
 */
export declare function limitedWalkDirFunc_walker(receiver: GoPtr<limitedWalkDirFunc>, path: string, d: DirEntry, err: GoError): GoError;
/**
 ...
 * }
 */
export declare function osFS_WalkDir(receiver: GoPtr<osFS>, root: string, walkFn: WalkDirFunc): GoError;
/**
 ...
 * }
 */
export declare function osFS_Realpath(receiver: GoPtr<osFS>, path: string): string;
/**
 ...
 * }
 */
export declare function osFSRealpath(path: string): string;
/**
 ...
 * }
 */
export declare function osFS_writeFileWithFlag(receiver: GoPtr<osFS>, path: string, content: string, flag: int): GoError;
/**
 ...
 * }
 */
export declare function osFS_ensureDirectoryExists(receiver: GoPtr<osFS>, directoryPath: string): GoError;
/**
 ...
 * }
 */
export declare function osFS_writeFileEnsuringDir(receiver: GoPtr<osFS>, path: string, content: string, flag: int): GoError;
/**
 ...
 * }
 */
export declare function osFS_WriteFile(receiver: GoPtr<osFS>, path: string, content: string): GoError;
/**
 ...
 * }
 */
export declare function osFS_AppendFile(receiver: GoPtr<osFS>, path: string, content: string): GoError;
/**
 ...
 * }
 */
export declare function osFS_Remove(receiver: GoPtr<osFS>, path: string): GoError;
/**
 ...
 * }
 */
export declare function osFS_Chtimes(receiver: GoPtr<osFS>, path: string, aTime: Time, mTime: Time): GoError;
/**
 ...
 * }
 */
export declare function GetGlobalTypingsCacheLocation(): string;
