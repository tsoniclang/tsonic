 ...
 * )
 */
export declare const UsageFiles: Usage;
export declare const UsageDirectories: Usage;
export declare const UsageExclude: Usage;
/**
 ...
 */
export declare const UnlimitedDepth: int;
/**
 ...
 * }
 */
export declare function ReadDirectory(host: FS, currentDir: string, path: string, extensions: GoSlice<string>, excludes: GoSlice<string>, includes: GoSlice<string>, depth: int): GoSlice<string>;
/**
 ...
 * }
 */
export declare function IsImplicitGlob(lastPathComponent: string): bool;
/**
 ...
 */
export declare let wildcardCharCodes: GoSlice<GoRune>;
/**
 ...
 * }
 */
export declare function getIncludeBasePath(absolute: string): string;
/**
 ...
 * }
 */
export declare function getBasePaths(path: string, includes: GoPtr<GoSlice<string>>, useCaseSensitiveFileNames: bool): GoSlice<string>;
/**
 ...
 * )
 */
export declare const kindLiteral: componentKind;
export declare const kindWildcard: componentKind;
export declare const kindDoubleAsterisk: componentKind;
/**
 ...
 * )
 */
export declare const segLiteral: segmentKind;
export declare const segStar: segmentKind;
export declare const segQuestion: segmentKind;
/**
 ...
 * }
 */
export declare function compileGlobPattern(spec: string, basePath: string, usage: Usage, caseSensitive: bool): [globPattern, bool];
/**
 ...
 * }
 */
export declare function parseComponent(s: string, isInclude: bool): component;
/**
 ...
 * }
 */
export declare function parseSegments(s: string): GoSlice<segment>;
/**
 ...
 * }
 */
export declare function globPattern_matches(receiver: GoPtr<globPattern>, path: string): bool;
/**
 ...
 * }
 */
export declare function globPattern_matchesParts(receiver: GoPtr<globPattern>, prefix: string, suffix: string): bool;
/**
 ...
 * }
 */
export declare function globPattern_matchesPrefixParts(receiver: GoPtr<globPattern>, prefix: string, suffix: string): bool;
/**
 ...
 * }
 */
export declare function globPattern_matchPathParts(receiver: GoPtr<globPattern>, prefix: string, suffix: string, pathOffset: int, compIdx: int, prefixOnly: bool): bool;
/**
 ...
 * }
 */
export declare function globPattern_patternSatisfied(receiver: GoPtr<globPattern>, compIdx: int): bool;
/**
 ...
 * }
 */
export declare function nextPathPartSingle(s: string, offset: int): [string, int, bool];
/**
 ...
 * }
 */
export declare function nextPathPartParts(prefix: string, suffix: string, offset: int): [string, int, bool];
/**
 ...
 * }
 */
export declare function globPattern_matchWildcard(receiver: GoPtr<globPattern>, segs: GoSlice<segment>, s: string): bool;
/**
 ...
 * }
 */
export declare function globPattern_matchSegments(receiver: GoPtr<globPattern>, segs: GoSlice<segment>, s: string): bool;
/**
 ...
 * }
 */
export declare function globPattern_shouldIncludeMinJs(receiver: GoPtr<globPattern>, filename: string, segs: GoSlice<segment>): bool;
/**
 ...
 * }
 */
export declare function globPattern_hasMinJsSuffix(receiver: GoPtr<globPattern>, filename: string): bool;
/**
 ...
 * }
 */
export declare function globPattern_patternMentionsMinSuffix(receiver: GoPtr<globPattern>, segs: GoSlice<segment>): bool;
/**
 ...
 * }
 */
export declare function globPattern_stringsEqual(receiver: GoPtr<globPattern>, a: string, b: string): bool;
/**
 ...
 * }
 */
export declare function isHiddenPath(name: string): bool;
/**
 ...
 * }
 */
export declare function isPackageFolder(name: string): bool;
/**
 ...
 * }
 */
export declare function ensureTrailingSlash(s: string): string;
/**
 ...
 * }
 */
export declare function newGlobMatcher(includeSpecs: GoPtr<GoSlice<string>>, excludeSpecs: GoPtr<GoSlice<string>>, basePath: string, caseSensitive: bool, usage: Usage): GoPtr<globMatcher>;
/**
 ...
 * }
 */
export declare function globMatcher_matchesFileParts(receiver: GoPtr<globMatcher>, prefix: string, suffix: string): [int, bool];
/**
 ...
 * }
 */
export declare function globMatcher_matchesDirectoryParts(receiver: GoPtr<globMatcher>, prefix: string, suffix: string): bool;
/**
 ...
 * }
 */
export declare function globVisitor_visit(receiver: GoPtr<globVisitor>, path: string, absolutePath: string, depth: int, resolvedRealPath: string): void;
/**
 ...
 * }
 */
export declare function matchFiles(path: string, extensions: GoPtr<GoSlice<string>>, excludes: GoPtr<GoSlice<string>>, includes: GoPtr<GoSlice<string>>, useCaseSensitiveFileNames: bool, currentDirectory: string, depth: int, host: FS): GoSlice<string>;
/**
 ...
 * }
 */
export declare function SpecMatcher_MatchString(receiver: GoPtr<SpecMatcher>, path: string): bool;
/**
 ...
 * }
 */
export declare function SpecMatcher_MatchIndex(receiver: GoPtr<SpecMatcher>, path: string): int;
/**
 ...
 * }
 */
export declare function NewSpecMatcher(specs: GoSlice<string>, basePath: string, usage: Usage, useCaseSensitiveFileNames: bool): GoPtr<SpecMatcher>;
//# sourceMappingURL=vfsmatch.d.ts.map