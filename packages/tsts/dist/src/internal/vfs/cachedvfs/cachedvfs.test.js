...
import { FSMock_as_vfs_FS, FSMock_DirectoryExistsCalls, FSMock_FileExistsCalls, FSMock_GetAccessibleEntriesCalls, FSMock_ReadFileCalls, FSMock_RealpathCalls, FSMock_RemoveCalls, FSMock_StatCalls, FSMock_UseCaseSensitiveFileNamesCalls, FSMock_WalkDirCalls, FSMock_WriteFileCalls, } from "../vfsmock/mock_generated.js";
import { FS_ClearCache, FS_DirectoryExists, FS_DisableAndClearCache, FS_Enable, FS_FileExists, FS_GetAccessibleEntries, FS_ReadFile, FS_Realpath, FS_Remove, FS_Stat, FS_UseCaseSensitiveFileNames, FS_WalkDir, FS_WriteFile, From, } from "./cachedvfs.js";
function createMockFS() {
    return Wrap(FromMap(new Map([
...
test("WalkDir and WriteFile pass through and preserve arguments", () => {
    const underlying = createMockFS();
    const cached = From(FSMock_as_vfs_FS(underlying));
    const walkFn = (_path, _info, _err) => undefined;
...
//# sourceMappingURL=cachedvfs.test.js.map