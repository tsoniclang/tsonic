 ...
 * var _ vfs.FS = (*FS)(nil)
 */
export let __2bea44dc_0 = FS_as_vfs_FS(undefined);
export function FS_as_vfs_FS(receiver) {
    return {
        UseCaseSensitiveFileNames: () => FS_UseCaseSensitiveFileNames(receiver),
        FileExists: (path) => FS_FileExists(receiver, path),
        ReadFile: (path) => FS_ReadFile(receiver, path),
        WriteFile: (path, data) => FS_WriteFile(receiver, path, data),
        AppendFile: (path, data) => FS_AppendFile(receiver, path, data),
        Remove: (path) => FS_Remove(receiver, path),
        Chtimes: (path, aTime, mTime) => FS_Chtimes(receiver, path, aTime, mTime),
        DirectoryExists: (path) => FS_DirectoryExists(receiver, path),
        GetAccessibleEntries: (path) => FS_GetAccessibleEntries(receiver, path),
        Stat: (path) => FS_Stat(receiver, path),
        WalkDir: (root, walkFn) => FS_WalkDir(receiver, root, walkFn),
        Realpath: (path) => FS_Realpath(receiver, path),
    };
}
/**
 ...
 * }
 */
export function From(fs) {
    const fsys = {
        fs: fs,
        enabled: new Bool(),
        directoryExistsCache: { __tsgoBlank0: [], __tsgoBlank1: [], m: new SyncGoMap() },
        fileExistsCache: { __tsgoBlank0: [], __tsgoBlank1: [], m: new SyncGoMap() },
        getAccessibleEntriesCache: { __tsgoBlank0: [], __tsgoBlank1: [], m: new SyncGoMap() },
        realpathCache: { __tsgoBlank0: [], __tsgoBlank1: [], m: new SyncGoMap() },
        statCache: { __tsgoBlank0: [], __tsgoBlank1: [], m: new SyncGoMap() },
    };
    fsys.enabled.Store(true);
    return fsys;
}
 ...
 * }
 */
export function FS_DisableAndClearCache(receiver) {
    if (receiver.enabled.CompareAndSwap(true, false)) {
 ...
 * }
 */
export function FS_Enable(receiver) {
    receiver.enabled.Store(true);
}
/**
 ...
 * }
 */
export function FS_ClearCache(receiver) {
 ...
 * }
 */
export function FS_DirectoryExists(receiver, path) {
    if (receiver.enabled.Load()) {
        const [ret, ok] = SyncMap_Load(receiver.directoryExistsCache, path);
        if (ok) {
            return ret;
        }
    }
    ...
    if (receiver.enabled.Load()) {
        SyncMap_Store(receiver.directoryExistsCache, path, ret);
    }
    return ret;
}
/**
 ...
 * }
 */
export function FS_FileExists(receiver, path) {
    if (receiver.enabled.Load()) {
        const [ret, ok] = SyncMap_Load(receiver.fileExistsCache, path);
        if (ok) {
            return ret;
        }
    }
    ...
    if (receiver.enabled.Load()) {
        SyncMap_Store(receiver.fileExistsCache, path, ret);
    }
    return ret;
}
/**
 ...
 * }
 */
export function FS_GetAccessibleEntries(receiver, path) {
    if (receiver.enabled.Load()) {
        const [ret, ok] = SyncMap_Load(receiver.getAccessibleEntriesCache, path);
        if (ok) {
            return ret;
        }
    }
    ...
    if (receiver.enabled.Load()) {
        SyncMap_Store(receiver.getAccessibleEntriesCache, path, ret);
    }
    return ret;
}
/**
 ...
 * }
 */
export function FS_ReadFile(receiver, path) {
 ...
 * }
 */
export function FS_Realpath(receiver, path) {
    if (receiver.enabled.Load()) {
        const [ret, ok] = SyncMap_Load(receiver.realpathCache, path);
        if (ok) {
            return ret;
        }
    }
    ...
    if (receiver.enabled.Load()) {
        SyncMap_Store(receiver.realpathCache, path, ret);
    }
    return ret;
}
/**
 ...
 * }
 */
export function FS_Remove(receiver, path) {
 ...
 * }
 */
export function FS_Chtimes(receiver, path, aTime, mTime) {
 ...
 * }
 */
export function FS_Stat(receiver, path) {
    if (receiver.enabled.Load()) {
        const [ret, ok] = SyncMap_Load(receiver.statCache, path);
        if (ok) {
            return ret;
        }
    }
    ...
    if (receiver.enabled.Load()) {
        SyncMap_Store(receiver.statCache, path, ret);
    }
    return ret;
}
/**
 ...
 * }
 */
export function FS_UseCaseSensitiveFileNames(receiver) {
 ...
 * }
 */
export function FS_WalkDir(receiver, root, walkFn) {
 ...
 * }
 */
export function FS_WriteFile(receiver, path, data) {
 ...
 * }
 */
export function FS_AppendFile(receiver, path, data) {
    return receiver.fs.AppendFile(path, data);
}
//# sourceMappingURL=cachedvfs.js.map