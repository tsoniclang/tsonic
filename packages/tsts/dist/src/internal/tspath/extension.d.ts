 ...
 * )
 */
export declare const ExtensionTs: string;
export declare const ExtensionTsx: string;
export declare const ExtensionDts: string;
export declare const ExtensionJs: string;
export declare const ExtensionJsx: string;
export declare const ExtensionJson: string;
export declare const ExtensionTsBuildInfo: string;
export declare const ExtensionMjs: string;
export declare const ExtensionMts: string;
export declare const ExtensionDmts: string;
export declare const ExtensionCjs: string;
export declare const ExtensionCts: string;
export declare const ExtensionDcts: string;
/**
 ...
 * )
 */
export declare const SupportedDeclarationExtensions: GoSlice<string>;
export declare const SupportedTSImplementationExtensions: GoSlice<string>;
export declare const supportedTSExtensionsForExtractExtension: GoSlice<string>;
export declare const AllSupportedExtensions: GoSlice<GoSlice<string>>;
export declare const SupportedTSExtensions: GoSlice<GoSlice<string>>;
export declare const SupportedTSExtensionsFlat: GoSlice<string>;
export declare const SupportedJSExtensions: GoSlice<GoSlice<string>>;
export declare const SupportedJSExtensionsFlat: GoSlice<string>;
export declare const AllSupportedExtensionsWithJson: unknown;
export declare const SupportedTSExtensionsWithJson: unknown;
export declare const SupportedTSExtensionsWithJsonFlat: unknown;
export declare const ExtensionsNotSupportingExtensionlessResolution: GoSlice<string>;
/**
 ...
 * }
 */
export declare function ExtensionIsTs(ext: string): bool;
/**
 ...
 */
export declare const extensionsToRemove: GoSlice<string>;
/**
 ...
 * }
 */
export declare function TryGetExtensionFromPath(p: string): string;
/**
 ...
 * }
 */
export declare function FileExtensionIsOneOf(path: string, extensions: GoSlice<string>): bool;
/**
 ...
 * }
 */
export declare function TryExtractTSExtension(fileName: string): string;
/**
 ...
 * }
 */
export declare function HasTSFileExtension(path: string): bool;
/**
 ...
 * }
 */
export declare function HasImplementationTSFileExtension(path: string): bool;
/**
 ...
 * }
 */
export declare function HasJSFileExtension(path: string): bool;
/**
 ...
 * }
 */
export declare function HasJSONFileExtension(path: string): bool;
/**
 ...
 * }
 */
export declare function IsDeclarationFileName(fileName: string): bool;
/**
 ...
 * }
 */
export declare function ExtensionIsOneOf(ext: string, extensions: GoSlice<string>): bool;
/**
 ...
 * }
 */
export declare function GetDeclarationFileExtension(fileName: string): string;
/**
 ...
 * }
 */
export declare function GetDeclarationEmitExtensionForPath(path: string): string;
/**
 ...
 * }
 */
export declare function ChangeAnyExtension(path: string, ext: string, extensions: GoSlice<string>, ignoreCase: bool): string;
/**
 ...
 * }
 */
export declare function ChangeExtension(path: string, newExtension: string): string;
/**
 ...
 * }
 */
export declare function GetPossibleOriginalInputExtensionForExtension(path: string): GoSlice<string>;
