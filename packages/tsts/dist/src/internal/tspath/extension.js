 ...
 * )
 */
export const SupportedDeclarationExtensions = [ExtensionDts, ExtensionDcts, ExtensionDmts];
export const SupportedTSImplementationExtensions = [ExtensionTs, ExtensionTsx, ExtensionMts, ExtensionCts];
export const supportedTSExtensionsForExtractExtension = [ExtensionDts, ExtensionDcts, ExtensionDmts, ExtensionTs, ExtensionTsx, ExtensionMts, ExtensionCts];
...
export const SupportedTSExtensions = [
    [ExtensionTs, ExtensionTsx, ExtensionDts],
    [ExtensionCts, ExtensionDcts],
    [ExtensionMts, ExtensionDmts],
];
export const SupportedTSExtensionsFlat = [ExtensionTs, ExtensionTsx, ExtensionDts, ExtensionCts, ExtensionDcts, ExtensionMts, ExtensionDmts];
export const SupportedJSExtensions = [[ExtensionJs, ExtensionJsx], [ExtensionMjs], [ExtensionCjs]];
export const SupportedJSExtensionsFlat = [ExtensionJs, ExtensionJsx, ExtensionMjs, ExtensionCjs];
export const AllSupportedExtensionsWithJson = slices.Concat(AllSupportedExtensions, [[ExtensionJson]]);
export const SupportedTSExtensionsWithJson = slices.Concat(SupportedTSExtensions, [[ExtensionJson]]);
export const SupportedTSExtensionsWithJsonFlat = slices.Concat(SupportedTSExtensionsFlat, [ExtensionJson]);
export const ExtensionsNotSupportingExtensionlessResolution = [ExtensionMts, ExtensionDmts, ExtensionMjs, ExtensionCts, ExtensionDcts, ExtensionCjs];
/**
 ...
 * }
 */
export function ExtensionIsTs(ext) {
 ...
 */
export const extensionsToRemove = [ExtensionDts, ExtensionDmts, ExtensionDcts, ExtensionMjs, ExtensionMts, ExtensionCjs, ExtensionCts, ExtensionTs, ExtensionJs, ExtensionTsx, ExtensionJsx, ExtensionJson];
/**
 ...
 * }
 */
export function TryGetExtensionFromPath(p) {
    for (const ext of extensionsToRemove) {
        if (FileExtensionIs(p, ext)) {
            return ext;
        }
 ...
 * }
 */
export function RemoveExtension(path, extension) {
 ...
 * }
 */
export function TryExtractTSExtension(fileName) {
 ...
 * }
 */
export function HasTSFileExtension(path) {
    return FileExtensionIsOneOf(path, SupportedTSExtensionsFlat);
}
/**
 ...
 * }
 */
export function HasImplementationTSFileExtension(path) {
    return FileExtensionIsOneOf(path, SupportedTSImplementationExtensions) && !IsDeclarationFileName(path);
}
/**
 ...
 * }
 */
export function HasJSFileExtension(path) {
    return FileExtensionIsOneOf(path, SupportedJSExtensionsFlat);
}
/**
 ...
 * }
 */
export function HasJSONFileExtension(path) {
    return FileExtensionIs(path, ExtensionJson);
}
/**
 ...
 * }
 */
export function ExtensionIsOneOf(ext, extensions) {
    return slices.Contains(extensions, ext);
}
/**
 ...
 * }
 */
export function GetDeclarationEmitExtensionForPath(path) {
 ...
 * }
 */
export function ChangeExtension(path, newExtension) {
    return ChangeAnyExtension(path, newExtension, extensionsToRemove, false /*ignoreCase*/);
}
/**
 ...
 * }
 */
export function GetPossibleOriginalInputExtensionForExtension(path) {
