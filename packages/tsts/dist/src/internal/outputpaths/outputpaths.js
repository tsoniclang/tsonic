...
import { ChangeExtension, ExtensionCjs, ExtensionCts, ExtensionJson, ExtensionJs, ExtensionJsx, ExtensionMjs, ExtensionMts, ExtensionTsBuildInfo, FileExtensionIsOneOf, GetDeclarationEmitExtensionForPath, RemoveFileExtension, } from "../tspath/extension.js";
import { CombinePaths, ComparePaths, ContainsPath, EnsureTrailingDirectorySeparator, FileExtensionIs, GetBaseFileName, GetCanonicalFileName, GetNormalizedAbsolutePath, GetRelativePathFromDirectory, ResolvePath, } from "../tspath/path.js";
/**
 ...
 * }
 */
export function OutputPaths_DeclarationFilePath(receiver) {
 ...
 * }
 */
export function OutputPaths_JsFilePath(receiver) {
 ...
 * }
 */
export function OutputPaths_SourceMapFilePath(receiver) {
 ...
 * }
 */
export function OutputPaths_DeclarationMapPath(receiver) {
 ...
 * }
 */
export function GetOutputPathsFor(sourceFile, options, host, forceDtsEmit) {
 ...
 * }
 */
export function ForEachEmittedFile(host, options, action, sourceFiles, forceDtsEmit) {
 ...
 * }
 */
export function GetOutputJSFileName(inputFileName, options, host) {
 ...
 * }
 */
export function GetOutputJSFileNameWorker(inputFileName, options, host) {
    return ChangeExtension(getOutputPathWithoutChangingExtension(inputFileName, options.OutDir, host), GetOutputExtension(inputFileName, options.Jsx));
}
/**
 ...
 * }
 */
export function GetOutputDeclarationFileNameWorker(inputFileName, options, host) {
    let dir = options.DeclarationDir;
    if (dir.length === 0) {
        dir = options.OutDir;
    }
    return ChangeExtension(getOutputPathWithoutChangingExtension(inputFileName, dir, host), GetDeclarationEmitExtensionForPath(inputFileName));
}
/**
 ...
 * }
 */
export function GetOutputExtension(fileName, jsx) {
 ...
 * }
 */
export function GetDeclarationEmitOutputFilePath(file, options, host) {
    let outputDir;
 ...
 * }
 */
export function GetSourceFilePathInNewDir(fileName, newDirPath, currentDirectory, commonSourceDirectory, useCaseSensitiveFileNames) {
 ...
 * }
 */
export function getOutputPathWithoutChangingExtension(inputFileName, outputDirectory, host) {
 ...
 * }
 */
export function GetSourceFilePathInNewDirWorker(fileName, newDirPath, currentDirectory, commonSourceDirectory, useCaseSensitiveFileNames) {
    let sourceFilePath = GetNormalizedAbsolutePath(fileName, currentDirectory);
 ...
 * }
 */
export function getOwnEmitOutputFilePath(fileName, options, host, extension) {
    let emitOutputFilePathWithoutExtension;
    if (options.OutDir.length > 0) {
        const currentDirectory = host.GetCurrentDirectory();
        emitOutputFilePathWithoutExtension = RemoveFileExtension(GetSourceFilePathInNewDir(fileName, options.OutDir, currentDirectory, host.CommonSourceDirectory(), host.UseCaseSensitiveFileNames()));
    }
    else {
 ...
 * }
 */
export function GetSourceMapFilePath(jsFilePath, options) {
 ...
 * }
 */
export function GetBuildInfoFileName(options, opts) {
