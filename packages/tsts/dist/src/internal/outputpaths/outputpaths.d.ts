 ...
 * }
 */
export declare function OutputPaths_DeclarationFilePath(receiver: GoPtr<OutputPaths>): string;
/**
 ...
 * }
 */
export declare function OutputPaths_JsFilePath(receiver: GoPtr<OutputPaths>): string;
/**
 ...
 * }
 */
export declare function OutputPaths_SourceMapFilePath(receiver: GoPtr<OutputPaths>): string;
/**
 ...
 * }
 */
export declare function OutputPaths_DeclarationMapPath(receiver: GoPtr<OutputPaths>): string;
/**
 ...
 * }
 */
export declare function GetOutputPathsFor(sourceFile: GoPtr<SourceFile>, options: GoPtr<CompilerOptions>, host: OutputPathsHost, forceDtsEmit: bool): GoPtr<OutputPaths>;
/**
 ...
 * }
 */
export declare function ForEachEmittedFile(host: OutputPathsHost, options: GoPtr<CompilerOptions>, action: (emitFileNames: GoPtr<OutputPaths>, sourceFile: GoPtr<SourceFile>) => bool, sourceFiles: GoSlice<GoPtr<SourceFile>>, forceDtsEmit: bool): bool;
/**
 ...
 * }
 */
export declare function GetOutputJSFileName(inputFileName: string, options: GoPtr<CompilerOptions>, host: OutputPathsHost): string;
/**
 ...
 * }
 */
export declare function GetOutputJSFileNameWorker(inputFileName: string, options: GoPtr<CompilerOptions>, host: OutputPathsHost): string;
/**
 ...
 * }
 */
export declare function GetOutputDeclarationFileNameWorker(inputFileName: string, options: GoPtr<CompilerOptions>, host: OutputPathsHost): string;
/**
 ...
 * }
 */
export declare function GetOutputExtension(fileName: string, jsx: JsxEmit): string;
/**
 ...
 * }
 */
export declare function GetDeclarationEmitOutputFilePath(file: string, options: GoPtr<CompilerOptions>, host: OutputPathsHost): string;
/**
 ...
 * }
 */
export declare function GetSourceFilePathInNewDir(fileName: string, newDirPath: string, currentDirectory: string, commonSourceDirectory: string, useCaseSensitiveFileNames: bool): string;
/**
 ...
 * }
 */
export declare function getOutputPathWithoutChangingExtension(inputFileName: string, outputDirectory: string, host: OutputPathsHost): string;
/**
 ...
 * }
 */
export declare function GetSourceFilePathInNewDirWorker(fileName: string, newDirPath: string, currentDirectory: string, commonSourceDirectory: string, useCaseSensitiveFileNames: bool): string;
/**
 ...
 * }
 */
export declare function getOwnEmitOutputFilePath(fileName: string, options: GoPtr<CompilerOptions>, host: OutputPathsHost, extension: string): string;
/**
 ...
 * }
 */
export declare function GetSourceMapFilePath(jsFilePath: string, options: GoPtr<CompilerOptions>): string;
/**
 ...
 * }
 */
export declare function GetBuildInfoFileName(options: GoPtr<CompilerOptions>, opts: ComparePathsOptions): string;
//# sourceMappingURL=outputpaths.d.ts.map