 ...
 * }
 */
export declare function BeginProfiling(profileDir: string, logWriter: Writer): GoPtr<ProfileSession>;
/**
 ...
 * }
 */
export declare function ProfileSession_Stop(receiver: GoPtr<ProfileSession>): void;
/**
 ...
 * }
 */
export declare function CPUProfiler_StartCPUProfile(receiver: GoPtr<CPUProfiler>, profileDir: string): GoError;
/**
 ...
 * }
 */
export declare function CPUProfiler_StopCPUProfile(receiver: GoPtr<CPUProfiler>): [string, GoError];
/**
 ...
 * }
 */
export declare function SaveHeapProfile(profileDir: string): [string, GoError];
/**
 ...
 * }
 */
export declare function SaveAllocProfile(profileDir: string): [string, GoError];
/**
