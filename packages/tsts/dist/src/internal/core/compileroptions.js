...
import { Tristate_IsTrue, Tristate_IsTrueOrUnknown, TSFalse, TSTrue, TSUnknown, } from "./tristate.js";
/**
 ...
 * func (*noCopy) Lock()   {}
 */
export function noCopy_Lock(receiver) { }
/**
 ...
 * func (*noCopy) Unlock() {}
 */
export function noCopy_Unlock(receiver) { }
/**
 ...
 */
export const EmptyCompilerOptions = {};
...
const normalizedCompilerOptionsMarker = Symbol("tsts.normalizedCompilerOptions");
 ...
 */
export const optionsType = TypeFor();
/**
 ...
 * }
 */
export function CompilerOptions_Clone(receiver) {
    return { ...receiver };
}
/**
 ...
 * }
 */
export function CompilerOptions_GetEmitScriptTarget(receiver) {
 ...
 * }
 */
export function CompilerOptions_GetEmitModuleKind(receiver) {
    const options = receiver;
    if (options.Module !== ModuleKindNone) {
        return options.Module;
    }
 ...
 * }
 */
export function CompilerOptions_GetModuleResolutionKind(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetEmitModuleDetectionKind(receiver) {
    const options = receiver;
    if (options.ModuleDetection !== ModuleDetectionKindNone) {
        return options.ModuleDetection;
    }
 ...
 * }
 */
export function CompilerOptions_GetResolvePackageJsonExports(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetResolvePackageJsonImports(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetAllowImportingTsExtensions(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_AllowImportingTsExtensionsFrom(receiver, fileName) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetResolveJsonModule(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_ShouldPreserveConstEnums(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetAllowJS(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetJSXTransformEnabled(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetStrictOptionValue(receiver, value) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetEffectiveTypeRoots(receiver, currentDirectory) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_UsesWildcardTypes(receiver) {
    const options = receiver;
    return slices.Contains(options.Types, "*");
}
/**
 ...
 * }
 */
export function CompilerOptions_GetIsolatedModules(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_IsIncremental(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetEmitStandardClassFields(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetUseDefineForClassFields(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetEmitDeclarations(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_GetAreDeclarationMapsEnabled(receiver) {
    const options = receiver;
 ...
 * }
 */
export function CompilerOptions_HasJsonModuleEmitEnabled(receiver) {
    const options = receiver;
    switch (CompilerOptions_GetEmitModuleKind(options)) {
 ...
 * }
 */
export function CompilerOptions_GetPathsBasePath(receiver, currentDirectory) {
    const options = receiver;
 ...
 * )
 */
export const ModuleDetectionKindNone = 0;
export const ModuleDetectionKindAuto = 1;
export const ModuleDetectionKindLegacy = 2;
export const ModuleDetectionKindForce = 3;
/**
...
// Deprecated: Do not use outside of options parsing and validation.
export const ModuleKindAMD = 2;
// Deprecated: Do not use outside of options parsing and validation.
export const ModuleKindUMD = 3;
// Deprecated: Do not use outside of options parsing and validation.
export const ModuleKindSystem = 4;
// NOTE: ES module kinds should be contiguous to more easily check whether a module kind is *any* ES module kind.
//       Non-ES module kinds should not come between ES2015 (the earliest ES module kind) and ESNext (the last ES
//       module kind).
export const ModuleKindES2015 = 5;
export const ModuleKindES2020 = 6;
export const ModuleKindES2022 = 7;
export const ModuleKindESNext = 99;
// Node16+ is an amalgam of commonjs (albeit updated) and es2022+, and represents a distinct module system from es2020/esnext
export const ModuleKindNode16 = 100;
export const ModuleKindNode18 = 101;
export const ModuleKindNode20 = 102;
export const ModuleKindNodeNext = 199;
// Emit as written
export const ModuleKindPreserve = 200;
/**
 ...
 * }
 */
export function ModuleKind_IsNonNodeESM(receiver) {
    const moduleKind = receiver;
    return moduleKind >= ModuleKindES2015 && moduleKind <= ModuleKindESNext;
}
/**
 ...
 * }
 */
export function ModuleKind_SupportsImportAttributes(receiver) {
    const moduleKind = receiver;
    return ((ModuleKindNode18 <= moduleKind && moduleKind <= ModuleKindNodeNext) ||
        moduleKind === ModuleKindPreserve ||
        moduleKind === ModuleKindESNext);
 ...
 * )
 */
export const ResolutionModeNone = ModuleKindNone;
export const ResolutionModeCommonJS = ModuleKindCommonJS;
export const ResolutionModeESM = ModuleKindESNext;
/**
 ...
 * )
 */
export const ModuleResolutionKindUnknown = 0;
// Deprecated: Do not use outside of options parsing and validation.
export const ModuleResolutionKindClassic = 1;
// Deprecated: Do not use outside of options parsing and validation.
export const ModuleResolutionKindNode10 = 2;
// Starting with node16, node's module resolver has significant departures from traditional cjs resolution
// to better support ECMAScript modules and their use within node - however more features are still being added.
// TypeScript's Node ESM support was introduced after Node 12 went end-of-life, and Node 14 is the earliest stable
// version that supports both pattern trailers - *but*, Node 16 is the first version that also supports ECMAScript 2022.
// In turn, we offer both a `NodeNext` moving resolution target, and a `Node16` version-anchored resolution target
export const ModuleResolutionKindNode16 = 3;
export const ModuleResolutionKindNodeNext = 99; // Not simply `Node16` so that compiled code linked against TS can use the `Next` value reliably (same as with `ModuleKind`)
export const ModuleResolutionKindBundler = 100;
/**
 ...
 * }
 */
export let ModuleKindToModuleResolutionKind = new globalThis.Map([
    [ModuleKindNode16, ModuleResolutionKindNode16],
    [ModuleKindNodeNext, ModuleResolutionKindNodeNext],
]);
/**
 ...
 * }
 */
export function ModuleResolutionKind_String(receiver) {
    const m = receiver;
    switch (m) {
        case ModuleResolutionKindUnknown:
 ...
 * }
 */
export function GetNewLineKind(s) {
    switch (s) {
        case "\r\n":
            return NewLineKindCRLF;
        case "\n":
 ...
 * }
 */
export function NewLineKind_GetNewLineCharacter(receiver) {
    const newLine = receiver;
    switch (newLine) {
        case NewLineKindCRLF:
            return "\r\n";
        default:
 ...
 * )
 */
export const ScriptTargetNone = 0;
// Deprecated: Do not use outside of options parsing and validation.
export const ScriptTargetES5 = 1;
export const ScriptTargetES2015 = 2;
export const ScriptTargetES2016 = 3;
export const ScriptTargetES2017 = 4;
export const ScriptTargetES2018 = 5;
export const ScriptTargetES2019 = 6;
export const ScriptTargetES2020 = 7;
export const ScriptTargetES2021 = 8;
export const ScriptTargetES2022 = 9;
export const ScriptTargetES2023 = 10;
export const ScriptTargetES2024 = 11;
export const ScriptTargetES2025 = 12;
export const ScriptTargetESNext = 99;
export const ScriptTargetJSON = 100;
export const ScriptTargetLatest = ScriptTargetESNext;
export const ScriptTargetLatestStandard = ScriptTargetES2025;
/**
 ...
 * )
 */
export const JsxEmitNone = 0;
export const JsxEmitPreserve = 1;
export const JsxEmitReactNative = 2;
export const JsxEmitReact = 3;
export const JsxEmitReactJSX = 4;
export const JsxEmitReactJSXDev = 5;
/**
 ...
 * }
 */
export function JsxEmit_String(receiver) {
    const j = receiver;
    switch (j) {
        case JsxEmitNone:
