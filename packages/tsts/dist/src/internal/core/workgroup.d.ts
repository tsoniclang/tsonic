 ...
 * }
 */
export declare function NewWorkGroup(singleThreaded: bool): WorkGroup;
/**
 ...
 */
export declare const __7c9694b3_0: WorkGroup;
export declare function parallelWorkGroup_as_WorkGroup(receiver: GoPtr<parallelWorkGroup>): WorkGroup;
/**
 ...
 * }
 */
export declare function parallelWorkGroup_Queue(receiver: GoPtr<parallelWorkGroup>, fn: () => void): void;
/**
 ...
 * }
 */
export declare function parallelWorkGroup_RunAndWait(receiver: GoPtr<parallelWorkGroup>): void;
/**
 ...
 */
export declare const __056fa025_0: WorkGroup;
export declare function singleThreadedWorkGroup_as_WorkGroup(receiver: GoPtr<singleThreadedWorkGroup>): WorkGroup;
/**
 ...
 * }
 */
export declare function singleThreadedWorkGroup_Queue(receiver: GoPtr<singleThreadedWorkGroup>, fn: () => void): void;
/**
 ...
 * }
 */
export declare function singleThreadedWorkGroup_RunAndWait(receiver: GoPtr<singleThreadedWorkGroup>): void;
/**
 ...
 * }
 */
export declare function singleThreadedWorkGroup_pop(receiver: GoPtr<singleThreadedWorkGroup>): GoPtr<() => void>;
/**
 ...
 * }
 */
export declare function NewThrottleGroup(ctx: Context, semaphore: GoChan<{
    readonly __tsgoEmpty?: never;
}, "bidirectional">): GoPtr<ThrottleGroup>;
/**
 ...
 * }
 */
export declare function ThrottleGroup_Go(receiver: GoPtr<ThrottleGroup>, fn: () => GoError): void;
/**
 ...
 * }
 */
export declare function ThrottleGroup_Wait(receiver: GoPtr<ThrottleGroup>): GoError;
