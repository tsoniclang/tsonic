 ...
 * }
 */
export declare function TryParsePattern(pattern: string): Pattern;
/**
 ...
 * }
 */
export declare function Pattern_IsValid(receiver: GoPtr<Pattern>): bool;
/**
 ...
 * }
 */
export declare function Pattern_Matches(receiver: GoPtr<Pattern>, candidate: string): bool;
/**
 ...
 * }
 */
export declare function Pattern_MatchedText(receiver: GoPtr<Pattern>, candidate: string): string;
/**
 ...
 * }
 */
export declare function FindBestPatternMatch<T>(values: GoSlice<T>, getPattern: (v: T) => Pattern, candidate: string): T;
