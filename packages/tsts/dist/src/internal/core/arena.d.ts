 ...
 * }
 */
export declare function Arena_New<T>(receiver: GoPtr<Arena<T>>): GoPtr<T>;
/**
 ...
 * }
 */
export declare function Arena_NewSlice<T>(receiver: GoPtr<Arena<T>>, size: int): GoSlice<T>;
/**
 ...
 * }
 */
export declare function Arena_NewSlice1<T>(receiver: GoPtr<Arena<T>>, t: T): GoSlice<T>;
/**
 ...
 * }
 */
export declare function Arena_Clone<T>(receiver: GoPtr<Arena<T>>, t: GoSlice<T>): GoSlice<T>;
/**
 ...
 * }
 */
export declare function nextArenaSize(size: int): int;
