 ...
 */
export const _LanguageVariant_name = "LanguageVariantStandardLanguageVariantJSX";
/**
 ...
 */
export let _LanguageVariant_index = [0, 23, 41];
/**
 ...
 * }
 */
export function LanguageVariant_String(receiver) {
    const i = receiver;
    const idx = i - 0;
    if (i < 0 || idx >= _LanguageVariant_index.length - 1) {
        return "LanguageVariant(" + FormatInt(i, 10) + ")";
    }
    return _LanguageVariant_name.slice(_LanguageVariant_index[idx], _LanguageVariant_index[idx + 1]);
}
//# sourceMappingURL=languagevariant_stringer_generated.js.map