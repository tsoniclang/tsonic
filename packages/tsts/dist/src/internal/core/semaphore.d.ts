 ...
 */
export declare const __c5a93a22_0: Semaphore;
/**
...
export declare function UnlimitedSemaphore_as_Semaphore(receiver: UnlimitedSemaphore): Semaphore;
/**
 ...
 * }
 */
export declare function UnlimitedSemaphore_Acquire(receiver: UnlimitedSemaphore): () => void;
/**
 ...
 * }
 */
export declare function UnlimitedSemaphore_TryAcquire(receiver: UnlimitedSemaphore, ctx: Context): [() => void, bool];
/**
 ...
 */
export declare const __1cad8911_0: Semaphore;
/**
...
export declare function LimitedSemaphore_as_Semaphore(receiver: GoPtr<LimitedSemaphore>): Semaphore;
/**
 ...
 * }
 */
export declare function NewLimitedSemaphore(maxConcurrency: int): GoPtr<LimitedSemaphore>;
/**
 ...
 * }
 */
export declare function LimitedSemaphore_Acquire(receiver: GoPtr<LimitedSemaphore>): () => void;
/**
 ...
 * }
 */
export declare function LimitedSemaphore_TryAcquire(receiver: GoPtr<LimitedSemaphore>, ctx: Context): [() => void, bool];
