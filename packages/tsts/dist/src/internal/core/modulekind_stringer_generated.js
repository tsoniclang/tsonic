...
import { ModuleKindAMD, ModuleKindCommonJS, ModuleKindES2015, ModuleKindES2020, ModuleKindES2022, ModuleKindESNext, ModuleKindNode16, ModuleKindNode18, ModuleKindNode20, ModuleKindNodeNext, ModuleKindNone, ModuleKindPreserve, ModuleKindSystem, ModuleKindUMD, } from "./compileroptions.js";
/**
 ...
 * )
 */
export const _ModuleKind_name_0 = "NoneCommonJSAMDUMDSystemES2015ES2020ES2022";
export const _ModuleKind_name_1 = "ESNextNode16Node18Node20";
export const _ModuleKind_name_2 = "NodeNextPreserve";
/**
 ...
 * )
 */
export let _ModuleKind_index_0 = [0, 4, 12, 15, 18, 24, 30, 36, 42];
export let _ModuleKind_index_1 = [0, 6, 12, 18, 24];
export let _ModuleKind_index_2 = [0, 8, 16];
/**
 ...
 * }
 */
export function ModuleKind_String(receiver) {
    let i = receiver;
    switch (true) {
        case 0 <= i && i <= 7:
        ...
        default:
            return "ModuleKind(" + FormatInt(i, 10) + ")";
    }
}
//# sourceMappingURL=modulekind_stringer_generated.js.map