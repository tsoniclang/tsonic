 ...
 * }
 */
export function NewTextRange(pos, end) {
 ...
 * }
 */
export function UndefinedTextRange() {
    return { pos: -1, end: -1 };
}
/**
 ...
 * }
 */
export function TextRange_Pos(receiver) {
    return receiver.pos;
}
/**
 ...
 * }
 */
export function TextRange_End(receiver) {
    return receiver.end;
}
/**
 ...
 * }
 */
export function TextRange_Len(receiver) {
 ...
 * }
 */
export function TextRange_IsValid(receiver) {
 ...
 * }
 */
export function TextRange_Contains(receiver, pos) {
 ...
 * }
 */
export function TextRange_ContainsInclusive(receiver, pos) {
    return pos >= receiver.pos && pos <= receiver.end;
}
/**
 ...
 * }
 */
export function TextRange_ContainsExclusive(receiver, pos) {
 ...
 * }
 */
export function TextRange_WithPos(receiver, pos) {
 ...
 * }
 */
export function TextRange_WithEnd(receiver, end) {
 ...
 * }
 */
export function TextRange_ContainedBy(receiver, t2) {
 ...
 * }
 */
export function TextRange_Overlaps(receiver, t2) {
 ...
 * }
 */
export function TextRange_Intersects(receiver, t2) {
    const start = Math.max(receiver.pos, t2.pos);
    const end = Math.min(receiver.end, t2.end);
    return start <= end;
}
 ...
 * }
 */
export function CompareTextRanges(r1, r2) {
