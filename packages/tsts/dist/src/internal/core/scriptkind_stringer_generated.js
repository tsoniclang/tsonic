...
import { ScriptKindDeferred, ScriptKindExternal, ScriptKindJS, ScriptKindJSON, ScriptKindJSX, ScriptKindTS, ScriptKindTSX, ScriptKindUnknown, } from "./scriptkind.js";
/**
 ...
 */
export const _ScriptKind_name = "ScriptKindUnknownScriptKindJSScriptKindJSXScriptKindTSScriptKindTSXScriptKindExternalScriptKindJSONScriptKindDeferred";
/**
 ...
 */
export let _ScriptKind_index = [0, 17, 29, 42, 54, 67, 85, 99, 117];
/**
 ...
 * }
 */
export function ScriptKind_String(receiver) {
    const i = receiver;
    const idx = i - 0;
    if (i < 0 || idx >= _ScriptKind_index.length - 1) {
        return "ScriptKind(" + FormatInt(i, 10) + ")";
    }
    return _ScriptKind_name.slice(_ScriptKind_index[idx], _ScriptKind_index[idx + 1]);
}
//# sourceMappingURL=scriptkind_stringer_generated.js.map