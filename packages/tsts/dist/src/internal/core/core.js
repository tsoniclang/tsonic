...
const byteSliceFrom = (s, start) => utf8.StringByteSlice(s, start);
// []rune(s): decode the string into Unicode code points (runes).
const stringToRunes = (s) => {
    const runes = [];
    for (const ch of s) {
 ...
 * }
 */
export function Filter(slice, f) {
    const values = slice ?? [];
 ...
 * }
 */
export function FilterSeq(slice, f) {
    return (yield_) => {
 ...
 * }
 */
export function FilterIndex(slice, f) {
    const values = slice ?? [];
    for (let i = 0; i < values.length; i++) {
        let value = values[i];
        if (!f(value, i, values)) {
...
export function Map(slice, f) {
    ...
    const result = new globalThis.Array(slice.length);
 ...
 * }
 */
export function TryMap(slice, f) {
    if (slice.length === 0) {
        return [[], undefined];
    }
    const result = new globalThis.Array(slice.length);
 ...
 * }
 */
export function MapIndex(slice, f) {
    if (slice === undefined) {
        return [];
    }
    const result = new globalThis.Array(slice.length);
 ...
 * }
 */
export function MapNonNil(slice, f) {
    const result = [];
    for (const value of slice) {
 ...
 * }
 */
export function MapFiltered(slice, f) {
    const result = [];
    for (const value of slice) {
 ...
 * }
 */
export function FlatMap(slice, f) {
    const result = [];
    for (const value of slice) {
        const mapped = f(value);
        if (mapped.length !== 0) {
 ...
 * }
 */
export function SameMap(slice, f) {
    for (let i = 0; i < slice.length; i++) {
        const value = slice[i];
        const mapped = f(value);
        if (mapped !== value) {
 ...
 * }
 */
export function SameMapIndex(slice, f) {
    for (let i = 0; i < slice.length; i++) {
        const value = slice[i];
 ...
 * }
 */
export function FindLast(slice, f) {
 ...
 * }
 */
export function FindIndex(slice, f) {
    for (let i = 0; i < slice.length; i++) {
        const value = slice[i];
        if (f(value)) {
            return i;
 ...
 * }
 */
export function FindLastIndex(slice, f) {
    for (let i = slice.length - 1; i >= 0; i--) {
        const value = slice[i];
        if (f(value)) {
            return i;
 ...
 * }
 */
export function FirstOrNil(slice) {
    if (slice.length !== 0) {
        return slice[0];
    }
    return undefined;
 ...
 * }
 */
export function LastOrNil(slice) {
    if (slice.length !== 0) {
 ...
 * }
 */
export function ElementOrNil(slice, index) {
 ...
 * }
 */
export function FirstOrNilSeq(seq) {
 ...
 * }
 */
export function FirstNonNil(slice, f) {
    for (const value of slice) {
        const mapped = f(value);
        if (mapped !== undefined) {
            return mapped;
 ...
 * }
 */
export function Concatenate(s1, s2) {
    const left = s1 ?? [];
    const right = s2 ?? [];
    if (right.length === 0) {
        return left;
 ...
 * }
 */
export function Splice(s1, start, deleteCount, ...items) {
    if (start < 0) {
 ...
 * }
 */
export function CountWhere(slice, f) {
    let count = 0;
    for (const value of slice) {
        if (f(value)) {
            count++;
 ...
 * }
 */
export function ReplaceElement(slice, i, t) {
 ...
 * }
 */
export function InsertSorted(slice, element, cmp) {
 ...
 * }
 */
export function MinAllFunc(xs, cmp) {
    if (xs.length === 0) {
        return [];
    }
    let m = xs[0];
 ...
 * }
 */
export function AppendIfUnique(slice, element) {
    if (slices.Contains(slice, element)) {
        return slice ?? [];
    }
 ...
 * }
 */
export function Memoize(create) {
    let value = undefined;
 ...
 * }
 */
export function IfElse(b, whenTrue, whenFalse) {
    if (b) {
        return whenTrue;
    }
    return whenFalse;
 ...
 * }
 */
export function ComputeECMALineStarts(text) {
    const result = [];
    return slices.AppendSeq(result, ComputeECMALineStartsSeq(text));
}
/**
 ...
 * }
 */
export function ComputeECMALineStartsSeq(text) {
    return (yield_) => {
 ...
 * }
 */
export function PositionToLineAndByteOffset(position, lineStarts) {
    const line = globalThis.Math.max(sort.Search(lineStarts.length, (i) => {
 ...
 * }
 */
export function FirstResult(t1, ...arg) {
    return t1;
}
/**
 ...
 * }
 */
export function StringifyJson(input, prefix, indent) {
 ...
 * }
 */
export function GetScriptKindFromFileName(fileName) {
 ...
 * }
 */
export function GetSpellingSuggestion(name, candidates, getName, compare) {
 ...
 * }
 */
export function GetSpellingSuggestionForStrings(name, candidates) {
 ...
 * }
 */
export const levenshteinBuffersPool = globalThis.Object.assign(new Pool(), {
    New: () => {
 ...
 * }
 */
export function levenshteinWithMax(buffers, s1, s2, maxValue) {
 ...
 * }
 */
export function CheckEachDefined(s, msg) {
 ...
 * }
 */
export function IndexAfter(s, pattern, startIndex) {
 ...
 * }
 */
export function ShouldRewriteModuleSpecifier(specifier, compilerOptions) {
 ...
 * }
 */
export function SingleElementSlice(element) {
 ...
 * }
 */
export function ConcatenateSeq(...seqs) {
    return (yield_) => {
 ...
 * }
 */
export function comparableValuesEqual(a, b) {
    return a === b;
}
/**
 ...
 * }
 */
export function DiffMaps(m1, m2, onAdded, onRemoved, onChanged) {
    DiffMapsFunc(m1, m2, comparableValuesEqual, onAdded, onRemoved, onChanged);
}
/**
 ...
 * }
 */
export function DiffMapsFunc(m1, m2, equalValues, onAdded, onRemoved, onChanged) {
 ...
 * }
 */
export function CopyMapInto(dst, src) {
    if (dst === undefined) {
        return maps.Clone(src);
    }
    maps.Copy(dst, src);
 ...
 * }
 */
export function UnorderedEqual(s1, s2) {
    if (s1.length !== s2.length) {
        return false;
    }
 ...
 * }
 */
export function Deduplicate(slice) {
    if (slice.length > 1) {
        for (let i = 0; i < slice.length; i++) {
            let value = slice[i];
 ...
 * }
 */
export function DeduplicateSorted(slice, isEqual) {
    if (slice.length === 0) {
        return slice;
    }
    let last = slice[0];
    ...
    const deduplicated = slice.slice(0, 1);
