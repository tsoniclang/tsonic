...
import { ScriptTargetES5, ScriptTargetES2015, ScriptTargetES2016, ScriptTargetES2017, ScriptTargetES2018, ScriptTargetES2019, ScriptTargetES2020, ScriptTargetES2021, ScriptTargetES2022, ScriptTargetES2023, ScriptTargetES2024, ScriptTargetES2025, ScriptTargetESNext, ScriptTargetJSON, ScriptTargetLatest, ScriptTargetLatestStandard, ScriptTargetNone, } from "./compileroptions.js";
/**
 ...
 * )
 */
export const _ScriptTarget_name_0 = "NoneES5ES2015ES2016ES2017ES2018ES2019ES2020ES2021ES2022ES2023ES2024ES2025";
export const _ScriptTarget_name_1 = "ESNextJSON";
/**
 ...
 * )
 */
export let _ScriptTarget_index_0 = [0, 4, 7, 13, 19, 25, 31, 37, 43, 49, 55, 61, 67, 73];
export let _ScriptTarget_index_1 = [0, 6, 10];
/**
 ...
 * }
 */
export function ScriptTarget_String(receiver) {
    let i = receiver;
    switch (true) {
        case 0 <= i && i <= 12:
        ...
        default:
            return "ScriptTarget(" + FormatInt(i, 10) + ")";
    }
}
//# sourceMappingURL=scripttarget_stringer_generated.js.map