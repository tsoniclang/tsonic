import type { bool, double, int } from "@tsonic/core/types.js";
import type { GoComparable, GoError, GoMap, GoPtr, GoRune, GoSeq, GoSeq2, GoSlice } from "../../go/compat.js";
 ...
 * }
 */
export declare function Filter<T>(slice: GoPtr<GoSlice<T>>, f: (arg0: T) => bool): GoSlice<T>;
/**
 ...
 * }
 */
export declare function FilterSeq<T>(slice: GoPtr<GoSlice<T>>, f: (arg0: T) => bool): GoSeq<T>;
/**
 ...
 * }
 */
export declare function FilterIndex<T>(slice: GoPtr<GoSlice<T>>, f: (arg0: T, arg1: int, arg2: GoSlice<T>) => bool): GoSlice<T>;
/**
 ...
 * }
 */
export declare function Map<T, U>(slice: GoSlice<T>, f: (arg0: T) => U): GoSlice<U>;
/**
 ...
 * }
 */
export declare function TryMap<T, U>(slice: GoSlice<T>, f: (arg0: T) => [U, GoError]): [GoSlice<U>, GoError];
/**
 ...
 * }
 */
export declare function MapIndex<T, U>(slice: GoSlice<T>, f: (arg0: T, arg1: int) => U): GoSlice<U>;
/**
 ...
 * }
 */
export declare function MapNonNil<T, U extends GoComparable>(slice: GoSlice<T>, f: (arg0: T) => U): GoSlice<U>;
/**
 ...
 * }
 */
export declare function MapFiltered<T, U>(slice: GoSlice<T>, f: (arg0: T) => [U, bool]): GoSlice<U>;
/**
 ...
 * }
 */
export declare function FlatMap<T, U>(slice: GoSlice<T>, f: (arg0: T) => GoSlice<U>): GoSlice<U>;
/**
 ...
 * }
 */
export declare function SameMap<T extends GoComparable>(slice: GoSlice<T>, f: (arg0: T) => T): GoSlice<T>;
/**
 ...
 * }
 */
export declare function SameMapIndex<T extends GoComparable>(slice: GoSlice<T>, f: (arg0: T, arg1: int) => T): GoSlice<T>;
/**
 ...
 * }
 */
export declare function Same<T>(s1: GoSlice<T>, s2: GoSlice<T>): bool;
/**
 ...
 * }
 */
export declare function Some<T>(slice: GoSlice<T> | undefined, f: (arg0: T) => bool): bool;
/**
 ...
 * }
 */
export declare function Every<T>(slice: GoSlice<T> | undefined, f: (arg0: T) => bool): bool;
/**
 ...
 * }
 */
export declare function Or<T>(...funcs: Array<(arg0: T) => bool>): (arg0: T) => bool;
/**
 ...
 * }
 */
export declare function Find<T>(slice: GoSlice<T>, f: (arg0: T) => bool): T;
/**
 ...
 * }
 */
export declare function FindLast<T>(slice: GoSlice<T>, f: (arg0: T) => bool): T;
/**
 ...
 * }
 */
export declare function FindIndex<T>(slice: GoSlice<T>, f: (arg0: T) => bool): int;
/**
 ...
 * }
 */
export declare function FindLastIndex<T>(slice: GoSlice<T>, f: (arg0: T) => bool): int;
/**
 ...
 * }
 */
export declare function FirstOrNil<T>(slice: GoSlice<T>): T;
/**
 ...
 * }
 */
export declare function LastOrNil<T>(slice: GoSlice<T>): T;
/**
 ...
 * }
 */
export declare function ElementOrNil<T>(slice: GoSlice<T>, index: int): T;
/**
 ...
 * }
 */
export declare function FirstOrNilSeq<T>(seq: GoSeq<T>): T;
/**
 ...
 * }
 */
export declare function FirstNonNil<T, U extends GoComparable>(slice: GoSlice<T>, f: (arg0: T) => U): U;
/**
 ...
 * }
 */
export declare function FirstNonZero<T extends GoComparable>(...values: Array<T>): T;
/**
 ...
 * }
 */
export declare function Concatenate<T>(s1: GoPtr<GoSlice<T>>, s2: GoPtr<GoSlice<T>>): GoSlice<T>;
/**
 ...
 * }
 */
export declare function Splice<T>(s1: GoSlice<T>, start: int, deleteCount: int, ...items: Array<T>): GoSlice<T>;
/**
 ...
 * }
 */
export declare function CountWhere<T>(slice: GoSlice<T>, f: (arg0: T) => bool): int;
/**
 ...
 * }
 */
export declare function ReplaceElement<T>(slice: GoSlice<T>, i: int, t: T): GoSlice<T>;
/**
 ...
 * }
 */
export declare function InsertSorted<T>(slice: GoSlice<T>, element: T, cmp: (arg0: T, arg1: T) => int): GoSlice<T>;
/**
 ...
 * }
 */
export declare function MinAllFunc<T>(xs: GoSlice<T>, cmp: (a: T, b: T) => int): GoSlice<T>;
/**
 ...
 * }
 */
export declare function AppendIfUnique<T extends GoComparable>(slice: GoPtr<GoSlice<T>>, element: T): GoSlice<T>;
/**
 ...
 * }
 */
export declare function Memoize<T>(create: () => T): () => T;
/**
 ...
 * }
 */
export declare function IfElse<T>(b: bool, whenTrue: T, whenFalse: T): T;
/**
 ...
 * }
 */
export declare function OrElse<T extends GoComparable>(value: T, defaultValue: T): T;
/**
 ...
 * }
 */
export declare function Coalesce<T, U>(a: T, b: T): T;
/**
 ...
 * }
 */
export declare function ComputeECMALineStarts(text: string): ECMALineStarts;
/**
 ...
 * }
 */
export declare function ComputeECMALineStartsSeq(text: string): GoSeq<TextPos>;
/**
 ...
 * }
 */
export declare function PositionToLineAndByteOffset(position: int, lineStarts: GoSlice<TextPos>): [int, int];
/**
 ...
 * }
 */
export declare function UTF16Len(s: string): UTF16Offset;
/**
 ...
 * }
 */
export declare function Flatten<T>(array: GoSlice<GoSlice<T>>): GoSlice<T>;
/**
 ...
 * }
 */
export declare function Must<T>(v: T, err: GoError): T;
/**
 ...
 * }
 */
export declare function FirstResult<T1>(t1: T1, ...arg: Array<unknown>): T1;
/**
 ...
 * }
 */
export declare function StringifyJson(input: unknown, prefix: string, indent: string): [string, GoError];
/**
 ...
 * }
 */
export declare function GetSpellingSuggestion<T>(name: string, candidates: GoSeq<T>, getName: (arg0: T) => string, compare: (arg0: T, arg1: T) => int): T;
/**
 ...
 * }
 */
export declare function GetSpellingSuggestionForStrings(name: string, candidates: GoSeq<string>): string;
/**
 ...
 * }
 */
export declare const levenshteinBuffersPool: Pool<levenshteinBuffers>;
/**
 ...
 * }
 */
export declare function levenshteinWithMax(buffers: GoPtr<levenshteinBuffers>, s1: GoSlice<GoRune>, s2: GoSlice<GoRune>, maxValue: double): double;
/**
 ...
 * }
 */
export declare function CheckEachDefined<S>(s: GoSlice<GoPtr<S>>, msg: string): GoSlice<GoPtr<S>>;
/**
 ...
 * }
 */
export declare function IndexAfter(s: string, pattern: string, startIndex: int): int;
/**
 ...
 * }
 */
export declare function ShouldRewriteModuleSpecifier(specifier: string, compilerOptions: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function SingleElementSlice<T>(element: GoPtr<T>): GoSlice<GoPtr<T>>;
/**
 ...
 * }
 */
export declare function ConcatenateSeq<T>(...seqs: Array<GoSeq<T>>): GoSeq<T>;
/**
 ...
 * }
 */
export declare function Enumerate<T>(seq: GoSeq<T>): GoSeq2<int, T>;
/**
 ...
 * }
 */
export declare function comparableValuesEqual<T extends GoComparable>(a: T, b: T): bool;
/**
 ...
 * }
 */
export declare function DiffMaps<K extends GoComparable, V extends GoComparable>(m1: GoMap<K, V>, m2: GoMap<K, V>, onAdded: (arg0: K, arg1: V) => void, onRemoved: (arg0: K, arg1: V) => void, onChanged: (arg0: K, arg1: V, arg2: V) => void): void;
/**
 ...
 * }
 */
export declare function DiffMapsFunc<K extends GoComparable, V1, V2>(m1: GoMap<K, V1>, m2: GoMap<K, V2>, equalValues: (arg0: V1, arg1: V2) => bool, onAdded: (arg0: K, arg1: V2) => void, onRemoved: (arg0: K, arg1: V1) => void, onChanged: (arg0: K, arg1: V1, arg2: V2) => void): void;
/**
 ...
 * }
 */
export declare function CopyMapInto<M1 extends GoMap<K, V>, M2 extends GoMap<K, V>, K extends GoComparable, V>(dst: M1, src: M2): GoMap<K, V>;
/**
 ...
 * }
 */
export declare function UnorderedEqual<T extends GoComparable>(s1: GoSlice<T>, s2: GoSlice<T>): bool;
/**
 ...
 * }
 */
export declare function Deduplicate<T extends GoComparable>(slice: GoSlice<T>): GoSlice<T>;
/**
 ...
 * }
 */
export declare function DeduplicateSorted<T>(slice: GoSlice<T>, isEqual: (a: T, b: T) => bool): GoSlice<T>;
/**
 ...
 * }
 */
export declare function CompareBooleans(a: bool, b: bool): int;
