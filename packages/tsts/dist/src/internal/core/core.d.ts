 ...
 * }
 */
export declare function ApplyDebugStackLimit(): void;
/**
 ...
 * }
 */
export declare function Coalesce<T extends GoPtr<U>, U>(a: T, b: T): T;
/**
 ...
 * }
 */
export declare function CopyMapInto<M1 extends GoConstraint<"~map[K]V"> & GoMap<K, V>, M2 extends GoConstraint<"~map[K]V"> & GoMap<K, V>, K extends GoComparable, V>(dst: M1, src: M2): GoMap<K, V>;
/**
