 ...
 * }
 */
export declare function ResolveProjectReferencePath(ref: GoPtr<ProjectReference>): string;
/**
 ...
 * }
 */
export declare function ResolveConfigFileNameOfProjectReference(path: string): string;
//# sourceMappingURL=projectreference.d.ts.map