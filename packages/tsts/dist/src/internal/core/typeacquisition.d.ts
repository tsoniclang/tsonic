 ...
 * }
 */
export declare function TypeAcquisition_Equals(receiver: GoPtr<TypeAcquisition>, other: GoPtr<TypeAcquisition>): bool;
//# sourceMappingURL=typeacquisition.d.ts.map