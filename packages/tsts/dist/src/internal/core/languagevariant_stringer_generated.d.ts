 ...
 */
export declare const _LanguageVariant_name: string;
/**
 ...
 */
export declare let _LanguageVariant_index: GoArray<byte, "...">;
/**
 ...
 * }
 */
export declare function LanguageVariant_String(receiver: LanguageVariant): string;
//# sourceMappingURL=languagevariant_stringer_generated.d.ts.map