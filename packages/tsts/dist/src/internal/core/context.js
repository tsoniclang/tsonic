 ...
 * )
 */
export const requestIDKey = 0;
export const checkerLifetimeKey = 1;
/**
 ...
 * }
 */
export function WithRequestID(ctx, id) {
 ...
 * )
 */
export const CheckerLifetimeTemporary = 0;
export const CheckerLifetimeDiagnostics = 1;
export const CheckerLifetimeAPI = 2;
/**
 ...
 * }
 */
export function WithCheckerLifetime(ctx, lifetime) {
 ...
 * }
 */
export function GetCheckerLifetime(ctx) {
