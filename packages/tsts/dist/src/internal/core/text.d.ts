 ...
 * }
 */
export declare function NewTextRange(pos: int, end: int): TextRange;
/**
 ...
 * }
 */
export declare function UndefinedTextRange(): TextRange;
/**
 ...
 * }
 */
export declare function TextRange_Pos(receiver: TextRange): int;
/**
 ...
 * }
 */
export declare function TextRange_End(receiver: TextRange): int;
/**
 ...
 * }
 */
export declare function TextRange_Len(receiver: TextRange): int;
/**
 ...
 * }
 */
export declare function TextRange_IsValid(receiver: TextRange): bool;
/**
 ...
 * }
 */
export declare function TextRange_Contains(receiver: TextRange, pos: int): bool;
/**
 ...
 * }
 */
export declare function TextRange_ContainsInclusive(receiver: TextRange, pos: int): bool;
/**
 ...
 * }
 */
export declare function TextRange_ContainsExclusive(receiver: TextRange, pos: int): bool;
/**
 ...
 * }
 */
export declare function TextRange_WithPos(receiver: TextRange, pos: int): TextRange;
/**
 ...
 * }
 */
export declare function TextRange_WithEnd(receiver: TextRange, end: int): TextRange;
/**
 ...
 * }
 */
export declare function TextRange_ContainedBy(receiver: TextRange, t2: TextRange): bool;
/**
 ...
 * }
 */
export declare function TextRange_Overlaps(receiver: TextRange, t2: TextRange): bool;
/**
 ...
 * }
 */
export declare function TextRange_Intersects(receiver: TextRange, t2: TextRange): bool;
/**
 ...
 * }
 */
export declare function CompareTextRanges(r1: TextRange, r2: TextRange): int;
