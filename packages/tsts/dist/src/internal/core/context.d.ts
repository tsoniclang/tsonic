 ...
 * )
 */
export declare const requestIDKey: key;
export declare const checkerLifetimeKey: key;
/**
 ...
 * }
 */
export declare function WithRequestID(ctx: Context, id: string): Context;
/**
 ...
 * }
 */
export declare function GetRequestID(ctx: Context): string;
/**
 ...
 * )
 */
export declare const CheckerLifetimeTemporary: CheckerLifetime;
export declare const CheckerLifetimeDiagnostics: CheckerLifetime;
export declare const CheckerLifetimeAPI: CheckerLifetime;
/**
 ...
 * }
 */
export declare function WithCheckerLifetime(ctx: Context, lifetime: CheckerLifetime): Context;
/**
 ...
 * }
 */
export declare function GetCheckerLifetime(ctx: Context): CheckerLifetime;
