 ...
 * }
 */
export let UnprefixedNodeCoreModules = new globalThis.Map([
    ["assert", true],
    ["assert/strict", true],
    ["async_hooks", true],
    ["buffer", true],
 ...
 * }
 */
export let ExclusivelyPrefixedNodeCoreModules = new globalThis.Map([
    ["node:quic", true],
    ["node:sea", true],
    ["node:sqlite", true],
    ["node:test", true],
 ...
 * })
 */
export let NodeCoreModules = OnceValue(() => {
    const nodeCoreModules = new globalThis.Map();
