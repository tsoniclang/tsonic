 ...
 * }
 */
export function Tristate_IsTrue(receiver) {
    const t = receiver ?? TSUnknown;
    return t === TSTrue;
}
/**
 ...
 * }
 */
export function Tristate_IsTrueOrUnknown(receiver) {
    const t = receiver ?? TSUnknown;
    return t === TSTrue || t === TSUnknown;
}
/**
 ...
 * }
 */
export function Tristate_IsFalse(receiver) {
    const t = receiver ?? TSUnknown;
    return t === TSFalse;
}
/**
 ...
 * }
 */
export function Tristate_IsFalseOrUnknown(receiver) {
    const t = receiver ?? TSUnknown;
    return t === TSFalse || t === TSUnknown;
}
/**
 ...
 * }
 */
export function Tristate_IsUnknown(receiver) {
    const t = receiver ?? TSUnknown;
    return t === TSUnknown;
}
/**
 ...
 * }
 */
export function Tristate_DefaultIfUnknown(receiver, value) {
    const t = receiver ?? TSUnknown;
    if (t === TSUnknown) {
        return value;
    }
 ...
 * }
 */
export function Tristate_UnmarshalJSON(receiver, data) {
 ...
 * }
 */
export function Tristate_MarshalJSON(receiver) {
    const t = receiver;
    switch (t) {
        case TSTrue:
...
function bytesToString(data) {
    return utf8Decoder.decode(new globalThis.Uint8Array(data));
}
/**
 ...
 * }
 */
export function BoolToTristate(b) {
    if (b) {
        return TSTrue;
    }
    return TSFalse;
