 ...
 */
export declare const _ScriptKind_name: string;
/**
 ...
 */
export declare let _ScriptKind_index: GoArray<byte, "...">;
/**
 ...
 * }
 */
export declare function ScriptKind_String(receiver: ScriptKind): string;
//# sourceMappingURL=scriptkind_stringer_generated.d.ts.map