 ...
 */
export declare function LinkStore_Get<K extends GoComparable, V>(receiver: GoPtr<LinkStore<K, V>>, key: K): GoPtr<V>;
/**
 ...
 * }
 */
export declare function LinkStore_Has<K extends GoComparable, V>(receiver: GoPtr<LinkStore<K, V>>, key: K): bool;
/**
 ...
 * }
 */
export declare function LinkStore_TryGet<K extends GoComparable, V>(receiver: GoPtr<LinkStore<K, V>>, key: K): GoPtr<V>;
//# sourceMappingURL=linkstore.d.ts.map