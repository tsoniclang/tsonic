 ...
 * }
 */
export declare function LinkStore_Get<K, V>(receiver: GoPtr<LinkStore<K, V>>, key: K): GoPtr<V>;
/**
 ...
 * }
 */
export declare function LinkStore_Has<K, V>(receiver: GoPtr<LinkStore<K, V>>, key: K): bool;
/**
 ...
 * }
 */
export declare function LinkStore_TryGet<K, V>(receiver: GoPtr<LinkStore<K, V>>, key: K): GoPtr<V>;
