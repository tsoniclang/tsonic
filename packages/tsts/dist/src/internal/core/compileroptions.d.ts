 ...
 * func (*noCopy) Lock()   {}
 */
export declare function noCopy_Lock(receiver: GoPtr<noCopy>): void;
/**
 ...
 * func (*noCopy) Unlock() {}
 */
export declare function noCopy_Unlock(receiver: GoPtr<noCopy>): void;
/**
 ...
 */
export declare const EmptyCompilerOptions: GoPtr<CompilerOptions>;
export declare function NormalizeCompilerOptions(options: GoPtr<CompilerOptions>): GoPtr<CompilerOptions>;
/**
 ...
 */
export declare const optionsType: unknown;
/**
 ...
 * }
 */
export declare function CompilerOptions_Clone(receiver: GoPtr<CompilerOptions>): GoPtr<CompilerOptions>;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetEmitScriptTarget(receiver: GoPtr<CompilerOptions>): ScriptTarget;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetEmitModuleKind(receiver: GoPtr<CompilerOptions>): ModuleKind;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetModuleResolutionKind(receiver: GoPtr<CompilerOptions>): ModuleResolutionKind;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetEmitModuleDetectionKind(receiver: GoPtr<CompilerOptions>): ModuleDetectionKind;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetResolvePackageJsonExports(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetResolvePackageJsonImports(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetAllowImportingTsExtensions(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_AllowImportingTsExtensionsFrom(receiver: GoPtr<CompilerOptions>, fileName: string): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetResolveJsonModule(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_ShouldPreserveConstEnums(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetAllowJS(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetJSXTransformEnabled(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetStrictOptionValue(receiver: GoPtr<CompilerOptions>, value: Tristate): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetEffectiveTypeRoots(receiver: GoPtr<CompilerOptions>, currentDirectory: string): [GoSlice<string>, bool];
/**
 ...
 * }
 */
export declare function CompilerOptions_UsesWildcardTypes(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetIsolatedModules(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_IsIncremental(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetEmitStandardClassFields(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetUseDefineForClassFields(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetEmitDeclarations(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetAreDeclarationMapsEnabled(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_HasJsonModuleEmitEnabled(receiver: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptions_GetPathsBasePath(receiver: GoPtr<CompilerOptions>, currentDirectory: string): string;
/**
 ...
 * )
 */
export declare const ModuleDetectionKindNone: ModuleDetectionKind;
export declare const ModuleDetectionKindAuto: ModuleDetectionKind;
export declare const ModuleDetectionKindLegacy: ModuleDetectionKind;
export declare const ModuleDetectionKindForce: ModuleDetectionKind;
/**
 ...
 * )
 */
export declare const ModuleKindNone: ModuleKind;
export declare const ModuleKindCommonJS: ModuleKind;
export declare const ModuleKindAMD: ModuleKind;
export declare const ModuleKindUMD: ModuleKind;
export declare const ModuleKindSystem: ModuleKind;
export declare const ModuleKindES2015: ModuleKind;
export declare const ModuleKindES2020: ModuleKind;
export declare const ModuleKindES2022: ModuleKind;
export declare const ModuleKindESNext: ModuleKind;
export declare const ModuleKindNode16: ModuleKind;
export declare const ModuleKindNode18: ModuleKind;
export declare const ModuleKindNode20: ModuleKind;
export declare const ModuleKindNodeNext: ModuleKind;
export declare const ModuleKindPreserve: ModuleKind;
/**
 ...
 * }
 */
export declare function ModuleKind_IsNonNodeESM(receiver: ModuleKind): bool;
/**
 ...
 * }
 */
export declare function ModuleKind_SupportsImportAttributes(receiver: ModuleKind): bool;
/**
 ...
 * )
 */
export declare const ResolutionModeNone: ModuleKind;
export declare const ResolutionModeCommonJS: ModuleKind;
export declare const ResolutionModeESM: ModuleKind;
/**
 ...
 * )
 */
export declare const ModuleResolutionKindUnknown: ModuleResolutionKind;
export declare const ModuleResolutionKindClassic: ModuleResolutionKind;
export declare const ModuleResolutionKindNode10: ModuleResolutionKind;
export declare const ModuleResolutionKindNode16: ModuleResolutionKind;
export declare const ModuleResolutionKindNodeNext: ModuleResolutionKind;
export declare const ModuleResolutionKindBundler: ModuleResolutionKind;
/**
 ...
 * }
 */
export declare let ModuleKindToModuleResolutionKind: GoMap<ModuleKind, ModuleResolutionKind>;
/**
 ...
 * }
 */
export declare function ModuleResolutionKind_String(receiver: ModuleResolutionKind): string;
/**
 ...
 * )
 */
export declare const NewLineKindNone: NewLineKind;
export declare const NewLineKindCRLF: NewLineKind;
export declare const NewLineKindLF: NewLineKind;
/**
 ...
 * }
 */
export declare function GetNewLineKind(s: string): NewLineKind;
/**
 ...
 * }
 */
export declare function NewLineKind_GetNewLineCharacter(receiver: NewLineKind): string;
/**
 ...
 * )
 */
export declare const ScriptTargetNone: ScriptTarget;
export declare const ScriptTargetES5: ScriptTarget;
export declare const ScriptTargetES2015: ScriptTarget;
export declare const ScriptTargetES2016: ScriptTarget;
export declare const ScriptTargetES2017: ScriptTarget;
export declare const ScriptTargetES2018: ScriptTarget;
export declare const ScriptTargetES2019: ScriptTarget;
export declare const ScriptTargetES2020: ScriptTarget;
export declare const ScriptTargetES2021: ScriptTarget;
export declare const ScriptTargetES2022: ScriptTarget;
export declare const ScriptTargetES2023: ScriptTarget;
export declare const ScriptTargetES2024: ScriptTarget;
export declare const ScriptTargetES2025: ScriptTarget;
export declare const ScriptTargetESNext: ScriptTarget;
export declare const ScriptTargetJSON: ScriptTarget;
export declare const ScriptTargetLatest: ScriptTarget;
export declare const ScriptTargetLatestStandard: ScriptTarget;
/**
 ...
 * )
 */
export declare const JsxEmitNone: JsxEmit;
export declare const JsxEmitPreserve: JsxEmit;
export declare const JsxEmitReactNative: JsxEmit;
export declare const JsxEmitReact: JsxEmit;
export declare const JsxEmitReactJSX: JsxEmit;
export declare const JsxEmitReactJSXDev: JsxEmit;
/**
 ...
 * }
 */
export declare function JsxEmit_String(receiver: JsxEmit): string;
