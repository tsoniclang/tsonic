 ...
 * )
 */
export declare const _ModuleKind_name_0: string;
export declare const _ModuleKind_name_1: string;
export declare const _ModuleKind_name_2: string;
/**
 ...
 * )
 */
export declare let _ModuleKind_index_0: GoArray<byte, "...">;
export declare let _ModuleKind_index_1: GoArray<byte, "...">;
export declare let _ModuleKind_index_2: GoArray<byte, "...">;
/**
 ...
 * }
 */
export declare function ModuleKind_String(receiver: ModuleKind): string;
//# sourceMappingURL=modulekind_stringer_generated.d.ts.map