 ...
 * }
 */
export function unmarshalJSONValue(v, data, elementFactory = identityJSONValueElement) {
    try {
 ...
 * }
 */
export function unmarshalJSONValueV2(v, dec, elementFactory = identityJSONValueElement) {
    if (dec === undefined) {
