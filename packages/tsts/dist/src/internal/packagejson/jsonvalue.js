 ...
 * )
 */
export const JSONValueTypeNotPresent = 0;
export const JSONValueTypeNull = 1;
export const JSONValueTypeString = 2;
export const JSONValueTypeNumber = 3;
export const JSONValueTypeBoolean = 4;
export const JSONValueTypeArray = 5;
export const JSONValueTypeObject = 6;
/**
 ...
 * }
 */
export function JSONValueType_String(receiver) {
    switch (receiver) {
        case JSONValueTypeNull:
            return "null";
        case JSONValueTypeString:
 ...
 * }
 */
export function JSONValue_IsPresent(receiver) {
 ...
 * }
 */
export function JSONValue_IsFalsy(receiver) {
    const v = receiver;
    switch (v.Type) {
 ...
 * }
 */
export function JSONValue_AsObject(receiver) {
 ...
 * }
 */
export function JSONValue_AsArray(receiver) {
 ...
 * }
 */
export function JSONValue_AsString(receiver) {
 ...
 */
export let __d3c38d60_0 = JSONValue_as_json_UnmarshalerFrom(undefined);
export function JSONValue_as_json_UnmarshalerFrom(receiver) {
    return {
        UnmarshalJSONFrom: (decoder) => JSONValue_UnmarshalJSONFrom(receiver, decoder),
    };
}
/**
 ...
 * }
 */
export function JSONValue_UnmarshalJSONFrom(receiver, dec) {
    return unmarshalJSONValueV2(receiver, dec);
}
/**
 ...
 * }
 */
export function unmarshalJSONValue(v, data) {
    return unmarshalJSONValueWithFactory(v, data, (value) => identityJSONValueElement(value));
}
export function unmarshalJSONValueWithFactory(v, data, elementFactory) {
    try {
        assignJSONValue(v, JSON.parse(textDecoder.decode(globalThis.Uint8Array.from(data))), elementFactory);
        return undefined;
    }
    catch (error) {
 ...
 * }
 */
export function unmarshalJSONValueV2(v, dec) {
    return unmarshalJSONValueV2WithFactory(v, dec, (value) => identityJSONValueElement(value));
}
export function unmarshalJSONValueV2WithFactory(v, dec, elementFactory) {
    if (dec === undefined) {
...
function decodeJSONValue(value, elementFactory) {
    ...
    if (typeof value === "object") {
        ...
        const object = NewOrderedMapWithSizeHint(entries.length);
...
function identityJSONValueElement(value) {
    return value;
}
