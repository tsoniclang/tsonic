 ...
 * }
 */
export declare function JSONValue_AsObject<T = JSONValue>(receiver: JSONValue): GoPtr<OrderedMap<string, T>>;
/**
 ...
 * }
 */
export declare function unmarshalJSONValue<T>(v: GoPtr<JSONValue>, data: GoSlice<byte>, elementFactory?: JSONValueElementFactory<T>): GoError;
/**
 ...
 * }
 */
export declare function unmarshalJSONValueV2<T>(v: GoPtr<JSONValue>, dec: GoPtr<Decoder>, elementFactory?: JSONValueElementFactory<T>): GoError;
export {};
