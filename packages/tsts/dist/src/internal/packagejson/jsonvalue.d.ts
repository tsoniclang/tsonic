import type { bool, byte, sbyte } from "../../go/scalars.js";
 ...
 * )
 */
export declare const JSONValueTypeNotPresent: JSONValueType;
export declare const JSONValueTypeNull: JSONValueType;
export declare const JSONValueTypeString: JSONValueType;
export declare const JSONValueTypeNumber: JSONValueType;
export declare const JSONValueTypeBoolean: JSONValueType;
export declare const JSONValueTypeArray: JSONValueType;
export declare const JSONValueTypeObject: JSONValueType;
/**
 ...
 * }
 */
export declare function JSONValueType_String(receiver: JSONValueType): string;
/**
 ...
 * }
 */
export declare function JSONValue_IsPresent(receiver: GoPtr<JSONValue>): bool;
/**
 ...
 * }
 */
export declare function JSONValue_IsFalsy(receiver: GoPtr<JSONValue>): bool;
/**
 ...
 * }
 */
export declare function JSONValue_AsObject(receiver: JSONValue): GoPtr<OrderedMap<string, JSONValue>>;
/**
 ...
 * }
 */
export declare function JSONValue_AsArray(receiver: JSONValue): GoSlice<JSONValue>;
/**
 ...
 * }
 */
export declare function JSONValue_AsString(receiver: JSONValue): string;
/**
 ...
 */
export declare let __d3c38d60_0: UnmarshalerFrom;
export declare function JSONValue_as_json_UnmarshalerFrom(receiver: GoPtr<JSONValue>): UnmarshalerFrom;
/**
 ...
 * }
 */
export declare function JSONValue_UnmarshalJSONFrom(receiver: GoPtr<JSONValue>, dec: GoPtr<Decoder>): GoError;
/**
 ...
 * }
 */
export declare function unmarshalJSONValue<T>(v: GoPtr<JSONValue>, data: GoSlice<byte>): GoError;
export declare function unmarshalJSONValueWithFactory<T>(v: GoPtr<JSONValue>, data: GoSlice<byte>, elementFactory: JSONValueElementFactory<T>): GoError;
/**
 ...
 * }
 */
export declare function unmarshalJSONValueV2<T>(v: GoPtr<JSONValue>, dec: GoPtr<Decoder>): GoError;
export declare function unmarshalJSONValueV2WithFactory<T>(v: GoPtr<JSONValue>, dec: GoPtr<Decoder>, elementFactory: JSONValueElementFactory<T>): GoError;
export {};
