 ...
 * )
 */
export declare const objectKindUnknown: objectKind;
export declare const objectKindSubpaths: objectKind;
export declare const objectKindConditions: objectKind;
export declare const objectKindImports: objectKind;
export declare const objectKindInvalid: objectKind;
/**
 ...
 */
export declare const __fac7894a_0: UnmarshalerFrom;
export declare function ExportsOrImports_as_json_UnmarshalerFrom(receiver: GoPtr<ExportsOrImports>): UnmarshalerFrom;
/**
 ...
 * }
 */
export declare function ExportsOrImports_UnmarshalJSONFrom(receiver: GoPtr<ExportsOrImports>, dec: GoPtr<Decoder>): GoError;
/**
 ...
 * }
 */
export declare function ExportsOrImports_AsObject<T = ExportsOrImports>(receiver: ExportsOrImports): GoPtr<OrderedMap<string, T>>;
/**
 ...
 * }
 */
export declare function ExportsOrImports_AsArray(receiver: ExportsOrImports): GoSlice<ExportsOrImports>;
/**
 ...
 * }
 */
export declare function ExportsOrImports_IsSubpaths(receiver: ExportsOrImports): bool;
/**
 ...
 * }
 */
export declare function ExportsOrImports_IsImports(receiver: ExportsOrImports): bool;
/**
 ...
 * }
 */
export declare function ExportsOrImports_IsConditions(receiver: ExportsOrImports): bool;
/**
 ...
 * }
 */
export declare function ExportsOrImports_initObjectKind(receiver: GoPtr<ExportsOrImports>): void;
//# sourceMappingURL=exportsorimports.d.ts.map