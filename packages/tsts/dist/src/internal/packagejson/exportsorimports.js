 ...
 * )
 */
export const objectKindUnknown = 0;
export const objectKindSubpaths = 1;
export const objectKindConditions = 2;
export const objectKindImports = 3;
export const objectKindInvalid = 4;
/**
 ...
 */
export const __fac7894a_0 = ExportsOrImports_as_json_UnmarshalerFrom(undefined);
export function ExportsOrImports_as_json_UnmarshalerFrom(receiver) {
    return {
        UnmarshalJSONFrom: (decoder) => ExportsOrImports_UnmarshalJSONFrom(receiver, decoder),
    };
}
/**
 ...
 * }
 */
export function ExportsOrImports_UnmarshalJSONFrom(receiver, dec) {
    const e = receiver;
    if (e.__tsgoEmbedded0 === undefined) {
        e.__tsgoEmbedded0 = { Type: JSONValueTypeNotPresent, Value: undefined };
    }
    return unmarshalJSONValueV2WithFactory(e.__tsgoEmbedded0, dec, value => ({ __tsgoEmbedded0: value, objectKind: objectKindUnknown }));
}
/**
 ...
 * }
 */
export function ExportsOrImports_AsArray(receiver) {
 ...
 * }
 */
export function ExportsOrImports_IsSubpaths(receiver) {
 ...
 * }
 */
export function ExportsOrImports_IsImports(receiver) {
    ExportsOrImports_initObjectKind(receiver);
 ...
 * }
 */
export function ExportsOrImports_IsConditions(receiver) {
    ExportsOrImports_initObjectKind(receiver);
 ...
 * }
 */
export function ExportsOrImports_initObjectKind(receiver) {
    const e = receiver;
...
//# sourceMappingURL=exportsorimports.js.map