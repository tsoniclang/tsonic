 ...
 * }
 */
export declare function NewNodeVisitor(visit: (node: GoPtr<Node>) => GoPtr<Node>, factory: GoPtr<NodeFactory>, hooks: NodeVisitorHooks): GoPtr<NodeVisitor>;
/**
 ...
 * }
 */
export declare function NodeVisitor_VisitSourceFile(receiver: GoPtr<NodeVisitor>, node: GoPtr<SourceFile>): GoPtr<SourceFile>;
/**
 ...
 * }
 */
export declare function NodeVisitor_VisitNode(receiver: GoPtr<NodeVisitor>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeVisitor_VisitEmbeddedStatement(receiver: GoPtr<NodeVisitor>, node: GoPtr<Statement>): GoPtr<Statement>;
/**
 ...
 * }
 */
export declare function NodeVisitor_VisitNodes(receiver: GoPtr<NodeVisitor>, nodes: GoPtr<NodeList>): GoPtr<NodeList>;
/**
 ...
 * }
 */
export declare function NodeVisitor_VisitModifiers(receiver: GoPtr<NodeVisitor>, nodes: GoPtr<ModifierList>): GoPtr<ModifierList>;
/**
 ...
 * }
 */
export declare function NodeVisitor_VisitSlice(receiver: GoPtr<NodeVisitor>, nodes: GoSlice<GoPtr<Node>>): [GoSlice<GoPtr<Node>>, bool];
/**
 ...
 * }
 */
export declare function NodeVisitor_VisitEachChild(receiver: GoPtr<NodeVisitor>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeVisitor_visitEmbeddedStatement(receiver: GoPtr<NodeVisitor>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeVisitor_visitIterationBody(receiver: GoPtr<NodeVisitor>, node: GoPtr<Statement>): GoPtr<Statement>;
/**
 ...
 * }
 */
export declare function NodeVisitor_visitFunctionBody(receiver: GoPtr<NodeVisitor>, node: GoPtr<BlockOrExpression>): GoPtr<BlockOrExpression>;
/**
 ...
 * }
 */
export declare function NodeVisitor_visitToken(receiver: GoPtr<NodeVisitor>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeVisitor_visitParameters(receiver: GoPtr<NodeVisitor>, nodes: GoPtr<ParameterList>): GoPtr<ParameterList>;
/**
 ...
 * }
 */
export declare function NodeVisitor_visitTopLevelStatements(receiver: GoPtr<NodeVisitor>, nodes: GoPtr<StatementList>): GoPtr<StatementList>;
/**
 ...
 * }
 */
export declare function NodeVisitor_liftToBlock(receiver: GoPtr<NodeVisitor>, node: GoPtr<Statement>): GoPtr<Statement>;
