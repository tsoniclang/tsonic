 ...
 * }
 */
export declare function NodeDefault_IterChildren(receiver: GoPtr<NodeDefault>): NodeIter;
/**
 ...
 */
export declare function Node_IterChildren(receiver: GoPtr<Node>): NodeIter;
/**
