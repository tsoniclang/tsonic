 ...
 * )
 */
export const CheckFlagsNone = 0;
export const CheckFlagsInstantiated = 1 << 0;
export const CheckFlagsSyntheticProperty = 1 << 1;
export const CheckFlagsSyntheticMethod = 1 << 2;
export const CheckFlagsReadonly = 1 << 3;
export const CheckFlagsReadPartial = 1 << 4;
export const CheckFlagsWritePartial = 1 << 5;
export const CheckFlagsHasNonUniformType = 1 << 6;
export const CheckFlagsHasLiteralType = 1 << 7;
export const CheckFlagsContainsPublic = 1 << 8;
export const CheckFlagsContainsProtected = 1 << 9;
export const CheckFlagsContainsPrivate = 1 << 10;
export const CheckFlagsContainsStatic = 1 << 11;
export const CheckFlagsLate = 1 << 12;
export const CheckFlagsReverseMapped = 1 << 13;
export const CheckFlagsOptionalParameter = 1 << 14;
export const CheckFlagsRestParameter = 1 << 15;
export const CheckFlagsDeferredType = 1 << 16;
export const CheckFlagsHasNeverType = 1 << 17;
export const CheckFlagsMapped = 1 << 18;
export const CheckFlagsStripOptional = 1 << 19;
export const CheckFlagsUnresolved = 1 << 20;
export const CheckFlagsIsDiscriminantComputed = 1 << 21;
export const CheckFlagsIsDiscriminant = 1 << 22;
export const CheckFlagsIndexSymbol = 1 << 23;
export const CheckFlagsSynthetic = CheckFlagsSyntheticProperty | CheckFlagsSyntheticMethod;
export const CheckFlagsNonUniformAndLiteral = CheckFlagsHasNonUniformType | CheckFlagsHasLiteralType;
export const CheckFlagsPartial = CheckFlagsReadPartial | CheckFlagsWritePartial;
//# sourceMappingURL=checkflags.js.map