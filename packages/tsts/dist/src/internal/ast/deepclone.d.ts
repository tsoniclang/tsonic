 ...
 * }
 */
export declare function getDeepCloneVisitor(f: GoPtr<NodeFactory>, syntheticLocation: bool): GoPtr<NodeVisitor>;
/**
 ...
 * }
 */
export declare function NodeFactory_DeepCloneNode(receiver: GoPtr<NodeFactory>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeFactory_DeepCloneReparse(receiver: GoPtr<NodeFactory>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeFactory_DeepCloneReparseModifiers(receiver: GoPtr<NodeFactory>, modifiers: GoPtr<ModifierList>): GoPtr<ModifierList>;
