 ...
 * )
 */
export const RepopulateModeMismatch = 1;
export const RepopulateModuleNotFound = 2;
/**
 ...
 */
export function Diagnostic_File(receiver) {
 ...
 */
export function Diagnostic_Pos(receiver) {
 ...
 */
export function Diagnostic_End(receiver) {
 ...
 */
export function Diagnostic_Len(receiver) {
 ...
 */
export function Diagnostic_Loc(receiver) {
    return receiver.loc;
}
/**
 ...
 */
export function Diagnostic_Code(receiver) {
 ...
 */
export function Diagnostic_Category(receiver) {
 ...
 */
export function Diagnostic_MessageKey(receiver) {
 ...
 */
export function Diagnostic_MessageArgs(receiver) {
 ...
 */
export function Diagnostic_MessageChain(receiver) {
 ...
 */
export function Diagnostic_RelatedInformation(receiver) {
 ...
 */
export function Diagnostic_ReportsUnnecessary(receiver) {
 ...
 */
export function Diagnostic_ReportsDeprecated(receiver) {
 ...
 */
export function Diagnostic_SkippedOnNoEmit(receiver) {
 ...
 */
export function Diagnostic_RepopulateInfo(receiver) {
 ...
 */
export function Diagnostic_SetFile(receiver, file) {
    receiver.file = file;
}
/**
 ...
 */
export function Diagnostic_SetLocation(receiver, loc) {
    receiver.loc = loc;
}
/**
 ...
 */
export function Diagnostic_SetCategory(receiver, category) {
 ...
 */
export function Diagnostic_SetSkippedOnNoEmit(receiver) {
 ...
 */
export function Diagnostic_SetRepopulateInfo(receiver, info) {
 ...
 * }
 */
export function Diagnostic_SetMessageChain(receiver, messageChain) {
 ...
 * }
 */
export function Diagnostic_AddMessageChain(receiver, messageChain) {
 ...
 * }
 */
export function Diagnostic_SetRelatedInfo(receiver, relatedInformation) {
 ...
 * }
 */
export function Diagnostic_AddRelatedInfo(receiver, relatedInformation) {
 ...
 * }
 */
export function Diagnostic_Clone(receiver) {
 ...
 * }
 */
export function Diagnostic_Localize(receiver, locale_) {
 ...
 * }
 */
export function Diagnostic_String(receiver) {
 ...
 * }
 */
export function NewDiagnosticFromSerialized(file, loc, code, category, messageKey, messageArgs, messageChain, relatedInformation, reportsUnnecessary, reportsDeprecated, skippedOnNoEmit) {
    return {
        file: file,
        loc: loc,
        code: code,
 ...
 * }
 */
export function NewDiagnostic(file, loc, message, ...args) {
    return {
        file: file,
        loc: loc,
 ...
 * }
 */
export function NewDiagnosticChain(chain, message, ...args) {
    if (chain !== undefined) {
 ...
 * }
 */
export function NewCompilerDiagnostic(message, ...args) {
 ...
 * }
 */
export function DiagnosticsCollection_Add(receiver, diagnostic) {
    receiver.mu.Lock();
    try {
        ...
        if (Diagnostic_File(diagnostic) !== undefined) {
            ...
            if (receiver.fileDiagnostics === undefined) {
                receiver.fileDiagnostics = new globalThis.Map();
            }
 ...
 * }
 */
export function DiagnosticsCollection_Lookup(receiver, diagnostic) {
    receiver.mu.Lock();
    try {
        const diagnostics_ = Diagnostic_File(diagnostic) !== undefined
 ...
 * }
 */
export function DiagnosticsCollection_GetGlobalDiagnostics(receiver) {
    receiver.mu.Lock();
    try {
 ...
 * }
 */
export function DiagnosticsCollection_getGlobalDiagnosticsLocked(receiver) {
 ...
 * }
 */
export function DiagnosticsCollection_GetDiagnosticsForFile(receiver, fileName) {
    receiver.mu.Lock();
    try {
 ...
 * }
 */
export function DiagnosticsCollection_getDiagnosticsForFileLocked(receiver, fileName) {
 ...
 * }
 */
export function DiagnosticsCollection_GetDiagnostics(receiver) {
    receiver.mu.Lock();
    try {
        const diagnostics_ = [];
 ...
 * }
 */
export function getDiagnosticPath(d) {
 ...
 * }
 */
export function EqualDiagnostics(d1, d2) {
    if (d1 === d2) {
        return true;
    }
    return EqualDiagnosticsNoRelatedInfo(d1, d2) &&
 ...
 * }
 */
export function EqualDiagnosticsNoRelatedInfo(d1, d2) {
    if (d1 === d2) {
        return true;
    }
    return getDiagnosticPath(d1) === getDiagnosticPath(d2) &&
 ...
 * }
 */
export function equalMessageChain(c1, c2) {
    if (c1 === c2) {
        return true;
    }
 ...
 * }
 */
export function compareMessageChainSize(c1, c2) {
 ...
 * }
 */
export function compareMessageChainContent(c1, c2) {
    for (let i = 0; i < c1.length; i++) {
 ...
 * }
 */
export function compareRelatedInfo(r1, r2) {
 ...
 * }
 */
export function CompareDiagnostics(d1, d2) {
    if (d1 === d2) {
        return 0;
    }
