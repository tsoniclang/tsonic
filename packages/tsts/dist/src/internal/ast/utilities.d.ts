 ...
 * }
 */
export declare function getCombinedFlags<T extends number>(node: GoPtr<Node>, getFlags: (arg0: GoPtr<Node>) => T): T;
/**
 ...
 * }
 */
export declare function IsExpandoInitializer(initializer: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function IsImplicitlyExportedJSTypeAlias(node: GoPtr<Node>): bool;
/**
