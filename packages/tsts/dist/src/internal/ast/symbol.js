 ...
 * }
 */
export function Symbol_IsExternalModule(receiver) {
    return ((receiver.Flags & SymbolFlagsModule) !== 0 &&
        receiver.Name.length > 0 &&
        receiver.Name.charCodeAt(0) === "\"".charCodeAt(0));
}
/**
 ...
 * }
 */
export function Symbol_IsStatic(receiver) {
    if (receiver.ValueDeclaration === undefined) {
        return false;
    }
    const modifierFlags = Node_ModifierFlags(receiver.ValueDeclaration);
    return ((modifierFlags & ModifierFlagsStatic) !== 0);
}
/**
 ...
 * }
 */
export function Symbol_CombinedLocalAndExportSymbolFlags(receiver) {
    if (receiver.ExportSymbol !== undefined) {
        return (receiver.Flags | receiver.ExportSymbol.Flags);
    }
...
export const InternalSymbolNamePrefix = "\uFFFD"; // Never occurs as IdentifierName
/**
 ...
 * }
 */
export function SymbolName(symbol_) {
 ...
 * }
 */
export function EscapeAllInternalSymbolNames(name) {
