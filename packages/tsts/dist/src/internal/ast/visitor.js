 ...
 * }
 */
export function NewNodeVisitor(visit, factory, hooks) {
 ...
 * }
 */
export function NodeVisitor_VisitSourceFile(receiver, node) {
 ...
 * }
 */
export function NodeVisitor_VisitNode(receiver, node) {
 ...
 * }
 */
export function NodeVisitor_VisitEmbeddedStatement(receiver, node) {
    if (node === undefined || receiver.Visit === undefined) {
        return node;
    }
    if (receiver.Visit !== undefined) {
 ...
 * }
 */
export function NodeVisitor_VisitNodes(receiver, nodes) {
 ...
 * }
 */
export function NodeVisitor_VisitModifiers(receiver, nodes) {
    if (nodes === undefined || receiver.Visit === undefined) {
        return nodes;
    }
    const [result, changed] = NodeVisitor_VisitSlice(receiver, nodes.Nodes);
 ...
 * }
 */
export function NodeVisitor_VisitSlice(receiver, nodes) {
    if (nodes === undefined || receiver.Visit === undefined) {
        return [nodes, false];
    }
 ...
 * }
 */
export function NodeVisitor_VisitEachChild(receiver, node) {
    if (node === undefined || receiver.Visit === undefined) {
        return node;
    }
 ...
 * }
 */
export function NodeVisitor_visitIterationBody(receiver, node) {
 ...
 * }
 */
export function NodeVisitor_visitFunctionBody(receiver, node) {
 ...
 * }
 */
export function NodeVisitor_visitToken(receiver, node) {
 ...
 * }
 */
export function NodeVisitor_visitParameters(receiver, nodes) {
 ...
 * }
 */
export function NodeVisitor_visitTopLevelStatements(receiver, nodes) {
 ...
 * }
 */
export function NodeVisitor_liftToBlock(receiver, node) {
    let nodes = [];
    if (node !== undefined) {
        if (node.Kind === KindSyntaxList) {
    ...
    if (nodes.length === 1) {
        ...
        node = NewBlock(receiver.Factory, NodeFactory_NewNodeList(receiver.Factory, nodes), true);
    }
    if (node.Kind === KindSyntaxList) {
        throw new globalThis.Error("The result of visiting and lifting a Node may not be SyntaxList");
    }
