...
import { AsBinaryExpression, AsConditionalExpression, AsInferTypeNode, AsPostfixUnaryExpression, AsPrefixUnaryExpression, AsTaggedTemplateExpression, AsTypeParameterDeclaration, } from "./generated/casts.js";
import { KindAmpersandAmpersandEqualsToken, KindAmpersandAmpersandToken, KindAmpersandEqualsToken, KindAmpersandToken, KindAnyKeyword, KindArrayLiteralExpression, KindArrayType, KindArrowFunction, KindAsExpression, KindAsKeyword, KindAsteriskAsteriskEqualsToken, KindAsteriskAsteriskToken, KindAsteriskEqualsToken, KindAsteriskToken, KindAwaitExpression, KindBarBarEqualsToken, KindBarBarToken, KindBarEqualsToken, KindBarToken, KindBigIntKeyword, KindBigIntLiteral, KindBinaryExpression, KindBooleanKeyword, KindCallExpression, KindCaretEqualsToken, KindCaretToken, KindClassExpression, KindCommaToken, KindConditionalExpression, KindConditionalType, KindConstructorType, KindDeleteExpression, KindElementAccessExpression, KindEqualsEqualsEqualsToken, KindEqualsEqualsToken, KindEqualsToken, KindExclamationEqualsEqualsToken, KindExclamationEqualsToken, KindExpressionWithTypeArguments, KindFalseKeyword, KindFunctionExpression, KindFunctionType, KindGreaterThanEqualsToken, KindGreaterThanGreaterThanEqualsToken, KindGreaterThanGreaterThanGreaterThanEqualsToken, KindGreaterThanGreaterThanGreaterThanToken, KindGreaterThanGreaterThanToken, KindGreaterThanToken, KindIdentifier, KindImportKeyword, KindImportType, KindIndexedAccessType, KindInferType, KindInKeyword, KindInstanceOfKeyword, KindIntersectionType, KindIntrinsicKeyword, KindJSDocAllType, KindJSDocNonNullableType, KindJSDocNullableType, KindJSDocOptionalType, KindJSDocVariadicType, KindJsxElement, KindJsxFragment, KindJsxSelfClosingElement, KindLessThanEqualsToken, KindLessThanLessThanEqualsToken, KindLessThanLessThanToken, KindLessThanToken, KindLiteralType, KindMappedType, KindMetaProperty, KindMinusEqualsToken, KindMinusToken, KindMissingDeclaration, KindNamedTupleMember, KindNeverKeyword, KindNewExpression, KindNonNullExpression, KindNoSubstitutionTemplateLiteral, KindNullKeyword, KindNumberKeyword, KindNumericLiteral, KindObjectKeyword, KindObjectLiteralExpression, KindOmittedExpression, KindOptionalType, KindParenthesizedExpression, KindParenthesizedType, KindPartiallyEmittedExpression, KindPercentEqualsToken, KindPercentToken, KindPlusEqualsToken, KindPlusToken, KindPostfixUnaryExpression, KindPrefixUnaryExpression, KindPrivateIdentifier, KindPropertyAccessExpression, KindQuestionQuestionEqualsToken, KindQuestionQuestionToken, KindRegularExpressionLiteral, KindRestType, KindSatisfiesExpression, KindSatisfiesKeyword, KindSlashEqualsToken, KindSlashToken, KindSpreadElement, KindString, KindStringKeyword, KindStringLiteral, KindSuperKeyword, KindSymbolKeyword, KindTaggedTemplateExpression, KindTemplateExpression, KindTemplateLiteralType, KindThisKeyword, KindThisType, KindTrueKeyword, KindTupleType, KindTypeAssertionExpression, KindTypeLiteral, KindTypeOfExpression, KindTypeOperator, KindTypePredicate, KindTypeQuery, KindTypeReference, KindUndefinedKeyword, KindUnionType, KindUnknownKeyword, KindVoidExpression, KindVoidKeyword, KindYieldExpression, } from "./generated/kinds.js";
...
//     AssignmentExpression
//     Expression `,` AssignmentExpression
export const OperatorPrecedenceComma = 0;
// NOTE: `Spread` is higher than `Comma` due to how it is parsed in |ElementList|
// SpreadElement:
//     `...` AssignmentExpression
export const OperatorPrecedenceSpread = 1;
// AssignmentExpression: YieldExpression
export const OperatorPrecedenceYield = 2;
// AssignmentExpression: LeftHandSideExpression `=` AssignmentExpression
export const OperatorPrecedenceAssignment = 3;
// AssignmentExpression: ConditionalExpression
export const OperatorPrecedenceConditional = 4;
// LogicalORExpression
export const OperatorPrecedenceLogicalOR = 5;
// LogicalANDExpression
export const OperatorPrecedenceLogicalAND = 6;
// BitwiseORExpression
export const OperatorPrecedenceBitwiseOR = 7;
// BitwiseXORExpression
export const OperatorPrecedenceBitwiseXOR = 8;
// BitwiseANDExpression
export const OperatorPrecedenceBitwiseAND = 9;
// EqualityExpression
export const OperatorPrecedenceEquality = 10;
// RelationalExpression
export const OperatorPrecedenceRelational = 11;
// ShiftExpression
export const OperatorPrecedenceShift = 12;
// AdditiveExpression
export const OperatorPrecedenceAdditive = 13;
// MultiplicativeExpression
export const OperatorPrecedenceMultiplicative = 14;
// ExponentiationExpression
export const OperatorPrecedenceExponentiation = 15;
// UnaryExpression
export const OperatorPrecedenceUnary = 16;
// UpdateExpression
export const OperatorPrecedenceUpdate = 17;
// LeftHandSideExpression: NewExpression
export const OperatorPrecedenceLeftHandSide = 18;
// LeftHandSideExpression: OptionalExpression
export const OperatorPrecedenceOptionalChain = 19;
// MemberExpression
export const OperatorPrecedenceMember = 20;
// PrimaryExpression
export const OperatorPrecedencePrimary = 21;
// CoverParenthesizedExpressionAndArrowParameterList
export const OperatorPrecedenceParentheses = 22;
export const OperatorPrecedenceLowest = OperatorPrecedenceComma;
export const OperatorPrecedenceHighest = OperatorPrecedenceParentheses;
export const OperatorPrecedenceDisallowComma = OperatorPrecedenceYield;
// ShortCircuitExpression / CoalesceExpression
export const OperatorPrecedenceCoalesce = OperatorPrecedenceLogicalOR;
// -1 is lower than all other precedences. Returning it will cause binary expression
// parsing to stop.
export const OperatorPrecedenceInvalid = -1;
/**
 ...
 * }
 */
export function getOperator(expression) {
    switch (expression.Kind) {
        case KindBinaryExpression:
...
export function GetExpressionPrecedence(expression) {
    const operator = getOperator(expression);
    const flags = expression.Kind === KindNewExpression && Node_ArgumentList(expression) === undefined
 ...
 * )
 */
export const OperatorPrecedenceFlagsNone = 0;
export const OperatorPrecedenceFlagsNewWithoutArguments = 1 << 0;
export const OperatorPrecedenceFlagsOptionalChain = 1 << 1;
/**
...
export function GetOperatorPrecedence(nodeKind, operatorKind, flags) {
    switch (nodeKind) {
        case KindSpreadElement:
            return OperatorPrecedenceSpread;
        case KindYieldExpression:
...
export function GetBinaryOperatorPrecedence(operatorKind) {
    switch (operatorKind) {
        case KindQuestionQuestionToken:
            return OperatorPrecedenceCoalesce;
        case KindBarBarToken:
...
export function GetLeftmostExpression(node, stopAtCallExpressions) {
 ...
 */
// Conditional precedence (lowest)
export const TypePrecedenceConditional = 0;
// JSDoc precedence (optional and variadic types)
export const TypePrecedenceJSDoc = 1;
// Function precedence
export const TypePrecedenceFunction = 2;
// Union precedence
export const TypePrecedenceUnion = 3;
// Intersection precedence
export const TypePrecedenceIntersection = 4;
// TypeOperatorNode precedence
export const TypePrecedenceTypeOperator = 5;
// Postfix precedence
export const TypePrecedencePostfix = 6;
// NonArray precedence (highest)
export const TypePrecedenceNonArray = 7;
export const TypePrecedenceLowest = TypePrecedenceConditional;
export const TypePrecedenceHighest = TypePrecedenceNonArray;
/**
...
export function GetTypeNodePrecedence(n) {
    switch (n.Kind) {
        case KindConditionalType:
            return TypePrecedenceConditional;
