...
import { IsDeclarationNode, NodeFactory_UpdateArrowFunction, NodeFactory_UpdateClassDeclaration, NodeFactory_UpdateClassExpression, NodeFactory_UpdateConstructorDeclaration, NodeFactory_UpdateConstructorTypeNode, NodeFactory_UpdateEnumDeclaration, NodeFactory_UpdateExportAssignment, NodeFactory_UpdateExportDeclaration, NodeFactory_UpdateFunctionDeclaration, NodeFactory_UpdateFunctionExpression, NodeFactory_UpdateGetAccessorDeclaration, NodeFactory_UpdateImportDeclaration, NodeFactory_UpdateImportEqualsDeclaration, NodeFactory_UpdateIndexSignatureDeclaration, NodeFactory_UpdateInterfaceDeclaration, NodeFactory_UpdateMethodDeclaration, NodeFactory_UpdateMethodSignatureDeclaration, NodeFactory_UpdateModuleDeclaration, NodeFactory_UpdateParameterDeclaration, NodeFactory_UpdatePropertyDeclaration, NodeFactory_UpdatePropertySignatureDeclaration, NodeFactory_UpdateSetAccessorDeclaration, NodeFactory_UpdateTypeAliasDeclaration, NodeFactory_UpdateTypeParameterDeclaration, NodeFactory_UpdateVariableStatement, Node_Expression, Node_Initializer, Node_ModifierFlags, Node_PropertyName, Node_QuestionDotToken, Node_Statement, Node_Text, Node_Type, } from "./ast.js";
import { Node_End, Node_LocalsContainerData, Node_Name, Node_Pos, } from "./spine.js";
import { AsArrayTypeNode, AsArrowFunction, AsBinaryExpression, AsBindingElement, AsCallExpression, AsClassDeclaration, AsClassExpression, AsConstructorDeclaration, AsConstructorTypeNode, AsElementAccessExpression, AsEnumDeclaration, AsExportAssignment, AsExportDeclaration, AsFunctionDeclaration, AsFunctionExpression, AsForInOrOfStatement, AsForStatement, AsGetAccessorDeclaration, AsHeritageClause, AsImportClause, AsImportDeclaration, AsImportEqualsDeclaration, AsIndexSignatureDeclaration, AsImportTypeNode, AsInterfaceDeclaration, AsJSDoc, AsJsxNamespacedName, AsJsxText, AsLiteralTypeNode, AsMetaProperty, AsMethodDeclaration, AsMethodSignatureDeclaration, AsModuleDeclaration, AsParameterDeclaration, AsPostfixUnaryExpression, AsPrefixUnaryExpression, AsPropertyDeclaration, AsPropertyAccessExpression, AsPropertySignatureDeclaration, AsQualifiedName, AsSetAccessorDeclaration, AsShorthandPropertyAssignment, AsTaggedTemplateExpression, AsTypeAliasDeclaration, AsTypeParameterDeclaration, AsTypeReferenceNode, AsVariableDeclarationList, AsVariableStatement, } from "./generated/casts.js";
import { NodeFlagsAmbient, NodeFlagsAwaitUsing, NodeFlagsBlockScoped, NodeFlagsConst, NodeFlagsContainsThis, NodeFlagsJSDoc, NodeFlagsJavaScriptFile, NodeFlagsJsonFile, NodeFlagsLet, NodeFlagsOptionalChain, NodeFlagsPossiblyContainsDeprecatedTag, NodeFlagsReparsed, NodeFlagsSynthesized, NodeFlagsUsing, SymbolFlagsAlias, SymbolFlagsAssignment, } from "./generated/flags.js";
import { KindAmpersandAmpersandEqualsToken, KindAmpersandAmpersandToken, KindAnyKeyword, KindArrayBindingPattern, KindArrayLiteralExpression, KindArrowFunction, KindAsExpression, KindAwaitExpression, KindBarBarEqualsToken, KindBarBarToken, KindBigIntKeyword, KindBigIntLiteral, KindBooleanKeyword, KindBindingElement, KindBinaryExpression, KindBlock, KindBreakStatement, KindCallExpression, KindCallSignature, KindCatchClause, KindClassDeclaration, KindClassExpression, KindClassStaticBlockDeclaration, KindCommaToken, KindComputedPropertyName, KindConditionalExpression, KindConstructor, KindConstructorType, KindConstructSignature, KindContinueStatement, KindDebuggerStatement, KindDeleteExpression, KindDoStatement, KindElementAccessExpression, KindEmptyStatement, KindEndOfFile, KindEnumDeclaration, KindEnumMember, KindEqualsToken, KindExclamationToken, KindExportAssignment, KindExportDeclaration, KindExpressionStatement, KindExpressionWithTypeArguments, KindExportSpecifier, KindFalseKeyword, KindFirstCompoundAssignment, KindFirstContextualKeyword, KindFirstJSDocNode, KindFirstKeyword, KindFirstTemplateToken, KindFirstTriviaToken, KindFirstTypeNode, KindForInStatement, KindForOfStatement, KindForStatement, KindFunctionDeclaration, KindFunctionExpression, KindFunctionType, KindGetAccessor, KindIdentifier, KindIfStatement, KindImportDeclaration, KindImportEqualsDeclaration, KindImportKeyword, KindIndexSignature, KindInterfaceDeclaration, KindImportSpecifier, KindJSDocSignature, KindIntrinsicKeyword, KindJSDocAllType, KindJSDocNonNullableType, KindJSDocNullableType, KindJSDocOptionalType, KindJSDocVariadicType, KindJSImportDeclaration, KindJSTypeAliasDeclaration, KindJsxExpression, KindJsxText, KindLastContextualKeyword, KindLastJSDocNode, KindLastKeyword, KindLastTemplateToken, KindLastTriviaToken, KindLastTypeNode, KindJsxAttribute, KindJsxClosingElement, KindJsxElement, KindJsxFragment, KindJsxOpeningElement, KindJsxSelfClosingElement, KindLabeledStatement, KindLastCompoundAssignment, KindTypeReference, KindMetaProperty, KindMethodDeclaration, KindMethodSignature, KindMinusMinusToken, KindMinusToken, KindMissingDeclaration, KindModuleDeclaration, KindNamespaceExportDeclaration, KindNeverKeyword, KindNewExpression, KindNonNullExpression, KindNoSubstitutionTemplateLiteral, KindNotEmittedStatement, KindNotEmittedTypeElement, KindNullKeyword, KindNumberKeyword, KindNumericLiteral, KindObjectKeyword, KindObjectBindingPattern, KindObjectLiteralExpression, KindOmittedExpression, KindAccessorKeyword, KindOverrideKeyword, KindParameter, KindStaticKeyword, KindTypeParameter, KindParenthesizedExpression, KindParenthesizedType, KindPartiallyEmittedExpression, KindPlusPlusToken, KindPlusToken, KindPostfixUnaryExpression, KindPrefixUnaryExpression, KindPrivateIdentifier, KindPropertyAccessExpression, KindPropertyAssignment, KindPropertyDeclaration, KindPropertySignature, KindQualifiedName, KindQuestionQuestionEqualsToken, KindQuestionQuestionToken, KindRegularExpressionLiteral, KindReturnStatement, KindSatisfiesExpression, KindSemicolonClassElement, KindSetAccessor, KindShorthandPropertyAssignment, KindSpreadAssignment, KindSpreadElement, KindStringKeyword, KindStringLiteral, KindSuperKeyword, KindSwitchStatement, KindSymbolKeyword, KindTaggedTemplateExpression, KindTemplateExpression, KindThisKeyword, KindThrowStatement, KindTrueKeyword, KindTryStatement, KindTypeAliasDeclaration, KindTypeAssertionExpression, KindTypeOfExpression, KindUndefinedKeyword, KindUnknownKeyword, KindVariableDeclaration, KindVariableDeclarationList, KindVariableStatement, KindVoidExpression, KindVoidKeyword, KindWhileStatement, KindWithStatement, KindYieldExpression, KindAbstractKeyword, KindArrayType, KindAsyncKeyword, KindCaseBlock, KindCaseClause, KindConstKeyword, KindDeclareKeyword, KindDecorator, KindDefaultClause, KindDefaultKeyword, KindExportKeyword, KindExtendsKeyword, KindExternalModuleReference, KindFirstJSDocTagNode, KindFirstNode, KindFirstStatement, KindGlobalKeyword, KindImplementsKeyword, KindImportClause, KindImportType, KindInKeyword, KindInferType, KindInstanceOfKeyword, KindJSDoc, KindJSDocAugmentsTag, KindJSDocCallbackTag, KindJSDocDeprecatedTag, KindJSDocImplementsTag, KindJSDocImportTag, KindJSDocLink, KindJSDocLinkCode, KindJSDocLinkPlain, KindJSDocOverloadTag, KindJSDocOverrideTag, KindJSDocParameterTag, KindJSDocPrivateTag, KindJSDocPropertyTag, KindJSDocProtectedTag, KindJSDocPublicTag, KindJSDocReadonlyTag, KindJSDocReturnTag, KindJSDocSatisfiesTag, KindJSDocSeeTag, KindJSDocTemplateTag, KindJSDocThisTag, KindJSDocThrowsTag, KindJSDocTypeExpression, KindJSDocTypeTag, KindJSDocTypedefTag, KindJSDocUnknownTag, KindJsxAttributes, KindJsxNamespacedName, KindJsxOpeningFragment, KindJsxSpreadAttribute, KindLastJSDocTagNode, KindLastStatement, KindLiteralType, KindMappedType, KindModuleBlock, KindNamedExports, KindNamedImports, KindNamedTupleMember, KindNamespaceExport, KindNamespaceImport, KindOptionalType, KindOutKeyword, KindPrivateKeyword, KindProtectedKeyword, KindPublicKeyword, KindQuestionToken, KindReadonlyKeyword, KindRestType, KindSourceFile, KindString, KindTemplateLiteralTypeSpan, KindTemplateSpan, KindTypeKeyword, KindTypeLiteral, KindTypeOperator, KindTypePredicate, KindTypeQuery, } from "./generated/kinds.js";
import { IsArrayLiteralExpression, IsArrowFunction, IsAsExpression, IsAssignmentOperator, IsBigIntLiteral, IsBinaryExpression, IsBindingElement, IsBlock, IsCallExpression, IsClassDeclaration, IsClassExpression, IsClassStaticBlockDeclaration, IsComputedPropertyName, IsConstructorDeclaration, IsDecorator, IsElementAccessExpression, IsEnumDeclaration, IsExportAssignment, IsExportDeclaration, IsExportSpecifier, IsExpressionWithTypeArguments, IsFunctionDeclaration, IsFunctionExpression, IsHeritageClause, IsIdentifier, IsImportDeclaration, IsImportEqualsDeclaration, IsImportSpecifier, IsImportTypeNode, IsInterfaceDeclaration, IsJSDocAugmentsTag, IsJSDocDeprecatedTag, IsJSDocImplementsTag, IsJSDocNameReference, IsJSTypeAliasDeclaration, IsJsxAttribute, IsJsxOpeningElement, IsJsxSelfClosingElement, IsJsxSpreadAttribute, IsLabeledStatement, IsLiteralKind, IsLiteralTypeNode, IsLogicalOrCoalescingAssignmentOperator, IsMetaProperty, IsMethodDeclaration, IsModifierKind, IsModuleBlock, IsModuleDeclaration, IsNamespaceExport, IsNamespaceImport, IsNewExpression, IsNonNullExpression, IsNumericLiteral, IsObjectLiteralExpression, IsParameterDeclaration, IsParenthesizedExpression, IsParenthesizedTypeNode, IsPrivateIdentifier, IsPropertyAccessExpression, IsPropertyDeclaration, IsPropertySignatureDeclaration, IsQualifiedName, IsShorthandPropertyAssignment, IsSourceFile, IsSpreadElement, IsStringLiteral, IsTaggedTemplateExpression, IsTokenKind, IsTypeLiteralNode, IsTypeQueryNode, IsTypeReferenceNode, IsVariableStatement, IsVoidExpression, } from "./generated/predicates.js";
import { ModifierFlagsAbstract, ModifierFlagsAccessor, ModifierFlagsAmbient, ModifierFlagsAsync, ModifierFlagsConst, ModifierFlagsDecorator, ModifierFlagsDefault, ModifierFlagsExport, ModifierFlagsIn, ModifierFlagsOut, ModifierFlagsOverride, ModifierFlagsParameterPropertyModifier, ModifierFlagsPrivate, ModifierFlagsProtected, ModifierFlagsPublic, ModifierFlagsReadonly, ModifierFlagsStatic, ModifierToFlag, } from "./modifierflags.js";
import { InternalSymbolNameDefault, InternalSymbolNameMissing, } from "./symbol.js";
import { SubtreeContainsESObjectRestOrSpread, SubtreeContainsObjectRestOrSpread, } from "./subtreefacts.js";
import { TokenFlagsUnterminated } from "./tokenflags.js";
import { AsSourceFile, SourceFile_Text } from "./ast.js";
import { ImportAttributesNode_GetResolutionModeOverride, Node_Arguments, Node_Body, Node_CommentList, Node_Elements, Node_ImportClause, Node_IsTypeOnly, Node_JSDoc, Node_Label, Node_MemberList, Node_Members, Node_ModuleSpecifier, Node_ParameterList, Node_Parameters, Node_PostfixToken, Node_Properties, Node_PropertyNameOrName, Node_QuestionToken, Node_Statements, Node_TagName, Node_TypeArguments, Node_TypeParameterList, Node_TypeParameters, } from "./ast.js";
import { Node_BodyData, Node_ForEachChild, Node_FunctionLikeData, Node_KindString, Node_LiteralLikeData, Node_SubtreeFacts, Node_TemplateLiteralLikeData, NodeDefault_AsNode, visitNodes, } from "./spine.js";
import { TextRange_ContainedBy } from "../core/text.js";
import { ScriptKindJS, ScriptKindJSON, ScriptKindJSX } from "../core/scriptkind.js";
import { CompilerOptions_GetEmitModuleKind, JsxEmitReactJSX, JsxEmitReactJSXDev, ModuleKindCommonJS, ModuleKindES2015, ModuleKindESNext, ModuleKindNode16, ModuleKindNodeNext, ModuleKindNone, ModuleKindPreserve, ResolutionModeCommonJS, ResolutionModeESM, ResolutionModeNone, } from "../core/compileroptions.js";
import { TSTrue, TSUnknown } from "../core/tristate.js";
import { ExtensionCjs, ExtensionCts, ExtensionDcts, ExtensionDmts, ExtensionDts, ExtensionJs, ExtensionJsx, ExtensionMjs, ExtensionMts, ExtensionTs, ExtensionTsx, } from "../tspath/extension.js";
import { FileExtensionIsOneOf } from "../tspath/extension.js";
import { Every, Filter, Find, FirstOrNil, IfElse, Some, } from "../core/core.js";
 ...
 * )
 */
export const nextNodeId = new Uint64();
export const nextSymbolId = new Uint64();
/**
...
export function GetNodeId(node) {
    node.id ??= new Uint64();
    const id0 = node.id.Load();
    if (id0 !== 0)
        return id0;
    // Worst case, we burn a few ids if we have to CAS.
    const attempted = nextNodeId.Add(1);
    const id1 = node.id.CompareAndSwap(0, attempted) ? attempted : node.id.Load();
    return id1;
}
/**
 ...
 * }
 */
export function GetSymbolId(symbol_) {
    symbol_.id ??= new Uint64();
    const id0 = symbol_.id.Load();
    if (id0 !== 0)
        return id0;
    // Worst case, we burn a few ids if we have to CAS.
    const attempted = nextSymbolId.Add(1);
    const id1 = symbol_.id.CompareAndSwap(0, attempted) ? attempted : symbol_.id.Load();
    return id1;
}
/**
 ...
 * }
 */
export function GetSymbolTable(data) {
    if (data === undefined) {
        return new Map();
    }
    return data;
 ...
 * }
 */
export function GetMembers(symbol_) {
 ...
 * }
 */
export function GetExports(symbol_) {
 ...
 * }
 */
export function GetLocals(container) {
...
export function NodeIsMissing(node) {
    return (node === undefined ||
        (Node_Pos(node) === Node_End(node) && Node_Pos(node) >= 0 && node.Kind !== KindEndOfFile));
}
/**
 ...
 * }
 */
export function NodeIsSynthesized(node) {
    return (PositionIsSynthesized(Node_Pos(node)) || PositionIsSynthesized(Node_End(node)));
}
/**
 ...
 * }
 */
export function RangeIsSynthesized(loc) {
    return (PositionIsSynthesized(TextRange_Pos(loc)) || PositionIsSynthesized(TextRange_End(loc)));
}
/**
 ...
 * }
 */
export function NodeKindIs(node, ...kinds) {
    return slices.Contains(kinds, node.Kind);
}
/**
 ...
 * }
 */
export function IsCompoundAssignment(token) {
    return (token >= KindFirstCompoundAssignment && token <= KindLastCompoundAssignment);
}
/**
 ...
 * }
 */
export function IsAssignmentExpression(node, excludeCompoundAssignment) {
    if (node.Kind === KindBinaryExpression) {
...
export function IsForInOrOfStatement(node) {
    return (node !== undefined &&
        (node.Kind === KindForInStatement || node.Kind === KindForOfStatement));
}
/**
 ...
 * }
 */
export function IsLogicalBinaryOperator(token) {
    return (token === KindBarBarToken || token === KindAmpersandAmpersandToken);
}
/**
 ...
 * }
 */
export function IsLogicalOrCoalescingBinaryOperator(token) {
    return (IsLogicalBinaryOperator(token) || token === KindQuestionQuestionToken);
}
/**
 ...
 * }
 */
export function IsLogicalOrCoalescingBinaryExpression(expr) {
    return (IsBinaryExpression(expr) &&
        IsLogicalOrCoalescingBinaryOperator(AsBinaryExpression(expr).OperatorToken.Kind));
}
/**
 ...
 * }
 */
export function IsLogicalOrCoalescingAssignmentExpression(expr) {
    return (IsBinaryExpression(expr) &&
        IsLogicalOrCoalescingAssignmentOperator(AsBinaryExpression(expr).OperatorToken.Kind));
}
/**
 ...
 * }
 */
export function IsIdentifierName(node) {
    ...
    switch (parent.Kind) {
        ...
        case KindPropertyAssignment:
        case KindPropertyAccessExpression:
            return (Node_Name(parent) === node);
        case KindQualifiedName:
            return (AsQualifiedName(parent).Right === node);
        case KindBindingElement:
            return (Node_PropertyName(parent) === node);
        case KindImportSpecifier:
            return (Node_PropertyName(parent) === node);
 ...
 * }
 */
export function IsPushOrUnshiftIdentifier(node) {
 ...
 * }
 */
export function IsStringOrNumericLiteralLike(node) {
    return (IsStringLiteralLike(node) || IsNumericLiteral(node));
}
/**
 ...
 * }
 */
export function getQuestionDotToken(node) {
...
export function IsOutermostOptionalChain(node) {
    ...
    return (!IsOptionalChain(parent) || // cases 1, 2, and 3
        IsOptionalChainRoot(parent) || // case 4
        node !== Node_Expression(parent)); // case 5
}
/**
...
export function IsExpressionOfOptionalChainRoot(node) {
    return (IsOptionalChainRoot(node.Parent) && Node_Expression(node.Parent) === node);
}
/**
...
export function IsNullishCoalesce(node) {
    return (node.Kind === KindBinaryExpression &&
        AsBinaryExpression(node).OperatorToken.Kind === KindQuestionQuestionToken);
}
/**
 ...
 * }
 */
export function isLeftHandSideExpressionKind(kind) {
    switch (kind) {
        case KindPropertyAccessExpression:
        case KindElementAccessExpression:
 ...
 * }
 */
export function isUnaryExpressionKind(kind) {
    switch (kind) {
        case KindPrefixUnaryExpression:
        case KindPostfixUnaryExpression:
 ...
 * }
 */
export function isExpressionKind(kind) {
    switch (kind) {
        case KindConditionalExpression:
...
export function IsCommaExpression(node) {
    return (node.Kind === KindBinaryExpression &&
        AsBinaryExpression(node).OperatorToken.Kind === KindCommaToken);
}
/**
    ...
    switch (node.Kind) {
        ...
        case KindLabeledStatement:
            return (lookInLabeledStatements &&
                IsIterationStatement(Node_Statement(node), lookInLabeledStatements));
    }
    return false;
}
/**
 ...
 * }
 */
export function isFunctionLikeDeclarationKind(kind) {
    switch (kind) {
        case KindFunctionDeclaration:
        case KindMethodDeclaration:
...
export function IsFunctionLikeDeclaration(node) {
    // TODO(rbuckton): Move `node != nil` test to call sites
    return (node !== undefined && isFunctionLikeDeclarationKind(node.Kind));
}
/**
 ...
 * }
 */
export function IsFunctionOrSourceFile(node) {
    return (IsFunctionLike(node) || IsSourceFile(node));
}
/**
 ...
 * }
 */
export function IsClassOrInterfaceLike(node) {
    return (node.Kind === KindClassDeclaration || node.Kind === KindClassExpression ||
...
export function IsPrivateIdentifierClassElementDeclaration(node) {
    return ((IsPropertyDeclaration(node) || IsMethodOrAccessor(node)) && IsPrivateIdentifier(Node_Name(node)));
}
/**
 ...
 * }
 */
export function IsObjectLiteralOrClassExpressionMethodOrAccessor(node) {
    const kind = node.Kind;
    return ((kind === KindMethodDeclaration || kind === KindGetAccessor || kind === KindSetAccessor) &&
        (node.Parent.Kind === KindObjectLiteralExpression || node.Parent.Kind === KindClassExpression));
}
 ...
 * }
 */
export function IsObjectLiteralMethod(node) {
    return (node !== undefined && node.Kind === KindMethodDeclaration &&
        node.Parent.Kind === KindObjectLiteralExpression);
}
/**
 ...
 * }
 */
export function isDeclarationStatementKind(kind) {
    switch (kind) {
        case KindFunctionDeclaration:
        case KindMissingDeclaration:
 ...
 * }
 */
export function isStatementKindButNotDeclarationKind(kind) {
    switch (kind) {
        case KindBreakStatement:
 ...
 * }
 */
export function IsBlockOrCatchScoped(declaration) {
 ...
 * }
 */
export function IsCatchClauseVariableDeclarationOrBindingElement(declaration) {
 ...
 * }
 */
export function IsTypeNodeKind(kind) {
    switch (kind) {
        case KindAnyKeyword:
 ...
 * }
 */
export function IsJSDocKind(kind) {
    return (KindFirstJSDocNode <= kind && kind <= KindLastJSDocNode);
}
/**
...
export function IsJSDocTypeAssertion(node) {
    ...
    return (IsAsExpression(expr) && Node_Type(expr) !== undefined &&
        (Node_Type(expr).Flags & NodeFlagsReparsed) !== 0);
}
/**
 ...
 * }
 */
export function IsPrologueDirective(node) {
    return (node.Kind === KindExpressionStatement &&
        Node_Expression(node).Kind === KindStringLiteral);
}
/**
 ...
 * )
 */
export const OEKParentheses = (1 << 0);
export const OEKTypeAssertions = (1 << 1);
export const OEKNonNullAssertions = (1 << 2);
export const OEKPartiallyEmittedExpressions = (1 << 3);
export const OEKExpressionsWithTypeArguments = (1 << 4);
export const OEKSatisfies = (1 << 5);
export const OEKExcludeJSDocTypeAssertion = (1 << 6);
export const OEKAssertions = (OEKTypeAssertions | OEKNonNullAssertions | OEKSatisfies);
export const OEKAll = (OEKParentheses | OEKAssertions | OEKPartiallyEmittedExpressions | OEKExpressionsWithTypeArguments);
/**
 ...
 * }
 */
export function IsOuterExpression(node, kinds) {
    switch (node.Kind) {
        case KindParenthesizedExpression:
            return ((kinds & OEKParentheses) !== 0 &&
                !((kinds & OEKExcludeJSDocTypeAssertion) !== 0 && IsJSDocTypeAssertion(node)));
        case KindTypeAssertionExpression:
        case KindAsExpression:
            return ((kinds & OEKTypeAssertions) !== 0);
        case KindSatisfiesExpression:
 ...
 * }
 */
export function SkipParentheses(node) {
    return SkipOuterExpressions(node, OEKParentheses);
}
/**
 ...
 * }
 */
export const setParentInChildrenPool = (() => {
 ...
 * }
 */
export function newParentInChildrenSetter() {
    // Consolidate state into one allocation.
    // Similar to https://go.dev/cl/552375.
    const state = {
        parent: undefined,
 ...
 * }
 */
export function SetParentInChildren(node) {
    const fn = setParentInChildrenPool.Get();
    try {
        fn(node);
    }
    finally {
 ...
 * }
 */
export function SetImportsOfSourceFile(node, imports) {
    node.imports = imports;
}
/**
 ...
 * }
 */
export function FindAncestorKind(node, kind) {
    for (let current = node; current !== undefined; current = current.Parent) {
 ...
 * )
 */
export const FindAncestorFalse = 0;
export const FindAncestorTrue = 1;
export const FindAncestorQuit = 2;
/**
 ...
 * }
 */
export function ToFindAncestorResult(b) {
    if (b) {
        return FindAncestorTrue;
    }
    return FindAncestorFalse;
 ...
 * }
 */
export function FindAncestorOrQuit(node, callback) {
    for (let current = node; current !== undefined; current = current.Parent) {
 ...
 * }
 */
export function HasSyntacticModifier(node, flags) {
    return ((Node_ModifierFlags(node) & flags) !== 0);
}
/**
 ...
 * }
 */
export function HasAccessorModifier(node) {
    return HasSyntacticModifier(node, ModifierFlagsAccessor);
}
/**
 ...
 * }
 */
export function CanHaveDecorators(node) {
    switch (node.Kind) {
        case KindParameter:
        case KindPropertyDeclaration:
        case KindMethodDeclaration:
 ...
 * }
 */
export function IsFunctionExpressionOrArrowFunction(node) {
    return (IsFunctionExpression(node) || IsArrowFunction(node));
}
/**
 ...
 * }
 */
export function ForEachReturnStatement(body, visitor) {
    const traverse = (node) => {
        switch (node.Kind) {
            case KindReturnStatement:
                return visitor(node);
 ...
 * }
 */
export function getCombinedFlags(node, getFlags) {
    ...
    const flags1 = isDeclList ? (flags0 | getFlags(n1)) : flags0;
    const n2 = isDeclList ? n1.Parent : n1;
    const flags2 = (n2 !== undefined && n2.Kind === KindVariableStatement) ? (flags1 | getFlags(n2)) : flags1;
    return flags2;
}
/**
 ...
 * }
 */
export function IsVarAwaitUsing(node) {
    return ((GetCombinedNodeFlags(node) & NodeFlagsBlockScoped) === NodeFlagsAwaitUsing);
}
/**
 ...
 * }
 */
export function IsVarUsing(node) {
    return ((GetCombinedNodeFlags(node) & NodeFlagsBlockScoped) === NodeFlagsUsing);
}
/**
 ...
 * }
 */
export function IsDeprecatedDeclaration(declaration) {
    return IsDeprecatedDeclarationWithCachedFlags(declaration, GetCombinedNodeFlags(declaration));
}
/**
 ...
 * }
 */
export function IsDeprecatedDeclarationWithCachedFlags(declaration, combinedFlags) {
    if ((combinedFlags & NodeFlagsPossiblyContainsDeprecatedTag) === 0) {
        return false;
    }
    // Walk up to find the node that directly has the flag, since JSDoc is
 ...
 * }
 */
export function IsVarConst(node) {
    return ((GetCombinedNodeFlags(node) & NodeFlagsBlockScoped) === NodeFlagsConst);
}
/**
 ...
 * }
 */
export function IsVarConstLike(node) {
    switch (GetCombinedNodeFlags(node) & NodeFlagsBlockScoped) {
        case NodeFlagsConst:
        case NodeFlagsUsing:
 ...
 * }
 */
export function IsSourceFileJS(file) {
    return (file.ScriptKind === ScriptKindJS || file.ScriptKind === ScriptKindJSX);
}
/**
 ...
 * }
 */
export function IsInJSFile(node) {
    return (node !== undefined && (node.Flags & NodeFlagsJavaScriptFile) !== 0);
}
/**
 ...
 * }
 */
export function IsDeclarationName(name) {
    return (!IsSourceFile(name) && !IsBindingPattern(name) && IsDeclaration(name.Parent) && Node_Name(name.Parent) === name);
}
/**
 ...
 * }
 */
export function IsDeclarationNameOrImportPropertyName(name) {
    switch (name.Parent.Kind) {
        case KindImportSpecifier:
        case KindExportSpecifier:
            return (IsIdentifier(name) || name.Kind === KindStringLiteral);
 ...
 * }
 */
export function IsLiteralComputedPropertyDeclarationName(node) {
    return (IsStringOrNumericLiteralLike(node) &&
        node.Parent.Kind === KindComputedPropertyName &&
        IsDeclaration(node.Parent.Parent));
}
 ...
 * }
 */
export function IsExternalModuleImportEqualsDeclaration(node) {
 ...
 * }
 */
export function IsLiteralImportTypeNode(node) {
    return (IsImportTypeNode(node) &&
        IsLiteralTypeNode(AsImportTypeNode(node).Argument) &&
        IsStringLiteral(AsLiteralTypeNode(AsImportTypeNode(node).Argument).Literal));
}
/**
...
export function IsJsxTagName(node) {
    ...
    switch (parent.Kind) {
        ...
        case KindJsxClosingElement:
        case KindJsxSelfClosingElement:
            return (Node_TagName(parent) === node);
    }
    return false;
}
/**
 ...
 * }
 */
export function IsVoidZero(node) {
    return (IsVoidExpression(node) && IsNumericLiteral(Node_Expression(node)) && Node_Text(Node_Expression(node)) === "0");
}
/**
 ...
 * }
 */
export function IsExportsIdentifier(node) {
    return (IsIdentifier(node) && Node_Text(node) === "exports");
}
/**
 ...
 * }
 */
export function IsModuleIdentifier(node) {
    return (IsIdentifier(node) && Node_Text(node) === "module");
}
/**
 ...
 * }
 */
export function IsThisIdentifier(node) {
    return (IsIdentifier(node) && Node_Text(node) === "this");
}
/**
 ...
 * }
 */
export function IsThisParameter(node) {
    return (IsParameterDeclaration(node) && Node_Name(node) !== undefined && IsThisIdentifier(Node_Name(node)));
}
/**
 ...
 * }
 */
export function IsBindableStaticAccessExpression(node, excludeThisKeyword) {
    return ((IsPropertyAccessExpression(node) &&
 ...
 * }
 */
export function IsBindableStaticElementAccessExpression(node, excludeThisKeyword) {
    return (IsLiteralLikeElementAccess(node) &&
        ((!excludeThisKeyword && Node_Expression(node).Kind === KindThisKeyword) ||
            IsEntityNameExpression(Node_Expression(node)) ||
            IsBindableStaticAccessExpression(Node_Expression(node), true /*excludeThisKeyword*/)));
}
/**
...
export function IsPrototypeAccess(node) {
    if (IsBindableStaticAccessExpression(node, false /*excludeThisKeyword*/)) {
        ...
        if (name !== undefined) {
            return (Node_Text(name) === "prototype");
        }
    }
    return false;
}
 ...
 * }
 */
export function IsLiteralLikeElementAccess(node) {
 ...
 * }
 */
export function IsBindableStaticNameExpression(node, excludeThisKeyword) {
    return (IsEntityNameExpression(node) || IsBindableStaticAccessExpression(node, excludeThisKeyword));
}
/**
 ...
 * }
 */
export function GetElementOrPropertyAccessName(node) {
    switch (node.Kind) {
        case KindPropertyAccessExpression:
            ...
            return undefined;
        case KindElementAccessExpression: {
            const arg = SkipParentheses(AsElementAccessExpression(node).ArgumentExpression);
 ...
 * }
 */
export function TryGetClassImplementingOrExtendingExpressionWithTypeArguments(node) {
    if (IsExpressionWithTypeArguments(node)) {
        if (IsHeritageClause(node.Parent) && IsClassLike(node.Parent.Parent)) {
            return [node.Parent.Parent, (AsHeritageClause(node.Parent).Token === KindImplementsKeyword)];
        }
    }
        ...
        case KindCallExpression:
            switch (GetAssignmentDeclarationKind(declaration)) {
                ...
                case JSDeclarationKindExportsProperty: {
                    const left = AsBinaryExpression(declaration).Left;
            ...
            return undefined;
        case KindExportAssignment: {
            const expr = Node_Expression(declaration);
            if (IsIdentifier(expr)) {
                return expr;
            }
            return undefined;
        ...
        switch (parent.Kind) {
            ...
            case KindBinaryExpression:
                if (node === AsBinaryExpression(parent).Right) {
                    const left = AsBinaryExpression(parent).Left;
                    switch (left.Kind) {
                        case KindIdentifier:
                            return left;
                        case KindPropertyAccessExpression:
                        ...
                        case KindElementAccessExpression: {
                            const arg = SkipParentheses(AsElementAccessExpression(left).ArgumentExpression);
                            if (IsStringOrNumericLiteralLike(arg)) {
                                return arg;
                            }
                        }
 ...
 * )
 */
export const JSDeclarationKindNone = 0;
// module.exports = expr, except for module.exports = exports
export const JSDeclarationKindModuleExports = 1;
// exports.name = expr
// module.exports.name = expr
export const JSDeclarationKindExportsProperty = 2;
// this.name = expr
export const JSDeclarationKindThisProperty = 3;
// F.name = expr, F[name] = expr, in JS or TS file
export const JSDeclarationKindProperty = 4;
// Object.defineProperty(x, 'name', { value: any, writable?: boolean (false by default) });
export const JSDeclarationKindObjectDefinePropertyValue = 5;
// Object.defineProperty(exports || module.exports, 'name', ...);
export const JSDeclarationKindObjectDefinePropertyExports = 6;
/**
 ...
 * }
 */
export function GetAssignmentDeclarationKind(node) {
    switch (node.Kind) {
        case KindBinaryExpression: {
        ...
        case KindCallExpression:
            if (IsInJSFile(node) && IsBindableObjectDefinePropertyCall(node)) {
                const entityName = Node_Arguments(node)[0];
                if (IsExportsIdentifier(entityName) || IsModuleExportsAccessExpression(entityName)) {
                    return JSDeclarationKindObjectDefinePropertyExports;
                }
                return JSDeclarationKindObjectDefinePropertyValue;
 ...
 * }
 */
export function IsBindableObjectDefinePropertyCall(node) {
...
export function IsDynamicName(name) {
    const expr = name.Kind === KindComputedPropertyName ? Node_Expression(name) :
 ...
 * }
 */
export function IsEntityNameExpressionEx(node, allowJS) {
    return (IsIdentifier(node) ||
        IsPropertyAccessEntityNameExpression(node, allowJS) ||
        (allowJS && (node.Kind === KindThisKeyword || isElementAccessEntityNameExpression(node, allowJS))));
}
 ...
 * }
 */
export function IsPropertyAccessEntityNameExpression(node, allowJS) {
    return (IsPropertyAccessExpression(node) && IsIdentifier(Node_Name(node)) &&
        IsEntityNameExpressionEx(Node_Expression(node), allowJS));
}
/**
 ...
 * }
 */
export function isElementAccessEntityNameExpression(node, allowJS) {
    return (IsElementAccessExpression(node) &&
        IsStringOrNumericLiteralLike(AsElementAccessExpression(node).ArgumentExpression) &&
        IsEntityNameExpressionEx(Node_Expression(node), allowJS));
}
 ...
 * }
 */
export function IsDottedName(node) {
    switch (node.Kind) {
        case KindIdentifier:
        case KindThisKeyword:
        case KindSuperKeyword:
 ...
 * }
 */
export function HasSamePropertyAccessName(node1, node2) {
    if (node1.Kind === KindIdentifier && node2.Kind === KindIdentifier) {
        return (Node_Text(node1) === Node_Text(node2));
    }
    else if (node1.Kind === KindPropertyAccessExpression && node2.Kind === KindPropertyAccessExpression) {
        return (Node_Text(Node_Name(node1)) === Node_Text(Node_Name(node2)) &&
            HasSamePropertyAccessName(Node_Expression(node1), Node_Expression(node2)));
    }
    return false;
}
/**
...
export function IsAmbientModule(node) {
    return (IsModuleDeclaration(node) &&
        (Node_Name(node).Kind === KindStringLiteral || IsGlobalScopeAugmentation(node)));
}
/**
 ...
 * }
 */
export function IsAmbientModuleSymbolName(s) {
    return (strings.HasPrefix(s, '"') && strings.HasSuffix(s, '"'));
}
/**
 ...
 * }
 */
export function IsExternalOrCommonJSModule(file) {
    return (file.ExternalModuleIndicator !== undefined || file.CommonJSModuleIndicator !== undefined);
}
/**
 ...
 * }
 */
export function IsEffectiveExternalModule(node, compilerOptions) {
    return (IsExternalModule(node) ||
        (isCommonJSContainingModuleKind(CompilerOptions_GetEmitModuleKind(compilerOptions)) && node.CommonJSModuleIndicator !== undefined));
}
/**
 ...
 * }
 */
export function isCommonJSContainingModuleKind(kind) {
    return (kind === ModuleKindCommonJS || (ModuleKindNode16 <= kind && kind <= ModuleKindNodeNext));
}
/**
 ...
 * }
 */
export function IsExternalModuleIndicator(node) {
    // Exported top-level member indicates moduleness
    return (IsAnyImportOrReExport(node) || IsExportAssignment(node) || HasSyntacticModifier(node, ModifierFlagsExport));
}
/**
 ...
 * }
 */
export function IsExportNamespaceAsDefaultDeclaration(node) {
    if (IsExportDeclaration(node)) {
        const decl = AsExportDeclaration(node);
        return (IsNamespaceExport(decl.ExportClause) && ModuleExportNameIsDefault(Node_Name(decl.ExportClause)));
    }
    return false;
}
/**
 ...
 * }
 */
export function IsGlobalScopeAugmentation(node) {
    return (IsModuleDeclaration(node) && AsModuleDeclaration(node).Keyword === KindGlobalKeyword);
}
/**
 ...
 * }
 */
export function IsModuleAugmentationExternal(node) {
    // external module augmentation is a ambient module declaration that is either:
    // - defined in the top level scope and source file is an external module
    // - defined inside ambient module declaration located in the top level scope and source file not an external module
    switch (node.Parent.Kind) {
        ...
        case KindModuleBlock: {
            ...
            return (IsAmbientModule(grandParent) && IsSourceFile(grandParent.Parent) && !IsExternalModule(AsSourceFile(grandParent.Parent)));
        }
    }
    return false;
}
 ...
 * }
 */
export function IsModuleWithStringLiteralName(node) {
    return (IsModuleDeclaration(node) && Node_Name(node).Kind === KindStringLiteral);
}
/**
 ...
 * }
 */
export function GetContainingClass(node) {
    return FindAncestor(node.Parent, IsClassLike);
}
/**
 ...
 * }
 */
export function GetExtendsHeritageClauseElement(node) {
 ...
 * }
 */
export function GetExtendsHeritageClauseElements(node) {
    return GetHeritageElements(node, KindExtendsKeyword);
}
/**
 ...
 * }
 */
export function GetImplementsHeritageClauseElements(node) {
    return GetHeritageElements(node, KindImplementsKeyword);
}
/**
 ...
 * }
 */
export function GetHeritageElements(node, kind) {
 ...
 * }
 */
export function GetHeritageClause(node, kind) {
 ...
 * }
 */
export function getHeritageClauses(node) {
    switch (node.Kind) {
        case KindClassDeclaration:
 ...
 * }
 */
export function IsPartOfParameterDeclaration(node) {
    return (GetRootDeclaration(node).Kind === KindParameter);
}
/**
...
export function IsInTopLevelContext(node) {
    // The name of a class or function declaration is a BindingIdentifier in its surrounding scope.
    const effective = IsIdentifier(node) &&
        (IsClassDeclaration(node.Parent) || IsFunctionDeclaration(node.Parent)) &&
        Node_Name(node.Parent) === node
        ? node.Parent
        : node;
    const container = GetThisContainer(effective, true /*includeArrowFunctions*/, false /*includeClassComputedPropertyName*/);
    return IsSourceFile(container);
}
/**
 ...
 * }
 */
export function IsEnumConst(node) {
    return ((GetCombinedModifierFlags(node) & ModifierFlagsConst) !== 0);
}
/**
 ...
 * }
 */
export function ExpressionIsAlias(node) {
    return (IsEntityNameExpression(node) || IsClassExpression(node));
}
/**
 ...
 * }
 */
export function IsInstanceOfExpression(node) {
    return (IsBinaryExpression(node) && AsBinaryExpression(node).OperatorToken.Kind === KindInstanceOfKeyword);
}
/**
 ...
 * }
 */
export function IsAnyImportOrReExport(node) {
    return (IsImportNode(node) || IsExportDeclaration(node));
}
/**
 ...
 * }
 */
export function IsJsonSourceFile(file) {
 ...
 * }
 */
export function IsInJsonFile(node) {
    return ((node.Flags & NodeFlagsJsonFile) !== 0);
}
/**
 ...
 * }
 */
export function GetExternalModuleName(node) {
    switch (node.Kind) {
        case KindImportDeclaration:
        case KindJSImportDeclaration:
        case KindExportDeclaration:
 ...
 * }
 */
export function GetImportAttributes(node) {
    switch (node.Kind) {
        case KindImportDeclaration:
        case KindJSImportDeclaration:
 ...
 * }
 */
export function getImportTypeNodeLiteral(node) {
    if (IsImportTypeNode(node)) {
...
export function IsExpressionNode(node) {
    switch (node.Kind) {
        ...
        case KindMetaProperty:
            // `import.defer` in `import.defer(...)` is not an expression
            return (!IsImportCall(node.Parent) || Node_Expression(node.Parent) !== node);
        case KindExpressionWithTypeArguments:
            return !IsHeritageClause(node.Parent);
        case KindQualifiedName: {
            let root = node;
        ...
        case KindPrivateIdentifier:
            return (IsBinaryExpression(node.Parent) && AsBinaryExpression(node.Parent).Left === node && AsBinaryExpression(node.Parent).OperatorToken.Kind === KindInKeyword);
        case KindIdentifier:
            if (IsTypeQueryNode(node.Parent) || IsJSDocLinkLike(node.Parent) || IsJSDocNameReference(node.Parent) || IsJsxTagName(node)) {
                return true;
            }
...
export function IsInExpressionContext(node) {
    ...
    switch (parent.Kind) {
        ...
        case KindPropertyAssignment:
        case KindBindingElement:
            return (Node_Initializer(parent) === node);
        case KindExpressionStatement:
        case KindIfStatement:
        case KindDoStatement:
        case KindWhileStatement:
        ...
        case KindComputedPropertyName:
        case KindSatisfiesExpression:
            return (Node_Expression(parent) === node);
        case KindForStatement: {
        ...
        case KindSpreadAssignment:
            return true;
        case KindExpressionWithTypeArguments:
            return (Node_Expression(parent) === node && !IsPartOfTypeNode(parent));
        case KindShorthandPropertyAssignment:
            return (AsShorthandPropertyAssignment(parent).ObjectAssignmentInitializer === node);
        default:
            return IsExpressionNode(parent);
    }
}
 ...
 * }
 */
export function isPartOfTypeNodeInParent(node) {
    const parent = node.Parent;
    if (parent.Kind === KindTypeQuery) {
        return false;
    }
    if (parent.Kind === KindImportType) {
        return !AsImportTypeNode(parent).IsTypeOf;
    }
    // Do not recursively call isPartOfTypeNode on the parent. In the example:
    //
    //     let a: A.B.C;
    ...
    switch (parent.Kind) {
        case KindExpressionWithTypeArguments:
            return isPartOfTypeExpressionWithTypeArguments(parent);
        case KindTypeParameter:
            return (node === AsTypeParameterDeclaration(parent).Constraint);
        case KindVariableDeclaration:
        case KindParameter:
        case KindPropertyDeclaration:
        case KindPropertySignature:
 ...
 * }
 */
export function isPartOfTypeExpressionWithTypeArguments(node) {
    const parent = node.Parent;
...
export function IsSuperCall(node) {
    return (IsCallExpression(node) && Node_Expression(node).Kind === KindSuperKeyword);
}
/**
...
export function IsImportCall(node) {
    ...
    const e = Node_Expression(node);
    return (e.Kind === KindImportKeyword ||
        (IsMetaProperty(e) && AsMetaProperty(e).KeywordToken === KindImportKeyword && Node_Text(e) === "defer"));
}
/**
 ...
 * }
 */
export function IsComputedNonLiteralName(name) {
    return (IsComputedPropertyName(name) && !IsStringOrNumericLiteralLike(Node_Expression(name)));
}
/**
...
export function IsQuestionToken(node) {
    return (node !== undefined && node.Kind === KindQuestionToken);
}
/**
 ...
 * }
 */
export function EntityNameToString(name, getTextOfNode) {
    switch (name.Kind) {
        case KindThisKeyword:
            return "this";
        case KindIdentifier:
 ...
 * }
 */
export function GetTextOfPropertyName(name) {
 ...
 * }
 */
export function TryGetTextOfPropertyName(name) {
    switch (name.Kind) {
        case KindIdentifier:
        case KindPrivateIdentifier:
        case KindStringLiteral:
        ...
        case KindBigIntLiteral:
        case KindNoSubstitutionTemplateLiteral:
            return [Node_Text(name), true];
        case KindComputedPropertyName:
            if (IsStringOrNumericLiteralLike(Node_Expression(name))) {
                return [Node_Text(Node_Expression(name)), true];
            }
            break;
        case KindJsxNamespacedName:
            return [Node_Text(AsJsxNamespacedName(name).Namespace) + ":" + Node_Text(Node_Name(name)), true];
    }
    return ["", false];
}
/**
 ...
 * }
 */
export function IsNonWhitespaceToken(node) {
    return (IsTokenKind(node.Kind) && !IsWhitespaceOnlyJsxText(node));
}
/**
 ...
 * }
 */
export function IsWhitespaceOnlyJsxText(node) {
    return (node.Kind === KindJsxText && AsJsxText(node).ContainsOnlyTriviaWhiteSpaces);
}
/**
 ...
 * }
 */
export function GetNewTargetContainer(node) {
    const container = GetThisContainer(node, false /*includeArrowFunctions*/, false /*includeClassComputedPropertyName*/);
 ...
 * }
 */
export function GetEnclosingBlockScopeContainer(node) {
 ...
 * }
 */
export function IsBlockScope(node, parentNode) {
    switch (node.Kind) {
        case KindSourceFile:
        case KindCaseBlock:
        case KindCatchClause:
 ...
 * )
 */
export const SemanticMeaningNone = 0;
export const SemanticMeaningValue = (1 << 0);
export const SemanticMeaningType = (1 << 1);
export const SemanticMeaningNamespace = (1 << 2);
export const SemanticMeaningAll = (SemanticMeaningValue | SemanticMeaningType | SemanticMeaningNamespace);
/**
...
export function IsLabelOfLabeledStatement(node) {
    ...
    return (node === Node_Label(node.Parent));
}
/**
 ...
 * }
 */
export function pushAncestor(ancestors, parent) {
 ...
 * }
 */
export function popAncestor(ancestors, node) {
 ...
 * )
 */
export const ModuleInstanceStateUnknown = 0;
export const ModuleInstanceStateNonInstantiated = 1;
export const ModuleInstanceStateInstantiated = 2;
export const ModuleInstanceStateConstEnumOnly = 3;
/**
 ...
 * }
 */
export function getModuleInstanceState(node, ancestors, visited) {
 ...
 * }
 */
export function getModuleInstanceStateCached(node, ancestors, visited) {
    const visitedMap = visited !== undefined ? visited : new globalThis.Map();
    const nodeId = GetNodeId(node);
    if (visitedMap.has(nodeId)) {
        const cached = visitedMap.get(nodeId);
        if (cached !== ModuleInstanceStateUnknown) {
            return cached;
        }
        return ModuleInstanceStateNonInstantiated;
    ...
    const result = getModuleInstanceStateWorker(node, ancestors, visitedMap);
 ...
 * }
 */
export function getModuleInstanceStateWorker(node, ancestors, visited) {
    // A module is uninstantiated if it contains only
    switch (node.Kind) {
        case KindInterfaceDeclaration:
        case KindTypeAliasDeclaration:
        ...
        case KindExportDeclaration: {
            ...
            if (decl.ModuleSpecifier === undefined && decl.ExportClause !== undefined && decl.ExportClause.Kind === KindNamedExports) {
                const stateAncestors = pushAncestor(pushAncestor(ancestors, node), decl.ExportClause);
                const stateBox = { value: ModuleInstanceStateNonInstantiated };
                for (const specifier of Node_Elements(decl.ExportClause)) {
                    const specifierState = getModuleInstanceStateForAliasTarget(specifier, stateAncestors, visited);
        ...
        case KindModuleBlock: {
            const stateBox = { state: ModuleInstanceStateNonInstantiated };
            const blockAncestors = pushAncestor(ancestors, node);
            Node_ForEachChild(node, (n) => {
                const childState = getModuleInstanceStateCached(n, blockAncestors, visited);
                switch (childState) {
                    case ModuleInstanceStateNonInstantiated:
                        return false;
                    case ModuleInstanceStateConstEnumOnly:
 ...
 * }
 */
export function getModuleInstanceStateForAliasTarget(node, ancestors, visited) {
    ...
    while (p !== undefined) {
        ...
        if (IsBlock(p) || IsModuleBlock(p) || IsSourceFile(p)) {
            ...
            const foundBox = { value: ModuleInstanceStateUnknown };
            for (const statement of Node_Statements(p) ?? []) {
                if (NodeHasName(statement, name)) {
                    const state = getModuleInstanceStateCached(statement, statementsAncestors, visited);
 ...
 * }
 */
export function NodeHasName(statement, id) {
    const name = Node_Name(statement);
    if (name !== undefined) {
        return (IsIdentifier(name) && Node_Text(name) === Node_Text(id));
    }
    if (IsVariableStatement(statement)) {
        const declarations = AsVariableDeclarationList(AsVariableStatement(statement).DeclarationList).Declarations.Nodes;
        return Some(declarations, (d) => {
 ...
 * }
 */
export function IsInternalModuleImportEqualsDeclaration(node) {
    return (IsImportEqualsDeclaration(node) && AsImportEqualsDeclaration(node).ModuleReference.Kind !== KindExternalModuleReference);
}
/**
 ...
 * }
 */
export function IsConstAssertion(node) {
    switch (node.Kind) {
        case KindAsExpression:
        case KindTypeAssertionExpression:
...
export function IsConstTypeReference(node) {
    return (IsTypeReferenceNode(node) && (Node_TypeArguments(node)?.length ?? 0) === 0 &&
        IsIdentifier(AsTypeReferenceNode(node).TypeName) && Node_Text(AsTypeReferenceNode(node).TypeName) === "const");
}
/**
 ...
 * }
 */
export function IsGlobalSourceFile(node) {
    return (node.Kind === KindSourceFile && !IsExternalOrCommonJSModule(AsSourceFile(node)));
}
/**
 ...
 * }
 */
export function IsParameterLike(node) {
    switch (node.Kind) {
        case KindParameter:
        case KindTypeParameter:
            return true;
 ...
 * }
 */
export function GetDeclarationOfKind(symbol_, kind) {
 ...
 * }
 */
export function GetFirstIdentifier(node) {
    switch (node.Kind) {
        case KindIdentifier:
            return node;
        case KindQualifiedName:
 ...
 * }
 */
export function GetNamespaceDeclarationNode(node) {
    switch (node.Kind) {
        case KindImportDeclaration:
        case KindJSImportDeclaration: {
 ...
 * }
 */
export function ModuleExportNameIsDefault(node) {
    return (Node_Text(node) === InternalSymbolNameDefault);
}
/**
...
export function IsDefaultImport(node) {
    switch (node.Kind) {
        ...
        case KindJSImportDeclaration: {
            const importClause = Node_ImportClause(node);
            return (importClause !== undefined && AsImportClause(importClause).name !== undefined);
        }
    }
    return false;
}
 ...
 * }
 */
export function GetImpliedNodeFormatForFile(path, packageJsonType) {
 ...
 * }
 */
export function GetEmitModuleFormatOfFileWorker(fileName, options, sourceFileMetaData) {
    const result = GetImpliedNodeFormatForEmitWorker(fileName, CompilerOptions_GetEmitModuleKind(options), sourceFileMetaData);
 ...
 * }
 */
export function GetImpliedNodeFormatForEmitWorker(fileName, emitModuleKind, sourceFileMetaData) {
 ...
 * }
 */
export function GetDeclarationContainer(node) {
    return FindAncestor(GetRootDeclaration(node), (n) => {
        switch (n.Kind) {
            case KindVariableDeclaration:
 ...
 * }
 */
export function IsNonLocalAlias(symbol_, excludes) {
    if (symbol_ === undefined) {
        return false;
    }
    return ((symbol_.Flags & (SymbolFlagsAlias | excludes)) === SymbolFlagsAlias ||
        ((symbol_.Flags & SymbolFlagsAlias) !== 0 && (symbol_.Flags & SymbolFlagsAssignment) !== 0));
}
/**
 ...
 * }
 */
export function IsAliasSymbolDeclaration(node) {
    switch (node.Kind) {
        case KindImportEqualsDeclaration:
        case KindNamespaceExportDeclaration:
        case KindNamespaceImport:
        ...
        case KindExportSpecifier:
            return true;
        case KindImportClause:
            return (Node_Name(node) !== undefined);
        case KindExportAssignment:
...
export function GetNodeAtPosition(file, position, includeJSDoc) {
    ...
    while (true) {
        ...
        const child = jsdocChild !== undefined ? jsdocChild : (() => {
            const found = { value: undefined };
            Node_ForEachChild(current, (node) => {
                if (nodeContainsPosition(node, position)) {
                    found.value = node;
                    return true;
                }
...
export function nodeContainsPosition(node, position) {
    return (node.Kind >= KindFirstNode && Node_Pos(node) <= position &&
        (position < Node_End(node) || (position === Node_End(node) && node.Kind === KindEndOfFile)));
}
const importBytes = [0x69, 0x6d, 0x70, 0x6f, 0x72, 0x74];
const requireBytes = [0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65];
function sourceTextByteIndexAnyIR(text, view, start, end) {
    if (view.ascii) {
        ...
        return globalThis.Math.min(importIndex, requireIndex);
    }
    for (let index = start; index < end; index++) {
        const byte = utf8.StringByteViewAt(text, view, index);
...
function sourceTextByteViewHasBytes(text, view, start, bytes) {
    if (start + bytes.length > utf8.StringByteViewLen(text, view)) {
        return false;
    }
    for (let index = 0; index < bytes.length; index++) {
        if (utf8.StringByteViewAt(text, view, (start + index)) !== bytes[index]) {
            return false;
        }
    }
    return true;
 ...
 * }
 */
export function findImportOrRequire(text, start) {
    const view = utf8.GetStringByteView(text);
    const n = utf8.StringByteViewLen(text, view);
    let index = globalThis.Math.max(start, 0);
    while (index < n) {
 ...
 * }
 */
export function IsRequireCall(node, requireStringLiteralLikeArgument) {
    if (!IsCallExpression(node)) {
        return false;
    }
 ...
 * }
 */
export function IsRequireVariableStatement(node) {
    if (IsVariableStatement(node)) {
 ...
 * }
 */
export function GetJSXImplicitImportBase(compilerOptions, file) {
    const jsxImportSourcePragma = GetPragmaFromSourceFile(file, "jsximportsource");
    const jsxRuntimePragma = GetPragmaFromSourceFile(file, "jsxruntime");
    if (GetPragmaArgument(jsxRuntimePragma, "factory") === "classic") {
        return "";
    }
    if (compilerOptions.Jsx === JsxEmitReactJSX ||
        ...
        GetPragmaArgument(jsxRuntimePragma, "factory") === "automatic") {
        const pragmaResult = GetPragmaArgument(jsxImportSourcePragma, "factory");
        const sourceResult = pragmaResult !== "" ? pragmaResult : compilerOptions.JsxImportSource;
 ...
 * }
 */
export function GetJSXRuntimeImport(base, options) {
    if (base === "") {
        return base;
    }
 ...
 * }
 */
export function GetPragmaFromSourceFile(file, name) {
    if (file === undefined)
        return undefined;
    return file.Pragmas.reduce((acc, p) => p.Name === name ? p : acc, undefined);
}
/**
 ...
 * }
 */
export function GetPragmaArgument(pragma, name) {
    if (pragma !== undefined) {
 ...
 * }
 */
export function IsVariableDeclarationInitializedToRequire(node) {
    const current = node.Kind === KindBindingElement ? node.Parent.Parent : node;
 ...
 * }
 */
export function IsVariableDeclarationInitializedToBareOrAccessedRequire(node) {
    return isVariableDeclarationInitializedWithRequireHelper(node, true /*allowAccessedRequire*/);
}
/**
 ...
 * }
 */
export function isVariableDeclarationInitializedWithRequireHelper(node, allowAccessedRequire) {
    if (!IsInJSFile(node)) {
        return false;
    }
    if (node.Kind !== KindVariableDeclaration) {
    ...
    const initializer0 = Node_Initializer(node);
    if (initializer0 === undefined) {
        return false;
    }
    const initializer = allowAccessedRequire ? GetLeftmostAccessExpression(initializer0) : initializer0;
 ...
 * }
 */
export function GetModuleSpecifierOfBareOrAccessedRequire(node) {
    if (isVariableDeclarationInitializedWithRequireHelper(node, false /*allowAccessedRequire*/)) {
        return Node_Arguments(Node_Initializer(node))[0];
    }
    if (isVariableDeclarationInitializedWithRequireHelper(node, true /*allowAccessedRequire*/)) {
        const leftmost = GetLeftmostAccessExpression(Node_Initializer(node));
        if (IsRequireCall(leftmost, true /*requireStringLiteralLikeArgument*/)) {
 ...
 * }
 */
export function IsModuleExportsQualifiedName(node) {
    return (IsQualifiedName(node) && IsModuleIdentifier(AsQualifiedName(node).Left) && Node_Text(AsQualifiedName(node).Right) === "exports");
}
/**
 ...
 * }
 */
export function IsCheckJSEnabledForFile(sourceFile, compilerOptions) {
    if (sourceFile.CheckJsDirective !== undefined) {
        return sourceFile.CheckJsDirective.Enabled;
    }
    return (compilerOptions.CheckJs === TSTrue);
}
/**
 ...
 * }
 */
export function IsPlainJSFile(file, checkJs) {
    return (file !== undefined && (file.ScriptKind === ScriptKindJS || file.ScriptKind === ScriptKindJSX) && file.CheckJsDirective === undefined && checkJs === TSUnknown);
}
/**
...
export function IsTypeOnlyImportDeclaration(node) {
    switch (node.Kind) {
        case KindImportSpecifier:
            return (Node_IsTypeOnly(node) || Node_IsTypeOnly(node.Parent.Parent));
        case KindNamespaceImport:
...
export function isTypeOnlyExportDeclaration(node) {
    switch (node.Kind) {
        ...
        case KindExportDeclaration: {
            ...
            return (d.IsTypeOnly && d.ModuleSpecifier !== undefined && d.ExportClause === undefined);
        }
        case KindNamespaceExport:
            return Node_IsTypeOnly(node.Parent);
    }
 ...
 * }
 */
export function IsExclusivelyTypeOnlyImportOrExport(node) {
    switch (node.Kind) {
        case KindExportDeclaration:
            return Node_IsTypeOnly(node);
        case KindImportDeclaration:
 ...
 * }
 */
export function GetClassLikeDeclarationOfSymbol(symbol_) {
...
export function IsCallLikeExpression(node) {
    switch (node.Kind) {
        ...
        case KindDecorator:
            return true;
        case KindBinaryExpression:
            return (AsBinaryExpression(node).OperatorToken.Kind === KindInstanceOfKeyword);
    }
    return false;
}
/**
 ...
 * }
 */
export function NodeHasKind(node, kind) {
    if (node === undefined) {
        return false;
    }
    return (node.Kind === kind);
 ...
 * }
 */
export function IsContextualKeyword(token) {
    return (KindFirstContextualKeyword <= token && token <= KindLastContextualKeyword);
}
/**
 ...
 * }
 */
export function IsThisInTypeQuery(node) {
    if (!IsThisIdentifier(node)) {
        return false;
    }
 ...
 * }
 */
export function IsClassMemberModifier(token) {
    return (IsParameterPropertyModifier(token) || token === KindStaticKeyword ||
        token === KindOverrideKeyword || token === KindAccessorKeyword);
}
/**
 ...
 * }
 */
export function ForEachChildAndJSDoc(node, sourceFile, v) {
 ...
 * }
 */
export function IsVariableParameterOrProperty(node) {
    switch (node.Kind) {
        case KindVariableDeclaration:
        case KindParameter:
        case KindPropertySignature:
 ...
 * }
 */
export function GetTypeAnnotationNode(node) {
    switch (node.Kind) {
        case KindVariableDeclaration:
        case KindParameter:
        case KindPropertySignature:
        ...
        default: {
            const funcLike = Node_FunctionLikeData(node);
 ...
 * }
 */
export function GetClassExtendsHeritageElement(node) {
 ...
 * }
 */
export function GetImplementsTypeNodes(node) {
    return GetHeritageElements(node, KindImplementsKeyword);
}
/**
 ...
 * }
 */
export function IsJSDocSingleCommentNodeList(nodeList) {
    if (nodeList === undefined || nodeList.Nodes.length === 0) {
        return false;
    }
    const parent = nodeList.Nodes[0].Parent;
    if (parent === undefined) {
        return false;
    }
    return (IsJSDocSingleCommentNode(parent) && nodeList === Node_CommentList(parent));
}
/**
 ...
 * }
 */
export function IsJSDocSingleCommentNodeComment(node) {
    if (node === undefined || node.Parent === undefined) {
        return false;
    }
    return (IsJSDocSingleCommentNode(node.Parent) && node === Node_CommentList(node.Parent).Nodes[0]);
}
/**
 ...
 * }
 */
export function IsJSDocSingleCommentNode(node) {
    return (hasComment(node.Kind) && Node_CommentList(node) !== undefined && Node_CommentList(node).Nodes.length === 1);
}
/**
 ...
 * }
 */
export function isIdentifierInNonEmittingHeritageClause(node) {
    if (!IsIdentifier(node)) {
        return false;
    }
 ...
 * }
 */
export function isShorthandPropertyNameUseSite(useSite) {
    return (IsIdentifier(useSite) && IsShorthandPropertyAssignment(useSite.Parent) && Node_Name(useSite.Parent) === useSite);
}
/**
 ...
 * }
 */
export function GetPropertyNameForPropertyNameNode(name) {
    switch (name.Kind) {
        case KindIdentifier:
        case KindPrivateIdentifier:
        case KindStringLiteral:
        ...
        case KindComputedPropertyName: {
            ...
            if (IsSignedNumericLiteral(nameExpression)) {
                const baseText = Node_Text(AsPrefixUnaryExpression(nameExpression).Operand);
 ...
 * }
 */
export function IsPartOfExclusivelyTypeOnlyImportOrExportDeclaration(node) {
    return (FindAncestor(node, IsExclusivelyTypeOnlyImportOrExport) !== undefined);
}
/**
 ...
 * }
 */
export function IsEmittableImport(node) {
    switch (node.Kind) {
        case KindImportDeclaration:
            return (Node_ImportClause(node) !== undefined && !Node_IsTypeOnly(Node_ImportClause(node)));
        case KindExportDeclaration:
        case KindImportEqualsDeclaration:
            return !Node_IsTypeOnly(node);
        case KindCallExpression:
 ...
 * }
 */
export function IsResolutionModeOverrideHost(node) {
    if (node === undefined) {
        return false;
    }
    switch (node.Kind) {
 ...
 * }
 */
export function HasResolutionModeOverride(node) {
    if (node === undefined) {
        return false;
    }
    const attributes = node.Kind === KindImportType ? AsImportTypeNode(node).Attributes :
 ...
 * }
 */
export function GetExternalModuleImportEqualsDeclarationExpression(node) {
 ...
 * }
 */
export function CreateModifiersFromModifierFlags(flags, createModifier) {
    let result = [];
    if ((flags & ModifierFlagsExport) !== 0) {
 ...
 * }
 */
export function GetThisParameter(signature) {
    // callback tags do not currently support this parameters
    if (Node_Parameters(signature).length !== 0) {
        const thisParameter = Node_Parameters(signature)[0];
        if (IsThisParameter(thisParameter)) {
            return thisParameter;
        }
    }
 ...
 * }
 */
export function ReplaceModifiers(factory, node, modifierArray) {
    switch (node.Kind) {
        case KindTypeParameter: {
            const declaration = AsTypeParameterDeclaration(node);
            return NodeFactory_UpdateTypeParameterDeclaration(factory, declaration, modifierArray, Node_Name(node), declaration.Constraint, declaration.Expression, declaration.DefaultType);
        }
        case KindParameter: {
            const declaration = AsParameterDeclaration(node);
            return NodeFactory_UpdateParameterDeclaration(factory, declaration, modifierArray, declaration.DotDotDotToken, Node_Name(node), Node_QuestionToken(node), Node_Type(node), Node_Initializer(node));
        }
        case KindConstructorType:
            return NodeFactory_UpdateConstructorTypeNode(factory, AsConstructorTypeNode(node), modifierArray, Node_TypeParameterList(node), Node_ParameterList(node), Node_Type(node));
        case KindPropertySignature:
            return NodeFactory_UpdatePropertySignatureDeclaration(factory, AsPropertySignatureDeclaration(node), modifierArray, Node_Name(node), Node_PostfixToken(node), Node_Type(node), Node_Initializer(node));
        case KindPropertyDeclaration:
            return NodeFactory_UpdatePropertyDeclaration(factory, AsPropertyDeclaration(node), modifierArray, Node_Name(node), Node_PostfixToken(node), Node_Type(node), Node_Initializer(node));
        case KindMethodSignature:
            return NodeFactory_UpdateMethodSignatureDeclaration(factory, AsMethodSignatureDeclaration(node), modifierArray, Node_Name(node), Node_PostfixToken(node), Node_TypeParameterList(node), Node_ParameterList(node), Node_Type(node));
        case KindMethodDeclaration: {
            const declaration = AsMethodDeclaration(node);
            return NodeFactory_UpdateMethodDeclaration(factory, declaration, modifierArray, declaration.AsteriskToken, Node_Name(node), Node_PostfixToken(node), Node_TypeParameterList(node), Node_ParameterList(node), Node_Type(node), declaration.FullSignature, Node_Body(node));
        }
        case KindConstructor: {
            const declaration = AsConstructorDeclaration(node);
            return NodeFactory_UpdateConstructorDeclaration(factory, declaration, modifierArray, Node_TypeParameterList(node), Node_ParameterList(node), Node_Type(node), declaration.FullSignature, Node_Body(node));
        }
        case KindGetAccessor: {
            const declaration = AsGetAccessorDeclaration(node);
            return NodeFactory_UpdateGetAccessorDeclaration(factory, declaration, modifierArray, Node_Name(node), Node_TypeParameterList(node), Node_ParameterList(node), Node_Type(node), declaration.FullSignature, Node_Body(node));
        }
        case KindSetAccessor: {
            const declaration = AsSetAccessorDeclaration(node);
            return NodeFactory_UpdateSetAccessorDeclaration(factory, declaration, modifierArray, Node_Name(node), Node_TypeParameterList(node), Node_ParameterList(node), Node_Type(node), declaration.FullSignature, Node_Body(node));
        }
        case KindIndexSignature:
            return NodeFactory_UpdateIndexSignatureDeclaration(factory, AsIndexSignatureDeclaration(node), modifierArray, Node_ParameterList(node), Node_Type(node));
        case KindFunctionExpression: {
            const declaration = AsFunctionExpression(node);
            return NodeFactory_UpdateFunctionExpression(factory, declaration, modifierArray, declaration.AsteriskToken, Node_Name(node), Node_TypeParameterList(node), Node_ParameterList(node), Node_Type(node), declaration.FullSignature, Node_Body(node));
        }
        case KindArrowFunction: {
            const declaration = AsArrowFunction(node);
            return NodeFactory_UpdateArrowFunction(factory, declaration, modifierArray, Node_TypeParameterList(node), Node_ParameterList(node), Node_Type(node), declaration.FullSignature, declaration.EqualsGreaterThanToken, Node_Body(node));
        }
        case KindClassExpression:
            return NodeFactory_UpdateClassExpression(factory, AsClassExpression(node), modifierArray, Node_Name(node), Node_TypeParameterList(node), AsClassExpression(node).HeritageClauses, Node_MemberList(node));
        case KindVariableStatement:
            return NodeFactory_UpdateVariableStatement(factory, AsVariableStatement(node), modifierArray, AsVariableStatement(node).DeclarationList);
        case KindFunctionDeclaration: {
            const declaration = AsFunctionDeclaration(node);
            return NodeFactory_UpdateFunctionDeclaration(factory, declaration, modifierArray, declaration.AsteriskToken, Node_Name(node), Node_TypeParameterList(node), Node_ParameterList(node), Node_Type(node), declaration.FullSignature, Node_Body(node));
        }
        case KindClassDeclaration:
            return NodeFactory_UpdateClassDeclaration(factory, AsClassDeclaration(node), modifierArray, Node_Name(node), Node_TypeParameterList(node), AsClassDeclaration(node).HeritageClauses, Node_MemberList(node));
        case KindInterfaceDeclaration:
            return NodeFactory_UpdateInterfaceDeclaration(factory, AsInterfaceDeclaration(node), modifierArray, Node_Name(node), Node_TypeParameterList(node), AsInterfaceDeclaration(node).HeritageClauses, Node_MemberList(node));
        case KindTypeAliasDeclaration:
            return NodeFactory_UpdateTypeAliasDeclaration(factory, AsTypeAliasDeclaration(node), modifierArray, Node_Name(node), Node_TypeParameterList(node), Node_Type(node));
        case KindEnumDeclaration:
            return NodeFactory_UpdateEnumDeclaration(factory, AsEnumDeclaration(node), modifierArray, Node_Name(node), Node_MemberList(node));
        case KindModuleDeclaration:
            return NodeFactory_UpdateModuleDeclaration(factory, AsModuleDeclaration(node), modifierArray, AsModuleDeclaration(node).Keyword, Node_Name(node), Node_Body(node));
        case KindImportEqualsDeclaration:
            return NodeFactory_UpdateImportEqualsDeclaration(factory, AsImportEqualsDeclaration(node), modifierArray, Node_IsTypeOnly(node), Node_Name(node), AsImportEqualsDeclaration(node).ModuleReference);
        case KindImportDeclaration:
            return NodeFactory_UpdateImportDeclaration(factory, AsImportDeclaration(node), modifierArray, Node_ImportClause(node), Node_ModuleSpecifier(node), AsImportDeclaration(node).Attributes);
        case KindExportAssignment:
            return NodeFactory_UpdateExportAssignment(factory, AsExportAssignment(node), modifierArray, AsExportAssignment(node).IsExportEquals, Node_Type(node), Node_Expression(node));
        case KindExportDeclaration:
            return NodeFactory_UpdateExportDeclaration(factory, AsExportDeclaration(node), modifierArray, Node_IsTypeOnly(node), AsExportDeclaration(node).ExportClause, Node_ModuleSpecifier(node), AsExportDeclaration(node).Attributes);
    }
 ...
 * }
 */
export function IsLateVisibilityPaintedStatement(node) {
    switch (node.Kind) {
        case KindImportDeclaration:
        case KindJSImportDeclaration:
        case KindImportEqualsDeclaration:
 ...
 * }
 */
export function IsExternalModuleAugmentation(node) {
    return (IsAmbientModule(node) && IsModuleAugmentationExternal(node));
}
/**
 ...
 * }
 */
export function GetSourceFileOfModule(module_) {
    const declaration = module_.ValueDeclaration !== undefined
 ...
 * }
 */
export function GetNonAugmentationDeclaration(symbol_) {
    return Find(symbol_.Declarations ?? [], (d) => {
        return (!IsExternalModuleAugmentation(d) && !IsGlobalScopeAugmentation(d));
    });
}
/**
 ...
 * }
 */
export function IsTypeDeclarationName(name) {
    return (name.Kind === KindIdentifier &&
        IsTypeDeclaration(name.Parent) &&
        GetNameOfDeclaration(name.Parent) === name);
}
...
export function IsRightSideOfPropertyAccess(node) {
    return (node.Parent.Kind === KindPropertyAccessExpression && Node_Name(node.Parent) === node);
}
/**
...
export function IsArgumentExpressionOfElementAccess(node) {
    return (node.Parent !== undefined && node.Parent.Kind === KindElementAccessExpression && AsElementAccessExpression(node.Parent).ArgumentExpression === node);
}
/**
 ...
 * }
 */
export function climbPastPropertyOrElementAccess(node) {
    if (IsRightSideOfPropertyAccess(node) || IsArgumentExpressionOfElementAccess(node)) {
        return node.Parent;
    }
    return node;
 ...
 * }
 */
export function selectExpressionOfCallOrNewExpressionOrDecorator(node) {
    if (IsCallExpression(node) || IsNewExpression(node) || IsDecorator(node)) {
 ...
 * }
 */
export function selectTagOfTaggedTemplateExpression(node) {
    if (IsTaggedTemplateExpression(node)) {
 ...
 * }
 */
export function selectTagNameOfJsxOpeningLikeElement(node) {
    if (IsJsxOpeningElement(node) || IsJsxSelfClosingElement(node)) {
 ...
 * }
 */
export function IsCallExpressionTarget(node, includeElementAccess, skipPastOuterExpressions) {
    return isCalleeWorker(node, IsCallExpression, selectExpressionOfCallOrNewExpressionOrDecorator, includeElementAccess, skipPastOuterExpressions);
}
/**
 ...
 * }
 */
export function IsNewExpressionTarget(node, includeElementAccess, skipPastOuterExpressions) {
    return isCalleeWorker(node, IsNewExpression, selectExpressionOfCallOrNewExpressionOrDecorator, includeElementAccess, skipPastOuterExpressions);
}
/**
 ...
 * }
 */
export function IsCallOrNewExpressionTarget(node, includeElementAccess, skipPastOuterExpressions) {
    return isCalleeWorker(node, IsCallOrNewExpression, selectExpressionOfCallOrNewExpressionOrDecorator, includeElementAccess, skipPastOuterExpressions);
}
/**
 ...
 * }
 */
export function IsTaggedTemplateTag(node, includeElementAccess, skipPastOuterExpressions) {
    return isCalleeWorker(node, IsTaggedTemplateExpression, selectTagOfTaggedTemplateExpression, includeElementAccess, skipPastOuterExpressions);
}
/**
 ...
 * }
 */
export function IsDecoratorTarget(node, includeElementAccess, skipPastOuterExpressions) {
    return isCalleeWorker(node, IsDecorator, selectExpressionOfCallOrNewExpressionOrDecorator, includeElementAccess, skipPastOuterExpressions);
}
/**
 ...
 * }
 */
export function IsJsxOpeningLikeElementTagName(node, includeElementAccess, skipPastOuterExpressions) {
    return isCalleeWorker(node, IsJsxOpeningLikeElement, selectTagNameOfJsxOpeningLikeElement, includeElementAccess, skipPastOuterExpressions);
}
/**
 ...
 * }
 */
export function isCalleeWorker(node, pred, calleeSelector, includeElementAccess, skipPastOuterExpressions) {
    const target0 = includeElementAccess
        ? climbPastPropertyOrElementAccess(node)
        : ClimbPastPropertyAccess(node);
    // Only skip outer expressions if the target is actually an expression node
    const target = skipPastOuterExpressions && IsExpression(target0)
        ? SkipOuterExpressions(target0, OEKAll)
        : target0;
    return (target !== undefined && target.Parent !== undefined && pred(target.Parent) && calleeSelector(target.Parent) === target);
}
/**
 ...
 * }
 */
export function IsRightSideOfQualifiedNameOrPropertyAccess(node) {
    const parent = node.Parent;
    switch (parent.Kind) {
        case KindQualifiedName:
            return (AsQualifiedName(parent).Right === node);
 ...
 * }
 */
export function ShouldTransformImportCall(fileName, options, impliedNodeFormatForEmit) {
    ...
    return (impliedNodeFormatForEmit < ModuleKindES2015);
}
/**
 ...
 * }
 */
export function HasQuestionToken(node) {
 ...
 * }
 */
export function GetInvokedExpression(node) {
    switch (node.Kind) {
        case KindTaggedTemplateExpression:
            return AsTaggedTemplateExpression(node).Tag;
        case KindJsxOpeningElement:
 ...
 * }
 */
export function IndexOfNode(nodes, node) {
 ...
 * }
 */
export function CompareNodePositions(n1, n2) {
 ...
 * }
 */
export function IsUnterminatedLiteral(node) {
    return ((IsLiteralKind(node.Kind) && (Node_LiteralLikeData(node).TokenFlags & TokenFlagsUnterminated) !== 0) ||
        (IsTemplateLiteralKind(node.Kind) && (Node_TemplateLiteralLikeData(node).TemplateFlags & TokenFlagsUnterminated) !== 0));
}
/**
 ...
 * }
 */
export function IsInitializedProperty(member) {
    return (member.Kind === KindPropertyDeclaration &&
 ...
 * }
 */
export function NewHasFileName(fileName, path) {
    const impl = {
        fileName: fileName,
        path: path,
    };
    return {
        FileName: () => hasFileNameImpl_FileName(impl),
        Path: () => hasFileNameImpl_Path(impl),
    };
}
/**
 ...
 * }
 */
export function hasFileNameImpl_FileName(receiver) {
 ...
 * }
 */
export function hasFileNameImpl_Path(receiver) {
 ...
 * }
 */
export function GetSemanticJsxChildren(children) {
    return Filter(children, (i) => {
        switch (i.Kind) {
            case KindJsxExpression:
                return (Node_Expression(i) !== undefined);
            case KindJsxText:
                return !AsJsxText(i).ContainsOnlyTriviaWhiteSpaces;
            default:
                return true;
        }
    });
 ...
 * }
 */
export function hasComment(kind) {
    switch (kind) {
        case KindJSDoc:
    ...
    switch (bindingElement.Kind) {
        case KindBindingElement:
            if (Node_PropertyName(bindingElement) !== undefined) {
                const propertyName = Node_PropertyName(bindingElement);
        ...
        case KindPropertyAssignment:
            if (Node_Name(bindingElement) !== undefined) {
                const propertyName = Node_Name(bindingElement);
                if (IsComputedPropertyName(propertyName) && IsStringOrNumericLiteralLike(Node_Expression(propertyName))) {
                    return Node_Expression(propertyName);
                }
                return propertyName;
 ...
 * }
 */
export function IsEmptyObjectLiteral(expression) {
    return (IsObjectLiteralExpression(expression) && (Node_Properties(expression)?.length ?? 0) === 0);
}
/**
 ...
 * }
 */
export function IsEmptyArrayLiteral(expression) {
    return (IsArrayLiteralExpression(expression) && (Node_Elements(expression)?.length ?? 0) === 0);
}
/**
 ...
 * }
 */
export function IsJSDocNameReferenceContext(node) {
    return ((node.Flags & NodeFlagsJSDoc) !== 0 && FindAncestor(node, (n) => {
 ...
 * }
 */
export function GetJSDocRoot(node) {
 ...
 * }
 */
export function GetNextJSDocCommentLocation(node) {
    const parent = node.Parent;
    if (parent !== undefined) {
        switch (parent.Kind) {
            case KindPropertyAssignment:
 ...
 * }
 */
export function IsImportOrImportEqualsDeclaration(node) {
    return (IsImportDeclaration(node) || IsImportEqualsDeclaration(node));
}
/**
 ...
 * }
 */
export function IsPrimitiveLiteralValue(node, includeBigInt) {
    switch (node.Kind) {
        case KindTrueKeyword:
        case KindFalseKeyword:
        case KindNumericLiteral:
        ...
        case KindPrefixUnaryExpression:
            if (AsPrefixUnaryExpression(node).Operator === KindMinusToken) {
                return (IsNumericLiteral(AsPrefixUnaryExpression(node).Operand) || (includeBigInt && IsBigIntLiteral(AsPrefixUnaryExpression(node).Operand)));
            }
 ...
 * }
 */
export function HasInferredType(node) {
    // Debug.type<HasInferredType>(node); // !!!
    switch (node.Kind) {
        case KindParameter:
        case KindPropertySignature:
 ...
 * }
 */
export function IsNonContextualKeyword(token) {
    return (IsKeyword(token) && !IsContextualKeyword(token));
}
/**
 ...
 * }
 */
export function IsExpandoInitializer(declaration, initializer) {
    ...
    if (IsInJSFile(initializer)) {
        return (IsClassExpression(initializer) || (IsObjectLiteralExpression(initializer) && (Node_Properties(initializer)?.length ?? 0) === 0 && Node_Type(declaration) === undefined));
    }
    return false;
}
/**
 ...
 * }
 */
export function ImportFromModuleSpecifier(node) {
    const result = TryGetImportFromModuleSpecifier(node);
    if (result !== undefined) {
        return result;
    }
    FailBadSyntaxKind({ KindString: () => Node_KindString(node.Parent) });
    return undefined;
}
/**
 ...
 * }
 */
export function TryGetImportFromModuleSpecifier(node) {
    switch (node.Parent.Kind) {
        case KindImportDeclaration:
        case KindJSImportDeclaration:
        case KindExportDeclaration:
 ...
 * }
 */
export function IsImplicitlyExportedJSDocDeclaration(node) {
 ...
 * }
 */
export function HasContextSensitiveParameters(node) {
    // Functions with type parameters are not context sensitive.
    if (Node_TypeParameters(node) === undefined) {
        // Functions with any parameters that lack type annotations are context sensitive.
        if (Some(Node_Parameters(node), (p) => {
            return (Node_Type(p) === undefined);
        })) {
            return true;
        }
        if (!IsArrowFunction(node)) {
            // If the first parameter is not an explicit 'this' parameter, then the function has
            // an implicit 'this' parameter which is subject to contextual typing.
            const parameter = FirstOrNil(Node_Parameters(node));
 ...
 * }
 */
export function IsInfinityOrNaNString(name) {
    return (name === "Infinity" || name === "-Infinity" || name === "NaN");
}
/**
 ...
 * }
 */
export function GetFirstConstructorWithBody(node) {
    for (const member of Node_Members(node) ?? []) {
        if (IsConstructorDeclaration(member) && NodeIsPresent(Node_Body(member))) {
            return member;
        }
 ...
 * }
 */
export function IsPotentiallyExecutableNode(node) {
    if (KindFirstStatement <= node.Kind && node.Kind <= KindLastStatement) {
        if (IsVariableStatement(node)) {
            ...
            return Some(declarations, (d) => {
                return (Node_Initializer(d) !== undefined);
            });
        }
        return true;
    }
 ...
 * }
 */
export function HasAbstractModifier(node) {
    return HasSyntacticModifier(node, ModifierFlagsAbstract);
}
/**
 ...
 * }
 */
export function HasAmbientModifier(node) {
    return HasSyntacticModifier(node, ModifierFlagsAmbient);
}
/**
 ...
 * }
 */
export function NodeCanBeDecorated(useLegacyDecorators, node, parent, grandparent) {
    // private names cannot be used with decorators yet
    ...
    switch (node.Kind) {
        ...
        case KindParameter:
            ...
            return (parent !== undefined && Node_Body(parent) !== undefined &&
                (parent.Kind === KindConstructor || parent.Kind === KindMethodDeclaration || parent.Kind === KindSetAccessor) &&
                GetThisParameter(parent) !== node && grandparent !== undefined && grandparent.Kind === KindClassDeclaration);
    }
    return false;
}
/**
 ...
 * }
 */
export function ClassOrConstructorParameterIsDecorated(useLegacyDecorators, node) {
    if (NodeIsDecorated(useLegacyDecorators, node, undefined, undefined)) {
        return true;
    }
    const constructor = GetFirstConstructorWithBody(node);
    return (constructor !== undefined && ChildIsDecorated(useLegacyDecorators, constructor, node));
}
/**
 ...
 * }
 */
export function ClassElementOrClassElementParameterIsDecorated(useLegacyDecorators, node, parent) {
    const paramsResult = (() => {
        if (IsAccessor(node)) {
            const decls = GetAllAccessorDeclarations(Node_Members(parent) ?? [], node);
            const firstAccessorWithDecorators = HasDecorators(decls.FirstAccessor) ? decls.FirstAccessor
        ...
        if (IsMethodDeclaration(node))
            return [false, Node_ParameterList(node)];
 ...
 * }
 */
export function NodeIsDecorated(useLegacyDecorators, node, parent, grandparent) {
    return (HasDecorators(node) && NodeCanBeDecorated(useLegacyDecorators, node, parent, grandparent));
}
/**
 ...
 * }
 */
export function NodeOrChildIsDecorated(useLegacyDecorators, node, parent, grandparent) {
    return (NodeIsDecorated(useLegacyDecorators, node, parent, grandparent) || ChildIsDecorated(useLegacyDecorators, node, parent));
}
/**
 ...
 * }
 */
export function ChildIsDecorated(useLegacyDecorators, node, parent) {
    switch (node.Kind) {
        case KindClassDeclaration:
        case KindClassExpression:
            return Some(Node_Members(node) ?? [], (m) => {
                return NodeOrChildIsDecorated(useLegacyDecorators, m, node, parent);
            });
        case KindMethodDeclaration:
        case KindSetAccessor:
        case KindConstructor:
            return Some(Node_Parameters(node), (p) => {
                return NodeIsDecorated(useLegacyDecorators, p, node, parent);
            });
        default:
            return false;
 ...
 * }
 */
export function GetAllAccessorDeclarationsForDeclaration(accessor, declarationsOfSymbol) {
    const otherKind = accessor.Kind === KindSetAccessor ? KindGetAccessor
        : accessor.Kind === KindGetAccessor ? KindSetAccessor
            : (() => { throw new globalThis.Error("Unexpected node kind " + KindString(accessor.Kind)); })();
    // otherAccessor := GetDeclarationOfKind(c.getSymbolOfDeclaration(accessor), otherKind)
    const otherAccessor = (declarationsOfSymbol ?? []).find(d => d.Kind === otherKind);
    const [firstAccessor, secondAccessor] = otherAccessor !== undefined && Node_Pos(otherAccessor) < Node_Pos(accessor)
        ? [otherAccessor, accessor]
        : [accessor, otherAccessor];
    const [setAccessor, getAccessor] = accessor.Kind === KindSetAccessor
 ...
 * }
 */
export function GetAllAccessorDeclarations(parentDeclarations, accessor) {
    if (HasDynamicName(accessor)) {
        // dynamic names can only be match up via checker symbol lookup, just return an object with just this accessor
        return GetAllAccessorDeclarationsForDeclaration(accessor, [accessor]);
    }
    const accessorName = GetPropertyNameForPropertyNameNode(Node_Name(accessor));
    const accessorStatic = IsStatic(accessor);
    const matches = parentDeclarations.filter(member => IsAccessor(member) && IsStatic(member) === accessorStatic &&
...
export function IsAsyncFunction(node) {
    switch (node.Kind) {
        ...
        case KindMethodDeclaration: {
            ...
            return (data.Body !== undefined && data.AsteriskToken === undefined && HasSyntacticModifier(node, ModifierFlagsAsync));
        }
    }
    return false;
}
 ...
 * }
 */
export function GetRestParameterElementType(node) {
    if (node === undefined) {
        return node;
    }
    if (node.Kind === KindArrayType) {
...
export function IsTagName(node) {
    return (node.Parent !== undefined && IsJSDocTag(node.Parent) && Node_TagName(node.Parent) === node);
}
/**
 ...
 * }
 */
export function literalIsName(node) {
    return (IsDeclarationName(node) ||
        node.Parent.Kind === KindExternalModuleReference ||
        isArgumentOfElementAccessExpression(node) ||
        IsLiteralComputedPropertyDeclarationName(node));
 ...
 * }
 */
export function isArgumentOfElementAccessExpression(node) {
    return (node !== undefined && node.Parent !== undefined &&
        node.Parent.Kind === KindElementAccessExpression &&
        AsElementAccessExpression(node.Parent).ArgumentExpression === node);
}
/**
 ...
 * }
 */
export function GetReparsedNodeForNode(node) {
    if (node !== undefined && (node.Flags & NodeFlagsJSDoc) !== 0 && (node.Flags & NodeFlagsReparsed) === 0) {
        ...
        if (file !== undefined && file.ReparsedClones.length !== 0) {
            ...
            const pos = (!found && rawPos > 0) ? (rawPos - 1) : rawPos;
            const candidate = file.ReparsedClones[pos];
            if (TextRange_ContainedBy(node.Loc, candidate.Loc)) {
                const reparsed = findCloneInNode(candidate, node);
...
export function findCloneInNode(node, original) {
    ...
    while (true) {
        ...
        const container = { next: undefined };
        const foundContainingChild = Node_ForEachChild(current, (n) => {
 ...
 * }
 */
export function IsExpandoPropertyDeclaration(node) {
...
export function IsSuperProperty(node) {
    return ((IsPropertyAccessExpression(node) || IsElementAccessExpression(node)) &&
        Node_Expression(node).Kind === KindSuperKeyword);
}
/**
 ...
 * }
 */
export function IsNamedEvaluationSource(node) {
    switch (node.Kind) {
        case KindPropertyAssignment:
            return !IsProtoSetter(Node_Name(node));
        case KindShorthandPropertyAssignment:
        ...
        case KindParameter:
            return (IsIdentifier(Node_Name(node)) && Node_Initializer(node) !== undefined && AsParameterDeclaration(node).DotDotDotToken === undefined);
        case KindBindingElement:
            return (IsIdentifier(Node_Name(node)) && Node_Initializer(node) !== undefined && AsBindingElement(node).DotDotDotToken === undefined);
        case KindPropertyDeclaration:
            return (Node_Initializer(node) !== undefined);
        case KindBinaryExpression:
            switch (AsBinaryExpression(node).OperatorToken.Kind) {
                ...
                case KindQuestionQuestionEqualsToken:
                    return IsIdentifier(AsBinaryExpression(node).Left);
            }
            break;
        case KindExportAssignment:
            return true;
 ...
 * }
 */
export function IsProtoSetter(node) {
    return ((IsIdentifier(node) || IsStringLiteral(node)) && Node_Text(node) === "__proto__");
}
