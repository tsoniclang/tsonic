...
import { CompilerOptions_GetAllowImportingTsExtensions, CompilerOptions_GetModuleResolutionKind, ModuleResolutionKindNode16, ModuleResolutionKindNodeNext, ResolutionModeCommonJS, ResolutionModeESM, ResolutionModeNone, } from "../core/compileroptions.js";
...
import { ImportModuleSpecifierEndingPreferenceIndex, ImportModuleSpecifierEndingPreferenceJs, ImportModuleSpecifierEndingPreferenceMinimal, ImportModuleSpecifierPreferenceNonRelative, ImportModuleSpecifierPreferenceProjectRelative, ImportModuleSpecifierPreferenceRelative, ModuleSpecifierEndingIndex, ModuleSpecifierEndingJsExtension, ModuleSpecifierEndingMinimal, ModuleSpecifierEndingTsExtension, RelativePreferenceExternalNonRelative, RelativePreferenceNonRelative, RelativePreferenceRelative, RelativePreferenceShortest, } from "./types.js";
/**
 ...
 * }
 */
export function usesExtensionsOnImports(file) {
 ...
 * }
 */
export function inferPreference(resolutionMode, sourceFile, moduleResolutionIsNodeNext) {
 ...
 * }
 */
export function getModuleSpecifierEndingPreference(pref, resolutionMode, compilerOptions, sourceFile) {
 ...
 * }
 */
export function getPreferredEnding(prefs, host, compilerOptions, importingSourceFile, oldImportSpecifier, resolutionMode) {
 ...
 * }
 */
export function GetAllowedEndingsInPreferredOrder(prefs, host, compilerOptions, importingSourceFile, oldImportSpecifier, syntaxImpliedNodeFormat) {
 ...
 * }
 */
export function getModuleSpecifierPreferences(prefs, host, compilerOptions, importingSourceFile, oldImportSpecifier) {
    const excludes = prefs.AutoImportSpecifierExcludeRegexes;
    let relativePreference = RelativePreferenceShortest;
    if (oldImportSpecifier.length > 0) {
    ...
    const getAllowedEndingsInPreferredOrderFn = (syntaxImpliedNodeFormat) => {
