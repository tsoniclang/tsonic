 ...
 * }
 */
export declare function GetModuleSpecifiersForFileWithInfo(importingSourceFile: SourceFileForSpecifierGeneration, moduleFileName: string, compilerOptions: GoPtr<CompilerOptions>, host: ModuleSpecifierGenerationHost, userPreferences: UserPreferences, options: ModuleSpecifierOptions, forAutoImports: bool): [GoSlice<string>, ResultKind];
/**
 ...
 * }
 */
export declare function tryGetModuleNameFromAmbientModule(moduleSymbol: GoPtr<Symbol>, checker: CheckerShape): string;
/**
 ...
 * }
 */
export declare function getInfo(importingSourceFileName: string, host: ModuleSpecifierGenerationHost): Info;
/**
 ...
 * }
 */
export declare function getAllModulePaths(info: Info, importedFileName: string, host: ModuleSpecifierGenerationHost, compilerOptions: GoPtr<CompilerOptions>, preferences: UserPreferences, options: ModuleSpecifierOptions): GoSlice<ModulePath>;
/**
 ...
 * }
 */
export declare function getAllModulePathsWorker(info: Info, importedFileName: string, host: ModuleSpecifierGenerationHost, compilerOptions: GoPtr<CompilerOptions>, options: ModuleSpecifierOptions): GoSlice<ModulePath>;
/**
 ...
 * }
 */
export declare function containsIgnoredPath(s: string): bool;
/**
 ...
 * }
 */
export declare function ContainsNodeModules(s: string): bool;
/**
 ...
 * }
 */
export declare function GetEachFileNameOfModule(importingFileName: string, importedFileName: string, host: ModuleSpecifierGenerationHost, preferSymlinks: bool): GoSlice<ModulePath>;
/**
 ...
 * }
 */
export declare function computeModuleSpecifiers(modulePaths: GoSlice<ModulePath>, compilerOptions: GoPtr<CompilerOptions>, importingSourceFile: SourceFileForSpecifierGeneration, host: ModuleSpecifierGenerationHost, userPreferences: UserPreferences, options: ModuleSpecifierOptions, forAutoImport: bool): [GoSlice<string>, ResultKind];
/**
 ...
 * }
 */
export declare function getLocalModuleSpecifier(moduleFileName: string, info: Info, compilerOptions: GoPtr<CompilerOptions>, host: ModuleSpecifierGenerationHost, importMode: ResolutionMode, preferences: ModuleSpecifierPreferences, pathsOnly: bool): string;
/**
 ...
 * }
 */
export declare function processEnding(fileName: string, allowedEndings: GoSlice<ModuleSpecifierEnding>, options: GoPtr<CompilerOptions>, host: ModuleSpecifierGenerationHost): string;
/**
 ...
 * }
 */
export declare function tryGetModuleNameFromRootDirs(rootDirs: GoSlice<string>, moduleFileName: string, sourceDirectory: string, allowedEndings: GoSlice<ModuleSpecifierEnding>, compilerOptions: GoPtr<CompilerOptions>, host: ModuleSpecifierGenerationHost): string;
/**
 ...
 * }
 */
export declare function tryGetModuleNameAsNodeModule(pathObj: ModulePath, info: Info, importingSourceFile: SourceFileForSpecifierGeneration, host: ModuleSpecifierGenerationHost, options: GoPtr<CompilerOptions>, userPreferences: UserPreferences, packageNameOnly: bool, overrideMode: ResolutionMode): string;
/**
 ...
 * }
 */
export declare function tryGetModuleNameFromExports(options: GoPtr<CompilerOptions>, host: ModuleSpecifierGenerationHost, targetFilePath: string, packageDirectory: string, packageName: string, exports: ExportsOrImports, conditions: GoSlice<string>): string;
/**
 ...
 * }
 */
export declare function tryGetModuleNameFromPackageJsonImports(moduleFileName: string, sourceDirectory: string, options: GoPtr<CompilerOptions>, host: ModuleSpecifierGenerationHost, importMode: ResolutionMode, preferTsExtension: bool): string;
/**
 ...
 * }
 */
export declare function tryGetModuleNameFromPaths(relativeToBaseUrl: string, paths: GoPtr<OrderedMap<string, GoSlice<string>>>, allowedEndings: GoSlice<ModuleSpecifierEnding>, baseDirectory: string, host: ModuleSpecifierGenerationHost, compilerOptions: GoPtr<CompilerOptions>): string;
/**
 ...
 * }
 */
export declare function validateEnding(c: specPair, relativeToBaseUrl: string, compilerOptions: GoPtr<CompilerOptions>, host: ModuleSpecifierGenerationHost): bool;
/**
 ...
 * }
 */
export declare function tryGetModuleNameFromExportsOrImports(options: GoPtr<CompilerOptions>, host: ModuleSpecifierGenerationHost, targetFilePath: string, packageDirectory: string, packageName: string, exports: ExportsOrImports, conditions: GoSlice<string>, mode: MatchingMode, isImports: bool, preferTsExtension: bool): string;
/**
 ...
 * }
 */
export declare function GetModuleSpecifier(compilerOptions: GoPtr<CompilerOptions>, host: ModuleSpecifierGenerationHost, importingSourceFile: GoPtr<SourceFile>, importingSourceFileName: string, oldImportSpecifier: string, toFileName: string, options: ModuleSpecifierOptions): string;
/**
 ...
 * }
 */
export declare function UpdateModuleSpecifier(compilerOptions: GoPtr<CompilerOptions>, host: ModuleSpecifierGenerationHost, importingSourceFile: GoPtr<SourceFile>, importingSourceFileName: string, oldImportSpecifier: string, toFileName: string, userPreferences: UserPreferences, options: ModuleSpecifierOptions): string;
/**
 ...
 * }
 */
export declare function getModuleSpecifierWithPreferences(compilerOptions: GoPtr<CompilerOptions>, host: ModuleSpecifierGenerationHost, importingSourceFile: GoPtr<SourceFile>, importingSourceFileName: string, oldImportSpecifier: string, toFileName: string, userPreferences: UserPreferences, options: ModuleSpecifierOptions): string;
