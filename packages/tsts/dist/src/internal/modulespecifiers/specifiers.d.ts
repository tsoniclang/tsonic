 ...
 * }
 */
export declare function tryGetModuleNameFromPaths(relativeToBaseUrl: string, paths: GoPtr<OrderedMap>, allowedEndings: GoSlice<ModuleSpecifierEnding>, baseDirectory: string, host: ModuleSpecifierGenerationHost, compilerOptions: GoPtr<CompilerOptions>): string;
/**
