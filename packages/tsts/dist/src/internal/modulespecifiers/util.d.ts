 ...
 * )
 */
export declare const regexPatternCacheMu: RWMutex;
export declare const regexPatternCache: GoMap<regexPatternCacheKey, GoPtr<Regexp>>;
/**
 ...
 * }
 */
export declare function comparePathsByRedirect(a: ModulePath, b: ModulePath, useCaseSensitiveFileNames: bool): int;
/**
 ...
 * }
 */
export declare function PathIsBareSpecifier(path: string): bool;
/**
 ...
 * }
 */
export declare function IsExcludedByRegex(moduleSpecifier: string, excludes: GoSlice<string>): bool;
export declare function stringToRegex(pattern: string): GoPtr<Regexp>;
/**
 ...
 * }
 */
export declare function GetJSExtensionForDeclarationFileExtension(ext: string): string;
/**
 ...
 * }
 */
export declare function TryGetRealFileNameForNonJSDeclarationFileName(fileName: string): string;
/**
 ...
 * }
 */
export declare function getJSExtensionForFile(fileName: string, options: GoPtr<CompilerOptions>): string;
/**
 ...
 * }
 */
export declare function extensionFromPath(path: string): string;
/**
 ...
 * }
 */
export declare function tryGetAnyFileFromPath(host: ModuleSpecifierGenerationHost, path: string): bool;
/**
 ...
 * }
 */
export declare function getPathsRelativeToRootDirs(path: string, rootDirs: GoSlice<string>, useCaseSensitiveFileNames: bool): GoSlice<string>;
/**
 ...
 * }
 */
export declare function isPathRelativeToParent(path: string): bool;
/**
 ...
 * }
 */
export declare function getRelativePathIfInSameVolume(path: string, directoryPath: string, useCaseSensitiveFileNames: bool): string;
/**
 ...
 * }
 */
export declare function packageJsonPathsAreEqual(a: string, b: string, options: ComparePathsOptions): bool;
/**
 ...
 * }
 */
export declare function prefersTsExtension(allowedEndings: GoSlice<ModuleSpecifierEnding>): bool;
/**
 ...
 * )
 */
export declare const nodeModulesPathParseStateBeforeNodeModules: nodeModulesPathParseState;
export declare const nodeModulesPathParseStateNodeModules: nodeModulesPathParseState;
export declare const nodeModulesPathParseStateScope: nodeModulesPathParseState;
export declare const nodeModulesPathParseStatePackageContent: nodeModulesPathParseState;
/**
 ...
 * }
 */
export declare function GetNodeModulePathParts(fullPath: string): GoPtr<NodeModulePathParts>;
/**
 ...
 * }
 */
export declare function GetNodeModulesPackageName(compilerOptions: GoPtr<CompilerOptions>, importingSourceFile: GoPtr<SourceFile>, nodeModulesFileName: string, host: ModuleSpecifierGenerationHost, preferences: UserPreferences, options: ModuleSpecifierOptions): string;
/**
 ...
 * }
 */
export declare function allKeysStartWithDot(obj: GoPtr<OrderedMap<string, ExportsOrImports>>): bool;
/**
 ...
 * }
 */
export declare function GetPackageNameFromDirectory(fileOrDirectoryPath: string): string;
/**
 ...
 * }
 */
export declare function ProcessEntrypointEnding(entrypoint: GoPtr<ResolvedEntrypoint>, prefs: UserPreferences, host: ModuleSpecifierGenerationHost, options: GoPtr<CompilerOptions>, importingSourceFile: SourceFileForSpecifierGeneration, allowedEndings: GoSlice<ModuleSpecifierEnding>): string;
