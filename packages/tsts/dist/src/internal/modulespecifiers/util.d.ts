 ...
 * }
 */
export declare function GetNodeModulesPackageName(compilerOptions: GoPtr<CompilerOptions>, importingSourceFile: SourceFileForSpecifierGeneration, nodeModulesFileName: string, host: ModuleSpecifierGenerationHost, preferences: UserPreferences, options: ModuleSpecifierOptions): string;
/**
 ...
 * }
 */
export declare function allKeysStartWithDot(obj: GoPtr<OrderedMap>): bool;
/**
