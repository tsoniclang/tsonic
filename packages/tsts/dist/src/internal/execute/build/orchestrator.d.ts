 ...
 * }
 */
export declare function Orchestrator_createBuildTasks(receiver: GoPtr<Orchestrator>, oldTasks: GoPtr<SyncMap<Path, GoPtr<BuildTask>>>, configs: GoSlice<string>, wg: WorkGroup): void;
/**
 ...
 * }
 */
export declare function Orchestrator_setupBuildTask(receiver: GoPtr<Orchestrator>, configName: string, downStream: GoPtr<BuildTask>, inCircularContext: bool, completed: GoPtr<Set<Path>>, analyzing: GoPtr<Set<Path>>, circularityStack: GoSlice<string>): GoPtr<BuildTask>;
/**
 ...
 * }
 */
export declare function Orchestrator_GenerateGraph(receiver: GoPtr<Orchestrator>, oldTasks: GoPtr<SyncMap<Path, GoPtr<BuildTask>>>): void;
/**
 ...
 * }
 */
export declare function Orchestrator_Start(receiver: GoPtr<Orchestrator>, ctx: Context): CommandLineResult;
/**
 ...
 * }
 */
export declare function Orchestrator_Watch(receiver: GoPtr<Orchestrator>, ctx: Context): void;
/**
