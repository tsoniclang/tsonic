 ...
 * }
 */
export declare function parseCache_loadOrStore<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<parseCache<K, V>>, key: K, parse: (arg0: K) => V, allowZero: bool): V;
/**
 ...
 * }
 */
export declare function parseCache_store<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<parseCache<K, V>>, key: K, value: V): void;
/**
 ...
 * }
 */
export declare function parseCache_delete<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<parseCache<K, V>>, key: K): void;
/**
 ...
 * }
 */
export declare function parseCache_reset<K extends GoComparable, V extends GoComparable>(receiver: GoPtr<parseCache<K, V>>): void;
//# sourceMappingURL=parseCache.d.ts.map