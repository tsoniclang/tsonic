 ...
 * }
 */
export declare function parseCache_loadOrStore<K, V>(receiver: GoPtr<parseCache<K, V>>, key: K, parse: (arg0: K) => V, allowZero: bool): V;
/**
 ...
 * }
 */
export declare function parseCache_store<K, V>(receiver: GoPtr<parseCache<K, V>>, key: K, value: V): void;
/**
 ...
 * }
 */
export declare function parseCache_delete<K, V>(receiver: GoPtr<parseCache<K, V>>, key: K): void;
/**
 ...
 * }
 */
export declare function parseCache_reset<K, V>(receiver: GoPtr<parseCache<K, V>>): void;
