 ...
 * )
 */
export declare const upToDateStatusTypeConfigFileNotFound: upToDateStatusType;
export declare const upToDateStatusTypeBuildErrors: upToDateStatusType;
export declare const upToDateStatusTypeUpstreamErrors: upToDateStatusType;
export declare const upToDateStatusTypeUpToDate: upToDateStatusType;
export declare const upToDateStatusTypeUpToDateWithUpstreamTypes: upToDateStatusType;
export declare const upToDateStatusTypeUpToDateWithInputFileText: upToDateStatusType;
export declare const upToDateStatusTypeInputFileMissing: upToDateStatusType;
export declare const upToDateStatusTypeOutputMissing: upToDateStatusType;
export declare const upToDateStatusTypeInputFileNewer: upToDateStatusType;
export declare const upToDateStatusTypeOutOfDateBuildInfoWithPendingEmit: upToDateStatusType;
export declare const upToDateStatusTypeOutOfDateBuildInfoWithErrors: upToDateStatusType;
export declare const upToDateStatusTypeOutOfDateOptions: upToDateStatusType;
export declare const upToDateStatusTypeOutOfDateRoots: upToDateStatusType;
export declare const upToDateStatusTypeTsVersionOutputOfDate: upToDateStatusType;
export declare const upToDateStatusTypeForceBuild: upToDateStatusType;
export declare const upToDateStatusTypeSolution: upToDateStatusType;
/**
 ...
 * }
 */
export declare function upToDateStatus_isError(receiver: GoPtr<upToDateStatus>): bool;
/**
 ...
 * }
 */
export declare function upToDateStatus_isPseudoBuild(receiver: GoPtr<upToDateStatus>): bool;
/**
 ...
 * }
 */
export declare function upToDateStatus_inputOutputFileAndTime(receiver: GoPtr<upToDateStatus>): GoPtr<inputOutputFileAndTime>;
/**
 ...
 * }
 */
export declare function upToDateStatus_inputOutputName(receiver: GoPtr<upToDateStatus>): GoPtr<inputOutputName>;
/**
 ...
 * }
 */
export declare function upToDateStatus_oldestOutputFileName(receiver: GoPtr<upToDateStatus>): string;
/**
 ...
 * }
 */
export declare function upToDateStatus_upstreamErrors(receiver: GoPtr<upToDateStatus>): GoPtr<upstreamErrors>;
//# sourceMappingURL=uptodatestatus.d.ts.map