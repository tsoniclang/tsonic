 ...
 * }
 */
export declare function WriteConfigFile(sys: System, locale: Locale, reportDiagnostic: DiagnosticReporter, options: GoPtr<OrderedMap<string, unknown>>): void;
/**
 ...
 * }
 */
export declare function generateTSConfig(options: GoPtr<OrderedMap<string, unknown>>, locale: Locale): string;
