...
import type { FormattingOptions } from "../../diagnosticwriter/diagnosticwriter.js";
 ...
 * }
 */
export declare function getFormatOptsOfSys(sys: System, locale: Locale): GoPtr<FormattingOptions>;
/**
 ...
 */
export declare function QuietDiagnosticReporter(_diagnostic: GoPtr<Diagnostic>): void;
/**
 ...
 * }
 */
export declare function CreateDiagnosticReporter(sys: System, w: Writer, locale: Locale, options: GoPtr<CompilerOptions>): DiagnosticReporter;
/**
 ...
 * }
 */
export declare function defaultIsPretty(sys: System): bool;
/**
 ...
 * }
 */
export declare function shouldBePretty(sys: System, options: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function createColors(sys: System): GoPtr<colors>;
/**
 ...
 * }
 */
export declare function colors_bold(receiver: GoPtr<colors>, str: string): string;
/**
 ...
 * }
 */
export declare function colors_blue(receiver: GoPtr<colors>, str: string): string;
/**
 ...
 * }
 */
export declare function colors_blueBackground(receiver: GoPtr<colors>, str: string): string;
/**
 ...
 * }
 */
export declare function colors_brightWhite(receiver: GoPtr<colors>, str: string): string;
/**
 ...
 */
export declare function QuietDiagnosticsReporter(_diagnostics: GoSlice<GoPtr<Diagnostic>>): void;
/**
 ...
 * }
 */
export declare function CreateReportErrorSummary(sys: System, locale: Locale, options: GoPtr<CompilerOptions>): DiagnosticsReporter;
/**
 ...
 * }
 */
export declare function CreateBuilderStatusReporter(sys: System, w: Writer, locale: Locale, options: GoPtr<CompilerOptions>, testing: CommandLineTesting | undefined): DiagnosticReporter;
/**
 ...
 * }
 */
export declare function CreateWatchStatusReporter(sys: System, locale: Locale, options: GoPtr<CompilerOptions>, testing: CommandLineTesting | undefined): DiagnosticReporter;
