 ...
 * }
 */
export declare function GetTraceWithWriterFromSys(w: Writer, locale: Locale, testing: CommandLineTesting | undefined): (msg: GoPtr<Message>, ...args: Array<unknown>) => void;
/**
 ...
 * }
 */
export declare function EmitAndReportStatistics(input: EmitInput): [CompileAndEmitResult, GoPtr<Statistics>];
/**
 ...
 * }
 */
export declare function EmitFilesAndReportErrors(input: EmitInput): CompileAndEmitResult;
/**
 ...
 * }
 */
export declare function listFiles(input: EmitInput, emitResult: GoPtr<EmitResult>): void;
