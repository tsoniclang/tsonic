 ...
 * )
 */
export declare const ExitStatusSuccess: ExitStatus;
export declare const ExitStatusDiagnosticsPresent_OutputsSkipped: ExitStatus;
export declare const ExitStatusDiagnosticsPresent_OutputsGenerated: ExitStatus;
export declare const ExitStatusInvalidProject_OutputsSkipped: ExitStatus;
export declare const ExitStatusProjectReferenceCycle_OutputsSkipped: ExitStatus;
export declare const ExitStatusNotImplemented: ExitStatus;
/**
