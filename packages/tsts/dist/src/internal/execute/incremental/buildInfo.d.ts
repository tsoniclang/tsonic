 ...
 * }
 */
export declare function BuildInfoEmitSignature_toEmitSignature(receiver: GoPtr<BuildInfoEmitSignature>, path: Path, emitSignatures: GoPtr<SyncMap>): GoPtr<emitSignature>;
/**
