...
import type { GoError, GoMap, GoPtr, GoSeq, GoSlice } from "../../../go/compat.js";
 ...
 * }
 */
export declare function BuildInfoRoot_MarshalJSON(receiver: GoPtr<BuildInfoRoot>): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function BuildInfoRoot_UnmarshalJSON(receiver: GoPtr<BuildInfoRoot>, data: GoSlice<byte>): GoError;
/**
 ...
 * }
 */
export declare function newBuildInfoFileInfo(fileInfo: GoPtr<FileInfo>): GoPtr<BuildInfoFileInfo>;
/**
 ...
 * }
 */
export declare function BuildInfoFileInfo_GetFileInfo(receiver: GoPtr<BuildInfoFileInfo>): GoPtr<FileInfo>;
/**
 ...
 * }
 */
export declare function BuildInfoFileInfo_HasSignature(receiver: GoPtr<BuildInfoFileInfo>): bool;
/**
 ...
 * }
 */
export declare function BuildInfoFileInfo_MarshalJSON(receiver: GoPtr<BuildInfoFileInfo>): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function BuildInfoFileInfo_UnmarshalJSON(receiver: GoPtr<BuildInfoFileInfo>, data: GoSlice<byte>): GoError;
/**
 ...
 * }
 */
export declare function BuildInfoReferenceMapEntry_MarshalJSON(receiver: GoPtr<BuildInfoReferenceMapEntry>): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function BuildInfoReferenceMapEntry_UnmarshalJSON(receiver: GoPtr<BuildInfoReferenceMapEntry>, data: GoSlice<byte>): GoError;
/**
 ...
 * }
 */
export declare function BuildInfoDiagnosticsOfFile_MarshalJSON(receiver: GoPtr<BuildInfoDiagnosticsOfFile>): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function BuildInfoDiagnosticsOfFile_UnmarshalJSON(receiver: GoPtr<BuildInfoDiagnosticsOfFile>, data: GoSlice<byte>): GoError;
/**
 ...
 * }
 */
export declare function BuildInfoSemanticDiagnostic_MarshalJSON(receiver: GoPtr<BuildInfoSemanticDiagnostic>): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function BuildInfoSemanticDiagnostic_UnmarshalJSON(receiver: GoPtr<BuildInfoSemanticDiagnostic>, data: GoSlice<byte>): GoError;
/**
 ...
 * }
 */
export declare function BuildInfoFilePendingEmit_MarshalJSON(receiver: GoPtr<BuildInfoFilePendingEmit>): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function BuildInfoFilePendingEmit_UnmarshalJSON(receiver: GoPtr<BuildInfoFilePendingEmit>, data: GoSlice<byte>): GoError;
/**
 ...
 * }
 */
export declare function BuildInfoEmitSignature_noEmitSignature(receiver: GoPtr<BuildInfoEmitSignature>): bool;
/**
 ...
 * }
 */
export declare function BuildInfoEmitSignature_toEmitSignature(receiver: GoPtr<BuildInfoEmitSignature>, path: Path, emitSignatures: GoPtr<SyncMap<Path, GoPtr<emitSignature>>>): GoPtr<emitSignature>;
/**
 ...
 * }
 */
export declare function BuildInfoEmitSignature_MarshalJSON(receiver: GoPtr<BuildInfoEmitSignature>): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function BuildInfoEmitSignature_UnmarshalJSON(receiver: GoPtr<BuildInfoEmitSignature>, data: GoSlice<byte>): GoError;
/**
 ...
 * }
 */
export declare function BuildInfoResolvedRoot_MarshalJSON(receiver: GoPtr<BuildInfoResolvedRoot>): [GoSlice<byte>, GoError];
/**
 ...
 * }
 */
export declare function BuildInfoResolvedRoot_UnmarshalJSON(receiver: GoPtr<BuildInfoResolvedRoot>, data: GoSlice<byte>): GoError;
/**
 ...
 * }
 */
export declare function BuildInfo_IsValidVersion(receiver: GoPtr<BuildInfo>): bool;
/**
 ...
 * }
 */
export declare function BuildInfo_IsIncremental(receiver: GoPtr<BuildInfo>): bool;
/**
 ...
 * }
 */
export declare function BuildInfo_fileName(receiver: GoPtr<BuildInfo>, fileId: BuildInfoFileId): string;
/**
 ...
 * }
 */
export declare function BuildInfo_fileInfo(receiver: GoPtr<BuildInfo>, fileId: BuildInfoFileId): GoPtr<BuildInfoFileInfo>;
/**
 ...
 * }
 */
export declare function BuildInfo_GetCompilerOptions(receiver: GoPtr<BuildInfo>, buildInfoDirectory: string): GoPtr<CompilerOptions>;
/**
 ...
 * }
 */
export declare function BuildInfo_IsEmitPending(receiver: GoPtr<BuildInfo>, resolved: GoPtr<ParsedCommandLine>, buildInfoDirectory: string): bool;
/**
 ...
 * }
 */
export declare function BuildInfo_GetBuildInfoRootInfoReader(receiver: GoPtr<BuildInfo>, buildInfoDirectory: string, comparePathOptions: ComparePathsOptions): GoPtr<BuildInfoRootInfoReader>;
/**
 ...
 * }
 */
export declare function BuildInfoRootInfoReader_GetBuildInfoFileInfo(receiver: GoPtr<BuildInfoRootInfoReader>, inputFilePath: Path): [GoPtr<BuildInfoFileInfo>, Path];
/**
 ...
 * }
 */
export declare function BuildInfoRootInfoReader_Roots(receiver: GoPtr<BuildInfoRootInfoReader>): GoSeq<Path>;
