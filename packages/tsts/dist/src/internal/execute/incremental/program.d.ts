...
import type { EmitOptions, EmitResult, Program as Program_22a0a6ce, ProgramLike } from "../../compiler/program.js";
 ...
 * )
 */
export declare const SignatureUpdateKindComputedDts: SignatureUpdateKind;
export declare const SignatureUpdateKindStoredAtEmit: SignatureUpdateKind;
export declare const SignatureUpdateKindUsedVersion: SignatureUpdateKind;
/**
 ...
 */
export declare let __9846d1d6_0: ProgramLike;
 ...
 * }
 */
export declare function NewProgram(program: GoPtr<Program_22a0a6ce>, oldProgram: GoPtr<Program>, host: Host, testing: bool): GoPtr<Program>;
/**
 ...
 * }
 */
export declare function Program_GetTestingData(receiver: GoPtr<Program>): GoPtr<TestingData>;
/**
 ...
 * }
 */
export declare function Program_panicIfNoProgram(receiver: GoPtr<Program>, method: string): void;
/**
 ...
 * }
 */
export declare function Program_GetProgram(receiver: GoPtr<Program>): GoPtr<Program_22a0a6ce>;
/**
 ...
 * }
 */
export declare function Program_HasChangedDtsFile(receiver: GoPtr<Program>): bool;
/**
 ...
 * }
 */
export declare function Program_Program(receiver: GoPtr<Program>): GoPtr<Program_22a0a6ce>;
/**
 ...
 * }
 */
export declare function Program_GetSourceFile(receiver: GoPtr<Program>, path: string): GoPtr<SourceFile>;
/**
 ...
 * }
 */
export declare function Program_GetSyntacticDiagnostics(receiver: GoPtr<Program>, ctx: Context, file: GoPtr<SourceFile>): GoSlice<GoPtr<Diagnostic>>;
/**
 ...
 * }
 */
export declare function Program_GetBindDiagnostics(receiver: GoPtr<Program>, ctx: Context, file: GoPtr<SourceFile>): GoSlice<GoPtr<Diagnostic>>;
/**
 ...
 * }
 */
export declare function Program_GetSemanticDiagnostics(receiver: GoPtr<Program>, ctx: Context, file: GoPtr<SourceFile>): GoSlice<GoPtr<Diagnostic>>;
/**
 ...
 * }
 */
export declare function Program_getSemanticDiagnosticsOfFile(receiver: GoPtr<Program>, file: GoPtr<SourceFile>): GoSlice<GoPtr<Diagnostic>>;
/**
 ...
 * }
 */
export declare function Program_GetDeclarationDiagnostics(receiver: GoPtr<Program>, ctx: Context, file: GoPtr<SourceFile>): GoSlice<GoPtr<Diagnostic>>;
/**
 ...
 * }
 */
export declare function Program_GetSuggestionDiagnostics(receiver: GoPtr<Program>, ctx: Context, file: GoPtr<SourceFile>): GoSlice<GoPtr<Diagnostic>>;
/**
 ...
 * }
 */
export declare function Program_collectSemanticDiagnosticsOfAffectedFiles(receiver: GoPtr<Program>, ctx: Context, file: GoPtr<SourceFile>): void;
/**
 ...
 * }
 */
export declare function Program_emitBuildInfo(receiver: GoPtr<Program>, ctx: Context, options: EmitOptions): GoPtr<EmitResult>;
/**
 ...
 * }
 */
export declare function Program_ensureHasErrorsForState(receiver: GoPtr<Program>, ctx: Context, program: GoPtr<Program_22a0a6ce>): void;
