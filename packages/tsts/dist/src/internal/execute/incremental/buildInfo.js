...
import { NewOrderedMapWithSizeHint, OrderedMap_Entries, OrderedMap_Get, OrderedMap_Keys, OrderedMap_Set, } from "../../collections/ordered_map.js";
...
import { ConvertOptionToAbsolutePath, ParseCompilerOptions, } from "../../tsoptions/parsinghelpers.js";
import { CommandLineCompilerOptionsMap } from "../../tsoptions/tsconfigparsing.js";
import { ToPath } from "../../tspath/path.js";
import { FileEmitKindDts, FileEmitKindDtsErrors, getPendingEmitKindWithOptions, } from "./snapshot.js";
 ...
 * }
 */
export function BuildInfoRoot_MarshalJSON(receiver) {
    if (receiver.Start !== 0) {
        if (receiver.End !== 0) {
 ...
 * }
 */
export function BuildInfoRoot_UnmarshalJSON(receiver, data) {
    ...
    if (globalThis.Array.isArray(parsed) && parsed.length === 2) {
        const arr = parsed;
        receiver.Start = arr[0];
        receiver.End = arr[1];
        receiver.NonIncremental = "";
        return undefined;
    }
    if (typeof parsed === "number") {
        receiver.Start = parsed;
        receiver.End = 0;
        receiver.NonIncremental = "";
        return undefined;
    }
 ...
 * }
 */
export function BuildInfoFileInfo_GetFileInfo(receiver) {
 ...
 * }
 */
export function BuildInfoFileInfo_HasSignature(receiver) {
 ...
 * }
 */
export function BuildInfoFileInfo_MarshalJSON(receiver) {
    if (receiver.signature !== "") {
 ...
 * }
 */
export function BuildInfoFileInfo_UnmarshalJSON(receiver, data) {
    const str = bytesToString(data);
    let parsed;
    try {
        parsed = globalThis.JSON.parse(str);
    ...
    if (parsed !== null && typeof parsed === "object" && parsed["noSignature"] === true) {
        const obj = parsed;
        receiver.signature = "";
        receiver.noSignature = {
            Version: obj["version"] ?? "",
            NoSignature: true,
            AffectsGlobalScope: obj["affectsGlobalScope"] ?? false,
            ImpliedNodeFormat: obj["impliedNodeFormat"] ?? 0,
        };
        receiver.fileInfo = undefined;
        return undefined;
    }
 ...
 * }
 */
export function BuildInfoReferenceMapEntry_MarshalJSON(receiver) {
 ...
 * }
 */
export function BuildInfoReferenceMapEntry_UnmarshalJSON(receiver, data) {
    const str = bytesToString(data);
    let parsed;
    try {
        parsed = globalThis.JSON.parse(str);
    ...
    const arr = parsed;
    receiver.FileId = arr[0];
    receiver.FileIdListId = arr[1];
    return undefined;
}
/**
 ...
 * }
 */
export function BuildInfoDiagnosticsOfFile_MarshalJSON(receiver) {
 ...
 * }
 */
export function BuildInfoDiagnosticsOfFile_UnmarshalJSON(receiver, data) {
    const str = bytesToString(data);
    let parsed;
    try {
        parsed = globalThis.JSON.parse(str);
 ...
 * }
 */
export function BuildInfoSemanticDiagnostic_MarshalJSON(receiver) {
 ...
 * }
 */
export function BuildInfoSemanticDiagnostic_UnmarshalJSON(receiver, data) {
    const str = bytesToString(data);
    let parsed;
    try {
        parsed = globalThis.JSON.parse(str);
 ...
 * }
 */
export function BuildInfoFilePendingEmit_MarshalJSON(receiver) {
 ...
 * }
 */
export function BuildInfoFilePendingEmit_UnmarshalJSON(receiver, data) {
    const str = bytesToString(data);
    let parsed;
    try {
        parsed = globalThis.JSON.parse(str);
 ...
 * }
 */
export function BuildInfoEmitSignature_noEmitSignature(receiver) {
 ...
 * }
 */
export function BuildInfoEmitSignature_toEmitSignature(receiver, path, emitSignatures) {
    let signature = "";
    let signatureWithDifferentOptions;
    if (receiver.DiffersOnlyInDtsMap) {
        signatureWithDifferentOptions = [];
        const [info] = SyncMap_Load(emitSignatures, path);
 ...
 * }
 */
export function BuildInfoEmitSignature_MarshalJSON(receiver) {
 ...
 * }
 */
export function BuildInfoEmitSignature_UnmarshalJSON(receiver, data) {
    const str = bytesToString(data);
    let parsed;
    try {
        parsed = globalThis.JSON.parse(str);
 ...
 * }
 */
export function BuildInfoResolvedRoot_MarshalJSON(receiver) {
 ...
 * }
 */
export function BuildInfoResolvedRoot_UnmarshalJSON(receiver, data) {
    const str = bytesToString(data);
    let parsed;
    try {
        parsed = globalThis.JSON.parse(str);
 ...
 * }
 */
export function BuildInfo_IsValidVersion(receiver) {
 ...
 * }
 */
export function BuildInfo_IsIncremental(receiver) {
 ...
 * }
 */
export function BuildInfo_fileName(receiver, fileId) {
 ...
 * }
 */
export function BuildInfo_fileInfo(receiver, fileId) {
 ...
 * }
 */
export function BuildInfo_GetCompilerOptions(receiver, buildInfoDirectory) {
    const options = {};
    const entries = OrderedMap_Entries(receiver.Options);
 ...
 * }
 */
export function BuildInfo_IsEmitPending(receiver, resolved, buildInfoDirectory) {
    ...
    if (!Tristate_IsTrue(co.NoEmit) || CompilerOptions_GetEmitDeclarations(co)) {
        ...
        if (Tristate_IsTrue(co.NoEmit)) {
            pendingEmit = (pendingEmit & FileEmitKindDtsErrors);
        }
        return pendingEmit !== 0;
    }
    return false;
 ...
 * }
 */
export function BuildInfo_GetBuildInfoRootInfoReader(receiver, buildInfoDirectory, comparePathOptions) {
    const resolvedRootFileInfos = new Map();
    const rootToResolved = NewOrderedMapWithSizeHint(receiver.FileNames?.length ?? 0);
    const resolvedToRoot = new Map();
    const toPath = (fileName) => ToPath(fileName, buildInfoDirectory, comparePathOptions.UseCaseSensitiveFileNames);
    ...
    const addRoot = (resolvedRoot, fileInfo) => {
    ...
    for (const root of receiver.Root ?? []) {
        if (root.NonIncremental !== "") {
            ...
            for (let i = root.Start; i <= root.End; i++) {
                addRoot(BuildInfo_fileName(receiver, i), BuildInfo_fileInfo(receiver, i));
            }
        }
    }
    return {
 ...
 * }
 */
export function BuildInfoRootInfoReader_GetBuildInfoFileInfo(receiver, inputFilePath) {
    const info = receiver.resolvedRootFileInfos.get(inputFilePath);
    if (info !== undefined) {
        return [info, inputFilePath];
    }
    const [resolved, ok] = OrderedMap_Get(receiver.rootToResolved, inputFilePath);
    if (ok) {
        return [receiver.resolvedRootFileInfos.get(resolved), resolved];
    }
    return [undefined, ""];
}
/**
 ...
 * }
 */
export function BuildInfoRootInfoReader_Roots(receiver) {
