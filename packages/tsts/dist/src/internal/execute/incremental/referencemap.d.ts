 ...
 * }
 */
export declare function referenceMap_storeReferences(receiver: GoPtr<referenceMap>, path: Path, refs: GoPtr<Set<Path>>): void;
/**
 ...
 * }
 */
export declare function referenceMap_getReferences(receiver: GoPtr<referenceMap>, path: Path): [GoPtr<Set<Path>>, bool];
/**
 ...
 * }
 */
export declare function referenceMap_getPathsWithReferences(receiver: GoPtr<referenceMap>): GoSlice<Path>;
/**
 ...
 * }
 */
export declare function referenceMap_getReferencedBy(receiver: GoPtr<referenceMap>, path: Path): GoSeq<Path>;
//# sourceMappingURL=referencemap.d.ts.map