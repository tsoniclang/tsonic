 ...
 * }
 */
export declare function referenceMap_storeReferences(receiver: GoPtr<referenceMap>, path: Path, refs: GoPtr<Set>): void;
/**
 ...
 * }
 */
export declare function referenceMap_getReferences(receiver: GoPtr<referenceMap>, path: Path): [GoPtr<Set>, bool];
/**
