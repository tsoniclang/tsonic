 ...
 * var _ Host = (*host)(nil)
 */
export let __bbc5d83a_0 = host_as_incremental_Host(undefined);
 ...
 * }
 */
export function host_GetMTime(receiver, fileName) {
 ...
 * }
 */
export function host_SetMTime(receiver, fileName, mTime) {
 ...
 * }
 */
export function CreateHost(compilerHost) {
    const h = { host: compilerHost };
 ...
 * }
 */
export function GetMTime(host, fileName) {
