...
import type { LiteralLikeNode } from "../../ast/generated/unions.js";
 ...
 * }
 */
export declare function addReferencedFilesFromSymbol(file: GoPtr<SourceFile>, referencedFiles: GoPtr<Set<Path>>, symbol_: GoPtr<Symbol>): void;
/**
 ...
 * }
 */
export declare function addReferencedFilesFromImportLiteral(file: GoPtr<SourceFile>, referencedFiles: GoPtr<Set<Path>>, checker: GoPtr<Checker>, importName: GoPtr<LiteralLikeNode>): void;
/**
 ...
 * }
 */
export declare function addReferencedFileFromFileName(program: GoPtr<Program>, fileName: string, referencedFiles: GoPtr<Set<Path>>, sourceFileDirectory: string): void;
/**
 ...
 * }
 */
export declare function getReferencedFiles(program: GoPtr<Program>, file: GoPtr<SourceFile>): GoPtr<Set<Path>>;
/**
