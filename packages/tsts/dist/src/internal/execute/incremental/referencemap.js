 ...
 * }
 */
export function referenceMap_storeReferences(receiver, path, refs) {
 ...
 * }
 */
export function referenceMap_getReferences(receiver, path) {
 ...
 * }
 */
export function referenceMap_getPathsWithReferences(receiver) {
    return slices.Collect(SyncMap_Keys(receiver.references));
}
/**
 ...
 * }
 */
export function referenceMap_getReferencedBy(receiver, path) {
    receiver.referenceBy.Do(() => {
        receiver.referencedBy = new globalThis.Map();
        SyncMap_Range(receiver.references, (key, value) => {
