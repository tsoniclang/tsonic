 ...
 * }
 */
export declare function emitFilesHandler_skipDtsOutputOfComposite(receiver: GoPtr<emitFilesHandler>, file: GoPtr<SourceFile>, outputFileName: string, text: string, data: GoPtr<WriteFileData>, newSignature: string, differsOnlyInMap: {
    v: bool;
}): bool;
/**
