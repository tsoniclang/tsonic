 ...
 */
export declare let __1917d4a9_0: BuildInfoReader;
export declare function buildInfoReader_as_incremental_BuildInfoReader(receiver: GoPtr<buildInfoReader>): BuildInfoReader;
/**
 ...
 * }
 */
export declare function buildInfoReader_ReadBuildInfo(receiver: GoPtr<buildInfoReader>, config: GoPtr<ParsedCommandLine>): GoPtr<BuildInfo>;
/**
 ...
 * }
 */
export declare function NewBuildInfoReader(host: CompilerHost): BuildInfoReader;
/**
 ...
 * }
 */
export declare function ReadBuildInfoProgram(config: GoPtr<ParsedCommandLine>, reader: BuildInfoReader, host: CompilerHost): GoPtr<Program>;
