 ...
 * }
 */
export declare function shouldRescanLessThanLessThanToken(s: GoPtr<Scanner>, containingNode: GoPtr<Node>, token: Kind): bool;
/**
 ...
 * }
 */
export declare function scanNavigationToken(s: GoPtr<Scanner>, containingNode: GoPtr<Node>): Kind;
/**
 ...
 * }
 */
export declare function GetTouchingPropertyName(sourceFile: GoPtr<SourceFile>, position: int): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function GetTouchingToken(sourceFile: GoPtr<SourceFile>, position: int): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function GetTokenAtPosition(sourceFile: GoPtr<SourceFile>, position: int): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function getTokenAtPosition(sourceFile: GoPtr<SourceFile>, position: int, allowPositionInLeadingTrivia: bool, includePrecedingTokenAtEndPosition: (node: GoPtr<Node>) => bool): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function getPosition(node: GoPtr<Node>, sourceFile: GoPtr<SourceFile>, allowPositionInLeadingTrivia: bool): int;
/**
 ...
 * }
 */
export declare function findRightmostNode(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function VisitEachChildAndJSDoc(node: GoPtr<Node>, sourceFile: GoPtr<SourceFile>, visitNode: (arg0: GoPtr<Node>, arg1: GoPtr<NodeVisitor>) => GoPtr<Node>, visitNodes: (arg0: GoPtr<NodeList>, arg1: GoPtr<NodeVisitor>) => GoPtr<NodeList>): void;
/**
 ...
 * )
 */
export declare const comparisonLessThan: int;
export declare const comparisonEqualTo: int;
export declare const comparisonGreaterThan: int;
/**
 ...
 * }
 */
export declare function FindPrecedingToken(sourceFile: GoPtr<SourceFile>, position: int): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function FindPrecedingTokenEx(sourceFile: GoPtr<SourceFile>, position: int, startNode: GoPtr<Node>, excludeJSDoc: bool): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function isValidPrecedingNode(node: GoPtr<Node>, sourceFile: GoPtr<SourceFile>): bool;
/**
 ...
 * }
 */
export declare function GetStartOfNode(node: GoPtr<Node>, file: GoPtr<SourceFile>, includeJSDoc: bool): int;
/**
 ...
 * }
 */
export declare function findRightmostValidToken(endPos: int, sourceFile: GoPtr<SourceFile>, containingNode: GoPtr<Node>, position: int, excludeJSDoc: bool): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function FindNextToken(previousToken: GoPtr<Node>, parent: GoPtr<Node>, file: GoPtr<SourceFile>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function getNodeVisitor(visitNode: (arg0: GoPtr<Node>, arg1: GoPtr<NodeVisitor>) => GoPtr<Node>, visitNodes: (arg0: GoPtr<NodeList>, arg1: GoPtr<NodeVisitor>) => GoPtr<NodeList>): GoPtr<NodeVisitor>;
/**
 ...
 * }
 */
export declare function shouldSkipChild(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function FindChildOfKind(containingNode: GoPtr<Node>, kind: Kind, sourceFile: GoPtr<SourceFile>): GoPtr<Node>;
