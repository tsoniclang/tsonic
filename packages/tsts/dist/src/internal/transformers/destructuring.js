...
import { NewArrayLiteralExpression, NewBindingElement, NewBindingPattern, NewConditionalExpression, NewElementAccessExpression, NewIdentifier, NewNumericLiteral, NewObjectLiteralExpression, NewOmittedExpression, NewPropertyAccessExpression, NewSyntaxList, NewToken, NewVariableDeclaration, } from "../ast/generated/factory.js";
import { IsComputedPropertyName, IsBigIntLiteral, IsIdentifier, IsOmittedExpression, IsPropertyAssignment, IsShorthandPropertyAssignment, IsSpreadElement, IsVariableDeclaration, } from "../ast/generated/predicates.js";
import { GetElementsOfBindingOrAssignmentPattern, GetRestIndicatorOfBindingOrAssignmentElement, GetTargetOfBindingOrAssignmentElement, IsAssignmentExpression, IsAssignmentPattern, IsBindingPattern, IsDeclarationBindingElement, IsDestructuringAssignment, IsEmptyArrayLiteral, IsEmptyObjectLiteral, IsLiteralExpression, IsPropertyNameLiteral, IsStringOrNumericLiteralLike, NodeIsSynthesized, TryGetPropertyNameOfBindingOrAssignmentElement, } from "../ast/utilities.js";
 ...
 * )
 */
export const FlattenLevelAll = 0; // Fully decompose all patterns into individual assignments/bindings
export const FlattenLevelObjectRest = 1; // Only decompose patterns containing object rest elements
/**
 ...
 * }
 */
export function FlattenDestructuringAssignment(tx, node, needsValue, level, createAssignmentCallback) {
 ...
 * }
 */
export function FlattenDestructuringBinding(tx, node, rval, level, hoistTempVariables, skipInitializer) {
    const f = newFlattener(tx, level);
    f.hoistTempVariables = hoistTempVariables;
 ...
 * }
 */
export function newFlattener(tx, level) {
    return {
        tx,
        level,
 ...
 * }
 */
export function flattener_createArrayAssignmentPattern(receiver, elements) {
 ...
 * }
 */
export function flattener_createObjectAssignmentPattern(receiver, elements) {
    const pf = Transformer_Factory(receiver.tx);
    const af = pf.__tsgoEmbedded0;
 ...
 * }
 */
export function flattener_createArrayAssignmentElement(receiver, expr) {
    return expr;
}
/**
 ...
 * }
 */
export function flattener_emitAssignment(receiver, target, value, location, original) {
    const pf = Transformer_Factory(receiver.tx);
    const visitor = Transformer_Visitor(receiver.tx);
    let expression;
 ...
 * }
 */
export function flattener_createArrayBindingPattern(receiver, elements) {
    const pf = Transformer_Factory(receiver.tx);
    const af = pf.__tsgoEmbedded0;
 ...
 * }
 */
export function flattener_createObjectBindingPattern(receiver, elements) {
    const pf = Transformer_Factory(receiver.tx);
    const af = pf.__tsgoEmbedded0;
 ...
 * }
 */
export function flattener_createArrayBindingElement(receiver, expr) {
 ...
 * }
 */
export function flattener_emitBinding(receiver, target, value, location, original) {
 ...
 * }
 */
export function flattener_emitExpression(receiver, expr) {
 ...
 * }
 */
export function flattener_ensureIdentifier(receiver, value, reuseIdentifierExpressions, location) {
 ...
 * }
 */
export function flattener_createDefaultValueCheck(receiver, value, defaultValue, location) {
    const ensured = flattener_ensureIdentifier(receiver, value, true, location);
    const pf = Transformer_Factory(receiver.tx);
    const af = pf.__tsgoEmbedded0;
    return NewConditionalExpression(af, NodeFactory_NewTypeCheck(pf, ensured, "undefined"), NewToken(af, KindQuestionToken), defaultValue, NewToken(af, KindColonToken), ensured);
}
/**
 ...
 * }
 */
export function flattener_createDestructuringPropertyAccess(receiver, value, propertyName) {
    const pf = Transformer_Factory(receiver.tx);
    const af = pf.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.tx);
    if (IsComputedPropertyName(propertyName)) {
        ...
        const coercible = { AsNodeFactory: () => af };
 ...
 * }
 */
export function flattener_flattenDestructuringAssignment(receiver, node, needsValue) {
    const pf = Transformer_Factory(receiver.tx);
    const af = pf.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.tx);
 ...
 * }
 */
export function flattener_flattenDestructuringBinding(receiver, node, rval, skipInitializer) {
    const pf = Transformer_Factory(receiver.tx);
    const af = pf.__tsgoEmbedded0;
    ...
    if (receiver.expressions.length > 0) {
        ...
        if (receiver.hoistTempVariables) {
            ...
            const last = receiver.declarations[receiver.declarations.length - 1];
            const updatedLast = {
                ...last,
    ...
    const decls = receiver.declarations.map((pending) => {
 ...
 * }
 */
export function flattener_flattenBindingOrAssignmentElement(receiver, element, value, location, skipInitializer) {
    const pf = Transformer_Factory(receiver.tx);
    const visitor = Transformer_Visitor(receiver.tx);
 ...
 * }
 */
export function flattener_flattenObjectBindingOrAssignmentPattern(receiver, parent, pattern, value, location) {
    const pf = Transformer_Factory(receiver.tx);
    const visitor = Transformer_Visitor(receiver.tx);
 ...
 * }
 */
export function flattener_flattenArrayBindingOrAssignmentPattern(receiver, parent, pattern, value, location) {
    const pf = Transformer_Factory(receiver.tx);
    const af = pf.__tsgoEmbedded0;
    const elements = GetElementsOfBindingOrAssignmentPattern(pattern);
    const numElements = elements.length;
 ...
 * }
 */
export function BindingOrAssignmentElementAssignsToName(element, name) {
 ...
 * }
 */
export function bindingOrAssignmentPatternAssignsToName(pattern, name) {
    const elements = GetElementsOfBindingOrAssignmentPattern(pattern);
 ...
 * }
 */
export function BindingOrAssignmentElementContainsNonLiteralComputedName(element) {
    const propertyName = TryGetPropertyNameOfBindingOrAssignmentElement(element);
 ...
 * }
 */
export function bindingOrAssignmentPatternContainsNonLiteralComputedName(pattern) {
    const elements = GetElementsOfBindingOrAssignmentPattern(pattern);
 ...
 * }
 */
export function isSimpleBindingOrAssignmentElement(element) {
    const target = GetTargetOfBindingOrAssignmentElement(element);
