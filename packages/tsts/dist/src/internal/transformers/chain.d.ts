 ...
 * }
 */
export declare function chainedTransformer_visit(receiver: GoPtr<chainedTransformer>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function Chain(...transforms: Array<TransformerFactory>): TransformerFactory;
