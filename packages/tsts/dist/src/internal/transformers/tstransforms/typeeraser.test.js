...
for (const rec of data) {
    test(rec.title, () => {
        ...
        const transformed = Transformer_TransformSourceFile(NewTypeEraserTransformer({ CompilerOptions: compilerOptions, Context: NewEmitContext() }), file);
        checkEmit(undefined, transformed, rec.output);
    });
}
//# sourceMappingURL=typeeraser.test.js.map