 ...
 * }
 */
export function NewLegacyDecoratorsTransformer(opt) {
    const tx = {
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visit(receiver, node) {
    ...
    switch (node.Kind) {
        case KindIdentifier:
            return LegacyDecoratorsTransformer_visitIdentifier(receiver, node);
        case KindPropertyAccessExpression:
            return LegacyDecoratorsTransformer_visitPropertyAccessExpression(receiver, node);
        case KindDecorator:
            return undefined;
        case KindClassDeclaration:
            return LegacyDecoratorsTransformer_visitClassDeclaration(receiver, node);
        case KindClassExpression:
            return LegacyDecoratorsTransformer_visitClassExpression(receiver, node);
        case KindConstructor:
            return LegacyDecoratorsTransformer_visitConstructorDeclaration(receiver, node);
        case KindMethodDeclaration:
            return LegacyDecoratorsTransformer_visitMethodDeclaration(receiver, node);
        ...
        case KindPropertyDeclaration:
            return LegacyDecoratorsTransformer_visitPropertyDeclaration(receiver, node);
        case KindParameter:
            return LegacyDecoratorsTransformer_visitParamerDeclaration(receiver, node);
        case KindSourceFile: {
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visitIdentifier(receiver, node) {
    const emitCtx = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    for (const d of receiver.enclosingClasses) {
        const dNode = d;
        if (receiver.classAliases.has(dNode) && receiver.referenceResolver.GetReferencedValueDeclaration(EmitContext_MostOriginal(emitCtx, node)) === EmitContext_MostOriginal(emitCtx, dNode)) {
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visitPropertyAccessExpression(receiver, node) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    if (expression !== Node_Expression(nodeAsNode)) {
        return NodeFactory_UpdatePropertyAccessExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsPropertyAccessExpression(nodeAsNode), expression, node.QuestionDotToken, node.name, node.Flags);
    }
    return nodeAsNode;
}
/**
 ...
 * }
 */
export function elideNodes(f, nodes) {
    if (nodes === undefined) {
        return undefined;
    }
 ...
 * }
 */
export function elideModifiers(f, nodes) {
    if (nodes === undefined) {
        return undefined;
    }
    if (nodes.Nodes.length === 0) {
 ...
 * }
 */
export function LegacyDecoratorsTransformer_finishClassElement(receiver, updated, original) {
    if (updated !== original) {
        const emitCtx = Transformer_EmitContext(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visitParamerDeclaration(receiver, node) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const emitCtx = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = printerFactory.__tsgoEmbedded0;
    const nodeAsNode = node;
    const updated = NodeFactory_UpdateParameterDeclaration(astFactory, node, elideModifiers(printerFactory, Node_Modifiers(nodeAsNode)), node.DotDotDotToken, NodeVisitor_VisitNode(visitor, Node_Name(nodeAsNode)), undefined, undefined, NodeVisitor_VisitNode(visitor, node.Initializer));
    if (updated !== nodeAsNode) {
        ...
        EmitContext_SetEmitFlags(emitCtx, Node_Name(updated), EFNoTrailingSourceMap);
    }
    return updated;
}
/**
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visitPropertyNameOfClassElement(receiver, member) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const emitCtx = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = printerFactory.__tsgoEmbedded0;
    ...
    if (IsComputedPropertyName(name) && HasDecorators(member)) {
        ...
        if (!IsSimpleInlineableExpression(innerExpression)) {
            ...
            return NodeFactory_UpdateComputedPropertyName(astFactory, cpn, NodeFactory_NewAssignmentExpression(printerFactory, generatedName, expression));
        }
    }
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visitPropertyDeclaration(receiver, node) {
    const nodeAsNode = node;
    if ((nodeAsNode.Flags & NodeFlagsAmbient) !== 0) {
        return undefined;
    }
    if (HasSyntacticModifier(nodeAsNode, (ModifierFlagsAmbient | ModifierFlagsAbstract))) {
        return undefined;
    }
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const astFactory = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    return LegacyDecoratorsTransformer_finishClassElement(receiver, NodeFactory_UpdatePropertyDeclaration(astFactory, node, NodeVisitor_VisitModifiers(visitor, Node_Modifiers(nodeAsNode)), LegacyDecoratorsTransformer_visitPropertyNameOfClassElement(receiver, nodeAsNode), undefined, undefined, NodeVisitor_VisitNode(visitor, node.Initializer)), nodeAsNode);
}
/**
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visitGetAccessorDeclaration(receiver, node) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const astFactory = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const nodeAsNode = node;
    return LegacyDecoratorsTransformer_finishClassElement(receiver, NodeFactory_UpdateGetAccessorDeclaration(astFactory, node, NodeVisitor_VisitModifiers(visitor, Node_Modifiers(nodeAsNode)), LegacyDecoratorsTransformer_visitPropertyNameOfClassElement(receiver, nodeAsNode), undefined, NodeVisitor_VisitNodes(visitor, Node_ParameterList(nodeAsNode)), undefined, undefined, NodeVisitor_VisitNode(visitor, Node_Body(nodeAsNode))), nodeAsNode);
}
/**
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visitSetAccessorDeclaration(receiver, node) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const astFactory = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const nodeAsNode = node;
    return LegacyDecoratorsTransformer_finishClassElement(receiver, NodeFactory_UpdateSetAccessorDeclaration(astFactory, node, NodeVisitor_VisitModifiers(visitor, Node_Modifiers(nodeAsNode)), LegacyDecoratorsTransformer_visitPropertyNameOfClassElement(receiver, nodeAsNode), undefined, NodeVisitor_VisitNodes(visitor, Node_ParameterList(nodeAsNode)), undefined, undefined, NodeVisitor_VisitNode(visitor, Node_Body(nodeAsNode))), nodeAsNode);
}
/**
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visitMethodDeclaration(receiver, node) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const astFactory = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const nodeAsNode = node;
    return LegacyDecoratorsTransformer_finishClassElement(receiver, NodeFactory_UpdateMethodDeclaration(astFactory, node, NodeVisitor_VisitModifiers(visitor, Node_Modifiers(nodeAsNode)), node.AsteriskToken, LegacyDecoratorsTransformer_visitPropertyNameOfClassElement(receiver, nodeAsNode), undefined, undefined, NodeVisitor_VisitNodes(visitor, Node_ParameterList(nodeAsNode)), undefined, undefined, NodeVisitor_VisitNode(visitor, Node_Body(nodeAsNode))), nodeAsNode);
}
/**
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visitConstructorDeclaration(receiver, node) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const astFactory = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const nodeAsNode = node;
    return NodeFactory_UpdateConstructorDeclaration(astFactory, node, NodeVisitor_VisitModifiers(visitor, Node_Modifiers(nodeAsNode)), undefined, NodeVisitor_VisitNodes(visitor, Node_ParameterList(nodeAsNode)), undefined, undefined, NodeVisitor_VisitNode(visitor, Node_Body(nodeAsNode)));
}
/**
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visitClassExpression(receiver, node) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const astFactory = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const nodeAsNode = node;
    return NodeFactory_UpdateClassExpression(astFactory, node, NodeVisitor_VisitModifiers(visitor, Node_Modifiers(nodeAsNode)), node.name, undefined, NodeVisitor_VisitNodes(visitor, node.HeritageClauses), NodeVisitor_VisitNodes(visitor, node.Members));
}
/**
 ...
 * }
 */
export function LegacyDecoratorsTransformer_visitClassDeclaration(receiver, node) {
    const nodeAsNode = node;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const decorated = ClassOrConstructorParameterIsDecorated(true, nodeAsNode);
    if (!(decorated || ChildIsDecorated(true, nodeAsNode, undefined))) {
        return NodeVisitor_VisitEachChild(visitor, nodeAsNode);
    }
    if (decorated) {
        return LegacyDecoratorsTransformer_transformClassDeclarationWithClassDecorators(receiver, node, node.name);
    }
    return LegacyDecoratorsTransformer_transformClassDeclarationWithoutClassDecorators(receiver, node, node.name);
}
/**
 ...
 * }
 */
export function LegacyDecoratorsTransformer_transformClassDeclarationWithoutClassDecorators(receiver, node, name) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = printerFactory.__tsgoEmbedded0;
    const modifiers = NodeVisitor_VisitModifiers(visitor, Node_Modifiers(node));
    ...
    const resolvedName = (name === undefined && decorationStatements.length > 0)
        ? NodeFactory_NewGeneratedNameForNode(printerFactory, node)
        : name;
    const updated = NodeFactory_UpdateClassDeclaration(astFactory, node, modifiers, resolvedName, undefined, heritageClauses, members);
 ...
 * }
 */
export function LegacyDecoratorsTransformer_popEnclosingClass(receiver) {
 ...
 * }
 */
export function LegacyDecoratorsTransformer_pushEnclosingClass(receiver, cls) {
 ...
 * }
 */
export function LegacyDecoratorsTransformer_transformClassDeclarationWithClassDecorators(receiver, node, name) {
    const nodeAsNode = node;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = printerFactory.__tsgoEmbedded0;
    ...
    const modifiers = (nodeModifiers !== undefined && nodeModifiers.Nodes.length > 0)
        ? (() => {
    ...
    const declName = NodeFactory_GetLocalNameEx(printerFactory, nodeAsNode, { AllowComments: false, AllowSourceMaps: true });
    const heritageClauses = NodeVisitor_VisitNodes(visitor, node.HeritageClauses);
    ...
    const members = assignClassAliasInStaticBlock
        ? (() => {
            const memberNodes = members0 !== undefined ? [...members0.Nodes] : [];
            const staticBlockStmt = NodeFactory_NewNodeList(astFactory, [
                NewExpressionStatement(astFactory, NodeFactory_NewAssignmentExpression(printerFactory, classAlias, NewKeywordExpression(astFactory, KindThisKeyword))),
            ]);
            const staticBlock = NewClassStaticBlockDeclaration(astFactory, undefined, NewBlock(astFactory, staticBlockStmt, false));
        ...
        : members0;
    const exprName = (name !== undefined && IsGeneratedIdentifier(emitCtx, name))
        ? undefined
        : name;
    const classExpression = NewClassExpression(astFactory, modifiers, exprName, undefined, heritageClauses, members);
    EmitContext_SetOriginal(emitCtx, classExpression, nodeAsNode);
    classExpression.Loc = location;
    const varInitializer = (classAlias !== undefined && !assignClassAliasInStaticBlock)
        ? NodeFactory_NewAssignmentExpression(printerFactory, classAlias, classExpression)
        : classExpression;
    const varDecl = NewVariableDeclaration(astFactory, declName, undefined, undefined, varInitializer);
    EmitContext_SetOriginal(emitCtx, varDecl, nodeAsNode);
    const varDeclList = NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [varDecl]), NodeFlagsLet);
    ...
    if (isExport) {
        const exportStatement = isDefault
            ? NodeFactory_NewExportDefault(printerFactory, declName)
            : NodeFactory_NewExternalModuleExport(printerFactory, NodeFactory_GetDeclarationName(printerFactory, nodeAsNode));
 ...
 * }
 */
export function LegacyDecoratorsTransformer_hasInternalStaticReference(receiver, node) {
    const emitCtx = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const classNode = EmitContext_MostOriginal(emitCtx, node);
    const isOrContainsStaticSelfReference = (n) => {
        if (IsIdentifier(n) && receiver.referenceResolver.GetReferencedValueDeclaration(EmitContext_MostOriginal(emitCtx, n)) === classNode) {
            return true;
        }
 ...
 * }
 */
export function LegacyDecoratorsTransformer_getClassAliasIfNeeded(receiver, node) {
 ...
 * }
 */
export function LegacyDecoratorsTransformer_getConstructorDecorationStatement(receiver, node) {
    const expression = LegacyDecoratorsTransformer_generateConstructorDecorationExpression(receiver, node);
    if (expression !== undefined) {
        const astFactory = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
        const emitCtx = Transformer_EmitContext(receiver.__tsgoEmbedded0);
        const result = NewExpressionStatement(astFactory, expression);
        EmitContext_SetOriginal(emitCtx, result, node);
        return result;
    }
    return undefined;
}
 ...
 * }
 */
export function LegacyDecoratorsTransformer_generateConstructorDecorationExpression(receiver, node) {
    const allDecorators = getAllDecoratorsOfClass(node, true);
    const nodeAsNode = node;
    ...
    const emitCtx = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const classAlias = receiver.classAliases !== undefined ? receiver.classAliases.get(nodeAsNode) : undefined;
    const localName = NodeFactory_GetDeclarationNameEx(printerFactory, nodeAsNode, { AllowComments: false, AllowSourceMaps: true });
    const decorate = NodeFactory_NewDecorateHelper(printerFactory, decoratorExpressions, localName, undefined, undefined);
    const assignmentTarget = classAlias !== undefined
        ? NodeFactory_NewAssignmentExpression(printerFactory, classAlias, decorate)
        : decorate;
    const expression = NodeFactory_NewAssignmentExpression(printerFactory, localName, assignmentTarget);
    EmitContext_SetEmitFlags(emitCtx, expression, EFNoComments);
    EmitContext_SetSourceMapRange(emitCtx, expression, MoveRangePastModifiers(nodeAsNode));
    return expression;
}
/**
 ...
 * }
 */
export function isClassStaticBlockDeclarationOrStaticProperty(node) {
    return (IsClassStaticBlockDeclaration(node) || (IsPropertyDeclaration(node) && HasStaticModifier(node)));
}
/**
 ...
 * }
 */
export function isNotExportOrDefaultOrDecorator(node) {
    return (!(IsDecorator(node) || node.Kind === KindExportKeyword || node.Kind === KindDefaultKeyword));
}
/**
 ...
 * }
 */
export function decoratorContainsPrivateIdentifierInExpression(decorator) {
    return ((Node_SubtreeFacts(decorator) & SubtreeContainsPrivateIdentifierInExpression) !== 0);
}
/**
 ...
 * }
 */
export function parameterDecoratorsContainPrivateIdentifierInExpression(parameterDecorators) {
...
export function hasClassElementWithDecoratorContainingPrivateIdentifierInExpression(node) {
    ...
    for (const member of node.Members.Nodes) {
        ...
        const allDecs = getAllDecoratorsOfClassElement(member, node, true);
 ...
 * }
 */
export function getAllDecoratorsOfClass(node, useLegacyDecorators) {
    const nodeAsNode = node;
    const decorators = Node_Decorators(nodeAsNode) ?? [];
    const parameters = useLegacyDecorators
 ...
 * }
 */
export function getAllDecoratorsOfClassElement(member, parent, useLegacyDecorators) {
    switch (member.Kind) {
        case KindGetAccessor:
        case KindSetAccessor:
            if (!useLegacyDecorators) {
 ...
 * }
 */
export function getAllDecoratorsOfAccessors(accessor, parent, useLegacyDecorators) {
    if (Node_Body(accessor) === undefined) {
        return undefined;
    }
    const memberNodes = parent.Members !== undefined ? parent.Members.Nodes : [];
    const decls = GetAllAccessorDeclarations(memberNodes, accessor);
    const firstAccessorWithDecorators = HasDecorators(decls.FirstAccessor)
        ? decls.FirstAccessor
        : (decls.SecondAccessor !== undefined && HasDecorators(decls.SecondAccessor))
    ...
    const parameters = (useLegacyDecorators && decls.SetAccessor !== undefined)
        ? getDecoratorsOfParameters(decls.SetAccessor)
        : [];
    if (decorators.length === 0 && parameters.length === 0) {
        return undefined;
    }
 ...
 * }
 */
export function getAllDecoratorsOfProperty(property) {
 ...
 * }
 */
export function getAllDecoratorsOfMethod(method, useLegacyDecorators) {
 ...
 * }
 */
export function getDecoratorsOfParameters(node) {
    const decorators = [];
    if (node !== undefined) {
        const parameters = Node_Parameters(node) ?? [];
        const firstParameterIsThis = parameters.length > 0 && IsThisParameter(parameters[0]);
        const firstParameterOffset = firstParameterIsThis ? 1 : 0;
        const numParameters = parameters.length - firstParameterOffset;
 ...
 * }
 */
export function LegacyDecoratorsTransformer_transformDecoratorsOfClassElements(receiver, node, members) {
    const astFactory = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const decorationStatements = [
        ...LegacyDecoratorsTransformer_getClassElementDecorationStatements(receiver, node, false),
        ...LegacyDecoratorsTransformer_getClassElementDecorationStatements(receiver, node, true),
    ];
    if (hasClassElementWithDecoratorContainingPrivateIdentifierInExpression(node)) {
        const memberNodes = (members !== undefined && members.Nodes.length > 0) ? [...members.Nodes] : [];
        const stmtList = NodeFactory_NewNodeList(astFactory, decorationStatements);
        const staticBlock = NewClassStaticBlockDeclaration(astFactory, undefined, NewBlock(astFactory, stmtList, true));
 ...
 * }
 */
export function LegacyDecoratorsTransformer_getClassElementDecorationStatements(receiver, node, isStatic) {
    const astFactory = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const exprs = LegacyDecoratorsTransformer_generateClassElementDecorationExpressions(receiver, node, isStatic);
    return exprs.map(e => NewExpressionStatement(astFactory, e));
}
/**
 ...
 * }
 */
export function isDecoratedClassElement(member, isStaticElement, parent) {
    return (isStaticElement === IsStatic(member) && NodeOrChildIsDecorated(true, member, parent, undefined));
}
/**
 ...
 * }
 */
export function getDecoratedClassElements(node, isStatic) {
    if (node.Members === undefined || node.Members.Nodes.length === 0) {
        return [];
    }
 ...
 * }
 */
export function LegacyDecoratorsTransformer_generateClassElementDecorationExpressions(receiver, node, isStatic) {
 ...
 * }
 */
export function LegacyDecoratorsTransformer_generateClassElementDecorationExpression(receiver, node, member) {
    const allDecs = getAllDecoratorsOfClassElement(member, node, true);
    ...
    const memberName = LegacyDecoratorsTransformer_getExpressionForPropertyName(receiver, member, ((member.Flags & NodeFlagsAmbient) === 0));
    const descriptor = (IsPropertyDeclaration(member) && !HasAccessorModifier(member))
        ? NodeFactory_NewVoidZeroExpression(printerFactory)
    ...
    EmitContext_SetEmitFlags(emitCtx, helper, EFNoComments);
    EmitContext_SetSourceMapRange(emitCtx, helper, MoveRangePastModifiers(member));
    return helper;
}
/**
 ...
 * }
 */
export function LegacyDecoratorsTransformer_isSyntheticMetadataDecorator(receiver, node) {
    return EmitContext_IsCallToHelper(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_Expression(node), "__metadata");
}
/**
 ...
 * }
 */
export function LegacyDecoratorsTransformer_transformAllDecoratorsOfDeclaration(receiver, allDecorators) {
    if (allDecorators === undefined) {
        return [];
    }
    const mm = GroupBy(allDecorators.decorators, (d) => LegacyDecoratorsTransformer_isSyntheticMetadataDecorator(receiver, d));
    const metadata = MultiMap_Get(mm, true);
    const decorators = MultiMap_Get(mm, false);
    return [
 ...
 * }
 */
export function LegacyDecoratorsTransformer_transformDecoratorsOfParameters(receiver, parameters) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const emitCtx = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const results = [];
    for (let i = 0; i < parameters.length; i++) {
        ...
        if (decorators !== undefined && decorators.length > 0) {
            for (const decorator of decorators) {
                ...
                const helper = NodeFactory_NewParamHelper(printerFactory, NodeVisitor_VisitNode(visitor, decoratorExpr), i, decoratorExpr.Loc);
                EmitContext_SetEmitFlags(emitCtx, helper, EFNoComments);
                results.push(helper);
            }
        }
 ...
 * }
 */
export function LegacyDecoratorsTransformer_transformDecorators(receiver, decorators) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function LegacyDecoratorsTransformer_getClassMemberPrefix(receiver, node, member) {
    if (IsStatic(member)) {
        return NodeFactory_GetDeclarationName(Transformer_Factory(receiver.__tsgoEmbedded0), node);
    }
 ...
 * }
 */
export function LegacyDecoratorsTransformer_getClassPrototype(receiver, node) {
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = printerFactory.__tsgoEmbedded0;
    const declName = NodeFactory_GetDeclarationName(printerFactory, node);
    return NewPropertyAccessExpression(astFactory, declName, undefined, NewIdentifier(astFactory, "prototype"), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function LegacyDecoratorsTransformer_getExpressionForPropertyName(receiver, member, generateNameForComputedPropertyName) {
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = printerFactory.__tsgoEmbedded0;
    const name = Node_Name(member);
    if (IsPrivateIdentifier(name)) {
        ...
        if (generateNameForComputedPropertyName && !IsSimpleInlineableExpression(cpnExpr)) {
            return NodeFactory_NewGeneratedNameForNode(printerFactory, name);
        }
        return cpnExpr;
    }
    else if (IsIdentifier(name)) {
        const identText = name.Text;
...
//# sourceMappingURL=legacydecorators.js.map