...
import { KindArrayBindingPattern, KindBlock, KindCaseBlock, KindClassDeclaration, KindClassExpression, KindComputedPropertyName, KindConstructor, KindEnumDeclaration, KindExportDeclaration, KindExternalModuleReference, KindFunctionDeclaration, KindIdentifier, KindImportClause, KindImportDeclaration, KindImportEqualsDeclaration, KindModuleBlock, KindModuleDeclaration, KindNumericLiteral, KindObjectBindingPattern, KindOverrideKeyword, KindPrivateIdentifier, KindPrivateKeyword, KindProtectedKeyword, KindPublicKeyword, KindReadonlyKeyword, KindEqualsToken, KindShorthandPropertyAssignment, KindSourceFile, KindStringLiteral, KindVariableDeclarationList, KindVariableStatement, } from "../../ast/generated/kinds.js";
import { NodeFlagsLet, NodeFlagsNone } from "../../ast/generated/flags.js";
import { ModifierFlagsDecorator, ModifierFlagsExport, ModifierFlagsExportDefault, ModifierFlagsTypeScriptModifier, } from "../../ast/modifierflags.js";
...
import { NewBinaryExpression, NewBlock, NewCallExpression, NewElementAccessExpression, NewExpressionStatement, NewFunctionExpression, NewIdentifier, NewNumericLiteral, NewObjectLiteralExpression, NewParameterDeclaration, NewParenthesizedExpression, NewPropertyAccessExpression, NewPropertyAssignment, NewPropertyDeclaration, NewStringLiteral, NewSyntaxList, NewToken, NewVariableDeclaration, NewVariableDeclarationList, NewVariableStatement, } from "../../ast/generated/factory.js";
import { TextRange_WithPos } from "../../core/text.js";
import { EmitContext_AddEmitFlags, EmitContext_AssignCommentAndSourceMapRanges, EmitContext_EndAndMergeVariableEnvironment, EmitContext_MostOriginal, EmitContext_NewNotEmittedStatement, EmitContext_ParseNode, EmitContext_SetCommentRange, EmitContext_SetEmitFlags, EmitContext_SetOriginal, EmitContext_SetSourceMapRange, EmitContext_StartVariableEnvironment, EmitContext_VisitFunctionBody, EmitContext_VisitParameters, } from "../../printer/emitcontext.js";
import { EFNoComments, EFNoLeadingComments, EFNoNestedComments, EFNoNestedSourceMaps, EFNoSourceMap, EFNone, EFNoTrailingComments, EFStartOnNewLine, } from "../../printer/emitflags.js";
import { NodeFactory_CreateExpressionFromEntityName, NodeFactory_GetDeclarationNameEx, NodeFactory_GetExternalModuleOrNamespaceExportName, NodeFactory_GetLocalName, NodeFactory_GetLocalNameEx, NodeFactory_GetNamespaceMemberName, NodeFactory_InlineExpressions, NodeFactory_NewAssignmentExpression, NodeFactory_NewGeneratedNameForNode, NodeFactory_NewLogicalORExpression, NodeFactory_NewStringLiteralFromNode, NodeFactory_NewThisExpression, NodeFactory_NewVoidZeroExpression, NodeFactory_SplitStandardPrologue, } from "../../printer/factory.js";
 ...
 * }
 */
export function NewRuntimeSyntaxTransformer(opt) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_pushNode(receiver, node) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_popNode(receiver, grandparentNode) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_pushScope(receiver, node) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_popScope(receiver, savedCurrentScope, savedCurrentScopeFirstDeclarationsOfName) {
 ...
 * }
 */
const RuntimeSyntaxTransformer_visitInner = (receiver, node) => {
    ...
    switch (node.Kind) {
        ...
        case KindIdentifier:
            return RuntimeSyntaxTransformer_visitIdentifier(receiver, node);
...
export function RuntimeSyntaxTransformer_visit(receiver, node) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_recordDeclarationInScope(receiver, node) {
    switch (node.Kind) {
        case KindVariableStatement:
    ...
    if (name !== undefined) {
        if (IsIdentifier(name)) {
            if (receiver.currentScopeFirstDeclarationsOfName === undefined) {
                receiver.currentScopeFirstDeclarationsOfName = new Map();
            }
 ...
 * }
 */
export function RuntimeSyntaxTransformer_isFirstDeclarationInScope(receiver, node) {
    const name = Node_Name(node);
 ...
 * }
 */
export function RuntimeSyntaxTransformer_isExportOfNamespace(receiver, node) {
    return (receiver.currentNamespace !== undefined &&
 ...
 * }
 */
export function RuntimeSyntaxTransformer_getExpressionForPropertyName(receiver, member) {
    ...
    switch (name.Kind) {
        ...
        case KindComputedPropertyName: {
            ...
            // enums don't support computed properties so we always generate the 'expression' part of the name as-is.
            return NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), n.Expression);
        }
        case KindIdentifier:
 ...
 * }
 */
export function RuntimeSyntaxTransformer_getEnumQualifiedElement(receiver, enum_, member) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_getNamespaceContainerName(receiver, node) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_getNamespaceQualifiedProperty(receiver, ns, name) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_getNamespaceQualifiedElement(receiver, ns, expression) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_getExportQualifiedReferenceToDeclaration(receiver, node) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_addVarForDeclaration(receiver, statements, node) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitEnumDeclaration(receiver, node) {
    ...
    let statements = [];
    const [statementsAfterVar, varAdded] = RuntimeSyntaxTransformer_addVarForDeclaration(receiver, statements, EnumDeclaration_as_nodeData(node).AsNode());
    ...
    const enumArg0 = NodeFactory_NewLogicalORExpression(factory, RuntimeSyntaxTransformer_getExportQualifiedReferenceToDeclaration(receiver, nodeAsNode), NodeFactory_NewAssignmentExpression(factory, RuntimeSyntaxTransformer_getExportQualifiedReferenceToDeclaration(receiver, nodeAsNode), NewObjectLiteralExpression(astFactory, NodeFactory_NewNodeList(astFactory, []), false)));
    let enumArg = enumArg0;
    if (RuntimeSyntaxTransformer_isExportOfNamespace(receiver, nodeAsNode)) {
        const localName = NodeFactory_GetLocalNameEx(factory, nodeAsNode, { AllowComments: false, AllowSourceMaps: true, IgnoreAssignedName: false });
 ...
 * }
 */
export function RuntimeSyntaxTransformer_transformEnumBody(receiver, node) {
    const savedCurrentEnum = receiver.currentEnum;
    receiver.currentEnum = Node_AsNode(node);
    // visit the children of `node` in advance to capture any references to enum members
    const visitedNode = NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_AsNode(node));
 ...
 * }
 */
export function RuntimeSyntaxTransformer_transformEnumMember(receiver, statements, enum_, index) {
    ...
    // E[E["A"] = x] = "A";
    //             ^
    let expression = member.Initializer; // NOTE: already visited
    ...
    //  E[E["A"] = 0] = "A";
    //    ^^^^^^^^--_____
    expression = NodeFactory_NewAssignmentExpression(factory, RuntimeSyntaxTransformer_getEnumQualifiedElement(receiver, enum_, member), expression);
    if (useExplicitReverseMapping) {
        //  E[E["A"] = 0] = "A";
        //  ^^--------------^^^^^
        const astFactory = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
        expression = NodeFactory_NewAssignmentExpression(factory, NewElementAccessExpression(Transformer_EmitContext(receiver.__tsgoEmbedded0).Factory.__tsgoEmbedded0, RuntimeSyntaxTransformer_getNamespaceContainerName(receiver, Node_AsNode(enum_)), undefined /*questionDotToken*/, expression, NodeFlagsNone), RuntimeSyntaxTransformer_getExpressionForPropertyName(receiver, member));
    }
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitModuleDeclaration(receiver, node) {
    ...
    let statements = [];
    const [statementsAfterVar, varAdded] = RuntimeSyntaxTransformer_addVarForDeclaration(receiver, statements, ModuleDeclaration_as_nodeData(node).AsNode());
    statements = statementsAfterVar;
    let emitFlags = EFNone;
    if (varAdded && (CompilerOptions_GetEmitModuleKind(receiver.compilerOptions) !== ModuleKindSystem || receiver.currentScope !== receiver.currentSourceFile)) {
        emitFlags = emitFlags | EFNoLeadingComments;
    ...
    //  x || (x = {})
    //  exports.x || (exports.x = {})
    const moduleArg0 = NodeFactory_NewLogicalORExpression(factory, RuntimeSyntaxTransformer_getExportQualifiedReferenceToDeclaration(receiver, nodeAsNode), NodeFactory_NewAssignmentExpression(factory, RuntimeSyntaxTransformer_getExportQualifiedReferenceToDeclaration(receiver, nodeAsNode), NewObjectLiteralExpression(astFactory, NodeFactory_NewNodeList(astFactory, []), false)));
 ...
 * }
 */
export function RuntimeSyntaxTransformer_transformModuleBody(receiver, node, namespaceLocalName) {
    const savedCurrentNamespace = receiver.currentNamespace;
    const savedCurrentScope = receiver.currentScope;
    const savedCurrentScopeFirstDeclarationsOfName = receiver.currentScopeFirstDeclarationsOfName;
    receiver.currentNamespace = Node_AsNode(node);
    receiver.currentScopeFirstDeclarationsOfName = undefined;
    let statements = [];
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitImportEqualsDeclaration(receiver, node) {
    if (node.ModuleReference.Kind === KindExternalModuleReference) {
        return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_AsNode(node));
    }
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    ...
    if (!RuntimeSyntaxTransformer_isExportOfNamespace(receiver, nodeAsNode)) {
        ...
        const statement = RuntimeSyntaxTransformer_createExportStatement(receiver, node.name, moduleReference, nodeAsNode.Loc, nodeAsNode.Loc, nodeAsNode);
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitVariableStatement(receiver, node) {
    if (RuntimeSyntaxTransformer_isExportOfNamespace(receiver, Node_AsNode(node))) {
        let expressions = [];
        ...
        for (const declaration of declList.Declarations.Nodes) {
            ...
            if (IsBindingPattern(Node_Name(Node_AsNode(v)))) {
                const expression = FlattenDestructuringAssignment(receiver.__tsgoEmbedded0, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), declaration), false, /*needsValue*/ FlattenLevelAll, (exportName, exportValue, location) => RuntimeSyntaxTransformer_createNamespaceExportExpression(receiver, exportName, exportValue, location));
                if (expression !== undefined) {
        ...
        const result = NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), statement);
 ...
 * }
 */
export function RuntimeSyntaxTransformer_createNamespaceExportExpression(receiver, exportName, exportValue, location) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitFunctionDeclaration(receiver, node) {
    if (RuntimeSyntaxTransformer_isExportOfNamespace(receiver, Node_AsNode(node))) {
        const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
        const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
        const updated = NodeFactory_UpdateFunctionDeclaration(factory.__tsgoEmbedded0, node, NodeVisitor_VisitModifiers(visitor, ExtractModifiers(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_Modifiers(Node_AsNode(node)), ~ModifierFlagsExport)), node.AsteriskToken, NodeVisitor_VisitNode(visitor, node.name), undefined /*typeParameters*/, NodeVisitor_VisitNodes(visitor, node.Parameters), undefined /*returnType*/, undefined /*fullSignature*/, NodeVisitor_VisitNode(visitor, node.Body));
        const export_ = RuntimeSyntaxTransformer_createExportStatementForDeclaration(receiver, Node_AsNode(node));
 ...
 * }
 */
export function RuntimeSyntaxTransformer_getParameterProperties(receiver, constructor_) {
    if (constructor_ === undefined) {
        return [];
    }
    return (Node_Parameters(constructor_) ?? [])
        .filter((parameter) => IsParameterPropertyDeclaration(parameter, constructor_))
        .map((parameter) => AsParameterDeclaration(parameter));
}
/**
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitClassDeclaration(receiver, node) {
    ...
    let name = NodeVisitor_VisitNode(visitor, node.name);
    ...
    if (parameterProperties.length > 0) {
        ...
        for (const parameter of parameterProperties) {
            if (IsIdentifier(Node_Name(Node_AsNode(parameter)))) {
                const parameterProperty = NewPropertyDeclaration(astFactory, undefined /*modifiers*/, Node_Clone(Node_Name(Node_AsNode(parameter)), { AsNodeFactory: () => astFactory }), undefined /*questionOrExclamationToken*/, undefined /*type*/, undefined /*initializer*/);
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitClassExpression(receiver, node) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    ...
    const name = NodeVisitor_VisitNode(visitor, node.name);
    const heritageClauses = NodeVisitor_VisitNodes(visitor, node.HeritageClauses);
    let members = NodeVisitor_VisitNodes(visitor, node.Members);
    const parameterProperties = RuntimeSyntaxTransformer_getParameterProperties(receiver, Find(node.Members.Nodes, IsConstructorDeclaration));
    if (parameterProperties.length > 0) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitConstructorDeclaration(receiver, node) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const modifiers = NodeVisitor_VisitModifiers(visitor, Node_Modifiers(Node_AsNode(node)));
    const parameters = EmitContext_VisitParameters(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_ParameterList(Node_AsNode(node)), visitor);
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitConstructorBody(receiver, body, constructor_) {
    const parameterProperties = RuntimeSyntaxTransformer_getParameterProperties(receiver, constructor_);
    if (parameterProperties.length === 0) {
        return EmitContext_VisitFunctionBody(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_AsNode(body), Transformer_Visitor(receiver.__tsgoEmbedded0));
    }
    ...
    let parameterPropertyAssignments = [];
    for (const parameter of parameterProperties) {
        if (IsIdentifier(Node_Name(Node_AsNode(parameter)))) {
            const innerFactory = factory.__tsgoEmbedded0;
            const paramName = Node_Name(Node_AsNode(parameter));
            const propertyName = Node_Clone(paramName, { AsNodeFactory: () => innerFactory });
            ...
            const localName = Node_Clone(paramName, { AsNodeFactory: () => innerFactory });
            ...
            const parameterProperty = NewExpressionStatement(innerFactory, NodeFactory_NewAssignmentExpression(factory, NewPropertyAccessExpression(innerFactory, NodeFactory_NewThisExpression(factory), undefined /*questionDotToken*/, propertyName, NodeFlagsNone), localName));
            EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), parameterProperty, Node_AsNode(parameter));
    ...
    if (superPath.length > 0) {
        ...
        const [visitedRest] = NodeVisitor_VisitSlice(Transformer_Visitor(receiver.__tsgoEmbedded0), rest);
 ...
 * }
 */
export function RuntimeSyntaxTransformer_transformConstructorBodyWorker(receiver, statementsIn, superPath, initializerStatements) {
    let statementsOut = [];
    ...
    const [visitedBefore] = NodeVisitor_VisitSlice(visitor, statementsIn.slice(0, superStatementIndex));
    statementsOut = [...statementsOut, ...visitedBefore];
    // if the statement containing `super` is a `try` statement, transform the body of the `try` block
    if (IsTryStatement(superStatement)) {
        const tryStatement = AsTryStatement(superStatement);
        ...
        // visit the `try` block
        const tryBlockStatements = RuntimeSyntaxTransformer_transformConstructorBodyWorker(receiver, tryBlock.Statements.Nodes, superPath.slice(1), initializerStatements);
        ...
        statementsOut = [
            ...statementsOut,
            NodeFactory_UpdateTryStatement(factory.__tsgoEmbedded0, tryStatement, NodeFactory_UpdateBlock(factory.__tsgoEmbedded0, tryBlock, tryBlockStatementList, tryBlock.MultiLine), NodeVisitor_VisitNode(visitor, tryStatement.CatchClause), NodeVisitor_VisitNode(visitor, tryStatement.FinallyBlock)),
        ];
        ...
        const [visitedSuper] = NodeVisitor_VisitSlice(visitor, statementsIn.slice(superStatementIndex, superStatementIndex + 1));
        statementsOut = [...statementsOut, ...visitedSuper];
        // insert the initializer statements
        statementsOut = [...statementsOut, ...initializerStatements];
    }
    // visit the statements after `super`
    const [visitedAfter] = NodeVisitor_VisitSlice(visitor, statementsIn.slice(superStatementIndex + 1));
    statementsOut = [...statementsOut, ...visitedAfter];
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitShorthandPropertyAssignment(receiver, node) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const name = Node_Name(Node_AsNode(node));
    ...
    if (exportedOrImportedName !== name) {
        ...
        if (node.ObjectAssignmentInitializer !== undefined) {
            ...
            expression = NewBinaryExpression(astFactory, undefined /*modifiers*/, expression, undefined /*typeNode*/, equalsToken, NodeVisitor_VisitNode(visitor, node.ObjectAssignmentInitializer));
        }
    ...
    return NodeFactory_UpdateShorthandPropertyAssignment(factory.__tsgoEmbedded0, node, undefined /*modifiers*/, exportedOrImportedName, undefined /*postfixToken*/, undefined /*typeNode*/, node.EqualsToken, NodeVisitor_VisitNode(visitor, node.ObjectAssignmentInitializer));
}
/**
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitIdentifier(receiver, node) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_visitExpressionIdentifier(receiver, node) {
    if ((receiver.currentEnum !== undefined || receiver.currentNamespace !== undefined) &&
        ...
        const location = EmitContext_MostOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), node);
        const container = receiver.resolver.GetReferencedExportContainer(location, false /*prefixLocals*/);
        if (container !== undefined && (IsEnumDeclaration(container) || IsModuleDeclaration(container))) {
            ...
            const coercible = { AsNodeFactory: () => f };
            const memberName = Node_Clone(node, coercible);
            EmitContext_SetEmitFlags(Transformer_EmitContext(receiver.__tsgoEmbedded0), memberName, EFNoComments | EFNoSourceMap);
            const expression = NodeFactory_GetNamespaceMemberName(Transformer_Factory(receiver.__tsgoEmbedded0), containerName, memberName, { AllowComments: false, AllowSourceMaps: true });
            EmitContext_AssignCommentAndSourceMapRanges(Transformer_EmitContext(receiver.__tsgoEmbedded0), expression, node);
            return expression;
        }
    }
    return node;
 ...
 * }
 */
export function RuntimeSyntaxTransformer_createExportStatementForDeclaration(receiver, node) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_createExportAssignment(receiver, name, expression, exportAssignmentSourceMapRange, original) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_createExportStatement(receiver, name, expression, exportAssignmentSourceMapRange, exportStatementSourceMapRange, original) {
 ...
 * }
 */
export function RuntimeSyntaxTransformer_shouldEmitEnumDeclaration(receiver, node) {
    return (!IsEnumConst(EnumDeclaration_as_nodeData(node).AsNode()) || CompilerOptions_ShouldPreserveConstEnums(receiver.compilerOptions));
}
/**
 ...
 * }
 */
export function RuntimeSyntaxTransformer_shouldEmitModuleDeclaration(receiver, node) {
    ...
    return IsInstantiatedModule(pn, CompilerOptions_ShouldPreserveConstEnums(receiver.compilerOptions));
}
/**
...
//# sourceMappingURL=runtimesyntax.js.map