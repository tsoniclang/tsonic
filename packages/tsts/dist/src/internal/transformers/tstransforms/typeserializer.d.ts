 ...
 * }
 */
export declare function newMetadataSerializer(resolver: EmitResolver, f: GoPtr<NodeFactory>, ec: GoPtr<EmitContext>, strictNullChecks: bool): GoPtr<metadataSerializer>;
/**
