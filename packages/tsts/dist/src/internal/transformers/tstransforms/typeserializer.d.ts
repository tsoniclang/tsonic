 ...
 * }
 */
export declare function newMetadataSerializer(resolver: EmitResolver, f: GoPtr<NodeFactory>, ec: GoPtr<EmitContext>, languageVersion: ScriptTarget, strictNullChecks: bool): GoPtr<metadataSerializer>;
/**
 ...
 * }
 */
export declare function metadataSerializer_setContext(receiver: GoPtr<metadataSerializer>, ctx: metadataSerializerContext): void;
/**
 ...
 * }
 */
export declare function metadataSerializer_SerializeTypeOfNode(receiver: GoPtr<metadataSerializer>, ctx: metadataSerializerContext, node: GoPtr<Node>, container: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_SerializeParameterTypesOfNode(receiver: GoPtr<metadataSerializer>, ctx: metadataSerializerContext, node: GoPtr<Node>, container: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_SerializeReturnTypeOfNode(receiver: GoPtr<metadataSerializer>, ctx: metadataSerializerContext, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function GetSetAccessorValueParameter(node: GoPtr<SetAccessorDeclaration>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function getSetAccessorTypeAnnotationNode(node: GoPtr<SetAccessorDeclaration>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function getAccessorTypeNode(node: GoPtr<Node>, container: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_serializeTypeOfNode(receiver: GoPtr<metadataSerializer>, node: GoPtr<Node>, container: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_serializeParameterTypesOfNode(receiver: GoPtr<metadataSerializer>, node: GoPtr<Node>, container: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function getParametersOfDecoratedDeclaration(node: GoPtr<Node>, container: GoPtr<Node>): GoPtr<NodeList>;
/**
 ...
 * }
 */
export declare function metadataSerializer_serializeReturnTypeOfNode(receiver: GoPtr<metadataSerializer>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_serializeTypeNode(receiver: GoPtr<metadataSerializer>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_serializeUnionOrIntersectionConstituents(receiver: GoPtr<metadataSerializer>, types: GoSlice<GoPtr<Node>>, isIntersection: bool): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_serializeLiteralOfLiteralTypeNode(receiver: GoPtr<metadataSerializer>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_serializeTypeReferenceNode(receiver: GoPtr<metadataSerializer>, node: GoPtr<TypeReferenceNode>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_serializeBigIntConstructor(receiver: GoPtr<metadataSerializer>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_serializeEntityNameAsExpression(receiver: GoPtr<metadataSerializer>, node: GoPtr<EntityName>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_serializeQualifiedNameAsExpression(receiver: GoPtr<metadataSerializer>, node: GoPtr<QualifiedName>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_serializeEntityNameAsExpressionFallback(receiver: GoPtr<metadataSerializer>, node: GoPtr<EntityName>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_createCheckedValue(receiver: GoPtr<metadataSerializer>, left: GoPtr<Node>, right: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function metadataSerializer_equateSerializedTypeNodes(receiver: GoPtr<metadataSerializer>, left: GoPtr<Node>, right: GoPtr<Node>): bool;
