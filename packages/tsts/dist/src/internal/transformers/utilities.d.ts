 ...
 * }
 */
export declare function IsGeneratedIdentifier(emitContext: GoPtr<EmitContext>, name: GoPtr<IdentifierNode>): bool;
/**
 ...
 * }
 */
export declare function IsHelperName(emitContext: GoPtr<EmitContext>, name: GoPtr<IdentifierNode>): bool;
/**
 ...
 * }
 */
export declare function IsLocalName(emitContext: GoPtr<EmitContext>, name: GoPtr<IdentifierNode>): bool;
/**
 ...
 * }
 */
export declare function IsExportName(emitContext: GoPtr<EmitContext>, name: GoPtr<IdentifierNode>): bool;
/**
 ...
 * }
 */
export declare function IsIdentifierReference(name: GoPtr<IdentifierNode>, parent: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function convertBindingElementToArrayAssignmentElement(emitContext: GoPtr<EmitContext>, element: GoPtr<BindingElement>): GoPtr<Expression>;
/**
 ...
 * }
 */
export declare function convertBindingElementToObjectAssignmentElement(emitContext: GoPtr<EmitContext>, element: GoPtr<BindingElement>): GoPtr<ObjectLiteralElement>;
/**
 ...
 * }
 */
export declare function ConvertBindingPatternToAssignmentPattern(emitContext: GoPtr<EmitContext>, element: GoPtr<BindingPattern>): GoPtr<Expression>;
/**
 ...
 * }
 */
export declare function convertBindingElementToObjectAssignmentPattern(emitContext: GoPtr<EmitContext>, element: GoPtr<BindingPattern>): GoPtr<Expression>;
/**
 ...
 * }
 */
export declare function convertBindingElementToArrayAssignmentPattern(emitContext: GoPtr<EmitContext>, element: GoPtr<BindingPattern>): GoPtr<Expression>;
/**
 ...
 * }
 */
export declare function convertBindingNameToAssignmentElementTarget(emitContext: GoPtr<EmitContext>, element: GoPtr<Node>): GoPtr<Expression>;
/**
 ...
 * }
 */
export declare function ConvertVariableDeclarationToAssignmentExpression(emitContext: GoPtr<EmitContext>, element: GoPtr<VariableDeclaration>): GoPtr<Expression>;
/**
 ...
 * }
 */
export declare function SingleOrMany(nodes: GoSlice<GoPtr<Node>> | undefined, factory: GoPtr<NodeFactory>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function IsSimpleCopiableExpression(expression: GoPtr<Expression>): bool;
/**
 ...
 * }
 */
export declare function IsOriginalNodeSingleLine(emitContext: GoPtr<EmitContext>, node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function IsSimpleInlineableExpression(expression: GoPtr<Expression>): bool;
/**
 ...
 * }
 */
export declare function FindSuperStatementIndexPath(statements: GoSlice<GoPtr<Statement>>, start: int): GoSlice<int>;
/**
 ...
 * }
 */
export declare function findSuperStatementIndexPathWorker(statements: GoSlice<GoPtr<Statement>>, start: int, indices: GoSlice<int>): GoSlice<int>;
/**
 ...
 * }
 */
export declare function GetSuperCallFromStatement(statement: GoPtr<Statement>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function MoveRangePastModifiers(node: GoPtr<Node>): TextRange;
/**
 ...
 * }
 */
export declare function MoveRangePastDecorators(node: GoPtr<Node>): TextRange;
/**
 ...
 * }
 */
export declare function GetNonAssignmentOperatorForCompoundAssignment(kind: Kind): Kind;
