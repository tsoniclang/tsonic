...
import { NewArrayLiteralExpression, NewObjectLiteralExpression, NewOmittedExpression, NewPropertyAssignment, NewShorthandPropertyAssignment, NewSpreadAssignment, NewSpreadElement, NewSyntaxList, NewToken, } from "../ast/generated/factory.js";
import { KindAmpersandAmpersandEqualsToken, KindAmpersandAmpersandToken, KindAmpersandEqualsToken, KindAmpersandToken, KindArrowFunction, KindArrayLiteralExpression, KindAsteriskAsteriskEqualsToken, KindAsteriskAsteriskToken, KindAsteriskEqualsToken, KindAsteriskToken, KindAwaitExpression, KindAsExpression, KindBarBarEqualsToken, KindBarBarToken, KindBarEqualsToken, KindBarToken, KindBinaryExpression, KindBindingElement, KindCallExpression, KindCaretEqualsToken, KindCaretToken, KindCaseClause, KindComputedPropertyName, KindConditionalExpression, KindDecorator, KindDeleteExpression, KindDoStatement, KindElementAccessExpression, KindEnumMember, KindEqualsToken, KindExportAssignment, KindExpressionStatement, KindExpressionWithTypeArguments, KindForInStatement, KindForOfStatement, KindForStatement, KindGreaterThanGreaterThanEqualsToken, KindGreaterThanGreaterThanGreaterThanEqualsToken, KindGreaterThanGreaterThanGreaterThanToken, KindGreaterThanGreaterThanToken, KindIfStatement, KindImportAttribute, KindJsxAttribute, KindJsxClosingElement, KindJsxExpression, KindJsxOpeningElement, KindJsxSelfClosingElement, KindJsxSpreadAttribute, KindLessThanLessThanEqualsToken, KindLessThanLessThanToken, KindMinusEqualsToken, KindMinusToken, KindNewExpression, KindNonNullExpression, KindParameter, KindParenthesizedExpression, KindPartiallyEmittedExpression, KindPercentEqualsToken, KindPercentToken, KindPlusEqualsToken, KindPlusToken, KindPostfixUnaryExpression, KindPrefixUnaryExpression, KindPropertyAccessExpression, KindPropertyAssignment, KindPropertyDeclaration, KindPropertySignature, KindQuestionQuestionEqualsToken, KindQuestionQuestionToken, KindReturnStatement, KindSatisfiesExpression, KindShorthandPropertyAssignment, KindSlashEqualsToken, KindSlashToken, KindSpreadAssignment, KindSpreadElement, KindSwitchStatement, KindTaggedTemplateExpression, KindTemplateSpan, KindThrowStatement, KindTypeAssertionExpression, KindTypeOfExpression, KindVariableDeclaration, KindVoidExpression, KindWhileStatement, KindWithStatement, KindYieldExpression, KindImportEqualsDeclaration, KindArrayBindingPattern, KindObjectBindingPattern, } from "../ast/generated/kinds.js";
import { IsDecorator, IsExpressionStatement, IsIdentifier, IsKeywordKind, IsMethodDeclaration, IsNumericLiteral, IsPropertyDeclaration, IsTryStatement, } from "../ast/generated/predicates.js";
import { AsBindingElement, AsBindingPattern, AsConditionalExpression, AsForStatement, AsImportAttribute, AsImportEqualsDeclaration, AsShorthandPropertyAssignment, AsTaggedTemplateExpression, AsTryStatement, AsVariableDeclaration, } from "../ast/generated/casts.js";
import { CanHaveModifiers, GetSourceFileOfNode, IsBindingPattern, IsStringLiteralLike, IsSuperCall, PositionIsSynthesized, SkipParentheses, } from "../ast/utilities.js";
import { Node_Arguments, Node_Body, Node_Expression, Node_Initializer, Node_ModifierNodes, Node_Statements, Node_TagName, SourceFile_ECMALineMap, SourceFile_Text, } from "../ast/ast.js";
import { FindLast, LastOrNil } from "../core/core.js";
import { GetECMALineOfPosition } from "../scanner/scanner.js";
import { NewTextRange } from "../core/text.js";
import { EmitContext_AssignCommentAndSourceMapRanges, EmitContext_EmitFlags, EmitContext_HasAutoGenerateInfo, EmitContext_MostOriginal, EmitContext_SetOriginal, } from "../printer/emitcontext.js";
 ...
 * }
 */
export function IsGeneratedIdentifier(emitContext, name) {
 ...
 * }
 */
export function IsHelperName(emitContext, name) {
 ...
 * }
 */
export function IsLocalName(emitContext, name) {
 ...
 * }
 */
export function IsExportName(emitContext, name) {
 ...
 * }
 */
export function IsIdentifierReference(name, parent) {
    switch (parent.Kind) {
        ...
        case KindTemplateSpan:
            return Node_Expression(parent) === name;
        ...
        case KindJsxAttribute:
            return Node_Initializer(parent) === name;
        case KindShorthandPropertyAssignment:
            return AsShorthandPropertyAssignment(parent).ObjectAssignmentInitializer === name;
        case KindForStatement:
            return (Node_Initializer(parent) === name ||
                AsForStatement(parent).Condition === name ||
                AsForStatement(parent).Incrementor === name);
        case KindForInStatement:
        case KindForOfStatement:
            return (Node_Initializer(parent) === name ||
                Node_Expression(parent) === name);
        case KindImportEqualsDeclaration:
            return AsImportEqualsDeclaration(parent).ModuleReference === name;
        case KindArrowFunction:
            return Node_Body(parent) === name;
        case KindConditionalExpression:
            return (AsConditionalExpression(parent).Condition === name ||
                AsConditionalExpression(parent).WhenTrue === name ||
                AsConditionalExpression(parent).WhenFalse === name);
        case KindCallExpression:
        case KindNewExpression: {
            const args = Node_Arguments(parent);
            return (Node_Expression(parent) === name ||
                (args !== undefined && args.includes(name)));
        }
        case KindTaggedTemplateExpression:
            return AsTaggedTemplateExpression(parent).Tag === name;
        case KindImportAttribute:
            return AsImportAttribute(parent).Value === name;
        case KindJsxOpeningElement:
        case KindJsxClosingElement:
            return Node_TagName(parent) === name;
        default:
            return false;
    }
}
 ...
 * }
 */
export function convertBindingElementToArrayAssignmentElement(emitContext, element) {
    ...
    if (element.DotDotDotToken !== undefined) {
        const spread = NewSpreadElement(af, element.name);
    ...
    const expression = convertBindingNameToAssignmentElementTarget(emitContext, element.name);
 ...
 * }
 */
export function convertBindingElementToObjectAssignmentElement(emitContext, element) {
    const af = emitContext.Factory.__tsgoEmbedded0;
    const elementNode = element;
    if (element.DotDotDotToken !== undefined) {
        const spread = NewSpreadAssignment(af, element.name);
        EmitContext_SetOriginal(emitContext, spread, elementNode);
        EmitContext_AssignCommentAndSourceMapRanges(emitContext, spread, elementNode);
        return spread;
    }
    if (element.PropertyName !== undefined) {
        let expression = convertBindingNameToAssignmentElementTarget(emitContext, element.name);
        if (element.Initializer !== undefined) {
    ...
    const assignment = NewShorthandPropertyAssignment(af, undefined, element.name, undefined, undefined, equalsToken, element.Initializer);
    EmitContext_SetOriginal(emitContext, assignment, elementNode);
    EmitContext_AssignCommentAndSourceMapRanges(emitContext, assignment, elementNode);
    return assignment;
}
 ...
 * }
 */
export function ConvertBindingPatternToAssignmentPattern(emitContext, element) {
    switch (element.Kind) {
 ...
 * }
 */
export function convertBindingElementToObjectAssignmentPattern(emitContext, element) {
    const af = emitContext.Factory.__tsgoEmbedded0;
    const elementNode = element;
    const properties = element.Elements.Nodes.map((n) => convertBindingElementToObjectAssignmentElement(emitContext, AsBindingElement(n)));
    const propertyList = NodeFactory_NewNodeList(af, properties);
    propertyList.Loc = element.Elements.Loc;
 ...
 * }
 */
export function convertBindingElementToArrayAssignmentPattern(emitContext, element) {
    const af = emitContext.Factory.__tsgoEmbedded0;
    const elementNode = element;
    const elements = element.Elements.Nodes.map((n) => convertBindingElementToArrayAssignmentElement(emitContext, AsBindingElement(n)));
    const elementList = NodeFactory_NewNodeList(af, elements);
    elementList.Loc = element.Elements.Loc;
 ...
 * }
 */
export function convertBindingNameToAssignmentElementTarget(emitContext, element) {
 ...
 * }
 */
export function ConvertVariableDeclarationToAssignmentExpression(emitContext, element) {
    if (element.Initializer === undefined) {
        return undefined;
    }
    const expression = convertBindingNameToAssignmentElementTarget(emitContext, element.name);
    const assignment = NodeFactory_NewAssignmentExpression(emitContext.Factory, expression, element.Initializer);
    EmitContext_SetOriginal(emitContext, assignment, element);
    EmitContext_AssignCommentAndSourceMapRanges(emitContext, assignment, element);
    return assignment;
}
/**
 ...
 * }
 */
export function SingleOrMany(nodes, factory) {
    if (nodes === undefined) {
        return undefined;
    }
    if (nodes.length === 1) {
 ...
 * }
 */
export function IsSimpleCopiableExpression(expression) {
 ...
 * }
 */
export function IsOriginalNodeSingleLine(emitContext, node) {
    if (node === undefined) {
        return false;
    }
    ...
    const sourceFileLike = { Text: () => SourceFile_Text(source), ECMALineMap: () => SourceFile_ECMALineMap(source) };
 ...
 * }
 */
export function IsSimpleInlineableExpression(expression) {
 ...
 * }
 */
export function FindSuperStatementIndexPath(statements, start) {
 ...
 * }
 */
export function findSuperStatementIndexPathWorker(statements, start, indices) {
    for (let i = start; i < statements.length; i++) {
        ...
        if (GetSuperCallFromStatement(statement) !== undefined) {
            ...
            const tryStmt = AsTryStatement(statement);
            const tryBlockStmts = Node_Statements(tryStmt.TryBlock);
            if (tryBlockStmts !== undefined) {
                const result = findSuperStatementIndexPathWorker(tryBlockStmts, 0, indices);
                if (result !== undefined) {
                    return [...result, i];
                }
            }
 ...
 * }
 */
export function GetSuperCallFromStatement(statement) {
    if (!IsExpressionStatement(statement)) {
        return undefined;
    }
    const expression = SkipParentheses(Node_Expression(statement));
 ...
 * }
 */
export function MoveRangePastDecorators(node) {
    let lastDecorator = undefined;
    if (CanHaveModifiers(node)) {
 ...
 * }
 */
export function GetNonAssignmentOperatorForCompoundAssignment(kind) {
    switch (kind) {
