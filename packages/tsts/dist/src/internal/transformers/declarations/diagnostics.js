import { KindArrayLiteralExpression, KindArrowFunction, KindBinaryExpression, KindBindingElement, KindCallSignature, KindClassDeclaration, KindComputedPropertyName, KindConstructor, KindConstructSignature, KindConstructorType, KindElementAccessExpression, KindExportAssignment, KindFunctionDeclaration, KindFunctionExpression, KindFunctionType, KindGetAccessor, KindImplementsKeyword, KindIndexSignature, KindInferType, KindInterfaceDeclaration, KindJSTypeAliasDeclaration, KindMappedType, KindMethodDeclaration, KindMethodSignature, KindParameter, KindPropertyAccessExpression, KindPropertyDeclaration, KindPropertySignature, KindSetAccessor, KindShorthandPropertyAssignment, KindSpreadAssignment, KindSpreadElement, KindTypeAliasDeclaration, KindVariableDeclaration, KindClassExpression, KindPropertyAssignment, } from "../../ast/generated/kinds.js";
import { AsExportAssignment, AsHeritageClause, } from "../../ast/generated/casts.js";
import { IsBindingElement, IsBinaryExpression, IsCallExpression, IsClassDeclaration, IsConstructorDeclaration, IsConstructSignatureDeclaration, IsCallSignatureDeclaration, IsElementAccessExpression, IsExportAssignment, IsExpressionWithTypeArguments, IsFunctionDeclaration, IsGetAccessorDeclaration, IsHeritageClause, IsImportEqualsDeclaration, IsIndexSignatureDeclaration, IsJSTypeAliasDeclaration, IsMethodDeclaration, IsMethodSignatureDeclaration, IsParameterDeclaration, IsParenthesizedExpression, IsPropertyAccessExpression, IsPropertyDeclaration, IsPropertySignatureDeclaration, IsReturnStatement, IsSetAccessorDeclaration, IsTypeAliasDeclaration, IsTypeParameterDeclaration, IsTypeQueryNode, IsVariableDeclaration, } from "../../ast/generated/predicates.js";
import { IsAssertionExpression, IsEntityName, IsEntityNameExpression, IsPartOfTypeNode, FindAncestor, FindAncestorOrQuit, FindAncestorTrue, FindAncestorQuit, ToFindAncestorResult, GetNameOfDeclaration, HasSyntacticModifier, IsFunctionLikeDeclaration, IsParameterPropertyDeclaration, IsStatement, IsStatic, GetAllAccessorDeclarationsForDeclaration, } from "../../ast/utilities.js";
 ...
 * }
 */
export function wrapSimpleDiagnosticSelector(node, selector) {
 ...
 * }
 */
export function wrapNamedDiagnosticSelector(node, selector) {
    return (symbolAccessibilityResult) => {
        const diagnosticMessage = selector(node, symbolAccessibilityResult);
        if (diagnosticMessage === undefined) {
            return undefined;
 ...
 * }
 */
export function wrapFallbackErrorDiagnosticSelector(node, selector) {
    return (symbolAccessibilityResult) => {
        const diagnosticMessage = selector(node, symbolAccessibilityResult);
        if (diagnosticMessage === undefined) {
            return undefined;
 ...
 * }
 */
export function selectDiagnosticBasedOnModuleName(symbolAccessibilityResult, moduleNotNameable, privateModule, nonModule) {
 ...
 * }
 */
export function selectDiagnosticBasedOnModuleNameNoNameCheck(symbolAccessibilityResult, privateModule, nonModule) {
    if (symbolAccessibilityResult.ErrorModuleName.length > 0) {
        return privateModule;
    }
    return nonModule;
 ...
 * }
 */
export function createGetSymbolAccessibilityDiagnosticForNodeName(node) {
 ...
 * }
 */
export function getAccessorNameVisibilityDiagnosticMessage(node, symbolAccessibilityResult) {
    if (IsStatic(node)) {
 ...
 * }
 */
export function getMethodNameVisibilityDiagnosticMessage(node, symbolAccessibilityResult) {
    if (IsStatic(node)) {
 ...
 * }
 */
export function createGetSymbolAccessibilityDiagnosticForNode(node) {
    if (IsVariableDeclaration(node) || IsPropertyDeclaration(node) || IsPropertySignatureDeclaration(node) || IsPropertyAccessExpression(node) || IsElementAccessExpression(node) || IsBinaryExpression(node) || IsBindingElement(node) || IsConstructorDeclaration(node)) {
        ...
        return wrapSimpleDiagnosticSelector(node, (_, _2) => {
            return diagnostics.Import_declaration_0_is_using_private_name_1;
        });
    }
    else if (IsTypeAliasDeclaration(node) || IsJSTypeAliasDeclaration(node)) {
        return (symbolAccessibilityResult) => {
            const diagnosticMessage = selectDiagnosticBasedOnModuleNameNoNameCheck(symbolAccessibilityResult, diagnostics.Exported_type_alias_0_has_or_is_using_private_name_1_from_module_2, diagnostics.Exported_type_alias_0_has_or_is_using_private_name_1);
        ...
        // JS object.defineProperty call
        return (symbolAccessibilityResult) => {
            const diagnosticMessage = selectDiagnosticBasedOnModuleName(symbolAccessibilityResult, diagnostics.Exported_variable_0_has_or_is_using_name_1_from_external_module_2_but_cannot_be_named, diagnostics.Exported_variable_0_has_or_is_using_name_1_from_private_module_2, diagnostics.Exported_variable_0_has_or_is_using_private_name_1);
 ...
 * }
 */
export function getVariableDeclarationTypeVisibilityDiagnosticMessage(node, symbolAccessibilityResult) {
 ...
 * }
 */
export function getAccessorDeclarationTypeVisibilityDiagnosticMessage(node, symbolAccessibilityResult) {
 ...
 * }
 */
export function getReturnTypeVisibilityDiagnosticMessage(node, symbolAccessibilityResult) {
    switch (node.Kind) {
 ...
 * }
 */
export function getParameterDeclarationTypeVisibilityDiagnosticMessage(node, symbolAccessibilityResult) {
    switch (node.Parent.Kind) {
 ...
 * }
 */
export function getTypeParameterConstraintVisibilityDiagnosticMessage(node, symbolAccessibilityResult) {
    // Type parameter constraints are named by user so we should always be able to name it
    switch (node.Parent.Kind) {
 ...
 * }
 */
export function getRelatedSuggestionByDeclarationKind(kind) {
    switch (kind) {
 ...
 * }
 */
export function getErrorByDeclarationKind(kind) {
    switch (kind) {
        case KindFunctionExpression:
            return diagnostics.Function_must_have_an_explicit_return_type_annotation_with_isolatedDeclarations;
        case KindFunctionDeclaration:
 ...
 * }
 */
export function isDeclarationEnoughForErrors(node) {
 ...
 * }
 */
export function isFunctionLikeAndNotConstructor(node) {
 ...
 * }
 */
export function findNearestDeclaration(node) {
 ...
 * }
 */
export function createEntityInTypeNodeError(node) {
 ...
 * }
 */
export function addParentDeclarationRelatedInfo(node, diag) {
 ...
 * }
 */
export function createAccessorTypeError(node) {
    const allDeclarations = GetAllAccessorDeclarationsForDeclaration(node, Node_Symbol(node).Declarations ?? []);
    ...
    if (setAccessor !== undefined) {
        Diagnostic_AddRelatedInfo(diag, NewDiagnosticForNode(setAccessor, getRelatedSuggestionByDeclarationKind(setAccessor.Kind)));
    }
    if (getAccessor !== undefined) {
        Diagnostic_AddRelatedInfo(diag, NewDiagnosticForNode(getAccessor, getRelatedSuggestionByDeclarationKind(getAccessor.Kind)));
    }
    return diag;
}
/**
 ...
 * }
 */
export function createObjectLiteralError(node) {
 ...
 * }
 */
export function createArrayLiteralError(node) {
    const diag = NewDiagnosticForNode(node, getErrorByDeclarationKind(node.Kind));
    addParentDeclarationRelatedInfo(node, diag);
    return diag;
}
 ...
 * }
 */
export function createReturnTypeError(node) {
    const diag = NewDiagnosticForNode(node, getErrorByDeclarationKind(node.Kind));
    addParentDeclarationRelatedInfo(node, diag);
 ...
 * }
 */
export function createBindingElementError(node) {
 ...
 * }
 */
export function createVariableOrPropertyError(node) {
    const diag = NewDiagnosticForNode(node, getErrorByDeclarationKind(node.Kind));
 ...
 * }
 */
export function createExpressionError(node) {
 ...
 * }
 */
export function createClassExpressionError(node) {
    return createExpressionErrorEx(node, diagnostics.Inference_from_class_expressions_is_not_supported_with_isolatedDeclarations);
}
/**
 ...
 * }
 */
export function isParentForIDDIagnostic(node) {
 ...
 * }
 */
export function createExpressionErrorEx(node, diagnosticMessage) {
    const parentDeclaration = findNearestDeclaration(node);
    if (parentDeclaration === undefined) {
 ...
 * }
 */
export function createGetIsolatedDeclarationErrors(resolver) {
    const createParameterError = (node) => {
