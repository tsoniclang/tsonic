 ...
 * }
 */
export declare function needsScopeMarker(result: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function canHaveLiteralInitializer(host: DeclarationEmitHost, node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function canProduceDiagnostics(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isDeclarationAndNotVisible(emitContext: GoPtr<EmitContext>, resolver: EmitResolver, node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function getBindingNameVisible(resolver: EmitResolver, elem: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isEnclosingDeclaration(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isAlwaysType(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function maskModifierFlags(host: DeclarationEmitHost, node: GoPtr<Node>, modifierMask: ModifierFlags, modifierAdditions: ModifierFlags): ModifierFlags;
/**
 ...
 * }
 */
export declare function unwrapParenthesizedExpression(o: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function isPrivateMethodTypeParameter(host: DeclarationEmitHost, node: GoPtr<TypeParameterDeclaration>): bool;
/**
 ...
 * }
 */
export declare function shouldEmitFunctionProperties(input: GoPtr<FunctionDeclaration>): bool;
/**
 ...
 * }
 */
export declare function getEffectiveBaseTypeNode(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function isScopeMarker(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function hasScopeMarker(statements: GoPtr<StatementList>): bool;
