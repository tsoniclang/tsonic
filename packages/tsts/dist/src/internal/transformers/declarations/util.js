 ...
 * }
 */
export function maskModifierFlags(host, node, modifierMask, modifierAdditions) {
    let flags = (host.GetEffectiveDeclarationFlags(node, modifierMask) | modifierAdditions) >>> 0;
