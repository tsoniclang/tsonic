...
import { type GetSymbolAccessibilityDiagnostic } from "./diagnostics.js";
 ...
 * }
 */
export declare function SymbolTrackerImpl_PopErrorFallbackNode(receiver: GoPtr<SymbolTrackerImpl>): void;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_PushErrorFallbackNode(receiver: GoPtr<SymbolTrackerImpl>, node: GoPtr<Node>): void;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_ReportCyclicStructureError(receiver: GoPtr<SymbolTrackerImpl>): void;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_ReportInaccessibleThisError(receiver: GoPtr<SymbolTrackerImpl>): void;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_ReportInaccessibleUniqueSymbolError(receiver: GoPtr<SymbolTrackerImpl>): void;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_ReportInferenceFallback(receiver: GoPtr<SymbolTrackerImpl>, node: GoPtr<Node>): void;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_ReportLikelyUnsafeImportRequiredError(receiver: GoPtr<SymbolTrackerImpl>, specifier: string, symbolName: string): void;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_ReportNonSerializableProperty(receiver: GoPtr<SymbolTrackerImpl>, propertyName: string): void;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_ReportNonlocalAugmentation(receiver: GoPtr<SymbolTrackerImpl>, containingFile: GoPtr<SourceFile>, parentSymbol: GoPtr<Symbol>, augmentingSymbol: GoPtr<Symbol>): void;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_ReportPrivateInBaseOfClassExpression(receiver: GoPtr<SymbolTrackerImpl>, propertyName: string): void;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_ReportTruncationError(receiver: GoPtr<SymbolTrackerImpl>): void;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_errorFallbackNode(receiver: GoPtr<SymbolTrackerImpl>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_errorLocation(receiver: GoPtr<SymbolTrackerImpl>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_errorDeclarationNameWithFallback(receiver: GoPtr<SymbolTrackerImpl>): string;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_TrackSymbol(receiver: GoPtr<SymbolTrackerImpl>, symbol_: GoPtr<Symbol>, enclosingDeclaration: GoPtr<Node>, meaning: SymbolFlags): bool;
/**
 ...
 * }
 */
export declare function SymbolTrackerImpl_handleSymbolAccessibilityError(receiver: GoPtr<SymbolTrackerImpl>, symbolAccessibilityResult: SymbolAccessibilityResult): bool;
/**
 ...
 * }
 */
export declare function SymbolTrackerSharedState_addDiagnostic(receiver: GoPtr<SymbolTrackerSharedState>, diag: GoPtr<Diagnostic>): void;
/**
 ...
 * }
 */
export declare function NewSymbolTracker(host: DeclarationEmitHost, resolver: EmitResolver, state: GoPtr<SymbolTrackerSharedState>): GoPtr<SymbolTrackerImpl>;
/**
 ...
 */
export declare function SymbolTrackerImpl_AsSymbolTracker(receiver: GoPtr<SymbolTrackerImpl>): SymbolTracker;
