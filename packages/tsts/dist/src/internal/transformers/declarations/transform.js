...
import { createGetSymbolAccessibilityDiagnosticForNode, createGetSymbolAccessibilityDiagnosticForNodeName } from "./diagnostics.js";
 ...
 * }
 */
export function NewDeclarationTransformer(host, context, compilerOptions, declarationFilePath, declarationMapPath) {
 ...
 * }
 */
export function DeclarationTransformer_GetDiagnostics(receiver) {
 ...
 * }
 */
export function DeclarationTransformer_shouldStripInternal(receiver, node) {
    return (receiver.state.stripInternal && node !== undefined && DeclarationTransformer_isInternalDeclaration(receiver, node, receiver.state.currentSourceFile));
}
/**
 ...
 * }
 */
export function DeclarationTransformer_isInternalDeclaration(receiver, node, sourceFile) {
    if (node === undefined) {
        return false;
    }
    ...
    if (parseTreeNode.Kind === KindParameter) {
        ...
        if (previousSibling !== undefined) {
            ...
            GetTrailingCommentRanges(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, text, trailingPos)((comment) => { commentRanges = [...commentRanges, comment]; return true; });
            GetLeadingCommentRanges(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, text, Node_Pos(node))((comment) => { commentRanges = [...commentRanges, comment]; return true; });
        }
        else {
    ...
    let found = false;
    DeclarationTransformer_getLeadingCommentRangesOfNode(receiver, parseTreeNode, sourceFile)((commentRange) => {
        if (hasInternalAnnotation(commentRange, sourceFile)) {
            found = true;
            return true;
        }
 ...
 * }
 */
export function DeclarationTransformer_getLeadingCommentRangesOfNode(receiver, node, sourceFile) {
 ...
 * }
 */
export function hasInternalAnnotation(commentRange, sourceFile) {
 ...
 */
export const declarationEmitNodeBuilderFlags = (FlagsMultilineObjectLiterals |
 ...
 */
export const declarationEmitInternalNodeBuilderFlags = InternalFlagsAllowUnresolvedNames;
/**
 ...
 * }
 */
export function DeclarationTransformer_visit(receiver, node) {
    if (node === undefined) {
        return undefined;
    }
    switch (node.Kind) {
 ...
 * }
 */
export function throwDiagnostic(result) {
 ...
 * }
 */
export function DeclarationTransformer_visitSourceFile(receiver, node) {
    if (node.IsDeclarationFile) {
        return node;
    }
 ...
 * }
 */
export function DeclarationTransformer_collectFileReferences(receiver, sourceFile) {
    receiver.rawReferencedFiles = [
        ...receiver.rawReferencedFiles,
        ...Map(sourceFile.ReferencedFiles, (ref) => ({ file: sourceFile, ref: ref })),
    ];
 ...
 * }
 */
export function DeclarationTransformer_transformSourceFile(receiver, node) {
    ...
    const statements = NodeVisitor_VisitNodes(visitor, node.Statements);
...
export function createEmptyExports(factory) {
    return NewExportDeclaration(factory, undefined, false, NewNamedExports(factory, NodeFactory_NewNodeList(factory, [])), undefined, undefined);
}
/**
 ...
 * }
 */
export function DeclarationTransformer_transformAndReplaceLatePaintedStatements(receiver, statements) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    while (true) {
        ...
        receiver.needsDeclare = (next.Parent !== undefined && IsSourceFile(next.Parent));
    ...
    return NodeFactory_NewNodeList(factory.__tsgoEmbedded0, results);
}
/**
 ...
 * }
 */
export function DeclarationTransformer_getReferencedFiles(receiver, outputFilePath) {
    const results = [];
    for (const pair of receiver.rawReferencedFiles) {
        ...
        if (file.IsDeclarationFile) {
            ...
            const paths = receiver.host.GetOutputPathsFor(file, true);
            declFileName = paths.DeclarationFilePath();
        ...
        const fileName = GetRelativePathToDirectoryOrUrl(outputFilePath, declFileName, false, {
 ...
 * }
 */
export function DeclarationTransformer_getLibReferences(receiver) {
    const result = [];
 ...
 * }
 */
export function DeclarationTransformer_getTypeReferences(receiver) {
    const result = [];
 ...
 * }
 */
export function DeclarationTransformer_setupDiagnosticContext(receiver, input) {
 ...
 * }
 */
export function DeclarationTransformer_visitDeclarationSubtree(receiver, input) {
 ...
 * }
 */
export function DeclarationTransformer_checkName(receiver, node) {
    const oldDiag = receiver.state.getSymbolAccessibilityDiagnostic;
 ...
 * }
 */
export function DeclarationTransformer_transformMappedTypeNode(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    ...
    const typeNode = input.Type === undefined
 ...
 * }
 */
export function DeclarationTransformer_transformHeritageClause(receiver, clause) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const retainedClauses = Filter(clause.Types.Nodes, (t) => {
        const ewta = AsExpressionWithTypeArguments(t);
        return (IsEntityNameExpression(ewta.Expression) ||
            (clause.Token === KindExtendsKeyword && Node_Expression(t).Kind === KindNullKeyword));
    });
 ...
 * }
 */
export function DeclarationTransformer_transformImportTypeNode(receiver, input) {
    ...
    const updatedArgument = newLiteral !== argLiteral.Literal
 ...
 * }
 */
export function DeclarationTransformer_transformConstructorTypeNode(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function DeclarationTransformer_transformFunctionTypeNode(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const typeParameters = NodeVisitor_VisitNodes(visitor, input.TypeParameters);
 ...
 * }
 */
export function DeclarationTransformer_transformConditionalTypeNode(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function DeclarationTransformer_transformTypeReference(receiver, input) {
    DeclarationTransformer_checkEntityNameVisibility(receiver, input.TypeName, receiver.enclosingDeclaration);
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), input);
}
/**
 ...
 * }
 */
export function DeclarationTransformer_transformExpressionWithTypeArguments(receiver, input) {
 ...
 * }
 */
export function DeclarationTransformer_transformTypeParameterDeclaration(receiver, input) {
 ...
 * }
 */
export function DeclarationTransformer_transformVariableDeclaration(receiver, input) {
    ...
    return NodeFactory_UpdateVariableDeclaration(astFactory, input, input.name, undefined, DeclarationTransformer_ensureType(receiver, input, false), DeclarationTransformer_ensureNoInitializer(receiver, input));
}
/**
 ...
 * }
 */
export function DeclarationTransformer_transformCjsRequireVariableDeclaration(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    ...
    if (IsIdentifier(Node_Name(input))) {
        // `const x = require("something")` -> `import x = require("something")`
        return NewImportEqualsDeclaration(astFactory, undefined, false, Node_Name(input), NewExternalModuleReference(astFactory, specifier));
    }
        ...
        for (const elem of b.Elements.Nodes) {
            ...
            importSpecifiers.push(NewImportSpecifier(astFactory, false, Node_PropertyName(elem), Node_Name(elem)));
        }
        return NewImportDeclaration(astFactory, undefined, NewImportClause(astFactory, KindUnknown, undefined, NewNamedImports(astFactory, NodeFactory_NewNodeList(astFactory, importSpecifiers))), specifier, undefined);
    }
}
/**
 ...
 * }
 */
export function DeclarationTransformer_recreateBindingPattern(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const results = [];
 ...
 * }
 */
export function DeclarationTransformer_recreateBindingElement(receiver, e) {
 ...
 * }
 */
export function DeclarationTransformer_transformIndexSignatureDeclaration(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    let t = NodeVisitor_VisitNode(visitor, input.Type);
    if (t === undefined) {
 ...
 * }
 */
export function DeclarationTransformer_transformCallSignatureDeclaration(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
 ...
 * }
 */
export function DeclarationTransformer_transformPropertySignatureDeclaration(receiver, input) {
 ...
 * }
 */
export function DeclarationTransformer_transformPropertyDeclaration(receiver, input) {
    if (IsPrivateIdentifier(Node_Name(input))) {
        return undefined;
    }
    // Remove definite assignment assertion (!) from declaration files
 ...
 * }
 */
export function DeclarationTransformer_transformSetAccessorDeclaration(receiver, input) {
    if (IsPrivateIdentifier(Node_Name(input))) {
        return undefined;
    }
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function DeclarationTransformer_transformGetAccesorDeclaration(receiver, input) {
    if (IsPrivateIdentifier(Node_Name(input))) {
        return undefined;
    }
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function DeclarationTransformer_updateAccessorParamList(receiver, input, isPrivate) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const newParams = [];
    if (!isPrivate) {
    ...
    return NodeFactory_NewNodeList(astFactory, newParams);
}
/**
 ...
 * }
 */
export function DeclarationTransformer_transformConstructorDeclaration(receiver, input) {
    // A constructor declaration may not have a type annotation
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const modifiers = DeclarationTransformer_ensureModifiers(receiver, input);
 ...
 * }
 */
export function DeclarationTransformer_transformConstructSignatureDeclaration(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
 ...
 * }
 */
export function DeclarationTransformer_omitPrivateMethodType(receiver, input) {
 ...
 * }
 */
export function DeclarationTransformer_transformMethodSignatureDeclaration(receiver, input) {
 ...
 * }
 */
export function DeclarationTransformer_transformMethodDeclaration(receiver, input) {
    if (receiver.host.GetEffectiveDeclarationFlags(EmitContext_ParseNode(Transformer_EmitContext(receiver.__tsgoEmbedded0), input), ModifierFlagsPrivate) !== 0) {
        return DeclarationTransformer_omitPrivateMethodType(receiver, input);
    }
    else if (IsPrivateIdentifier(Node_Name(input))) {
 ...
 * }
 */
export function DeclarationTransformer_visitDeclarationStatements(receiver, input) {
    if (DeclarationTransformer_shouldStripInternal(receiver, input)) {
        return undefined;
    }
    switch (input.Kind) {
 ...
 * }
 */
export function DeclarationTransformer_transformExportAssignment(receiver, input, assignment, expression, isExportEquals) {
    if (IsSourceFile(input.Parent)) {
        receiver.resultHasExternalModuleIndicator = true;
    }
    receiver.resultHasScopeMarker = true;
    ...
    let type_;
    let initializer;
    if (IsPrimitiveLiteralValue(unwrapParenthesizedExpression(expression), true)) {
    ...
    const declList = NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [varDecl]), NodeFlagsConst);
 ...
 * }
 */
export function DeclarationTransformer_transformCommonJSExport(receiver, input, name) {
    let nameText = "";
    ...
    if (isCommonJSAliasExport(input)) {
        ...
        const exportSpecifier = NewExportSpecifier(astFactory, false, propertyName, name);
        return NewExportDeclaration(astFactory, undefined, false, NewNamedExports(astFactory, NodeFactory_NewNodeList(astFactory, [exportSpecifier])), undefined, undefined);
    }
        ...
        if (Node_Text(name) === "default") {
            ...
            const declList = NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [varDecl]), NodeFlagsConst);
            const statement = NewVariableStatement(astFactory, modList, declList);
            const assignment = NewExportAssignment(astFactory, Node_Modifiers(input), false, undefined, newId);
            // Remove comments from the export declaration and copy them onto the synthetic _default declaration
            DeclarationTransformer_preserveJsDoc(receiver, statement, input);
            ...
            const modList = NodeFactory_NewModifierList(astFactory, modNodes);
            const declList = NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [varDecl]), NodeFlagsNone);
    ...
    const declList = NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [varDecl]), NodeFlagsConst);
    const statement = NewVariableStatement(astFactory, modList, declList);
    const exportSpecList = NodeFactory_NewNodeList(astFactory, [NewExportSpecifier(astFactory, false, newId, name)]);
    const assignment = NewExportDeclaration(astFactory, undefined, false, NewNamedExports(astFactory, exportSpecList), undefined, undefined);
    // Remove comments from the export declaration and copy them onto the synthetic _default declaration
    DeclarationTransformer_preserveJsDoc(receiver, statement, input);
    DeclarationTransformer_removeAllComments(receiver, assignment);
    return NewSyntaxList(astFactory, [statement, assignment]);
 ...
 * }
 */
export function isCommonJSAliasExport(node) {
 ...
 * }
 */
export function DeclarationTransformer_rewriteModuleSpecifier(receiver, parent, input) {
    if (input === undefined) {
        return undefined;
    }
 ...
 * }
 */
export function DeclarationTransformer_tryGetResolutionModeOverride(receiver, node) {
    if (node === undefined) {
        return node;
    }
 ...
 * }
 */
export function DeclarationTransformer_preserveJsDoc(receiver, updated, original) {
    // Copy comment range from original to updated node so JSDoc comments are preserved
 ...
 * }
 */
export function DeclarationTransformer_preservePartialJsDoc(receiver, updated, original) {
    ...
    const comment = "*\n * " + strings.ReplaceAll(description, "\n", "\n * ") + "\n ";
    EmitContext_AddSyntheticLeadingComment(Transformer_EmitContext(receiver.__tsgoEmbedded0), updated, KindMultiLineCommentTrivia, comment, true /*hasTrailingNewLine*/);
}
/**
 ...
 * }
 */
export function DeclarationTransformer_removeAllComments(receiver, node) {
 ...
 * }
 */
export function DeclarationTransformer_ensureType(receiver, node, ignorePrivate) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    ...
    const typeNode = HasInferredType(node)
 ...
 * }
 */
export function DeclarationTransformer_shouldPrintWithInitializer(receiver, node) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    return (canHaveLiteralInitializer(receiver.host, node) && Node_Initializer(node) !== undefined && receiver.resolver.IsLiteralConstDeclaration(EmitContext_MostOriginal(emitContext, node)));
}
/**
 ...
 * }
 */
export function DeclarationTransformer_checkEntityNameVisibility(receiver, entityName, enclosingDeclaration) {
 ...
 * }
 */
export function DeclarationTransformer_transformTopLevelDeclaration(receiver, input) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    if (receiver.state.lateMarkedStatements.length > 0) {
 ...
 * }
 */
export function DeclarationTransformer_transformTypeAliasDeclaration(receiver, input) {
 ...
 * }
 */
export function DeclarationTransformer_transformInterfaceDeclaration(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const modifiers = DeclarationTransformer_ensureModifiers(receiver, input);
 ...
 * }
 */
export function DeclarationTransformer_transformFunctionDeclaration(receiver, input) {
 ...
 * }
 */
export function DeclarationTransformer_transformModuleDeclaration(receiver, input) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    if (inner !== undefined && inner.Kind === KindModuleBlock) {
        ...
        const lateStatementsResult = DeclarationTransformer_transformAndReplaceLatePaintedStatements(receiver, statements);
        ...
        // 2. Everything is exported and there are no export assignments or export declarations - strip all export modifiers
        // 3. Some things are exported, some are not, and there's no marker - add an empty marker
        const lateStatements = (!IsGlobalScopeAugmentation(input) && !receiver.resultHasScopeMarker && !hasScopeMarker(lateStatementsResult))
            ? (receiver.needsScopeFixMarker
                ? NodeFactory_NewNodeList(astFactory, [...lateStatementsResult.Nodes, createEmptyExports(astFactory)])
                : NodeVisitor_VisitNodes(receiver.exportStrippingVisitor, lateStatementsResult))
 ...
 * }
 */
export function DeclarationTransformer_stripExportModifiers(receiver, statement) {
    ...
    const newFlags = (oldFlags & (ModifierFlagsAll ^ ModifierFlagsExport));
 ...
 * }
 */
export function DeclarationTransformer_transformClassDeclaration(receiver, input) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    try {
        ...
        const parameterProperties = (() => {
            ...
            const result = ctorDecl.Parameters.Nodes.reduce((acc, param) => {
                ...
                if (paramDecl.name.Kind === KindIdentifier) {
                    const updated = NewPropertyDeclaration(astFactory, DeclarationTransformer_ensureModifiers(receiver, param), paramDecl.name, paramDecl.QuestionToken, DeclarationTransformer_ensureType(receiver, param, false), DeclarationTransformer_ensureNoInitializer(receiver, param));
        ...
        const privateIdentifier = Some(input.Members.Nodes, (member) => {
            const memberName = Node_Name(member);
            return (memberName !== undefined && IsPrivateIdentifier(memberName));
        })
            ? NewPropertyDeclaration(astFactory, undefined, NewPrivateIdentifier(astFactory, "#private"), undefined, undefined, undefined)
            : undefined;
        // Collect this.x property assignments from constructors and static blocks in JS files
        let thisPropertyAssignments = [];
        if (IsInJSFile(input)) {
            thisPropertyAssignments = DeclarationTransformer_collectThisPropertyAssignments(receiver, input);
        }
        const lateIndexes = receiver.resolver.CreateLateBoundIndexSignatures(emitContext, input, receiver.enclosingDeclaration, declarationEmitNodeBuilderFlags, declarationEmitInternalNodeBuilderFlags, SymbolTrackerImpl_AsSymbolTracker(receiver.tracker));
        ...
        const members = NodeFactory_NewNodeList(astFactory, memberNodes);
        ...
        if (extendsClause !== undefined) {
            ...
            if (!IsEntityNameExpression(extendsEwta.Expression) && extendsEwta.Expression.Kind !== KindNullKeyword) {
                ...
                const varDecl = NewVariableDeclaration(astFactory, newId, undefined, receiver.resolver.CreateTypeOfExpression(emitContext, extendsEwta.Expression, input, declarationEmitNodeBuilderFlags, declarationEmitInternalNodeBuilderFlags, SymbolTrackerImpl_AsSymbolTracker(receiver.tracker)), undefined);
                ...
                const statement = NewVariableStatement(astFactory, declMods, NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [varDecl]), NodeFlagsConst));
                ...
                const newHeritageClause = updateNode(NewHeritageClause(astFactory, heritageClause.Token, NodeFactory_NewNodeList(astFactory, [updatedExtendsEwta])), heritageClause, astFactory.hooks);
                ...
                const heritageClauses = NodeFactory_NewNodeList(astFactory, heritageList);
        ...
        return NodeFactory_UpdateClassDeclaration(astFactory, input, modifiers, input.name, typeParameters, NodeVisitor_VisitNodes(visitor, input.HeritageClauses), members);
    }
    finally {
        SymbolTrackerImpl_PopErrorFallbackNode(receiver.tracker);
    }
 ...
 * }
 */
export function DeclarationTransformer_visitThisPropertyAssignments(receiver, node) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    let isStatic = false;
 ...
 * }
 */
export function isClassExtendingNull(node) {
    if (node === undefined) {
        return false;
    }
 ...
 * }
 */
export function DeclarationTransformer_collectThisPropertyAssignments(receiver, input) {
    const seen = { M: new globalThis.Map() };
    // Pre-populate seen with existing direct member nodes to avoid duplicates
 ...
 * }
 */
export function DeclarationTransformer_walkBindingPattern(receiver, pattern, param) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    return pattern.Elements.Nodes.reduce((elems, elem) => {
        ...
        return [...elems, NewPropertyDeclaration(astFactory, DeclarationTransformer_ensureModifiers(receiver, param), elemName, undefined, DeclarationTransformer_ensureType(receiver, elem, false), undefined)];
    }, []);
}
/**
 ...
 * }
 */
export function DeclarationTransformer_transformVariableStatement(receiver, input) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    const nodeList = NodeFactory_NewNodeList(astFactory, nodes);
    const modifiers = DeclarationTransformer_ensureModifiers(receiver, input);
    let newDeclList;
    if (IsVarUsing(input.DeclarationList) || IsVarAwaitUsing(input.DeclarationList)) {
        ...
        newDeclList = NodeFactory_UpdateVariableDeclarationList(astFactory, declListData, nodeList, input.DeclarationList.Flags);
    }
    const res = NodeFactory_UpdateVariableStatement(astFactory, input, modifiers, newDeclList);
    if (extraImports.length > 0) {
 ...
 * }
 */
export function DeclarationTransformer_transformEnumDeclaration(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const modifiers = DeclarationTransformer_ensureModifiers(receiver, input);
    const newMembers = MapNonNil(input.Members.Nodes, (m) => {
 ...
 * }
 */
export function DeclarationTransformer_ensureModifiers(receiver, node) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const currentFlags = ((GetCombinedModifierFlags(EmitContext_ParseNode(emitContext, node)) & ModifierFlagsAll) >>> 0);
 ...
 * }
 */
export function DeclarationTransformer_ensureModifierFlags(receiver, node) {
    const baseMask = (ModifierFlagsAll ^ (ModifierFlagsPublic | ModifierFlagsAsync | ModifierFlagsOverride));
    const baseAdditions = (receiver.needsDeclare && !isAlwaysType(node)) ? ModifierFlagsAmbient : ModifierFlagsNone;
    const parentIsFile = node.Parent !== undefined && node.Parent.Kind === KindSourceFile;
    const mask = parentIsFile ? baseMask : (baseMask ^ ModifierFlagsAmbient);
    const additions = parentIsFile
        ? (IsImplicitlyExportedJSDocDeclaration(node) ? (baseAdditions | ModifierFlagsExport) : baseAdditions)
 ...
 * }
 */
export function DeclarationTransformer_ensureTypeParams(receiver, node, params) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    ...
    const typeParameters = (data !== undefined && data.FullSignature !== undefined)
        ? (() => {
            ...
            if (nodes !== undefined && nodes.length > 0) {
                return { Loc: node.Loc, Nodes: nodes };
            }
            return undefined;
        })()
        : undefined;
 ...
 * }
 */
export function DeclarationTransformer_updateParamList(receiver, node, params) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
 ...
 * }
 */
export function DeclarationTransformer_ensureParameter(receiver, p) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const oldDiag = receiver.state.getSymbolAccessibilityDiagnostic;
    if (!receiver.suppressNewDiagnosticContexts) {
    ...
    const questionToken = receiver.resolver.IsOptionalParameter(p)
 ...
 * }
 */
export function DeclarationTransformer_ensureNoInitializer(receiver, node) {
    if (DeclarationTransformer_shouldPrintWithInitializer(receiver, node)) {
 ...
 * }
 */
export function DeclarationTransformer_visitBindingName(receiver, node) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    switch (node.Kind) {
        case KindIdentifier:
 ...
 * }
 */
export function DeclarationTransformer_transformImportEqualsDeclaration(receiver, decl) {
 ...
 * }
 */
export function DeclarationTransformer_transformImportDeclaration(receiver, decl) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const makeImportDecl = (importClause, moduleSpecifier, attributes) => {
    ...
    // The `importClause` visibility corresponds to the default's visibility.
    const visibleDefaultBinding = (decl.ImportClause !== undefined && importClauseNode.name !== undefined && receiver.resolver.IsDeclarationVisible(decl.ImportClause))
        ? importClauseNode.name
        : undefined;
    const makeImportClause = (name, namedBindings) => {
    ...
    if (importClauseNode.NamedBindings.Kind === KindNamespaceImport) {
        // Namespace import (optionally with visible default)
        const namedBindings = receiver.resolver.IsDeclarationVisible(importClauseNode.NamedBindings)
    ...
    if (bindingList.length > 0 || visibleDefaultBinding !== undefined) {
        const namedImports = bindingList.length > 0
 ...
 * }
 */
export function DeclarationTransformer_transformJSDocTypeExpression(receiver, input) {
 ...
 * }
 */
export function DeclarationTransformer_transformJSDocTypeLiteral(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function DeclarationTransformer_transformJSDocPropertyTag(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function DeclarationTransformer_transformJSDocAllType(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function DeclarationTransformer_transformJSDocNullableType(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function DeclarationTransformer_transformJSDocNonNullableType(receiver, input) {
    return NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), input.Type);
}
/**
 ...
 * }
 */
export function DeclarationTransformer_transformJSDocVariadicType(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function DeclarationTransformer_transformJSDocOptionalType(receiver, input) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function DeclarationTransformer_getNameExpressionPreferringIdentifier(receiver, nameExpr) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
 ...
 * }
 */
export function DeclarationTransformer_visitExpressionStatement(receiver, node) {
            ...
            switch (GetAssignmentDeclarationKind(expression)) {
                case JSDeclarationKindModuleExports:
                    if (IsSourceFile(node.Parent) && AsSourceFile(node.Parent).CommonJSModuleIndicator !== undefined) {
                        return DeclarationTransformer_transformExportAssignment(receiver, node, expression, AsBinaryExpression(expression).Right, true);
                    }
                    break;
 ...
 * }
 */
export function DeclarationTransformer_visitNestedExpression(receiver, expression) {
    if (expression !== undefined) {
        switch (GetAssignmentDeclarationKind(expression)) {
            case JSDeclarationKindProperty:
 ...
 * }
 */
export function DeclarationTransformer_transformExpandoAssignment(receiver, node) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    ...
    Node_LocalsContainerData(synthesizedNamespace).Locals = new globalThis.Map();
    ...
    try {
        ...
        try {
            const statements = [
                NewVariableStatement(astFactory, varModifiers, NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [
            ...
            if (isNonContextualKeywordName) {
                const namedExports = NewNamedExports(astFactory, NodeFactory_NewNodeList(astFactory, [
                    NewExportSpecifier(astFactory, false, exportName, NewIdentifier(astFactory, property)),
                ]));
                statements.push(NewExportDeclaration(astFactory, undefined, false, namedExports, undefined, undefined));
            }
            if (statements.length > 1 && !preexistingExpandoHasExport) {
                // Add an `export` modifier to all existing expando members so they remain exported after the `export {}` is added
                for (const decl of receiver.expandoMembers.get(hostId) ?? []) {
                    const modifierFlags = ((ModifierFlagsExport | GetCombinedModifierFlags(decl)) >>> 0);
 ...
 * }
 */
export function DeclarationTransformer_getExpandoHostId(receiver, declaration) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function DeclarationTransformer_transformExpandoHost(receiver, name, declaration) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const root = IfElse(IsVariableDeclaration(declaration), declaration.Parent.Parent, declaration);
    ...
    receiver.needsDeclare = saveNeedsDeclare;
    if (defaultExport) {
        modifierFlags = ((((modifierFlags | ModifierFlagsAmbient) >>> 0) ^ ModifierFlagsDefault ^ ModifierFlagsExport) >>> 0);
    }
    ...
    try {
        ...
        if (defaultExport) {
            ...
            receiver.resultHasScopeMarker = true;
            replacement = [...replacement, NewExportAssignment(astFactory, undefined, false, undefined, name)];
        }
        // store host result to be added to the output when it's actually visited
 ...
 * }
 */
export function DeclarationTransformer_createFullExpandoBlock(receiver, id) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    ...
    if (addOns !== undefined) {
        ...
        if (name !== undefined) {
            const moduleDecl = NewModuleDeclaration(astFactory, modifiers, KindNamespaceKeyword, name, NewModuleBlock(astFactory, NodeFactory_NewNodeList(astFactory, addOns)));
 ...
 * }
 */
export function extractExpandoHostParams(node) {
    switch (node.Kind) {
 ...
 * }
 */
export function DeclarationTransformer_tryGetPropertyName(receiver, node) {
