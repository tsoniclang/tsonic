...
import { IsExportAssignment, IsVariableDeclaration, } from "../../ast/generated/predicates.js";
import { GetNameOfDeclaration, GetSourceFileOfNode, IsSourceFileJS, } from "../../ast/utilities.js";
...
import { createGetIsolatedDeclarationErrors } from "./diagnostics.js";
/**
 ...
 * }
 */
export function SymbolTrackerImpl_PopErrorFallbackNode(receiver) {
 ...
 * }
 */
export function SymbolTrackerImpl_PushErrorFallbackNode(receiver, node) {
 ...
 * }
 */
export function SymbolTrackerImpl_ReportCyclicStructureError(receiver) {
 ...
 * }
 */
export function SymbolTrackerImpl_ReportInaccessibleThisError(receiver) {
    const location = SymbolTrackerImpl_errorLocation(receiver);
    if (location !== undefined) {
 ...
 * }
 */
export function SymbolTrackerImpl_ReportInaccessibleUniqueSymbolError(receiver) {
    const location = SymbolTrackerImpl_errorLocation(receiver);
    if (location !== undefined) {
 ...
 * }
 */
export function SymbolTrackerImpl_ReportInferenceFallback(receiver, node) {
 ...
 * }
 */
export function SymbolTrackerImpl_ReportLikelyUnsafeImportRequiredError(receiver, specifier, symbolName) {
    const location = SymbolTrackerImpl_errorLocation(receiver);
    if (location !== undefined) {
        if (symbolName !== "") {
 ...
 * }
 */
export function SymbolTrackerImpl_ReportNonSerializableProperty(receiver, propertyName) {
    const location = SymbolTrackerImpl_errorLocation(receiver);
    if (location !== undefined) {
 ...
 * }
 */
export function SymbolTrackerImpl_ReportNonlocalAugmentation(receiver, containingFile, parentSymbol, augmentingSymbol) {
    const primaryDeclaration = Find(parentSymbol.Declarations ?? [], (d) => GetSourceFileOfNode(d) === containingFile);
    const augmentingDeclarations = Filter(augmentingSymbol.Declarations ?? [], (d) => GetSourceFileOfNode(d) !== containingFile);
 ...
 * }
 */
export function SymbolTrackerImpl_ReportPrivateInBaseOfClassExpression(receiver, propertyName) {
    const location = SymbolTrackerImpl_errorLocation(receiver);
    if (location !== undefined) {
 ...
 * }
 */
export function SymbolTrackerImpl_ReportTruncationError(receiver) {
    const location = SymbolTrackerImpl_errorLocation(receiver);
    if (location !== undefined) {
 ...
 * }
 */
export function SymbolTrackerImpl_errorFallbackNode(receiver) {
 ...
 * }
 */
export function SymbolTrackerImpl_errorLocation(receiver) {
 ...
 * }
 */
export function SymbolTrackerImpl_errorDeclarationNameWithFallback(receiver) {
 ...
 * }
 */
export function SymbolTrackerImpl_TrackSymbol(receiver, symbol_, enclosingDeclaration, meaning) {
 ...
 * }
 */
export function SymbolTrackerImpl_handleSymbolAccessibilityError(receiver, symbolAccessibilityResult) {
 ...
 * }
 */
export function SymbolTrackerSharedState_addDiagnostic(receiver, diag) {
 ...
 * }
 */
export function NewSymbolTracker(host, resolver, state) {
    const tracker = {
        host: host,
        resolver: resolver,
        state: state,
 ...
 */
export function SymbolTrackerImpl_AsSymbolTracker(receiver) {
    return {
