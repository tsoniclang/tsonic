...
const byteAt = (s, i) => utf8Encoder.encode(s)[i];
 ...
 * }
 */
export function NewJSXTransformer(opts) {
 ...
 * }
 */
export function JSXTransformer_getCurrentFileNameExpression(receiver) {
    ...
    const d = NewVariableDeclaration(astFactory, NodeFactory_NewUniqueNameEx(factory, "_jsxFileName", {
        Flags: GeneratedIdentifierFlagsOptimistic | GeneratedIdentifierFlagsFileLevel,
        Prefix: "",
        Suffix: "",
    }), undefined, undefined, NewStringLiteral(astFactory, SourceFile_FileName(receiver.currentSourceFile), TokenFlagsNone));
 ...
 * }
 */
export function JSXTransformer_getJsxFactoryCalleePrimitive(receiver, isStaticChildren) {
 ...
 * }
 */
export function JSXTransformer_getJsxFactoryCallee(receiver, isStaticChildren) {
 ...
 * }
 */
export function JSXTransformer_getImplicitJsxFragmentReference(receiver) {
 ...
 * }
 */
export function JSXTransformer_getImplicitImportForName(receiver, name) {
    let importSource = receiver.importSpecifier;
    if (name !== "createElement") {
        importSource = GetJSXRuntimeImport(importSource, receiver.compilerOptions);
    }
    const [existing, ok] = OrderedMap_Get(receiver.utilizedImplicitRuntimeImports, importSource);
    if (ok) {
        ...
        OrderedMap_Set(receiver.utilizedImplicitRuntimeImports, importSource, new globalThis.Map());
    }
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    ...
    const [existingMap] = OrderedMap_Get(receiver.utilizedImplicitRuntimeImports, importSource);
 ...
 * }
 */
export function JSXTransformer_setInChild(receiver, v) {
 ...
 * }
 */
export function JSXTransformer_visit(receiver, node) {
    if (node === undefined) {
        return undefined;
    }
 ...
 * }
 */
export function hasKeyAfterPropsSpread(node) {
    let spread = false;
    let opener = node;
 ...
 * }
 */
export function JSXTransformer_shouldUseCreateElement(receiver, node) {
 ...
 * }
 */
export function insertStatementAfterPrologue(to, statement, isPrologueDirective, callee) {
 ...
 * }
 */
export function JSXTransformer_isAnyPrologueDirective(receiver, node) {
 ...
 * }
 */
export function JSXTransformer_insertStatementAfterCustomPrologue(receiver, to, statement) {
 ...
 * }
 */
export function sortImportSpecifiers(a, b) {
 ...
 * }
 */
export function getSortedSpecifiers(m) {
    const res = [...m.values()];
 ...
 * }
 */
export function JSXTransformer_visitSourceFile(receiver, file) {
    if (file.IsDeclarationFile) {
        return file;
    }
    ...
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    let visited = NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), file);
    EmitContext_AddEmitHelper(emitContext, visited, ...EmitContext_ReadEmitHelpers(emitContext));
    let statements = Node_Statements(visited) ?? [];
    let statementsUpdated = false;
    if (receiver.filenameDeclaration !== undefined) {
        statements = JSXTransformer_insertStatementAfterCustomPrologue(receiver, statements, NewVariableStatement(astFactory, undefined, NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [receiver.filenameDeclaration]), NodeFlagsConst)));
        statementsUpdated = true;
    }
    if (OrderedMap_Size(receiver.utilizedImplicitRuntimeImports) > 0) {
        if (IsExternalModule(file)) {
            ...
            OrderedMap_Entries(receiver.utilizedImplicitRuntimeImports)((importSource, importSpecifiersMap) => {
                const s = NewImportDeclaration(astFactory, undefined, NewImportClause(astFactory, KindUnknown, undefined, NewNamedImports(astFactory, NodeFactory_NewNodeList(astFactory, getSortedSpecifiers(importSpecifiersMap)))), NewStringLiteral(astFactory, importSource, TokenFlagsNone), undefined);
            ...
            OrderedMap_Entries(receiver.utilizedImplicitRuntimeImports)((importSource, importSpecifiersMap) => {
                ...
                const s = NewVariableStatement(astFactory, undefined, NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [
                    NewVariableDeclaration(astFactory, NewBindingPattern(astFactory, KindObjectBindingPattern, NodeFactory_NewNodeList(astFactory, asBindingElems)), undefined, undefined, NewCallExpression(astFactory, NewIdentifier(astFactory, "require"), undefined, undefined, NodeFactory_NewNodeList(astFactory, [NewStringLiteral(astFactory, importSource, TokenFlagsNone)]), NodeFlagsNone)),
                ]), NodeFlagsConst));
                SetParentInChildren(s);
                newStatements.push(s);
                return true;
 ...
 * }
 */
export function JSXTransformer_visitJsxElement(receiver, element) {
    let tagTransform = JSXTransformer_visitJsxOpeningLikeElementJSX;
    if (JSXTransformer_shouldUseCreateElement(receiver, element)) {
        tagTransform = JSXTransformer_visitJsxOpeningLikeElementCreateElement;
    }
    const location = NewTextRange(SkipTrivia(SourceFile_Text(receiver.currentSourceFile), Node_Pos(element)), Node_End(element));
 ...
 * }
 */
export function JSXTransformer_visitJsxSelfClosingElement(receiver, element) {
    let tagTransform = JSXTransformer_visitJsxOpeningLikeElementJSX;
    if (JSXTransformer_shouldUseCreateElement(receiver, element)) {
        tagTransform = JSXTransformer_visitJsxOpeningLikeElementCreateElement;
    }
    const location = NewTextRange(SkipTrivia(SourceFile_Text(receiver.currentSourceFile), Node_Pos(element)), Node_End(element));
    return tagTransform(receiver, element, undefined, location);
}
/**
 ...
 * }
 */
export function JSXTransformer_visitJsxFragment(receiver, fragment) {
    ...
    const location = NewTextRange(SkipTrivia(SourceFile_Text(receiver.currentSourceFile), Node_Pos(fragment)), Node_End(fragment));
 ...
 * }
 */
export function JSXTransformer_convertJsxChildrenToChildrenPropObject(receiver, children) {
 ...
 * }
 */
export function JSXTransformer_transformJsxChildToExpression(receiver, node) {
    const prev = receiver.inJsxChild;
    JSXTransformer_setInChild(receiver, true);
    try {
        return Transformer_Visitor(receiver.__tsgoEmbedded0).Visit(node);
    }
    finally {
 ...
 * }
 */
export function JSXTransformer_convertJsxChildrenToChildrenPropAssignment(receiver, children) {
    ...
    if (nonWhitespaceChildren.length === 1 && (nonWhitespaceChildren[0].Kind !== KindJsxExpression || AsJsxExpression(nonWhitespaceChildren[0]).DotDotDotToken === undefined)) {
        const result = JSXTransformer_transformJsxChildToExpression(receiver, nonWhitespaceChildren[0]);
        if (result === undefined) {
            return undefined;
        }
    ...
    for (const child of nonWhitespaceChildren) {
        const res = JSXTransformer_transformJsxChildToExpression(receiver, child);
        if (res === undefined) {
            continue;
        }
 ...
 * }
 */
export function JSXTransformer_getTagName(receiver, node) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    if (node.Kind === KindJsxElement) {
        ...
        if (IsIdentifier(tagName) && IsIntrinsicJsxName(Node_Text(tagName))) {
            ...
            return NewStringLiteral(astFactory, Node_Text(AsJsxNamespacedName(tagName).Namespace) + ":" + Node_Text(AsJsxNamespacedName(tagName).name), TokenFlagsNone);
        }
        else {
 ...
 * }
 */
export function JSXTransformer_visitJsxOpeningLikeElementJSX(receiver, element, children, location) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    ...
    if (children !== undefined && children.Nodes.length > 0) {
        childrenProp = JSXTransformer_convertJsxChildrenToChildrenPropAssignment(receiver, children.Nodes);
    }
    let keyAttr = undefined;
    let attrs = Node_Properties(Node_Attributes(element)) ?? [];
    ...
    return JSXTransformer_visitJsxOpeningLikeElementOrFragmentJSX(receiver, tagName, object, keyAttr, children, location);
}
/**
 ...
 * }
 */
export function JSXTransformer_transformJsxAttributesToObjectProps(receiver, attrs, childrenProp) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
 ...
 * }
 */
export function JSXTransformer_transformJsxAttributesToExpression(receiver, attrs, childrenProp) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    let expressions = [];
    let properties = [];
            ...
            if (IsObjectLiteralExpression(Node_Expression(attr)) && !hasProto(AsObjectLiteralExpression(Node_Expression(attr)))) {
                for (const prop of Node_Properties(Node_Expression(attr)) ?? []) {
                    if (IsSpreadAssignment(prop)) {
                        ...
                        expressions = [...expressions, Transformer_Visitor(receiver.__tsgoEmbedded0).Visit(Node_Expression(prop))];
                        continue;
                    }
                    properties = [...properties, Transformer_Visitor(receiver.__tsgoEmbedded0).Visit(prop)];
                }
                continue;
            }
            [expressions, properties] = JSXTransformer_combinePropertiesIntoNewExpression(receiver, expressions, properties);
            expressions = [...expressions, Transformer_Visitor(receiver.__tsgoEmbedded0).Visit(Node_Expression(attr))];
            continue;
        }
 ...
 * }
 */
export function JSXTransformer_combinePropertiesIntoNewExpression(receiver, expressions, props) {
    if (props.length === 0) {
        return [expressions, props];
    }
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function JSXTransformer_transformJsxAttributesToProps(receiver, attrs, childrenProp) {
    const props = [];
    for (const attr of attrs) {
 ...
 * }
 */
export function JSXTransformer_transformJsxSpreadAttributesToProps(receiver, node) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    if (IsObjectLiteralExpression(node.Expression) && !hasProto(AsObjectLiteralExpression(node.Expression))) {
        const [res] = NodeVisitor_VisitSlice(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Properties(node.Expression) ?? []);
        return res;
    }
    return [NewSpreadAssignment(astFactory, Transformer_Visitor(receiver.__tsgoEmbedded0).Visit(node.Expression))];
}
/**
 ...
 * }
 */
export function JSXTransformer_transformJsxAttributeToObjectLiteralElement(receiver, node) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const name = JSXTransformer_getAttributeName(receiver, node);
    const expression = JSXTransformer_transformJsxAttributeInitializer(receiver, node.Initializer);
 ...
 * }
 */
export function JSXTransformer_getAttributeName(receiver, node) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    ...
    // must be jsx namespace
    return NewStringLiteral(astFactory, Node_Text(AsJsxNamespacedName(name).Namespace) + ":" + Node_Text(AsJsxNamespacedName(name).name), TokenFlagsNone);
}
/**
 ...
 * }
 */
export function JSXTransformer_transformJsxAttributeInitializer(receiver, node) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    if (node === undefined) {
    ...
    if (node.Kind === KindJsxExpression) {
        ...
        return Transformer_Visitor(receiver.__tsgoEmbedded0).Visit(AsJsxExpression(node).Expression);
    }
 ...
 * }
 */
export function JSXTransformer_visitJsxOpeningLikeElementOrFragmentJSX(receiver, tagName, object, keyAttr, children, location) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    let nonWhitespaceChildren = [];
    if (children !== undefined) {
        nonWhitespaceChildren = GetSemanticJsxChildren(children.Nodes);
    }
    const isStaticChildren = nonWhitespaceChildren.length > 1 ||
    ...
    if (receiver.compilerOptions.Jsx === JsxEmitReactJSXDev) {
        const originalFile = EmitContext_MostOriginal(emitContext, receiver.currentSourceFile);
        if (originalFile !== undefined && IsSourceFile(originalFile)) {
            // "maybeKey" has to be replaced with "void 0" to not break the jsxDEV signature
            if (keyAttr === undefined) {
                args.push(NodeFactory_NewVoidZeroExpression(factory));
            }
            // isStaticChildren development flag
            if (isStaticChildren) {
                args.push(NodeFactory_NewTrueExpression(factory));
            }
            else {
                args.push(NodeFactory_NewFalseExpression(factory));
            }
            // __source development flag
            const [line, col] = GetECMALineAndUTF16CharacterOfPosition(AsSourceFile(originalFile), location.pos);
            args.push(NewObjectLiteralExpression(astFactory, NodeFactory_NewNodeList(astFactory, [
                NewPropertyAssignment(astFactory, undefined, NewIdentifier(astFactory, "fileName"), undefined, undefined, JSXTransformer_getCurrentFileNameExpression(receiver)),
                NewPropertyAssignment(astFactory, undefined, NewIdentifier(astFactory, "lineNumber"), undefined, undefined, NewNumericLiteral(astFactory, FormatInt(line + 1, 10), TokenFlagsNone)),
                NewPropertyAssignment(astFactory, undefined, NewIdentifier(astFactory, "columnNumber"), undefined, undefined, NewNumericLiteral(astFactory, FormatInt(col + 1, 10), TokenFlagsNone)),
            ]), false));
            // __self development flag
            args.push(NodeFactory_NewThisExpression(factory));
        }
    }
    const element = NewCallExpression(astFactory, JSXTransformer_getJsxFactoryCallee(receiver, isStaticChildren), undefined, undefined, NodeFactory_NewNodeList(astFactory, args), NodeFlagsNone);
    element.Loc = location;
    if (receiver.inJsxChild) {
        EmitContext_AddEmitFlags(emitContext, element, EFStartOnNewLine);
    }
    return element;
}
/**
 ...
 * }
 */
export function JSXTransformer_visitJsxOpeningFragmentJSX(receiver, fragment, children, location) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    let childrenProps = undefined;
    if (children !== undefined && children.Nodes.length > 0) {
        const result = JSXTransformer_convertJsxChildrenToChildrenPropObject(receiver, children.Nodes);
        if (result !== undefined) {
            childrenProps = result;
        }
    }
    if (childrenProps === undefined) {
        childrenProps = NewObjectLiteralExpression(astFactory, NodeFactory_NewNodeList(astFactory, []), false);
    }
    return JSXTransformer_visitJsxOpeningLikeElementOrFragmentJSX(receiver, JSXTransformer_getImplicitJsxFragmentReference(receiver), childrenProps, undefined, children, location);
}
/**
 ...
 * }
 */
export function JSXTransformer_createReactNamespace(receiver, reactNamespace, parent) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    // To ensure the emit resolver can properly resolve the namespace, we need to
    ...
    // If the identifier refers to an exported member of a namespace, substitute with
    // a qualified namespace property access (e.g., `React` -> `M.React`).
    const container = receiver.emitResolver.GetReferencedExportContainer(AsIdentifier(react), false /*prefixLocals*/);
    if (container !== undefined && IsModuleDeclaration(container)) {
        const containerName = NodeFactory_NewGeneratedNameForNode(factory, container);
        return NewPropertyAccessExpression(astFactory, containerName, undefined, react, NodeFlagsNone);
    }
    return react;
}
/**
 ...
 * }
 */
export function JSXTransformer_createJsxFactoryExpressionFromEntityName(receiver, e, parent) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    if (IsQualifiedName(e)) {
        const left = JSXTransformer_createJsxFactoryExpressionFromEntityName(receiver, AsQualifiedName(e).Left, parent);
        const right = NewIdentifier(astFactory, Node_Text(AsQualifiedName(e).Right));
        return NewPropertyAccessExpression(astFactory, left, undefined, right, NodeFlagsNone);
    }
 ...
 * }
 */
export function JSXTransformer_createJsxPseudoFactoryExpression(receiver, parent, e, target) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    if (e !== undefined) {
        return JSXTransformer_createJsxFactoryExpressionFromEntityName(receiver, e, parent);
    }
    return NewPropertyAccessExpression(astFactory, JSXTransformer_createReactNamespace(receiver, receiver.compilerOptions.ReactNamespace, parent), undefined, NewIdentifier(astFactory, target), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function JSXTransformer_createJsxFactoryExpression(receiver, parent) {
    const e = receiver.emitResolver.GetJsxFactoryEntity(receiver.currentSourceFile);
 ...
 * }
 */
export function JSXTransformer_createJsxFragmentFactoryExpression(receiver, parent) {
    const e = receiver.emitResolver.GetJsxFragmentFactoryEntity(receiver.currentSourceFile);
 ...
 * }
 */
export function JSXTransformer_visitJsxOpeningLikeElementCreateElement(receiver, element, children, location) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const tagName = JSXTransformer_getTagName(receiver, element);
    ...
    if (attrs.length > 0) {
        objectProperties = JSXTransformer_transformJsxAttributesToObjectProps(receiver, attrs, undefined);
    }
    else {
        objectProperties = NewKeywordExpression(astFactory, KindNullKeyword); // When there are no attributes, React wants "null"
    }
    let callee;
    if (receiver.importSpecifier.length === 0) {
        callee = JSXTransformer_createJsxFactoryExpression(receiver, element);
    }
    else {
        callee = JSXTransformer_getImplicitImportForName(receiver, "createElement");
    }
    const newChildren = [];
    if (children !== undefined && children.Nodes.length > 0) {
        for (const c of children.Nodes) {
            const res = JSXTransformer_transformJsxChildToExpression(receiver, c);
            if (res !== undefined) {
    ...
    const args = [];
    args.push(tagName);
    args.push(objectProperties);
    args.push(...newChildren);
    const result = NewCallExpression(astFactory, callee, undefined, undefined, NodeFactory_NewNodeList(astFactory, args), NodeFlagsNone);
    result.Loc = location;
    if (receiver.inJsxChild) {
        EmitContext_AddEmitFlags(emitContext, result, EFStartOnNewLine);
    }
    return result;
}
/**
 ...
 * }
 */
export function JSXTransformer_visitJsxOpeningFragmentCreateElement(receiver, fragment, children, location) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const tagName = JSXTransformer_createJsxFragmentFactoryExpression(receiver, fragment);
    const callee = JSXTransformer_createJsxFactoryExpression(receiver, fragment);
    const newChildren = [];
    if (children !== undefined && children.Nodes.length > 0) {
        for (const c of children.Nodes) {
            const res = JSXTransformer_transformJsxChildToExpression(receiver, c);
    ...
    const args = [];
    args.push(tagName);
    args.push(NewKeywordExpression(astFactory, KindNullKeyword));
    args.push(...newChildren);
    const result = NewCallExpression(astFactory, callee, undefined, undefined, NodeFactory_NewNodeList(astFactory, args), NodeFlagsNone);
    result.Loc = location;
    if (receiver.inJsxChild) {
 ...
 * }
 */
export function JSXTransformer_visitJsxText(receiver, text) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
 ...
 * }
 */
export function addLineOfJsxText(b, trimmedLine, isInitial) {
    // We do not escape the string here as that is handled by the printer
    // when it emits the literal. We do, however, need to decode JSX entities.
 ...
 * }
 */
export function JSXTransformer_visitJsxExpression(receiver, expression) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const astFactory = factory.__tsgoEmbedded0;
    const e = Transformer_Visitor(receiver.__tsgoEmbedded0).Visit(expression.Expression);
...
export function decodeEntity(entity) {
    ...
    if (byteAt(entity, 0) === 0x23 /* '#' */) {
        ...
        const [parsed, err] = ParseInt(rest, base, 32);
        if (err !== undefined) {
            return [0, false];
        }
        return [parsed, true];
 ...
 * }
 */
export let entities = new globalThis.Map([
    ["quot", 0x0022],
    ["amp", 0x0026],
    ["apos", 0x0027],
    ["lt", 0x003c],
