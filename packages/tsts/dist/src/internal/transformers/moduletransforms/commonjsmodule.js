 ...
 * }
 */
export function NewCommonJSModuleTransformer(opts) {
 ...
 * }
 */
export function CommonJSModuleTransformer_pushNode(receiver, node) {
 ...
 * }
 */
export function CommonJSModuleTransformer_popNode(receiver, grandparentNode) {
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevel(receiver, node) {
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNested(receiver, node) {
    const grandparentNode = CommonJSModuleTransformer_pushNode(receiver, node);
    try {
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedNoStack(receiver, node) {
    switch (node.Kind) {
        case KindVariableStatement:
            node = CommonJSModuleTransformer_visitTopLevelNestedVariableStatement(receiver, AsVariableStatement(node));
            break;
        case KindForStatement:
            node = CommonJSModuleTransformer_visitTopLevelNestedForStatement(receiver, AsForStatement(node));
            break;
        case KindForInStatement:
        case KindForOfStatement:
            node = CommonJSModuleTransformer_visitTopLevelNestedForInOrOfStatement(receiver, AsForInOrOfStatement(node));
            break;
        case KindDoStatement:
            node = CommonJSModuleTransformer_visitTopLevelNestedDoStatement(receiver, node);
            break;
        case KindWhileStatement:
            node = CommonJSModuleTransformer_visitTopLevelNestedWhileStatement(receiver, node);
            break;
        case KindLabeledStatement:
            node = CommonJSModuleTransformer_visitTopLevelNestedLabeledStatement(receiver, node);
            break;
        case KindWithStatement:
            node = CommonJSModuleTransformer_visitTopLevelNestedWithStatement(receiver, node);
            break;
        case KindIfStatement:
            node = CommonJSModuleTransformer_visitTopLevelNestedIfStatement(receiver, node);
            break;
        case KindSwitchStatement:
            node = CommonJSModuleTransformer_visitTopLevelNestedSwitchStatement(receiver, node);
            break;
        case KindCaseBlock:
            node = CommonJSModuleTransformer_visitTopLevelNestedCaseBlock(receiver, AsCaseBlock(node));
            break;
        case KindCaseClause:
        case KindDefaultClause:
            node = CommonJSModuleTransformer_visitTopLevelNestedCaseOrDefaultClause(receiver, AsCaseOrDefaultClause(node));
            break;
        case KindTryStatement:
            node = CommonJSModuleTransformer_visitTopLevelNestedTryStatement(receiver, node);
            break;
        case KindCatchClause:
            node = CommonJSModuleTransformer_visitTopLevelNestedCatchClause(receiver, AsCatchClause(node));
            break;
        case KindBlock:
            node = CommonJSModuleTransformer_visitTopLevelNestedBlock(receiver, AsBlock(node));
            break;
        default:
 ...
 * }
 */
export function CommonJSModuleTransformer_visit(receiver, node) {
    const grandparentNode = CommonJSModuleTransformer_pushNode(receiver, node);
    try {
 ...
 * }
 */
export function CommonJSModuleTransformer_visitNoStack(receiver, node, resultIsDiscarded) {
    // This visitor does not need to descend into the tree if there are no dynamic imports or identifiers in the subtree
    ...
    switch (node.Kind) {
        case KindSourceFile:
            node = CommonJSModuleTransformer_visitSourceFile(receiver, node);
            break;
        case KindForStatement:
            node = CommonJSModuleTransformer_visitForStatement(receiver, AsForStatement(node));
            break;
        case KindForInStatement:
        case KindForOfStatement:
            node = CommonJSModuleTransformer_visitForInOrOfStatement(receiver, AsForInOrOfStatement(node));
            break;
        case KindExpressionStatement:
            node = CommonJSModuleTransformer_visitExpressionStatement(receiver, node);
            break;
        case KindVoidExpression:
            node = CommonJSModuleTransformer_visitVoidExpression(receiver, node);
            break;
        case KindParenthesizedExpression:
            node = CommonJSModuleTransformer_visitParenthesizedExpression(receiver, node, resultIsDiscarded);
            break;
        case KindPartiallyEmittedExpression:
            node = CommonJSModuleTransformer_visitPartiallyEmittedExpression(receiver, node, resultIsDiscarded);
            break;
        case KindCallExpression:
            node = CommonJSModuleTransformer_visitCallExpression(receiver, node);
            break;
        case KindTaggedTemplateExpression:
            node = CommonJSModuleTransformer_visitTaggedTemplateExpression(receiver, node);
            break;
        case KindBinaryExpression:
            node = CommonJSModuleTransformer_visitBinaryExpression(receiver, AsBinaryExpression(node), resultIsDiscarded);
            break;
        case KindPrefixUnaryExpression:
            node = CommonJSModuleTransformer_visitPrefixUnaryExpression(receiver, node, resultIsDiscarded);
            break;
        case KindPostfixUnaryExpression:
            node = CommonJSModuleTransformer_visitPostfixUnaryExpression(receiver, node, resultIsDiscarded);
            break;
        case KindShorthandPropertyAssignment:
            node = CommonJSModuleTransformer_visitShorthandPropertyAssignment(receiver, AsShorthandPropertyAssignment(node));
            break;
        case KindIdentifier:
            node = CommonJSModuleTransformer_visitIdentifier(receiver, node);
            break;
        default:
            node = NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
            break;
    }
    return node;
}
 ...
 * }
 */
export function CommonJSModuleTransformer_visitDiscardedValue(receiver, node) {
    const grandparentNode = CommonJSModuleTransformer_pushNode(receiver, node);
    try {
 ...
 * }
 */
export function CommonJSModuleTransformer_visitAssignmentPattern(receiver, node) {
    const grandparentNode = CommonJSModuleTransformer_pushNode(receiver, node);
    try {
 ...
 * }
 */
export function CommonJSModuleTransformer_visitAssignmentPatternNoStack(receiver, node) {
    switch (node.Kind) {
        // AssignmentPattern
        case KindObjectLiteralExpression:
        case KindArrayLiteralExpression:
            node = NodeVisitor_VisitEachChild(receiver.assignmentPatternVisitor, node);
            break;
        // AssignmentProperty
        case KindPropertyAssignment:
            node = CommonJSModuleTransformer_visitAssignmentProperty(receiver, AsPropertyAssignment(node));
            break;
        case KindShorthandPropertyAssignment:
            node = CommonJSModuleTransformer_visitShorthandAssignmentProperty(receiver, AsShorthandPropertyAssignment(node));
            break;
        // AssignmentRestProperty
        case KindSpreadAssignment:
            node = CommonJSModuleTransformer_visitAssignmentRestProperty(receiver, AsSpreadAssignment(node));
            break;
        // AssignmentRestElement
        case KindSpreadElement:
            node = CommonJSModuleTransformer_visitAssignmentRestElement(receiver, node);
            break;
        // AssignmentElement
        default:
 ...
 * }
 */
export function CommonJSModuleTransformer_visitSourceFile(receiver, node) {
    if (node.IsDeclarationFile ||
 ...
 * }
 */
export function CommonJSModuleTransformer_shouldEmitUnderscoreUnderscoreESModule(receiver) {
 ...
 * }
 */
export function CommonJSModuleTransformer_createUnderscoreUnderscoreESModule(receiver) {
    ...
    const statement = NewExpressionStatement(f, NewCallExpression(f, NewPropertyAccessExpression(f, NewIdentifier(f, "Object"), undefined, /*questionDotToken*/ NewIdentifier(f, "defineProperty"), NodeFlagsNone), undefined, /*questionDotToken*/ undefined, /*typeArguments*/ NodeFactory_NewNodeList(f, [
        NewIdentifier(f, "exports"),
        NewStringLiteral(f, "__esModule", TokenFlagsNone),
        NewObjectLiteralExpression(f, NodeFactory_NewNodeList(f, [
            NewPropertyAssignment(f, undefined, /*modifiers*/ NewIdentifier(f, "value"), undefined, /*postfixToken*/ undefined, /*typeNode*/ NodeFactory_NewTrueExpression(pf)),
        ]), false),
    ]), NodeFlagsNone));
 ...
 * }
 */
export function CommonJSModuleTransformer_transformCommonJSModule(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const topLevelVisitor = receiver.topLevelVisitor;
    ...
    if (receiver.currentModuleInfo.exportedNames.length > 0) {
        ...
        for (let i = 0; i < l; i += chunkSize) {
            let right = NodeFactory_NewVoidZeroExpression(pf);
            for (const nextId of receiver.currentModuleInfo.exportedNames.slice(i, Math.min(i + chunkSize, l))) {
                ...
                if (nextId.Kind === KindStringLiteral) {
                    left = NewElementAccessExpression(f, NewIdentifier(f, "exports"), undefined, /*questionDotToken*/ NodeFactory_NewStringLiteralFromNode(pf, nextId), NodeFlagsNone);
                }
                else {
                    const name = Node_Clone(nextId, { AsNodeFactory: () => f });
                    EmitContext_SetEmitFlags(emitContext, name, EFNoSourceMap | EFNoComments);
                    left = NewPropertyAccessExpression(f, NewIdentifier(f, "exports"), undefined, /*questionDotToken*/ name, NodeFlagsNone);
                }
                right = NodeFactory_NewAssignmentExpression(pf, left, right);
            }
    ...
    OrderedSet_Values(receiver.currentModuleInfo.exportedFunctions)((f_) => {
        statements = CommonJSModuleTransformer_appendExportsOfClassOrFunctionDeclaration(receiver, statements, f_);
    ...
    EmitContext_AddEmitHelper(emitContext, result, ...EmitContext_ReadEmitHelpers(emitContext));
 ...
 * }
 */
export function CommonJSModuleTransformer_appendExportEqualsIfNeeded(receiver, statements) {
    if (receiver.currentModuleInfo.exportEquals !== undefined) {
        ...
        if (expressionResult !== undefined) {
            ...
            const f = pf.__tsgoEmbedded0;
            const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
            const statement = NewExpressionStatement(f, NodeFactory_NewAssignmentExpression(pf, NewPropertyAccessExpression(f, NewIdentifier(f, "module"), undefined, /*questionDotToken*/ NewIdentifier(f, "exports"), NodeFlagsNone), expressionResult));
 ...
 * }
 */
export function CommonJSModuleTransformer_visitExportEquals(receiver, node) {
    const grandparentNode = CommonJSModuleTransformer_pushNode(receiver, Node_AsNode(node));
    try {
        return NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Expression);
    }
    finally {
        CommonJSModuleTransformer_popNode(receiver, grandparentNode);
    }
 ...
 * }
 */
export function CommonJSModuleTransformer_appendExportsOfImportDeclaration(receiver, statements, decl) {
    if (receiver.currentModuleInfo.exportEquals !== undefined) {
        return statements;
    }
    ...
    const seen = NewSetWithSizeHint(0);
    if (Node_Name(importClause) !== undefined) {
        statements = CommonJSModuleTransformer_appendExportsOfDeclaration(receiver, statements, importClause, seen, false /*liveBinding*/);
    }
    const namedBindings = AsImportClause(importClause).NamedBindings;
    if (namedBindings !== undefined) {
        switch (namedBindings.Kind) {
            case KindNamespaceImport:
                statements = CommonJSModuleTransformer_appendExportsOfDeclaration(receiver, statements, namedBindings, seen, false /*liveBinding*/);
                break;
            case KindNamedImports:
                for (const importBinding of Node_Elements(namedBindings)) {
                    statements = CommonJSModuleTransformer_appendExportsOfDeclaration(receiver, statements, importBinding, seen, true /*liveBinding*/);
                }
                break;
        }
    }
 ...
 * }
 */
export function CommonJSModuleTransformer_appendExportsOfVariableStatement(receiver, statements, node) {
 ...
 * }
 */
export function CommonJSModuleTransformer_appendExportsOfVariableDeclarationList(receiver, statements, node, isForInOrOfInitializer) {
    if (receiver.currentModuleInfo.exportEquals !== undefined) {
        return statements;
    }
 ...
 * }
 */
export function CommonJSModuleTransformer_appendExportsOfBindingElement(receiver, statements, decl, isForInOrOfInitializer) {
    ...
    if (IsBindingPattern(Node_Name(decl))) {
        ...
        statements = CommonJSModuleTransformer_appendExportsOfDeclaration(receiver, statements, decl, undefined /*seen*/, false /*liveBinding*/);
    }
    return statements;
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_appendExportsOfClassOrFunctionDeclaration(receiver, statements, decl) {
    if (receiver.currentModuleInfo.exportEquals !== undefined) {
        return statements;
    }
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    ...
    if (HasSyntacticModifier(Node_AsNode(decl), ModifierFlagsExport)) {
        ...
        statements = CommonJSModuleTransformer_appendExportStatement(receiver, statements, seen, exportName, exportValue, decl.Loc, false /*allowComments*/, false /*liveBinding*/);
    }
 ...
 * }
 */
export function CommonJSModuleTransformer_appendExportsOfDeclaration(receiver, statements, decl, seen, liveBinding) {
    if (receiver.currentModuleInfo.exportEquals !== undefined) {
        return statements;
    }
    if (seen === undefined) {
        seen = NewSetWithSizeHint(0);
    }
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    ...
    if (MultiMap_Len(receiver.currentModuleInfo.exportSpecifiers) > 0 && name !== undefined && IsIdentifier(name)) {
        ...
        if (exportSpecifiers.length > 0) {
            const exportValue = CommonJSModuleTransformer_visitExpressionIdentifier(receiver, declName);
            for (const exportSpecifier of exportSpecifiers) {
                statements = CommonJSModuleTransformer_appendExportStatement(receiver, statements, seen, exportSpecifier.name, exportValue, exportSpecifier.name.Loc /*location*/, false /*allowComments*/, liveBinding);
            }
        }
    }
    return statements;
 ...
 * }
 */
export function CommonJSModuleTransformer_appendExportStatement(receiver, statements, seen, exportName, expression, location, allowComments, liveBinding) {
 ...
 * }
 */
export function CommonJSModuleTransformer_createExportStatement(receiver, name, value, location, allowComments, liveBinding) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function CommonJSModuleTransformer_createExportExpression(receiver, name, value, location, liveBinding) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    let expression;
    if (liveBinding) {
        // For a live binding we emit a getter on `exports` that returns the value:
        //  Object.defineProperty(exports, "<name>", { enumerable: true, get: function () { return <value>; } });
        expression = NewCallExpression(f, NewPropertyAccessExpression(f, NewIdentifier(f, "Object"), undefined, /*questionDotToken*/ NewIdentifier(f, "defineProperty"), NodeFlagsNone), undefined, /*questionDotToken*/ undefined, /*typeArguments*/ NodeFactory_NewNodeList(f, [
            NewIdentifier(f, "exports"),
            NodeFactory_NewStringLiteralFromNode(pf, name),
            NewObjectLiteralExpression(f, NodeFactory_NewNodeList(f, [
                NewPropertyAssignment(f, undefined, /*modifiers*/ NewIdentifier(f, "enumerable"), undefined, /*postfixToken*/ undefined, /*typeNode*/ NodeFactory_NewTrueExpression(pf)),
                NewPropertyAssignment(f, undefined, /*modifiers*/ NewIdentifier(f, "get"), undefined, /*postfixToken*/ undefined, /*typeNode*/ NewFunctionExpression(f, undefined, /*modifiers*/ undefined, /*asteriskToken*/ undefined, /*name*/ undefined, /*typeParameters*/ NodeFactory_NewNodeList(f, []), undefined, /*type*/ undefined, /*fullSignature*/ NewBlock(f, NodeFactory_NewNodeList(f, [
        ...
        if (name.Kind === KindStringLiteral) {
            // emits:
            //  exports["<name>"] = <value>;
            left = NewElementAccessExpression(f, NewIdentifier(f, "exports"), undefined, /*questionDotToken*/ NodeFactory_NewStringLiteralFromNode(pf, name), NodeFlagsNone);
        }
        else {
            // emits:
            //  exports.<name> = <value>;
            left = NewPropertyAccessExpression(f, NewIdentifier(f, "exports"), undefined, /*questionDotToken*/ Node_Clone(name, { AsNodeFactory: () => f }), NodeFlagsNone);
        }
 ...
 * }
 */
export function CommonJSModuleTransformer_createRequireCall(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    let args = [];
    ...
    return NewCallExpression(f, NewIdentifier(f, "require"), undefined, /*questionDotToken*/ undefined, /*typeArguments*/ NodeFactory_NewNodeList(f, args), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_getHelperExpressionForExport(receiver, node, innerExpr) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    if (getExportNeedsImportStarHelper(node)) {
        return NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), NodeFactory_NewImportStarHelper(pf, innerExpr));
    }
    return innerExpr;
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_getHelperExpressionForImport(receiver, node, innerExpr) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    if (getImportNeedsImportStarHelper(node)) {
        return NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), NodeFactory_NewImportStarHelper(pf, innerExpr));
    }
    if (getImportNeedsImportDefaultHelper(node)) {
        return NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), NodeFactory_NewImportDefaultHelper(pf, innerExpr));
    }
    return innerExpr;
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelImportDeclaration(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    ...
    if (namespaceDeclaration !== undefined && !IsDefaultImport(Node_AsNode(node))) {
        // import * as n from "mod";
        variables = [...variables, NewVariableDeclaration(f, Node_Clone(Node_Name(namespaceDeclaration), { AsNodeFactory: () => f }), undefined, /*exclamationToken*/ undefined, /*type*/ CommonJSModuleTransformer_getHelperExpressionForImport(receiver, node, CommonJSModuleTransformer_createRequireCall(receiver, Node_AsNode(node)))),
        ];
    }
    else {
        // import d from "mod";
        ...
        // import d, { x, y } from "mod";
        // import d, * as n from "mod";
        variables = [...variables, NewVariableDeclaration(f, NodeFactory_NewGeneratedNameForNode(pf, Node_AsNode(node)), undefined, /*exclamationToken*/ undefined, /*type*/ CommonJSModuleTransformer_getHelperExpressionForImport(receiver, node, CommonJSModuleTransformer_createRequireCall(receiver, Node_AsNode(node)))),
        ];
        if (namespaceDeclaration !== undefined && IsDefaultImport(Node_AsNode(node))) {
            variables = [...variables, NewVariableDeclaration(f, Node_Clone(Node_Name(namespaceDeclaration), { AsNodeFactory: () => f }), undefined, /*exclamationToken*/ undefined, /*type*/ NodeFactory_NewGeneratedNameForNode(pf, Node_AsNode(node))),
            ];
        }
    }
    const varStatement = NewVariableStatement(f, undefined, /*modifiers*/ NewVariableDeclarationList(f, NodeFactory_NewNodeList(f, variables), NodeFlagsConst));
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelImportEqualsDeclaration(receiver, node) {
    ...
    if (HasSyntacticModifier(Node_AsNode(node), ModifierFlagsExport)) {
        // export import m = require("mod");
        const statement = NewExpressionStatement(f, CommonJSModuleTransformer_createExportExpression(receiver, node.name, CommonJSModuleTransformer_createRequireCall(receiver, Node_AsNode(node)), node.Loc /*location*/, false));
        EmitContext_SetOriginal(emitContext, statement, Node_AsNode(node));
        EmitContext_AssignCommentAndSourceMapRanges(emitContext, statement, Node_AsNode(node));
        statements = [...statements, statement];
    }
        ...
        // import m = require("mod");
        const statement = NewVariableStatement(f, undefined, /*modifiers*/ NewVariableDeclarationList(f, NodeFactory_NewNodeList(f, [
            NewVariableDeclaration(f, Node_Clone(node.name, { AsNodeFactory: () => f }), undefined, /*exclamationToken*/ undefined, /*typeNode*/ CommonJSModuleTransformer_createRequireCall(receiver, Node_AsNode(node))),
        ]), NodeFlagsConst));
        EmitContext_SetOriginal(emitContext, statement, Node_AsNode(node));
        EmitContext_AssignCommentAndSourceMapRanges(emitContext, statement, Node_AsNode(node));
        statements = [...statements, statement];
    }
    statements = CommonJSModuleTransformer_appendExportsOfDeclaration(receiver, statements, Node_AsNode(node), undefined /*seen*/, false /*liveBinding*/);
    return SingleOrMany(statements, pf);
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelExportDeclaration(receiver, node) {
    ...
    if (node.ExportClause !== undefined && IsNamedExports(node.ExportClause)) {
        // export { x, y } from "mod";
        let statements = [];
        const varStatement = NewVariableStatement(f, undefined, /*modifiers*/ NewVariableDeclarationList(f, NodeFactory_NewNodeList(f, [
            NewVariableDeclaration(f, generatedName, undefined, /*exclamationToken*/ undefined, /*type*/ CommonJSModuleTransformer_createRequireCall(receiver, Node_AsNode(node))),
        ]), NodeFlagsNone));
        EmitContext_SetOriginal(emitContext, varStatement, Node_AsNode(node));
        EmitContext_AssignCommentAndSourceMapRanges(emitContext, varStatement, Node_AsNode(node));
        statements = [...statements, varStatement];
        for (const specifier of Node_Elements(node.ExportClause)) {
            ...
            let target;
            if (exportNeedsImportDefault) {
                target = NodeFactory_NewImportDefaultHelper(pf, generatedName);
            }
            else {
                target = generatedName;
            }
            ...
            const stmt = NewExpressionStatement(f, CommonJSModuleTransformer_createExportExpression(receiver, exportName, exportedValue, undefined, /*location*/ true));
    ...
    if (node.ExportClause !== undefined) {
        ...
        const stmt = NewExpressionStatement(f, CommonJSModuleTransformer_createExportExpression(receiver, exportName, CommonJSModuleTransformer_getHelperExpressionForExport(receiver, node, CommonJSModuleTransformer_createRequireCall(receiver, Node_AsNode(node))), undefined, /*location*/ false));
    ...
    // export * from "mod";
    const stmt = NewExpressionStatement(f, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), NodeFactory_NewExportStarHelper(pf, CommonJSModuleTransformer_createRequireCall(receiver, Node_AsNode(node)), NewIdentifier(f, "exports"))));
    EmitContext_SetOriginal(emitContext, stmt, Node_AsNode(node));
    EmitContext_AssignCommentAndSourceMapRanges(emitContext, stmt, Node_AsNode(node));
    return stmt;
}
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelExportAssignment(receiver, node) {
    if (node.IsExportEquals) {
        return undefined;
    }
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    return CommonJSModuleTransformer_createExportStatement(receiver, NewIdentifier(f, "default"), NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Expression), node.Loc, /*location*/ true, /*allowComments*/ false);
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelFunctionDeclaration(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    if (HasSyntacticModifier(Node_AsNode(node), ModifierFlagsExport)) {
        return NodeFactory_UpdateFunctionDeclaration(pf.__tsgoEmbedded0, node, ExtractModifiers(emitContext, Node_Modifiers(Node_AsNode(node)), ~ModifierFlagsExportDefault), node.AsteriskToken, NodeFactory_GetDeclarationName(pf, Node_AsNode(node)), undefined, /*typeParameters*/ NodeVisitor_VisitNodes(visitor, node.Parameters), undefined, /*type*/ undefined, /*fullSignature*/ NodeVisitor_VisitNode(visitor, node.Body));
    }
    else {
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelClassDeclaration(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    let statements = [];
    if (HasSyntacticModifier(Node_AsNode(node), ModifierFlagsExport)) {
        statements = [...statements, NodeFactory_UpdateClassDeclaration(pf.__tsgoEmbedded0, node, NodeVisitor_VisitModifiers(visitor, ExtractModifiers(emitContext, Node_Modifiers(Node_AsNode(node)), ~ModifierFlagsExportDefault)), NodeFactory_GetDeclarationName(pf, Node_AsNode(node)), undefined, /*typeParameters*/ NodeVisitor_VisitNodes(visitor, node.HeritageClauses), NodeVisitor_VisitNodes(visitor, node.Members))];
    }
    else {
        statements = [...statements, NodeVisitor_VisitEachChild(visitor, Node_AsNode(node))];
    }
    statements = CommonJSModuleTransformer_appendExportsOfClassOrFunctionDeclaration(receiver, statements, Node_AsNode(node));
    return SingleOrMany(statements, pf);
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelVariableStatement(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    if (HasSyntacticModifier(Node_AsNode(node), ModifierFlagsExport)) {
        ...
        let statements = [];
        const commitPendingVariables = () => {
            if (variables.length > 0) {
                const variableList = NodeFactory_NewNodeList(f, variables);
                const statement = NodeFactory_UpdateVariableStatement(f, node, modifiers, NodeFactory_UpdateVariableDeclarationList(f, AsVariableDeclarationList(node.DeclarationList), variableList, node.DeclarationList.Flags));
        ...
        const commitPendingExpressions = () => {
        ...
        for (let variable of AsVariableDeclarationList(node.DeclarationList).Declarations.Nodes) {
            ...
            if (IsIdentifier(Node_Name(variable)) && IsLocalName(emitContext, Node_Name(variable))) {
                ...
                if (v.Initializer !== undefined) {
                    variable = NewVariableDeclaration(f, Node_Name(variable), undefined, /*exclamationToken*/ undefined, /*type*/ CommonJSModuleTransformer_createExportExpression(receiver, Node_Name(variable), NodeVisitor_VisitNode(visitor, v.Initializer), undefined, false));
                }
                pushVariable(variable);
            }
                ...
                // preserve variable declarations for functions and classes to assign names
                pushVariable(NewVariableDeclaration(f, Node_Name(variable), v.ExclamationToken, v.Type, NodeVisitor_VisitNode(visitor, v.Initializer)));
                const propertyAccess = NewPropertyAccessExpression(f, NewIdentifier(f, "exports"), undefined, /*questionDotToken*/ Node_Name(variable), NodeFlagsNone);
                EmitContext_AssignCommentAndSourceMapRanges(emitContext, propertyAccess, Node_Name(variable));
                pushExpression(NodeFactory_NewAssignmentExpression(pf, propertyAccess, Node_Clone(Node_Name(variable), { AsNodeFactory: () => f })));
            }
                ...
                if (expression !== undefined) {
                    pushExpression(NodeVisitor_VisitNode(visitor, expression));
                }
            }
 ...
 * }
 */
export function CommonJSModuleTransformer_transformInitializedVariable(receiver, node) {
    ...
    if (IsBindingPattern(name)) {
        return FlattenDestructuringAssignment(receiver.__tsgoEmbedded0, NodeVisitor_VisitNode(visitor, Node_AsNode(node)), false, /*needsValue*/ FlattenLevelAll, (n, v, loc) => CommonJSModuleTransformer_createAllExportExpressions(receiver, n, v, loc));
    }
    const propertyAccess = NewPropertyAccessExpression(f, NewIdentifier(f, "exports"), undefined, /*questionDotToken*/ name, NodeFlagsNone);
    EmitContext_AssignCommentAndSourceMapRanges(emitContext, propertyAccess, name);
    return NodeFactory_NewAssignmentExpression(pf, propertyAccess, node.Initializer);
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedVariableStatement(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    let statements = [];
    statements = [...statements, NodeVisitor_VisitEachChild(visitor, Node_AsNode(node))];
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedForStatement(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const discardedValueVisitor = receiver.discardedValueVisitor;
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
    if (node.Initializer !== undefined && IsVariableDeclarationList(node.Initializer) && (node.Initializer.Flags & NodeFlagsBlockScoped) === 0) {
        ...
        if (exportStatements.length > 0) {
            ...
            statements = [...statements, NodeFactory_UpdateForStatement(f, node, undefined, /*initializer*/ condition, incrementor, body)];
            return SingleOrMany(statements, pf);
        }
    }
    return NodeFactory_UpdateForStatement(f, node, NodeVisitor_VisitNode(discardedValueVisitor, node.Initializer), NodeVisitor_VisitNode(visitor, node.Condition), NodeVisitor_VisitNode(discardedValueVisitor, node.Incrementor), EmitContext_VisitIterationBody(emitContext, node.Statement, topLevelNestedVisitor));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedForInOrOfStatement(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    if (IsVariableDeclarationList(node.Initializer) && (node.Initializer.Flags & NodeFlagsBlockScoped) === 0) {
        ...
        if (exportStatements.length > 0) {
            ...
            let body = EmitContext_VisitIterationBody(emitContext, node.Statement, topLevelNestedVisitor);
            if (IsBlock(body)) {
    ...
    return NodeFactory_UpdateForInOrOfStatement(f, node, node.AwaitModifier, NodeVisitor_VisitNode(discardedValueVisitor, node.Initializer), NodeVisitor_VisitNode(visitor, node.Expression), EmitContext_VisitIterationBody(emitContext, node.Statement, topLevelNestedVisitor));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedDoStatement(receiver, node) {
    const f = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
    return NodeFactory_UpdateDoStatement(f, node, EmitContext_VisitIterationBody(emitContext, node.Statement, topLevelNestedVisitor), NodeVisitor_VisitNode(visitor, node.Expression));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedWhileStatement(receiver, node) {
    const f = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
    return NodeFactory_UpdateWhileStatement(f, node, NodeVisitor_VisitNode(visitor, node.Expression), EmitContext_VisitIterationBody(emitContext, node.Statement, topLevelNestedVisitor));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedLabeledStatement(receiver, node) {
    const f = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
    return NodeFactory_UpdateLabeledStatement(f, node, node.Label, NodeVisitor_VisitEmbeddedStatement(topLevelNestedVisitor, node.Statement));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedWithStatement(receiver, node) {
    const f = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
    return NodeFactory_UpdateWithStatement(f, node, NodeVisitor_VisitNode(visitor, node.Expression), NodeVisitor_VisitEmbeddedStatement(topLevelNestedVisitor, node.Statement));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedIfStatement(receiver, node) {
    const f = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
    return NodeFactory_UpdateIfStatement(f, node, NodeVisitor_VisitNode(visitor, node.Expression), NodeVisitor_VisitEmbeddedStatement(topLevelNestedVisitor, node.ThenStatement), NodeVisitor_VisitEmbeddedStatement(topLevelNestedVisitor, node.ElseStatement));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedSwitchStatement(receiver, node) {
    const f = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
    return NodeFactory_UpdateSwitchStatement(f, node, NodeVisitor_VisitNode(visitor, node.Expression), NodeVisitor_VisitNode(topLevelNestedVisitor, node.CaseBlock));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedCaseBlock(receiver, node) {
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedCaseOrDefaultClause(receiver, node) {
    const f = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
    return NodeFactory_UpdateCaseOrDefaultClause(f, node, NodeVisitor_VisitNode(visitor, node.Expression), NodeVisitor_VisitNodes(topLevelNestedVisitor, node.Statements));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedTryStatement(receiver, node) {
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
    return NodeVisitor_VisitEachChild(topLevelNestedVisitor, Node_AsNode(node));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedCatchClause(receiver, node) {
    const f = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
    return NodeFactory_UpdateCatchClause(f, node, node.VariableDeclaration, NodeVisitor_VisitNode(topLevelNestedVisitor, node.Block));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTopLevelNestedBlock(receiver, node) {
    const topLevelNestedVisitor = receiver.topLevelNestedVisitor;
    return NodeVisitor_VisitEachChild(topLevelNestedVisitor, Node_AsNode(node));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitForStatement(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function CommonJSModuleTransformer_visitForInOrOfStatement(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function CommonJSModuleTransformer_visitExpressionStatement(receiver, node) {
    const discardedValueVisitor = receiver.discardedValueVisitor;
 ...
 * }
 */
export function CommonJSModuleTransformer_visitVoidExpression(receiver, node) {
    const discardedValueVisitor = receiver.discardedValueVisitor;
    return NodeVisitor_VisitEachChild(discardedValueVisitor, Node_AsNode(node));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitParenthesizedExpression(receiver, node, resultIsDiscarded) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const discardedValueVisitor = receiver.discardedValueVisitor;
 ...
 * }
 */
export function CommonJSModuleTransformer_visitPartiallyEmittedExpression(receiver, node, resultIsDiscarded) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const discardedValueVisitor = receiver.discardedValueVisitor;
 ...
 * }
 */
export function CommonJSModuleTransformer_visitBinaryExpression(receiver, node, resultIsDiscarded) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function CommonJSModuleTransformer_visitAssignmentExpression(receiver, node) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    if (IsIdentifier(node.Left) &&
        ...
        if (exportedNames.length > 0) {
            let expression = NodeVisitor_VisitEachChild(visitor, Node_AsNode(node));
            for (const exportName of exportedNames) {
                expression = CommonJSModuleTransformer_createExportExpression(receiver, exportName, expression, node.Loc /*location*/, false /*liveBinding*/);
            }
            return expression;
        }
    }
 ...
 * }
 */
export function CommonJSModuleTransformer_visitDestructuringAssignment(receiver, node, valueIsDiscarded) {
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    if (CommonJSModuleTransformer_destructuringNeedsFlattening(receiver, node.Left)) {
        return FlattenDestructuringAssignment(receiver.__tsgoEmbedded0, Node_AsNode(node), !valueIsDiscarded, /*needsValue*/ FlattenLevelAll, (name, value, location) => CommonJSModuleTransformer_createAllExportExpressions(receiver, name, value, location));
    }
    return NodeVisitor_VisitEachChild(visitor, Node_AsNode(node));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_destructuringNeedsFlattening(receiver, node) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function CommonJSModuleTransformer_createAllExportExpressions(receiver, name, value, location) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    ...
    if (exportedNames.length > 0) {
        ...
        if (CommonJSModuleTransformer_isDirectExport(receiver, name)) {
            const exportName = Node_Clone(name, { AsNodeFactory: () => f });
            EmitContext_AddEmitFlags(emitContext, exportName, EFNoComments | EFNoSourceMap);
            const propertyAccess = NewPropertyAccessExpression(f, NewIdentifier(f, "exports"), undefined /*questionDotToken*/, exportName, NodeFlagsNone);
 ...
 * }
 */
export function CommonJSModuleTransformer_isDirectExport(receiver, name) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
 ...
 * }
 */
export function CommonJSModuleTransformer_visitAssignmentProperty(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const assignmentPatternVisitor = receiver.assignmentPatternVisitor;
    return NodeFactory_UpdatePropertyAssignment(f, node, undefined /*modifiers*/, NodeVisitor_VisitNode(visitor, node.name), undefined /*postfixToken*/, undefined /*typeNode*/, NodeVisitor_VisitNode(assignmentPatternVisitor, node.Initializer));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitShorthandAssignmentProperty(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    let target = CommonJSModuleTransformer_visitDestructuringAssignmentTargetNoStack(receiver, node.name);
    if (IsIdentifier(target)) {
        return NodeFactory_UpdateShorthandPropertyAssignment(f, node, undefined /*modifiers*/, target, undefined /*postfixToken*/, undefined /*typeNode*/, node.EqualsToken, NodeVisitor_VisitNode(visitor, node.ObjectAssignmentInitializer));
    }
    if (node.ObjectAssignmentInitializer !== undefined) {
        ...
        target = NewBinaryExpression(f, undefined /*modifiers*/, target, undefined /*typeNode*/, equalsToken, NodeVisitor_VisitNode(visitor, node.ObjectAssignmentInitializer));
    }
    const updated = NewPropertyAssignment(f, undefined /*modifiers*/, node.name, undefined /*postfixToken*/, undefined /*typeNode*/, target);
 ...
 * }
 */
export function CommonJSModuleTransformer_visitAssignmentRestProperty(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    return NodeFactory_UpdateSpreadAssignment(f, node, CommonJSModuleTransformer_visitDestructuringAssignmentTarget(receiver, node.Expression));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitAssignmentRestElement(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    return NodeFactory_UpdateSpreadElement(f, node, CommonJSModuleTransformer_visitDestructuringAssignmentTarget(receiver, node.Expression));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitAssignmentElement(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    if (IsBinaryExpression(node)) {
        ...
        if (n.OperatorToken.Kind === KindEqualsToken) {
            return NodeFactory_UpdateBinaryExpression(f, n, undefined /*modifiers*/, CommonJSModuleTransformer_visitDestructuringAssignmentTarget(receiver, n.Left), undefined /*typeNode*/, n.OperatorToken, NodeVisitor_VisitNode(visitor, n.Right));
        }
    }
 ...
 * }
 */
export function CommonJSModuleTransformer_visitDestructuringAssignmentTarget(receiver, node) {
    const grandparentNode = CommonJSModuleTransformer_pushNode(receiver, node);
    try {
        switch (node.Kind) {
            case KindObjectLiteralExpression:
 ...
 * }
 */
export function CommonJSModuleTransformer_visitDestructuringAssignmentTargetNoStack(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    if (IsIdentifier(node) &&
        ...
        let expression = CommonJSModuleTransformer_visitExpressionIdentifier(receiver, node);
        const exportedNames = CommonJSModuleTransformer_getExports(receiver, node);
        if (exportedNames.length > 0) {
            const value = NodeFactory_NewUniqueNameEx(pf, "value", { Flags: GeneratedIdentifierFlagsOptimistic, Prefix: "", Suffix: "" });
            expression = NodeFactory_NewAssignmentExpression(pf, expression, value);
            for (const exportName of exportedNames) {
            ...
            const statement = NewExpressionStatement(f, expression);
            const statementList = NodeFactory_NewNodeList(f, [statement]);
            const param = NewParameterDeclaration(f, undefined /*modifiers*/, undefined /*dotDotDotToken*/, value, undefined /*questionToken*/, undefined /*type*/, undefined /*initializer*/);
            const valueSetter = NewSetAccessorDeclaration(f, undefined /*modifiers*/, NewIdentifier(f, "value"), undefined /*typeParameters*/, NodeFactory_NewNodeList(f, [param]), undefined /*returnType*/, undefined /*fullSignature*/, NewBlock(f, statementList, false /*multiLine*/));
            ...
            expression = NewPropertyAccessExpression(f, expression, undefined /*questionDotToken*/, NewIdentifier(f, "value"), NodeFlagsNone);
        }
        return expression;
    }
    return CommonJSModuleTransformer_visitNoStack(receiver, node, false /*resultIsDiscarded*/);
 ...
 * }
 */
export function CommonJSModuleTransformer_visitCommaExpression(receiver, node, resultIsDiscarded) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const discardedValueVisitor = receiver.discardedValueVisitor;
    ...
    return NodeFactory_UpdateBinaryExpression(f, node, undefined /*modifiers*/, left, undefined /*typeNode*/, node.OperatorToken, right);
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitPrefixUnaryExpression(receiver, node, resultIsDiscarded) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    if ((node.Operator === KindPlusPlusToken || node.Operator === KindMinusMinusToken) &&
        ...
        if (exportedNames.length > 0) {
            let expression = NodeFactory_UpdatePrefixUnaryExpression(f, node, node.Operator, NodeVisitor_VisitNode(visitor, node.Operand));
            for (const exportName of exportedNames) {
                expression = CommonJSModuleTransformer_createExportExpression(receiver, exportName, expression, undefined /*location*/, false /*liveBinding*/);
 ...
 * }
 */
export function CommonJSModuleTransformer_visitPostfixUnaryExpression(receiver, node, resultIsDiscarded) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    if ((node.Operator === KindPlusPlusToken || node.Operator === KindMinusMinusToken) &&
        ...
        if (exportedNames.length > 0) {
            let temp = undefined;
            let expression = NodeFactory_UpdatePostfixUnaryExpression(f, node, NodeVisitor_VisitNode(visitor, node.Operand), node.Operator);
            if (!resultIsDiscarded) {
            ...
            expression = NodeFactory_NewCommaExpression(pf, expression, Node_Clone(node.Operand, { AsNodeFactory: () => f }));
            EmitContext_AssignCommentAndSourceMapRanges(emitContext, expression, Node_AsNode(node));
            for (const exportName of exportedNames) {
                expression = CommonJSModuleTransformer_createExportExpression(receiver, exportName, expression, undefined /*location*/, false /*liveBinding*/);
                EmitContext_AssignCommentAndSourceMapRanges(emitContext, expression, Node_AsNode(node));
            ...
            if (temp !== undefined) {
                expression = NodeFactory_NewCommaExpression(pf, expression, temp);
                EmitContext_AssignCommentAndSourceMapRanges(emitContext, expression, Node_AsNode(node));
            }
            return expression;
        }
 ...
 * }
 */
export function CommonJSModuleTransformer_visitCallExpression(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    if (IsIdentifier(node.Expression)) {
        ...
        const updated = NodeFactory_UpdateCallExpression(f, node, expression, node.QuestionDotToken, undefined /*typeArguments*/, NodeVisitor_VisitNodes(visitor, node.Arguments), node.Flags);
 ...
 * }
 */
export function CommonJSModuleTransformer_shouldTransformImportCall(receiver) {
 ...
 * }
 */
export function CommonJSModuleTransformer_visitImportCallExpression(receiver, node, rewriteOrShim) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    const firstArgument = NodeVisitor_VisitNode(visitor, FirstOrNil(node.Arguments?.Nodes ?? []));
    let argument;
    ...
    return CommonJSModuleTransformer_createImportCallExpressionCommonJS(receiver, argument);
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_createImportCallExpressionCommonJS(receiver, arg) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const needSyncEval = arg !== undefined && !isSimpleInlineableExpression(arg);
    let promiseResolveArguments = [];
    if (needSyncEval) {
        promiseResolveArguments = [
            NewTemplateExpression(f, NewTemplateHead(f, "", "", TokenFlagsNone), NodeFactory_NewNodeList(f, [
                NewTemplateSpan(f, arg, NewTemplateTail(f, "", "", TokenFlagsNone)),
            ])),
        ];
    }
    const promiseResolveCall = NewCallExpression(f, NewPropertyAccessExpression(f, NewIdentifier(f, "Promise"), undefined /*questionDotToken*/, NewIdentifier(f, "resolve"), NodeFlagsNone), undefined /*questionDotToken*/, undefined /*typeArguments*/, NodeFactory_NewNodeList(f, promiseResolveArguments), NodeFlagsNone);
    let requireArguments = [];
    if (needSyncEval) {
        requireArguments = [NewIdentifier(f, "s")];
    }
    else if (arg !== undefined) {
        requireArguments = [arg];
    }
    const requireCall = NodeFactory_NewImportStarHelper(pf, NewCallExpression(f, NewIdentifier(f, "require"), undefined /*questionDotToken*/, undefined /*typeArguments*/, NodeFactory_NewNodeList(f, requireArguments), NodeFlagsNone));
    let parameters = [];
    if (needSyncEval) {
        parameters = [
            NewParameterDeclaration(f, undefined /*modifiers*/, undefined /*dotDotDotToken*/, NewIdentifier(f, "s"), undefined /*questionToken*/, undefined /*type*/, undefined /*initializer*/),
        ];
    }
    const func = NewArrowFunction(f, undefined /*modifiers*/, undefined /*typeParameters*/, NodeFactory_NewNodeList(f, parameters), undefined /*type*/, undefined /*fullSignature*/, NewToken(f, KindEqualsGreaterThanToken), requireCall);
    const downleveledImport = NewCallExpression(f, NewPropertyAccessExpression(f, promiseResolveCall, undefined /*questionDotToken*/, NewIdentifier(f, "then"), NodeFlagsNone), undefined /*questionDotToken*/, undefined /*typeArguments*/, NodeFactory_NewNodeList(f, [func]), NodeFlagsNone);
    return downleveledImport;
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_shimOrRewriteImportOrRequireCall(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    if ((node.Arguments?.Nodes?.length ?? 0) > 0) {
        let firstArgument = node.Arguments.Nodes[0];
        ...
        if (IsStringLiteralLike(firstArgument)) {
            ...
            firstArgument = NodeFactory_NewRewriteRelativeImportExtensionsHelper(pf, firstArgument, receiver.compilerOptions.Jsx === JsxEmitPreserve);
            firstArgumentChanged = true;
        }
        const [rest, restChanged] = NodeVisitor_VisitSlice(visitor, node.Arguments.Nodes.slice(1));
        if (firstArgumentChanged || restChanged) {
            const argumentsNodes = [firstArgument, ...rest];
            argumentsList = NodeFactory_NewNodeList(f, argumentsNodes);
            argumentsList.Loc = node.Arguments.Loc;
        }
    }
    return NodeFactory_UpdateCallExpression(f, node, expression, node.QuestionDotToken, undefined /*typeArguments*/, argumentsList, node.Flags);
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitTaggedTemplateExpression(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    if (IsIdentifier(node.Tag)) {
        ...
        const updated = NodeFactory_UpdateTaggedTemplateExpression(f, node, expression, undefined /*questionDotToken*/, undefined /*typeArguments*/, NodeVisitor_VisitNode(visitor, node.Template), node.Flags);
 ...
 * }
 */
export function CommonJSModuleTransformer_visitShorthandPropertyAssignment(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const f = pf.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    if (exportedOrImportedName !== name) {
        ...
        if (node.ObjectAssignmentInitializer !== undefined) {
            expression = NodeFactory_NewAssignmentExpression(pf, expression, NodeVisitor_VisitNode(visitor, node.ObjectAssignmentInitializer));
        }
    ...
    return NodeFactory_UpdateShorthandPropertyAssignment(f, node, undefined /*modifiers*/, exportedOrImportedName, undefined /*postfixToken*/, undefined /*typeNode*/, node.EqualsToken, NodeVisitor_VisitNode(visitor, node.ObjectAssignmentInitializer));
}
/**
 ...
 * }
 */
export function CommonJSModuleTransformer_visitIdentifier(receiver, node) {
 ...
 * }
 */
export function CommonJSModuleTransformer_visitExpressionIdentifier(receiver, node) {
    const pf = Transformer_Factory(receiver.__tsgoEmbedded0);
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    ...
    if (!(info !== undefined && !GeneratedIdentifierFlags_HasAllowNameSubstitution(info.Flags)) &&
        ...
        if (exportContainer !== undefined && IsSourceFile(exportContainer)) {
            const reference = NewPropertyAccessExpression(pf.__tsgoEmbedded0, NewIdentifier(pf.__tsgoEmbedded0, "exports"), undefined /*questionDotToken*/, Node_Clone(node, { AsNodeFactory: () => pf.__tsgoEmbedded0 }), NodeFlagsNone);
        ...
        if (importDeclaration !== undefined) {
            if (IsImportClause(importDeclaration)) {
                const reference = NewPropertyAccessExpression(pf.__tsgoEmbedded0, NodeFactory_NewGeneratedNameForNode(pf, importDeclaration.Parent), undefined /*questionDotToken*/, NewIdentifier(pf.__tsgoEmbedded0, "default"), NodeFlagsNone);
                EmitContext_AssignCommentAndSourceMapRanges(emitContext, reference, node);
                reference.Loc = node.Loc;
                return reference;
            }
            if (IsImportSpecifier(importDeclaration)) {
                ...
                if (IsStringLiteral(name)) {
                    reference = NewElementAccessExpression(pf.__tsgoEmbedded0, target, undefined /*questionDotToken*/, NodeFactory_NewStringLiteralFromNode(pf, name), NodeFlagsNone);
                }
                else {
                    ...
                    reference = NewPropertyAccessExpression(pf.__tsgoEmbedded0, target, undefined /*questionDotToken*/, referenceName, NodeFlagsNone);
                }
                EmitContext_AssignCommentAndSourceMapRanges(emitContext, reference, node);
                reference.Loc = node.Loc;
                return reference;
 ...
 * }
 */
export function CommonJSModuleTransformer_getExports(receiver, name) {
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    if (!IsGeneratedIdentifier(emitContext, name)) {
        ...
        const bindingsSet = NewSetWithSizeHint(0);
        let bindings = [];
...
//# sourceMappingURL=commonjsmodule.js.map