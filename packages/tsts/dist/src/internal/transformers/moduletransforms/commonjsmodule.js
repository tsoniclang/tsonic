...
export function CommonJSModuleTransformer_visitTopLevelImportDeclaration(receiver, node) {
    ...
    if (namespaceDeclaration !== undefined && !IsDefaultImport(Node_AsNode(node))) {
        // import * as n from "mod";
        variables = [...variables,
            NewVariableDeclaration(f, Node_Clone(Node_Name(namespaceDeclaration), { AsNodeFactory: () => f }), undefined, /*exclamationToken*/ undefined, /*type*/ CommonJSModuleTransformer_getHelperExpressionForImport(receiver, node, CommonJSModuleTransformer_createRequireCall(receiver, Node_AsNode(node)))),
        ];
    }
    else {
        // import d from "mod";
        ...
        // import d, * as n from "mod";
        variables = [...variables,
            NewVariableDeclaration(f, NodeFactory_NewGeneratedNameForNode(pf, Node_AsNode(node)), undefined, /*exclamationToken*/ undefined, /*type*/ CommonJSModuleTransformer_getHelperExpressionForImport(receiver, node, CommonJSModuleTransformer_createRequireCall(receiver, Node_AsNode(node)))),
        ];
        if (namespaceDeclaration !== undefined && IsDefaultImport(Node_AsNode(node))) {
            variables = [...variables,
                NewVariableDeclaration(f, Node_Clone(Node_Name(namespaceDeclaration), { AsNodeFactory: () => f }), undefined, /*exclamationToken*/ undefined, /*type*/ NodeFactory_NewGeneratedNameForNode(pf, Node_AsNode(node))),
            ];
        }
    }
...
export function CommonJSModuleTransformer_transformInitializedVariable(receiver, node) {
    ...
    if (IsBindingPattern(name)) {
        ...
        return CommonJSModuleTransformer_visitDestructuringAssignment(receiver, AsBinaryExpression(assignment), true /*valueIsDiscarded*/);
    }
...
export function CommonJSModuleTransformer_visitTopLevelNestedIfStatement(receiver, node) {
    ...
    if (thenStatement === undefined) {
        thenStatement = NewBlock(f, NodeFactory_NewNodeList(f, []), false /*multiLine*/);
    }
