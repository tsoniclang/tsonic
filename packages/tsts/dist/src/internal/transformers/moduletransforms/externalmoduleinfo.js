 ...
 * }
 */
export function collectExternalModuleInfo(sourceFile, compilerOptions, emitContext, resolver) {
    const c = {
        sourceFile: sourceFile,
        compilerOptions: compilerOptions,
        emitContext: emitContext,
        resolver: resolver,
        uniqueExports: NewSetWithSizeHint(0),
        hasExportDefault: false,
        output: {
            externalImports: [],
            exportSpecifiers: NewMultiMapWithSizeHint(0),
            exportedBindings: NewMultiMapWithSizeHint(0),
            exportedNames: [],
            exportedFunctions: NewOrderedSetWithSizeHint(0),
 ...
 * }
 */
export function externalModuleInfoCollector_collect(receiver) {
 ...
 * }
 */
export function externalModuleInfoCollector_addUniqueExport(receiver, name) {
 ...
 * }
 */
export function externalModuleInfoCollector_addExportedBinding(receiver, decl, name) {
 ...
 * }
 */
export function externalModuleInfoCollector_addExternalImport(receiver, node) {
 ...
 * }
 */
export function externalModuleInfoCollector_addExportedName(receiver, name) {
 ...
 * }
 */
export function externalModuleInfoCollector_addExportedNamesForExportDeclaration(receiver, node) {
 ...
 * }
 */
export function externalModuleInfoCollector_addExportedFunctionDeclaration(receiver, node, name, isDefault) {
 ...
 * }
 */
export function externalModuleInfoCollector_collectExportedVariableInfo(receiver, decl) {
 ...
 * }
 */
export function createExternalHelpersImportDeclarationIfNeeded(emitContext, sourceFile, compilerOptions, fileModuleKind, hasExportStarsToExportValues, hasImportStar, hasImportDefault) {
    if (Tristate_IsTrue(compilerOptions.ImportHelpers) && IsEffectiveExternalModule(sourceFile, compilerOptions)) {
        ...
        if (fileModuleKind === ModuleKindCommonJS || (fileModuleKind === ModuleKindNone && moduleKind === ModuleKindCommonJS)) {
            ...
            if (externalHelpersModuleName !== undefined) {
                ...
                const externalHelpersImportDeclaration = NewImportEqualsDeclaration(f, undefined, /*modifiers*/ false, /*isTypeOnly*/ externalHelpersModuleName, NewExternalModuleReference(f, NewStringLiteral(f, externalHelpersModuleNameText, TokenFlagsNone)));
            ...
            if (helperNames.length > 0) {
                ...
                // NOTE: We don't need to care about global import collisions as this is a module.
                const f = emitContext.Factory.__tsgoEmbedded0;
                const importSpecifiers = CoreMap(helperNames, (name) => {
                ...
                const externalHelpersImportDeclaration = NewImportDeclaration(f, undefined, /*modifiers*/ NewImportClause(f, KindUnknown /*phaseModifier*/, undefined /*name*/, namedBindings), NewStringLiteral(f, externalHelpersModuleNameText, TokenFlagsNone), undefined);
                EmitContext_AddEmitFlags(emitContext, externalHelpersImportDeclaration, EFCustomPrologue);
                return externalHelpersImportDeclaration;
            }
        }
 ...
 * }
 */
export function getImportedHelpers(emitContext, sourceFile) {
    let helpers = [];
 ...
 * }
 */
export function getOrCreateExternalHelpersModuleNameIfNeeded(emitContext, node, compilerOptions, helpers, hasExportStarsToExportValues, hasImportStarOrImportDefault, fileModuleKind) {
 ...
 * }
 */
export function isNamedDefaultReference(e) {
 ...
 * }
 */
export function containsDefaultReference(node) {
    if (node === undefined)
        return false;
...
//# sourceMappingURL=externalmoduleinfo.js.map