 ...
 * }
 */
export declare function isDeclarationNameOfEnumOrNamespace(emitContext: GoPtr<EmitContext>, node: GoPtr<IdentifierNode>): bool;
/**
 ...
 * }
 */
export declare function rewriteModuleSpecifier(emitContext: GoPtr<EmitContext>, node: GoPtr<Expression>, compilerOptions: GoPtr<CompilerOptions>): GoPtr<Expression>;
/**
 ...
 * }
 */
export declare function createEmptyImports(factory: GoPtr<NodeFactory>): GoPtr<Statement>;
/**
 ...
 * }
 */
export declare function getExternalModuleNameLiteral(factory: GoPtr<NodeFactory>, importNode: GoPtr<Node>, sourceFile: GoPtr<SourceFile>, host: unknown, resolver: EmitResolver, compilerOptions: GoPtr<CompilerOptions>): GoPtr<StringLiteralNode>;
/**
 ...
 * }
 */
export declare function tryGetModuleNameFromFile(factory: GoPtr<NodeFactory>, file: GoPtr<SourceFile>, host: unknown, options: GoPtr<CompilerOptions>): GoPtr<StringLiteralNode>;
/**
 ...
 * }
 */
export declare function tryGetModuleNameFromDeclaration(declaration: GoPtr<Node>, host: unknown, factory: GoPtr<NodeFactory>, resolver: EmitResolver, compilerOptions: GoPtr<CompilerOptions>): GoPtr<StringLiteralNode>;
/**
 ...
 * }
 */
export declare function getExternalModuleNameFromPath(host: unknown, fileName: string, referencePath: string): string;
/**
 ...
 * }
 */
export declare function tryRenameExternalModule(factory: GoPtr<NodeFactory>, moduleName: GoPtr<LiteralExpression>, sourceFile: GoPtr<SourceFile>): GoPtr<StringLiteralNode>;
/**
 ...
 * }
 */
export declare function isFileLevelReservedGeneratedIdentifier(emitContext: GoPtr<EmitContext>, name: GoPtr<IdentifierNode>): bool;
/**
