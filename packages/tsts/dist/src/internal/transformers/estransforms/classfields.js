...
export function classFieldsTransformer_wrapPrivateIdentifierForDestructuringTarget(receiver, node) {
    ...
    if (isThisOrSuperProperty || !IsSimpleCopiableExpression(prop.Expression)) {
        ...
        receiver.pendingExpressions = [...receiver.pendingExpressions,
            NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), recvTemp, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), prop.Expression)),
        ];
        recv = recvTemp;
    }
