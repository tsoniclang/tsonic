 ...
 * )
 */
export const classFactsNone = 0;
export const classFactsClassWasDecorated = 1 << 0;
export const classFactsNeedsClassConstructorReference = 1 << 1;
export const classFactsNeedsClassSuperReference = 1 << 2;
export const classFactsNeedsSubstitutionForThisInClassStaticField = 1 << 3;
export const classFactsWillHoistInitializersToConstructor = 1 << 4;
/**
 ...
 * }
 */
export function newClassFieldsTransformer(opts) {
 ...
 * }
 */
export function classFieldsTransformer_requiresBlockScopedVar(receiver) {
    return (receiver.inIterationStatement && receiver.currentClassContainer !== undefined && IsClassExpression(receiver.currentClassContainer));
}
/**
 ...
 * }
 */
export function classFieldsTransformer_classExpressionNeedsBlockScopedTemp(receiver) {
 ...
 * }
 */
export function classFieldsTransformer_visitSourceFile(receiver, node) {
    ...
    const visited = NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
 ...
 * }
 */
export function classFieldsTransformer_visitModifier(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_pushNode(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_popNode(receiver, grandparentNode) {
 ...
 * }
 */
export function classFieldsTransformer_visitForSubstitution(receiver, node) {
    ...
    return NodeVisitor_VisitEachChild(receiver.substitutionVisitor, node);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visit(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_visitDiscardedValue(receiver, node) {
    switch (node.Kind) {
        case KindPrefixUnaryExpression:
        case KindPostfixUnaryExpression:
 ...
 * }
 */
export function classFieldsTransformer_visitHeritageClause(receiver, node) {
    switch (node.Kind) {
        case KindHeritageClause:
            return NodeVisitor_VisitEachChild(receiver.heritageClauseVisitor, node);
 ...
 * }
 */
export function classFieldsTransformer_visitAssignmentTarget(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function classFieldsTransformer_visitDestructuringAssignmentTarget(receiver, node) {
    ...
    if (receiver.shouldTransformSuperInStaticInitializers && receiver.currentClassElement !== undefined &&
        ...
        if (data.classConstructor !== undefined && data.superClassReference !== undefined) {
            ...
            if (IsElementAccessExpression(node)) {
                name = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), AsElementAccessExpression(node).ArgumentExpression);
            }
            ...
            if (name !== undefined) {
                ...
                const setExpr = NodeFactory_NewReflectSetCall(Transformer_Factory(receiver.__tsgoEmbedded0), data.superClassReference, name, temp, data.classConstructor);
 ...
 * }
 */
export function classFieldsTransformer_visitClassElement(receiver, node) {
    switch (node.Kind) {
        case KindConstructor:
 ...
 * }
 */
export function classFieldsTransformer_visitPropertyName(receiver, name) {
    if (IsComputedPropertyName(name)) {
        return classFieldsTransformer_visitComputedPropertyName(receiver, AsComputedPropertyName(name));
    }
    return NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), name);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitAccessorFieldResult(receiver, node) {
    switch (node.Kind) {
        case KindPropertyDeclaration:
        ...
        default:
            debug.FailBadSyntaxKind({ KindString: () => Node_KindString(node) }, "Expected node to either be a PropertyDeclaration, GetAccessorDeclaration, or SetAccessorDeclaration");
            return undefined;
    }
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitIdentifier(receiver, node) {
    ...
    if (declaration !== undefined) {
        ...
        if (alias !== undefined && Set_Has(receiver.enclosingClassDeclarations, declaration)) {
            const clone = Node_Clone(alias, Transformer_Factory(receiver.__tsgoEmbedded0));
 ...
 * }
 */
export function classFieldsTransformer_visitPrivateIdentifier(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_transformPrivateIdentifierInInExpression(receiver, node) {
    const info = classFieldsTransformer_accessPrivateIdentifier(receiver, node.Left);
    if (info !== undefined) {
        const receiver2 = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Right);
    ...
    // Private name has not been declared. Subsequent transformers will handle this error
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), BinaryExpression_as_nodeData(node).AsNode());
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitPropertyAssignment(receiver, node) {
    // 13.2.5.5 RS: PropertyDefinitionEvaluation
    //   PropertyAssignment : PropertyName `:` AssignmentExpression
    //     ...
    //     5. If IsAnonymousFunctionDefinition(|AssignmentExpression|) is *true* and _isProtoSetter_ is *false*, then
    ...
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), PropertyAssignment_as_nodeData(node).AsNode());
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitVariableStatement(receiver, node) {
    const savedPendingStatements = receiver.pendingStatements;
    receiver.pendingStatements = [];
    const visitedNode = NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), VariableStatement_as_nodeData(node).AsNode());
 ...
 * }
 */
export function classFieldsTransformer_visitVariableDeclaration(receiver, node) {
    // 14.3.1.2 RS: Evaluation
    //   LexicalBinding : BindingIdentifier Initializer
    //     ...
    //     3. If IsAnonymousFunctionDefinition(|Initializer|) is *true*, then
    ...
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), VariableDeclaration_as_nodeData(node).AsNode());
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitParameterDeclaration(receiver, node) {
    // 8.6.3 RS: IteratorBindingInitialization
    //   SingleNameBinding : BindingIdentifier Initializer?
    //     ...
    //     5. If |Initializer| is present and _v_ is *undefined*, then
    ...
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), ParameterDeclaration_as_nodeData(node).AsNode());
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitBindingElement(receiver, node) {
    // 8.6.3 RS: IteratorBindingInitialization
    //   SingleNameBinding : BindingIdentifier Initializer?
    //     ...
    //     5. If |Initializer| is present and _v_ is *undefined*, then
    ...
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), BindingElement_as_nodeData(node).AsNode());
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitExportAssignment(receiver, node) {
    // 16.2.3.7 RS: Evaluation
    //   ExportDeclaration : `export` `default` AssignmentExpression `;`
    //     1. If IsAnonymousFunctionDefinition(|AssignmentExpression|) is *true*, then
    //        a. Let _value_ be ? NamedEvaluation of |AssignmentExpression| with argument `"default"`.
    ...
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), ExportAssignment_as_nodeData(node).AsNode());
}
/**
 ...
 * }
 */
export function classFieldsTransformer_injectPendingExpressions(receiver, expression) {
    if (receiver.pendingExpressions.length > 0) {
        if (IsParenthesizedExpression(expression)) {
            ...
            expression = NodeFactory_UpdateParenthesizedExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsParenthesizedExpression(expression), NodeFactory_InlineExpressions(Transformer_Factory(receiver.__tsgoEmbedded0), receiver.pendingExpressions));
        }
        else {
 ...
 * }
 */
export function classFieldsTransformer_visitComputedPropertyName(receiver, node) {
    ...
    const expression = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Expression);
    receiver.lexicalEnvironment = savedLexicalEnvironment;
    receiver.insideComputedPropertyName = savedInsideComputedPropertyName;
    return NodeFactory_UpdateComputedPropertyName(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, classFieldsTransformer_injectPendingExpressions(receiver, expression));
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitConstructorDeclaration(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_shouldTransformClassElementToWeakMap(receiver, node) {
    if (receiver.shouldTransformPrivateElementsOrClassStaticBlocks) {
        return true;
    }
 ...
 * }
 */
export function classFieldsTransformer_shouldAlwaysTransformPrivateStaticElements(receiver, node) {
    return (HasStaticModifier(node) && (EmitContext_EmitFlags(Transformer_EmitContext(receiver.__tsgoEmbedded0), node) & EFTransformPrivateStaticElements) !== 0);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_nodeHasTransformPrivateStaticElementsFlag(receiver, node) {
    return ((EmitContext_EmitFlags(Transformer_EmitContext(receiver.__tsgoEmbedded0), node) & EFTransformPrivateStaticElements) !== 0);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitMethodOrAccessorDeclaration(receiver, node) {
    ...
    if (!IsPrivateIdentifierClassElementDeclaration(node) || !classFieldsTransformer_shouldTransformClassElementToWeakMap(receiver, node)) {
        return NodeVisitor_VisitEachChild(receiver.classElementVisitor, node);
    }
    // leave invalid code untransformed
    ...
    if (functionName !== undefined) {
        ...
        const params = NodeVisitor_VisitNodes(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_ParameterList(node));
        receiver.inIterationStatement = saved;
        const funcExpr = NewFunctionExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, modifiers, AsMethodDeclaration(node).AsteriskToken, functionName, undefined, params, undefined, undefined, body);
 ...
 * }
 */
export function classFieldsTransformer_extractNonStaticNonAccessorModifiers(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_setCurrentClassElementAnd(receiver, classElement, visitor, node) {
 ...
 * }
 */
export function classFieldsTransformer_visitEachChildOfNode(receiver, node) {
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_setInIterationStatementAnd(receiver, inIteration, visitor, node) {
 ...
 * }
 */
export function classFieldsTransformer_clearClassElementAndVisitEachChild(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_visitFunctionExpressionOrDeclaration(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_setClassElementAndVisitEachChild(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_getHoistedFunctionName(receiver, node) {
    debug.Assert((Node_Name(node) !== undefined && IsPrivateIdentifier(Node_Name(node))));
    const info = classFieldsTransformer_accessPrivateIdentifier(receiver, Node_Name(node));
    debug.Assert((info !== undefined), "Undeclared private name for property declaration.");
 ...
 * }
 */
export function classFieldsTransformer_tryGetClassThis(receiver) {
 ...
 * }
 */
export function classFieldsTransformer_tryGetClassThisNoContainer(receiver) {
 ...
 * }
 */
export function classFieldsTransformer_transformAutoAccessor(receiver, node) {
    const commentRange = EmitContext_CommentRange(Transformer_EmitContext(receiver.__tsgoEmbedded0), node);
    const sourceMapRange = EmitContext_SourceMapRange(Transformer_EmitContext(receiver.__tsgoEmbedded0), node);
    // Since we're creating two declarations where there was previously one, cache
    // the expression for any computed property names.
    ...
    if (IsComputedPropertyName(name) && !IsSimpleInlineableExpression(AsComputedPropertyName(name).Expression)) {
        ...
        if (cacheAssignment !== undefined) {
            getterName = NodeFactory_UpdateComputedPropertyName(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsComputedPropertyName(name), NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), AsComputedPropertyName(name).Expression));
            setterName = NodeFactory_UpdateComputedPropertyName(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsComputedPropertyName(name), cacheAssignment.Left);
        }
        else {
            const temp = NodeFactory_NewTempVariable(Transformer_Factory(receiver.__tsgoEmbedded0));
            ...
            const expression = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), AsComputedPropertyName(name).Expression);
            ...
            getterName = NodeFactory_UpdateComputedPropertyName(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsComputedPropertyName(name), assignment);
            setterName = NodeFactory_UpdateComputedPropertyName(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsComputedPropertyName(name), temp);
        }
    }
    const modifiers = NodeVisitor_VisitModifiers(receiver.modifierVisitor, Node_Modifiers(node));
    const backingField = createAccessorPropertyBackingField(Transformer_Factory(receiver.__tsgoEmbedded0), node, modifiers, Node_Initializer(node));
    EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), backingField, node);
    ...
    EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), getter, node);
    ...
    EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), setter, node);
    ...
    // Visit the results in a second pass
    const [visited] = NodeVisitor_VisitSlice(receiver.accessorFieldResultVisitor, [backingField, getter, setter]);
 ...
 * }
 */
export function classFieldsTransformer_transformPrivateFieldInitializer(receiver, node) {
    if (classFieldsTransformer_shouldTransformClassElementToWeakMap(receiver, node)) {
        // If we are transforming private elements into WeakMap/WeakSet, we should elide the node.
        const info = classFieldsTransformer_accessPrivateIdentifier(receiver, Node_Name(node));
        debug.Assert(info !== undefined, "Undeclared private name for property declaration.");
        // Leave invalid code untransformed
        ...
        if (info.isStatic && !receiver.shouldTransformPrivateElementsOrClassStaticBlocks) {
            // TODO: fix
            const statement = classFieldsTransformer_transformPropertyOrClassStaticBlock(receiver, node, NodeFactory_NewThisExpression(Transformer_Factory(receiver.__tsgoEmbedded0)));
            if (statement !== undefined) {
                return NewClassStaticBlockDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, undefined, /*modifiers*/ NewBlock(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, [statement]), true /*multiLine*/));
            }
        }
        return undefined;
    }
    if (receiver.shouldTransformInitializersUsingSet && !HasStaticModifier(node) &&
        receiver.lexicalEnvironment !== undefined && receiver.lexicalEnvironment.data !== undefined &&
        (receiver.lexicalEnvironment.data.facts & classFactsWillHoistInitializersToConstructor) !== 0) {
        return NodeFactory_UpdatePropertyDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, NodeVisitor_VisitModifiers(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Modifiers(node)), Node_Name(node), undefined, /*postfixToken*/ undefined, /*typeNode*/ undefined);
    }
    if (isNamedEvaluationAnd(Transformer_EmitContext(receiver.__tsgoEmbedded0), node, receiver.isAnonymousClassNeedingAssignedName)) {
        node = AsPropertyDeclaration(transformNamedEvaluation(Transformer_EmitContext(receiver.__tsgoEmbedded0), node, false, ""));
    }
    return NodeFactory_UpdatePropertyDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, NodeVisitor_VisitModifiers(receiver.modifierVisitor, Node_Modifiers(node)), classFieldsTransformer_visitPropertyName(receiver, Node_Name(node)), undefined, /*postfixToken*/ undefined, /*typeNode*/ NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Initializer(node)));
}
/**
 ...
 * }
 */
export function classFieldsTransformer_transformPublicFieldInitializer(receiver, node) {
    if (receiver.shouldTransformInitializers && !IsAutoAccessorPropertyDeclaration(node)) {
        // Elide the property declaration; the initializer will be moved to the constructor.
        // For computed property names, we still need to emit the expression.
        const expr = classFieldsTransformer_getPropertyNameExpressionIfNeeded(receiver, Node_Name(node), Node_Initializer(node) !== undefined || CompilerOptions_GetUseDefineForClassFields(receiver.compilerOptions));
        if (expr !== undefined) {
        ...
        // initializers must be converted into `static { this.x = ...; }` blocks so that `this`
        // refers to the class constructor inside the static block.
        if (IsStatic(node) && !receiver.shouldTransformPrivateElementsOrClassStaticBlocks) {
            const initializerStatement = classFieldsTransformer_transformPropertyOrClassStaticBlock(receiver, node, NodeFactory_NewThisExpression(Transformer_Factory(receiver.__tsgoEmbedded0)));
            if (initializerStatement !== undefined) {
                const staticBlock = NewClassStaticBlockDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, undefined, /*modifiers*/ NewBlock(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, [initializerStatement]), false));
                EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), staticBlock, node);
 ...
 * }
 */
export function classFieldsTransformer_transformFieldInitializer(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_shouldTransformAutoAccessorsInCurrentClass(receiver) {
 ...
 * }
 */
export function classFieldsTransformer_visitPropertyDeclaration(receiver, node) {
    // If this is an auto-accessor, we defer to `transformAutoAccessor`. That function
    // will in turn call `transformFieldInitializer` as needed.
 ...
 * }
 */
export function classFieldsTransformer_createPrivateIdentifierAccess(receiver, info, receiver1) {
    receiver1 = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), receiver1);
 ...
 * }
 */
export function classFieldsTransformer_createPrivateIdentifierAccessHelper(receiver, info, receiver1) {
    ...
    switch (info.kind) {
        case PrivateIdentifierKindAccessor:
            return NodeFactory_NewClassPrivateFieldGetHelper(Transformer_Factory(receiver.__tsgoEmbedded0), receiver1, info.brandCheckIdentifier, info.kind, info.getterName);
        case PrivateIdentifierKindMethod:
            return NodeFactory_NewClassPrivateFieldGetHelper(Transformer_Factory(receiver.__tsgoEmbedded0), receiver1, info.brandCheckIdentifier, info.kind, info.methodName);
        case PrivateIdentifierKindField: {
            const f = info.isStatic ? info.variableName : undefined;
            return NodeFactory_NewClassPrivateFieldGetHelper(Transformer_Factory(receiver.__tsgoEmbedded0), receiver1, info.brandCheckIdentifier, info.kind, f);
        }
 ...
 * }
 */
export function classFieldsTransformer_visitPropertyAccessExpression(receiver, node) {
    ...
    if (receiver.shouldTransformSuperInStaticInitializers && receiver.currentClassElement !== undefined &&
        IsSuperProperty(node) && IsIdentifier(node.name) &&
        isStaticPropertyDeclarationOrClassStaticBlock(receiver.currentClassElement) &&
        receiver.lexicalEnvironment !== undefined && receiver.lexicalEnvironment.data !== undefined) {
        const data = receiver.lexicalEnvironment.data;
        if ((data.facts & classFactsClassWasDecorated) !== 0) {
        ...
        if (data.classConstructor !== undefined && data.superClassReference !== undefined) {
            // converts `super.x` into `Reflect.get(_baseTemp, "x", _classTemp)`
            const superProperty = NodeFactory_NewReflectGetCall(Transformer_Factory(receiver.__tsgoEmbedded0), data.superClassReference, NodeFactory_NewStringLiteralFromNode(Transformer_Factory(receiver.__tsgoEmbedded0), node.name), data.classConstructor);
 ...
 * }
 */
export function classFieldsTransformer_visitPropertyAccessExpressionForSubstitution(receiver, node) {
    const expression = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Expression);
    if (expression !== node.Expression) {
 ...
 * }
 */
export function classFieldsTransformer_visitElementAccessExpression(receiver, node) {
    if (receiver.shouldTransformSuperInStaticInitializers && receiver.currentClassElement !== undefined &&
        IsSuperProperty(node) &&
        isStaticPropertyDeclarationOrClassStaticBlock(receiver.currentClassElement) &&
        receiver.lexicalEnvironment !== undefined && receiver.lexicalEnvironment.data !== undefined) {
        ...
        if (data.classConstructor !== undefined && data.superClassReference !== undefined) {
            // converts `super[x]` into `Reflect.get(_baseTemp, x, _classTemp)`
            const superProperty = NodeFactory_NewReflectGetCall(Transformer_Factory(receiver.__tsgoEmbedded0), data.superClassReference, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.ArgumentExpression), data.classConstructor);
            EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), superProperty, node.Expression);
            superProperty.Loc = node.Expression.Loc;
            return superProperty;
        }
 ...
 * }
 */
export function classFieldsTransformer_visitPreOrPostfixUnaryExpression(receiver, node, discarded) {
    let operator;
    let operand;
    ...
    if (operator === KindPlusPlusToken || operator === KindMinusMinusToken) {
        ...
        if (IsPropertyAccessExpression(operandSkipped) && IsPrivateIdentifier(AsPropertyAccessExpression(operandSkipped).name)) {
            ...
            if (info !== undefined) {
                const receiverExpr = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Expression(operandSkipped));
                const [readExpression, initializeExpression] = classFieldsTransformer_createCopiableReceiverExpr(receiver, receiverExpr);
                let expression = classFieldsTransformer_createPrivateIdentifierAccessHelper(receiver, info, readExpression);
                let temp = undefined;
            ...
            if (data.classConstructor !== undefined && data.superClassReference !== undefined) {
                ...
                if (IsPropertyAccessExpression(operandSkipped)) {
                    ...
                    if (IsSimpleInlineableExpression(AsElementAccessExpression(operandSkipped).ArgumentExpression)) {
                        ...
                        setterName = NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), getterName, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), AsElementAccessExpression(operandSkipped).ArgumentExpression));
                    }
                }
                if (setterName !== undefined && getterName !== undefined) {
                    let expression = NodeFactory_NewReflectGetCall(Transformer_Factory(receiver.__tsgoEmbedded0), data.superClassReference, getterName, data.classConstructor);
                    expression.Loc = operandSkipped.Loc;
                    let temp = undefined;
                    if (!discarded) {
                        temp = NodeFactory_NewTempVariable(Transformer_Factory(receiver.__tsgoEmbedded0));
 ...
 * }
 */
export function classFieldsTransformer_visitForStatement(receiver, node) {
    const initializer = NodeVisitor_VisitNode(receiver.discardedValueVisitor, node.Initializer);
    const condition = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Condition);
    const incrementor = NodeVisitor_VisitNode(receiver.discardedValueVisitor, node.Incrementor);
    const saved = receiver.inIterationStatement;
 ...
 * }
 */
export function classFieldsTransformer_visitExpressionStatement(receiver, node) {
    // Preserve private identifiers that appear directly as the expression of an
    // ExpressionStatement (e.g., `#;`). This is error-recovery output from the parser
    // for invalid syntax.
    ...
    return NodeFactory_UpdateExpressionStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, NodeVisitor_VisitNode(receiver.discardedValueVisitor, node.Expression));
}
/**
 ...
 * }
 */
export function classFieldsTransformer_createCopiableReceiverExpr(receiver, receiver1) {
    let clone = receiver1;
    if (!NodeIsSynthesized(receiver1)) {
        clone = Node_Clone(receiver1, Transformer_Factory(receiver.__tsgoEmbedded0));
    }
 ...
 * }
 */
export function classFieldsTransformer_visitCallExpression(receiver, node) {
    if (IsPropertyAccessExpression(node.Expression) && IsPrivateIdentifier(AsPropertyAccessExpression(node.Expression).name) &&
        ...
        const visitedTarget = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), target);
        const visitedThisArg = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), thisArg);
        const visitedArgs = NodeVisitor_VisitNodes(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Arguments);
        const allArgs = [visitedThisArg, ...(visitedArgs ? visitedArgs.Nodes : [])];
        if ((node.Flags & NodeFlagsOptionalChain) !== 0) {
            return NodeFactory_UpdateCallExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, NewPropertyAccessExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, visitedTarget, node.QuestionDotToken, NewIdentifier(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, "call"), NodeFlagsOptionalChain), undefined, undefined, NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, allArgs), node.Flags);
        }
        return NodeFactory_UpdateCallExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, NewPropertyAccessExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, visitedTarget, undefined, NewIdentifier(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, "call"), NodeFlagsNone), undefined, undefined, NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, allArgs), node.Flags);
    }
    if (receiver.shouldTransformSuperInStaticInitializers && receiver.currentClassElement !== undefined &&
        ...
        const invocation = NodeFactory_NewFunctionCallCall(Transformer_Factory(receiver.__tsgoEmbedded0), NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Expression), receiver.lexicalEnvironment.data.classConstructor, NodeVisitor_VisitNodes(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Arguments)?.Nodes ?? []);
        EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), invocation, node);
        invocation.Loc = node.Loc;
        return invocation;
    }
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
 ...
 * }
 */
export function classFieldsTransformer_visitTaggedTemplateExpression(receiver, node) {
    if (IsPropertyAccessExpression(node.Tag) && IsPrivateIdentifier(AsPropertyAccessExpression(node.Tag).name) &&
        ...
        const bindExpr = NewCallExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NewPropertyAccessExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), target), undefined, NewIdentifier(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, "bind"), NodeFlagsNone), undefined, undefined, NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, [NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), thisArg)]), NodeFlagsNone);
        return NodeFactory_UpdateTaggedTemplateExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, bindExpr, undefined, undefined, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Template), node.Flags);
    }
    if (receiver.shouldTransformSuperInStaticInitializers && receiver.currentClassElement !== undefined &&
        ...
        receiver.lexicalEnvironment !== undefined && receiver.lexicalEnvironment.data !== undefined &&
        receiver.lexicalEnvironment.data.classConstructor !== undefined) {
        const invocation = NodeFactory_NewFunctionBindCall(Transformer_Factory(receiver.__tsgoEmbedded0), NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Tag), receiver.lexicalEnvironment.data.classConstructor, []);
        EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), invocation, node);
        invocation.Loc = node.Loc;
        return NodeFactory_UpdateTaggedTemplateExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, invocation, undefined, undefined, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Template), node.Flags);
    }
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_transformClassStaticBlockDeclaration(receiver, node) {
    if (receiver.shouldTransformPrivateElementsOrClassStaticBlocks) {
        if (isClassThisAssignmentBlock(Transformer_EmitContext(receiver.__tsgoEmbedded0), node)) {
            const firstStatement = AsBlock(AsClassStaticBlockDeclaration(node).Body).Statements.Nodes[0];
            const result = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Expression(firstStatement));
        ...
        if (isClassNamedEvaluationHelperBlock(Transformer_EmitContext(receiver.__tsgoEmbedded0), node)) {
            const firstStatement = AsBlock(AsClassStaticBlockDeclaration(node).Body).Statements.Nodes[0];
            return NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Expression(firstStatement));
        }
        EmitContext_StartVariableEnvironment(Transformer_EmitContext(receiver.__tsgoEmbedded0));
        let statements = classFieldsTransformer_setCurrentClassElementAndVisitStatements(receiver, node, AsBlock(AsClassStaticBlockDeclaration(node).Body).Statements.Nodes);
        ...
        const arrowFunction = SkipParentheses(AsCallExpression(iife).Expression);
        ...
        AsBlock(AsArrowFunction(arrowFunction).Body).Statements.Loc =
            AsBlock(AsClassStaticBlockDeclaration(node).Body).Statements.Loc;
        EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), iife, node);
        EmitContext_AssignSourceMapRange(Transformer_EmitContext(receiver.__tsgoEmbedded0), iife, node);
 ...
 * }
 */
export function classFieldsTransformer_setCurrentClassElementAndVisitStatements(receiver, classElement, statements) {
    const savedCurrentClassElement = receiver.currentClassElement;
    receiver.currentClassElement = classElement;
    const [result] = NodeVisitor_VisitSlice(Transformer_Visitor(receiver.__tsgoEmbedded0), statements);
 ...
 * }
 */
export function classFieldsTransformer_isAnonymousClassNeedingAssignedNameWorker(receiver, node) {
    if (IsClassExpression(node) && Node_Name(node) === undefined) {
        const staticPropertiesOrClassStaticBlocks = classFieldsTransformer_getStaticPropertiesAndClassStaticBlock(receiver, node);
        if (Some(staticPropertiesOrClassStaticBlocks, (n) => isClassNamedEvaluationHelperBlock(Transformer_EmitContext(receiver.__tsgoEmbedded0), n))) {
            return false;
        }
        const hasTransformableStatics = (receiver.shouldTransformPrivateElementsOrClassStaticBlocks ||
            classFieldsTransformer_nodeHasTransformPrivateStaticElementsFlag(receiver, node)) &&
            Some(staticPropertiesOrClassStaticBlocks, (n) => IsClassStaticBlockDeclaration(n) ||
 ...
 * }
 */
export function classFieldsTransformer_visitBinaryExpression(receiver, node, discarded) {
    if (IsDestructuringAssignment(node)) {
        const savedPendingExpressions = receiver.pendingExpressions;
        receiver.pendingExpressions = [];
        const updated = NodeFactory_UpdateBinaryExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, undefined, NodeVisitor_VisitNode(receiver.assignmentTargetVisitor, node.Left), undefined, node.OperatorToken, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Right));
        let result;
        if (receiver.pendingExpressions.length > 0) {
            const exprs = [...receiver.pendingExpressions, updated];
    ...
    if (IsAssignmentExpression(node, false)) {
        if (isNamedEvaluationAnd(Transformer_EmitContext(receiver.__tsgoEmbedded0), node, receiver.isAnonymousClassNeedingAssignedName)) {
            node = AsBinaryExpression(transformNamedEvaluation(Transformer_EmitContext(receiver.__tsgoEmbedded0), node, false, ""));
            debug.Assert(node !== undefined && IsAssignmentExpression(node, false));
        }
        const left = SkipOuterExpressions(node.Left, (OEKPartiallyEmittedExpressions | OEKParentheses));
        if (IsPropertyAccessExpression(left) && IsPrivateIdentifier(AsPropertyAccessExpression(left).name)) {
            const info = classFieldsTransformer_accessPrivateIdentifier(receiver, AsPropertyAccessExpression(left).name);
            if (info !== undefined) {
                const result = classFieldsTransformer_createPrivateIdentifierAssignment(receiver, info, AsPropertyAccessExpression(left).Expression, node.Right, node.OperatorToken.Kind);
                EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), result, node);
                result.Loc = node.Loc;
                return result;
            }
            ...
            const data = receiver.lexicalEnvironment.data;
            if ((data.facts & classFactsClassWasDecorated) !== 0) {
                return NodeFactory_UpdateBinaryExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, undefined, classFieldsTransformer_visitInvalidSuperProperty(receiver, node.Left), undefined, node.OperatorToken, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Right));
            }
            if (data.classConstructor !== undefined && data.superClassReference !== undefined) {
                let setterName = undefined;
                if (IsElementAccessExpression(node.Left)) {
                    setterName = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), AsElementAccessExpression(node.Left).ArgumentExpression);
                }
                else if (IsPropertyAccessExpression(node.Left) && IsIdentifier(AsPropertyAccessExpression(node.Left).name)) {
                    setterName = NodeFactory_NewStringLiteralFromNode(Transformer_Factory(receiver.__tsgoEmbedded0), AsPropertyAccessExpression(node.Left).name);
                }
                if (setterName !== undefined) {
                    let expression = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Right);
                    if (IsCompoundAssignment(node.OperatorToken.Kind)) {
                        ...
                        const superPropertyGet = NodeFactory_NewReflectGetCall(Transformer_Factory(receiver.__tsgoEmbedded0), data.superClassReference, getterName, data.classConstructor);
                        EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), superPropertyGet, node.Left);
                        superPropertyGet.Loc = node.Left.Loc;
                        expression = NewBinaryExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, undefined, superPropertyGet, undefined, NewToken(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, GetNonAssignmentOperatorForCompoundAssignment(node.OperatorToken.Kind)), expression);
                        expression.Loc = node.Loc;
                    }
                    let temp = undefined;
                    if (!discarded) {
    ...
    if (node.OperatorToken.Kind === KindInKeyword && IsPrivateIdentifier(node.Left)) {
 ...
 * }
 */
export function classFieldsTransformer_visitParenthesizedExpression(receiver, node, discarded) {
    if (discarded) {
        const expression = NodeVisitor_VisitNode(receiver.discardedValueVisitor, node.Expression);
 ...
 * }
 */
export function classFieldsTransformer_createPrivateIdentifierAssignment(receiver, info, receiver1, right, operator) {
    let recv = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), receiver1);
    let rightExpr = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), right);
    if (IsCompoundAssignment(operator)) {
        ...
        rightExpr = NewBinaryExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, undefined, classFieldsTransformer_createPrivateIdentifierAccessHelper(receiver, info, readExpression), undefined, NewToken(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, GetNonAssignmentOperatorForCompoundAssignment(operator)), rightExpr);
    }
    EmitContext_SetCommentRange(Transformer_EmitContext(receiver.__tsgoEmbedded0), recv, { pos: -1, end: Node_End(recv) });
    switch (info.kind) {
        case PrivateIdentifierKindAccessor:
            return NodeFactory_NewClassPrivateFieldSetHelper(Transformer_Factory(receiver.__tsgoEmbedded0), recv, info.brandCheckIdentifier, rightExpr, info.kind, info.setterName);
        case PrivateIdentifierKindMethod:
            return NodeFactory_NewClassPrivateFieldSetHelper(Transformer_Factory(receiver.__tsgoEmbedded0), recv, info.brandCheckIdentifier, rightExpr, info.kind, undefined);
        case PrivateIdentifierKindField: {
            const f = info.isStatic ? info.variableName : undefined;
            return NodeFactory_NewClassPrivateFieldSetHelper(Transformer_Factory(receiver.__tsgoEmbedded0), recv, info.brandCheckIdentifier, rightExpr, info.kind, f);
        }
        case PrivateIdentifierKindUntransformed:
            debug.Fail("Access helpers should not be created for untransformed private elements");
            return undefined;
 ...
 * }
 */
export function classFieldsTransformer_getPrivateInstanceMethodsAndAccessors(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_memberContainsConstructorReference(receiver, member, classDecl) {
    const classOriginal = EmitContext_MostOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), classDecl);
    const className = GetNameOfDeclaration(classDecl);
    const check = (n) => {
        if (IsIdentifier(n) && n !== className) {
            const decl = receiver.resolver.GetReferencedValueDeclaration(n);
            if (decl === classOriginal) {
                return true;
            }
        }
        if (IsPropertyAccessExpression(n)) {
            return check(AsPropertyAccessExpression(n).Expression);
        }
 ...
 * }
 */
export function classFieldsTransformer_classContainsConstructorReference(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_getClassFacts(receiver, node) {
    let facts = classFactsNone;
    const original = EmitContext_MostOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), node);
 ...
 * }
 */
export function classFieldsTransformer_visitExpressionWithTypeArgumentsInHeritageClause(receiver, node) {
    let facts = classFactsNone;
    ...
    if ((facts & classFactsNeedsClassSuperReference) !== 0) {
        ...
        return NodeFactory_UpdateExpressionWithTypeArguments(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), temp, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Expression)), undefined);
    }
    return NodeVisitor_VisitEachChild(receiver.heritageClauseVisitor, node);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitInNewClassLexicalEnvironment(receiver, node, visitor) {
    const savedCurrentClassContainer = receiver.currentClassContainer;
    const savedPendingExpressions = receiver.pendingExpressions;
    const savedLexicalEnvironment = receiver.lexicalEnvironment;
    receiver.currentClassContainer = node;
    receiver.pendingExpressions = [];
    ...
    if (receiver.shouldTransformPrivateElementsOrClassStaticBlocks || classFieldsTransformer_nodeHasTransformPrivateStaticElementsFlag(receiver, node)) {
        ...
        if (name !== undefined && IsIdentifier(name)) {
            classFieldsTransformer_getPrivateIdentifierEnvironment(receiver).data.className = name;
        }
        else {
            ...
            if (assignedName !== undefined) {
                if (IsStringLiteral(assignedName)) {
                    ...
                    if (textSourceNode !== undefined && IsIdentifier(textSourceNode)) {
                        classFieldsTransformer_getPrivateIdentifierEnvironment(receiver).data.className = textSourceNode;
                    }
                        ...
                        classFieldsTransformer_getPrivateIdentifierEnvironment(receiver).data.className = prefixName;
                    }
                }
            }
        }
 ...
 * }
 */
export function classFieldsTransformer_visitClassDeclaration(receiver, node) {
    return classFieldsTransformer_visitInNewClassLexicalEnvironment(receiver, node, classFieldsTransformer_visitClassDeclarationInNewClassLexicalEnvironment);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitClassDeclarationInNewClassLexicalEnvironment(receiver, node, facts) {
    const classDecl = AsClassDeclaration(node);
    let pendingClassReferenceAssignment = undefined;
    if ((facts & classFactsNeedsClassConstructorReference) !== 0) {
        if (receiver.shouldTransformPrivateElementsOrClassStaticBlocks && EmitContext_ClassThis(Transformer_EmitContext(receiver.__tsgoEmbedded0), node) !== undefined) {
            ...
            pendingClassReferenceAssignment = NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), classThis, NodeFactory_GetLocalName(Transformer_Factory(receiver.__tsgoEmbedded0), node));
        }
        else {
            const temp = NodeFactory_NewTempVariableEx(Transformer_Factory(receiver.__tsgoEmbedded0), {
                Flags: GeneratedIdentifierFlagsReservedInNestedScopes,
            ...
            EmitContext_AddVariableDeclaration(Transformer_EmitContext(receiver.__tsgoEmbedded0), temp);
            classFieldsTransformer_getClassLexicalEnvironment(receiver).classConstructor = Node_Clone(temp, Transformer_Factory(receiver.__tsgoEmbedded0));
            pendingClassReferenceAssignment = NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), temp, NodeFactory_GetLocalName(Transformer_Factory(receiver.__tsgoEmbedded0), node));
        }
    }
    ...
    const modifiers = NodeVisitor_VisitModifiers(receiver.modifierVisitor, Node_Modifiers(node));
    const heritageClauses = NodeVisitor_VisitNodes(receiver.heritageClauseVisitor, classDecl.HeritageClauses);
    ...
    if (receiver.pendingExpressions.length > 0) {
        statements = [...statements, NewExpressionStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NodeFactory_InlineExpressions(Transformer_Factory(receiver.__tsgoEmbedded0), receiver.pendingExpressions))];
    }
    ...
    if (receiver.shouldTransformInitializersUsingSet || receiver.shouldTransformPrivateElementsOrClassStaticBlocks) {
        ...
        if (staticProperties.length > 0) {
            if (name === undefined) {
                name = NodeFactory_NewGeneratedNameForNode(Transformer_Factory(receiver.__tsgoEmbedded0), node);
            }
            statements = classFieldsTransformer_addPropertyOrClassStaticBlockStatements(receiver, statements, staticProperties, NodeFactory_GetLocalName(Transformer_Factory(receiver.__tsgoEmbedded0), node));
        }
    }
    ...
    if (statements.length > 0 && isExport && isDefault) {
        ...
        const exportAssignment = NewExportAssignment(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, undefined, false, undefined, NodeFactory_GetLocalName(Transformer_Factory(receiver.__tsgoEmbedded0), node));
        statements = [...statements, exportAssignment];
        const updatedClass = NodeFactory_UpdateClassDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, classDecl, extractedModifiers, name, undefined, /*typeParameters*/ heritageClauses, members);
        const result = [];
        if (membersPrologue !== undefined) {
            result.push(NewExpressionStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, membersPrologue));
        }
    ...
    const updatedClass = NodeFactory_UpdateClassDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, classDecl, modifiers, name, undefined, /*typeParameters*/ heritageClauses, members);
    const result = [];
    if (membersPrologue !== undefined) {
        result.push(NewExpressionStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, membersPrologue));
    }
 ...
 * }
 */
export function classFieldsTransformer_visitClassExpression(receiver, node) {
    return classFieldsTransformer_visitInNewClassLexicalEnvironment(receiver, node, classFieldsTransformer_visitClassExpressionInNewClassLexicalEnvironment);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitClassExpressionInNewClassLexicalEnvironment(receiver, node, facts) {
    ...
    if (!isDecoratedClassDeclaration) {
        ...
        const willHavePrivatePendingExpressions = receiver.shouldTransformPrivateElementsOrClassStaticBlocks &&
            Some(Node_Members(node) ?? [], (n) => IsPrivateIdentifierClassElementDeclaration(n) && !HasStaticModifier(n) && classFieldsTransformer_shouldTransformClassElementToWeakMap(receiver, n));
    ...
    const modifiers = NodeVisitor_VisitModifiers(receiver.modifierVisitor, Node_Modifiers(node));
    const heritageClauses = NodeVisitor_VisitNodes(receiver.heritageClauseVisitor, classExpr.HeritageClauses);
    const [members, membersPrologue] = classFieldsTransformer_transformClassMembers(receiver, node);
    if (deferTempDeclaration) {
        if (classFieldsTransformer_classExpressionNeedsBlockScopedTemp(receiver)) {
            EmitContext_AddLexicalDeclaration(Transformer_EmitContext(receiver.__tsgoEmbedded0), temp);
    ...
    const classExpression = NodeFactory_UpdateClassExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, classExpr, modifiers, classExpr.name, undefined, /*typeParameters*/ heritageClauses, members);
    let expressions = [];
    if (membersPrologue !== undefined) {
    ...
    if (!isDecoratedClassDeclaration) {
        if (hasTransformableStatics || receiver.pendingExpressions.length > 0) {
            ...
            expressions = [...expressions, NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), temp, classExpression)];
            ...
            expressions = [...expressions, Node_Clone(temp, Transformer_Factory(receiver.__tsgoEmbedded0))];
        }
        else {
        ...
        if (receiver.pendingExpressions.length > 0) {
            for (const expr of receiver.pendingExpressions) {
                receiver.pendingStatements = [...receiver.pendingStatements, NewExpressionStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, expr)];
            }
        }
        if (staticPropertiesOrClassStaticBlocks.length > 0) {
            let classThisOrName = EmitContext_ClassThis(Transformer_EmitContext(receiver.__tsgoEmbedded0), node);
            if (classThisOrName === undefined) {
                classThisOrName = NodeFactory_GetLocalName(Transformer_Factory(receiver.__tsgoEmbedded0), node);
            }
        ...
        if (temp !== undefined) {
            ...
            expressions = [...expressions, NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), EmitContext_ClassThis(Transformer_EmitContext(receiver.__tsgoEmbedded0), node), classExpression)];
        }
        else {
            expressions = [...expressions, classExpression];
        }
    ...
    if (expressions.length > 1) {
        EmitContext_AddEmitFlags(Transformer_EmitContext(receiver.__tsgoEmbedded0), classExpression, EFIndented);
        for (const expr of expressions) {
            EmitContext_AddEmitFlags(Transformer_EmitContext(receiver.__tsgoEmbedded0), expr, EFStartOnNewLine);
        }
    }
 ...
 * }
 */
export function classFieldsTransformer_visitClassStaticBlockDeclaration(receiver, node) {
    if (!receiver.shouldTransformPrivateElementsOrClassStaticBlocks) {
        return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
    }
    // ClassStaticBlockDeclaration for classes are transformed in visitClassDeclaration/visitClassExpression.
 ...
 * }
 */
export function classFieldsTransformer_visitThisExpression(receiver, node) {
    ...
    if (receiver.shouldTransformThisInStaticInitializers && receiver.currentClassElement !== undefined &&
        ...
        if ((receiver.lexicalEnvironment.data.facts & classFactsClassWasDecorated) !== 0 && receiver.legacyDecorators) {
            return NewParenthesizedExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NodeFactory_NewVoidZeroExpression(Transformer_Factory(receiver.__tsgoEmbedded0)));
        }
    }
    return node;
}
 ...
 * }
 */
export function classFieldsTransformer_transformClassMembers(receiver, node) {
    ...
    let members = NodeVisitor_VisitNodes(receiver.classElementVisitor, Node_MemberList(node));
    // Create a synthetic constructor if necessary
    let syntheticConstructor = undefined;
    ...
    let syntheticStaticBlock = undefined;
    let prologue = undefined;
    if (!receiver.shouldTransformPrivateElementsOrClassStaticBlocks && receiver.pendingExpressions.length > 0) {
        let statement = NewExpressionStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NodeFactory_InlineExpressions(Transformer_Factory(receiver.__tsgoEmbedded0), receiver.pendingExpressions));
        if ((Node_SubtreeFacts(statement) & SubtreeContainsLexicalThisOrSuper) !== 0) {
            ...
            const arrow = NewArrowFunction(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, undefined, /*modifiers*/ undefined, /*typeParameters*/ NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, []), /*parameters*/ undefined, /*returnType*/ undefined, /*fullSignature*/ NewToken(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, KindEqualsGreaterThanToken), /*equalsGreaterThanToken*/ NewBlock(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, [statement]), false));
            prologue = NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), tempArrow, arrow);
            statement = NewExpressionStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NewCallExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, tempArrow, undefined, undefined, NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, []), NodeFlagsNone));
        }
    ...
    if (syntheticConstructor !== undefined || syntheticStaticBlock !== undefined) {
        ...
        const membersArray = [];
        const classThisIdx = memberNodes.findIndex((n) => isClassThisAssignmentBlock(Transformer_EmitContext(receiver.__tsgoEmbedded0), n));
        const namedEvalIdx = memberNodes.findIndex((n) => isClassNamedEvaluationHelperBlock(Transformer_EmitContext(receiver.__tsgoEmbedded0), n));
        if (classThisIdx >= 0)
            membersArray.push(memberNodes[classThisIdx]);
        if (namedEvalIdx >= 0)
            membersArray.push(memberNodes[namedEvalIdx]);
        if (syntheticConstructor !== undefined)
            membersArray.push(syntheticConstructor);
        if (syntheticStaticBlock !== undefined)
            membersArray.push(syntheticStaticBlock);
        ...
        if (members?.Loc !== undefined)
            newMembers.Loc = members.Loc;
        members = newMembers;
    }
    return [members, prologue];
}
 ...
 * }
 */
export function classFieldsTransformer_createBrandCheckWeakSetForPrivateMethods(receiver) {
    const env = classFieldsTransformer_getPrivateIdentifierEnvironment(receiver);
    ...
    classFieldsTransformer_addPendingExpressions(receiver, NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), weakSetName, NewNewExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NewIdentifier(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, "WeakSet"), undefined, /*typeArguments*/ NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, []))));
}
/**
 ...
 * }
 */
export function classFieldsTransformer_transformConstructor(receiver, constructor_, container) {
    if (receiver.lexicalEnvironment === undefined || receiver.lexicalEnvironment.data === undefined ||
        (receiver.lexicalEnvironment.data.facts & classFactsWillHoistInitializersToConstructor) === 0) {
        if (constructor_ !== undefined) {
            return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), constructor_);
        }
        return undefined;
    }
    const extendsClauseElement = GetClassExtendsHeritageElement(container);
    const isDerivedClass = extendsClauseElement !== undefined &&
        SkipOuterExpressions(AsExpressionWithTypeArguments(extendsClauseElement).Expression, OEKAll).Kind !== KindNullKeyword;
    let parameters = undefined;
    if (constructor_ !== undefined) {
        parameters = NodeVisitor_VisitNodes(Transformer_Visitor(receiver.__tsgoEmbedded0), constructor_.Parameters);
    }
    ...
    if (constructor_ !== undefined) {
        return NodeFactory_UpdateConstructorDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, constructor_, undefined, /*modifiers*/ undefined, /*typeParameters*/ parameters, undefined, /*returnType*/ undefined, /*fullSignature*/ body);
    }
    if (parameters === undefined) {
        parameters = NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, []);
    }
    const result = NewConstructorDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, undefined, /*modifiers*/ undefined, /*typeParameters*/ parameters, undefined, /*returnType*/ undefined, /*fullSignature*/ body);
    result.Loc = container.Loc;
    return result;
}
/**
 ...
 * }
 */
export function classFieldsTransformer_transformConstructorBodyWorker(receiver, statementsOut, statementsIn, statementOffset, superPath, superPathDepth, initializerStatements, constructor_) {
    const superStatementIndex = superPath[superPathDepth];
    const superStatement = statementsIn[superStatementIndex];
    // Visit statements before super
    const [visitedBefore] = NodeVisitor_VisitSlice(Transformer_Visitor(receiver.__tsgoEmbedded0), statementsIn.slice(statementOffset, superStatementIndex));
    let out = [...statementsOut, ...visitedBefore];
    let newOffset = superStatementIndex + 1;
    if (IsTryStatement(superStatement)) {
        const tryStmt = AsTryStatement(superStatement);
        const tryBlock = AsBlock(tryStmt.TryBlock);
        const tryBlockStatements = classFieldsTransformer_transformConstructorBodyWorker(receiver, [], tryBlock.Statements.Nodes, 0, /*statementOffset*/ superPath, superPathDepth + 1, initializerStatements, constructor_);
        const tryStatementList = NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, tryBlockStatements);
        tryStatementList.Loc = tryBlock.Statements.Loc;
        const catchClause = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), tryStmt.CatchClause);
        const finallyBlock = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), tryStmt.FinallyBlock);
        const updatedBlock = NodeFactory_UpdateBlock(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, tryBlock, tryStatementList, tryBlock.MultiLine);
        const updated = NodeFactory_UpdateTryStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, tryStmt, updatedBlock, catchClause, finallyBlock);
        out = [...out, updated];
    }
    else {
        const [visitedSuper] = NodeVisitor_VisitSlice(Transformer_Visitor(receiver.__tsgoEmbedded0), statementsIn.slice(superStatementIndex, superStatementIndex + 1));
        out = [...out, ...visitedSuper];
        // parameter-property assignments should occur immediately after the prologue and `super()`,
        // so only count the statements that immediately follow.
        while (newOffset < statementsIn.length) {
            const stmt = statementsIn[newOffset];
            const orig = EmitContext_MostOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), stmt);
            if (IsParameterPropertyDeclaration(orig, constructor_)) {
                newOffset++;
            }
            else {
                break;
    ...
    // Visit remaining statements
    const [visited2] = NodeVisitor_VisitSlice(Transformer_Visitor(receiver.__tsgoEmbedded0), statementsIn.slice(newOffset));
    out = [...out, ...visited2];
    return out;
}
/**
 ...
 * }
 */
export function classFieldsTransformer_transformConstructorBody(receiver, container, constructor_, isDerivedClass) {
    ...
    if (!CompilerOptions_GetUseDefineForClassFields(receiver.compilerOptions)) {
        properties = properties.filter((prop) => Node_Initializer(prop) !== undefined || IsPrivateIdentifier(Node_Name(prop)) || HasAccessorModifier(prop));
    }
    ...
    if (constructor_ === undefined && !needsConstructorBody) {
        return EmitContext_VisitFunctionBody(Transformer_EmitContext(receiver.__tsgoEmbedded0), undefined, Transformer_Visitor(receiver.__tsgoEmbedded0));
    }
    EmitContext_StartVariableEnvironment(Transformer_EmitContext(receiver.__tsgoEmbedded0));
    const needsSyntheticConstructor = constructor_ === undefined && isDerivedClass;
    let statements = [];
    // Add the property initializers.
    let initializerStatements = [];
    ...
    if (constructor_ !== undefined) {
        const constructorNode = constructor_;
        const parameterProperties = instanceProperties.filter((prop) => IsParameterPropertyDeclaration(EmitContext_MostOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), prop), constructorNode));
        const nonParameterProperties = properties.filter((prop) => !IsParameterPropertyDeclaration(EmitContext_MostOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), prop), constructorNode));
        initializerStatements = classFieldsTransformer_addPropertyOrClassStaticBlockStatements(receiver, initializerStatements, parameterProperties, receiverExpr);
        initializerStatements = classFieldsTransformer_addPropertyOrClassStaticBlockStatements(receiver, initializerStatements, nonParameterProperties, receiverExpr);
    }
    else {
        initializerStatements = classFieldsTransformer_addPropertyOrClassStaticBlockStatements(receiver, initializerStatements, properties, receiverExpr);
    }
    if (constructor_ !== undefined && constructor_.Body !== undefined) {
        ...
        const superPath = FindSuperStatementIndexPath(body.Statements.Nodes, statementOffset);
        if (superPath.length > 0) {
            statements = classFieldsTransformer_transformConstructorBodyWorker(receiver, statements, body.Statements.Nodes, statementOffset, superPath, 0, initializerStatements, constructor_);
        }
        else {
            // parameter-property assignments should occur immediately after the prologue and `super()`,
            // so only count the statements that immediately follow.
            const bodyNodes = body.Statements.Nodes;
            ...
            const [visited] = NodeVisitor_VisitSlice(Transformer_Visitor(receiver.__tsgoEmbedded0), bodyNodes.slice(statementOffset));
        ...
        if (needsSyntheticConstructor) {
            ...
            //  super(...arguments);
            //
            const superCall = NewExpressionStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NewCallExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NewKeywordExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, KindSuperKeyword), undefined, /*typeArguments*/ undefined, /*questionDotToken*/ NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, [
            ...
            statements = [...statements, superCall];
        }
        statements = [...statements, ...initializerStatements];
    }
    statements = EmitContext_EndAndMergeVariableEnvironment(Transformer_EmitContext(receiver.__tsgoEmbedded0), statements);
    ...
    const statementList = NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, statements);
    if (constructor_ !== undefined && constructor_.Body !== undefined) {
 ...
 * }
 */
export function classFieldsTransformer_addPropertyOrClassStaticBlockStatements(receiver, statements, properties, receiver1) {
    let out = statements;
 ...
 * }
 */
export function classFieldsTransformer_transformPropertyOrClassStaticBlock(receiver, property, receiver1) {
    let expression;
    if (IsClassStaticBlockDeclaration(property)) {
        expression = classFieldsTransformer_setCurrentClassElementAnd(receiver, property, classFieldsTransformer_transformClassStaticBlockDeclaration, property);
    }
    else {
 ...
 * }
 */
export function classFieldsTransformer_generateInitializedPropertyExpressionsOrClassStaticBlock(receiver, propertiesOrClassStaticBlocks, receiver1) {
    let expressions = [];
 ...
 * }
 */
export function classFieldsTransformer_transformProperty(receiver, property, receiver1) {
    const savedCurrentClassElement = receiver.currentClassElement;
    ...
    if (transformed !== undefined && HasStaticModifier(property) &&
        ...
        // capture the lexical environment for the member
        EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), transformed, property);
        EmitContext_SetSourceMapRange(Transformer_EmitContext(receiver.__tsgoEmbedded0), transformed, EmitContext_SourceMapRange(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_Name(property)));
    }
    receiver.currentClassElement = savedCurrentClassElement;
    return transformed;
}
 ...
 * }
 */
export function classFieldsTransformer_transformPropertyWorker(receiver, property, receiver1) {
    ...
    let prop = property;
    if (isNamedEvaluationAnd(Transformer_EmitContext(receiver.__tsgoEmbedded0), property, receiver.isAnonymousClassNeedingAssignedName)) {
        prop = AsPropertyDeclaration(transformNamedEvaluation(Transformer_EmitContext(receiver.__tsgoEmbedded0), property, false, ""));
    }
    let propertyName = Node_Name(prop);
    if (HasAccessorModifier(prop)) {
        propertyName = NodeFactory_NewGeneratedPrivateNameForNodeEx(Transformer_Factory(receiver.__tsgoEmbedded0), propertyName, { Suffix: "_accessor_storage" });
    }
    else if (IsComputedPropertyName(propertyName) && !IsSimpleInlineableExpression(Node_Expression(propertyName))) {
        propertyName = NodeFactory_UpdateComputedPropertyName(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsComputedPropertyName(propertyName), NodeFactory_NewGeneratedNameForNode(Transformer_Factory(receiver.__tsgoEmbedded0), propertyName));
    }
    if (HasStaticModifier(prop)) {
        receiver.currentClassElement = prop;
    }
    if (IsPrivateIdentifier(propertyName) && classFieldsTransformer_shouldTransformClassElementToWeakMap(receiver, prop)) {
        const info = classFieldsTransformer_accessPrivateIdentifier(receiver, propertyName);
        if (info !== undefined) {
            if (info.kind === PrivateIdentifierKindField) {
                if (!info.isStatic) {
                    return createPrivateInstanceFieldInitializer(Transformer_Factory(receiver.__tsgoEmbedded0), receiver1, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Initializer(prop)), info.brandCheckIdentifier);
                }
                return createPrivateStaticFieldInitializer(Transformer_Factory(receiver.__tsgoEmbedded0), info.variableName, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Initializer(prop)));
            }
            return undefined;
        }
        else {
    ...
    if ((IsPrivateIdentifier(propertyName) || HasStaticModifier(prop)) && Node_Initializer(prop) === undefined) {
        return undefined;
    }
    // TODO: can we get rid of this original checking and better coordinate with runtimesyntax?
    if (HasAbstractModifier(EmitContext_MostOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), prop))) {
        return undefined;
    }
    let initializer = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Initializer(prop));
    const propertyOriginalNode = EmitContext_MostOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), prop);
    ...
    if (emitAssignment || IsPrivateIdentifier(propertyName)) {
        const memberAccess = createMemberAccessForPropertyName(Transformer_Factory(receiver.__tsgoEmbedded0), Transformer_EmitContext(receiver.__tsgoEmbedded0), receiver1, propertyName, propertyName);
    ...
    if (IsComputedPropertyName(propertyName)) {
        name = Node_Expression(propertyName);
    }
    ...
    const descriptor = NewObjectLiteralExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, [
    ...
    return NodeFactory_NewObjectDefinePropertyCall(Transformer_Factory(receiver.__tsgoEmbedded0), receiver1, name, descriptor);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_addInstanceMethodStatements(receiver, statements, methods, receiver1) {
    ...
    const weakSetName = env.data.weakSetName;
    debug.Assert(weakSetName !== undefined, "weakSetName should be set in private identifier environment");
    const stmt = NewExpressionStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, createPrivateInstanceMethodInitializer(Transformer_Factory(receiver.__tsgoEmbedded0), receiver1, weakSetName));
 ...
 * }
 */
export function classFieldsTransformer_visitInvalidSuperProperty(receiver, node) {
    if (IsPropertyAccessExpression(node)) {
        return NodeFactory_UpdatePropertyAccessExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsPropertyAccessExpression(node), NodeFactory_NewVoidZeroExpression(Transformer_Factory(receiver.__tsgoEmbedded0)), undefined, Node_Name(node), node.Flags);
    }
    return NodeFactory_UpdateElementAccessExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsElementAccessExpression(node), NodeFactory_NewVoidZeroExpression(Transformer_Factory(receiver.__tsgoEmbedded0)), undefined, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), AsElementAccessExpression(node).ArgumentExpression), node.Flags);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_getPropertyNameExpressionIfNeeded(receiver, name, shouldHoist) {
    if (!IsComputedPropertyName(name)) {
        return undefined;
    }
    const cacheAssignment = findComputedPropertyNameCacheAssignment(Transformer_EmitContext(receiver.__tsgoEmbedded0), name);
    ...
    const expression = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Expression(name));
    receiver.lexicalEnvironment = savedLexicalEnvironment;
    receiver.insideComputedPropertyName = savedInsideComputedPropertyName;
    const innerExpression = SkipPartiallyEmittedExpressions(expression);
    const inlinable = IsSimpleInlineableExpression(innerExpression);
    const alreadyTransformed = cacheAssignment !== undefined || (IsAssignmentExpression(innerExpression, true /*excludeCompoundAssignment*/) && IsIdentifier(AsBinaryExpression(innerExpression).Left) && IsGeneratedIdentifier(Transformer_EmitContext(receiver.__tsgoEmbedded0), AsBinaryExpression(innerExpression).Left));
    if (!alreadyTransformed && !inlinable && shouldHoist) {
        const generatedName = NodeFactory_NewGeneratedNameForNode(Transformer_Factory(receiver.__tsgoEmbedded0), name);
        if (classFieldsTransformer_requiresBlockScopedVar(receiver)) {
 ...
 * }
 */
export function classFieldsTransformer_startClassLexicalEnvironment(receiver) {
 ...
 * }
 */
export function classFieldsTransformer_endClassLexicalEnvironment(receiver) {
    receiver.lexicalEnvironment = receiver.lexicalEnvironment.previous;
}
/**
 ...
 * }
 */
export function classFieldsTransformer_getClassLexicalEnvironment(receiver) {
 ...
 * }
 */
export function classFieldsTransformer_getPrivateIdentifierEnvironment(receiver) {
    debug.Assert((receiver.lexicalEnvironment !== undefined));
 ...
 * }
 */
export function classFieldsTransformer_addPendingExpressions(receiver, ...exprs) {
 ...
 * }
 */
export function classFieldsTransformer_addPrivateIdentifierPropertyDeclarationToEnvironment(receiver, node, name) {
    const lex = classFieldsTransformer_getClassLexicalEnvironment(receiver);
    const env = classFieldsTransformer_getPrivateIdentifierEnvironment(receiver);
    ...
    if (isStatic) {
        ...
        classFieldsTransformer_addPendingExpressions(receiver, NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), weakMapName, NewNewExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NewIdentifier(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, "WeakMap"), undefined, /*typeArguments*/ NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, []))));
    }
}
/**
 ...
 * }
 */
export function classFieldsTransformer_addPrivateIdentifierMethodToEnvironment(receiver, name, lex, env, isStatic, isValid) {
    const methodName = classFieldsTransformer_createHoistedVariableForPrivateName(receiver, name, "");
    let brandCheckIdentifier;
    if (isStatic) {
        brandCheckIdentifier = lex.classThis;
        if (brandCheckIdentifier === undefined) {
            brandCheckIdentifier = lex.classConstructor;
 ...
 * }
 */
export function classFieldsTransformer_addPrivateIdentifierGetAccessorToEnvironment(receiver, name, lex, env, isStatic, isValid, previousInfo) {
 ...
 * }
 */
export function classFieldsTransformer_addPrivateIdentifierSetAccessorToEnvironment(receiver, name, lex, env, isStatic, isValid, previousInfo) {
 ...
 * }
 */
export function classFieldsTransformer_addPrivateIdentifierAutoAccessorToEnvironment(receiver, node, name, lex, env, isStatic, isValid) {
    const getterName = classFieldsTransformer_createHoistedVariableForPrivateName(receiver, name, "_get");
    const setterName = classFieldsTransformer_createHoistedVariableForPrivateName(receiver, name, "_set");
    let brandCheckIdentifier;
    if (isStatic) {
 ...
 * }
 */
export function classFieldsTransformer_addPrivateIdentifierToEnvironment(receiver, node) {
    const lex = classFieldsTransformer_getClassLexicalEnvironment(receiver);
    const env = classFieldsTransformer_getPrivateIdentifierEnvironment(receiver);
 ...
 * }
 */
export function classFieldsTransformer_setPrivateIdentifier(receiver, env, name, info) {
    if (EmitContext_HasAutoGenerateInfo(Transformer_EmitContext(receiver.__tsgoEmbedded0), name)) {
        if (env.generatedIdentifiers === undefined) {
            env.generatedIdentifiers = new Map();
        }
 ...
 * }
 */
export function classFieldsTransformer_getPrivateIdentifier(receiver, env, name) {
    if (EmitContext_HasAutoGenerateInfo(Transformer_EmitContext(receiver.__tsgoEmbedded0), name)) {
 ...
 * }
 */
export function classFieldsTransformer_createHoistedVariableForClass(receiver, nameText, node, suffix) {
    const env = classFieldsTransformer_getPrivateIdentifierEnvironment(receiver);
    let identifier;
    if (env.data.className !== undefined) {
        const prefix = "_" + Node_Text(env.data.className) + "_";
 ...
 * }
 */
export function classFieldsTransformer_createHoistedVariableForClassFromNode(receiver, name, suffix) {
    const env = classFieldsTransformer_getPrivateIdentifierEnvironment(receiver);
    let prefix;
    if (env.data.className !== undefined) {
        prefix = "_" + Node_Text(env.data.className) + "_";
    }
    else {
        prefix = "_";
    }
 ...
 * }
 */
export function classFieldsTransformer_createHoistedVariableForPrivateName(receiver, name, suffix) {
    // If the name is a generated identifier (e.g., auto-accessor backing field),
    // use node-based name generation so the emitter can resolve the name properly.
    if (EmitContext_HasAutoGenerateInfo(Transformer_EmitContext(receiver.__tsgoEmbedded0), name)) {
 ...
 * }
 */
export function classFieldsTransformer_accessPrivateIdentifier(receiver, name) {
 ...
 * }
 */
export function classFieldsTransformer_wrapPrivateIdentifierForDestructuringTarget(receiver, node) {
    ...
    const info = classFieldsTransformer_accessPrivateIdentifier(receiver, prop.name);
    if (info === undefined) {
        return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
    }
    let recv = prop.Expression;
    // We cannot copy `this` or `super` into the function because they will be bound
    // differently inside the function.
    ...
    if (isThisOrSuperProperty || !IsSimpleCopiableExpression(prop.Expression)) {
        ...
        receiver.pendingExpressions = [...receiver.pendingExpressions, NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), recvTemp, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), prop.Expression)),
        ];
        recv = recvTemp;
    }
    const assignExpr = classFieldsTransformer_createPrivateIdentifierAssignment(receiver, info, recv, parameter, KindEqualsToken);
 ...
 * }
 */
export function classFieldsTransformer_visitAssignmentElement(receiver, node) {
    // 13.15.5.5 RS: IteratorDestructuringAssignmentEvaluation
    //   AssignmentElement : DestructuringAssignmentTarget Initializer?
    //     ...
    //     4. If |Initializer| is present and _value_ is *undefined*, then
    ...
    if (IsAssignmentExpression(node, true /*excludeCompoundAssignment*/)) {
        const left = classFieldsTransformer_visitDestructuringAssignmentTarget(receiver, AsBinaryExpression(node).Left);
        const right = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), AsBinaryExpression(node).Right);
        return NodeFactory_UpdateBinaryExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsBinaryExpression(node), undefined, left, undefined, AsBinaryExpression(node).OperatorToken, right);
    }
 ...
 * }
 */
export function classFieldsTransformer_visitAssignmentRestElement(receiver, node) {
    const spread = AsSpreadElement(node);
    if (IsLeftHandSideExpression(spread.Expression)) {
        const expr = classFieldsTransformer_visitDestructuringAssignmentTarget(receiver, spread.Expression);
        return NodeFactory_UpdateSpreadElement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, spread, expr);
    }
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitArrayAssignmentElement(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_visitAssignmentProperty(receiver, node) {
    // AssignmentProperty : PropertyName `:` AssignmentElement
    // AssignmentElement : DestructuringAssignmentTarget Initializer?
    // 13.15.5.6 RS: KeyedDestructuringAssignmentEvaluation
    //   AssignmentElement : DestructuringAssignmentTarget Initializer?
    ...
    const name = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), prop.name);
    const init = prop.Initializer;
    if (IsAssignmentExpression(init, true /*excludeCompoundAssignment*/)) {
        const assignElem = classFieldsTransformer_visitAssignmentElement(receiver, init);
        return NodeFactory_UpdatePropertyAssignment(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, prop, undefined, name, undefined, undefined, assignElem);
    }
    if (IsLeftHandSideExpression(init)) {
        const target = classFieldsTransformer_visitDestructuringAssignmentTarget(receiver, init);
        return NodeFactory_UpdatePropertyAssignment(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, prop, undefined, name, undefined, undefined, target);
    }
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitShorthandAssignmentProperty(receiver, node) {
    // AssignmentProperty : IdentifierReference Initializer?
    // 13.15.5.3 RS: PropertyDestructuringAssignmentEvaluation
    //   AssignmentProperty : IdentifierReference Initializer?
    //     ...
 ...
 * }
 */
export function classFieldsTransformer_visitAssignmentRestProperty(receiver, node) {
    const spread = AsSpreadAssignment(node);
    if (IsLeftHandSideExpression(spread.Expression)) {
        const expr = classFieldsTransformer_visitDestructuringAssignmentTarget(receiver, spread.Expression);
        return NodeFactory_UpdateSpreadAssignment(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, spread, expr);
    }
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_visitObjectAssignmentElement(receiver, node) {
 ...
 * }
 */
export function classFieldsTransformer_visitAssignmentPattern(receiver, node) {
    if (IsArrayLiteralExpression(node)) {
        ...
        // Transformation:
        // [ { set value(x) { this.#myProp = x; } }.value ] = [ "hello" ];
        return NodeFactory_UpdateArrayLiteralExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsArrayLiteralExpression(node), NodeVisitor_VisitNodes(receiver.arrayAssignmentElementVisitor, AsArrayLiteralExpression(node).Elements), AsArrayLiteralExpression(node).MultiLine);
    }
    // Transforms private names in destructuring assignment object bindings.
    // Transforms SuperProperty assignments in destructuring assignment object bindings in static initializers.
    //
    ...
    // Transformation:
    // ({ stringProperty: { set value(x) { this.#myProp = x; } }.value }) = { stringProperty: "hello" };
    return NodeFactory_UpdateObjectLiteralExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, AsObjectLiteralExpression(node), NodeVisitor_VisitNodes(receiver.objectAssignmentElementVisitor, AsObjectLiteralExpression(node).Properties), AsObjectLiteralExpression(node).MultiLine);
}
/**
 ...
 * }
 */
export function createPrivateStaticFieldInitializer(factory, variableName, initializer) {
    let init = initializer;
    if (init === undefined) {
        init = NodeFactory_NewVoidZeroExpression(factory);
    }
    return NodeFactory_NewAssignmentExpression(factory, variableName, NewObjectLiteralExpression(factory.__tsgoEmbedded0, NodeFactory_NewNodeList(factory.__tsgoEmbedded0, [
        NewPropertyAssignment(factory.__tsgoEmbedded0, undefined, NewIdentifier(factory.__tsgoEmbedded0, "value"), undefined, undefined, init),
    ]), false));
}
/**
 ...
 * }
 */
export function createPrivateInstanceFieldInitializer(factory, receiver, initializer, weakMapName) {
    let init = initializer;
    if (init === undefined) {
        init = NodeFactory_NewVoidZeroExpression(factory);
    }
    return NodeFactory_NewMethodCall(factory, weakMapName, NewIdentifier(factory.__tsgoEmbedded0, "set"), [receiver, init]);
}
/**
 ...
 * }
 */
export function createPrivateInstanceMethodInitializer(factory, receiver, weakSetName) {
    return NodeFactory_NewMethodCall(factory, weakSetName, NewIdentifier(factory.__tsgoEmbedded0, "add"), [receiver]);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_isReservedPrivateName(receiver, node) {
    return (!(IsPrivateIdentifier(node) && EmitContext_HasAutoGenerateInfo(Transformer_EmitContext(receiver.__tsgoEmbedded0), node)) && Node_Text(node) === "#constructor");
}
/**
 ...
 * }
 */
export function isStaticPropertyDeclarationOrClassStaticBlock(node) {
 ...
 * }
 */
export function classFieldsTransformer_getProperties(receiver, node, requireInitializer, isStatic) {
    const result = [];
    for (const member of Node_Members(node) ?? []) {
        if (IsPropertyDeclaration(member) &&
 ...
 * }
 */
export function classFieldsTransformer_getStaticPropertiesAndClassStaticBlock(receiver, node) {
    const result = [];
    for (const member of Node_Members(node) ?? []) {
 ...
 * }
 */
export function classHasClassThisAssignment(emitContext, node) {
    for (const member of Node_Members(node) ?? []) {
        if (isClassThisAssignmentBlock(emitContext, member)) {
            return true;
        }
 ...
 * }
 */
export function isNonStaticMethodOrAccessorWithPrivateName(member) {
    return (!IsStatic(member) &&
        (IsMethodOrAccessor(member) || IsAutoAccessorPropertyDeclaration(member)) &&
        IsPrivateIdentifier(Node_Name(member)));
}
/**
 ...
 * }
 */
export function createMemberAccessForPropertyName(factory, emitContext, receiver, name, location) {
    if (IsComputedPropertyName(name)) {
    ...
    if (IsIdentifier(name) || IsPrivateIdentifier(name)) {
        expression = NewPropertyAccessExpression(factory.__tsgoEmbedded0, receiver, undefined, name, NodeFlagsNone);
    }
    else {
        // string or numeric literal
        expression = NewElementAccessExpression(factory.__tsgoEmbedded0, receiver, undefined, name, NodeFlagsNone);
    }
 ...
 * }
 */
export function classFieldsTransformer_createCallBinding(receiver, node) {
    if (IsSuperProperty(node)) {
        return [NodeFactory_NewThisExpression(Transformer_Factory(receiver.__tsgoEmbedded0)), node];
    }
    if (IsPropertyAccessExpression(node)) {
        ...
        if (shouldBeCapturedInTempVariable(expr.Expression)) {
            ...
            const target = NewPropertyAccessExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NewParenthesizedExpression(// TODO: do we even need these?
            Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), thisArg, expr.Expression)), undefined, expr.name, NodeFlagsNone);
            return [thisArg, target];
        }
        return [expr.Expression, node];
    }
    return [NodeFactory_NewVoidZeroExpression(Transformer_Factory(receiver.__tsgoEmbedded0)), node];
}
/**
 ...
 * }
 */
export function shouldBeCapturedInTempVariable(node) {
 ...
 * }
 */
export function classFieldsTransformer_createAccessorPropertyGetRedirector(receiver, node, modifiers, name, receiver1) {
    const backingFieldName = NodeFactory_NewGeneratedPrivateNameForNodeEx(Transformer_Factory(receiver.__tsgoEmbedded0), Node_Name(node), { Suffix: "_accessor_storage" });
    const returnExpr = NewPropertyAccessExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, receiver1, undefined, backingFieldName, NodeFlagsNone);
    const returnStmt = NewReturnStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, returnExpr);
    ...
    return NewGetAccessorDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, modifiers, name, undefined, /*typeParameters*/ NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, []), undefined, /*returnType*/ undefined, /*fullSignature*/ body);
}
/**
 ...
 * }
 */
export function classFieldsTransformer_createAccessorPropertySetRedirector(receiver, node, modifiers, name, receiver1) {
    const backingFieldName = NodeFactory_NewGeneratedPrivateNameForNodeEx(Transformer_Factory(receiver.__tsgoEmbedded0), Node_Name(node), { Suffix: "_accessor_storage" });
    const valueParam = NewParameterDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, undefined, /*modifiers*/ undefined, /*dotDotDotToken*/ NewIdentifier(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, "value"), undefined, /*questionToken*/ undefined, /*typeNode*/ undefined);
    const assignExpr = NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), NewPropertyAccessExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, receiver1, undefined, backingFieldName, NodeFlagsNone), NewIdentifier(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, "value"));
    ...
    return NewSetAccessorDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, modifiers, name, undefined, /*typeParameters*/ NodeFactory_NewNodeList(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, [valueParam]), undefined, /*returnType*/ undefined, /*fullSignature*/ body);
}
/**
 ...
 * }
 */
export function flattenCommaListWorker(node, yield_) {
 ...
 * }
 */
export function findComputedPropertyNameCacheAssignment(emitContext, name) {
 ...
 * }
 */
export function expandPreOrPostfixIncrementOrDecrementExpression(factory, emitContext, node, expression, resultVariable) {
    let operator;
    let operand;
    if (IsPrefixUnaryExpression(node)) {
        operator = AsPrefixUnaryExpression(node).Operator;
    ...
    let expr = NodeFactory_NewAssignmentExpression(factory, temp, expression);
    expr.Loc = operand.Loc;
    let operation;
    if (IsPrefixUnaryExpression(node)) {
        operation = NewPrefixUnaryExpression(factory.__tsgoEmbedded0, operator, temp);
    }
    else {
        operation = NewPostfixUnaryExpression(factory.__tsgoEmbedded0, temp, operator);
    }
    operation.Loc = node.Loc;
    if (resultVariable !== undefined) {
        operation = NodeFactory_NewAssignmentExpression(factory, resultVariable, operation);
        operation.Loc = node.Loc;
    }
    expr = NodeFactory_NewCommaExpression(factory, expr, operation);
    expr.Loc = node.Loc;
    if (IsPostfixUnaryExpression(node)) {
        expr = NodeFactory_NewCommaExpression(factory, expr, temp);
        expr.Loc = node.Loc;
    }
    return expr;
}
//# sourceMappingURL=classfields.js.map