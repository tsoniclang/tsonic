...
import { IsBlock, IsIdentifier, IsOmittedExpression, IsPostfixUnaryExpression, IsPrefixUnaryExpression, IsVariableDeclarationList, } from "../../ast/generated/predicates.js";
...
export function asyncTransformer_fallbackVisitor(receiver, node) {
    ...
    switch (node.Kind) {
        ...
        case KindVariableDeclaration:
            ...
            break;
        case KindIdentifier:
            if (receiver.lexicalArguments.binding !== undefined &&
...
export function asyncTransformer_visit(receiver, node) {
    const restoreLexicalThis = (EmitContext_EmitFlags(Transformer_EmitContext(receiver.__tsgoEmbedded0), node) & EFNoLexicalThis) !== 0 &&
    ...
    try {
        ...
        switch (node.Kind) {
            case KindAsyncKeyword:
                ...
                return undefined;
            case KindSourceFile:
                return asyncTransformer_visitSourceFile(receiver, node);
            case KindAwaitExpression:
                return asyncTransformer_visitAwaitExpression(receiver, node);
            case KindMethodDeclaration:
