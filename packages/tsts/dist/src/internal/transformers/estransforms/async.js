...
import { AsArrowFunction, AsArrayLiteralExpression, AsBindingPattern, AsBlock, AsCatchClause, AsConstructorDeclaration, AsForInOrOfStatement, AsForStatement, AsFunctionDeclaration, AsFunctionExpression, AsGetAccessorDeclaration, AsMethodDeclaration, AsObjectLiteralExpression, AsParameterDeclaration, AsParenthesizedExpression, AsPostfixUnaryExpression, AsPrefixUnaryExpression, AsPropertyAssignment, AsSetAccessorDeclaration, AsShorthandPropertyAssignment, AsSpreadAssignment, AsSpreadElement, AsVariableDeclaration, AsVariableDeclarationList, AsVariableStatement, } from "../../ast/generated/casts.js";
import { KindArrowFunction, KindArrayLiteralExpression, KindAsyncKeyword, KindAwaitExpression, KindBindingElement, KindBlock, KindCaseBlock, KindCaseClause, KindCatchClause, KindClassDeclaration, KindClassExpression, KindConstructor, KindDefaultClause, KindDoStatement, KindElementAccessExpression, KindForInStatement, KindForOfStatement, KindForStatement, KindFunctionDeclaration, KindFunctionExpression, KindGetAccessor, KindIdentifier, KindIfStatement, KindLabeledStatement, KindMethodDeclaration, KindMinusMinusToken, KindObjectLiteralExpression, KindParameter, KindParenthesizedExpression, KindPlusPlusToken, KindPropertyAccessExpression, KindPropertyAssignment, KindSetAccessor, KindShorthandPropertyAssignment, KindSourceFile, KindSpreadAssignment, KindSpreadElement, KindSuperKeyword, KindSwitchStatement, KindTryStatement, KindVariableDeclaration, KindVariableStatement, KindWhileStatement, KindWithStatement, } from "../../ast/generated/kinds.js";
import { IsBlock, IsIdentifier, IsOmittedExpression, IsPropertyAccessExpression, IsPropertyAssignment, IsPostfixUnaryExpression, IsPrefixUnaryExpression, IsVariableDeclarationList, } from "../../ast/generated/predicates.js";
 ...
 * )
 */
export const asyncContextNonTopLevel = 1 << 0;
export const asyncContextHasLexicalThis = 1 << 1;
/**
 ...
 * }
 */
export function newAsyncTransformer(opts) {
    const tx = {
        __tsgoEmbedded0: {},
        __tsgoEmbedded1: {},
        contextFlags: 0,
 ...
 * }
 */
export function asyncTransformer_visitSourceFile(receiver, node) {
    if (node.IsDeclarationFile) {
        return node;
    }
 ...
 * }
 */
export function asyncTransformer_setContextFlag(receiver, flag, val) {
    if (val) {
 ...
 * }
 */
export function asyncTransformer_inContext(receiver, flags) {
 ...
 * }
 */
export function asyncTransformer_inTopLevelContext(receiver) {
 ...
 * }
 */
export function asyncTransformer_inHasLexicalThisContext(receiver) {
 ...
 * }
 */
export function asyncTransformer_doWithContext(receiver, flags, cb, node) {
 ...
 * }
 */
export function asyncTransformer_visitDefault(receiver, node) {
 ...
 * }
 */
export function asyncTransformer_fallbackVisitor(receiver, node) {
    ...
    switch (node.Kind) {
        ...
        case KindIdentifier:
            if (receiver.lexicalArguments.binding !== undefined && Node_Text(node) === "arguments" && !isNameOfPropertyAccessOrAssignment(receiver.parentNode, node)) {
                ...
                return receiver.lexicalArguments.binding;
            }
            break;
    }
    return NodeVisitor_VisitEachChild(receiver.fallbackNodeVisitor, node);
}
/**
 ...
 * }
 */
export function asyncTransformer_descendInto(receiver, node) {
 ...
 * }
 */
export function asyncTransformer_visitFallback(receiver, node) {
 ...
 * }
 */
export function asyncTransformer_visit(receiver, node) {
    const cleanup = asyncTransformer_descendInto(receiver, node);
    ...
    switch (node.Kind) {
        case KindAsyncKeyword:
            ...
            break;
        case KindSourceFile:
            result = asyncTransformer_visitSourceFile(receiver, node);
            break;
        case KindAwaitExpression:
            result = asyncTransformer_visitAwaitExpression(receiver, node);
            break;
        case KindMethodDeclaration:
        ...
        case KindClassExpression:
            ...
            break;
        default:
            result = NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
            break;
    }
    cleanup();
    return result;
 ...
 * }
 */
export function asyncTransformer_visitAsyncBodyNode(receiver, node) {
    if (isNodeWithPossibleHoistedDeclaration(node)) {
        switch (node.Kind) {
            ...
            case KindLabeledStatement:
                return NodeVisitor_VisitEachChild(receiver.asyncBodyVisitor, node);
        }
    }
 ...
 * }
 */
export function asyncTransformer_visitCatchClauseInAsyncBody(receiver, node) {
    const catchClauseNames = NewSetWithSizeHint(0);
    if (node.VariableDeclaration !== undefined) {
        asyncTransformer_recordDeclarationName(receiver, node.VariableDeclaration, catchClauseNames);
    }
    // names declared in a catch variable are block scoped
    let catchClauseUnshadowedNames = undefined;
    ...
    if (catchClauseUnshadowedNames !== undefined) {
        ...
        const result = NodeVisitor_VisitEachChild(receiver.asyncBodyVisitor, node);
 ...
 * }
 */
export function asyncTransformer_visitVariableStatementInAsyncBody(receiver, node) {
    const declList = AsVariableStatement(node).DeclarationList;
    if (asyncTransformer_isVariableDeclarationListWithCollidingName(receiver, declList)) {
        const expression = asyncTransformer_visitVariableDeclarationListWithCollidingNames(receiver, AsVariableDeclarationList(declList), false);
        if (expression !== undefined) {
            return NewExpressionStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, expression);
        }
        return undefined;
    }
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
 ...
 * }
 */
export function asyncTransformer_visitForInStatementInAsyncBody(receiver, node) {
    let visitedInitializer;
    if (asyncTransformer_isVariableDeclarationListWithCollidingName(receiver, node.Initializer)) {
        visitedInitializer = asyncTransformer_visitVariableDeclarationListWithCollidingNames(receiver, AsVariableDeclarationList(node.Initializer), true);
    }
    else {
        visitedInitializer = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Initializer);
    }
    return NodeFactory_UpdateForInOrOfStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, undefined, // awaitModifier
    visitedInitializer, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Expression), NodeVisitor_VisitEmbeddedStatement(receiver.asyncBodyVisitor, node.Statement));
}
/**
 ...
 * }
 */
export function asyncTransformer_visitForOfStatementInAsyncBody(receiver, node) {
    let visitedInitializer;
    if (asyncTransformer_isVariableDeclarationListWithCollidingName(receiver, node.Initializer)) {
        visitedInitializer = asyncTransformer_visitVariableDeclarationListWithCollidingNames(receiver, AsVariableDeclarationList(node.Initializer), true);
    }
    ...
    return NodeFactory_UpdateForInOrOfStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.AwaitModifier), visitedInitializer, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Expression), NodeVisitor_VisitEmbeddedStatement(receiver.asyncBodyVisitor, node.Statement));
}
/**
 ...
 * }
 */
export function asyncTransformer_visitForStatementInAsyncBody(receiver, node) {
    const initializer = node.Initializer;
    let visitedInitializer;
    if (initializer !== undefined && asyncTransformer_isVariableDeclarationListWithCollidingName(receiver, initializer)) {
        visitedInitializer = asyncTransformer_visitVariableDeclarationListWithCollidingNames(receiver, AsVariableDeclarationList(initializer), false);
    }
    else {
        visitedInitializer = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Initializer);
    }
    return NodeFactory_UpdateForStatement(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, node, visitedInitializer, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Condition), NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Incrementor), NodeVisitor_VisitEmbeddedStatement(receiver.asyncBodyVisitor, node.Statement));
}
/**
 ...
 * }
 */
export function asyncTransformer_visitAwaitExpression(receiver, node) {
    // do not downlevel a top-level await as it is module syntax...
    if (asyncTransformer_inTopLevelContext(receiver)) {
        return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
    }
    const yieldExpr = NewYieldExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, undefined, // asteriskToken
    NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Expression(node)));
    yieldExpr.Loc = node.Loc;
    EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), yieldExpr, node);
    return yieldExpr;
}
/**
 ...
 * }
 */
export function asyncTransformer_visitConstructorDeclaration(receiver, node) {
    ...
    const updated = NodeFactory_UpdateConstructorDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, decl, NodeVisitor_VisitModifiers(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Modifiers(node)), undefined, // typeParameters
    EmitContext_VisitParameters(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_ParameterList(node), Transformer_Visitor(receiver.__tsgoEmbedded0)), undefined, // returnType
    undefined, // fullSignature
    asyncTransformer_transformMethodBody(receiver, node));
 ...
 * }
 */
export function asyncTransformer_visitMethodDeclaration(receiver, node) {
    ...
    if ((functionFlags & FunctionFlagsAsync) !== 0) {
        ...
        parameters = EmitContext_VisitParameters(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_ParameterList(node), Transformer_Visitor(receiver.__tsgoEmbedded0));
        body = asyncTransformer_transformMethodBody(receiver, node);
    }
    const updated = NodeFactory_UpdateMethodDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, decl, NodeVisitor_VisitModifiers(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Modifiers(node)), decl.AsteriskToken, Node_Name(node), undefined, // postfixToken
    undefined, // typeParameters
    parameters, undefined, // returnType
    undefined, // fullSignature
    body);
    receiver.lexicalArguments = savedLexicalArguments;
    return updated;
 ...
 * }
 */
export function asyncTransformer_visitGetAccessorDeclaration(receiver, node) {
    const decl = AsGetAccessorDeclaration(node);
    const savedLexicalArguments = receiver.lexicalArguments;
    receiver.lexicalArguments = { binding: undefined, used: false };
    const updated = NodeFactory_UpdateGetAccessorDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, decl, NodeVisitor_VisitModifiers(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Modifiers(node)), Node_Name(node), undefined, // typeParameters
    EmitContext_VisitParameters(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_ParameterList(node), Transformer_Visitor(receiver.__tsgoEmbedded0)), undefined, // returnType
    undefined, // fullSignature
    asyncTransformer_transformMethodBody(receiver, node));
    receiver.lexicalArguments = savedLexicalArguments;
 ...
 * }
 */
export function asyncTransformer_visitSetAccessorDeclaration(receiver, node) {
    const decl = AsSetAccessorDeclaration(node);
    const savedLexicalArguments = receiver.lexicalArguments;
    receiver.lexicalArguments = { binding: undefined, used: false };
    const updated = NodeFactory_UpdateSetAccessorDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, decl, NodeVisitor_VisitModifiers(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Modifiers(node)), Node_Name(node), undefined, // typeParameters
    EmitContext_VisitParameters(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_ParameterList(node), Transformer_Visitor(receiver.__tsgoEmbedded0)), undefined, // returnType
    undefined, // fullSignature
    asyncTransformer_transformMethodBody(receiver, node));
    receiver.lexicalArguments = savedLexicalArguments;
 ...
 * }
 */
export function asyncTransformer_visitFunctionDeclaration(receiver, node) {
    ...
    if ((functionFlags & FunctionFlagsAsync) !== 0) {
        ...
        parameters = EmitContext_VisitParameters(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_ParameterList(node), Transformer_Visitor(receiver.__tsgoEmbedded0));
        body = EmitContext_VisitFunctionBody(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_Body(node), Transformer_Visitor(receiver.__tsgoEmbedded0));
    }
    const updated = NodeFactory_UpdateFunctionDeclaration(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, decl, NodeVisitor_VisitModifiers(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Modifiers(node)), decl.AsteriskToken, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), decl.name), undefined, // typeParameters
    parameters, undefined, // returnType
    undefined, // fullSignature
    body);
    receiver.lexicalArguments = savedLexicalArguments;
 ...
 * }
 */
export function asyncTransformer_visitFunctionExpression(receiver, node) {
    ...
    const updated = NodeFactory_UpdateFunctionExpression(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, decl, NodeVisitor_VisitModifiers(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Modifiers(node)), decl.AsteriskToken, NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), decl.name), undefined, // typeParameters
    parameters, undefined, // returnType
    undefined, // fullSignature
    body);
    receiver.lexicalArguments = savedLexicalArguments;
 ...
 * }
 */
export function asyncTransformer_visitArrowFunction(receiver, node) {
    // `arguments` in class static blocks is always an error, but we preserve Strada's emit
    // behavior for baseline compatibility.
    let savedLexicalArguments;
    ...
    const result = NodeFactory_UpdateArrowFunction(Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0, decl, NodeVisitor_VisitModifiers(Transformer_Visitor(receiver.__tsgoEmbedded0), Node_Modifiers(node)), undefined, // typeParameters
    parameters, undefined, // returnType
    undefined, // fullSignature
 ...
 * }
 */
export function asyncTransformer_recordDeclarationName(receiver, node, names) {
    const name = Node_Name(node);
    if (name === undefined) {
        return;
    }
    if (IsIdentifier(name)) {
        Set_Add(names, Node_Text(name));
    }
 ...
 * }
 */
export function asyncTransformer_isVariableDeclarationListWithCollidingName(receiver, node) {
 ...
 * }
 */
export function asyncTransformer_visitVariableDeclarationListWithCollidingNames(receiver, node, hasReceiver) {
    asyncTransformer_hoistVariableDeclarationList(receiver, node);
    const variables = node.Declarations.Nodes.filter((decl) => AsVariableDeclaration(decl).Initializer !== undefined);
    if (variables === undefined || variables.length === 0) {
        if (hasReceiver) {
            const name = Node_Name(node.Declarations.Nodes[0]);
            let target;
            if (IsBindingPattern(name)) {
                target = ConvertBindingPatternToAssignmentPattern(Transformer_EmitContext(receiver.__tsgoEmbedded0), AsBindingPattern(name));
            }
            else {
                target = name;
            }
            return NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), target);
        }
        return undefined;
    }
    const expressions = variables.map((variable) => asyncTransformer_transformInitializedVariable(receiver, AsVariableDeclaration(variable)));
 ...
 * }
 */
export function asyncTransformer_hoistVariableDeclarationList(receiver, node) {
 ...
 * }
 */
export function asyncTransformer_hoistVariable(receiver, node) {
    const name = Node_Name(node);
    if (name === undefined) {
        return;
    }
    if (IsIdentifier(name)) {
        EmitContext_AddVariableDeclaration(Transformer_EmitContext(receiver.__tsgoEmbedded0), name);
    }
    else if (IsBindingPattern(name)) {
        const bp = AsBindingPattern(name);
        for (const element of bp.Elements.Nodes) {
 ...
 * }
 */
export function asyncTransformer_transformInitializedVariable(receiver, node) {
    let target;
    const nameNode = Node_Name(node);
    if (IsBindingPattern(nameNode)) {
        target = ConvertBindingPatternToAssignmentPattern(Transformer_EmitContext(receiver.__tsgoEmbedded0), AsBindingPattern(nameNode));
    }
    else {
        target = nameNode;
    }
    const converted = NodeFactory_NewAssignmentExpression(Transformer_Factory(receiver.__tsgoEmbedded0), target, node.Initializer);
    EmitContext_SetSourceMapRange(Transformer_EmitContext(receiver.__tsgoEmbedded0), converted, node.Loc);
    return NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), converted);
}
/**
 ...
 * }
 */
export function asyncTransformer_collidesWithParameterName(receiver, node) {
    const name = Node_Name(node);
    if (name === undefined) {
        return false;
    }
    if (IsIdentifier(name)) {
        return receiver.enclosingFunctionParameterNames !== undefined && Set_Has(receiver.enclosingFunctionParameterNames, Node_Text(name));
    }
    if (IsBindingPattern(name)) {
        const bp = AsBindingPattern(name);
        for (const element of bp.Elements.Nodes) {
 ...
 * }
 */
export function asyncTransformer_transformMethodBody(receiver, node) {
    ...
    receiver.__tsgoEmbedded1.capturedSuperProperties = NewOrderedSetWithSizeHint(0);
    receiver.__tsgoEmbedded1.hasSuperElementAccess = false;
    receiver.__tsgoEmbedded1.hasSuperPropertyAssignment = false;
    ...
    let updated = EmitContext_VisitFunctionBody(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_Body(node), Transformer_Visitor(receiver.__tsgoEmbedded0));
    // Minor optimization, emit `_super` helper to capture `super` access in an arrow.
    const emitSuperHelpers = (OrderedSet_Size(receiver.__tsgoEmbedded1.capturedSuperProperties) > 0 || receiver.__tsgoEmbedded1.hasSuperElementAccess) &&
    ...
    const mergedStatements = EmitContext_EndAndMergeVariableEnvironmentList(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_StatementList(updated));
    ...
    if (emitSuperHelpers && receiver.__tsgoEmbedded1.hasSuperElementAccess && !updatedBlock.MultiLine) {
        const newBlock = NewBlock(factory, mergedStatements, true);
        newBlock.Loc = updated.Loc;
        updated = newBlock;
    }
    else {
        updated = NodeFactory_UpdateBlock(factory, updatedBlock, mergedStatements, updatedBlock.MultiLine);
    }
 ...
 * }
 */
export function asyncTransformer_createCaptureArgumentsStatement(receiver) {
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const factory = printerFactory.__tsgoEmbedded0;
    const variable = NewVariableDeclaration(factory, receiver.lexicalArguments.binding, undefined, undefined, NewIdentifier(factory, "arguments"));
    const declList = NewVariableDeclarationList(factory, NodeFactory_NewNodeList(factory, [variable]), NodeFlagsNone);
    const statement = NewVariableStatement(factory, undefined, declList);
 ...
 * }
 */
export function asyncTransformer_transformAsyncFunctionParameterList(receiver, node) {
    if (isSimpleParameterList(Node_Parameters(node))) {
        return EmitContext_VisitParameters(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_ParameterList(node), Transformer_Visitor(receiver.__tsgoEmbedded0));
    }
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const factory = printerFactory.__tsgoEmbedded0;
    const newParameters = [];
    for (const parameter of Node_Parameters(node) ?? []) {
        ...
        if (param.Initializer !== undefined || param.DotDotDotToken !== undefined) {
            ...
            if (node.Kind === KindArrowFunction) {
                const restParameter = NewParameterDeclaration(factory, undefined, NewToken(factory, KindDotDotDotToken), NodeFactory_NewUniqueNameEx(printerFactory, "args", { Flags: GeneratedIdentifierFlagsReservedInNestedScopes, Prefix: "", Suffix: "" }), undefined, undefined, undefined);
        ...
        // for arrow functions we capture fixed parameters to forward to `__awaiter`. For all other functions
        // we add fixed parameters to preserve the function's `length` property.
        const newParameter = NewParameterDeclaration(factory, undefined, undefined, NodeFactory_NewGeneratedNameForNodeEx(printerFactory, param.name, { Flags: GeneratedIdentifierFlagsReservedInNestedScopes, Prefix: "", Suffix: "" }), undefined, undefined, undefined);
 ...
 * }
 */
export function asyncTransformer_transformAsyncFunctionBody(receiver, node, outerParameters) {
    ...
    let innerParameters = undefined;
    if (!isSimpleParameterList(Node_Parameters(node))) {
        innerParameters = EmitContext_VisitParameters(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_ParameterList(node), Transformer_Visitor(receiver.__tsgoEmbedded0));
    }
    const savedLexicalArguments = receiver.lexicalArguments;
    ...
    let argumentsExpression = undefined;
        ...
        if (isArrow) {
            ...
            for (let i = 0; i < params.length; i++) {
                ...
                if (originalParameter.Initializer !== undefined || originalParameter.DotDotDotToken !== undefined) {
                    parameterBindings.push(NewSpreadElement(factory, Node_Name(outerParameters.Nodes[i])));
                    break;
                }
                parameterBindings.push(Node_Name(outerParameters.Nodes[i]));
            }
            argumentsExpression = NewArrayLiteralExpression(factory, NodeFactory_NewNodeList(factory, parameterBindings), false);
        }
        else {
            argumentsExpression = NewIdentifier(factory, "arguments");
        }
    }
    // An async function is emit as an outer function that calls an inner generator function.
    const savedEnclosingFunctionParameterNames = receiver.enclosingFunctionParameterNames;
    receiver.enclosingFunctionParameterNames = NewSetWithSizeHint(0);
    for (const parameter of Node_Parameters(node)) {
        asyncTransformer_recordDeclarationName(receiver, parameter, receiver.enclosingFunctionParameterNames);
    }
    ...
    asyncBody = NodeFactory_UpdateBlock(factory, asyncBodyBlock, EmitContext_EndAndMergeVariableEnvironmentList(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_StatementList(asyncBody)), asyncBodyBlock.MultiLine);
    ...
    if (emitSuperHelpers) {
        if (innerParameters !== undefined) {
            innerParameters = NodeVisitor_VisitNodes(receiver.__tsgoEmbedded1.superAccessVisitor, innerParameters);
        }
    ...
    if (!isArrow) {
        ...
        const returnStmt = NewReturnStatement(factory, NodeFactory_NewAwaiterHelper(printerFactory, hasLexicalThis, argumentsExpression, innerParameters, asyncBody));
        const stmtList = NodeFactory_NewNodeList(factory, [returnStmt]);
        const mergedStmts = EmitContext_EndAndMergeVariableEnvironmentList(Transformer_EmitContext(receiver.__tsgoEmbedded0), stmtList);
        const block = NewBlock(factory, mergedStmts, true);
        block.Loc = Node_Body(node).Loc;
        if (emitSuperHelpers && receiver.__tsgoEmbedded1.hasSuperElementAccess) {
            if (receiver.__tsgoEmbedded1.hasSuperPropertyAssignment) {
                EmitContext_AddEmitHelper(Transformer_EmitContext(receiver.__tsgoEmbedded0), block, AdvancedAsyncSuperHelper);
            }
            else {
                EmitContext_AddEmitHelper(Transformer_EmitContext(receiver.__tsgoEmbedded0), block, AsyncSuperHelper);
            }
        }
        result = block;
    }
    else {
        result = NodeFactory_NewAwaiterHelper(printerFactory, hasLexicalThis, argumentsExpression, innerParameters, asyncBody);
        if (captureLexicalArguments && receiver.lexicalArguments.used) {
            const block = asyncTransformer_convertToFunctionBlock(receiver, result);
            const blockBlock = AsBlock(block);
            result = NodeFactory_UpdateBlock(factory, blockBlock, EmitContext_MergeEnvironmentList(Transformer_EmitContext(receiver.__tsgoEmbedded0), Node_StatementList(block), [asyncTransformer_createCaptureArgumentsStatement(receiver)]), blockBlock.MultiLine);
        }
    }
    receiver.enclosingFunctionParameterNames = savedEnclosingFunctionParameterNames;
    if (!isArrow) {
 ...
 * }
 */
export function asyncTransformer_transformAsyncFunctionBodyWorker(receiver, body) {
    const factory = Transformer_Factory(receiver.__tsgoEmbedded0).__tsgoEmbedded0;
    if (IsBlock(body)) {
        const bodyBlock = AsBlock(body);
        return NodeFactory_UpdateBlock(factory, bodyBlock, NodeVisitor_VisitNodes(receiver.asyncBodyVisitor, Node_StatementList(body)), bodyBlock.MultiLine);
    }
    // Convert expression body to block body with return statement
    const visited = NodeVisitor_VisitNode(receiver.asyncBodyVisitor, body);
    const ret = NewReturnStatement(factory, visited);
    ret.Loc = body.Loc;
    const list = NodeFactory_NewNodeList(factory, [ret]);
    list.Loc = body.Loc;
    const block = NewBlock(factory, list, false);
    block.Loc = body.Loc;
    return block;
}
/**
 ...
 * }
 */
export function asyncTransformer_convertToFunctionBlock(receiver, node) {
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const factory = printerFactory.__tsgoEmbedded0;
    if (IsBlock(node)) {
        return node;
    }
    const ret = NewReturnStatement(factory, node);
    ret.Loc = node.Loc;
    EmitContext_SetOriginal(Transformer_EmitContext(receiver.__tsgoEmbedded0), ret, node);
    const list = NodeFactory_NewNodeList(factory, [ret]);
    list.Loc = node.Loc;
    const block = NewBlock(factory, list, true);
    block.Loc = node.Loc;
    return block;
}
/**
 ...
 * }
 */
export function assignmentTargetContainsSuperProperty(node) {
    switch (node.Kind) {
        case KindPropertyAccessExpression:
        case KindElementAccessExpression:
            return Node_Expression(node).Kind === KindSuperKeyword;
        case KindParenthesizedExpression:
            return assignmentTargetContainsSuperProperty(AsParenthesizedExpression(node).Expression);
            ...
            for (const prop of AsObjectLiteralExpression(node).Properties.Nodes) {
                switch (prop.Kind) {
                    case KindPropertyAssignment:
                        if (assignmentTargetContainsSuperProperty(AsPropertyAssignment(prop).Initializer)) {
                            return true;
                        }
                        break;
                    case KindShorthandPropertyAssignment:
                        if (assignmentTargetContainsSuperProperty(Node_Name(AsShorthandPropertyAssignment(prop)))) {
                            return true;
                        }
                        break;
                    case KindSpreadAssignment:
                        if (assignmentTargetContainsSuperProperty(AsSpreadAssignment(prop).Expression)) {
                            return true;
                        }
                        break;
                }
        ...
        case KindSpreadElement:
            return assignmentTargetContainsSuperProperty(AsSpreadElement(node).Expression);
    }
    return false;
}
/**
 ...
 * }
 */
export function asyncTransformer_getOriginalIfFunctionLike(receiver, node) {
 ...
 * }
 */
export function isNameOfPropertyAccessOrAssignment(parent, node) {
 ...
 * }
 */
export function isSimpleParameterList(params) {
 ...
 * }
 */
export function isNodeWithPossibleHoistedDeclaration(node) {
    switch (node.Kind) {
        case KindBlock:
        case KindVariableStatement:
        case KindWithStatement:
