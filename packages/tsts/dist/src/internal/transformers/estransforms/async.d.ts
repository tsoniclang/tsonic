 ...
 * }
 */
export declare function asyncTransformer_descendInto(receiver: GoPtr<asyncTransformer>, node: GoPtr<Node>): () => void;
/**
 ...
 * }
 */
export declare function asyncTransformer_recordDeclarationName(receiver: GoPtr<asyncTransformer>, node: GoPtr<Node>, names: GoPtr<Set>): void;
/**
 ...
 * }
 */
export declare function isNameOfPropertyAccessOrAssignment(parent: GoPtr<Node>, node: GoPtr<Node>): bool;
/**
