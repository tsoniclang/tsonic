import { CompilerOptions_GetEmitScriptTarget, ScriptTargetES2016, ScriptTargetES2017, ScriptTargetES2018, ScriptTargetES2019, ScriptTargetES2020, ScriptTargetES2021, ScriptTargetES2022, ScriptTargetES2023, ScriptTargetES2024, ScriptTargetES2025, ScriptTargetESNext, } from "../../core/compileroptions.js";
 ...
 * )
 */
export const esDecoratorAndClassFields = Chain(newESDecoratorTransformer, newClassFieldsTransformer);
...
export const NewES2018Transformer = Chain(NewES2019Transformer, newObjectRestSpreadTransformer, newforawaitTransformer, newTaggedTemplateLiftRestrictionTransformer);
 ...
 * }
 */
export function GetESTransformer(opts) {
