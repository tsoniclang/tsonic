...
export function usingDeclarationTransformer_visitSourceFile(receiver, node) {
    ...
    if (usingKind !== usingKindNone) {
        ...
        if (receiver.exportBindings.size > 0) {
            topLevelStatements = [...topLevelStatements, NewExportDeclaration(factory, undefined, false, NewNamedExports(factory, NodeFactory_NewNodeList(factory, Array.from(receiver.exportBindings.values()))), undefined, undefined)];
        }
