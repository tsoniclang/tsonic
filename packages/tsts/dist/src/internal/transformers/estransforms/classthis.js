 ...
 * }
 */
export function isClassThisAssignmentBlock(emitContext, node) {
    if (IsClassStaticBlockDeclaration(node)) {
        ...
        if (body.Statements.Nodes.length === 1) {
            ...
            if (IsExpressionStatement(statement)) {
                ...
                if (IsAssignmentExpression(expression, true)) {
                    ...
                    return (IsIdentifier(binary.Left) &&
                        ...
                        binary.Right.Kind === KindThisKeyword);
                }
            }
        }
    }
...
//# sourceMappingURL=classthis.js.map