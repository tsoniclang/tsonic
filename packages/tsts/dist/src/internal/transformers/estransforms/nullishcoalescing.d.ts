 ...
 * }
 */
export declare function nullishCoalescingTransformer_visit(receiver: GoPtr<nullishCoalescingTransformer>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function nullishCoalescingTransformer_visitBinaryExpression(receiver: GoPtr<nullishCoalescingTransformer>, node: GoPtr<BinaryExpression>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function newNullishCoalescingTransformer(opts: GoPtr<TransformOptions>): GoPtr<Transformer>;
//# sourceMappingURL=nullishcoalescing.d.ts.map