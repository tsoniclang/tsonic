 ...
 * }
 */
export function NewUseStrictTransformer(opts) {
    const tx = {
 ...
 * }
 */
export function useStrictTransformer_visit(receiver, node) {
 ...
 * }
 */
export function useStrictTransformer_visitSourceFile(receiver, node) {
    ...
    const statements = NodeFactory_EnsureUseStrict(printerFactory, node.Statements.Nodes);
...
//# sourceMappingURL=usestrict.js.map