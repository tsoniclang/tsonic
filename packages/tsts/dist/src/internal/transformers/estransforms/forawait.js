 ...
 */
export const forAwaitHierarchyFactsNone = 0;
/**
...
export const forAwaitHierarchyFactsHasLexicalThis = 1 << 0;
// forAwaitHierarchyFactsIterationContainer (iota=1)
export const forAwaitHierarchyFactsIterationContainer = 1 << 1;
// forAwaitHierarchyFactsAncestorFactsMask = 1<<iota - 1 (iota=2)
export const forAwaitHierarchyFactsAncestorFactsMask = (1 << 2) - 1;
export const forAwaitHierarchyFactsSourceFileExcludes = forAwaitHierarchyFactsIterationContainer;
export const forAwaitHierarchyFactsStrictModeSourceFileIncludes = forAwaitHierarchyFactsNone;
export const forAwaitHierarchyFactsClassOrFunctionIncludes = forAwaitHierarchyFactsHasLexicalThis;
export const forAwaitHierarchyFactsClassOrFunctionExcludes = forAwaitHierarchyFactsIterationContainer;
export const forAwaitHierarchyFactsArrowFunctionIncludes = forAwaitHierarchyFactsNone;
export const forAwaitHierarchyFactsArrowFunctionExcludes = forAwaitHierarchyFactsClassOrFunctionExcludes;
export const forAwaitHierarchyFactsIterationStatementIncludes = forAwaitHierarchyFactsIterationContainer;
export const forAwaitHierarchyFactsIterationStatementExcludes = forAwaitHierarchyFactsNone;
/**
 ...
 * }
 */
export function newforawaitTransformer(opts) {
    const tx = {
        __tsgoEmbedded0: {},
        __tsgoEmbedded1: {},
        compilerOptions: opts.CompilerOptions,
 ...
 * }
 */
export function forawaitTransformer_affectsSubtree(receiver, excludeFacts, includeFacts) {
 ...
 * }
 */
export function forawaitTransformer_enterSubtree(receiver, excludeFacts, includeFacts) {
 ...
 * }
 */
export function forawaitTransformer_exitSubtree(receiver, ancestorFacts) {
 ...
 * }
 */
export function forawaitTransformer_visitModifiersNoAsync(receiver, modifiers) {
    return NodeVisitor_VisitModifiers(receiver.noAsyncModifierVisitor, modifiers);
}
/**
 ...
 * }
 */
export function forawaitTransformer_doWithHierarchyFacts(receiver, cb, node, excludeFacts, includeFacts) {
 ...
 * }
 */
export function forawaitTransformer_visitDefault(receiver, node) {
 ...
 * }
 */
export function forawaitTransformer_fallbackVisitor(receiver, node) {
 ...
 * }
 */
export function forawaitTransformer_visitFallback(receiver, node) {
 ...
 * }
 */
export function forawaitTransformer_visit(receiver, node) {
    ...
    switch (node.Kind) {
        ...
        case KindForInStatement:
            return forawaitTransformer_doWithHierarchyFacts(receiver, forawaitTransformer_visitDefault, node, forAwaitHierarchyFactsIterationStatementExcludes, forAwaitHierarchyFactsIterationStatementIncludes);
        case KindForOfStatement:
            return forawaitTransformer_visitForOfStatement(receiver, AsForInOrOfStatement(node), undefined);
        case KindForStatement:
            return forawaitTransformer_doWithHierarchyFacts(receiver, forawaitTransformer_visitDefault, node, forAwaitHierarchyFactsIterationStatementExcludes, forAwaitHierarchyFactsIterationStatementIncludes);
        case KindConstructor:
            return forawaitTransformer_doWithHierarchyFacts(receiver, forawaitTransformer_visitConstructorDeclaration, node, forAwaitHierarchyFactsClassOrFunctionExcludes, forAwaitHierarchyFactsClassOrFunctionIncludes);
        case KindMethodDeclaration:
            return forawaitTransformer_doWithHierarchyFacts(receiver, forawaitTransformer_visitMethodDeclaration, node, forAwaitHierarchyFactsClassOrFunctionExcludes, forAwaitHierarchyFactsClassOrFunctionIncludes);
        case KindGetAccessor:
            return forawaitTransformer_doWithHierarchyFacts(receiver, forawaitTransformer_visitGetAccessorDeclaration, node, forAwaitHierarchyFactsClassOrFunctionExcludes, forAwaitHierarchyFactsClassOrFunctionIncludes);
        case KindSetAccessor:
            return forawaitTransformer_doWithHierarchyFacts(receiver, forawaitTransformer_visitSetAccessorDeclaration, node, forAwaitHierarchyFactsClassOrFunctionExcludes, forAwaitHierarchyFactsClassOrFunctionIncludes);
        case KindFunctionDeclaration:
            return forawaitTransformer_doWithHierarchyFacts(receiver, forawaitTransformer_visitFunctionDeclaration, node, forAwaitHierarchyFactsClassOrFunctionExcludes, forAwaitHierarchyFactsClassOrFunctionIncludes);
        case KindFunctionExpression:
            return forawaitTransformer_doWithHierarchyFacts(receiver, forawaitTransformer_visitFunctionExpression, node, forAwaitHierarchyFactsClassOrFunctionExcludes, forAwaitHierarchyFactsClassOrFunctionIncludes);
        case KindArrowFunction:
            return forawaitTransformer_doWithHierarchyFacts(receiver, forawaitTransformer_visitArrowFunction, node, forAwaitHierarchyFactsArrowFunctionExcludes, forAwaitHierarchyFactsArrowFunctionIncludes);
        case KindClassDeclaration:
        case KindClassExpression:
            return forawaitTransformer_doWithHierarchyFacts(receiver, forawaitTransformer_visitDefault, node, forAwaitHierarchyFactsClassOrFunctionExcludes, forAwaitHierarchyFactsClassOrFunctionIncludes);
        default:
            return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
    }
}
 ...
 * }
 */
export function forawaitTransformer_visitAwaitExpression(receiver, node) {
    if ((receiver.enclosingFunctionFlags & FunctionFlagsAsync) !== 0 && (receiver.enclosingFunctionFlags & FunctionFlagsGenerator) !== 0) {
        ...
        const visited = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Expression);
 ...
 * }
 */
export function forawaitTransformer_visitYieldExpression(receiver, node) {
    if ((receiver.enclosingFunctionFlags & FunctionFlagsAsync) !== 0 && (receiver.enclosingFunctionFlags & FunctionFlagsGenerator) !== 0) {
        if (node.AsteriskToken !== undefined) {
            ...
            asyncDelegatorResult.Loc = expression.Loc;
            const factory = printerFactory.__tsgoEmbedded0;
            const innerYield = NodeFactory_UpdateYieldExpression(factory, node, node.AsteriskToken, asyncDelegatorResult);
        ...
        if (node.Expression !== undefined) {
            innerExpression = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Expression);
        }
        else {
 ...
 * }
 */
export function forawaitTransformer_visitReturnStatement(receiver, node) {
    if ((receiver.enclosingFunctionFlags & FunctionFlagsAsync) !== 0 && (receiver.enclosingFunctionFlags & FunctionFlagsGenerator) !== 0) {
        const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
        const factory = printerFactory.__tsgoEmbedded0;
        let expression;
        if (node.Expression !== undefined) {
            expression = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), node.Expression);
        }
        else {
            expression = NodeFactory_NewVoidZeroExpression(printerFactory);
        }
        return NodeFactory_UpdateReturnStatement(factory, node, forawaitTransformer_createDownlevelAwait(receiver, expression));
    }
    return NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node);
}
/**
 ...
 * }
 */
export function forawaitTransformer_visitLabeledStatement(receiver, node) {
    if ((receiver.enclosingFunctionFlags & FunctionFlagsAsync) !== 0) {
        ...
        const visited = NodeVisitor_VisitNode(Transformer_Visitor(receiver.__tsgoEmbedded0), statement);
 ...
 * }
 */
export function forawaitTransformer_visitSourceFile(receiver, node) {
 ...
 * }
 */
export function forawaitTransformer_visitForOfStatement(receiver, node, outermostLabeledStatement) {
    ...
    const result = node.AwaitModifier !== undefined
        ...
        : NodeFactory_RestoreEnclosingLabel(Transformer_Factory(receiver.__tsgoEmbedded0), NodeVisitor_VisitEachChild(Transformer_Visitor(receiver.__tsgoEmbedded0), node), outermostLabeledStatement);
    forawaitTransformer_exitSubtree(receiver, ancestorFacts);
    return result;
}
/**
 ...
 * }
 */
export function forawaitTransformer_convertForOfStatementHead(receiver, node, boundValue, nonUserCode) {
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const factory = printerFactory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    ...
    const binding = NodeFactory_CreateForOfBindingStatement(printerFactory, node.Initializer, value);
    const visitedBinding = NodeVisitor_VisitNode(visitor, binding);
    const statement = NodeVisitor_VisitEmbeddedStatement(visitor, node.Statement);
    const statements = [iteratorValueStatement, exitNonUserCodeStatement, visitedBinding];
 ...
 * }
 */
export function forawaitTransformer_createDownlevelAwait(receiver, expression) {
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const factory = printerFactory.__tsgoEmbedded0;
 ...
 * }
 */
export function forawaitTransformer_transformForAwaitOfStatement(receiver, node, outermostLabeledStatement, ancestorFacts) {
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const factory = printerFactory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    const result = IsIdentifier(expression)
        ? NodeFactory_NewGeneratedNameForNode(printerFactory, iterator)
        : NodeFactory_NewTempVariable(printerFactory);
    ...
    const catchVariable = NodeFactory_NewGeneratedNameForNode(printerFactory, errorRecord);
    ...
    callValues.Loc = node.Expression.Loc;
    const callNext = NewCallExpression(factory, NewPropertyAccessExpression(factory, iterator, undefined, NewIdentifier(factory, "next"), NodeFlagsNone), undefined, undefined, NodeFactory_NewNodeList(factory, []), NodeFlagsNone);
    const getDone = NewPropertyAccessExpression(factory, result, undefined, NewIdentifier(factory, "done"), NodeFlagsNone);
    const getValue = NewPropertyAccessExpression(factory, result, undefined, NewIdentifier(factory, "value"), NodeFlagsNone);
    const callReturn = NodeFactory_NewFunctionCallCall(printerFactory, returnMethod, iterator, []);
    ...
    const initializer = (ancestorFacts & forAwaitHierarchyFactsIterationContainer) !== 0
        ? NodeFactory_InlineExpressions(printerFactory, [
            NodeFactory_NewAssignmentExpression(printerFactory, errorRecord, NodeFactory_NewVoidZeroExpression(printerFactory)),
            callValues,
        ])
        : callValues;
    const iteratorDecl = NewVariableDeclaration(factory, iterator, undefined, undefined, initializer);
    iteratorDecl.Loc = node.Expression.Loc;
    const varDeclList = NewVariableDeclarationList(factory, NodeFactory_NewNodeList(factory, [
        NewVariableDeclaration(factory, nonUserCode, undefined, undefined, NewKeywordExpression(factory, KindTrueKeyword)),
        iteratorDecl,
        NewVariableDeclaration(factory, result, undefined, undefined, undefined),
    ]), NodeFlagsNone);
    varDeclList.Loc = node.Expression.Loc;
    const condition = NodeFactory_InlineExpressions(printerFactory, [
        NodeFactory_NewAssignmentExpression(printerFactory, result, forawaitTransformer_createDownlevelAwait(receiver, callNext)),
        NodeFactory_NewAssignmentExpression(printerFactory, done, getDone),
        NewPrefixUnaryExpression(factory, KindExclamationToken, done),
    ]);
    const incrementor = NodeFactory_NewAssignmentExpression(printerFactory, nonUserCode, NewKeywordExpression(factory, KindTrueKeyword));
    const forStatement = NewForStatement(factory, varDeclList, condition, incrementor, forawaitTransformer_convertForOfStatementHead(receiver, node, getValue, nonUserCode));
    forStatement.Loc = node.Loc;
    EmitContext_AddEmitFlags(emitContext, forStatement, EFNoTokenTrailingSourceMaps);
    EmitContext_SetOriginal(emitContext, forStatement, node);
    const tryBlock = NewBlock(factory, NodeFactory_NewNodeList(factory, [
        NodeFactory_RestoreEnclosingLabel(printerFactory, forStatement, outermostLabeledStatement),
    ]), true);
    const catchBody = NewBlock(factory, NodeFactory_NewNodeList(factory, [
        NewExpressionStatement(factory, NodeFactory_NewAssignmentExpression(printerFactory, errorRecord, NewObjectLiteralExpression(factory, NodeFactory_NewNodeList(factory, [
            NewPropertyAssignment(factory, undefined, NewIdentifier(factory, "error"), undefined, undefined, catchVariable),
        ]), false))),
    ]), false);
    EmitContext_AddEmitFlags(emitContext, catchBody, EFSingleLine);
    const catchClause = NewCatchClause(factory, NewVariableDeclaration(factory, catchVariable, undefined, undefined, undefined), catchBody);
    const innerIfCondition = NewBinaryExpression(factory, undefined, NewBinaryExpression(factory, undefined, NewPrefixUnaryExpression(factory, KindExclamationToken, nonUserCode), undefined, NewToken(factory, KindAmpersandAmpersandToken), NewPrefixUnaryExpression(factory, KindExclamationToken, done)), undefined, NewToken(factory, KindAmpersandAmpersandToken), NodeFactory_NewAssignmentExpression(printerFactory, returnMethod, NewPropertyAccessExpression(factory, iterator, undefined, NewIdentifier(factory, "return"), NodeFlagsNone)));
    const innerIfStatement = NewIfStatement(factory, innerIfCondition, NewExpressionStatement(factory, forawaitTransformer_createDownlevelAwait(receiver, callReturn)), undefined);
    ...
    const innerFinallyIf = NewIfStatement(factory, errorRecord, NewThrowStatement(factory, NewPropertyAccessExpression(factory, errorRecord, undefined, NewIdentifier(factory, "error"), NodeFlagsNone)), undefined);
 ...
 * }
 */
export function forawaitTransformer_visitConstructorDeclaration(receiver, node) {
    ...
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const updated = NodeFactory_UpdateConstructorDeclaration(factory, decl, Node_Modifiers(node), undefined, EmitContext_VisitParameters(emitContext, decl.Parameters, visitor), undefined, undefined, EmitContext_VisitFunctionBody(emitContext, Node_Body(node), visitor));
 ...
 * }
 */
export function forawaitTransformer_visitGetAccessorDeclaration(receiver, node) {
    ...
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const updated = NodeFactory_UpdateGetAccessorDeclaration(factory, decl, Node_Modifiers(node), NodeVisitor_VisitNode(visitor, Node_Name(node)), undefined, EmitContext_VisitParameters(emitContext, decl.Parameters, visitor), undefined, undefined, EmitContext_VisitFunctionBody(emitContext, Node_Body(node), visitor));
    receiver.enclosingFunctionFlags = savedEnclosingFunctionFlags;
    return updated;
}
/**
 ...
 * }
 */
export function forawaitTransformer_visitSetAccessorDeclaration(receiver, node) {
    ...
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const updated = NodeFactory_UpdateSetAccessorDeclaration(factory, decl, Node_Modifiers(node), NodeVisitor_VisitNode(visitor, Node_Name(node)), undefined, EmitContext_VisitParameters(emitContext, decl.Parameters, visitor), undefined, undefined, EmitContext_VisitFunctionBody(emitContext, Node_Body(node), visitor));
    receiver.enclosingFunctionFlags = savedEnclosingFunctionFlags;
    return updated;
}
/**
 ...
 * }
 */
export function forawaitTransformer_visitMethodDeclaration(receiver, node) {
    ...
    const updated = NodeFactory_UpdateMethodDeclaration(factory, decl, modifiers, asteriskToken, NodeVisitor_VisitNode(visitor, Node_Name(node)), undefined, undefined, parameters, undefined, undefined, body);
    receiver.enclosingFunctionFlags = savedEnclosingFunctionFlags;
    return updated;
}
/**
 ...
 * }
 */
export function forawaitTransformer_visitFunctionDeclaration(receiver, node) {
    ...
    const updated = NodeFactory_UpdateFunctionDeclaration(factory, decl, modifiers, asteriskToken, Node_Name(node), undefined, parameters, undefined, undefined, body);
    receiver.enclosingFunctionFlags = savedEnclosingFunctionFlags;
    return updated;
}
/**
 ...
 * }
 */
export function forawaitTransformer_visitArrowFunction(receiver, node) {
    ...
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    const updated = NodeFactory_UpdateArrowFunction(factory, decl, Node_Modifiers(node), undefined, EmitContext_VisitParameters(emitContext, decl.Parameters, visitor), undefined, undefined, decl.EqualsGreaterThanToken, EmitContext_VisitFunctionBody(emitContext, Node_Body(node), visitor));
    receiver.enclosingFunctionFlags = savedEnclosingFunctionFlags;
    return updated;
}
/**
 ...
 * }
 */
export function forawaitTransformer_visitFunctionExpression(receiver, node) {
    ...
    const updated = NodeFactory_UpdateFunctionExpression(factory, decl, modifiers, asteriskToken, decl.name, undefined, parameters, undefined, undefined, body);
    receiver.enclosingFunctionFlags = savedEnclosingFunctionFlags;
    return updated;
}
/**
 ...
 * }
 */
export function forawaitTransformer_transformAsyncGeneratorFunctionParameterList(receiver, node) {
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const factory = printerFactory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    for (const parameter of Node_Parameters(node)) {
        ...
        const newParameter = NewParameterDeclaration(factory, undefined, undefined, NodeFactory_NewGeneratedNameForNodeEx(printerFactory, Node_Name(parameter), { Flags: GeneratedIdentifierFlagsReservedInNestedScopes }), undefined, undefined, undefined);
 ...
 * }
 */
export function forawaitTransformer_transformAsyncGeneratorFunctionBody(receiver, node) {
    const printerFactory = Transformer_Factory(receiver.__tsgoEmbedded0);
    const factory = printerFactory.__tsgoEmbedded0;
    const emitContext = Transformer_EmitContext(receiver.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(receiver.__tsgoEmbedded0);
    ...
    superState.capturedSuperProperties = NewOrderedSetWithSizeHint(0);
    superState.hasSuperElementAccess = false;
    superState.hasSuperPropertyAssignment = false;
    superState.superBinding = NodeFactory_NewUniqueNameEx(printerFactory, "_super", { Flags: GeneratedIdentifierFlagsOptimistic | GeneratedIdentifierFlagsFileLevel });
    superState.superIndexBinding = NodeFactory_NewUniqueNameEx(printerFactory, "_superIndex", { Flags: GeneratedIdentifierFlagsOptimistic | GeneratedIdentifierFlagsFileLevel });
    const body = AsBlock(Node_Body(node));
    let asyncBody = NodeFactory_UpdateBlock(factory, body, NodeVisitor_VisitNodes(visitor, Node_StatementList(body)), body.MultiLine);
    let asyncBodyBlock = AsBlock(asyncBody);
    asyncBody = NodeFactory_UpdateBlock(factory, asyncBodyBlock, EmitContext_EndAndMergeVariableEnvironmentList(emitContext, Node_StatementList(asyncBody)), asyncBodyBlock.MultiLine);
    ...
    const innerParams = innerParameters ?? NodeFactory_NewNodeList(factory, []);
    const name = Node_Name(node) !== undefined ? NodeFactory_NewGeneratedNameForNode(printerFactory, Node_Name(node)) : undefined;
    const generatorFunc = NewFunctionExpression(factory, undefined, NewToken(factory, KindAsteriskToken), name, undefined, innerParams, undefined, undefined, asyncBody);
    const returnStatement = NewReturnStatement(factory, NodeFactory_NewAsyncGeneratorHelper(printerFactory, generatorFunc, (receiver.forAwaitHierarchyFacts & forAwaitHierarchyFactsHasLexicalThis) !== 0));
    ...
    const outerStatements = [returnStatement];
    const block = NodeFactory_UpdateBlock(factory, body, EmitContext_EndAndMergeVariableEnvironmentList(emitContext, NodeFactory_NewNodeList(factory, outerStatements)), body.MultiLine);
...
//# sourceMappingURL=forawait.js.map