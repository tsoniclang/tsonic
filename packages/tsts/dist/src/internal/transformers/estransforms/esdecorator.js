...
import { KindAccessorKeyword, KindAsyncKeyword, KindBinaryExpression, KindBindingElement, KindCallExpression, KindClassDeclaration, KindClassExpression, KindClassStaticBlockDeclaration, KindCommaToken, KindComputedPropertyName, KindConstructor, KindDecorator, KindElementAccessExpression, KindExportAssignment, KindExportKeyword, KindExpressionStatement, KindForStatement, KindFunctionDeclaration, KindFunctionExpression, KindGetAccessor, KindIdentifier, KindMethodDeclaration, KindNullKeyword, KindParameter, KindParenthesizedExpression, KindPartiallyEmittedExpression, KindPostfixUnaryExpression, KindPrefixUnaryExpression, KindPropertyAccessExpression, KindPropertyAssignment, KindPropertyDeclaration, KindSetAccessor, KindSourceFile, KindStaticKeyword, KindThisKeyword, KindVariableDeclaration, KindQuestionToken, KindColonToken, KindQuestionQuestionToken, KindPlusPlusToken, KindMinusMinusToken, KindExtendsKeyword, KindSuperKeyword, KindNumericLiteral, KindBigIntLiteral, KindStringLiteral, KindEqualsToken, KindTaggedTemplateExpression, } from "../../ast/generated/kinds.js";
import { IsClassStaticBlockDeclaration, IsComputedPropertyName, IsGetAccessorDeclaration, IsIdentifier, IsPrivateIdentifier, IsPropertyDeclaration, IsSetAccessorDeclaration, IsArrowFunction, IsSpreadElement, IsSpreadAssignment, IsPropertyAssignment, IsShorthandPropertyAssignment, IsOmittedExpression, IsClassDeclaration, IsConstructorDeclaration, IsStringLiteral, IsPostfixUnaryExpression, IsPrefixUnaryExpression, IsClassExpression, IsFunctionExpression, IsElementAccessExpression, IsPropertyAccessExpression, IsObjectLiteralExpression, IsArrayLiteralExpression, IsMethodDeclaration, IsParenthesizedExpression, IsTryStatement, } from "../../ast/generated/predicates.js";
import { IsAccessExpression, IsArrayBindingOrAssignmentElement, IsAssignmentExpression, IsAutoAccessorPropertyDeclaration, IsClassLike, IsCompoundAssignment, IsDestructuringAssignment, IsLeftHandSideExpression, IsMethodOrAccessor, IsObjectBindingOrAssignmentElement, IsPrivateIdentifierClassElementDeclaration, IsPropertyNameLiteral, IsStatic, IsSuperProperty, HasAccessorModifier, HasDecorators, HasStaticModifier, HasSyntacticModifier, OEKAll, SkipOuterExpressions, SkipParentheses, GetHeritageClause, GetFirstConstructorWithBody, ClassOrConstructorParameterIsDecorated, NodeOrChildIsDecorated, ChildIsDecorated, NodeIsDecorated, } from "../../ast/utilities.js";
...
import { NewBlock, NewArrayLiteralExpression, NewBinaryExpression, NewCallExpression, NewClassDeclaration, NewClassExpression, NewClassStaticBlockDeclaration, NewConditionalExpression, NewConstructorDeclaration, NewElementAccessExpression, NewExpressionStatement, NewFunctionExpression, NewGetAccessorDeclaration, NewIdentifier as NewAstIdentifier, NewIfStatement, NewKeywordExpression, NewObjectLiteralExpression, NewParameterDeclaration, NewPropertyAccessExpression, NewPropertyAssignment, NewReturnStatement, NewSetAccessorDeclaration, NewSpreadElement, NewStringLiteral, NewNumericLiteral, NewToken, NewVariableDeclaration, NewVariableDeclarationList, NewVariableStatement, } from "../../ast/generated/factory.js";
...
import { EmitContext_AddEmitFlags, EmitContext_AddEmitHelper, EmitContext_AddVariableDeclaration, EmitContext_AssignCommentRange, EmitContext_AssignedName, EmitContext_ClassThis, EmitContext_CommentRange, EmitContext_EmitFlags, EmitContext_EndVariableEnvironment, EmitContext_HasAutoGenerateInfo, EmitContext_MergeEnvironment, EmitContext_MostOriginal, EmitContext_NewNodeVisitor, EmitContext_ReadEmitHelpers, EmitContext_SetAssignedName, EmitContext_SetClassThis, EmitContext_SetCommentRange, EmitContext_SetEmitFlags, EmitContext_SetOriginal, EmitContext_SetSourceMapRange, EmitContext_SourceMapRange, EmitContext_StartVariableEnvironment, EmitContext_VisitIterationBody, } from "../../printer/emitcontext.js";
...
import { NodeFactory_GetDeclarationName, NodeFactory_GetLocalName, NodeFactory_GetLocalNameEx, NodeFactory_InlineExpressions, NodeFactory_NewAssignmentExpression, NodeFactory_NewAssignmentTargetWrapper, NodeFactory_NewCommaExpression, NodeFactory_NewESDecorateClassContextObject, NodeFactory_NewESDecorateClassElementContextObject, NodeFactory_NewESDecorateHelper, NodeFactory_NewGeneratedNameForNode, NodeFactory_NewGeneratedPrivateNameForNodeEx, NodeFactory_NewLogicalANDExpression, NodeFactory_NewPropKeyHelper, NodeFactory_NewReflectGetCall, NodeFactory_NewReflectSetCall, NodeFactory_NewRunInitializersHelper, NodeFactory_NewSetFunctionNameHelper, NodeFactory_NewStringLiteralFromNode, NodeFactory_NewTempVariable, NodeFactory_NewThisExpression, NodeFactory_NewTrueExpression, NodeFactory_NewTypeCheck, NodeFactory_NewUniqueNameEx, NodeFactory_NewVoidZeroExpression, NodeFactory_SplitStandardPrologue, NodeFactory_NewFunctionBindCall, NodeFactory_NewFunctionCallCall, NodeFactory_NewImmediatelyInvokedArrowFunction, NodeFactory_RestoreOuterExpressions, NodeFactory_NewExportDefault, NodeFactory_NewExternalModuleExport, } from "../../printer/factory.js";
import { EFTransformPrivateStaticElements, EFSingleLine, EFNoLeadingComments, EFNoComments, EFHelperName, EFNoTrailingSourceMap, } from "../../printer/emitflags.js";
import { NodeVisitor_VisitEachChild, NodeVisitor_VisitNode, NodeVisitor_VisitNodes, NodeVisitor_VisitModifiers, NodeVisitor_VisitSlice, NodeVisitor_VisitSourceFile, } from "../../ast/visitor.js";
import { FindSuperStatementIndexPath, IsGeneratedIdentifier, IsSimpleInlineableExpression, MoveRangePastDecorators, MoveRangePastModifiers, SingleOrMany, GetNonAssignmentOperatorForCompoundAssignment, } from "../utilities.js";
import { Transformer_EmitContext, Transformer_Factory, Transformer_NewTransformer, Transformer_Visitor } from "../transformer.js";
import { classHasClassThisAssignment, findComputedPropertyNameCacheAssignment, expandPreOrPostfixIncrementOrDecrementExpression, } from "./classfields.js";
import { classHasDeclaredOrExplicitlyAssignedName, isClassNamedEvaluationHelperBlock, injectClassNamedEvaluationHelperBlockIfMissing, isNamedEvaluationAnd, transformNamedEvaluation, } from "./namedevaluation.js";
 ...
 * )
 */
export const lexicalEntryKindClass = 0;
export const lexicalEntryKindClassElement = 1;
export const lexicalEntryKindName = 2;
export const lexicalEntryKindOther = 3;
/**
 ...
 * }
 */
export function newESDecoratorTransformer(opts) {
 ...
 * }
 */
export function esDecoratorTransformer_updateState(receiver) {
 ...
 * }
 */
export function esDecoratorTransformer_enterClass(receiver, ci) {
    receiver.top = {
        kind: lexicalEntryKindClass,
        next: receiver.top,
        classInfoData: ci,
 ...
 * }
 */
export function esDecoratorTransformer_exitClass(receiver) {
 ...
 * }
 */
export function esDecoratorTransformer_enterClassElement(receiver, node) {
    receiver.top = {
        kind: lexicalEntryKindClassElement,
        next: receiver.top,
 ...
 * }
 */
export function esDecoratorTransformer_exitClassElement(receiver) {
    receiver.top = receiver.top.next;
    esDecoratorTransformer_updateState(receiver);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_enterName(receiver) {
    receiver.top = {
        kind: lexicalEntryKindName,
        next: receiver.top,
        classInfoData: undefined,
 ...
 * }
 */
export function esDecoratorTransformer_exitName(receiver) {
    receiver.top = receiver.top.next;
    esDecoratorTransformer_updateState(receiver);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_enterOther(receiver) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_exitOther(receiver) {
    const tx = receiver;
    if ((tx.top?.depth ?? 0) > 0) {
 ...
 * }
 */
export function esDecoratorTransformer_visitSourceFile(receiver, node) {
    const tx = receiver;
    tx.top = undefined;
    tx.shouldTransformPrivateStaticElementsInFile = false;
    const visited = NodeVisitor_VisitEachChild(Transformer_Visitor(tx.__tsgoEmbedded0), node);
 ...
 * }
 */
export function esDecoratorTransformer_outerThisVisit(receiver, n) {
    const tx = receiver;
    ...
    if (n.Kind === KindThisKeyword) {
        if (tx.outerThis === undefined) {
            tx.outerThis = NodeFactory_NewUniqueNameEx(Transformer_Factory(tx.__tsgoEmbedded0), "_outerThis", { Flags: GeneratedIdentifierFlagsOptimistic, Prefix: "", Suffix: "" });
        }
        return tx.outerThis;
    }
    return NodeVisitor_VisitEachChild(tx.outerThisVisitor, n);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_shouldVisitNode(receiver, node) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_visit(receiver, node) {
    const tx = receiver;
    ...
    switch (node.Kind) {
        ...
        case KindFunctionDeclaration: {
            ...
            const result = NodeVisitor_VisitEachChild(Transformer_Visitor(tx.__tsgoEmbedded0), node);
            esDecoratorTransformer_exitOther(tx);
            return result;
        }
        default:
            return NodeVisitor_VisitEachChild(Transformer_Visitor(tx.__tsgoEmbedded0), node);
    }
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_modifierVisitorVisit(receiver, node) {
 ...
 * }
 */
export function esDecoratorTransformer_classElementVisitorVisit(receiver, node) {
    const tx = receiver;
    switch (node.Kind) {
        case KindConstructor:
 ...
 * }
 */
export function esDecoratorTransformer_discardedValueVisit(receiver, node) {
    const tx = receiver;
    switch (node.Kind) {
        case KindPrefixUnaryExpression:
        case KindPostfixUnaryExpression:
 ...
 * }
 */
export function esDecoratorTransformer_nonConstructorClassElementVisit(receiver, node) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_constructorClassElementVisit(receiver, node) {
    const tx = receiver;
    if (IsConstructorDeclaration(node)) {
        return esDecoratorTransformer_classElementVisitorVisit(tx, node);
    }
 ...
 * }
 */
export function esDecoratorTransformer_exportStrippingModifierVisit(receiver, node) {
    const tx = receiver;
 ...
 * }
 */
export function getHelperVariableName(ec, node) {
 ...
 * }
 */
export function esDecoratorTransformer_createHelperVariable(receiver, node, suffix) {
    const tx = receiver;
    return NodeFactory_NewUniqueNameEx(Transformer_Factory(tx.__tsgoEmbedded0), getHelperVariableName(Transformer_EmitContext(tx.__tsgoEmbedded0), node) + "_" + suffix, { Flags: GeneratedIdentifierFlagsOptimistic | GeneratedIdentifierFlagsReservedInNestedScopes, Prefix: "", Suffix: "" });
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_createLet(receiver, name, initializer) {
    const tx = receiver;
    const factory = Transformer_Factory(tx.__tsgoEmbedded0).__tsgoEmbedded0;
    const varDecl = NewVariableDeclaration(factory, name, undefined, undefined, initializer);
    const declList = NewVariableDeclarationList(factory, NodeFactory_NewNodeList(factory, [varDecl]), NodeFlagsLet);
    return NewVariableStatement(factory, undefined, declList);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_createClassInfo(receiver, node) {
    const tx = receiver;
    ...
    if (NodeIsDecorated(false, node, undefined, undefined)) {
        const needsUniqueClassThis = Some(Node_Members(node) ?? [], (member) => (IsPrivateIdentifierClassElementDeclaration(member) || IsAutoAccessorPropertyDeclaration(member)) && HasStaticModifier(member));
 ...
 * }
 */
export function esDecoratorTransformer_transformClassLike(receiver, node) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    ...
    if (!classHasDeclaredOrExplicitlyAssignedName(ec, node) && ClassOrConstructorParameterIsDecorated(false, node)) {
        node = injectClassNamedEvaluationHelperBlockIfMissing(ec, node, NewStringLiteral(factory, "", 0), undefined);
    }
    const classReference = NodeFactory_GetLocalNameEx(f, node, {});
    ...
    if (classDecorators.length > 0) {
        ...
        const decoratorsArray = NewArrayLiteralExpression(factory, NodeFactory_NewNodeList(factory, classDecorators), false);
        classDefinitionStatements.push(esDecoratorTransformer_createLet(tx, ci.classDecoratorsName, decoratorsArray), esDecoratorTransformer_createLet(tx, ci.classDescriptorName, undefined), esDecoratorTransformer_createLet(tx, ci.classExtraInitializersName, NewArrayLiteralExpression(factory, NodeFactory_NewNodeList(factory, []), false)), esDecoratorTransformer_createLet(tx, ci.classThis, undefined));
    ...
    let extendsExpression = undefined;
    if (extendsElement !== undefined) {
        extendsExpression = NodeVisitor_VisitNode(visitor, AsExpressionWithTypeArguments(extendsElement).Expression);
    }
    if (extendsExpression !== undefined) {
        ci.classSuper = NodeFactory_NewUniqueNameEx(f, "_classSuper", {
            Flags: GeneratedIdentifierFlagsOptimistic | GeneratedIdentifierFlagsFileLevel,
        });
        const unwrapped = SkipOuterExpressions(extendsExpression, OEKAll);
        let safeExtendsExpression = extendsExpression;
        if ((IsClassExpression(unwrapped) && Node_Name(unwrapped) === undefined) ||
            ...
            safeExtendsExpression = NodeFactory_NewCommaExpression(f, NewNumericLiteral(factory, "0", 0), extendsExpression);
        }
        classDefinitionStatements.push(esDecoratorTransformer_createLet(tx, ci.classSuper, safeExtendsExpression));
        const updatedExtendsElement = NodeFactory_UpdateExpressionWithTypeArguments(factory, AsExpressionWithTypeArguments(extendsElement), ci.classSuper, undefined);
        const hc = AsHeritageClause(extendsClause);
        const updatedExtendsClause = NodeFactory_UpdateHeritageClause(factory, hc, hc.Token, NodeFactory_NewNodeList(factory, [updatedExtendsElement]));
        heritageClauses = NodeFactory_NewNodeList(factory, [updatedExtendsClause]);
    }
    const renamedClassThis = ci.classThis !== undefined
        ? ci.classThis
    ...
    let members = NodeVisitor_VisitNodes(tx.nonConstructorClassElementVisitor, Node_MemberList(node));
    members = NodeVisitor_VisitNodes(tx.constructorClassElementVisitor, members);
    if (tx.pendingExpressions.length > 0) {
        tx.outerThis = undefined;
        for (let expr of tx.pendingExpressions) {
            if ((Node_SubtreeFacts(expr) & SubtreeContainsLexicalThis) !== 0) {
                expr = NodeVisitor_VisitNode(tx.outerThisVisitor, expr);
            }
            leadingBlockStatements.push(NewExpressionStatement(factory, expr));
        }
        if (tx.outerThis !== undefined) {
    ...
    if (ci.pendingInstanceInitializers.length > 0 && GetFirstConstructorWithBody(node) === undefined) {
        ...
        if (initializerStatements.length > 0) {
            const isDerivedClass = extendsElement !== undefined &&
                SkipOuterExpressions(AsExpressionWithTypeArguments(extendsElement).Expression, OEKAll).Kind !== KindNullKeyword;
            const constructorStatements = [];
            if (isDerivedClass) {
                const spreadArguments = NewSpreadElement(factory, NewAstIdentifier(factory, "arguments"));
                const superCall = NewCallExpression(factory, NewKeywordExpression(factory, KindSuperKeyword), undefined, undefined, NodeFactory_NewNodeList(factory, [spreadArguments]), NodeFlagsNone);
                constructorStatements.push(NewExpressionStatement(factory, superCall));
            }
            constructorStatements.push(...initializerStatements);
            const constructorBody = NewBlock(factory, NodeFactory_NewNodeList(factory, constructorStatements), true);
            syntheticConstructor = NewConstructorDeclaration(factory, undefined, undefined, NodeFactory_NewNodeList(factory, []), undefined, undefined, constructorBody);
        }
    }
    if (ci.staticMethodExtraInitializersName !== undefined) {
        classDefinitionStatements.push(esDecoratorTransformer_createLet(tx, ci.staticMethodExtraInitializersName, NewArrayLiteralExpression(factory, NodeFactory_NewNodeList(factory, []), false)));
    }
    if (ci.instanceMethodExtraInitializersName !== undefined) {
        classDefinitionStatements.push(esDecoratorTransformer_createLet(tx, ci.instanceMethodExtraInitializersName, NewArrayLiteralExpression(factory, NodeFactory_NewNodeList(factory, []), false)));
    }
    ...
    if (ci.classDescriptorName !== undefined && ci.classDecoratorsName !== undefined && ci.classExtraInitializersName !== undefined && ci.classThis !== undefined) {
        ...
        const classDescriptor = NewObjectLiteralExpression(factory, NodeFactory_NewNodeList(factory, [valueProperty]), false);
        const classDescriptorAssignment = NodeFactory_NewAssignmentExpression(f, ci.classDescriptorName, classDescriptor);
        const classNameReference = NewPropertyAccessExpression(factory, renamedClassThis, undefined, NewAstIdentifier(factory, "name"), NodeFlagsNone);
        const contextObj = NodeFactory_NewESDecorateClassContextObject(f, classNameReference, ci.metadataReference);
        const esDecorateHelper = NodeFactory_NewESDecorateHelper(f, NewToken(factory, KindNullKeyword), classDescriptorAssignment, ci.classDecoratorsName, contextObj, NewToken(factory, KindNullKeyword), ci.classExtraInitializersName);
        const esDecorateStatement = NewExpressionStatement(factory, esDecorateHelper);
        ...
        const classDescriptorValueRef = NewPropertyAccessExpression(factory, ci.classDescriptorName, undefined, NewAstIdentifier(factory, "value"), NodeFlagsNone);
        const classThisAssignment = NodeFactory_NewAssignmentExpression(f, ci.classThis, classDescriptorValueRef);
        const classReferenceAssignment = NodeFactory_NewAssignmentExpression(f, classReference, classThisAssignment);
        leadingBlockStatements.push(NewExpressionStatement(factory, classReferenceAssignment));
    }
    ...
    if (ci.pendingStaticInitializers.length > 0) {
        for (const initializer of ci.pendingStaticInitializers) {
            const initializerStatement = NewExpressionStatement(factory, initializer);
            EmitContext_SetSourceMapRange(ec, initializerStatement, EmitContext_SourceMapRange(ec, initializer));
            trailingBlockStatements.push(initializerStatement);
        }
        ci.pendingStaticInitializers = [];
    }
    if (ci.classExtraInitializersName !== undefined) {
        const runClassInitializersHelper = NodeFactory_NewRunInitializersHelper(f, renamedClassThis, ci.classExtraInitializersName, undefined);
        const runClassInitializersStatement = NewExpressionStatement(factory, runClassInitializersHelper);
    ...
    let leadingStaticBlock = undefined;
    if (leadingBlockStatements.length > 0) {
        leadingStaticBlock = NewClassStaticBlockDeclaration(factory, undefined, NewBlock(factory, NodeFactory_NewNodeList(factory, leadingBlockStatements), true));
    }
    ...
    let trailingStaticBlock = undefined;
    if (trailingBlockStatements.length > 0) {
        trailingStaticBlock = NewClassStaticBlockDeclaration(factory, undefined, NewBlock(factory, NodeFactory_NewNodeList(factory, trailingBlockStatements), true));
    }
    ...
    let classExpression;
    if (classDecorators.length > 0) {
        classExpression = NewClassExpression(factory, undefined, undefined, undefined, heritageClauses, members);
        EmitContext_SetOriginal(ec, classExpression, node);
        if (ci.classThis !== undefined) {
            classExpression = injectClassThisAssignmentIfMissing(ec, f, classExpression, ci.classThis);
        }
        const classReferenceDeclaration = NewVariableDeclaration(factory, classReference, undefined, undefined, classExpression);
        const classReferenceVarDeclList = NewVariableDeclarationList(factory, NodeFactory_NewNodeList(factory, [classReferenceDeclaration]), NodeFlagsNone);
        const returnExpr = ci.classThis !== undefined
            ? NodeFactory_NewAssignmentExpression(f, classReference, ci.classThis)
            : classReference;
        classDefinitionStatements.push(NewVariableStatement(factory, undefined, classReferenceVarDeclList), NewReturnStatement(factory, returnExpr));
    }
    else {
        classExpression = NewClassExpression(factory, undefined, Node_Name(node), undefined, heritageClauses, members);
        EmitContext_SetOriginal(ec, classExpression, node);
        classDefinitionStatements.push(NewReturnStatement(factory, classExpression));
    }
    if (shouldTransformPrivateStaticElementsInClass) {
 ...
 * }
 */
export function esDecoratorTransformer_emitMemberInfoDeclarations(receiver, ci, isStatic) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const factory = f.__tsgoEmbedded0;
    const stmts = [];
    OrderedMap_Entries(ci.memberInfos)((member, mi) => {
        ...
        if (mi.memberInitializersName !== undefined) {
            stmts.push(esDecoratorTransformer_createLet(tx, mi.memberInitializersName, NewArrayLiteralExpression(factory, NodeFactory_NewNodeList(factory, []), false)));
        }
        if (mi.memberExtraInitializersName !== undefined) {
            stmts.push(esDecoratorTransformer_createLet(tx, mi.memberExtraInitializersName, NewArrayLiteralExpression(factory, NodeFactory_NewNodeList(factory, []), false)));
        }
 ...
 * }
 */
export function isDecoratedClassLike(node) {
 ...
 * }
 */
export function esDecoratorTransformer_visitClassDeclaration(receiver, node) {
    const tx = receiver;
    ...
    if (isDecoratedClassLike(nodeAsNode)) {
        ...
        if (Node_Name(originalClass) !== undefined) {
            className = NodeFactory_NewStringLiteralFromNode(f, Node_Name(originalClass));
        }
        else {
            className = NewStringLiteral(astFactory, "default", 0);
        }
        ...
        if (isExport && isDefault) {
            ...
            if (Node_Name(classNode) !== undefined) {
                const varDecl = NewVariableDeclaration(astFactory, NodeFactory_GetLocalName(f, classNode), undefined, undefined, iife);
                EmitContext_SetOriginal(ec, varDecl, classNode);
                const varDecls = NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [varDecl]), NodeFlagsLet);
                const varStatement = NewVariableStatement(astFactory, undefined, varDecls);
                statements = [...statements, varStatement];
                const exportStatement = NodeFactory_NewExportDefault(f, NodeFactory_GetDeclarationName(f, classNode));
                ...
                statements = [...statements, exportStatement];
            }
            else {
                const exportStatement = NodeFactory_NewExportDefault(f, iife);
                EmitContext_SetOriginal(ec, exportStatement, classNode);
                EmitContext_AssignCommentRange(ec, exportStatement, classNode);
                EmitContext_SetSourceMapRange(ec, exportStatement, MoveRangePastDecorators(classNode));
                statements = [...statements, exportStatement];
            ...
            const iife = esDecoratorTransformer_transformClassLike(tx, classNode);
            const modifiers = NodeVisitor_VisitModifiers(tx.exportStrippingModifierVisitor, Node_Modifiers(classNode));
            const declName = NodeFactory_GetLocalNameEx(f, classNode, { AllowSourceMaps: true });
            const varDecl = NewVariableDeclaration(astFactory, declName, undefined, undefined, iife);
            EmitContext_SetOriginal(ec, varDecl, classNode);
            const varDecls = NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [varDecl]), NodeFlagsLet);
            ...
            statements = [...statements, varStatement];
            if (isExport) {
                const exportStatement = NodeFactory_NewExternalModuleExport(f, declName);
                EmitContext_SetOriginal(ec, exportStatement, classNode);
                statements = [...statements, exportStatement];
            }
        }
    ...
    // Non-decorated class
    const modifiers = NodeVisitor_VisitModifiers(tx.modifierVisitor, Node_Modifiers(nodeAsNode));
    const heritageClauses = NodeVisitor_VisitNodes(visitor, node.HeritageClauses);
    esDecoratorTransformer_enterClass(tx, undefined);
    const members = NodeVisitor_VisitNodes(tx.classElementVisitor, node.Members);
    esDecoratorTransformer_exitClass(tx);
    return NodeFactory_UpdateClassDeclaration(astFactory, node, modifiers, node.name, undefined, heritageClauses, members);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitClassExpression(receiver, node) {
    const tx = receiver;
    const nodeAsNode = node;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    ...
    const members = NodeVisitor_VisitNodes(tx.classElementVisitor, node.Members);
    esDecoratorTransformer_exitClass(tx);
    return NodeFactory_UpdateClassExpression(astFactory, node, modifiers, node.name, undefined, heritageClauses, members);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_prepareConstructor(receiver, ci) {
    const tx = receiver;
    ...
    const stmt = NewExpressionStatement(factory, inlined);
 ...
 * }
 */
export function esDecoratorTransformer_transformConstructorBodyWorker(receiver, statementsOut, statementsIn, statementOffset, superPath, superPathDepth, initializerStatements) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    ...
    if (superStatementIndex > statementOffset) {
        for (const s of statementsIn.slice(statementOffset, superStatementIndex)) {
            out = [...out, NodeVisitor_VisitNode(visitor, s)];
        }
    }
    ...
    if (IsTryStatement(superStatement)) {
        ...
        const tryBlockStatements = esDecoratorTransformer_transformConstructorBodyWorker(tx, [], tryBlock.Statements.Nodes, 0, superPath, superPathDepth + 1, initializerStatements);
        const newTryBlock = NodeFactory_NewNodeList(astFactory, tryBlockStatements);
        const newTryBlockNode = NewBlock(astFactory, newTryBlock, true);
        newTryBlockNode.Loc = tryBlockNode.Loc;
        let catchClause = undefined;
        if (tryStmt.CatchClause !== undefined) {
            catchClause = NodeVisitor_VisitNode(visitor, tryStmt.CatchClause);
        }
        let finallyBlock = undefined;
        if (tryStmt.FinallyBlock !== undefined) {
            finallyBlock = NodeVisitor_VisitNode(visitor, tryStmt.FinallyBlock);
        }
        const updated = NodeFactory_UpdateTryStatement(astFactory, tryStmt, newTryBlockNode, catchClause, finallyBlock);
        out = [...out, updated];
    }
    else {
        out = [...out, NodeVisitor_VisitNode(visitor, superStatement)];
 ...
 * }
 */
export function esDecoratorTransformer_visitConstructorDeclaration(receiver, node) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    ...
    const modifiers = NodeVisitor_VisitModifiers(tx.modifierVisitor, Node_Modifiers(node));
    ...
    if (ctor.Body !== undefined && tx.classInfoStack !== undefined) {
        ...
        if (initializerStatements.length > 0) {
            let stmts = [];
            const [prologue, rest] = NodeFactory_SplitStandardPrologue(f, AsBlock(ctor.Body).Statements.Nodes);
            ...
            body = NewBlock(astFactory, NodeFactory_NewNodeList(astFactory, stmts), true);
            EmitContext_SetOriginal(ec, body, ctor.Body);
            body.Loc = ctor.Body.Loc;
        }
    }
    if (body === undefined) {
        body = NodeVisitor_VisitNode(visitor, ctor.Body);
    }
    esDecoratorTransformer_exitClassElement(tx);
    return NodeFactory_UpdateConstructorDeclaration(astFactory, ctor, modifiers, undefined, parameters, undefined, undefined, body);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_finishClassElement(receiver, updated, original) {
    const tx = receiver;
    if (updated !== original) {
        const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
 ...
 * }
 */
export function esDecoratorTransformer_partialTransformClassElement(receiver, member, ci, createDescriptor) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    if (ci === undefined) {
        const modifiers = NodeVisitor_VisitModifiers(tx.modifierVisitor, Node_Modifiers(member));
    ...
    tx.classThis = savedClassThis;
    const modifiers = NodeVisitor_VisitModifiers(tx.modifierVisitor, Node_Modifiers(member));
    const result = { modifiers, referencedName: undefined, name: undefined, initializersName: undefined, extraInitializersName: undefined, descriptorName: undefined, thisArg: undefined };
    if (memberDecorators.length > 0) {
        const memberDecoratorsName = esDecoratorTransformer_createHelperVariable(tx, member, "decorators");
        const memberDecoratorsArray = NewArrayLiteralExpression(astFactory, NodeFactory_NewNodeList(astFactory, memberDecorators), false);
        const memberDecoratorsAssignment = NodeFactory_NewAssignmentExpression(f, memberDecoratorsName, memberDecoratorsArray);
        const mi = { memberDecoratorsName, memberInitializersName: undefined, memberExtraInitializersName: undefined, memberDescriptorName: undefined };
        ...
        const contextObj = NodeFactory_NewESDecorateClassElementContextObject(f, kind, propertyNameComputed, propertyNameExpr, IsStatic(member), memberName !== undefined && IsPrivateIdentifier(memberName), IsPropertyDeclaration(member) || IsGetAccessorDeclaration(member) || IsMethodDeclaration(member), IsPropertyDeclaration(member) || IsSetAccessorDeclaration(member), ci.metadataReference);
        if (IsMethodOrAccessor(member)) {
            ...
            if (IsPrivateIdentifierClassElementDeclaration(member) && createDescriptor !== undefined) {
                const asyncMods = NodeVisitor_VisitModifiers(tx.asyncOnlyModifierVisitor, modifiers);
                ...
                result.descriptorName = mi.memberDescriptorName;
                descriptorArg = NodeFactory_NewAssignmentExpression(f, mi.memberDescriptorName, descriptor);
            }
            else {
                descriptorArg = NewToken(astFactory, KindNullKeyword);
            }
            const esDecorateExpr = NodeFactory_NewESDecorateHelper(f, NodeFactory_NewThisExpression(f), descriptorArg, memberDecoratorsName, contextObj, NewToken(astFactory, KindNullKeyword), methodExtraInitializersName);
            const esDecorateStatement = NewExpressionStatement(astFactory, esDecorateExpr);
            ...
            const ctorArg = IsAutoAccessorPropertyDeclaration(member) ? NodeFactory_NewThisExpression(f) : NewToken(astFactory, KindNullKeyword);
            let descriptorArg;
            ...
            const esDecorateExpr = NodeFactory_NewESDecorateHelper(f, ctorArg, descriptorArg, memberDecoratorsName, contextObj, mi.memberInitializersName, mi.memberExtraInitializersName);
            const esDecorateStatement = NewExpressionStatement(astFactory, esDecorateExpr);
            EmitContext_SetSourceMapRange(ec, esDecorateStatement, MoveRangePastDecorators(member));
            esDecoratorTransformer_appendDecorationStatement(tx, ci, member, esDecorateStatement);
        }
 ...
 * }
 */
export function esDecoratorTransformer_appendDecorationStatement(receiver, ci, member, stmt) {
 ...
 * }
 */
export function esDecoratorTransformer_visitMethodDeclaration(receiver, node) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const factory = f.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    ...
    return esDecoratorTransformer_finishClassElement(tx, NodeFactory_UpdateMethodDeclaration(factory, method, result.modifiers, method.AsteriskToken, result.name, undefined, undefined, parameters, undefined, undefined, body), node);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitGetAccessorDeclaration(receiver, node) {
    const tx = receiver;
    const factory = Transformer_Factory(tx.__tsgoEmbedded0).__tsgoEmbedded0;
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    esDecoratorTransformer_enterClassElement(tx, node);
    ...
    return esDecoratorTransformer_finishClassElement(tx, NodeFactory_UpdateGetAccessorDeclaration(factory, accessor, result.modifiers, result.name, undefined, parameters, undefined, undefined, body), node);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitSetAccessorDeclaration(receiver, node) {
    const tx = receiver;
    const factory = Transformer_Factory(tx.__tsgoEmbedded0).__tsgoEmbedded0;
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    esDecoratorTransformer_enterClassElement(tx, node);
    ...
    return esDecoratorTransformer_finishClassElement(tx, NodeFactory_UpdateSetAccessorDeclaration(factory, accessor, result.modifiers, result.name, undefined, parameters, undefined, undefined, body), node);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitClassStaticBlockDeclaration(receiver, node) {
    const tx = receiver;
    esDecoratorTransformer_enterClassElement(tx, node);
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const factory = f.__tsgoEmbedded0;
    ...
    if (isClassNamedEvaluationHelperBlock(ec, node)) {
        ...
        if ((varStatements ?? []).length > 0) {
            ...
            result = NewClassStaticBlockDeclaration(factory, undefined, NewBlock(factory, NodeFactory_NewNodeList(factory, newStmts), blockBody.MultiLine));
        }
        if (tx.classInfoStack !== undefined) {
            ...
            if ((tx.classInfoStack.pendingStaticInitializers ?? []).length > 0) {
                ...
                for (const init of tx.classInfoStack.pendingStaticInitializers) {
                    const initStmt = NewExpressionStatement(factory, init);
                    EmitContext_SetSourceMapRange(ec, initStmt, EmitContext_SourceMapRange(ec, init));
                    stmts.push(initStmt);
                }
                const body = NewBlock(factory, NodeFactory_NewNodeList(factory, stmts), true);
                const staticBlock = NewClassStaticBlockDeclaration(factory, undefined, body);
 ...
 * }
 */
export function esDecoratorTransformer_visitPropertyDeclaration(receiver, node) {
    const tx = receiver;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    ...
    if (isNamedEvaluationAnd(ec, node, isAnonymousClassNeedingAssignedName)) {
        node = transformNamedEvaluation(ec, node, canIgnoreEmptyStringLiteralInAssignedName(Node_Initializer(node)), "");
    }
    esDecoratorTransformer_enterClassElement(tx, node);
    let createDescriptor = undefined;
    ...
    EmitContext_StartVariableEnvironment(ec);
    let initializer = NodeVisitor_VisitNode(visitor, Node_Initializer(node));
    if (result.initializersName !== undefined) {
        ...
        if (result.thisArg !== undefined) {
            ...
            thisArg = NodeFactory_NewThisExpression(f);
        }
        if (initializer === undefined) {
            initializer = NodeFactory_NewVoidZeroExpression(f);
        }
        initializer = NodeFactory_NewRunInitializersHelper(f, thisArg, result.initializersName, initializer);
    }
    ...
    if (declarations.length > 0) {
        const stmts = [
            ...declarations,
            NewReturnStatement(astFactory, initializer),
        ];
        initializer = NodeFactory_NewImmediatelyInvokedArrowFunction(f, stmts);
    }
    if (tx.classInfoStack !== undefined) {
        if (IsStatic(node)) {
            ...
            if (result.extraInitializersName !== undefined) {
                ...
                tx.classInfoStack.pendingStaticInitializers = [
                    ...(tx.classInfoStack.pendingStaticInitializers ?? []),
                    NodeFactory_NewRunInitializersHelper(f, thisArg, result.extraInitializersName, undefined),
                ];
            }
        }
        else {
            ...
            if (result.extraInitializersName !== undefined) {
                tx.classInfoStack.pendingInstanceInitializers = [
                    ...(tx.classInfoStack.pendingInstanceInitializers ?? []),
                    NodeFactory_NewRunInitializersHelper(f, NodeFactory_NewThisExpression(f), result.extraInitializersName, undefined),
                ];
            }
        }
    }
    ...
    if (HasAccessorModifier(node) && result.descriptorName !== undefined) {
        ...
        let getterName = result.name;
        let setterName = result.name;
        if (IsComputedPropertyName(propName) && !IsSimpleInlineableExpression(AsComputedPropertyName(propName).Expression)) {
            const cpn = AsComputedPropertyName(propName);
            const cacheAssignment = findComputedPropertyNameCacheAssignment(ec, propName);
            if (cacheAssignment !== undefined) {
                getterName = NodeFactory_UpdateComputedPropertyName(astFactory, cpn, NodeVisitor_VisitNode(visitor, cpn.Expression));
                setterName = NodeFactory_UpdateComputedPropertyName(astFactory, cpn, cacheAssignment.Left);
            }
            else {
                const temp = NodeFactory_NewTempVariable(f);
                EmitContext_SetSourceMapRange(ec, temp, cpn.Expression.Loc);
                EmitContext_AddVariableDeclaration(ec, temp);
                const expression = NodeVisitor_VisitNode(visitor, cpn.Expression);
                const assignment = NodeFactory_NewAssignmentExpression(f, temp, expression);
                EmitContext_SetSourceMapRange(ec, assignment, cpn.Expression.Loc);
                getterName = NodeFactory_UpdateComputedPropertyName(astFactory, cpn, assignment);
                setterName = NodeFactory_UpdateComputedPropertyName(astFactory, cpn, temp);
            }
        }
        const modifiersWithoutAccessor = NodeVisitor_VisitModifiers(tx.accessorStrippingModifierVisitor, result.modifiers);
        const backingField = createAccessorPropertyBackingField(f, AsPropertyDeclaration(node), modifiersWithoutAccessor, initializer);
        EmitContext_SetOriginal(ec, backingField, node);
        EmitContext_SetEmitFlags(ec, backingField, EFNoComments);
        EmitContext_SetSourceMapRange(ec, backingField, sourceMapRange);
        EmitContext_SetSourceMapRange(ec, AsPropertyDeclaration(backingField).name, EmitContext_SourceMapRange(ec, Node_Name(node)));
        const getter = esDecoratorTransformer_createGetAccessorDescriptorForwarder(tx, modifiersWithoutAccessor, getterName, result.descriptorName);
        ...
        const setter = esDecoratorTransformer_createSetAccessorDescriptorForwarder(tx, modifiersWithoutAccessor, setterName, result.descriptorName);
    ...
    return esDecoratorTransformer_finishClassElement(tx, NodeFactory_UpdatePropertyDeclaration(astFactory, prop, result.modifiers, result.name, undefined, undefined, initializer), node);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitThisExpression(receiver, node) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_visitCallExpression(receiver, node) {
    const tx = receiver;
    ...
    if (IsSuperProperty(call.Expression) && tx.classThis !== undefined) {
        ...
        const argumentsList = NodeVisitor_VisitNodes(visitor, call.Arguments);
        const invocation = NodeFactory_NewFunctionCallCall(f, expression, tx.classThis, argumentsList?.Nodes ?? []);
 ...
 * }
 */
export function esDecoratorTransformer_visitTaggedTemplateExpression(receiver, node) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    ...
    if (IsSuperProperty(tte.Tag) && tx.classThis !== undefined) {
        const tag = NodeVisitor_VisitNode(visitor, tte.Tag);
        const boundTag = NodeFactory_NewFunctionBindCall(f, tag, tx.classThis, []);
        EmitContext_SetOriginal(ec, boundTag, node);
        boundTag.Loc = node.Loc;
        const template = NodeVisitor_VisitNode(visitor, tte.Template);
        return NodeFactory_UpdateTaggedTemplateExpression(astFactory, tte, boundTag, undefined, undefined, template, tte.Flags);
    }
 ...
 * }
 */
export function esDecoratorTransformer_visitPropertyAccessExpression(receiver, node) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_visitElementAccessExpression(receiver, node) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_visitParameterDeclaration(receiver, node) {
    const tx = receiver;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    ...
    if (isNamedEvaluationAnd(ec, paramNode, isAnonymousClassNeedingAssignedName)) {
        paramNode = transformNamedEvaluation(ec, paramNode, canIgnoreEmptyStringLiteralInAssignedName(node.Initializer), "");
        node = AsParameterDeclaration(paramNode);
    }
    const updated = NodeFactory_UpdateParameterDeclaration(astFactory, node, undefined, node.DotDotDotToken, NodeVisitor_VisitNode(visitor, node.name), undefined, undefined, NodeVisitor_VisitNode(visitor, node.Initializer));
    if (updated !== paramNode) {
        ...
        EmitContext_SetEmitFlags(ec, Node_Name(updated), EFNoTrailingSourceMap);
    }
    return updated;
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitNamedEvaluationSite(receiver, node, classExpr) {
    const tx = receiver;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    if (isNamedEvaluationAnd(ec, node, isAnonymousClassNeedingAssignedName)) {
 ...
 * }
 */
export function isAnonymousClassNeedingAssignedName(node) {
 ...
 * }
 */
export function canIgnoreEmptyStringLiteralInAssignedName(node) {
    if (node === undefined) {
        return false;
    }
 ...
 * }
 */
export function esDecoratorTransformer_visitForStatement(receiver, node) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    ...
    return NodeFactory_UpdateForStatement(astFactory, forStmt, NodeVisitor_VisitNode(tx.discardedVisitor, forStmt.Initializer), NodeVisitor_VisitNode(visitor, forStmt.Condition), NodeVisitor_VisitNode(tx.discardedVisitor, forStmt.Incrementor), EmitContext_VisitIterationBody(ec, forStmt.Statement, visitor));
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitExpressionStatement(receiver, node) {
    const tx = receiver;
    return NodeVisitor_VisitEachChild(tx.discardedVisitor, node);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitBinaryExpression(receiver, node, discarded) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    ...
    if (IsDestructuringAssignment(node)) {
        const left = esDecoratorTransformer_visitAssignmentPattern(tx, bin.Left);
        const right = NodeVisitor_VisitNode(visitor, bin.Right);
        return NodeFactory_UpdateBinaryExpression(astFactory, bin, undefined, left, undefined, bin.OperatorToken, right);
    }
    if (IsAssignmentExpression(node, false)) {
        if (isNamedEvaluationAnd(ec, node, isAnonymousClassNeedingAssignedName)) {
            const updated = transformNamedEvaluation(ec, node, canIgnoreEmptyStringLiteralInAssignedName(bin.Right), "");
            return NodeVisitor_VisitEachChild(visitor, updated);
        }
        if (IsSuperProperty(bin.Left) && tx.classThis !== undefined && tx.classSuper !== undefined) {
            let setterName = undefined;
            if (IsElementAccessExpression(bin.Left)) {
                setterName = NodeVisitor_VisitNode(visitor, AsElementAccessExpression(bin.Left).ArgumentExpression);
            }
            else if (IsPropertyAccessExpression(bin.Left) && IsIdentifier(AsPropertyAccessExpression(bin.Left).name)) {
                setterName = NodeFactory_NewStringLiteralFromNode(f, AsPropertyAccessExpression(bin.Left).name);
            }
            if (setterName !== undefined) {
                let expression = NodeVisitor_VisitNode(visitor, bin.Right);
                if (IsCompoundAssignment(bin.OperatorToken.Kind)) {
                    ...
                    if (!IsSimpleInlineableExpression(setterName)) {
                        ...
                        getterName = getterNameId;
                        setterName = NodeFactory_NewAssignmentExpression(f, getterName, setterName);
                    }
                    const superPropertyGet = NodeFactory_NewReflectGetCall(f, tx.classSuper, getterName, tx.classThis);
                    EmitContext_SetOriginal(ec, superPropertyGet, bin.Left);
                    superPropertyGet.Loc = bin.Left.Loc;
                    expression = NewBinaryExpression(astFactory, undefined, superPropertyGet, undefined, NewToken(astFactory, GetNonAssignmentOperatorForCompoundAssignment(bin.OperatorToken.Kind)), expression);
                    expression.Loc = node.Loc;
                }
                let temp = undefined;
                if (!discarded) {
                ...
                if (temp !== undefined) {
                    expression = NodeFactory_NewAssignmentExpression(f, temp, expression);
                    expression.Loc = node.Loc;
                }
                ...
                expression.Loc = node.Loc;
                if (temp !== undefined) {
                    expression = NodeFactory_NewCommaExpression(f, expression, temp);
                    expression.Loc = node.Loc;
                }
                return expression;
            }
    ...
    if (bin.OperatorToken.Kind === KindCommaToken) {
        const left = NodeVisitor_VisitNode(tx.discardedVisitor, bin.Left);
        let right;
        if (discarded) {
            right = NodeVisitor_VisitNode(tx.discardedVisitor, bin.Right);
        }
        else {
            right = NodeVisitor_VisitNode(visitor, bin.Right);
        }
 ...
 * }
 */
export function esDecoratorTransformer_visitPreOrPostfixUnaryExpression(receiver, node, discarded) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    ...
    if (operator === KindPlusPlusToken || operator === KindMinusMinusToken) {
        ...
        if (IsSuperProperty(operand) && tx.classThis !== undefined && tx.classSuper !== undefined) {
            ...
            if (IsElementAccessExpression(operand)) {
                ...
                setterName = NodeVisitor_VisitNode(visitor, ea.ArgumentExpression);
            }
            else if (IsPropertyAccessExpression(operand) && IsIdentifier(AsPropertyAccessExpression(operand).name)) {
                setterName = NodeFactory_NewStringLiteralFromNode(f, AsPropertyAccessExpression(operand).name);
            }
            if (setterName !== undefined) {
                let getterName = setterName;
                if (!IsSimpleInlineableExpression(setterName)) {
                    getterName = NodeFactory_NewTempVariable(f);
                    EmitContext_AddVariableDeclaration(ec, getterName);
                    setterName = NodeFactory_NewAssignmentExpression(f, getterName, setterName);
                }
 ...
 * }
 */
export function esDecoratorTransformer_visitReferencedPropertyName(receiver, node) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    ...
    if (IsPropertyNameLiteral(node) || IsPrivateIdentifier(node)) {
        return [NodeFactory_NewStringLiteralFromNode(f, node), NodeVisitor_VisitNode(visitor, node)];
    }
    const cpn = AsComputedPropertyName(node);
    if (IsPropertyNameLiteral(cpn.Expression) && !IsIdentifier(cpn.Expression)) {
        return [NodeFactory_NewStringLiteralFromNode(f, cpn.Expression), NodeVisitor_VisitNode(visitor, node)];
    }
    const referencedName = NodeFactory_NewGeneratedNameForNode(f, node);
    EmitContext_AddVariableDeclaration(ec, referencedName);
    const key = NodeFactory_NewPropKeyHelper(f, NodeVisitor_VisitNode(visitor, cpn.Expression));
    const assignment = NodeFactory_NewAssignmentExpression(f, referencedName, key);
    const updatedName = NodeFactory_UpdateComputedPropertyName(astFactory, cpn, esDecoratorTransformer_injectPendingExpressions(tx, assignment));
    return [referencedName, updatedName];
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitPropertyName(receiver, node) {
    const tx = receiver;
    if (IsComputedPropertyName(node)) {
        return esDecoratorTransformer_visitComputedPropertyName(tx, node);
    }
    return NodeVisitor_VisitNode(Transformer_Visitor(tx.__tsgoEmbedded0), node);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitComputedPropertyName(receiver, node) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    const cpn = AsComputedPropertyName(node);
    let expression = NodeVisitor_VisitNode(visitor, cpn.Expression);
 ...
 * }
 */
export function esDecoratorTransformer_visitDestructuringAssignmentTarget(receiver, node) {
    const tx = receiver;
    ...
    if (IsSuperProperty(node) && tx.classThis !== undefined && tx.classSuper !== undefined) {
        ...
        if (IsElementAccessExpression(node)) {
            propertyName = NodeVisitor_VisitNode(visitor, AsElementAccessExpression(node).ArgumentExpression);
        }
        else if (IsPropertyAccessExpression(node) && IsIdentifier(AsPropertyAccessExpression(node).name)) {
            propertyName = NodeFactory_NewStringLiteralFromNode(f, AsPropertyAccessExpression(node).name);
        }
        if (propertyName !== undefined) {
            const paramName = NodeFactory_NewTempVariable(f);
            const expression = NodeFactory_NewAssignmentTargetWrapper(f, paramName, NodeFactory_NewReflectSetCall(f, tx.classSuper, propertyName, paramName, tx.classThis));
            EmitContext_SetOriginal(ec, expression, node);
            expression.Loc = node.Loc;
            return expression;
        }
 ...
 * }
 */
export function esDecoratorTransformer_visitAssignmentElement(receiver, node) {
    const tx = receiver;
    if (IsAssignmentExpression(node, true)) {
        ...
        return NodeFactory_UpdateBinaryExpression(astFactory, bin, undefined, assignmentTarget, undefined, bin.OperatorToken, initializer);
    }
 ...
 * }
 */
export function esDecoratorTransformer_visitAssignmentRestElement(receiver, node) {
    const tx = receiver;
    ...
    if (IsLeftHandSideExpression(se.Expression)) {
        ...
        return NodeFactory_UpdateSpreadElement(astFactory, se, expression);
    }
    return NodeVisitor_VisitEachChild(Transformer_Visitor(tx.__tsgoEmbedded0), node);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitArrayAssignmentElement(receiver, node) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_visitAssignmentPropertyNode(receiver, node) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    ...
    if (IsAssignmentExpression(pa.Initializer, true)) {
        ...
        return NodeFactory_UpdatePropertyAssignment(astFactory, pa, undefined, name, undefined, undefined, assignmentElement);
    }
 ...
 * }
 */
export function esDecoratorTransformer_visitShorthandAssignmentProperty(receiver, node) {
    const tx = receiver;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    let n = node;
 ...
 * }
 */
export function esDecoratorTransformer_visitAssignmentRestProperty(receiver, node) {
    const tx = receiver;
    ...
    if (IsLeftHandSideExpression(sa.Expression)) {
        ...
        return NodeFactory_UpdateSpreadAssignment(astFactory, sa, expression);
    }
    return NodeVisitor_VisitEachChild(Transformer_Visitor(tx.__tsgoEmbedded0), node);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitObjectAssignmentElement(receiver, node) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_visitAssignmentPattern(receiver, node) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    if (IsArrayLiteralExpression(node)) {
        const ale = AsArrayLiteralExpression(node);
        const elements = NodeVisitor_VisitNodes(tx.arrayAssignmentVisitor, ale.Elements);
        return NodeFactory_UpdateArrayLiteralExpression(astFactory, ale, elements, ale.MultiLine);
    }
    const ole = AsObjectLiteralExpression(node);
    const properties = NodeVisitor_VisitNodes(tx.objectAssignmentVisitor, ole.Properties);
 ...
 * }
 */
export function esDecoratorTransformer_visitExportAssignment(receiver, node) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_visitParenthesizedExpression(receiver, node, discarded) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    ...
    const expression = discarded
        ? NodeVisitor_VisitNode(tx.discardedVisitor, pe.Expression)
        : NodeVisitor_VisitNode(visitor, pe.Expression);
    return NodeFactory_UpdateParenthesizedExpression(astFactory, pe, expression);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_visitPartiallyEmittedExpression(receiver, node, discarded) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    ...
    const expression = discarded
        ? NodeVisitor_VisitNode(tx.discardedVisitor, pe.Expression)
        : NodeVisitor_VisitNode(visitor, pe.Expression);
    return NodeFactory_UpdatePartiallyEmittedExpression(astFactory, pe, expression);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_prependExpressions(receiver, pending, expression) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    if (pending.length === 0) {
    ...
    if (IsParenthesizedExpression(expression)) {
        const pe = AsParenthesizedExpression(expression);
        const exprs = [...pending, pe.Expression];
        return NodeFactory_UpdateParenthesizedExpression(astFactory, pe, NodeFactory_InlineExpressions(f, exprs));
    }
 ...
 * }
 */
export function esDecoratorTransformer_injectPendingExpressions(receiver, expression) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_injectPendingInitializers(receiver, ci, isStatic, expression) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_transformAllDecoratorsOfDeclaration(receiver, decorators) {
    const tx = receiver;
 ...
 * }
 */
export function esDecoratorTransformer_transformDecorator(receiver, decorator) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    let expression = NodeVisitor_VisitNode(visitor, AsDecorator(decorator).Expression);
 ...
 * }
 */
export function esDecoratorTransformer_createCallBinding(receiver, expression) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    ...
    if ((EmitContext_EmitFlags(ec, callee) & EFHelperName) !== 0) {
        return [callee, NodeFactory_NewVoidZeroExpression(f)];
    }
    if (IsPropertyAccessExpression(callee)) {
        const pa = AsPropertyAccessExpression(callee);
        if (esDecoratorTransformer_shouldBeCapturedInTempVariable(tx, pa.Expression)) {
            const thisArg = NodeFactory_NewTempVariable(f);
            EmitContext_AddVariableDeclaration(ec, thisArg);
            const assign = NodeFactory_NewAssignmentExpression(f, thisArg, pa.Expression);
            assign.Loc = pa.Expression.Loc;
            const target = NewPropertyAccessExpression(astFactory, assign, undefined, pa.name, NodeFlagsNone);
            target.Loc = callee.Loc;
            return [target, thisArg];
        }
        return [callee, pa.Expression];
    ...
    if (IsElementAccessExpression(callee)) {
        const ea = AsElementAccessExpression(callee);
        if (esDecoratorTransformer_shouldBeCapturedInTempVariable(tx, ea.Expression)) {
            const thisArg = NodeFactory_NewTempVariable(f);
            EmitContext_AddVariableDeclaration(ec, thisArg);
            const assign = NodeFactory_NewAssignmentExpression(f, thisArg, ea.Expression);
            assign.Loc = ea.Expression.Loc;
            const target = NewElementAccessExpression(astFactory, assign, undefined, ea.ArgumentExpression, NodeFlagsNone);
            target.Loc = callee.Loc;
            return [target, thisArg];
        }
        return [callee, ea.Expression];
 ...
 * }
 */
export function esDecoratorTransformer_shouldBeCapturedInTempVariable(receiver, node) {
 ...
 * }
 */
export function esDecoratorTransformer_createDescriptorMethod(receiver, original, name, modifiers, asteriskToken, kind, parameters, body) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    ...
    if (bodyNode === undefined) {
        bodyNode = NewBlock(astFactory, NodeFactory_NewNodeList(astFactory, []), false);
    }
    const funcExpr = NewFunctionExpression(astFactory, modifiers, asteriskToken, undefined, undefined, parameters, undefined, undefined, bodyNode);
    ...
    const functionName = NodeFactory_NewStringLiteralFromNode(f, name);
    const namedFunction = NodeFactory_NewSetFunctionNameHelper(f, funcExpr, functionName, prefix);
    const method = NewPropertyAssignment(astFactory, undefined, NewAstIdentifier(astFactory, kind), undefined, undefined, namedFunction);
 ...
 * }
 */
export function esDecoratorTransformer_createMethodDescriptorObject(receiver, member, modifiers) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    ...
    return NewObjectLiteralExpression(astFactory, NodeFactory_NewNodeList(astFactory, [descriptorMethod]), false);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_createGetAccessorDescriptorObject(receiver, member, modifiers) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
    const body = NodeVisitor_VisitNode(visitor, Node_Body(member));
    const descriptorMethod = esDecoratorTransformer_createDescriptorMethod(tx, member, Node_Name(member), modifiers, undefined, "get", NodeFactory_NewNodeList(astFactory, []), body);
    return NewObjectLiteralExpression(astFactory, NodeFactory_NewNodeList(astFactory, [descriptorMethod]), false);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_createSetAccessorDescriptorObject(receiver, member, modifiers) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const visitor = Transformer_Visitor(tx.__tsgoEmbedded0);
 ...
 * }
 */
export function esDecoratorTransformer_createAccessorPropertyDescriptorObject(receiver, member, arg) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    ...
    const thisExpr = NodeFactory_NewThisExpression(f);
    const backingFieldAccess = NewPropertyAccessExpression(astFactory, thisExpr, undefined, backingFieldName, NodeFlagsNone);
    const returnBackingField = NewReturnStatement(astFactory, backingFieldAccess);
    const getBody = NewBlock(astFactory, NodeFactory_NewNodeList(astFactory, [returnBackingField]), false);
    const valueId = NewAstIdentifier(astFactory, "value");
    const backingFieldAccess2 = NewPropertyAccessExpression(astFactory, NodeFactory_NewThisExpression(f), undefined, backingFieldName, NodeFlagsNone);
    const assignStmt = NewExpressionStatement(astFactory, NewBinaryExpression(astFactory, undefined, backingFieldAccess2, undefined, NewToken(astFactory, KindEqualsToken), valueId));
    const setBody = NewBlock(astFactory, NodeFactory_NewNodeList(astFactory, [assignStmt]), false);
    const setParam = NewParameterDeclaration(astFactory, undefined, undefined, NewAstIdentifier(astFactory, "value"), undefined, undefined, undefined);
    const getDescriptor = esDecoratorTransformer_createDescriptorMethod(tx, member, Node_Name(member), undefined, undefined, "get", NodeFactory_NewNodeList(astFactory, []), getBody);
    const setDescriptor = esDecoratorTransformer_createDescriptorMethod(tx, member, Node_Name(member), undefined, undefined, "set", NodeFactory_NewNodeList(astFactory, [setParam]), setBody);
    return NewObjectLiteralExpression(astFactory, NodeFactory_NewNodeList(astFactory, [getDescriptor, setDescriptor]), false);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_createMethodDescriptorForwarder(receiver, modifiers, name, descriptorName) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const staticOnly = NodeVisitor_VisitModifiers(tx.staticOnlyModifierVisitor, modifiers);
    const valueAccess = NewPropertyAccessExpression(astFactory, descriptorName, undefined, NewAstIdentifier(astFactory, "value"), NodeFlagsNone);
    const returnStmt = NewReturnStatement(astFactory, valueAccess);
    const body = NewBlock(astFactory, NodeFactory_NewNodeList(astFactory, [returnStmt]), false);
    return NewGetAccessorDeclaration(astFactory, staticOnly, name, undefined, NodeFactory_NewNodeList(astFactory, []), undefined, undefined, body);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_createGetAccessorDescriptorForwarder(receiver, modifiers, name, descriptorName) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const staticOnly = NodeVisitor_VisitModifiers(tx.staticOnlyModifierVisitor, modifiers);
    const getAccess = NewPropertyAccessExpression(astFactory, descriptorName, undefined, NewAstIdentifier(astFactory, "get"), NodeFlagsNone);
    const bindCall = NodeFactory_NewFunctionCallCall(f, getAccess, NodeFactory_NewThisExpression(f), []);
    const returnStmt = NewReturnStatement(astFactory, bindCall);
    const body = NewBlock(astFactory, NodeFactory_NewNodeList(astFactory, [returnStmt]), false);
    return NewGetAccessorDeclaration(astFactory, staticOnly, name, undefined, NodeFactory_NewNodeList(astFactory, []), undefined, undefined, body);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_createSetAccessorDescriptorForwarder(receiver, modifiers, name, descriptorName) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const staticOnly = NodeVisitor_VisitModifiers(tx.staticOnlyModifierVisitor, modifiers);
    const setAccess = NewPropertyAccessExpression(astFactory, descriptorName, undefined, NewAstIdentifier(astFactory, "set"), NodeFlagsNone);
    const valueId = NewAstIdentifier(astFactory, "value");
    const bindCall = NodeFactory_NewFunctionCallCall(f, setAccess, NodeFactory_NewThisExpression(f), [valueId]);
    const returnStmt = NewReturnStatement(astFactory, bindCall);
    const body = NewBlock(astFactory, NodeFactory_NewNodeList(astFactory, [returnStmt]), false);
    const valueParam = NewParameterDeclaration(astFactory, undefined, undefined, NewAstIdentifier(astFactory, "value"), undefined, undefined, undefined);
    return NewSetAccessorDeclaration(astFactory, staticOnly, name, undefined, NodeFactory_NewNodeList(astFactory, [valueParam]), undefined, undefined, body);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_createMetadata(receiver, name, classSuper) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const superMetadata = classSuper !== undefined
        ? esDecoratorTransformer_createSymbolMetadataReference(tx, classSuper)
        : NewToken(astFactory, KindNullKeyword);
    const objectCreateExpr = NewPropertyAccessExpression(astFactory, NewAstIdentifier(astFactory, "Object"), undefined, NewAstIdentifier(astFactory, "create"), NodeFlagsNone);
    const objectCreate = NewCallExpression(astFactory, objectCreateExpr, undefined, undefined, NodeFactory_NewNodeList(astFactory, [superMetadata]), NodeFlagsNone);
    const symbolMetadataAccess = NewPropertyAccessExpression(astFactory, NewAstIdentifier(astFactory, "Symbol"), undefined, NewAstIdentifier(astFactory, "metadata"), NodeFlagsNone);
    const typeCheck = NodeFactory_NewTypeCheck(f, NewAstIdentifier(astFactory, "Symbol"), "function");
    const symbolCheck = NodeFactory_NewLogicalANDExpression(f, typeCheck, symbolMetadataAccess);
    const conditional = NewConditionalExpression(astFactory, symbolCheck, NewToken(astFactory, KindQuestionToken), objectCreate, NewToken(astFactory, KindColonToken), NodeFactory_NewVoidZeroExpression(f));
    const varDecl = NewVariableDeclaration(astFactory, name, undefined, undefined, conditional);
    const varDeclList = NewVariableDeclarationList(astFactory, NodeFactory_NewNodeList(astFactory, [varDecl]), NodeFlagsConst);
    return NewVariableStatement(astFactory, undefined, varDeclList);
}
/**
 ...
 * }
 */
export function esDecoratorTransformer_createSymbolMetadata(receiver, target, value) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const ec = Transformer_EmitContext(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const symbolMetadata = NewPropertyAccessExpression(astFactory, NewAstIdentifier(astFactory, "Symbol"), undefined, NewAstIdentifier(astFactory, "metadata"), NodeFlagsNone);
    const descriptorProps = [
        NewPropertyAssignment(astFactory, undefined, NewAstIdentifier(astFactory, "enumerable"), undefined, undefined, NodeFactory_NewTrueExpression(f)),
        NewPropertyAssignment(astFactory, undefined, NewAstIdentifier(astFactory, "configurable"), undefined, undefined, NodeFactory_NewTrueExpression(f)),
        NewPropertyAssignment(astFactory, undefined, NewAstIdentifier(astFactory, "writable"), undefined, undefined, NodeFactory_NewTrueExpression(f)),
        NewPropertyAssignment(astFactory, undefined, NewAstIdentifier(astFactory, "value"), undefined, undefined, value),
    ];
    const descriptor = NewObjectLiteralExpression(astFactory, NodeFactory_NewNodeList(astFactory, descriptorProps), false);
    const definePropertyExpr = NewPropertyAccessExpression(astFactory, NewAstIdentifier(astFactory, "Object"), undefined, NewAstIdentifier(astFactory, "defineProperty"), NodeFlagsNone);
    const defineProperty = NewCallExpression(astFactory, definePropertyExpr, undefined, undefined, NodeFactory_NewNodeList(astFactory, [target, symbolMetadata, descriptor]), NodeFlagsNone);
    const ifStatement = NewIfStatement(astFactory, value, NewExpressionStatement(astFactory, defineProperty), undefined);
 ...
 * }
 */
export function esDecoratorTransformer_createSymbolMetadataReference(receiver, classSuper) {
    const tx = receiver;
    const f = Transformer_Factory(tx.__tsgoEmbedded0);
    const astFactory = f.__tsgoEmbedded0;
    const symbolMetadata = NewPropertyAccessExpression(astFactory, NewAstIdentifier(astFactory, "Symbol"), undefined, NewAstIdentifier(astFactory, "metadata"), NodeFlagsNone);
    const elementAccess = NewElementAccessExpression(astFactory, classSuper, undefined, symbolMetadata, NodeFlagsNone);
    return NewBinaryExpression(astFactory, undefined, elementAccess, undefined, NewToken(astFactory, KindQuestionQuestionToken), NewToken(astFactory, KindNullKeyword));
}
/**
 ...
 * }
 */
export function injectClassThisAssignmentIfMissing(ec, f, node, classThis) {
    if (classHasClassThisAssignment(ec, node)) {
        return node;
    }
    const astFactory = f.__tsgoEmbedded0;
    const expression = NodeFactory_NewAssignmentExpression(f, classThis, NodeFactory_NewThisExpression(f));
    ...
    const newMembers = [staticBlock, ...(Node_Members(node) ?? [])];
    ...
    if (IsClassDeclaration(node)) {
        ...
        updatedNode = NodeFactory_UpdateClassDeclaration(astFactory, cd, cd.modifiers, cd.name, undefined, cd.HeritageClauses, membersList);
    }
    else {
        const ce = AsClassExpression(node);
        updatedNode = NodeFactory_UpdateClassExpression(astFactory, ce, ce.modifiers, ce.name, undefined, ce.HeritageClauses, membersList);
    }
    EmitContext_SetClassThis(ec, updatedNode, classThis);
    return updatedNode;
}
//# sourceMappingURL=esdecorator.js.map