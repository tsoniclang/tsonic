 ...
 * }
 */
export declare function Transformer_NewTransformer(receiver: GoPtr<Transformer>, visit: (node: GoPtr<Node>) => GoPtr<Node>, emitContext: GoPtr<EmitContext_680f09ca>): GoPtr<Transformer>;
/**
 ...
 * }
 */
export declare function Transformer_EmitContext(receiver: GoPtr<Transformer>): GoPtr<EmitContext_680f09ca>;
/**
 ...
 * }
 */
export declare function Transformer_Visitor(receiver: GoPtr<Transformer>): GoPtr<NodeVisitor>;
/**
 ...
 * }
 */
export declare function Transformer_Factory(receiver: GoPtr<Transformer>): GoPtr<NodeFactory>;
/**
 ...
 * }
 */
export declare function Transformer_TransformSourceFile(receiver: GoPtr<Transformer>, file: GoPtr<SourceFile>): GoPtr<SourceFile>;
