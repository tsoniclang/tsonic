import { NewOrderedMapWithSizeHint, OrderedMap_Entries, OrderedMap_Get, OrderedMap_Set, OrderedMap_Size, } from "../collections/ordered_map.js";
...
import { CommandLineOption_Elements, CommandLineOptionTypeList, } from "./commandlineoption.js";
import { extraKeyDiagnostics, extraKeyDidYouMeanDiagnostics } from "./errors.js";
import { CommandLineCompilerOptionsMap, CommandLineOptionNameMap_Get, } from "./tsconfigparsing.js";
 ...
 * }
 */
export function parseStringMap(value) {
    const m = asOrderedMap(value);
    if (m !== undefined) {
        const result = NewOrderedMapWithSizeHint(OrderedMap_Size(m));
        OrderedMap_Entries(m)((k, v) => {
...
export function parseNumber(value) {
    ...
    if (typeof value === "number") {
        ...
        const n = globalThis.Math.trunc(value);
        return n;
    }
    return undefined;
}
 ...
 * }
 */
export function parseProjectReference(json) {
    const result = [];
    const v = asOrderedMap(json);
    if (v !== undefined) {
        const reference = { Path: "", OriginalPath: "", Circular: false };
        {
            const [pv, ok] = OrderedMap_Get(v, "path");
            if (ok) {
                reference.Path = pv;
            }
        }
        {
            const [cv, ok] = OrderedMap_Get(v, "circular");
            if (ok) {
                reference.Circular = cv;
            }
        }
 ...
 * }
 */
export function parseJsonToStringKey(json) {
    const result = NewOrderedMapWithSizeHint(6);
    ...
    if (m !== undefined) {
        ...
        }
        {
            ...
            if (ok) {
                if (typeof v === "string") {
                    const str = v;
                    OrderedMap_Set(result, "extends", [str]);
                }
 ...
 * }
 */
export function compilerOptionsParser_ParseOption(receiver, key, value) {
    const o = receiver;
 ...
 * }
 */
export function compilerOptionsParser_UnknownOptionDiagnostic(receiver) {
    return extraKeyDiagnostics("compilerOptions");
}
/**
 ...
 * }
 */
export function compilerOptionsParser_UnknownDidYouMeanDiagnostic(receiver) {
    return extraKeyDidYouMeanDiagnostics("compilerOptions");
}
export function compilerOptionsParser_as_optionParser(receiver) {
    return {
        ParseOption: (key, value) => compilerOptionsParser_ParseOption(receiver, key, value),
        UnknownOptionDiagnostic: () => compilerOptionsParser_UnknownOptionDiagnostic(receiver),
        UnknownDidYouMeanDiagnostic: () => compilerOptionsParser_UnknownDidYouMeanDiagnostic(receiver),
    };
}
/**
 ...
 * }
 */
export function watchOptionsParser_ParseOption(receiver, key, value) {
    const o = receiver;
 ...
 * }
 */
export function watchOptionsParser_UnknownOptionDiagnostic(receiver) {
    return extraKeyDiagnostics("watchOptions");
}
/**
 ...
 * }
 */
export function watchOptionsParser_UnknownDidYouMeanDiagnostic(receiver) {
    return extraKeyDidYouMeanDiagnostics("watchOptions");
}
export function watchOptionsParser_as_optionParser(receiver) {
    return {
        ParseOption: (key, value) => watchOptionsParser_ParseOption(receiver, key, value),
        UnknownOptionDiagnostic: () => watchOptionsParser_UnknownOptionDiagnostic(receiver),
        UnknownDidYouMeanDiagnostic: () => watchOptionsParser_UnknownDidYouMeanDiagnostic(receiver),
    };
}
/**
 ...
 * }
 */
export function typeAcquisitionParser_ParseOption(receiver, key, value) {
    const o = receiver;
 ...
 * }
 */
export function typeAcquisitionParser_UnknownOptionDiagnostic(receiver) {
    return extraKeyDiagnostics("typeAcquisition");
}
/**
 ...
 * }
 */
export function typeAcquisitionParser_UnknownDidYouMeanDiagnostic(receiver) {
    return extraKeyDidYouMeanDiagnostics("typeAcquisition");
}
export function typeAcquisitionParser_as_optionParser(receiver) {
    return {
        ParseOption: (key, value) => typeAcquisitionParser_ParseOption(receiver, key, value),
        UnknownOptionDiagnostic: () => typeAcquisitionParser_UnknownOptionDiagnostic(receiver),
        UnknownDidYouMeanDiagnostic: () => typeAcquisitionParser_UnknownDidYouMeanDiagnostic(receiver),
    };
}
/**
 ...
 * }
 */
export function buildOptionsParser_ParseOption(receiver, key, value) {
    const o = receiver;
 ...
 * }
 */
export function buildOptionsParser_UnknownOptionDiagnostic(receiver) {
    return extraKeyDiagnostics("buildOptions");
}
/**
 ...
 * }
 */
export function buildOptionsParser_UnknownDidYouMeanDiagnostic(receiver) {
    return extraKeyDidYouMeanDiagnostics("buildOptions");
}
export function buildOptionsParser_as_optionParser(receiver) {
    return {
        ParseOption: (key, value) => buildOptionsParser_ParseOption(receiver, key, value),
        UnknownOptionDiagnostic: () => buildOptionsParser_UnknownOptionDiagnostic(receiver),
        UnknownDidYouMeanDiagnostic: () => buildOptionsParser_UnknownDidYouMeanDiagnostic(receiver),
    };
}
/**
 ...
 * }
 */
export function ParseCompilerOptions(key, value, allOptions) {
    if (value === undefined) {
        return [];
    }
...
export function parseCompilerOptions(key, value, allOptions) {
    ...
    const k = option !== undefined ? option.Name : key;
    const o = allOptions;
    switch (k) {
        case "allowJs":
        ...
        case "isolatedDeclarations":
            ...
            break;
        case "jsx":
            o.Jsx = floatOrInt32ToFlag(value);
            break;
        case "jsxFactory":
        ...
        case "jsxImportSource":
            ...
            break;
        case "lib":
            if (globalThis.Array.isArray(value) && value.every((e) => typeof e === "string")) {
                o.Lib = value;
            }
            else {
        ...
        case "mapRoot":
            ...
            break;
        case "module":
            o.Module = floatOrInt32ToFlag(value);
            break;
        case "moduleDetectionKind":
            o.ModuleDetection = floatOrInt32ToFlag(value);
            break;
        case "moduleResolution":
            o.ModuleResolution = floatOrInt32ToFlag(value);
            break;
        case "moduleSuffixes":
        ...
        case "suppressOutputPathCheck":
            ...
            break;
        case "target":
            o.Target = floatOrInt32ToFlag(value);
            break;
        ...
        case "outDir":
            ...
            break;
        case "newLine":
            o.NewLine = floatOrInt32ToFlag(value);
            break;
        case "watch":
 ...
 * }
 */
export function floatOrInt32ToFlag(value) {
 ...
 * }
 */
export function ParseWatchOptions(key, value, allOptions) {
    if (allOptions === undefined) {
        return [];
    }
    const o = allOptions;
    switch (key) {
        ...
        case "watchDirectory":
            if (value !== undefined) {
                o.DirectoryKind = value;
            }
            break;
        case "fallbackPolling":
            if (value !== undefined) {
                o.FallbackPolling = value;
            }
            break;
        case "synchronousWatchDirectory":
 ...
 * }
 */
export function ParseTypeAcquisition(key, value, allOptions) {
    if (value === undefined) {
        return [];
    }
    if (allOptions === undefined) {
 ...
 * }
 */
export function ParseBuildOptions(key, value, allOptions) {
    if (value === undefined) {
        return [];
    }
    if (allOptions === undefined) {
    ...
    const option = NameMap_Get(BuildNameMap, key);
    const k = option !== undefined ? option.Name : key;
    const o = allOptions;
    switch (k) {
        case "clean":
 ...
 * }
 */
export function mergeCompilerOptions(targetOptions, sourceOptions, rawSource) {
    if (sourceOptions === undefined) {
        return targetOptions;
    }
    const explicitNullFields = new globalThis.Set();
    if (rawSource !== undefined) {
        const rawMap = asOrderedMap(rawSource);
        if (rawMap !== undefined) {
            const [compilerOptionsRaw, exists] = OrderedMap_Get(rawMap, "compilerOptions");
            if (exists) {
                const compilerOptionsMap = asOrderedMap(compilerOptionsRaw);
                if (compilerOptionsMap !== undefined) {
                    OrderedMap_Entries(compilerOptionsMap)((key, value) => {
...
function compilerOptionJsonKeyToFieldName(key) {
    if (key === "esModuleInterop") {
        return "ESModuleInterop";
    }
    return key.slice(0, 1).toUpperCase() + key.slice(1);
}
function compilerOptionFieldNameToJsonKey(fieldName) {
 ...
 * }
 */
export function convertToOptionsWithAbsolutePaths(optionsBase, optionMap, cwd) {
    // !!! convert to options with absolute paths was previously done with `CompilerOptions` object, but for ease of implementation, we do it pre-conversion.
    // !!! Revisit this choice if/when refactoring when conversion is done in tsconfig parsing
 ...
 * }
 */
export function ConvertOptionToAbsolutePath(o, v, optionMap, cwd) {
    ...
    if (option.Kind === CommandLineOptionTypeList) {
        if (CommandLineOption_Elements(option).IsFilePath) {
            if (globalThis.Array.isArray(v) && v.every((e) => typeof e === "string")) {
                const arr = v;
                return [
                    core_Map(arr, (item) => {
