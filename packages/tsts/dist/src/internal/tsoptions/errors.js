...
import { Argument_for_0_option_must_be_Colon_1, Compiler_option_0_may_only_be_used_with_build, Option_build_must_be_the_first_command_line_argument, Unknown_build_option_0, Unknown_build_option_0_Did_you_mean_1, Unknown_compiler_option_0, Unknown_compiler_option_0_Did_you_mean_1, Unknown_type_acquisition_option_0, Unknown_type_acquisition_option_0_Did_you_mean_1, Unknown_watch_option_0, Unknown_watch_option_0_Did_you_mean_1, } from "../diagnostics/generated/messages.js";
import { CommandLineOption_DeprecatedKeys, CommandLineOption_Elements, CommandLineOption_EnumMap, CommandLineOptionTypeList, CommandLineOptionTypeListOrElement, } from "./commandlineoption.js";
 ...
 * }
 */
export function createDiagnosticForInvalidEnumType(opt, sourceFile, node) {
 ...
 * }
 */
export function formatEnumTypeKeys(opt, keys) {
    const filtered = CommandLineOption_DeprecatedKeys(opt) !== undefined
        ? Filter(keys, (key) => !Set_Has(CommandLineOption_DeprecatedKeys(opt), key))
        : keys;
 ...
 * }
 */
export function getCompilerOptionValueTypeString(option) {
    switch (option.Kind) {
        case CommandLineOptionTypeListOrElement:
 ...
 * }
 */
export function commandLineParser_createUnknownOptionError(receiver, unknownOption, unknownOptionErrorText, node, sourceFile) {
    return createUnknownOptionError(unknownOption, commandLineParser_UnknownOptionDiagnostic(receiver), unknownOptionErrorText, node, sourceFile, commandLineParser_AlternateMode(receiver));
}
/**
 ...
 * }
 */
export function createUnknownOptionError(unknownOption, unknownOptionDiagnostic, unknownOptionErrorText, node, sourceFile, alternateMode) {
 ...
 * }
 */
export function CreateDiagnosticForNodeInSourceFile(sourceFile, node, message, ...args) {
 ...
 * }
 */
export function CreateDiagnosticForNodeInSourceFileOrCompilerDiagnostic(sourceFile, node, message, ...args) {
 ...
 * }
 */
export function extraKeyDiagnostics(s) {
    switch (s) {
        case "compilerOptions":
 ...
 * }
 */
export function extraKeyDidYouMeanDiagnostics(s) {
    switch (s) {
        case "compilerOptions":
