 ...
 * }
 */
export declare function commandLineParser_AlternateMode(receiver: GoPtr<commandLineParser>): GoPtr<AlternateModeDiagnostics>;
/**
 ...
 * }
 */
export declare function commandLineParser_OptionsDeclarations(receiver: GoPtr<commandLineParser>): GoSlice<GoPtr<CommandLineOption>>;
/**
 ...
 * }
 */
export declare function commandLineParser_UnknownOptionDiagnostic(receiver: GoPtr<commandLineParser>): GoPtr<Message>;
/**
 ...
 * }
 */
export declare function commandLineParser_UnknownDidYouMeanDiagnostic(receiver: GoPtr<commandLineParser>): GoPtr<Message>;
/**
 ...
 * }
 */
export declare function ParseCommandLine(commandLine: GoSlice<string>, host: ParseConfigHost): GoPtr<ParsedCommandLine>;
/**
 ...
 * }
 */
export declare function ParseBuildCommandLine(commandLine: GoSlice<string>, host: ParseConfigHost): GoPtr<ParsedBuildCommandLine>;
/**
 ...
 * }
 */
export declare function parseCommandLineWorker(parseCommandLineWithDiagnostics: GoPtr<ParseCommandLineWorkerDiagnostics>, commandLine: GoSlice<string>, fs: FS, currentDirectory: string): GoPtr<commandLineParser>;
/**
 ...
 * }
 */
export declare function commandLineParser_parseStrings(receiver: GoPtr<commandLineParser>, args: GoSlice<string>): void;
/**
 ...
 * }
 */
export declare function getInputOptionName(input: string): string;
/**
 ...
 * }
 */
export declare function commandLineParser_parseResponseFile(receiver: GoPtr<commandLineParser>, fileName: string): void;
/**
 ...
 * }
 */
export declare function tryReadFile(fileName: string, readFile: (arg0: string) => [string, bool], errors: GoSlice<GoPtr<Diagnostic>>): [string, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function commandLineParser_parseOptionValue(receiver: GoPtr<commandLineParser>, args: GoSlice<string>, i: int, opt: GoPtr<CommandLineOption>, diag: GoPtr<Message>): int;
/**
 ...
 * }
 */
export declare function commandLineParser_parseListTypeOption(receiver: GoPtr<commandLineParser>, opt: GoPtr<CommandLineOption>, value: string): [GoSlice<unknown>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function ParseListTypeOption(opt: GoPtr<CommandLineOption>, value: string): [GoSlice<unknown>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function convertJsonOptionOfEnumType(opt: GoPtr<CommandLineOption>, value: string, valueExpression: GoPtr<Expression>, sourceFile: GoPtr<SourceFile>): [unknown, GoSlice<GoPtr<Diagnostic>>];
