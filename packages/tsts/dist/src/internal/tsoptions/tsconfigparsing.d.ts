...
import type { optionParser } from "./parsinghelpers.js";
 ...
 */
export declare const CommandLineCompilerOptionsMap: CommandLineOptionNameMap;
/**
 ...
 * }
 */
export declare const compilerOptionsDeclaration: GoPtr<CommandLineOption>;
/**
 ...
 * }
 */
export declare const compileOnSaveCommandLineOption: GoPtr<CommandLineOption>;
/**
 ...
 * }
 */
export declare const extendsOptionDeclaration: GoPtr<CommandLineOption>;
/**
 ...
 * }
 */
export declare const tsconfigRootOptionsMap: GoPtr<CommandLineOption>;
/**
 ...
 * }
 */
export declare function configFileSpecs_matchesExclude(receiver: GoPtr<configFileSpecs>, fileName: string, comparePathsOptions: ComparePathsOptions): bool;
/**
 ...
 * }
 */
export declare function configFileSpecs_getMatchedIncludeSpec(receiver: GoPtr<configFileSpecs>, fileName: string, comparePathsOptions: ComparePathsOptions): string;
/**
 ...
 * }
 */
export declare function configFileSpecs_getMatchedFileSpec(receiver: GoPtr<configFileSpecs>, fileName: string, comparePathsOptions: ComparePathsOptions): string;
/**
 ...
 * }
 */
export declare function ExtendedConfigCacheEntry_ExtendedFileNames(receiver: GoPtr<ExtendedConfigCacheEntry>): GoSlice<string>;
/**
 ...
 * }
 */
export declare function parseOwnConfigOfJsonSourceFile(sourceFile: GoPtr<SourceFile>, host: ParseConfigHost, basePath: string, configFileName: string): [GoPtr<parsedTsconfig>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function tsconfigToSourceFile(tsconfigSourceFile: GoPtr<TsConfigSourceFile>): GoPtr<SourceFile>;
/**
 ...
 * }
 */
export declare function NewTsconfigSourceFileFromFilePath(configFileName: string, configPath: Path, configSourceText: string): GoPtr<TsConfigSourceFile>;
/**
 ...
 * }
 */
export declare function convertConfigFileToObject(sourceFile: GoPtr<SourceFile>, jsonConversionNotifier: GoPtr<jsonConversionNotifier>): [unknown, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 */
export declare const orderedMapType: Type;
export declare function isOrderedMap(value: unknown): value is OrderedMap<string, unknown>;
/**
 ...
 * }
 */
export declare function isCompilerOptionsValue(option: GoPtr<CommandLineOption>, value: unknown): bool;
/**
 ...
 * }
 */
export declare function validateJsonOptionValue(opt: GoPtr<CommandLineOption>, val: unknown, valueExpression: GoPtr<Expression>, sourceFile: GoPtr<SourceFile>): [unknown, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function convertJsonOptionOfListType(option: GoPtr<CommandLineOption>, values: unknown, basePath: string, propertyAssignment: GoPtr<PropertyAssignment>, valueExpression: GoPtr<Node>, sourceFile: GoPtr<SourceFile>): [GoSlice<unknown>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 */
export declare const configDirTemplate: string;
/**
 ...
 * }
 */
export declare function startsWithConfigDirTemplate(value: unknown): bool;
/**
 ...
 * }
 */
export declare function normalizeNonListOptionValue(option: GoPtr<CommandLineOption>, basePath: string, value: unknown): unknown;
/**
 ...
 * }
 */
export declare function convertJsonOption(opt: GoPtr<CommandLineOption>, value: unknown, basePath: string, propertyAssignment: GoPtr<PropertyAssignment>, valueExpression: GoPtr<Expression>, sourceFile: GoPtr<SourceFile>): [unknown, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function getExtendsConfigPathOrArray(value: CompilerOptionsValue, host: ParseConfigHost, basePath: string, configFileName: string, propertyAssignment: GoPtr<PropertyAssignment>, valueExpression: GoPtr<Expression>, sourceFile: GoPtr<SourceFile>): [GoSlice<string>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function getExtendsConfigPath(extendedConfig: string, host: ParseConfigHost, basePath: string, valueExpression: GoPtr<Expression>, sourceFile: GoPtr<SourceFile>): [string, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function CommandLineOptionNameMap_Get(receiver: CommandLineOptionNameMap, name: string): GoPtr<CommandLineOption>;
/**
 ...
 * }
 */
export declare function convertMapToOptions<O extends optionParser>(compilerOptions: GoPtr<OrderedMap<string, unknown>>, result: O): O;
/**
 ...
 * }
 */
export declare function convertOptionsFromJson<O extends optionParser>(optionsNameMap: CommandLineOptionNameMap, jsonOptions: unknown, basePath: string, result: O): [O, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function convertArrayLiteralExpressionToJson(sourceFile: GoPtr<SourceFile>, elements: GoSlice<GoPtr<Expression>>, elementOption: GoPtr<CommandLineOption>, returnValue: bool): [unknown, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function directoryOfCombinedPath(fileName: string, basePath: string): string;
/**
 ...
 * }
 */
export declare function ParseConfigFileTextToJson(fileName: string, path: Path, jsonText: string): [unknown, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 */
export declare function resolverHost_Trace(receiver: GoPtr<resolverHost>, msg: string): void;
/**
 ...
 * }
 */
export declare function ParseJsonSourceFileConfigFileContent(sourceFile: GoPtr<TsConfigSourceFile>, host: ParseConfigHost, basePath: string, existingOptions: GoPtr<CompilerOptions>, existingOptionsRaw: GoPtr<OrderedMap<string, unknown>>, configFileName: string, resolutionStack: GoSlice<Path>, extraFileExtensions: GoSlice<FileExtensionInfo>, extendedConfigCache: GoPtr<ExtendedConfigCache>): GoPtr<ParsedCommandLine>;
/**
 ...
 * }
 */
export declare function convertObjectLiteralExpressionToJson(sourceFile: GoPtr<SourceFile>, returnValue: bool, node: GoPtr<ObjectLiteralExpression>, objectOption: GoPtr<CommandLineOption>, jsonConversionNotifier: GoPtr<jsonConversionNotifier>): [GoPtr<OrderedMap<string, unknown>>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function convertToJson(sourceFile: GoPtr<SourceFile>, rootExpression: GoPtr<Expression>, returnValue: bool, jsonConversionNotifier: GoPtr<jsonConversionNotifier>): [unknown, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function convertPropertyValueToJson(sourceFile: GoPtr<SourceFile>, valueExpression: GoPtr<Expression>, option: GoPtr<CommandLineOption>, returnValue: bool, jsonConversionNotifier: GoPtr<jsonConversionNotifier>): [unknown, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function ParseJsonConfigFileContent(json: unknown, host: ParseConfigHost, basePath: string, existingOptions: GoPtr<CompilerOptions>, configFileName: string, resolutionStack: GoSlice<Path>, extraFileExtensions: GoSlice<FileExtensionInfo>, extendedConfigCache: GoPtr<ExtendedConfigCache>): GoPtr<ParsedCommandLine>;
/**
 ...
 * }
 */
export declare function convertToObject(sourceFile: GoPtr<SourceFile>): [unknown, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function getDefaultCompilerOptions(configFileName: string): GoPtr<CompilerOptions>;
/**
 ...
 * }
 */
export declare function getDefaultTypeAcquisition(configFileName: string): GoPtr<TypeAcquisition>;
/**
 ...
 * }
 */
export declare function convertCompilerOptionsFromJsonWorker(jsonOptions: unknown, basePath: string, configFileName: string): [GoPtr<CompilerOptions>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function convertTypeAcquisitionFromJsonWorker(jsonOptions: unknown, basePath: string, configFileName: string): [GoPtr<TypeAcquisition>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function parseOwnConfigOfJson(json: GoPtr<OrderedMap<string, unknown>>, host: ParseConfigHost, basePath: string, configFileName: string): [GoPtr<parsedTsconfig>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function readJsonConfigFile(fileName: string, path: Path, readFile: (fileName: string) => [string, bool]): [GoPtr<TsConfigSourceFile>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function getExtendedConfig(sourceFile: GoPtr<TsConfigSourceFile>, extendedConfigFileName: string, host: ParseConfigHost, resolutionStack: GoSlice<Path>, extendedConfigCache: GoPtr<ExtendedConfigCache>, result: GoPtr<extendsResult>): [GoPtr<parsedTsconfig>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function ParseExtendedConfig(fileName: string, path: Path, resolutionStack: GoSlice<Path>, host: ParseConfigHost, extendedConfigCache: GoPtr<ExtendedConfigCache>): GoPtr<ExtendedConfigCacheEntry>;
/**
 ...
 * }
 */
export declare function parseConfig(json: GoPtr<OrderedMap<string, unknown>>, sourceFile: GoPtr<TsConfigSourceFile>, host: ParseConfigHost, basePath: string, configFileName: string, resolutionStack: GoSlice<Path>, extendedConfigCache: GoPtr<ExtendedConfigCache>): [GoPtr<parsedTsconfig>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 */
export declare const defaultIncludeSpec: string;
/**
 ...
 * }
 */
export declare function parseJsonConfigFileContentWorker(json: GoPtr<OrderedMap<string, unknown>>, sourceFile: GoPtr<TsConfigSourceFile>, host: ParseConfigHost, basePath: string, existingOptions: GoPtr<CompilerOptions>, existingOptionsRaw: GoPtr<OrderedMap<string, unknown>>, configFileName: string, resolutionStack: GoSlice<Path>, extraFileExtensions: GoSlice<FileExtensionInfo>, extendedConfigCache: GoPtr<ExtendedConfigCache>): GoPtr<ParsedCommandLine>;
/**
 ...
 * }
 */
export declare function canJsonReportNoInputFiles(rawConfig: GoPtr<OrderedMap<string, unknown>>): bool;
/**
 ...
 * }
 */
export declare function shouldReportNoInputFiles(fileNames: GoSlice<string>, canJsonReportNoInputFiles: bool, resolutionStack: GoSlice<Path>): bool;
/**
 ...
 * }
 */
export declare function validateSpecs(specs: unknown, disallowTrailingRecursion: bool, jsonSourceFile: GoPtr<SourceFile>, specKey: string): [GoSlice<string>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function specToDiagnostic(spec: string, disallowTrailingRecursion: bool): GoPtr<Message>;
/**
 ...
 * }
 */
export declare function invalidTrailingRecursion(spec: string): bool;
/**
 ...
 * }
 */
export declare function invalidDotDotAfterRecursiveWildcard(s: string): bool;
/**
 ...
 * }
 */
export declare function GetTsConfigPropArrayElementValue(tsConfigSourceFile: GoPtr<SourceFile>, propKey: string, elementValue: string): GoPtr<StringLiteral>;
/**
 ...
 * }
 */
export declare function ForEachTsConfigPropArray<T>(tsConfigSourceFile: GoPtr<SourceFile>, propKey: string, callback: (property: GoPtr<PropertyAssignment>) => GoPtr<T>): GoPtr<T>;
/**
 ...
 * }
 */
export declare function CreateDiagnosticAtReferenceSyntax(config: GoPtr<ParsedCommandLine>, index: int, message: GoPtr<Message>, ...args: Array<unknown>): GoPtr<Diagnostic>;
/**
 ...
 * }
 */
export declare function GetCallbackForFindingPropertyAssignmentByValue(value: string): (property: GoPtr<PropertyAssignment>) => GoPtr<Node>;
/**
 ...
 * }
 */
export declare function GetOptionsSyntaxByArrayElementValue(objectLiteral: GoPtr<ObjectLiteralExpression>, propKey: string, elementValue: string): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function ForEachPropertyAssignment<T>(objectLiteral: GoPtr<ObjectLiteralExpression>, key: string, callback: (property: GoPtr<PropertyAssignment>) => GoPtr<T>, ...key2: Array<string>): GoPtr<T>;
/**
 ...
 * }
 */
export declare function getTsConfigObjectLiteralExpression(tsConfigSourceFile: GoPtr<SourceFile>): GoPtr<ObjectLiteralExpression>;
/**
 ...
 * }
 */
export declare function getSubstitutedPathWithConfigDirTemplate(value: string, basePath: string): string;
/**
 ...
 * }
 */
export declare function getSubstitutedStringArrayWithConfigDirTemplate(list: GoPtr<GoSlice<string>>, basePath: string): GoPtr<GoSlice<string>>;
/**
 ...
 * }
 */
export declare function handleOptionConfigDirTemplateSubstitution(compilerOptions: GoPtr<CompilerOptions>, basePath: string): void;
/**
 ...
 * }
 */
export declare function hasFileWithHigherPriorityExtension(file: string, extensions: GoSlice<GoSlice<string>>, hasFile: (fileName: string) => bool): bool;
/**
 ...
 * }
 */
export declare function removeWildcardFilesWithLowerPriorityExtension(file: string, wildcardFiles: GoPtr<OrderedMap<string, string>>, extensions: GoSlice<GoSlice<string>>, keyMapper: (value: string) => string): void;
/**
 ...
 * }
 */
export declare function getFileNamesFromConfigSpecs(configFileSpecs: configFileSpecs, basePath: string, options: GoPtr<CompilerOptions>, host: FS, extraFileExtensions: GoSlice<FileExtensionInfo>): [GoSlice<string>, int];
/**
 ...
 * }
 */
export declare function GetSupportedExtensions(compilerOptions: GoPtr<CompilerOptions>, extraFileExtensions: GoSlice<FileExtensionInfo>): GoSlice<GoSlice<string>>;
/**
 ...
 * }
 */
export declare function GetSupportedExtensionsWithJsonIfResolveJsonModule(compilerOptions: GoPtr<CompilerOptions>, supportedExtensions: GoSlice<GoSlice<string>>): GoSlice<GoSlice<string>>;
/**
 ...
 * }
 */
export declare function GetParsedCommandLineOfConfigFile(configFileName: string, options: GoPtr<CompilerOptions>, optionsRaw: GoPtr<OrderedMap<string, unknown>>, sys: ParseConfigHost, extendedConfigCache: GoPtr<ExtendedConfigCache>): [GoPtr<ParsedCommandLine>, GoSlice<GoPtr<Diagnostic>>];
/**
 ...
 * }
 */
export declare function GetParsedCommandLineOfConfigFilePath(configFileName: string, path: Path, options: GoPtr<CompilerOptions>, optionsRaw: GoPtr<OrderedMap<string, unknown>>, sys: ParseConfigHost, extendedConfigCache: GoPtr<ExtendedConfigCache>): [GoPtr<ParsedCommandLine>, GoSlice<GoPtr<Diagnostic>>];
//# sourceMappingURL=tsconfigparsing.d.ts.map