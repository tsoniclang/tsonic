 ...
 * )
 */
export const fileGlobPattern = "*.{js,jsx,mjs,cjs,ts,tsx,mts,cts,json}";
export const recursiveFileGlobPattern = "**/*.{js,jsx,mjs,cjs,ts,tsx,mts,cts,json}";
...
export function ParsedCommandLine_as_ResolvedProjectReference(receiver) {
    const p = receiver;
    return {
        ConfigName: () => ParsedCommandLine_ConfigName(p),
        CompilerOptions: () => ParsedCommandLine_CompilerOptions(p),
    };
}
...
// corresponding free function (Go interface satisfaction -> method-bearing adapter).
function ParsedCommandLine_as_OutputPathsHost(receiver) {
    const p = receiver;
    return {
        CommonSourceDirectory: () => ParsedCommandLine_CommonSourceDirectory(p),
        GetCurrentDirectory: () => ParsedCommandLine_GetCurrentDirectory(p),
        UseCaseSensitiveFileNames: () => ParsedCommandLine_UseCaseSensitiveFileNames(p),
    };
}
/**
 ...
 * }
 */
export function NewParsedCommandLine(compilerOptions, rootFileNames, comparePathsOptions) {
 ...
 * )
 */
export const ____696f5a2e_0 = ParsedCommandLine_as_ResolvedProjectReference(undefined);
export const ____696f5a2e_1 = ParsedCommandLine_as_OutputPathsHost(undefined);
/**
 ...
 * }
 */
export function ParsedCommandLine_ConfigName(receiver) {
 ...
 * }
 */
export function ParsedCommandLine_SourceToProjectReference(receiver) {
 ...
 * }
 */
export function ParsedCommandLine_OutputDtsToProjectReference(receiver) {
 ...
 * }
 */
export function ParsedCommandLine_ParseInputOutputNames(receiver) {
    const p = receiver;
    p.sourceAndOutputMapsOnce.Do(() => {
        const sourceToOutput = new globalThis.Map();
        const outputDtsToSource = new globalThis.Map();
        ParsedCommandLine_getOutputDeclarationAndSourceFileNames(p)((outputDts, source) => {
 ...
 * }
 */
export function ParsedCommandLine_CommonSourceDirectory(receiver) {
    const p = receiver;
    p.commonSourceDirectoryOnce.Do(() => {
        p.commonSourceDirectory = GetCommonSourceDirectory(p.ParsedConfig.CompilerOptions, () => {
            return Filter(p.ParsedConfig.FileNames, (file) => {
                return !(Tristate_IsTrue(p.ParsedConfig.CompilerOptions.NoEmitForJsFiles) && HasJSFileExtension(file)) &&
                    !IsDeclarationFileName(file);
            });
        }, ParsedCommandLine_GetCurrentDirectory(p), ParsedCommandLine_UseCaseSensitiveFileNames(p), (sourceFiles, rootDirectory) => ParsedCommandLine_checkSourceFilesBelongToPath(p, sourceFiles, rootDirectory));
    });
    return p.commonSourceDirectory;
}
/**
 ...
 * }
 */
export function ParsedCommandLine_checkSourceFilesBelongToPath(receiver, sourceFiles, rootDirectory) {
    const p = receiver;
 ...
 * }
 */
export function ParsedCommandLine_GetCurrentDirectory(receiver) {
 ...
 * }
 */
export function ParsedCommandLine_UseCaseSensitiveFileNames(receiver) {
 ...
 * }
 */
export function ParsedCommandLine_getOutputDeclarationAndSourceFileNames(receiver) {
    const p = receiver;
    return (yield_) => {
 ...
 * }
 */
export function ParsedCommandLine_GetOutputFileNames(receiver) {
    const p = receiver;
    return (yield_) => {
        for (const fileName of p.ParsedConfig.FileNames) {
 ...
 * }
 */
export function ParsedCommandLine_GetBuildInfoFileName(receiver) {
    const p = receiver;
 ...
 * }
 */
export function ParsedCommandLine_WildcardDirectories(receiver) {
    if (receiver === undefined) {
        return new globalThis.Map();
    }
    const p = receiver;
    p.wildcardDirectoriesOnce.Do(() => {
        if (p.wildcardDirectories.size === 0) {
            p.wildcardDirectories = getWildcardDirectories(p.ConfigFile.configFileSpecs.validatedIncludeSpecs, p.ConfigFile.configFileSpecs.validatedExcludeSpecs, p.comparePathsOptions);
        }
    });
    return p.wildcardDirectories;
}
 ...
 * }
 */
export function ParsedCommandLine_LiteralFileNames(receiver) {
 ...
 * }
 */
export function ParsedCommandLine_SetParsedOptions(receiver, o) {
 ...
 * }
 */
export function ParsedCommandLine_SetCompilerOptions(receiver, o) {
 ...
 * }
 */
export function ParsedCommandLine_CompilerOptions(receiver) {
    const p = receiver;
    if (p === undefined) {
        return undefined;
    }
 ...
 * }
 */
export function ParsedCommandLine_SetTypeAcquisition(receiver, o) {
 ...
 * }
 */
export function ParsedCommandLine_TypeAcquisition(receiver) {
 ...
 * }
 */
export function ParsedCommandLine_FileNames(receiver) {
 ...
 * }
 */
export function ParsedCommandLine_FileNamesByPath(receiver) {
    const p = receiver;
    p.fileNamesByPathOnce.Do(() => {
        p.fileNamesByPath = new globalThis.Map();
        for (const fileName of p.ParsedConfig.FileNames) {
 ...
 * }
 */
export function ParsedCommandLine_ProjectReferences(receiver) {
 ...
 * }
 */
export function ParsedCommandLine_ResolvedProjectReferencePaths(receiver) {
    const p = receiver;
    p.resolvedProjectReferencePathsOnce.Do(() => {
 ...
 * }
 */
export function ParsedCommandLine_ExtendedSourceFiles(receiver) {
    if (receiver === undefined || receiver.ConfigFile === undefined) {
        return [];
    }
 ...
 * }
 */
export function ParsedCommandLine_GetConfigFileParsingDiagnostics(receiver) {
    const p = receiver;
 ...
 * }
 */
export function ParsedCommandLine_PossiblyMatchesFileName(receiver, fileName) {
    const p = receiver;
    const path = ToPath(fileName, ParsedCommandLine_GetCurrentDirectory(p), ParsedCommandLine_UseCaseSensitiveFileNames(p));
 ...
 * }
 */
export function ParsedCommandLine_PossiblyMatchesDirectoryName(receiver, directoryPath) {
    const p = receiver;
 ...
 * }
 */
export function ParsedCommandLine_GetMatchedFileSpec(receiver, fileName) {
    const p = receiver;
 ...
 * }
 */
export function ParsedCommandLine_GetMatchedIncludeSpec(receiver, fileName) {
    const p = receiver;
 ...
 * }
 */
export function ParsedCommandLine_ReloadFileNamesOfParsedCommandLine(receiver, fs) {
    const p = receiver;
    const parsedConfig = { ...p.ParsedConfig };
    const [fileNames, literalFileNamesLen] = getFileNamesFromConfigSpecs({ ...p.ConfigFile.configFileSpecs }, ParsedCommandLine_GetCurrentDirectory(p), ParsedCommandLine_CompilerOptions(p), fs, p.extraFileExtensions);
    parsedConfig.FileNames = fileNames;
 ...
 * }
 */
export function ParsedCommandLine_Locale(receiver) {
    const p = receiver;
    p.localeOnce.Do(() => {
...
//# sourceMappingURL=parsedcommandline.js.map