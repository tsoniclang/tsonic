 ...
 * }
 */
export declare function createDiagnosticForInvalidEnumType(opt: GoPtr<CommandLineOption>, sourceFile: GoPtr<SourceFile>, node: GoPtr<Node>): GoPtr<Diagnostic>;
/**
 ...
 * }
 */
export declare function formatEnumTypeKeys(opt: GoPtr<CommandLineOption>, keys: GoSlice<string>): string;
/**
 ...
 * }
 */
export declare function getCompilerOptionValueTypeString(option: GoPtr<CommandLineOption>): string;
/**
 ...
 * }
 */
export declare function commandLineParser_createUnknownOptionError(receiver: GoPtr<commandLineParser>, unknownOption: string, unknownOptionErrorText: string, node: GoPtr<Node>, sourceFile: GoPtr<SourceFile>): GoPtr<Diagnostic>;
/**
 ...
 * }
 */
export declare function createUnknownOptionError(unknownOption: string, unknownOptionDiagnostic: GoPtr<Message>, unknownOptionErrorText: string, node: GoPtr<Node>, sourceFile: GoPtr<SourceFile>, alternateMode: GoPtr<AlternateModeDiagnostics>): GoPtr<Diagnostic>;
/**
 ...
 * }
 */
export declare function CreateDiagnosticForNodeInSourceFile(sourceFile: GoPtr<SourceFile>, node: GoPtr<Node>, message: GoPtr<Message>, ...args: Array<unknown>): GoPtr<Diagnostic>;
/**
 ...
 * }
 */
export declare function CreateDiagnosticForNodeInSourceFileOrCompilerDiagnostic(sourceFile: GoPtr<SourceFile>, node: GoPtr<Node>, message: GoPtr<Message>, ...args: Array<unknown>): GoPtr<Diagnostic>;
/**
 ...
 * }
 */
export declare function extraKeyDiagnostics(s: string): GoPtr<Message>;
/**
 ...
 * }
 */
export declare function extraKeyDidYouMeanDiagnostics(s: string): GoPtr<Message>;
