 ...
 * }
 */
export declare const OptionsForBuild: GoSlice<GoPtr<CommandLineOption>>;
/**
 ...
 */
export declare const BuildOpts: GoSlice<GoPtr<CommandLineOption>>;
//# sourceMappingURL=declsbuild.d.ts.map