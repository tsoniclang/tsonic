...
import { NewOrderedMapFromList, OrderedMap_Get, OrderedMap_Keys, OrderedMap_Values, } from "../collections/ordered_map.js";
import { NewSetFromItems, Set_Has } from "../collections/set.js";
import * as core from "../core/core.js";
import { CompilerOptions_GetEmitScriptTarget, JsxEmitPreserve, JsxEmitReact, JsxEmitReactJSX, JsxEmitReactJSXDev, JsxEmitReactNative, ModuleDetectionKindAuto, ModuleDetectionKindForce, ModuleDetectionKindLegacy, ModuleKindAMD, ModuleKindCommonJS, ModuleKindES2015, ModuleKindES2020, ModuleKindES2022, ModuleKindESNext, ModuleKindNode16, ModuleKindNode18, ModuleKindNode20, ModuleKindNodeNext, ModuleKindPreserve, ModuleKindSystem, ModuleKindUMD, ModuleResolutionKindBundler, ModuleResolutionKindClassic, ModuleResolutionKindNode10, ModuleResolutionKindNode16, ModuleResolutionKindNodeNext, NewLineKindCRLF, NewLineKindLF, ScriptTargetES2015, ScriptTargetES2016, ScriptTargetES2017, ScriptTargetES2018, ScriptTargetES2019, ScriptTargetES2020, ScriptTargetES2021, ScriptTargetES2022, ScriptTargetES2023, ScriptTargetES2024, ScriptTargetES2025, ScriptTargetES5, ScriptTargetESNext, } from "../core/compileroptions.js";
import { PollingKindDynamicPriority, PollingKindFixedChunkSize, PollingKindFixedInterval, PollingKindPriorityInterval, WatchDirectoryKindDynamicPriorityPolling, WatchDirectoryKindFixedChunkSizePolling, WatchDirectoryKindFixedPollingInterval, WatchDirectoryKindUseFsEvents, WatchFileKindDynamicPriorityPolling, WatchFileKindFixedChunkSizePolling, WatchFileKindFixedPollingInterval, WatchFileKindPriorityPollingInterval, WatchFileKindUseFsEvents, WatchFileKindUseFsEventsOnParentDirectory, } from "../core/watchoptions.js";
 ...
 * })
 */
export const LibMap = NewOrderedMapFromList([
    // JavaScript only
    { Key: "es5", Value: "lib.es5.d.ts" },
    { Key: "es6", Value: "lib.es2015.d.ts" },
    { Key: "es2015", Value: "lib.es2015.d.ts" },
 ...
 * )
 */
export const Libs = slices.Collect(OrderedMap_Keys(LibMap));
export const LibFilesSet = NewSetFromItems(...core.Map(slices.Collect(OrderedMap_Values(LibMap)), (s) => {
    return s;
}));
/**
 ...
 * }
 */
export function GetLibFileName(libName) {
    // checks if the libName is a valid lib name or file name and converts the lib name to the filename if needed
 ...
 * })
 */
export const moduleResolutionOptionMap = NewOrderedMapFromList([
 ...
 * })
 */
export const targetOptionMap = NewOrderedMapFromList([
 ...
 * })
 */
export const moduleOptionMap = NewOrderedMapFromList([
 ...
 * })
 */
export const moduleDetectionOptionMap = NewOrderedMapFromList([
 ...
 * })
 */
export const jsxOptionMap = NewOrderedMapFromList([
 ...
 * })
 */
export const newLineOptionMap = NewOrderedMapFromList([
 ...
 * }
 */
export const targetToLibMap = new globalThis.Map([
 ...
 * }
 */
export function TargetToLibMap() {
    return targetToLibMap;
}
/**
...
export function GetDefaultLibFileName(options) {
    ...
    const name = targetToLibMap.get(key);
    if (!ok) {
        return "lib.d.ts";
    }
    return name;
 ...
 * })
 */
export const watchFileEnumMap = NewOrderedMapFromList([
 ...
 * })
 */
export const watchDirectoryEnumMap = NewOrderedMapFromList([
 ...
 * })
 */
export const fallbackEnumMap = NewOrderedMapFromList([
