 ...
 * }
 */
export declare function parseStringMap(value: unknown): GoPtr<OrderedMap>;
/**
 ...
 * }
 */
export declare function parseJsonToStringKey(json: unknown): GoPtr<OrderedMap>;
/**
 ...
 * }
 */
export declare function floatOrInt32ToFlag<T>(value: unknown): T;
/**
 ...
 * }
 */
export declare function convertToOptionsWithAbsolutePaths(optionsBase: GoPtr<OrderedMap>, optionMap: CommandLineOptionNameMap, cwd: string): GoPtr<OrderedMap>;
/**
