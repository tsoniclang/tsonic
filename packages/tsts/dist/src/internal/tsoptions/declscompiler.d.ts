 ...
 */
export declare let OptionsDeclarations: GoSlice<GoPtr<CommandLineOption>>;
/**
 ...
 * }
 */
export declare const commonOptionsWithBuild: GoSlice<GoPtr<CommandLineOption>>;
/**
 ...
 * }
 */
export declare const optionsForCompiler: GoSlice<GoPtr<CommandLineOption>>;
/**
 ...
 */
export declare const optionsType: ReadonlyMap<string, GoPtr<CommandLineOption>>;
/**
 ...
 * }
 */
export declare function optionsHaveChanges(oldOptions: GoPtr<CompilerOptions>, newOptions: GoPtr<CompilerOptions>, declFilter: (arg0: GoPtr<CommandLineOption>) => bool): bool;
/**
 ...
 * }
 */
export declare function ForEachCompilerOptionValue(options: GoPtr<CompilerOptions>, declFilter: (arg0: GoPtr<CommandLineOption>) => bool, fn: (option: GoPtr<CommandLineOption>, value: Value, i: int) => bool): bool;
/**
 ...
 * }
 */
export declare function CompilerOptionsAffectSemanticDiagnostics(oldOptions: GoPtr<CompilerOptions>, newOptions: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptionsAffectDeclarationPath(oldOptions: GoPtr<CompilerOptions>, newOptions: GoPtr<CompilerOptions>): bool;
/**
 ...
 * }
 */
export declare function CompilerOptionsAffectEmit(oldOptions: GoPtr<CompilerOptions>, newOptions: GoPtr<CompilerOptions>): bool;
//# sourceMappingURL=declscompiler.d.ts.map