...
export let CompilerNameMap = undefined;
export let BuildNameMap = undefined;
export let WatchNameMap = undefined;
/**
 ...
 * }
 */
export function GetNameMapFromList(optDecls) {
    const optionsNames = NewOrderedMapWithSizeHint(optDecls.length);
    const shortOptionNames = new globalThis.Map();
 ...
 * }
 */
export function NameMap_Get(receiver, name) {
    const nm = receiver;
    return OrderedMap_GetOrZero(nm.optionsNames, strings.ToLower(name));
}
/**
 ...
 * }
 */
export function NameMap_GetFromShort(receiver, shortName) {
    const nm = receiver;
    // returns option only if shortName is a valid short option
 ...
 * }
 */
export function NameMap_GetOptionDeclarationFromName(receiver, optionName, allowShort) {
    const nm = receiver;
