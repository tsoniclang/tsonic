...
import { CommandLineOptionTypeNumber, extraValidationNone, newCommandLineOption, } from "./commandlineoption.js";
 ...
 * }
 */
export const TscBuildOption = newCommandLineOption({
    Name: "build",
    Kind: "boolean",
    ShortName: "b",
    ShowInSimplifiedHelpView: true,
 ...
 */
export const BuildOpts = Concat(commonOptionsWithBuild, OptionsForBuild);
//# sourceMappingURL=declsbuild.js.map