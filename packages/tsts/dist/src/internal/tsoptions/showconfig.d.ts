 ...
 * }
 */
export declare function getNameOfCompilerOptionValue(value: unknown, enumMap: GoPtr<OrderedMap>): string;
/**
 ...
 * }
 */
export declare function serializeCompilerOptions(options: GoPtr<CompilerOptions>, configFilePath: string, comparePathsOptions: ComparePathsOptions): GoPtr<OrderedMap>;
/**
 ...
 * }
 */
export declare function serializeEnumValue(value: unknown, enumMap: GoPtr<OrderedMap>): string;
/**
 ...
 * }
 */
export declare function addImpliedOptions(optionMap: GoPtr<OrderedMap>, options: GoPtr<CompilerOptions>, arg: string, arg1: ComparePathsOptions): void;
/**
