 ...
 * }
 */
export declare function ASTDiagnostic_RelatedInformation(receiver: GoPtr<ASTDiagnostic>): GoSlice<Diagnostic>;
/**
 ...
 * }
 */
export declare function ASTDiagnostic_File(receiver: GoPtr<ASTDiagnostic>): FileLike;
/**
 ...
 * }
 */
export declare function ASTDiagnostic_MessageChain(receiver: GoPtr<ASTDiagnostic>): GoSlice<Diagnostic>;
/**
 ...
 * }
 */
export declare function WrapASTDiagnostic(d: GoPtr<Diagnostic_34a9f76f>): GoPtr<ASTDiagnostic>;
/**
 ...
 * }
 */
export declare function WrapASTDiagnostics(diags: GoSlice<GoPtr<Diagnostic_34a9f76f>>): GoSlice<GoPtr<ASTDiagnostic>>;
/**
 ...
 * }
 */
export declare function FromASTDiagnostics(diags: GoSlice<GoPtr<Diagnostic_34a9f76f>>): GoSlice<Diagnostic>;
/**
 ...
 * }
 */
export declare function ToDiagnostics<T extends Diagnostic>(diags: GoSlice<T>): GoSlice<Diagnostic>;
/**
 ...
 * }
 */
export declare function CompareASTDiagnostics(a: GoPtr<ASTDiagnostic>, b: GoPtr<ASTDiagnostic>): int;
/**
 ...
 * )
 */
export declare const foregroundColorEscapeGrey: string;
export declare const foregroundColorEscapeRed: string;
export declare const foregroundColorEscapeYellow: string;
export declare const foregroundColorEscapeBlue: string;
export declare const foregroundColorEscapeCyan: string;
/**
 ...
 * )
 */
export declare const gutterStyleSequence: string;
export declare const gutterSeparator: string;
export declare const resetEscapeSequence: string;
 ...
 * }
 */
export declare function FormatDiagnosticsWithColorAndContext(output: Writer, diags: GoSlice<Diagnostic>, formatOpts: GoPtr<FormattingOptions>): void;
/**
 ...
 * }
 */
export declare function FormatDiagnosticWithColorAndContext(output: Writer, diagnostic: Diagnostic, formatOpts: GoPtr<FormattingOptions>): void;
/**
 ...
 * }
 */
export declare function writeCodeSnippet(writer: Writer, sourceFile: FileLike, start: int, length: int, squiggleColor: string, indent: string, formatOpts: GoPtr<FormattingOptions>): void;
/**
 ...
 * }
 */
export declare function FlattenDiagnosticMessage(d: Diagnostic, newLine: string, locale: Locale): string;
/**
 ...
 * }
 */
export declare function WriteFlattenedASTDiagnosticMessage(writer: Writer, diagnostic: GoPtr<Diagnostic_34a9f76f>, newline: string, locale: Locale): void;
/**
 ...
 * }
 */
export declare function WriteFlattenedDiagnosticMessage(writer: Writer, diagnostic: Diagnostic, newline: string, locale: Locale): void;
/**
 ...
 * }
 */
export declare function flattenDiagnosticMessageChain(writer: Writer, chain: Diagnostic, newLine: string, locale: Locale, level: int): void;
/**
 ...
 * }
 */
export declare function getCategoryFormat(category: Category): string;
/**
 ...
 * }
 */
export declare function writeWithStyleAndReset(output: Writer, text: string, formatStyle: string): void;
/**
 ...
 * }
 */
export declare function WriteLocation(output: Writer, file: FileLike, pos: int, formatOpts: GoPtr<FormattingOptions>, writeWithStyleAndReset: FormattedWriter): void;
/**
 ...
 * }
 */
export declare function WriteErrorSummaryText(output: Writer, allDiagnostics: GoSlice<Diagnostic>, formatOpts: GoPtr<FormattingOptions>): void;
/**
 ...
 * }
 */
export declare function getErrorSummary(diags: GoSlice<Diagnostic>): GoPtr<ErrorSummary>;
/**
 ...
 * }
 */
export declare function writeTabularErrorsDisplay(output: Writer, errorSummary: GoPtr<ErrorSummary>, formatOpts: GoPtr<FormattingOptions>): void;
/**
 ...
 * }
 */
export declare function prettyPathForFileError(file: FileLike, fileErrors: GoSlice<Diagnostic>, formatOpts: GoPtr<FormattingOptions>): string;
/**
 ...
 * }
 */
export declare function WriteFormatDiagnostics(output: Writer, diagnostics: GoSlice<Diagnostic>, formatOpts: GoPtr<FormattingOptions>): void;
/**
 ...
 * }
 */
export declare function WriteFormatDiagnostic(output: Writer, diagnostic: Diagnostic, formatOpts: GoPtr<FormattingOptions>): void;
/**
 ...
 * }
 */
export declare function FormatDiagnosticsStatusWithColorAndTime(output: Writer, time: string, diag: Diagnostic, formatOpts: GoPtr<FormattingOptions>): void;
/**
 ...
 * }
 */
export declare function FormatDiagnosticsStatusAndTime(output: Writer, time: string, diag: Diagnostic, formatOpts: GoPtr<FormattingOptions>): void;
/**
 ...
 * }
 */
export declare let ScreenStartingCodes: GoSlice<int>;
/**
 ...
 * }
 */
export declare function TryClearScreen(output: Writer, diag: Diagnostic, options: GoPtr<CompilerOptions>): bool;
