import type { bool, long } from "../../go/scalars.js";
 ...
 * const embedded = true
 */
export declare const embedded: bool;
/**
 ...
 * }
 */
export declare function splitPath(path: string): [string, bool];
/**
 ...
 * }
 */
export declare function libPath(): string;
/**
 ...
 * }
 */
export declare function IsBundled(path: string): bool;
/**
 ...
 */
export declare let __eb693fb3_0: FS;
export declare function wrappedFS_as_vfs_FS(receiver: GoPtr<wrappedFS>): FS;
/**
 ...
 * }
 */
export declare function wrapFS(fsArg: FS): FS;
/**
 ...
 * }
 */
export declare function wrappedFS_UseCaseSensitiveFileNames(receiver: GoPtr<wrappedFS>): bool;
/**
 ...
 * }
 */
export declare function wrappedFS_FileExists(receiver: GoPtr<wrappedFS>, path: string): bool;
/**
 ...
 * }
 */
export declare function wrappedFS_ReadFile(receiver: GoPtr<wrappedFS>, path: string): [string, bool];
/**
 ...
 * }
 */
export declare function wrappedFS_DirectoryExists(receiver: GoPtr<wrappedFS>, path: string): bool;
/**
 ...
 * }
 */
export declare function wrappedFS_GetAccessibleEntries(receiver: GoPtr<wrappedFS>, path: string): Entries;
/**
 ...
 * }
 */
export declare let rootEntries: GoSlice<DirEntry>;
export declare let libsEntries: GoSlice<DirEntry>;
/**
 ...
 * }
 */
export declare function wrappedFS_Stat(receiver: GoPtr<wrappedFS>, path: string): GoPtr<FileInfo>;
/**
 ...
 * }
 */
export declare function wrappedFS_WalkDir(receiver: GoPtr<wrappedFS>, root: string, walkFn: WalkDirFunc): GoError;
/**
 ...
 * }
 */
export declare function wrappedFS_walkDir(receiver: GoPtr<wrappedFS>, rest: string, walkFn: WalkDirFunc): GoError;
/**
 ...
 * }
 */
export declare function wrappedFS_Realpath(receiver: GoPtr<wrappedFS>, path: string): string;
/**
 ...
 * }
 */
export declare function wrappedFS_WriteFile(receiver: GoPtr<wrappedFS>, path: string, data: string): GoError;
/**
 ...
 * }
 */
export declare function wrappedFS_AppendFile(receiver: GoPtr<wrappedFS>, path: string, data: string): GoError;
/**
 ...
 * }
 */
export declare function wrappedFS_Remove(receiver: GoPtr<wrappedFS>, path: string): GoError;
/**
 ...
 * }
 */
export declare function wrappedFS_Chtimes(receiver: GoPtr<wrappedFS>, path: string, aTime: Time, mTime: Time): GoError;
/**
 ...
 * )
 */
export declare let ____85348954_0: FileInfo_2d3efe16;
export declare let ____85348954_1: DirEntry;
export declare function fileInfo_as_io_fs_FileInfo(receiver: GoPtr<fileInfo>): FileInfo_2d3efe16;
export declare function fileInfo_as_io_fs_DirEntry(receiver: GoPtr<fileInfo>): DirEntry;
/**
 ...
 * }
 */
export declare function fileInfo_IsDir(receiver: GoPtr<fileInfo>): bool;
/**
 ...
 * }
 */
export declare function fileInfo_ModTime(_receiver: GoPtr<fileInfo>): Time;
/**
 ...
 * }
 */
export declare function fileInfo_Mode(receiver: GoPtr<fileInfo>): FileMode;
/**
 ...
 * }
 */
export declare function fileInfo_Size(receiver: GoPtr<fileInfo>): long;
/**
 ...
 * }
 */
export declare function fileInfo_Sys(_receiver: GoPtr<fileInfo>): unknown;
/**
 ...
 * }
 */
export declare function fileInfo_Info(receiver: GoPtr<fileInfo>): [FileInfo_2d3efe16, GoError];
/**
 ...
 * }
 */
export declare function fileInfo_Type(receiver: GoPtr<fileInfo>): FileMode;
