...
const generatedBundledHeaderPattern = /^\/\/ Code generated by TSTS bundled generator\. DO NOT EDIT\.\r?\n\/\/ @tsgo-generated {[^}\r\n]+}\r?\n\r?\n/;
const embeddedContentCache = new globalThis.Map();
let embeddedLibRootValue;
function embeddedLibRoot() {
...
function hasEmbeddedContent(rest) {
    return embeddedContentNames.has(rest);
}
function readEmbeddedContent(rest) {
...
function embeddedContentSize(rest) {
    return (embeddedContentSizes.get(rest) ?? 0);
}
/**
...
export function wrappedFS_Stat(receiver, path) {
    ...
    if (ok) {
        ...
        if (hasEmbeddedContent(rest)) {
            ...
            return fileInfo_as_io_fs_FileInfo({ name: libName, mode: 0, size: embeddedContentSize(rest) });
        }
        return undefined;
    }
