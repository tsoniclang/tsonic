 ...
 * }
 */
export declare function WrapFS(fs: FS): FS;
/**
 ...
 * })
 */
export declare const bundledSourceDir: () => string;
/**
 ...
 * })
 */
export declare const testingLibPath: () => string;
/**
 ...
 * }
 */
export declare function TestingLibPath(): string;
