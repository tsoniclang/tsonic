...
import { IsComputedPropertyName, IsCallSignatureDeclaration, IsConditionalTypeNode, IsConstructSignatureDeclaration, IsConstructorTypeNode, IsIdentifier, IsExpressionWithTypeArguments, IsFunctionTypeNode, IsImportTypeNode, IsIndexedAccessTypeNode, IsIndexSignatureDeclaration, IsJSDocAllType, IsJSDocNonNullableType, IsJSDocNullableType, IsJSDocOptionalType, IsJSDocSignature, IsJSDocParameterTag, IsJSDocTypeExpression, IsJSDocTypeLiteral, IsJSDocVariadicType, IsMappedTypeNode, IsMethodSignatureDeclaration, IsPropertyDeclaration, IsPropertySignatureDeclaration, IsParameterDeclaration, IsQualifiedName, IsStringLiteral, IsThisTypeNode, IsTupleTypeNode, IsTypeLiteralNode, IsTypeOperatorNode, IsTypeParameterDeclaration, IsTypePredicateNode, IsTypeQueryNode, IsTypeReferenceNode, } from "../ast/generated/predicates.js";
...
import { classifyPropertyName, NodeBuilderImpl_checkTypeExpandability, NodeBuilderImpl_getTypeFromTypeNode, NodeBuilderImpl_newIdentifier, NodeBuilderImpl_serializeTypeName, NodeBuilderImpl_setTextRange, NodeBuilderImpl_typeParameterToName, NodeBuilderImpl_typeToTypeNode, propertyNameNodeKindIdentifier, propertyNameNodeKindStringLiteral, } from "./nodebuilderimpl.js";
 ...
 * }
 */
export function NodeBuilderImpl_reuseNode(receiver, node) {
    if (node === undefined) {
        return node;
    }
 ...
 * }
 */
export function NodeBuilderImpl_tryJSTypeNodeToTypeNode(receiver, node) {
 ...
 * }
 */
export function NodeBuilderImpl_reuseName(receiver, node, isMethod) {
 ...
 * }
 */
export function NodeBuilderImpl_reuseTypeNode(receiver, node) {
    if (node === undefined) {
        return node;
    }
 ...
 * }
 */
export function NodeBuilderImpl_walkNodeForExpandability(receiver, node) {
 ...
 * }
 */
export function recoveryBoundary_markError(receiver, f) {
 ...
 * }
 */
export function recoveryBoundary_startRecoveryScope(receiver) {
    const trackedSymbolsTop = receiver.ctx.trackedSymbols.length;
    const unreportedErrorsTop = receiver.deferredReports.length;
 ...
 * }
 */
export function recoveryBoundary_endRecoveryScope(receiver, state) {
 ...
 * }
 */
export function wrappingTracker_PopErrorFallbackNode(receiver) {
 ...
 * }
 */
export function wrappingTracker_PushErrorFallbackNode(receiver, node) {
 ...
 * }
 */
export function wrappingTracker_ReportCyclicStructureError(receiver) {
 ...
 * }
 */
export function wrappingTracker_ReportInaccessibleThisError(receiver) {
    recoveryBoundary_markError(receiver.bound, () => {
 ...
 * }
 */
export function wrappingTracker_ReportInaccessibleUniqueSymbolError(receiver) {
    recoveryBoundary_markError(receiver.bound, () => {
 ...
 * }
 */
export function wrappingTracker_ReportInferenceFallback(receiver, node) {
 ...
 * }
 */
export function wrappingTracker_ReportLikelyUnsafeImportRequiredError(receiver, specifier, symbolName) {
    recoveryBoundary_markError(receiver.bound, () => {
 ...
 * }
 */
export function wrappingTracker_ReportNonSerializableProperty(receiver, propertyName) {
    recoveryBoundary_markError(receiver.bound, () => {
 ...
 * }
 */
export function wrappingTracker_ReportNonlocalAugmentation(receiver, containingFile, parentSymbol, augmentingSymbol) {
 ...
 * }
 */
export function wrappingTracker_ReportPrivateInBaseOfClassExpression(receiver, propertyName) {
    recoveryBoundary_markError(receiver.bound, () => {
 ...
 * }
 */
export function wrappingTracker_ReportTruncationError(receiver) {
 ...
 * }
 */
export function wrappingTracker_TrackSymbol(receiver, symbol_, enclosingDeclaration, meaning) {
    const arg = { "symbol": symbol_, enclosingDeclaration: enclosingDeclaration, meaning: meaning };
 ...
 * }
 */
export function newWrappingTracker(inner, bound) {
    return {
        wrapped: inner,
        bound: bound,
    };
}
export function wrappingTracker_as_SymbolTracker(receiver) {
    if (receiver === undefined) {
        return undefined;
    }
    return {
        TrackSymbol: (symbol_, enclosingDeclaration, meaning) => wrappingTracker_TrackSymbol(receiver, symbol_, enclosingDeclaration, meaning),
        ReportInaccessibleThisError: () => wrappingTracker_ReportInaccessibleThisError(receiver),
        ReportPrivateInBaseOfClassExpression: (propertyName) => wrappingTracker_ReportPrivateInBaseOfClassExpression(receiver, propertyName),
        ReportInaccessibleUniqueSymbolError: () => wrappingTracker_ReportInaccessibleUniqueSymbolError(receiver),
        ReportCyclicStructureError: () => wrappingTracker_ReportCyclicStructureError(receiver),
        ReportLikelyUnsafeImportRequiredError: (specifier, symbolName) => wrappingTracker_ReportLikelyUnsafeImportRequiredError(receiver, specifier, symbolName),
        ReportTruncationError: () => wrappingTracker_ReportTruncationError(receiver),
        ReportNonlocalAugmentation: (containingFile, parentSymbol, augmentingSymbol) => wrappingTracker_ReportNonlocalAugmentation(receiver, containingFile, parentSymbol, augmentingSymbol),
        ReportNonSerializableProperty: (propertyName) => wrappingTracker_ReportNonSerializableProperty(receiver, propertyName),
        ReportInferenceFallback: (node) => wrappingTracker_ReportInferenceFallback(receiver, node),
        PushErrorFallbackNode: (node) => wrappingTracker_PushErrorFallbackNode(receiver, node),
        PopErrorFallbackNode: () => wrappingTracker_PopErrorFallbackNode(receiver),
    };
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_createRecoveryBoundary(receiver) {
 ...
 * }
 */
export function NodeBuilderImpl_finalizeBoundary(receiver, bound) {
 ...
 * }
 */
export function NodeBuilderImpl_tryReuseExistingNodeHelper(receiver, existing) {
    const b = receiver;
    const bound = NodeBuilderImpl_createRecoveryBoundary(b);
    const visitor = getExistingNodeTreeVisitor(b, bound);
    const transformed = NodeVisitor_VisitNode(visitor, existing);
 ...
 * }
 */
export function NodeBuilderImpl_getModuleSpecifierOverride(receiver, parent, lit) {
    if (receiver.ctx.enclosingFile !== GetSourceFileOfNode(lit)) {
        ...
        const nodeSymbol = LinkStore_Get(receiver.ch.symbolNodeLinks, parent).resolvedSymbol;
        let meaning = SymbolFlagsType;
 ...
 * }
 */
export function NodeBuilderImpl_rewriteModuleSpecifier(receiver, parent, lit) {
 ...
 * }
 */
export function getExistingNodeTreeVisitor(b, bound) {
    let visitor;
    const asNodeVisitor = () => visitor;
    const visitNode = (node) => NodeVisitor_VisitNode(asNodeVisitor(), node);
    const visitNodes = (nodes) => NodeVisitor_VisitNodes(asNodeVisitor(), nodes);
    const visitModifiers = (nodes) => NodeVisitor_VisitModifiers(asNodeVisitor(), nodes);
    const visitEachChild = (node) => Node_VisitEachChild(node, asNodeVisitor());
    const attachSymbolToLeftmostIdentifier = (leftmost, node, sym) => {
        let vis;
        const visitorFunc = (current) => {
            if (current === leftmost) {
                let type_ = undefined;
                let name = undefined;
                if (sym !== undefined) {
    ...
    const trackExistingEntityName = (node, overrideEnclosing) => {
    ...
    let tryVisitSimpleTypeNode;
    const tryVisitIndexedAccess = (node) => {
        ...
        return NodeBuilderImpl_setTextRange(b, NodeFactory_UpdateIndexedAccessTypeNode(b.f, indexed, resultObjectType, visitNode(indexed.IndexType)), node);
    };
    const tryVisitKeyOf = (node) => {
    ...
    const tryVisitTypeQuery = (node) => {
        const typeQuery = AsTypeQueryNode(node);
        const [introducesError, exprName] = trackExistingEntityName(typeQuery.ExprName, undefined);
        if (!introducesError) {
            return NodeBuilderImpl_setTextRange(b, NodeFactory_UpdateTypeQueryNode(b.f, typeQuery, exprName, visitNodes(typeQuery.TypeArguments)), node);
        }
    ...
    const tryVisitTypeReference = (node) => {
        if (IsConstTypeReference(node)) {
            return undefined;
        }
        const links = LinkStore_Get(b.ch.symbolNodeLinks, node);
        ...
        if (!introducesError) {
            return NodeBuilderImpl_setTextRange(b, NodeFactory_UpdateTypeReferenceNode(b.f, ref, newName, typeArguments), node);
        }
    ...
    tryVisitSimpleTypeNode = (node) => {
        const innerNode = SkipParentheses(node);
    ...
    const visitExistingNodeTreeSymbolsWorker = (node) => {
        const factory = b.f;
        ...
        if (IsJSDocVariadicType(node)) {
            return NewArrayTypeNode(factory, visitNode(AsJSDocVariadicType(node).Type));
        }
        if (IsJSDocTypeLiteral(node)) {
            ...
            for (const tag of AsJSDocTypeLiteral(node).JSDocPropertyTags ?? []) {
                ...
                members.push(NewPropertySignatureDeclaration(factory, undefined, name, question, typeNode, undefined));
            }
            return NewTypeLiteralNode(factory, NodeFactory_NewNodeList(factory, members));
        }
        ...
        if (IsTypeParameterDeclaration(node)) {
            ...
            return NodeFactory_UpdateTypeParameterDeclaration(factory, typeParam, visitModifiers(Node_Modifiers(node)), newName, visitNode(typeParam.Constraint), visitNode(typeParam.Expression), visitNode(typeParam.DefaultType));
        }
        ...
        if (IsLiteralImportTypeNode(node)) {
            ...
            const type_ = NodeBuilderImpl_getTypeFromTypeNode(b, node, true);
            if (type_ === undefined) {
                recoveryBoundary_markError(bound, undefined);
                return node;
            }
            ...
            if (specifier !== originalSpec) {
                arg = NewLiteralTypeNode(factory, specifier);
            }
            return NodeFactory_UpdateImportTypeNode(factory, importType, importType.IsTypeOf, arg, visitNode(importType.Attributes), visitNode(importType.Qualifier), visitNodes(importType.TypeArguments));
        }
        ...
        if ((IsFunctionLike(node) && Node_Type(node) === undefined) ||
            ...
            if (IsPropertyDeclaration(visited)) {
                return NodeFactory_UpdatePropertyDeclaration(factory, visited, Node_Modifiers(visited), Node_Name(visited), Node_PostfixToken(visited), newType, undefined);
            }
            if (IsPropertySignatureDeclaration(visited)) {
                return NodeFactory_UpdatePropertySignatureDeclaration(factory, visited, Node_Modifiers(visited), Node_Name(visited), Node_PostfixToken(visited), newType, undefined);
            }
            if (IsParameterDeclaration(visited)) {
                const param = AsParameterDeclaration(visited);
                return NodeFactory_UpdateParameterDeclaration(factory, param, undefined, param.DotDotDotToken, Node_Name(visited), param.QuestionToken, newType, undefined);
            }
            if (IsMethodSignatureDeclaration(visited)) {
                const method = AsMethodSignatureDeclaration(visited);
                return NodeFactory_UpdateMethodSignatureDeclaration(factory, method, Node_Modifiers(visited), Node_Name(visited), Node_PostfixToken(visited), method.TypeParameters, method.Parameters, newType);
            }
            if (IsCallSignatureDeclaration(visited)) {
                const call = AsCallSignatureDeclaration(visited);
                return NodeFactory_UpdateCallSignatureDeclaration(factory, call, call.TypeParameters, call.Parameters, newType);
            }
            if (IsJSDocSignature(visited)) {
                const jsdocSig = AsJSDocSignature(visited);
                return NodeFactory_UpdateJSDocSignature(factory, jsdocSig, jsdocSig.TypeParameters, jsdocSig.Parameters, newType);
            }
            if (IsConstructSignatureDeclaration(visited)) {
                const construct = AsConstructSignatureDeclaration(visited);
                return NodeFactory_UpdateConstructSignatureDeclaration(factory, construct, construct.TypeParameters, construct.Parameters, newType);
            }
            if (IsIndexSignatureDeclaration(visited)) {
                const index = AsIndexSignatureDeclaration(visited);
                return NodeFactory_UpdateIndexSignatureDeclaration(factory, index, Node_Modifiers(visited), index.Parameters, newType);
            }
            if (IsFunctionTypeNode(visited)) {
                const fn = AsFunctionTypeNode(visited);
                return NodeFactory_UpdateFunctionTypeNode(factory, fn, fn.TypeParameters, fn.Parameters, newType);
            }
            if (IsConstructorTypeNode(visited)) {
                const ctor = AsConstructorTypeNode(visited);
                return NodeFactory_UpdateConstructorTypeNode(factory, ctor, Node_Modifiers(visited), ctor.TypeParameters, ctor.Parameters, newType);
            }
        }
        if (IsComputedPropertyName(node) && IsEntityNameExpression(AsComputedPropertyName(node).Expression)) {
            ...
            if (!introducesError) {
                return NodeFactory_UpdateComputedPropertyName(factory, AsComputedPropertyName(node), result);
            }
            recoveryBoundary_markError(bound, undefined);
            return visitEachChild(node);
        }
        if (IsTypePredicateNode(node)) {
            ...
            return NodeBuilderImpl_setTextRange(b, NodeFactory_UpdateTypePredicateNode(factory, predicate, visitNode(predicate.AssertsModifier), parameterName, visitNode(predicate.Type)), node);
        }
        if (IsConditionalTypeNode(node)) {
            ...
            return NodeFactory_UpdateConditionalTypeNode(factory, conditional, checkType, extendsType, trueType, falseType);
        }
    ...
    visitor = NewNodeVisitor((node) => {
        ...
        if (bound.hadError) {
            if (IsTypeNode(node) && !IsTypePredicateNode(node)) {
                ...
                const type_ = NodeBuilderImpl_getTypeFromTypeNode(b, node, false);
...
//# sourceMappingURL=nodecopy.js.map