...
import { TypeFlagsTypeParameter, TypeFlagsIndexedAccess, TypeFlagsConditional, TypeFlagsSubstitution, TypeFlagsAnyOrUnknown, TypeFlagsUnknown, TypeFlagsAny, TypeFlagsPrimitive, TypeFlagsNever, TypeFlagsUnionOrIntersection, TypeFlagsUnion, TypeFlagsIntersection, TypeFlagsTemplateLiteral, TypeFlagsStringMapping, TypeFlagsIndex, TypeFlagsObject, TypeFlagsInstantiableNonPrimitive, TypeFlagsInstantiable, TypeFlagsNullable, TypeFlagsUndefined, TypeFlagsString, TypeFlagsStringLiteral, TypeFlagsStringOrNumberLiteralOrUnique, TypeFlagsObjectFlagsType, TypeAlias_TypeArguments, Type_AsConditionalType, Type_AsSubstitutionType, Type_AsTypeParameter, Type_AsUnionOrIntersectionType, Type_AsTemplateLiteralType, Type_AsIndexedAccessType, Type_AsMappedType, Type_AsIndexType, Type_AsTypeReference, Type_AsInstantiationExpressionType, StructuredType_CallSignatures, StructuredType_ConstructSignatures, Type_TargetTupleType, Type_AsConstrainedType, Type_AsObjectType, Type_Target, Type_Mapper, Type_Types, ObjectFlagsReference, ObjectFlagsInterface, ObjectFlagsMapped, ObjectFlagsAnonymous, ObjectFlagsInstantiated, ObjectFlagsInstantiationExpressionType, ObjectFlagsNone, ObjectFlagsSingleSignatureType, ObjectFlagsCouldContainTypeVariablesComputed, ObjectFlagsCouldContainTypeVariables, ElementFlagsVariadic, IndexFlagsNone, AccessFlagsNone, } from "../types.js";
import { TypeSystemPropertyNameResolvedBaseConstraint, CachedTypeKindPermissiveInstantiation, CachedTypeKindRestrictiveInstantiation, IntrinsicTypeKindNoInfer, IntrinsicTypeKindUppercase, IntrinsicTypeKindLowercase, IntrinsicTypeKindCapitalize, IntrinsicTypeKindUncapitalize, intrinsicTypeKinds, getTypeInstantiationKey, getConditionalTypeKey, getTypeAliasInstantiationKey, getStringLiteralValue, everyType, someType, applyStringMapping, isUnaryTupleTypeNode, WideningKindNormal, } from "./state.js";
 ...
 * }
 */
export function Checker_checkInferType(receiver, node) {
    if (FindAncestor(node, (n) => (n.Parent !== undefined && n.Parent.Kind === KindConditionalType && AsConditionalTypeNode(n.Parent).ExtendsType === n)) === undefined) {
    ...
    if ((symbol_.Declarations?.length ?? 0) > 1) {
        ...
        if (!links.typeParametersChecked) {
            ...
            if (!Checker_areTypeParametersIdentical(receiver, declarations, [typeParameter], (decl) => [decl])) {
 ...
 * }
 */
export function Checker_checkIndexConstraints(receiver, t, symbol_, isStaticIndex) {
    ...
    for (const prop of Checker_getPropertiesOfObjectType(receiver, t)) {
        if (!(isStaticIndex && (prop.Flags & SymbolFlagsPrototype) !== 0)) {
            Checker_checkIndexConstraintForProperty(receiver, t, prop, Checker_getLiteralTypeFromProperty(receiver, prop, TypeFlagsStringOrNumberLiteralOrUnique, true), Checker_getNonMissingTypeOfSymbol(receiver, prop));
        }
    }
 ...
 * }
 */
export function Checker_checkIndexConstraintForProperty(receiver, t, prop, propNameType, propType) {
    ...
    for (const info of indexInfos) {
        ...
        if (errorNode === undefined && interfaceDeclaration !== undefined && !Some(Checker_getBaseTypes(receiver, t), (base) => (Checker_getPropertyOfObjectType(receiver, base, prop.Name) !== undefined && Checker_getIndexTypeOfType(receiver, base, info.keyType) !== undefined))) {
            errorNode = interfaceDeclaration;
        }
        if (errorNode !== undefined && !Checker_isTypeAssignableTo(receiver, propType, info.valueType)) {
            const diagnostic = NewDiagnosticForNode(errorNode, Property_0_of_type_1_is_not_assignable_to_2_index_type_3, Checker_symbolToString(receiver, prop), Checker_TypeToString(receiver, propType), Checker_TypeToString(receiver, info.keyType), Checker_TypeToString(receiver, info.valueType));
 ...
 * }
 */
export function Checker_getInstantiationExpressionType(receiver, exprType, node) {
    ...
    const key = { nodeId: GetNodeId(node), typeId: exprType.id };
    ...
    const getInstantiatedSignatures = (signatures) => {
        const applicableSignatures = Filter(signatures, (sig) => (sig.typeParameters?.length ?? 0) !== 0 && Checker_hasCorrectTypeArgumentArity(receiver, sig, typeArgumentNodes));
    ...
    const getInstantiatedType = (t) => {
        let hasSignatures = false;
        let hasApplicableSignature = false;
        const getInstantiatedTypePart = (part) => {
            if ((part.flags & TypeFlagsObject) !== 0) {
                const resolved = Checker_resolveStructuredTypeMembers(receiver, part);
                const resolvedCallSignatures = StructuredType_CallSignatures(resolved);
                const resolvedConstructSignatures = StructuredType_ConstructSignatures(resolved);
                ...
                if (!Same(callSignatures, resolvedCallSignatures) || !Same(constructSignatures, resolvedConstructSignatures)) {
                    const result = Checker_newObjectType(receiver, (ObjectFlagsAnonymous | ObjectFlagsInstantiationExpressionType), Checker_newSymbol(receiver, SymbolFlagsNone, InternalSymbolNameInstantiationExpression));
 ...
 * }
 */
export function Checker_getTypeOfInstantiatedSymbol(receiver, symbol_) {
 ...
 * }
 */
export function Checker_getWriteTypeOfInstantiatedSymbol(receiver, symbol_) {
    const links = LinkStore_Get(receiver.valueSymbolLinks, symbol_);
 ...
 * }
 */
export function Checker_widenTypeInferredFromInitializer(receiver, declaration, t) {
 ...
 * }
 */
export function Checker_getConstraintOfType(receiver, t) {
 ...
 * }
 */
export function Checker_hasNonCircularBaseConstraint(receiver, t) {
 ...
 * }
 */
export function Checker_getConstraintOfIndexedAccess(receiver, t) {
 ...
 * }
 */
export function Checker_getConstraintFromIndexedAccess(receiver, t) {
 ...
 * }
 */
export function Checker_getConstraintOfConditionalType(receiver, t) {
    if (Checker_hasNonCircularBaseConstraint(receiver, t)) {
 ...
 * }
 */
export function Checker_getConstraintFromConditionalType(receiver, t) {
 ...
 * }
 */
export function Checker_getDefaultConstraintOfConditionalType(receiver, t) {
 ...
 * }
 */
export function Checker_getConstraintOfDistributiveConditionalType(receiver, t) {
    const d = Type_AsConditionalType(t);
    if (d.resolvedConstraintOfDistributive === undefined) {
        if (d.root.isDistributive && receiver.cachedTypes.get({ kind: CachedTypeKindRestrictiveInstantiation, typeId: t.id }) !== t) {
 ...
 * }
 */
export function Checker_createInstantiatedSymbolTable(receiver, symbols, m) {
 ...
 * }
 */
export function Checker_pushActiveMapper(receiver, mapper) {
    receiver.activeMappers.push(mapper);
    // In TypeScript arrays have no separate cap concept; always push a new map.
    receiver.activeTypeMappersCaches.push(NewGoStructMap());
}
/**
 ...
 * }
 */
export function Checker_popActiveMapper(receiver) {
 ...
 * }
 */
export function Checker_findActiveMapper(receiver, mapper) {
    return FindLastIndex(receiver.activeMappers, (m) => m === mapper);
}
/**
 ...
 * }
 */
export function Checker_clearActiveMapperCaches(receiver) {
 ...
 * }
 */
export function Checker_getObjectTypeInstantiation(receiver, t, m, alias) {
    let declaration;
    ...
    const links = LinkStore_Get(receiver.typeNodeLinks, declaration);
    let target;
    if ((t.objectFlags & ObjectFlagsReference) !== 0) {
        target = links.resolvedType;
    }
    ...
    if (typeParameters === undefined) {
        ...
        if (targetTypeArgs === undefined || targetTypeArgs.length === 0) {
            if ((t.objectFlags & (ObjectFlagsReference | ObjectFlagsInstantiationExpressionType)) !== 0) {
                typeParameters = Filter(typeParameters, (tp) => Checker_isTypeParameterPossiblyReferenced(receiver, tp, declaration));
            }
            else if ((target.symbol.Flags & (SymbolFlagsMethod | SymbolFlagsTypeLiteral)) !== 0) {
                typeParameters = Filter(typeParameters, (tp) => Some(t.symbol.Declarations, (d) => Checker_isTypeParameterPossiblyReferenced(receiver, tp, d)));
            }
        }
        if (typeParameters === undefined) {
            typeParameters = [];
    ...
    const typeArguments = typeParameters.map((tp) => TypeMapper_Map(combinedMapper, tp));
    let newAlias = alias;
    ...
    if (data.instantiations === undefined) {
        data.instantiations = NewGoStructMap();
    ...
    if (result === undefined) {
        ...
        if ((result.flags & TypeFlagsObjectFlagsType) !== 0 && (result.objectFlags & ObjectFlagsCouldContainTypeVariablesComputed) === 0) {
            const resultCouldContainObjectFlags = Some(typeArguments, (ta) => receiver.couldContainTypeVariables(ta));
            if ((result.objectFlags & ObjectFlagsCouldContainTypeVariablesComputed) === 0) {
                if ((result.objectFlags & (ObjectFlagsMapped | ObjectFlagsAnonymous | ObjectFlagsReference)) !== 0) {
 ...
 * }
 */
export function Checker_getConditionalTypeInstantiation(receiver, t, mapper, forConstraint, alias) {
    return Checker_getConditionalTypeInstantiationWithCapture(receiver, t, mapper, forConstraint, alias, undefined);
}
export function Checker_getConditionalTypeInstantiationWithCapture(receiver, t, mapper, forConstraint, alias, capture) {
    const root = Type_AsConditionalType(t).root;
    if (root.outerTypeParameters.length !== 0) {
        const typeArguments = Map(root.outerTypeParameters, (tp) => TypeMapper_Map(mapper, tp));
        ...
        if (result === undefined || capture !== undefined) {
            ...
            let distributionType = undefined;
            if (root.isDistributive) {
            ...
            if (distributionType !== undefined && checkType !== distributionType && (distributionType.flags & (TypeFlagsUnion | TypeFlagsNever)) !== 0) {
                result = Checker_mapTypeWithAlias(receiver, distributionType, (innerT) => {
 ...
 * }
 */
export function Checker_hasArrayOrTypeTypeConstraint(receiver, typeVariable) {
    const constraint = Checker_getConstraintOfTypeParameter(receiver, typeVariable);
    return constraint !== undefined && everyType(constraint, (t) => Checker_isArrayOrTupleType(receiver, t));
}
/**
 ...
 * }
 */
export function Checker_getConstraintTypeFromMappedType(receiver, t) {
 ...
 * }
 */
export function Checker_isMappedTypeWithKeyofConstraintDeclaration(receiver, t) {
 ...
 * }
 */
export function Checker_getConstraintDeclarationForMappedType(receiver, t) {
 ...
 * }
 */
export function Checker_getTypeAliasInstantiation(receiver, symbol_, typeArguments, alias) {
 ...
 * }
 */
export function Checker_getPermissiveInstantiation(receiver, t) {
    if ((t.flags & (TypeFlagsPrimitive | TypeFlagsAnyOrUnknown | TypeFlagsNever)) !== 0) {
        return t;
    }
    const key = { kind: CachedTypeKindPermissiveInstantiation, typeId: t.id };
 ...
 * }
 */
export function Checker_getRestrictiveInstantiation(receiver, t) {
    if ((t.flags & (TypeFlagsPrimitive | TypeFlagsAnyOrUnknown | TypeFlagsNever)) !== 0) {
        return t;
    }
    const key = { kind: CachedTypeKindRestrictiveInstantiation, typeId: t.id };
    const cached = receiver.cachedTypes.get(key);
    if (cached !== undefined) {
        return cached;
    }
 ...
 * }
 */
export function Checker_restrictiveMapperWorker(receiver, t) {
    if ((t.flags & TypeFlagsTypeParameter) !== 0) {
 ...
 * }
 */
export function Checker_permissiveMapperWorker(receiver, t) {
    if ((t.flags & TypeFlagsTypeParameter) !== 0) {
 ...
 * }
 */
export function Checker_getInferredTrueTypeFromConditionalType(receiver, t) {
    const d = Type_AsConditionalType(t);
 ...
 * }
 */
export function Checker_getTypeFromInferTypeNode(receiver, node) {
 ...
 * }
 */
export function Checker_getImpliedConstraint(receiver, t, checkNode, extendsNode) {
 ...
 * }
 */
export function Checker_newStringMappingType(receiver, symbol_, target) {
    const data = {
 ...
 * }
 */
export function Checker_newSubstitutionType(receiver, baseType, constraint) {
    const data = {
        resolvedBaseConstraint: undefined,
        baseType,
        constraint,
 ...
 * }
 */
export function Checker_isTypeMatchedByTemplateLiteralOrStringMapping(receiver, t, template) {
    if ((template.flags & TypeFlagsTemplateLiteral) !== 0) {
 ...
 * }
 */
export function Checker_isNoInferType(receiver, t) {
 ...
 * }
 */
export function Checker_getSubstitutionIntersection(receiver, t) {
 ...
 * }
 */
export function Checker_getNoInferType(receiver, t) {
 ...
 * }
 */
export function Checker_isNoInferTargetType(receiver, t) {
    return (((t.flags & TypeFlagsUnionOrIntersection) !== 0 && Some(Type_AsUnionOrIntersectionType(t).types, (s) => Checker_isNoInferTargetType(receiver, s))) ||
 ...
 * }
 */
export function Checker_getSubstitutionType(receiver, baseType, constraint) {
    if ((constraint.flags & TypeFlagsAnyOrUnknown) !== 0 || constraint === baseType || (baseType.flags & TypeFlagsAny) !== 0) {
        return baseType;
    }
 ...
 * }
 */
export function Checker_getOrCreateSubstitutionType(receiver, baseType, constraint) {
    const key = { baseId: baseType.id, constraintId: constraint.id };
 ...
 * }
 */
export function Checker_getBaseConstraintOrType(receiver, t) {
 ...
 * }
 */
export function Checker_getBaseConstraintOfType(receiver, t) {
 ...
 * }
 */
export function Checker_getResolvedBaseConstraint(receiver, t, stack) {
 ...
 * }
 */
export function Checker_computeBaseConstraint(receiver, t, stack) {
    if ((t.flags & TypeFlagsTypeParameter) !== 0) {
    ...
    if (Checker_isGenericTupleType(receiver, t)) {
        ...
        for (let i = 0; i < elementTypes.length; i++) {
            ...
            if ((v.flags & TypeFlagsTypeParameter) !== 0 && (elementInfos[i].flags & ElementFlagsVariadic) !== 0) {
                ...
                if (constraint !== undefined && constraint !== v && everyType(constraint, (n) => Checker_isArrayOrTupleType(receiver, n) && !Checker_isGenericTupleType(receiver, n))) {
                    newElement = constraint;
                }
            }
 ...
 * }
 */
export function Checker_getNextBaseConstraint(receiver, t, stack) {
    if (t === undefined) {
        return undefined;
    }
 ...
 * }
 */
export function Checker_maybeTypeOfKindConsideringBaseConstraint(receiver, t, kind) {
 ...
 * }
 */
export function Checker_getSimplifiedTypeOrConstraint(receiver, t) {
 ...
 * }
 */
export function Checker_getConstraintDeclaration(receiver, t) {
 ...
 * }
 */
export function Checker_getStringMappingType(receiver, symbol_, t) {
    if ((t.flags & (TypeFlagsUnion | TypeFlagsNever)) !== 0) {
        return Checker_mapType(receiver, t, (s) => Checker_getStringMappingType(receiver, symbol_, s));
    }
 ...
 * }
 */
export function Checker_applyTemplateStringMapping(receiver, symbol_, texts, types) {
    const kind = intrinsicTypeKinds.get(symbol_.Name);
    if (kind === IntrinsicTypeKindUppercase || kind === IntrinsicTypeKindLowercase) {
        return [Map(texts, (t) => applyStringMapping(symbol_, t)), Map(types, (t) => Checker_getStringMappingType(receiver, symbol_, t))];
    }
 ...
 * }
 */
export function Checker_getStringMappingTypeForGenericType(receiver, symbol_, t) {
    const key = { s: symbol_, t: t };
 ...
 * }
 */
export function Checker_getContextualTypeForSubstitutionExpression(receiver, template, substitutionExpression) {
 ...
 * }
 */
export function Checker_pushInferenceContext(receiver, node, context) {
 ...
 * }
 */
export function Checker_popInferenceContext(receiver) {
 ...
 * }
 */
export function Checker_getInferenceContext(receiver, node) {
 ...
 * }
 */
export function Checker_getGlobalNonNullableTypeInstantiation(receiver, t) {
 ...
 * }
 */
export function Checker_isAwaitedTypeInstantiation(receiver, t) {
    if ((t.flags & TypeFlagsConditional) !== 0) {
 ...
 * }
 */
export function Checker_isConstraintPosition(receiver, t, node) {
    ...
    return IsPropertyAccessExpression(parent) || IsQualifiedName(parent) ||
        ...
        (IsElementAccessExpression(parent) && Node_Expression(parent) === node && !(someType(t, (s) => Checker_isGenericTypeWithoutNullableConstraint(receiver, s)) && Checker_isGenericIndexType(receiver, Checker_getTypeOfExpression(receiver, AsElementAccessExpression(parent).ArgumentExpression))));
}
/**
 ...
 * }
 */
export function Checker_isGenericTypeWithUnionConstraint(receiver, t) {
    if ((t.flags & TypeFlagsIntersection) !== 0) {
        return Some(Type_Types(t), (s) => Checker_isGenericTypeWithUnionConstraint(receiver, s));
    }
 ...
 * }
 */
export function Checker_isGenericTypeWithoutNullableConstraint(receiver, t) {
    if ((t.flags & TypeFlagsIntersection) !== 0) {
        return Some(Type_Types(t), (s) => Checker_isGenericTypeWithoutNullableConstraint(receiver, s));
    }
 ...
 * }
 */
export function Checker_isGenericTypeWithUndefinedConstraint(receiver, t) {
    if ((t.flags & TypeFlagsInstantiable) !== 0) {
        const constraint = Checker_getBaseConstraintOfType(receiver, t);
        if (constraint !== undefined) {
