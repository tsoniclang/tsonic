...
import { Checker_registerForUnusedIdentifiersCheck, Checker_checkVariableDeclarationList, Checker_checkVariableLikeDeclaration, Checker_checkExternalModuleExports, Checker_checkForDisallowedESSymbolOperand, Checker_getIndexTypeOrString, Checker_checkAccessorDeclaration, Checker_checkUnusedIdentifiers, Checker_reportUnusedVariableDeclarations, Checker_isUnreferencedVariableDeclaration, Checker_getIndexedAccessType, Checker_getTargetOfAliasLikeExpression, Checker_markSymbolOfAliasDeclarationIfTypeOnly, Checker_needCollisionCheckForIdentifier, Checker_getTypeOfSymbol, Checker_getExportSymbolOfValueSymbolIfExported, Checker_getResolvedSymbolOrNil, Checker_isReadonlySymbol, Checker_reportNonexistentProperty, Checker_checkIdentifier, Checker_checkPrivateIdentifierExpression, Checker_checkPropertyAccessExpression, Checker_checkQualifiedName, Checker_checkIndexedAccess, Checker_checkMetaProperty, Checker_getDeclaredTypeOfSymbol, Checker_getSymbolOfDeclaration, Checker_classDeclarationExtendsNull, } from "./symbols.js";
...
import { Checker_checkGrammarStatementInAmbientContext, Checker_grammarErrorOnFirstToken, Checker_grammarErrorOnNode, Checker_checkGrammarVariableDeclarationList, Checker_checkGrammarBreakOrContinueStatement, Checker_checkGrammarForInOrForOfStatement, Checker_checkGrammarYieldExpression, Checker_checkGrammarAwaitOrAwaitUsing, Checker_checkGrammarForDisallowedBlockScopedVariableStatement, Checker_grammarErrorAtPos, Checker_checkGrammarSourceFile, Checker_checkGrammarNumericLiteral, Checker_checkGrammarBigIntLiteral, } from "../grammarchecks.js";
import { Checker_produceDeferredDiagnostics, Checker_hasParseDiagnostics, Checker_addErrorOrSuggestion, Checker_addDeferredDiagnostic, Checker_isErrorType, Checker_reportOperatorError, Checker_reportOperatorErrorUnless, Checker_IsDeprecatedDeclaration, Checker_invocationError, Checker_resolveErrorCall, } from "./diagnostics.js";
import { Checker_checkTypeAssignableToAndOptionallyElaborate, Checker_checkTypeAssignableTo, Checker_checkTypeComparableTo, Checker_isTypeAssignableTo, Checker_isTypeSubtypeOf, Checker_isTypeRelatedTo, Checker_areTypesComparable, Checker_getThisTypeOfSignature, } from "../relater.js";
...
import { Checker_checkIteratedTypeOrElementType, Checker_getNonNullableTypeIfNeeded, Checker_checkNonNullType, Checker_checkNonNullExpression, Checker_getTypeFromTypeNode, Checker_getUnaryResultType, Checker_checkArithmeticOperandType, Checker_bothAreBigIntLike, Checker_checkNullishCoalesceOperands, Checker_checkFunctionExpressionOrObjectLiteralMethodDeferred, Checker_hasTypeFacts, Checker_getTypeFacts, Checker_checkAwaitedType, Checker_isFunctionType, Checker_isEmptyObjectType, Checker_hasEmptyObjectIntersection, Checker_getAwaitedTypeOfPromise, Checker_getRegularTypeOfLiteralType, Checker_getWidenedLiteralLikeTypeForContextualType, Checker_instantiateContextualType, Checker_getContextualType, Checker_checkConstEnumAccess, Checker_getFreshTypeOfLiteralType, Checker_getNumberLiteralType, Checker_getBigIntLiteralType, Checker_getBaseTypeOfLiteralType, Checker_getBaseTypeOfLiteralTypeForComparison, Checker_filterType, Checker_getContextualIterationType, Checker_getYieldedTypeOfYieldExpression, Checker_getIterationTypeOfIterable, Checker_getApparentType, Checker_getStringLiteralType, Checker_checkTemplateExpression, Checker_checkRegularExpressionLiteral, Checker_checkArrayLiteral, Checker_checkObjectLiteral, Checker_checkTaggedTemplateExpression, Checker_checkFunctionExpressionOrObjectLiteralMethod, Checker_checkTypeOfExpression, Checker_checkNonNullAssertion, Checker_checkVoidExpression, Checker_checkConditionalExpression, Checker_GetNonNullableType, Checker_getUnionType, Checker_getUnionTypeEx, Checker_maybeTypeOfKind, Checker_getBaseTypes, } from "./types.js";
...
import { The_body_of_an_if_statement_cannot_be_the_empty_statement, X_with_statements_are_not_allowed_in_an_async_function_block, The_with_statement_is_not_supported_All_symbols_in_a_with_block_will_have_type_any, Line_break_not_permitted_here, All_variables_are_unused, Did_you_forget_to_use_await, A_return_statement_can_only_be_used_within_a_function_body, A_return_statement_cannot_be_used_inside_a_class_static_block, Not_all_code_paths_return_a_value, Setters_cannot_return_a_value, Return_type_of_constructor_signature_must_be_assignable_to_the_instance_type_of_the_class, Catch_clause_variable_type_annotation_must_be_any_or_unknown_if_specified, Catch_clause_variable_cannot_have_an_initializer, Cannot_redeclare_identifier_0_in_catch_clause, Unused_label, Duplicate_label_0, A_default_clause_cannot_appear_more_than_once_in_a_switch_statement, Fallthrough_case_in_switch, The_left_hand_side_of_a_for_in_statement_cannot_be_a_destructuring_pattern, The_left_hand_side_of_a_for_in_statement_must_be_of_type_string_or_any, The_left_hand_side_of_a_for_in_statement_must_be_a_variable_or_a_property_access, The_left_hand_side_of_a_for_in_statement_may_not_be_an_optional_property_access, The_right_hand_side_of_a_for_in_statement_must_be_of_type_any_an_object_type_or_a_type_parameter_but_here_has_type_0, The_left_hand_side_of_a_for_of_statement_must_be_a_variable_or_a_property_access, The_left_hand_side_of_a_for_of_statement_may_not_be_an_optional_property_access, X_for_await_loops_cannot_be_used_inside_a_class_static_block, The_return_type_of_an_async_function_must_either_be_a_valid_promise_or_must_not_contain_a_callable_then_member, The_operand_of_a_delete_operator_must_be_optional, Type_of_await_operand_must_either_be_a_valid_promise_or_must_not_contain_a_callable_then_member, X_await_has_no_effect_on_the_type_of_this_expression, An_arithmetic_operand_must_be_of_type_any_number_bigint_or_an_enum_type, The_operand_of_an_increment_or_decrement_operator_must_be_a_variable_or_a_property_access, The_operand_of_an_increment_or_decrement_operator_may_not_be_an_optional_property_access, The_right_hand_side_of_an_instanceof_expression_must_be_either_of_type_any_a_class_function_or_other_type_assignable_to_the_Function_interface_type_or_an_object_type_with_a_Symbol_hasInstance_method, X_yield_expression_implicitly_results_in_an_any_type_because_its_containing_generator_lacks_a_return_type_annotation, X_super_must_be_called_before_accessing_this_in_the_constructor_of_a_derived_class, X_super_cannot_be_referenced_in_a_computed_property_name, Super_calls_are_not_permitted_outside_constructors_or_in_nested_functions_inside_constructors, X_super_can_only_be_referenced_in_members_of_derived_classes_or_object_literal_expressions, X_super_property_access_is_permitted_only_in_a_constructor_member_function_or_member_accessor_of_a_derived_class, X_super_must_be_called_before_accessing_a_property_of_super_in_the_constructor_of_a_derived_class, X_super_can_only_be_referenced_in_a_derived_class, X_super_cannot_be_referenced_in_constructor_arguments, X_this_cannot_be_referenced_in_a_computed_property_name, X_this_cannot_be_referenced_in_a_module_or_namespace_body, X_this_cannot_be_referenced_in_current_location, The_containing_arrow_function_captures_the_global_value_of_this, X_this_implicitly_has_type_any_because_it_does_not_have_a_type_annotation, An_outer_value_of_this_is_shadowed_by_this_container, The_operand_of_a_delete_operator_must_be_a_property_reference, The_operand_of_a_delete_operator_cannot_be_a_private_identifier, The_operand_of_a_delete_operator_cannot_be_a_read_only_property, The_left_hand_side_of_an_instanceof_expression_must_be_of_type_any_an_object_type_or_a_type_parameter, An_object_s_Symbol_hasInstance_method_must_return_a_boolean_value_for_it_to_be_used_on_the_right_hand_side_of_an_instanceof_expression, Type_0_may_represent_a_primitive_value_which_is_not_permitted_as_the_right_operand_of_the_in_operator, Untyped_function_calls_may_not_accept_type_arguments, Cannot_create_an_instance_of_an_abstract_class, Only_a_void_function_can_be_called_with_the_new_keyword, A_function_that_is_called_with_the_new_keyword_cannot_have_a_this_type_that_is_void, The_0_operator_cannot_be_applied_to_type_symbol, Operator_0_cannot_be_applied_to_type_1, } from "../../diagnostics/generated/messages.js";
...
import { ContextFlagsNone, TypeFlagsAnyOrUnknown, TypeFlagsNonPrimitive, TypeFlagsInstantiableNonPrimitive, TypeFlagsNever, TypeFlagsPrimitive, TypeFlagsESSymbolLike, TypeFlagsBigIntLike, TypeFlagsUnion, TypeFlagsBooleanLike, TypeFlagsNumberLike, TypeFlagsStringLike, } from "../types.js";
 ...
 * }
 */
export function Checker_checkSourceFile(receiver, ctx, sourceFile, checkUnused) {
    receiver.ctx = ctx;
 ...
 * }
 */
export function Checker_checkNodeDeferred(receiver, node) {
 ...
 * }
 */
export function Checker_checkDeferredNodes(receiver, context) {
 ...
 * }
 */
export function Checker_checkDeferredNode(receiver, node) {
 ...
 * }
 */
export function Checker_checkBlock(receiver, node) {
 ...
 * }
 */
export function Checker_checkIfStatement(receiver, node) {
    Checker_checkGrammarStatementInAmbientContext(receiver, node);
 ...
 * }
 */
export function Checker_checkDoStatement(receiver, node) {
    Checker_checkGrammarStatementInAmbientContext(receiver, node);
 ...
 * }
 */
export function Checker_checkWhileStatement(receiver, node) {
    Checker_checkGrammarStatementInAmbientContext(receiver, node);
    Checker_checkTruthinessExpression(receiver, Node_Expression(node), CheckModeNormal);
    Checker_checkSourceElement(receiver, Node_Statement(node));
}
 ...
 * }
 */
export function Checker_checkForStatement(receiver, node) {
 ...
 * }
 */
export function Checker_checkForInStatement(receiver, node) {
 ...
 * }
 */
export function Checker_checkForOfStatement(receiver, node) {
    const data = AsForInOrOfStatement(node);
    Checker_checkGrammarForInOrForOfStatement(receiver, data);
    ...
    if (IsVariableDeclarationList(data.Initializer)) {
        ...
        if (IsArrayLiteralExpression(varExpr) || IsObjectLiteralExpression(varExpr)) {
            Checker_checkDestructuringAssignment(receiver, varExpr, OrElse(iteratedType, receiver.errorType), CheckModeNormal, false);
        }
        else {
            const leftType = Checker_checkExpression(receiver, varExpr);
 ...
 * }
 */
export function Checker_checkBreakOrContinueStatement(receiver, node) {
    if (!Checker_checkGrammarStatementInAmbientContext(receiver, node)) {
 ...
 * }
 */
export function Checker_checkReturnStatement(receiver, node) {
    if (Checker_checkGrammarStatementInAmbientContext(receiver, node)) {
        return;
    }
    const container = getContainingFunctionOrClassStaticBlock(node);
    ...
    if (receiver.strictNullChecks || exprNode !== undefined || (returnType.flags & TypeFlagsNever) !== 0) {
        ...
        if (IsSetAccessorDeclaration(container)) {
            ...
            Checker_checkReturnExpression(receiver, container, unwrappedReturnType, node, Node_Expression(node), exprType, false);
        }
    }
 ...
 * }
 */
export function Checker_checkReturnExpression(receiver, container, unwrappedReturnType, node, expr, exprType, inConditionalExpression) {
    ...
    if (expr !== undefined) {
        ...
        if (IsConditionalExpression(unwrappedExpr)) {
            ...
            Checker_checkReturnExpression(receiver, container, unwrappedReturnType, node, whenTrue, Checker_checkExpression(receiver, whenTrue), true);
            Checker_checkReturnExpression(receiver, container, unwrappedReturnType, node, whenFalse, Checker_checkExpression(receiver, whenFalse), true);
            return;
        }
    }
    const inReturnStatement = node.Kind === KindReturnStatement;
    if ((functionFlags & FunctionFlagsAsync) !== 0) {
        unwrappedExprType = Checker_checkAwaitedType(receiver, exprType, false, node, The_return_type_of_an_async_function_must_either_be_a_valid_promise_or_must_not_contain_a_callable_then_member);
    }
 ...
 * }
 */
export function Checker_checkWithStatement(receiver, node) {
    if (!Checker_checkGrammarStatementInAmbientContext(receiver, node)) {
 ...
 * }
 */
export function Checker_checkSwitchStatement(receiver, node) {
    Checker_checkGrammarStatementInAmbientContext(receiver, node);
    let firstDefaultClause = undefined;
 ...
 * }
 */
export function Checker_checkLabeledStatement(receiver, node) {
 ...
 * }
 */
export function Checker_checkThrowStatement(receiver, node) {
 ...
 * }
 */
export function Checker_checkTryStatement(receiver, node) {
    Checker_checkGrammarStatementInAmbientContext(receiver, node);
 ...
 * }
 */
export function Checker_checkCatchClause(receiver, node) {
 ...
 * }
 */
export function Checker_checkVariableStatement(receiver, node) {
 ...
 * }
 */
export function Checker_isYieldIteratorResult(receiver, t) {
 ...
 * }
 */
export function Checker_isReturnIteratorResult(receiver, t) {
 ...
 * }
 */
export function Checker_reportUnusedVariable(receiver, location, diagnostic) {
    let loc = location;
 ...
 * }
 */
export function Checker_reportUnusedVariables(receiver, node) {
 ...
 * }
 */
export function Checker_checkExpressionStatement(receiver, node) {
    Checker_checkGrammarStatementInAmbientContext(receiver, node);
    Checker_checkExpression(receiver, Node_Expression(node));
}
/**
 ...
 * }
 */
export function Checker_getContextNode(receiver, node) {
 ...
 * }
 */
export function Checker_checkExpressionCached(receiver, node) {
 ...
 * }
 */
export function Checker_checkExpressionCachedEx(receiver, node, checkMode) {
    if (checkMode !== CheckModeNormal) {
 ...
 * }
 */
export function Checker_checkExpression(receiver, node) {
 ...
 * }
 */
export function Checker_checkExpressionEx(receiver, node, checkMode) {
    const saveCurrentNode = receiver.currentNode;
    receiver.currentNode = node;
    receiver.instantiationCount = 0;
 ...
 * }
 */
export function Checker_checkExpressionWorker(receiver, node, checkMode) {
    switch (node.Kind) {
        case KindIdentifier:
 ...
 * }
 */
export function Checker_checkSuperExpression(receiver, node) {
    ...
    const isLegalUsageOfSuperExpression = () => {
        if (isCallExpression) {
    ...
    if (container === undefined || !isLegalUsageOfSuperExpression()) {
        const current = FindAncestorOrQuit(node, (n) => {
            if (n === container) {
        ...
        if (!isCallExpression &&
            ...
            for (let current = GetEnclosingBlockScopeContainer(node.Parent); current !== undefined; current = GetEnclosingBlockScopeContainer(current)) {
                if (!IsSourceFile(current) || IsExternalOrCommonJSModule(AsSourceFile(current))) {
                    LinkStore_Get(receiver.nodeLinks, current).flags |= NodeCheckFlagsContainsSuperPropertyInStaticInitializer;
                }
            }
        }
 ...
 * }
 */
export function Checker_resolveNewExpression(receiver, node, candidatesOutArray, checkMode) {
 ...
 * }
 */
export function Checker_resolveInstanceofExpression(receiver, node, candidatesOutArray, checkMode) {
    ...
    if (!IsTypeAny(rightType)) {
        ...
        if (hasInstanceMethodType !== undefined) {
            ...
            Checker_error(receiver, right, The_right_hand_side_of_an_instanceof_expression_must_be_either_of_type_any_a_class_function_or_other_type_assignable_to_the_Function_interface_type_or_an_object_type_with_a_Symbol_hasInstance_method);
            return Checker_resolveErrorCall(receiver, node);
        }
    }
 ...
 * }
 */
export function Checker_maybeAddMissingAwaitInfo(receiver, errorNode, source, target, relation, reportErrors, diagnosticOutput) {
 ...
 * }
 */
export function Checker_getEffectiveCheckNode(receiver, argument) {
    const flags = IfElse(IsInJSFile(argument), (OEKParentheses | OEKSatisfies | OEKExcludeJSDocTypeAssertion), (OEKParentheses | OEKSatisfies));
 ...
 * }
 */
export function Checker_isGenericFunctionReturningFunction(receiver, signature) {
 ...
 * }
 */
export function Checker_skippedGenericFunction(receiver, node, checkMode) {
    if ((checkMode & CheckModeInferential) !== 0) {
 ...
 * }
 */
export function Checker_checkParenthesizedExpression(receiver, node, checkMode) {
 ...
 * }
 */
export function Checker_recordPotentialCollisionWithWeakMapSetInGeneratedCode(receiver, node, name) {
 ...
 * }
 */
export function Checker_recordPotentialCollisionWithReflectInGeneratedCode(receiver, node, name) {
 ...
 * }
 */
export function Checker_checkDeleteExpression(receiver, node) {
    Checker_checkExpression(receiver, Node_Expression(node));
 ...
 * }
 */
export function Checker_checkDeleteExpressionMustBeOptional(receiver, expr, symbol_) {
 ...
 * }
 */
export function Checker_checkAwaitExpression(receiver, node) {
 ...
 * }
 */
export function Checker_checkPrefixUnaryExpression(receiver, node) {
    ...
    switch (expr.Operator) {
        ...
        case KindMinusMinusToken: {
            const ok = Checker_checkArithmeticOperandType(receiver, expr.Operand, Checker_checkNonNullType(receiver, operandType, expr.Operand), An_arithmetic_operand_must_be_of_type_any_number_bigint_or_an_enum_type, false);
            if (ok) {
 ...
 * }
 */
export function Checker_checkPostfixUnaryExpression(receiver, node) {
 ...
 * }
 */
export function Checker_checkSpreadExpression(receiver, node, checkMode) {
 ...
 * }
 */
export function Checker_checkYieldExpression(receiver, node) {
    ...
    if (returnType !== undefined && (returnType.flags & TypeFlagsUnion) !== 0) {
        returnType = Checker_filterType(receiver, returnType, (t) => Checker_checkGeneratorInstantiationAssignabilityToReturnType(receiver, t, functionFlags, undefined));
    }
    let iterationTypes = { yieldType: undefined, returnType: undefined, nextType: undefined };
 ...
 * }
 */
export function Checker_checkSyntheticExpression(receiver, node) {
 ...
 * }
 */
export function Checker_containerSeemsToBeEmptyDomElement(receiver, containingType) {
 ...
 * }
 */
export function Checker_isUncalledFunctionReference(receiver, node, symbol_) {
    if ((symbol_.Flags & (SymbolFlagsFunction | SymbolFlagsMethod)) !== 0) {
        let parent = FindAncestor(node.Parent, (n) => !IsAccessExpression(n));
        if (parent === undefined) {
            parent = node.Parent;
        }
        if (IsCallLikeExpression(parent)) {
            return (IsCallOrNewExpression(parent) && IsIdentifier(node) && Checker_hasMatchingArgument(receiver, parent, node));
        }
        return Every(symbol_.Declarations, (declaration) => (!IsFunctionLike(declaration) || Checker_IsDeprecatedDeclaration(receiver, declaration)));
    }
    return true;
}
/**
 ...
 * }
 */
export function Checker_checkThisExpression(receiver, node) {
 ...
 * }
 */
export function Checker_checkBinaryExpression(receiver, node, checkMode) {
...
function isIterativelyCheckableNonLogicalBinaryExpression(node) {
    if (node === undefined || node.Kind !== KindBinaryExpression) {
        return false;
    }
    const binary = AsBinaryExpression(node);
    const operator = binary.OperatorToken.Kind;
    return (!(operator === KindEqualsToken && (binary.Left.Kind === KindObjectLiteralExpression || binary.Left.Kind === KindArrayLiteralExpression)) &&
 ...
 * }
 */
export function Checker_checkBinaryLikeExpression(receiver, left, operatorToken, right, checkMode, errorNode) {
...
function Checker_checkBinaryLikeExpressionWithTypes(receiver, left, operatorToken, right, checkMode, errorNode, initialLeftType, initialRightType) {
    const operator = operatorToken.Kind;
    ...
    switch (operator) {
        ...
        case KindAmpersandEqualsToken: {
            ...
            const leftOk = Checker_checkArithmeticOperandType(receiver, left, leftType, The_left_hand_side_of_an_arithmetic_operation_must_be_of_type_any_number_bigint_or_an_enum_type, true);
            const rightOk = Checker_checkArithmeticOperandType(receiver, right, rightType, The_right_hand_side_of_an_arithmetic_operation_must_be_of_type_any_number_bigint_or_an_enum_type, true);
            let resultType;
            if ((Checker_isTypeAssignableToKind(receiver, leftType, TypeFlagsAnyOrUnknown) && Checker_isTypeAssignableToKind(receiver, rightType, TypeFlagsAnyOrUnknown)) ||
                ...
                switch (operator) {
                    ...
                    case KindGreaterThanGreaterThanGreaterThanEqualsToken: {
                        ...
                        if (typeof rhsEval.Value === "number") {
                            const numValue = rhsEval.Value;
                            if (Number_Abs(numValue) >= 32) {
                                Checker_errorOrSuggestion(receiver, IsEnumMember(WalkUpParenthesizedExpressions(right.Parent.Parent)), errorNode, This_operation_can_be_simplified_This_shift_is_identical_to_0_1_2, GetTextOfNode(left), TokenToString(operator), Number_Remainder(numValue, 32));
                            }
                        }
                        break;
                    }
        ...
        case KindPlusEqualsToken: {
            ...
            let resultType;
            if (Checker_isTypeAssignableToKindEx(receiver, leftType, TypeFlagsNumberLike, true) && Checker_isTypeAssignableToKindEx(receiver, rightType, TypeFlagsNumberLike, true)) {
                resultType = receiver.numberType;
            }
            else if (Checker_isTypeAssignableToKindEx(receiver, leftType, TypeFlagsBigIntLike, true) && Checker_isTypeAssignableToKindEx(receiver, rightType, TypeFlagsBigIntLike, true)) {
                resultType = receiver.bigintType;
            }
            else if (Checker_isTypeAssignableToKindEx(receiver, leftType, TypeFlagsStringLike, true) || Checker_isTypeAssignableToKindEx(receiver, rightType, TypeFlagsStringLike, true)) {
            ...
            if (resultType === undefined) {
                const closeEnoughKind = (TypeFlagsNumberLike | TypeFlagsBigIntLike | TypeFlagsStringLike | TypeFlagsAnyOrUnknown);
                Checker_reportOperatorError(receiver, leftType, operator, rightType, errorNode, (leftOperand, rightOperand) => Checker_isTypeAssignableToKind(receiver, leftOperand, closeEnoughKind) && Checker_isTypeAssignableToKind(receiver, rightOperand, closeEnoughKind));
                return receiver.anyType;
            }
        ...
        case KindExclamationEqualsEqualsToken:
            if ((checkMode & CheckModeTypeOnly) === 0) {
                ...
                Checker_checkNaNEquality(receiver, errorNode, operator, left, right);
        ...
        case KindInstanceOfKeyword:
            return Checker_checkInstanceOfExpression(receiver, left, right, leftType, rightType, checkMode);
        case KindInKeyword:
            return Checker_checkInExpression(receiver, left, right, leftType, rightType);
 ...
 * }
 */
export function Checker_checkInstanceOfExpression(receiver, left, right, leftType, rightType, checkMode) {
    if (leftType === receiver.silentNeverType || rightType === receiver.silentNeverType) {
        return receiver.silentNeverType;
    }
    if (!IsTypeAny(leftType) && Checker_allTypesAssignableToKind(receiver, leftType, TypeFlagsPrimitive)) {
        Checker_error(receiver, left, The_left_hand_side_of_an_instanceof_expression_must_be_of_type_any_an_object_type_or_a_type_parameter);
    }
    const signature = Checker_getResolvedSignature(receiver, left.Parent, undefined, checkMode);
    if (signature === receiver.resolvingSignature) {
        return receiver.silentNeverType;
    }
    const returnType = Checker_getReturnTypeOfSignature(receiver, signature);
    Checker_checkTypeAssignableTo(receiver, returnType, receiver.booleanType, right, An_object_s_Symbol_hasInstance_method_must_return_a_boolean_value_for_it_to_be_used_on_the_right_hand_side_of_an_instanceof_expression);
    return receiver.booleanType;
}
/**
 ...
 * }
 */
export function Checker_checkInExpression(receiver, left, right, leftType, rightType) {
    if (leftType === receiver.silentNeverType || rightType === receiver.silentNeverType) {
        return receiver.silentNeverType;
    }
    if (IsPrivateIdentifier(left)) {
        ...
        const links = LinkStore_Get(receiver.symbolNodeLinks, left);
        if (links.resolvedSymbol === undefined && GetContainingClass(left) !== undefined) {
            const isUncheckedJS = Checker_isUncheckedJSSuggestion(receiver, left, rightType.symbol, true);
            Checker_reportNonexistentProperty(receiver, left, rightType, isUncheckedJS);
        }
    }
    else {
        Checker_checkTypeAssignableTo(receiver, Checker_checkNonNullType(receiver, leftType, left), receiver.stringNumberSymbolType, left, undefined);
    }
    if (Checker_checkTypeAssignableTo(receiver, Checker_checkNonNullType(receiver, rightType, right), receiver.nonPrimitiveType, right, undefined)) {
        if (Checker_hasEmptyObjectIntersection(receiver, rightType)) {
            Checker_error(receiver, right, Type_0_may_represent_a_primitive_value_which_is_not_permitted_as_the_right_operand_of_the_in_operator, Checker_TypeToString(receiver, rightType));
        }
    }
    return receiver.booleanType;
}
 ...
 * }
 */
export function Checker_checkReferenceExpression(receiver, expr, invalidReferenceMessage, invalidOptionalChainMessage) {
    const node = SkipOuterExpressions(expr, (OEKAssertions | OEKParentheses));
 ...
 * }
 */
export function Checker_checkExpressionForMutableLocation(receiver, node, checkMode) {
    ...
    return Checker_getWidenedLiteralLikeTypeForContextualType(receiver, t, Checker_instantiateContextualType(receiver, Checker_getContextualType(receiver, node, ContextFlagsNone), node, ContextFlagsNone));
}
/**
 ...
 * }
 */
export function Checker_errorAndMaybeSuggestAwait(receiver, location, maybeMissingAwait, message, ...args) {
 ...
 * }
 */
export function Checker_getTargetOfBinaryExpression(receiver, node) {
 ...
 * }
 */
export function Checker_getTargetOfAccessExpression(receiver, node) {
 ...
 * }
 */
export function keyBuilder_writeNodeId(receiver, id) {
    keyBuilder_writeInt(receiver, id);
}
/**
 ...
 * }
 */
export function keyBuilder_writeNode(receiver, node) {
    if (node !== undefined) {
 ...
 * }
 */
export function Checker_getCombinedNodeFlagsCached(receiver, node) {
 ...
 * }
 */
export function Checker_functionHasImplicitReturn(receiver, fn) {
 ...
 * }
 */
export function Checker_createSyntheticExpression(receiver, parent, t, isSpread, tupleNameSource) {
 ...
 * }
 */
export function Checker_findContextualNode(receiver, node, includeCaches) {
 ...
 * }
 */
export function Checker_hasContextSensitiveReturnExpression(receiver, node) {
    ...
    return ForEachReturnStatement(body, (statement) => Node_Expression(statement) !== undefined && Checker_isContextSensitive(receiver, Node_Expression(statement)));
}
/**
 ...
 * }
 */
export function Checker_hasContextSensitiveYieldExpression(receiver, node) {
    const body = Node_Body(node);
    return (GetFunctionFlags(node) & FunctionFlagsGenerator) !== 0 && body !== undefined && forEachYieldExpression(body, (expr) => Checker_isContextSensitive(receiver, expr));
}
//# sourceMappingURL=syntax-checking.js.map