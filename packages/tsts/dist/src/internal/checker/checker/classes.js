...
import { Checker_checkClassLikeDeclaration, Checker_getSymbolOfDeclaration, Checker_getTypeOfSymbol, Checker_forEachProperty, Checker_getParentOfSymbol, Checker_getDeclaredTypeOfSymbol, Checker_isPropertyAbstractOrInterface, Checker_isPropertyInClassDerivedFrom, Checker_resolveEntityName, Checker_registerForUnusedIdentifiersCheck, } from "./symbols.js";
 ...
 * }
 */
export function Checker_arePropertiesAbstractOrInterface(receiver, base, baseDeclarationFlags) {
    if ((base.CheckFlags & CheckFlagsSynthetic) !== 0) {
        return Some(base.Declarations, (d) => Checker_isPropertyAbstractOrInterface(receiver, d, baseDeclarationFlags));
    }
    return Every(base.Declarations, (d) => Checker_isPropertyAbstractOrInterface(receiver, d, baseDeclarationFlags));
}
/**
 ...
 * }
 */
export function Checker_checkClassExpression(receiver, node) {
 ...
 * }
 */
export function Checker_checkClassExpressionDeferred(receiver, node) {
 ...
 * }
 */
export function Checker_getDeclaringClass(receiver, prop) {
 ...
 * }
 */
export function Checker_isValidOverrideOf(receiver, sourceProp, targetProp) {
    return !Checker_forEachProperty(receiver, targetProp, (tp) => {
 ...
 * }
 */
export function Checker_isNodeUsedDuringClassInitialization(receiver, node) {
    return FindAncestorOrQuit(node, (element) => {
 ...
 * }
 */
export function Checker_isNodeWithinClass(receiver, node, classDeclaration) {
    return Checker_forEachEnclosingClass(receiver, node, (n) => n === classDeclaration);
}
/**
 ...
 * }
 */
export function Checker_forEachEnclosingClass(receiver, node, callback) {
 ...
 * }
 */
export function Checker_isClassDerivedFromDeclaringClasses(receiver, checkClass, prop, writing) {
    return !Checker_forEachProperty(receiver, prop, (p) => {
 ...
 * }
 */
export function Checker_checkThisInStaticClassFieldInitializerInDecoratedClass(receiver, thisExpression, container) {
 ...
 * }
 */
export function Checker_checkSpreadPropOverrides(receiver, t, props, spread) {
 ...
 * }
 */
export function Checker_isThislessInterface(receiver, symbol_) {
