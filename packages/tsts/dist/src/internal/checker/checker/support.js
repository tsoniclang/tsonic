...
import { KindArrayType, KindBindingElement, KindBlock, KindBreakStatement, KindCallSignature, KindClassDeclaration, KindClassStaticBlockDeclaration, KindConditionalType, KindConstructor, KindConstructorType, KindConstructSignature, KindContinueStatement, KindDebuggerStatement, KindDoStatement, KindEmptyStatement, KindEnumDeclaration, KindEnumMember, KindExportAssignment, KindExportDeclaration, KindForInStatement, KindForOfStatement, KindForStatement, KindFunctionDeclaration, KindFunctionType, KindGetAccessor, KindIfStatement, KindImportDeclaration, KindImportEqualsDeclaration, KindImportType, KindIndexedAccessType, KindIndexSignature, KindInferType, KindInterfaceDeclaration, KindIntersectionType, KindJSDocAllType, KindJSDocNullableType, KindJSDocNonNullableType, KindJSDocTypeLiteral, KindJSImportDeclaration, KindJSTypeAliasDeclaration, KindLabeledStatement, KindMappedType, KindMethodDeclaration, KindMethodSignature, KindMissingDeclaration, KindModuleBlock, KindModuleDeclaration, KindNamedTupleMember, KindOptionalType, KindParameter, KindParenthesizedType, KindPropertyDeclaration, KindPropertySignature, KindRestType, KindReturnStatement, KindSetAccessor, KindSwitchStatement, KindTemplateLiteralType, KindThisType, KindThrowStatement, KindTryStatement, KindTupleType, KindTypeAssertionExpression, KindTypeAliasDeclaration, KindTypeLiteral, KindTypeOperator, KindTypeParameter, KindTypePredicate, KindTypeQuery, KindTypeReference, KindUnionType, KindVariableDeclaration, KindVariableStatement, KindWhileStatement, KindWithStatement, KindExpressionStatement, } from "../../ast/generated/kinds.js";
...
import { All_destructured_elements_are_unused, An_async_iterator_must_have_a_next_method, An_iterator_must_have_a_next_method, A_const_assertion_can_only_be_applied_to_references_to_enum_members_or_string_number_boolean_array_or_object_literals, Compiler_reserves_name_0_when_emitting_private_identifier_downlevel, Conversion_of_type_0_to_type_1_may_be_a_mistake_because_neither_type_sufficiently_overlaps_with_the_other_If_this_was_intentional_convert_the_expression_to_unknown_first, Declaration_name_conflicts_with_built_in_global_identifier_0, Did_you_mean_0, Duplicate_identifier_0_Compiler_reserves_name_1_when_emitting_super_references_in_static_initializers, The_0_property_of_an_async_iterator_must_be_a_method, The_0_property_of_an_iterator_must_be_a_method, This_condition_will_always_return_0, This_syntax_is_not_allowed_when_erasableSyntaxOnly_is_enabled, The_type_returned_by_the_0_method_of_an_async_iterator_must_be_a_promise_for_a_type_with_a_value_property, The_type_returned_by_the_0_method_of_an_iterator_must_have_a_value_property, Type_of_await_operand_must_either_be_a_valid_promise_or_must_not_contain_a_callable_then_member, We_can_only_write_a_type_for_0_by_adding_a_type_for_the_entire_parameter_here, X_0_is_an_unused_renaming_of_1_Did_you_intend_to_use_it_as_a_type_annotation, } from "../../diagnostics/generated/messages.js";
 ...
 * }
 */
export function Checker_reportUnreliableWorker(receiver, t) {
 ...
 * }
 */
export function Checker_reportUnmeasurableWorker(receiver, t) {
    if (t === receiver.markerSuperType || t === receiver.markerSubType || t === receiver.markerOtherType) {
 ...
 * }
 */
export function Checker_initializeClosures(receiver) {
    receiver.isPrimitiveOrObjectOrEmptyType = (t) => {
        return (t.flags & (TypeFlagsPrimitive | TypeFlagsNonPrimitive)) !== 0 || Checker_IsEmptyAnonymousObjectType(receiver, t);
    };
    receiver.containsMissingType = (t) => {
        return t === receiver.missingType || ((t.flags & TypeFlagsUnion) !== 0 && Type_Types(t)[0] === receiver.missingType);
    };
    receiver.couldContainTypeVariables = (t) => Checker_couldContainTypeVariablesWorker(receiver, t);
    receiver.isStringIndexSignatureOnlyType = (t) => Checker_isStringIndexSignatureOnlyTypeWorker(receiver, t);
    receiver.markNodeAssignments = (node) => Checker_markNodeAssignmentsWorker(receiver, node);
    receiver.compareTypesAssignable = (s, t, reportErrors) => Checker_compareTypesAssignableWorker(receiver, s, t, reportErrors);
}
/**
 ...
 * }
 */
export function Checker_initializeIterationResolvers(receiver) {
    receiver.syncIterationTypesResolver = {
        ...
        resolveIterationType: (t, _errorNode) => t,
    ...
    receiver.asyncIterationTypesResolver = {
        ...
        resolveIterationType: (t, errorNode) => Checker_getAwaitedTypeEx(receiver, t, errorNode, Type_of_await_operand_must_either_be_a_valid_promise_or_must_not_contain_a_callable_then_member),
 ...
 * }
 */
export function Checker_initializeChecker(receiver) {
    const ambientModuleSymbols = [];
    const augmentations = [];
    for (const file of receiver.files) {
        if (!IsExternalOrCommonJSModule(file)) {
            const fileLocals = Node_Locals(file);
        ...
        if (Node_Symbol(file) !== undefined) {
            for (const [name, symbol_] of file.GlobalExports ?? new globalThis.Map()) {
 ...
 * }
 */
export function Checker_symbolReferenced(receiver, symbol_, meaning) {
 ...
 * }
 */
export function Checker_checkSourceElements(receiver, nodes) {
 ...
 * }
 */
export function Checker_checkSourceElement(receiver, node) {
    if (node !== undefined) {
 ...
 * }
 */
export function Checker_checkSourceElementWorker(receiver, node) {
    ...
    switch (node.Kind) {
        ...
        case KindRestType:
            Node_ForEachChild(node, (child) => Checker_checkSourceElement(receiver, child));
            break;
        case KindThisType:
 ...
 * }
 */
export function Checker_shouldCheckErasableSyntax(receiver, node) {
 ...
 * }
 */
export function Checker_checkBindingElement(receiver, node) {
 ...
 * }
 */
export function Checker_reportUnused(receiver, location, kind, diagnostic) {
 ...
 * }
 */
export function Checker_reportUnusedBindingElements(receiver, node) {
 ...
 * }
 */
export function Checker_checkUnusedRenamedBindingElements(receiver) {
    for (const node of receiver.renamedBindingElementsInTypes) {
        const links = LinkStore_Get(receiver.symbolReferenceLinks, Checker_getSymbolOfDeclaration(receiver, node));
        if ((links.referenceKinds ?? SymbolFlagsNone) === 0) {
            ...
            const diagnostic = NewDiagnosticForNode(name, X_0_is_an_unused_renaming_of_1_Did_you_intend_to_use_it_as_a_type_annotation, DeclarationNameToString(name), DeclarationNameToString(propertyName));
            if (Node_Type(wrappingDeclaration) === undefined) {
                Diagnostic_AddRelatedInfo(diagnostic, NewDiagnostic(GetSourceFileOfNode(wrappingDeclaration), NewTextRange(Node_End(wrappingDeclaration), Node_End(wrappingDeclaration)), We_can_only_write_a_type_for_0_by_adding_a_type_for_the_entire_parameter_here, DeclarationNameToString(propertyName)));
            }
            Checker_addDiagnostic(receiver, diagnostic);
        }
    }
 ...
 * }
 */
export function Checker_checkWeakMapSetCollision(receiver, node) {
    const enclosingBlockScope = GetEnclosingBlockScopeContainer(node);
    if ((LinkStore_Get(receiver.nodeLinks, enclosingBlockScope).flags & NodeCheckFlagsContainsClassWithPrivateIdentifiers) !== 0) {
        const name = Node_Name(node);
 ...
 * }
 */
export function Checker_checkReflectCollision(receiver, node) {
    let hasCollision = false;
    if (IsClassExpression(node)) {
        for (const member of Node_Members(node) ?? []) {
            if ((LinkStore_Get(receiver.nodeLinks, member).flags & NodeCheckFlagsContainsSuperPropertyInStaticInitializer) !== 0) {
                hasCollision = true;
                break;
            }
        }
        ...
        if ((LinkStore_Get(receiver.nodeLinks, node).flags & NodeCheckFlagsContainsSuperPropertyInStaticInitializer) !== 0) {
            hasCollision = true;
        }
    }
    else {
        const container = GetEnclosingBlockScopeContainer(node);
        if (container !== undefined && (LinkStore_Get(receiver.nodeLinks, container).flags & NodeCheckFlagsContainsSuperPropertyInStaticInitializer) !== 0) {
            hasCollision = true;
        }
    }
    if (hasCollision) {
 ...
 * }
 */
export function Checker_checkThisBeforeSuper(receiver, node, container, diagnosticMessage) {
 ...
 * }
 */
export function Checker_checkAssertion(receiver, node, checkMode) {
    if (node.Kind === KindTypeAssertionExpression) {
        if (Checker_shouldCheckErasableSyntax(receiver, node)) {
            const sourceFile = GetSourceFileOfNode(node);
            Checker_addDiagnostic(receiver, NewDiagnostic(sourceFile, NewTextRange(SkipTrivia(SourceFile_Text(sourceFile), Node_Pos(node)), Node_Pos(Node_Expression(node))), This_syntax_is_not_allowed_when_erasableSyntaxOnly_is_enabled));
        }
    }
    ...
    const links = LinkStore_Get(receiver.assertionLinks, node);
    links.exprType = exprType;
 ...
 * }
 */
export function Checker_checkAssertionDeferred(receiver, node) {
    const typeNode = Node_Type(node);
    const sourceType = LinkStore_Get(receiver.assertionLinks, node).exprType;
    ...
    if (!Checker_isErrorType(receiver, sourceType) && !Checker_isErrorType(receiver, targetType)) {
        ...
        if (!Checker_isTypeComparableTo(receiver, targetType, widenedType)) {
            ...
            recordExtensionCheckedAssertionConversion(receiver, node, sourceType, targetType, node.Kind === KindTypeAssertionExpression
                ? "angle-bracket"
 ...
 * }
 */
export function Checker_checkNaNEquality(receiver, errorNode, operator, left, right) {
    const isLeftNaN = Checker_isGlobalNaN(receiver, SkipParentheses(left));
    const isRightNaN = Checker_isGlobalNaN(receiver, SkipParentheses(right));
    if (isLeftNaN || isRightNaN) {
        const err = Checker_error(receiver, errorNode, This_condition_will_always_return_0, TokenToString(operator === KindEqualsEqualsEqualsToken || operator === KindEqualsEqualsToken ? KindFalseKeyword : KindTrueKeyword));
        if (isLeftNaN && isRightNaN) {
            return;
        }
        let operatorString = "";
 ...
 * }
 */
export function Checker_error(receiver, location, message, ...args) {
 ...
 * }
 */
export function Checker_errorSkippedOnNoEmit(receiver, location, message, ...args) {
 ...
 * }
 */
export function Checker_errorOrSuggestion(receiver, isError, location, message, ...args) {
 ...
 * }
 */
export function Checker_canHaveSyntheticDefault(receiver, file, moduleSymbol, dontResolveAlias, usage) {
    const c = receiver;
    ...
    if (sourceFile === undefined || sourceFile.IsDeclarationFile) {
        const defaultExportSymbol = Checker_resolveExportByName(receiver, moduleSymbol, InternalSymbolNameDefault, undefined, true);
    ...
    return ((sourceFile.ExternalModuleIndicator === undefined || sourceFile.ExternalModuleIndicator === file) &&
        Checker_resolveExportByName(receiver, moduleSymbol, "__esModule", undefined, dontResolveAlias) === undefined);
}
/**
 ...
 * }
 */
export function CacheHashKey_IsZero(receiver) {
 ...
 * }
 */
export function keyBuilder_writeByte(receiver, c) {
    receiver.h.Write([c]);
}
/**
 ...
 * }
 */
export function keyBuilder_writeString(receiver, s) {
 ...
 * }
 */
export function keyBuilder_writeInt(receiver, value) {
 ...
 * }
 */
export function Checker_findMixins(receiver, types) {
    const mixinFlags = Map(types, (t) => Checker_isMixinConstructorType(receiver, t));
 ...
 * }
 */
export function Checker_symbolIsValue(receiver, symbol_) {
 ...
 * }
 */
export function Checker_symbolIsValueEx(receiver, symbol_, includeTypeOnlyMembers) {
 ...
 * }
 */
export function Checker_evaluateEntity(receiver, expr, location) {
    switch (expr.Kind) {
        case KindIdentifier:
        case KindPropertyAccessExpression: {
            const symbol_ = Checker_resolveEntityName(receiver, expr, SymbolFlagsValue, true, false, undefined);
            ...
            if (expr.Kind === KindIdentifier) {
                if (IsInfinityOrNaNString(Node_Text(expr)) && symbol_ === Checker_getGlobalSymbol(receiver, Node_Text(expr), SymbolFlagsValue, undefined)) {
                    return NewResult(FromString(Node_Text(expr)), false, false, false);
                }
            }
            ...
            if (Checker_isConstantVariable(receiver, symbol_)) {
                ...
                if (declaration !== undefined &&
                    ...
                    if (location !== undefined && GetSourceFileOfNode(location) !== GetSourceFileOfNode(declaration)) {
                        return NewResult(result.Value, false, true, true);
                    }
                    return NewResult(result.Value, result.IsSyntacticallyString, result.ResolvedOtherFiles, true);
                }
            }
            return NewResult(undefined, false, false, false);
        }
        case KindElementAccessExpression: {
            ...
            if (IsEntityNameExpression(root) && IsStringLiteralLike(argumentExpression)) {
                const rootSymbol = Checker_resolveEntityName(receiver, root, SymbolFlagsValue, true, false, undefined);
 ...
 * }
 */
export function Checker_compareProperties(receiver, sourceProp, targetProp, compareTypes) {
    // Two members are considered identical when
    // - they are public properties with identical names, optionality, and types,
    // - they are private or protected properties originating in the same declaration and having identical types
    if (sourceProp === targetProp) {
 ...
 * }
 */
export function Checker_GetEmitResolver(receiver) {
    receiver.emitResolverOnce.Do(() => {
