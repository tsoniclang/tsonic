 ...
 * }
 */
export declare function Checker_checkTypePredicate(receiver: GoPtr<Checker>, node: GoPtr<Node>): void;
/**
 ...
 * }
 */
export declare function Checker_getTypePredicateParent(receiver: GoPtr<Checker>, node: GoPtr<Node>): GoPtr<SignatureDeclaration>;
/**
 ...
 * }
 */
export declare function Checker_checkIfTypePredicateVariableIsDeclaredInBindingPattern(receiver: GoPtr<Checker>, pattern: GoPtr<Node>, predicateVariableNode: GoPtr<Node>, predicateVariableName: string): bool;
/**
 ...
 * }
 */
export declare function Checker_checkTestingKnownTruthyCallableOrAwaitableOrEnumMemberType(receiver: GoPtr<Checker>, condExpr: GoPtr<Node>, condType: GoPtr<Type>, body: GoPtr<Node>): void;
/**
 ...
 * }
 */
export declare function Checker_checkTestingKnownTruthyTypes(receiver: GoPtr<Checker>, condExpr: GoPtr<Node>, condType: GoPtr<Type>, body: GoPtr<Node>): void;
/**
 ...
 * }
 */
export declare function Checker_checkTestingKnownTruthyType(receiver: GoPtr<Checker>, condExpr: GoPtr<Node>, condType: GoPtr<Type>, body: GoPtr<Node>): void;
/**
 ...
 * }
 */
export declare function Checker_checkTruthinessExpression(receiver: GoPtr<Checker>, node: GoPtr<Node>, checkMode: CheckMode): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function Checker_getFlowTypeOfAccessExpression(receiver: GoPtr<Checker>, node: GoPtr<Node>, prop: GoPtr<Symbol>, propType: GoPtr<Type>, errorNode: GoPtr<Node>, checkMode: CheckMode): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function Checker_getControlFlowContainer(receiver: GoPtr<Checker>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function Checker_getFlowTypeOfProperty(receiver: GoPtr<Checker>, reference: GoPtr<Node>, prop: GoPtr<Symbol>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function Checker_checkTruthinessOfType(receiver: GoPtr<Checker>, t: GoPtr<Type>, node: GoPtr<Node>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function Checker_getSyntacticTruthySemantics(receiver: GoPtr<Checker>, node: GoPtr<Node>): PredicateSemantics;
/**
 ...
 * }
 */
export declare function Checker_getNarrowedTypeOfSymbol(receiver: GoPtr<Checker>, symbol_: GoPtr<Symbol>, location: GoPtr<Node>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function Checker_getFlowTypeOfDestructuring(receiver: GoPtr<Checker>, node: GoPtr<Node>, declaredType: GoPtr<Type>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function Checker_getTypePredicateFromBody(receiver: GoPtr<Checker>, fn: GoPtr<Node>): GoPtr<TypePredicate>;
/**
 ...
 * }
 */
export declare function Checker_isDiscriminantWithNeverType(receiver: GoPtr<Checker>, prop: GoPtr<Symbol>): bool;
/**
 ...
 * }
 */
export declare function Checker_getConditionalFlowTypeOfType(receiver: GoPtr<Checker>, t: GoPtr<Type>, node: GoPtr<Node>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function Checker_removeDefinitelyFalsyTypes(receiver: GoPtr<Checker>, t: GoPtr<Type>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function Checker_extractDefinitelyFalsyTypes(receiver: GoPtr<Checker>, t: GoPtr<Type>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function Checker_getDefinitelyFalsyPartOfType(receiver: GoPtr<Checker>, t: GoPtr<Type>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function Checker_isPossiblyDiscriminantValue(receiver: GoPtr<Checker>, node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function Checker_getNarrowableTypeForReference(receiver: GoPtr<Checker>, t: GoPtr<Type>, reference: GoPtr<Node>, checkMode: CheckMode): GoPtr<Type>;
//# sourceMappingURL=flow-narrowing.d.ts.map