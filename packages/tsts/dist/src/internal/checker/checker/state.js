 ...
 * )
 */
export const CheckModeNormal = 0; // Normal type checking
export const CheckModeContextual = 1 << 0; // Explicitly assigned contextual type, therefore not cacheable
export const CheckModeInferential = 1 << 1; // Inferential typing
export const CheckModeSkipContextSensitive = 1 << 2; // Skip context sensitive function expressions
export const CheckModeSkipGenericFunctions = 1 << 3; // Skip single signature generic functions
export const CheckModeIsForSignatureHelp = 1 << 4; // Call resolution for purposes of signature help
export const CheckModeRestBindingElement = 1 << 5; // Checking a type that is going to be used to determine the type of a rest binding element
export const CheckModeTypeOnly = 1 << 6; // Called from getTypeOfExpression, diagnostics may be omitted
export const CheckModeForceTuple = 1 << 7;
/**
 ...
 * )
 */
export const TypeSystemPropertyNameType = 0;
export const TypeSystemPropertyNameResolvedBaseConstructorType = 1;
export const TypeSystemPropertyNameDeclaredType = 2;
export const TypeSystemPropertyNameResolvedReturnType = 3;
export const TypeSystemPropertyNameResolvedBaseConstraint = 4;
export const TypeSystemPropertyNameResolvedTypeArguments = 5;
export const TypeSystemPropertyNameResolvedBaseTypes = 6;
export const TypeSystemPropertyNameWriteType = 7;
export const TypeSystemPropertyNameInitializerIsUndefined = 8;
export const TypeSystemPropertyNameAliasTarget = 9;
/**
 ...
 * )
 */
export const WideningKindNormal = 0;
export const WideningKindFunctionReturn = 1;
export const WideningKindGeneratorNext = 2;
export const WideningKindGeneratorYield = 3;
/**
 ...
 * )
 */
export const CachedTypeKindLiteralUnionBaseType = 0;
export const CachedTypeKindIndexType = 1;
export const CachedTypeKindStringIndexType = 2;
export const CachedTypeKindEquivalentBaseType = 3;
export const CachedTypeKindApparentType = 4;
export const CachedTypeKindAwaitedType = 5;
export const CachedTypeKindEvolvingArrayType = 6;
export const CachedTypeKindArrayLiteralType = 7;
export const CachedTypeKindPermissiveInstantiation = 8;
export const CachedTypeKindRestrictiveInstantiation = 9;
export const CachedTypeKindRestrictiveTypeParameter = 10;
export const CachedTypeKindIndexedAccessForReading = 11;
export const CachedTypeKindIndexedAccessForWriting = 12;
export const CachedTypeKindWidened = 13;
export const CachedTypeKindRegularObjectLiteral = 14;
export const CachedTypeKindPromisedTypeOfPromise = 15;
export const CachedTypeKindDefaultOnlyType = 16;
export const CachedTypeKindSyntheticType = 17;
export const CachedTypeKindDecoratorContext = 18;
export const CachedTypeKindDecoratorContextStatic = 19;
export const CachedTypeKindDecoratorContextPrivate = 20;
export const CachedTypeKindDecoratorContextPrivateStatic = 21;
/**
 ...
 * )
 */
export let SignatureKeyErased = xxh3.HashString128("-");
export let SignatureKeyCanonical = xxh3.HashString128("*");
export let SignatureKeyBase = xxh3.HashString128("#");
export let SignatureKeyInner = xxh3.HashString128("<");
export let SignatureKeyOuter = xxh3.HashString128(">");
/**
 ...
 * )
 */
export const InferenceFlagsNone = 0; // No special inference behaviors
export const InferenceFlagsNoDefault = 1 << 0; // Infer silentNeverType for no inferences (otherwise anyType or unknownType)
export const InferenceFlagsAnyDefault = 1 << 1; // Infer anyType (in JS files) for no inferences (otherwise unknownType)
export const InferenceFlagsSkippedGenericFunction = 1 << 2; // A generic function was skipped during inference
/**
 ...
 * )
 */
export const InferencePriorityNone = 0;
export const InferencePriorityNakedTypeVariable = 1 << 0; // Naked type variable in union or intersection type
export const InferencePrioritySpeculativeTuple = 1 << 1; // Speculative tuple inference
export const InferencePrioritySubstituteSource = 1 << 2; // Source of inference originated within a substitution type's substitute
export const InferencePriorityHomomorphicMappedType = 1 << 3; // Reverse inference for homomorphic mapped type
export const InferencePriorityPartialHomomorphicMappedType = 1 << 4; // Partial reverse inference for homomorphic mapped type
export const InferencePriorityMappedTypeConstraint = 1 << 5; // Reverse inference for mapped type
export const InferencePriorityContravariantConditional = 1 << 6; // Conditional type in contravariant position
export const InferencePriorityReturnType = 1 << 7; // Inference made from return type of generic function
export const InferencePriorityLiteralKeyof = 1 << 8; // Inference made from a string literal to a keyof T
export const InferencePriorityNoConstraints = 1 << 9; // Don't infer from constraints of instantiable types
export const InferencePriorityAlwaysStrict = 1 << 10; // Always use strict rules for contravariant inferences
export const InferencePriorityMaxValue = 1 << 11; // Seed for inference priority tracking
export const InferencePriorityCircularity = -1; // Inference circularity (value less than all other priorities)
// These priorities imply that the resulting type should be a combination of all candidates
export const InferencePriorityPriorityImpliesCombination = InferencePriorityReturnType | InferencePriorityMappedTypeConstraint | InferencePriorityLiteralKeyof;
/**
 ...
 * )
 */
export const DeclarationMeaningGetAccessor = 1 << 0;
export const DeclarationMeaningSetAccessor = 1 << 1;
export const DeclarationMeaningPropertyAssignment = 1 << 2;
export const DeclarationMeaningMethod = 1 << 3;
export const DeclarationMeaningPrivateStatic = 1 << 4;
export const DeclarationMeaningGetOrSetAccessor = DeclarationMeaningGetAccessor | DeclarationMeaningSetAccessor;
export const DeclarationMeaningPropertyAssignmentOrMethod = DeclarationMeaningPropertyAssignment | DeclarationMeaningMethod;
/**
 ...
 * )
 */
export const DeclarationSpacesNone = 0;
export const DeclarationSpacesExportValue = 1 << 0;
export const DeclarationSpacesExportType = 1 << 1;
export const DeclarationSpacesExportNamespace = 1 << 2;
/**
 ...
 * )
 */
export const IntrinsicTypeKindUnknown = 0;
export const IntrinsicTypeKindUppercase = 1;
export const IntrinsicTypeKindLowercase = 2;
export const IntrinsicTypeKindCapitalize = 3;
export const IntrinsicTypeKindUncapitalize = 4;
export const IntrinsicTypeKindNoInfer = 5;
/**
 ...
 * }
 */
export let intrinsicTypeKinds = new globalThis.Map([
    ["Uppercase", IntrinsicTypeKindUppercase],
    ["Lowercase", IntrinsicTypeKindLowercase],
    ["Capitalize", IntrinsicTypeKindCapitalize],
    ["Uncapitalize", IntrinsicTypeKindUncapitalize],
 ...
 * )
 */
export const MappedTypeModifiersIncludeReadonly = 1 << 0;
export const MappedTypeModifiersExcludeReadonly = 1 << 1;
export const MappedTypeModifiersIncludeOptional = 1 << 2;
export const MappedTypeModifiersExcludeOptional = 1 << 3;
/**
 ...
 * )
 */
export const MappedTypeNameTypeKindNone = 0;
export const MappedTypeNameTypeKindFiltering = 1;
export const MappedTypeNameTypeKindRemapping = 2;
/**
 ...
 * )
 */
export const ReferenceHintUnspecified = 0;
export const ReferenceHintIdentifier = 1;
export const ReferenceHintProperty = 2;
export const ReferenceHintExportAssignment = 3;
export const ReferenceHintJsx = 4;
export const ReferenceHintExportImportEquals = 5;
export const ReferenceHintExportSpecifier = 6;
export const ReferenceHintDecorator = 7;
/**
 ...
 * )
 */
export const TypeFactsNone = 0;
export const TypeFactsTypeofEQString = 1 << 0;
export const TypeFactsTypeofEQNumber = 1 << 1;
export const TypeFactsTypeofEQBigInt = 1 << 2;
export const TypeFactsTypeofEQBoolean = 1 << 3;
export const TypeFactsTypeofEQSymbol = 1 << 4;
export const TypeFactsTypeofEQObject = 1 << 5;
export const TypeFactsTypeofEQFunction = 1 << 6;
export const TypeFactsTypeofEQHostObject = 1 << 7;
export const TypeFactsTypeofNEString = 1 << 8;
export const TypeFactsTypeofNENumber = 1 << 9;
export const TypeFactsTypeofNEBigInt = 1 << 10;
export const TypeFactsTypeofNEBoolean = 1 << 11;
export const TypeFactsTypeofNESymbol = 1 << 12;
export const TypeFactsTypeofNEObject = 1 << 13;
export const TypeFactsTypeofNEFunction = 1 << 14;
export const TypeFactsTypeofNEHostObject = 1 << 15;
export const TypeFactsEQUndefined = 1 << 16;
export const TypeFactsEQNull = 1 << 17;
export const TypeFactsEQUndefinedOrNull = 1 << 18;
export const TypeFactsNEUndefined = 1 << 19;
export const TypeFactsNENull = 1 << 20;
export const TypeFactsNEUndefinedOrNull = 1 << 21;
export const TypeFactsTruthy = 1 << 22;
export const TypeFactsFalsy = 1 << 23;
export const TypeFactsIsUndefined = 1 << 24;
export const TypeFactsIsNull = 1 << 25;
export const TypeFactsIsUndefinedOrNull = TypeFactsIsUndefined | TypeFactsIsNull;
export const TypeFactsAll = (1 << 27) - 1;
// The following members encode facts about particular kinds of types for use in the getTypeFacts function.
// The presence of a particular fact means that the given test is true for some (and possibly all) values
// of that kind of type.
export const TypeFactsBaseStringStrictFacts = TypeFactsTypeofEQString | TypeFactsTypeofNENumber | TypeFactsTypeofNEBigInt | TypeFactsTypeofNEBoolean | TypeFactsTypeofNESymbol | TypeFactsTypeofNEObject | TypeFactsTypeofNEFunction | TypeFactsTypeofNEHostObject | TypeFactsNEUndefined | TypeFactsNENull | TypeFactsNEUndefinedOrNull;
export const TypeFactsBaseStringFacts = TypeFactsBaseStringStrictFacts | TypeFactsEQUndefined | TypeFactsEQNull | TypeFactsEQUndefinedOrNull | TypeFactsFalsy;
export const TypeFactsStringStrictFacts = TypeFactsBaseStringStrictFacts | TypeFactsTruthy | TypeFactsFalsy;
export const TypeFactsStringFacts = TypeFactsBaseStringFacts | TypeFactsTruthy;
export const TypeFactsEmptyStringStrictFacts = TypeFactsBaseStringStrictFacts | TypeFactsFalsy;
export const TypeFactsEmptyStringFacts = TypeFactsBaseStringFacts;
export const TypeFactsNonEmptyStringStrictFacts = TypeFactsBaseStringStrictFacts | TypeFactsTruthy;
export const TypeFactsNonEmptyStringFacts = TypeFactsBaseStringFacts | TypeFactsTruthy;
export const TypeFactsBaseNumberStrictFacts = TypeFactsTypeofEQNumber | TypeFactsTypeofNEString | TypeFactsTypeofNEBigInt | TypeFactsTypeofNEBoolean | TypeFactsTypeofNESymbol | TypeFactsTypeofNEObject | TypeFactsTypeofNEFunction | TypeFactsTypeofNEHostObject | TypeFactsNEUndefined | TypeFactsNENull | TypeFactsNEUndefinedOrNull;
export const TypeFactsBaseNumberFacts = TypeFactsBaseNumberStrictFacts | TypeFactsEQUndefined | TypeFactsEQNull | TypeFactsEQUndefinedOrNull | TypeFactsFalsy;
export const TypeFactsNumberStrictFacts = TypeFactsBaseNumberStrictFacts | TypeFactsTruthy | TypeFactsFalsy;
export const TypeFactsNumberFacts = TypeFactsBaseNumberFacts | TypeFactsTruthy;
export const TypeFactsZeroNumberStrictFacts = TypeFactsBaseNumberStrictFacts | TypeFactsFalsy;
export const TypeFactsZeroNumberFacts = TypeFactsBaseNumberFacts;
export const TypeFactsNonZeroNumberStrictFacts = TypeFactsBaseNumberStrictFacts | TypeFactsTruthy;
export const TypeFactsNonZeroNumberFacts = TypeFactsBaseNumberFacts | TypeFactsTruthy;
export const TypeFactsBaseBigIntStrictFacts = TypeFactsTypeofEQBigInt | TypeFactsTypeofNEString | TypeFactsTypeofNENumber | TypeFactsTypeofNEBoolean | TypeFactsTypeofNESymbol | TypeFactsTypeofNEObject | TypeFactsTypeofNEFunction | TypeFactsTypeofNEHostObject | TypeFactsNEUndefined | TypeFactsNENull | TypeFactsNEUndefinedOrNull;
export const TypeFactsBaseBigIntFacts = TypeFactsBaseBigIntStrictFacts | TypeFactsEQUndefined | TypeFactsEQNull | TypeFactsEQUndefinedOrNull | TypeFactsFalsy;
export const TypeFactsBigIntStrictFacts = TypeFactsBaseBigIntStrictFacts | TypeFactsTruthy | TypeFactsFalsy;
export const TypeFactsBigIntFacts = TypeFactsBaseBigIntFacts | TypeFactsTruthy;
export const TypeFactsZeroBigIntStrictFacts = TypeFactsBaseBigIntStrictFacts | TypeFactsFalsy;
export const TypeFactsZeroBigIntFacts = TypeFactsBaseBigIntFacts;
export const TypeFactsNonZeroBigIntStrictFacts = TypeFactsBaseBigIntStrictFacts | TypeFactsTruthy;
export const TypeFactsNonZeroBigIntFacts = TypeFactsBaseBigIntFacts | TypeFactsTruthy;
export const TypeFactsBaseBooleanStrictFacts = TypeFactsTypeofEQBoolean | TypeFactsTypeofNEString | TypeFactsTypeofNENumber | TypeFactsTypeofNEBigInt | TypeFactsTypeofNESymbol | TypeFactsTypeofNEObject | TypeFactsTypeofNEFunction | TypeFactsTypeofNEHostObject | TypeFactsNEUndefined | TypeFactsNENull | TypeFactsNEUndefinedOrNull;
export const TypeFactsBaseBooleanFacts = TypeFactsBaseBooleanStrictFacts | TypeFactsEQUndefined | TypeFactsEQNull | TypeFactsEQUndefinedOrNull | TypeFactsFalsy;
export const TypeFactsBooleanStrictFacts = TypeFactsBaseBooleanStrictFacts | TypeFactsTruthy | TypeFactsFalsy;
export const TypeFactsBooleanFacts = TypeFactsBaseBooleanFacts | TypeFactsTruthy;
export const TypeFactsFalseStrictFacts = TypeFactsBaseBooleanStrictFacts | TypeFactsFalsy;
export const TypeFactsFalseFacts = TypeFactsBaseBooleanFacts;
export const TypeFactsTrueStrictFacts = TypeFactsBaseBooleanStrictFacts | TypeFactsTruthy;
export const TypeFactsTrueFacts = TypeFactsBaseBooleanFacts | TypeFactsTruthy;
export const TypeFactsSymbolStrictFacts = TypeFactsTypeofEQSymbol | TypeFactsTypeofNEString | TypeFactsTypeofNENumber | TypeFactsTypeofNEBigInt | TypeFactsTypeofNEBoolean | TypeFactsTypeofNEObject | TypeFactsTypeofNEFunction | TypeFactsTypeofNEHostObject | TypeFactsNEUndefined | TypeFactsNENull | TypeFactsNEUndefinedOrNull | TypeFactsTruthy;
export const TypeFactsSymbolFacts = TypeFactsSymbolStrictFacts | TypeFactsEQUndefined | TypeFactsEQNull | TypeFactsEQUndefinedOrNull | TypeFactsFalsy;
export const TypeFactsObjectStrictFacts = TypeFactsTypeofEQObject | TypeFactsTypeofEQHostObject | TypeFactsTypeofNEString | TypeFactsTypeofNENumber | TypeFactsTypeofNEBigInt | TypeFactsTypeofNEBoolean | TypeFactsTypeofNESymbol | TypeFactsTypeofNEFunction | TypeFactsNEUndefined | TypeFactsNENull | TypeFactsNEUndefinedOrNull | TypeFactsTruthy;
export const TypeFactsObjectFacts = TypeFactsObjectStrictFacts | TypeFactsEQUndefined | TypeFactsEQNull | TypeFactsEQUndefinedOrNull | TypeFactsFalsy;
export const TypeFactsFunctionStrictFacts = TypeFactsTypeofEQFunction | TypeFactsTypeofEQHostObject | TypeFactsTypeofNEString | TypeFactsTypeofNENumber | TypeFactsTypeofNEBigInt | TypeFactsTypeofNEBoolean | TypeFactsTypeofNESymbol | TypeFactsTypeofNEObject | TypeFactsNEUndefined | TypeFactsNENull | TypeFactsNEUndefinedOrNull | TypeFactsTruthy;
export const TypeFactsFunctionFacts = TypeFactsFunctionStrictFacts | TypeFactsEQUndefined | TypeFactsEQNull | TypeFactsEQUndefinedOrNull | TypeFactsFalsy;
export const TypeFactsVoidFacts = TypeFactsTypeofNEString | TypeFactsTypeofNENumber | TypeFactsTypeofNEBigInt | TypeFactsTypeofNEBoolean | TypeFactsTypeofNESymbol | TypeFactsTypeofNEObject | TypeFactsTypeofNEFunction | TypeFactsTypeofNEHostObject | TypeFactsEQUndefined | TypeFactsEQUndefinedOrNull | TypeFactsNENull | TypeFactsFalsy;
export const TypeFactsUndefinedFacts = TypeFactsTypeofNEString | TypeFactsTypeofNENumber | TypeFactsTypeofNEBigInt | TypeFactsTypeofNEBoolean | TypeFactsTypeofNESymbol | TypeFactsTypeofNEObject | TypeFactsTypeofNEFunction | TypeFactsTypeofNEHostObject | TypeFactsEQUndefined | TypeFactsEQUndefinedOrNull | TypeFactsNENull | TypeFactsFalsy | TypeFactsIsUndefined;
export const TypeFactsNullFacts = TypeFactsTypeofEQObject | TypeFactsTypeofNEString | TypeFactsTypeofNENumber | TypeFactsTypeofNEBigInt | TypeFactsTypeofNEBoolean | TypeFactsTypeofNESymbol | TypeFactsTypeofNEFunction | TypeFactsTypeofNEHostObject | TypeFactsEQNull | TypeFactsEQUndefinedOrNull | TypeFactsNEUndefined | TypeFactsFalsy | TypeFactsIsNull;
export const TypeFactsEmptyObjectStrictFacts = TypeFactsAll & ~(TypeFactsEQUndefined | TypeFactsEQNull | TypeFactsEQUndefinedOrNull | TypeFactsIsUndefinedOrNull);
export const TypeFactsEmptyObjectFacts = TypeFactsAll & ~TypeFactsIsUndefinedOrNull;
export const TypeFactsUnknownFacts = TypeFactsAll & ~TypeFactsIsUndefinedOrNull;
export const TypeFactsAllTypeofNE = TypeFactsTypeofNEString | TypeFactsTypeofNENumber | TypeFactsTypeofNEBigInt | TypeFactsTypeofNEBoolean | TypeFactsTypeofNESymbol | TypeFactsTypeofNEObject | TypeFactsTypeofNEFunction | TypeFactsNEUndefined;
// Masks
export const TypeFactsOrFactsMask = TypeFactsTypeofEQFunction | TypeFactsTypeofNEObject;
export const TypeFactsAndFactsMask = TypeFactsAll & ~TypeFactsOrFactsMask;
/**
 ...
 * )
 */
export const IterationUseAllowsSyncIterablesFlag = 1 << 0;
export const IterationUseAllowsAsyncIterablesFlag = 1 << 1;
export const IterationUseAllowsStringInputFlag = 1 << 2;
export const IterationUseForOfFlag = 1 << 3;
export const IterationUseYieldStarFlag = 1 << 4;
export const IterationUseSpreadFlag = 1 << 5;
export const IterationUseDestructuringFlag = 1 << 6;
export const IterationUsePossiblyOutOfBounds = 1 << 7;
// Spread, Destructuring, Array element assignment
export const IterationUseElement = IterationUseAllowsSyncIterablesFlag;
export const IterationUseSpread = IterationUseAllowsSyncIterablesFlag | IterationUseSpreadFlag;
export const IterationUseDestructuring = IterationUseAllowsSyncIterablesFlag | IterationUseDestructuringFlag;
export const IterationUseForOf = IterationUseAllowsSyncIterablesFlag | IterationUseAllowsStringInputFlag | IterationUseForOfFlag;
export const IterationUseForAwaitOf = IterationUseAllowsSyncIterablesFlag | IterationUseAllowsAsyncIterablesFlag | IterationUseAllowsStringInputFlag | IterationUseForOfFlag;
export const IterationUseYieldStar = IterationUseAllowsSyncIterablesFlag | IterationUseYieldStarFlag;
export const IterationUseAsyncYieldStar = IterationUseAllowsSyncIterablesFlag | IterationUseAllowsAsyncIterablesFlag | IterationUseYieldStarFlag;
export const IterationUseGeneratorReturnType = IterationUseAllowsSyncIterablesFlag;
export const IterationUseAsyncGeneratorReturnType = IterationUseAllowsAsyncIterablesFlag;
export const IterationUseCacheFlags = IterationUseAllowsSyncIterablesFlag | IterationUseAllowsAsyncIterablesFlag | IterationUseForOfFlag;
/**
 ...
 * )
 */
export const IterationTypeKindYield = 0;
export const IterationTypeKindReturn = 1;
export const IterationTypeKindNext = 2;
/**
 ...
 */
export let nextCheckerID = new Uint32();
function newArena() {
    return { data: [] };
}
function newLinkStore() {
    return {
        entries: new globalThis.Map(),
        arena: newArena(),
    };
}
function newCheckerSet() {
    return NewSetWithSizeHint(0);
}
export function Checker_getSourceFileLinks(receiver, sourceFile) {
    const links = LinkStore_Get(receiver.sourceFileLinks, sourceFile);
    links.deferredNodes ??= NewOrderedSetWithSizeHint(0);
    links.identifierCheckNodes ??= [];
    links.localJsxNamespace ??= "";
    links.localJsxFragmentNamespace ??= "";
    return links;
}
function newDiagnosticsCollection() {
    return {
        mu: new Mutex(),
        count: 0,
        fileDiagnostics: undefined,
        fileDiagnosticsSorted: newCheckerSet(),
 ...
 * }
 */
export function NewChecker(program, tracer) {
    program.BindSourceFiles();
    const checker = {};
    ...
    checker.wasCanceled = false;
    checker.flowAnalysisDisabled = false;
    checker.inVarianceComputation = false;
    checker.isInferencePartiallyBlocked = false;
    checker.saveDeferredDiagnostics = false;
    checker.lastFlowNodeReachable = false;
    ...
    checker.compareSymbols = (left, right) => Checker_compareSymbolsWorker(checker, left, right);
    checker.compareSymbolChains = (left, right) => Checker_compareSymbolChainsWorker(checker, left, right);
    ...
    checker.globals = new globalThis.Map();
    checker.evaluate = NewEvaluator((expr, location) => Checker_evaluateEntity(checker, expr, location), OEKParentheses);
    ...
    checker.markerTypes = newCheckerSet();
    checker.symbolArena = newArena();
    checker.signatureArena = newArena();
    checker.indexInfoArena = newArena();
    ...
    checker.globalThisSymbol = Checker_newSymbolEx(checker, SymbolFlagsModule, "globalThis", CheckFlagsReadonly);
    ...
    checker.resolveName = (location, name, meaning, nameNotFoundMessage, isUse, excludeGlobals) => NameResolver_Resolve(nameResolver, location, name, meaning, nameNotFoundMessage, isUse, excludeGlobals);
    checker.resolveNameForSymbolSuggestion = (location, name, meaning, nameNotFoundMessage, isUse, excludeGlobals) => NameResolver_Resolve(suggestionNameResolver, location, name, meaning, nameNotFoundMessage, isUse, excludeGlobals);
    ...
    checker.nodeLinks = newLinkStore();
    checker.signatureLinks = newLinkStore();
    checker.symbolNodeLinks = newLinkStore();
    checker.typeNodeLinks = newLinkStore();
    checker.enumMemberLinks = newLinkStore();
    checker.assertionLinks = newLinkStore();
    checker.arrayLiteralLinks = newLinkStore();
    checker.switchStatementLinks = newLinkStore();
    checker.jsxElementLinks = newLinkStore();
    checker.symbolReferenceLinks = newLinkStore();
    checker.valueSymbolLinks = newLinkStore();
    checker.mappedSymbolLinks = newLinkStore();
    checker.deferredSymbolLinks = newLinkStore();
    checker.aliasSymbolLinks = newLinkStore();
    checker.moduleSymbolLinks = newLinkStore();
    checker.lateBoundLinks = newLinkStore();
    checker.exportTypeLinks = newLinkStore();
    checker.membersAndExportsLinks = newLinkStore();
    checker.typeAliasLinks = newLinkStore();
    checker.declaredTypeLinks = newLinkStore();
    checker.spreadLinks = newLinkStore();
    checker.varianceLinks = newLinkStore();
    checker.ReverseMappedSymbolLinks = newLinkStore();
    checker.markedAssignmentSymbolLinks = newLinkStore();
    checker.symbolContainerLinks = newLinkStore();
    checker.sourceFileLinks = newLinkStore();
    ...
    checker.uniqueLiteralMapper = newFunctionTypeMapper((typeParameter) => Checker_getUniqueLiteralTypeForTypeParameter(checker, typeParameter));
    checker.reportUnreliableMapper = newFunctionTypeMapper((type) => Checker_reportUnreliableWorker(checker, type));
    checker.reportUnmeasurableMapper = newFunctionTypeMapper((type) => Checker_reportUnmeasurableWorker(checker, type));
    checker.restrictiveMapper = newFunctionTypeMapper((type) => Checker_restrictiveMapperWorker(checker, type));
    checker.permissiveMapper = newFunctionTypeMapper((type) => Checker_permissiveMapperWorker(checker, type));
    ...
    checker.noTypePredicate = { kind: TypePredicateKindIdentifier, parameterIndex: 0, parameterName: "<<unresolved>>", t: checker.anyType };
    ...
    checker.skipDirectInferenceNodes = newCheckerSet();
    ...
    checker.reportedUnreachableNodes = newCheckerSet();
    checker.nonExistentProperties = newCheckerSet();
 ...
 * }
 */
export function createFileIndexMap(files) {
 ...
 * }
 */
export function countGlobalSymbols(files) {
    let count = 0;
    for (const file of files) {
        if (!IsExternalOrCommonJSModule(file)) {
            const locals = Node_Locals(file);
            if (locals !== undefined) {
                count += locals.size;
            }
        }
 ...
 * }
 */
export function getGlobalTypeDeclaration(symbol_) {
 ...
 * }
 */
export function isPrimitiveTypeName(s) {
    return s === "any" || s === "string" || s === "number" || s === "boolean" || s === "never" || s === "unknown";
}
/**
 ...
 * }
 */
export function isES2015OrLaterConstructorName(s) {
    return s === "Promise" || s === "Symbol" || s === "Map" || s === "WeakMap" || s === "Set" || s === "WeakSet";
}
let _primitiveTypeAliasSuggestionsCache;
/**
 ...
 * })
 */
function _getPrimitiveTypeAliasSuggestionsMap() {
    if (_primitiveTypeAliasSuggestionsCache === undefined) {
        ...
        for (const e of pairs) {
            const sym = { Flags: (SymbolFlagsTypeAlias | SymbolFlagsTransient), CheckFlags: 0, Name: e.primitive, Declarations: [], ValueDeclaration: undefined, Members: undefined, Exports: undefined, id: new Uint64(), Parent: undefined, ExportSymbol: undefined };
...
export let primitiveTypeAliasSuggestions = _getPrimitiveTypeAliasSuggestionsMap;
/**
 ...
 * }
 */
export function getPrimitiveTypeAliasSuggestions(symbols) {
    return (yield_) => {
 ...
 * }
 */
export function isImmediatelyUsedInInitializerOfBlockScopedVariable(declaration, usage, declContainer) {
    switch (declaration.Parent.Parent.Kind) {
 ...
 * }
 */
export function isSameScopeDescendentOf(initial, parent, stopAt) {
    if (parent === undefined) {
        return false;
    }
    for (let n = initial; n !== undefined; n = n.Parent) {
        if (n === parent) {
            return true;
        }
 ...
 * }
 */
export function isPropertyImmediatelyReferencedWithinDeclaration(declaration, usage, stopAtAnyPropertyDeclaration) {
    if (Node_End(usage) > Node_End(declaration)) {
        return false;
    }
    for (let node = usage; node !== undefined && node !== declaration; node = node.Parent) {
        switch (node.Kind) {
 ...
 * }
 */
export function isInstancePropertyWithInitializerOrPrivateIdentifierProperty(n) {
 ...
 * }
 */
export function superCallIsRootLevelInConstructor(superCall, body) {
 ...
 * }
 */
export function nodeImmediatelyReferencesSuperOrThis(node) {
    switch (node.Kind) {
 ...
 * }
 */
export function getFirstNonAmbientClassOrFunctionDeclaration(symbol_) {
    for (const declaration of symbol_.Declarations ?? []) {
 ...
 * }
 */
export function hasTypeJsonImportAttribute(node) {
    const attributes = AsImportDeclaration(node).Attributes;
    return attributes !== undefined && Some(AsImportAttributes(attributes).Attributes.Nodes, (attr) => {
        const ia = AsImportAttribute(attr);
        return Node_Text(Node_Name(attr)) === "type" && IsStringLiteralLike(ia.Value) && Node_Text(ia.Value) === "json";
    });
}
/**
 ...
 * }
 */
export function getVerbatimModuleSyntaxErrorMessage(node) {
 ...
 * }
 */
export function isNotOverload(node) {
 ...
 * }
 */
export function isES2015OrLaterIterable(n) {
    switch (n) {
        case "Float32Array":
        case "Float64Array":
        case "Int16Array":
 ...
 * )
 */
export const UnusedKindLocal = 0;
export const UnusedKindParameter = 1;
/**
 ...
 * }
 */
export function isIdentifierThatStartsWithUnderscore(node) {
 ...
 * }
 */
export function importClauseFromImported(node) {
    switch (node.Kind) {
 ...
 * }
 */
export function hasTypeParameterByName(typeParameters, name) {
    return Some(typeParameters, (tp) => {
 ...
 * }
 */
export function getUniqueTypeParameterName(typeParameters, baseName) {
 ...
 * }
 */
export function isSpreadIntoCallOrNew(node) {
 ...
 * }
 */
export function someSignature(signatures, f) {
 ...
 * }
 */
export function signatureHasLiteralTypes(s) {
    return (s.flags & SignatureFlagsHasLiteralTypes) !== 0;
}
/**
 ...
 * }
 */
export function getErrorNodeForCallNode(node) {
 ...
 * }
 */
export function hasCommonDomTypeName(t) {
 ...
 * }
 */
export function getThisParameterFromNodeContext(node) {
 ...
 * )
 */
export const PredicateSemanticsNone = 0;
export const PredicateSemanticsAlways = 1 << 0;
export const PredicateSemanticsNever = 1 << 1;
export const PredicateSemanticsSometimes = PredicateSemanticsAlways | PredicateSemanticsNever;
/**
 ...
 * }
 */
export function createDiagnosticForNode(node, message, ...args) {
    return NewDiagnosticForNode(node, message, ...args);
}
/**
 ...
 * }
 */
export function getAdjustedNodeForError(node) {
 ...
 * }
 */
export function getFirstDeclaration(symbol_) {
 ...
 * }
 */
export function getExcludedSymbolFlags(flags) {
    let result = 0;
 ...
 * }
 */
export function getModuleSpecifierFromNode(node) {
    switch (node.Kind) {
 ...
 * }
 */
export function resolutionExtensionIsTSOrJson(ext) {
 ...
 * }
 */
export function isESMFormatImportImportingCommonjsFormatFile(usageMode, targetMode) {
 ...
 * }
 */
export function signatureHasRestParameter(sig) {
    return (sig.flags & SignatureFlagsHasRestParameter) !== 0;
}
/**
 ...
 * }
 */
export function hashWrite32(h, value) {
    const v = value;
    h.Write([
        v & 0xff,
        (v >> 8) & 0xff,
 ...
 * }
 */
export function hashWrite64(h, value) {
    const v = value;
    h.Write([
        v & 0xff,
        (v >> 8) & 0xff,
 ...
 * }
 */
export function getTypeListKey(types) {
    const b = { h: xxh3.New() };
 ...
 * }
 */
export function getAliasKey(alias) {
    const b = { h: xxh3.New() };
 ...
 * }
 */
export function getUnionKey(types, origin, alias) {
    const b = { h: xxh3.New() };
    if (origin === undefined) {
        keyBuilder_writeTypes(b, types);
    }
 ...
 * }
 */
export function getIntersectionKey(types, flags, alias) {
    const b = { h: xxh3.New() };
    keyBuilder_writeTypes(b, types);
    if ((flags & IntersectionFlagsNoConstraintReduction) === 0) {
        keyBuilder_writeAlias(b, alias);
 ...
 * }
 */
export function getTupleKey(elementInfos, readonly) {
    const b = { h: xxh3.New() };
 ...
 * }
 */
export function getTypeAliasInstantiationKey(typeArguments, alias) {
    return getTypeInstantiationKey(typeArguments, alias, false);
}
/**
 ...
 * }
 */
export function getTypeInstantiationKey(typeArguments, alias, singleSignature) {
    const b = { h: xxh3.New() };
 ...
 * }
 */
export function getIndexedAccessKey(objectType, indexType, accessFlags, alias) {
    const b = { h: xxh3.New() };
 ...
 * }
 */
export function getTemplateTypeKey(texts, types) {
    const b = { h: xxh3.New() };
    keyBuilder_writeTypes(b, types);
    keyBuilder_writeByte(b, "|".charCodeAt(0));
 ...
 * }
 */
export function getConditionalTypeKey(typeArguments, alias, forConstraint) {
    const b = { h: xxh3.New() };
    keyBuilder_writeTypes(b, typeArguments);
    keyBuilder_writeAlias(b, alias);
    if (forConstraint) {
 ...
 * }
 */
export function getRelationKey(source, target, intersectionState, isIdentity, ignoreConstraints) {
    if (isIdentity && source.id > target.id) {
        const tmp = source;
        source = target;
        target = tmp;
 ...
 * }
 */
export function getNodeListKey(nodes) {
    const b = { h: xxh3.New() };
 ...
 * }
 */
export function isTypeReferenceWithGenericArguments(t) {
    return isNonDeferredTypeReference(t) && Some(Checker_getTypeArguments(t.checker, t), (arg) => {
 ...
 * }
 */
export function isNonDeferredTypeReference(t) {
 ...
 * }
 */
export function isUnconstrainedTypeParameter(tp) {
 ...
 * )
 */
export const thisAssignmentDeclarationNone = 0; // not (all) this.property assignments
export const thisAssignmentDeclarationTyped = 1; // typed; use the type annotation
export const thisAssignmentDeclarationConstructor = 2; // at least one in the constructor; use control flow
export const thisAssignmentDeclarationMethod = 3; // methods only; look in base first, and if not found, union all declaration types plus undefined
/**
 ...
 * }
 */
export function findIndexInfo(indexInfos, keyType) {
 ...
 * }
 */
export function getBaseTypeNodeOfClass(t) {
 ...
 * }
 */
export function getTargetType(t) {
    if ((t.objectFlags & ObjectFlagsReference) !== 0) {
 ...
 * }
 */
export function isLateBindableAST(node) {
    let expr = undefined;
    if (IsComputedPropertyName(node)) {
        expr = Node_Expression(node);
    }
    else if (IsElementAccessExpression(node)) {
        expr = AsElementAccessExpression(node).ArgumentExpression;
    }
 ...
 * }
 */
export function getEffectiveSetAccessorTypeAnnotationNode(node) {
 ...
 * }
 */
export function mayReturnNever(fn) {
    switch (fn.Kind) {
        case KindFunctionExpression:
        case KindArrowFunction:
            return true;
 ...
 * }
 */
export function isThisless(symbol_) {
 ...
 * }
 */
export function isThislessVariableLikeDeclaration(node) {
 ...
 * }
 */
export function isThislessType(node) {
    switch (node.Kind) {
        case KindAnyKeyword:
        ...
        case KindLiteralType:
            return true;
        case KindArrayType:
            return isThislessType(AsArrayTypeNode(node).ElementType);
        case KindTypeReference:
            return Every(Node_TypeArguments(node), isThislessType);
    }
    return false;
}
/**
 ...
 * }
 */
export function isThislessFunctionLikeDeclaration(node) {
    const returnType = Node_Type(node);
    return (IsConstructorDeclaration(node) || (returnType !== undefined && isThislessType(returnType))) &&
        Every(Node_Parameters(node), isThislessVariableLikeDeclaration) &&
        Every(Node_TypeParameters(node), isThislessTypeParameter);
}
/**
 ...
 * }
 */
export function isThislessTypeParameter(node) {
    const constraint = AsTypeParameterDeclaration(node).Constraint;
    return constraint === undefined || isThislessType(constraint);
}
/**
 ...
 * }
 */
export function isPrototypeProperty(symbol_) {
 ...
 * }
 */
export function isConflictingPrivateProperty(prop) {
 ...
 * }
 */
export function getModifiedReadonlyState(state, modifiers) {
 ...
 * }
 */
export function instantiateList(c, values, m, instantiator) {
 ...
 * }
 */
export function getSymbolPath(symbol_) {
 ...
 * }
 */
export function getStartElementCount(t, flags) {
 ...
 * }
 */
export function getEndElementCount(t, flags) {
    const infos = t.elementInfos;
 ...
 * }
 */
export function getTotalFixedElementCount(t) {
    return t.fixedLength + getEndElementCount(t, ElementFlagsFixed);
}
/**
 ...
 * }
 */
export function isMutableTupleType(t) {
 ...
 * }
 */
export function isGenericTupleType(t) {
 ...
 * }
 */
export function isSingleElementGenericTupleType(t) {
 ...
 * }
 */
export function isLocalTypeAlias(symbol_) {
 ...
 * }
 */
export function getTypeReferenceName(node) {
    switch (node.Kind) {
        case KindTypeReference:
 ...
 * }
 */
export function isUnaryTupleTypeNode(node) {
 ...
 * }
 */
export function isFreshLiteralType(t) {
 ...
 * }
 */
export function getStringLiteralValue(t) {
    return Type_AsLiteralType(t).value;
}
/**
 ...
 * }
 */
export function getNumberLiteralValue(t) {
    return Type_AsLiteralType(t).value;
}
/**
 ...
 * }
 */
export function getBigIntLiteralValue(t) {
    return Type_AsLiteralType(t).value;
}
/**
 ...
 * }
 */
export function getBooleanLiteralValue(t) {
    return Type_AsLiteralType(t).value;
}
/**
 ...
 * }
 */
export function isNeitherUnitTypeNorNever(t) {
    return (t.flags & (TypeFlagsUnit | TypeFlagsNever)) === 0;
}
/**
 ...
 * )
 */
export const UnionReductionNone = 0;
export const UnionReductionLiteral = 1;
export const UnionReductionSubtype = 2;
/**
 ...
 * )
 */
export const IntersectionFlagsNone = 0;
export const IntersectionFlagsNoSupertypeReduction = 1 << 0;
export const IntersectionFlagsNoConstraintReduction = 1 << 1;
/**
 ...
 * }
 */
export function isUnionWithUndefined(t) {
 ...
 * }
 */
export function isUnionWithNull(t) {
 ...
 * }
 */
export function isIntersectionType(t) {
    return (t.flags & TypeFlagsIntersection) !== 0;
}
/**
 ...
 * }
 */
export function isPrimitiveUnion(t) {
    return (t.objectFlags & ObjectFlagsPrimitiveUnion) !== 0;
}
/**
 ...
 * }
 */
export function isNotUndefinedType(t) {
    return (t.flags & TypeFlagsUndefined) === 0;
}
/**
 ...
 * }
 */
export function isNotNullType(t) {
    return (t.flags & TypeFlagsNull) === 0;
}
/**
 ...
 * }
 */
export function getConstituentCount(t) {
 ...
 * }
 */
export function getConstituentCountOfTypes(types) {
    let n = 0;
 ...
 * }
 */
export function forEachType(t, f) {
    if (t.flags & TypeFlagsUnion) {
 ...
 * }
 */
export function everyContainedType(t, f) {
 ...
 * }
 */
export function containsType(types, t) {
 ...
 * }
 */
export function insertType(types, t) {
 ...
 * }
 */
export function compareTypeIds(t1, t2) {
    return t1.id - t2.id;
}
/**
 ...
 * }
 */
export function getIndexNodeForAccessExpression(accessNode) {
    switch (accessNode.Kind) {
        case KindElementAccessExpression:
            return AsElementAccessExpression(accessNode).ArgumentExpression;
        case KindIndexedAccessType:
            return AsIndexedAccessTypeNode(accessNode).IndexType;
 ...
 * }
 */
export function indexTypeLessThan(indexType, limit) {
 ...
 * }
 */
export function isConstEnumObjectType(t) {
 ...
 * }
 */
export function isConstEnumSymbol(symbol_) {
 ...
 * }
 */
export function compareTypesEqual(s, t) {
    if (s === t) {
        return TernaryTrue;
    }
    return TernaryFalse;
 ...
 * }
 */
export function hasRestParameter(signature) {
    const last = LastOrNil(Node_Parameters(signature));
 ...
 * }
 */
export function isRestParameter(param) {
 ...
 * }
 */
export function getNameFromIndexInfo(info) {
    if (info.declaration !== undefined) {
        const params = Node_Parameters(info.declaration);
        const param0 = params !== undefined ? params[0] : undefined;
        return DeclarationNameToString(Node_Name(param0));
    }
    return "x";
}
/**
 ...
 * }
 */
export function isExportOrExportExpression(location) {
    return FindAncestor(location, (n) => {
        ...
        if (parent !== undefined) {
            ...
            if (IsExportSpecifier(parent)) {
                return AsExportSpecifier(parent).name === n || Node_PropertyName(parent) === n;
            }
        }
        return false;
    }) !== undefined;
 ...
 * }
 */
export function shouldMarkIdentifierAliasReferenced(node) {
    const parent = node.Parent;
    if (parent !== undefined) {
        if (IsPropertyAccessExpression(parent) && Node_Expression(parent) === node) {
            return false;
        }
 ...
 * }
 */
export function getEntityNameFromTypeNode(node) {
    const n = node;
    switch (n.Kind) {
        case KindTypeReference:
            return AsTypeReferenceNode(n).TypeName;
        case KindExpressionWithTypeArguments: {
            const expr = AsExpressionWithTypeArguments(n).Expression;
            if (IsEntityNameExpression(expr)) {
                return expr;
            }
            return undefined;
 ...
 * }
 */
export function getMappedTypeModifiers(t) {
 ...
 * }
 */
export function getMappedTypeOptionality(t) {
 ...
 * }
 */
export function isPartialMappedType(t) {
    return (t.objectFlags & ObjectFlagsMapped) !== 0 && (getMappedTypeModifiers(t) & MappedTypeModifiersIncludeOptional) !== 0;
}
/**
 ...
 * }
 */
export function applyStringMapping(symbol_, str) {
 ...
 * }
 */
export function isSpreadArgument(arg) {
 ...
 * }
 */
export function isZeroBigInt(t) {
