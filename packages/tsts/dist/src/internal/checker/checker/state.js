 ...
 * )
 */
export let SignatureKeyErased = xxh3.HashString128("-").String();
export let SignatureKeyCanonical = xxh3.HashString128("*").String();
export let SignatureKeyBase = xxh3.HashString128("#").String();
export let SignatureKeyInner = xxh3.HashString128("<").String();
export let SignatureKeyOuter = xxh3.HashString128(">").String();
/**
 ...
 * }
 */
export function getSetAccessorValueParameter(accessor) {
    const parameters = Node_Parameters(accessor);
    if (parameters !== undefined && parameters.length > 0) {
        const hasThis = parameters.length === 2 && IsThisParameter(parameters[0]);
