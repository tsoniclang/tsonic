...
import { KindGetAccessor, KindSetAccessor, KindParameter, KindPropertyDeclaration, KindPropertySignature, KindSourceFile, KindModuleDeclaration, KindParenthesizedType, KindTupleType, KindRestType, KindNamedTupleMember, KindArrayType, KindOptionalType, KindReadonlyKeyword, KindTypeAliasDeclaration, KindJSTypeAliasDeclaration, KindDotToken, KindTypeReference, KindKeyOfKeyword, KindUniqueKeyword, KindSymbolKeyword, KindArrowFunction, KindAwaitExpression, KindCallExpression, KindTaggedTemplateExpression, KindDecorator, KindElementAccessExpression, KindMetaProperty, KindNewExpression, KindPropertyAccessExpression, KindYieldExpression, KindReturnStatement, KindBinaryExpression, KindEnumDeclaration, KindBarBarToken, KindBarBarEqualsToken, KindAmpersandAmpersandToken, KindAmpersandAmpersandEqualsToken, KindCommaToken, KindEqualsToken, KindQuestionQuestionToken, KindQuestionQuestionEqualsToken, KindConditionalExpression, KindSuperKeyword, KindTypeAssertionExpression, KindAsExpression, KindPropertyAssignment, KindShorthandPropertyAssignment, KindSpreadAssignment, KindArrayLiteralExpression, KindTemplateSpan, KindParenthesizedExpression, KindNonNullExpression, KindFunctionDeclaration, KindSatisfiesExpression, KindExportAssignment, KindJsxExpression, KindJsxAttribute, KindJsxSpreadAttribute, KindJsxOpeningElement, KindJsxSelfClosingElement, KindImportAttribute, KindVariableDeclaration, KindBindingElement, KindMethodDeclaration, KindMethodSignature, } from "../../ast/generated/kinds.js";
...
function installTypeData(data, t, flags, objectFlags) {
    const runtime = data;
    ...
    const isTypeReference = isObject && (objectFlags & (ObjectFlagsReference | ObjectFlagsClassOrInterface | ObjectFlagsTuple)) !== 0;
    const isInterface = isObject && (objectFlags & (ObjectFlagsClassOrInterface | ObjectFlagsTuple)) !== 0;
    runtime.AsType = () => t;
    runtime.AsConstrainedType = () => isConstrained ? data : undefined;
    runtime.AsStructuredType = () => (isObject || isUnionOrIntersection) ? data : undefined;
    runtime.AsObjectType = () => isObject ? data : undefined;
    runtime.AsTypeReference = () => isTypeReference ? data : undefined;
    runtime.AsInterfaceType = () => isInterface ? data : undefined;
    runtime.AsUnionOrIntersectionType = () => isUnionOrIntersection ? data : undefined;
    return data;
}
function goNilMap() {
    return undefined;
...
function emptyStructuredData() {
    ...
    data.__tsgoEmbedded0 = data;
    return data;
}
function emptyObjectData() {
    const data = emptyStructuredData();
    data.__tsgoEmbedded0 = data;
    data.target = undefined;
    data.mapper = undefined;
    data.instantiations = goNilMap();
    return data;
}
function emptyTypeReferenceData() {
    const data = emptyObjectData();
    data.__tsgoEmbedded0 = data;
    data.node = undefined;
    data.resolvedTypeArguments = undefined;
    return data;
}
function emptyInterfaceData() {
    const data = emptyTypeReferenceData();
    data.__tsgoEmbedded0 = data;
...
function emptyUnionOrIntersectionData(types) {
    const data = emptyStructuredData();
    data.__tsgoEmbedded0 = data;
    data.types = types;
    data.propertyCache = goNilMap();
    data.propertyCacheWithoutFunctionPropertyAugment = goNilMap();
 ...
 * }
 */
export function Checker_maybeMappedType(receiver, node, symbol_) {
    for (;;) {
        node = node.Parent;
    ...
    if (IsTypeLiteralNode(node) && (Node_Members(node) ?? []).length === 1) {
        ...
        return ((t.flags & TypeFlagsUnion) !== 0 && Checker_allTypesAssignableToKindEx(receiver, t, TypeFlagsStringOrNumberLiteral, true));
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkJSDocType(receiver, node) {
    Checker_checkJSDocTypeIsInJsFile(receiver, node);
    Node_ForEachChild(node, (n) => Checker_checkSourceElement(receiver, n));
}
/**
 ...
 * }
 */
export function Checker_checkJSDocTypeIsInJsFile(receiver, node) {
    if (!IsInJSFile(node)) {
 ...
 * }
 */
export function Checker_checkTypeReferenceNode(receiver, node) {
 ...
 * }
 */
export function Checker_checkTypeQuery(receiver, node) {
 ...
 * }
 */
export function Checker_checkTypeLiteral(receiver, node) {
 ...
 * }
 */
export function Checker_checkArrayType(receiver, node) {
 ...
 * }
 */
export function Checker_checkTupleType(receiver, node) {
 ...
 * }
 */
export function Checker_checkUnionOrIntersectionType(receiver, node) {
    Node_ForEachChild(node, (n) => Checker_checkSourceElement(receiver, n));
    Checker_getTypeFromTypeNode(receiver, node);
}
/**
 ...
 * }
 */
export function Checker_checkTypeOperator(receiver, node) {
 ...
 * }
 */
export function Checker_checkConditionalType(receiver, node) {
    Node_ForEachChild(node, (n) => Checker_checkSourceElement(receiver, n));
}
/**
 ...
 * }
 */
export function Checker_checkTemplateLiteralType(receiver, node) {
 ...
 * }
 */
export function Checker_checkMappedType(receiver, node) {
 ...
 * }
 */
export function Checker_checkAllCodePathsInNonVoidFunctionReturnOrThrow(receiver, fn, returnType) {
    ...
    const hasExplicitReturn = ((fn.Flags & NodeFlagsHasExplicitReturn) !== 0);
 ...
 * }
 */
export function Checker_checkBaseTypeAccessibility(receiver, t, node) {
 ...
 * }
 */
export function Checker_checkIteratedTypeOrElementType(receiver, use, inputType, sentType, errorNode) {
    if (IsTypeAny(inputType)) {
        return inputType;
    }
...
export function Checker_checkForOfIterationWithExtensionSelection(receiver, iterationKind, inputType, sentType, errorNode) {
    const use = iterationKind === "for-await-of" ? IterationUseForAwaitOf : IterationUseForOf;
    if (IsTypeAny(inputType)) {
        const sourceType = inputType;
        const selection = iterationKind === "for-await-of"
            ? {
 ...
 * }
 */
export function Checker_getIteratedTypeOrElementType(receiver, use, inputType, sentType, errorNode, checkAssignability) {
...
function Checker_getIteratedTypeOrElementTypeInternal(receiver, use, inputType, sentType, errorNode, checkAssignability, capture) {
    ...
    let stringIterationType;
    if ((use & IterationUseAllowsStringInputFlag) !== 0) {
        if ((arrayType.flags & TypeFlagsUnion) !== 0) {
            const arrayTypes = Type_Types(inputType);
            const filteredTypes = core.Filter(arrayTypes, (ty) => (ty.flags & TypeFlagsStringLike) === 0);
            if (!core.Same(filteredTypes, arrayTypes)) {
                if (capture !== undefined) {
                    const stringTypes = core.Filter(arrayTypes, (ty) => (ty.flags & TypeFlagsStringLike) !== 0);
 ...
 * }
 */
export function Checker_getIterationTypeOfIterable(receiver, use, typeKind, inputType, errorNode) {
    if (IsTypeAny(inputType)) {
        return undefined;
    }
 ...
 * }
 */
export function Checker_getIterationTypesOfIterable(receiver, t, use, errorNode) {
    ...
    const key = { typeId: t.id, use: (use & IterationUseCacheFlags) };
    let noCache = false;
...
function Checker_getIterationTypesOfIterableWithExtensionSelection(receiver, t, use, errorNode, capture) {
    ...
    if (cached !== undefined) {
        if (errorNode === undefined || IterationTypes_hasTypes(cached)) {
            const recomputed = Checker_getIterationTypesOfIterableWorkerInternal(receiver, t, use, undefined, true, capture, 0);
 ...
 * }
 */
export function Checker_getIterationTypesOfIterableWorker(receiver, t, use, errorNode, noCache) {
    return Checker_getIterationTypesOfIterableWorkerInternal(receiver, t, use, errorNode, noCache, undefined, 0);
}
function Checker_getIterationTypesOfIterableWorkerInternal(receiver, t, use, errorNode, noCache, capture, unionDepth) {
    if ((t.flags & TypeFlagsUnion) !== 0) {
        const allIterationTypes = [];
 ...
 * }
 */
export function Checker_getIterationTypesOfIterableFast(receiver, t, r) {
    return Checker_getIterationTypesOfIterableFastInternal(receiver, t, r, undefined);
}
function Checker_getIterationTypesOfIterableFastInternal(receiver, t, r, capture) {
 ...
 * }
 */
export function IterationTypesResolver_getResolvedIterationTypes(receiver, yieldType, returnType, nextType) {
    return {
 ...
 * }
 */
export function Checker_isReferenceToType(receiver, t, target) {
 ...
 * }
 */
export function Checker_isReferenceToSomeType(receiver, t, targets) {
 ...
 * }
 */
export function IterationTypes_hasTypes(receiver) {
 ...
 * }
 */
export function IterationTypes_getType(receiver, typeKind) {
    switch (typeKind) {
        case IterationTypeKindYield:
 ...
 * }
 */
export function Checker_combineIterationTypes(receiver, iterationTypes) {
    return {
        yieldType: Checker_getIterationTypeUnion(receiver, iterationTypes, (t) => t.yieldType),
        returnType: Checker_getIterationTypeUnion(receiver, iterationTypes, (t) => t.returnType),
        nextType: Checker_getIterationTypeUnion(receiver, iterationTypes, (t) => t.nextType),
    };
}
/**
 ...
 * }
 */
export function Checker_getIterationTypeUnion(receiver, iterationTypes, f) {
 ...
 * }
 */
export function Checker_getAsyncFromSyncIterationTypes(receiver, iterationTypes, errorNode) {
    if (!IterationTypes_hasTypes(iterationTypes) ||
 ...
 * }
 */
export function Checker_getIterationTypesOfIterableSlow(receiver, t, r, errorNode, diagnosticOutput) {
    return Checker_getIterationTypesOfIterableSlowInternal(receiver, t, r, errorNode, diagnosticOutput, undefined);
}
function Checker_getIterationTypesOfIterableSlowInternal(receiver, t, r, errorNode, diagnosticOutput, capture) {
    ...
    if (method !== undefined && (method.Flags & SymbolFlagsOptional) === 0) {
        ...
        const validSignatures = core.Filter(allSignatures, (sig) => Checker_getMinArgumentCount(receiver, sig) === 0);
        if (validSignatures.length !== 0) {
            const iteratorType = Checker_getIntersectionType(receiver, core.Map(validSignatures, (sig) => Checker_getReturnTypeOfSignature(receiver, sig)));
 ...
 * }
 */
export function Checker_getIterationTypesOfIterator(receiver, t, r, errorNode, diagnosticOutput) {
 ...
 * }
 */
export function Checker_getIterationTypesOfIteratorWorker(receiver, t, r, errorNode, diagnosticOutput) {
    if (IsTypeAny(t)) {
        return { yieldType: receiver.anyType, returnType: receiver.anyType, nextType: receiver.anyType };
    }
 ...
 * }
 */
export function Checker_getIterationTypesOfIteratorFast(receiver, t, r) {
 ...
 * }
 */
export function Checker_getIterationTypesOfIteratorSlow(receiver, t, r, errorNode, diagnosticOutput) {
 ...
 * }
 */
export function Checker_getIterationTypesOfMethod(receiver, t, resolver, methodName, errorNode, diagnosticOutput) {
 ...
 * }
 */
export function Checker_getIterationTypesOfIteratorResult(receiver, t) {
    if (IsTypeAny(t)) {
        return { yieldType: receiver.anyType, returnType: receiver.anyType, nextType: receiver.anyType };
    }
    ...
    const yieldIteratorResult = Checker_filterType(receiver, t, (ty) => Checker_isYieldIteratorResult(receiver, ty));
    let yieldType;
    if (yieldIteratorResult !== receiver.neverType) {
        yieldType = Checker_getTypeOfPropertyOfType(receiver, yieldIteratorResult, "value");
    }
    const returnIteratorResult = Checker_filterType(receiver, t, (ty) => Checker_isReturnIteratorResult(receiver, ty));
    let returnType;
 ...
 * }
 */
export function Checker_getTypeOfExpression(receiver, node) {
    ...
    if (receiver.flowInvocationCount !== startInvocationCount) {
        if (receiver.flowTypeCache === undefined) {
            receiver.flowTypeCache = new globalThis.Map();
        }
 ...
 * }
 */
export function Checker_getQuickTypeOfExpression(receiver, node) {
 ...
 * }
 */
export function Checker_checkNonNullExpression(receiver, node) {
 ...
 * }
 */
export function Checker_checkNonNullType(receiver, t, node) {
 ...
 * }
 */
export function Checker_checkNonNullNonVoidType(receiver, t, node) {
 ...
 * }
 */
export function Checker_checkExpressionWithContextualType(receiver, node, contextualType, inferenceContext, checkMode) {
    ...
    let t = Checker_checkExpressionEx(receiver, node, (checkMode | CheckModeContextual | (inferenceContext !== undefined ? CheckModeInferential : 0)));
 ...
 * }
 */
export function Checker_getContextFreeTypeOfExpression(receiver, node) {
 ...
 * }
 */
export function Checker_checkConstEnumAccess(receiver, node, t) {
    const parent = node.Parent;
    const ok = ((IsPropertyAccessExpression(parent) && Node_Expression(parent) === node) ||
    ...
    if (receiver.compilerOptions.IsolatedModules === TSTrue ||
        ...
        if ((constEnumDeclaration.Flags & NodeFlagsAmbient) !== 0 &&
...
export function Checker_checkTemplateExpression(receiver, node) {
    ...
    if (evaluated !== undefined) {
        return Checker_getFreshTypeOfLiteralType(receiver, Checker_getStringLiteralType(receiver, evaluated));
    }
    if (Checker_isConstContext(receiver, node) ||
        Checker_isTemplateLiteralContext(receiver, node) ||
        someType(core.OrElse(Checker_getContextualType(receiver, node, ContextFlagsNone), receiver.unknownType), (candidate) => Checker_isTemplateLiteralContextualType(receiver, candidate))) {
 ...
 * }
 */
export function Checker_isTemplateLiteralContext(receiver, node) {
    const parent = node.Parent;
 ...
 * }
 */
export function Checker_isTemplateLiteralContextualType(receiver, t) {
 ...
 * }
 */
export function Checker_checkRegularExpressionLiteral(receiver, node) {
    const nodeLinks = LinkStore_Get(receiver.nodeLinks, node);
    if ((nodeLinks.flags & NodeCheckFlagsTypeChecked) === 0) {
        nodeLinks.flags |= NodeCheckFlagsTypeChecked;
 ...
 * }
 */
export function Checker_checkArrayLiteral(receiver, node, checkMode) {
    const elements = Node_Elements(node) ?? [];
    const elementTypes = new Array(elements.length);
    const elementInfos = new Array(elements.length);
    ...
    try {
        ...
        const inTupleContext = isSpreadIntoCallOrNew(node) ||
            (contextualType !== undefined && someType(contextualType, (t) => Checker_isTupleLikeType(receiver, t) ||
            ...
            if (IsSpreadElement(element)) {
                ...
                if (Checker_isArrayLikeType(receiver, spreadType)) {
                    ...
                    if (restElementType === undefined) {
                        restElementType = Checker_getIteratedTypeOrElementType(receiver, IterationUseDestructuring, spreadType, receiver.undefinedType, undefined, false);
                        if (restElementType === undefined) {
                    ...
                    elementTypes[i] = Checker_checkIteratedTypeOrElementType(receiver, IterationUseSpread, spreadType, receiver.undefinedType, Node_Expression(element));
                    elementInfos[i] = { flags: ElementFlagsRest, labeledDeclaration: undefined };
                }
            }
        ...
        if ((checkMode & CheckModeForceTuple) !== 0 || inConstContext || inTupleContext) {
            return Checker_createArrayLiteralType(receiver, Checker_createTupleTypeEx(receiver, elementTypes, elementInfos, inConstContext && !(contextualType !== undefined && someType(contextualType, (t) => Checker_isMutableArrayLikeType(receiver, t)))));
        }
        let elementType;
 ...
 * }
 */
export function Checker_createArrayLiteralType(receiver, t) {
    if ((t.objectFlags & ObjectFlagsReference) === 0) {
        return t;
    }
    const key = { kind: CachedTypeKindArrayLiteralType, typeId: t.id };
 ...
 * }
 */
export function Checker_typeHasProtectedAccessibleBase(receiver, target, t) {
 ...
 * }
 */
export function Checker_resolveTaggedTemplateExpression(receiver, node, candidatesOutArray, checkMode) {
 ...
 * }
 */
export function Checker_checkTaggedTemplateExpression(receiver, node) {
 ...
 * }
 */
export function Checker_checkFunctionExpressionOrObjectLiteralMethod(receiver, node, checkMode) {
 ...
 * }
 */
export function Checker_contextuallyCheckFunctionExpressionOrObjectLiteralMethod(receiver, node, checkMode) {
    const links = LinkStore_Get(receiver.nodeLinks, node);
    if ((links.flags & NodeCheckFlagsContextChecked) === 0) {
        const contextualSignature = Checker_getContextualSignature(receiver, node);
        if ((links.flags & NodeCheckFlagsContextChecked) === 0) {
            links.flags |= NodeCheckFlagsContextChecked;
 ...
 * }
 */
export function Checker_checkFunctionExpressionOrObjectLiteralMethodDeferred(receiver, node) {
 ...
 * }
 */
export function Checker_assignBindingElementTypes(receiver, pattern, parentType) {
 ...
 * }
 */
export function Checker_checkTypeOfExpression(receiver, node) {
 ...
 * }
 */
export function Checker_checkNonNullAssertion(receiver, node) {
 ...
 * }
 */
export function Checker_checkNonNullChain(receiver, node) {
 ...
 * }
 */
export function Checker_checkVoidExpression(receiver, node) {
    Checker_checkNodeDeferred(receiver, node);
 ...
 * }
 */
export function Checker_getUnaryResultType(receiver, operandType) {
 ...
 * }
 */
export function Checker_checkConditionalExpression(receiver, node, checkMode) {
 ...
 * }
 */
export function Checker_getYieldedTypeOfYieldExpression(receiver, node, expressionType, sentType, isAsync) {
    ...
    return Checker_getAwaitedTypeEx(receiver, yieldedType, errorNode, core.IfElse(isYieldStar, diagnosticsMessages.Type_of_iterated_elements_of_a_yield_Asterisk_operand_must_either_be_a_valid_promise_or_must_not_contain_a_callable_then_member, diagnosticsMessages.Type_of_yield_operand_in_an_async_generator_must_either_be_a_valid_promise_or_must_not_contain_a_callable_then_member));
}
/**
 ...
 * }
 */
export function Checker_removeOptionalityFromDeclaredType(receiver, declaredType, declaration) {
 ...
 * }
 */
export function Checker_parameterInitializerContainsUndefined(receiver, declaration) {
    const links = LinkStore_Get(receiver.nodeLinks, declaration);
    if ((links.flags & NodeCheckFlagsInitializerIsUndefinedComputed) === 0) {
 ...
 * }
 */
export function Checker_isInAmbientOrTypeNode(receiver, node) {
 ...
 * }
 */
export function Checker_getBaseTypesIfUnrelated(receiver, leftType, rightType, isRelated) {
 ...
 * }
 */
export function Checker_bothAreBigIntLike(receiver, left, right) {
 ...
 * }
 */
export function Checker_checkArithmeticOperandType(receiver, operand, t, diagnostic, isAwaitValid) {
 ...
 * }
 */
export function Checker_checkNullishCoalesceOperands(receiver, left, right) {
 ...
 * }
 */
export function Checker_checkNullishCoalesceOperandLeft(receiver, left) {
 ...
 * }
 */
export function Checker_getSyntacticNullishnessSemantics(receiver, node) {
 ...
 * }
 */
export function Checker_hasEmptyObjectIntersection(receiver, t) {
    return someType(t, (tt) => tt === receiver.unknownEmptyObjectType ||
        ((tt.flags & TypeFlagsIntersection) !== 0 && Checker_IsEmptyAnonymousObjectType(receiver, Checker_getBaseConstraintOrType(receiver, tt))));
}
/**
 ...
 * }
 */
export function Checker_checkObjectLiteral(receiver, node, checkMode) {
    const nodeSymbol = Node_Symbol(node);
    if ((Node_Properties(node)?.length ?? 0) === 0 && nodeSymbol !== undefined && (nodeSymbol.Exports?.size ?? 0) !== 0) {
        const result = Checker_newAnonymousType(receiver, nodeSymbol, nodeSymbol.Exports, undefined, undefined, undefined);
    ...
    let allPropertiesTable;
    if (receiver.strictNullChecks) {
        allPropertiesTable = new globalThis.Map();
    }
    let propertiesTable = new globalThis.Map();
    let propertiesArray = [];
    let spread = receiver.emptyObjectType;
    Checker_pushCachedContextualType(receiver, node);
    const contextualType = Checker_getApparentTypeOfContextualType(receiver, node, ContextFlagsNone);
    let contextualTypeHasPattern = false;
    ...
    let objectFlags = ObjectFlagsFreshLiteral;
    ...
    for (const memberDecl of Node_Properties(node) ?? []) {
        ...
        if (IsPropertyAssignment(memberDecl) || IsShorthandPropertyAssignment(memberDecl) || IsObjectLiteralMethod(memberDecl)) {
            ...
            let prop;
            if (nameType !== undefined) {
                prop = Checker_newSymbolEx(receiver, (SymbolFlagsProperty | member.Flags), getPropertyNameFromType(nameType), (checkFlags | CheckFlagsLate));
            }
            else {
                prop = Checker_newSymbolEx(receiver, (SymbolFlagsProperty | member.Flags), member.Name, checkFlags);
            }
            ...
            if (propertiesArray.length > 0) {
                ...
                propertiesArray = [];
                propertiesTable = new globalThis.Map();
                hasComputedStringProperty = false;
                hasComputedNumberProperty = false;
                hasComputedSymbolProperty = false;
            }
            const t = Checker_getReducedType(receiver, Checker_checkExpressionEx(receiver, Node_Expression(memberDecl), (checkMode & CheckModeInferential)));
    ...
    if (spread !== receiver.emptyObjectType) {
        ...
        return Checker_mapType(receiver, spread, (t) => {
 ...
 * }
 */
export function Checker_getSpreadType(receiver, left, right, symbol_, objectFlags, readonly) {
    if ((left.flags & TypeFlagsAny) !== 0 || (right.flags & TypeFlagsAny) !== 0) {
        return receiver.anyType;
    }
    if ((left.flags & TypeFlagsUnknown) !== 0 || (right.flags & TypeFlagsUnknown) !== 0) {
    ...
    if ((left.flags & TypeFlagsUnion) !== 0) {
        if (Checker_checkCrossProductUnion(receiver, [left, right])) {
            return Checker_mapType(receiver, left, (t) => {
    ...
    if ((right.flags & TypeFlagsUnion) !== 0) {
        if (Checker_checkCrossProductUnion(receiver, [left, right])) {
            return Checker_mapType(receiver, right, (t) => {
    ...
    const skippedPrivateMembers = new globalThis.Set();
    ...
    for (const leftProp of Checker_getPropertiesOfType(receiver, left)) {
        ...
        if (rightProp !== undefined) {
            ...
            if ((rightProp.Flags & SymbolFlagsOptional) !== 0) {
                ...
                const flags = (SymbolFlagsProperty | (leftProp.Flags & SymbolFlagsOptional));
                const result = Checker_newSymbol(receiver, flags, leftProp.Name);
                const links = LinkStore_Get(receiver.valueSymbolLinks, result);
                ...
                LinkStore_Get(receiver.spreadLinks, result).leftSpread = leftProp;
                LinkStore_Get(receiver.spreadLinks, result).rightSpread = rightProp;
                result.Declarations = declarations;
                links.nameType = LinkStore_Get(receiver.valueSymbolLinks, leftProp).nameType;
    ...
    const spreadIndexInfos = core.SameMap(indexInfos, (info) => {
 ...
 * }
 */
export function Checker_isValidSpreadType(receiver, t) {
    const s = Checker_removeDefinitelyFalsyTypes(receiver, Checker_mapType(receiver, t, (ty) => Checker_getBaseConstraintOrType(receiver, ty)));
    return (s.flags & (TypeFlagsAny | TypeFlagsNonPrimitive | TypeFlagsObject | TypeFlagsInstantiableNonPrimitive)) !== 0 ||
        ((s.flags & TypeFlagsUnionOrIntersection) !== 0 && core.Every(Type_Types(s), (ty) => Checker_isValidSpreadType(receiver, ty)));
}
/**
 ...
 * }
 */
export function Checker_isNonGenericObjectType(receiver, t) {
 ...
 * }
 */
export function Checker_tryMergeUnionOfObjectTypeAndEmptyObject(receiver, t, readonly) {
    if ((t.flags & TypeFlagsUnion) === 0) {
        return t;
    }
    const types = Type_Types(t);
    if (core.Every(types, (ty) => Checker_isEmptyObjectTypeOrSpreadsIntoEmptyObject(receiver, ty))) {
        const empty = core.Find(types, (ty) => Checker_isEmptyObjectType(receiver, ty));
        if (empty !== undefined) {
            return empty;
        }
        return receiver.emptyObjectType;
    }
    const firstType = core.Find(types, (ty) => {
        return !Checker_isEmptyObjectTypeOrSpreadsIntoEmptyObject(receiver, ty);
    });
    if (firstType === undefined) {
        return t;
    }
    const secondType = core.Find(types, (ty) => {
    ...
    for (const prop of Checker_getPropertiesOfType(receiver, firstType)) {
        ...
        if (Checker_isSpreadableProperty(receiver, prop)) {
            ...
            const flags = (SymbolFlagsProperty | SymbolFlagsOptional);
            ...
            result.Declarations = prop.Declarations;
            links.nameType = LinkStore_Get(receiver.valueSymbolLinks, prop).nameType;
            LinkStore_Get(receiver.mappedSymbolLinks, result).syntheticOrigin = prop;
 ...
 * }
 */
export function Checker_isEmptyObjectTypeOrSpreadsIntoEmptyObject(receiver, t) {
 ...
 * }
 */
export function Checker_isConstTypeVariable(receiver, t, depth) {
    if (depth >= 5 || t === undefined) {
        return false;
    }
    if ((t.flags & TypeFlagsTypeParameter) !== 0) {
        return (t.symbol !== undefined && core.Some(t.symbol.Declarations, (d) => HasSyntacticModifier(d, ModifierFlagsConst)));
    }
    if ((t.flags & TypeFlagsUnionOrIntersection) !== 0) {
        return core.Some(Type_Types(t), (s) => Checker_isConstTypeVariable(receiver, s, depth));
    }
 ...
 * }
 */
export function Checker_checkObjectLiteralMethod(receiver, node, checkMode) {
 ...
 * }
 */
export function Checker_resolveExternalModuleTypeByLiteral(receiver, name) {
 ...
 * }
 */
export function Checker_errorOnImplicitAnyModule(receiver, isError, errorNode, mode, resolvedModule, moduleReference) {
    if (isSideEffectImport(errorNode)) {
        return;
    }
    let errorInfo;
    ...
    Checker_addErrorOrSuggestion(receiver, isError, NewDiagnosticChainForNode(errorInfo, errorNode, diagnosticsMessages.Could_not_find_a_declaration_file_for_module_0_1_implicitly_has_an_any_type, moduleReference, resolvedModule.ResolvedFileName));
}
/**
 ...
 * }
 */
export function Checker_getTypeWithSyntheticDefaultOnly(receiver, t, symbol_, originalSymbol, moduleSpecifier) {
    ...
    if (hasDefaultOnly && t !== undefined && !Checker_isErrorType(receiver, t)) {
        const key = { kind: CachedTypeKindDefaultOnlyType, typeId: t.id };
        const cached = receiver.cachedTypes.get(key);
        if (cached !== undefined) {
            return cached;
        }
 ...
 * }
 */
export function Checker_cloneTypeAsModuleType(receiver, symbol_, moduleType, referenceParent) {
    const result = Checker_newSymbol(receiver, symbol_.Flags, symbol_.Name);
    result.Declarations = slices.Clone(symbol_.Declarations);
    result.ValueDeclaration = symbol_.ValueDeclaration;
    result.Members = maps.Clone(symbol_.Members);
    result.Exports = maps.Clone(symbol_.Exports);
    result.Parent = symbol_.Parent;
    const links = LinkStore_Get(receiver.exportTypeLinks, result);
 ...
 * }
 */
export function Checker_padObjectLiteralType(receiver, t, pattern) {
 ...
 * }
 */
export function Checker_padTupleType(receiver, t, pattern) {
 ...
 * }
 */
export function Checker_getWidenedLiteralTypeForInitializer(receiver, declaration, t) {
 ...
 * }
 */
export function Checker_getTypeOfFuncClassEnumModule(receiver, symbol_) {
 ...
 * }
 */
export function Checker_getTypeOfFuncClassEnumModuleWorker(receiver, symbol_) {
    if ((symbol_.Flags & SymbolFlagsModule) !== 0 && isShorthandAmbientModuleSymbol(symbol_)) {
        return receiver.anyType;
    }
    else if ((symbol_.Flags & SymbolFlagsValueModule) !== 0 &&
 ...
 * }
 */
export function Checker_getBaseTypeVariableOfClass(receiver, symbol_) {
 ...
 * }
 */
export function Checker_isFunctionType(receiver, t) {
 ...
 * }
 */
export function Checker_getDeclaredTypeOfClassOrInterface(receiver, symbol_) {
    const links = LinkStore_Get(receiver.declaredTypeLinks, symbol_);
 ...
 * }
 */
export function keyBuilder_writeType(receiver, t) {
 ...
 * }
 */
export function keyBuilder_writeTypes(receiver, types) {
    keyBuilder_writeInt(receiver, types.length);
 ...
 * }
 */
export function keyBuilder_writeGenericTypeReferences(receiver, source, target, ignoreConstraints) {
    let constrained = false;
    const typeParameters = [];
    const writeTypeReference = (ref, depth) => {
        ...
        for (const t of Type_AsTypeReference(ref).resolvedTypeArguments) {
            if ((t.flags & TypeFlagsTypeParameter) !== 0) {
                if (ignoreConstraints || Checker_getConstraintOfTypeParameter(t.checker, t) === undefined) {
                    ...
                    keyBuilder_writeByte(receiver, "=".charCodeAt(0));
 ...
 * }
 */
export function Checker_isNullOrUndefined(receiver, node) {
    const expr = SkipParentheses(node);
    switch (expr.Kind) {
        case KindNullKeyword:
            return true;
 ...
 * }
 */
export function Checker_getTypeForBindingElement(receiver, declaration) {
 ...
 * }
 */
export function Checker_getTypeForBindingElementParent(receiver, node, checkMode) {
    if (checkMode === CheckModeNormal) {
        const symbol_ = Checker_getSymbolOfDeclaration(receiver, node);
        if (symbol_ !== undefined) {
            const resolvedType = LinkStore_Get(receiver.valueSymbolLinks, symbol_).resolvedType;
 ...
 * }
 */
export function Checker_getBindingElementTypeFromParentType(receiver, declaration, parentType, noTupleBoundsCheck) {
    if (IsTypeAny(parentType)) {
        return parentType;
    }
    ...
    const accessFlags = (AccessFlagsExpressionPosition | (noTupleBoundsCheck || Checker_hasDefaultValue(receiver, declaration) ? AccessFlagsAllowMissing : 0));
    let t;
    if (IsObjectBindingPattern(pattern)) {
        ...
        const elementType = Checker_checkIteratedTypeOrElementType(receiver, (IterationUseDestructuring | (hasDotDotDotToken(declaration) ? 0 : IterationUsePossiblyOutOfBounds)), parentType, receiver.undefinedType, pattern);
        const index = slices.Index(Node_Elements(pattern) ?? [], declaration);
        if (hasDotDotDotToken(declaration)) {
            const baseConstraint = Checker_mapType(receiver, parentType, (type_) => {
            ...
            if (everyType(baseConstraint, isTupleType)) {
                t = Checker_mapType(receiver, baseConstraint, (type_) => Checker_sliceTupleType(receiver, type_, index, 0));
            }
            else {
            ...
            const indexType = Checker_getNumberLiteralType(receiver, index);
    ...
    return Checker_widenTypeInferredFromInitializer(receiver, declaration, Checker_getUnionTypeEx(receiver, [Checker_getNonUndefinedType(receiver, t), Checker_checkDeclarationInitializer(receiver, declaration, CheckModeNormal, undefined)], UnionReductionSubtype, undefined, undefined));
}
/**
 ...
 * }
 */
export function Checker_getTypeFromBindingPattern(receiver, pattern, includePatternInType, reportErrors) {
    if (includePatternInType) {
 ...
 * }
 */
export function Checker_getTypeFromObjectBindingPattern(receiver, pattern, includePatternInType, reportErrors) {
    const members = new globalThis.Map();
    let stringIndexInfo;
    let objectFlags = (ObjectFlagsObjectLiteral | ObjectFlagsContainsObjectOrArrayLiteral);
    for (const e of Node_Elements(pattern) ?? []) {
        ...
        if (!isTypeUsableAsPropertyName(exprType)) {
            objectFlags = (objectFlags | ObjectFlagsObjectLiteralPatternWithComputedProperties);
            continue;
        }
        const text = getPropertyNameFromType(exprType);
        const flags = (SymbolFlagsProperty | (Node_Initializer(e) !== undefined ? SymbolFlagsOptional : 0));
    ...
    result.objectFlags = (result.objectFlags | objectFlags);
    if (includePatternInType) {
        receiver.patternForType.set(result, pattern);
        result.objectFlags = (result.objectFlags | ObjectFlagsContainsObjectOrArrayLiteral);
    }
    return result;
}
/**
 ...
 * }
 */
export function Checker_getTypeFromArrayBindingPattern(receiver, pattern, includePatternInType, reportErrors) {
    const elements = Node_Elements(pattern) ?? [];
    const lastElement = core.LastOrNil(elements);
    let restElement;
    ...
    const minLength = core.FindLastIndex(elements, (e) => !(e === restElement || Node_Name(e) === undefined || Checker_hasDefaultValue(receiver, e))) + 1;
    const elementTypes = new globalThis.Array(elements.length);
    const elementInfos = new globalThis.Array(elements.length);
    for (let i = 0; i < elements.length; i++) {
        const e = elements[i];
        let t;
 ...
 * }
 */
export function Checker_getTypeFromBindingElement(receiver, element, includePatternInType, reportErrors) {
 ...
 * }
 */
export function Checker_reportImplicitAny(receiver, declaration, t, wideningKind) {
    ...
    switch (declaration.Kind) {
        ...
        case KindPropertySignature:
            diagnostic = core.IfElse(receiver.noImplicitAny, diagnosticsMessages.Member_0_implicitly_has_an_1_type, diagnosticsMessages.Member_0_implicitly_has_an_1_type_but_a_better_type_may_be_inferred_from_usage);
            break;
        case KindParameter: {
 ...
 * }
 */
export function Checker_getWidenedType(receiver, t) {
 ...
 * }
 */
export function Checker_getWidenedTypeWithContext(receiver, t, context) {
    if ((t.objectFlags & ObjectFlagsRequiresWidening) !== 0) {
        if (context === undefined) {
            const cached = receiver.cachedTypes.get({ kind: CachedTypeKindWidened, typeId: t.id });
            if (cached !== undefined) {
                return cached;
            }
        }
        ...
        if ((t.flags & (TypeFlagsAny | TypeFlagsNullable)) !== 0) {
            ...
            const widenedTypes = core.SameMap(Type_Types(t) ?? [], (type_) => {
                if ((type_.flags & TypeFlagsNullable) !== 0) {
                    return type_;
                }
                return Checker_getWidenedTypeWithContext(receiver, type_, unionContext);
            });
            result = Checker_getUnionTypeEx(receiver, widenedTypes, core.Some(widenedTypes, (type_) => Checker_isEmptyObjectType(receiver, type_)) ? UnionReductionSubtype : UnionReductionLiteral, undefined, undefined);
        }
        else if ((t.flags & TypeFlagsIntersection) !== 0) {
            result = Checker_getIntersectionType(receiver, core.SameMap(Type_Types(t) ?? [], (type_) => Checker_getWidenedType(receiver, type_)));
        }
        else if (Checker_isArrayOrTupleType(receiver, t)) {
            result = Checker_createTypeReference(receiver, Type_Target(t), core.SameMap(Checker_getTypeArguments(receiver, t), (type_) => Checker_getWidenedType(receiver, type_)));
        }
        if (result !== undefined && context === undefined) {
            receiver.cachedTypes.set({ kind: CachedTypeKindWidened, typeId: t.id }, result);
        }
        return core.OrElse(result, t);
    }
    return t;
 ...
 * }
 */
export function Checker_getWidenedTypeOfObjectLiteral(receiver, t, context) {
    if (context !== undefined) {
    ...
    const result = Checker_newAnonymousType(receiver, t["symbol"], members, [], [], core.SameMap(Checker_getIndexInfosOfType(receiver, t), (info) => Checker_newIndexInfo(receiver, info.keyType, Checker_getWidenedType(receiver, info.valueType), info.isReadonly, info.declaration, info.components)));
    result.objectFlags = (result.objectFlags | (t.objectFlags & (ObjectFlagsJSLiteral | ObjectFlagsNonInferrableType)));
    if (context !== undefined && context.parent !== undefined) {
        if (context.widenedTypes === undefined) {
            context.widenedTypes = new Map();
        }
 ...
 * }
 */
export function WideningContext_getChildContext(receiver, propertyName) {
    ...
    if (receiver.childContexts === undefined) {
        receiver.childContexts = new Map();
    }
 ...
 * }
 */
export function Checker_getTypeOfAccessors(receiver, symbol_) {
    const links = LinkStore_Get(receiver.valueSymbolLinks, symbol_);
    if (links.resolvedType === undefined) {
        ...
        if (t === undefined && accessor !== undefined) {
            t = Checker_getWidenedTypeForVariableLikeDeclaration(receiver, accessor, true);
        }
        if (t === undefined) {
 ...
 * }
 */
export function Checker_getWriteTypeOfAccessors(receiver, symbol_) {
    const links = LinkStore_Get(receiver.valueSymbolLinks, symbol_);
 ...
 * }
 */
export function Checker_getOptionalType(receiver, t, isProperty) {
 ...
 * }
 */
export function Checker_getNullableType(receiver, t, flags) {
 ...
 * }
 */
export function Checker_GetNonNullableType(receiver, t) {
    if (receiver.strictNullChecks) {
 ...
 * }
 */
export function Checker_IsNullableType(receiver, t) {
 ...
 * }
 */
export function Checker_getNonNullableTypeIfNeeded(receiver, t) {
 ...
 * }
 */
export function Checker_pushTypeResolution(receiver, target, propertyName) {
 ...
 * }
 */
export function Checker_getPropertiesOfType(receiver, t) {
 ...
 * }
 */
export function Checker_getPropertiesOfObjectType(receiver, t) {
    if ((t.flags & TypeFlagsObject) !== 0) {
 ...
 * }
 */
export function Checker_getPropertiesOfUnionOrIntersectionType(receiver, t) {
    const d = Type_AsUnionOrIntersectionType(t);
    if (d.resolvedProperties === undefined) {
        const checked = { valuesByKey: new globalThis.Map(), values: [] };
        let props = [];
 ...
 * }
 */
export function Checker_getBaseTypes(receiver, t) {
    if ((t.objectFlags & (ObjectFlagsClassOrInterface | ObjectFlagsReference)) === 0) {
        return [];
    }
 ...
 * }
 */
export function Checker_getTupleBaseType(receiver, t) {
    const tupleType = Type_AsTupleType(t);
    const typeParameters = InterfaceType_TypeParameters(tupleType);
 ...
 * }
 */
export function Checker_resolveBaseTypesOfClass(receiver, t) {
    ...
    if (!Checker_isValidBaseType(receiver, reducedBaseType)) {
        ...
        diagnostic = NewDiagnosticChainForNode(diagnostic, errorNode, diagnosticsMessages.Base_constructor_return_type_0_is_not_an_object_type_or_intersection_of_object_types_with_statically_known_members, Checker_TypeToString(receiver, reducedBaseType));
 ...
 * }
 */
export function Checker_resolveBaseTypesOfInterface(receiver, t) {
    const data = Type_AsInterfaceType(t);
    for (const declaration of t.symbol.Declarations ?? []) {
 ...
 * }
 */
export function Checker_reportCircularBaseType(receiver, node, t) {
 ...
 * }
 */
export function Checker_isValidBaseType(receiver, t) {
    if ((t.flags & TypeFlagsTypeParameter) !== 0) {
 ...
 * }
 */
export function Checker_hasBaseType(receiver, t, checkBase) {
    const check = (t) => {
        if ((t.objectFlags & (ObjectFlagsClassOrInterface | ObjectFlagsReference)) !== 0) {
 ...
 * }
 */
export function Checker_getAnnotatedAccessorType(receiver, accessor) {
 ...
 * }
 */
export function Checker_getAnnotatedAccessorTypeNode(receiver, accessor) {
 ...
 * }
 */
export function Checker_checkAndAggregateReturnExpressionTypes(receiver, fn, checkMode) {
    const functionFlags = GetFunctionFlags(fn);
    let aggregatedTypes = [];
    let hasReturnWithNoExpression = Checker_functionHasImplicitReturn(receiver, fn);
    let hasReturnOfTypeNever = false;
    ForEachReturnStatement(Node_Body(fn), (returnStatement) => {
        ...
        let t = Checker_checkExpressionCachedEx(receiver, expr, (checkMode & ~CheckModeSkipGenericFunctions));
 ...
 * }
 */
export function Checker_checkAndAggregateYieldOperandTypes(receiver, fn, checkMode) {
    const isAsync = (GetFunctionFlags(fn) & FunctionFlagsAsync) !== 0;
    let yieldTypes = [];
    let nextTypes = [];
    forEachYieldExpression(Node_Body(fn), (yieldExpr) => {
        let yieldExprType = receiver.undefinedWideningType;
        const expression = Node_Expression(yieldExpr);
        if (expression !== undefined) {
            yieldExprType = Checker_checkExpressionEx(receiver, expression, (checkMode & ~CheckModeSkipGenericFunctions));
        }
 ...
 * }
 */
export function Checker_createPromiseType(receiver, promisedType) {
 ...
 * }
 */
export function Checker_createPromiseLikeType(receiver, promisedType) {
 ...
 * }
 */
export function Checker_getWidenedLiteralLikeTypeForContextualIterationTypeIfNeeded(receiver, t, contextualSignatureReturnType, kind, isAsyncGenerator) {
 ...
 * }
 */
export function Checker_createGeneratorType(receiver, yieldType, returnType, nextType, isAsyncGenerator) {
 ...
 * }
 */
export function Checker_addOptionalTypeMarker(receiver, t) {
    if (receiver.strictNullChecks) {
 ...
 * }
 */
export function Checker_getLowerBoundOfKeyType(receiver, t) {
    ...
    if ((t.flags & TypeFlagsUnion) !== 0) {
        return Checker_mapTypeEx(receiver, t, (ty) => Checker_getLowerBoundOfKeyType(receiver, ty), true);
    }
    if ((t.flags & TypeFlagsIntersection) !== 0) {
        const types = Type_Types(t);
        ...
        return Checker_getIntersectionType(receiver, core.SameMap(types, (ty) => Checker_getLowerBoundOfKeyType(receiver, ty)));
    }
    return t;
}
/**
 ...
 * }
 */
export function Checker_combineUnionOrIntersectionThisParam(receiver, left, right, mapper, isUnion) {
    if (left === undefined) {
        return right;
    }
    if (right === undefined) {
 ...
 * }
 */
export function Checker_includeMixinType(receiver, t, types, mixinFlags, index) {
    const mixedTypes = [];
 ...
 * }
 */
export function Checker_getApparentType(receiver, t) {
 ...
 * }
 */
export function Checker_getApparentTypeOfMappedType(receiver, t) {
 ...
 * }
 */
export function Checker_getResolvedApparentTypeOfMappedType(receiver, t) {
    ...
    if (typeVariable !== undefined && AsMappedTypeNode(Type_AsMappedType(target).declaration).NameType === undefined) {
        ...
        if (baseConstraint !== undefined && everyType(baseConstraint, (ty) => Checker_isArrayOrTupleType(receiver, ty) || Checker_isArrayOrTupleOrIntersection(receiver, ty))) {
 ...
 * }
 */
export function Checker_getApparentTypeOfIntersectionType(receiver, t, thisArgument) {
    if (t === thisArgument) {
    ...
    const key = { kind: CachedTypeKindApparentType, typeId: thisArgument.id };
 ...
 * }
 */
export function Checker_getReducedType(receiver, t) {
    if ((t.flags & TypeFlagsUnion) !== 0) {
        if ((t.objectFlags & ObjectFlagsContainsIntersections) !== 0) {
 ...
 * }
 */
export function Checker_getReducedUnionType(receiver, unionType) {
 ...
 * }
 */
export function Checker_getReducedApparentType(receiver, t) {
 ...
 * }
 */
export function Checker_elaborateNeverIntersection(receiver, chain, node, t) {
    if ((t.flags & TypeFlagsIntersection) !== 0 && (t.objectFlags & ObjectFlagsIsNeverIntersection) !== 0) {
        const neverProp = core.Find(Checker_getPropertiesOfUnionOrIntersectionType(receiver, t), (prop) => Checker_isDiscriminantWithNeverType(receiver, prop));
 ...
 * }
 */
export function Checker_instantiateType(receiver, t, m) {
 ...
 * }
 */
export function Checker_couldContainTypeVariablesWorker(receiver, t) {
    if ((t.flags & TypeFlagsStructuredOrInstantiable) === 0) {
        return false;
    }
    ...
    const result = (((t.flags & TypeFlagsInstantiable) !== 0) ||
        ((t.flags & TypeFlagsObject) !== 0 && !Checker_isNonGenericTopLevelType(receiver, t) &&
            (((objectFlags & ObjectFlagsReference) !== 0 &&
                (Type_AsTypeReference(t).node !== undefined || core.Some(Checker_getTypeArguments(receiver, t), (typeArgument) => receiver.couldContainTypeVariables(typeArgument)))) ||
        ...
        ((t.flags & TypeFlagsUnionOrIntersection) !== 0 && (t.flags & TypeFlagsEnumLiteral) === 0 && !Checker_isNonGenericTopLevelType(receiver, t) &&
            core.Some(Type_Types(t), (type_) => receiver.couldContainTypeVariables(type_))));
    t.objectFlags |= (ObjectFlagsCouldContainTypeVariablesComputed | (result ? ObjectFlagsCouldContainTypeVariables : 0));
    return result;
}
/**
 ...
 * }
 */
export function Checker_isNonGenericTopLevelType(receiver, t) {
    if (t.alias !== undefined && t.alias.typeArguments.length === 0) {
        ...
        return (declaration !== undefined && FindAncestorOrQuit(declaration.Parent, (n) => {
            switch (n.Kind) {
                case KindSourceFile:
 ...
 * }
 */
export function Checker_instantiateTypeWorker(receiver, t, m, alias) {
    const flags = t.flags;
    ...
    if ((flags & TypeFlagsIndexedAccess) !== 0) {
        ...
        return Checker_getIndexedAccessTypeEx(receiver, Checker_instantiateType(receiver, d.objectType, m), Checker_instantiateType(receiver, d.indexType, m), d.accessFlags, undefined, newAlias);
    }
 ...
 * }
 */
export function Checker_instantiateAnonymousType(receiver, t, m, alias) {
 ...
 * }
 */
export function Checker_getHomomorphicTypeVariable(receiver, t) {
    const constraintType = Checker_getConstraintTypeFromMappedType(receiver, t);
    if ((constraintType.flags & TypeFlagsIndex) !== 0) {
 ...
 * }
 */
export function Checker_instantiateMappedType(receiver, t, m, alias) {
    const d = Type_AsMappedType(t);
    const typeVariable = Checker_getHomomorphicTypeVariable(receiver, t);
    const instantiateConstituent = (s) => {
        ...
        if (AsMappedTypeNode(d.declaration).NameType === undefined) {
            if (Checker_isArrayType(receiver, s) ||
 ...
 * }
 */
export function Checker_instantiateMappedArrayType(receiver, arrayType, mappedType, m) {
 ...
 * }
 */
export function Checker_instantiateMappedTupleType(receiver, tupleType, mappedType, typeVariable, m) {
    ...
    const newElementTypes = new Array(elementTypes.length);
    ...
    const newElementInfos = elementInfos.map((info) => ({ ...info }));
    for (let i = 0; i < elementTypes.length; i++) {
 ...
 * }
 */
export function Checker_instantiateMappedTypeTemplate(receiver, t, key, isOptional, m) {
 ...
 * }
 */
export function Checker_getTemplateTypeFromMappedType(receiver, t) {
    const m = Type_AsMappedType(t);
 ...
 * }
 */
export function Checker_getApparentMappedTypeKeys(receiver, nameType, targetType) {
    const modifiersType = Checker_getApparentType(receiver, Checker_getModifiersTypeFromMappedType(receiver, targetType));
    const mappedKeys = [];
    Checker_forEachMappedTypePropertyKeyTypeAndIndexSignatureKeyType(receiver, modifiersType, TypeFlagsStringOrNumberLiteralOrUnique, false, (t) => {
 ...
 * }
 */
export function Checker_instantiateReverseMappedType(receiver, t, m) {
 ...
 * }
 */
export function Checker_instantiateTypes(receiver, types, m) {
 ...
 * }
 */
export function Checker_tryGetTypeFromTypeNode(receiver, node) {
 ...
 * }
 */
export function Checker_getTypeFromTypeNode(receiver, node) {
 ...
 * }
 */
export function Checker_getTypeFromTypeNodeWorker(receiver, node) {
    switch (node.Kind) {
        case KindAnyKeyword:
 ...
 * }
 */
export function Checker_getTypeFromLiteralTypeNode(receiver, node) {
 ...
 * }
 */
export function Checker_getTypeFromTypeOperatorNode(receiver, node) {
    const links = LinkStore_Get(receiver.typeNodeLinks, node);
    if (links.resolvedType === undefined) {
 ...
 * }
 */
export function Checker_getTypeFromTypeReference(receiver, node) {
    const links = LinkStore_Get(receiver.typeNodeLinks, node);
    if (links.resolvedType === undefined) {
 ...
 * }
 */
export function Checker_getIntendedTypeFromJSDocTypeReference(receiver, node) {
 ...
 * }
 */
export function Checker_getTypeReferenceType(receiver, node, symbol_) {
 ...
 * }
 */
export function Checker_getTypeFromClassOrInterfaceReference(receiver, node, symbol_) {
    ...
    if (typeParameters.length !== 0) {
        ...
        const typeArguments = [...InterfaceType_OuterTypeParameters(d), ...localTypeArguments];
 ...
 * }
 */
export function Checker_isDeferredTypeReferenceNode(receiver, node, hasDefaultTypeArguments) {
    ...
    if (Checker_isResolvedByTypeAlias(receiver, node)) {
        switch (node.Kind) {
            ...
            case KindTupleType:
                return core.Some(Node_Elements(node) ?? [], (element) => Checker_mayResolveTypeAlias(receiver, element));
            case KindTypeReference:
                return (hasDefaultTypeArguments || core.Some(Node_TypeArguments(node) ?? [], (typeArgument) => Checker_mayResolveTypeAlias(receiver, typeArgument)));
        }
 ...
 * }
 */
export function Checker_createNormalizedTypeReference(receiver, target, typeArguments) {
    if ((target.objectFlags & ObjectFlagsTuple) !== 0) {
 ...
 * }
 */
export function Checker_createNormalizedTupleType(receiver, target, elementTypes) {
 ...
 * }
 */
export function TupleNormalizer_normalize(receiver, c, elementTypes, elementInfos) {
    receiver.c = c;
 ...
 * }
 */
export function TupleNormalizer_add(receiver, t, info) {
    if ((info.flags & ElementFlagsRequired) !== 0) {
 ...
 * }
 */
export function Checker_getElementTypes(receiver, t) {
    const typeArguments = Checker_getTypeArguments(receiver, t);
 ...
 * }
 */
export function Checker_isArrayType(receiver, t) {
 ...
 * }
 */
export function Checker_isReadonlyArrayType(receiver, t) {
 ...
 * }
 */
export function Checker_isArrayOrTupleType(receiver, t) {
 ...
 * }
 */
export function Checker_isMutableArrayOrTuple(receiver, t) {
 ...
 * }
 */
export function Checker_getElementTypeOfArrayType(receiver, t) {
 ...
 * }
 */
export function Checker_isArrayLikeType(receiver, t) {
 ...
 * }
 */
export function Checker_isMutableArrayLikeType(receiver, t) {
 ...
 * }
 */
export function Checker_isEmptyArrayLiteralType(receiver, t) {
 ...
 * }
 */
export function Checker_isEmptyLiteralType(receiver, t) {
    if (receiver.strictNullChecks) {
 ...
 * }
 */
export function Checker_isTupleLikeType(receiver, t) {
 ...
 * }
 */
export function Checker_isArrayOrTupleLikeType(receiver, t) {
 ...
 * }
 */
export function Checker_isArrayOrTupleOrIntersection(receiver, t) {
 ...
 * }
 */
export function Checker_getTupleElementType(receiver, t, index) {
    const propType = Checker_getTypeOfPropertyOfType(receiver, t, globalThis.String(index));
    if (propType !== undefined) {
        return propType;
    }
    if (everyType(t, isTupleType)) {
        return Checker_getTupleElementTypeOutOfStartCount(receiver, t, index, receiver.compilerOptions.NoUncheckedIndexedAccess === TSTrue ? receiver.undefinedType : undefined);
    }
    return undefined;
}
/**
 ...
 * }
 */
export function Checker_getDeclaredTypeOfEnum(receiver, symbol_) {
    const links = LinkStore_Get(receiver.declaredTypeLinks, symbol_);
    if (links.declaredType === undefined) {
            ...
            if (declaration.Kind === KindEnumDeclaration) {
                for (const member of Node_Members(declaration) ?? []) {
                    if (Checker_hasBindableName(receiver, member)) {
                        ...
                        LinkStore_Get(receiver.declaredTypeLinks, memberSymbol).declaredType = Checker_getFreshTypeOfLiteralType(receiver, memberType);
        ...
        if (memberTypeList.length !== 0) {
            enumType = Checker_getUnionTypeEx(receiver, memberTypeList, UnionReductionLiteral, { "symbol": symbol_, typeArguments: [] }, undefined);
        }
        else {
 ...
 * }
 */
export function Checker_createComputedEnumType(receiver, symbol_) {
 ...
 * }
 */
export function Checker_getTypeFromTypeQueryNode(receiver, node) {
    const links = LinkStore_Get(receiver.typeNodeLinks, node);
    if (links.resolvedType === undefined) {
 ...
 * }
 */
export function Checker_getTypeFromArrayOrTupleTypeNode(receiver, node) {
    const links = LinkStore_Get(receiver.typeNodeLinks, node);
    if (links.resolvedType === undefined) {
 ...
 * }
 */
export function Checker_isVariadicTupleElement(receiver, node) {
 ...
 * }
 */
export function Checker_getArrayOrTupleTargetType(receiver, node) {
 ...
 * }
 */
export function Checker_isReadonlyTypeOperator(receiver, node) {
 ...
 * }
 */
export function Checker_getArrayElementTypeNode(receiver, node) {
    switch (node.Kind) {
        case KindParenthesizedType:
 ...
 * }
 */
export function Checker_getTypeFromOptionalTypeNode(receiver, node) {
 ...
 * }
 */
export function Checker_getTypeFromUnionTypeNode(receiver, node) {
    const links = LinkStore_Get(receiver.typeNodeLinks, node);
    if (links.resolvedType === undefined) {
 ...
 * }
 */
export function Checker_getTypeFromIntersectionTypeNode(receiver, node) {
    const links = LinkStore_Get(receiver.typeNodeLinks, node);
    if (links.resolvedType === undefined) {
        const alias = Checker_getAliasForTypeNode(receiver, node);
 ...
 * }
 */
export function Checker_getTypeFromTemplateTypeNode(receiver, node) {
    const links = LinkStore_Get(receiver.typeNodeLinks, node);
    if (links.resolvedType === undefined) {
        const data = AsTemplateLiteralTypeNode(node);
        const spans = data.TemplateSpans.Nodes;
        const texts = new Array(spans.length + 1);
        const types = new Array(spans.length);
 ...
 * }
 */
export function Checker_getTypeFromMappedTypeNode(receiver, node) {
    const links = LinkStore_Get(receiver.typeNodeLinks, node);
    if (links.resolvedType === undefined) {
 ...
 * }
 */
export function Checker_getTypeFromConditionalTypeNode(receiver, node) {
    const links = LinkStore_Get(receiver.typeNodeLinks, node);
    if (links.resolvedType === undefined) {
        ...
        const outerTypeParameters = alias !== undefined && alias.typeArguments.length !== 0
            ? allOuterTypeParameters
            : core.Filter(allOuterTypeParameters, (typeParameter) => Checker_isTypeParameterPossiblyReferenced(receiver, typeParameter, node));
        const root = {
 ...
 * }
 */
export function Checker_getConditionalType(receiver, root, mapper, forConstraint, alias) {
    ...
    for (;;) {
        ...
        let combinedMapper = undefined;
        if (root.inferTypeParameters.length !== 0) {
            const context = Checker_newInferenceContext(receiver, root.inferTypeParameters, undefined, InferenceFlagsNone, undefined);
            if (mapper !== undefined) {
        ...
        if (!checkTypeDeferred && !Checker_isDeferredType(receiver, inferredExtendsType, checkTuples)) {
            if ((inferredExtendsType.flags & TypeFlagsAnyOrUnknown) === 0 &&
                ...
                if ((checkType.flags & TypeFlagsAny) !== 0 ||
                    (forConstraint &&
                        (inferredExtendsType.flags & TypeFlagsNever) === 0 &&
                        someType(Checker_getPermissiveInstantiation(receiver, inferredExtendsType), (t) => Checker_isTypeAssignableTo(receiver, t, Checker_getPermissiveInstantiation(receiver, checkType))))) {
 ...
 * }
 */
export function Checker_isSimpleTupleType(receiver, node) {
    if (!IsTupleTypeNode(node)) {
        return false;
    }
    const elements = Node_Elements(node);
    return elements.length > 0 && !core.Some(elements, (e) => IsOptionalTypeNode(e) || IsRestTypeNode(e) || (IsNamedTupleMember(e) && (Node_QuestionToken(e) !== undefined || AsNamedTupleMember(e).DotDotDotToken !== undefined)));
}
/**
 ...
 * }
 */
export function Checker_isDeferredType(receiver, t, checkTuples) {
 ...
 * }
 */
export function Checker_getTrueTypeFromConditionalType(receiver, t) {
 ...
 * }
 */
export function Checker_getFalseTypeFromConditionalType(receiver, t) {
    const d = Type_AsConditionalType(t);
 ...
 * }
 */
export function Checker_createIterableType(receiver, iteratedType) {
 ...
 * }
 */
export function Checker_createArrayType(receiver, elementType) {
 ...
 * }
 */
export function Checker_createArrayTypeEx(receiver, elementType, readonly) {
 ...
 * }
 */
export function Checker_getTupleElementFlags(receiver, node) {
    switch (node.Kind) {
        case KindOptionalType:
 ...
 * }
 */
export function Checker_getTupleElementInfo(receiver, node) {
    return {
 ...
 * }
 */
export function Checker_createTupleType(receiver, elementTypes) {
    const elementInfos = core.Map(elementTypes ?? [], (_) => ({ flags: ElementFlagsRequired, labeledDeclaration: undefined }));
    return Checker_createTupleTypeEx(receiver, elementTypes, elementInfos, false);
}
/**
 ...
 * }
 */
export function Checker_createTupleTypeEx(receiver, elementTypes, elementInfos, readonly) {
 ...
 * }
 */
export function Checker_getTupleTargetType(receiver, elementInfos, readonly) {
 ...
 * }
 */
export function Checker_createTupleTargetType(receiver, elementInfos, readonly) {
    const arity = elementInfos.length;
    const minLength = core.CountWhere(elementInfos, (elementInfo) => ((elementInfo.flags & (ElementFlagsRequired | ElementFlagsVariadic)) !== 0));
    const typeParameters = [];
    const members = new Map();
    let combinedFlags = ElementFlagsNone;
    if (arity !== 0) {
        for (let index = 0; index < arity; index++) {
            ...
            if ((combinedFlags & ElementFlagsVariable) === 0) {
                const property = Checker_newSymbolEx(receiver, (SymbolFlagsProperty | ((flags & ElementFlagsOptionalFlag) !== 0 ? SymbolFlagsOptional : 0)), strconv.Itoa(index), readonly ? CheckFlagsReadonly : 0);
                LinkStore_Get(receiver.valueSymbolLinks, property).resolvedType = typeParameter;
    ...
    if ((combinedFlags & ElementFlagsVariable) !== 0) {
        LinkStore_Get(receiver.valueSymbolLinks, lengthSymbol).resolvedType = receiver.numberType;
    }
    else {
        const literalTypes = [];
        ...
        LinkStore_Get(receiver.valueSymbolLinks, lengthSymbol).resolvedType = Checker_getUnionType(receiver, literalTypes);
    }
    ...
    tupleType.fixedLength = fixedLength;
 ...
 * }
 */
export function Checker_getElementTypeOfSliceOfTupleType(receiver, t, index, endSkipCount, writing, noReductions) {
 ...
 * }
 */
export function Checker_getTupleElementTypeOutOfStartCount(receiver, t, index, undefinedLikeType) {
    return Checker_mapType(receiver, t, (ty) => {
 ...
 * }
 */
export function Checker_isGenericType(receiver, t) {
    return (Checker_getGenericObjectFlags(receiver, t) !== 0);
}
/**
 ...
 * }
 */
export function Checker_isGenericObjectType(receiver, t) {
    return ((Checker_getGenericObjectFlags(receiver, t) & ObjectFlagsIsGenericObjectType) !== 0);
}
/**
 ...
 * }
 */
export function Checker_getGenericObjectFlags(receiver, t) {
        ...
        if ((t.objectFlags & ObjectFlagsIsGenericTypeComputed) === 0) {
            if ((t.flags & TypeFlagsUnionOrIntersection) !== 0) {
                ...
                combinedFlags = (Checker_getGenericObjectFlags(receiver, SubstitutionType_BaseType(Type_AsSubstitutionType(t))) |
                    Checker_getGenericObjectFlags(receiver, Type_AsSubstitutionType(t).constraint));
            }
            t.objectFlags |= (ObjectFlagsIsGenericTypeComputed | combinedFlags);
        }
        return (t.objectFlags & ObjectFlagsIsGenericType);
 ...
 * }
 */
export function Checker_isGenericTupleType(receiver, t) {
 ...
 * }
 */
export function Checker_isGenericMappedType(receiver, t) {
    if ((t.objectFlags & ObjectFlagsMapped) !== 0) {
 ...
 * }
 */
export function Checker_isGenericReducibleType(receiver, t) {
 ...
 * }
 */
export function Checker_isReducibleIntersection(receiver, t) {
    const d = Type_AsIntersectionType(t);
 ...
 * }
 */
export function Checker_newType(receiver, flags, objectFlags, data) {
    receiver.TypeCount++;
    const t = {
        flags,
 ...
 * }
 */
export function Checker_newIntrinsicType(receiver, flags, intrinsicName) {
 ...
 * }
 */
export function Checker_newIntrinsicTypeEx(receiver, flags, intrinsicName, objectFlags) {
    const data = {
        intrinsicName,
    };
 ...
 * }
 */
export function Checker_createWideningType(receiver, nonWideningType) {
    if (receiver.strictNullChecks) {
        return nonWideningType;
    }
 ...
 * }
 */
export function Checker_createUnknownUnionType(receiver) {
    if (receiver.strictNullChecks) {
 ...
 * }
 */
export function Checker_newLiteralType(receiver, flags, value, regularType) {
    const data = {
        value,
        freshType: undefined,
 ...
 * }
 */
export function Checker_newObjectType(receiver, objectFlags, symbol_) {
    let data;
    if ((objectFlags & ObjectFlagsClassOrInterface) !== 0) {
        data = emptyInterfaceData();
    }
    else if ((objectFlags & ObjectFlagsTuple) !== 0) {
        const tuple = emptyInterfaceData();
        tuple.__tsgoEmbedded0 = tuple;
        tuple.elementInfos = [];
        tuple.minLength = 0;
        tuple.fixedLength = 0;
        ...
        data = emptyTypeReferenceData();
    }
    else if ((objectFlags & ObjectFlagsMapped) !== 0) {
        const mapped = emptyObjectData();
        mapped.__tsgoEmbedded0 = mapped;
        ...
        const reverseMapped = emptyObjectData();
        reverseMapped.__tsgoEmbedded0 = reverseMapped;
        ...
        const evolvingArray = emptyObjectData();
        evolvingArray.__tsgoEmbedded0 = evolvingArray;
        ...
        const instantiationExpression = emptyObjectData();
        instantiationExpression.__tsgoEmbedded0 = instantiationExpression;
        instantiationExpression.node = undefined;
        data = instantiationExpression;
    }
 ...
 * }
 */
export function Checker_newAnonymousType(receiver, symbol_, members, callSignatures, constructSignatures, indexInfos) {
    const t = Checker_newObjectType(receiver, ObjectFlagsAnonymous, symbol_);
 ...
 * }
 */
export function Checker_tryCreateTypeReference(receiver, target, typeArguments) {
 ...
 * }
 */
export function Checker_createTypeReference(receiver, target, typeArguments) {
 ...
 * }
 */
export function Checker_createDeferredTypeReference(receiver, target, node, mapper, alias) {
    if (alias === undefined) {
 ...
 * }
 */
export function Checker_cloneTypeReference(receiver, source) {
 ...
 * }
 */
export function Checker_getPropagatingFlagsOfTypes(receiver, types, excludeKinds) {
 ...
 * }
 */
export function Checker_newUnionType(receiver, objectFlags, types) {
    const data = emptyUnionOrIntersectionData(types);
    data.__tsgoEmbedded0 = data;
    data.resolvedReducedType = undefined;
    data.regularType = undefined;
    data.origin = undefined;
    data.keyPropertyName = "";
    data.constituentMap = goNilMap();
 ...
 * }
 */
export function Checker_newIntersectionType(receiver, objectFlags, types) {
    const data = emptyUnionOrIntersectionData(types);
    data.__tsgoEmbedded0 = data;
 ...
 * }
 */
export function Checker_newTemplateLiteralType(receiver, texts, types) {
    const data = {
        resolvedBaseConstraint: undefined,
        texts: texts ?? [],
        types: types ?? [],
 ...
 * }
 */
export function Checker_newConditionalType(receiver, root, mapper, combinedMapper) {
    const data = {
        resolvedBaseConstraint: undefined,
        root,
 ...
 * }
 */
export function Checker_getRegularTypeOfLiteralType(receiver, t) {
    if ((t.flags & TypeFlagsFreshable) !== 0) {
 ...
 * }
 */
export function Checker_getFreshTypeOfLiteralType(receiver, t) {
    if ((t.flags & TypeFlagsFreshable) !== 0) {
 ...
 * }
 */
export function Checker_getStringLiteralType(receiver, value) {
 ...
 * }
 */
export function Checker_getNumberLiteralType(receiver, value) {
    // NaN cannot be used as a Go map key because NaN != NaN in IEEE 754,
    // so Go map lookups for NaN always miss. Cache NaN type separately.
 ...
 * }
 */
export function Checker_getBigIntLiteralType(receiver, value) {
 ...
 * }
 */
export function Checker_parseBigIntLiteralType(receiver, text) {
 ...
 * }
 */
export function Checker_getEnumLiteralType(receiver, value, enumSymbol, symbol_) {
    let flags;
 ...
 * }
 */
export function Checker_isUnitLikeType(receiver, t) {
 ...
 * }
 */
export function Checker_extractUnitType(receiver, t) {
    if ((t.flags & TypeFlagsIntersection) !== 0) {
 ...
 * }
 */
export function Checker_getBaseTypeOfLiteralType(receiver, t) {
 ...
 * }
 */
export function Checker_getBaseTypeOfLiteralTypeForComparison(receiver, t) {
    if ((t.flags & (TypeFlagsStringLiteral | TypeFlagsTemplateLiteral | TypeFlagsStringMapping)) !== 0) {
        return receiver.stringType;
    }
 ...
 * }
 */
export function Checker_getBaseTypeOfEnumLikeType(receiver, t) {
 ...
 * }
 */
export function Checker_getBaseTypeOfLiteralTypeUnion(receiver, t) {
    const key = { kind: CachedTypeKindLiteralUnionBaseType, typeId: t.id };
    const cached = receiver.cachedTypes.get(key);
    if (cached !== undefined) {
        return cached;
    }
 ...
 * }
 */
export function Checker_getWidenedLiteralType(receiver, t) {
    ...
    if ((t.flags & TypeFlagsUnion) !== 0) {
        return Checker_mapType(receiver, t, (ty) => Checker_getWidenedLiteralType(receiver, ty));
    }
    return t;
}
/**
 ...
 * }
 */
export function Checker_getWidenedLiteralLikeTypeForContextualType(receiver, t, contextualType) {
 ...
 * }
 */
export function Checker_isLiteralOfContextualType(receiver, candidateType, contextualType) {
    if (contextualType !== undefined) {
        if ((contextualType.flags & TypeFlagsUnionOrIntersection) !== 0) {
            return core.Some(Type_Types(contextualType), (t) => Checker_isLiteralOfContextualType(receiver, candidateType, t));
        }
        if ((contextualType.flags & TypeFlagsInstantiableNonPrimitive) !== 0) {
            const constraint = core.OrElse(Checker_getBaseConstraintOfType(receiver, contextualType), receiver.unknownType);
            return ((Checker_maybeTypeOfKind(receiver, constraint, TypeFlagsString) && Checker_maybeTypeOfKind(receiver, candidateType, TypeFlagsStringLiteral)) ||
        ...
        return (((contextualType.flags & (TypeFlagsStringLiteral | TypeFlagsIndex | TypeFlagsTemplateLiteral | TypeFlagsStringMapping)) !== 0 && Checker_maybeTypeOfKind(receiver, candidateType, TypeFlagsStringLiteral)) ||
 ...
 * }
 */
export function Checker_mapType(receiver, t, f) {
 ...
 * }
 */
export function Checker_mapTypeEx(receiver, t, f, noReductions) {
    if ((t.flags & TypeFlagsNever) !== 0) {
        return t;
    }
    if ((t.flags & TypeFlagsUnion) === 0) {
 ...
 * }
 */
export function Checker_getUnionOrIntersectionType(receiver, types, isUnion, unionReduction) {
    if (isUnion) {
 ...
 * }
 */
export function Checker_getUnionType(receiver, types) {
 ...
 * }
 */
export function Checker_getUnionTypeEx(receiver, types, unionReduction, alias, origin) {
    if (types.length === 0) {
        return receiver.neverType;
    }
    if (types.length === 1) {
    ...
    if (types.length === 2 && origin === undefined && ((types[0].flags & TypeFlagsUnion) !== 0 || (types[1].flags & TypeFlagsUnion) !== 0)) {
        ...
        const key = { id1, id2, r: unionReduction, a: getAliasKey(alias) };
 ...
 * }
 */
export function Checker_getUnionTypeWorker(receiver, types, unionReduction, alias, origin) {
    ...
    if (origin === undefined && (includes & TypeFlagsUnion) !== 0) {
        ...
        for (const t of typeSet) {
            if (!core.Some(namedUnions, (u) => containsType(Type_Types(u), t))) {
                reducedTypes.push(t);
            }
        }
    ...
    const objectFlags = (((includes & TypeFlagsNotPrimitiveUnion) !== 0 ? ObjectFlagsNone : ObjectFlagsPrimitiveUnion) |
 ...
 * }
 */
export function Checker_getUnionTypeFromSortedList(receiver, types, precomputedObjectFlags, alias, origin) {
    if (types.length === 0) {
        return receiver.neverType;
    }
    if (types.length === 1) {
    ...
    if (t === undefined) {
        t = Checker_newUnionType(receiver, (precomputedObjectFlags | Checker_getPropagatingFlagsOfTypes(receiver, types, TypeFlagsNullable)), types);
 ...
 * }
 */
export function Checker_UnionTypes(receiver) {
    return (yieldValue) => {
 ...
 * }
 */
export function Checker_addTypesToUnion(receiver, typeSet, includes, types) {
    let lastType;
    for (const t of types) {
        if (t !== lastType) {
            if ((t.flags & TypeFlagsUnion) !== 0) {
                ...
                if (t.alias !== undefined || unionType.origin !== undefined) {
                    includes = (includes | TypeFlagsUnion);
                }
 ...
 * }
 */
export function Checker_addTypeToUnion(receiver, typeSet, includes, t) {
    const flags = t.flags;
    if ((flags & TypeFlagsNever) === 0) {
        includes = (includes | (flags & TypeFlagsIncludesMask));
        if ((flags & TypeFlagsInstantiable) !== 0) {
            includes = (includes | TypeFlagsIncludesInstantiable);
        }
        if ((flags & TypeFlagsIntersection) !== 0 && (t.objectFlags & ObjectFlagsIsConstrainedTypeVariable) !== 0) {
            includes = (includes | TypeFlagsIncludesConstrainedTypeVariable);
        }
        if (t === receiver.wildcardType) {
            includes = (includes | TypeFlagsIncludesWildcard);
        }
        if (Checker_isErrorType(receiver, t)) {
            includes = (includes | TypeFlagsIncludesError);
        }
        if (!receiver.strictNullChecks && (flags & TypeFlagsNullable) !== 0) {
            if ((t.objectFlags & ObjectFlagsContainsWideningType) === 0) {
                includes = (includes | TypeFlagsIncludesNonWideningType);
            }
        }
        else {
 ...
 * }
 */
export function Checker_removeRedundantLiteralTypes(receiver, types, includes, reduceVoidUndefined) {
    for (let i = types.length; i > 0;) {
        ...
        const remove = (((flags & (TypeFlagsStringLiteral | TypeFlagsTemplateLiteral | TypeFlagsStringMapping)) !== 0 && (includes & TypeFlagsString) !== 0) ||
            ...
            ((flags & TypeFlagsUniqueESSymbol) !== 0 && (includes & TypeFlagsESSymbol) !== 0) ||
            (reduceVoidUndefined && (flags & TypeFlagsUndefined) !== 0 && (includes & TypeFlagsVoid) !== 0) ||
            (isFreshLiteralType(t) && containsType(types, Type_AsLiteralType(t).regularType)));
        if (remove) {
            types = slices.Delete(types, i, i + 1);
        }
    }
 ...
 * }
 */
export function Checker_removeStringLiteralsMatchedByTemplateLiterals(receiver, types) {
    const templates = core.Filter(types, (ty) => Checker_isPatternLiteralType(receiver, ty));
    if (templates.length !== 0) {
        for (let i = types.length; i > 0;) {
            i--;
            const t = types[i];
            if ((t.flags & TypeFlagsStringLiteral) !== 0 && core.Some(templates, (template) => Checker_isTypeMatchedByTemplateLiteralOrStringMapping(receiver, t, template))) {
                types = slices.Delete(types, i, i + 1);
            }
        }
    }
 ...
 * }
 */
export function Checker_removeConstrainedTypeVariables(receiver, types) {
    let typeVariables = [];
    for (const t of types) {
        if ((t.flags & TypeFlagsIntersection) !== 0 && (t.objectFlags & ObjectFlagsIsConstrainedTypeVariable) !== 0) {
            let index = 0;
 ...
 * }
 */
export function Checker_intersectTypes(receiver, type1, type2) {
    if (type1 === undefined) {
        return type2;
    }
    if (type2 === undefined) {
 ...
 * }
 */
export function Checker_getIntersectionType(receiver, types) {
 ...
 * }
 */
export function Checker_getIntersectionTypeEx(receiver, types, flags, alias) {
    const orderedTypes = {
        values: [],
        valuesByKey: goNilMap(),
    };
    ...
    if (typeSet.length === 2 && (flags & IntersectionFlagsNoConstraintReduction) === 0) {
        ...
        if ((typeVariable.flags & TypeFlagsTypeVariable) !== 0 && ((((primitiveType.flags & (TypeFlagsPrimitive | TypeFlagsNonPrimitive)) !== 0) && !Checker_isGenericStringLikeType(receiver, primitiveType)) ||
            ...
            if (constraint !== undefined && everyType(constraint, receiver.isPrimitiveOrObjectOrEmptyType)) {
                ...
                if (!((constraint.flags & TypeFlagsUnion) !== 0 && someType(constraint, (n) => Checker_isTypeStrictSubtypeOf(receiver, n, primitiveType)))) {
 ...
 * }
 */
export function Checker_addTypesToIntersection(receiver, typeSet, includes, types) {
    for (const t of types) {
 ...
 * }
 */
export function Checker_addTypeToIntersection(receiver, typeSet, includes, t) {
    const flags = t.flags;
    if ((flags & TypeFlagsIntersection) !== 0) {
    ...
    if (Checker_IsEmptyAnonymousObjectType(receiver, t)) {
        if ((includes & TypeFlagsIncludesEmptyObject) === 0) {
            includes = (includes | TypeFlagsIncludesEmptyObject);
        ...
        if ((flags & TypeFlagsAnyOrUnknown) !== 0) {
            ...
            if (t === receiver.missingType) {
                includes = (includes | TypeFlagsIncludesMissingType);
                t = receiver.undefinedType;
            }
            if (!orderedSet_contains(typeSet, t)) {
                if ((t.flags & TypeFlagsUnit) !== 0 && (includes & TypeFlagsUnit) !== 0) {
                    includes = (includes | TypeFlagsNonPrimitive);
                }
                orderedSet_add(typeSet, t);
            }
        }
 ...
 * }
 */
export function Checker_extractRedundantTemplateLiterals(receiver, types) {
    const literals = core.Filter(types, (t) => (t.flags & TypeFlagsStringLiteral) !== 0);
    for (let i = types.length; i > 0;) {
        i--;
        const t = types[i];
        if ((t.flags & (TypeFlagsTemplateLiteral | TypeFlagsStringMapping)) === 0) {
 ...
 * }
 */
export function Checker_intersectUnionsOfPrimitiveTypes(receiver, types) {
    const index = slices.IndexFunc(types, isPrimitiveUnion);
    if (index < 0) {
        return [types, false];
    }
    let i = index + 1;
    const unionTypes = [types[index]];
 ...
 * }
 */
export function Checker_eachUnionContains(receiver, unionTypes, t) {
    for (const u of unionTypes) {
 ...
 * }
 */
export function Checker_getCrossProductIntersections(receiver, types, flags) {
 ...
 * }
 */
export function Checker_filterTypes(receiver, types, predicate) {
    for (let i = 0; i < types.length; i++) {
 ...
 * }
 */
export function Checker_IsEmptyAnonymousObjectType(receiver, t) {
    return ((t.objectFlags & ObjectFlagsAnonymous) !== 0 &&
        (((t.objectFlags & ObjectFlagsMembersResolved) !== 0 && Checker_isEmptyResolvedType(receiver, Type_AsStructuredType(t))) ||
            (t["symbol"] !== undefined && (t["symbol"].Flags & SymbolFlagsTypeLiteral) !== 0 && Checker_getMembersOfSymbol(receiver, t["symbol"]).size === 0)));
}
/**
 ...
 * }
 */
export function Checker_isEmptyResolvedType(receiver, t) {
 ...
 * }
 */
export function Checker_isEmptyObjectType(receiver, t) {
    switch (true) {
        case (t.flags & TypeFlagsObject) !== 0:
 ...
 * }
 */
export function Checker_isPatternLiteralPlaceholderType(receiver, t) {
    if ((t.flags & TypeFlagsIntersection) !== 0) {
 ...
 * }
 */
export function Checker_isPatternLiteralType(receiver, t) {
 ...
 * }
 */
export function Checker_isGenericStringLikeType(receiver, t) {
 ...
 * }
 */
export function Checker_filterType(receiver, t, f) {
    if ((t.flags & TypeFlagsUnion) !== 0) {
        const types = Type_Types(t);
        ...
        if (origin !== undefined && (origin.flags & TypeFlagsUnion) !== 0) {
            ...
            const originFiltered = core.Filter(originTypes, (u) => (u.flags & TypeFlagsUnion) !== 0 || f(u));
        ...
        return Checker_getUnionTypeFromSortedList(receiver, filtered, t.objectFlags & (ObjectFlagsPrimitiveUnion | ObjectFlagsContainsIntersections), undefined, newOrigin);
    }
    if ((t.flags & TypeFlagsNever) !== 0 || f(t)) {
        return t;
    }
 ...
 * }
 */
export function Checker_removeType(receiver, t, targetType) {
    return Checker_filterType(receiver, t, (ty) => ty !== targetType);
}
/**
 ...
 * }
 */
export function Checker_checkCrossProductUnion(receiver, types) {
 ...
 * }
 */
export function Checker_getCrossProductUnionSize(receiver, types) {
    let size = 1;
    for (const t of types) {
        if ((t.flags & TypeFlagsUnion) !== 0) {
 ...
 * }
 */
export function Checker_getExtractStringType(receiver, t) {
 ...
 * }
 */
export function Checker_getLiteralTypeFromProperties(receiver, t, include, includeOrigin) {
    const key = {
        typeId: t.id,
        include,
        includeOrigin,
 ...
 * }
 */
export function Checker_isKeyTypeIncluded(receiver, keyType, include) {
    return (keyType.flags & include) !== 0 ||
 ...
 * }
 */
export function Checker_getSuggestedTypeForNonexistentStringLiteralType(receiver, source, target) {
 ...
 * }
 */
export function Checker_isSelfTypeAccess(receiver, name, parent) {
 ...
 * }
 */
export function Checker_maybeTypeOfKind(receiver, t, kind) {
    if ((t.flags & kind) !== 0) {
        return true;
    }
    if ((t.flags & TypeFlagsUnionOrIntersection) !== 0) {
 ...
 * }
 */
export function Checker_isUnknownLikeUnionType(receiver, t) {
    if (receiver.strictNullChecks && (t.flags & TypeFlagsUnion) !== 0) {
        if ((t.objectFlags & ObjectFlagsIsUnknownLikeUnionComputed) === 0) {
            t.objectFlags |= ObjectFlagsIsUnknownLikeUnionComputed;
            const types = Type_Types(t);
            if (types.length >= 3 && (types[0].flags & TypeFlagsUndefined) !== 0 && (types[1].flags & TypeFlagsNull) !== 0 && core.Some(types, (ty) => Checker_IsEmptyAnonymousObjectType(receiver, ty))) {
                t.objectFlags |= ObjectFlagsIsUnknownLikeUnion;
            }
        }
        return ((t.objectFlags & ObjectFlagsIsUnknownLikeUnion) !== 0);
 ...
 * }
 */
export function Checker_containsUndefinedType(receiver, t) {
    if ((t.flags & TypeFlagsUnion) !== 0) {
        t = Type_Types(t)[0];
    }
    return (t.flags & TypeFlagsUndefined) !== 0;
 ...
 * }
 */
export function Checker_getNormalizedType(receiver, t, writing) {
    for (;;) {
        let n;
 ...
 * }
 */
export function Checker_getSimplifiedType(receiver, t, writing) {
    if ((t.flags & TypeFlagsIndexedAccess) !== 0) {
 ...
 * }
 */
export function Checker_getSimplifiedConditionalType(receiver, t, writing) {
 ...
 * }
 */
export function Checker_isIntersectionEmpty(receiver, type1, type2) {
    return ((Checker_getUnionType(receiver, [Checker_intersectTypes(receiver, type1, type2), receiver.neverType]).flags & TypeFlagsNever) !== 0);
}
/**
 ...
 * }
 */
export function Checker_getNormalizedUnionOrIntersectionType(receiver, t, writing) {
    ...
    if ((t.flags & TypeFlagsIntersection) !== 0 && Checker_shouldNormalizeIntersection(receiver, t)) {
        const types = Type_Types(t);
        const normalizedTypes = core.SameMap(types, (u) => Checker_getNormalizedType(receiver, u, writing));
        if (!core.Same(normalizedTypes, types)) {
 ...
 * }
 */
export function Checker_shouldNormalizeIntersection(receiver, t) {
 ...
 * }
 */
export function Checker_getNormalizedTupleType(receiver, t, writing) {
    const elements = Checker_getElementTypes(receiver, t);
    const normalizedElements = core.SameMap(elements, (ty) => {
 ...
 * }
 */
export function Checker_getModifiersTypeFromMappedType(receiver, t) {
    const m = Type_AsMappedType(t);
 ...
 * }
 */
export function Checker_extractTypesOfKind(receiver, t, kind) {
    return Checker_filterType(receiver, t, (ty) => (ty.flags & kind) !== 0);
}
/**
 ...
 * }
 */
export function Checker_getRegularTypeOfObjectLiteral(receiver, t) {
    if (!(isObjectLiteralType(t) && (t.objectFlags & ObjectFlagsFreshLiteral) !== 0)) {
        return t;
    }
    const key = { kind: CachedTypeKindRegularObjectLiteral, typeId: t.id };
    const cached = receiver.cachedTypes.get(key);
    if (cached !== undefined) {
        return cached;
    }
    const resolved = Checker_resolveStructuredTypeMembers(receiver, t);
    const members = Checker_transformTypeOfMembers(receiver, t, (propertyType) => Checker_getRegularTypeOfObjectLiteral(receiver, propertyType));
    ...
    const resolvedType = resolved.AsType();
    regular.flags = resolvedType.flags;
    regular.objectFlags |= (resolvedType.objectFlags & ~ObjectFlagsFreshLiteral);
 ...
 * }
 */
export function Checker_markDecoratorMedataDataTypeNodeAsReferenced(receiver, node) {
 ...
 * }
 */
export function Checker_markTypeNodeAsReferenced(receiver, node) {
    if (node !== undefined) {
 ...
 * }
 */
export function Checker_GetPromisedTypeOfPromise(receiver, t) {
 ...
 * }
 */
export function Checker_getPromisedTypeOfPromiseEx(receiver, t, errorNode, thisTypeForErrorOut) {
    if (IsTypeAny(t)) {
        return undefined;
    }
    const key = { kind: CachedTypeKindPromisedTypeOfPromise, typeId: t.id };
    const cached = receiver.cachedTypes.get(key);
    if (cached !== undefined) {
        return cached;
    }
    ...
    if (candidates.length === 0) {
        if (thisTypeForErrorOut !== undefined) {
            thisTypeForErrorOut[0] = thisTypeForError;
        }
        if (errorNode !== undefined) {
            Checker_error(receiver, errorNode, diagnosticsMessages.The_this_context_of_type_0_is_not_assignable_to_method_s_this_of_type_1, Checker_TypeToString(receiver, t), Checker_TypeToString(receiver, thisTypeForError));
        }
        return undefined;
    }
    const onfulfilledParameterType = Checker_getTypeWithFacts(receiver, Checker_getUnionType(receiver, candidates.map((signature) => Checker_getTypeOfFirstParameterOfSignature(receiver, signature))), TypeFactsNEUndefinedOrNull);
    if (IsTypeAny(onfulfilledParameterType)) {
        return undefined;
    }
    ...
    const result = Checker_getUnionTypeEx(receiver, onfulfilledParameterSignatures.map((signature) => Checker_getTypeOfFirstParameterOfSignature(receiver, signature)), UnionReductionSubtype, undefined, undefined);
    receiver.cachedTypes.set(key, result);
    return result;
}
/**
 ...
 * }
 */
export function Checker_getCombinedMappedTypeOptionality(receiver, t) {
    if ((t.objectFlags & ObjectFlagsMapped) !== 0) {
 ...
 * }
 */
export function Checker_getOptionalExpressionType(receiver, exprType, expression) {
 ...
 * }
 */
export function Checker_removeOptionalTypeMarker(receiver, t) {
    if (receiver.strictNullChecks) {
 ...
 * }
 */
export function Checker_propagateOptionalTypeMarker(receiver, t, node, wasOptional) {
    if (wasOptional) {
 ...
 * }
 */
export function Checker_removeMissingType(receiver, t, isOptional) {
 ...
 * }
 */
export function Checker_removeMissingOrUndefinedType(receiver, t) {
 ...
 * }
 */
export function Checker_getTemplateLiteralType(receiver, texts, types) {
    const unionIndex = core.FindIndex(types, (t) => (t.flags & (TypeFlagsNever | TypeFlagsUnion)) !== 0);
    if (unionIndex >= 0) {
        if (!Checker_checkCrossProductUnion(receiver, types)) {
            return receiver.errorType;
        }
        return Checker_mapType(receiver, types[unionIndex], (t) => Checker_getTemplateLiteralType(receiver, texts, core.ReplaceElement(types, unionIndex, t)));
    }
    ...
    const newTexts = [];
    let sb = texts[0];
    const addSpans = (spanTexts, spanTypes) => {
    ...
    newTexts.push(CombineSurrogatePairs(sb));
    if (core.Every(newTexts, (t) => t === "")) {
        if (core.Every(newTypes, (t) => (t.flags & TypeFlagsString) !== 0)) {
            return receiver.stringType;
        }
 ...
 * }
 */
export function Checker_getTemplateStringForType(receiver, t) {
 ...
 * }
 */
export function Checker_getContextualType(receiver, node, contextFlags) {
    if ((node.Flags & NodeFlagsInWithStatement) !== 0) {
        return undefined;
    }
    const record = (contextualType) => {
 ...
 * }
 */
export function Checker_getContextualTypeForInitializerExpression(receiver, node, contextFlags) {
 ...
 * }
 */
export function Checker_isContextSensitiveFunctionOrObjectLiteralMethod(receiver, fn) {
    return ((IsFunctionExpressionOrArrowFunction(fn) || IsObjectLiteralMethod(fn)) && Checker_isContextSensitiveFunctionLikeDeclaration(receiver, fn));
}
/**
 ...
 * }
 */
export function Checker_getMutableArrayOrTupleType(receiver, t) {
    if ((t.flags & TypeFlagsUnion) !== 0) {
        return Checker_mapType(receiver, t, (ty) => Checker_getMutableArrayOrTupleType(receiver, ty));
    }
 ...
 * }
 */
export function Checker_getContextualTypeForBindingElement(receiver, declaration, contextFlags) {
    const name = Node_PropertyNameOrName(declaration);
 ...
 * }
 */
export function Checker_getContextualTypeForReturnExpression(receiver, node, contextFlags) {
    ...
    if (fn !== undefined) {
        ...
        if (contextualReturnType !== undefined) {
            ...
            if ((functionFlags & FunctionFlagsGenerator) !== 0) {
                ...
                if ((contextualReturnType.flags & TypeFlagsUnion) !== 0) {
                    contextualReturnType = Checker_filterType(receiver, contextualReturnType, (type_) => (Checker_getIterationTypeOfGeneratorFunctionReturnType(receiver, IterationTypeKindReturn, type_, isAsyncGenerator) !== undefined));
                }
                const iterationReturnType = Checker_getIterationTypeOfGeneratorFunctionReturnType(receiver, IterationTypeKindReturn, contextualReturnType, ((functionFlags & FunctionFlagsAsync) !== 0));
            ...
            if ((functionFlags & FunctionFlagsAsync) !== 0) {
                // Get the awaited type without the `Awaited<T>` alias
                const contextualAwaitedType = Checker_mapType(receiver, contextualReturnType, (type_) => Checker_getAwaitedTypeNoAlias(receiver, type_));
 ...
 * }
 */
export function Checker_getContextualIterationType(receiver, kind, functionDecl) {
 ...
 * }
 */
export function Checker_getContextualTypeForYieldOperand(receiver, node, contextFlags) {
    const fn = GetContainingFunction(node);
    if (fn !== undefined) {
        const functionFlags = GetFunctionFlags(fn);
        let contextualReturnType = Checker_getContextualReturnType(receiver, fn, contextFlags);
 ...
 * }
 */
export function Checker_getContextualTypeForAwaitOperand(receiver, node, contextFlags) {
 ...
 * }
 */
export function Checker_getContextualTypeForDecorator(receiver, decorator) {
 ...
 * }
 */
export function Checker_getContextualTypeForBinaryOperand(receiver, node, contextFlags) {
    ...
    switch (binary.OperatorToken.Kind) {
        ...
        case KindQuestionQuestionEqualsToken:
            if (node === binary.Right) {
                const target = GetLeftmostExpression(binary.Left, false);
        ...
        case KindQuestionQuestionToken: {
            ...
            if (node === binary.Right && (contextualType === undefined || receiver.patternForType.get(contextualType) !== undefined)) {
                return Checker_getTypeOfExpression(receiver, binary.Left);
            }
            return contextualType;
        }
        case KindAmpersandAmpersandToken:
 ...
 * }
 */
export function Checker_getContextualTypeForObjectLiteralElement(receiver, element, contextFlags) {
    ...
    if (contextualType !== undefined) {
        if (Checker_hasBindableName(receiver, element)) {
            ...
            return Checker_getTypeOfPropertyOfContextualTypeEx(receiver, contextualType, symbol_.Name, LinkStore_Get(receiver.valueSymbolLinks, symbol_).nameType);
        }
        ...
        if (name !== undefined) {
            const nameType = Checker_getLiteralTypeFromPropertyName(receiver, name);
            return Checker_mapTypeEx(receiver, contextualType, (type_) => {
 ...
 * }
 */
export function Checker_getContextualTypeForObjectLiteralMethod(receiver, node, contextFlags) {
    if ((node.Flags & NodeFlagsInWithStatement) !== 0) {
        return undefined;
    }
 ...
 * }
 */
export function Checker_getContextualTypeForElementExpression(receiver, t, index, length, firstSpreadIndex, lastSpreadIndex) {
    if (t === undefined) {
        return undefined;
    }
    return Checker_mapTypeEx(receiver, t, (type_) => {
        if (isTupleType(type_)) {
            ...
            if (offset > 0 && (targetTupleType.combinedFlags & ElementFlagsVariable) !== 0) {
                fixedEndLength = getEndElementCount(targetTupleType, ElementFlagsFixed);
            }
            if (offset > 0 && offset <= fixedEndLength) {
            ...
            if (firstSpreadIndex >= 0) {
                tupleIndex = Math.min(tupleIndex, firstSpreadIndex);
            }
            let endSkipCount = fixedEndLength;
            if (length >= 0 && lastSpreadIndex >= 0) {
                endSkipCount = Math.min(fixedEndLength, length - lastSpreadIndex);
            }
            return Checker_getElementTypeOfSliceOfTupleType(receiver, type_, tupleIndex, endSkipCount, false, true);
        }
        if (firstSpreadIndex < 0 || index < firstSpreadIndex) {
        ...
        return Checker_getIteratedTypeOrElementType(receiver, IterationUseElement, type_, receiver.undefinedType, undefined, false);
    }, true);
}
/**
 ...
 * }
 */
export function Checker_getContextualTypeForConditionalOperand(receiver, node, contextFlags) {
 ...
 * }
 */
export function Checker_newClassDecoratorContextType(receiver, classType) {
 ...
 * }
 */
export function Checker_newClassMethodDecoratorContextType(receiver, classType, valueType) {
 ...
 * }
 */
export function Checker_newClassGetterDecoratorContextType(receiver, classType, valueType) {
 ...
 * }
 */
export function Checker_newClassSetterDecoratorContextType(receiver, classType, valueType) {
 ...
 * }
 */
export function Checker_newClassAccessorDecoratorContextType(receiver, thisType, valueType) {
 ...
 * }
 */
export function Checker_newClassFieldDecoratorContextType(receiver, thisType, valueType) {
 ...
 * }
 */
export function Checker_newClassAccessorDecoratorTargetType(receiver, thisType, valueType) {
 ...
 * }
 */
export function Checker_newClassAccessorDecoratorResultType(receiver, thisType, valueType) {
 ...
 * }
 */
export function Checker_newClassFieldDecoratorInitializerMutatorType(receiver, thisType, valueType) {
 ...
 * }
 */
export function Checker_newFunctionType(receiver, typeParameters, thisParameter, parameters, returnType) {
 ...
 * }
 */
export function Checker_newGetterFunctionType(receiver, t) {
 ...
 * }
 */
export function Checker_newSetterFunctionType(receiver, t) {
 ...
 * }
 */
export function Checker_getParentTypeOfClassElement(receiver, node) {
 ...
 * }
 */
export function Checker_getApparentTypeOfContextualType(receiver, node, contextFlags) {
    ...
    if (instantiatedType !== undefined && !((contextFlags & ContextFlagsNoConstraints) !== 0 && (instantiatedType.flags & TypeFlagsTypeVariable) !== 0)) {
        const apparentType = Checker_mapTypeEx(receiver, instantiatedType, (type_) => {
 ...
 * }
 */
export function ObjectLiteralDiscriminator_len(receiver) {
    return (receiver.props.length + receiver.members.length);
}
/**
 ...
 * }
 */
export function ObjectLiteralDiscriminator_name(receiver, index) {
 ...
 * }
 */
export function ObjectLiteralDiscriminator_matches(receiver, index, t) {
    let propType;
    if (index < receiver.props.length) {
 ...
 * }
 */
export function Checker_getMatchingUnionConstituentForObjectLiteral(receiver, unionType, node) {
    const keyPropertyName = Checker_getKeyPropertyName(receiver, unionType);
    if (keyPropertyName !== "") {
        const propNode = core.Find(Node_Properties(node) ?? [], (p) => Node_Symbol(p) !== undefined &&
 ...
 * }
 */
export function Checker_instantiateContextualType(receiver, contextualType, node, contextFlags) {
            ...
            if (inferenceContext.returnMapper !== undefined) {
                ...
                if ((instantiatedType.flags & TypeFlagsAnyOrUnknown) === 0) {
                    if ((instantiatedType.flags & TypeFlagsUnion) !== 0 &&
                        ...
                        return Checker_filterType(receiver, instantiatedType, (type_) => (type_ !== receiver.regularFalseType && type_ !== receiver.regularTrueType));
                    }
                    return instantiatedType;
                }
            }
 ...
 * }
 */
export function Checker_instantiateInstantiableTypes(receiver, t, mapper) {
    if ((t.flags & TypeFlagsInstantiable) !== 0) {
        return Checker_instantiateType(receiver, t, mapper);
    }
    if ((t.flags & TypeFlagsUnion) !== 0) {
        return Checker_getUnionTypeEx(receiver, core.Map(Type_Types(t), (ty) => Checker_instantiateInstantiableTypes(receiver, ty, mapper)), UnionReductionNone, undefined, undefined);
    }
    if ((t.flags & TypeFlagsIntersection) !== 0) {
        return Checker_getIntersectionType(receiver, core.Map(Type_Types(t), (ty) => Checker_instantiateInstantiableTypes(receiver, ty, mapper)));
    }
    return t;
}
/**
 ...
 * }
 */
export function Checker_pushCachedContextualType(receiver, node) {
 ...
 * }
 */
export function Checker_pushContextualType(receiver, node, t, isCache) {
 ...
 * }
 */
export function Checker_popContextualType(receiver) {
    const lastIndex = receiver.contextualInfos.length - 1;
    receiver.contextualInfos[lastIndex] = {};
 ...
 * }
 */
export function Checker_getTypeFacts(receiver, t, mask) {
 ...
 * }
 */
export function Checker_hasTypeFacts(receiver, t, mask) {
 ...
 * }
 */
export function Checker_getTypeFactsWorker(receiver, t, callerOnlyNeeds) {
    if ((t.flags & (TypeFlagsIntersection | TypeFlagsInstantiable)) !== 0) {
        t = Checker_getBaseConstraintOfType(receiver, t);
        if (t === undefined) {
            t = receiver.unknownType;
 ...
 * }
 */
export function Checker_getIntersectionTypeFacts(receiver, t, callerOnlyNeeds) {
 ...
 * }
 */
export function Checker_isFunctionObjectType(receiver, t) {
    if ((t.objectFlags & ObjectFlagsEvolvingArray) !== 0) {
        return false;
    }
    const resolved = Checker_resolveStructuredTypeMembers(receiver, t);
    return (resolved.signatures.length !== 0 || (resolved.members.get("bind") !== undefined && Checker_isTypeSubtypeOf(receiver, t, receiver.globalFunctionType)));
}
/**
 ...
 * }
 */
export function Checker_getTypeWithFacts(receiver, t, include) {
    return Checker_filterType(receiver, t, (ty) => Checker_hasTypeFacts(receiver, ty, include));
}
/**
 ...
 * }
 */
export function Checker_getAdjustedTypeWithFacts(receiver, t, facts) {
    ...
    if (receiver.strictNullChecks) {
        switch (facts) {
            ...
            case TypeFactsTruthy:
                return Checker_mapType(receiver, reduced, (mappedType) => {
 ...
 * }
 */
export function Checker_removeNullableByIntersection(receiver, t, targetFacts, otherFacts, otherIncludesFacts, otherType) {
    const facts = Checker_getTypeFacts(receiver, t, (TypeFactsEQUndefined | TypeFactsEQNull | TypeFactsIsUndefined | TypeFactsIsNull));
    if ((facts & targetFacts) === 0) {
        return t;
    }
    const emptyAndOtherUnion = Checker_getUnionType(receiver, [receiver.emptyObjectType, otherType]);
    return Checker_mapType(receiver, t, (mappedType) => {
 ...
 * }
 */
export function Checker_recombineUnknownType(receiver, t) {
 ...
 * }
 */
export function Checker_convertAutoToAny(receiver, t) {
 ...
 * }
 */
export function Checker_checkAwaitedType(receiver, t, withAlias, errorNode, diagnosticMessage) {
    let awaitedType;
    if (withAlias) {
 ...
 * }
 */
export function Checker_getAwaitedType(receiver, t) {
 ...
 * }
 */
export function Checker_getAwaitedTypeEx(receiver, t, errorNode, diagnosticMessage, ...args) {
 ...
 * }
 */
export function Checker_isAwaitedTypeNeeded(receiver, t) {
    ...
    if (Checker_isGenericObjectType(receiver, t)) {
        ...
        if (baseConstraint !== undefined) {
            return ((baseConstraint.flags & TypeFlagsAnyOrUnknown) !== 0 ||
                ...
                someType(baseConstraint, (candidate) => Checker_isThenableType(receiver, candidate)));
        }
 ...
 * }
 */
export function Checker_createAwaitedTypeIfNeeded(receiver, t) {
 ...
 * }
 */
export function Checker_tryCreateAwaitedType(receiver, t) {
 ...
 * }
 */
export function Checker_unwrapAwaitedType(receiver, t) {
    if ((t.flags & TypeFlagsUnion) !== 0) {
        return Checker_mapType(receiver, t, (mapped) => Checker_unwrapAwaitedType(receiver, mapped));
    }
 ...
 * }
 */
export function Checker_isThenableType(receiver, t) {
    if (Checker_allTypesAssignableToKind(receiver, Checker_getBaseConstraintOrType(receiver, t), TypeFlagsPrimitive | TypeFlagsNever)) {
        return false;
    }
    const thenFunction = Checker_getTypeOfPropertyOfType(receiver, t, "then");
 ...
 * }
 */
export function Checker_getAwaitedTypeOfPromise(receiver, t) {
 ...
 * }
 */
export function Checker_getAwaitedTypeOfPromiseEx(receiver, t, errorNode, diagnosticMessage, ...args) {
 ...
 * }
 */
export function Checker_getTargetType(receiver, t) {
    if ((t.objectFlags & ObjectFlagsReference) !== 0) {
 ...
 * }
 */
export function Checker_hasContextualTypeWithNoGenericTypes(receiver, node, checkMode) {
 ...
 * }
 */
export function Checker_getNonUndefinedType(receiver, t) {
 ...
 * }
 */
export function Checker_getActualTypeVariable(receiver, t) {
    if ((t.flags & TypeFlagsSubstitution) !== 0) {
 ...
 * }
 */
export function Checker_getTypeOfNode(receiver, node) {
    ...
    if (IsPartOfTypeNode(node)) {
        ...
        if (classType !== undefined) {
            return Checker_getTypeWithThisArgument(receiver, typeFromTypeNode, Type_AsInterfaceType(classType).thisType, false);
        }
        return typeFromTypeNode;
    }
    ...
    if (classType !== undefined && !isImplements) {
        ...
        if (baseType !== undefined) {
            return Checker_getTypeWithThisArgument(receiver, baseType, Type_AsInterfaceType(classType).thisType, false);
        }
        return receiver.errorType;
    }
 ...
 * }
 */
export function Checker_getRegularTypeOfExpression(receiver, expr) {
 ...
 * }
 */
export function Checker_GetTypeAtLocation(receiver, node) {
