 ...
 * }
 */
export function Checker_addUndefinedToGlobalsOrErrorOnRedeclaration(receiver) {
    const c = receiver;
 ...
 * }
 */
export function Checker_checkAndReportErrorForInvalidInitializer(receiver, errorLocation, name, propertyWithInvalidInitializer, result) {
    const c = receiver;
    if (!CompilerOptions_GetEmitStandardClassFields(c.compilerOptions)) {
        ...
        const message = IfElse(errorLocation !== undefined && prop.Type !== undefined && TextRange_ContainsInclusive(prop.Type.Loc, Node_Pos(errorLocation)), Type_of_instance_member_variable_0_cannot_reference_identifier_1_declared_in_the_constructor, Initializer_of_instance_member_variable_0_cannot_reference_identifier_1_declared_in_the_constructor);
 ...
 * }
 */
export function Checker_checkAndReportErrorForMissingPrefix(receiver, errorLocation, name) {
    const c = receiver;
    ...
    const container = Checker_getThisContainer(receiver, errorLocation, false, false);
 ...
 * }
 */
export function Checker_checkAndReportErrorForUsingTypeAsNamespace(receiver, errorLocation, name, meaning) {
    const c = receiver;
    if (meaning === SymbolFlagsNamespace) {
        const symbol = Checker_resolveSymbol(receiver, c.resolveName(errorLocation, name, (SymbolFlagsType & ~SymbolFlagsNamespace), undefined, false, false));
        if (symbol !== undefined) {
 ...
 * }
 */
export function Checker_checkAndReportErrorForExportingPrimitiveType(receiver, errorLocation, name) {
    const c = receiver;
 ...
 * }
 */
export function Checker_checkAndReportErrorForUsingNamespaceAsTypeOrValue(receiver, errorLocation, name, meaning) {
    const c = receiver;
    if ((meaning & (SymbolFlagsValue & ~SymbolFlagsType)) !== 0) {
        const symbol = Checker_resolveSymbol(receiver, c.resolveName(errorLocation, name, SymbolFlagsNamespaceModule, undefined, false, false));
        if (symbol !== undefined) {
            Checker_error(receiver, errorLocation, Cannot_use_namespace_0_as_a_value, name);
            return true;
        }
    }
    else if ((meaning & (SymbolFlagsType & ~SymbolFlagsValue)) !== 0) {
        const symbol = Checker_resolveSymbol(receiver, c.resolveName(errorLocation, name, SymbolFlagsModule, undefined, false, false));
        if (symbol !== undefined) {
 ...
 * }
 */
export function Checker_checkAndReportErrorForUsingTypeAsValue(receiver, errorLocation, name, meaning) {
    const c = receiver;
    if ((meaning & SymbolFlagsValue) !== 0) {
        ...
        const symbol = Checker_resolveSymbol(receiver, c.resolveName(errorLocation, name, (SymbolFlagsType & ~SymbolFlagsValue), undefined, false, false));
        if (symbol !== undefined) {
 ...
 * }
 */
export function Checker_checkAndReportErrorForUsingValueAsType(receiver, errorLocation, name, meaning) {
    const c = receiver;
    if ((meaning & (SymbolFlagsType & ~SymbolFlagsNamespace)) !== 0) {
        const symbol = Checker_resolveSymbol(receiver, c.resolveName(errorLocation, name, (~SymbolFlagsType & SymbolFlagsValue), undefined, false, false));
 ...
 * }
 */
export function Checker_addTypeOnlyDeclarationRelatedInfo(receiver, diagnostic, typeOnlyDeclaration, name) {
 ...
 * }
 */
export function Checker_checkSourceElementUnreachable(receiver, node) {
    const c = receiver;
    ...
    const start = GetTokenPosOfNode(startNode, sourceFile, false);
 ...
 * }
 */
export function Checker_isSourceElementUnreachable(receiver, node) {
    const c = receiver;
 ...
 * }
 */
export function Checker_getDeprecatedSuggestionNode(receiver, node) {
    ...
    switch (node.Kind) {
        ...
        case KindTaggedTemplateExpression:
            return Checker_getDeprecatedSuggestionNode(receiver, AsTaggedTemplateExpression(node).Tag);
        case KindJsxOpeningElement:
        case KindJsxSelfClosingElement:
            return Checker_getDeprecatedSuggestionNode(receiver, Node_TagName(node));
        case KindElementAccessExpression:
            return AsElementAccessExpression(node).ArgumentExpression;
        case KindPropertyAccessExpression:
            return Node_Name(node);
        case KindTypeReference: {
            const typeName = AsTypeReferenceNode(node).TypeName;
            if (IsQualifiedName(typeName)) {
                return AsQualifiedName(typeName).Right;
            }
            break;
        }
    }
 ...
 * }
 */
export function Checker_reportDuplicateMemberErrors(receiver, node, name, checkStatic, isStatic, message) {
 ...
 * }
 */
export function Checker_issueMemberSpecificError(receiver, node, typeWithThis, baseWithThis, broadDiag) {
    const c = receiver;
 ...
 * }
 */
export function Checker_reportTypeNotIterableError(receiver, errorNode, t, allowAsyncIterables) {
    const c = receiver;
    const message = allowAsyncIterables
        ? Type_0_must_have_a_Symbol_asyncIterator_method_that_returns_an_async_iterator
        : Type_0_must_have_a_Symbol_iterator_method_that_returns_an_iterator;
    const suggestAwait = Checker_getAwaitedTypeOfPromise(receiver, t) !== undefined || (!allowAsyncIterables &&
 ...
 * }
 */
export function Checker_getIterationDiagnosticDetails(receiver, use, inputType, allowsStrings) {
 ...
 * }
 */
export function Checker_unusedIsError(receiver, kind) {
    const c = receiver;
    switch (kind) {
        case UnusedKindLocal:
 ...
 * }
 */
export function Checker_checkNonNullTypeWithReporter(receiver, t, node, reportError) {
    const c = receiver;
    if (c.strictNullChecks && (t.flags & TypeFlagsUnknown) !== 0) {
 ...
 * }
 */
export function Checker_reportObjectPossiblyNullOrUndefinedError(receiver, node, facts) {
    let nodeText = "";
    if (IsEntityNameExpression(node)) {
        nodeText = entityNameToString(node);
    }
    ...
    if (nodeText !== "" && nodeText.length < 100) {
        ...
        Checker_error(receiver, node, IfElse((facts & TypeFactsIsUndefined) !== 0, IfElse((facts & TypeFactsIsNull) !== 0, X_0_is_possibly_null_or_undefined, X_0_is_possibly_undefined), X_0_is_possibly_null), nodeText);
    }
    else {
        Checker_error(receiver, node, IfElse((facts & TypeFactsIsUndefined) !== 0, IfElse((facts & TypeFactsIsNull) !== 0, Object_is_possibly_null_or_undefined, Object_is_possibly_undefined), Object_is_possibly_null));
    }
}
/**
 ...
 * }
 */
export function Checker_checkDeprecatedSignature(receiver, sig, node) {
    if ((sig.flags & SignatureFlagsIsSignatureCandidateForOverloadFailure) !== 0) {
        return;
    }
 ...
 * }
 */
export function Checker_addDeprecatedSuggestionWithSignature(receiver, location, declaration, deprecatedEntity, signatureString) {
 ...
 * }
 */
export function Checker_getDiagnosticHeadMessageForDecoratorResolution(receiver, node) {
    switch (node.Parent.Kind) {
 ...
 * }
 */
export function Checker_reportCallResolutionErrors(receiver, node, s, signatures, headMessage) {
    const c = receiver;
    if (s.candidatesForArgumentError.length !== 0) {
        const last = s.candidatesForArgumentError[s.candidatesForArgumentError.length - 1];
        const diags = [];
        Checker_isSignatureApplicable(receiver, s.node, s.args, last, c.assignableRelation, CheckModeNormal, true, diags);
        ...
        Checker_checkTypeArguments(receiver, s.candidateForTypeArgumentError, Node_TypeArguments(s.node) ?? [], true, headMessage);
    }
    else if (!IsJsxOpeningFragment(node)) {
        const signaturesWithCorrectTypeArgumentArity = Filter(signatures, (sig) => Checker_hasCorrectTypeArgumentArity(receiver, sig, s.typeArguments));
 ...
 * }
 */
export function Checker_getArgumentArityError(receiver, node, signatures, args, headMessage) {
    ...
    let closestSignature = undefined;
    ...
    const hasRestParameter = Some(signatures, (sig) => Checker_hasEffectiveRestParameter(receiver, sig));
    let parameterRange;
    if (hasRestParameter) {
    ...
    if (minCount < args.length && args.length < maxCount) {
        // between min and max, but with no matching overload
        let diagnostic = NewDiagnosticForNode(errorNode, No_overload_expects_0_arguments_but_overloads_do_exist_that_expect_either_1_or_2_arguments, args.length, maxBelow, minAbove);
        if (headMessage !== undefined) {
            diagnostic = NewDiagnosticChain(diagnostic, headMessage);
        }
        return diagnostic;
        ...
        // too short: put the error span on the call expression, not any of the args
        let diagnostic = NewDiagnosticForNode(errorNode, message, parameterRange, args.length);
        if (headMessage !== undefined) {
            diagnostic = NewDiagnosticChain(diagnostic, headMessage);
        }
        let parameter = undefined;
        if (closestSignature !== undefined && closestSignature.declaration !== undefined) {
            parameter = ElementOrNil(Node_Parameters(closestSignature.declaration), args.length + IfElse(closestSignature.thisParameter !== undefined, 1, 0));
        }
        ...
        let diagnostic = NewDiagnostic(sourceFile, NewTextRange(pos, end), message, parameterRange, args.length);
        if (headMessage !== undefined) {
            diagnostic = NewDiagnosticChain(diagnostic, headMessage);
        }
        return diagnostic;
 ...
 * }
 */
export function Checker_isPromiseResolveArityError(receiver, node) {
    const c = receiver;
    if (!IsCallExpression(node) || !IsIdentifier(Node_Expression(node))) {
        return false;
    }
    const symbol = c.resolveName(Node_Expression(node), Node_Text(Node_Expression(node)), SymbolFlagsValue, undefined, false, false);
    if (symbol === undefined) {
        return false;
    }
 ...
 * }
 */
export function Checker_getTypeArgumentArityError(receiver, node, signatures, typeArguments, headMessage) {
 ...
 * }
 */
export function Checker_reportCannotInvokePossiblyNullOrUndefinedError(receiver, node, facts) {
    Checker_error(receiver, node, IfElse((facts & TypeFactsIsUndefined) !== 0, IfElse((facts & TypeFactsIsNull) !== 0, Cannot_invoke_an_object_which_is_possibly_null_or_undefined, Cannot_invoke_an_object_which_is_possibly_undefined), Cannot_invoke_an_object_which_is_possibly_null));
}
/**
 ...
 * }
 */
export function Checker_resolveErrorCall(receiver, node) {
    const c = receiver;
 ...
 * }
 */
export function Checker_invocationErrorDetails(receiver, errorTarget, apparentType, kind) {
    let diagnostic = undefined;
    ...
    if ((apparentType.flags & TypeFlagsUnion) !== 0) {
        ...
        for (const constituent of types) {
            ...
            if (signatures.length !== 0) {
                ...
                if (diagnostic === undefined) {
                    diagnostic = NewDiagnosticForNode(target, IfElse(isCall, Type_0_has_no_call_signatures, Type_0_has_no_construct_signatures), Checker_TypeToString(receiver, constituent));
                    diagnostic = NewDiagnosticChainForNode(diagnostic, target, IfElse(isCall, Not_all_constituents_of_type_0_are_callable, Not_all_constituents_of_type_0_are_constructable), Checker_TypeToString(receiver, apparentType));
                }
                if (hasSignatures) {
                    break;
                }
        ...
        if (!hasSignatures) {
            diagnostic = NewDiagnosticForNode(target, IfElse(isCall, No_constituent_of_type_0_is_callable, No_constituent_of_type_0_is_constructable), Checker_TypeToString(receiver, apparentType));
        }
        if (diagnostic === undefined) {
            diagnostic = NewDiagnosticForNode(target, IfElse(isCall, Each_member_of_the_union_type_0_has_signatures_but_none_of_those_signatures_are_compatible_with_each_other, Each_member_of_the_union_type_0_has_construct_signatures_but_none_of_those_signatures_are_compatible_with_each_other), Checker_TypeToString(receiver, apparentType));
        }
    }
    else {
        diagnostic = NewDiagnosticChainForNode(diagnostic, target, IfElse(isCall, Type_0_has_no_call_signatures, Type_0_has_no_construct_signatures), Checker_TypeToString(receiver, apparentType));
    }
 ...
 * }
 */
export function Checker_invocationError(receiver, errorTarget, apparentType, kind, relatedInformation) {
 ...
 * }
 */
export function Checker_invocationErrorRecovery(receiver, apparentType, kind, diagnostic) {
    if (apparentType.symbol === undefined) {
        return;
    }
    const links = LinkStore_Get(receiver.exportTypeLinks, apparentType.symbol);
    ...
    if (importNode !== undefined && !IsImportCall(importNode)) {
        ...
        Diagnostic_AddRelatedInfo(diagnostic, NewDiagnosticForNode(importNode, Type_originates_at_this_import_A_namespace_style_import_cannot_be_called_or_constructed_and_will_cause_a_failure_at_runtime_Consider_using_a_default_import_or_import_require_here_instead));
    }
}
/**
 ...
 * }
 */
export function Checker_checkAndReportErrorForExtendingInterface(receiver, errorLocation) {
 ...
 * }
 */
export function Checker_reportOperatorError(receiver, leftType, operator, rightType, errorNode, isRelated) {
 ...
 * }
 */
export function Checker_reportOperatorErrorUnless(receiver, leftType, operator, rightType, errorNode, typesAreCompatible) {
    if (!typesAreCompatible(leftType, rightType)) {
 ...
 * }
 */
export function Checker_getCannotFindNameDiagnosticForName(receiver, node) {
    const c = receiver;
    switch (Node_Text(node)) {
        ...
        case "$":
            return IfElse(CompilerOptions_UsesWildcardTypes(c.compilerOptions), Cannot_find_name_0_Do_you_need_to_install_type_definitions_for_jQuery_Try_npm_i_save_dev_types_Slashjquery, Cannot_find_name_0_Do_you_need_to_install_type_definitions_for_jQuery_Try_npm_i_save_dev_types_Slashjquery_and_then_add_jquery_to_the_types_field_in_your_tsconfig);
        case "beforeEach":
        case "describe":
        case "suite":
        case "it":
 ...
 * }
 */
export function Checker_GetDiagnostics(receiver, ctx, sourceFile) {
 ...
 * }
 */
export function Checker_GetSuggestionDiagnostics(receiver, ctx, sourceFile) {
 ...
 * }
 */
export function Checker_getDiagnostics(receiver, ctx, sourceFile, collection) {
    const c = receiver;
    ...
    const checkUnused = (Tristate_IsTrue(c.compilerOptions.NoUnusedLocals) ||
        ...
        collection === c.suggestionDiagnostics);
 ...
 * }
 */
export function Checker_GetGlobalDiagnostics(receiver) {
    Checker_checkNotCanceled(receiver);
 ...
 * }
 */
export function Checker_addDeferredDiagnostic(receiver, callback) {
    const c = receiver;
    if (c.saveDeferredDiagnostics) {
 ...
 * }
 */
export function Checker_produceDeferredDiagnostics(receiver) {
    const c = receiver;
 ...
 * }
 */
export function Checker_addErrorOrSuggestion(receiver, isError, diagnostic) {
    if (isError) {
        Checker_addDiagnostic(receiver, diagnostic);
    }
    else {
 ...
 * }
 */
export function Checker_IsDeprecatedDeclaration(receiver, declaration) {
 ...
 * }
 */
export function Checker_addDeprecatedSuggestion(receiver, location, declarations, deprecatedEntity) {
 ...
 * }
 */
export function Checker_addDeprecatedSuggestionWorker(receiver, declarations, diagnostic) {
 ...
 * }
 */
export function Checker_isDeprecatedSymbol(receiver, symbol_) {
    ...
    return ((symbol_.ValueDeclaration !== undefined && Checker_IsDeprecatedDeclaration(receiver, symbol_.ValueDeclaration)) ||
        (declarations.length !== 0 && Every(declarations, (declaration) => Checker_IsDeprecatedDeclaration(receiver, declaration))));
}
/**
 ...
 * }
 */
export function Checker_hasParseDiagnostics(receiver, sourceFile) {
    return (SourceFile_Diagnostics(sourceFile).length > 0);
}
/**
 ...
 * }
 */
export function Checker_reportMergeSymbolError(receiver, target, source) {
    const c = receiver;
    const isEitherEnum = ((target.Flags & SymbolFlagsEnum) !== 0 || (source.Flags & SymbolFlagsEnum) !== 0);
    const isEitherBlockScoped = ((target.Flags & SymbolFlagsBlockScopedVariable) !== 0 || (source.Flags & SymbolFlagsBlockScopedVariable) !== 0);
    let message;
    if (isEitherEnum) {
 ...
 * }
 */
export function Checker_addDuplicateDeclarationErrorsForSymbols(receiver, target, message, symbolName, source) {
 ...
 * }
 */
export function Checker_addDuplicateDeclarationError(receiver, node, message, symbolName, relatedNodes) {
    ...
    for (const relatedNode of relatedNodes) {
        ...
        if (Diagnostic_RelatedInformation(err).length >= 5 ||
            Some(Diagnostic_RelatedInformation(err), (d) => CompareDiagnostics(d, followOnMessage) === 0 || CompareDiagnostics(d, leadingMessage) === 0)) {
            continue;
        }
 ...
 * }
 */
export function Checker_lookupOrIssueError(receiver, location, message, ...args) {
 ...
 * }
 */
export function Checker_checkAndReportErrorForResolvingImportAliasToTypeOnlySymbol(receiver, node, resolved) {
    ...
    for (;;) {
        ...
        if (typeOnlyDeclaration !== undefined) {
            ...
            const message = IfElse(isExport, An_import_alias_cannot_reference_a_declaration_that_was_exported_using_export_type, An_import_alias_cannot_reference_a_declaration_that_was_imported_using_import_type);
            const relatedMessage = IfElse(isExport, X_0_was_exported_here, X_0_was_imported_here);
            let declarationName = "*";
            if (!IsExportDeclaration(typeOnlyDeclaration)) {
                declarationName = Node_Text(Node_Name(typeOnlyDeclaration));
            }
            Diagnostic_AddRelatedInfo(Checker_error(receiver, decl.ModuleReference, message), createDiagnosticForNode(typeOnlyDeclaration, relatedMessage, declarationName));
            break;
        }
 ...
 * }
 */
export function Checker_getCannotResolveModuleNameErrorForSpecificModule(receiver, moduleName) {
 ...
 * }
 */
export function Checker_reportCircularityError(receiver, symbol_) {
 ...
 * }
 */
export function Checker_reportErrorsFromWidening(receiver, declaration, t, wideningKind) {
 ...
 * }
 */
export function Checker_shouldReportErrorsFromWideningWithContextualSignature(receiver, declaration, wideningKind) {
 ...
 * }
 */
export function Checker_reportWideningErrorsInType(receiver, t) {
    let errorReported = false;
    if ((t.objectFlags & ObjectFlagsContainsWideningType) !== 0) {
        if ((t.flags & TypeFlagsUnion) !== 0) {
            if (Some(Type_Types(t), (tt) => Checker_isEmptyObjectType(receiver, tt))) {
                errorReported = true;
            }
            else {
            ...
            for (const p of Checker_getPropertiesOfObjectType(receiver, t)) {
                ...
                if ((s.objectFlags & ObjectFlagsContainsWideningType) !== 0) {
                    ...
                    if (!errorReported) {
                        const valueDeclaration = Find(p.Declarations ?? [], (d) => {
 ...
 * }
 */
export function Checker_isErrorType(receiver, t) {
    return (t === receiver.errorType || ((t.flags & TypeFlagsAny) !== 0 && t.alias !== undefined));
}
