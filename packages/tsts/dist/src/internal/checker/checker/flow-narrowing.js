...
import { KindArrowFunction, KindArrayLiteralExpression, KindBarBarToken, KindBigIntLiteral, KindCallSignature, KindClassExpression, KindConditionalExpression, KindConstructor, KindFalseKeyword, KindFunctionDeclaration, KindFunctionExpression, KindFunctionType, KindGetAccessor, KindIdentifier, KindJSDoc, KindJsxElement, KindJsxExpression, KindJsxSelfClosingElement, KindMethodDeclaration, KindMethodSignature, KindNoSubstitutionTemplateLiteral, KindNullKeyword, KindNumericLiteral, KindObjectLiteralExpression, KindParenthesizedExpression, KindPropertyAccessExpression, KindQuestionQuestionToken, KindRegularExpressionLiteral, KindSetAccessor, KindStringLiteral, KindTemplateExpression, KindThisKeyword, KindTrueKeyword, KindUndefinedKeyword, KindVoidExpression, } from "../../ast/generated/kinds.js";
...
import { TypeFlagsAnyOrUnknown, TypeFlagsBigInt, TypeFlagsBigIntLiteral, TypeFlagsEnumLiteral, TypeFlagsNever, TypeFlagsNull, TypeFlagsNumber, TypeFlagsNumberLiteral, TypeFlagsString, TypeFlagsStringLiteral, TypeFlagsTypeParameter, TypeFlagsTypeVariable, TypeFlagsUnion, TypeFlagsUndefined, TypeFlagsVoid, Type_AsLiteralType, Type_AsSubstitutionType, TypePredicateKindAssertsThis, TypePredicateKindThis, SignatureKindCall, NodeCheckFlagsInCheckIdentifier, } from "../types.js";
...
import { Checker_getBaseConstraintOrType, Checker_getInferenceContext, Checker_getImpliedConstraint, Checker_getSubstitutionType, Checker_isConstraintPosition, Checker_isGenericTypeWithUnionConstraint, Checker_isNoInferType, } from "./inference.js";
...
import { Checker_filterType, Checker_getActualTypeVariable, Checker_getAwaitedTypeOfPromise, Checker_getBaseTypeOfLiteralType, Checker_getBindingElementTypeFromParentType, Checker_getHomomorphicTypeVariable, Checker_getIntersectionType, Checker_getNumberLiteralType, Checker_getOptionalType, Checker_getReducedApparentType, Checker_getTypeForBindingElementParent, Checker_getTypeFromTypeNode, Checker_getUnionType, Checker_hasContextualTypeWithNoGenericTypes, Checker_hasTypeFacts, Checker_containsUndefinedType, Checker_isArrayOrTupleType, Checker_isContextSensitiveFunctionOrObjectLiteralMethod, Checker_instantiateType, Checker_mapType, Checker_removeMissingType, } from "./types.js";
import { CheckModeInferential, CheckModeNormal, PredicateSemanticsAlways, PredicateSemanticsNever, PredicateSemanticsSometimes, TypeFactsTruthy, everyType, getNumberLiteralValue, getStringLiteralValue, isZeroBigInt, isTupleType, signatureHasRestParameter, someType, } from "./state.js";
...
import { A_type_predicate_cannot_reference_element_0_in_a_binding_pattern, A_type_predicate_cannot_reference_a_rest_parameter, A_type_predicate_is_only_allowed_in_return_type_position_for_functions_and_methods, A_type_predicate_s_type_must_be_assignable_to_its_parameter_s_type, An_expression_of_type_void_cannot_be_tested_for_truthiness, Cannot_find_parameter_0, This_condition_will_always_return_0, This_condition_will_always_return_true_since_this_0_is_always_defined, This_condition_will_always_return_true_since_this_function_is_always_defined_Did_you_mean_to_call_it_instead, Property_0_is_used_before_being_assigned, This_kind_of_expression_is_always_falsy, This_kind_of_expression_is_always_truthy, } from "../../diagnostics/generated/messages.js";
 ...
 * }
 */
export function Checker_checkTypePredicate(receiver, node) {
 ...
 * }
 */
export function Checker_getTypePredicateParent(receiver, node) {
 ...
 * }
 */
export function Checker_checkIfTypePredicateVariableIsDeclaredInBindingPattern(receiver, pattern, predicateVariableNode, predicateVariableName) {
 ...
 * }
 */
export function Checker_checkTestingKnownTruthyCallableOrAwaitableOrEnumMemberType(receiver, condExpr, condType, body) {
 ...
 * }
 */
export function Checker_checkTestingKnownTruthyTypes(receiver, condExpr, condType, body) {
 ...
 * }
 */
export function Checker_checkTestingKnownTruthyType(receiver, condExpr, condType, body) {
    ...
    const isUsed = (testedSymbol !== undefined && IsBinaryExpression(condExpr.Parent) &&
 ...
 * }
 */
export function Checker_checkTruthinessExpression(receiver, node, checkMode) {
 ...
 * }
 */
export function Checker_getFlowTypeOfAccessExpression(receiver, node, prop, propType, errorNode, checkMode) {
    ...
    if (receiver.strictNullChecks && prop !== undefined) {
        ...
        if (declaration !== undefined) {
            if (receiver.strictPropertyInitialization &&
 ...
 * }
 */
export function Checker_getControlFlowContainer(receiver, node) {
    return FindAncestor(node.Parent, (n) => (IsFunctionLike(n) && GetImmediatelyInvokedFunctionExpression(n) === undefined) ||
        IsModuleBlock(n) ||
        IsSourceFile(n) ||
 ...
 * }
 */
export function Checker_getFlowTypeOfProperty(receiver, reference, prop) {
 ...
 * }
 */
export function Checker_checkTruthinessOfType(receiver, t, node) {
    if ((t.flags & TypeFlagsVoid) !== 0) {
 ...
 * }
 */
export function Checker_getSyntacticTruthySemantics(receiver, node) {
    ...
    switch (node.Kind) {
        ...
        case KindConditionalExpression:
            return (Checker_getSyntacticTruthySemantics(receiver, AsConditionalExpression(node).WhenTrue) |
                Checker_getSyntacticTruthySemantics(receiver, AsConditionalExpression(node).WhenFalse));
        case KindIdentifier:
 ...
 * }
 */
export function Checker_getNarrowedTypeOfSymbol(receiver, symbol_, location) {
    ...
    if (declaration !== undefined) {
        if (IsBindingElement(declaration) &&
            ...
            if ((Node_Parameters(fn) ?? []).length >= 2 &&
                ...
                if (contextualSignature !== undefined && contextualSignature.parameters.length === 1 && signatureHasRestParameter(contextualSignature)) {
                    ...
                    if ((restType.flags & TypeFlagsUnion) !== 0 &&
 ...
 * }
 */
export function Checker_getFlowTypeOfDestructuring(receiver, node, declaredType) {
 ...
 * }
 */
export function Checker_getTypePredicateFromBody(receiver, fn) {
    switch (fn.Kind) {
 ...
 * }
 */
export function Checker_isDiscriminantWithNeverType(receiver, prop) {
 ...
 * }
 */
export function Checker_getConditionalFlowTypeOfType(receiver, t, node) {
    const constraints = [];
    let covariant = true;
    while (node !== undefined && !IsStatement(node) && node.Kind !== KindJSDoc) {
        ...
        if ((covariant || (t.flags & TypeFlagsTypeVariable) !== 0) &&
 ...
 * }
 */
export function Checker_removeDefinitelyFalsyTypes(receiver, t) {
 ...
 * }
 */
export function Checker_extractDefinitelyFalsyTypes(receiver, t) {
 ...
 * }
 */
export function Checker_getDefinitelyFalsyPartOfType(receiver, t) {
    ...
    else if (t === receiver.regularFalseType ||
 ...
 * }
 */
export function Checker_isPossiblyDiscriminantValue(receiver, node) {
    switch (node.Kind) {
        case KindStringLiteral:
        case KindNumericLiteral:
        case KindBigIntLiteral:
 ...
 * }
 */
export function Checker_getNarrowableTypeForReference(receiver, t, reference, checkMode) {
    ...
    // parameter type 'T extends string | undefined' with a contextual type 'string', we substitute
    // 'string | undefined' to give control flow analysis the opportunity to narrow to type 'string'.
    const substituteConstraints = (checkMode & CheckModeInferential) === 0 &&
...
//# sourceMappingURL=flow-narrowing.js.map