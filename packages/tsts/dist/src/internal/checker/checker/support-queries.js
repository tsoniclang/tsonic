...
import { KindAmpersandAmpersandToken, KindAmpersandEqualsToken, KindAmpersandToken, KindArrowFunction, KindArrayLiteralExpression, KindBarBarToken, KindBarEqualsToken, KindBarToken, KindBigIntLiteral, KindBinaryExpression, KindCallSignature, KindCaretEqualsToken, KindCaretToken, KindClassExpression, KindClassStaticBlockDeclaration, KindComputedPropertyName, KindConditionalExpression, KindConstructSignature, KindConstructor, KindDecorator, KindEnumDeclaration, KindEqualsToken, KindExclamationEqualsEqualsToken, KindExclamationToken, KindFalseKeyword, KindFunctionDeclaration, KindFunctionExpression, KindGetAccessor, KindIdentifier, KindIndexSignature, KindJsxAttribute, KindJsxAttributes, KindJsxElement, KindJsxExpression, KindJsxSelfClosingElement, KindMethodDeclaration, KindMethodSignature, KindMinusToken, KindModuleDeclaration, KindNoSubstitutionTemplateLiteral, KindNonNullExpression, KindNullKeyword, KindNumericLiteral, KindObjectLiteralExpression, KindParameter, KindPlusToken, KindParenthesizedExpression, KindPrefixUnaryExpression, KindPropertyAssignment, KindPropertyDeclaration, KindPropertySignature, KindQuestionQuestionToken, KindSetAccessor, KindSpreadElement, KindShorthandPropertyAssignment, KindSourceFile, KindRegularExpressionLiteral, KindStringLiteral, KindTaggedTemplateExpression, KindTemplateExpression, KindTildeToken, KindTrueKeyword, KindTypeOfExpression, KindUndefinedKeyword, KindUnknown, KindVariableDeclaration, KindYieldExpression, } from "../../ast/generated/kinds.js";
 ...
 * }
 */
export function Checker_isIteratorResult(receiver, t, kind) {
    // From https://tc39.github.io/ecma262/#sec-iteratorresult-interface:
    // > [done] is the result status of an iterator `next` method call. If the end of the iterator was reached `done` is `true`.
    // > If the end was not reached `done` is `false` and a value is available.
    // > If a `done` property (either own or inherited) does not exist, it is consider to have the value `false`.
 ...
 * }
 */
export function Checker_isReferenced(receiver, symbol_) {
    return (LinkStore_Get(receiver.symbolReferenceLinks, symbol_).referenceKinds ?? SymbolFlagsNone) !== 0;
}
/**
 ...
 * }
 */
export function Checker_addImplementationSuccessElaboration(receiver, s, failed, diagnostic) {
    if (failed.declaration !== undefined && Node_Symbol(failed.declaration) !== undefined) {
        ...
        if (declarations.length > 1) {
            const implementation = declarations.find((declaration) => IsFunctionLikeDeclaration(declaration) && NodeIsPresent(Node_Body(declaration)));
            if (implementation !== undefined) {
                ...
                if (Checker_chooseOverload(receiver, localState, receiver.assignableRelation) !== undefined) {
                    Diagnostic_AddRelatedInfo(diagnostic, NewDiagnosticForNode(implementation, The_call_would_have_succeeded_against_this_implementation_but_implementation_signatures_of_overloads_are_not_externally_visible));
                }
            }
        }
    }
 ...
 * }
 */
export function Checker_getThisContainer(receiver, node, includeArrowFunctions, includeClassComputedPropertyName) {
    for (;;) {
        node = node.Parent;
        if (node === undefined) {
 ...
 * }
 */
export function Checker_getSuggestedBooleanOperator(receiver, operator) {
    switch (operator) {
        case KindBarToken:
 ...
 * }
 */
export function Checker_isSideEffectFree(receiver, node) {
    ...
    switch (node.Kind) {
        ...
        case KindConditionalExpression:
            return (Checker_isSideEffectFree(receiver, AsConditionalExpression(node).WhenTrue) &&
        ...
        case KindBinaryExpression:
            ...
            return (Checker_isSideEffectFree(receiver, AsBinaryExpression(node).Left) &&
 ...
 * }
 */
export function Checker_getExactOptionalUnassignableProperties(receiver, source, target) {
    if (isTupleType(source) && isTupleType(target)) {
        return [];
    }
    return Filter(Checker_getPropertiesOfType(receiver, target), (targetProp) => Checker_isExactOptionalPropertyMismatch(receiver, Checker_getTypeOfPropertyOfType(receiver, source, targetProp.Name), Checker_getTypeOfSymbol(receiver, targetProp)));
}
/**
 ...
 * }
 */
export function Checker_hasDefaultValue(receiver, node) {
    return ((IsBindingElement(node) && Node_Initializer(node) !== undefined) ||
 ...
 * }
 */
export function Checker_isConstContext(receiver, node) {
 ...
 * }
 */
export function Checker_createModeMismatchDetails(receiver, sourceFile, errorNode) {
 ...
 * }
 */
export function Checker_isCommonJSRequire(receiver, node) {
 ...
 * }
 */
export function keyBuilder_hash(receiver) {
 ...
 * }
 */
export function Checker_getPropertiesOfContext(receiver, context) {
 ...
 * }
 */
export function Checker_getSiblingsOfContext(receiver, context) {
 ...
 * }
 */
export function Checker_addOptionality(receiver, t) {
 ...
 * }
 */
export function Checker_addOptionalityEx(receiver, t, isProperty, isOptional) {
 ...
 * }
 */
export function Checker_isVarConstLike(receiver, node) {
    const blockScopeKind = (Checker_getCombinedNodeFlagsCached(receiver, node) & NodeFlagsBlockScoped);
 ...
 * }
 */
export function Checker_getCombinedModifierFlagsCached(receiver, node) {
 ...
 * }
 */
export function Checker_getTailRecursionRoot(receiver, newType, newMapper) {
    if ((newType.flags & TypeFlagsConditional) !== 0 && newMapper !== undefined) {
        ...
        if (newRoot.outerTypeParameters.length !== 0) {
            ...
            const typeArguments = core_Map(newRoot.outerTypeParameters, (t) => TypeMapper_Map(typeParamMapper, t));
            const newRootMapper = newTypeMapper(newRoot.outerTypeParameters, typeArguments);
            const newCheckType = newRoot.isDistributive ? TypeMapper_Map(newRootMapper, newRoot.checkType) : undefined;
 ...
 * }
 */
export function Checker_markLinkedReferences(receiver, location, hint, propSymbol, parentType) {
    ...
    switch (hint) {
        case ReferenceHintIdentifier:
            Checker_markIdentifierAliasReferenced(receiver, location);
            return;
        case ReferenceHintProperty:
        ...
        case ReferenceHintExportImportEquals:
            ...
            return;
        case ReferenceHintExportSpecifier:
            Checker_markExportSpecifierAliasReferenced(receiver, location);
            return;
        case ReferenceHintDecorator:
        ...
        case ReferenceHintUnspecified:
            if (IsIdentifier(location) &&
                ...
                if (IsPropertyAccessOrQualifiedName(location.Parent)) {
                    const left = IsPropertyAccessExpression(location.Parent) ? Node_Expression(location.Parent) : AsQualifiedName(location.Parent).Left;
                    if (left !== location) {
                        return;
                    }
                }
 ...
 * }
 */
export function Checker_getSpreadIndices(receiver, node) {
    const links = LinkStore_Get(receiver.arrayLiteralLinks, node);
    if (!links.indicesComputed) {
        let first = -1;
        let last = -1;
...
export function Checker_isContextSensitive(receiver, node) {
    switch (node.Kind) {
        ...
        case KindConditionalExpression:
            return (Checker_isContextSensitive(receiver, AsConditionalExpression(node).WhenTrue) ||
                Checker_isContextSensitive(receiver, AsConditionalExpression(node).WhenFalse));
        case KindBinaryExpression: {
            const binary = AsBinaryExpression(node);
            return (NodeKindIs(binary.OperatorToken, KindBarBarToken, KindQuestionQuestionToken) &&
...
//# sourceMappingURL=support-queries.js.map