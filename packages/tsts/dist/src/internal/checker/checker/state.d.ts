...
import type { AccessFlags, ElementFlags, IndexInfo, Signature, SourceFileLinks, Ternary, TupleElementInfo, TupleType, Type, TypeAlias, TypeAliasLinks, TypeComparer, TypeFlags, TypeId, TypeNodeLinks, TypePredicate, ValueSymbolLinks, VarianceFlags } from "../types.js";
 ...
 * )
 */
export declare const CheckModeNormal: CheckMode;
export declare const CheckModeContextual: CheckMode;
export declare const CheckModeInferential: CheckMode;
export declare const CheckModeSkipContextSensitive: CheckMode;
export declare const CheckModeSkipGenericFunctions: CheckMode;
export declare const CheckModeIsForSignatureHelp: CheckMode;
export declare const CheckModeRestBindingElement: CheckMode;
export declare const CheckModeTypeOnly: CheckMode;
export declare const CheckModeForceTuple: CheckMode;
/**
 ...
 * )
 */
export declare const TypeSystemPropertyNameType: TypeSystemPropertyName;
export declare const TypeSystemPropertyNameResolvedBaseConstructorType: TypeSystemPropertyName;
export declare const TypeSystemPropertyNameDeclaredType: TypeSystemPropertyName;
export declare const TypeSystemPropertyNameResolvedReturnType: TypeSystemPropertyName;
export declare const TypeSystemPropertyNameResolvedBaseConstraint: TypeSystemPropertyName;
export declare const TypeSystemPropertyNameResolvedTypeArguments: TypeSystemPropertyName;
export declare const TypeSystemPropertyNameResolvedBaseTypes: TypeSystemPropertyName;
export declare const TypeSystemPropertyNameWriteType: TypeSystemPropertyName;
export declare const TypeSystemPropertyNameInitializerIsUndefined: TypeSystemPropertyName;
export declare const TypeSystemPropertyNameAliasTarget: TypeSystemPropertyName;
/**
 ...
 * )
 */
export declare const WideningKindNormal: WideningKind;
export declare const WideningKindFunctionReturn: WideningKind;
export declare const WideningKindGeneratorNext: WideningKind;
export declare const WideningKindGeneratorYield: WideningKind;
/**
 ...
 * )
 */
export declare const CachedTypeKindLiteralUnionBaseType: CachedTypeKind;
export declare const CachedTypeKindIndexType: CachedTypeKind;
export declare const CachedTypeKindStringIndexType: CachedTypeKind;
export declare const CachedTypeKindEquivalentBaseType: CachedTypeKind;
export declare const CachedTypeKindApparentType: CachedTypeKind;
export declare const CachedTypeKindAwaitedType: CachedTypeKind;
export declare const CachedTypeKindEvolvingArrayType: CachedTypeKind;
export declare const CachedTypeKindArrayLiteralType: CachedTypeKind;
export declare const CachedTypeKindPermissiveInstantiation: CachedTypeKind;
export declare const CachedTypeKindRestrictiveInstantiation: CachedTypeKind;
export declare const CachedTypeKindRestrictiveTypeParameter: CachedTypeKind;
export declare const CachedTypeKindIndexedAccessForReading: CachedTypeKind;
export declare const CachedTypeKindIndexedAccessForWriting: CachedTypeKind;
export declare const CachedTypeKindWidened: CachedTypeKind;
export declare const CachedTypeKindRegularObjectLiteral: CachedTypeKind;
export declare const CachedTypeKindPromisedTypeOfPromise: CachedTypeKind;
export declare const CachedTypeKindDefaultOnlyType: CachedTypeKind;
export declare const CachedTypeKindSyntheticType: CachedTypeKind;
export declare const CachedTypeKindDecoratorContext: CachedTypeKind;
export declare const CachedTypeKindDecoratorContextStatic: CachedTypeKind;
export declare const CachedTypeKindDecoratorContextPrivate: CachedTypeKind;
export declare const CachedTypeKindDecoratorContextPrivateStatic: CachedTypeKind;
/**
 ...
 * )
 */
export declare let SignatureKeyErased: CacheHashKey;
export declare let SignatureKeyCanonical: CacheHashKey;
export declare let SignatureKeyBase: CacheHashKey;
export declare let SignatureKeyInner: CacheHashKey;
export declare let SignatureKeyOuter: CacheHashKey;
/**
 ...
 * )
 */
export declare const InferenceFlagsNone: InferenceFlags;
export declare const InferenceFlagsNoDefault: InferenceFlags;
export declare const InferenceFlagsAnyDefault: InferenceFlags;
export declare const InferenceFlagsSkippedGenericFunction: InferenceFlags;
/**
 ...
 * )
 */
export declare const InferencePriorityNone: InferencePriority;
export declare const InferencePriorityNakedTypeVariable: InferencePriority;
export declare const InferencePrioritySpeculativeTuple: InferencePriority;
export declare const InferencePrioritySubstituteSource: InferencePriority;
export declare const InferencePriorityHomomorphicMappedType: InferencePriority;
export declare const InferencePriorityPartialHomomorphicMappedType: InferencePriority;
export declare const InferencePriorityMappedTypeConstraint: InferencePriority;
export declare const InferencePriorityContravariantConditional: InferencePriority;
export declare const InferencePriorityReturnType: InferencePriority;
export declare const InferencePriorityLiteralKeyof: InferencePriority;
export declare const InferencePriorityNoConstraints: InferencePriority;
export declare const InferencePriorityAlwaysStrict: InferencePriority;
export declare const InferencePriorityMaxValue: InferencePriority;
export declare const InferencePriorityCircularity: InferencePriority;
export declare const InferencePriorityPriorityImpliesCombination: int;
/**
 ...
 * )
 */
export declare const DeclarationMeaningGetAccessor: DeclarationMeaning;
export declare const DeclarationMeaningSetAccessor: DeclarationMeaning;
export declare const DeclarationMeaningPropertyAssignment: DeclarationMeaning;
export declare const DeclarationMeaningMethod: DeclarationMeaning;
export declare const DeclarationMeaningPrivateStatic: DeclarationMeaning;
export declare const DeclarationMeaningGetOrSetAccessor: int;
export declare const DeclarationMeaningPropertyAssignmentOrMethod: int;
/**
 ...
 * )
 */
export declare const DeclarationSpacesNone: DeclarationSpaces;
export declare const DeclarationSpacesExportValue: DeclarationSpaces;
export declare const DeclarationSpacesExportType: DeclarationSpaces;
export declare const DeclarationSpacesExportNamespace: DeclarationSpaces;
/**
 ...
 * )
 */
export declare const IntrinsicTypeKindUnknown: IntrinsicTypeKind;
export declare const IntrinsicTypeKindUppercase: IntrinsicTypeKind;
export declare const IntrinsicTypeKindLowercase: IntrinsicTypeKind;
export declare const IntrinsicTypeKindCapitalize: IntrinsicTypeKind;
export declare const IntrinsicTypeKindUncapitalize: IntrinsicTypeKind;
export declare const IntrinsicTypeKindNoInfer: IntrinsicTypeKind;
/**
 ...
 * }
 */
export declare let intrinsicTypeKinds: GoMap<string, IntrinsicTypeKind>;
/**
 ...
 * )
 */
export declare const MappedTypeModifiersIncludeReadonly: MappedTypeModifiers;
export declare const MappedTypeModifiersExcludeReadonly: MappedTypeModifiers;
export declare const MappedTypeModifiersIncludeOptional: MappedTypeModifiers;
export declare const MappedTypeModifiersExcludeOptional: MappedTypeModifiers;
/**
 ...
 * )
 */
export declare const MappedTypeNameTypeKindNone: MappedTypeNameTypeKind;
export declare const MappedTypeNameTypeKindFiltering: MappedTypeNameTypeKind;
export declare const MappedTypeNameTypeKindRemapping: MappedTypeNameTypeKind;
/**
 ...
 * )
 */
export declare const ReferenceHintUnspecified: ReferenceHint;
export declare const ReferenceHintIdentifier: ReferenceHint;
export declare const ReferenceHintProperty: ReferenceHint;
export declare const ReferenceHintExportAssignment: ReferenceHint;
export declare const ReferenceHintJsx: ReferenceHint;
export declare const ReferenceHintExportImportEquals: ReferenceHint;
export declare const ReferenceHintExportSpecifier: ReferenceHint;
export declare const ReferenceHintDecorator: ReferenceHint;
/**
 ...
 * )
 */
export declare const TypeFactsNone: TypeFacts;
export declare const TypeFactsTypeofEQString: TypeFacts;
export declare const TypeFactsTypeofEQNumber: TypeFacts;
export declare const TypeFactsTypeofEQBigInt: TypeFacts;
export declare const TypeFactsTypeofEQBoolean: TypeFacts;
export declare const TypeFactsTypeofEQSymbol: TypeFacts;
export declare const TypeFactsTypeofEQObject: TypeFacts;
export declare const TypeFactsTypeofEQFunction: TypeFacts;
export declare const TypeFactsTypeofEQHostObject: TypeFacts;
export declare const TypeFactsTypeofNEString: TypeFacts;
export declare const TypeFactsTypeofNENumber: TypeFacts;
export declare const TypeFactsTypeofNEBigInt: TypeFacts;
export declare const TypeFactsTypeofNEBoolean: TypeFacts;
export declare const TypeFactsTypeofNESymbol: TypeFacts;
export declare const TypeFactsTypeofNEObject: TypeFacts;
export declare const TypeFactsTypeofNEFunction: TypeFacts;
export declare const TypeFactsTypeofNEHostObject: TypeFacts;
export declare const TypeFactsEQUndefined: TypeFacts;
export declare const TypeFactsEQNull: TypeFacts;
export declare const TypeFactsEQUndefinedOrNull: TypeFacts;
export declare const TypeFactsNEUndefined: TypeFacts;
export declare const TypeFactsNENull: TypeFacts;
export declare const TypeFactsNEUndefinedOrNull: TypeFacts;
export declare const TypeFactsTruthy: TypeFacts;
export declare const TypeFactsFalsy: TypeFacts;
export declare const TypeFactsIsUndefined: TypeFacts;
export declare const TypeFactsIsNull: TypeFacts;
export declare const TypeFactsIsUndefinedOrNull: TypeFacts;
export declare const TypeFactsAll: TypeFacts;
export declare const TypeFactsBaseStringStrictFacts: TypeFacts;
export declare const TypeFactsBaseStringFacts: TypeFacts;
export declare const TypeFactsStringStrictFacts: TypeFacts;
export declare const TypeFactsStringFacts: TypeFacts;
export declare const TypeFactsEmptyStringStrictFacts: TypeFacts;
export declare const TypeFactsEmptyStringFacts: TypeFacts;
export declare const TypeFactsNonEmptyStringStrictFacts: TypeFacts;
export declare const TypeFactsNonEmptyStringFacts: TypeFacts;
export declare const TypeFactsBaseNumberStrictFacts: TypeFacts;
export declare const TypeFactsBaseNumberFacts: TypeFacts;
export declare const TypeFactsNumberStrictFacts: TypeFacts;
export declare const TypeFactsNumberFacts: TypeFacts;
export declare const TypeFactsZeroNumberStrictFacts: TypeFacts;
export declare const TypeFactsZeroNumberFacts: TypeFacts;
export declare const TypeFactsNonZeroNumberStrictFacts: TypeFacts;
export declare const TypeFactsNonZeroNumberFacts: TypeFacts;
export declare const TypeFactsBaseBigIntStrictFacts: TypeFacts;
export declare const TypeFactsBaseBigIntFacts: TypeFacts;
export declare const TypeFactsBigIntStrictFacts: TypeFacts;
export declare const TypeFactsBigIntFacts: TypeFacts;
export declare const TypeFactsZeroBigIntStrictFacts: TypeFacts;
export declare const TypeFactsZeroBigIntFacts: TypeFacts;
export declare const TypeFactsNonZeroBigIntStrictFacts: TypeFacts;
export declare const TypeFactsNonZeroBigIntFacts: TypeFacts;
export declare const TypeFactsBaseBooleanStrictFacts: TypeFacts;
export declare const TypeFactsBaseBooleanFacts: TypeFacts;
export declare const TypeFactsBooleanStrictFacts: TypeFacts;
export declare const TypeFactsBooleanFacts: TypeFacts;
export declare const TypeFactsFalseStrictFacts: TypeFacts;
export declare const TypeFactsFalseFacts: TypeFacts;
export declare const TypeFactsTrueStrictFacts: TypeFacts;
export declare const TypeFactsTrueFacts: TypeFacts;
export declare const TypeFactsSymbolStrictFacts: TypeFacts;
export declare const TypeFactsSymbolFacts: TypeFacts;
export declare const TypeFactsObjectStrictFacts: TypeFacts;
export declare const TypeFactsObjectFacts: TypeFacts;
export declare const TypeFactsFunctionStrictFacts: TypeFacts;
export declare const TypeFactsFunctionFacts: TypeFacts;
export declare const TypeFactsVoidFacts: TypeFacts;
export declare const TypeFactsUndefinedFacts: TypeFacts;
export declare const TypeFactsNullFacts: TypeFacts;
export declare const TypeFactsEmptyObjectStrictFacts: TypeFacts;
export declare const TypeFactsEmptyObjectFacts: TypeFacts;
export declare const TypeFactsUnknownFacts: TypeFacts;
export declare const TypeFactsAllTypeofNE: TypeFacts;
export declare const TypeFactsOrFactsMask: TypeFacts;
export declare const TypeFactsAndFactsMask: TypeFacts;
/**
 ...
 * )
 */
export declare const IterationUseAllowsSyncIterablesFlag: IterationUse;
export declare const IterationUseAllowsAsyncIterablesFlag: IterationUse;
export declare const IterationUseAllowsStringInputFlag: IterationUse;
export declare const IterationUseForOfFlag: IterationUse;
export declare const IterationUseYieldStarFlag: IterationUse;
export declare const IterationUseSpreadFlag: IterationUse;
export declare const IterationUseDestructuringFlag: IterationUse;
export declare const IterationUsePossiblyOutOfBounds: IterationUse;
export declare const IterationUseElement: IterationUse;
export declare const IterationUseSpread: int;
export declare const IterationUseDestructuring: int;
export declare const IterationUseForOf: int;
export declare const IterationUseForAwaitOf: int;
export declare const IterationUseYieldStar: int;
export declare const IterationUseAsyncYieldStar: int;
export declare const IterationUseGeneratorReturnType: IterationUse;
export declare const IterationUseAsyncGeneratorReturnType: IterationUse;
export declare const IterationUseCacheFlags: int;
/**
 ...
 * )
 */
export declare const IterationTypeKindYield: IterationTypeKind;
export declare const IterationTypeKindReturn: IterationTypeKind;
export declare const IterationTypeKindNext: IterationTypeKind;
/**
...
export declare function Checker_getSourceFileLinks(receiver: GoPtr<Checker>, sourceFile: GoPtr<SourceFile>): GoPtr<SourceFileLinks>;
/**
 ...
 * }
 */
export declare function NewChecker(program: Program, tracer: GoPtr<Tracer>): [GoPtr<Checker>, GoPtr<Mutex>];
/**
 ...
 * }
 */
export declare function createFileIndexMap(files: GoSlice<GoPtr<SourceFile>>): GoMap<GoPtr<SourceFile>, int>;
/**
 ...
 * }
 */
export declare function countGlobalSymbols(files: GoSlice<GoPtr<SourceFile>>): int;
/**
 ...
 * }
 */
export declare function getGlobalTypeDeclaration(symbol_: GoPtr<Symbol>): GoPtr<Declaration>;
/**
 ...
 * }
 */
export declare function isPrimitiveTypeName(s: string): bool;
/**
 ...
 * }
 */
export declare function isES2015OrLaterConstructorName(s: string): bool;
export declare let primitiveTypeAliasSuggestions: () => GoMap<string, GoPtr<Symbol>>;
/**
 ...
 * }
 */
export declare function getPrimitiveTypeAliasSuggestions(symbols: SymbolTable | undefined): GoSeq<GoPtr<Symbol>>;
/**
 ...
 * }
 */
export declare function isImmediatelyUsedInInitializerOfBlockScopedVariable(declaration: GoPtr<Node>, usage: GoPtr<Node>, declContainer: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isSameScopeDescendentOf(initial: GoPtr<Node>, parent: GoPtr<Node>, stopAt: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isPropertyImmediatelyReferencedWithinDeclaration(declaration: GoPtr<Node>, usage: GoPtr<Node>, stopAtAnyPropertyDeclaration: bool): bool;
/**
 ...
 * }
 */
export declare function isInstancePropertyWithInitializerOrPrivateIdentifierProperty(n: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function superCallIsRootLevelInConstructor(superCall: GoPtr<Node>, body: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function nodeImmediatelyReferencesSuperOrThis(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function getFirstNonAmbientClassOrFunctionDeclaration(symbol_: GoPtr<Symbol>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function hasTypeJsonImportAttribute(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function getVerbatimModuleSyntaxErrorMessage(node: GoPtr<Node>): GoPtr<Message>;
/**
 ...
 * }
 */
export declare function isNotOverload(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isES2015OrLaterIterable(n: string): bool;
/**
 ...
 * )
 */
export declare const UnusedKindLocal: UnusedKind;
export declare const UnusedKindParameter: UnusedKind;
/**
 ...
 * }
 */
export declare function isIdentifierThatStartsWithUnderscore(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function importClauseFromImported(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function hasTypeParameterByName(typeParameters: GoSlice<GoPtr<Type>>, name: string): bool;
/**
 ...
 * }
 */
export declare function getUniqueTypeParameterName(typeParameters: GoSlice<GoPtr<Type>>, baseName: string): string;
/**
 ...
 * }
 */
export declare function isSpreadIntoCallOrNew(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function someSignature(signatures: GoSlice<GoPtr<Signature>>, f: (s: GoPtr<Signature>) => bool): bool;
/**
 ...
 * }
 */
export declare function signatureHasLiteralTypes(s: GoPtr<Signature>): bool;
/**
 ...
 * }
 */
export declare function acceptsVoid(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function getErrorNodeForCallNode(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function hasCommonDomTypeName(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function getThisParameterFromNodeContext(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * )
 */
export declare const PredicateSemanticsNone: PredicateSemantics;
export declare const PredicateSemanticsAlways: PredicateSemantics;
export declare const PredicateSemanticsNever: PredicateSemantics;
export declare const PredicateSemanticsSometimes: int;
/**
 ...
 * }
 */
export declare function createDiagnosticForNode(node: GoPtr<Node>, message: GoPtr<Message>, ...args: Array<unknown>): GoPtr<Diagnostic>;
/**
 ...
 * }
 */
export declare function getAdjustedNodeForError(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function getFirstDeclaration(symbol_: GoPtr<Symbol>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function getExcludedSymbolFlags(flags: SymbolFlags): SymbolFlags;
/**
 ...
 * }
 */
export declare function getModuleSpecifierFromNode(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function resolutionExtensionIsTSOrJson(ext: string): bool;
/**
 ...
 * }
 */
export declare function isESMFormatImportImportingCommonjsFormatFile(usageMode: ResolutionMode, targetMode: ResolutionMode): bool;
/**
 ...
 * }
 */
export declare function signatureHasRestParameter(sig: GoPtr<Signature>): bool;
/**
 ...
 * }
 */
export declare function hashWrite32<T>(h: GoPtr<Hasher>, value: T): void;
/**
 ...
 * }
 */
export declare function hashWrite64<T>(h: GoPtr<Hasher>, value: T): void;
/**
 ...
 * }
 */
export declare function getTypeListKey(types: GoSlice<GoPtr<Type>>): CacheHashKey;
/**
 ...
 * }
 */
export declare function getAliasKey(alias: GoPtr<TypeAlias>): CacheHashKey;
/**
 ...
 * }
 */
export declare function getUnionKey(types: GoSlice<GoPtr<Type>>, origin: GoPtr<Type>, alias: GoPtr<TypeAlias>): CacheHashKey;
/**
 ...
 * }
 */
export declare function getIntersectionKey(types: GoSlice<GoPtr<Type>>, flags: IntersectionFlags, alias: GoPtr<TypeAlias>): CacheHashKey;
/**
 ...
 * }
 */
export declare function getTupleKey(elementInfos: GoSlice<TupleElementInfo>, readonly: bool): CacheHashKey;
/**
 ...
 * }
 */
export declare function getTypeAliasInstantiationKey(typeArguments: GoSlice<GoPtr<Type>>, alias: GoPtr<TypeAlias>): CacheHashKey;
/**
 ...
 * }
 */
export declare function getTypeInstantiationKey(typeArguments: GoSlice<GoPtr<Type>>, alias: GoPtr<TypeAlias>, singleSignature: bool): CacheHashKey;
/**
 ...
 * }
 */
export declare function getIndexedAccessKey(objectType: GoPtr<Type>, indexType: GoPtr<Type>, accessFlags: AccessFlags, alias: GoPtr<TypeAlias>): CacheHashKey;
/**
 ...
 * }
 */
export declare function getTemplateTypeKey(texts: GoSlice<string>, types: GoSlice<GoPtr<Type>>): CacheHashKey;
/**
 ...
 * }
 */
export declare function getConditionalTypeKey(typeArguments: GoSlice<GoPtr<Type>>, alias: GoPtr<TypeAlias>, forConstraint: bool): CacheHashKey;
/**
 ...
 * }
 */
export declare function getRelationKey(source: GoPtr<Type>, target: GoPtr<Type>, intersectionState: IntersectionState, isIdentity: bool, ignoreConstraints: bool): [CacheHashKey, bool];
/**
 ...
 * }
 */
export declare function getNodeListKey(nodes: GoSlice<GoPtr<Node>>): CacheHashKey;
/**
 ...
 * }
 */
export declare function isTypeReferenceWithGenericArguments(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isNonDeferredTypeReference(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isUnconstrainedTypeParameter(tp: GoPtr<Type>): bool;
/**
 ...
 * )
 */
export declare const thisAssignmentDeclarationNone: thisAssignmentDeclarationKind;
export declare const thisAssignmentDeclarationTyped: thisAssignmentDeclarationKind;
export declare const thisAssignmentDeclarationConstructor: thisAssignmentDeclarationKind;
export declare const thisAssignmentDeclarationMethod: thisAssignmentDeclarationKind;
/**
 ...
 * }
 */
export declare function findIndexInfo(indexInfos: GoSlice<GoPtr<IndexInfo>>, keyType: GoPtr<Type>): GoPtr<IndexInfo>;
/**
 ...
 * }
 */
export declare function getBaseTypeNodeOfClass(t: GoPtr<Type>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function getTargetType(t: GoPtr<Type>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function isLateBindableAST(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function getEffectiveSetAccessorTypeAnnotationNode(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function getSetAccessorValueParameter(accessor: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function mayReturnNever(fn: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isThisless(symbol_: GoPtr<Symbol>): bool;
/**
 ...
 * }
 */
export declare function isThislessVariableLikeDeclaration(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isThislessType(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isThislessFunctionLikeDeclaration(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isThislessTypeParameter(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isPrototypeProperty(symbol_: GoPtr<Symbol>): bool;
/**
 ...
 * }
 */
export declare function isConflictingPrivateProperty(prop: GoPtr<Symbol>): bool;
/**
 ...
 * }
 */
export declare function getModifiedReadonlyState(state: bool, modifiers: MappedTypeModifiers): bool;
/**
 ...
 * }
 */
export declare function instantiateList<T extends GoComparable>(c: GoPtr<Checker>, values: GoSlice<T>, m: GoPtr<TypeMapper>, instantiator: (c: GoPtr<Checker>, value: T, m: GoPtr<TypeMapper>) => T): GoSlice<T>;
/**
 ...
 * }
 */
export declare function getSymbolPath(symbol_: GoPtr<Symbol>): string;
/**
 ...
 * }
 */
export declare function getStartElementCount(t: GoPtr<TupleType>, flags: ElementFlags): int;
/**
 ...
 * }
 */
export declare function getEndElementCount(t: GoPtr<TupleType>, flags: ElementFlags): int;
/**
 ...
 * }
 */
export declare function getTotalFixedElementCount(t: GoPtr<TupleType>): int;
/**
 ...
 * }
 */
export declare function isTupleType(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isMutableTupleType(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isGenericTupleType(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isSingleElementGenericTupleType(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isLocalTypeAlias(symbol_: GoPtr<Symbol>): bool;
/**
 ...
 * }
 */
export declare function getTypeReferenceName(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function isUnaryTupleTypeNode(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isFreshLiteralType(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function getStringLiteralValue(t: GoPtr<Type>): string;
/**
 ...
 * }
 */
export declare function getNumberLiteralValue(t: GoPtr<Type>): Number;
/**
 ...
 * }
 */
export declare function getBigIntLiteralValue(t: GoPtr<Type>): PseudoBigInt;
/**
 ...
 * }
 */
export declare function getBooleanLiteralValue(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isLiteralType(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isNeitherUnitTypeNorNever(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isUnitType(t: GoPtr<Type>): bool;
/**
 ...
 * )
 */
export declare const UnionReductionNone: UnionReduction;
export declare const UnionReductionLiteral: UnionReduction;
export declare const UnionReductionSubtype: UnionReduction;
/**
 ...
 * )
 */
export declare const IntersectionFlagsNone: IntersectionFlags;
export declare const IntersectionFlagsNoSupertypeReduction: IntersectionFlags;
export declare const IntersectionFlagsNoConstraintReduction: IntersectionFlags;
/**
 ...
 * }
 */
export declare function isUnionWithUndefined(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isUnionWithNull(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isIntersectionType(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isPrimitiveUnion(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isNotUndefinedType(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isNotNullType(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function getConstituentCount(t: GoPtr<Type>): int;
/**
 ...
 * }
 */
export declare function getConstituentCountOfTypes(types: GoSlice<GoPtr<Type>>): int;
/**
 ...
 * }
 */
export declare function forEachType(t: GoPtr<Type>, f: (t: GoPtr<Type>) => void): void;
/**
 ...
 * }
 */
export declare function someType(t: GoPtr<Type>, f: (arg0: GoPtr<Type>) => bool): bool;
/**
 ...
 * }
 */
export declare function everyType(t: GoPtr<Type>, f: (arg0: GoPtr<Type>) => bool): bool;
/**
 ...
 * }
 */
export declare function everyContainedType(t: GoPtr<Type>, f: (arg0: GoPtr<Type>) => bool): bool;
/**
 ...
 * }
 */
export declare function containsType(types: GoSlice<GoPtr<Type>>, t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function insertType(types: GoSlice<GoPtr<Type>>, t: GoPtr<Type>): [GoSlice<GoPtr<Type>>, bool];
/**
 ...
 * }
 */
export declare function countTypes(t: GoPtr<Type>): int;
/**
 ...
 * }
 */
export declare function compareTypeIds(t1: GoPtr<Type>, t2: GoPtr<Type>): int;
/**
 ...
 * }
 */
export declare function getIndexNodeForAccessExpression(accessNode: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function indexTypeLessThan(indexType: GoPtr<Type>, limit: int): bool;
/**
 ...
 * }
 */
export declare function isConstEnumObjectType(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function isConstEnumSymbol(symbol_: GoPtr<Symbol>): bool;
/**
 ...
 * }
 */
export declare function compareTypesEqual(s: GoPtr<Type>, t: GoPtr<Type>): Ternary;
/**
 ...
 * }
 */
export declare function hasRestParameter(signature: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isRestParameter(param: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function getNameFromIndexInfo(info: GoPtr<IndexInfo>): string;
/**
 ...
 * }
 */
export declare function isExportOrExportExpression(location: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function shouldMarkIdentifierAliasReferenced(node: GoPtr<IdentifierNode>): bool;
/**
 ...
 * }
 */
export declare function getEntityNameFromTypeNode(node: GoPtr<TypeNode>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function getMappedTypeModifiers(t: GoPtr<Type>): MappedTypeModifiers;
/**
 ...
 * }
 */
export declare function getMappedTypeOptionality(t: GoPtr<Type>): int;
/**
 ...
 * }
 */
export declare function isPartialMappedType(t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function applyStringMapping(symbol_: GoPtr<Symbol>, str: string): string;
/**
 ...
 * }
 */
export declare function isSpreadArgument(arg: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isZeroBigInt(t: GoPtr<Type>): bool;
