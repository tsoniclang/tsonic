 ...
 * }
 */
export declare function hashWrite32<T extends GoConstraint<"~int32 | ~uint32"> & number>(h: GoPtr<Hasher>, value: T): void;
/**
 ...
 * }
 */
export declare function hashWrite64<T extends GoConstraint<"~int | ~uint | ~int64 | ~uint64"> & number>(h: GoPtr<Hasher>, value: T): void;
/**
