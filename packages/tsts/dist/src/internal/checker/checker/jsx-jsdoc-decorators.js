 ...
 * }
 */
export function Checker_checkJSDocComments(receiver, node) {
 ...
 * }
 */
export function Checker_checkJSDocComment(receiver, node) {
    // This performs minimal checking of JSDoc nodes to ensure that @link references to entities are recorded
    // for purposes of checking unused identifiers.
    switch (node.Kind) {
        case KindJSDocLink:
 ...
 * }
 */
export function Checker_checkDecorators(receiver, node) {
    // skip this check for nodes that cannot have decorators. These should have already had an error reported by
    // checkGrammarModifiers.
 ...
 * }
 */
export function Checker_checkDecorator(receiver, node) {
 ...
 * }
 */
export function Checker_resolveDecorator(receiver, node, candidatesOutArray, checkMode) {
 ...
 * }
 */
export function Checker_isPotentiallyUncalledDecorator(receiver, decorator, signatures) {
    return signatures.length !== 0 && Every(signatures, (sig) => {
...
//# sourceMappingURL=jsx-jsdoc-decorators.js.map