 ...
 * )
 */
export declare const ParseFlagsNone: ParseFlags;
export declare const ParseFlagsYield: ParseFlags;
export declare const ParseFlagsAwait: ParseFlags;
export declare const ParseFlagsType: ParseFlags;
export declare const ParseFlagsIgnoreMissingOpenBrace: ParseFlags;
export declare const ParseFlagsJSDoc: ParseFlags;
/**
 ...
 * )
 */
export declare const SignatureKindCall: SignatureKind;
export declare const SignatureKindConstruct: SignatureKind;
/**
 ...
 * )
 */
export declare const ContextFlagsNone: ContextFlags;
export declare const ContextFlagsSignature: ContextFlags;
export declare const ContextFlagsNoConstraints: ContextFlags;
export declare const ContextFlagsIgnoreNodeInferences: ContextFlags;
export declare const ContextFlagsSkipBindingPatterns: ContextFlags;
/**
 ...
 * )
 */
export declare const TypeFormatFlagsNone: TypeFormatFlags;
export declare const TypeFormatFlagsNoTruncation: TypeFormatFlags;
export declare const TypeFormatFlagsWriteArrayAsGenericType: TypeFormatFlags;
export declare const TypeFormatFlagsGenerateNamesForShadowedTypeParams: TypeFormatFlags;
export declare const TypeFormatFlagsUseStructuralFallback: TypeFormatFlags;
export declare const TypeFormatFlagsWriteTypeArgumentsOfSignature: TypeFormatFlags;
export declare const TypeFormatFlagsUseFullyQualifiedType: TypeFormatFlags;
export declare const TypeFormatFlagsSuppressAnyReturnType: TypeFormatFlags;
export declare const TypeFormatFlagsMultilineObjectLiterals: TypeFormatFlags;
export declare const TypeFormatFlagsWriteClassExpressionAsTypeLiteral: TypeFormatFlags;
export declare const TypeFormatFlagsUseTypeOfFunction: TypeFormatFlags;
export declare const TypeFormatFlagsOmitParameterModifiers: TypeFormatFlags;
export declare const TypeFormatFlagsUseAliasDefinedOutsideCurrentScope: TypeFormatFlags;
export declare const TypeFormatFlagsUseSingleQuotesForStringLiteralType: TypeFormatFlags;
export declare const TypeFormatFlagsNoTypeReduction: TypeFormatFlags;
export declare const TypeFormatFlagsUseInstantiationExpressions: TypeFormatFlags;
export declare const TypeFormatFlagsOmitThisParameter: TypeFormatFlags;
export declare const TypeFormatFlagsWriteCallStyleSignature: TypeFormatFlags;
export declare const TypeFormatFlagsAllowUniqueESSymbolType: TypeFormatFlags;
export declare const TypeFormatFlagsAddUndefined: TypeFormatFlags;
export declare const TypeFormatFlagsWriteArrowStyleSignature: TypeFormatFlags;
export declare const TypeFormatFlagsInArrayType: TypeFormatFlags;
export declare const TypeFormatFlagsInElementType: TypeFormatFlags;
export declare const TypeFormatFlagsInFirstTypeArgument: TypeFormatFlags;
export declare const TypeFormatFlagsInTypeAlias: TypeFormatFlags;
/**
 ...
 */
export declare const TypeFormatFlagsNodeBuilderFlagsMask: int;
/**
 ...
 * )
 */
export declare const SymbolFormatFlagsNone: SymbolFormatFlags;
export declare const SymbolFormatFlagsWriteTypeParametersOrArguments: SymbolFormatFlags;
export declare const SymbolFormatFlagsUseOnlyExternalAliasing: SymbolFormatFlags;
export declare const SymbolFormatFlagsAllowAnyNodeKind: SymbolFormatFlags;
export declare const SymbolFormatFlagsUseAliasDefinedOutsideCurrentScope: SymbolFormatFlags;
export declare const SymbolFormatFlagsWriteComputedProps: SymbolFormatFlags;
export declare const SymbolFormatFlagsDoNotIncludeSymbolChain: SymbolFormatFlags;
/**
 ...
 * )
 */
export declare const ExternalEmitHelpersRest: ExternalEmitHelpers;
export declare const ExternalEmitHelpersDecorate: ExternalEmitHelpers;
export declare const ExternalEmitHelpersMetadata: ExternalEmitHelpers;
export declare const ExternalEmitHelpersParam: ExternalEmitHelpers;
export declare const ExternalEmitHelpersAwaiter: ExternalEmitHelpers;
export declare const ExternalEmitHelpersAwait: ExternalEmitHelpers;
export declare const ExternalEmitHelpersAsyncGenerator: ExternalEmitHelpers;
export declare const ExternalEmitHelpersAsyncDelegator: ExternalEmitHelpers;
export declare const ExternalEmitHelpersAsyncValues: ExternalEmitHelpers;
export declare const ExternalEmitHelpersExportStar: ExternalEmitHelpers;
export declare const ExternalEmitHelpersImportStar: ExternalEmitHelpers;
export declare const ExternalEmitHelpersImportDefault: ExternalEmitHelpers;
export declare const ExternalEmitHelpersMakeTemplateObject: ExternalEmitHelpers;
export declare const ExternalEmitHelpersClassPrivateFieldGet: ExternalEmitHelpers;
export declare const ExternalEmitHelpersClassPrivateFieldSet: ExternalEmitHelpers;
export declare const ExternalEmitHelpersClassPrivateFieldIn: ExternalEmitHelpers;
export declare const ExternalEmitHelpersSetFunctionName: ExternalEmitHelpers;
export declare const ExternalEmitHelpersPropKey: ExternalEmitHelpers;
export declare const ExternalEmitHelpersAddDisposableResourceAndDisposeResources: ExternalEmitHelpers;
export declare const ExternalEmitHelpersRewriteRelativeImportExtension: ExternalEmitHelpers;
export declare const ExternalEmitHelpersESDecorateAndRunInitializers: int;
export declare const ExternalEmitHelpersFirstEmitHelper: int;
export declare const ExternalEmitHelpersLastEmitHelper: int;
export declare const ExternalEmitHelpersForAwaitOfIncludes: int;
export declare const ExternalEmitHelpersAsyncGeneratorIncludes: int;
export declare const ExternalEmitHelpersAsyncDelegatorIncludes: int;
/**
 ...
 * )
 */
export declare const ExhaustiveStateUnknown: ExhaustiveState;
export declare const ExhaustiveStateComputing: ExhaustiveState;
export declare const ExhaustiveStateFalse: ExhaustiveState;
export declare const ExhaustiveStateTrue: ExhaustiveState;
/**
 ...
 * )
 */
export declare const MembersOrExportsResolutionKindResolvedExports: MembersOrExportsResolutionKind;
export declare const MembersOrExportsResolutionKindResolvedMembers: MembersOrExportsResolutionKind;
/**
 ...
 * )
 */
export declare const VarianceFlagsInvariant: VarianceFlags;
export declare const VarianceFlagsCovariant: VarianceFlags;
export declare const VarianceFlagsContravariant: VarianceFlags;
export declare const VarianceFlagsBivariant: VarianceFlags;
export declare const VarianceFlagsIndependent: VarianceFlags;
export declare const VarianceFlagsVarianceMask: VarianceFlags;
export declare const VarianceFlagsUnmeasurable: VarianceFlags;
export declare const VarianceFlagsUnreliable: VarianceFlags;
export declare const VarianceFlagsAllowsStructuralFallback: int;
/**
 ...
 * )
 */
export declare const AccessFlagsNone: AccessFlags;
export declare const AccessFlagsIncludeUndefined: AccessFlags;
export declare const AccessFlagsNoIndexSignatures: AccessFlags;
export declare const AccessFlagsWriting: AccessFlags;
export declare const AccessFlagsCacheSymbol: AccessFlags;
export declare const AccessFlagsAllowMissing: AccessFlags;
export declare const AccessFlagsExpressionPosition: AccessFlags;
export declare const AccessFlagsReportDeprecated: AccessFlags;
export declare const AccessFlagsSuppressNoImplicitAnyError: AccessFlags;
export declare const AccessFlagsContextual: AccessFlags;
export declare const AccessFlagsPersistent: AccessFlags;
/**
 ...
 * )
 */
export declare const NodeCheckFlagsNone: NodeCheckFlags;
export declare const NodeCheckFlagsTypeChecked: NodeCheckFlags;
export declare const NodeCheckFlagsContextChecked: NodeCheckFlags;
export declare const NodeCheckFlagsEnumValuesComputed: NodeCheckFlags;
export declare const NodeCheckFlagsAssignmentsMarked: NodeCheckFlags;
export declare const NodeCheckFlagsContainsClassWithPrivateIdentifiers: NodeCheckFlags;
export declare const NodeCheckFlagsContainsSuperPropertyInStaticInitializer: NodeCheckFlags;
export declare const NodeCheckFlagsInCheckIdentifier: NodeCheckFlags;
export declare const NodeCheckFlagsInitializerIsUndefined: NodeCheckFlags;
export declare const NodeCheckFlagsInitializerIsUndefinedComputed: NodeCheckFlags;
/**
 ...
 * )
 */
export declare const TypeFlagsNone: TypeFlags;
export declare const TypeFlagsAny: TypeFlags;
export declare const TypeFlagsUnknown: TypeFlags;
export declare const TypeFlagsUndefined: TypeFlags;
export declare const TypeFlagsNull: TypeFlags;
export declare const TypeFlagsVoid: TypeFlags;
export declare const TypeFlagsString: TypeFlags;
export declare const TypeFlagsNumber: TypeFlags;
export declare const TypeFlagsBigInt: TypeFlags;
export declare const TypeFlagsBoolean: TypeFlags;
export declare const TypeFlagsESSymbol: TypeFlags;
export declare const TypeFlagsStringLiteral: TypeFlags;
export declare const TypeFlagsNumberLiteral: TypeFlags;
export declare const TypeFlagsBigIntLiteral: TypeFlags;
export declare const TypeFlagsBooleanLiteral: TypeFlags;
export declare const TypeFlagsUniqueESSymbol: TypeFlags;
export declare const TypeFlagsEnumLiteral: TypeFlags;
export declare const TypeFlagsEnum: TypeFlags;
export declare const TypeFlagsNonPrimitive: TypeFlags;
export declare const TypeFlagsNever: TypeFlags;
export declare const TypeFlagsTypeParameter: TypeFlags;
export declare const TypeFlagsObject: TypeFlags;
export declare const TypeFlagsIndex: TypeFlags;
export declare const TypeFlagsTemplateLiteral: TypeFlags;
export declare const TypeFlagsStringMapping: TypeFlags;
export declare const TypeFlagsSubstitution: TypeFlags;
export declare const TypeFlagsIndexedAccess: TypeFlags;
export declare const TypeFlagsConditional: TypeFlags;
export declare const TypeFlagsUnion: TypeFlags;
export declare const TypeFlagsIntersection: TypeFlags;
export declare const TypeFlagsReserved1: TypeFlags;
export declare const TypeFlagsReserved2: TypeFlags;
export declare const TypeFlagsReserved3: TypeFlags;
export declare const TypeFlagsAnyOrUnknown: int;
export declare const TypeFlagsNullable: int;
export declare const TypeFlagsLiteral: int;
export declare const TypeFlagsUnit: int;
export declare const TypeFlagsFreshable: int;
export declare const TypeFlagsStringOrNumberLiteral: int;
export declare const TypeFlagsStringOrNumberLiteralOrUnique: int;
export declare const TypeFlagsDefinitelyFalsy: int;
export declare const TypeFlagsPossiblyFalsy: int;
export declare const TypeFlagsIntrinsic: int;
export declare const TypeFlagsStringLike: int;
export declare const TypeFlagsNumberLike: int;
export declare const TypeFlagsBigIntLike: int;
export declare const TypeFlagsBooleanLike: int;
export declare const TypeFlagsEnumLike: int;
export declare const TypeFlagsESSymbolLike: int;
export declare const TypeFlagsVoidLike: int;
export declare const TypeFlagsPrimitive: int;
export declare const TypeFlagsDefinitelyNonNullable: int;
export declare const TypeFlagsDisjointDomains: int;
export declare const TypeFlagsUnionOrIntersection: int;
export declare const TypeFlagsStructuredType: int;
export declare const TypeFlagsTypeVariable: int;
export declare const TypeFlagsInstantiableNonPrimitive: int;
export declare const TypeFlagsInstantiablePrimitive: int;
export declare const TypeFlagsInstantiable: int;
export declare const TypeFlagsStructuredOrInstantiable: int;
export declare const TypeFlagsObjectFlagsType: int;
export declare const TypeFlagsSimplifiable: int;
export declare const TypeFlagsSingleton: int;
export declare const TypeFlagsNarrowable: int;
export declare const TypeFlagsIncludesMask: int;
export declare const TypeFlagsIncludesMissingType: TypeFlags;
export declare const TypeFlagsIncludesNonWideningType: TypeFlags;
export declare const TypeFlagsIncludesWildcard: TypeFlags;
export declare const TypeFlagsIncludesEmptyObject: TypeFlags;
export declare const TypeFlagsIncludesInstantiable: TypeFlags;
export declare const TypeFlagsIncludesConstrainedTypeVariable: TypeFlags;
export declare const TypeFlagsIncludesError: TypeFlags;
export declare const TypeFlagsNotPrimitiveUnion: int;
/**
 ...
 * }
 */
export declare const typeFlagNames: GoArray<{
    flag: TypeFlags;
    name: string;
}, "...">;
/**
 ...
 * }
 */
export declare function FormatTypeFlags(flags: TypeFlags): GoSlice<string>;
/**
 ...
 * }
 */
export declare function TypeFlags_String(receiver: TypeFlags): string;
/**
 ...
 * }
 */
export declare function VarianceFlags_String(receiver: VarianceFlags): string;
/**
 ...
 * )
 */
export declare const ObjectFlagsNone: ObjectFlags;
export declare const ObjectFlagsClass: ObjectFlags;
export declare const ObjectFlagsInterface: ObjectFlags;
export declare const ObjectFlagsReference: ObjectFlags;
export declare const ObjectFlagsTuple: ObjectFlags;
export declare const ObjectFlagsAnonymous: ObjectFlags;
export declare const ObjectFlagsMapped: ObjectFlags;
export declare const ObjectFlagsInstantiated: ObjectFlags;
export declare const ObjectFlagsObjectLiteral: ObjectFlags;
export declare const ObjectFlagsEvolvingArray: ObjectFlags;
export declare const ObjectFlagsObjectLiteralPatternWithComputedProperties: ObjectFlags;
export declare const ObjectFlagsReverseMapped: ObjectFlags;
export declare const ObjectFlagsJsxAttributes: ObjectFlags;
export declare const ObjectFlagsJSLiteral: ObjectFlags;
export declare const ObjectFlagsFreshLiteral: ObjectFlags;
export declare const ObjectFlagsArrayLiteral: ObjectFlags;
export declare const ObjectFlagsPrimitiveUnion: ObjectFlags;
export declare const ObjectFlagsContainsWideningType: ObjectFlags;
export declare const ObjectFlagsContainsObjectOrArrayLiteral: ObjectFlags;
export declare const ObjectFlagsNonInferrableType: ObjectFlags;
export declare const ObjectFlagsCouldContainTypeVariablesComputed: ObjectFlags;
export declare const ObjectFlagsCouldContainTypeVariables: ObjectFlags;
export declare const ObjectFlagsMembersResolved: ObjectFlags;
export declare const ObjectFlagsClassOrInterface: int;
export declare const ObjectFlagsRequiresWidening: int;
export declare const ObjectFlagsPropagatingFlags: int;
export declare const ObjectFlagsInstantiatedMapped: int;
export declare const ObjectFlagsContainsSpread: int;
export declare const ObjectFlagsObjectRestType: int;
export declare const ObjectFlagsInstantiationExpressionType: int;
export declare const ObjectFlagsSingleSignatureType: int;
export declare const ObjectFlagsIsClassInstanceClone: int;
export declare const ObjectFlagsObjectTypeKindMask: int;
export declare const ObjectFlagsIdenticalBaseTypeCalculated: int;
export declare const ObjectFlagsIdenticalBaseTypeExists: int;
export declare const ObjectFlagsUnresolvedMembers: int;
export declare const ObjectFlagsFromTypeNode: int;
export declare const ObjectFlagsIsGenericTypeComputed: int;
export declare const ObjectFlagsIsGenericObjectType: int;
export declare const ObjectFlagsIsGenericIndexType: int;
export declare const ObjectFlagsIsGenericType: int;
export declare const ObjectFlagsContainsIntersections: int;
export declare const ObjectFlagsIsUnknownLikeUnionComputed: int;
export declare const ObjectFlagsIsUnknownLikeUnion: int;
export declare const ObjectFlagsIsNeverIntersectionComputed: int;
export declare const ObjectFlagsIsNeverIntersection: int;
export declare const ObjectFlagsIsConstrainedTypeVariable: int;
/**
 ...
 * }
 */
export declare function TypeAlias_Symbol(receiver: GoPtr<TypeAlias>): GoPtr<Symbol_62f2f8bf>;
/**
 ...
 * }
 */
export declare function TypeAlias_TypeArguments(receiver: GoPtr<TypeAlias>): GoSlice<GoPtr<Type>>;
/**
 ...
 * }
 */
export declare function Type_Id(receiver: GoPtr<Type>): TypeId;
/**
 ...
 * }
 */
export declare function Type_Flags(receiver: GoPtr<Type>): TypeFlags;
/**
 ...
 * }
 */
export declare function Type_ObjectFlags(receiver: GoPtr<Type>): ObjectFlags;
/**
 ...
 */
export declare function Type_AsIntrinsicType(receiver: GoPtr<Type>): GoPtr<IntrinsicType>;
/**
 ...
 */
export declare function Type_AsLiteralType(receiver: GoPtr<Type>): GoPtr<LiteralType>;
/**
 ...
 */
export declare function Type_AsUniqueESSymbolType(receiver: GoPtr<Type>): GoPtr<UniqueESSymbolType>;
/**
 ...
 */
export declare function Type_AsTupleType(receiver: GoPtr<Type>): GoPtr<TupleType>;
/**
 ...
 * }
 */
export declare function Type_AsInstantiationExpressionType(receiver: GoPtr<Type>): GoPtr<InstantiationExpressionType>;
/**
 ...
 */
export declare function Type_AsMappedType(receiver: GoPtr<Type>): GoPtr<MappedType>;
/**
 ...
 */
export declare function Type_AsReverseMappedType(receiver: GoPtr<Type>): GoPtr<ReverseMappedType>;
/**
 ...
 */
export declare function Type_AsEvolvingArrayType(receiver: GoPtr<Type>): GoPtr<EvolvingArrayType>;
/**
 ...
 */
export declare function Type_AsTypeParameter(receiver: GoPtr<Type>): GoPtr<TypeParameter>;
/**
 ...
 */
export declare function Type_AsUnionType(receiver: GoPtr<Type>): GoPtr<UnionType>;
/**
 ...
 */
export declare function Type_AsIntersectionType(receiver: GoPtr<Type>): GoPtr<IntersectionType>;
/**
 ...
 */
export declare function Type_AsIndexType(receiver: GoPtr<Type>): GoPtr<IndexType>;
/**
 ...
 */
export declare function Type_AsIndexedAccessType(receiver: GoPtr<Type>): GoPtr<IndexedAccessType>;
/**
 ...
 */
export declare function Type_AsTemplateLiteralType(receiver: GoPtr<Type>): GoPtr<TemplateLiteralType>;
/**
 ...
 */
export declare function Type_AsStringMappingType(receiver: GoPtr<Type>): GoPtr<StringMappingType>;
/**
 ...
 */
export declare function Type_AsSubstitutionType(receiver: GoPtr<Type>): GoPtr<SubstitutionType>;
/**
 ...
 */
export declare function Type_AsConditionalType(receiver: GoPtr<Type>): GoPtr<ConditionalType>;
/**
 ...
 */
export declare function Type_AsConstrainedType(receiver: GoPtr<Type>): GoPtr<ConstrainedType>;
/**
 ...
 */
export declare function Type_AsStructuredType(receiver: GoPtr<Type>): GoPtr<StructuredType>;
/**
 ...
 */
export declare function Type_AsObjectType(receiver: GoPtr<Type>): GoPtr<ObjectType>;
/**
 ...
 */
export declare function Type_AsTypeReference(receiver: GoPtr<Type>): GoPtr<TypeReference>;
/**
 ...
 */
export declare function Type_AsInterfaceType(receiver: GoPtr<Type>): GoPtr<InterfaceType>;
/**
 ...
 * }
 */
export declare function Type_AsUnionOrIntersectionType(receiver: GoPtr<Type>): GoPtr<UnionOrIntersectionType>;
/**
 ...
 * }
 */
export declare function Type_Distributed(receiver: GoPtr<Type>): GoSlice<GoPtr<Type>>;
/**
 ...
 * }
 */
export declare function Type_Target(receiver: GoPtr<Type>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function Type_Mapper(receiver: GoPtr<Type>): GoPtr<TypeMapper>;
/**
 ...
 * }
 */
export declare function Type_Types(receiver: GoPtr<Type>): GoSlice<GoPtr<Type>>;
/**
 ...
 * }
 */
export declare function Type_TargetInterfaceType(receiver: GoPtr<Type>): GoPtr<InterfaceType>;
/**
 ...
 * }
 */
export declare function Type_TargetTupleType(receiver: GoPtr<Type>): GoPtr<TupleType>;
/**
 ...
 * }
 */
export declare function Type_Symbol(receiver: GoPtr<Type>): GoPtr<Symbol_62f2f8bf>;
/**
 ...
 * }
 */
export declare function Type_Alias(receiver: GoPtr<Type>): GoPtr<TypeAlias>;
/**
 ...
 * }
 */
export declare function Type_IsUnion(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsString(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsIntersection(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsStringLiteral(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsNumberLiteral(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsBigIntLiteral(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsEnumLiteral(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsBooleanLike(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsStringLike(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsClass(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsTypeParameter(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsIndex(receiver: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function Type_IsTupleType(receiver: GoPtr<Type>): bool;
/**
 ...
 */
export declare function TypeBase_AsType(receiver: GoPtr<TypeBase>): GoPtr<Type>;
/**
 ...
 */
export declare function TypeBase_AsConstrainedType(receiver: GoPtr<TypeBase>): GoPtr<ConstrainedType>;
/**
 ...
 */
export declare function TypeBase_AsStructuredType(receiver: GoPtr<TypeBase>): GoPtr<StructuredType>;
/**
 ...
 */
export declare function TypeBase_AsObjectType(receiver: GoPtr<TypeBase>): GoPtr<ObjectType>;
/**
 ...
 */
export declare function TypeBase_AsTypeReference(receiver: GoPtr<TypeBase>): GoPtr<TypeReference>;
/**
 ...
 */
export declare function TypeBase_AsInterfaceType(receiver: GoPtr<TypeBase>): GoPtr<InterfaceType>;
/**
 ...
 */
export declare function TypeBase_AsUnionOrIntersectionType(receiver: GoPtr<TypeBase>): GoPtr<UnionOrIntersectionType>;
/**
 ...
 */
export declare function IntrinsicType_IntrinsicName(receiver: GoPtr<IntrinsicType>): string;
/**
 ...
 * }
 */
export declare function LiteralType_Value(receiver: GoPtr<LiteralType>): unknown;
/**
 ...
 * }
 */
export declare function LiteralType_FreshType(receiver: GoPtr<LiteralType>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function LiteralType_RegularType(receiver: GoPtr<LiteralType>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function LiteralType_String(receiver: GoPtr<LiteralType>): string;
/**
 ...
 */
export declare function ConstrainedType_AsConstrainedType(receiver: GoPtr<ConstrainedType>): GoPtr<ConstrainedType>;
/**
 ...
 */
export declare function StructuredType_AsStructuredType(receiver: GoPtr<StructuredType>): GoPtr<StructuredType>;
/**
 ...
 * }
 */
export declare function StructuredType_CallSignatures(receiver: GoPtr<StructuredType>): GoSlice<GoPtr<Signature>>;
/**
 ...
 * }
 */
export declare function StructuredType_ConstructSignatures(receiver: GoPtr<StructuredType>): GoSlice<GoPtr<Signature>>;
/**
 ...
 * }
 */
export declare function StructuredType_Properties(receiver: GoPtr<StructuredType>): GoSlice<GoPtr<Symbol_62f2f8bf>>;
/**
 ...
 */
export declare function ObjectType_AsObjectType(receiver: GoPtr<ObjectType>): GoPtr<ObjectType>;
/**
 ...
 */
export declare function TypeReference_AsTypeReference(receiver: GoPtr<TypeReference>): GoPtr<TypeReference>;
/**
 ...
 */
export declare function InterfaceType_AsInterfaceType(receiver: GoPtr<InterfaceType>): GoPtr<InterfaceType>;
/**
 ...
 * }
 */
export declare function InterfaceType_OuterTypeParameters(receiver: GoPtr<InterfaceType>): GoSlice<GoPtr<Type>>;
/**
 ...
 * }
 */
export declare function InterfaceType_LocalTypeParameters(receiver: GoPtr<InterfaceType>): GoSlice<GoPtr<Type>>;
/**
 ...
 * }
 */
export declare function InterfaceType_TypeParameters(receiver: GoPtr<InterfaceType>): GoSlice<GoPtr<Type>>;
/**
 ...
 * )
 */
export declare const ElementFlagsNone: ElementFlags;
export declare const ElementFlagsRequired: ElementFlags;
export declare const ElementFlagsOptional: ElementFlags;
export declare const ElementFlagsRest: ElementFlags;
export declare const ElementFlagsVariadic: ElementFlags;
export declare const ElementFlagsFixed: int;
export declare const ElementFlagsVariable: int;
export declare const ElementFlagsNonRequired: int;
export declare const ElementFlagsNonRest: int;
/**
 ...
 */
export declare function TupleElementInfo_TupleElementFlags(receiver: GoPtr<TupleElementInfo>): ElementFlags;
/**
 ...
 */
export declare function TupleElementInfo_LabeledDeclaration(receiver: GoPtr<TupleElementInfo>): GoPtr<Node>;
/**
 ...
 */
export declare function TupleType_FixedLength(receiver: GoPtr<TupleType>): int;
/**
 ...
 */
export declare function TupleType_IsReadonly(receiver: GoPtr<TupleType>): bool;
/**
 ...
 * }
 */
export declare function TupleType_ElementFlags(receiver: GoPtr<TupleType>): GoSlice<ElementFlags>;
/**
 ...
 */
export declare function TupleType_ElementInfos(receiver: GoPtr<TupleType>): GoSlice<TupleElementInfo>;
/**
 ...
 */
export declare function UnionOrIntersectionType_AsUnionOrIntersectionType(receiver: GoPtr<UnionOrIntersectionType>): GoPtr<UnionOrIntersectionType>;
/**
 ...
 * }
 */
export declare function UnionOrIntersectionType_Types(receiver: GoPtr<UnionOrIntersectionType>): GoSlice<GoPtr<Type>>;
/**
 ...
 */
export declare function TypeParameter_IsThisType(receiver: GoPtr<TypeParameter>): bool;
/**
 ...
 * )
 */
export declare const IndexFlagsNone: IndexFlags;
export declare const IndexFlagsStringsOnly: IndexFlags;
export declare const IndexFlagsNoIndexSignatures: IndexFlags;
export declare const IndexFlagsNoReducibleCheck: IndexFlags;
/**
 ...
 */
export declare function IndexType_Target(receiver: GoPtr<IndexType>): GoPtr<Type>;
/**
 ...
 */
export declare function IndexedAccessType_ObjectType(receiver: GoPtr<IndexedAccessType>): GoPtr<Type>;
/**
 ...
 */
export declare function IndexedAccessType_IndexType(receiver: GoPtr<IndexedAccessType>): GoPtr<Type>;
/**
 ...
 */
export declare function TemplateLiteralType_Texts(receiver: GoPtr<TemplateLiteralType>): GoSlice<string>;
/**
 ...
 */
export declare function TemplateLiteralType_Types(receiver: GoPtr<TemplateLiteralType>): GoSlice<GoPtr<Type>>;
/**
 ...
 */
export declare function StringMappingType_Target(receiver: GoPtr<StringMappingType>): GoPtr<Type>;
/**
 ...
 */
export declare function SubstitutionType_BaseType(receiver: GoPtr<SubstitutionType>): GoPtr<Type>;
/**
 ...
 */
export declare function SubstitutionType_SubstConstraint(receiver: GoPtr<SubstitutionType>): GoPtr<Type>;
/**
 ...
 */
export declare function ConditionalType_CheckType(receiver: GoPtr<ConditionalType>): GoPtr<Type>;
/**
 ...
 */
export declare function ConditionalType_ExtendsType(receiver: GoPtr<ConditionalType>): GoPtr<Type>;
/**
 ...
 * )
 */
export declare const SignatureFlagsNone: SignatureFlags;
export declare const SignatureFlagsHasRestParameter: SignatureFlags;
export declare const SignatureFlagsHasLiteralTypes: SignatureFlags;
export declare const SignatureFlagsConstruct: SignatureFlags;
export declare const SignatureFlagsAbstract: SignatureFlags;
export declare const SignatureFlagsIsInnerCallChain: SignatureFlags;
export declare const SignatureFlagsIsOuterCallChain: SignatureFlags;
export declare const SignatureFlagsIsUntypedSignatureInJSFile: SignatureFlags;
export declare const SignatureFlagsIsNonInferrable: SignatureFlags;
export declare const SignatureFlagsIsSignatureCandidateForOverloadFailure: SignatureFlags;
export declare const SignatureFlagsPropagatingFlags: int;
export declare const SignatureFlagsCallChainFlags: int;
/**
 ...
 * }
 */
export declare function Signature_Flags(receiver: GoPtr<Signature>): SignatureFlags;
/**
 ...
 * }
 */
export declare function Signature_TypeParameters(receiver: GoPtr<Signature>): GoSlice<GoPtr<Type>>;
/**
 ...
 * }
 */
export declare function Signature_Declaration(receiver: GoPtr<Signature>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function Signature_Target(receiver: GoPtr<Signature>): GoPtr<Signature>;
/**
 ...
 * }
 */
export declare function Signature_ThisParameter(receiver: GoPtr<Signature>): GoPtr<Symbol_62f2f8bf>;
/**
 ...
 * }
 */
export declare function Signature_Parameters(receiver: GoPtr<Signature>): GoSlice<GoPtr<Symbol_62f2f8bf>>;
/**
 ...
 * }
 */
export declare function Signature_HasRestParameter(receiver: GoPtr<Signature>): bool;
/**
 ...
 * }
 */
export declare function Signature_MinArgumentCount(receiver: GoPtr<Signature>): int;
/**
 ...
 * )
 */
export declare const TypePredicateKindThis: TypePredicateKind;
export declare const TypePredicateKindIdentifier: TypePredicateKind;
export declare const TypePredicateKindAssertsThis: TypePredicateKind;
export declare const TypePredicateKindAssertsIdentifier: TypePredicateKind;
/**
 ...
 * }
 */
export declare function TypePredicate_Type(receiver: GoPtr<TypePredicate>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function TypePredicate_Kind(receiver: GoPtr<TypePredicate>): TypePredicateKind;
/**
 ...
 * }
 */
export declare function TypePredicate_ParameterIndex(receiver: GoPtr<TypePredicate>): int;
/**
 ...
 * }
 */
export declare function TypePredicate_ParameterName(receiver: GoPtr<TypePredicate>): string;
/**
 ...
 * }
 */
export declare function IndexInfo_KeyType(receiver: GoPtr<IndexInfo>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function IndexInfo_ValueType(receiver: GoPtr<IndexInfo>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function IndexInfo_IsReadonly(receiver: GoPtr<IndexInfo>): bool;
/**
 ...
 * }
 */
export declare function IndexInfo_Declaration(receiver: GoPtr<IndexInfo>): GoPtr<Node>;
/**
 ...
 * )
 */
export declare const TernaryFalse: Ternary;
export declare const TernaryUnknown: Ternary;
export declare const TernaryMaybe: Ternary;
export declare const TernaryTrue: Ternary;
/**
 ...
 * }
 */
export declare const LanguageFeatureMinimumTarget: LanguageFeatureMinimumTargetMap;
/**
