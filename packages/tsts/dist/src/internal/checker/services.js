 ...
 * }
 */
export function Checker_GetSymbolsInScope(receiver, location, meaning) {
...
export function Checker_getSymbolsInScope(receiver, location, meaning) {
    ...
    const symbols = new globalThis.Map();
    let isStaticSymbol = false;
    // Copy the given symbol into symbol tables if the symbol has the given meaning
    // and it doesn't already exists in the symbol table.
    const copySymbol = (symbol_, meaning_) => {
    ...
    const copySymbols = (source, meaning_) => {
        if (meaning_ !== 0) {
    ...
    const copyLocallyVisibleExportSymbols = (source, meaning_) => {
        if (meaning_ !== 0) {
            for (const [, symbol_] of source) {
                // Similar condition as in `resolveNameHelper`
    ...
    const populateSymbols = () => {
        ...
        while (loc !== undefined) {
            ...
            switch (loc.Kind) {
                case KindSourceFile:
                    if (!IsExternalModule(loc)) {
                        break;
                    }
                // fallthrough
                // eslint-disable-next-line no-fallthrough
                case KindModuleDeclaration:
                    copyLocallyVisibleExportSymbols(Checker_getSymbolOfDeclaration(receiver, loc).Exports, (meaning & SymbolFlagsModuleMember));
                    break;
                case KindEnumDeclaration:
                    copySymbols(Checker_getSymbolOfDeclaration(receiver, loc).Exports, (meaning & SymbolFlagsEnumMember));
                    break;
                case KindClassExpression: {
                    const className = Node_Name(loc);
                    if (className !== undefined) {
                        copySymbol(Node_Symbol(loc), meaning);
                    }
                    // this fall-through is necessary because we would like to handle
                    // type parameter inside class expression similar to how we handle it in classDeclaration and interface Declaration.
                    // eslint-disable-next-line no-fallthrough
                ...
                case KindInterfaceDeclaration:
                    ...
                    // Note: that the memberFlags come from previous iteration.
                    if (!isStaticSymbol) {
                        copySymbols(Checker_getMembersOfSymbol(receiver, Checker_getSymbolOfDeclaration(receiver, loc)), (meaning & SymbolFlagsType));
                    }
                    break;
 ...
 * }
 */
export function Checker_GetExportsOfModule(receiver, symbol_) {
 ...
 * }
 */
export function Checker_ForEachExportAndPropertyOfModule(receiver, moduleSymbol, cb) {
 ...
 * }
 */
export function Checker_IsValidPropertyAccess(receiver, node, propertyName) {
 ...
 * }
 */
export function Checker_isValidPropertyAccessWithType(receiver, node, isSuper, propertyName, t) {
    // Short-circuiting for improved performance.
    if (IsTypeAny(t)) {
        return true;
    }
 ...
 * }
 */
export function Checker_IsValidPropertyAccessForCompletions(receiver, node, t, property) {
    return Checker_isPropertyAccessible(receiver, node, node.Kind === KindPropertyAccessExpression && Node_Expression(node).Kind === KindSuperKeyword, false, /*isWrite*/ t, property);
    // Previously we validated the 'this' type of methods but this adversely affected performance. See #31377 for more context.
}
/**
 ...
 * }
 */
export function Checker_IsUnknownSymbol(receiver, symbol_) {
 ...
 * }
 */
export function Checker_IsUndefinedSymbol(receiver, symbol_) {
 ...
 * }
 */
export function Checker_IsArgumentsSymbol(receiver, symbol_) {
 ...
 * }
 */
export function Checker_GetNonOptionalType(receiver, t) {
 ...
 * }
 */
export function Checker_GetStringIndexType(receiver, t) {
 ...
 * }
 */
export function Checker_GetNumberIndexType(receiver, t) {
 ...
 * }
 */
export function Checker_GetCallSignatures(receiver, t) {
 ...
 * }
 */
export function Checker_GetConstructSignatures(receiver, t) {
 ...
 * }
 */
export function Checker_GetApparentProperties(receiver, t) {
 ...
 * }
 */
export function Checker_getAugmentedPropertiesOfType(receiver, t) {
 ...
 * }
 */
export function Checker_TryGetMemberInModuleExportsAndProperties(receiver, memberName, moduleSymbol) {
 ...
 * }
 */
export function Checker_TryGetMemberInModuleExports(receiver, memberName, moduleSymbol) {
 ...
 * }
 */
export function Checker_shouldTreatPropertiesOfExternalModuleAsExports(receiver, resolvedExternalModuleType) {
    return (resolvedExternalModuleType.flags & TypeFlagsPrimitive) === 0 ||
        (resolvedExternalModuleType.objectFlags & ObjectFlagsClass) !== 0 ||
...
export function Checker_GetContextualType(receiver, node, contextFlags) {
    if ((contextFlags & ContextFlagsIgnoreNodeInferences) !== 0) {
        return runWithInferenceBlockedFromSourceNode(receiver, node, () => Checker_getContextualType(receiver, node, contextFlags));
    }
 ...
 * }
 */
export function GetResolvedSignatureForSignatureHelp(node, argumentCount, c) {
 ...
 * }
 */
export function Checker_SkipAlias(receiver, symbol_) {
 ...
 * }
 */
export function Checker_GetRootSymbols(receiver, symbol_) {
 ...
 * }
 */
export function Checker_GetMappedTypeSymbolOfProperty(receiver, symbol_) {
    const valueLinks = LinkStore_TryGet(receiver.valueSymbolLinks, symbol_);
    if (valueLinks !== undefined) {
        return Type_Symbol(valueLinks.containingType);
    }
    return undefined;
}
/**
 ...
 * }
 */
export function Checker_getImmediateRootSymbols(receiver, symbol_) {
    if ((symbol_.CheckFlags & CheckFlagsSynthetic) !== 0) {
        return MapNonNil(Type_Types(LinkStore_Get(receiver.valueSymbolLinks, symbol_).containingType), (t) => {
    ...
    if ((symbol_.Flags & SymbolFlagsTransient) !== 0) {
        if (LinkStore_Has(receiver.spreadLinks, symbol_)) {
            const leftSpread = LinkStore_Get(receiver.spreadLinks, symbol_).leftSpread;
            const rightSpread = LinkStore_Get(receiver.spreadLinks, symbol_).rightSpread;
            if (leftSpread !== undefined) {
                return [leftSpread, rightSpread];
            }
        }
        if (LinkStore_Has(receiver.mappedSymbolLinks, symbol_)) {
            const syntheticOrigin = LinkStore_Get(receiver.mappedSymbolLinks, symbol_).syntheticOrigin;
 ...
 * }
 */
export function Checker_tryGetTarget(receiver, symbol_) {
    let target = undefined;
    let next = symbol_;
    for (;;) {
        if (LinkStore_Has(receiver.valueSymbolLinks, next)) {
            next = LinkStore_Get(receiver.valueSymbolLinks, next).target;
        }
        else if (LinkStore_Has(receiver.exportTypeLinks, next)) {
            next = LinkStore_Get(receiver.exportTypeLinks, next).target;
        }
        else {
            next = undefined;
        }
 ...
 * }
 */
export function Checker_GetExportSymbolOfSymbol(receiver, symbol_) {
 ...
 * }
 */
export function Checker_GetExportSpecifierLocalTargetSymbol(receiver, node) {
    // node should be ExportSpecifier | Identifier
    switch (node.Kind) {
 ...
 * }
 */
export function Checker_GetShorthandAssignmentValueSymbol(receiver, location) {
 ...
 * }
 */
export function Checker_GetSymbolsOfParameterPropertyDeclaration(receiver, parameter, parameterName) {
 ...
 * }
 */
export function Checker_IsDeclarationUsed(receiver, sourceFile, identifier, jsxElementsPresent, jsxModeNeedsExplicitImport) {
    if (jsxElementsPresent && jsxModeNeedsExplicitImport) {
        const jsxNamespace = Checker_getJsxNamespace(receiver, sourceFile);
        const jsxFragmentFactory = Checker_GetJsxFragmentFactory(receiver, sourceFile);
    ...
    const symbol_ = Checker_GetSymbolAtLocation(receiver, identifier);
    if (symbol_ === undefined) {
        return true;
    }
 ...
 * }
 */
export function Checker_IsSymbolReferencedInFile(receiver, sourceFile, definition, symbol_) {
    const identifierText = definition.Text;
    for (const token of getPossibleSymbolReferenceNodes(sourceFile, identifierText, sourceFile)) {
 ...
 * }
 */
export function Checker_GetReferencesToSymbolInFile(receiver, sourceFile, symbol_) {
 ...
 * }
 */
export function Checker_getLocalSymbolForExportSpecifier(receiver, referenceLocation, referenceSymbol, exportSpecifier) {
    if (isExportSpecifierAlias(referenceLocation, exportSpecifier)) {
        const symbol_ = Checker_GetExportSpecifierLocalTargetSymbol(receiver, exportSpecifier);
        if (symbol_ !== undefined) {
            return symbol_;
        }
    }
 ...
 * }
 */
export function isExportSpecifierAlias(referenceLocation, exportSpecifier) {
 ...
 * }
 */
export function getPossibleSymbolReferenceNodes(sourceFile, symbolName, container) {
    return MapNonNil(getPossibleSymbolReferencePositions(sourceFile, symbolName, container), (pos) => {
 ...
 * }
 */
export function getPossibleSymbolReferencePositions(sourceFile, symbolName, container) {
    const positions = [];
    // TODO: Cache symbol existence for files to save text search
    // Also, need to make this work for unicode escapes.
    // Be resilient in the face of a symbol with no name or zero length name
    ...
    const containerNode = container ?? sourceFile;
 ...
 * }
 */
export function Checker_GetTypeArgumentConstraint(receiver, node) {
    if (!IsTypeNode(node)) {
        return undefined;
    }
 ...
 * }
 */
export function Checker_getUninstantiatedSignatures(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function Checker_getTypeParameterConstraintForPositionAcrossSignatures(receiver, signatures, position) {
...
export function Checker_getTypeArgumentConstraint(receiver, node) {
    ...
    if (typeArgumentPosition >= 0) {
        ...
        if (IsCallLikeExpression(node.Parent)) {
            return Checker_getTypeParameterConstraintForPositionAcrossSignatures(receiver, Checker_getUninstantiatedSignatures(receiver, node.Parent), typeArgumentPosition);
        }
        if (IsDecorator(node.Parent.Parent)) {
            return Checker_getTypeParameterConstraintForPositionAcrossSignatures(receiver, Checker_getUninstantiatedSignatures(receiver, node.Parent.Parent), typeArgumentPosition);
        }
        if (IsExpressionWithTypeArguments(node.Parent) && IsExpressionStatement(node.Parent.Parent)) {
            ...
            const callConstraint = Checker_getTypeParameterConstraintForPositionAcrossSignatures(receiver, Checker_getSignaturesOfType(receiver, uninstantiatedType, SignatureKindCall), typeArgumentPosition);
            const constructConstraint = Checker_getTypeParameterConstraintForPositionAcrossSignatures(receiver, Checker_getSignaturesOfType(receiver, uninstantiatedType, SignatureKindConstruct), typeArgumentPosition);
            // An instantiation expression instantiates both call and construct signatures, so
            // if both exist type arguments must be assignable to both constraints.
            if ((constructConstraint.flags & TypeFlagsNever) !== 0) {
                return callConstraint;
        ...
        if (IsTypeReferenceType(node.Parent)) {
            ...
            if (constraint !== undefined) {
                return Checker_instantiateType(receiver, constraint, newTypeMapper(typeParameters, Checker_getEffectiveTypeArguments(receiver, node.Parent, typeParameters)));
            }
        }
    }
    return undefined;
 ...
 * }
 */
export function Checker_IsTypeInvalidDueToUnionDiscriminant(receiver, contextualType, obj) {
    const properties = Node_Properties(obj) ?? [];
    return Some(properties, (property) => {
        let nameType = undefined;
 ...
 * }
 */
export function Checker_GetExportsAndPropertiesOfModule(receiver, moduleSymbol) {
 ...
 * }
 */
export function Checker_getExportsOfModuleAsArray(receiver, moduleSymbol) {
 ...
 * }
 */
export function Checker_GetJsxIntrinsicTagNamesAt(receiver, location) {
 ...
 * }
 */
export function Checker_GetContextualTypeForJsxAttribute(receiver, attribute) {
 ...
 * }
 */
export function Checker_GetConstantValue(receiver, node) {
    if (node.Kind === KindEnumMember) {
        return Checker_getEnumMemberValue(receiver, node).Value;
    }
    if (LinkStore_Get(receiver.symbolNodeLinks, node).resolvedSymbol === undefined) {
        Checker_checkExpressionCached(receiver, node); // ensure cached resolved symbol is set
    }
    let symbol_ = LinkStore_Get(receiver.symbolNodeLinks, node).resolvedSymbol;
    if (symbol_ === undefined && IsEntityNameExpression(node)) {
        symbol_ = Checker_resolveEntityName(receiver, node, SymbolFlagsValue, true, /*ignoreErrors*/ false, /*dontResolveAlias*/ undefined /*location*/);
    }
 ...
 * }
 */
export function Checker_getResolvedSignatureWorker(receiver, node, checkMode, argumentCount) {
 ...
 * }
 */
export function Checker_GetCandidateSignaturesForStringLiteralCompletions(receiver, call, editingArgument) {
    // first, get candidates when inference is blocked from the source node.
    let candidates = runWithInferenceBlockedFromSourceNode(receiver, editingArgument, () => {
        const [, blockedInferenceCandidates] = Checker_getResolvedSignatureWorker(receiver, call, CheckModeNormal, 0);
        return blockedInferenceCandidates;
    });
    ...
    const otherCandidates = runWithoutResolvedSignatureCaching(receiver, editingArgument, () => {
        const [, inferenceCandidates] = Checker_getResolvedSignatureWorker(receiver, call, CheckModeNormal, 0);
        return inferenceCandidates;
    });
 ...
 * }
 */
export function Checker_GetTypeAtPosition(receiver, s, pos) {
 ...
 * }
 */
export function Checker_GetTypeParameterAtPosition(receiver, s, pos) {
 ...
 * }
 */
export function Checker_GetContextualTypeForArrayLiteralAtPosition(receiver, contextualArrayType, arrayLiteral, position) {
    ...
    // The array may be incomplete, so we don't know its final length.
    return Checker_getContextualTypeForElementExpression(receiver, contextualArrayType, elementIndex, -1, /*length*/ firstSpreadIndex, lastSpreadIndex);
}
/**
 ...
 * }
 */
export let knownGenericTypeNames = new globalThis.Map([
    ["Array", {}],
    ["ArrayLike", {}],
    ["ReadonlyArray", {}],
    ["Promise", {}],
 ...
 * }
 */
export function isKnownGenericTypeName(name) {
 ...
 * }
 */
export function Checker_GetFirstTypeArgumentFromKnownType(receiver, t) {
    const tSym = t.symbol;
 ...
 * }
 */
export function Checker_GetPropertySymbolsFromContextualType(receiver, node, contextualType, unionSymbolOk) {
    ...
    if (IsObjectLiteralExpression(node.Parent) || IsJsxAttributes(node.Parent)) {
        filteredTypes = Filter(filteredTypes, (t) => {
            return !Checker_IsTypeInvalidDueToUnionDiscriminant(receiver, t, node.Parent);
        });
    }
    const discriminatedPropertySymbols = MapNonNil(filteredTypes, (t) => {
    ...
    if (filteredTypes.length === 0 && discriminatedPropertySymbols.length === 0) {
        // Bad discriminant -- do again without discriminating
        return MapNonNil(Type_Types(contextualType), (t) => {
            return Checker_getPropertyOfType(receiver, t, name);
        });
    }
    // by eliminating duplicates we might even end up with a single symbol
 ...
 * }
 */
export function Checker_GetPropertySymbolOfDestructuringAssignment(receiver, location) {
 ...
 * }
 */
export function Checker_getTypeOfAssignmentPattern(receiver, expr) {
    // If this is from "for of"
    //     for ( { a } of elems) {
    //     }
 ...
 * }
 */
export function Checker_GetSignatureFromDeclaration(receiver, node) {
 ...
 * }
 */
export function Checker_IsLibSymbolForHoverVerbosity(receiver, symbol_) {
    if (symbol_ === undefined) {
        return false;
    }
 ...
 * }
 */
export function Checker_IsLibTypeForHoverVerbosity(receiver, t) {
    let symbol_;
    if ((t.objectFlags & ObjectFlagsReference) !== 0) {
    ...
    if (Checker_IsLibSymbolForHoverVerbosity(receiver, symbol_)) {
        return true;
    }
    return isTupleType(t);
}
