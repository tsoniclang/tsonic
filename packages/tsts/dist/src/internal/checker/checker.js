...
import { Static_property_0_conflicts_with_built_in_property_Function_0_of_constructor_function_1, Duplicate_identifier_0_Compiler_reserves_name_1_in_top_level_scope_of_a_module, This_syntax_requires_an_imported_helper_named_1_which_does_not_exist_in_0_Consider_upgrading_your_version_of_0, This_syntax_requires_an_imported_helper_named_1_with_2_parameters_which_is_not_compatible_with_the_one_in_0_Consider_upgrading_your_version_of_0, This_syntax_requires_an_imported_helper_but_module_0_cannot_be_found, } from "../diagnostics/generated/messages.js";
import { ObjectFlagsReference, TypeFlagsNone, TypeFlagsNever, TypeFlagsUnion, TypeFlagsInstantiable, TypeFlagsNumberLike, TypeFlagsNumber, ElementFlagsNonRequired, ElementFlagsVariadic, externalHelpersModuleNameText, ExternalEmitHelpersFirstEmitHelper, ExternalEmitHelpersLastEmitHelper, ExternalEmitHelpersRest, ExternalEmitHelpersDecorate, ExternalEmitHelpersMetadata, ExternalEmitHelpersParam, ExternalEmitHelpersAwaiter, ExternalEmitHelpersAwait, ExternalEmitHelpersAsyncGenerator, ExternalEmitHelpersAsyncDelegator, ExternalEmitHelpersAsyncValues, ExternalEmitHelpersExportStar, ExternalEmitHelpersImportStar, ExternalEmitHelpersImportDefault, ExternalEmitHelpersMakeTemplateObject, ExternalEmitHelpersClassPrivateFieldGet, ExternalEmitHelpersClassPrivateFieldSet, ExternalEmitHelpersClassPrivateFieldIn, ExternalEmitHelpersSetFunctionName, ExternalEmitHelpersPropKey, ExternalEmitHelpersAddDisposableResourceAndDisposeResources, ExternalEmitHelpersRewriteRelativeImportExtension, LanguageFeatureMinimumTarget, Type_AsTupleType, Type_AsObjectType, Type_AsTypeReference, Type_AsIndexedAccessType, Type_TargetTupleType, } from "./types.js";
import { walkUpOuterExpressions } from "./utilities.js";
import { Checker_mergeSymbol, Checker_getMergedSymbol, Checker_getSymbolOfDeclaration, Checker_getEffectivePropertyNameForPropertyNameNode, Checker_getSymbolOfNode, Checker_needCollisionCheckForIdentifier, Checker_distributeObjectOverIndexType, Checker_distributeIndexOverObjectType, Checker_getMappedTypeNameTypeKind, Checker_substituteIndexedMappedType, Checker_resolveSymbol, Checker_getExportsOfModule, Checker_getSymbol, } from "./checker/symbols.js";
...
import { Checker_newObjectType, Checker_getPropagatingFlagsOfTypes, Checker_getTupleTargetType, Checker_checkCrossProductUnion, Checker_isGenericTupleType, Checker_isGenericMappedType, Checker_getElementTypeOfSliceOfTupleType, Checker_getSimplifiedType, Checker_mapType, TupleNormalizer_normalize, } from "./checker/types.js";
 ...
 * }
 */
export function Checker_mergeGlobalSymbol(receiver, symbol_) {
    const globalSymbol = receiver.globals.get(symbol_.Name);
    let merged;
    if (globalSymbol !== undefined) {
        merged = Checker_mergeSymbol(receiver, globalSymbol, symbol_, false);
    }
    else {
 ...
 * }
 */
export function Checker_checkClassForStaticPropertyNameConflicts(receiver, node) {
    ...
    for (const member of Node_Members(node) ?? []) {
        ...
        if (isStaticMember && memberNameNode !== undefined) {
            const [memberName] = Checker_getEffectivePropertyNameForPropertyNameNode(receiver, memberNameNode);
            switch (memberName) {
                case "name":
                case "length":
                case "caller":
                case "arguments":
                    Checker_error(receiver, memberNameNode, Static_property_0_conflicts_with_built_in_property_Function_0_of_constructor_function_1, memberName, Checker_symbolToString(receiver, Checker_getSymbolOfDeclaration(receiver, node)));
                    break;
            }
        }
    }
 ...
 * }
 */
export function Checker_getFirstTransformableStaticClassElement(receiver, node) {
    ...
    const willTransformPrivateElementsOrClassStaticBlocks = (receiver.languageVersion < LanguageFeatureMinimumTarget.PrivateNamesAndClassStaticBlocks || receiver.languageVersion < LanguageFeatureMinimumTarget.ClassAndClassElementDecorators);
    const willTransformInitializers = (!receiver.emitStandardClassFields);
    if (willTransformStaticElementsOfDecoratedClass || willTransformPrivateElementsOrClassStaticBlocks) {
        for (const member of Node_Members(node) ?? []) {
 ...
 * }
 */
export function Checker_checkClassExpressionExternalHelpers(receiver, node) {
    ...
    const willTransformESDecorators = (!receiver.legacyDecorators && receiver.languageVersion < LanguageFeatureMinimumTarget.ClassAndClassElementDecorators);
    let location;
 ...
 * }
 */
export function Checker_checkCollisionWithGlobalObjectInGeneratedCode(receiver, node, name) {
 ...
 * }
 */
export function Checker_addDiagnostic(receiver, diagnostic) {
    // Discard diagnostics created while at the maximum number of recursive TypeToString invocations.
 ...
 * }
 */
export function Checker_addSuggestionDiagnostic(receiver, diagnostic) {
    // Discard diagnostics created while at the maximum number of recursive TypeToString invocations.
    if (receiver.serializationLevel < maxSerializationLevel) {
 ...
 * }
 */
export function Checker_hasParentWithTypeAnnotation(receiver, symbol_) {
    if (symbol_.Parent !== undefined && symbol_.Parent.ValueDeclaration !== undefined && IsFunctionExpressionOrArrowFunction(symbol_.Parent.ValueDeclaration)) {
        ...
        if (possiblyAnnotatedSymbol !== undefined && possiblyAnnotatedSymbol.ValueDeclaration !== undefined) {
            return (Node_Type(possiblyAnnotatedSymbol.ValueDeclaration) !== undefined);
        }
    }
    return false;
}
 ...
 * }
 */
export function Checker_containsSameNamedThisProperty(receiver, thisProperty, expression) {
    const visit = (node) => {
 ...
 * }
 */
export function Checker_createNormalizedTupleTypeEx(receiver, target, elementTypes, objectFlags) {
    ...
    if ((d.combinedFlags & ElementFlagsVariadic) !== 0) {
        for (let i = 0; i < elementTypes.length; i++) {
            ...
            if (i < d.elementInfos.length && (d.elementInfos[i].flags & ElementFlagsVariadic) !== 0 && (e.flags & (TypeFlagsNever | TypeFlagsUnion)) !== 0) {
                // Transform [A, ...(X | Y | Z)] into [A, ...X] | [A, ...Y] | [A, ...Z]
                const checkTypes = core.MapIndex(elementTypes, (t, ti) => {
                ...
                if (Checker_checkCrossProductUnion(receiver, checkTypes)) {
                    return Checker_mapType(receiver, e, (t) => Checker_createNormalizedTupleTypeEx(receiver, target, core.ReplaceElement(elementTypes, i, t), objectFlags));
                }
            }
        }
    }
 ...
 * }
 */
export function Checker_createTypeReferenceEx(receiver, target, typeArguments, objectFlags) {
    ...
    const t = Checker_newObjectType(receiver, (ObjectFlagsReference | objectFlags | Checker_getPropagatingFlagsOfTypes(receiver, typeArguments, TypeFlagsNone)), target["symbol"]);
 ...
 * }
 */
export function Checker_getSimplifiedIndexedAccessTypeWorker(receiver, t, writing) {
    // We recursively simplify the object type as it may in turn be an indexed access type. For example, with
    // '{ [P in T]: { [Q in U]: number } }[T][U]' we want to first simplify the inner indexed access type.
    ...
    if (Checker_isGenericTupleType(receiver, objectType) && (indexType.flags & TypeFlagsNumberLike) !== 0) {
        const elementType = Checker_getElementTypeOfSliceOfTupleType(receiver, objectType, core.IfElse((indexType.flags & TypeFlagsNumber) !== 0, 0, Type_TargetTupleType(objectType).fixedLength), 0, writing, false);
    ...
    if (Checker_isGenericMappedType(receiver, objectType)) {
        if (Checker_getMappedTypeNameTypeKind(receiver, objectType) !== MappedTypeNameTypeKindRemapping) {
            return Checker_mapType(receiver, Checker_substituteIndexedMappedType(receiver, objectType, Type_AsIndexedAccessType(t).indexType), (t2) => Checker_getSimplifiedType(receiver, t2, writing));
        }
    }
    return t;
}
 ...
 * }
 */
export function isPartOfImportEqualsModuleReference(location) {
    const importEquals = FindAncestorKind(location, KindImportEqualsDeclaration);
    if (importEquals === undefined) {
        return false;
    }
    for (let node = location; node !== undefined && node !== importEquals; node = node.Parent) {
 ...
 * }
 */
export function Checker_checkExternalEmitHelpers(receiver, location, helpers) {
    ...
    if ((links.requestedExternalEmitHelpers & helpers) !== helpers) {
        ...
        for (let helper = ExternalEmitHelpersFirstEmitHelper; helper <= ExternalEmitHelpersLastEmitHelper; helper = (helper << 1)) {
            if ((uncheckedHelpers & helper) === 0) {
                continue;
            }
            for (const name of Checker_getHelperNames(receiver, helper)) {
                ...
                if (symbol_ === undefined) {
                    ...
                    if (!Checker_hasSignatureWithArityGreaterThan(receiver, symbol_, 3)) {
                    ...
                    if (!Checker_hasSignatureWithArityGreaterThan(receiver, symbol_, 4)) {
 ...
 * }
 */
export function Checker_hasSignatureWithArityGreaterThan(receiver, symbol_, arity) {
 ...
 * }
 */
export function Checker_getHelperNames(receiver, helper) {
    switch (helper) {
        case ExternalEmitHelpersRest:
            return ["__rest"];
        case ExternalEmitHelpersDecorate:
 ...
 * }
 */
export function Checker_resolveHelpersModule(receiver, file, errorNode) {
    ...
    if (links.externalHelpersModule === undefined) {
        ...
        let helpersModule = Checker_resolveExternalModule(receiver, location, externalHelpersModuleNameText, This_syntax_requires_an_imported_helper_but_module_0_cannot_be_found, errorNode, false);
