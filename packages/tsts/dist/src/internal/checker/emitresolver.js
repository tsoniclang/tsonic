...
export function EmitResolver_as_printer_EmitResolver(receiver) {
    return {
        GetReferencedExportContainer: (node, prefixLocals) => EmitResolver_GetReferencedExportContainer(receiver, node, prefixLocals),
        GetReferencedImportDeclaration: (node) => EmitResolver_GetReferencedImportDeclaration(receiver, node),
        GetReferencedMemberValueDeclaration: (node) => EmitResolver_GetReferencedMemberValueDeclaration(receiver, node),
        GetReferencedValueDeclaration: (node) => EmitResolver_GetReferencedValueDeclaration(receiver, node),
        GetReferencedValueDeclarations: (node) => EmitResolver_GetReferencedValueDeclarations(receiver, node),
        GetElementAccessExpressionName: (expression) => EmitResolver_GetElementAccessExpressionName(receiver, expression),
        IsReferencedAliasDeclaration: (node) => EmitResolver_IsReferencedAliasDeclaration(receiver, node),
        IsValueAliasDeclaration: (node) => EmitResolver_IsValueAliasDeclaration(receiver, node),
        IsTopLevelValueImportEqualsWithEntityName: (node) => EmitResolver_IsTopLevelValueImportEqualsWithEntityName(receiver, node),
        MarkLinkedReferencesRecursively: (file) => EmitResolver_MarkLinkedReferencesRecursively(receiver, file),
        GetExternalModuleFileFromDeclaration: (node) => EmitResolver_GetExternalModuleFileFromDeclaration(receiver, node),
        GetEffectiveDeclarationFlags: (node, flags) => EmitResolver_GetEffectiveDeclarationFlags(receiver, node, flags),
        GetResolutionModeOverride: (node) => EmitResolver_GetResolutionModeOverride(receiver, node),
        GetTypeReferenceSerializationKind: (name, serialScope) => EmitResolver_GetTypeReferenceSerializationKind(receiver, name, serialScope),
        GetConstantValue: (node) => EmitResolver_GetConstantValue(receiver, node),
        GetJsxFactoryEntity: (location) => EmitResolver_GetJsxFactoryEntity(receiver, location),
        GetJsxFragmentFactoryEntity: (location) => EmitResolver_GetJsxFragmentFactoryEntity(receiver, location),
        SetReferencedImportDeclaration: (node, ref) => EmitResolver_SetReferencedImportDeclaration(receiver, node, ref),
        PrecalculateDeclarationEmitVisibility: (file) => EmitResolver_PrecalculateDeclarationEmitVisibility(receiver, file),
        IsSymbolAccessible: (symbol_, enclosingDeclaration, meaning, shouldComputeAliasToMarkVisible) => EmitResolver_IsSymbolAccessible(receiver, symbol_, enclosingDeclaration, meaning, shouldComputeAliasToMarkVisible),
        IsEntityNameVisible: (entityName, enclosingDeclaration) => EmitResolver_IsEntityNameVisible(receiver, entityName, enclosingDeclaration),
        IsExpandoFunctionDeclaration: (node) => EmitResolver_IsExpandoFunctionDeclaration(receiver, node),
        IsExpandoFunctionDeclarationUnsafe: (node) => EmitResolver_IsExpandoFunctionDeclarationUnsafe(receiver, node),
        IsLiteralConstDeclaration: (node) => EmitResolver_IsLiteralConstDeclaration(receiver, node),
        RequiresAddingImplicitUndefined: (node, symbol_, enclosingDeclaration) => EmitResolver_RequiresAddingImplicitUndefined(receiver, node, symbol_, enclosingDeclaration),
        IsDeclarationVisible: (node) => EmitResolver_IsDeclarationVisible(receiver, node),
        IsImportRequiredByAugmentation: (decl) => EmitResolver_IsImportRequiredByAugmentation(receiver, decl),
        IsDefinitelyReferenceToGlobalSymbolObject: (node) => EmitResolver_IsDefinitelyReferenceToGlobalSymbolObject(receiver, node),
        IsImplementationOfOverload: (node) => EmitResolver_IsImplementationOfOverload(receiver, node),
        GetEnumMemberValue: (node) => EmitResolver_GetEnumMemberValue(receiver, node),
        IsLateBound: (node) => EmitResolver_IsLateBound(receiver, node),
        IsOptionalParameter: (node) => EmitResolver_IsOptionalParameter(receiver, node),
        GetBaseDeclarationsForPropertyDeclaration: (node) => EmitResolver_GetBaseDeclarationsForPropertyDeclaration(receiver, node),
        GetPropertiesOfContainerFunction: (node) => EmitResolver_GetPropertiesOfContainerFunction(receiver, node),
        RequiresAddingImplicitUndefinedUnsafe: (node, symbol_, enclosingDeclaration) => EmitResolver_RequiresAddingImplicitUndefinedUnsafe(receiver, node, symbol_, enclosingDeclaration),
        CreateTypeOfDeclaration: (emitContext, declaration, enclosingDeclaration, flags, internalFlags, tracker) => EmitResolver_CreateTypeOfDeclaration(receiver, emitContext, declaration, enclosingDeclaration, flags, internalFlags, tracker),
        CreateReturnTypeOfSignatureDeclaration: (emitContext, signatureDeclaration, enclosingDeclaration, flags, internalFlags, tracker) => EmitResolver_CreateReturnTypeOfSignatureDeclaration(receiver, emitContext, signatureDeclaration, enclosingDeclaration, flags, internalFlags, tracker),
        CreateTypeParametersOfSignatureDeclaration: (emitContext, signatureDeclaration, enclosingDeclaration, flags, internalFlags, tracker) => EmitResolver_CreateTypeParametersOfSignatureDeclaration(receiver, emitContext, signatureDeclaration, enclosingDeclaration, flags, internalFlags, tracker),
        CreateLiteralConstValue: (emitContext, node, tracker) => EmitResolver_CreateLiteralConstValue(receiver, emitContext, node, tracker),
        CreateTypeOfExpression: (emitContext, expression, enclosingDeclaration, flags, internalFlags, tracker) => EmitResolver_CreateTypeOfExpression(receiver, emitContext, expression, enclosingDeclaration, flags, internalFlags, tracker),
        CreateLateBoundIndexSignatures: (emitContext, container, enclosingDeclaration, flags, internalFlags, tracker) => EmitResolver_CreateLateBoundIndexSignatures(receiver, emitContext, container, enclosingDeclaration, flags, internalFlags, tracker),
        TryJSTypeNodeToTypeNode: (emitContext, typeNode, enclosingDeclaration, flags, internalFlags, tracker) => EmitResolver_TryJSTypeNodeToTypeNode(receiver, emitContext, typeNode, enclosingDeclaration, flags, internalFlags, tracker),
    };
}
/**
 ...
 */
export let __69112d2a_0 = EmitResolver_as_printer_EmitResolver(undefined);
/**
...
export function newEmitResolver(checker) {
    const e = {
        ...
        isValueAliasDeclaration: (node) => EmitResolver_isValueAliasDeclarationWorker(e, node),
        aliasMarkingVisitor: (node) => EmitResolver_aliasMarkingVisitorWorker(e, node),
        referenceResolver: undefined,
        jsxLinks: { entries: new Map(), arena: { data: [] } },
        declarationLinks: { entries: new Map(), arena: { data: [] } },
        declarationFileLinks: { entries: new Map(), arena: { data: [] } },
    };
    return e;
}
/**
 ...
 * }
 */
export function EmitResolver_GetJsxFactoryEntity(receiver, location) {
 ...
 * }
 */
export function EmitResolver_GetJsxFragmentFactoryEntity(receiver, location) {
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_IsOptionalParameter(receiver, node) {
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_GetBaseDeclarationsForPropertyDeclaration(receiver, node) {
    if (node === undefined) {
        return [];
    }
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_IsLateBound(receiver, node) {
    if (node === undefined) {
        return false;
    }
    ...
    return ((symbol_.CheckFlags & CheckFlagsLate) !== 0);
}
/**
 ...
 * }
 */
export function EmitResolver_GetEnumMemberValue(receiver, node) {
    if (!IsParseTreeNode(node)) {
    ...
    const result = LinkStore_Get(receiver.checker.enumMemberLinks, node).value;
    receiver.checkerMu.Unlock();
    return result;
}
/**
 ...
 * }
 */
export function EmitResolver_IsDeclarationVisible(receiver, node) {
    receiver.checkerMu.Lock();
...
export function EmitResolver_isDeclarationVisible(receiver, node) {
    ...
    const links = LinkStore_Get(receiver.declarationLinks, node);
    ...
    return ((links.isVisible ?? TSUnknown) === TSTrue);
}
/**
 ...
 * }
 */
export function EmitResolver_determineIfDeclarationIsVisible(receiver, node) {
    switch (node.Kind) {
        case KindJSDocCallbackTag:
        case KindJSDocTypedefTag:
            return (node.Parent !== undefined && node.Parent.Parent !== undefined && node.Parent.Parent.Parent !== undefined && IsSourceFile(node.Parent.Parent.Parent));
        ...
        case KindMethodSignature:
            if (Checker_GetEffectiveDeclarationFlags(receiver.checker, node, (ModifierFlagsPrivate | ModifierFlagsProtected)) !== 0) {
                return false;
            }
 ...
 * }
 */
export function EmitResolver_PrecalculateDeclarationEmitVisibility(receiver, file) {
    receiver.checkerMu.Lock();
    const fileLinks = LinkStore_Get(receiver.declarationFileLinks, file);
    if (fileLinks.aliasesMarked) {
        receiver.checkerMu.Unlock();
        return;
    }
    fileLinks.aliasesMarked = true;
    Node_ForEachChild(file, receiver.aliasMarkingVisitor);
    receiver.checkerMu.Unlock();
}
/**
 ...
 * }
 */
export function isCommonJSModuleExports(node) {
 ...
 * }
 */
export function EmitResolver_aliasMarkingVisitorWorker(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function EmitResolver_markLinkedAliases(receiver, node) {
    let exportSymbol = undefined;
    if (node.Kind !== KindStringLiteral && node.Parent !== undefined && (IsExportAssignment(node.Parent) || isCommonJSModuleExports(node.Parent))) {
        exportSymbol = receiver.checker.resolveName(node, Node_Text(node) ?? "", (SymbolFlagsValue | SymbolFlagsType | SymbolFlagsNamespace | SymbolFlagsAlias), undefined, false, false);
    }
    else if (node.Parent.Kind === KindExportSpecifier) {
        exportSymbol = Checker_getTargetOfExportSpecifier(receiver.checker, node.Parent, (SymbolFlagsValue | SymbolFlagsType | SymbolFlagsNamespace | SymbolFlagsAlias), false);
    }
    ...
    while (exportSymbol !== undefined) {
        ...
        for (const declaration of exportSymbol.Declarations ?? []) {
            LinkStore_Get(receiver.declarationLinks, declaration).isVisible = TSTrue;
            if (IsInternalModuleImportEqualsDeclaration(declaration)) {
                const internalModuleReference = AsImportEqualsDeclaration(declaration).ModuleReference;
                const firstIdentifier = GetFirstIdentifier(internalModuleReference);
                const importSymbol = receiver.checker.resolveName(declaration, Node_Text(firstIdentifier) ?? "", (SymbolFlagsValue | SymbolFlagsType | SymbolFlagsNamespace | SymbolFlagsAlias), undefined, false, false);
                nextSymbol = importSymbol;
            }
        }
        exportSymbol = nextSymbol;
 ...
 * }
 */
export function getMeaningOfEntityNameReference(entityName) {
 ...
 * }
 */
export function EmitResolver_IsEntityNameVisible(receiver, entityName, enclosingDeclaration) {
    receiver.checkerMu.Lock();
    const result = EmitResolver_isEntityNameVisible(receiver, entityName, enclosingDeclaration, true);
    receiver.checkerMu.Unlock();
    return result;
}
/**
 ...
 * }
 */
export function EmitResolver_isEntityNameVisible(receiver, entityName, enclosingDeclaration, shouldComputeAliasToMakeVisible) {
    ...
    const symbol_ = receiver.checker.resolveName(enclosingDeclaration, Node_Text(firstIdentifier) ?? "", meaning, undefined, false, false);
    ...
    if (symbol_ === undefined && IsThisIdentifier(firstIdentifier)) {
        const sym = Checker_getSymbolOfDeclaration(receiver.checker, Checker_getThisContainer(receiver.checker, firstIdentifier, false, false));
        if (EmitResolver_isSymbolAccessible(receiver, sym, enclosingDeclaration, meaning, false).Accessibility === SymbolAccessibilityAccessible) {
            return { Accessibility: SymbolAccessibilityAccessible, AliasesToMakeVisible: [], ErrorSymbolName: "", ErrorNode: undefined, ErrorModuleName: "" };
        }
    }
    if (symbol_ === undefined) {
 ...
 */
export function noopAddVisibleAlias(declaration, aliasingStatement) { }
/**
 ...
 * }
 */
export function EmitResolver_hasVisibleDeclarations(receiver, symbol_, shouldComputeAliasToMakeVisible) {
    let aliasesToMakeVisibleSet = undefined;
    let addVisibleAlias;
    if (shouldComputeAliasToMakeVisible) {
        addVisibleAlias = (declaration, aliasingStatement) => {
            LinkStore_Get(receiver.declarationLinks, declaration).isVisible = TSTrue;
            if (aliasesToMakeVisibleSet === undefined) {
                aliasesToMakeVisibleSet = new Map();
            }
        ...
        if (!EmitResolver_isDeclarationVisible(receiver, declaration)) {
            ...
            if (IsBindingElement(declaration)) {
                ...
                if ((symbol_.Flags & SymbolFlagsBlockScopedVariable) !== 0) {
                    ...
                    if (!EmitResolver_isDeclarationVisible(receiver, variableStatement.Parent)) {
                        return undefined;
                    }
                    addVisibleAlias(declaration, variableStatement);
                    continue;
    ...
    const aliasesMap = aliasesToMakeVisibleSet;
    const aliasesToMakeVisible = aliasesMap !== undefined ? Array.from(aliasesMap.values()) : [];
 ...
 * }
 */
export function EmitResolver_IsImplementationOfOverload(receiver, node) {
    if (!IsParseTreeNode(node)) {
        return false;
    }
    if (NodeIsPresent(Node_Body(node))) {
 ...
 * }
 */
export function EmitResolver_IsImportRequiredByAugmentation(receiver, decl) {
    if (!IsParseTreeNode(decl)) {
        return false;
    }
    const file = GetSourceFileOfNode(decl);
    if (file === undefined || Node_Symbol(file) === undefined) {
        return false;
    }
    const importTarget = EmitResolver_GetExternalModuleFileFromDeclaration(receiver, decl);
    ...
    receiver.checkerMu.Lock();
    const exports = Checker_getExportsOfModule(receiver.checker, Node_Symbol(file));
 ...
 * }
 */
export function EmitResolver_IsDefinitelyReferenceToGlobalSymbolObject(receiver, node) {
    ...
    if (Node_Expression(node).Kind === KindIdentifier) {
        if (Node_Text(Node_Expression(node)) !== "Symbol") {
            return false;
        }
        receiver.checkerMu.Lock();
        const result = (Checker_getResolvedSymbol(receiver.checker, Node_Expression(node)) === Checker_getGlobalSymbol(receiver.checker, "Symbol", (SymbolFlagsValue | SymbolFlagsExportValue), undefined));
        receiver.checkerMu.Unlock();
        return result;
    }
    ...
    receiver.checkerMu.Lock();
    const result = (Checker_getResolvedSymbol(receiver.checker, Node_Expression(Node_Expression(node))) === receiver.checker.globalThisSymbol);
    receiver.checkerMu.Unlock();
    return result;
}
/**
 ...
 * }
 */
export function EmitResolver_RequiresAddingImplicitUndefined(receiver, declaration, symbol_, enclosingDeclaration) {
 ...
 * }
 */
export function EmitResolver_RequiresAddingImplicitUndefinedUnsafe(receiver, declaration, symbol_, enclosingDeclaration) {
    if (!IsParseTreeNode(declaration)) {
        return false;
    }
    ...
    switch (declaration.Kind) {
        ...
        case KindJSDocPropertyTag: {
            ...
            return ((symbol_.Flags & SymbolFlagsProperty) !== 0) &&
                ...
                LinkStore_Has(receiver.checker.ReverseMappedSymbolLinks, symbol_) &&
                (LinkStore_Get(receiver.checker.ReverseMappedSymbolLinks, symbol_).mappedType !== undefined) &&
                containsNonMissingUndefinedType(receiver.checker, t);
        }
        case KindParameter:
 ...
 * }
 */
export function EmitResolver_requiresAddingImplicitUndefinedWorker(receiver, parameter, enclosingDeclaration) {
    return ((EmitResolver_isRequiredInitializedParameter(receiver, parameter, enclosingDeclaration) || EmitResolver_isOptionalUninitializedParameterProperty(receiver, parameter)) && !EmitResolver_declaredParameterTypeContainsUndefined(receiver, parameter));
}
/**
 ...
 * }
 */
export function EmitResolver_declaredParameterTypeContainsUndefined(receiver, parameter) {
    const typeNode = Node_Type(parameter);
    if (typeNode === undefined) {
        return false;
    }
    const t = Checker_getTypeFromTypeNode(receiver.checker, typeNode);
    return (Checker_isErrorType(receiver.checker, t) || Checker_containsUndefinedType(receiver.checker, t));
}
/**
 ...
 * }
 */
export function EmitResolver_isOptionalUninitializedParameterProperty(receiver, parameter) {
 ...
 * }
 */
export function EmitResolver_isRequiredInitializedParameter(receiver, parameter, enclosingDeclaration) {
    ...
    if (HasSyntacticModifier(parameter, ModifierFlagsParameterPropertyModifier)) {
        return (enclosingDeclaration !== undefined && IsFunctionLikeDeclaration(enclosingDeclaration));
    }
    return true;
}
/**
 ...
 * }
 */
export function EmitResolver_IsLiteralConstDeclaration(receiver, node) {
    if (!IsParseTreeNode(node)) {
        return false;
    }
    if (isDeclarationReadonly(node) || (IsVariableDeclaration(node) && IsVarConst(node))) {
        receiver.checkerMu.Lock();
        const result = isFreshLiteralType(Checker_getTypeOfSymbol(receiver.checker, Checker_getSymbolOfDeclaration(receiver.checker, node)));
        receiver.checkerMu.Unlock();
        return result;
    }
    return false;
 ...
 * }
 */
export function EmitResolver_IsExpandoFunctionDeclarationUnsafe(receiver, node) {
    if (!IsParseTreeNode(node)) {
        return false;
    }
 ...
 * }
 */
export function EmitResolver_IsExpandoFunctionDeclaration(receiver, node) {
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_isSymbolAccessible(receiver, symbol_, enclosingDeclaration, meaning, shouldComputeAliasToMarkVisible) {
 ...
 * }
 */
export function EmitResolver_IsReferencedAliasDeclaration(receiver, node) {
    ...
    if (IsAliasSymbolDeclaration(node)) {
        ...
        if (symbol !== undefined) {
            const aliasLinks = LinkStore_Get(c.aliasSymbolLinks, symbol);
            if (aliasLinks.referenced) {
                result = true;
            }
            else {
 ...
 * }
 */
export function EmitResolver_IsValueAliasDeclaration(receiver, node) {
    const c = receiver.checker;
    if (!c.canCollectSymbolAliasAccessibilityData || !IsParseTreeNode(node)) {
        return true;
    }
 ...
 * }
 */
export function EmitResolver_isValueAliasDeclarationWorker(receiver, node) {
    const c = receiver.checker;
    switch (node.Kind) {
        case KindImportEqualsDeclaration:
            return EmitResolver_isAliasResolvedToValue(receiver, Checker_getSymbolOfDeclaration(c, node), false);
        case KindImportClause:
        case KindNamespaceImport:
        case KindImportSpecifier:
        case KindExportSpecifier: {
            const symbol = Checker_getSymbolOfDeclaration(c, node);
            return (symbol !== undefined && EmitResolver_isAliasResolvedToValue(receiver, symbol, true));
        }
        case KindExportDeclaration: {
            ...
            return (exportClause !== undefined && (IsNamespaceExport(exportClause) ||
                Some(Node_Elements(exportClause) ?? [], receiver.isValueAliasDeclaration)));
        }
        case KindExportAssignment: {
            if (Node_Expression(node) !== undefined && Node_Expression(node).Kind === KindIdentifier) {
                return EmitResolver_isAliasResolvedToValue(receiver, Checker_getSymbolOfDeclaration(c, node), true);
            }
            return true;
        }
        case KindBinaryExpression: {
 ...
 * }
 */
export function EmitResolver_isAliasResolvedToValue(receiver, symbol_, excludeTypeOnlyValues) {
    const c = receiver.checker;
    if (symbol_ === undefined) {
        return false;
    }
    if (symbol_.ValueDeclaration !== undefined) {
        ...
        if (container !== undefined) {
            const fileSymbol = Checker_getSymbolOfDeclaration(c, container);
            Checker_resolveExternalModuleSymbol(c, fileSymbol, false);
        }
    }
    const target = Checker_getExportSymbolOfValueSymbolIfExported(c, Checker_resolveAlias(c, symbol_));
    if (target === c.unknownSymbol) {
        return (!excludeTypeOnlyValues || Checker_getTypeOnlyAliasDeclaration(c, symbol_) === undefined);
    }
    return ((Checker_getSymbolFlagsEx(c, symbol_, excludeTypeOnlyValues, true) & SymbolFlagsValue) !== 0 &&
        (CompilerOptions_ShouldPreserveConstEnums(c.compilerOptions) || !isConstEnumOrConstEnumOnlyModule(target)));
}
/**
 ...
 * }
 */
export function EmitResolver_IsTopLevelValueImportEqualsWithEntityName(receiver, node) {
    const c = receiver.checker;
    if (!c.canCollectSymbolAliasAccessibilityData) {
        return true;
    }
    ...
    receiver.checkerMu.Lock();
    const result = EmitResolver_isAliasResolvedToValue(receiver, Checker_getSymbolOfDeclaration(c, node), false);
    receiver.checkerMu.Unlock();
    return result;
}
/**
 ...
 * }
 */
export function EmitResolver_MarkLinkedReferencesRecursively(receiver, file) {
    receiver.checkerMu.Lock();
    try {
        if (file !== undefined) {
            const pending = [];
            const pushChildrenInVisitOrder = (children) => {
                for (let index = children.length - 1; index >= 0; index--) {
                    pending.push(children[index]);
                }
            };
            const sourceChildren = [];
            SourceFile_ForEachChild(file, (n) => {
 ...
 * }
 */
export function EmitResolver_GetExternalModuleFileFromDeclaration(receiver, declaration) {
    if (!IsParseTreeNode(declaration)) {
        return undefined;
    }
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_getReferenceResolver(receiver) {
 ...
 * }
 */
export function EmitResolver_GetReferencedExportContainer(receiver, node, prefixLocals) {
    if (!IsParseTreeNode(node)) {
        return undefined;
    }
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_SetReferencedImportDeclaration(receiver, node, ref) {
    receiver.checkerMu.Lock();
    LinkStore_Get(receiver.jsxLinks, node).importRef = ref;
    receiver.checkerMu.Unlock();
}
/**
 ...
 * }
 */
export function EmitResolver_GetReferencedMemberValueDeclaration(receiver, node) {
    if (!IsParseTreeNode(node)) {
        return undefined;
    }
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_GetReferencedImportDeclaration(receiver, node) {
    receiver.checkerMu.Lock();
    if (!IsParseTreeNode(node)) {
        const result = LinkStore_Get(receiver.jsxLinks, node).importRef;
        receiver.checkerMu.Unlock();
        return result;
    }
    const symbol = Checker_getReferencedValueOrAliasSymbol(receiver.checker, node);
    let result = undefined;
    if (IsNonLocalAlias(symbol, SymbolFlagsValue) && Checker_getTypeOnlyAliasDeclarationEx(receiver.checker, symbol, SymbolFlagsValue) === undefined) {
        result = Checker_getDeclarationOfAliasSymbol(receiver.checker, symbol);
    }
    receiver.checkerMu.Unlock();
    return result;
}
 ...
 * }
 */
export function EmitResolver_GetReferencedValueDeclaration(receiver, node) {
    if (!IsParseTreeNode(node)) {
        return undefined;
    }
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_GetReferencedValueDeclarations(receiver, node) {
    if (!IsParseTreeNode(node)) {
        return [];
    }
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_GetElementAccessExpressionName(receiver, expression) {
    if (!IsParseTreeNode(Node_AsNode(expression))) {
        return "";
    }
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_CreateReturnTypeOfSignatureDeclaration(receiver, emitContext, signatureDeclaration, enclosingDeclaration, flags, internalFlags, tracker) {
 ...
 * }
 */
export function EmitResolver_CreateTypeParametersOfSignatureDeclaration(receiver, emitContext, signatureDeclaration, enclosingDeclaration, flags, internalFlags, tracker) {
    const original = EmitContext_ParseNode(emitContext, signatureDeclaration);
    if (original === undefined) {
        return [];
    }
 ...
 * }
 */
export function EmitResolver_CreateTypeOfDeclaration(receiver, emitContext, declaration, enclosingDeclaration, flags, internalFlags, tracker) {
    ...
    const result = NodeBuilder_SerializeTypeForDeclaration(requestNodeBuilder, declaration, symbol_, enclosingDeclaration, (flags | FlagsMultilineObjectLiterals), internalFlags, tracker);
    receiver.checkerMu.Unlock();
    return result;
}
/**
 ...
 * }
 */
export function EmitResolver_CreateLiteralConstValue(receiver, emitContext, node, tracker) {
    ...
    // PseudoBigInt object
    return NewBigIntLiteral(astFactory, pseudoBigIntToString(value) + "n", TokenFlagsNone);
}
/**
 ...
 * }
 */
export function EmitResolver_CreateTypeOfExpression(receiver, emitContext, expression, enclosingDeclaration, flags, internalFlags, tracker) {
    ...
    receiver.checkerMu.Lock();
    const requestNodeBuilder = NewNodeBuilder(receiver.checker, emitContext);
    const result = NodeBuilder_SerializeTypeForExpression(requestNodeBuilder, expression, enclosingDeclaration, (flags | FlagsMultilineObjectLiterals), internalFlags, tracker);
    receiver.checkerMu.Unlock();
    return result;
}
/**
 ...
 * }
 */
export function EmitResolver_CreateLateBoundIndexSignatures(receiver, emitContext, container, enclosingDeclaration, flags, internalFlags, tracker) {
    ...
    for (let index = 0; index < 2; index++) {
        ...
        for (const info of infoList) {
            ...
            if (info.components.length !== 0) {
                const allComponentComputedNamesSerializable = enclosingDeclaration !== undefined && Every(info.components, (component) => {
                ...
                if (allComponentComputedNamesSerializable) {
                    for (const component of info.components) {
                        ...
                        const name = receiver.checker.resolveName(firstIdentifier, Node_Text(firstIdentifier), (SymbolFlagsValue | SymbolFlagsExportValue), undefined, true, false);
                        if (name !== undefined) {
                            tracker.TrackSymbol(name, enclosingDeclaration, SymbolFlagsValue);
                        }
                        const mods = isStatic ? [NodeFactory_NewModifier(emitContext.Factory.__tsgoEmbedded0, KindStaticKeyword)] : [];
                        if (info.isReadonly) {
                            mods.push(NodeFactory_NewModifier(emitContext.Factory.__tsgoEmbedded0, KindReadonlyKeyword));
                        }
                        const decl = NewPropertyDeclaration(emitContext.Factory.__tsgoEmbedded0, mods.length !== 0 ? NodeFactory_NewModifierList(emitContext.Factory.__tsgoEmbedded0, mods) : undefined, Node_Name(component), Node_QuestionToken(component), NodeBuilder_TypeToTypeNode(requestNodeBuilder, Checker_getTypeOfSymbol(receiver.checker, Node_Symbol(component)), enclosingDeclaration, flags, internalFlags, tracker), undefined);
                        result.push(decl);
                    }
                    continue;
                }
            ...
            if (node !== undefined && isStatic) {
                const modNodes = [NodeFactory_NewModifier(emitContext.Factory.__tsgoEmbedded0, KindStaticKeyword), ...(Node_ModifierNodes(node) ?? [])];
                const mods = NodeFactory_NewModifierList(emitContext.Factory.__tsgoEmbedded0, modNodes);
                node = NodeFactory_UpdateIndexSignatureDeclaration(emitContext.Factory.__tsgoEmbedded0, AsIndexSignatureDeclaration(node), mods, Node_ParameterList(node), Node_Type(node));
            }
            if (node !== undefined) {
                result.push(node);
            }
 ...
 * }
 */
export function EmitResolver_GetEffectiveDeclarationFlags(receiver, node, flags) {
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_GetResolutionModeOverride(receiver, node) {
    receiver.checkerMu.Lock();
    const result = Checker_GetResolutionModeOverride(receiver.checker, AsImportAttributes(node), false);
    receiver.checkerMu.Unlock();
    return result;
}
/**
 ...
 * }
 */
export function EmitResolver_GetConstantValue(receiver, node) {
    receiver.checkerMu.Lock();
 ...
 * }
 */
export function EmitResolver_GetTypeReferenceSerializationKind(receiver, typeName, location) {
    receiver.checkerMu.Lock();
    ...
    if (typeName.Kind === KindQualifiedName) {
        const rootValueSymbol = Checker_resolveEntityName(receiver.checker, GetFirstIdentifier(typeName), SymbolFlagsValue, true, true, location);
        if (rootValueSymbol !== undefined && rootValueSymbol.Declarations !== undefined && rootValueSymbol.Declarations.length > 0) {
            isTypeOnly = Every(rootValueSymbol.Declarations, IsTypeOnlyImportOrExportDeclaration);
        }
    }
    const valueSymbol = Checker_resolveEntityName(receiver.checker, typeName, SymbolFlagsValue, true, true, location);
    ...
    isTypeOnly = (isTypeOnly || (valueSymbol !== undefined && Checker_getTypeOnlyAliasDeclarationEx(receiver.checker, valueSymbol, SymbolFlagsValue) !== undefined));
    const typeSymbol = Checker_resolveEntityName(receiver.checker, typeName, SymbolFlagsType, true, true, location);
    ...
    isTypeOnly = (isTypeOnly || (typeSymbol !== undefined && Checker_getTypeOnlyAliasDeclarationEx(receiver.checker, typeSymbol, SymbolFlagsType) !== undefined));
    ...
    else if (Checker_isTypeAssignableToKind(receiver.checker, type_, (TypeFlagsVoid | TypeFlagsNullable | TypeFlagsNever))) {
 ...
 * }
 */
export function EmitResolver_GetPropertiesOfContainerFunction(receiver, node) {
    if (node === undefined) {
        return [];
    }
    const s = Checker_getSymbolOfDeclaration(receiver.checker, node);
 ...
 * }
 */
export function EmitResolver_TryJSTypeNodeToTypeNode(receiver, emitContext, typeNode, enclosingDeclaration, flags, internalFlags, tracker) {
