...
import { KindAmpersandToken, KindArrayLiteralExpression, KindArrowFunction, KindAsteriskAsteriskToken, KindAsteriskToken, KindBarToken, KindBinaryExpression, KindBigIntLiteral, KindBindingElement, KindBlock, KindCallSignature, KindCaretToken, KindCaseBlock, KindCatchClause, KindClassDeclaration, KindClassExpression, KindClassStaticBlockDeclaration, KindCommaToken, KindComputedPropertyName, KindConditionalType, KindConstructSignature, KindConstructor, KindConstructorType, KindDecorator, KindDeleteExpression, KindEnumDeclaration, KindEnumMember, KindEqualsEqualsEqualsToken, KindEqualsEqualsToken, KindEqualsToken, KindExclamationEqualsEqualsToken, KindExclamationEqualsToken, KindExclamationToken, KindExportAssignment, KindExportSpecifier, KindExpressionWithTypeArguments, KindForInStatement, KindForOfStatement, KindForStatement, KindFunctionDeclaration, KindFunctionExpression, KindFunctionType, KindGetAccessor, KindGreaterThanEqualsToken, KindGreaterThanGreaterThanGreaterThanToken, KindGreaterThanGreaterThanToken, KindGreaterThanToken, KindIdentifier, KindImportClause, KindImportEqualsDeclaration, KindImportSpecifier, KindImportType, KindInKeyword, KindIndexSignature, KindInstanceOfKeyword, KindInterfaceDeclaration, KindJSDocSignature, KindJSTypeAliasDeclaration, KindJsxExpression, KindLessThanEqualsToken, KindLessThanLessThanToken, KindLessThanToken, KindMappedType, KindMethodDeclaration, KindMethodSignature, KindMinusToken, KindModuleDeclaration, KindNamedTupleMember, KindNamespaceExport, KindNamespaceImport, KindObjectLiteralExpression, KindParameter, KindPercentToken, KindPlusToken, KindPostfixUnaryExpression, KindPrefixUnaryExpression, KindPropertyAccessExpression, KindPropertyAssignment, KindPropertyDeclaration, KindPropertySignature, KindQualifiedName, KindQuestionQuestionToken, KindRegularExpressionLiteral, KindSetAccessor, KindSlashToken, KindSourceFile, KindSuperKeyword, KindThisKeyword, KindTypeAliasDeclaration, KindTypeLiteral, KindTypeQuery, KindVariableDeclaration, KindVariableStatement, KindYieldExpression, } from "../ast/generated/kinds.js";
...
import { ObjectFlagsArrayLiteral, ObjectFlagsClassOrInterface, ObjectFlagsJSLiteral, ObjectFlagsObjectLiteral, ObjectFlagsObjectTypeKindMask, ObjectFlagsReference, ObjectFlagsTuple, TypeFlagsAny, TypeFlagsBigInt, TypeFlagsBoolean, TypeFlagsBooleanLiteral, TypeFlagsConditional, TypeFlagsESSymbol, TypeFlagsEnum, TypeFlagsEnumLiteral, TypeFlagsIndex, TypeFlagsIndexedAccess, TypeFlagsInstantiable, TypeFlagsIntersection, TypeFlagsNever, TypeFlagsNonPrimitive, TypeFlagsNull, TypeFlagsNumber, TypeFlagsNumberLiteral, TypeFlagsObject, TypeFlagsString, TypeFlagsStringLiteral, TypeFlagsStringMapping, TypeFlagsStringOrNumberLiteralOrUnique, TypeFlagsSubstitution, TypeFlagsTemplateLiteral, TypeFlagsTypeParameter, TypeFlagsUndefined, TypeFlagsUnion, TypeFlagsUniqueESSymbol, TypeFlagsUnknown, TypeFlagsVoid, Type_AsConditionalType, Type_AsIndexType, Type_AsIndexedAccessType, Type_AsLiteralType, Type_AsObjectType, Type_AsStringMappingType, Type_AsSubstitutionType, Type_AsTemplateLiteralType, Type_AsTupleType, Type_AsTypeParameter, Type_AsTypeReference, Type_AsUnionType, Type_AsUniqueESSymbolType, Type_Target, Type_Types, } from "./types.js";
 ...
 * }
 */
export function NewDiagnosticForNode(node, message, ...args) {
    let file = undefined;
    let loc = NewTextRange(0, 0);
    if (node !== undefined) {
 ...
 * }
 */
export function NewDiagnosticChainForNode(chain, node, message, ...args) {
    if (chain !== undefined) {
 ...
 * }
 */
export function findInMap(m, predicate) {
...
export function tokenIsIdentifierOrKeywordOrGreaterThan(token) {
    return (token === KindGreaterThanToken || tokenIsIdentifierOrKeyword(token));
}
/**
 ...
 * }
 */
export function hasOverrideModifier(node) {
 ...
 * }
 */
export function hasAsyncModifier(node) {
...
export function getSelectedModifierFlags(node, flags) {
    return (Node_ModifierFlags(node) & flags);
}
/**
 ...
 * }
 */
export function isStaticPrivateIdentifierProperty(s) {
    return (s.ValueDeclaration !== undefined && IsPrivateIdentifierClassElementDeclaration(s.ValueDeclaration) && IsStatic(s.ValueDeclaration));
}
/**
...
export function isEmptyObjectLiteral(expression) {
    return (IsObjectLiteralExpression(expression) && (Node_Properties(expression) ?? []).length === 0);
}
/**
 ...
 * )
 */
export const AssignmentKindNone = 0;
export const AssignmentKindDefinite = 1;
export const AssignmentKindCompound = 2;
/**
 ...
 * }
 */
export function getAssignmentTargetKind(node) {
 ...
 * }
 */
export function isDeleteTarget(node) {
    if (!IsAccessExpression(node)) {
        return false;
    }
    const walked = WalkUpParenthesizedExpressions(node.Parent);
    return (walked !== undefined && walked.Kind === KindDeleteExpression);
}
/**
 ...
 * }
 */
export function isInCompoundLikeAssignment(node) {
    const target = GetAssignmentTarget(node);
    return (target !== undefined && IsAssignmentExpression(target, true) && isCompoundLikeAssignment(target));
}
/**
 ...
 * }
 */
export function isCompoundLikeAssignment(assignment) {
    const right = SkipParentheses(AsBinaryExpression(assignment).Right);
    return (right.Kind === KindBinaryExpression && isShiftOperatorOrHigher(AsBinaryExpression(right).OperatorToken.Kind));
}
/**
...
export function isConstTypeReference(node) {
    return (IsTypeReferenceNode(node) && (Node_TypeArguments(node) ?? []).length === 0 && IsIdentifier(AsTypeReferenceNode(node).TypeName) && Node_Text(AsTypeReferenceNode(node).TypeName) === "const");
}
/**
 ...
 * }
 */
export function isTypeReferenceIdentifier(node) {
    let cur = node;
 ...
 * }
 */
export function IsInTypeQuery(node) {
    // TypeScript 1.0 spec (April 2014): 3.6.3
    // A type query consists of the keyword typeof followed by an expression.
    // The expression is restricted to a single identifier or a sequence of identifiers separated by periods
 ...
 * }
 */
export function isShorthandAmbientModuleSymbol(moduleSymbol) {
    return isShorthandAmbientModule(moduleSymbol.ValueDeclaration);
}
/**
 ...
 * }
 */
export function isShorthandAmbientModule(node) {
    // The only kind of module that can be missing a body is a shorthand ambient module.
    return (node !== undefined && node.Kind === KindModuleDeclaration && Node_Body(node) === undefined);
}
/**
 ...
 * }
 */
export function getAliasDeclarationFromName(node) {
    switch (node.Parent.Kind) {
 ...
 * }
 */
export function getContainingQualifiedNameNode(node) {
    let cur = node;
 ...
 * }
 */
export function isSideEffectImport(node) {
    const ancestor = FindAncestor(node, IsImportDeclaration);
    return (ancestor !== undefined && Node_ImportClause(ancestor) === undefined);
}
/**
 ...
 * }
 */
export function getExternalModuleRequireArgument(node) {
 ...
 * }
 */
export function isRightSideOfAccessExpression(node) {
    return (node.Parent !== undefined && ((IsPropertyAccessExpression(node.Parent) && Node_Name(node.Parent) === node) ||
        (IsElementAccessExpression(node.Parent) && AsElementAccessExpression(node.Parent).ArgumentExpression === node)));
}
/**
 ...
 * }
 */
export function isTopLevelInExternalModuleAugmentation(node) {
    return (node !== undefined && node.Parent !== undefined && IsModuleBlock(node.Parent) && IsExternalModuleAugmentation(node.Parent.Parent));
}
/**
 ...
 * }
 */
export function isSyntacticDefault(node) {
 ...
 * }
 */
export function hasExportAssignmentSymbol(moduleSymbol) {
    return (moduleSymbol.Exports?.get(InternalSymbolNameExportEquals) !== undefined);
}
/**
 ...
 * }
 */
export function hasDotDotDotToken(node) {
    switch (node.Kind) {
        case KindParameter:
        ...
        case KindNamedTupleMember:
            return (AsNamedTupleMember(node).DotDotDotToken !== undefined);
        case KindJsxExpression:
            return (AsJsxExpression(node).DotDotDotToken !== undefined);
    }
    return false;
}
/**
 ...
 * }
 */
export function IsTypeAny(t) {
    return (t !== undefined && (t.flags & TypeFlagsAny) !== 0);
}
/**
 ...
 * }
 */
export function isJSDocOptionalParameter(node) {
    return false;
}
/**
...
export function isExclamationToken(node) {
    return (node !== undefined && node.Kind === KindExclamationToken);
}
/**
 ...
 * }
 */
export function isOptionalDeclaration(declaration) {
 ...
 * }
 */
export function Checker_isOptionalParameter(receiver, node) {
    // !!! TODO: JSDoc support
    ...
    if (Node_Initializer(node) !== undefined) {
        ...
        // in grammar checks and checking for `void` too early results in parameter types widening too early
        // and causes some noImplicitAny errors to be lost.
        return (parameterIndex >= Checker_getMinArgumentCountEx(receiver, signature, (MinArgumentCountFlagsStrongArityForUntypedJS | MinArgumentCountFlagsVoidIsNonOptional)));
    }
    ...
    if (iife !== undefined) {
        ...
        return (Node_Type(node) === undefined &&
            ...
            parameterIndex >= Checker_getEffectiveCallArguments(receiver, iife).length);
    }
    return false;
}
/**
...
export function isEmptyArrayLiteral(expression) {
    return (IsArrayLiteralExpression(expression) && (Node_Elements(expression) ?? []).length === 0);
}
/**
 ...
 * }
 */
export function declarationBelongsToPrivateAmbientMember(declaration) {
 ...
 * }
 */
export function isPrivateWithinAmbient(node) {
    return ((HasModifier(node, ModifierFlagsPrivate) || IsPrivateIdentifierClassElementDeclaration(node)) && (node.Flags & NodeFlagsAmbient) !== 0);
}
/**
 ...
 * }
 */
export function createSymbolTable(symbols) {
    if (symbols.length === 0) {
        return undefined;
    }
 ...
 * }
 */
export function Checker_sortSymbols(receiver, symbols) {
 ...
 * }
 */
export function Checker_compareSymbolsWorker(receiver, s1, s2) {
    if (s1 === s2) {
        return 0;
    }
    if (s1 === undefined) {
 ...
 * }
 */
export function Checker_compareNodes(receiver, n1, n2) {
    if (n1 === n2) {
        return 0;
    }
    if (n1 === undefined) {
...
function compareStringLists(s1, s2) {
    const a1 = s1 ?? [];
    const a2 = s2 ?? [];
 ...
 * }
 */
export function CompareTypes(t1, t2) {
    if (t1 === t2) {
        return 0;
    }
    if (t1 === undefined) {
    ...
    if ((t1.flags & (TypeFlagsAny | TypeFlagsUnknown | TypeFlagsString | TypeFlagsNumber | TypeFlagsBoolean | TypeFlagsBigInt | TypeFlagsESSymbol | TypeFlagsVoid | TypeFlagsUndefined | TypeFlagsNull | TypeFlagsNever | TypeFlagsNonPrimitive)) !== 0) {
        ...
        // String literal types are ordered by their values.
        const strings = strings_Compare(Type_AsLiteralType(t1).value, Type_AsLiteralType(t2).value);
        if (strings !== 0) {
            return strings;
        }
    }
        ...
        // Numeric literal types are ordered by their values.
        const numbers = compareNumbers(Type_AsLiteralType(t1).value, Type_AsLiteralType(t2).value);
        if (numbers !== 0) {
            return numbers;
        }
    }
    else if ((t1.flags & TypeFlagsBooleanLiteral) !== 0) {
        const b1 = Type_AsLiteralType(t1).value;
        const b2 = Type_AsLiteralType(t2).value;
        if (b1 !== b2) {
            if (b1) {
                return 1;
            }
        ...
        const nodes = Checker_compareNodes(t1.checker, Type_AsConditionalType(t1).root.node, Type_AsConditionalType(t2).root.node);
        if (nodes !== 0) {
            return nodes;
        }
 ...
 * }
 */
export function getSortOrderFlags(t) {
    // Return TypeFlagsEnum for all enum-like unit types (they'll be sorted by their symbols)
    if ((t.flags & (TypeFlagsEnumLiteral | TypeFlagsEnum)) !== 0 && (t.flags & TypeFlagsUnion) === 0) {
        return TypeFlagsEnum;
    }
    return t.flags;
}
/**
 ...
 * }
 */
export function compareTypeNames(t1, t2) {
 ...
 * }
 */
export function getTypeNameSymbol(t) {
 ...
 * }
 */
export function getObjectTypeName(t) {
    if ((t.objectFlags & (ObjectFlagsClassOrInterface | ObjectFlagsReference)) !== 0) {
        return t.symbol;
    }
    return undefined;
 ...
 * }
 */
export function compareTupleTypes(t1, t2) {
    if (t1 === t2) {
        return 0;
    }
    if (t1.readonly !== t2.readonly) {
 ...
 * }
 */
export function compareElementLabels(n1, n2) {
    if (n1 === n2) {
        return 0;
    }
    if (n1 === undefined) {
 ...
 * }
 */
export function compareTypeLists(s1, s2) {
    const a1 = s1 ?? [];
    const a2 = s2 ?? [];
    if (a1.length !== a2.length) {
        return a1.length - a2.length;
 ...
 * }
 */
export function compareTypeMappers(m1, m2) {
    if (m1 === m2) {
        return 0;
    }
    if (m1 === undefined) {
    ...
    switch (kind1) {
        case TypeMapperKindSimple: {
            const mapper1 = m1.data[goReceiverKey];
            const mapper2 = m2.data[goReceiverKey];
 ...
 * }
 */
export function getDeclarationModifierFlagsFromSymbol(s) {
 ...
 * }
 */
export function getDeclarationModifierFlagsFromSymbolEx(s, isWrite) {
    ...
    if ((s.CheckFlags & CheckFlagsSynthetic) !== 0) {
        ...
        let staticModifier = ModifierFlagsNone;
...
export function isExponentiationOperator(kind) {
    return (kind === KindAsteriskAsteriskToken);
}
/**
...
export function isMultiplicativeOperator(kind) {
    return (kind === KindAsteriskToken || kind === KindSlashToken || kind === KindPercentToken);
}
/**
...
export function isAdditiveOperator(kind) {
    return (kind === KindPlusToken || kind === KindMinusToken);
}
/**
...
export function isShiftOperator(kind) {
    return (kind === KindLessThanLessThanToken || kind === KindGreaterThanGreaterThanToken ||
        kind === KindGreaterThanGreaterThanGreaterThanToken);
}
/**
...
export function isRelationalOperator(kind) {
    return (kind === KindLessThanToken || kind === KindLessThanEqualsToken || kind === KindGreaterThanToken ||
        kind === KindGreaterThanEqualsToken || kind === KindInstanceOfKeyword || kind === KindInKeyword);
}
/**
...
export function isEqualityOperator(kind) {
    return (kind === KindEqualsEqualsToken || kind === KindEqualsEqualsEqualsToken ||
        kind === KindExclamationEqualsToken || kind === KindExclamationEqualsEqualsToken);
}
/**
...
export function isBitwiseOperator(kind) {
    return (kind === KindAmpersandToken || kind === KindBarToken || kind === KindCaretToken);
}
/**
...
export function isAssignmentOperatorOrHigher(kind) {
    return (kind === KindQuestionQuestionToken || isLogicalOperatorOrHigher(kind) || IsAssignmentOperator(kind));
}
/**
...
export function isBinaryOperator(kind) {
    return (isAssignmentOperatorOrHigher(kind) || kind === KindCommaToken);
}
/**
 ...
 * }
 */
export function isObjectLiteralType(t) {
    return ((t.objectFlags & ObjectFlagsObjectLiteral) !== 0);
}
/**
 ...
 */
export const orderedSetMapThreshold = 16;
/**
 ...
 * }
 */
export function orderedSet_contains(receiver, value) {
    if (receiver.valuesByKey === undefined) {
        return slices.Contains(receiver.values, value);
    }
    return receiver.valuesByKey.has(value);
}
/**
 ...
 * }
 */
export function orderedSet_add(receiver, value) {
    ...
    if (receiver.valuesByKey === undefined) {
        ...
        receiver.valuesByKey = new globalThis.Map();
 ...
 * }
 */
export function getContainingFunctionOrClassStaticBlock(node) {
 ...
 * }
 */
export function isTypeUsableAsPropertyName(t) {
    return ((t.flags & TypeFlagsStringOrNumberLiteralOrUnique) !== 0);
}
/**
 ...
 * }
 */
export function isNumericLiteralName(name) {
    return (Number_String(FromString(name)) === name);
}
/**
 ...
 * }
 */
export function isThisProperty(node) {
    return ((IsPropertyAccessExpression(node) || IsElementAccessExpression(node)) && Node_Expression(node).Kind === KindThisKeyword);
}
/**
 ...
 * }
 */
export function isValidNumberString(s, roundTripOnly) {
    if (s === "") {
        return false;
    }
    const n = FromString(s);
    return (!Number_IsNaN(n) && !Number_IsInf(n) && (!roundTripOnly || Number_String(n) === s));
}
/**
 ...
 * }
 */
export function isValidBigIntString(s, roundTripOnly) {
    if (s === "") {
        return false;
    }
    const scanner = NewScanner();
    Scanner_SetSkipTrivia(scanner, false);
    let success = true;
    Scanner_SetOnError(scanner, (_diagnostic, _start, _length, ..._args) => {
        success = false;
    });
    ...
    return (success && result === KindBigIntLiteral && Scanner_TokenEnd(scanner) === inputLength + 1 && (flags & TokenFlagsContainsSeparator) === 0 &&
        (!roundTripOnly || s === pseudoBigIntToString(NewPseudoBigInt(ParsePseudoBigInt(Scanner_TokenValue(scanner)), negative))));
}
/**
 ...
 * }
 */
export function isValidESSymbolDeclaration(node) {
    if (IsVariableDeclaration(node)) {
        return (IsVarConst(node) && IsIdentifier(Node_Name(node)) && isVariableDeclarationInVariableStatement(node));
    }
 ...
 * }
 */
export function isVariableDeclarationInVariableStatement(node) {
 ...
 * }
 */
export function IsKnownSymbol(symbol_) {
 ...
 * }
 */
export function IsPrivateIdentifierSymbol(symbol_) {
    if (symbol_ === undefined) {
        return false;
    }
    return symbol_.Name.startsWith(InternalSymbolNamePrefix + "#");
}
/**
 ...
 * }
 */
export function isLateBoundName(name) {
    ...
    return (name.length >= 2 && name.startsWith(InternalSymbolNamePrefix) && name.charCodeAt(1) === 0x40);
}
/**
 ...
 * }
 */
export function isObjectOrArrayLiteralType(t) {
    return ((t.objectFlags & (ObjectFlagsObjectLiteral | ObjectFlagsArrayLiteral)) !== 0);
}
/**
 ...
 * }
 */
export function getContainingClassExcludingClassDecorators(node) {
    const decorator = FindAncestorOrQuit(node.Parent, (n) => {
        if (IsClassLike(n)) {
            return FindAncestorQuit;
        }
        if (IsDecorator(n)) {
 ...
 * }
 */
export function isThisTypeParameter(t) {
    return ((t.flags & TypeFlagsTypeParameter) !== 0 && Type_AsTypeParameter(t).isThisType);
}
/**
...
export function isClassInstanceProperty(node) {
    if (IsInJSFile(node) && IsExpandoPropertyDeclaration(node)) {
        ...
        return ((!IsBindableStaticAccessExpression(left, false) || !IsPrototypeAccess(Node_Expression(left))) &&
            !IsBindableStaticNameExpression(left, true));
    }
    return (node.Parent !== undefined && IsClassLike(node.Parent) && IsPropertyDeclaration(node) && !HasAccessorModifier(node));
}
/**
 ...
 * }
 */
export function isThisInitializedObjectBindingExpression(node) {
    return (node !== undefined && (IsShorthandPropertyAssignment(node) || IsPropertyAssignment(node)) && IsBinaryExpression(node.Parent.Parent) &&
        ...
        AsBinaryExpression(node.Parent.Parent).Right.Kind === KindThisKeyword);
}
/**
 ...
 * }
 */
export function isThisInitializedDeclaration(node) {
    return (node !== undefined && IsVariableDeclaration(node) && Node_Initializer(node) !== undefined && Node_Initializer(node).Kind === KindThisKeyword);
}
/**
 ...
 * }
 */
export function Checker_isConstantVariable(receiver, symbol_) {
    return ((symbol_.Flags & SymbolFlagsVariable) !== 0 && (Checker_getDeclarationNodeFlagsFromSymbol(receiver, symbol_) & NodeFlagsConstant) !== 0);
}
/**
 ...
 * }
 */
export function Checker_isParameterOrMutableLocalVariable(receiver, symbol_) {
    // Return true if symbol is a parameter, a catch clause variable, or a mutable local variable
    if (symbol_.ValueDeclaration !== undefined) {
        const declaration = GetRootDeclaration(symbol_.ValueDeclaration);
        return (declaration !== undefined && (IsParameterDeclaration(declaration) || IsVariableDeclaration(declaration) && (IsCatchClause(declaration.Parent) || Checker_isMutableLocalVariableDeclaration(receiver, declaration))));
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_isMutableLocalVariableDeclaration(receiver, declaration) {
    // Return true if symbol is a non-exported and non-global `let` variable
    return ((declaration.Parent.Flags & NodeFlagsLet) !== 0 && !((GetCombinedModifierFlags(declaration) & ModifierFlagsExport) !== 0 || declaration.Parent.Parent.Kind === KindVariableStatement && IsGlobalSourceFile(declaration.Parent.Parent.Parent)));
}
/**
 ...
 * }
 */
export function isInAmbientOrTypeNode(node) {
    return ((node.Flags & NodeFlagsAmbient) !== 0 || FindAncestor(node, (n) => {
        return (IsInterfaceDeclaration(n) || IsTypeOrJSTypeAliasDeclaration(n) || IsTypeLiteralNode(n));
    }) !== undefined);
}
/**
 ...
 * }
 */
export function canHaveFlowNode(node) {
    return (Node_FlowNodeData(node) !== undefined);
}
/**
 ...
 * }
 */
export function isNonNullAccess(node) {
    return (IsAccessExpression(node) && IsNonNullExpression(Node_Expression(node)));
}
/**
 ...
 * }
 */
export function getBindingElementPropertyName(node) {
 ...
 * }
 */
export function Checker_callLikeExpressionMayHaveTypeArguments(receiver, node) {
 ...
 * }
 */
export function isSuperCall(n) {
    return (IsCallExpression(n) && Node_Expression(n).Kind === KindSuperKeyword);
}
/**
 ...
 * }
 */
export function getMembersOfDeclaration(node) {
    switch (node.Kind) {
 ...
 * }
 */
export function isInRightSideOfImportOrExportAssignment(node) {
    let cur = node;
    while (cur.Parent.Kind === KindQualifiedName) {
        cur = cur.Parent;
    }
    return ((cur.Parent.Kind === KindImportEqualsDeclaration && AsImportEqualsDeclaration(cur.Parent).ModuleReference === cur) ||
        (cur.Parent.Kind === KindExportAssignment && Node_Expression(cur.Parent) === cur));
}
/**
 ...
 * }
 */
export function isJsxIntrinsicTagName(tagName) {
    return ((IsIdentifier(tagName) && IsIntrinsicJsxName(Node_Text(tagName))) || IsJsxNamespacedName(tagName));
}
/**
 ...
 * }
 */
export function getContainingObjectLiteral(f) {
 ...
 * }
 */
export function isImportTypeQualifierPart(node) {
    let cur = node;
 ...
 * }
 */
export function isInNameOfExpressionWithTypeArguments(node) {
    let cur = node;
    while (cur.Parent.Kind === KindPropertyAccessExpression) {
        cur = cur.Parent;
    }
    return (cur.Parent.Kind === KindExpressionWithTypeArguments);
}
/**
 ...
 * }
 */
export function getIndexSymbolFromSymbolTable(symbolTable) {
 ...
 * }
 */
export function expressionResultIsUnused(node) {
    let cur = node;
    for (;;) {
 ...
 * }
 */
export function pseudoBigIntToString(value) {
 ...
 * }
 */
export function forEachYieldExpression(body, visitor) {
    const traverse = (node) => {
        switch (node.Kind) {
 ...
 * }
 */
export function getEnclosingContainer(node) {
 ...
 * }
 */
export function getDeclarationsOfKind(symbol_, kind) {
    return Filter(symbol_.Declarations ?? [], (d) => (d.Kind === kind));
}
/**
 ...
 * }
 */
export function getNonRestParameterCount(sig) {
 ...
 * }
 */
export function minAndMax(slice, getValue) {
    let minValue = 0;
    let maxValue = 0;
 ...
 * })
 */
export const getFeatureMap = () => (featureMapValue ??= new Map([
    ["Array", [
 ...
 * }
 */
export function rangeOfTypeParameters(sourceFile, typeParameters) {
 ...
 * }
 */
export function tryGetPropertyAccessOrIdentifierToString(expr) {
 ...
 * }
 */
export function allDeclarationsInSameSourceFile(symbol_) {
 ...
 * }
 */
export function containsNonMissingUndefinedType(c, t) {
 ...
 * }
 */
export function getAnyImportSyntax(node) {
    switch (node.Kind) {
        case KindImportEqualsDeclaration:
            return node;
        case KindImportClause:
...
export function isReservedMemberName(name) {
    ...
    return (name.length >= 2 && name.startsWith(InternalSymbolNamePrefix) && name.charCodeAt(1) !== 0x40 && name.charCodeAt(1) !== 0x23);
}
/**
 ...
 * }
 */
export function introducesArgumentsExoticObject(node) {
    switch (node.Kind) {
        case KindMethodDeclaration:
        case KindMethodSignature:
        case KindConstructor:
 ...
 * }
 */
export function symbolsToArray(symbols) {
    let result = [];
 ...
 * }
 */
export function SkipAlias(symbol_, checker) {
 ...
 * }
 */
export function IsExternalModuleSymbol(moduleSymbol) {
    return ((moduleSymbol.Flags & SymbolFlagsModule) !== 0 && moduleSymbol.Name.length > 0 && moduleSymbol.Name.charCodeAt(0) === "\"".charCodeAt(0));
}
/**
 ...
 * }
 */
export function Checker_isCanceled(receiver) {
    return (receiver.ctx !== undefined && receiver.ctx.Err() !== undefined);
}
/**
 ...
 * }
 */
export function Checker_checkNotCanceled(receiver) {
 ...
 * }
 */
export function Checker_getPackagesMap(receiver) {
        ...
        for (const [, resolvedModulesInFile] of resolvedModules) {
            for (const [, module_] of resolvedModulesInFile) {
                ...
                if (module !== undefined && !ResolvedModule_IsProviderVirtual(module) && module.PackageId.Name !== "") {
                    receiver.packagesMap.set(module.PackageId.Name, (receiver.packagesMap.get(module.PackageId.Name) || module.Extension === ExtensionDts));
                }
            }
        }
    }
 ...
 * }
 */
export function Checker_typesPackageExists(receiver, packageName) {
    const packagesMap = Checker_getPackagesMap(receiver);
    return packagesMap.has(GetTypesPackageName(packageName));
}
/**
 ...
 * }
 */
export function Checker_packageBundlesTypes(receiver, packageName) {
    const packagesMap = Checker_getPackagesMap(receiver);
    return (packagesMap.get(packageName) ?? false);
}
/**
...
export function ValueToString(value) {
    ...
    if (typeof value === "object" && value !== null && "Base10Value" in value && "Negative" in value) {
        return PseudoBigInt_String(value) + "n";
    }
 ...
 * }
 */
export function nodeStartsNewLexicalEnvironment(node) {
    switch (node.Kind) {
        case KindConstructor:
        case KindFunctionExpression:
        case KindFunctionDeclaration:
 ...
 * }
 */
export function Checker_isUncheckedJSSuggestion(receiver, node, suggestion, excludeClasses) {
    ...
    if (file !== undefined) {
        if (Tristate_IsUnknown(receiver.compilerOptions.CheckJs) && file.CheckJsDirective === undefined && (file.ScriptKind === ScriptKindJS || file.ScriptKind === ScriptKindJSX)) {
            ...
            const suggestionHasNoExtendsOrDecorators = suggestion === undefined ||
                ...
                ClassOrConstructorParameterIsDecorated(false, suggestion.ValueDeclaration);
            return (!(file !== declarationFile && declarationFile !== undefined && IsGlobalSourceFile(declarationFile)) &&
                ...
                !(node !== undefined && excludeClasses && IsPropertyAccessExpression(node) && Node_Expression(node).Kind === KindThisKeyword && suggestionHasNoExtendsOrDecorators));
        }
    }
    return false;
}
 ...
 * }
 */
export function Checker_isJSLiteralType(receiver, t) {
    ...
    if ((t.flags & TypeFlagsUnion) !== 0) {
        return Every(Type_Types(t), (element) => Checker_isJSLiteralType(receiver, element));
    }
    if ((t.flags & TypeFlagsIntersection) !== 0) {
        return Some(Type_Types(t), (element) => Checker_isJSLiteralType(receiver, element));
    }
    if ((t.flags & TypeFlagsInstantiable) !== 0) {
        const constraint = Checker_getResolvedBaseConstraint(receiver, t, []);
        return (constraint !== t && Checker_isJSLiteralType(receiver, constraint));
    }
    return false;
}
/**
 ...
 * }
 */
export function CreateModuleNotFoundChain(program, file, moduleReference, mode, packageName) {
    const currentSourceFile = NewHasFileName(SourceFile_FileName(file), SourceFile_Path(file));
 ...
 * }
 */
export function CreateModeMismatchDetails(program, file) {
 ...
 * }
 */
export function walkUpOuterExpressions(node) {
    let parent = node.Parent;
    while (parent !== undefined && IsOuterExpression(parent, OEKAll)) {
        parent = parent.Parent;
    }
    return parent;
}
