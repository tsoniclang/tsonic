...
import { EmitContext_AddEmitFlags, EmitContext_AddSyntheticLeadingComment, EmitContext_AssignCommentRange, EmitContext_MostOriginal, EmitContext_Original, EmitContext_SetEmitFlags, EmitContext_SetOriginalEx, } from "../printer/emitcontext.js";
...
function compositeSymbolIdentityKey(id) {
    return `${id.isConstructorNode ? 1 : 0}:${id.symbolId}:${id.nodeId}`;
}
function compositeTypeCacheIdentityKey(id) {
...
export function NodeBuilderImpl_lookupTypeParameterNodes(receiver, chain, index) {
    ...
    receiver.ctx.typeParameterSymbolList.set(symbolId, {});
...
export function NodeBuilderImpl_typeParameterToName(receiver, typeParameter) {
    ...
    if ((receiver.ctx.flags & FlagsGenerateNamesForShadowedTypeParams) !== 0) {
        ...
        receiver.ctx.typeParameterNamesByText.set(text, {});
    }
...
export function NodeBuilderImpl_createTypeNodesFromResolvedType(receiver, resolvedType) {
    if (NodeBuilderImpl_checkTruncationLength(receiver)) {
        if ((receiver.ctx.flags & FlagsNoTruncation) !== 0) {
            ...
            return NodeFactory_NewNodeList(receiver.f, [EmitContext_AddSyntheticLeadingComment(receiver.e, elem, KindMultiLineCommentTrivia, "elided", false)]);
        }
    ...
    for (const info of resolvedType.indexInfos ?? []) {
        typeElements.push(NodeBuilderImpl_indexInfoToIndexSignatureDeclarationHelper(receiver, info, (resolvedObjectFlags & ObjectFlagsReverseMapped) !== 0 ? NodeBuilderImpl_createElidedInformationPlaceholder(receiver) : undefined));
    }
    ...
    for (const propertySymbol of properties) {
        ...
        if (NodeBuilderImpl_checkTruncationLength(receiver) && (i + 2 < properties.length - 1)) {
            if ((receiver.ctx.flags & FlagsNoTruncation) !== 0) {
                typeElements[typeElements.length - 1] = EmitContext_AddSyntheticLeadingComment(receiver.e, typeElements[typeElements.length - 1], KindMultiLineCommentTrivia, `... ${properties.length - i} more elided ...`, false);
            }
            else {
...
export function NodeBuilderImpl_visitAndTransformType(receiver, t, transform) {
    ...
    if (receiver.ctx.enclosingDeclaration !== undefined && LinkStore_Has(receiver.links, receiver.ctx.enclosingDeclaration)) {
