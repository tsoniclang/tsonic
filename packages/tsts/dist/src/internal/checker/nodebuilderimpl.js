...
import { KindAccessorKeyword, KindAnyKeyword, KindArrowFunction, KindBindingElement, KindBigIntKeyword, KindBooleanKeyword, KindCallSignature, KindClassExpression, KindConstructor, KindConstructorType, KindConstructSignature, KindDotDotDotToken, KindExportDeclaration, KindExportSpecifier, KindExternalModuleReference, KindFalseKeyword, KindFunctionDeclaration, KindFunctionExpression, KindFunctionType, KindGetAccessor, KindIndexSignature, KindImportClause, KindImportDeclaration, KindImportEqualsDeclaration, KindImportSpecifier, KindImportType, KindIntrinsicKeyword, KindKeyOfKeyword, KindJSDocImportTag, KindJSDocParameterTag, KindMinusToken, KindModuleBlock, KindMultiLineCommentTrivia, KindNeverKeyword, KindPropertyDeclaration, KindMethodDeclaration, KindMethodSignature, KindNamespaceExport, KindNamespaceImport, KindNullKeyword, KindNumberKeyword, KindObjectKeyword, KindParameter, KindQuestionToken, KindAssertsKeyword, KindReadonlyKeyword, KindSetAccessor, KindSourceFile, KindStringKeyword, KindSymbolKeyword, KindTrueKeyword, KindTypeParameter, KindUndefinedKeyword, KindUniqueKeyword, KindUnknownKeyword, KindVariableDeclaration, KindVoidKeyword, KindWithKeyword, } from "../ast/generated/kinds.js";
...
import { NodeFlagsNone, NodeFlagsSynthesized, SymbolFlagsAlias, SymbolFlagsAccessor, SymbolFlagsClass, SymbolFlagsEnum, SymbolFlagsEnumMember, SymbolFlagsExportValue, SymbolFlagsFunction, SymbolFlagsFunctionScopedVariable, SymbolFlagsMethod, SymbolFlagsInterface, SymbolFlagsOptional, SymbolFlagsPrototype, SymbolFlagsSignature, SymbolFlagsTransient, SymbolFlagsType, SymbolFlagsObjectLiteral, SymbolFlagsTypeLiteral, SymbolFlagsTypeParameter, SymbolFlagsValue, SymbolFlagsValueModule, } from "../ast/generated/flags.js";
import { FindAncestor, GetDeclarationOfKind, GetFirstIdentifier, GetNameOfDeclaration, GetNodeId, GetSourceFileOfModule, GetSourceFileOfNode, GetSymbolId, IsAmbientModule, IsAmbientModuleSymbolName, IsEntityNameExpression, CanHaveModifiers, CreateModifiersFromModifierFlags, IsClassLike, IsEntityName, HasInferredType, IsAccessor, IsLiteralImportTypeNode, IsPropertyAccessEntityNameExpression, IsModifier, IsRequireCall, IsStatic, NewHasFileName, NodeIsSynthesized, WalkUpParenthesizedTypes, } from "../ast/utilities.js";
...
import { NewArrowFunction, NewBlock, NewCallSignatureDeclaration, NewComputedPropertyName, NewConstructSignatureDeclaration, NewConditionalTypeNode, NewConstructorDeclaration, NewConstructorTypeNode, NewExpressionWithTypeArguments, NewFunctionDeclaration, NewFunctionExpression, NewFunctionTypeNode, NewGetAccessorDeclaration, NewArrayTypeNode, NewBigIntLiteral, NewInferTypeNode, NewIdentifier, NewImportAttribute, NewImportAttributes, NewImportTypeNode, NewIndexedAccessTypeNode, NewKeywordTypeNode, NewKeywordExpression, NewElementAccessExpression, NewIntersectionTypeNode, NewLiteralTypeNode, NewMappedTypeNode, NewMethodDeclaration, NewMethodSignatureDeclaration, NewNotEmittedTypeElement, NewNumericLiteral, NewNamedTupleMember, NewOptionalTypeNode, NewParameterDeclaration, NewParenthesizedTypeNode, NewPrefixUnaryExpression, NewPropertyAccessExpression, NewPropertySignatureDeclaration, NewQualifiedName, NewStringLiteral, NewThisTypeNode, NewTemplateHead, NewTemplateMiddle, NewTemplateTail, NewTemplateLiteralTypeNode, NewTemplateLiteralTypeSpan, NewToken, NewTypeOperatorNode, NewSetAccessorDeclaration, NewTypeParameterDeclaration, NewTypePredicateNode, NewTupleTypeNode, NewTypeQueryNode, NewTypeReferenceNode, NewRestTypeNode, NewTypeLiteralNode, NewUnionTypeNode, NewIndexSignatureDeclaration, } from "../ast/generated/factory.js";
...
import { FlagsAllowAnonymousIdentifier, FlagsAllowEmptyUnionOrIntersection, FlagsAllowEmptyTuple, FlagsAllowEmptyIndexInfoType, FlagsAllowNodeModulesRelativePaths, FlagsAllowQualifiedNameInPlaceOfIdentifier, FlagsAllowThisInObjectLiteral, FlagsAllowUniqueESSymbolType, FlagsForbidIndexedAccessSymbolReferences, FlagsGenerateNamesForShadowedTypeParams, FlagsInInitialEntityName, FlagsInObjectTypeLiteral, FlagsInTypeAlias, FlagsMultilineObjectLiterals, FlagsNoTruncation, FlagsNoTypeReduction, FlagsOmitParameterModifiers, FlagsOmitThisParameter, FlagsSuppressAnyReturnType, FlagsUseAliasDefinedOutsideCurrentScope, FlagsUseFullyQualifiedType, FlagsUseInstantiationExpressions, FlagsUseOnlyExternalAliasing, FlagsUseStructuralFallback, FlagsUseTypeOfFunction, FlagsUseSingleQuotesForStringLiteralType, FlagsWriteClassExpressionAsTypeLiteral, FlagsWriteArrayAsGenericType, FlagsWriteTypeArgumentsOfSignature, FlagsWriteTypeParametersInQualifiedName, InternalFlagsDoNotIncludeSymbolChain, InternalFlagsWriteComputedProps, } from "../nodebuilder/types.js";
import { EmitContext_AddEmitFlags, EmitContext_AddSyntheticLeadingComment, EmitContext_AddSyntheticTrailingComment, EmitContext_AssignCommentRange, EmitContext_MostOriginal, EmitContext_Original, EmitContext_SetEmitFlags, EmitContext_SetOriginalEx, } from "../printer/emitcontext.js";
...
import { Checker_getDefaultFromTypeParameter, Checker_getConstraintOfTypeParameter, Checker_getInferredTypeParameterConstraint, Checker_getLocalTypeParametersOfClassOrInterfaceOrTypeAlias, Checker_getMinTypeArgumentCount, Checker_getOuterTypeParametersOfClassOrInterface, Checker_getOrCreateTypeFromSignature, Checker_getSignatureFromDeclaration, Checker_getSignaturesOfType, Checker_getReturnTypeOfSignature, Checker_getTypeArguments, Checker_getTypeParameterFromMappedType, Checker_getTypeParametersFromDeclaration, Checker_getTypeReferenceArity, Checker_instantiateSignature, Checker_isLateBindableIndexSignature, Checker_newSignature, Checker_newTypeParameter, } from "./checker/signatures.js";
import { Checker_getDeclaredTypeOfClassOrInterface, Checker_getHomomorphicTypeVariable, Checker_getBaseTypeVariableOfClass, Checker_getOptionalType, Checker_getRegularTypeOfExpression, Checker_getFalseTypeFromConditionalType, Checker_getTrueTypeFromConditionalType, Checker_getReducedType, Checker_getTypeFromTypeNode, Checker_getTypeFromTypeReference, Checker_getTypeWithFacts, Checker_getWidenedType, Checker_getWidenedLiteralType, Checker_getIntersectionType, Checker_getTemplateTypeFromMappedType, Checker_getModifiersTypeFromMappedType, Checker_filterType, Checker_getPropertiesOfObjectType, Checker_instantiateType, Checker_createArrayType, Checker_isReferenceToType, Checker_isGenericMappedType, Checker_removeMissingType, Checker_newAnonymousType, } from "./checker/types.js";
...
import { Checker_getAliasForSymbolInContainer, Checker_getAccessibleSymbolChain, Checker_getContainersOfSymbol, Checker_getFileSymbolIfFileSymbolExportEqualsContainer, Checker_IsSymbolAccessible, Checker_IsTypeSymbolAccessible, Checker_IsValueSymbolAccessible, Checker_needsQualification, getQualifiedLeftMeaning, hasNonGlobalAugmentationExternalModuleSymbol, } from "./symbolaccessibility.js";
import { Checker_getExportsOfSymbol, Checker_getMembersOfSymbol, Checker_getDeclaredTypeOfSymbol, Checker_getGlobalTypeAliasSymbol, Checker_getNameTypeFromMappedType, Checker_getNonMissingTypeOfSymbol, Checker_getParentOfSymbol, Checker_getSymbolIfSameReference, Checker_getSymbolOfDeclaration, Checker_getSymbolOfNode, Checker_getTargetSymbol, Checker_getTypeOfSymbol, Checker_hasLateBindableName, Checker_isLateBindableName, Checker_getWriteTypeOfSymbol, Checker_isReadonlySymbol, Checker_newSymbol, Checker_newSymbolEx, Checker_resolveAlias, Checker_resolveEntityName, Checker_resolveStructuredTypeMembers, Checker_GetSymbolAtLocation, Checker_GetAliasedSymbol } from "./checker/symbols.js";
 ...
 * }
 */
export function newNodeBuilderImpl(ch, e, idToSymbol) {
    const resolvedIdToSymbol = idToSymbol !== undefined ? idToSymbol : new globalThis.Map();
    const b = {
        f: e.Factory.__tsgoEmbedded0,
        ch,
        e,
        pc: NewPseudoChecker(ch.strictNullChecks, ch.exactOptionalPropertyTypes),
        links: { entries: new globalThis.Map(), arena: { data: [] } },
        symbolLinks: { entries: new globalThis.Map(), arena: { data: [] } },
        ctx: undefined,
 ...
 * }
 */
export function NodeBuilderImpl_saveRestoreFlags(receiver) {
 ...
 * }
 */
export function NodeBuilderImpl_checkTruncationLength(receiver) {
    if (receiver.ctx.truncating) {
        return receiver.ctx.truncating;
    }
    const maxLength = (receiver.ctx.flags & FlagsNoTruncation) !== 0
 ...
 * }
 */
export function NodeBuilderImpl_checkTruncationLengthIfExpanding(receiver) {
 ...
 * }
 */
export function NodeBuilderImpl_isExpandableType(receiver, t, isAlias) {
    if (isAlias) {
 ...
 * }
 */
export function NodeBuilderImpl_isTypeOnStack(receiver, t) {
 ...
 * }
 */
export function NodeBuilderImpl_shouldExpandType(receiver, t, isAlias) {
 ...
 * }
 */
export function NodeBuilderImpl_isActivelyExpanding(receiver) {
 ...
 * }
 */
export function NodeBuilderImpl_checkTypeExpandability(receiver, t) {
    ...
    if (t.alias !== undefined) {
        NodeBuilderImpl_shouldExpandType(receiver, t, true);
    }
    if (!receiver.ctx.canIncreaseExpansionDepth) {
        NodeBuilderImpl_shouldExpandType(receiver, t, false);
    }
 ...
 * }
 */
export function NodeBuilderImpl_appendReferenceToType(receiver, root, ref) {
    if (IsImportTypeNode(root)) {
        const imprt = AsImportTypeNode(root);
        const ids = getAccessStack(ref);
        const qualifier = ids.reduce((q, id) => q !== undefined ? NewQualifiedName(receiver.f, q, id) : id, imprt.Qualifier);
    ...
    if (IsTypeReferenceNode(root)) {
        ...
        if ((receiver.ctx.flags & FlagsUseInstantiationExpressions) !== 0 && typeRef.TypeArguments !== undefined && typeRef.TypeArguments.Nodes.length !== 0) {
            ...
            const expr = ids2.reduce((e, id) => NewPropertyAccessExpression(receiver.f, e, undefined, id, NodeFlagsNone), NodeBuilderImpl_createExpressionWithTypeArguments(receiver, NodeBuilderImpl_createAccessExpression(receiver, typeRef.TypeName), typeRef.TypeArguments));
            return expr;
        }
        const ids3 = getAccessStack(ref);
        const typeName = ids3.reduce((tn, id) => NewQualifiedName(receiver.f, tn, id), typeRef.TypeName);
    ...
    return ids4.reduce((e, id) => NewPropertyAccessExpression(receiver.f, e, undefined, id, NodeFlagsNone), NodeBuilderImpl_createAccessExpression(receiver, root));
}
/**
 ...
 * }
 */
export function getAccessStack(ref) {
    let state = AsTypeReferenceNode(ref).TypeName;
    let ids = [];
 ...
 * }
 */
export function isClassInstanceSide(c, t) {
    return (t.symbol !== undefined &&
        (t.symbol.Flags & SymbolFlagsClass) !== 0 &&
        (t === Checker_getDeclaredTypeOfClassOrInterface(c, t.symbol) ||
            ((t.flags & TypeFlagsObject) !== 0 && (t.objectFlags & ObjectFlagsIsClassInstanceClone) !== 0)));
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_createElidedInformationPlaceholder(receiver) {
 ...
 * }
 */
export function NodeBuilderImpl_mapToTypeNodes(receiver, list, isBareList) {
    if (list.length === 0) {
        return undefined;
    }
    ...
    const seenNames = mayHaveNameCollisions ? { M: new globalThis.Map() } : undefined;
    const result = [];
    let i = 0;
    for (const t of list) {
    ...
    if (seenNames !== undefined) {
        ...
        MultiMap_Values(seenNames)(types => {
 ...
 * }
 */
export function NodeBuilderImpl_serializeTypeName(receiver, node, isTypeOf, typeArguments) {
 ...
 * }
 */
export function isIdentifierTypeReference(node) {
 ...
 * }
 */
export function arrayIsHomogeneous(array, comparer) {
    if (array.length < 2) {
        return true;
    }
    const first = array[0];
 ...
 * }
 */
export function typesAreSameReference(a, b) {
 ...
 * }
 */
export function NodeBuilderImpl_setCommentRange(receiver, node, range_) {
 ...
 * }
 */
export function NodeBuilderImpl_tryReuseExistingTypeNode(receiver, typeNode, t, host, addUndefined) {
 ...
 * }
 */
export function NodeBuilderImpl_typeNodeIsEquivalentToType(receiver, annotatedDeclaration, t, typeFromTypeNode) {
    if (typeFromTypeNode === t) {
        return true;
    }
 ...
 * }
 */
export function NodeBuilderImpl_existingTypeNodeIsNotReferenceOrIsReferenceWithCompatibleTypeArgumentCount(receiver, existing, t) {
    if ((t.objectFlags & ObjectFlagsReference) === 0) {
        return true;
    }
    ...
    const links = LinkStore_TryGet(receiver.ch.symbolNodeLinks, existing);
    if (links === undefined) {
        return true;
    }
 ...
 * }
 */
export function NodeBuilderImpl_tryReuseExistingNonParameterTypeNode(receiver, existing, t, host, annotationType) {
 ...
 * }
 */
export function NodeBuilderImpl_getResolvedTypeWithoutAbstractConstructSignatures(receiver, t) {
    const asType = t.AsType();
 ...
 * }
 */
export function NodeBuilderImpl_symbolToNode(receiver, symbol_, meaning) {
    if ((receiver.ctx.internalFlags & InternalFlagsWriteComputedProps) !== 0) {
        ...
        if (LinkStore_Has(receiver.ch.valueSymbolLinks, symbol_)) {
            const nameType = LinkStore_Get(receiver.ch.valueSymbolLinks, symbol_).nameType;
 ...
 * }
 */
export function NodeBuilderImpl_symbolToName(receiver, symbol_, meaning, expectsIdentifier) {
    const chain = NodeBuilderImpl_lookupSymbolChain(receiver, symbol_, meaning, false);
 ...
 * }
 */
export function NodeBuilderImpl_createEntityNameFromSymbolChain(receiver, chain, index) {
    ...
    if (index > 0) {
        return NewQualifiedName(receiver.f, NodeBuilderImpl_createEntityNameFromSymbolChain(receiver, chain, index - 1), identifier);
    }
    return identifier;
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_symbolToEntityNameNode(receiver, symbol_) {
 ...
 * }
 */
export function NodeBuilderImpl_symbolToTypeNode(receiver, symbol_, mask, typeArguments) {
    ...
    if (Some(chain[0].Declarations, hasNonGlobalAugmentationExternalModuleSymbol)) {
        ...
        if (moduleResolutionKind === ModuleResolutionKindNode16 || moduleResolutionKind === ModuleResolutionKindNodeNext) {
            if (targetFile !== undefined && contextFile !== undefined) {
                ...
                if (receiver.ch.program.GetEmitModuleFormatOfFile(targetHasFileName) === ModuleKindESNext &&
                    ...
                    attributes = NewImportAttributes(receiver.f, KindWithKeyword, NodeFactory_NewNodeList(receiver.f, [NewImportAttribute(receiver.f, NodeBuilderImpl_newStringLiteral(receiver, "resolution-mode"), NodeBuilderImpl_newStringLiteral(receiver, "import"))]), false);
                }
            }
        }
        ...
        if ((receiver.ctx.flags & FlagsAllowNodeModulesRelativePaths) === 0 && specifier.includes("/node_modules/")) {
            ...
            if (moduleResolutionKind === ModuleResolutionKindNode16 || moduleResolutionKind === ModuleResolutionKindNodeNext) {
                ...
                if (specifier.includes("/node_modules/")) {
                    ...
                    attributes = NewImportAttributes(receiver.f, KindWithKeyword, NodeFactory_NewNodeList(receiver.f, [NewImportAttribute(receiver.f, NodeBuilderImpl_newStringLiteral(receiver, "resolution-mode"), NodeBuilderImpl_newStringLiteral(receiver, modeStr))]), false);
                }
            }
        ...
        const lit = NewLiteralTypeNode(receiver.f, NodeBuilderImpl_newStringLiteral(receiver, specifier));
        receiver.ctx.approximateLength += specifier.length + 10;
        if (nonRootParts === undefined || IsEntityName(nonRootParts)) {
            return NewImportTypeNode(receiver.f, isTypeOf, lit, attributes, nonRootParts, typeParameterNodes);
        }
        ...
        return NewIndexedAccessTypeNode(receiver.f, NewImportTypeNode(receiver.f, isTypeOf, lit, attributes, qualifier, typeParameterNodes), splitNode.IndexType);
    }
    ...
    if (IsEntityName(entityName)) {
        if (isTypeOf) {
            return NewTypeQueryNode(receiver.f, entityName, undefined);
        }
        return NewTypeReferenceNode(receiver.f, entityName, typeArguments);
    }
    if (isTypeOf && IsExpressionWithTypeArguments(entityName)) {
        const expr = AsExpressionWithTypeArguments(entityName);
        return NewTypeQueryNode(receiver.f, NodeFactory_DeepCloneNode(receiver.f, expr.Expression), expr.TypeArguments);
    }
    return entityName;
}
/**
 ...
 * }
 */
export function getTopmostIndexedAccessType(node) {
 ...
 * }
 */
export function NodeBuilderImpl_createAccessFromSymbolChain(receiver, chain, index, stopper, overrideTypeArguments) {
    ...
    if (symbolName.length === 0) {
        ...
        if (name !== undefined && IsComputedPropertyName(name) && IsEntityName(Node_Expression(name))) {
            ...
            if (IsEntityName(lhs)) {
                return NewIndexedAccessTypeNode(receiver.f, NewParenthesizedTypeNode(receiver.f, NewTypeQueryNode(receiver.f, lhs, undefined)), NewTypeQueryNode(receiver.f, Node_Expression(name), undefined));
            }
            return lhs;
        }
        symbolName = NodeBuilderImpl_getNameOfSymbolAsWritten(receiver, symbol_);
    ...
    if ((receiver.ctx.flags & FlagsForbidIndexedAccessSymbolReferences) === 0 && parent !== undefined) {
        ...
        if (member !== undefined && Checker_getSymbolIfSameReference(receiver.ch, member, symbol_) !== undefined) {
            ...
            if (IsIndexedAccessTypeNode(lhs)) {
                return NewIndexedAccessTypeNode(receiver.f, lhs, NewLiteralTypeNode(receiver.f, NodeBuilderImpl_newStringLiteral(receiver, symbolName)));
            }
            return NewIndexedAccessTypeNode(receiver.f, NewTypeReferenceNode(receiver.f, lhs, typeParameterNodes), NewLiteralTypeNode(receiver.f, NodeBuilderImpl_newStringLiteral(receiver, symbolName)));
        }
    }
    const identifier = NodeBuilderImpl_newIdentifier(receiver, symbolName, symbol_);
    EmitContext_AddEmitFlags(receiver.e, identifier, EFNoAsciiEscaping);
    if (index > stopper) {
        ...
        if ((receiver.ctx.flags & FlagsUseInstantiationExpressions) === 0 || (IsEntityName(lhs) && (typeParameterNodes === undefined || typeParameterNodes.Nodes.length === 0))) {
            return NewQualifiedName(receiver.f, lhs, identifier);
        }
        return NodeBuilderImpl_createExpressionWithTypeArguments(receiver, NewPropertyAccessExpression(receiver.f, NodeBuilderImpl_createAccessExpression(receiver, lhs), undefined, identifier, NodeFlagsNone), typeParameterNodes);
    }
    return identifier;
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_symbolToExpression(receiver, symbol_, mask) {
    const chain = NodeBuilderImpl_lookupSymbolChain(receiver, symbol_, mask, false);
 ...
 * }
 */
export function NodeBuilderImpl_createExpressionFromSymbolChain(receiver, chain, index) {
    ...
    if (startsWithSingleOrDoubleQuote(symbolName) && Some(symbol_.Declarations, hasNonGlobalAugmentationExternalModuleSymbol)) {
        ...
        return NodeBuilderImpl_newStringLiteral(receiver, specifier);
    }
    if (index === 0 || canUsePropertyAccess(symbolName)) {
        const identifier = NodeBuilderImpl_newIdentifier(receiver, symbolName, symbol_);
        EmitContext_AddEmitFlags(receiver.e, identifier, EFNoAsciiEscaping);
        ...
        if (index > 0) {
            const result = NewPropertyAccessExpression(receiver.f, NodeBuilderImpl_createExpressionFromSymbolChain(receiver, chain, index - 1), undefined, identifier, NodeFlagsNone);
            EmitContext_AddEmitFlags(receiver.e, result, EFNoIndentation);
            return NodeBuilderImpl_createExpressionWithTypeArguments(receiver, result, typeParameterNodes);
        }
        return NodeBuilderImpl_createExpressionWithTypeArguments(receiver, identifier, typeParameterNodes);
    }
    if (startsWithSquareBracket(symbolName)) {
    ...
    if (startsWithSingleOrDoubleQuote(symbolName) && (symbol_.Flags & SymbolFlagsEnumMember) === 0) {
        ...
        expression = NodeBuilderImpl_newStringLiteralEx(receiver, literalText, symbolName[0] === "'");
    }
    else if (String(FromString(symbolName)) === symbolName) {
        receiver.ctx.approximateLength += symbolName.length;
        expression = NewNumericLiteral(receiver.f, symbolName, TokenFlagsNone);
    }
    if (expression === undefined) {
        receiver.ctx.approximateLength += symbolName.length;
        expression = NodeBuilderImpl_newIdentifier(receiver, symbolName, symbol_);
        EmitContext_AddEmitFlags(receiver.e, expression, EFNoAsciiEscaping);
    }
    receiver.ctx.approximateLength += 2;
    return NodeBuilderImpl_createExpressionWithTypeArguments(receiver, NewElementAccessExpression(receiver.f, NodeBuilderImpl_createExpressionFromSymbolChain(receiver, chain, index - 1), undefined, expression, NodeFlagsNone), typeParameterNodes);
}
/**
 ...
 * }
 */
export function canUsePropertyAccess(name) {
    if (name.length === 0) {
        return false;
    }
    // TODO: in strada, this only used `isIdentifierStart` on the first character, while this checks the whole string for validity
 ...
 * }
 */
export function startsWithSingleOrDoubleQuote(str) {
 ...
 * }
 */
export function startsWithSquareBracket(str) {
 ...
 * }
 */
export function isDefaultBindingContext(location) {
    return (location.Kind === KindSourceFile || IsAmbientModule(location));
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_getNameOfSymbolFromNameType(receiver, symbol_) {
    if (LinkStore_Has(receiver.ch.valueSymbolLinks, symbol_)) {
        const nameType = LinkStore_Get(receiver.ch.valueSymbolLinks, symbol_).nameType;
        ...
        if ((nameType.flags & TypeFlagsStringOrNumberLiteral) !== 0) {
            ...
            const name = (typeof litValue === "number" || (litValue !== null && typeof litValue === "object")) ? String(litValue) : litValue;
 ...
 * }
 */
export function NodeBuilderImpl_getNameOfSymbolAsWritten(receiver, symbol_) {
 ...
 * }
 */
export function NodeBuilderImpl_getTypeParametersOfClassOrInterface(receiver, symbol_) {
 ...
 * }
 */
export function NodeBuilderImpl_lookupTypeParameterNodes(receiver, chain, index) {
    const symbol_ = chain[index];
 ...
 * }
 */
export function NodeBuilderImpl_lookupSymbolChain(receiver, symbol_, meaning, yieldModuleSymbol) {
 ...
 * }
 */
export function NodeBuilderImpl_lookupSymbolChainWorker(receiver, symbol_, meaning, yieldModuleSymbol) {
    // Try to get qualified name if the symbol is not a type parameter and there is an enclosing declaration.
    ...
    if (!isTypeParameter && (receiver.ctx.enclosingDeclaration !== undefined || (receiver.ctx.flags & FlagsUseFullyQualifiedType) !== 0) && (receiver.ctx.internalFlags & InternalFlagsDoNotIncludeSymbolChain) === 0) {
        const res = NodeBuilderImpl_getSymbolChain(receiver, symbol_, meaning, true, yieldModuleSymbol);
        const chain = res;
        // debug.Assert(chain != nil)
        // debug.Assert(len(chain) > 0)
        return chain;
 ...
 * }
 */
export function NodeBuilderImpl_getSymbolChain(receiver, symbol_, meaning, endOfChain, yieldModuleSymbol) {
    let accessibleSymbolChain = Checker_getAccessibleSymbolChain(receiver.ch, symbol_, receiver.ctx.enclosingDeclaration, meaning, ((receiver.ctx.flags & FlagsUseOnlyExternalAliasing) !== 0));
    ...
    if ((accessibleSymbolChain === undefined || accessibleSymbolChain.length === 0) ||
        ...
        if (parents !== undefined && parents.length > 0) {
            const parentSpecifiers = parents.map((sym) => {
            ...
            for (const pair of parentSpecifiers) {
                ...
                const parentChain = NodeBuilderImpl_getSymbolChain(receiver, parent, getQualifiedLeftMeaning(meaning), false, yieldModuleSymbol);
                if (parentChain !== undefined && parentChain.length > 0) {
                    ...
                    let nextSyms = accessibleSymbolChain !== undefined && accessibleSymbolChain.length > 0 ? accessibleSymbolChain : undefined;
 ...
 * }
 */
export function NodeBuilderImpl_sortByBestName(receiver, a, b) {
 ...
 * }
 */
export function canHaveModuleSpecifier(node) {
    if (node === undefined) {
        return false;
    }
    switch (node.Kind) {
 ...
 * }
 */
export function TryGetModuleSpecifierFromDeclaration(node) {
 ...
 * }
 */
export function tryGetModuleSpecifierFromDeclarationWorker(node) {
    switch (node.Kind) {
        case KindVariableDeclaration:
        case KindBindingElement: {
            const requireCall = FindAncestor(Node_Initializer(node), (current) => IsRequireCall(current, true));
 ...
 * }
 */
export function NodeBuilderImpl_getSpecifierForModuleSymbol(receiver, symbol_, overrideImportMode) {
    ...
    if (resolutionMode === ResolutionModeNone && originalModuleSpecifier !== undefined) {
        resolutionMode = receiver.ch.program.GetEmitSyntaxForUsageLocation(contextHasFileName, originalModuleSpecifier);
    }
    else if (resolutionMode === ResolutionModeNone && contextFile !== undefined) {
        resolutionMode = receiver.ch.program.GetImpliedNodeFormatForEmit(contextHasFileName);
    }
    const cacheKey = { Name: String(SourceFile_Path(contextFile)), Mode: resolutionMode };
    const links = LinkStore_Get(receiver.symbolLinks, symbol_);
    if (links.specifierCache === undefined) {
        links.specifierCache = new globalThis.Map();
    }
    if (links.specifierCache.has(cacheKey)) {
        return links.specifierCache.get(cacheKey);
    }
    const host = (receiver.ctx.host.__tsgoEmbedded0 ?? receiver.ctx.host);
    ...
    const checkerShape = {
        GetSymbolAtLocation: (node) => Checker_GetSymbolAtLocation(receiver.ch, node),
        GetAliasedSymbol: (aliasSymbol) => Checker_GetAliasedSymbol(receiver.ch, aliasSymbol),
    };
    const allSpecifiers = GetModuleSpecifiers(symbol_, checkerShape, specifierCompilerOptions, importingSourceFile, host, {
        ImportModuleSpecifierPreference: specifierPref,
        ImportModuleSpecifierEnding: endingPref,
        AutoImportSpecifierExcludeRegexes: [],
    }, { OverrideImportMode: overrideImportMode }, false);
 ...
 * }
 */
export function NodeBuilderImpl_typeParameterToDeclarationWithConstraint(receiver, typeParameter, constraintNode) {
    const restoreFlags = NodeBuilderImpl_saveRestoreFlags(receiver);
    ...
    restoreFlags();
    return NewTypeParameterDeclaration(receiver.f, modifiersList, NodeDefault_AsNode(name), constraintNode, undefined, defaultParameterDeclarationNode);
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_setTextRange(receiver, range_, location) {
    if (range_ === undefined) {
        return range_;
    }
    const cloned = (!NodeIsSynthesized(range_) || (range_.Flags & NodeFlagsSynthesized) === 0 || receiver.ctx.enclosingFile === undefined || receiver.ctx.enclosingFile !== GetSourceFileOfNode(EmitContext_MostOriginal(receiver.e, range_)))
        ? (() => {
            ...
            const symbol = receiver.idToSymbol.get(original);
            if (symbol !== undefined) {
                receiver.idToSymbol.set(c, symbol);
            }
            return c;
        })()
        : range_;
    ...
    const checkOriginal = (() => {
        const findOriginalLoop = (o) => {
            if (o === undefined || o === location)
                return o;
 ...
 * }
 */
export function NodeBuilderImpl_typeParameterShadowsOtherTypeParameterInScope(receiver, name, typeParameter) {
    const result = receiver.ch.resolveName(receiver.ctx.enclosingDeclaration, name, SymbolFlagsType, undefined, false, false);
 ...
 * }
 */
export function NodeBuilderImpl_typeParameterToName(receiver, typeParameter) {
    ...
    let result = NodeBuilderImpl_symbolToName(receiver, typeParameter["symbol"], SymbolFlagsType, true);
 ...
 * }
 */
export function NodeBuilderImpl_isMappedTypeHomomorphic(receiver, mapped) {
 ...
 * }
 */
export function NodeBuilderImpl_isHomomorphicMappedTypeWithNonHomomorphicInstantiation(receiver, mapped) {
    const mappedAsType = mapped.AsType();
    const target = Type_Target(mappedAsType);
    return (target !== undefined &&
        !NodeBuilderImpl_isMappedTypeHomomorphic(receiver, mappedAsType) &&
        NodeBuilderImpl_isMappedTypeHomomorphic(receiver, target));
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_createMappedTypeNodeFromType(receiver, t) {
    ...
    let appropriateConstraintTypeNode = undefined;
    let newTypeVariable = undefined;
    ...
    const constraintOfConstraint = (constraintType.flags & TypeFlagsTypeParameter) !== 0
        ...
        : undefined;
    const needsModifierPreservingWrapper = !Checker_isMappedTypeWithKeyofConstraintDeclaration(b.ch, t) &&
    ...
    if (Checker_isMappedTypeWithKeyofConstraintDeclaration(b.ch, t)) {
        if ((b.ctx.flags & FlagsGenerateNamesForShadowedTypeParams) !== 0 && NodeBuilderImpl_isHomomorphicMappedTypeWithNonHomomorphicInstantiation(receiver, mapped)) {
            ...
            newTypeVariable = NewTypeReferenceNode(b.f, name, undefined);
            templateType = Checker_instantiateType(b.ch, Checker_getTemplateTypeFromMappedType(b.ch, target), newTypeMapper([Checker_getTypeParameterFromMappedType(b.ch, target), Checker_getModifiersTypeFromMappedType(b.ch, target)], [typeParameter, newConstraintParam]));
        }
        const indexTarget = newTypeVariable !== undefined
            ? newTypeVariable
            : NodeBuilderImpl_typeToTypeNode(receiver, modifiersType);
        appropriateConstraintTypeNode = NewTypeOperatorNode(b.f, KindKeyOfKeyword, indexTarget);
    }
    else if (needsModifierPreservingWrapper) {
    ...
    const nameTypeNode = declaration.NameType !== undefined
        ...
        : undefined;
    const templateTypeNode = NodeBuilderImpl_typeToTypeNode(receiver, Checker_removeMissingType(b.ch, templateType, (getMappedTypeModifiers(t) & MappedTypeModifiersIncludeOptional) !== 0));
    cleanup();
    const result = NewMappedTypeNode(b.f, readonlyToken, typeParameterDeclarationNode, nameTypeNode, questionToken, templateTypeNode, undefined);
    b.ctx.approximateLength += 10;
    ...
    if ((b.ctx.flags & FlagsGenerateNamesForShadowedTypeParams) !== 0 && NodeBuilderImpl_isHomomorphicMappedTypeWithNonHomomorphicInstantiation(receiver, mapped)) {
        ...
        const originalConstraint = Checker_instantiateType(b.ch, rawConstraintTypeFromDeclaration, mapped.AsObjectType().mapper);
        ...
        return NewConditionalTypeNode(b.f, NodeBuilderImpl_typeToTypeNode(receiver, modifiersType), NewInferTypeNode(b.f, NewTypeParameterDeclaration(b.f, undefined, NodeFactory_DeepCloneNode(b.f, newTypeVariableName), originalConstraintNode, undefined, undefined)), result, NewKeywordTypeNode(b.f, KindNeverKeyword));
    }
    else if (needsModifierPreservingWrapper) {
        const newTypeVariableName = AsTypeReferenceNode(newTypeVariable).TypeName;
        return NewConditionalTypeNode(b.f, NodeBuilderImpl_typeToTypeNode(receiver, constraintType), NewInferTypeNode(b.f, NewTypeParameterDeclaration(b.f, undefined, NodeFactory_DeepCloneNode(b.f, newTypeVariableName), NewTypeOperatorNode(b.f, KindKeyOfKeyword, NodeBuilderImpl_typeToTypeNode(receiver, modifiersType)), undefined, undefined)), result, NewKeywordTypeNode(b.f, KindNeverKeyword));
    }
    return result;
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_typePredicateToTypePredicateNode(receiver, predicate) {
    ...
    return NewTypePredicateNode(receiver.f, assertsModifier, parameterName, typeNode);
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_typeToTypeNodeHelperWithPossibleReusableTypeNode(receiver, t, typeNode) {
    if (t === undefined) {
        return NewKeywordTypeNode(receiver.f, KindAnyKeyword);
    }
    if (!NodeBuilderImpl_isActivelyExpanding(receiver) && typeNode !== undefined && NodeBuilderImpl_getTypeFromTypeNode(receiver, typeNode, false) === t) {
 ...
 * }
 */
export function NodeBuilderImpl_typeParameterToDeclaration(receiver, parameter) {
    const constraint = Checker_getConstraintOfTypeParameter(receiver.ch, parameter);
    const constraintNode = constraint !== undefined
        ? NodeBuilderImpl_typeToTypeNodeHelperWithPossibleReusableTypeNode(receiver, constraint, Checker_getConstraintDeclaration(receiver.ch, parameter))
        : undefined;
 ...
 * }
 */
export function NodeBuilderImpl_symbolToTypeParameterDeclarations(receiver, symbol_) {
 ...
 * }
 */
export function NodeBuilderImpl_typeParametersToTypeParameterDeclarations(receiver, symbol_) {
 ...
 * }
 */
export function getEffectiveParameterDeclaration(symbol_) {
 ...
 * }
 */
export function NodeBuilderImpl_symbolToParameterDeclaration(receiver, parameterSymbol, preserveModifierFlags) {
    const parameterDeclaration = getEffectiveParameterDeclaration(parameterSymbol);
    const parameterType = Checker_getTypeOfSymbol(receiver.ch, parameterSymbol);
    const parameterTypeNode = NodeBuilderImpl_serializeTypeForDeclaration(receiver, parameterDeclaration, parameterType, parameterSymbol, true);
    let modifiers;
    if ((receiver.ctx.flags & FlagsOmitParameterModifiers) === 0 && preserveModifierFlags && parameterDeclaration !== undefined && CanHaveModifiers(parameterDeclaration)) {
        ...
        const clones = CoreMap(originals, (node) => Node_Clone(node, receiver.f));
        if (clones.length > 0) {
            modifiers = NodeFactory_NewModifierList(receiver.f, clones);
        }
    }
    const isRest = ((parameterDeclaration !== undefined && isRestParameter(parameterDeclaration)) || (parameterSymbol.CheckFlags & CheckFlagsRestParameter) !== 0);
    ...
    const isOptional = ((parameterDeclaration !== undefined && Checker_isOptionalParameter(receiver.ch, parameterDeclaration)) || (parameterSymbol.CheckFlags & CheckFlagsOptionalParameter) !== 0);
    const questionToken = isOptional ? NewToken(receiver.f, KindQuestionToken) : undefined;
    const parameterNode = NewParameterDeclaration(receiver.f, modifiers, dotDotDotToken, name, questionToken, parameterTypeNode, undefined);
 ...
 * }
 */
export function NodeBuilderImpl_parameterToParameterDeclarationName(receiver, parameterSymbol, parameterDeclaration) {
    ...
    if (IsIdentifier(name)) {
        ...
        receiver.idToSymbol.set(cloned, parameterSymbol);
        return cloned;
    }
 ...
 * }
 */
export function NodeBuilderImpl_cloneBindingName(receiver, node) {
    ...
    if (IsBindingElement(visited)) {
        ...
        visited = NodeFactory_UpdateBindingElement(receiver.f, bindingElement, bindingElement.DotDotDotToken, bindingElement.PropertyName, Node_Name(visited), undefined);
    }
 ...
 * }
 */
export function NodeBuilderImpl_serializeTypeForExpression(receiver, expr) {
    // !!! TODO: shim, add node reuse
 ...
 * }
 */
export function NodeBuilderImpl_serializeInferredReturnTypeForSignature(receiver, signature, returnType) {
 ...
 * }
 */
export function NodeBuilderImpl_typePredicateToTypePredicateNodeHelper(receiver, typePredicate) {
 ...
 * }
 */
export function NodeBuilderImpl_signatureToSignatureDeclarationHelper(receiver, signature, kind, options) {
    ...
    const parameterSource = Some(expandedParams, (p) => p !== expandedParams[expandedParams.length - 1] && (p.CheckFlags & CheckFlagsRestParameter) !== 0)
        ? signatureParameters
        : expandedParams;
    let parameters = parameterSource.map((parameter) => NodeBuilderImpl_symbolToParameterDeclaration(receiver, parameter, kind === KindConstructor));
    ...
    let modifiers = options !== undefined ? options.modifiers : undefined;
    ...
    switch (kind) {
        case KindCallSignature:
            node = NewCallSignatureDeclaration(receiver.f, typeParamList, paramList, returnTypeNode);
            break;
        case KindConstructSignature:
            node = NewConstructSignatureDeclaration(receiver.f, typeParamList, paramList, returnTypeNode);
            break;
        case KindMethodSignature:
            node = NewMethodSignatureDeclaration(receiver.f, modifierList, name, options !== undefined ? options.questionToken : undefined, typeParamList, paramList, returnTypeNode);
            break;
        case KindMethodDeclaration:
            node = NewMethodDeclaration(receiver.f, modifierList, undefined, name, undefined, typeParamList, paramList, returnTypeNode, undefined, undefined);
            break;
        case KindConstructor:
            node = NewConstructorDeclaration(receiver.f, modifierList, undefined, paramList, undefined, undefined, undefined);
            break;
        case KindGetAccessor:
            node = NewGetAccessorDeclaration(receiver.f, modifierList, name, undefined, paramList, returnTypeNode, undefined, undefined);
            break;
        case KindSetAccessor:
            node = NewSetAccessorDeclaration(receiver.f, modifierList, name, undefined, paramList, undefined, undefined, undefined);
            break;
        case KindIndexSignature:
            node = NewIndexSignatureDeclaration(receiver.f, modifierList, paramList, returnTypeNode);
            break;
        case KindFunctionType:
            if (returnTypeNode === undefined) {
                returnTypeNode = NewTypeReferenceNode(receiver.f, NewIdentifier(receiver.f, ""), undefined);
            }
            node = NewFunctionTypeNode(receiver.f, typeParamList, paramList, returnTypeNode);
            break;
        case KindConstructorType:
            if (returnTypeNode === undefined) {
                returnTypeNode = NewTypeReferenceNode(receiver.f, NewIdentifier(receiver.f, ""), undefined);
            }
            node = NewConstructorTypeNode(receiver.f, modifierList, typeParamList, paramList, returnTypeNode);
            break;
        case KindFunctionDeclaration:
            node = NewFunctionDeclaration(receiver.f, modifierList, undefined, name, typeParamList, paramList, returnTypeNode, undefined, undefined);
            break;
        case KindFunctionExpression:
            node = NewFunctionExpression(receiver.f, modifierList, undefined, name, typeParamList, paramList, returnTypeNode, undefined, NewBlock(receiver.f, NodeFactory_NewNodeList(receiver.f, []), false));
            break;
        case KindArrowFunction:
            node = NewArrowFunction(receiver.f, modifierList, typeParamList, paramList, returnTypeNode, undefined, undefined, NewBlock(receiver.f, NodeFactory_NewNodeList(receiver.f, []), false));
            break;
        default:
 ...
 * }
 */
export function Checker_getExpandedParameters(receiver, sig, skipUnionExpanding) {
    if (signatureHasRestParameter(sig)) {
        const restIndex = sig.parameters.length - 1;
        const restSymbol = sig.parameters[restIndex];
        const restType = Checker_getTypeOfSymbol(receiver, restSymbol);
        const getUniqAssociatedNamesFromTupleType = (t, tupleRestSymbol) => {
            ...
            if (names.length > 0) {
                const duplicates = [];
                const uniqueNames = new globalThis.Map();
                ...
                const counters = new globalThis.Map();
        ...
        const expandSignatureParametersWithTupleMembers = (tupleRestType, tupleRestIndex, tupleRestSymbol) => {
 ...
 * }
 */
export function NodeBuilderImpl_tryGetThisParameterDeclaration(receiver, signature) {
    if (signature.thisParameter !== undefined) {
        return NodeBuilderImpl_symbolToParameterDeclaration(receiver, signature.thisParameter, false);
    }
 ...
 * }
 */
export function NodeBuilderImpl_serializeReturnTypeForSignature(receiver, signature, tryReuse) {
    ...
    if (!(suppressAny && IsTypeAny(returnType))) {
        if (!NodeBuilderImpl_isActivelyExpanding(receiver) && tryReuse && receiver.ctx.enclosingDeclaration !== undefined && signature.declaration !== undefined && !NodeIsSynthesized(signature.declaration)) {
            ...
            if (NodeBuilderImpl_pseudoTypeEquivalentToType(receiver, pt, returnType, false, !receiver.ctx.suppressReportInferenceFallback)) {
                const typePredicate = Checker_getTypePredicateOfSignature(receiver.ch, signature);
 ...
 * }
 */
export function NodeBuilderImpl_isTriviallySerializableComputedName(receiver, e) {
    ...
    // TODO: going through emit resolver here is weird. Relayer these APIs.
    return EmitResolver_isEntityNameVisible(Checker_GetEmitResolver(receiver.ch), Node_Expression(Node_Name(e)), receiver.ctx.enclosingDeclaration, false).Accessibility === SymbolAccessibilityAccessible;
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_indexInfoToObjectComputedNamesOrSignatureDeclaration(receiver, indexInfo, typeNode) {
            ...
            const results = CoreMap(newComponents, (e) => {
                ...
                if (name !== undefined) {
                    ...
                    if (Node_PostfixToken(e) !== undefined) {
                        postfixToken = Node_Clone(Node_PostfixToken(e), receiver.f);
                    }
                    let currentTypeNode;
                    if (typeNode !== undefined) {
                    ...
                    const sig = NewPropertySignatureDeclaration(receiver.f, mods, name, postfixToken, currentTypeNode, undefined);
                    sig.Loc = e.Loc;
                    return sig;
                }
                bailed = true;
 ...
 * }
 */
export function NodeBuilderImpl_indexInfoToIndexSignatureDeclarationHelper(receiver, indexInfo, typeNode) {
    const name = getNameFromIndexInfo(indexInfo);
    const indexerTypeNode = NodeBuilderImpl_typeToTypeNode(receiver, indexInfo.keyType);
    const indexingParameter = NewParameterDeclaration(receiver.f, undefined, undefined, NodeBuilderImpl_newIdentifier(receiver, name, undefined), undefined, indexerTypeNode, undefined);
    let resolvedTypeNode = typeNode;
    if (resolvedTypeNode === undefined) {
        if (indexInfo.valueType === undefined) {
            resolvedTypeNode = NewKeywordTypeNode(receiver.f, KindAnyKeyword);
        }
        else {
    ...
    return NewIndexSignatureDeclaration(receiver.f, modifiers, NodeFactory_NewNodeList(receiver.f, [indexingParameter]), resolvedTypeNode);
}
/**
 ...
 * }
 */
export function hasTypeAnnotation(declaration) {
    return (declaration !== undefined && Node_Type(declaration) !== undefined);
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_serializeTypeForDeclaration(receiver, declaration, t, symbol_, tryReuse) {
    if (declaration === undefined && symbol_ !== undefined) {
        declaration = symbol_.ValueDeclaration;
        if (declaration === undefined) {
            declaration = FirstOrNil(symbol_.Declarations ?? []);
        }
    }
    ...
    if (addUndefinedForParameter) {
        t = Checker_getOptionalType(receiver.ch, t, false);
    }
    const restoreFlags = NodeBuilderImpl_saveRestoreFlags(receiver);
    ...
    if (!NodeBuilderImpl_isActivelyExpanding(receiver) &&
        ...
        if ((pt === undefined || pt.Kind === PseudoTypeKindNoResult) && IsBinaryExpression(declaration)) {
            ...
            if (decl !== undefined) {
                // Binary expressions have a first-in-wins type annotation system. The first one with an annotation supplies the type for the rest.
                pt = PseudoChecker_GetTypeOfDeclaration(receiver.pc, decl);
            }
        }
        const reportErrors = !receiver.ctx.suppressReportInferenceFallback;
        if (pt !== undefined && NodeBuilderImpl_pseudoTypeEquivalentToType(receiver, pt, t, !requiresAddingUndefined &&
            (IsParameterDeclaration(declaration) || IsPropertySignatureDeclaration(declaration) || IsPropertyDeclaration(declaration)) &&
            isOptionalDeclaration(declaration), reportErrors)) {
            let pseudoType = pt;
            ...
            if (requiresAddingUndefined) {
                ...
                if (NodeBuilderImpl_pseudoTypeEquivalentToType(receiver, pseudoType, t, false, reportErrors)) {
                    result = NodeBuilderImpl_pseudoTypeToNodeWithCheckerFallback(receiver, pseudoType, t);
                    reportedInferenceFallback = false;
                }
            }
 ...
 */
export const MAX_REVERSE_MAPPED_NESTING_INSPECTION_DEPTH = 3;
/**
 ...
 * }
 */
export function NodeBuilderImpl_shouldUsePlaceholderForProperty(receiver, propertySymbol) {
    ...
    if (receiver.ctx.reverseMappedStack.length > 0) {
        ...
        if (LinkStore_Has(receiver.ch.ReverseMappedSymbolLinks, last)) {
            const links = LinkStore_TryGet(receiver.ch.ReverseMappedSymbolLinks, last);
    ...
    if (!LinkStore_Has(receiver.ch.ReverseMappedSymbolLinks, propertySymbol)) {
        return false;
    }
    const propertyLinks = LinkStore_TryGet(receiver.ch.ReverseMappedSymbolLinks, propertySymbol);
    ...
    for (let i = 0; i < receiver.ctx.reverseMappedStack.length; i++) {
        ...
        if (LinkStore_Has(receiver.ch.ReverseMappedSymbolLinks, prop)) {
            const links = LinkStore_TryGet(receiver.ch.ReverseMappedSymbolLinks, prop);
 ...
 * }
 */
export function NodeBuilderImpl_trackComputedName(receiver, accessExpression, enclosingDeclaration) {
    const firstIdentifier = GetFirstIdentifier(accessExpression);
    const name = receiver.ch.resolveName(enclosingDeclaration, AsIdentifier(firstIdentifier).Text, (SymbolFlagsValue | SymbolFlagsExportValue), undefined, true, false);
    if (name !== undefined) {
        receiver.ctx.tracker.TrackSymbol(name, enclosingDeclaration, SymbolFlagsValue);
    }
    else {
        const fallback = receiver.ch.resolveName(firstIdentifier, AsIdentifier(firstIdentifier).Text, (SymbolFlagsValue | SymbolFlagsExportValue), undefined, true, false);
        if (fallback !== undefined) {
            receiver.ctx.tracker.TrackSymbol(fallback, enclosingDeclaration, SymbolFlagsValue);
        }
    }
}
/**
 ...
 * )
 */
export const propertyNameNodeKindIdentifier = 0;
export const propertyNameNodeKindNumericLiteral = 1;
export const propertyNameNodeKindStringLiteral = 2;
/**
 ...
 * }
 */
export function classifyPropertyName(name, stringNamed, isMethod) {
    if (isMethod && name === "new") {
        return propertyNameNodeKindStringLiteral;
    }
 ...
 * }
 */
export function NodeBuilderImpl_createPropertyNameNodeForIdentifierOrLiteral(receiver, name, singleQuote, stringNamed, isMethod, symbol_) {
    switch (classifyPropertyName(name, stringNamed, isMethod)) {
        case propertyNameNodeKindIdentifier:
 ...
 * }
 */
export function NodeBuilderImpl_isStringNamed(receiver, d) {
 ...
 * }
 */
export function NodeBuilderImpl_isSingleQuotedStringNamed(receiver, d) {
    const name = GetNameOfDeclaration(d);
 ...
 * }
 */
export function NodeBuilderImpl_getPropertyNameNodeForSymbol(receiver, symbol_) {
    if (symbol_.ValueDeclaration !== undefined) {
 ...
 * }
 */
export function NodeBuilderImpl_getPropertyNameNodeForSymbolFromNameType(receiver, symbol_, singleQuote, stringNamed, isMethod) {
    if (!LinkStore_Has(receiver.ch.valueSymbolLinks, symbol_)) {
        return undefined;
    }
    const linksVal = LinkStore_TryGet(receiver.ch.valueSymbolLinks, symbol_);
    ...
    if ((nameType.flags & TypeFlagsStringOrNumberLiteral) !== 0) {
        const litValue = Type_AsLiteralType(nameType).value;
        const name = typeof litValue === "number" ? String(litValue) : litValue;
    ...
    if ((nameType.flags & TypeFlagsUniqueESSymbol) !== 0) {
        ...
        return NewComputedPropertyName(receiver.f, NodeBuilderImpl_symbolToExpression(receiver, uniqueSymbol, SymbolFlagsValue));
    }
    return undefined;
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_addPropertyToElementList(receiver, propertySymbol, typeElements) {
            ...
            if (Checker_hasLateBindableName(receiver.ch, declaration)) {
                if (IsBinaryExpression(declaration)) {
                    ...
                    if (name !== undefined &&
                        ...
                        IsPropertyAccessEntityNameExpression(AsElementAccessExpression(name).ArgumentExpression, false)) {
                        NodeBuilderImpl_trackComputedName(receiver, AsElementAccessExpression(name).ArgumentExpression, saveEnclosingDeclaration);
                    }
                }
                else {
    ...
    const propertyName = NodeBuilderImpl_getPropertyNameNodeForSymbol(receiver, propertySymbol);
    receiver.ctx.enclosingDeclaration = saveEnclosingDeclaration;
    ...
    if ((propertySymbol.Flags & SymbolFlagsAccessor) !== 0) {
        ...
        if (!Checker_isErrorType(receiver.ch, propertyType) && !Checker_isErrorType(receiver.ch, writeType)) {
            ...
            if (propertyType !== writeType || (propertySymbol.Parent !== undefined && (propertySymbol.Parent.Flags & SymbolFlagsClass) !== 0 && propDeclaration === undefined)) {
                const symbolMapper = LinkStore_Get(receiver.ch.valueSymbolLinks, propertySymbol).mapper;
                ...
                typeElements.push(fakeGetterDeclaration);
                const setterParam = Checker_newSymbol(receiver.ch, SymbolFlagsFunctionScopedVariable, "arg");
                LinkStore_Get(receiver.ch.valueSymbolLinks, setterParam).resolvedType = writeType;
                ...
                typeElements.push(fakeSetterDeclaration);
                return typeElements;
            }
        }
    }
    ...
    if ((propertySymbol.Flags & (SymbolFlagsFunction | SymbolFlagsMethod)) !== 0 &&
        ...
        const signatures = Checker_getSignaturesOfType(receiver.ch, Checker_filterType(receiver.ch, propertyType, (type_) => (type_.flags & TypeFlagsUndefined) === 0), SignatureKindCall);
    ...
    if (NodeBuilderImpl_shouldUsePlaceholderForProperty(receiver, propertySymbol)) {
        ...
        if (propertyType !== undefined) {
            propertyTypeNode = NodeBuilderImpl_serializeTypeForDeclaration(receiver, undefined, propertyType, propertySymbol, true);
        }
        else {
    ...
    const propertySignature = NewPropertySignatureDeclaration(receiver.f, modifiers, propertyName, optionalToken, propertyTypeNode, undefined);
 ...
 * }
 */
export function NodeBuilderImpl_createTypeNodesFromResolvedType(receiver, resolvedType) {
    if (NodeBuilderImpl_checkTruncationLength(receiver)) {
        if ((receiver.ctx.flags & FlagsNoTruncation) !== 0) {
            const elem = NewNotEmittedTypeElement(receiver.f);
            return NodeFactory_NewNodeList(receiver.f, [EmitContext_AddSyntheticTrailingComment(receiver.e, elem, KindMultiLineCommentTrivia, "elided", false)]);
        }
        return NodeFactory_NewNodeList(receiver.f, [NewPropertySignatureDeclaration(receiver.f, undefined, NewIdentifier(receiver.f, "..."), undefined, undefined, undefined)]);
    }
    let typeElements = [];
    for (const signature of StructuredType_CallSignatures(resolvedType)) {
        typeElements.push(NodeBuilderImpl_signatureToSignatureDeclarationHelper(receiver, signature, KindCallSignature, undefined));
    }
    for (const signature of StructuredType_ConstructSignatures(resolvedType)) {
        if ((signature.flags & SignatureFlagsAbstract) !== 0) {
            continue;
        }
        typeElements.push(NodeBuilderImpl_signatureToSignatureDeclarationHelper(receiver, signature, KindConstructSignature, undefined));
    }
    const resolvedObjectFlags = resolvedType.AsType().objectFlags;
    for (const info of resolvedType.indexInfos ?? []) {
        typeElements = slices.Concat(typeElements, NodeBuilderImpl_indexInfoToObjectComputedNamesOrSignatureDeclaration(receiver, info, (resolvedObjectFlags & ObjectFlagsReverseMapped) !== 0 ? NodeBuilderImpl_createElidedInformationPlaceholder(receiver) : undefined));
    }
    ...
    for (const propertySymbol of properties) {
        ...
        if (NodeBuilderImpl_checkTruncationLength(receiver) && (i + 2 < properties.length - 1)) {
            if ((receiver.ctx.flags & FlagsNoTruncation) !== 0) {
                typeElements[typeElements.length - 1] = EmitContext_AddSyntheticTrailingComment(receiver.e, typeElements[typeElements.length - 1], KindMultiLineCommentTrivia, `... ${properties.length - i} more elided ...`, false);
            }
            else {
                const text = `... ${properties.length - i} more ...`;
                typeElements.push(NewPropertySignatureDeclaration(receiver.f, undefined, NewIdentifier(receiver.f, text), undefined, undefined, undefined));
            }
 ...
 * }
 */
export function NodeBuilderImpl_createTypeNodeFromObjectType(receiver, t) {
    ...
    if ((resolved.properties ?? []).length === 0 && (resolved.indexInfos ?? []).length === 0) {
        ...
        if (callSigs.length === 1 && ctorSigs.length === 0) {
            return NodeBuilderImpl_signatureToSignatureDeclarationHelper(receiver, callSigs[0], KindFunctionType, undefined);
        }
        if (ctorSigs.length === 1 && callSigs.length === 0) {
            return NodeBuilderImpl_signatureToSignatureDeclarationHelper(receiver, ctorSigs[0], KindConstructorType, undefined);
        }
    }
    ...
    restoreFlags();
    const typeLiteralNode = NewTypeLiteralNode(receiver.f, members);
    receiver.ctx.approximateLength += 2;
 ...
 * }
 */
export function getTypeAliasForTypeLiteral(c, t) {
 ...
 * }
 */
export function NodeBuilderImpl_shouldWriteTypeOfFunctionSymbol(receiver, symbol_, typeId) {
    const isStaticMethodSymbol = (symbol_.Flags & SymbolFlagsMethod) !== 0 && Some(symbol_.Declarations, (declaration) => IsStatic(declaration) && !Checker_isLateBindableIndexSignature(receiver.ch, GetNameOfDeclaration(declaration)));
 ...
 * }
 */
export function NodeBuilderImpl_createAnonymousTypeNode(receiver, t) {
    return NodeBuilderImpl_createAnonymousTypeNodeEx(receiver, t, false, false);
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_createAnonymousTypeNodeEx(receiver, t, forceClassExpansion, forceExpansion) {
    const typeId = t.id;
    ...
    if (symbol_ !== undefined) {
        ...
        if (isInstantiationExpressionType) {
            ...
            if (IsTypeQueryNode(existing) && NodeBuilderImpl_getTypeFromTypeNode(receiver, existing, false) === t) {
                // Guard against unbounded recursion when the existing typeof node fails to be reused
                // (e.g. its entity name isn't accessible from this scope) and the recovery boundary's
                // fallback re-enters typeToTypeNode with the very same instantiation type, which would
                // in turn try to reuse the same node again. Mark the type as visited around the reuse
                ...
                const typeNode = NodeBuilderImpl_tryReuseExistingNonParameterTypeNode(receiver, existing, t, undefined, undefined);
 ...
 * }
 */
export function NodeBuilderImpl_getTypeFromTypeNode(receiver, node, noMappedTypes) {
 ...
 * }
 */
export function NodeBuilderImpl_typeToTypeNodeOrCircularityElision(receiver, t) {
    if ((t.flags & TypeFlagsUnion) !== 0) {
 ...
 * }
 */
export function NodeBuilderImpl_conditionalTypeToTypeNode(receiver, _t) {
    if (NodeBuilderImpl_checkTruncationLength(receiver)) {
        return NodeBuilderImpl_createElidedInformationPlaceholder(receiver);
    }
    ...
    if ((receiver.ctx.flags & FlagsGenerateNamesForShadowedTypeParams) !== 0 && t.root.isDistributive && (t.checkType.flags & TypeFlagsTypeParameter) === 0) {
        ...
        const syntheticExtendsNode = NewInferTypeNode(receiver.f, NewTypeParameterDeclaration(receiver.f, undefined, newId, undefined, undefined, undefined));
        ...
        const syntheticTrueNode = NewConditionalTypeNode(receiver.f, NewTypeReferenceNode(receiver.f, NodeFactory_DeepCloneNode(receiver.f, name), undefined), NodeFactory_DeepCloneNode(receiver.f, checkTypeNode), innerCheckConditionalNode, NewKeywordTypeNode(receiver.f, KindNeverKeyword));
        return NewConditionalTypeNode(receiver.f, checkTypeNode, syntheticExtendsNode, syntheticTrueNode, NewKeywordTypeNode(receiver.f, KindNeverKeyword));
    }
    const saveInferTypeParameters = receiver.ctx.inferTypeParameters;
    receiver.ctx.inferTypeParameters = t.root.inferTypeParameters;
    ...
    return NewConditionalTypeNode(receiver.f, checkTypeNode, extendsTypeNode, trueTypeNode, falseTypeNode);
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_getParentSymbolOfTypeParameter(receiver, typeParameter) {
    ...
    const typeObj = typeParameter.AsType();
 ...
 * }
 */
export function NodeBuilderImpl_typeReferenceToTypeNode(receiver, t) {
    ...
    if (target === receiver.ch.globalArrayType || target === receiver.ch.globalReadonlyArrayType) {
        if ((receiver.ctx.flags & FlagsWriteArrayAsGenericType) !== 0) {
            ...
            return NewTypeReferenceNode(receiver.f, NodeBuilderImpl_newIdentifier(receiver, target === receiver.ch.globalArrayType ? "Array" : "ReadonlyArray", target.symbol), NodeFactory_NewNodeList(receiver.f, [typeArgumentNode]));
        }
        ...
        return NewTypeOperatorNode(receiver.f, KindReadonlyKeyword, arrayType);
    }
        ...
        if (typeArguments.length > 0) {
            ...
            if (tupleConstituentNodes !== undefined) {
                for (let index = 0; index < tupleConstituentNodes.Nodes.length; index++) {
                    ...
                    const currentNode = tupleConstituentNodes.Nodes[index];
                    if (labeledElementDeclaration !== undefined) {
                        const elementType = (flags & ElementFlagsRest) !== 0 ? NewArrayTypeNode(receiver.f, currentNode) : currentNode;
                        tupleConstituentNodes.Nodes[index] = NewNamedTupleMember(receiver.f, (flags & ElementFlagsVariable) !== 0 ? NewToken(receiver.f, KindDotDotDotToken) : undefined, NodeBuilderImpl_newIdentifier(receiver, Checker_getTupleElementLabel(receiver.ch, tupleTarget.elementInfos[index], undefined, index), undefined), (flags & ElementFlagsOptional) !== 0 ? NewToken(receiver.f, KindQuestionToken) : undefined, elementType);
                    }
                    else if ((flags & ElementFlagsVariable) !== 0) {
                        const restType = (flags & ElementFlagsRest) !== 0 ? NewArrayTypeNode(receiver.f, currentNode) : currentNode;
                ...
                const tupleTypeNode = NewTupleTypeNode(receiver.f, tupleConstituentNodes);
                EmitContext_SetEmitFlags(receiver.e, tupleTypeNode, EFSingleLine);
                if (tupleTarget.readonly) {
                    return NewTypeOperatorNode(receiver.f, KindReadonlyKeyword, tupleTypeNode);
                }
                return tupleTypeNode;
            }
        }
        if (receiver.ctx.encounteredError || (receiver.ctx.flags & FlagsAllowEmptyTuple) !== 0) {
            const tupleTypeNode = NewTupleTypeNode(receiver.f, NodeFactory_NewNodeList(receiver.f, []));
            EmitContext_SetEmitFlags(receiver.e, tupleTypeNode, EFSingleLine);
            if (tupleTarget.readonly) {
                return NewTypeOperatorNode(receiver.f, KindReadonlyKeyword, tupleTypeNode);
            }
 ...
 * }
 */
export function NodeBuilderImpl_visitAndTransformType(receiver, t, transform) {
    const typeId = t.id;
    ...
    if ((t.objectFlags & ObjectFlagsReference) !== 0 && Type_AsTypeReference(t).node !== undefined) {
        id = { isConstructorNode: false, symbolId: 0, nodeId: GetNodeId(Type_AsTypeReference(t).node) };
    }
    else if ((t.flags & TypeFlagsConditional) !== 0) {
        id = { isConstructorNode: false, symbolId: 0, nodeId: GetNodeId(Type_AsConditionalType(t).root.node) };
    }
    else if (t.symbol !== undefined) {
        id = { isConstructorNode: isConstructorObject, symbolId: GetSymbolId(t.symbol), nodeId: 0 };
    }
    const key = { typeId: typeId, flags: receiver.ctx.flags, internalFlags: receiver.ctx.internalFlags };
    // Don't rely on type cache if we're expanding a type, because we need to compute `canIncreaseExpansionDepth`.
    const canUseCache = receiver.ctx.maxExpansionDepth < 0;
    if (canUseCache && receiver.ctx.enclosingDeclaration !== undefined && LinkStore_Has(receiver.links, receiver.ctx.enclosingDeclaration)) {
        const links = LinkStore_Get(receiver.links, receiver.ctx.enclosingDeclaration);
        ...
        if (cachedResult !== undefined) {
            ...
            return NodeFactory_DeepCloneNode(receiver.f, cachedResult.node);
        }
    }
    let depth = 0;
    if (id !== undefined) {
    ...
    if (canUseCache && !receiver.ctx.reportedDiagnostic && !receiver.ctx.encounteredError) {
        ...
        if (links.serializedTypes === undefined) {
            links.serializedTypes = NewGoStructMap();
        }
 ...
 * }
 */
export function NodeBuilderImpl_typeToTypeNode(receiver, t) {
    ...
    try {
        ...
        if ((t.flags & TypeFlagsAny) !== 0) {
            if (t.alias !== undefined) {
                return TypeAlias_ToTypeReferenceNode(t.alias, receiver);
            }
            if (t === receiver.ch.unresolvedType) {
                return EmitContext_AddSyntheticLeadingComment(receiver.e, NewKeywordTypeNode(receiver.f, KindAnyKeyword), KindMultiLineCommentTrivia, "unresolved", false);
            }
            receiver.ctx.approximateLength += 3;
            return NewKeywordTypeNode(receiver.f, t === receiver.ch.intrinsicMarkerType ? KindIntrinsicKeyword : KindAnyKeyword);
        }
        if ((t.flags & TypeFlagsUnknown) !== 0) {
            return NewKeywordTypeNode(receiver.f, KindUnknownKeyword);
        }
        if ((t.flags & TypeFlagsString) !== 0) {
            receiver.ctx.approximateLength += 6;
            return NewKeywordTypeNode(receiver.f, KindStringKeyword);
        }
        if ((t.flags & TypeFlagsNumber) !== 0) {
            receiver.ctx.approximateLength += 6;
            return NewKeywordTypeNode(receiver.f, KindNumberKeyword);
        }
        if ((t.flags & TypeFlagsBigInt) !== 0) {
            receiver.ctx.approximateLength += 6;
            return NewKeywordTypeNode(receiver.f, KindBigIntKeyword);
        }
        if ((t.flags & TypeFlagsBoolean) !== 0 && t.alias === undefined) {
            receiver.ctx.approximateLength += 7;
            return NewKeywordTypeNode(receiver.f, KindBooleanKeyword);
        }
        ...
        if ((t.flags & TypeFlagsEnumLike) !== 0) {
            if ((t.symbol.Flags & SymbolFlagsEnumMember) !== 0) {
                ...
                if (IsIdentifierText(memberName, LanguageVariantStandard)) {
                    return NodeBuilderImpl_appendReferenceToType(receiver, parentName, NewTypeReferenceNode(receiver.f, NewIdentifier(receiver.f, memberName), undefined));
                }
                if (IsImportTypeNode(parentName)) {
                    AsImportTypeNode(parentName).IsTypeOf = true;
                    return NewIndexedAccessTypeNode(receiver.f, parentName, NewLiteralTypeNode(receiver.f, NodeBuilderImpl_newStringLiteral(receiver, memberName)));
                }
                if (IsTypeReferenceNode(parentName)) {
                    return NewIndexedAccessTypeNode(receiver.f, NewTypeQueryNode(receiver.f, AsTypeReferenceNode(parentName).TypeName, undefined), NewLiteralTypeNode(receiver.f, NodeBuilderImpl_newStringLiteral(receiver, memberName)));
                }
        ...
        if ((t.flags & TypeFlagsStringLiteral) !== 0) {
            ...
            return NewLiteralTypeNode(receiver.f, literal);
        }
        if ((t.flags & TypeFlagsNumberLiteral) !== 0) {
            const value = Type_AsLiteralType(t).value;
            ...
            if (value < 0) {
                return NewLiteralTypeNode(receiver.f, NewPrefixUnaryExpression(receiver.f, KindMinusToken, NewNumericLiteral(receiver.f, text.slice(1), TokenFlagsNone)));
            }
            return NewLiteralTypeNode(receiver.f, NewNumericLiteral(receiver.f, text, TokenFlagsNone));
        }
        if ((t.flags & TypeFlagsBigIntLiteral) !== 0) {
            const text = pseudoBigIntToString(getBigIntLiteralValue(t));
            receiver.ctx.approximateLength += text.length + 1;
            return NewLiteralTypeNode(receiver.f, NewBigIntLiteral(receiver.f, text + "n", TokenFlagsNone));
        }
        if ((t.flags & TypeFlagsBooleanLiteral) !== 0) {
            const value = Type_AsLiteralType(t).value;
            receiver.ctx.approximateLength += value ? 4 : 5;
            return NewLiteralTypeNode(receiver.f, NewKeywordExpression(receiver.f, value ? KindTrueKeyword : KindFalseKeyword));
        }
        if ((t.flags & TypeFlagsUniqueESSymbol) !== 0) {
            ...
            return NewTypeOperatorNode(receiver.f, KindUniqueKeyword, NewKeywordTypeNode(receiver.f, KindSymbolKeyword));
        }
        if ((t.flags & TypeFlagsVoid) !== 0) {
            receiver.ctx.approximateLength += 4;
            return NewKeywordTypeNode(receiver.f, KindVoidKeyword);
        }
        if ((t.flags & TypeFlagsUndefined) !== 0) {
            receiver.ctx.approximateLength += 9;
            return NewKeywordTypeNode(receiver.f, KindUndefinedKeyword);
        }
        if ((t.flags & TypeFlagsNull) !== 0) {
            receiver.ctx.approximateLength += 4;
            return NewLiteralTypeNode(receiver.f, NewKeywordExpression(receiver.f, KindNullKeyword));
        }
        if ((t.flags & TypeFlagsNever) !== 0) {
            receiver.ctx.approximateLength += 5;
            return NewKeywordTypeNode(receiver.f, KindNeverKeyword);
        }
        if ((t.flags & TypeFlagsESSymbol) !== 0) {
            receiver.ctx.approximateLength += 6;
            return NewKeywordTypeNode(receiver.f, KindSymbolKeyword);
        }
        if ((t.flags & TypeFlagsNonPrimitive) !== 0) {
            receiver.ctx.approximateLength += 6;
            return NewKeywordTypeNode(receiver.f, KindObjectKeyword);
        }
        if (isThisTypeParameter(t)) {
            ...
            receiver.ctx.approximateLength += 4;
            return NewThisTypeNode(receiver.f);
        }
        if (inTypeAlias === 0 && t.alias !== undefined && ((receiver.ctx.flags & FlagsUseAliasDefinedOutsideCurrentScope) !== 0 || Checker_IsTypeSymbolAccessible(receiver.ch, TypeAlias_Symbol(t.alias), receiver.ctx.enclosingDeclaration))) {
            if (!NodeBuilderImpl_shouldExpandType(receiver, t, true)) {
                ...
                if (isReservedMemberName(sym.Name) && (sym.Flags & SymbolFlagsClass) === 0) {
                    return NewTypeReferenceNode(receiver.f, NewIdentifier(receiver.f, ""), typeArgumentNodes);
                }
                if (typeArgumentNodes !== undefined && typeArgumentNodes.Nodes.length === 1 && sym === receiver.ch.globalArrayType.symbol) {
                    return NewArrayTypeNode(receiver.f, typeArgumentNodes.Nodes[0]);
                }
        ...
        if ((t.flags & TypeFlagsTypeParameter) !== 0 || (objectFlags & ObjectFlagsClassOrInterface) !== 0) {
            ...
            if ((t.flags & TypeFlagsTypeParameter) !== 0 && slices.Contains(receiver.ctx.inferTypeParameters, t)) {
                ...
                return NewInferTypeNode(receiver.f, NodeBuilderImpl_typeParameterToDeclarationWithConstraint(receiver, t, constraintNode));
            }
            if ((receiver.ctx.flags & FlagsGenerateNamesForShadowedTypeParams) !== 0 && (t.flags & TypeFlagsTypeParameter) !== 0) {
                ...
                return NewTypeReferenceNode(receiver.f, NodeBuilderImpl_newIdentifier(receiver, name.Text, t.symbol), undefined);
            }
            ...
            const name = (t === receiver.ch.markerSuperTypeForCheck || t === receiver.ch.markerSubTypeForCheck) && receiver.ch.varianceTypeParameter !== undefined && receiver.ch.varianceTypeParameter.symbol !== undefined
                ...
                : "?";
            return NewTypeReferenceNode(receiver.f, NodeBuilderImpl_newIdentifier(receiver, name, undefined), undefined);
        }
        ...
        if ((t.flags & (TypeFlagsUnion | TypeFlagsIntersection)) !== 0) {
            ...
            if (typeNodes !== undefined && typeNodes.Nodes.length > 0) {
                return ((t.flags & TypeFlagsUnion) !== 0 ? NewUnionTypeNode(receiver.f, typeNodes) : NewIntersectionTypeNode(receiver.f, typeNodes));
            }
        ...
        if ((t.flags & TypeFlagsIndex) !== 0) {
            ...
            receiver.ctx.approximateLength += 6;
            return NewTypeOperatorNode(receiver.f, KindKeyOfKeyword, NodeBuilderImpl_typeToTypeNode(receiver, indexedType));
        }
        if ((t.flags & TypeFlagsTemplateLiteral) !== 0) {
            ...
            const templateSpans = NodeFactory_NewNodeList(receiver.f, MapIndex(types, (typePart, index) => {
                ...
                EmitContext_AddEmitFlags(receiver.e, literal, EFNoAsciiEscaping);
                return NewTemplateLiteralTypeSpan(receiver.f, NodeBuilderImpl_typeToTypeNode(receiver, typePart), literal);
            }));
            receiver.ctx.approximateLength += 2;
            return NewTemplateLiteralTypeNode(receiver.f, templateHead, templateSpans);
        }
        if ((t.flags & TypeFlagsStringMapping) !== 0) {
        ...
        if ((t.flags & TypeFlagsIndexedAccess) !== 0) {
            ...
            receiver.ctx.approximateLength += 2;
            return NewIndexedAccessTypeNode(receiver.f, objectTypeNode, indexTypeNode);
        }
        if ((t.flags & TypeFlagsConditional) !== 0) {
 ...
 * }
 */
export function NodeBuilderImpl_newStringLiteral(receiver, text) {
    return NodeBuilderImpl_newStringLiteralEx(receiver, text, false);
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_newStringLiteralEx(receiver, text, isSingleQuote) {
    const flags = (isSingleQuote || (receiver.ctx.flags & FlagsUseSingleQuotesForStringLiteralType) !== 0)
 ...
 * }
 */
export function TypeAlias_ToTypeReferenceNode(receiver, b) {
    return NewTypeReferenceNode(b.f, NodeBuilderImpl_symbolToEntityNameNode(b, TypeAlias_Symbol(receiver)), NodeBuilderImpl_mapToTypeNodes(b, TypeAlias_TypeArguments(receiver), false));
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_newIdentifier(receiver, text, symbol_) {
    const id = NewIdentifier(receiver.f, text);
    if (symbol_ !== undefined) {
        receiver.idToSymbol.set(id, symbol_);
    }
    return id;
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_createAccessExpression(receiver, node) {
 ...
 * }
 */
export function NodeBuilderImpl_createExpressionWithTypeArguments(receiver, expr, typeArguments) {
 ...
 * }
 */
export function NodeBuilderImpl_lookupInstantiatedTypeArgumentNodes(receiver, chain, index) {
    if (NodeBuilderImpl_shouldWriteTypeParametersInQualifiedName(receiver, chain, index)) {
        ...
        const targetMapper = LinkStore_Get(receiver.ch.valueSymbolLinks, nextSymbol).mapper;
        if (targetMapper !== undefined) {
            params = CoreMap(params, (param) => TypeMapper_Map(targetMapper, param));
        }
        return NodeBuilderImpl_mapToTypeNodes(receiver, params, false);
    }
    return undefined;
}
/**
 ...
 * }
 */
export function NodeBuilderImpl_lookupExpressionChainTypeArgumentNodes(receiver, chain, index) {
    if (NodeBuilderImpl_shouldWriteTypeParametersInQualifiedName(receiver, chain, index)) {
        const symbol_ = chain[index];
        const symbolId = GetSymbolId(symbol_);
        if (CopyOnWriteSet_Has(receiver.ctx.typeParameterSymbolList, symbolId)) {
 ...
 * }
 */
export function NodeBuilderImpl_shouldWriteTypeParametersInQualifiedName(receiver, chain, index) {
