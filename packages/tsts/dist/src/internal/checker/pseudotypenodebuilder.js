                ...
                for (const element of elements) {
                    ...
                    switch (elementNode.Kind) {
                        case PseudoObjectElementKindMethod: {
                            ...
                            if (isConst) {
                                newProp = NewPropertySignatureDeclaration(b.f, modifiers, NodeBuilderImpl_reuseName(b, elementNode.Name), undefined, NewFunctionTypeNode(b.f, typeParams, NodeBuilderImpl_pseudoParametersToNodeList(b, d.Parameters), NodeBuilderImpl_pseudoTypeToNode(b, d.ReturnType)), undefined);
                                break;
                            }
                            newProp = NewMethodSignatureDeclaration(b.f, modifiers, NodeBuilderImpl_reuseName(b, elementNode.Name), undefined, typeParams, NodeBuilderImpl_pseudoParametersToNodeList(b, d.Parameters), NodeBuilderImpl_pseudoTypeToNode(b, d.ReturnType));
                            break;
                        }
                        case PseudoObjectElementKindPropertyAssignment: {
                            const d = PseudoObjectElement_AsPseudoPropertyAssignment(elementNode);
                            newProp = NewPropertySignatureDeclaration(b.f, modifiers, NodeBuilderImpl_reuseName(b, elementNode.Name), undefined, NodeBuilderImpl_pseudoTypeToNode(b, d.Type), undefined);
                            break;
                        }
                        case PseudoObjectElementKindSetAccessor: {
                            const d = PseudoObjectElement_AsPseudoSetAccessor(elementNode);
                            newProp = NewSetAccessorDeclaration(b.f, undefined, NodeBuilderImpl_reuseName(b, elementNode.Name), undefined, NodeFactory_NewNodeList(b.f, [NodeBuilderImpl_pseudoParameterToNode(b, d.Parameter)]), undefined, undefined, undefined);
                            break;
                        }
                        case PseudoObjectElementKindGetAccessor: {
                            const d = PseudoObjectElement_AsPseudoGetAccessor(elementNode);
                            newProp = NewGetAccessorDeclaration(b.f, undefined, NodeBuilderImpl_reuseName(b, elementNode.Name), undefined, undefined, NodeBuilderImpl_pseudoTypeToNode(b, d.Type), undefined, undefined);
                            break;
                        }
                    }
...
export function NodeBuilderImpl_pseudoParameterToNode(receiver, p) {
    ...
    return NewParameterDeclaration(b.f, undefined, dotDotDot, 
    // matches strada behavior of always reserializing param names from scratch
