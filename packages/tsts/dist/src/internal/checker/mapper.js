...
import { Checker_getInferredType, Checker_inferFromIntraExpressionSites, clearCachedInferences, } from "./inference.js";
/**
 ...
 * )
 */
export const TypeMapperKindUnknown = 0;
export const TypeMapperKindSimple = 1;
export const TypeMapperKindArray = 2;
export const TypeMapperKindMerged = 3;
/**
 ...
 */
export function TypeMapper_Map(receiver, t) {
 ...
 */
export function TypeMapper_Kind(receiver) {
 ...
 * }
 */
export function newTypeMapper(sources, targets) {
    if (sources.length === 1) {
        return newSimpleTypeMapper(sources[0], targets[0]);
    }
    return newArrayTypeMapper(sources, targets);
 ...
 * }
 */
export function Checker_combineTypeMappers(receiver, m1, m2) {
    if (m1 !== undefined) {
 ...
 * }
 */
export function mergeTypeMappers(m1, m2) {
    if (m1 !== undefined) {
        return newMergedTypeMapper(m1, m2);
    }
    return m2;
 ...
 * }
 */
export function prependTypeMapping(source, target, mapper) {
    if (mapper === undefined) {
        return newSimpleTypeMapper(source, target);
    }
    return newMergedTypeMapper(newSimpleTypeMapper(source, target), mapper);
 ...
 * }
 */
export function appendTypeMapping(mapper, source, target) {
    if (mapper === undefined) {
        return newSimpleTypeMapper(source, target);
    }
    return newMergedTypeMapper(mapper, newSimpleTypeMapper(source, target));
 ...
 * }
 */
export function Checker_newBackreferenceMapper(receiver, context, index) {
    const forwardInferences = context.inferences.slice(index);
    const typeParameters = core.Map(forwardInferences, (i) => {
        return i.typeParameter;
    });
 ...
 */
export function TypeMapperBase_Map(receiver, t) {
    return t;
}
/**
 ...
 */
export function TypeMapperBase_Kind(receiver) {
 ...
 * }
 */
export function newSimpleTypeMapper(source, target) {
    const m = {
        source: source,
        target: target,
    };
...
function SimpleTypeMapper_as_TypeMapperData(receiver) {
    return {
        [goReceiverKey]: receiver,
        Map: (t) => SimpleTypeMapper_Map(receiver, t),
        Kind: () => SimpleTypeMapper_Kind(receiver),
    };
}
/**
 ...
 * }
 */
export function SimpleTypeMapper_Map(receiver, t) {
 ...
 * }
 */
export function SimpleTypeMapper_Kind(receiver) {
    return TypeMapperKindSimple;
}
/**
 ...
 * }
 */
export function newArrayTypeMapper(sources, targets) {
    const m = {
        sources: sources,
        targets: targets,
    };
...
function ArrayTypeMapper_as_TypeMapperData(receiver) {
    return {
        [goReceiverKey]: receiver,
        Map: (t) => ArrayTypeMapper_Map(receiver, t),
        Kind: () => ArrayTypeMapper_Kind(receiver),
    };
}
/**
 ...
 * }
 */
export function ArrayTypeMapper_Map(receiver, t) {
 ...
 * }
 */
export function ArrayTypeMapper_Kind(receiver) {
    return TypeMapperKindArray;
}
/**
 ...
 * }
 */
export function newArrayToSingleTypeMapper(sources, target) {
    const m = {
        sources: sources,
        target: target,
    };
...
function ArrayToSingleTypeMapper_as_TypeMapperData(receiver) {
    return {
        [goReceiverKey]: receiver,
        Map: (t) => ArrayToSingleTypeMapper_Map(receiver, t),
        Kind: () => TypeMapperBase_Kind(undefined),
    };
}
/**
 ...
 * }
 */
export function ArrayToSingleTypeMapper_Map(receiver, t) {
 ...
 * }
 */
export function newDeferredTypeMapper(sources, targets) {
    const m = {
        sources: sources,
        targets: targets,
    };
...
function DeferredTypeMapper_as_TypeMapperData(receiver) {
    return {
        [goReceiverKey]: receiver,
        Map: (t) => DeferredTypeMapper_Map(receiver, t),
        Kind: () => TypeMapperBase_Kind(undefined),
    };
}
/**
 ...
 * }
 */
export function DeferredTypeMapper_Map(receiver, t) {
    for (let i = 0; i < receiver.sources.length; i++) {
        const s = receiver.sources[i];
        if (t === s) {
            return receiver.targets[i]();
 ...
 * }
 */
export function newFunctionTypeMapper(fn) {
    const m = {
        fn: fn,
    };
    return { data: FunctionTypeMapper_as_TypeMapperData(m) };
}
function FunctionTypeMapper_as_TypeMapperData(receiver) {
    return {
        [goReceiverKey]: receiver,
        Map: (t) => FunctionTypeMapper_Map(receiver, t),
        Kind: () => TypeMapperBase_Kind(undefined),
    };
}
/**
 ...
 * }
 */
export function FunctionTypeMapper_Map(receiver, t) {
 ...
 * }
 */
export function newMergedTypeMapper(m1, m2) {
    const m = {
        m1: m1,
        m2: m2,
    };
...
function MergedTypeMapper_as_TypeMapperData(receiver) {
    return {
        [goReceiverKey]: receiver,
        Map: (t) => MergedTypeMapper_Map(receiver, t),
        Kind: () => MergedTypeMapper_Kind(receiver),
    };
}
/**
 ...
 * }
 */
export function MergedTypeMapper_Map(receiver, t) {
 ...
 * }
 */
export function MergedTypeMapper_Kind(receiver) {
    return TypeMapperKindMerged;
}
/**
 ...
 * }
 */
export function newCompositeTypeMapper(c, m1, m2) {
    const m = {
        c: c,
        m1: m1,
        m2: m2,
...
function CompositeTypeMapper_as_TypeMapperData(receiver) {
    return {
        [goReceiverKey]: receiver,
        Map: (t) => CompositeTypeMapper_Map(receiver, t),
        Kind: () => TypeMapperBase_Kind(undefined),
    };
}
/**
 ...
 * }
 */
export function CompositeTypeMapper_Map(receiver, t) {
 ...
 * }
 */
export function Checker_newInferenceTypeMapper(receiver, n, fixing) {
    const m = {
        c: receiver,
        n: n,
        fixing: fixing,
...
function InferenceTypeMapper_as_TypeMapperData(receiver) {
    return {
        [goReceiverKey]: receiver,
        Map: (t) => InferenceTypeMapper_Map(receiver, t),
        Kind: () => TypeMapperBase_Kind(undefined),
    };
}
/**
 ...
 * }
 */
export function InferenceTypeMapper_Map(receiver, t) {
