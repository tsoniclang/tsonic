 ...
 */
export declare const _SignatureKind_name: string;
/**
 ...
 */
export declare let _SignatureKind_index: GoArray<byte, "...">;
/**
 ...
 * }
 */
export declare function SignatureKind_String(receiver: SignatureKind): string;
//# sourceMappingURL=stringer_generated.d.ts.map