 ...
 * }
 */
export function NewSymbolTrackerImpl(context, tracker) {
    if (tracker !== undefined) {
        for (;;) {
            const t = tracker;
            if (t === undefined || !("inner" in t && "context" in t && "DisableTrackSymbol" in t)) {
                break;
            }
            tracker = t.inner;
        }
...
export function SymbolTrackerImpl_as_SymbolTracker(receiver) {
 ...
 * }
 */
export function SymbolTrackerImpl_onDiagnosticReported(receiver) {
    receiver.context.reportedDiagnostic = true;
}
/**
...
//# sourceMappingURL=symboltracker.js.map