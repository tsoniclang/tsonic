import { SymbolFlagsAll } from "../ast/generated/flags.js";
import { KindCallSignature, KindConstructorType, KindConstructSignature, KindFunctionType, KindSourceFile, } from "../ast/generated/kinds.js";
import { GetSourceFileOfNode } from "../ast/utilities.js";
import { TSTrue } from "../core/tristate.js";
import { FlagsIgnoreErrors, FlagsNoTruncation, FlagsUseAliasDefinedOutsideCurrentScope, FlagsUseOnlyExternalAliasing, FlagsWriteTypeParametersInQualifiedName, InternalFlagsDoNotIncludeSymbolChain, InternalFlagsNone, InternalFlagsWriteComputedProps, } from "../nodebuilder/types.js";
...
import { Checker_getNodeBuilder, Checker_getNodeBuilderEx, NodeBuilder_EmitContext, NodeBuilder_ExpandSymbolForHover, NodeBuilder_SignatureToSignatureDeclaration, NodeBuilder_SymbolToEntityName, NodeBuilder_SymbolToNode, NodeBuilder_TypeParameterToDeclaration, NodeBuilder_TypePredicateToTypePredicateNode, NodeBuilder_TypeToTypeNode, } from "./nodebuilder.js";
...
import { SignatureFlagsConstruct, SymbolFormatFlagsAllowAnyNodeKind, SymbolFormatFlagsDoNotIncludeSymbolChain, SymbolFormatFlagsUseAliasDefinedOutsideCurrentScope, SymbolFormatFlagsUseOnlyExternalAliasing, SymbolFormatFlagsWriteComputedProps, SymbolFormatFlagsWriteTypeParametersOrArguments, TypeFlagsBooleanLiteral, TypeFlagsEnumLike, TypeFlagsNull, TypeFlagsNullable, TypeFlagsUndefined, TypeFlagsUnion, TypeFormatFlagsAllowUniqueESSymbolType, TypeFormatFlagsMultilineObjectLiterals, TypeFormatFlagsNodeBuilderFlagsMask, TypeFormatFlagsNone, TypeFormatFlagsNoTruncation, TypeFormatFlagsUseAliasDefinedOutsideCurrentScope, TypeFormatFlagsWriteArrowStyleSignature, TypeFormatFlagsWriteCallStyleSignature, Type_Types, } from "./types.js";
...
function semicolonRemoverWriter_as_EmitTextWriter(receiver) {
    const s = receiver;
    return {
        Write: (s1) => semicolonRemoverWriter_Write(s, s1),
        WriteTrailingSemicolon: (text) => semicolonRemoverWriter_WriteTrailingSemicolon(s, text),
        WriteComment: (text) => semicolonRemoverWriter_WriteComment(s, text),
        WriteKeyword: (text) => semicolonRemoverWriter_WriteKeyword(s, text),
        WriteOperator: (text) => semicolonRemoverWriter_WriteOperator(s, text),
        WritePunctuation: (text) => semicolonRemoverWriter_WritePunctuation(s, text),
        WriteSpace: (text) => semicolonRemoverWriter_WriteSpace(s, text),
        WriteStringLiteral: (text) => semicolonRemoverWriter_WriteStringLiteral(s, text),
        WriteParameter: (text) => semicolonRemoverWriter_WriteParameter(s, text),
        WriteProperty: (text) => semicolonRemoverWriter_WriteProperty(s, text),
        WriteSymbol: (text, symbol_) => semicolonRemoverWriter_WriteSymbol(s, text, symbol_),
        WriteLine: () => semicolonRemoverWriter_WriteLine(s),
        WriteLineForce: (force) => semicolonRemoverWriter_WriteLineForce(s, force),
        IncreaseIndent: () => semicolonRemoverWriter_IncreaseIndent(s),
        DecreaseIndent: () => semicolonRemoverWriter_DecreaseIndent(s),
        Clear: () => semicolonRemoverWriter_Clear(s),
        String: () => semicolonRemoverWriter_String(s),
        RawWrite: (s1) => semicolonRemoverWriter_RawWrite(s, s1),
        WriteLiteral: (s1) => semicolonRemoverWriter_WriteLiteral(s, s1),
        GetTextPos: () => semicolonRemoverWriter_GetTextPos(s),
        GetLine: () => semicolonRemoverWriter_GetLine(s),
        GetColumn: () => semicolonRemoverWriter_GetColumn(s),
        GetIndent: () => semicolonRemoverWriter_GetIndent(s),
        IsAtStartOfLine: () => semicolonRemoverWriter_IsAtStartOfLine(s),
        HasTrailingComment: () => semicolonRemoverWriter_HasTrailingComment(s),
        HasTrailingWhitespace: () => semicolonRemoverWriter_HasTrailingWhitespace(s),
    };
}
/**
 ...
 * }
 */
export function semicolonRemoverWriter_commitSemicolon(receiver) {
    const s = receiver;
    if (s.hasPendingSemicolon) {
        s.inner.WriteTrailingSemicolon(";");
        s.hasPendingSemicolon = false;
 ...
 * }
 */
export function semicolonRemoverWriter_Clear(receiver) {
    const s = receiver;
    s.inner.Clear();
}
/**
 ...
 * }
 */
export function semicolonRemoverWriter_DecreaseIndent(receiver) {
    const s = receiver;
 ...
 * }
 */
export function semicolonRemoverWriter_GetColumn(receiver) {
    const s = receiver;
    return s.inner.GetColumn();
}
/**
 ...
 * }
 */
export function semicolonRemoverWriter_GetIndent(receiver) {
    const s = receiver;
    return s.inner.GetIndent();
}
/**
 ...
 * }
 */
export function semicolonRemoverWriter_GetLine(receiver) {
    const s = receiver;
    return s.inner.GetLine();
}
/**
 ...
 * }
 */
export function semicolonRemoverWriter_GetTextPos(receiver) {
    const s = receiver;
    return s.inner.GetTextPos();
}
/**
 ...
 * }
 */
export function semicolonRemoverWriter_HasTrailingComment(receiver) {
    const s = receiver;
    return s.inner.HasTrailingComment();
}
/**
 ...
 * }
 */
export function semicolonRemoverWriter_HasTrailingWhitespace(receiver) {
    const s = receiver;
    return s.inner.HasTrailingWhitespace();
}
/**
 ...
 * }
 */
export function semicolonRemoverWriter_IncreaseIndent(receiver) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.IncreaseIndent();
}
 ...
 * }
 */
export function semicolonRemoverWriter_IsAtStartOfLine(receiver) {
    const s = receiver;
    return s.inner.IsAtStartOfLine();
}
/**
 ...
 * }
 */
export function semicolonRemoverWriter_RawWrite(receiver, s1) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.RawWrite(s1);
}
 ...
 * }
 */
export function semicolonRemoverWriter_String(receiver) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    return s.inner.String();
}
 ...
 * }
 */
export function semicolonRemoverWriter_Write(receiver, s1) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.Write(s1);
}
 ...
 * }
 */
export function semicolonRemoverWriter_WriteComment(receiver, text) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.WriteComment(text);
}
 ...
 * }
 */
export function semicolonRemoverWriter_WriteKeyword(receiver, text) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.WriteKeyword(text);
}
 ...
 * }
 */
export function semicolonRemoverWriter_WriteLine(receiver) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.WriteLine();
}
 ...
 * }
 */
export function semicolonRemoverWriter_WriteLineForce(receiver, force) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.WriteLineForce(force);
}
 ...
 * }
 */
export function semicolonRemoverWriter_WriteLiteral(receiver, s1) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.WriteLiteral(s1);
}
 ...
 * }
 */
export function semicolonRemoverWriter_WriteOperator(receiver, text) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.WriteOperator(text);
}
 ...
 * }
 */
export function semicolonRemoverWriter_WriteParameter(receiver, text) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.WriteParameter(text);
}
 ...
 * }
 */
export function semicolonRemoverWriter_WriteProperty(receiver, text) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.WriteProperty(text);
}
 ...
 * }
 */
export function semicolonRemoverWriter_WritePunctuation(receiver, text) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.WritePunctuation(text);
}
 ...
 * }
 */
export function semicolonRemoverWriter_WriteSpace(receiver, text) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.WriteSpace(text);
}
 ...
 * }
 */
export function semicolonRemoverWriter_WriteStringLiteral(receiver, text) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
    s.inner.WriteStringLiteral(text);
}
 ...
 * }
 */
export function semicolonRemoverWriter_WriteSymbol(receiver, text, symbol_) {
    const s = receiver;
    semicolonRemoverWriter_commitSemicolon(s);
 ...
 * }
 */
export function semicolonRemoverWriter_WriteTrailingSemicolon(receiver, text) {
    const s = receiver;
    s.hasPendingSemicolon = true;
}
/**
 ...
 * }
 */
export function getTrailingSemicolonDeferringWriter(writer) {
 ...
 * }
 */
export function Checker_TypeToString(receiver, t) {
 ...
 * }
 */
export function Checker_typeToString(receiver, t, enclosingDeclaration) {
    return Checker_typeToStringEx(receiver, t, enclosingDeclaration, (TypeFormatFlagsAllowUniqueESSymbolType | TypeFormatFlagsUseAliasDefinedOutsideCurrentScope) >>> 0, undefined);
}
/**
 ...
 * }
 */
export function toNodeBuilderFlags(flags) {
 ...
 * }
 */
export function Checker_TypeToStringEx(receiver, t, enclosingDeclaration, flags, vc) {
...
export function Checker_typeToStringEx(receiver, t, enclosingDeclaration, flags, vc) {
    ...
    const noTruncation = ((vc === undefined || vc.MaxTruncationLength === 0) && receiver.compilerOptions.NoErrorTruncation === TSTrue) ||
 ...
 * }
 */
export function Checker_SymbolToString(receiver, s) {
 ...
 * }
 */
export function Checker_symbolToString(receiver, symbol_) {
    return Checker_symbolToStringEx(receiver, symbol_, undefined, SymbolFlagsAll, SymbolFormatFlagsAllowAnyNodeKind);
}
/**
 ...
 * }
 */
export function Checker_SymbolToStringEx(receiver, symbol_, enclosingDeclaration, meaning, flags) {
...
export function Checker_symbolToStringEx(receiver, symbol_, enclosingDeclaration, meaning, flags) {
    ...
    try {
        let nodeFlags = FlagsIgnoreErrors;
 ...
 * }
 */
export function Checker_signatureToString(receiver, signature) {
 ...
 * }
 */
export function Checker_SignatureToStringEx(receiver, signature, enclosingDeclaration, flags, vc) {
 ...
 * }
 */
export function Checker_typePredicateToString(receiver, typePredicate) {
    return Checker_typePredicateToStringEx(receiver, typePredicate, undefined, TypeFormatFlagsUseAliasDefinedOutsideCurrentScope);
}
/**
 ...
 * }
 */
export function Checker_typePredicateToStringEx(receiver, typePredicate, enclosingDeclaration, flags) {
    const [writer, putWriter] = GetSingleLineStringWriter();
    try {
        const [nodeBuilder, release] = Checker_getNodeBuilder(receiver);
        try {
 ...
 * }
 */
export function Checker_valueToString(receiver, value) {
    return ValueToString(value);
}
/**
 ...
 * }
 */
export function Checker_formatUnionTypes(receiver, types, expandingEnum) {
    const result = [];
    let flags = 0;
 ...
 * }
 */
export function Checker_TypeToTypeNode(receiver, t, enclosingDeclaration, flags, idToSymbol) {
    const nodeBuilder = Checker_getNodeBuilderEx(receiver, idToSymbol);
    return NodeBuilder_TypeToTypeNode(nodeBuilder, t, enclosingDeclaration, flags, InternalFlagsNone, undefined);
}
/**
 ...
 * }
 */
export function Checker_SignatureToSignatureDeclaration(receiver, signature, kind, enclosingDeclaration, flags) {
    const [nodeBuilder, release] = Checker_getNodeBuilder(receiver);
    try {
 ...
 * }
 */
export function Checker_ExpandSymbolForHover(receiver, symbol_, meaning, vc) {
    const [nodeBuilder, release] = Checker_getNodeBuilder(receiver);
    try {
        const oldVerbosity = nodeBuilder.verbosity;
        nodeBuilder.verbosity = vc;
 ...
 * }
 */
export function Checker_TypeParameterToStringEx(receiver, t, enclosingDeclaration, vc) {
    const [nodeBuilder, release] = Checker_getNodeBuilder(receiver);
    try {
        const oldVerbosity = nodeBuilder.verbosity;
        nodeBuilder.verbosity = vc;
 ...
 * }
 */
export function Checker_TypeToTypeNodeEx(receiver, t, enclosingDeclaration, flags, internalFlags, idToSymbol) {
    const nodeBuilder = Checker_getNodeBuilderEx(receiver, idToSymbol);
    return NodeBuilder_TypeToTypeNode(nodeBuilder, t, enclosingDeclaration, flags, internalFlags, undefined);
}
/**
 ...
 * }
 */
export function Checker_TypePredicateToTypePredicateNode(receiver, t, enclosingDeclaration, flags, idToSymbol) {
    const nodeBuilder = Checker_getNodeBuilderEx(receiver, idToSymbol);
    return NodeBuilder_TypePredicateToTypePredicateNode(nodeBuilder, t, enclosingDeclaration, flags, InternalFlagsNone, undefined);
}
