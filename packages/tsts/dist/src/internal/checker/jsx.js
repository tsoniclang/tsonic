 ...
 * )
 */
export const JsxFlagsNone = 0;
export const JsxFlagsIntrinsicNamedElement = 1 << 0; // An element from a named property of the JSX.IntrinsicElements interface
export const JsxFlagsIntrinsicIndexedElement = 1 << 1; // An element inferred from the string index signature of the JSX.IntrinsicElements interface
export const JsxFlagsIntrinsicElement = JsxFlagsIntrinsicNamedElement | JsxFlagsIntrinsicIndexedElement;
/**
 ...
 * )
 */
export const JsxReferenceKindComponent = 0;
export const JsxReferenceKindFunction = 1;
export const JsxReferenceKindMixed = 2;
/**
 ...
 * }
 */
export function Checker_checkJsxElement(receiver, node, checkMode) {
 ...
 * }
 */
export function Checker_checkJsxElementDeferred(receiver, node) {
 ...
 * }
 */
export function Checker_checkJsxExpression(receiver, node, checkMode) {
 ...
 * }
 */
export function Checker_checkJsxSelfClosingElement(receiver, node, checkMode) {
    Checker_checkNodeDeferred(receiver, node);
    return Checker_getJsxElementTypeAt(receiver, node);
}
/**
 ...
 * }
 */
export function Checker_checkJsxSelfClosingElementDeferred(receiver, node) {
 ...
 * }
 */
export function Checker_checkJsxFragment(receiver, node) {
    ...
    if (CompilerOptions_GetJSXTransformEnabled(receiver.compilerOptions) && (receiver.compilerOptions.JsxFactory !== "" || GetPragmaFromSourceFile(nodeSourceFile, "jsx") !== undefined) && receiver.compilerOptions.JsxFragmentFactory === "" && GetPragmaFromSourceFile(nodeSourceFile, "jsxfrag") === undefined) {
        const message = IfElse(receiver.compilerOptions.JsxFactory !== "", The_jsxFragmentFactory_compiler_option_must_be_provided_to_use_JSX_fragments_with_the_jsxFactory_compiler_option, An_jsxFrag_pragma_is_required_when_using_an_jsx_pragma_with_JSX_fragments);
 ...
 * }
 */
export function Checker_checkJsxAttributes(receiver, node, checkMode) {
 ...
 * }
 */
export function Checker_checkJsxOpeningLikeElementOrOpeningFragment(receiver, node) {
 ...
 * }
 */
export function Checker_checkJsxPreconditions(receiver, errorNode) {
    // Preconditions for using JSX
 ...
 * }
 */
export function Checker_checkJsxReturnAssignableToAppropriateBound(receiver, refKind, elemInstanceType, openingLikeElement) {
    const diags = [];
    switch (refKind) {
        case JsxReferenceKindFunction: {
 ...
 * }
 */
export function Checker_inferJsxTypeArguments(receiver, node, signature, checkMode, context) {
 ...
 * }
 */
export function Checker_getContextualTypeForJsxExpression(receiver, node, contextFlags) {
    if (IsJsxAttributeLike(node.Parent)) {
        return Checker_getContextualType(receiver, node, contextFlags);
    }
    if (IsJsxElement(node.Parent)) {
        return Checker_getContextualTypeForChildJsxExpression(receiver, node.Parent, node, contextFlags);
    }
    return undefined;
}
/**
 ...
 * }
 */
export function Checker_getContextualTypeForJsxAttribute(receiver, attribute, contextFlags) {
    // When we trying to resolve JsxOpeningLikeElement as a stateless function element, we will already give its attributes a contextual type
    // which is a type of the parameter of the signature we are trying out.
    // If there is no contextual type (e.g. we are trying to resolve stateful component), get attributes type from resolving element's tagName
 ...
 * }
 */
export function Checker_getContextualJsxElementAttributesType(receiver, node, contextFlags) {
 ...
 * }
 */
export function Checker_getContextualTypeForChildJsxExpression(receiver, node, child, contextFlags) {
 ...
 * }
 */
export function Checker_discriminateContextualTypeByJSXAttributes(receiver, node, contextualType) {
    const key = { nodeId: GetNodeId(node), typeId: contextualType.id };
    ...
    const discriminatorData = { c: receiver, props: discriminantProperties, members: discriminantMembers };
    const discriminator = {
        len: () => ObjectLiteralDiscriminator_len(discriminatorData),
        name: (index) => ObjectLiteralDiscriminator_name(discriminatorData, index),
        matches: (index, target) => ObjectLiteralDiscriminator_matches(discriminatorData, index, target),
    };
 ...
 * }
 */
export function Checker_elaborateJsxComponents(receiver, node, source, target, relation, diagnosticOutput) {
    ...
    if (IsJsxOpeningElement(node.Parent) && IsJsxElement(node.Parent.Parent)) {
        ...
        let invalidTextDiagnosticArgs = [];
        const getInvalidTextualChildDiagnostic = () => {
 ...
 * }
 */
export function Checker_generateJsxChildren(receiver, node, getInvalidTextDiagnostic) {
    return (yieldValue) => {
        let memberOffset = 0;
 ...
 * }
 */
export function Checker_getElaborationElementForJsxChild(receiver, child, nameType, getInvalidTextDiagnostic) {
    switch (child.Kind) {
 ...
 * }
 */
export function Checker_elaborateIterableOrArrayLikeTargetElementwise(receiver, iterator, source, target, relation, diagnosticOutput) {
 ...
 * }
 */
export function Checker_getSuggestedSymbolForNonexistentJSXAttribute(receiver, name, containingType) {
 ...
 * }
 */
export function Checker_getJSXFragmentType(receiver, node) {
    ...
    if (jsxFactorySymbol === undefined) {
        ...
        jsxFactorySymbol = receiver.resolveName(node, jsxFragmentFactoryName, flags, Using_JSX_fragments_requires_fragment_factory_0_to_be_in_scope_but_it_could_not_be_found, true, false);
    }
    if (jsxFactorySymbol === undefined) {
 ...
 * }
 */
export function Checker_resolveJsxOpeningLikeElement(receiver, node, candidatesOutArray, checkMode) {
    ...
    if (!isJsxOpenFragment) {
        if (isJsxIntrinsicTagName(Node_TagName(node))) {
            ...
            Checker_checkTypeAssignableToAndOptionallyElaborate(receiver, Checker_checkExpressionWithContextualType(receiver, Node_Attributes(node), Checker_getEffectiveFirstArgumentForJsxSignature(receiver, fakeSignature, node), undefined, CheckModeNormal), result, Node_TagName(node), Node_Attributes(node), undefined, undefined);
 ...
 * }
 */
export function Checker_checkApplicableSignatureForJsxCallLikeElement(receiver, node, signature, relation, checkMode, reportErrors, diagnosticOutput) {
    const paramType = Checker_getEffectiveFirstArgumentForJsxSignature(receiver, signature, node);
    let attributesType;
    ...
    let checkAttributesType;
    const checkTagNameDoesNotExpectTooManyArguments = () => {
        ...
        let absoluteMinArgCount = Number.MAX_SAFE_INTEGER;
 ...
 * }
 */
export function Checker_createJsxAttributesTypeFromAttributesProperty(receiver, openingLikeElement, checkMode) {
    let allAttributesTable;
    if (receiver.strictNullChecks) {
        allAttributesTable = new globalThis.Map();
    }
    let attributesTable = new globalThis.Map();
    ...
    let objectFlags = ObjectFlagsJsxAttributes;
    const createJsxAttributesType = () => {
        ...
        result.objectFlags = (result.objectFlags | objectFlags | ObjectFlagsObjectLiteral | ObjectFlagsContainsObjectOrArrayLiteral);
        return result;
    };
    ...
    if (!isJsxOpenFragment) {
        ...
        for (const attributeDecl of Node_Properties(attributes) ?? []) {
            ...
            if (IsJsxAttribute(attributeDecl)) {
                ...
                objectFlags = (objectFlags | (exprType.objectFlags & ObjectFlagsPropagatingFlags));
                const attributeSymbol = Checker_newSymbol(receiver, (SymbolFlagsProperty | member.Flags), member.Name);
                attributeSymbol.Declarations = member.Declarations;
                attributeSymbol.Parent = member.Parent;
                if (member.ValueDeclaration !== undefined) {
                    attributeSymbol.ValueDeclaration = member.ValueDeclaration;
                }
                const links = LinkStore_Get(receiver.valueSymbolLinks, attributeSymbol);
                links.resolvedType = exprType;
                links.target = member;
                ...
                const exprType = Checker_getReducedType(receiver, Checker_checkExpressionEx(receiver, Node_Expression(attributeDecl), (checkMode & CheckModeInferential)));
                if (IsTypeAny(exprType)) {
                    hasSpreadAnyType = true;
                }
    ...
    const parentHasSemanticJsxChildren = (element) => {
    ...
    if (parentHasSemanticJsxChildren(openingLikeElement)) {
        ...
        if (!hasSpreadAnyType && jsxChildrenPropertyName !== InternalSymbolNameMissing && jsxChildrenPropertyName !== "") {
            ...
            const links = LinkStore_Get(receiver.valueSymbolLinks, childrenPropSymbol);
            ...
            const childPropMap = new globalThis.Map();
            childPropMap.set(jsxChildrenPropertyName, childrenPropSymbol);
            spread = Checker_getSpreadType(receiver, spread, Checker_newAnonymousType(receiver, attributesSymbol, childPropMap, [], [], []), attributesSymbol, (objectFlags | Checker_getPropagatingFlagsOfTypes(receiver, childTypes, TypeFlagsNone)), false);
        }
    }
    if (hasSpreadAnyType) {
 ...
 * }
 */
export function Checker_checkJsxAttribute(receiver, node, checkMode) {
 ...
 * }
 */
export function Checker_checkJsxChildren(receiver, node, checkMode) {
    const childTypes = [];
 ...
 * }
 */
export function Checker_getUninstantiatedJsxSignaturesOfType(receiver, elementType, caller) {
    if ((elementType.flags & TypeFlagsString) !== 0) {
    ...
    if (signatures.length === 0 && (apparentElemType.flags & TypeFlagsUnion) !== 0) {
        // If each member has some combination of new/call signatures; make a union signature list for those
        signatures = Checker_getUnionSignatures(receiver, Map(Type_Types(apparentElemType), (t) => {
 ...
 * }
 */
export function Checker_getEffectiveFirstArgumentForJsxSignature(receiver, signature, node) {
 ...
 * }
 */
export function Checker_getJsxPropsTypeFromCallSignature(receiver, sig, context) {
 ...
 * }
 */
export function Checker_getJsxPropsTypeFromClassType(receiver, sig, context) {
 ...
 * }
 */
export function Checker_getJsxPropsTypeForSignatureFromMember(receiver, sig, forcedLookupLocation) {
 ...
 * }
 */
export function Checker_getJsxManagedAttributesFromLocatedAttributes(receiver, context, ns, attributesType) {
 ...
 * }
 */
export function Checker_instantiateAliasOrInterfaceWithDefaults(receiver, managedSym, typeArguments, inJavaScript) {
    const declaredManagedType = Checker_getDeclaredTypeOfSymbol(receiver, managedSym);
    // fetches interface type, or initializes symbol links type parameters
    if (managedSym.Flags & SymbolFlagsTypeAlias) {
        const params = LinkStore_Get(receiver.typeAliasLinks, managedSym).typeParameters;
 ...
 * }
 */
export function Checker_getJsxLibraryManagedAttributes(receiver, jsxNamespace) {
    if (jsxNamespace !== undefined) {
        return Checker_getSymbol(receiver, jsxNamespace.Exports, JsxNames.LibraryManagedAttributes, SymbolFlagsType);
    }
    return undefined;
}
/**
 ...
 * }
 */
export function Checker_getJsxElementTypeSymbol(receiver, jsxNamespace) {
    if (jsxNamespace !== undefined) {
        return Checker_getSymbol(receiver, jsxNamespace.Exports, JsxNames.ElementType, SymbolFlagsType);
    }
    return undefined;
}
/**
 ...
 * }
 */
export function Checker_getJsxElementPropertiesName(receiver, jsxNamespace) {
 ...
 * }
 */
export function Checker_getJsxElementChildrenPropertyName(receiver, jsxNamespace) {
 ...
 * }
 */
export function Checker_getNameFromJsxElementAttributesContainer(receiver, nameOfAttribPropContainer, jsxNamespace) {
    if (jsxNamespace !== undefined) {
        const jsxElementAttribPropInterfaceSym = Checker_getSymbol(receiver, jsxNamespace.Exports, nameOfAttribPropContainer, SymbolFlagsType);
 ...
 * }
 */
export function Checker_getStaticTypeOfReferencedJsxConstructor(receiver, context) {
 ...
 * }
 */
export function Checker_getIntrinsicAttributesTypeFromStringLiteralType(receiver, t, location) {
 ...
 * }
 */
export function Checker_getJsxReferenceKind(receiver, node) {
    if (isJsxIntrinsicTagName(Node_TagName(node))) {
        return JsxReferenceKindMixed;
    }
 ...
 * }
 */
export function Checker_createSignatureForJSXIntrinsic(receiver, node, result) {
    ...
    const parameterSymbol = Checker_newSymbol(receiver, SymbolFlagsFunctionScopedVariable, "props");
    LinkStore_Get(receiver.valueSymbolLinks, parameterSymbol).resolvedType = result;
 ...
 * }
 */
export function Checker_getIntrinsicAttributesTypeFromJsxOpeningLikeElement(receiver, node) {
    // debug.Assert(isJsxIntrinsicTagName(node.TagName()))
    const links = LinkStore_Get(receiver.jsxElementLinks, node);
 ...
 * }
 */
export function Checker_getIntrinsicTagSymbol(receiver, node) {
    const links = LinkStore_Get(receiver.symbolNodeLinks, node);
    ...
    if (!Checker_isErrorType(receiver, intrinsicElementsType)) {
        ...
        if (intrinsicProp !== undefined) {
            LinkStore_Get(receiver.jsxElementLinks, node).jsxFlags |= JsxFlagsIntrinsicNamedElement;
            links.resolvedSymbol = intrinsicProp;
            return links.resolvedSymbol;
        }
        // Intrinsic string indexer case
        ...
        if (indexSymbol !== undefined) {
            LinkStore_Get(receiver.jsxElementLinks, node).jsxFlags |= JsxFlagsIntrinsicIndexedElement;
            links.resolvedSymbol = indexSymbol;
            return links.resolvedSymbol;
        }
 ...
 * }
 */
export function Checker_getJsxStatelessElementTypeAt(receiver, location) {
 ...
 * }
 */
export function Checker_getJsxElementClassTypeAt(receiver, location) {
 ...
 * }
 */
export function Checker_getJsxElementTypeAt(receiver, location) {
 ...
 * }
 */
export function Checker_getJsxElementTypeTypeAt(receiver, location) {
 ...
 * }
 */
export function Checker_getJsxType(receiver, name, location) {
 ...
 * }
 */
export function Checker_getJsxNamespaceAt(receiver, location) {
    let links;
    if (location !== undefined) {
        links = LinkStore_Get(receiver.jsxElementLinks, location);
    }
    ...
    if (links === undefined || links.jsxNamespace !== receiver.unknownSymbol) {
        ...
        if (resolvedNamespace === undefined || resolvedNamespace === receiver.unknownSymbol) {
            ...
            resolvedNamespace = receiver.resolveName(location, namespaceName, SymbolFlagsNamespace, undefined, false, false);
        }
 ...
 * }
 */
export function Checker_getJsxNamespace(receiver, location) {
    if (location !== undefined) {
        ...
        if (file !== undefined) {
            ...
            if (IsJsxOpeningFragment(location)) {
                ...
                if (jsxFragmentPragma !== undefined) {
                    links.localJsxFragmentFactory = Checker_parseIsolatedEntityName(receiver, GetPragmaArgument(jsxFragmentPragma, "factory"));
    ...
    if (receiver._jsxFactoryEntity === undefined) {
        receiver._jsxFactoryEntity = NewQualifiedName(receiver.factory, NewIdentifier(receiver.factory, receiver._jsxNamespace), NewIdentifier(receiver.factory, "createElement"));
    }
 ...
 * }
 */
export function Checker_getLocalJsxNamespace(receiver, file) {
    const links = Checker_getSourceFileLinks(receiver, file);
    if (links.localJsxNamespace !== "") {
        return links.localJsxNamespace;
    }
 ...
 * }
 */
export function Checker_getJsxFactoryEntity(receiver, location) {
    if (location !== undefined) {
 ...
 * }
 */
export function Checker_getJsxFragmentFactoryEntity(receiver, location) {
    if (location !== undefined) {
        const file = GetSourceFileOfNode(location);
        if (file !== undefined) {
            const links = Checker_getSourceFileLinks(receiver, file);
            ...
            if (jsxFragPragma !== undefined) {
                links.localJsxFragmentFactory = Checker_parseIsolatedEntityName(receiver, GetPragmaArgument(jsxFragPragma, "factory"));
                return links.localJsxFragmentFactory;
            }
        }
    }
    if (receiver.compilerOptions.JsxFragmentFactory !== "") {
        return Checker_parseIsolatedEntityName(receiver, receiver.compilerOptions.JsxFragmentFactory);
    }
    return undefined;
}
/**
 ...
 * }
 */
export function Checker_parseIsolatedEntityName(receiver, name) {
 ...
 * }
 */
export function markAsSynthetic(node) {
 ...
 * }
 */
export function Checker_getJsxNamespaceContainerForImplicitImport(receiver, location) {
    let file;
    let links;
    if (location !== undefined) {
        file = GetSourceFileOfNode(location);
        if (file !== undefined) {
            links = LinkStore_Get(receiver.jsxElementLinks, file);
        }
    }
    ...
    const mod = Checker_resolveExternalModule(receiver, OrElse(specifier, location), moduleReference, errorMessage, location, false);
    let result;
 ...
 * }
 */
export function Checker_getJSXRuntimeImportSpecifier(receiver, file) {
