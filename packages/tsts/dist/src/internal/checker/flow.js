...
function getMarkedAssignmentSymbolLinks(receiver, symbol_) {
    const links = LinkStore_Get(receiver.markedAssignmentSymbolLinks, symbol_);
    links.lastAssignmentPos ??= 0;
    links.hasDefiniteAssignment ??= false;
    return links;
}
/**
 ...
 * }
 */
export function FlowType_isNil(receiver) {
    return receiver?.t === undefined;
}
const flowLoopNodeKeys = new WeakMap();
let nextFlowLoopNodeKey = 1;
function getFlowLoopKey(flow, refKey) {
    let flowKey = flowLoopNodeKeys.get(flow);
    if (flowKey === undefined) {
        flowKey = nextFlowLoopNodeKey;
        nextFlowLoopNodeKey = (nextFlowLoopNodeKey + 1);
        flowLoopNodeKeys.set(flow, flowKey);
    }
    return `${flowKey}:${refKey}`;
}
/**
 ...
 * }
 */
export function Checker_newFlowType(receiver, t, incomplete) {
    let resolvedT = t;
 ...
 * }
 */
export function Checker_getFlowState(receiver) {
 ...
 * }
 */
export function Checker_putFlowState(receiver, f) {
 ...
 * }
 */
export function getFlowNodeOfNode(node) {
 ...
 * }
 */
export function Checker_getFlowTypeOfReference(receiver, reference, declaredType) {
 ...
 * }
 */
export function Checker_getFlowTypeOfReferenceEx(receiver, reference, declaredType, initialType, flowContainer, flowNode) {
    ...
    if (resultType === receiver.unreachableNeverType ||
 ...
 * }
 */
export function Checker_getTypeAtFlowNode(receiver, f, flow) {
    if (f.depth === 2000) {
 ...
 * }
 */
export function getBranchLabelAntecedents(flow, reduceLabels) {
 ...
 * }
 */
export function Checker_getTypeAtFlowAssignment(receiver, f, flow) {
 ...
 * }
 */
export function Checker_getInitialOrAssignedType(receiver, f, flow) {
 ...
 * }
 */
export function Checker_isEmptyArrayAssignment(receiver, node) {
    return ((IsVariableDeclaration(node) && Node_Initializer(node) !== undefined && isEmptyArrayLiteral(Node_Initializer(node))) ||
 ...
 * }
 */
export function Checker_getTypeAtFlowCall(receiver, f, flow) {
 ...
 * }
 */
export function Checker_narrowTypeByTypePredicate(receiver, f, t, predicate, callExpression, assumeTrue) {
 ...
 * }
 */
export function Checker_narrowTypeByAssertion(receiver, f, t, expr) {
 ...
 * }
 */
export function Checker_getTypeAtFlowCondition(receiver, f, flow) {
    const flowType = Checker_getTypeAtFlowNode(receiver, f, flow.Antecedent);
    if ((flowType.t.flags & TypeFlagsNever) !== 0) {
        return flowType;
    }
 ...
 * }
 */
export function Checker_narrowType(receiver, f, t, expr, assumeTrue) {
 ...
 * }
 */
export function Checker_narrowTypeByOptionality(receiver, f, t, expr, assumePresent) {
    ...
    if (access !== undefined) {
        return Checker_narrowTypeByDiscriminant(receiver, t, access, (innerT) => Checker_getTypeWithFacts(receiver, innerT, IfElse(assumePresent, TypeFactsNEUndefinedOrNull, TypeFactsEQUndefinedOrNull)));
    }
    return t;
}
/**
 ...
 * }
 */
export function Checker_narrowTypeByTruthiness(receiver, f, t, expr, assumeTrue) {
    if (Checker_isMatchingReference(receiver, f.reference, expr)) {
    ...
    if (access !== undefined) {
        return Checker_narrowTypeByDiscriminant(receiver, localT, access, (innerT) => Checker_getTypeWithFacts(receiver, innerT, IfElse(assumeTrue, TypeFactsTruthy, TypeFactsFalsy)));
    }
    return localT;
}
/**
 ...
 * }
 */
export function Checker_narrowTypeByCallExpression(receiver, f, t, callExpression, assumeTrue) {
    ...
    if (receiver.containsMissingType(t) && IsAccessExpression(f.reference) && IsPropertyAccessExpression(Node_Expression(callExpression))) {
        ...
        if (Checker_isMatchingReference(receiver, Node_Expression(f.reference), Checker_getReferenceCandidate(receiver, Node_Expression(callAccess))) &&
 ...
 * }
 */
export function Checker_narrowTypeByBinaryExpression(receiver, f, t, expr, assumeTrue) {
    switch (expr.OperatorToken.Kind) {
 ...
 * }
 */
export function Checker_narrowTypeByEquality(receiver, t, operator, value, assumeTrue) {
 ...
 * }
 */
export function Checker_narrowTypeByTypeof(receiver, f, t, typeOfExpr, operator, literal, assumeTrue) {
    // We have '==', '!=', '===', or '!==' operator with 'typeof xxx' and string literal operands
    if (operator === KindExclamationEqualsToken || operator === KindExclamationEqualsEqualsToken) {
        assumeTrue = !assumeTrue;
    }
    const target = Checker_getReferenceCandidate(receiver, Node_Expression(typeOfExpr));
    if (!Checker_isMatchingReference(receiver, f.reference, target)) {
        ...
        if (propertyAccess !== undefined) {
            return Checker_narrowTypeByDiscriminant(receiver, t, propertyAccess, (t) => Checker_narrowTypeByLiteralExpression(receiver, t, literal, assumeTrue));
        }
        return t;
    }
    return Checker_narrowTypeByLiteralExpression(receiver, t, literal, assumeTrue);
}
/**
 ...
 * }
 */
class LazyTypeofNEFacts extends Map {
    initialized = false;
    ensureInitialized() {
        if (this.initialized) {
            return;
...
export const typeofNEFacts = new LazyTypeofNEFacts();
/**
 ...
 * }
 */
export function Checker_narrowTypeByLiteralExpression(receiver, t, literal, assumeTrue) {
    if (assumeTrue) {
        return Checker_narrowTypeByTypeName(receiver, t, Node_Text(literal));
    }
    const text = Node_Text(literal);
 ...
 * }
 */
export function Checker_narrowTypeByTypeName(receiver, t, typeName) {
    switch (typeName) {
        case "string":
 ...
 * }
 */
export function Checker_narrowTypeByTypeFacts(receiver, t, impliedType, facts) {
 ...
 * }
 */
export function Checker_narrowTypeByDiscriminantProperty(receiver, t, access, operator, value, assumeTrue) {
 ...
 * }
 */
export function Checker_narrowTypeByDiscriminant(receiver, t, access, narrowType) {
 ...
 * }
 */
export function Checker_isMatchingConstructorReference(receiver, f, expr) {
 ...
 * }
 */
export function Checker_narrowTypeByConstructor(receiver, t, operator, identifier, assumeTrue) {
    // Do not narrow when checking inequality.
 ...
 * }
 */
export function Checker_isConstructedBy(receiver, source, target) {
    // If either the source or target type are a class type then we need to check that they are the same exact type.
 ...
 * }
 */
export function Checker_narrowTypeByBooleanComparison(receiver, f, t, expr, boolValue, operator, assumeTrue) {
 ...
 * }
 */
export function Checker_narrowTypeByInstanceof(receiver, f, t, expr, assumeTrue) {
    const left = Checker_getReferenceCandidate(receiver, expr.Left);
    if (!Checker_isMatchingReference(receiver, f.reference, left)) {
    ...
    let predicate = undefined;
    const signature = Checker_getEffectsSignature(receiver, expr);
    if (signature !== undefined) {
        predicate = Checker_getTypePredicateOfSignature(receiver, signature);
    }
 ...
 * }
 */
export function Checker_getNarrowedType(receiver, t, candidate, assumeTrue, checkDerived) {
    if (!(t.flags & TypeFlagsUnion)) {
        return Checker_getNarrowedTypeWorker(receiver, t, candidate, assumeTrue, checkDerived);
    }
    const key = { t, candidate, assumeTrue, checkDerived };
 ...
 * }
 */
export function Checker_getNarrowedTypeWorker(receiver, t, candidate, assumeTrue, checkDerived) {
    if (!assumeTrue) {
        if (t === candidate) {
            return receiver.neverType;
        }
 ...
 * }
 */
export function Checker_getInstanceType(receiver, constructorType) {
 ...
 * }
 */
export function Checker_narrowTypeByPrivateIdentifierInInExpression(receiver, f, t, expr, assumeTrue) {
    const target = Checker_getReferenceCandidate(receiver, expr.Right);
    if (!Checker_isMatchingReference(receiver, f.reference, target)) {
        return t;
    }
 ...
 * }
 */
export function Checker_narrowTypeByInKeyword(receiver, f, t, nameType, assumeTrue) {
 ...
 * }
 */
export function Checker_isTypePresencePossible(receiver, t, propName, assumeTrue) {
 ...
 * }
 */
export function Checker_narrowTypeByOptionalChainContainment(receiver, f, t, operator, value, assumeTrue) {
    const equalsOperator = operator === KindEqualsEqualsToken || operator === KindEqualsEqualsEqualsToken;
    const nullableFlags = (operator === KindEqualsEqualsToken || operator === KindExclamationEqualsToken)
        ? TypeFlagsNullable
        : TypeFlagsUndefined;
    const valueType = Checker_getTypeOfExpression(receiver, value);
    // Note that we include any and unknown in the exclusion test because their domain includes null and undefined.
 ...
 * }
 */
export function Checker_getTypeAtSwitchClause(receiver, f, flow) {
 ...
 * }
 */
export function Checker_narrowTypeBySwitchOnDiscriminant(receiver, t, data) {
    ...
    if ((t.flags & TypeFlagsUnknown) && !hasDefaultClause) {
        let groundClauseTypes = undefined;
 ...
 * }
 */
export function Checker_narrowTypeBySwitchOnTypeOf(receiver, t, data) {
    ...
    const clauses = AsCaseBlock(switchStmt.CaseBlock).Clauses.Nodes;
    // Equal start and end denotes implicit fallthrough; undefined marks explicit default clause.
 ...
 * }
 */
export function Checker_narrowTypeBySwitchOnTrue(receiver, f, t, data) {
    const clauses = AsCaseBlock(AsSwitchStatement(data.SwitchStatement).CaseBlock).Clauses.Nodes;
    const defaultIndex = FindIndex(clauses, (clause) => clause.Kind === KindDefaultClause);
    const clauseStart = data.ClauseStart;
    const clauseEnd = data.ClauseEnd;
    const hasDefaultClause = clauseStart === clauseEnd || (defaultIndex >= clauseStart && defaultIndex < clauseEnd);
 ...
 * }
 */
export function Checker_narrowTypeBySwitchOptionalChainContainment(receiver, t, data, clauseCheck) {
 ...
 * }
 */
export function Checker_narrowTypeBySwitchOnDiscriminantProperty(receiver, t, access, data) {
 ...
 * }
 */
export function Checker_getTypeAtFlowBranchLabel(receiver, f, flow, antecedents) {
    const antecedentStart = receiver.antecedentTypes.length;
    let subtypeReduction = false;
    let seenIncomplete = false;
    let bypassFlow = undefined;
 ...
 * }
 */
export function Checker_getUnionOrEvolvingArrayType(receiver, f, types, subtypeReduction) {
    if (isEvolvingArrayTypeList(types)) {
 ...
 * }
 */
export function Checker_getTypeAtFlowLoopLabel(receiver, f, flow) {
    ...
    let antecedentTypes = [];
    let subtypeReduction = false;
    let firstAntecedentType = { t: undefined, incomplete: false };
 ...
 * }
 */
export function Checker_getTypeAtFlowArrayMutation(receiver, f, flow) {
    if (f.declaredType === receiver.autoType || f.declaredType === receiver.autoArrayType) {
        const node = flow.Node;
        let expr;
 ...
 * }
 */
export function Checker_getDiscriminantPropertyAccess(receiver, f, expr, computedType) {
    // As long as the computed type is a subset of the declared type, we use the full declared type to detect
 ...
 * }
 */
export function Checker_getCandidateDiscriminantPropertyAccess(receiver, f, expr) {
 ...
 * }
 */
export function getCandidateVariableDeclarationInitializer(node) {
 ...
 * }
 */
export function Checker_getEvolvingArrayType(receiver, elementType) {
    const key = { kind: CachedTypeKindEvolvingArrayType, typeId: elementType.id };
 ...
 * }
 */
export function Checker_getElementTypeOfEvolvingArrayType(receiver, t) {
 ...
 * }
 */
export function isEvolvingArrayTypeList(types) {
 ...
 * }
 */
export function Checker_isEvolvingArrayOperationTarget(receiver, node) {
 ...
 * }
 */
export function Checker_addEvolvingArrayElementType(receiver, evolvingArrayType, node) {
 ...
 * }
 */
export function Checker_finalizeEvolvingArrayType(receiver, t) {
    if (t.objectFlags & ObjectFlagsEvolvingArray) {
 ...
 * }
 */
export function Checker_getFinalArrayType(receiver, t) {
 ...
 * }
 */
export function Checker_createFinalArrayType(receiver, elementType) {
 ...
 * }
 */
export function Checker_reportFlowControlError(receiver, node) {
 ...
 * }
 */
export function Checker_isMatchingReference(receiver, source, target) {
    switch (target.Kind) {
        case KindParenthesizedExpression:
        case KindNonNullExpression:
    ...
    switch (source.Kind) {
        ...
        case KindQualifiedName:
            if (IsAccessExpression(target)) {
                const [targetPropertyName, targetOk] = Checker_getAccessedPropertyName(receiver, target);
                if (targetOk) {
                    return Node_Text(AsQualifiedName(source).Right) === targetPropertyName && Checker_isMatchingReference(receiver, AsQualifiedName(source).Left, Node_Expression(target));
                }
            }
            break;
        case KindBinaryExpression:
 ...
 */
export const nonDottedNameCacheKey = HashString128("?").String();
/**
 ...
 * }
 */
export function Checker_getFlowReferenceKey(receiver, f) {
    const b = { h: NewXxh3() };
 ...
 * }
 */
export function Checker_writeFlowCacheKey(receiver, b, node, declaredType, initialType, flowContainer) {
    ...
    switch (node.Kind) {
        ...
        case KindQualifiedName:
            if (!Checker_writeFlowCacheKey(receiver, b, AsQualifiedName(node).Left, declaredType, initialType, flowContainer)) {
                return false;
            }
 ...
 * }
 */
export function Checker_getAccessedPropertyName(receiver, access) {
 ...
 * }
 */
export function Checker_tryGetElementAccessExpressionName(receiver, node) {
 ...
 * }
 */
export function Checker_tryGetNameFromEntityNameExpression(receiver, node) {
 ...
 * }
 */
export function tryGetNameFromType(t) {
 ...
 * }
 */
export function Checker_getDestructuringPropertyName(receiver, node) {
 ...
 * }
 */
export function Checker_getLiteralPropertyNameText(receiver, name) {
 ...
 * }
 */
export function Checker_isConstantReference(receiver, node) {
    switch (node.Kind) {
        case KindThisKeyword:
            return true;
        case KindIdentifier:
 ...
 * }
 */
export function Checker_containsMatchingReference(receiver, source, target) {
    let s = source;
 ...
 * }
 */
export function Checker_optionalChainContainsReference(receiver, source, target) {
    let s = source;
 ...
 * }
 */
export function Checker_getReferenceCandidate(receiver, node) {
    switch (node.Kind) {
        case KindParenthesizedExpression:
 ...
 * }
 */
export function Checker_getReferenceRoot(receiver, node) {
    const parent = node.Parent;
 ...
 * }
 */
export function Checker_hasMatchingArgument(receiver, expression, reference) {
 ...
 * }
 */
export function Checker_isOrContainsMatchingReference(receiver, source, target) {
 ...
 * }
 */
export function Checker_replacePrimitivesWithLiterals(receiver, typeWithPrimitives, typeWithLiterals) {
 ...
 * }
 */
export function isCoercibleUnderDoubleEquals(source, target) {
 ...
 * }
 */
export function Checker_isExhaustiveSwitchStatement(receiver, node) {
 ...
 * }
 */
export function Checker_computeExhaustiveSwitchStatement(receiver, node) {
 ...
 * }
 */
export function Checker_eachTypeContainedIn(receiver, source, types) {
    if (source.flags & TypeFlagsUnion) {
        return !Some(Type_Types(source), (t) => !types.includes(t));
    }
 ...
 * }
 */
export function Checker_getSwitchClauseTypeOfWitnesses(receiver, node) {
    const links = LinkStore_Get(receiver.switchStatementLinks, node);
    if (!links.witnessesComputed) {
        const clauses = AsCaseBlock(AsSwitchStatement(node).CaseBlock).Clauses.Nodes;
        const witnesses = new Array(clauses.length).fill("");
        let valid = true;
 ...
 * }
 */
export function Checker_getNotEqualFactsFromTypeofSwitch(receiver, start, end, witnesses) {
 ...
 * }
 */
export function Checker_getSwitchClauseTypes(receiver, node) {
    const links = LinkStore_Get(receiver.switchStatementLinks, node);
    if (!links.switchTypesComputed) {
        const clauses = AsCaseBlock(AsSwitchStatement(node).CaseBlock).Clauses.Nodes;
        const types = new Array(clauses.length);
        for (let i = 0; i < clauses.length; i++) {
 ...
 * }
 */
export function Checker_getTypeOfSwitchClause(receiver, clause) {
    if (clause.Kind === KindCaseClause) {
 ...
 * }
 */
export function Checker_getEffectsSignature(receiver, node) {
 ...
 * }
 */
export function Checker_getSymbolHasInstanceMethodOfObjectType(receiver, t) {
 ...
 * }
 */
export function Checker_getPropertyNameForKnownSymbolName(receiver, symbolName) {
 ...
 * }
 */
export function Checker_getTypeOfDottedName(receiver, node, diagnostic) {
 ...
 * }
 */
export function Checker_getExplicitTypeOfSymbol(receiver, symbol_, diagnostic) {
        ...
        if (declaration !== undefined) {
            ...
            if (IsVariableDeclaration(declaration) && IsForOfStatement(declaration.Parent.Parent)) {
                ...
                if (expressionType !== undefined) {
                    const use = AsForInOrOfStatement(statement).AwaitModifier !== undefined ? IterationUseForAwaitOf : IterationUseForOf;
 ...
 * }
 */
export function Checker_isDeclarationWithExplicitTypeAnnotation(receiver, node) {
 ...
 * }
 */
export function Checker_isExpandoPropertyFunctionWithReturnTypeAnnotation(receiver, node) {
    if (IsBinaryExpression(node)) {
 ...
 * }
 */
export function Checker_hasTypePredicateOrNeverReturnType(receiver, sig) {
 ...
 * }
 */
export function Checker_getExplicitThisType(receiver, node) {
 ...
 * }
 */
export function Checker_getInitialType(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function Checker_getInitialTypeOfVariableDeclaration(receiver, node) {
    const initializer = Node_Initializer(node);
    if (initializer !== undefined) {
 ...
 * }
 */
export function Checker_getTypeOfInitializer(receiver, node) {
 ...
 * }
 */
export function Checker_getInitialTypeOfBindingElement(receiver, node) {
 ...
 * }
 */
export function Checker_getAssignedType(receiver, node) {
    const parent = node.Parent;
    switch (parent.Kind) {
 ...
 * }
 */
export function Checker_getAssignedTypeOfBinaryExpression(receiver, node) {
 ...
 * }
 */
export function Checker_getAssignedTypeOfArrayLiteralElement(receiver, node, element) {
 ...
 * }
 */
export function Checker_getTypeOfDestructuredArrayElement(receiver, t, index) {
 ...
 * }
 */
export function Checker_includeUndefinedInIndexSignature(receiver, t) {
 ...
 * }
 */
export function Checker_getAssignedTypeOfSpreadExpression(receiver, node) {
 ...
 * }
 */
export function Checker_getTypeOfDestructuredSpreadExpression(receiver, t) {
    ...
    if (elementType === undefined) {
        elementType = receiver.errorType;
    }
    return Checker_createArrayType(receiver, elementType);
}
/**
 ...
 * }
 */
export function Checker_getAssignedTypeOfPropertyAssignment(receiver, node) {
 ...
 * }
 */
export function Checker_getTypeOfDestructuredProperty(receiver, t, name) {
    ...
    if (indexInfo !== undefined) {
        return Checker_includeUndefinedInIndexSignature(receiver, indexInfo.valueType);
    }
    return receiver.errorType;
}
/**
 ...
 * }
 */
export function Checker_getAssignedTypeOfShorthandPropertyAssignment(receiver, node) {
    return Checker_getTypeWithDefault(receiver, Checker_getAssignedTypeOfPropertyAssignment(receiver, node), AsShorthandPropertyAssignment(node).ObjectAssignmentInitializer);
}
/**
 ...
 * }
 */
export function Checker_isDestructuringAssignmentTarget(receiver, parent) {
 ...
 * }
 */
export function Checker_getTypeWithDefault(receiver, t, defaultExpression) {
 ...
 * }
 */
export function Checker_getAssignmentReducedType(receiver, declaredType, assignedType) {
    if (declaredType === assignedType) {
        return declaredType;
    }
    ...
    const key = { id1: declaredType.id, id2: assignedType.id };
 ...
 * }
 */
export function Checker_getAssignmentReducedTypeWorker(receiver, declaredType, assignedType) {
    ...
    if (Checker_isTypeAssignableTo(receiver, assignedType, reducedType)) {
        return reducedType;
    }
    return declaredType;
}
 ...
 * }
 */
export function Checker_typeMaybeAssignableTo(receiver, source, target) {
    if (!(source.flags & TypeFlagsUnion)) {
        return Checker_isTypeAssignableTo(receiver, source, target);
    }
    for (const t of Type_AsUnionOrIntersectionType(source).types) {
        if (Checker_isTypeAssignableTo(receiver, t, target)) {
            return true;
        }
    }
    return false;
 ...
 * }
 */
export function Checker_getTypePredicateArgument(receiver, predicate, callExpression) {
    if (predicate.kind === TypePredicateKindIdentifier || predicate.kind === TypePredicateKindAssertsIdentifier) {
 ...
 * }
 */
export function Checker_getFlowTypeInConstructor(receiver, symbol_, constructor_) {
    let accessName;
    ...
    const reference = NewPropertyAccessExpression(receiver.factory, NewKeywordExpression(receiver.factory, KindThisKeyword), undefined, accessName, NodeFlagsNone);
    ...
    if (everyType(flowType, (t) => Checker_IsNullableType(receiver, t))) {
        return undefined;
    }
 ...
 * }
 */
export function Checker_getFlowTypeInStaticBlocks(receiver, symbol_, staticBlocks) {
    let accessName;
    if (symbol_.Name.startsWith(InternalSymbolNamePrefix + "#")) {
        accessName = NewPrivateIdentifier(receiver.factory, symbol_.Name.slice(symbol_.Name.indexOf("@") + 1));
    }
 ...
 * }
 */
export function Checker_isReachableFlowNode(receiver, flow) {
    const f = Checker_getFlowState(receiver);
 ...
 * }
 */
export function Checker_isReachableFlowNodeWorker(receiver, f, flow, noCacheCheck) {
    for (;;) {
        if (flow === receiver.lastFlowNode) {
            return receiver.lastFlowNodeReachable;
        }
        ...
        if (flags & (FlowFlagsAssignment | FlowFlagsCondition | FlowFlagsArrayMutation)) {
            ...
            if (signature !== undefined) {
                ...
                if (Checker_getReturnTypeOfSignature(receiver, signature).flags & TypeFlagsNever) {
                    return false;
                }
            }
            flow = flow.Antecedent;
            ...
            for (let list = getBranchLabelAntecedents(flow, f.reduceLabels); list !== undefined; list = list.Next) {
                if (Checker_isReachableFlowNodeWorker(receiver, f, list.Flow, false)) {
                    return true;
                }
            }
            return false;
            ...
            const data = Node_AsFlowSwitchClauseData(flow.Node);
            if (data.ClauseStart === data.ClauseEnd && Checker_isExhaustiveSwitchStatement(receiver, data.SwitchStatement)) {
                return false;
            }
            flow = flow.Antecedent;
        }
 ...
 * }
 */
export function Checker_isFalseExpression(receiver, expr) {
    const node = SkipParentheses(expr);
    if (node.Kind === KindFalseKeyword) {
        return true;
    }
 ...
 * }
 */
export function Checker_isPostSuperFlowNode(receiver, flow, noCacheCheck) {
    const f = Checker_getFlowState(receiver);
 ...
 * }
 */
export function Checker_isPostSuperFlowNodeWorker(receiver, f, flow, noCacheCheck) {
    for (;;) {
        const flags = flow.Flags;
        if (flags & FlowFlagsShared) {
            if (!noCacheCheck) {
        ...
        if (flags & (FlowFlagsAssignment | FlowFlagsCondition | FlowFlagsArrayMutation | FlowFlagsSwitchClause)) {
            ...
            if (Node_Expression(flow.Node).Kind === KindSuperKeyword) {
                return true;
            }
            flow = flow.Antecedent;
        }
            ...
            for (let list = getBranchLabelAntecedents(flow, f.reduceLabels); list !== undefined; list = list.Next) {
                if (!Checker_isPostSuperFlowNodeWorker(receiver, f, list.Flow, false)) {
                    return false;
                }
            }
            return true;
 ...
 * }
 */
export function Checker_isSymbolAssignedDefinitely(receiver, symbol_) {
 ...
 * }
 */
export function Checker_isSymbolAssigned(receiver, symbol_) {
    Checker_ensureAssignmentsMarked(receiver, symbol_);
 ...
 * }
 */
export function Checker_isPastLastAssignment(receiver, symbol_, location) {
    Checker_ensureAssignmentsMarked(receiver, symbol_);
 ...
 * }
 */
export function Checker_ensureAssignmentsMarked(receiver, symbol_) {
    if (getMarkedAssignmentSymbolLinks(receiver, symbol_).lastAssignmentPos !== 0) {
        return;
    }
    ...
    const links = LinkStore_Get(receiver.nodeLinks, parent);
 ...
 * }
 */
export function Checker_hasParentWithAssignmentsMarked(receiver, node) {
    return FindAncestor(node.Parent, (n) => IsFunctionOrSourceFile(n) && !!(LinkStore_Get(receiver.nodeLinks, n).flags & NodeCheckFlagsAssignmentsMarked)) !== undefined;
}
/**
 ...
 * }
 */
export function Checker_markNodeAssignmentsWorker(receiver, node) {
    switch (node.Kind) {
        case KindIdentifier: {
 ...
 * }
 */
export function Checker_extendAssignmentPosition(receiver, node, declaration) {
