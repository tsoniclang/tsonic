...
import { InferenceFlagsNoDefault, InferenceFlagsAnyDefault, InferenceFlagsNone, InferencePriorityAlwaysStrict, InferencePriorityCircularity, InferencePriorityContravariantConditional, InferencePriorityHomomorphicMappedType, InferencePriorityMappedTypeConstraint, InferencePriorityMaxValue, InferencePriorityNakedTypeVariable, InferencePriorityNone, InferencePriorityPartialHomomorphicMappedType, InferencePriorityPriorityImpliesCombination, InferencePriorityReturnType, InferencePrioritySpeculativeTuple, UnionReductionSubtype, getEndElementCount, getMappedTypeModifiers, isTupleType, isLiteralType, someType, applyStringMapping, getNumberLiteralValue, getBigIntLiteralValue, getBooleanLiteralValue, getStringLiteralValue, InferencePriorityLiteralKeyof, InferencePriorityNoConstraints, InferencePrioritySubstituteSource, MappedTypeModifiersIncludeOptional, MappedTypeModifiersIncludeReadonly, } from "./checker/state.js";
import { Checker_clearActiveMapperCaches, Checker_getBaseConstraintOfType, Checker_getConstraintOfType, Checker_getConstraintTypeFromMappedType, Checker_getDefaultConstraintOfConditionalType, Checker_getSubstitutionIntersection, Checker_isNoInferType, } from "./checker/inference.js";
import { Checker_getApplicableIndexInfo, Checker_getBaseSignature, Checker_getConstraintOfTypeParameter, Checker_getDefaultFromTypeParameter, Checker_getErasedSignature, Checker_getMinTypeArgumentCount, Checker_fillMissingTypeArguments, Checker_getReturnTypeOfSignature, Checker_getSignaturesOfType, Checker_getTypeArguments, Checker_getTypeParameterFromMappedType, Checker_getTypeReferenceArity, Checker_getTypeWithThisArgument, Checker_isApplicableIndexType, } from "./checker/signatures.js";
import { Checker_distributeIndexOverObjectType, Checker_getIndexInfoOfType, Checker_getIndexInfosOfType, Checker_getIndexType, Checker_getIndexTypeEx, Checker_getIndexedAccessType, Checker_getLiteralTypeFromProperty, Checker_getNameTypeFromMappedType, Checker_getPropertyOfType, Checker_getTypeOfSymbol, Checker_isReadonlySymbol, Checker_newIndexInfo, Checker_newSymbol, Checker_newSymbolEx, Checker_setStructuredTypeMembers, } from "./checker/symbols.js";
import { Checker_createArrayType, Checker_createArrayTypeEx, Checker_getContextualType, Checker_getContextualTypeForObjectLiteralMethod, Checker_createTupleType, Checker_createTupleTypeEx, Checker_filterType, Checker_getActualTypeVariable, Checker_getApparentType, Checker_getBaseTypeOfLiteralType, Checker_getElementTypeOfSliceOfTupleType, Checker_getElementTypes, Checker_getFalseTypeFromConditionalType, Checker_getIntersectionType, Checker_getNullableType, Checker_getNumberLiteralType, Checker_getPropertiesOfObjectType, Checker_getPropertiesOfType, Checker_getReducedType, Checker_getRegularTypeOfLiteralType, Checker_getSimplifiedType, Checker_getTemplateTypeFromMappedType, Checker_getTrueTypeFromConditionalType, Checker_getUnionType, Checker_getUnionTypeEx, Checker_getWidenedLiteralType, Checker_getWidenedType, Checker_instantiateType, Checker_isArrayOrTupleType, Checker_isArrayType, Checker_isConstTypeVariable, Checker_isGenericMappedType, Checker_isMutableArrayLikeType, Checker_isReadonlyArrayType, Checker_mapType, Checker_maybeTypeOfKind, Checker_isNonGenericObjectType, Checker_newAnonymousType, Checker_newObjectType, Checker_parseBigIntLiteralType, Checker_removeMissingOrUndefinedType, Checker_removeMissingType, } from "./checker/types.js";
...
import { Checker_getAliasVariances, Checker_getEffectiveRestType, Checker_getParameterCount, Checker_getRestTypeAtPosition, Checker_getThisTypeOfSignature, Checker_getTypeAtPosition, Checker_getTypePredicateOfSignature, Checker_getUnmatchedProperty, Checker_getVariances, Checker_isDeeplyNestedType, Checker_inferTypesFromTemplateLiteralType, Checker_isObjectTypeWithInferableIndex, Checker_isTypeAssignableTo, Checker_isTypeIdenticalTo, Checker_isTypeMatchedByTemplateLiteralType, Checker_isTypeStrictSubtypeOf, Checker_isTypeSubtypeOf, Checker_sliceTupleType, Checker_typePredicateKindsMatch, ExpandingFlagsBoth, ExpandingFlagsSource, ExpandingFlagsTarget, } from "./relater.js";
import { ContextFlagsNoConstraints, ElementFlagsFixed, ElementFlagsOptional, ElementFlagsRequired, ElementFlagsRest, ElementFlagsVariable, ElementFlagsVariadic, IndexFlagsNoIndexSignatures, IndexFlagsNone, ObjectFlagsAnonymous, ObjectFlagsMapped, ObjectFlagsNonInferrableType, ObjectFlagsReference, ObjectFlagsReverseMapped, SignatureFlagsIsNonInferrable, SignatureKindCall, SignatureKindConstruct, TernaryFalse, Type_AsConditionalType, Type_AsIndexType, Type_AsIndexedAccessType, Type_AsMappedType, Type_AsReverseMappedType, Type_AsStringMappingType, Type_AsSubstitutionType, Type_AsTemplateLiteralType, Type_AsTypeReference, Type_AsUnionType, Type_Distributed, Type_Target, Type_TargetTupleType, Type_Types, TypeFlagsAny, TypeFlagsBigInt, TypeFlagsBigIntLike, TypeFlagsBigIntLiteral, TypeFlagsBoolean, TypeFlagsBooleanLiteral, TypeFlagsConditional, TypeFlagsEnum, TypeFlagsIndex, TypeFlagsIndexedAccess, TypeFlagsInstantiable, TypeFlagsIntersection, TypeFlagsNever, TypeFlagsNone, TypeFlagsNull, TypeFlagsNullable, TypeFlagsNumber, TypeFlagsNumberLike, TypeFlagsNumberLiteral, TypeFlagsObject, TypeFlagsPrimitive, TypeFlagsString, TypeFlagsStringLiteral, TypeFlagsStringMapping, TypeFlagsSubstitution, TypeFlagsTemplateLiteral, TypeFlagsTypeParameter, TypeFlagsTypeVariable, TypeFlagsUndefined, TypeFlagsUnion, TypeFlagsStringOrNumberLiteralOrUnique, TypeFlagsUnionOrIntersection, Type_AsIntrinsicType, VarianceFlagsContravariant, VarianceFlagsVarianceMask, } from "./types.js";
 ...
 * }
 */
export function Checker_getInferenceState(receiver) {
    const c = receiver;
    const n = c.freeinferenceState ?? {
        inferences: [],
 ...
 * }
 */
export function Checker_putInferenceState(receiver, n) {
    const c = receiver;
    const state = n;
    state.visited.clear();
 ...
 * }
 */
export function Checker_inferTypes(receiver, inferences, originalSource, originalTarget, priority, contravariant) {
    const c = receiver;
 ...
 * }
 */
export function Checker_inferFromTypes(receiver, n, source, target) {
    const c = receiver;
    const state = n;
    ...
    if (source.alias !== undefined && target.alias !== undefined && source.alias["symbol"] === target.alias["symbol"]) {
        if (source.alias.typeArguments.length !== 0 || target.alias.typeArguments.length !== 0) {
            // Source and target are types originating in the same generic type alias declaration.
            // Simply infer from source type arguments to target type arguments, with defaults applied.
            const aliasSymbol = source.alias["symbol"];
            const params = LinkStore_Get(c.typeAliasLinks, aliasSymbol).typeParameters;
    ...
    else if ((target.flags & TypeFlagsIntersection) !== 0 && !core.Every(Type_Types(target), (t) => Checker_isNonGenericObjectType(c, t))) {
        // We reduce intersection types unless they're simple combinations of object types. For example,
        // when inferring from 'string[] & { extra: any }' to 'string[] & T' we want to remove string[] and
        // infer { extra: any } for T. But when inferring to 'string[] & Iterable<T>' we want to keep the
        // string[] on the source side and infer string for T.
 ...
 * }
 */
export function Checker_inferFromTypeArguments(receiver, n, sourceTypes, targetTypes, variances) {
    const c = receiver;
 ...
 * }
 */
export function Checker_inferWithPriority(receiver, n, source, target, newPriority) {
    const c = receiver;
    const state = n;
 ...
 * }
 */
export function Checker_inferFromContravariantTypesWithPriority(receiver, n, source, target, newPriority) {
    const c = receiver;
    const state = n;
    const savePriority = state.priority;
    state.priority |= newPriority;
 ...
 * }
 */
export function Checker_inferFromContravariantTypes(receiver, n, source, target) {
    const c = receiver;
    const state = n;
 ...
 * }
 */
export function Checker_inferFromContravariantTypesIfStrictFunctionTypes(receiver, n, source, target) {
    const c = receiver;
    const state = n;
 ...
 * }
 */
export function Checker_invokeOnce(receiver, n, source, target, action) {
    const c = receiver;
    const state = n;
    const key = { s: source.id, t: target.id };
 ...
 * }
 */
export function Checker_inferFromMatchingTypes(receiver, n, sources, targets, matches) {
    const c = receiver;
    let matchedSources = [];
    let matchedTargets = [];
    ...
    if (matchedSources.length !== 0) {
        resultSources = core.Filter(sources, (t) => !slices.Contains(matchedSources, t));
    }
    if (matchedTargets.length !== 0) {
        resultTargets = core.Filter(targets, (t) => !slices.Contains(matchedTargets, t));
    }
 ...
 * }
 */
export function Checker_inferToMultipleTypes(receiver, n, source, targets, targetFlags) {
    const c = receiver;
    const state = n;
    let typeVariableCount = 0;
    if ((targetFlags & TypeFlagsUnion) !== 0) {
        let nakedTypeVariable = undefined;
        let sources;
        if ((source.flags & TypeFlagsUnion) !== 0) {
        ...
        const matched = new Array(sources.length).fill(false);
 ...
 * }
 */
export function getSingleTypeVariableFromIntersectionTypes(n, types) {
    let typeVariable = undefined;
    for (const t of types) {
        if ((t.flags & TypeFlagsIntersection) === 0) {
            return undefined;
        }
        const v = core.Find(Type_Types(t), (t2) => getInferenceInfoForType(n, t2) !== undefined);
 ...
 * }
 */
export function Checker_inferToMultipleTypesWithPriority(receiver, n, source, targets, targetFlags, newPriority) {
    const c = receiver;
    const state = n;
    const savePriority = state.priority;
    state.priority |= newPriority;
 ...
 * }
 */
export function Checker_inferToConditionalType(receiver, n, source, target) {
    const c = receiver;
    const state = n;
    if ((source.flags & TypeFlagsConditional) !== 0) {
        ...
        const targetTypes = [Checker_getTrueTypeFromConditionalType(c, target), Checker_getFalseTypeFromConditionalType(c, target)];
        Checker_inferToMultipleTypesWithPriority(c, state, source, targetTypes, target.flags, core.IfElse(state.contravariant, InferencePriorityContravariantConditional, 0));
    }
}
/**
 ...
 * }
 */
export function Checker_inferToTemplateLiteralType(receiver, n, source, target) {
    const c = receiver;
    ...
    if (matchCount !== 0 || core.Every(target.texts, (s) => s === "")) {
            ...
            if ((sourceType.flags & TypeFlagsStringLiteral) !== 0 && (targetType.flags & TypeFlagsTypeVariable) !== 0) {
                ...
                if (inferenceContext !== undefined) {
                    ...
                    if (constraint !== undefined && !IsTypeAny(constraint)) {
                        let allTypeFlags = TypeFlagsNone;
                        ...
                        if ((allTypeFlags & TypeFlagsString) === 0) {
                            ...
                            const choose = (left, right) => {
                                ...
                                if ((right.flags & TypeFlagsBooleanLiteral) !== 0 && core.IfElse(getBooleanLiteralValue(right), "true", "false") === str) {
                                    return right;
                                }
 ...
 * }
 */
export function Checker_inferFromGenericMappedTypes(receiver, n, source, target) {
    const c = receiver;
    const state = n;
    // The source and target types are generic types { [P in S]: X } and { [P in T]: Y }, so we infer
    // from S to T and from X to Y.
 ...
 * }
 */
export function Checker_inferFromObjectTypes(receiver, n, source, target) {
    const c = receiver;
    const state = n;
    if ((source.objectFlags & ObjectFlagsReference) !== 0 &&
        (target.objectFlags & ObjectFlagsReference) !== 0 &&
        ...
        if (isTupleType(target)) {
            ...
            if (!isTupleType(source) || (sourceArity - startLength - endLength === 1 && (Type_TargetTupleType(source).elementInfos[startLength].flags & ElementFlagsRest) !== 0)) {
                ...
                if (middleLength === 2) {
                    ...
                    // Middle of target is exactly one variadic element. Infer the slice between the fixed parts in the source.
                    // If target ends in optional element(s), make a lower priority a speculative inference.
                    const priority = core.IfElse((elementInfos[targetArity - 1].flags & ElementFlagsOptional) !== 0, InferencePrioritySpeculativeTuple, 0);
 ...
 * }
 */
export function Checker_inferFromProperties(receiver, n, source, target) {
    const c = receiver;
    ...
    for (const targetProp of properties) {
        ...
        if (sourceProp !== undefined && !core.Some(sourceProp.Declarations, (node) => Checker_isSkipDirectInferenceNode(c, node))) {
 ...
 * }
 */
export function Checker_inferFromSignatures(receiver, n, source, target, kind) {
    const c = receiver;
    const state = n;
 ...
 * }
 */
export function Checker_inferFromSignature(receiver, n, source, target) {
    const c = receiver;
    const state = n;
    if ((source.flags & SignatureFlagsIsNonInferrable) === 0) {
 ...
 * }
 */
export function Checker_applyToParameterTypes(receiver, source, target, callback) {
    const c = receiver;
    ...
    if (targetRestType !== undefined) {
        callback(Checker_getRestTypeAtPosition(c, source, paramCount, Checker_isConstTypeVariable(c, targetRestType, 0) && !someType(targetRestType, (t) => Checker_isMutableArrayLikeType(c, t))), targetRestType);
    }
}
/**
 ...
 * }
 */
export function Checker_applyToReturnTypes(receiver, source, target, callback) {
    const c = receiver;
 ...
 * }
 */
export function Checker_inferToMappedType(receiver, n, source, target, constraintType) {
    const c = receiver;
    const state = n;
    if ((constraintType.flags & TypeFlagsUnion) !== 0 || (constraintType.flags & TypeFlagsIntersection) !== 0) {
        let result = false;
    ...
    if ((constraintType.flags & TypeFlagsIndex) !== 0) {
        ...
        if (inference !== undefined && !inference.isFixed && !Checker_isFromInferenceBlockedSource(c, source)) {
            ...
            if (inferredType !== undefined) {
                ...
                // types because we may only have a partial result (i.e. we may have failed to make
                // reverse inferences for some properties).
                Checker_inferWithPriority(c, state, inferredType, inference.typeParameter, core.IfElse((source.objectFlags & ObjectFlagsNonInferrableType) !== 0, InferencePriorityPartialHomomorphicMappedType, InferencePriorityHomomorphicMappedType));
            }
        }
        return true;
    }
    if ((constraintType.flags & TypeFlagsTypeParameter) !== 0) {
        ...
        // If no inferences can be made to K's constraint, infer from a union of the property types
        // in the source to the template type X.
        const propTypes = core.Map(Checker_getPropertiesOfType(c, source), (prop) => Checker_getTypeOfSymbol(c, prop));
        const indexTypes = core.Map(Checker_getIndexInfosOfType(c, source), (info) => {
            if (info !== c.enumNumberIndexInfo) {
                return info.valueType;
            }
            return c.neverType;
 ...
 * }
 */
export function Checker_inferTypeForHomomorphicMappedType(receiver, source, target, constraint) {
    const c = receiver;
    const key = { sourceId: source.id, targetId: target.id, constraintId: constraint.id };
 ...
 * }
 */
export function Checker_createReverseMappedType(receiver, source, target, constraint) {
    const c = receiver;
    // We consider a source type reverse mappable if it has a string index signature or if
    // it has one or more properties and is of a partially inferable type.
    ...
    if (isTupleType(source)) {
        const elementTypes = core.Map(Checker_getElementTypes(c, source), (t) => {
            return Checker_inferReverseMappedType(c, t, target, constraint);
        });
        if (!core.Every(elementTypes, (t) => t !== undefined)) {
            return undefined;
        }
        let elementInfos = Type_TargetTupleType(source).elementInfos;
        if ((getMappedTypeModifiers(target) & MappedTypeModifiersIncludeOptional) !== 0) {
            elementInfos = core.SameMap(elementInfos, (info) => {
                if ((info.flags & ElementFlagsOptional) !== 0) {
 ...
 * }
 */
export function Checker_isPartiallyInferableType(receiver, t) {
    const c = receiver;
    return ((t.objectFlags & ObjectFlagsNonInferrableType) === 0 ||
        (isObjectLiteralType(t) && core.Some(Checker_getPropertiesOfType(c, t), (prop) => {
            return Checker_isPartiallyInferableType(c, Checker_getTypeOfSymbol(c, prop));
        })) ||
        (isTupleType(t) && core.Some(Checker_getElementTypes(c, t), (et) => Checker_isPartiallyInferableType(c, et))));
}
/**
 ...
 * }
 */
export function Checker_inferReverseMappedType(receiver, source, target, constraint) {
    const c = receiver;
    const key = { sourceId: source.id, targetId: target.id, constraintId: constraint.id };
 ...
 * }
 */
export function Checker_inferReverseMappedTypeWorker(receiver, source, target, constraint) {
    const c = receiver;
 ...
 * }
 */
export function Checker_resolveReverseMappedTypeMembers(receiver, t) {
    const c = receiver;
    ...
    for (const prop of Checker_getPropertiesOfType(receiver, r.source)) {
        ...
        inferredProp.Declarations = prop.Declarations;
        LinkStore_Get(c.valueSymbolLinks, inferredProp).nameType = LinkStore_Get(c.valueSymbolLinks, prop).nameType;
        const links = LinkStore_Get(c.ReverseMappedSymbolLinks, inferredProp);
 ...
 * }
 */
export function Checker_getTypeOfReverseMappedSymbol(receiver, symbol_) {
    const c = receiver;
    const links = LinkStore_Get(c.valueSymbolLinks, symbol_);
    if (links.resolvedType === undefined) {
        const reverseLinks = LinkStore_Get(c.ReverseMappedSymbolLinks, symbol_);
 ...
 * }
 */
export function Checker_getLimitedConstraint(receiver, t) {
    const c = receiver;
    ...
    const limitedConstraint = Checker_getIntersectionType(c, core.Filter(Type_Types(origin), (u) => u !== constraintType));
    if (limitedConstraint !== c.neverType) {
        return limitedConstraint;
    }
    return undefined;
 ...
 * }
 */
export function Checker_replaceIndexedAccess(receiver, instantiable, t, replacement) {
    return Checker_instantiateType(receiver, instantiable, newTypeMapper([Type_AsIndexedAccessType(t).indexType, Type_AsIndexedAccessType(t).objectType], [Checker_getNumberLiteralType(receiver, 0), Checker_createTupleType(receiver, [replacement])]));
}
/**
 ...
 * }
 */
export function Checker_typesDefinitelyUnrelated(receiver, source, target) {
    if (isTupleType(source) && isTupleType(target)) {
        return tupleTypesDefinitelyUnrelated(source, target);
    }
 ...
 * }
 */
export function tupleTypesDefinitelyUnrelated(source, target) {
 ...
 * }
 */
export function Checker_isTupleTypeStructureMatching(receiver, t1, t2) {
 ...
 * }
 */
export function Checker_isTypeOrBaseIdenticalTo(receiver, s, t) {
    const c = receiver;
    if (t === c.missingType) {
        return s === t;
    }
 ...
 * }
 */
export function Checker_isTypeCloselyMatchedBy(receiver, s, t) {
 ...
 * }
 */
export function Checker_createEmptyObjectTypeFromStringLiteral(receiver, t) {
    const c = receiver;
    const members = new Map();
    for (const t2 of Type_Distributed(t)) {
        ...
        LinkStore_Get(c.valueSymbolLinks, literalProp).resolvedType = c.anyType;
 ...
 * }
 */
export function Checker_newInferenceContext(receiver, typeParameters, signature, flags, compareTypes) {
    const c = receiver;
 ...
 * }
 */
export function Checker_cloneInferenceContext(receiver, n, extraFlags) {
    if (n === undefined) {
        return undefined;
    }
 ...
 * }
 */
export function Checker_cloneInferredPartOfContext(receiver, n) {
 ...
 * }
 */
export function Checker_newInferenceContextWorker(receiver, inferences, signature, flags, compareTypes) {
    const n = {
        inferences,
        signature,
        flags,
 ...
 * }
 */
export function Checker_addIntraExpressionInferenceSite(receiver, n, node, t) {
    const site = { node, t };
 ...
 * }
 */
export function Checker_inferFromIntraExpressionSites(receiver, n) {
 ...
 * }
 */
export function Checker_getInferredType(receiver, n, index) {
    const c = receiver;
    ...
    if (inference.inferredType === undefined) {
            ...
            if (inferredCovariantType !== undefined || inferredContravariantType !== undefined) {
                const preferCovariantType = inferredCovariantType !== undefined && (inferredContravariantType === undefined ||
                    ((inferredCovariantType.flags & (TypeFlagsNever | TypeFlagsAny)) === 0 &&
                        ...
                        core.Every(n.inferences, (other) => (other !== inference && Checker_getConstraintOfTypeParameter(receiver, other.typeParameter) !== inference.typeParameter) ||
        ...
        if (constraint !== undefined) {
            ...
            if (inferredType !== undefined) {
                ...
                if (n.compareTypes(inferredType, constraintWithThis, false) === TernaryFalse) {
                    let filteredByConstraint = undefined;
                    if (inference.priority === InferencePriorityReturnType) {
                        filteredByConstraint = Checker_mapType(receiver, inferredType, (t) => n.compareTypes(t, constraintWithThis, false) !== TernaryFalse ? t : c.neverType);
                    }
 ...
 * }
 */
export function Checker_getInferredTypes(receiver, n) {
    const result = new Array(n.inferences.length);
 ...
 * }
 */
export function Checker_getMapperFromContext(receiver, n) {
    if (n === undefined) {
        return undefined;
    }
    return n.mapper;
 ...
 * }
 */
export function Checker_createOuterReturnMapper(receiver, context) {
 ...
 * }
 */
export function Checker_getCovariantInference(receiver, inference, signature) {
 ...
 * }
 */
export function Checker_getContravariantInference(receiver, inference) {
    if ((inference.priority & InferencePriorityPriorityImpliesCombination) !== 0) {
 ...
 * }
 */
export function Checker_unionObjectAndArrayLiteralCandidates(receiver, candidates) {
 ...
 * }
 */
export function Checker_hasPrimitiveConstraint(receiver, t) {
 ...
 * }
 */
export function Checker_isTypeParameterAtTopLevel(receiver, t, tp, depth) {
    return t === tp ||
 ...
 * }
 */
export function Checker_isTypeParameterAtTopLevelInReturnType(receiver, signature, typeParameter) {
 ...
 * }
 */
export function Checker_getTypeFromInference(receiver, inference) {
    if (inference.candidates.length !== 0) {
 ...
 * }
 */
export function getInferenceInfoForType(n, t) {
    if ((t.flags & TypeFlagsTypeVariable) !== 0) {
 ...
 * }
 */
export function Checker_getCommonSupertype(receiver, types) {
    const c = receiver;
    if (types.length === 1) {
        return types[0];
    }
 ...
 * }
 */
export function Checker_getSingleCommonSupertype(receiver, types) {
 ...
 * }
 */
export function Checker_findLeftmostType(receiver, types, f) {
 ...
 * }
 */
export function Checker_getCommonSubtype(receiver, types) {
 ...
 * }
 */
export function Checker_getCombinedTypeFlags(receiver, types) {
 ...
 * }
 */
export function Checker_literalTypesWithSameBaseType(receiver, types) {
    const c = receiver;
    let commonBaseType = undefined;
    for (const t of types) {
        if ((t.flags & TypeFlagsNever) === 0) {
 ...
 * }
 */
export function Checker_isFromInferenceBlockedSource(receiver, t) {
 ...
 * }
 */
export function Checker_isSkipDirectInferenceNode(receiver, node) {
    const c = receiver;
 ...
 * }
 */
export function newInferenceInfo(typeParameter) {
 ...
 * }
 */
export function clearCachedInferences(inferences) {
 ...
 * }
 */
export function hasTypeParameterDefault(tp) {
 ...
 * }
 */
export function hasOverlappingInferences(a, b) {
 ...
 * }
 */
export function Checker_mergeInferences(receiver, target, source) {
