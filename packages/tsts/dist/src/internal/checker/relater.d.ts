 ...
 * }
 */
export declare function asRecursionId<T>(value: T): RecursionId;
/**
 ...
 * }
 */
export declare function excludeProperties(properties: GoPtr<GoSlice<GoPtr<Symbol>>>, excludedProperties: Set): GoSlice<GoPtr<Symbol>>;
/**
 ...
 * }
 */
export declare function Relater_propertiesRelatedTo(receiver: GoPtr<Relater>, source: GoPtr<Type>, target: GoPtr<Type>, reportErrors: bool, excludedProperties: Set, optionalsOnly: bool, intersectionState: IntersectionState): Ternary;
/**
 ...
 * }
 */
export declare function Relater_propertiesIdenticalTo(receiver: GoPtr<Relater>, source: GoPtr<Type>, target: GoPtr<Type>, excludedProperties: Set): Ternary;
/**
