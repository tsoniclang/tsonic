 ...
 * )
 */
export const stKindLocals = 0; // 0 << 62
export const stKindExports = 0x4000000000000000; // 1 << 62
export const stKindMembers = 0x8000000000000000; // 2 << 62
export const stKindGlobals = 0xC000000000000000; // 3 << 62
/**
 ...
 * }
 */
export function Checker_trySymbolTable(receiver, ctx, symbols, isGlobals, ignoreQualification, isLocalNameLookup) {
    // If symbol is directly available by its name in the symbol table
