...
import { FormatTypeFlags, ObjectFlagsAnonymous, ObjectFlagsEvolvingArray, ObjectFlagsReference, ObjectFlagsReverseMapped, ObjectFlagsTuple, TypeAlias_Symbol, TypeAlias_TypeArguments, Type_AsConditionalType, Type_AsEvolvingArrayType, Type_AsIndexType, Type_AsIndexedAccessType, Type_AsReverseMappedType, Type_AsSubstitutionType, Type_AsTypeReference, Type_AsUnionOrIntersectionType, Type_Target, TypeFlagsConditional, TypeFlagsIndex, TypeFlagsIndexedAccess, TypeFlagsIntersection, TypeFlagsIntrinsic, TypeFlagsLiteral, TypeFlagsObject, TypeFlagsSubstitution, TypeFlagsTemplateLiteral, TypeFlagsUnion, } from "./types.js";
/**
 ...
 * }
 */
export function NewTracer(tr, checkerIndex) {
 ...
 * }
 */
export function Tracer_RecordType(receiver, typ) {
 ...
 * }
 */
export function Tracer_Push(receiver, phase, name, args, separateBeginAndEnd) {
    if (!separateBeginAndEnd) {
 ...
 * }
 */
export function Tracer_Instant(receiver, phase, name, args) {
 ...
 * }
 */
export function Tracer_copyWithCheckerIndex(receiver, args) {
    const withCheckerIndex = new globalThis.Map();
    maps.Copy(withCheckerIndex, args ?? new globalThis.Map());
 ...
 * }
 */
export function Tracer_temporarilyAddCheckerIndex(receiver, args) {
    if (args === undefined) {
        args = new globalThis.Map();
    }
 ...
 */
export const __88a6f671_0 = wrapType(undefined);
/**
 ...
 * }
 */
export function tracedTypeAdapter_Id(receiver) {
    return receiver.t.id;
}
/**
 ...
 * }
 */
export function tracedTypeAdapter_FormatFlags(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_IsConditional(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_Symbol(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_AliasSymbol(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_AliasTypeArguments(receiver) {
    if (receiver.t.alias === undefined) {
        return [];
    }
 ...
 * }
 */
export function tracedTypeAdapter_IntrinsicName(receiver) {
    if ((receiver.t.flags & TypeFlagsIntrinsic) === 0) {
        return "";
    }
    const data = receiver.t.data[goReceiverKey];
    if (data === undefined) {
        return "";
    }
    return data.intrinsicName;
 ...
 * }
 */
export function tracedTypeAdapter_UnionTypes(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_IntersectionTypes(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_IndexType(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_IndexedAccessObjectType(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_IndexedAccessIndexType(receiver) {
    if ((receiver.t.flags & TypeFlagsIndexedAccess) === 0) {
        return undefined;
    }
 ...
 * }
 */
export function tracedTypeAdapter_ConditionalCheckType(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_ConditionalExtendsType(receiver) {
    if ((receiver.t.flags & TypeFlagsConditional) === 0) {
        return undefined;
    }
 ...
 * }
 */
export function tracedTypeAdapter_ConditionalTrueType(receiver) {
    if ((receiver.t.flags & TypeFlagsConditional) === 0) {
        return undefined;
    }
 ...
 * }
 */
export function tracedTypeAdapter_ConditionalFalseType(receiver) {
    if ((receiver.t.flags & TypeFlagsConditional) === 0) {
        return undefined;
    }
 ...
 * }
 */
export function tracedTypeAdapter_SubstitutionBaseType(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_SubstitutionConstraintType(receiver) {
    if ((receiver.t.flags & TypeFlagsSubstitution) === 0) {
        return undefined;
    }
 ...
 * }
 */
export function tracedTypeAdapter_ReferenceTarget(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_ReferenceTypeArguments(receiver) {
    if ((receiver.t.flags & TypeFlagsObject) === 0 || (receiver.t.objectFlags & ObjectFlagsReference) === 0) {
        return [];
    }
 ...
 * }
 */
export function tracedTypeAdapter_ReferenceNode(receiver) {
    if ((receiver.t.flags & TypeFlagsObject) === 0 || (receiver.t.objectFlags & ObjectFlagsReference) === 0) {
        return undefined;
    }
 ...
 * }
 */
export function tracedTypeAdapter_ReverseMappedSourceType(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_ReverseMappedMappedType(receiver) {
    if ((receiver.t.flags & TypeFlagsObject) === 0 || (receiver.t.objectFlags & ObjectFlagsReverseMapped) === 0) {
        return undefined;
    }
 ...
 * }
 */
export function tracedTypeAdapter_ReverseMappedConstraintType(receiver) {
    if ((receiver.t.flags & TypeFlagsObject) === 0 || (receiver.t.objectFlags & ObjectFlagsReverseMapped) === 0) {
        return undefined;
    }
 ...
 * }
 */
export function tracedTypeAdapter_EvolvingArrayElementType(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_EvolvingArrayFinalType(receiver) {
    if ((receiver.t.flags & TypeFlagsObject) === 0 || (receiver.t.objectFlags & ObjectFlagsEvolvingArray) === 0) {
        return undefined;
    }
 ...
 * }
 */
export function tracedTypeAdapter_IsTuple(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_Pattern(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_RecursionIdentity(receiver) {
 ...
 * }
 */
export function tracedTypeAdapter_Display(receiver) {
    if (receiver.checker === undefined) {
        return "";
    }
    if ((receiver.t.objectFlags & ObjectFlagsAnonymous) !== 0 ||
 ...
 * }
 */
export function wrapType(t) {
    if (t === undefined) {
        return undefined;
    }
    const a = { t, checker: t.checker };
    return {
 ...
 * }
 */
export function wrapTypes(types) {
    if (types.length === 0) {
        return [];
    }
