 ...
 * }
 */
export declare function cloneNodeBuilderContext(context: GoPtr<NodeBuilderContext>): () => void;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_addSymbolTypeToContext(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>, t: GoPtr<Type>): () => void;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_enterSignatureScope(receiver: GoPtr<NodeBuilderImpl>, signature: GoPtr<Signature>): [GoSlice<GoPtr<Symbol>>, () => void];
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_enterNewScope(receiver: GoPtr<NodeBuilderImpl>, declaration: GoPtr<Node>, expandedParams: GoSlice<GoPtr<Symbol>>, typeParameters: GoSlice<GoPtr<Type>>, originalParameters: GoSlice<GoPtr<Symbol>>, mapper: GoPtr<TypeMapper>): () => void;
//# sourceMappingURL=nodebuilderscopes.d.ts.map