 ...
 * }
 */
export function NodeBuilderImpl_addSymbolTypeToContext(receiver, symbol_, t) {
 ...
 * }
 */
export function NodeBuilderImpl_enterSignatureScope(receiver, signature) {
 ...
 * }
 */
export function NodeBuilderImpl_enterNewScope(receiver, declaration, expandedParams, typeParameters, originalParameters, mapper) {
    ...
    if (receiver.ctx.enclosingDeclaration !== undefined && declaration !== undefined) {
        ...
        const pushFakeScope = (kind, addAll) => {
            Assert(receiver.ctx.enclosingDeclaration !== undefined);
            let existingFakeScope;
            if (LinkStore_Has(links, receiver.ctx.enclosingDeclaration)) {
                const existingLinks = LinkStore_Get(links, receiver.ctx.enclosingDeclaration);
            ...
            if (existingFakeScope === undefined && receiver.ctx.enclosingDeclaration.Parent !== undefined) {
                if (LinkStore_Has(links, receiver.ctx.enclosingDeclaration.Parent)) {
                    const parentLinks = LinkStore_Get(links, receiver.ctx.enclosingDeclaration.Parent);
            ...
            if (existingFakeScope === undefined) {
                ...
                LinkStore_Get(links, fakeScope).fakeScopeForSignatureDeclaration = kind;
        ...
        if (expandedParams === undefined || !Some(expandedParams, (p) => p !== undefined)) {
            cleanupParams = undefined;
        }
        else {
            cleanupParams = pushFakeScope("params", (add) => {
                ...
                for (let pIndex = 0; pIndex < expandedParams.length; pIndex++) {
                    ...
                    else if (!Some(param.Declarations, (d) => {
                        const bindElement = (e) => {
        ...
        if ((receiver.ctx.flags & FlagsGenerateNamesForShadowedTypeParams) !== 0 && typeParameters !== undefined && Some(typeParameters, (p) => p !== undefined)) {
            cleanupTypeParams = pushFakeScope("typeParams", (add) => {
...
//# sourceMappingURL=nodebuilderscopes.js.map