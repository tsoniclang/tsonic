 ...
 * )
 */
export declare const defaultMaximumTruncationLength: int;
export declare const noTruncationMaximumTruncationLength: int;
/**
 ...
 * }
 */
export declare function newNodeBuilderImpl(ch: GoPtr<Checker>, e: GoPtr<EmitContext>, idToSymbol: GoMap<GoPtr<IdentifierNode>, GoPtr<Symbol>>): GoPtr<NodeBuilderImpl>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_saveRestoreFlags(receiver: GoPtr<NodeBuilderImpl>): () => void;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_checkTruncationLength(receiver: GoPtr<NodeBuilderImpl>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_checkTruncationLengthIfExpanding(receiver: GoPtr<NodeBuilderImpl>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_isExpandableType(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>, isAlias: bool): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_isTypeOnStack(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_shouldExpandType(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>, isAlias: bool): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_isActivelyExpanding(receiver: GoPtr<NodeBuilderImpl>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_checkTypeExpandability(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>): void;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_appendReferenceToType(receiver: GoPtr<NodeBuilderImpl>, root: GoPtr<TypeNode>, ref: GoPtr<TypeNode>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function getAccessStack(ref: GoPtr<Node>): GoSlice<GoPtr<Node>>;
/**
 ...
 * }
 */
export declare function isClassInstanceSide(c: GoPtr<Checker>, t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createElidedInformationPlaceholder(receiver: GoPtr<NodeBuilderImpl>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_mapToTypeNodes(receiver: GoPtr<NodeBuilderImpl>, list: GoSlice<GoPtr<Type>>, isBareList: bool): GoPtr<NodeList>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_serializeTypeName(receiver: GoPtr<NodeBuilderImpl>, node: GoPtr<Node>, isTypeOf: bool, typeArguments: GoPtr<NodeList>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function isIdentifierTypeReference(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function arrayIsHomogeneous<T>(array: GoSlice<T>, comparer: (a: T, B: T) => bool): bool;
/**
 ...
 * }
 */
export declare function typesAreSameReference(a: GoPtr<Type>, b: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_setCommentRange(receiver: GoPtr<NodeBuilderImpl>, node: GoPtr<Node>, range_: GoPtr<Node>): void;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_tryReuseExistingTypeNode(receiver: GoPtr<NodeBuilderImpl>, typeNode: GoPtr<TypeNode>, t: GoPtr<Type>, host: GoPtr<Node>, addUndefined: bool): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typeNodeIsEquivalentToType(receiver: GoPtr<NodeBuilderImpl>, annotatedDeclaration: GoPtr<Node>, t: GoPtr<Type>, typeFromTypeNode: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_existingTypeNodeIsNotReferenceOrIsReferenceWithCompatibleTypeArgumentCount(receiver: GoPtr<NodeBuilderImpl>, existing: GoPtr<TypeNode>, t: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_tryReuseExistingNonParameterTypeNode(receiver: GoPtr<NodeBuilderImpl>, existing: GoPtr<TypeNode>, t: GoPtr<Type>, host: GoPtr<Node>, annotationType: GoPtr<Type>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_getResolvedTypeWithoutAbstractConstructSignatures(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<StructuredType>): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_symbolToNode(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>, meaning: SymbolFlags): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_symbolToName(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>, meaning: SymbolFlags, expectsIdentifier: bool): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createEntityNameFromSymbolChain(receiver: GoPtr<NodeBuilderImpl>, chain: GoSlice<GoPtr<Symbol>>, index: int): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_symbolToEntityNameNode(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>): GoPtr<EntityName>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_symbolToTypeNode(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>, mask: SymbolFlags, typeArguments: GoPtr<NodeList>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function getTopmostIndexedAccessType(node: GoPtr<IndexedAccessTypeNode>): GoPtr<IndexedAccessTypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createAccessFromSymbolChain(receiver: GoPtr<NodeBuilderImpl>, chain: GoSlice<GoPtr<Symbol>>, index: int, stopper: int, overrideTypeArguments: GoPtr<NodeList>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_symbolToExpression(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>, mask: SymbolFlags): GoPtr<Expression>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createExpressionFromSymbolChain(receiver: GoPtr<NodeBuilderImpl>, chain: GoSlice<GoPtr<Symbol>>, index: int): GoPtr<Expression>;
/**
 ...
 * }
 */
export declare function canUsePropertyAccess(name: string): bool;
/**
 ...
 * }
 */
export declare function startsWithSingleOrDoubleQuote(str: string): bool;
/**
 ...
 * }
 */
export declare function startsWithSquareBracket(str: string): bool;
/**
 ...
 * }
 */
export declare function isDefaultBindingContext(location: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_getNameOfSymbolFromNameType(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>): string;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_getNameOfSymbolAsWritten(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>): string;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_getTypeParametersOfClassOrInterface(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>): GoSlice<GoPtr<Type>>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_lookupTypeParameterNodes(receiver: GoPtr<NodeBuilderImpl>, chain: GoSlice<GoPtr<Symbol>>, index: int): GoPtr<TypeParameterList>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_lookupSymbolChain(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>, meaning: SymbolFlags, yieldModuleSymbol: bool): GoSlice<GoPtr<Symbol>>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_lookupSymbolChainWorker(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>, meaning: SymbolFlags, yieldModuleSymbol: bool): GoSlice<GoPtr<Symbol>>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_getSymbolChain(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>, meaning: SymbolFlags, endOfChain: bool, yieldModuleSymbol: bool): GoSlice<GoPtr<Symbol>>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_sortByBestName(receiver: GoPtr<NodeBuilderImpl>, a: sortedSymbolNamePair, b: sortedSymbolNamePair): int;
/**
 ...
 * }
 */
export declare function canHaveModuleSpecifier(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function TryGetModuleSpecifierFromDeclaration(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function tryGetModuleSpecifierFromDeclarationWorker(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_getSpecifierForModuleSymbol(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>, overrideImportMode: ResolutionMode): string;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typeParameterToDeclarationWithConstraint(receiver: GoPtr<NodeBuilderImpl>, typeParameter: GoPtr<Type>, constraintNode: GoPtr<TypeNode>): GoPtr<TypeParameterDeclarationNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_setTextRange(receiver: GoPtr<NodeBuilderImpl>, range_: GoPtr<Node>, location: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typeParameterShadowsOtherTypeParameterInScope(receiver: GoPtr<NodeBuilderImpl>, name: string, typeParameter: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typeParameterToName(receiver: GoPtr<NodeBuilderImpl>, typeParameter: GoPtr<Type>): GoPtr<Identifier>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_isMappedTypeHomomorphic(receiver: GoPtr<NodeBuilderImpl>, mapped: GoPtr<Type>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_isHomomorphicMappedTypeWithNonHomomorphicInstantiation(receiver: GoPtr<NodeBuilderImpl>, mapped: GoPtr<MappedType>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createMappedTypeNodeFromType(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typePredicateToTypePredicateNode(receiver: GoPtr<NodeBuilderImpl>, predicate: GoPtr<TypePredicate>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typeToTypeNodeHelperWithPossibleReusableTypeNode(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>, typeNode: GoPtr<TypeNode>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typeParameterToDeclaration(receiver: GoPtr<NodeBuilderImpl>, parameter: GoPtr<Type>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_symbolToTypeParameterDeclarations(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>): GoSlice<GoPtr<Node>>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typeParametersToTypeParameterDeclarations(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>): GoSlice<GoPtr<Node>>;
/**
 ...
 * }
 */
export declare function getEffectiveParameterDeclaration(symbol_: GoPtr<Symbol>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_symbolToParameterDeclaration(receiver: GoPtr<NodeBuilderImpl>, parameterSymbol: GoPtr<Symbol>, preserveModifierFlags: bool): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_parameterToParameterDeclarationName(receiver: GoPtr<NodeBuilderImpl>, parameterSymbol: GoPtr<Symbol>, parameterDeclaration: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_cloneBindingName(receiver: GoPtr<NodeBuilderImpl>, node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_serializeTypeForExpression(receiver: GoPtr<NodeBuilderImpl>, expr: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_serializeInferredReturnTypeForSignature(receiver: GoPtr<NodeBuilderImpl>, signature: GoPtr<Signature>, returnType: GoPtr<Type>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typePredicateToTypePredicateNodeHelper(receiver: GoPtr<NodeBuilderImpl>, typePredicate: GoPtr<TypePredicate>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_signatureToSignatureDeclarationHelper(receiver: GoPtr<NodeBuilderImpl>, signature: GoPtr<Signature>, kind: Kind, options: GoPtr<SignatureToSignatureDeclarationOptions>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function Checker_getExpandedParameters(receiver: GoPtr<Checker>, sig: GoPtr<Signature>, skipUnionExpanding: bool): GoSlice<GoSlice<GoPtr<Symbol>>>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_tryGetThisParameterDeclaration(receiver: GoPtr<NodeBuilderImpl>, signature: GoPtr<Signature>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_serializeReturnTypeForSignature(receiver: GoPtr<NodeBuilderImpl>, signature: GoPtr<Signature>, tryReuse: bool): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_isTriviallySerializableComputedName(receiver: GoPtr<NodeBuilderImpl>, e: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_indexInfoToObjectComputedNamesOrSignatureDeclaration(receiver: GoPtr<NodeBuilderImpl>, indexInfo: GoPtr<IndexInfo>, typeNode: GoPtr<TypeNode>): GoSlice<GoPtr<Node>>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_indexInfoToIndexSignatureDeclarationHelper(receiver: GoPtr<NodeBuilderImpl>, indexInfo: GoPtr<IndexInfo>, typeNode: GoPtr<TypeNode>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function hasTypeAnnotation(declaration: GoPtr<Declaration>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_serializeTypeForDeclaration(receiver: GoPtr<NodeBuilderImpl>, declaration: GoPtr<Declaration>, t: GoPtr<Type>, symbol_: GoPtr<Symbol>, tryReuse: bool): GoPtr<Node>;
/**
 ...
 */
export declare const MAX_REVERSE_MAPPED_NESTING_INSPECTION_DEPTH: int;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_shouldUsePlaceholderForProperty(receiver: GoPtr<NodeBuilderImpl>, propertySymbol: GoPtr<Symbol>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_trackComputedName(receiver: GoPtr<NodeBuilderImpl>, accessExpression: GoPtr<Node>, enclosingDeclaration: GoPtr<Node>): void;
/**
 ...
 * )
 */
export declare const propertyNameNodeKindIdentifier: propertyNameNodeKind;
export declare const propertyNameNodeKindNumericLiteral: propertyNameNodeKind;
export declare const propertyNameNodeKindStringLiteral: propertyNameNodeKind;
/**
 ...
 * }
 */
export declare function classifyPropertyName(name: string, stringNamed: bool, isMethod: bool): propertyNameNodeKind;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createPropertyNameNodeForIdentifierOrLiteral(receiver: GoPtr<NodeBuilderImpl>, name: string, singleQuote: bool, stringNamed: bool, isMethod: bool, symbol_: GoPtr<Symbol>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_isStringNamed(receiver: GoPtr<NodeBuilderImpl>, d: GoPtr<Declaration>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_isSingleQuotedStringNamed(receiver: GoPtr<NodeBuilderImpl>, d: GoPtr<Declaration>): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_getPropertyNameNodeForSymbol(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_getPropertyNameNodeForSymbolFromNameType(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>, singleQuote: bool, stringNamed: bool, isMethod: bool): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_addPropertyToElementList(receiver: GoPtr<NodeBuilderImpl>, propertySymbol: GoPtr<Symbol>, typeElements: GoSlice<GoPtr<TypeElement>>): GoSlice<GoPtr<TypeElement>>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createTypeNodesFromResolvedType(receiver: GoPtr<NodeBuilderImpl>, resolvedType: GoPtr<StructuredType>): GoPtr<NodeList>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createTypeNodeFromObjectType(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function getTypeAliasForTypeLiteral(c: GoPtr<Checker>, t: GoPtr<Type>): GoPtr<Symbol>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_shouldWriteTypeOfFunctionSymbol(receiver: GoPtr<NodeBuilderImpl>, symbol_: GoPtr<Symbol>, typeId: TypeId): bool;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createAnonymousTypeNode(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createAnonymousTypeNodeEx(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>, forceClassExpansion: bool, forceExpansion: bool): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_getTypeFromTypeNode(receiver: GoPtr<NodeBuilderImpl>, node: GoPtr<TypeNode>, noMappedTypes: bool): GoPtr<Type>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typeToTypeNodeOrCircularityElision(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_conditionalTypeToTypeNode(receiver: GoPtr<NodeBuilderImpl>, _t: GoPtr<Type>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_getParentSymbolOfTypeParameter(receiver: GoPtr<NodeBuilderImpl>, typeParameter: GoPtr<TypeParameter>): GoPtr<Symbol>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typeReferenceToTypeNode(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_visitAndTransformType(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>, transform: (b: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>) => GoPtr<TypeNode>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_typeToTypeNode(receiver: GoPtr<NodeBuilderImpl>, t: GoPtr<Type>): GoPtr<TypeNode>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_newStringLiteral(receiver: GoPtr<NodeBuilderImpl>, text: string): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_newStringLiteralEx(receiver: GoPtr<NodeBuilderImpl>, text: string, isSingleQuote: bool): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function TypeAlias_ToTypeReferenceNode(receiver: GoPtr<TypeAlias>, b: GoPtr<NodeBuilderImpl>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_newIdentifier(receiver: GoPtr<NodeBuilderImpl>, text: string, symbol_: GoPtr<Symbol>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createAccessExpression(receiver: GoPtr<NodeBuilderImpl>, node: GoPtr<Node>): GoPtr<Expression>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_createExpressionWithTypeArguments(receiver: GoPtr<NodeBuilderImpl>, expr: GoPtr<Expression>, typeArguments: GoPtr<NodeList>): GoPtr<Expression>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_lookupInstantiatedTypeArgumentNodes(receiver: GoPtr<NodeBuilderImpl>, chain: GoSlice<GoPtr<Symbol>>, index: int): GoPtr<TypeParameterList>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_lookupExpressionChainTypeArgumentNodes(receiver: GoPtr<NodeBuilderImpl>, chain: GoSlice<GoPtr<Symbol>>, index: int): GoPtr<TypeParameterList>;
/**
 ...
 * }
 */
export declare function NodeBuilderImpl_shouldWriteTypeParametersInQualifiedName(receiver: GoPtr<NodeBuilderImpl>, chain: GoSlice<GoPtr<Symbol>>, index: int): bool;
//# sourceMappingURL=nodebuilderimpl.d.ts.map