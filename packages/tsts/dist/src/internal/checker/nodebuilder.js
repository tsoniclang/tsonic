...
import { NodeBuilderImpl_indexInfoToIndexSignatureDeclarationHelper, NodeBuilderImpl_serializeReturnTypeForSignature, NodeBuilderImpl_serializeTypeForDeclaration, NodeBuilderImpl_serializeTypeForExpression, NodeBuilderImpl_signatureToSignatureDeclarationHelper, NodeBuilderImpl_symbolToExpression, NodeBuilderImpl_symbolToName, NodeBuilderImpl_symbolToNode, NodeBuilderImpl_symbolToParameterDeclaration, NodeBuilderImpl_symbolToTypeParameterDeclarations, NodeBuilderImpl_typeParameterToDeclaration, NodeBuilderImpl_typePredicateToTypePredicateNode, NodeBuilderImpl_typeToTypeNode, } from "./nodebuilderimpl.js";
...
import { FlagsIgnoreErrors, FlagsMultilineObjectLiterals, FlagsUseAliasDefinedOutsideCurrentScope, } from "../nodebuilder/types.js";
 ...
 * }
 */
export function NodeBuilder_EmitContext(receiver) {
    const b = receiver;
    return b.impl.e;
}
/**
 ...
 * }
 */
export function NodeBuilder_enterContext(receiver, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    ...
    b.impl.ctx = {
        ...
        typeParameterNames: { m: new globalThis.Map(), owned: false },
        typeParameterNamesByText: { m: { m: new globalThis.Map(), owned: false } },
        typeParameterNamesByTextNextNameCount: { m: new globalThis.Map(), owned: false },
        typeParameterSymbolList: { m: { m: new globalThis.Map(), owned: false } },
    };
 ...
 * }
 */
export function NodeBuilder_propagateVerbosityOut(receiver) {
    const b = receiver;
    if (b.verbosity !== undefined) {
        // Only set to true, never clear — multiple calls share the same VerbosityContext
        if (b.impl.ctx.canIncreaseExpansionDepth) {
 ...
 * }
 */
export function NodeBuilder_popContext(receiver) {
    const b = receiver;
 ...
 * }
 */
export function NodeBuilder_exitContext(receiver, result) {
    const b = receiver;
 ...
 * }
 */
export function NodeBuilder_exitContextSlice(receiver, result) {
    const b = receiver;
    NodeBuilder_propagateVerbosityOut(b);
    NodeBuilder_exitContextCheck(b);
    try {
 ...
 * }
 */
export function NodeBuilder_exitContextCheck(receiver) {
    const b = receiver;
 ...
 * }
 */
export function NodeBuilder_IndexInfoToIndexSignatureDeclaration(receiver, info, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
 ...
 * }
 */
export function NodeBuilder_SerializeReturnTypeForSignature(receiver, signatureDeclaration, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
 ...
 * }
 */
export function NodeBuilder_SerializeTypeParametersForSignature(receiver, signatureDeclaration, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
 ...
 * }
 */
export function NodeBuilder_SerializeTypeForDeclaration(receiver, declaration, symbol_, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
    return NodeBuilder_exitContext(b, NodeBuilderImpl_serializeTypeForDeclaration(b.impl, declaration, undefined, symbol_, true));
}
/**
 ...
 * }
 */
export function NodeBuilder_SerializeTypeForExpression(receiver, expr, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
 ...
 * }
 */
export function NodeBuilder_SignatureToSignatureDeclaration(receiver, signature, kind, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
 ...
 * }
 */
export function NodeBuilder_ExpandSymbolForHover(receiver, symbol_, meaning) {
    const b = receiver;
    NodeBuilder_enterContext(b, undefined, (FlagsIgnoreErrors | FlagsMultilineObjectLiterals | FlagsUseAliasDefinedOutsideCurrentScope), 0, undefined);
 ...
 * }
 */
export function simplifyClassDeclaration(f, classDecl, symbol_) {
    const classDeclarations = Filter(symbol_.Declarations ?? [], IsClassLike);
    let originalClassDecl;
    ...
    if (isAnonymous) {
        ...
        classDecl = NodeFactory_UpdateClassDeclaration(f, cd, Node_Modifiers(classDecl), undefined, cd.TypeParameters, cd.HeritageClauses, cd.Members);
    }
    return ReplaceModifiers(f, classDecl, NodeFactory_NewModifierList(f, CreateModifiersFromModifierFlags(modifiers, (kind) => NodeFactory_NewModifier(f, kind))));
}
/**
 ...
 * }
 */
export function simplifyModifiers(f, newDecl, isDeclKind, symbol_) {
    const decls = Filter(symbol_.Declarations ?? [], isDeclKind);
    let declWithModifiers;
    if (decls.length > 0) {
        declWithModifiers = decls[0];
    }
    else {
    ...
    return ReplaceModifiers(f, newDecl, NodeFactory_NewModifierList(f, CreateModifiersFromModifierFlags(modifiers, (kind) => NodeFactory_NewModifier(f, kind))));
}
/**
 ...
 * }
 */
export function NodeBuilder_SymbolToEntityName(receiver, symbol_, meaning, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
    return NodeBuilder_exitContext(b, NodeBuilderImpl_symbolToName(b.impl, symbol_, meaning, false));
}
/**
 ...
 * }
 */
export function NodeBuilder_SymbolToExpression(receiver, symbol_, meaning, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
 ...
 * }
 */
export function NodeBuilder_SymbolToNode(receiver, symbol_, meaning, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
 ...
 * }
 */
export function NodeBuilder_SymbolToParameterDeclaration(receiver, symbol_, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
    return NodeBuilder_exitContext(b, NodeBuilderImpl_symbolToParameterDeclaration(b.impl, symbol_, false));
}
/**
 ...
 * }
 */
export function NodeBuilder_SymbolToTypeParameterDeclarations(receiver, symbol_, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
 ...
 * }
 */
export function NodeBuilder_TypeParameterToDeclaration(receiver, parameter, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
 ...
 * }
 */
export function NodeBuilder_TypePredicateToTypePredicateNode(receiver, predicate, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
 ...
 * }
 */
export function NodeBuilder_TypeToTypeNode(receiver, typ, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
 ...
 * }
 */
export function NodeBuilder_TryJSTypeNodeToTypeNode(receiver, node, enclosingDeclaration, flags, internalFlags, tracker) {
    const b = receiver;
    NodeBuilder_enterContext(b, enclosingDeclaration, flags, internalFlags, tracker);
 ...
 * }
 */
export function NewNodeBuilder(ch, e) {
    return NewNodeBuilderEx(ch, e, new globalThis.Map());
}
/**
 ...
 * }
 */
export function NewNodeBuilderEx(ch, e, idToSymbol) {
    const impl = newNodeBuilderImpl(ch, e, idToSymbol);
    return { impl: impl, ctxStack: [], host: ch.program, verbosity: undefined };
}
/**
 ...
 * }
 */
export function Checker_getNodeBuilder(receiver) {
    const releaseNodes = () => {
    ...
    receiver.typeToStringNodebuilder = Checker_getNodeBuilderEx(receiver, new globalThis.Map());
    return [receiver.typeToStringNodebuilder, releaseNodes];
}
/**
 ...
 * }
 */
export function Checker_getNodeBuilderEx(receiver, idToSymbol) {
