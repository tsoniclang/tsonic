...
import { KindSourceFile, KindModuleBlock, KindModuleDeclaration, KindBlock, KindImportDeclaration, KindImportEqualsDeclaration, KindExportAssignment, KindExportDeclaration, KindMethodDeclaration, KindFunctionDeclaration, KindFunctionExpression, KindArrowFunction, KindClassDeclaration, KindClassExpression, KindInterfaceDeclaration, KindTypeAliasDeclaration, KindEnumDeclaration, KindVariableStatement, KindGetAccessor, KindSetAccessor, KindConstructor, KindParameter, KindTypeParameter, KindPropertyDeclaration, KindPropertySignature, KindMethodSignature, KindIndexSignature, KindClassStaticBlockDeclaration, KindPropertyAssignment, KindShorthandPropertyAssignment, KindNamespaceExportDeclaration, KindMissingDeclaration, KindNumericLiteral, KindBigIntLiteral, KindSymbolKeyword, KindArrayType, KindTupleType, KindNewKeyword, KindImportKeyword, KindInKeyword, KindOutKeyword, KindConstKeyword, KindReadonlyKeyword, KindStaticKeyword, KindAccessorKeyword, KindAsyncKeyword, KindAbstractKeyword, KindDeclareKeyword, KindDefaultKeyword, KindExportKeyword, KindPublicKeyword, KindProtectedKeyword, KindPrivateKeyword, KindOverrideKeyword, KindCommaToken, KindExclamationToken, KindQuestionToken, KindComputedPropertyName, KindSwitchStatement, KindLabeledStatement, KindBreakStatement, KindContinueStatement, KindVariableDeclaration as KindVariableDeclarationNode, KindVariableDeclarationList, KindRegularExpressionLiteral, KindJSTypeAliasDeclaration, KindJSImportDeclaration, KindNamespaceImport, KindNamedImports, KindNamedExports, KindImportSpecifier, KindExportSpecifier, KindJsxSpreadAttribute, KindJSDocAugmentsTag, KindMetaProperty, KindTypeLiteral, KindIdentifier, KindExpressionWithTypeArguments, KindPrivateIdentifier, KindConstructorType, KindAwaitKeyword, KindExtendsKeyword, KindImplementsKeyword, KindObjectLiteralExpression, KindPrefixUnaryExpression, KindForInStatement, KindForOfStatement, KindUniqueKeyword, KindTrueKeyword, KindFalseKeyword, KindMinusToken, KindDeferKeyword, KindTypeKeyword, KindSpreadAssignment, KindJsxExpression, KindBinaryExpression, } from "../ast/generated/kinds.js";
import { AsArrowFunction, AsCallExpression, AsBinaryExpression, AsPropertyAccessExpression, AsVariableDeclarationList, AsParameterDeclaration, AsHeritageClause, AsExpressionWithTypeArguments, AsVariableStatement, AsMetaProperty, AsComputedPropertyName, AsMethodDeclaration, AsPropertyDeclaration, AsPropertyAssignment, AsShorthandPropertyAssignment, AsSpreadAssignment, AsJsxAttribute, AsJSDoc, AsVariableDeclaration, AsTypeOperatorNode, AsMappedTypeNode, AsConstructorDeclaration, AsImportClause, AsGetAccessorDeclaration, AsSetAccessorDeclaration, AsIndexSignatureDeclaration, AsJsxNamespacedName, AsBindingElement, AsElementAccessExpression, } from "../ast/generated/casts.js";
import { IsIdentifier, IsForInStatement, IsForOfStatement, IsBinaryExpression, IsPropertyAccessExpression, IsCallExpression, IsParenthesizedExpression, IsExpressionWithTypeArguments, IsNonNullExpression, IsArrowFunction as IsArrowFunctionPred, IsClassStaticBlockDeclaration, IsAwaitExpression, IsPrefixUnaryExpression, IsLiteralTypeNode, IsTypeLiteralNode, IsPropertySignatureDeclaration, IsJSTypeAliasDeclaration, IsSpreadElement, IsJsxNamespacedName, IsMethodDeclaration, IsElementAccessExpression, IsForStatement, IsBlock, IsVariableStatement, IsPropertyDeclaration, IsCaseClause, IsDefaultClause, IsStringLiteral, IsArrayLiteralExpression, IsObjectLiteralExpression, IsComputedPropertyName, IsDecorator, IsInterfaceDeclaration, IsCallSignatureDeclaration, IsConstructSignatureDeclaration, IsMethodSignatureDeclaration, IsFunctionTypeNode, IsConstructorTypeNode, IsTypeAliasDeclaration, } from "../ast/generated/predicates.js";
import { ModifierFlagsNone, ModifierFlagsExport, ModifierFlagsAbstract, ModifierFlagsAmbient, ModifierFlagsStatic, ModifierFlagsAccessor, ModifierFlagsAsync, ModifierFlagsDefault, ModifierFlagsConst, ModifierFlagsIn, ModifierFlagsOut, ModifierFlagsDecorator, ModifierFlagsOverride, ModifierFlagsReadonly, ModifierFlagsPrivate, ModifierFlagsPublic, ModifierFlagsProtected, ModifierFlagsAccessibilityModifier, ModifierFlagsParameterPropertyModifier, ModifierFlagsExportDefault, ModifierFlagsModifier, ModifierToFlag, } from "../ast/modifierflags.js";
import { NodeFlagsAmbient, NodeFlagsAwaitContext, NodeFlagsYieldContext, NodeFlagsOptionalChain, NodeFlagsReparsed, NodeFlagsConst, NodeFlagsUsing, NodeFlagsAwaitUsing, NodeFlagsBlockScoped, NodeFlagsLet, NodeFlagsJSDoc, } from "../ast/generated/flags.js";
...
import { A_0_modifier_cannot_be_used_with_an_import_declaration, A_bigint_literal_cannot_be_used_as_a_property_name, A_break_statement_can_only_be_used_within_an_enclosing_iteration_or_switch_statement, A_break_statement_can_only_jump_to_a_label_of_an_enclosing_statement, Abstract_methods_can_only_appear_within_an_abstract_class, Abstract_properties_can_only_appear_within_an_abstract_class, Accessibility_modifier_already_seen, A_class_member_cannot_have_the_0_keyword, A_comma_expression_is_not_allowed_in_a_computed_property_name, A_computed_property_name_in_a_class_property_declaration_must_have_a_simple_literal_type_or_a_unique_symbol_type, A_computed_property_name_in_a_method_overload_must_refer_to_an_expression_whose_type_is_a_literal_type_or_a_unique_symbol_type, A_computed_property_name_in_an_ambient_context_must_refer_to_an_expression_whose_type_is_a_literal_type_or_a_unique_symbol_type, A_computed_property_name_in_an_interface_must_refer_to_an_expression_whose_type_is_a_literal_type_or_a_unique_symbol_type, A_computed_property_name_in_a_type_literal_must_refer_to_an_expression_whose_type_is_a_literal_type_or_a_unique_symbol_type, A_const_initializer_in_an_ambient_context_must_be_a_string_or_numeric_literal_or_literal_enum_reference, A_continue_statement_can_only_be_used_within_an_enclosing_iteration_statement, A_continue_statement_can_only_jump_to_a_label_of_an_enclosing_iteration_statement, A_declare_modifier_cannot_be_used_in_an_already_ambient_context, A_decorator_can_only_decorate_a_method_implementation_not_an_overload, A_default_export_can_only_be_used_in_an_ECMAScript_style_module, A_definite_assignment_assertion_is_not_permitted_in_this_context, A_destructuring_declaration_must_have_an_initializer, A_get_accessor_cannot_have_parameters, A_mapped_type_may_not_declare_properties_or_methods, An_abstract_accessor_cannot_have_an_implementation, An_accessibility_modifier_cannot_be_used_with_a_private_identifier, An_accessor_cannot_have_type_parameters, An_accessor_property_cannot_be_declared_optional, An_implementation_cannot_be_declared_in_ambient_contexts, An_index_signature_cannot_have_a_rest_parameter, An_index_signature_cannot_have_a_trailing_comma, An_index_signature_must_have_a_type_annotation, An_index_signature_must_have_exactly_one_parameter, An_index_signature_parameter_cannot_have_an_accessibility_modifier, An_index_signature_parameter_cannot_have_an_initializer, An_index_signature_parameter_cannot_have_a_question_mark, An_index_signature_parameter_must_have_a_type_annotation, An_index_signature_parameter_type_cannot_be_a_literal_type_or_generic_type_Consider_using_a_mapped_object_type_instead, An_index_signature_parameter_type_must_be_string_number_symbol_or_a_template_literal_type, An_interface_property_cannot_have_an_initializer, An_object_literal_cannot_have_multiple_get_Slashset_accessors_with_the_same_name, An_object_literal_cannot_have_multiple_properties_with_the_same_name, An_object_literal_cannot_have_property_and_accessor_with_the_same_name, An_object_member_cannot_be_declared_optional, An_overload_signature_cannot_be_declared_as_a_generator, A_parameter_property_cannot_be_declared_using_a_rest_parameter, A_parameter_property_may_not_be_declared_using_a_binding_pattern, A_property_of_a_class_whose_type_is_a_unique_symbol_type_must_be_both_static_and_readonly, A_property_of_an_interface_or_type_literal_whose_type_is_a_unique_symbol_type_must_be_readonly, A_required_parameter_cannot_follow_an_optional_parameter, A_rest_element_cannot_contain_a_binding_pattern, A_rest_element_cannot_have_an_initializer, A_rest_element_cannot_have_a_property_name, A_rest_element_must_be_last_in_a_destructuring_pattern, A_rest_parameter_cannot_be_optional, A_rest_parameter_cannot_have_an_initializer, A_rest_parameter_must_be_last_in_a_parameter_list, A_rest_parameter_or_binding_pattern_may_not_have_a_trailing_comma, Argument_of_dynamic_import_cannot_be_spread_element, A_set_accessor_cannot_have_an_optional_parameter, A_set_accessor_cannot_have_a_return_type_annotation, A_set_accessor_cannot_have_rest_parameter, A_set_accessor_must_have_exactly_one_parameter, A_set_accessor_parameter_cannot_have_an_initializer, A_top_level_export_modifier_cannot_be_used_on_value_declarations_in_a_CommonJS_module_when_verbatimModuleSyntax_is_enabled, A_type_literal_property_cannot_have_an_initializer, A_type_only_import_can_specify_a_default_import_or_named_bindings_but_not_both, A_variable_whose_type_is_a_unique_symbol_type_must_be_const, A_yield_expression_is_only_allowed_in_a_generator_body, BigInt_literals_are_not_available_when_targeting_lower_than_ES2020, Cannot_find_name_0, Classes_can_only_extend_a_single_class, Classes_may_not_have_a_field_named_constructor, Declarations_with_definite_assignment_assertions_must_also_have_type_annotations, Declarations_with_initializers_cannot_also_have_definite_assignment_assertions, Decorators_are_not_valid_here, Decorators_cannot_be_applied_to_multiple_get_Slashset_accessors_of_the_same_name, Decorators_may_not_appear_after_export_or_export_default_if_they_also_appear_before_export, Decorator_used_before_export_here, Expression_must_be_enclosed_in_parentheses_to_be_used_as_a_decorator, Invalid_syntax_in_decorator, Modifiers_cannot_appear_here, Neither_decorators_nor_modifiers_may_be_applied_to_this_parameters, Non_simple_parameter_declared_here, Private_identifiers_are_not_allowed_outside_class_bodies, Private_identifiers_are_only_allowed_in_class_bodies_and_may_only_be_used_as_part_of_a_class_member_declaration_property_access_or_on_the_left_hand_side_of_an_in_expression, React_components_cannot_include_JSX_namespace_names, Statements_are_not_allowed_in_ambient_contexts, Tagged_template_expressions_are_not_permitted_in_an_optional_chain, The_current_file_is_a_CommonJS_module_and_cannot_use_await_at_the_top_level, The_left_hand_side_of_a_for_in_statement_cannot_be_an_await_using_declaration, The_left_hand_side_of_a_for_in_statement_cannot_be_a_using_declaration, The_left_hand_side_of_a_for_in_statement_cannot_use_a_type_annotation, The_left_hand_side_of_a_for_of_statement_cannot_use_a_type_annotation, The_left_hand_side_of_a_for_of_statement_may_not_be_async, The_type_modifier_cannot_be_used_on_a_named_export_when_export_type_is_used_on_its_export_statement, The_type_modifier_cannot_be_used_on_a_named_import_when_import_type_is_used_on_its_import_statement, The_variable_declaration_of_a_for_in_statement_cannot_have_an_initializer, The_variable_declaration_of_a_for_of_statement_cannot_have_an_initializer, This_parameter_is_not_allowed_with_use_strict_directive, This_syntax_is_reserved_in_files_with_the_mts_or_cts_extension_Add_a_trailing_comma_or_explicit_constraint, This_use_of_import_is_invalid_import_calls_can_be_written_but_they_must_have_parentheses_and_cannot_have_type_arguments, Top_level_await_expressions_are_only_allowed_when_the_module_option_is_set_to_es2022_esnext_system_node16_node18_node20_nodenext_or_preserve_and_the_target_option_is_set_to_es2017_or_higher, Top_level_await_using_statements_are_only_allowed_when_the_module_option_is_set_to_es2022_esnext_system_node16_node18_node20_nodenext_or_preserve_and_the_target_option_is_set_to_es2017_or_higher, Top_level_declarations_in_d_ts_files_must_start_with_either_a_declare_or_export_modifier, Top_level_for_await_loops_are_only_allowed_when_the_module_option_is_set_to_es2022_esnext_system_node16_node18_node20_nodenext_or_preserve_and_the_target_option_is_set_to_es2017_or_higher, Trailing_comma_not_allowed, Type_annotation_cannot_appear_on_a_constructor_declaration, Type_argument_list_cannot_be_empty, Type_parameter_list_cannot_be_empty, Type_parameters_cannot_appear_on_a_constructor_declaration, Variable_declaration_list_cannot_be_empty, X_0_declarations_can_only_be_declared_inside_a_block, X_0_declarations_may_not_have_binding_patterns, X_0_declarations_must_be_initialized, X_0_expected, X_0_is_not_a_valid_meta_property_for_keyword_1_Did_you_mean_2, X_0_is_not_a_valid_meta_property_for_keyword_import_Did_you_mean_meta_or_defer, X_0_list_cannot_be_empty, X_0_modifier_already_seen, X_0_modifier_cannot_appear_on_a_constructor_declaration, X_0_modifier_cannot_appear_on_a_module_or_namespace_element, X_0_modifier_cannot_appear_on_an_await_using_declaration, X_0_modifier_cannot_appear_on_an_index_signature, X_0_modifier_cannot_appear_on_a_parameter, X_0_modifier_cannot_appear_on_a_type_member, X_0_modifier_cannot_appear_on_a_type_parameter, X_0_modifier_cannot_appear_on_a_using_declaration, X_0_modifier_cannot_appear_on_class_elements_of_this_kind, X_0_modifier_cannot_be_used_here, X_0_modifier_cannot_be_used_in_an_ambient_context, X_0_modifier_cannot_be_used_with_1_modifier, X_0_modifier_cannot_be_used_with_a_private_identifier, X_0_modifier_can_only_appear_on_a_type_parameter_of_a_class_interface_or_type_alias, X_0_modifier_can_only_appear_on_a_type_parameter_of_a_function_method_or_class, X_0_modifier_must_precede_1_modifier, X_abstract_modifier_can_only_appear_on_a_class_method_or_property_declaration, X_accessor_modifier_can_only_appear_on_a_property_declaration, X_and_here, X_await_expression_cannot_be_used_inside_a_class_static_block, X_await_expressions_are_only_allowed_at_the_top_level_of_a_file_when_that_file_is_a_module_but_this_file_has_no_imports_or_exports_Consider_adding_an_empty_export_to_make_this_file_a_module, X_await_expressions_are_only_allowed_within_async_functions_and_at_the_top_levels_of_modules, X_await_expressions_cannot_be_used_in_a_parameter_initializer, X_await_using_declarations_are_not_allowed_in_ambient_contexts, X_await_using_declarations_are_not_allowed_in_case_or_default_clauses_unless_contained_within_a_block, X_await_using_statements_are_only_allowed_at_the_top_level_of_a_file_when_that_file_is_a_module_but_this_file_has_no_imports_or_exports_Consider_adding_an_empty_export_to_make_this_file_a_module, X_await_using_statements_are_only_allowed_within_async_functions_and_at_the_top_levels_of_modules, X_await_using_statements_cannot_be_used_inside_a_class_static_block, X_extends_clause_already_seen, X_extends_clause_must_precede_implements_clause, X_for_await_loops_are_only_allowed_at_the_top_level_of_a_file_when_that_file_is_a_module_but_this_file_has_no_imports_or_exports_Consider_adding_an_empty_export_to_make_this_file_a_module, X_for_await_loops_are_only_allowed_within_async_functions_and_at_the_top_levels_of_modules, X_implements_clause_already_seen, X_let_is_not_allowed_to_be_used_as_a_name_in_let_or_const_declarations, X_readonly_modifier_can_only_appear_on_a_property_declaration_or_index_signature, X_readonly_type_modifier_is_only_permitted_on_array_and_tuple_literal_types, X_unique_symbol_types_are_not_allowed_here, X_unique_symbol_types_are_only_allowed_on_variables_in_a_variable_statement, X_unique_symbol_types_may_not_be_used_on_a_variable_declaration_with_a_binding_name, X_use_strict_directive_cannot_be_used_with_non_simple_parameter_list, X_use_strict_directive_used_here, X_using_declarations_are_not_allowed_in_ambient_contexts, X_using_declarations_are_not_allowed_in_case_or_default_clauses_unless_contained_within_a_block, X_yield_expressions_cannot_be_used_in_a_parameter_initializer, } from "../diagnostics/generated/messages.js";
import { Diagnostic_Pos, Diagnostic_Len, Diagnostic_Category } from "../ast/diagnostic.js";
import { Assert } from "../debug/debug.js";
import { DeclarationMeaningGetAccessor, DeclarationMeaningSetAccessor, DeclarationMeaningPropertyAssignment, DeclarationMeaningMethod, DeclarationMeaningGetOrSetAccessor, getSetAccessorValueParameter, someType, everyType, createDiagnosticForNode, } from "./checker/state.js";
...
import { KindIfStatement, KindDoStatement, KindWhileStatement, KindWithStatement, KindForStatement, } from "../ast/generated/kinds.js";
...
import { Only_a_single_variable_declaration_is_allowed_in_a_for_in_statement, Only_a_single_variable_declaration_is_allowed_in_a_for_of_statement, Interface_declaration_cannot_have_implements_clause, Did_you_mean_to_use_a_Colon_An_can_only_follow_a_property_name_when_the_containing_object_literal_is_part_of_a_destructuring_pattern, Dynamic_imports_are_only_supported_when_the_module_flag_is_set_to_es2020_es2022_esnext_commonjs_amd_system_umd_node16_node18_node20_or_nodenext, Did_you_mean_to_mark_this_function_as_async, JSX_elements_cannot_have_multiple_attributes_with_the_same_name, JSX_attributes_must_only_be_assigned_a_non_empty_expression, JSX_property_access_expressions_cannot_include_JSX_namespace_names, JSX_expressions_may_not_use_the_comma_operator_Did_you_mean_to_write_an_array, Default_imports_are_not_allowed_in_a_deferred_import, Named_imports_are_not_allowed_in_a_deferred_import, Deferred_imports_are_only_supported_when_the_module_flag_is_set_to_esnext_or_preserve, Numeric_literals_with_absolute_values_equal_to_2_53_or_greater_are_too_large_to_be_represented_accurately_as_integers, Dynamic_imports_can_only_accept_a_module_specifier_and_an_optional_set_of_attributes_as_arguments, Dynamic_imports_only_support_a_second_argument_when_the_module_option_is_set_to_esnext_node16_node18_node20_nodenext_or_preserve, Parameter_cannot_have_question_mark_and_initializer, Line_terminator_not_permitted_before_arrow, JSDoc_0_1_does_not_match_the_extends_2_clause, Generators_are_not_allowed_in_an_ambient_context, Jump_target_cannot_cross_function_boundary, Identifier_expected_esModule_is_reserved_as_an_exported_marker_when_transforming_ECMAScript_modules, Duplicate_identifier_0, Initializers_are_not_allowed_in_ambient_contexts, } from "../diagnostics/generated/messages.js";
/**
 ...
 * }
 */
export function Checker_grammarErrorOnFirstToken(receiver, node, message, ...args) {
 ...
 * }
 */
export function Checker_grammarErrorAtPos(receiver, nodeForSourceFile, start, length, message, ...args) {
 ...
 * }
 */
export function Checker_grammarErrorOnNode(receiver, node, message, ...args) {
    const sourceFile = GetSourceFileOfNode(node);
    if (!Checker_hasParseDiagnostics(receiver, sourceFile)) {
 ...
 * }
 */
export function Checker_grammarErrorOnNodeSkippedOnNoEmit(receiver, node, message, ...args) {
    const sourceFile = GetSourceFileOfNode(node);
    if (!Checker_hasParseDiagnostics(receiver, sourceFile)) {
 ...
 * }
 */
export function Checker_checkGrammarRegularExpressionLiteral(receiver, node) {
    const sourceFile = GetSourceFileOfNode(node);
    if (!Checker_hasParseDiagnostics(receiver, sourceFile)) {
        ...
        Scanner_SetOnError(receiver.regExpScanner, (message, start, length, ...args) => {
        ...
        Scanner_ResetTokenState(receiver.regExpScanner, Node_Pos(node));
 ...
 * }
 */
export function Checker_checkGrammarPrivateIdentifierExpression(receiver, privId) {
    const privIdAsNode = privId;
    if (GetContainingClass(privId) === undefined) {
        return Checker_grammarErrorOnNode(receiver, privId, Private_identifiers_are_not_allowed_outside_class_bodies);
    }
 ...
 * }
 */
export function Checker_checkGrammarMappedType(receiver, node) {
 ...
 * }
 */
export function Checker_checkGrammarDecorator(receiver, decorator) {
    ...
    if (!Checker_hasParseDiagnostics(receiver, sourceFile)) {
        ...
        if (errorNode !== undefined) {
            const err = Checker_error(receiver, decorator.Expression, Expression_must_be_enclosed_in_parentheses_to_be_used_as_a_decorator);
 ...
 * }
 */
export function Checker_checkGrammarExportDeclaration(receiver, node) {
    if (node.IsTypeOnly && node.ExportClause !== undefined && node.ExportClause.Kind === KindNamedExports) {
        return Checker_checkGrammarTypeOnlyNamedImportsOrExports(receiver, node.ExportClause);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarModuleElementContext(receiver, node, errorMessage) {
 ...
 * }
 */
export function Checker_checkGrammarModifiers(receiver, node) {
    ...
    let blockScopeKind = NodeFlagsNone;
    if (IsVariableStatement(node)) {
        blockScopeKind = AsVariableStatement(node).DeclarationList.Flags & NodeFlagsBlockScoped;
    }
    let lastStatic = undefined;
    let lastDeclare = undefined;
    let lastAsync = undefined;
    let lastOverride = undefined;
    let firstDecorator = undefined;
    let flags = ModifierFlagsNone;
    ...
    for (const modifier of modifiers ?? []) {
        if (IsDecorator(modifier)) {
            ...
            switch (modifier.Kind) {
                ...
                case KindInKeyword:
                case KindOutKeyword: {
                    const inOutFlag = modifier.Kind === KindInKeyword ? ModifierFlagsIn : ModifierFlagsOut;
                    const inOutText = modifier.Kind === KindInKeyword ? "in" : "out";
                    const parent = node.Parent;
 ...
 * }
 */
export function isJSDocTypedefTag(_arg) {
    // !!!
    return false;
}
/**
 ...
 * }
 */
export function Checker_reportObviousModifierErrors(receiver, node) {
 ...
 * }
 */
export function Checker_findFirstModifierExcept(receiver, node, allowedModifier) {
 ...
 * }
 */
export function Checker_findFirstIllegalModifier(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function Checker_reportObviousDecoratorErrors(receiver, node) {
 ...
 * }
 */
export function Checker_findFirstIllegalDecorator(receiver, node) {
 ...
 * }
 */
export function Checker_checkGrammarAsyncModifier(receiver, node, asyncModifier) {
    switch (node.Kind) {
        case KindMethodDeclaration:
        case KindFunctionDeclaration:
        case KindFunctionExpression:
 ...
 * }
 */
export function Checker_checkGrammarForDisallowedTrailingComma(receiver, list, diag) {
 ...
 * }
 */
export function Checker_checkGrammarTypeParameterList(receiver, typeParameters, file) {
    if (typeParameters !== undefined && typeParameters.Nodes.length === 0) {
        ...
        return Checker_grammarErrorAtPos(receiver, file, start, end - start, Type_parameter_list_cannot_be_empty);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarParameterList(receiver, parameters) {
    ...
    for (let i = 0; i < parameterCount; i++) {
        ...
        if (parameter.DotDotDotToken !== undefined) {
            ...
            if (parameter.Initializer !== undefined) {
                return Checker_grammarErrorOnNode(receiver, Node_Name(parameter), A_rest_parameter_cannot_have_an_initializer);
            }
        }
            ...
            if (parameter.QuestionToken !== undefined && parameter.Initializer !== undefined) {
                return Checker_grammarErrorOnNode(receiver, Node_Name(parameter), Parameter_cannot_have_question_mark_and_initializer);
            }
        }
        else if (seenOptionalParameter && parameter.Initializer === undefined) {
            return Checker_grammarErrorOnNode(receiver, Node_Name(parameter), A_required_parameter_cannot_follow_an_optional_parameter);
        }
    }
    return false;
}
 ...
 * }
 */
export function Checker_checkGrammarForUseStrictSimpleParameterList(receiver, node) {
    if (receiver.languageVersion >= ScriptTargetES2016) {
        const body = Node_Body(node);
        let useStrictDirective = undefined;
        ...
        if (useStrictDirective !== undefined) {
            const nonSimpleParameters = Filter(Node_Parameters(node), (n) => {
 ...
 * }
 */
export function Checker_checkGrammarFunctionLikeDeclaration(receiver, node) {
    // Prevent cascading error by short-circuit
 ...
 * }
 */
export function Checker_checkGrammarClassLikeDeclaration(receiver, node) {
    const file = GetSourceFileOfNode(node);
    return Checker_checkGrammarClassDeclarationHeritageClauses(receiver, node, file) || Checker_checkGrammarTypeParameterList(receiver, Node_TypeParameterList(node), file);
}
/**
 ...
 * }
 */
export function Checker_checkGrammarArrowFunction(receiver, node, file) {
    ...
    const sourceFileLike = { Text: () => SourceFile_Text(file), ECMALineMap: () => SourceFile_ECMALineMap(file) };
 ...
 * }
 */
export function Checker_checkGrammarIndexSignatureParameters(receiver, node) {
    const paramNodes = node.Parameters.Nodes;
    if (paramNodes.length === 0) {
        return Checker_grammarErrorOnNode(receiver, node, An_index_signature_must_have_exactly_one_parameter);
    }
    ...
    if (someType(t, (t2) => (t2.flags & TypeFlagsStringOrNumberLiteralOrUnique) !== 0) || Checker_isGenericType(receiver, t)) {
    ...
    if (!everyType(t, (t2) => Checker_isValidIndexKeyType(receiver, t2))) {
    ...
    if (node.Type === undefined) {
        return Checker_grammarErrorOnNode(receiver, node, An_index_signature_must_have_a_type_annotation);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarIndexSignature(receiver, node) {
    // Prevent cascading error by short-circuit
    return Checker_checkGrammarModifiers(receiver, node) || Checker_checkGrammarIndexSignatureParameters(receiver, node);
}
/**
 ...
 * }
 */
export function Checker_checkGrammarForAtLeastOneTypeArgument(receiver, node, typeArguments) {
    if (typeArguments !== undefined && typeArguments.Nodes.length === 0) {
        ...
        return Checker_grammarErrorAtPos(receiver, sourceFile, start, end - start, Type_argument_list_cannot_be_empty);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarTypeArguments(receiver, node, typeArguments) {
 ...
 * }
 */
export function Checker_checkGrammarTaggedTemplateChain(receiver, node) {
    if (node.QuestionDotToken !== undefined || (node.Flags & NodeFlagsOptionalChain) !== 0) {
        return Checker_grammarErrorOnNode(receiver, node.Template, Tagged_template_expressions_are_not_permitted_in_an_optional_chain);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarHeritageClause(receiver, node) {
    ...
    if (types !== undefined && types.Nodes.length === 0) {
        ...
        // TODO(danielr): why not error on the token?
        return Checker_grammarErrorAtPos(receiver, node, NodeList_Pos(types), 0, X_0_list_cannot_be_empty, listType);
    }
    if (types !== undefined) {
 ...
 * }
 */
export function Checker_checkGrammarExpressionWithTypeArguments(receiver, node) {
 ...
 * }
 */
export function Checker_checkGrammarClassDeclarationHeritageClauses(receiver, node, file) {
    let seenExtendsClause = false;
    let seenImplementsClause = false;
    const classLikeData = Node_ClassLikeData(node);
    if (!Checker_checkGrammarModifiers(receiver, node) && classLikeData.HeritageClauses !== undefined) {
        for (const heritageClauseNode of classLikeData.HeritageClauses.Nodes) {
            ...
            if (heritageClause.Token === KindExtendsKeyword) {
                ...
                for (const j of Node_EagerJSDoc(node, file)) {
                    ...
                    for (const tag of AsJSDoc(j).Tags.Nodes) {
                        if (tag.Kind === KindJSDocAugmentsTag) {
                            ...
                            if (!HasSamePropertyAccessName(target.Expression, source.Expression) &&
                                target.Expression.Kind === KindIdentifier &&
                                source.Expression.Kind === KindIdentifier) {
                                return Checker_grammarErrorOnNode(receiver, Node_ClassName(tag), JSDoc_0_1_does_not_match_the_extends_2_clause, Node_Text(Node_TagName(tag)), Node_Text(source.Expression), Node_Text(target.Expression));
                            }
                        }
                    }
                }
 ...
 * }
 */
export function Checker_checkGrammarInterfaceDeclaration(receiver, node) {
 ...
 * }
 */
export function Checker_checkGrammarComputedPropertyName(receiver, node) {
    // If node is not a computedPropertyName, just skip the grammar checking
    if (node.Kind !== KindComputedPropertyName) {
        return false;
    }
    const computedPropertyName = AsComputedPropertyName(node);
    if (computedPropertyName.Expression.Kind === KindBinaryExpression && AsBinaryExpression(computedPropertyName.Expression).OperatorToken.Kind === KindCommaToken) {
        return Checker_grammarErrorOnNode(receiver, computedPropertyName.Expression, A_comma_expression_is_not_allowed_in_a_computed_property_name);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarForGenerator(receiver, node) {
    ...
    if (bodyData !== undefined && bodyData.AsteriskToken !== undefined) {
        ...
        if ((node.Flags & NodeFlagsAmbient) !== 0) {
            return Checker_grammarErrorOnNode(receiver, bodyData.AsteriskToken, Generators_are_not_allowed_in_an_ambient_context);
        }
        if (bodyData.Body === undefined) {
            return Checker_grammarErrorOnNode(receiver, bodyData.AsteriskToken, An_overload_signature_cannot_be_declared_as_a_generator);
        }
    }
    return false;
}
 ...
 * }
 */
export function Checker_checkGrammarForInvalidQuestionMark(receiver, postfixToken, message) {
    return postfixToken !== undefined && postfixToken.Kind === KindQuestionToken && Checker_grammarErrorOnNode(receiver, postfixToken, message);
}
/**
 ...
 * }
 */
export function Checker_checkGrammarForInvalidExclamationToken(receiver, postfixToken, message) {
    return postfixToken !== undefined && postfixToken.Kind === KindExclamationToken && Checker_grammarErrorOnNode(receiver, postfixToken, message);
}
/**
 ...
 * }
 */
export function Checker_checkGrammarObjectLiteralExpression(receiver, node, inDestructuring) {
    const seen = new Map();
    ...
    for (const prop of properties) {
        if (prop.Kind === KindSpreadAssignment) {
            ...
            if (inDestructuring) {
                const expression = SkipParentheses(spreadAssignment.Expression);
                if (IsArrayLiteralExpression(expression) || IsObjectLiteralExpression(expression)) {
                    return Checker_grammarErrorOnNode(receiver, spreadAssignment.Expression, A_rest_element_cannot_contain_a_binding_pattern);
                }
            }
            continue;
        }
        ...
        if (prop.Kind === KindShorthandPropertyAssignment && !inDestructuring) {
            ...
            if (shorthandProp.ObjectAssignmentInitializer !== undefined) {
                let lastNodeBeforeInitializer = undefined;
                Node_ForEachChild(prop, (child) => {
                    if (child !== shorthandProp.ObjectAssignmentInitializer) {
                        lastNodeBeforeInitializer = child;
                        return false;
                    }
        ...
        switch (prop.Kind) {
            ...
            case KindPropertyAssignment: {
                ...
                Checker_checkGrammarForInvalidExclamationToken(receiver, postfixToken, A_definite_assignment_assertion_is_not_permitted_in_this_context);
                Checker_checkGrammarForInvalidQuestionMark(receiver, postfixToken, An_object_member_cannot_be_declared_optional);
                if (name.Kind === KindNumericLiteral) {
                    Checker_checkGrammarNumericLiteral(receiver, name);
                }
        ...
        if (!inDestructuring) {
            ...
            const existingKind = seen.get(effectiveName) ?? 0;
            if (existingKind === 0) {
 ...
 * }
 */
export function Checker_checkGrammarJsxElement(receiver, node) {
    Checker_checkGrammarJsxName(receiver, Node_TagName(node));
    ...
    for (const attrNode of props) {
        ...
        if (initializer !== undefined && initializer.Kind === KindJsxExpression && Node_Expression(initializer) === undefined) {
            return Checker_grammarErrorOnNode(receiver, initializer, JSX_attributes_must_only_be_assigned_a_non_empty_expression);
        }
    }
    return false;
}
 ...
 * }
 */
export function Checker_checkGrammarJsxName(receiver, node) {
    if (IsPropertyAccessExpression(node) && IsJsxNamespacedName(Node_Expression(node))) {
        return Checker_grammarErrorOnNode(receiver, Node_Expression(node), JSX_property_access_expressions_cannot_include_JSX_namespace_names);
    }
    if (IsJsxNamespacedName(node) && CompilerOptions_GetJSXTransformEnabled(receiver.compilerOptions) && !IsIntrinsicJsxName(Node_Text(AsJsxNamespacedName(node).Namespace))) {
        return Checker_grammarErrorOnNode(receiver, node, React_components_cannot_include_JSX_namespace_names);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarJsxExpression(receiver, node) {
    if (node.Expression !== undefined && IsCommaSequence(node.Expression)) {
        return Checker_grammarErrorOnNode(receiver, node.Expression, JSX_expressions_may_not_use_the_comma_operator_Did_you_mean_to_write_an_array);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarForInOrForOfStatement(receiver, forInOrOfStatement) {
    const asNode = forInOrOfStatement;
            ...
            if (IsInTopLevelContext(asNode)) {
                if (!Checker_hasParseDiagnostics(receiver, sourceFile)) {
                    if (!IsEffectiveExternalModule(sourceFile, receiver.compilerOptions)) {
                        DiagnosticsCollection_Add(receiver.diagnostics, createDiagnosticForNode(forInOrOfStatement.AwaitModifier, X_for_await_loops_are_only_allowed_at_the_top_level_of_a_file_when_that_file_is_a_module_but_this_file_has_no_imports_or_exports_Consider_adding_an_empty_export_to_make_this_file_a_module));
                    }
                    ...
                    if (isNodeModuleKind2) {
                        ...
                        if (sourceFileMetaData.ImpliedNodeFormat === ModuleKindCommonJS) {
                            DiagnosticsCollection_Add(receiver.diagnostics, createDiagnosticForNode(forInOrOfStatement.AwaitModifier, The_current_file_is_a_CommonJS_module_and_cannot_use_await_at_the_top_level));
                    ...
                    if (!skipTopLevelForAwaitError) {
                        DiagnosticsCollection_Add(receiver.diagnostics, createDiagnosticForNode(forInOrOfStatement.AwaitModifier, Top_level_for_await_loops_are_only_allowed_when_the_module_option_is_set_to_es2022_esnext_system_node16_node18_node20_nodenext_or_preserve_and_the_target_option_is_set_to_es2017_or_higher));
                    }
                }
            }
            else {
                // use of 'for-await-of' in non-async function
                if (!Checker_hasParseDiagnostics(receiver, sourceFile)) {
                    const diagnostic = createDiagnosticForNode(forInOrOfStatement.AwaitModifier, X_for_await_loops_are_only_allowed_within_async_functions_and_at_the_top_levels_of_modules);
    ...
    if (IsForOfStatement(asNode) && (forInOrOfStatement.Flags & NodeFlagsAwaitContext) === 0 && IsIdentifier(forInOrOfStatement.Initializer) && Node_Text(forInOrOfStatement.Initializer) === "async") {
        Checker_grammarErrorOnNode(receiver, forInOrOfStatement.Initializer, The_left_hand_side_of_a_for_of_statement_may_not_be_async);
        return false;
    }
    if (forInOrOfStatement.Initializer.Kind === KindVariableDeclarationList) {
        const variableList = AsVariableDeclarationList(forInOrOfStatement.Initializer);
 ...
 * }
 */
export function Checker_checkGrammarAccessor(receiver, accessor) {
    const asNode = accessor;
    ...
    if (body !== undefined) {
        ...
        if (asNode.Parent.Kind === KindTypeLiteral || asNode.Parent.Kind === KindInterfaceDeclaration) {
            return Checker_grammarErrorOnNode(receiver, body, An_implementation_cannot_be_declared_in_ambient_contexts);
        }
    }
    ...
    if (asNode.Kind === KindSetAccessor) {
        ...
        if (parameter.DotDotDotToken !== undefined) {
            return Checker_grammarErrorOnNode(receiver, parameter.DotDotDotToken, A_set_accessor_cannot_have_rest_parameter);
        }
        if (parameter.QuestionToken !== undefined) {
            return Checker_grammarErrorOnNode(receiver, parameter.QuestionToken, A_set_accessor_cannot_have_an_optional_parameter);
        }
        if (parameter.Initializer !== undefined) {
 ...
 * }
 */
export function Checker_doesAccessorHaveCorrectParameterCount(receiver, accessor) {
    const asNode = accessor;
    const funcData = Node_FunctionLikeData(asNode);
 ...
 * }
 */
export function Checker_checkGrammarTypeOperatorNode(receiver, node) {
    const asNode = node;
 ...
 * }
 */
export function Checker_checkGrammarForInvalidDynamicName(receiver, node, message) {
 ...
 * }
 */
export function Checker_isNonBindableDynamicName(receiver, node) {
    const asNode = node;
 ...
 * }
 */
export function Checker_checkGrammarMethod(receiver, node) {
    ...
    if (node.Kind === KindMethodDeclaration) {
        if (node.Parent.Kind === KindObjectLiteralExpression) {
            ...
            if (Checker_checkGrammarForInvalidQuestionMark(receiver, methodDecl.PostfixToken, An_object_member_cannot_be_declared_optional)) {
                return true;
            }
            if (Checker_checkGrammarForInvalidExclamationToken(receiver, methodDecl.PostfixToken, A_definite_assignment_assertion_is_not_permitted_in_this_context)) {
                return true;
            }
    ...
    if (IsClassLike(node.Parent)) {
        if ((node.Flags & NodeFlagsAmbient) !== 0) {
            return Checker_checkGrammarForInvalidDynamicName(receiver, Node_Name(node), A_computed_property_name_in_an_ambient_context_must_refer_to_an_expression_whose_type_is_a_literal_type_or_a_unique_symbol_type);
        }
        else if (node.Kind === KindMethodDeclaration && Node_Body(node) === undefined) {
            return Checker_checkGrammarForInvalidDynamicName(receiver, Node_Name(node), A_computed_property_name_in_a_method_overload_must_refer_to_an_expression_whose_type_is_a_literal_type_or_a_unique_symbol_type);
        }
    }
    else if (node.Parent.Kind === KindInterfaceDeclaration) {
        return Checker_checkGrammarForInvalidDynamicName(receiver, Node_Name(node), A_computed_property_name_in_an_interface_must_refer_to_an_expression_whose_type_is_a_literal_type_or_a_unique_symbol_type);
    }
    else if (node.Parent.Kind === KindTypeLiteral) {
        return Checker_checkGrammarForInvalidDynamicName(receiver, Node_Name(node), A_computed_property_name_in_a_type_literal_must_refer_to_an_expression_whose_type_is_a_literal_type_or_a_unique_symbol_type);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarBreakOrContinueStatement(receiver, node) {
 ...
 * }
 */
export function Checker_checkGrammarBindingElement(receiver, node) {
    const asNode = node;
    ...
    if (node.DotDotDotToken !== undefined && node.Initializer !== undefined) {
        return Checker_grammarErrorAtPos(receiver, asNode, Node_Pos(node.Initializer) - 1, 1, A_rest_element_cannot_have_an_initializer);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarVariableDeclaration(receiver, node) {
    const asNode = node;
    ...
    if (node.ExclamationToken !== undefined && (asNode.Parent.Parent.Kind !== KindVariableStatement || node.Type === undefined || node.Initializer !== undefined || (nodeFlags & NodeFlagsAmbient) !== 0)) {
        ...
        return Checker_grammarErrorOnNode(receiver, node.ExclamationToken, message);
    }
 ...
 * }
 */
export function Checker_checkGrammarForEsModuleMarkerInBindingName(receiver, name) {
 ...
 * }
 */
export function Checker_checkGrammarNameInLetOrConstDeclarations(receiver, name) {
 ...
 * }
 */
export function Checker_checkGrammarVariableDeclarationList(receiver, declarationList) {
    const asNode = declarationList;
 ...
 * }
 */
export function Checker_checkGrammarAwaitOrAwaitUsing(receiver, node) {
    let hasError = false;
 ...
 * }
 */
export function Checker_checkGrammarYieldExpression(receiver, node) {
    let hasError = false;
 ...
 * }
 */
export function Checker_checkGrammarForDisallowedBlockScopedVariableStatement(receiver, node) {
    const asNode = node;
    if (!Checker_containerAllowsBlockScopedVariable(receiver, asNode.Parent)) {
        const blockScopeKind = Checker_getCombinedNodeFlagsCached(receiver, node.DeclarationList) & NodeFlagsBlockScoped;
        if (blockScopeKind !== 0) {
            let keyword;
 ...
 * }
 */
export function Checker_containerAllowsBlockScopedVariable(receiver, parent) {
    switch (parent.Kind) {
 ...
 * }
 */
export function Checker_checkGrammarMetaProperty(receiver, node) {
    const asNode = node;
 ...
 * }
 */
export function Checker_checkGrammarConstructorTypeParameters(receiver, node) {
    const asNode = node;
 ...
 * }
 */
export function Checker_checkGrammarConstructorTypeAnnotation(receiver, node) {
    const t = node.Type;
    if (t !== undefined) {
        return Checker_grammarErrorOnNode(receiver, t, Type_annotation_cannot_appear_on_a_constructor_declaration);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarProperty(receiver, node) {
    ...
    if (IsClassLike(node.Parent)) {
        ...
        if (Checker_checkGrammarForInvalidDynamicName(receiver, propertyName, A_computed_property_name_in_a_class_property_declaration_must_have_a_simple_literal_type_or_a_unique_symbol_type)) {
            return true;
        }
        if (IsAutoAccessorPropertyDeclaration(node) && Checker_checkGrammarForInvalidQuestionMark(receiver, Node_PostfixToken(node), An_accessor_property_cannot_be_declared_optional)) {
            return true;
        }
    }
    else if (IsInterfaceDeclaration(node.Parent)) {
        if (Checker_checkGrammarForInvalidDynamicName(receiver, propertyName, A_computed_property_name_in_an_interface_must_refer_to_an_expression_whose_type_is_a_literal_type_or_a_unique_symbol_type)) {
            return true;
        }
        ...
        if (Checker_checkGrammarForInvalidDynamicName(receiver, Node_Name(node), A_computed_property_name_in_a_type_literal_must_refer_to_an_expression_whose_type_is_a_literal_type_or_a_unique_symbol_type)) {
            return true;
        }
        if (!IsPropertySignatureDeclaration(node)) {
            throw new globalThis.Error(`Unexpected node kind "${node.Kind}"`);
 ...
 * }
 */
export function Checker_checkAmbientInitializer(receiver, node) {
    ...
    if (initializer !== undefined) {
        const isInvalidInitializer = !(isInitializerStringOrNumberLiteralExpression(initializer) || Checker_isInitializerSimpleLiteralEnumReference(receiver, initializer) || initializer.Kind === KindTrueKeyword || initializer.Kind === KindFalseKeyword || isInitializerBigIntLiteralExpression(initializer));
 ...
 * }
 */
export function isInitializerStringOrNumberLiteralExpression(expr) {
    const asNode = expr;
 ...
 * }
 */
export function isInitializerBigIntLiteralExpression(expr) {
    const asNode = expr;
 ...
 * }
 */
export function Checker_isInitializerSimpleLiteralEnumReference(receiver, expr) {
    const asNode = expr;
    ...
    if (IsElementAccessExpression(asNode)) {
        ...
        return isInitializerStringOrNumberLiteralExpression(elementAccess.ArgumentExpression) && IsEntityNameExpression(elementAccess.Expression) && (Checker_checkExpressionCached(receiver, asNode).flags & TypeFlagsEnumLike) !== 0;
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_checkGrammarTopLevelElementForRequiredDeclareModifier(receiver, node) {
 ...
 * }
 */
export function Checker_checkGrammarTopLevelElementsForRequiredDeclareModifier(receiver, file) {
    const fileAsNode = file;
 ...
 * }
 */
export function Checker_checkGrammarSourceFile(receiver, node) {
    return (node.Flags & NodeFlagsAmbient) !== 0 && Checker_checkGrammarTopLevelElementsForRequiredDeclareModifier(receiver, node);
}
/**
 ...
 * }
 */
export function Checker_checkGrammarStatementInAmbientContext(receiver, node) {
    if ((node.Flags & NodeFlagsAmbient) !== 0) {
        ...
        if (node.Parent.Kind === KindBlock || node.Parent.Kind === KindModuleBlock || node.Parent.Kind === KindSourceFile) {
            const parentLinks = LinkStore_Get(receiver.nodeLinks, node.Parent);
 ...
 * }
 */
export function Checker_checkGrammarNumericLiteral(receiver, node) {
    ...
    Checker_addErrorOrSuggestion(receiver, false, createDiagnosticForNode(node, Numeric_literals_with_absolute_values_equal_to_2_53_or_greater_are_too_large_to_be_represented_accurately_as_integers));
}
/**
 ...
 * }
 */
export function Checker_checkGrammarBigIntLiteral(receiver, node) {
    const asNode = node;
 ...
 * }
 */
export function Checker_checkGrammarImportClause(receiver, node) {
    const asNode = node;
    switch (node.PhaseModifier) {
        case KindTypeKeyword:
            ...
            if (node.NamedBindings !== undefined && node.NamedBindings.Kind === KindNamedImports) {
                return Checker_checkGrammarTypeOnlyNamedImportsOrExports(receiver, node.NamedBindings);
            }
            break;
 ...
 * }
 */
export function Checker_checkGrammarTypeOnlyNamedImportsOrExports(receiver, namedBindings) {
    const nodeList = Node_ElementList(namedBindings);
    for (const specifier of nodeList.Nodes) {
        let specifierIsTypeOnly;
        let message;
 ...
 * }
 */
export function Checker_checkGrammarImportCallExpression(receiver, node) {
...
//# sourceMappingURL=grammarchecks.js.map