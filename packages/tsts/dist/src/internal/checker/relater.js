...
import { Cannot_assign_a_0_constructor_type_to_a_1_constructor_type, Cannot_assign_an_abstract_constructor_type_to_a_non_abstract_constructor_type, Class_0_incorrectly_implements_class_1_Did_you_mean_to_extend_1_and_inherit_its_members_as_a_subclass, Class_0_incorrectly_implements_interface_1, Conversion_of_type_0_to_type_1_may_be_a_mistake_because_neither_type_sufficiently_overlaps_with_the_other_If_this_was_intentional_convert_the_expression_to_unknown_first, Did_you_mean_to_call_this_expression, Did_you_mean_to_use_new_with_this_expression, Excessive_complexity_comparing_types_0_and_1, Excessive_stack_depth_comparing_types_0_and_1, Index_signature_for_type_0_is_missing_in_type_1, Its_element_type_0_is_not_a_valid_JSX_element, Its_instance_type_0_is_not_a_valid_JSX_element, Its_return_type_0_is_not_a_valid_JSX_element, Object_literal_may_only_specify_known_properties_and_0_does_not_exist_in_type_1, Object_literal_may_only_specify_known_properties_but_0_does_not_exist_in_type_1_Did_you_mean_to_write_2, Property_0_does_not_exist_on_type_1_Did_you_mean_2, Property_0_is_incompatible_with_index_signature, The_type_0_is_readonly_and_cannot_be_assigned_to_the_mutable_type_1, The_types_of_0_are_incompatible_between_these_types, The_types_returned_by_0_are_incompatible_between_these_types, Type_0_has_no_properties_in_common_with_type_1, Type_0_provides_no_match_for_the_signature_1, Types_of_property_0_are_incompatible, Value_of_type_0_has_no_properties_in_common_with_type_1_Did_you_mean_to_call_it, X_0_and_1_index_signatures_are_incompatible, X_0_index_signatures_are_incompatible, X_0_is_a_primitive_but_1_is_a_wrapper_object_Prefer_using_0_when_possible, Source_has_0_element_s_but_target_requires_1, Source_has_0_element_s_but_target_allows_only_1, Target_requires_0_element_s_but_source_may_have_fewer, Target_allows_only_0_element_s_but_source_may_have_more, Source_provides_no_match_for_required_element_at_position_0_in_target, Source_provides_no_match_for_variadic_element_at_position_0_in_target, Variadic_element_at_position_0_in_source_does_not_match_element_at_position_1_in_target, Type_at_position_0_in_source_is_not_compatible_with_type_at_position_1_in_target, Type_at_positions_0_through_1_in_source_is_not_compatible_with_type_at_position_2_in_target, Property_0_does_not_exist_on_type_1, Property_0_is_private_in_type_1_but_not_in_type_2, Property_0_is_missing_in_type_1_but_required_in_type_2, Property_0_is_optional_in_type_1_but_required_in_type_2, Types_have_separate_declarations_of_a_private_property_0, Property_0_is_protected_but_type_1_is_not_a_class_derived_from_2, Property_0_is_protected_in_type_1_but_public_in_type_2, The_Object_type_is_assignable_to_very_few_other_types_Did_you_mean_to_use_the_any_type_instead, The_intersection_0_was_reduced_to_never_because_property_1_has_conflicting_types_in_some_constituents, The_intersection_0_was_reduced_to_never_because_property_1_exists_in_multiple_constituents_and_is_private_in_some, This_type_parameter_might_need_an_extends_0_constraint, Type_0_is_not_comparable_to_type_1, Type_0_is_not_assignable_to_type_1, Type_0_is_not_assignable_to_type_1_Did_you_mean_2, Type_0_is_not_assignable_to_type_1_Two_different_types_with_this_name_exist_but_they_are_unrelated, Type_0_is_not_assignable_to_type_1_with_exactOptionalPropertyTypes_Colon_true_Consider_adding_undefined_to_the_types_of_the_target_s_properties, Type_0_is_missing_the_following_properties_from_type_1_Colon_2, Type_0_is_missing_the_following_properties_from_type_1_Colon_2_and_3_more, Property_0_in_type_1_refers_to_a_different_member_that_cannot_be_accessed_from_within_type_2, X_0_is_declared_here, X_0_is_assignable_to_the_constraint_of_type_1_but_1_could_be_instantiated_with_a_different_subtype_of_constraint_2, X_0_could_be_instantiated_with_an_arbitrary_type_which_could_be_unrelated_to_1, } from "../diagnostics/generated/messages.js";
...
import { Target_signature_provides_too_few_arguments_Expected_0_or_more_but_got_1, The_this_types_of_each_signature_are_incompatible, Types_of_parameters_0_and_1_are_incompatible, Signature_0_must_be_a_type_predicate, Call_signature_return_types_0_and_1_are_incompatible, Construct_signature_return_types_0_and_1_are_incompatible, Call_signatures_with_no_arguments_have_incompatible_return_types_0_and_1, Construct_signatures_with_no_arguments_have_incompatible_return_types_0_and_1, A_this_based_type_guard_is_not_compatible_with_a_parameter_based_type_guard, Type_predicate_0_is_not_assignable_to_1, Parameter_0_is_not_in_the_same_position_as_parameter_1, Property_0_is_missing_in_type_1, Each_declaration_of_0_1_differs_in_its_value_where_2_was_expected_but_3_was_given, One_value_of_0_1_is_the_string_2_and_the_other_is_assumed_to_be_an_unknown_numeric_value, Type_originates_at_this_import_A_namespace_style_import_cannot_be_called_or_constructed_and_will_cause_a_failure_at_runtime_Consider_using_a_default_import_or_import_require_here_instead, } from "../diagnostics/generated/messages.js";
...
import { Checker_getTypeOfParameter, Checker_getReturnTypeOfSignature, Checker_getNonCircularReturnTypeOfSignature, Checker_getTypeArguments, Checker_getMinTypeArgumentCount, Checker_fillMissingTypeArguments, Checker_getTypeReferenceArity, Checker_getRestTypeOfTupleType, Checker_getSingleCallSignature, Checker_getCanonicalSignature, Checker_instantiateSignatureInContextOf, Checker_instantiateSignatureEx, Checker_getConstraintOrUnknownFromTypeParameter, Checker_getDefaultOrUnknownFromTypeParameter, Checker_getConstraintFromTypeParameter, Checker_getTypeWithThisArgument, Checker_cloneTypeParameter, } from "./checker/signatures.js";
import { Checker_getIndexedAccessType } from "./checker/symbols.js";
import { Checker_createArrayType, Checker_createTupleType, Checker_createTupleTypeEx, Checker_getStringLiteralType, Checker_getNumberLiteralType, Checker_getUnionType, Checker_getUnionOrIntersectionType, Checker_getElementTypeOfArrayType, Checker_GetNonNullableType, Checker_getTypeFacts, Checker_getTypeFromTypeNode, Checker_instantiateType, } from "./checker/types.js";
 ...
 * )
 */
export const SignatureCheckModeNone = 0;
export const SignatureCheckModeBivariantCallback = 1 << 0;
export const SignatureCheckModeStrictCallback = 1 << 1;
export const SignatureCheckModeIgnoreReturnTypes = 1 << 2;
export const SignatureCheckModeStrictArity = 1 << 3;
export const SignatureCheckModeStrictTopSignature = 1 << 4;
export const SignatureCheckModeCallback = SignatureCheckModeBivariantCallback | SignatureCheckModeStrictCallback;
/**
 ...
 * )
 */
export const MinArgumentCountFlagsNone = 0;
export const MinArgumentCountFlagsStrongArityForUntypedJS = 1 << 0;
export const MinArgumentCountFlagsVoidIsNonOptional = 1 << 1;
/**
 ...
 * )
 */
export const IntersectionStateNone = 0;
export const IntersectionStateSource = 1 << 0; // Source type is a constituent of an outer intersection
export const IntersectionStateTarget = 1 << 1; // Target type is a constituent of an outer intersection
/**
 ...
 * )
 */
export const RecursionFlagsNone = 0;
export const RecursionFlagsSource = 1 << 0;
export const RecursionFlagsTarget = 1 << 1;
export const RecursionFlagsBoth = RecursionFlagsSource | RecursionFlagsTarget;
/**
 ...
 * )
 */
export const ExpandingFlagsNone = 0;
export const ExpandingFlagsSource = 1 << 0;
export const ExpandingFlagsTarget = 1 << 1;
export const ExpandingFlagsBoth = ExpandingFlagsSource | ExpandingFlagsTarget;
/**
 ...
 * )
 */
export const RelationComparisonResultNone = 0;
export const RelationComparisonResultSucceeded = 1 << 0;
export const RelationComparisonResultFailed = 1 << 1;
export const RelationComparisonResultReportsUnmeasurable = 1 << 3;
export const RelationComparisonResultReportsUnreliable = 1 << 4;
export const RelationComparisonResultComplexityOverflow = 1 << 5;
export const RelationComparisonResultStackDepthOverflow = 1 << 6;
export const RelationComparisonResultReportsMask = RelationComparisonResultReportsUnmeasurable | RelationComparisonResultReportsUnreliable;
export const RelationComparisonResultOverflow = RelationComparisonResultComplexityOverflow | RelationComparisonResultStackDepthOverflow;
/**
 ...
 * }
 */
export function asRecursionId(value) {
    return { value };
}
/**
 ...
 * }
 */
export function Relation_get(receiver, key) {
 ...
 * }
 */
export function Relation_set(receiver, key, result) {
    if (receiver.results === undefined) {
        receiver.results = new globalThis.Map();
    }
 ...
 * }
 */
export function Relation_size(receiver) {
    if (receiver.results === undefined) {
        return 0;
    }
 ...
 * }
 */
export function Checker_isTypeIdenticalTo(receiver, source, target) {
 ...
 * }
 */
export function Checker_compareTypesIdentical(receiver, source, target) {
 ...
 * }
 */
export function Checker_compareTypesAssignableSimple(receiver, source, target) {
 ...
 * }
 */
export function Checker_compareTypesAssignableWorker(receiver, source, target, reportErrors) {
    if (Checker_isTypeRelatedTo(receiver, source, target, receiver.assignableRelation)) {
        return TernaryTrue;
    }
    return TernaryFalse;
 ...
 * }
 */
export function Checker_compareTypesSubtypeOf(receiver, source, target) {
 ...
 * }
 */
export function Checker_isTypeAssignableTo(receiver, source, target) {
 ...
 * }
 */
export function Checker_isTypeSubtypeOf(receiver, source, target) {
 ...
 * }
 */
export function Checker_isTypeStrictSubtypeOf(receiver, source, target) {
 ...
 * }
 */
export function Checker_isTypeComparableTo(receiver, source, target) {
 ...
 * }
 */
export function Checker_areTypesComparable(receiver, type1, type2) {
 ...
 * }
 */
export function Checker_isTypeRelatedTo(receiver, source, target, relation) {
    if (isFreshLiteralType(source)) {
    ...
    if (relation !== receiver.identityRelation) {
        if ((relation === receiver.comparableRelation && (target.flags & TypeFlagsNever) === 0 && Checker_isSimpleTypeRelatedTo(receiver, target, source, relation, undefined)) ||
 ...
 * }
 */
export function Checker_isSimpleTypeRelatedTo(receiver, source, target, relation, errorReporter) {
 ...
 * }
 */
export function Checker_isEnumTypeRelatedTo(receiver, source, target, errorReporter) {
    ...
    const key = { sourceId: GetSymbolId(sourceSymbol), targetId: GetSymbolId(targetSymbol) };
    ...
    for (const sourceProperty of Checker_getPropertiesOfType(receiver, Checker_getTypeOfSymbol(receiver, sourceSymbol)) ?? []) {
        if ((sourceProperty.Flags & SymbolFlagsEnumMember) !== 0) {
            ...
            const sourceValue = Checker_getEnumMemberValue(receiver, GetDeclarationOfKind(sourceProperty, KindEnumMember));
            const targetValue = Checker_getEnumMemberValue(receiver, GetDeclarationOfKind(targetProperty, KindEnumMember));
 ...
 * }
 */
export function Checker_checkTypeAssignableTo(receiver, source, target, errorNode, headMessage) {
 ...
 * }
 */
export function Checker_checkTypeAssignableToEx(receiver, source, target, errorNode, headMessage, diagnosticOutput) {
 ...
 * }
 */
export function Checker_checkTypeComparableTo(receiver, source, target, errorNode, headMessage) {
 ...
 * }
 */
export function Checker_checkTypeRelatedTo(receiver, source, target, relation, errorNode) {
 ...
 * }
 */
export function Checker_checkTypeRelatedToEx(receiver, source, target, relation, errorNode, headMessage, diagnosticOutput) {
    const r = Checker_getRelater(receiver);
    r.relation = relation;
    r.errorNode = errorNode;
    r.relationCount = (16_000_000 - Relation_size(relation)) / 8;
    const result = Relater_isRelatedToEx(r, source, target, RecursionFlagsBoth, (errorNode !== undefined), headMessage, IntersectionStateNone);
    if (r.overflow) {
        const [id] = getRelationKey(source, target, IntersectionStateNone, relation === receiver.identityRelation, false);
        Relation_set(relation, id, (RelationComparisonResultFailed | (r.relationCount <= 0 ? RelationComparisonResultComplexityOverflow : RelationComparisonResultStackDepthOverflow)));
        if (receiver.tracer !== undefined) {
            Tracer_Instant(receiver.tracer, PhaseCheckTypes, "checkTypeRelatedTo_DepthLimit", new globalThis.Map([["sourceId", source.id], ["targetId", target.id], ["depth", r.sourceStack.length], ["targetDepth", r.targetStack.length]]));
        }
        ...
        if (headMessage !== undefined && errorNode !== undefined && result === TernaryFalse && source.symbol !== undefined && LinkStore_Has(receiver.exportTypeLinks, source.symbol)) {
            const links = LinkStore_Get(receiver.exportTypeLinks, source.symbol);
 ...
 * }
 */
export function createDiagnosticChainFromErrorChain(chain, errorNode, relatedInfo) {
 ...
 * }
 */
export function Checker_reportDiagnostic(receiver, diagnostic, diagnosticOutput) {
 ...
 * }
 */
export function Checker_checkTypeRelatedToAndOptionallyElaborate(receiver, source, target, relation, errorNode, expr, headMessage, diagnosticOutput) {
 ...
 * }
 */
export function Checker_elaborateError(receiver, node, source, target, relation, headMessage, diagnosticOutput) {
    if (node === undefined || Checker_isOrHasGenericConditional(receiver, target)) {
        return false;
    }
    if (Checker_elaborateDidYouMeanToCallOrConstruct(receiver, node, source, target, relation, SignatureKindConstruct, headMessage, diagnosticOutput) ||
 ...
 * }
 */
export function Checker_isOrHasGenericConditional(receiver, t) {
    return (t.flags & TypeFlagsConditional) !== 0 || ((t.flags & TypeFlagsIntersection) !== 0 && Type_Types(t).some((t) => Checker_isOrHasGenericConditional(receiver, t)));
}
/**
 ...
 * }
 */
export function Checker_elaborateDidYouMeanToCallOrConstruct(receiver, node, source, target, relation, kind, headMessage, diagnosticOutput) {
    if (Checker_getSignaturesOfType(receiver, source, kind).some((s) => {
 ...
 * }
 */
export function Checker_elaborateObjectLiteral(receiver, node, source, target, relation, diagnosticOutput) {
    if ((target.flags & (TypeFlagsPrimitive | TypeFlagsNever)) !== 0) {
        return false;
    }
    ...
    for (const prop of Node_Properties(node) ?? []) {
        ...
        if (IsSetAccessorDeclaration(prop) || IsGetAccessorDeclaration(prop) || IsMethodDeclaration(prop) || IsShorthandPropertyAssignment(prop)) {
            reportedError = (Checker_elaborateElement(receiver, source, target, relation, Node_Name(prop), undefined, nameType, undefined, undefined, diagnosticOutput) || reportedError);
        }
            ...
            reportedError = (Checker_elaborateElement(receiver, source, target, relation, Node_Name(prop), Node_Initializer(prop), nameType, message, undefined, diagnosticOutput) || reportedError);
        }
    }
    return reportedError;
}
 ...
 * }
 */
export function Checker_elaborateArrayLiteral(receiver, node, source, target, relation, diagnosticOutput) {
    if ((target.flags & (TypeFlagsPrimitive | TypeFlagsNever)) !== 0) {
        return false;
    }
    if (!Checker_isTupleLikeType(receiver, source)) {
        Checker_pushContextualType(receiver, node, target, false);
        source = Checker_checkArrayLiteral(receiver, node, (CheckModeContextual | CheckModeForceTuple));
    ...
    for (let i = 0; i < elements.length; i++) {
        ...
        const indexName = Number_String(i);
        ...
        const nameType = Checker_getNumberLiteralType(receiver, i);
        const checkNode = Checker_getEffectiveCheckNode(receiver, element);
        reportedError = (Checker_elaborateElement(receiver, source, target, relation, checkNode, checkNode, nameType, undefined, undefined, diagnosticOutput) || reportedError);
    }
    return reportedError;
}
/**
 ...
 * }
 */
export function Checker_elaborateElement(receiver, source, target, relation, prop, next, nameType, errorMessage, diagnosticFactory, diagnosticOutput) {
    ...
    const diags = [];
    let specificSource = sourcePropType;
    if (next !== undefined) {
 ...
 * }
 */
export function Checker_getBestMatchIndexedAccessTypeOrUndefined(receiver, source, target, nameType) {
    const idx = Checker_getIndexedAccessTypeOrUndefined(receiver, target, nameType, AccessFlagsNone, undefined, undefined);
    if (idx !== undefined) {
        return idx;
    }
    if ((target.flags & TypeFlagsUnion) !== 0) {
        const best = Checker_getBestMatchingType(receiver, source, target, (s, t) => Checker_compareTypesAssignableSimple(receiver, s, t));
        if (best !== undefined) {
 ...
 * }
 */
export function Checker_checkExpressionForMutableLocationWithContextualType(receiver, next, sourcePropType) {
 ...
 * }
 */
export function Checker_elaborateArrowFunction(receiver, node, source, target, relation, diagnosticOutput) {
    ...
    const targetReturn = Checker_getUnionType(receiver, targetSignatures.map((signature) => Checker_getReturnTypeOfSignature(receiver, signature)));
 ...
 * }
 */
export function Checker_isWeakType(receiver, t) {
    if ((t.flags & TypeFlagsObject) !== 0) {
        ...
        return signatures.length === 0 && indexInfos.length === 0 && properties.length > 0 && properties.every((p) => (p.Flags & SymbolFlagsOptional) !== 0);
    }
    if ((t.flags & TypeFlagsSubstitution) !== 0) {
        return Checker_isWeakType(receiver, Type_AsSubstitutionType(t).baseType);
    }
    if ((t.flags & TypeFlagsIntersection) !== 0) {
        return Type_Types(t).every((t2) => Checker_isWeakType(receiver, t2));
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_hasCommonProperties(receiver, source, target, isComparingJsxAttributes) {
 ...
 * }
 */
export function Checker_isKnownProperty(receiver, targetType, name, isComparingJsxAttributes) {
    if ((targetType.flags & TypeFlagsObject) !== 0) {
 ...
 * }
 */
export function isHyphenatedJsxName(name) {
 ...
 * }
 */
export function isExcessPropertyCheckTarget(t) {
    return ((t.flags & TypeFlagsObject) !== 0 && (t.objectFlags & ObjectFlagsObjectLiteralPatternWithComputedProperties) === 0) ||
        (t.flags & TypeFlagsNonPrimitive) !== 0 ||
 ...
 * }
 */
export function Checker_isDeeplyNestedType(receiver, t, stack, maxDepth) {
 ...
 * }
 */
export function Checker_getMappedTargetWithSymbol(receiver, t) {
    let cur = t;
    while (true) {
        if ((cur.objectFlags & ObjectFlagsInstantiatedMapped) === ObjectFlagsInstantiatedMapped) {
            const target = Checker_getModifiersTypeFromMappedType(receiver, cur);
            if (target !== undefined && (target.symbol !== undefined || ((target.flags & TypeFlagsIntersection) !== 0 && Type_Types(target).some((t2) => t2.symbol !== undefined)))) {
                cur = target;
                continue;
            }
        }
 ...
 * }
 */
export function Checker_hasMatchingRecursionIdentity(receiver, t, identity) {
    let cur = t;
    if ((cur.objectFlags & ObjectFlagsInstantiatedMapped) === ObjectFlagsInstantiatedMapped) {
        cur = Checker_getMappedTargetWithSymbol(receiver, cur);
    }
 ...
 * }
 */
export function getRecursionIdentity(t) {
    if ((t.flags & TypeFlagsObject) !== 0 && !isObjectOrArrayLiteralType(t)) {
 ...
 * }
 */
export function Checker_getBestMatchingType(receiver, source, target, isRelatedTo) {
 ...
 * }
 */
export function Checker_findMatchingTypeReferenceOrTypeAliasReference(receiver, source, unionTarget) {
 ...
 * }
 */
export function Checker_findBestTypeForInvokable(receiver, source, unionTarget, kind) {
    if (Checker_getSignaturesOfType(receiver, source, kind).length !== 0) {
        return Type_Types(unionTarget).find((t) => Checker_getSignaturesOfType(receiver, t, kind).length !== 0);
    }
    return undefined;
}
/**
 ...
 * }
 */
export function Checker_findMostOverlappyType(receiver, source, unionTarget) {
    let bestMatch;
    if ((source.flags & (TypeFlagsPrimitive | TypeFlagsInstantiablePrimitive)) === 0) {
        let matchingCount = 0;
        for (const target of Type_Types(unionTarget)) {
 ...
 * }
 */
export function Checker_findBestTypeForObjectLiteral(receiver, source, unionTarget) {
    if ((source.objectFlags & ObjectFlagsObjectLiteral) !== 0 && someType(unionTarget, (t) => Checker_isArrayLikeType(receiver, t))) {
        return Type_Types(unionTarget).find((t) => !Checker_isArrayLikeType(receiver, t));
    }
    return undefined;
}
/**
 ...
 * }
 */
export function Checker_shouldReportUnmatchedPropertyError(receiver, source, target) {
 ...
 * }
 */
export function Checker_getUnmatchedProperty(receiver, source, target, requireOptionalProperties, matchDiscriminantProperties) {
 ...
 * }
 */
export function Checker_getUnmatchedProperties(receiver, source, target, requireOptionalProperties, matchDiscriminantProperties) {
    const props = [];
 ...
 * }
 */
export function Checker_getUnmatchedPropertiesWorker(receiver, source, target, requireOptionalProperties, matchDiscriminantProperties, propsOut) {
 ...
 * }
 */
export function excludeProperties(properties, excludedProperties) {
 ...
 * }
 */
export function TypeDiscriminator_len(receiver) {
 ...
 * }
 */
export function TypeDiscriminator_name(receiver, index) {
 ...
 * }
 */
export function TypeDiscriminator_matches(receiver, index, t) {
 ...
 * }
 */
export function Checker_findMatchingDiscriminantType(receiver, source, target, isRelatedTo) {
    if ((target.flags & TypeFlagsUnion) !== 0 && (source.flags & (TypeFlagsIntersection | TypeFlagsObject)) !== 0) {
        ...
        if (discriminantProperties.length !== 0) {
            const discriminatorData = { c: receiver, props: discriminantProperties, isRelatedTo };
            const discriminator = {
                len: () => TypeDiscriminator_len(discriminatorData),
                name: (index) => TypeDiscriminator_name(discriminatorData, index),
                matches: (index, t) => TypeDiscriminator_matches(discriminatorData, index, t),
            };
 ...
 * }
 */
export function Checker_findDiscriminantProperties(receiver, sourceProperties, target) {
    const result = [];
 ...
 * }
 */
export function Checker_isDiscriminantProperty(receiver, t, name) {
    if (t !== undefined && (t.flags & TypeFlagsUnion) !== 0) {
        ...
        if (prop !== undefined && (prop.CheckFlags & CheckFlagsSyntheticProperty) !== 0) {
            if ((prop.CheckFlags & CheckFlagsIsDiscriminantComputed) === 0) {
                prop.CheckFlags = (prop.CheckFlags | CheckFlagsIsDiscriminantComputed);
                if ((prop.CheckFlags & CheckFlagsNonUniformAndLiteral) === CheckFlagsNonUniformAndLiteral && !Checker_isGenericType(receiver, Checker_getTypeOfSymbol(receiver, prop))) {
                    prop.CheckFlags = (prop.CheckFlags | CheckFlagsIsDiscriminant);
                }
            }
 ...
 * }
 */
export function Checker_getMatchingUnionConstituentForType(receiver, unionType, t) {
 ...
 * }
 */
export function Checker_getKeyPropertyName(receiver, t) {
 ...
 * }
 */
export function Checker_getConstituentTypeForKeyType(receiver, t, keyType) {
 ...
 * }
 */
export function Checker_computeKeyPropertyNameAndMap(receiver, t) {
 ...
 * }
 */
export function isObjectOrInstantiableNonPrimitive(t) {
    return (t.flags & (TypeFlagsObject | TypeFlagsInstantiableNonPrimitive)) !== 0;
}
/**
 ...
 * }
 */
export function Checker_getKeyPropertyCandidateName(receiver, types) {
 ...
 * }
 */
export function Checker_mapTypesByKeyProperty(receiver, types, keyPropertyName) {
    const typesByKey = new globalThis.Map();
    let count = 0;
    for (const t of types) {
        if ((t.flags & (TypeFlagsObject | TypeFlagsIntersection | TypeFlagsInstantiableNonPrimitive)) !== 0) {
 ...
 * }
 */
export function Checker_discriminateTypeByDiscriminableItems(receiver, target, discriminator) {
    const types = Type_Types(target);
    const include = new Array(types.length).fill(0);
 ...
 * }
 */
export function Checker_filterPrimitivesIfContainsNonPrimitive(receiver, unionType) {
 ...
 * }
 */
export function isNonPrimitiveType(t) {
    return (t.flags & TypeFlagsPrimitive) === 0;
}
/**
 ...
 * }
 */
export function Checker_getTypeNamesForErrorDisplay(receiver, left, right) {
    let leftStr;
 ...
 * }
 */
export function Checker_getTypeNameForErrorDisplay(receiver, t) {
 ...
 * }
 */
export function Checker_symbolValueDeclarationIsContextSensitive(receiver, symbol_) {
 ...
 * }
 */
export function Checker_typeCouldHaveTopLevelSingletonTypes(receiver, t) {
    if ((t.flags & TypeFlagsBoolean) !== 0) {
        return false;
    }
    if ((t.flags & TypeFlagsUnionOrIntersection) !== 0) {
        return Type_Types(t).some((t2) => Checker_typeCouldHaveTopLevelSingletonTypes(receiver, t2));
    }
    if ((t.flags & TypeFlagsInstantiable) !== 0) {
 ...
 * }
 */
export function Checker_getVariances(receiver, t) {
 ...
 * }
 */
export function Checker_getAliasVariances(receiver, symbol_) {
 ...
 * }
 */
export function Checker_getVariancesWorker(receiver, symbol_, typeParameters) {
    ...
    if (links.variances === undefined) {
        ...
        links.variances = [];
        const variances = new Array(typeParameters.length).fill(0);
        for (let i = 0; i < typeParameters.length; i++) {
            ...
            if ((modifiers & ModifierFlagsOut) !== 0) {
                ...
                if ((receiver.reliabilityFlags & RelationComparisonResultReportsUnmeasurable) !== 0) {
                    variance = (variance | VarianceFlagsUnmeasurable);
                }
                if ((receiver.reliabilityFlags & RelationComparisonResultReportsUnreliable) !== 0) {
                    variance = (variance | VarianceFlagsUnreliable);
                }
 ...
 * }
 */
export function Checker_createMarkerType(receiver, symbol_, source, target) {
 ...
 * }
 */
export function Checker_isMarkerType(receiver, t) {
 ...
 * }
 */
export function Checker_getTypeParameterModifiers(receiver, tp) {
    let flags = 0;
    if (tp.symbol !== undefined) {
        for (const d of tp.symbol.Declarations ?? []) {
            flags = (flags | Node_ModifierFlags(d));
        }
    }
 ...
 * }
 */
export function Checker_hasCovariantVoidArgument(receiver, typeArguments, variances) {
 ...
 * }
 */
export function Checker_isSignatureAssignableTo(receiver, source, target, ignoreReturnTypes) {
    return Checker_compareSignaturesRelated(receiver, source, target, ignoreReturnTypes ? SignatureCheckModeIgnoreReturnTypes : SignatureCheckModeNone, false, undefined, receiver.compareTypesAssignable, undefined) !== TernaryFalse;
}
/**
 ...
 * }
 */
export function Checker_compareSignaturesRelated(receiver, source, target, checkMode, reportErrors, errorReporter, compareTypes, reportUnreliableMarkers) {
    if (source === target) {
        return TernaryTrue;
    }
    ...
    for (let i = 0; i < paramCount; i++) {
        ...
        if (sourceType !== undefined && targetType !== undefined && (sourceType !== targetType || (checkMode & SignatureCheckModeStrictArity) !== 0)) {
            let sourceSig = undefined;
            let targetSig = undefined;
            ...
            let related = TernaryFalse;
            if (callbacks) {
                related = Checker_compareSignaturesRelated(receiver, targetSig, sourceSig, ((checkMode & SignatureCheckModeStrictArity) | (strictVariance ? SignatureCheckModeStrictCallback : SignatureCheckModeBivariantCallback)), reportErrors, errorReporter, compareTypes, reportUnreliableMarkers);
            }
            else {
                if ((checkMode & SignatureCheckModeCallback) === 0 && !strictVariance) {
            ...
            if (related !== TernaryFalse && (checkMode & SignatureCheckModeStrictArity) !== 0 && i >= Checker_getMinArgumentCount(receiver, src) && i < Checker_getMinArgumentCount(receiver, tgt) && compareTypes(sourceType, targetType, false) !== TernaryFalse) {
                related = TernaryFalse;
            }
            if (related === TernaryFalse) {
                if (reportErrors) {
    ...
    if ((checkMode & SignatureCheckModeIgnoreReturnTypes) === 0) {
        ...
        if (targetTypePredicate !== undefined) {
            ...
            if (sourceTypePredicate !== undefined) {
                result = (result & Checker_compareTypePredicateRelatedTo(receiver, sourceTypePredicate, targetTypePredicate, reportErrors, errorReporter, compareTypes));
            }
            else if (targetTypePredicate.kind === TypePredicateKindIdentifier || targetTypePredicate.kind === TypePredicateKindThis) {
                if (reportErrors) {
 ...
 * }
 */
export function Checker_compareTypePredicateRelatedTo(receiver, source, target, reportErrors, errorReporter, compareTypes) {
    if (source.kind !== target.kind) {
        if (reportErrors) {
 ...
 * }
 */
export function Checker_isTopSignature(receiver, s) {
    if (s.typeParameters === undefined || s.typeParameters.length === 0) {
        if ((s.thisParameter === undefined || IsTypeAny(Checker_getTypeOfParameter(receiver, s.thisParameter))) && s.parameters.length === 1 && signatureHasRestParameter(s)) {
            ...
            return ((restType.flags & (TypeFlagsAny | TypeFlagsNever)) !== 0 && (Checker_getReturnTypeOfSignature(receiver, s).flags & TypeFlagsAnyOrUnknown) !== 0);
        }
    }
    return false;
}
 ...
 * }
 */
export function Checker_getParameterCount(receiver, signature) {
 ...
 * }
 */
export function Checker_getMinArgumentCount(receiver, signature) {
 ...
 * }
 */
export function Checker_getMinArgumentCountEx(receiver, signature, flags) {
    ...
    if (voidIsNonOptional !== 0 || signature.resolvedMinArgumentCount === -1) {
        ...
        if (signatureHasRestParameter(signature)) {
            ...
            if (isTupleType(restType)) {
                const tupleType = Type_TargetTupleType(restType);
                const firstOptionalIndex = FindIndex(tupleType.elementInfos, (info) => (info.flags & ElementFlagsRequired) === 0);
        ...
        for (let i = minArgumentCount - 1; i >= 0; i--) {
            ...
            if (!someType(t, (t) => (t.flags & TypeFlagsVoid) !== 0)) {
                break;
            }
            minArgumentCount = i;
        }
 ...
 * }
 */
export function Checker_hasEffectiveRestParameter(receiver, signature) {
    if (signatureHasRestParameter(signature)) {
        const restType = Checker_getTypeOfSymbol(receiver, signature.parameters[signature.parameters.length - 1]);
        return (!isTupleType(restType) || (Type_TargetTupleType(restType).combinedFlags & ElementFlagsVariable) !== 0);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_getTypeAtPosition(receiver, signature, pos) {
 ...
 * }
 */
export function Checker_tryGetTypeAtPosition(receiver, signature, pos) {
 ...
 * }
 */
export function Checker_getRestOrAnyTypeAtPosition(receiver, source, pos) {
    const restType = Checker_getRestTypeAtPosition(receiver, source, pos, false);
 ...
 * }
 */
export function Checker_getRestTypeAtPosition(receiver, source, pos, readonly) {
    ...
    const infos = new Array(length);
    for (let i = 0; i < length; i++) {
        let flags;
        if (restType === undefined || i < length - 1) {
            types[i] = Checker_getTypeAtPosition(receiver, source, i + pos);
            flags = (i + pos < minArgumentCount ? ElementFlagsRequired : ElementFlagsOptional);
        }
        else {
            types[i] = restType;
            flags = ElementFlagsVariadic;
        }
        infos[i] = { flags, labeledDeclaration: Checker_getNameableDeclarationAtPosition(receiver, source, i + pos) };
    }
 ...
 * }
 */
export function Checker_getNameableDeclarationAtPosition(receiver, signature, pos) {
    const paramCount = signature.parameters.length - (signatureHasRestParameter(signature) ? 1 : 0);
    if (pos < paramCount) {
 ...
 * }
 */
export function Checker_isValidDeclarationForTupleLabel(receiver, d) {
    return (IsNamedTupleMember(d) || IsParameterDeclaration(d) && d.data.Name() !== undefined && IsIdentifier(d.data.Name()));
}
/**
 ...
 * }
 */
export function Checker_getNonArrayRestType(receiver, signature) {
 ...
 * }
 */
export function Checker_getEffectiveRestType(receiver, signature) {
    if (signatureHasRestParameter(signature)) {
        const restType = Checker_getTypeOfSymbol(receiver, signature.parameters[signature.parameters.length - 1]);
        if (!isTupleType(restType)) {
            if (IsTypeAny(restType)) {
 ...
 * }
 */
export function Checker_sliceTupleType(receiver, t, index, endSkipCount) {
    ...
    return Checker_createTupleTypeEx(receiver, Checker_getTypeArguments(receiver, t).slice(index, endIndex), target.elementInfos.slice(index, endIndex), false);
}
/**
 ...
 * }
 */
export function Checker_getKnownKeysOfTupleType(receiver, t) {
    const fixedLength = Type_TargetTupleType(t).fixedLength;
    const keys = new Array(fixedLength + 1);
 ...
 * }
 */
export function Checker_getRestArrayTypeOfTupleType(receiver, t) {
 ...
 * }
 */
export function Checker_getThisTypeOfSignature(receiver, signature) {
 ...
 * }
 */
export function Checker_isInstantiatedGenericParameter(receiver, signature, pos) {
    if (signature.target === undefined) {
        return false;
    }
    const t = Checker_tryGetTypeAtPosition(receiver, signature.target, pos);
    return (t !== undefined && Checker_isGenericType(receiver, t));
}
/**
 ...
 * }
 */
export function Checker_getParameterNameAtPosition(receiver, signature, pos) {
    const paramCount = signature.parameters.length - (signatureHasRestParameter(signature) ? 1 : 0);
    if (pos < paramCount) {
        return signature.parameters[pos].Name;
    }
 ...
 * }
 */
export function Checker_getTupleElementLabel(receiver, elementInfo, restSymbol, index) {
 ...
 * }
 */
export function Checker_getTupleElementLabelFromBindingElement(receiver, node, index, elementFlags) {
 ...
 * }
 */
export function Checker_getTypePredicateOfSignature(receiver, sig) {
 ...
 * }
 */
export function Checker_getUnionOrIntersectionTypePredicate(receiver, signatures, isUnion) {
    let last = undefined;
    const types = [];
 ...
 * }
 */
export function Checker_typePredicateKindsMatch(receiver, a, b) {
    return a.kind === b.kind && a.parameterIndex === b.parameterIndex;
}
/**
 ...
 * }
 */
export function Checker_createTypePredicateFromTypePredicateNode(receiver, node, signature) {
    ...
    const index = FindIndex(signature.parameters, (p) => p.Name === name);
 ...
 * }
 */
export function Checker_instantiateTypePredicate(receiver, predicate, mapper) {
 ...
 * }
 */
export function Checker_newTypePredicate(receiver, kind, parameterName, parameterIndex, t) {
    return { kind, parameterIndex, parameterName, t };
}
/**
 ...
 * }
 */
export function Checker_isResolvingReturnTypeOfSignature(receiver, signature) {
    if (signature.composite !== undefined && signature.composite.signatures.some((s) => Checker_isResolvingReturnTypeOfSignature(receiver, s))) {
        return true;
    }
    return (signature.resolvedReturnType === undefined && Checker_findResolutionCycleStartIndex(receiver, signature, TypeSystemPropertyNameResolvedReturnType) >= 0);
}
/**
 ...
 * }
 */
export function Checker_findMatchingSignatures(receiver, signatureLists, signature, listIndex) {
    if (signature.typeParameters !== undefined && signature.typeParameters.length !== 0) {
        if (listIndex > 0) {
            return undefined;
        }
        for (let i = 1; i < signatureLists.length; i++) {
            if (Checker_findMatchingSignature(receiver, signatureLists[i], signature, false, false, false) === undefined) {
                return undefined;
            }
        }
        return [signature];
    ...
    for (let i = 0; i < signatureLists.length; i++) {
        ...
        if (i === listIndex) {
            ...
            match = Checker_findMatchingSignature(receiver, signatureLists[i], signature, false, false, true);
            if (match === undefined) {
                match = Checker_findMatchingSignature(receiver, signatureLists[i], signature, true, false, true);
            }
        }
        if (match === undefined) {
            return undefined;
 ...
 * }
 */
export function Checker_findMatchingSignature(receiver, signatureList, signature, partialMatch, ignoreThisTypes, ignoreReturnTypes) {
    const compareTypes = partialMatch
        ? (s, t) => Checker_compareTypesSubtypeOf(receiver, s, t)
        : (s, t) => Checker_compareTypesIdentical(receiver, s, t);
 ...
 * }
 */
export function Checker_compareSignaturesIdentical(receiver, source, target, partialMatch, ignoreThisTypes, ignoreReturnTypes, compareTypes) {
    if (source === target) {
        return TernaryTrue;
    }
    ...
    if (tgtTpLen !== 0) {
        ...
        src = Checker_instantiateSignatureEx(receiver, source, mapper, true);
    }
    let result = TernaryTrue;
    if (!ignoreThisTypes) {
        const sourceThisType = Checker_getThisTypeOfSignature(receiver, src);
    ...
    if (!ignoreReturnTypes) {
        ...
        if (sourceTypePredicate !== undefined || targetTypePredicate !== undefined) {
            result = (result & Checker_compareTypePredicatesIdentical(receiver, sourceTypePredicate, targetTypePredicate, compareTypes));
        }
        else {
            result = (result & compareTypes(Checker_getReturnTypeOfSignature(receiver, src), Checker_getReturnTypeOfSignature(receiver, target)));
        }
    }
    return result;
}
 ...
 * }
 */
export function Checker_isMatchingSignature(receiver, source, target, partialMatch) {
 ...
 * }
 */
export function Checker_compareTypeParametersIdentical(receiver, sourceParams, targetParams) {
 ...
 * }
 */
export function Checker_compareTypePredicatesIdentical(receiver, source, target, compareTypes) {
 ...
 * }
 */
export function Checker_getEffectiveConstraintOfIntersection(receiver, types, targetIsUnion) {
    ...
    if (constraints !== undefined && (targetIsUnion || hasDisjointDomainType)) {
        ...
        return Checker_getNormalizedType(receiver, Checker_getIntersectionTypeEx(receiver, constraints, IntersectionFlagsNoConstraintReduction, undefined), false);
    }
    return undefined;
}
/**
 ...
 * }
 */
export function Checker_templateLiteralTypesDefinitelyUnrelated(receiver, source, target) {
 ...
 * }
 */
export function Checker_isTypeMatchedByTemplateLiteralType(receiver, source, target, compareTypes) {
 ...
 * }
 */
export function Checker_inferTypesFromTemplateLiteralType(receiver, source, target) {
 ...
 * }
 */
export function Checker_inferFromLiteralPartsToTemplateLiteral(receiver, sourceTexts, sourceTypes, target) {
    ...
    const addMatch = (s, p) => {
        ...
        if (s === seg) {
            ...
            const matchTexts = new Array(s - seg + 1);
 ...
 * }
 */
export function Checker_getStringLikeTypeForType(receiver, t) {
    if ((t.flags & (TypeFlagsAny | TypeFlagsStringLike)) !== 0) {
        return t;
    }
 ...
 * }
 */
export function Checker_isValidTypeForTemplateLiteralPlaceholder(receiver, source, target, compareTypes) {
    if ((target.flags & TypeFlagsIntersection) !== 0) {
        return Every(Type_Types(target), (t) => t === receiver.emptyTypeLiteralType || Checker_isValidTypeForTemplateLiteralPlaceholder(receiver, source, t, compareTypes));
    }
    if ((target.flags & TypeFlagsString) !== 0 || compareTypes(source, target, false) !== TernaryFalse) {
        return true;
    }
    if ((source.flags & TypeFlagsStringLiteral) !== 0) {
        const value = getStringLiteralValue(source);
        return (((target.flags & TypeFlagsNumber) !== 0 && isValidNumberString(value, false)) ||
            ((target.flags & TypeFlagsBigInt) !== 0 && isValidBigIntString(value, false)) ||
    ...
    if ((source.flags & TypeFlagsTemplateLiteral) !== 0) {
        ...
        return (texts.length === 2 && texts[0] === "" && texts[1] === "" && compareTypes(Type_AsTemplateLiteralType(source).types[0], target, false) !== TernaryFalse);
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_isMemberOfStringMapping(receiver, source, target) {
    ...
    if ((target.flags & TypeFlagsStringMapping) !== 0) {
        ...
        return (mapped === source && Checker_isMemberOfStringMapping(receiver, source, inner));
    }
    return false;
}
/**
 ...
 * }
 */
export function Checker_applyTargetStringMappingToSource(receiver, source, target) {
 ...
 * }
 */
export function visibilityToString(flags) {
 ...
 * }
 */
export function Checker_getRelater(receiver) {
    ...
    if (r === undefined) {
        r = {
            ...
            relatedInfo: [],
            maybeKeys: [],
            maybeKeysSet: NewSetWithSizeHint(0),
            sourceStack: [],
            targetStack: [],
            maybeCount: 0,
            sourceDepth: 0,
 ...
 * }
 */
export function Checker_putRelater(receiver, r) {
 ...
 * }
 */
export function Relater_isRelatedToSimple(receiver, source, target) {
 ...
 * }
 */
export function Relater_isRelatedToWorker(receiver, source, target, reportErrors) {
 ...
 * }
 */
export function Relater_isRelatedTo(receiver, source, target, recursionFlags, reportErrors) {
 ...
 * }
 */
export function Relater_isRelatedToEx(receiver, originalSource, originalTarget, recursionFlags, reportErrors, headMessage, intersectionState) {
    if (originalSource === originalTarget) {
        return TernaryTrue;
    }
    const reportError = (message, ...args) => Relater_reportError(receiver, message, ...args);
    if ((originalSource.flags & TypeFlagsObject) !== 0 && (originalTarget.flags & TypeFlagsPrimitive) !== 0) {
        if ((receiver.relation === receiver.c.comparableRelation && (originalTarget.flags & TypeFlagsNever) === 0 && Checker_isSimpleTypeRelatedTo(receiver.c, originalTarget, originalSource, receiver.relation, undefined)) ||
    ...
    if ((receiver.relation === receiver.c.comparableRelation && (target.flags & TypeFlagsNever) === 0 && Checker_isSimpleTypeRelatedTo(receiver.c, target, source, receiver.relation, undefined)) ||
    ...
    if ((source.flags & TypeFlagsStructuredOrInstantiable) !== 0 || (target.flags & TypeFlagsStructuredOrInstantiable) !== 0) {
        ...
        const isPerformingCommonPropertyChecks = (receiver.relation !== receiver.c.comparableRelation || isUnitType(source)) &&
            (intersectionState & IntersectionStateTarget) === 0 &&
        ...
        if (isPerformingCommonPropertyChecks && !Checker_hasCommonProperties(receiver.c, source, target, isComparingJsxAttributes)) {
            if (reportErrors) {
                ...
                if ((calls.length > 0 && Relater_isRelatedTo(receiver, Checker_getReturnTypeOfSignature(receiver.c, calls[0]), target, RecursionFlagsSource, false) !== TernaryFalse) ||
        ...
        Relater_traceUnionsOrIntersectionsTooLarge(receiver, source, target);
        const skipCaching = ((source.flags & TypeFlagsUnion) !== 0 && Type_Types(source).length < 4 && (target.flags & TypeFlagsUnion) === 0) ||
 ...
 * }
 */
export function Relater_hasExcessProperties(receiver, source, target, reportErrors) {
    if (!isExcessPropertyCheckTarget(target) || (!receiver.c.noImplicitAny && (target.objectFlags & ObjectFlagsJSLiteral) !== 0)) {
        return false;
    }
    const isComparingJsxAttributes = (source.objectFlags & ObjectFlagsJsxAttributes) !== 0;
    if ((receiver.relation === receiver.c.assignableRelation || receiver.relation === receiver.c.comparableRelation) &&
            ...
            if (!Checker_isKnownProperty(receiver.c, reducedTarget, prop.Name, isComparingJsxAttributes)) {
                if (reportErrors) {
                    ...
                    if (IsJsxAttributes(receiver.errorNode) || IsJsxOpeningLikeElement(receiver.errorNode) || (errorNodeParent !== undefined && IsJsxOpeningLikeElement(errorNodeParent))) {
                        ...
                        let objectLiteralDeclaration = undefined;
 ...
 * }
 */
export function Checker_getTypeOfPropertyInTypes(receiver, types, name) {
    let propTypes = [];
    for (const t of types ?? []) {
 ...
 * }
 */
export function Checker_getTypeOfPropertyInType(receiver, t, name) {
    t = Checker_getApparentType(receiver, t);
    let prop;
    if ((t.flags & TypeFlagsUnionOrIntersection) !== 0) {
        prop = Checker_getPropertyOfUnionOrIntersectionType(receiver, t, name, false);
    }
    else {
 ...
 * }
 */
export function shouldCheckAsExcessProperty(prop, container) {
 ...
 * }
 */
export function isIgnoredJsxProperty(source, sourceProp) {
    return (source.objectFlags & ObjectFlagsJsxAttributes) !== 0 && isHyphenatedJsxName(sourceProp.Name);
}
/**
 ...
 * }
 */
export function Checker_isTypeSubsetOf(receiver, source, target) {
 ...
 * }
 */
export function Checker_isTypeSubsetOfUnion(receiver, source, target) {
    if ((source.flags & TypeFlagsUnion) !== 0) {
 ...
 * }
 */
export function Relater_unionOrIntersectionRelatedTo(receiver, source, target, reportErrors, intersectionState) {
    if ((source.flags & TypeFlagsUnion) !== 0) {
        if ((target.flags & TypeFlagsUnion) !== 0) {
    ...
    if (receiver.relation === receiver.c.comparableRelation && (target.flags & TypeFlagsPrimitive) !== 0) {
        const constraints = SameMap(Type_Types(source), (t) => {
            if ((t.flags & TypeFlagsInstantiable) !== 0) {
 ...
 * }
 */
export function Relater_someTypeRelatedToType(receiver, source, target, reportErrors, intersectionState) {
 ...
 * }
 */
export function Relater_eachTypeRelatedToType(receiver, source, target, reportErrors, intersectionState) {
    let result = TernaryTrue;
    const sourceTypes = Type_Types(source);
 ...
 * }
 */
export function Relater_getUndefinedStrippedTargetIfNeeded(receiver, source, target) {
 ...
 * }
 */
export function Relater_typeRelatedToSomeType(receiver, source, target, reportErrors, intersectionState) {
    ...
    if (reportErrors) {
        const bestMatchingType = Checker_getBestMatchingType(receiver.c, source, target, (s, t) => Relater_isRelatedToSimple(receiver, s, t));
 ...
 * }
 */
export function Relater_typeRelatedToEachType(receiver, source, target, reportErrors, intersectionState) {
    let result = TernaryTrue;
    const targetTypes = Type_Types(target);
 ...
 * }
 */
export function Relater_eachTypeRelatedToSomeType(receiver, source, target) {
    let result = TernaryTrue;
    const sourceTypes = Type_Types(source);
 ...
 * }
 */
export function Relater_recursiveTypeRelatedTo(receiver, source, target, reportErrors, intersectionState, recursionFlags) {
    ...
    if (entry !== RelationComparisonResultNone) {
        if (reportErrors && (entry & RelationComparisonResultFailed) !== 0 && (entry & RelationComparisonResultOverflow) === 0) {
            ...
            receiver.c.reliabilityFlags = (receiver.c.reliabilityFlags | (entry & (RelationComparisonResultReportsUnmeasurable | RelationComparisonResultReportsUnreliable)));
            if (reportErrors && (entry & RelationComparisonResultOverflow) !== 0) {
    ...
    if ((recursionFlags & RecursionFlagsSource) !== 0) {
        ...
        if ((receiver.expandingFlags & ExpandingFlagsSource) === 0 && Checker_isDeeplyNestedType(receiver.c, source, receiver.sourceStack, 3)) {
            receiver.expandingFlags = (receiver.expandingFlags | ExpandingFlagsSource);
        }
    }
    if ((recursionFlags & RecursionFlagsTarget) !== 0) {
        ...
        if ((receiver.expandingFlags & ExpandingFlagsTarget) === 0 && Checker_isDeeplyNestedType(receiver.c, target, receiver.targetStack, 3)) {
            receiver.expandingFlags = (receiver.expandingFlags | ExpandingFlagsTarget);
        }
    }
    const saveReliabilityFlags = receiver.c.reliabilityFlags;
    receiver.c.reliabilityFlags = RelationComparisonResultNone;
    let result;
    ...
    receiver.c.reliabilityFlags = (receiver.c.reliabilityFlags | saveReliabilityFlags);
    if ((recursionFlags & RecursionFlagsSource) !== 0) {
    ...
    if (result !== TernaryFalse) {
        ...
        Relation_set(receiver.relation, id, (RelationComparisonResultFailed | propagatingVarianceFlags));
 ...
 * }
 */
export function Relater_resetMaybeStack(receiver, maybeStart, propagatingVarianceFlags, markAllAsSucceeded) {
    for (let i = maybeStart; i < receiver.maybeKeys.length; i++) {
        Set_Delete(receiver.maybeKeysSet, receiver.maybeKeys[i]);
        if (markAllAsSucceeded) {
            Relation_set(receiver.relation, receiver.maybeKeys[i], (RelationComparisonResultSucceeded | propagatingVarianceFlags));
            receiver.relationCount--;
        }
    }
 ...
 * }
 */
export function Relater_getErrorState(receiver) {
    return { errorChain: receiver.errorChain, relatedInfo: receiver.relatedInfo };
}
/**
 ...
 * }
 */
export function Relater_restoreErrorState(receiver, e) {
 ...
 * }
 */
export function Relater_structuredTypeRelatedTo(receiver, source, target, reportErrors, intersectionState) {
    ...
    if (receiver.relation !== receiver.c.identityRelation) {
        if (result === TernaryFalse && ((source.flags & TypeFlagsIntersection) !== 0 || ((source.flags & TypeFlagsTypeParameter) !== 0 && (target.flags & TypeFlagsUnion) !== 0))) {
            ...
            if (constraint !== undefined && everyType(constraint, (constraintType) => constraintType !== source)) {
        ...
        if (result !== TernaryFalse &&
            ...
            result = (result & Relater_propertiesRelatedTo(receiver, source, target, reportErrors, { M: new globalThis.Map() }, false, IntersectionStateNone));
            if (result !== TernaryFalse && isObjectLiteralType(source) && (source.objectFlags & ObjectFlagsFreshLiteral) !== 0) {
                result = (result & Relater_indexSignaturesRelatedTo(receiver, source, target, false, reportErrors, IntersectionStateNone));
            }
        }
        else if (result !== TernaryFalse &&
            ...
            result = (result & Relater_propertiesRelatedTo(receiver, source, target, reportErrors, { M: new globalThis.Map() }, true, intersectionState));
        }
    }
    if (result !== TernaryFalse) {
 ...
 * }
 */
export function Relater_isSourceIntersectionNeedingExtraCheck(receiver, source, target) {
    return ((source.flags & TypeFlagsIntersection) !== 0 &&
        (Checker_getApparentType(receiver.c, source).flags & TypeFlagsStructuredType) !== 0 &&
        !Type_Types(source).some((t) => t === target || (t.objectFlags & ObjectFlagsNonInferrableType) !== 0));
}
/**
 ...
 * }
 */
export function Relater_structuredTypeRelatedToWorker(receiver, source, target, reportErrors, intersectionState) {
    let result = TernaryFalse;
    let varianceCheckFailed = false;
    let originalErrorChain;
    const saveErrorState = Relater_getErrorState(receiver);
    const c = receiver.c;
    const relateVariances = (sourceTypeArguments, targetTypeArguments, variances, varianceIntersectionState) => {
        ...
        if (Some(variances, (v) => (v & VarianceFlagsAllowsStructuralFallback) !== 0)) {
        ...
        if (variances.length !== 0 && !allowStructuralFallback) {
            if (varianceCheckFailed && !(reportErrors && Some(variances, (v) => (v & VarianceFlagsVarianceMask) === VarianceFlagsInvariant))) {
                return [TernaryFalse, true];
            }
    ...
    if (receiver.relation === c.identityRelation) {
        if ((source.flags & TypeFlagsUnionOrIntersection) !== 0) {
            ...
            if (result !== TernaryFalse) {
                result = (result & Relater_eachTypeRelatedToSomeType(receiver, target, source));
            }
            return result;
        }
        if ((source.flags & TypeFlagsIndex) !== 0) {
        ...
        if ((source.flags & TypeFlagsIndexedAccess) !== 0) {
            ...
            if (result !== TernaryFalse) {
                result = (result & Relater_isRelatedTo(receiver, Type_AsIndexedAccessType(source).indexType, Type_AsIndexedAccessType(target).indexType, RecursionFlagsBoth, false));
                if (result !== TernaryFalse) {
                    return result;
                }
            }
            ...
            if (sourceConditional.root.isDistributive === targetConditional.root.isDistributive) {
                ...
                if (result !== TernaryFalse) {
                    result = (result & Relater_isRelatedTo(receiver, sourceConditional.extendsType, targetConditional.extendsType, RecursionFlagsBoth, false));
                    if (result !== TernaryFalse) {
                        result = (result & Relater_isRelatedTo(receiver, Checker_getTrueTypeFromConditionalType(c, source), Checker_getTrueTypeFromConditionalType(c, target), RecursionFlagsBoth, false));
                        if (result !== TernaryFalse) {
                            result = (result & Relater_isRelatedTo(receiver, Checker_getFalseTypeFromConditionalType(c, source), Checker_getFalseTypeFromConditionalType(c, target), RecursionFlagsBoth, false));
                            if (result !== TernaryFalse) {
                                return result;
                            }
                        }
            ...
            if (result !== TernaryFalse) {
                result = (result & Relater_isRelatedTo(receiver, Type_AsSubstitutionType(source).constraint, Type_AsSubstitutionType(target).constraint, RecursionFlagsBoth, false));
                if (result !== TernaryFalse) {
                    return result;
                }
            }
            ...
            if (slices.Equal(sourceTemplate.texts, targetTemplate.texts)) {
                ...
                for (let index = 0; index < sourceTemplate.types.length; index++) {
                    result = (result & Relater_isRelatedTo(receiver, sourceTemplate.types[index], targetTemplate.types[index], RecursionFlagsBoth, false));
                    if (result === TernaryFalse) {
                        return result;
                    }
                }
    ...
    if ((target.flags & TypeFlagsTypeParameter) !== 0) {
        ...
        if (receiver.relation === c.comparableRelation && (source.flags & TypeFlagsTypeParameter) !== 0) {
            ...
            if (constraint !== undefined && someType(constraint, (constraintType) => (constraintType.flags & TypeFlagsTypeParameter) !== 0)) {
        ...
        if ((source.flags & TypeFlagsIndexedAccess) !== 0) {
            ...
            if (result !== TernaryFalse) {
                result = (result & Relater_isRelatedTo(receiver, Type_AsIndexedAccessType(source).indexType, Type_AsIndexedAccessType(target).indexType, RecursionFlagsBoth, reportErrors));
            }
            if (result !== TernaryFalse) {
                return result;
            }
        ...
        if (isTupleType(targetType)) {
            ...
            if (constraint !== undefined) {
                if (Relater_isRelatedTo(receiver, source, Checker_getIndexTypeEx(c, constraint, (targetIndex.indexFlags | IndexFlagsNoReducibleCheck)), RecursionFlagsTarget, reportErrors) === TernaryTrue) {
                    return TernaryTrue;
                }
            }
        ...
        const targetConditional = Type_AsConditionalType(target);
        if ((targetConditional.root.inferTypeParameters ?? []).length === 0 &&
            ...
            if (result !== TernaryFalse) {
                if (skipFalse) {
                    result = (result & TernaryTrue);
                }
                else {
                    result = (result & Relater_isRelatedToEx(receiver, source, Checker_getFalseTypeFromConditionalType(c, target), RecursionFlagsTarget, false, undefined, intersectionState));
                }
                if (result !== TernaryFalse) {
                    return result;
                }
        ...
        if (Checker_isTypeMatchedByTemplateLiteralType(c, source, Type_AsTemplateLiteralType(target), (s, t, errors) => Relater_isRelatedToWorker(receiver, s, t, errors))) {
            return TernaryTrue;
        }
    }
        ...
        if ((modifiers & MappedTypeModifiersExcludeOptional) === 0) {
            ...
            if (!Checker_isGenericMappedType(c, source)) {
                ...
                if ((includeOptional && filteredByApplicability !== undefined && (filteredByApplicability.flags & TypeFlagsNever) === 0) || (!includeOptional && Relater_isRelatedTo(receiver, targetKeys, sourceKeys, RecursionFlagsBoth, false) !== TernaryFalse)) {
                    ...
                    const nonNullComponent = Checker_extractTypesOfKind(c, targetTemplateType, ~TypeFlagsNullable);
    ...
    if ((source.flags & TypeFlagsTypeVariable) !== 0) {
        ...
        if ((target.flags & TypeFlagsConditional) !== 0) {
            ...
            if (sourceParams.length !== 0) {
                const context = Checker_newInferenceContext(c, sourceParams, undefined, InferenceFlagsNone, (s, t, errors) => Relater_isRelatedToWorker(receiver, s, t, errors));
            ...
            if (Checker_isTypeIdenticalTo(c, sourceExtends, targetConditional.extendsType) &&
                ...
                if (result !== TernaryFalse) {
                    result = (result & Relater_isRelatedTo(receiver, Checker_getFalseTypeFromConditionalType(c, source), Checker_getFalseTypeFromConditionalType(c, target), RecursionFlagsBoth, reportErrors));
                }
                if (result !== TernaryFalse) {
                    return result;
                }
        ...
        else if (Checker_isArrayType(c, target) &&
            ((Checker_isReadonlyArrayType(c, target) && everyType(source, (type_) => Checker_isArrayOrTupleType(c, type_))) || everyType(source, isMutableTupleType))) {
            if (receiver.relation !== c.identityRelation) {
        ...
        else if ((receiver.relation === c.subtypeRelation || receiver.relation === c.strictSubtypeRelation) &&
        ...
        if ((source.flags & (TypeFlagsObject | TypeFlagsIntersection)) !== 0 && (target.flags & TypeFlagsObject) !== 0) {
            ...
            result = Relater_propertiesRelatedTo(receiver, source, target, reportStructuralErrors, NewSetWithSizeHint(0), false, intersectionState);
            if (result !== TernaryFalse) {
                result = (result & Relater_signaturesRelatedTo(receiver, source, target, SignatureKindCall, reportStructuralErrors, intersectionState));
                if (result !== TernaryFalse) {
                    result = (result & Relater_signaturesRelatedTo(receiver, source, target, SignatureKindConstruct, reportStructuralErrors, intersectionState));
                    if (result !== TernaryFalse) {
                        result = (result & Relater_indexSignaturesRelatedTo(receiver, source, target, sourceIsPrimitive, reportStructuralErrors, intersectionState));
                    }
                }
            }
            if (result !== TernaryFalse) {
        ...
        if ((source.flags & (TypeFlagsObject | TypeFlagsIntersection)) !== 0 && (target.flags & TypeFlagsUnion) !== 0) {
            const objectOnlyTarget = Checker_extractTypesOfKind(c, target, (TypeFlagsObject | TypeFlagsIntersection | TypeFlagsSubstitution));
            if ((objectOnlyTarget.flags & TypeFlagsUnion) !== 0) {
 ...
 * }
 */
export function Relater_typeArgumentsRelatedTo(receiver, sources, targets, variances, reportErrors, intersectionState) {
    ...
    let result = TernaryTrue;
    for (let i = 0; i < length; i++) {
        let varianceFlags = VarianceFlagsCovariant;
        ...
        if (variance !== VarianceFlagsIndependent) {
            ...
            if ((varianceFlags & VarianceFlagsUnmeasurable) !== 0) {
                ...
                if (variance === VarianceFlagsCovariant) {
                    ...
                    related = Relater_isRelatedToEx(receiver, s, t, RecursionFlagsBoth, reportErrors, undefined, intersectionState);
                    if (related !== TernaryFalse) {
                        related = (related & Relater_isRelatedToEx(receiver, t, s, RecursionFlagsBoth, reportErrors, undefined, intersectionState));
                    }
                }
            }
            if (related === TernaryFalse) {
 ...
 * }
 */
export function Relater_mappedTypeRelatedTo(receiver, source, target, reportErrors) {
    const modifiersRelated = receiver.relation === receiver.c.comparableRelation ||
    ...
    if (modifiersRelated) {
        ...
        const sourceConstraint = Checker_instantiateType(receiver.c, Checker_getConstraintTypeFromMappedType(receiver.c, source), Checker_getCombinedMappedTypeOptionality(receiver.c, source) < 0 ? receiver.c.reportUnmeasurableMapper : receiver.c.reportUnreliableMapper);
        ...
        if (result !== TernaryFalse) {
            ...
            if (Checker_instantiateType(receiver.c, Checker_getNameTypeFromMappedType(receiver.c, source), mapper) === Checker_instantiateType(receiver.c, Checker_getNameTypeFromMappedType(receiver.c, target), mapper)) {
                return (result & Relater_isRelatedTo(receiver, Checker_instantiateType(receiver.c, Checker_getTemplateTypeFromMappedType(receiver.c, source), mapper), Checker_getTemplateTypeFromMappedType(receiver.c, target), RecursionFlagsBoth, reportErrors));
            }
        }
    }
    return TernaryFalse;
 ...
 * }
 */
export function Relater_typeRelatedToDiscriminatedType(receiver, source, target) {
    ...
    for (const sourceProperty of sourcePropertiesFiltered) {
        numCombinations = (numCombinations * countTypes(Checker_getNonMissingTypeOfSymbol(receiver.c, sourceProperty)));
        if (numCombinations > 25) {
            if (receiver.c.tracer !== undefined) {
                Tracer_Instant(receiver.c.tracer, PhaseCheckTypes, "typeRelatedToDiscriminatedType_DepthLimit", new globalThis.Map([
                    ["sourceId", source.id],
                    ["targetId", target.id],
    ...
    const sourceDiscriminantTypes = new globalThis.Array(sourcePropertiesFiltered.length);
    const excludedProperties = NewSetWithSizeHint(0);
    ...
    const discriminantCombinations = new globalThis.Array(numCombinations);
    for (let i = 0; i < numCombinations; i++) {
        const combination = new globalThis.Array(sourceDiscriminantTypes.length);
        let n = i;
    ...
    for (const combination of discriminantCombinations) {
        ...
        targetLoop: for (const t of Type_Types(target)) {
            for (let i = 0; i < sourcePropertiesFiltered.length; i++) {
                ...
                const related = Relater_propertyRelatedTo(receiver, source, target, sourceProperty, targetProperty, () => combination[i], false, IntersectionStateNone, receiver.c.strictNullChecks || receiver.relation === receiver.c.comparableRelation);
                if (related === TernaryFalse) {
                    continue targetLoop;
                }
            }
    ...
    for (const t of matchingTypes) {
        result = (result & Relater_propertiesRelatedTo(receiver, source, t, false, excludedProperties, false, IntersectionStateNone));
        if (result !== TernaryFalse) {
            result = (result & Relater_signaturesRelatedTo(receiver, source, t, SignatureKindCall, false, IntersectionStateNone));
            if (result !== TernaryFalse) {
                result = (result & Relater_signaturesRelatedTo(receiver, source, t, SignatureKindConstruct, false, IntersectionStateNone));
                if (result !== TernaryFalse && !(isTupleType(source) && isTupleType(t))) {
                    result = (result & Relater_indexSignaturesRelatedTo(receiver, source, t, false, false, IntersectionStateNone));
                }
            }
        }
        if (result === TernaryFalse) {
 ...
 * }
 */
export function Relater_propertiesRelatedTo(receiver, source, target, reportErrors, excludedProperties, optionalsOnly, intersectionState) {
    if (receiver.relation === receiver.c.identityRelation) {
    ...
    if (isTupleType(target)) {
        ...
        if (Checker_isArrayOrTupleType(receiver.c, source)) {
            ...
            const targetStartCount = getStartElementCount(targetTupleType, ElementFlagsNonRest);
            const targetEndCount = getEndElementCount(targetTupleType, ElementFlagsNonRest);
            ...
            for (let sourcePosition = 0; sourcePosition < sourceArity; sourcePosition++) {
                ...
                let targetFlags = ElementFlagsNone;
                if (targetPosition >= 0) {
    ...
    const requireOptionalProperties = (receiver.relation === receiver.c.subtypeRelation || receiver.relation === receiver.c.strictSubtypeRelation) &&
    ...
    for (const targetProp of excludeProperties(properties, excludedProperties)) {
        ...
        if ((targetProp.Flags & SymbolFlagsPrototype) === 0 && (!numericNamesOnly || isNumericLiteralName(name) || name === "length") && (!optionalsOnly || (targetProp.Flags & SymbolFlagsOptional) !== 0)) {
            ...
            if (sourceProp !== undefined && sourceProp !== targetProp) {
                const related = Relater_propertyRelatedTo(receiver, source, target, sourceProp, targetProp, (sym) => Checker_getNonMissingTypeOfSymbol(receiver.c, sym), reportErrors, intersectionState, receiver.relation === receiver.c.comparableRelation);
                if (related === TernaryFalse) {
                    return TernaryFalse;
                }
                result = (result & related);
 ...
 * }
 */
export function Relater_propertyRelatedTo(receiver, source, target, sourceProp, targetProp, getTypeOfSourceProperty, reportErrors, intersectionState, skipOptional) {
    ...
    if ((sourcePropFlags & ModifierFlagsPrivate) !== 0 || (targetPropFlags & ModifierFlagsPrivate) !== 0) {
        if (sourceProp.ValueDeclaration !== targetProp.ValueDeclaration) {
            if (reportErrors) {
                if ((sourcePropFlags & ModifierFlagsPrivate) !== 0 && (targetPropFlags & ModifierFlagsPrivate) !== 0) {
                    ...
                    Relater_reportError(receiver, Property_0_is_private_in_type_1_but_not_in_type_2, Checker_symbolToString(receiver.c, targetProp), Checker_TypeToString(receiver.c, (sourcePropFlags & ModifierFlagsPrivate) !== 0 ? source : target), Checker_TypeToString(receiver.c, (sourcePropFlags & ModifierFlagsPrivate) !== 0 ? target : source));
                }
            }
            return TernaryFalse;
        }
        ...
        if (!Checker_isValidOverrideOf(receiver.c, sourceProp, targetProp)) {
            if (reportErrors) {
                ...
                Relater_reportError(receiver, Property_0_is_protected_but_type_1_is_not_a_class_derived_from_2, Checker_symbolToString(receiver.c, targetProp), Checker_TypeToString(receiver.c, sourceType), Checker_TypeToString(receiver.c, targetType));
            }
            return TernaryFalse;
        }
    }
        ...
        if (reportErrors) {
            Relater_reportError(receiver, Property_0_is_protected_in_type_1_but_public_in_type_2, Checker_symbolToString(receiver.c, targetProp), Checker_TypeToString(receiver.c, source), Checker_TypeToString(receiver.c, target));
        }
        return TernaryFalse;
    }
    ...
    if (!skipOptional && (sourceProp.Flags & SymbolFlagsOptional) !== 0 && (targetProp.Flags & SymbolFlagsClassMember) !== 0 && (targetProp.Flags & SymbolFlagsOptional) === 0) {
        if (reportErrors) {
            Relater_reportError(receiver, Property_0_is_optional_in_type_1_but_required_in_type_2, Checker_symbolToString(receiver.c, targetProp), Checker_TypeToString(receiver.c, source), Checker_TypeToString(receiver.c, target));
        }
        return TernaryFalse;
    }
    return related;
 ...
 * }
 */
export function Relater_isPropertySymbolTypeRelated(receiver, sourceProp, targetProp, getTypeOfSourceProperty, reportErrors, intersectionState) {
 ...
 * }
 */
export function Relater_reportUnmatchedProperty(receiver, source, target, unmatchedProperty, requireOptionalProperties) {
    if (unmatchedProperty.ValueDeclaration !== undefined &&
        ...
        if (Checker_getPropertyOfType(receiver.c, source, symbolTableKey) !== undefined) {
            Relater_reportError(receiver, Property_0_in_type_1_refers_to_a_different_member_that_cannot_be_accessed_from_within_type_2, privateIdentifierDescription, Checker_symbolToString(receiver.c, source.symbol), Checker_symbolToString(receiver.c, target.symbol));
            return;
        }
    }
    ...
    if (props.length === 1) {
        ...
        const [sourceType, targetType] = Checker_getTypeNamesForErrorDisplay(receiver.c, source, target);
        if (props.length > 5) {
            const propNames = props.slice(0, 4).map((prop) => Checker_symbolToString(receiver.c, prop)).join(", ");
            ...
            const propNames = props.map((prop) => Checker_symbolToString(receiver.c, prop)).join(", ");
 ...
 * }
 */
export function Relater_tryElaborateArrayLikeErrors(receiver, source, target, reportErrors) {
    if (isTupleType(source)) {
 ...
 * }
 */
export function Relater_tryElaborateErrorsForPrimitivesAndObjects(receiver, source, target) {
    if ((source === receiver.c.globalStringType && target === receiver.c.stringType) ||
 ...
 * }
 */
export function Relater_propertiesIdenticalTo(receiver, source, target, excludedProperties) {
    if ((source.flags & TypeFlagsObject) === 0 || (target.flags & TypeFlagsObject) === 0) {
        return TernaryFalse;
    }
    ...
    for (const sourceProp of sourceProperties) {
        ...
        const related = Checker_compareProperties(receiver.c, sourceProp, targetProp, (s, t) => Relater_isRelatedToSimple(receiver, s, t));
        if (related === TernaryFalse) {
            return TernaryFalse;
        }
        result = (result & related);
 ...
 * }
 */
export function Relater_signaturesRelatedTo(receiver, source, target, kind, reportErrors, intersectionState) {
    if (receiver.relation === receiver.c.identityRelation) {
    ...
    let result = TernaryTrue;
    if ((((source.objectFlags & ObjectFlagsInstantiated) !== 0 && (target.objectFlags & ObjectFlagsInstantiated) !== 0 && source.symbol === target.symbol) ||
        ...
        targetLoop: for (const t of targetSignatures) {
            const saveErrorState = Relater_getErrorState(receiver);
 ...
 * }
 */
export function Relater_constructorVisibilitiesAreCompatible(receiver, sourceSignature, targetSignature, reportErrors) {
 ...
 * }
 */
export function Relater_signatureRelatedTo(receiver, source, target, erase, reportErrors, intersectionState) {
    let checkMode = SignatureCheckModeNone;
    ...
    const isRelatedToWorker = (sourceType, targetType, reportWorkerErrors) => {
    ...
    return Checker_compareSignaturesRelated(receiver.c, sourceSignature, targetSignature, checkMode, reportErrors, (message, ...args) => Relater_reportError(receiver, message, ...args), isRelatedToWorker, receiver.c.reportUnreliableMapper);
}
/**
 ...
 * }
 */
export function Relater_signaturesIdenticalTo(receiver, source, target, kind) {
    const sourceSignatures = Checker_getSignaturesOfType(receiver.c, source, kind);
    const targetSignatures = Checker_getSignaturesOfType(receiver.c, target, kind);
    ...
    for (let i = 0; i < sourceSignatures.length; i++) {
        const related = Checker_compareSignaturesIdentical(receiver.c, sourceSignatures[i], targetSignatures[i], false, false, false, (s, t) => Relater_isRelatedToSimple(receiver, s, t));
        if (related === 0) {
            return TernaryFalse;
        }
        result = (result & related);
 ...
 * }
 */
export function Relater_indexSignaturesRelatedTo(receiver, source, target, sourceIsPrimitive, reportErrors, intersectionState) {
    if (receiver.relation === receiver.c.identityRelation) {
    ...
    const targetHasStringIndex = indexInfos.some((info) => info.keyType === receiver.c.stringType);
    let result = TernaryTrue;
 ...
 * }
 */
export function Relater_typeRelatedToIndexInfo(receiver, source, targetInfo, reportErrors, intersectionState) {
 ...
 * }
 */
export function Checker_isObjectTypeWithInferableIndex(receiver, t) {
    if ((t.flags & TypeFlagsIntersection) !== 0) {
        return Every(Type_Types(t), (ti) => Checker_isObjectTypeWithInferableIndex(receiver, ti));
    }
 ...
 * }
 */
export function Relater_membersRelatedToIndexInfo(receiver, source, targetInfo, reportErrors, intersectionState) {
    let result = TernaryTrue;
    ...
    for (const prop of props) {
        ...
        if (Checker_isApplicableIndexType(receiver.c, Checker_getLiteralTypeFromProperty(receiver.c, prop, TypeFlagsStringOrNumberLiteralOrUnique, false), keyType)) {
            ...
            const t = receiver.c.exactOptionalPropertyTypes || (propType.flags & TypeFlagsUndefined) !== 0 || keyType === receiver.c.numberType || (prop.Flags & SymbolFlagsOptional) === 0
                ? propType
 ...
 * }
 */
export function Relater_indexInfoRelatedTo(receiver, sourceInfo, targetInfo, reportErrors, intersectionState) {
 ...
 * }
 */
export function Relater_indexSignaturesIdenticalTo(receiver, source, target) {
 ...
 * }
 */
export function Relater_reportErrorResults(receiver, originalSource, originalTarget, source, target, headMessage) {
    ...
    if ((source.flags & TypeFlagsObject) !== 0 && (target.flags & TypeFlagsPrimitive) !== 0) {
        ...
        if (!Checker_isErrorType(receiver.c, intrinsicAttributes) &&
        ...
        let prop = Find(Checker_getPropertiesOfUnionOrIntersectionType(receiver.c, originalTarget), (candidate) => Checker_isDiscriminantWithNeverType(receiver.c, candidate));
        if (prop === undefined) {
 ...
 * }
 */
export function Relater_reportRelationError(receiver, message, source, target) {
    const [sourceType, targetType] = Checker_getTypeNamesForErrorDisplay(receiver.c, source, target);
 ...
 * }
 */
export function Relater_reportError(receiver, message, ...args) {
 ...
 * }
 */
export function Relater_chainArgsMatch(receiver, ...args) {
 ...
 * }
 */
export function getPropertyNameArg(arg) {
    const s = arg;
 ...
 * }
 */
export function Checker_isTypeDerivedFrom(receiver, source, target) {
    if ((source.flags & TypeFlagsUnion) !== 0) {
        return Type_Types(source).every((t) => Checker_isTypeDerivedFrom(receiver, t, target));
    }
    if ((target.flags & TypeFlagsUnion) !== 0) {
        return Type_Types(target).some((t) => Checker_isTypeDerivedFrom(receiver, source, t));
    }
    if ((source.flags & TypeFlagsIntersection) !== 0) {
        return Type_Types(source).some((t) => Checker_isTypeDerivedFrom(receiver, t, target));
    }
 ...
 * }
 */
export function Checker_isDistributionDependent(receiver, root) {
 ...
 * }
 */
export function Relater_traceUnionsOrIntersectionsTooLarge(receiver, source, target) {
    // tracing not implemented in TSTS port
}
//# sourceMappingURL=relater.js.map