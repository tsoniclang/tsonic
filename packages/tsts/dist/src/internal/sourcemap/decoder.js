...
const byteLenOf = (s) => utf8Encoder.encode(s).length;
const byteAtOf = (s, i) => utf8Encoder.encode(s)[i];
/**
 ...
 * }
 */
export function Mapping_Equals(receiver, other) {
    const m = receiver;
    const o = other;
 ...
 * }
 */
export function Mapping_IsSourceMapping(receiver) {
    const m = receiver;
    return m.SourceIndex !== MissingSource &&
        m.SourceLine !== MissingLineOrColumn &&
        m.SourceCharacter !== MissingUTF16Column;
 ...
 * )
 */
export const MissingSource = -1;
export const MissingName = -1;
export const MissingLineOrColumn = -1;
export const MissingUTF16Column = -1;
/**
 ...
 * }
 */
export function MappingsDecoder_MappingsString(receiver) {
    const d = receiver;
    return d.mappings;
}
/**
 ...
 * }
 */
export function MappingsDecoder_Pos(receiver) {
    const d = receiver;
    return d.pos;
}
/**
 ...
 * }
 */
export function MappingsDecoder_Error(receiver) {
    const d = receiver;
    return d.error;
}
/**
 ...
 * }
 */
export function MappingsDecoder_State(receiver) {
    const d = receiver;
 ...
 * }
 */
export function MappingsDecoder_Values(receiver) {
    const d = receiver;
    return (yield_) => {
 ...
 * }
 */
export function MappingsDecoder_Next(receiver) {
    const d = receiver;
    while (!d.done && d.pos < byteLenOf(d.mappings)) {
        const ch = byteAtOf(d.mappings, d.pos);
        if (ch === 0x3b /* ';' */) {
            // new line
            d.generatedLine++;
            d.generatedCharacter = 0;
 ...
 * }
 */
export function MappingsDecoder_captureMapping(receiver, hasSource, hasName) {
    const d = receiver;
    const mapping = Arena_New(d.mappingArena);
    mapping.GeneratedLine = d.generatedLine;
    mapping.GeneratedCharacter = d.generatedCharacter;
 ...
 * }
 */
export function MappingsDecoder_stopIterating(receiver) {
    const d = receiver;
    d.done = true;
 ...
 * }
 */
export function MappingsDecoder_setError(receiver, err) {
    const d = receiver;
 ...
 * }
 */
export function MappingsDecoder_setErrorAndStopIterating(receiver, err) {
    const d = receiver;
 ...
 * }
 */
export function MappingsDecoder_hasReportedError(receiver) {
    const d = receiver;
 ...
 * }
 */
export function MappingsDecoder_isSourceMappingSegmentEnd(receiver) {
    const d = receiver;
 ...
 * }
 */
export function MappingsDecoder_base64VLQFormatDecode(receiver) {
    const d = receiver;
    let moreDigits = true;
    let shiftCount = 0;
    let value = 0;
    for (; moreDigits; d.pos++) {
        ...
        // 6 digit number
        const currentByte = base64FormatDecode(byteAtOf(d.mappings, d.pos));
        if (currentByte === -1) {
 ...
 * }
 */
export function base64FormatDecode(ch) {
