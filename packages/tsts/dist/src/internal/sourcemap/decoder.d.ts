 ...
 * }
 */
export declare function Mapping_Equals(receiver: GoPtr<Mapping>, other: GoPtr<Mapping>): bool;
/**
 ...
 * }
 */
export declare function Mapping_IsSourceMapping(receiver: GoPtr<Mapping>): bool;
/**
 ...
 * )
 */
export declare const MissingSource: SourceIndex;
export declare const MissingName: NameIndex;
export declare const MissingLineOrColumn: int;
export declare const MissingUTF16Column: UTF16Offset;
/**
 ...
 * }
 */
export declare function DecodeMappings(mappings: string): GoPtr<MappingsDecoder>;
/**
 ...
 * }
 */
export declare function MappingsDecoder_MappingsString(receiver: GoPtr<MappingsDecoder>): string;
/**
 ...
 * }
 */
export declare function MappingsDecoder_Pos(receiver: GoPtr<MappingsDecoder>): int;
/**
 ...
 * }
 */
export declare function MappingsDecoder_Error(receiver: GoPtr<MappingsDecoder>): GoError;
/**
 ...
 * }
 */
export declare function MappingsDecoder_State(receiver: GoPtr<MappingsDecoder>): GoPtr<Mapping>;
/**
 ...
 * }
 */
export declare function MappingsDecoder_Values(receiver: GoPtr<MappingsDecoder>): GoSeq<GoPtr<Mapping>>;
/**
 ...
 * }
 */
export declare function MappingsDecoder_Next(receiver: GoPtr<MappingsDecoder>): [GoPtr<Mapping>, bool];
/**
 ...
 * }
 */
export declare function MappingsDecoder_captureMapping(receiver: GoPtr<MappingsDecoder>, hasSource: bool, hasName: bool): GoPtr<Mapping>;
/**
 ...
 * }
 */
export declare function MappingsDecoder_stopIterating(receiver: GoPtr<MappingsDecoder>): [GoPtr<Mapping>, bool];
/**
 ...
 * }
 */
export declare function MappingsDecoder_setError(receiver: GoPtr<MappingsDecoder>, err: string): void;
/**
 ...
 * }
 */
export declare function MappingsDecoder_setErrorAndStopIterating(receiver: GoPtr<MappingsDecoder>, err: string): [GoPtr<Mapping>, bool];
/**
 ...
 * }
 */
export declare function MappingsDecoder_hasReportedError(receiver: GoPtr<MappingsDecoder>): bool;
/**
 ...
 * }
 */
export declare function MappingsDecoder_isSourceMappingSegmentEnd(receiver: GoPtr<MappingsDecoder>): bool;
/**
 ...
 * }
 */
export declare function MappingsDecoder_base64VLQFormatDecode(receiver: GoPtr<MappingsDecoder>): int;
/**
 ...
 * }
 */
export declare function base64FormatDecode(ch: byte): int;
