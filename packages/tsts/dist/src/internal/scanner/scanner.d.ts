 ...
 * )
 */
export declare const unicodeESNextIdentifierStart: GoSlice<GoRune>;
export declare const unicodeESNextIdentifierPart: GoSlice<GoRune>;
/**
 ...
 * }
 */
export declare function cleared<K extends GoComparable, V, M extends GoMap<K, V> | undefined>(m: M): M;
/**
 ...
 * }
 */
export declare function isUnicodeIdentifierStart(ch: GoRune): bool;
/**
 ...
 * }
 */
export declare function isUnicodeIdentifierPart(ch: GoRune): bool;
/**
 ...
 * }
 */
export declare function isInUnicodeRanges(cp: GoRune, ranges: GoSlice<GoRune>): bool;
/**
 ...
 * }()
 */
export declare const tokenToText: GoMap<Kind, string>;
/**
