 ...
 * )
 */
export const surr1 = 0xd800;
export const surr2 = 0xdc00;
export const surr3 = 0xe000;
export const surrSelf = 0x10000;
/**
 ...
 * }
 */
export function codePointIsHighSurrogate(r) {
    return surr1 <= r && r < surr2;
}
/**
 ...
 * }
 */
export function codePointIsLowSurrogate(r) {
    return surr2 <= r && r < surr3;
}
/**
 ...
 * }
 */
export function surrogatePairToCodepoint(r1, r2) {
    return ((r1 - surr1) << 10) | (r2 - surr2 + surrSelf);
}
/**
 ...
 * }
 */
export function encodeSurrogate(r) {
 ...
 * }
 */
export function decodeClassAtomRune(s) {
 ...
 * }
 */
export function GetSourceTextOfNodeFromSourceFile(sourceFile, node, includeTrivia) {
 ...
 * }
 */
export function GetTextOfNodeFromSourceText(sourceText, node, includeTrivia) {
...
export function GetTextOfNode(node) {
    return GetSourceTextOfNodeFromSourceFile(GetSourceFileOfNode(node), node, false);
}
/**
 ...
 * }
 */
export function DeclarationNameToString(name) {
 ...
 * }
 */
export function IsIdentifierText(name, languageVariant) {
 ...
 * }
 */
export function IsIntrinsicJsxName(name) {
    const nameBytes = utf8Encoder.encode(name);
    const b0 = nameBytes.length !== 0 ? nameBytes[0] : 0;
