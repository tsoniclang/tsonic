...
import { CommentDirectiveKindExpectError, CommentDirectiveKindIgnore, Node_Body, Node_EagerJSDoc, Node_JSDoc, Node_Statements, Node_TagName, Node_Type, NodeFactory_NewCommentRange, SourceFile_ECMALineMap, SourceFile_Text, } from "../ast/ast.js";
...
import { KindAmpersandAmpersandEqualsToken, KindAmpersandAmpersandToken, KindAmpersandEqualsToken, KindAmpersandToken, KindAsteriskAsteriskEqualsToken, KindAsteriskAsteriskToken, KindAsteriskEqualsToken, KindAsteriskToken, KindAtToken, KindBacktickToken, KindBarBarEqualsToken, KindBarBarToken, KindBarEqualsToken, KindBarToken, KindBigIntLiteral, KindCaretEqualsToken, KindCaretToken, KindCloseBraceToken, KindCloseBracketToken, KindCloseParenToken, KindColonToken, KindCommaToken, KindConflictMarkerTrivia, KindDotDotDotToken, KindDotToken, KindEqualsEqualsEqualsToken, KindEqualsEqualsToken, KindEqualsGreaterThanToken, KindEqualsToken, KindEndOfFile, KindExclamationEqualsEqualsToken, KindExclamationEqualsToken, KindExclamationToken, KindGreaterThanEqualsToken, KindGreaterThanGreaterThanEqualsToken, KindGreaterThanGreaterThanGreaterThanEqualsToken, KindGreaterThanGreaterThanGreaterThanToken, KindGreaterThanGreaterThanToken, KindGreaterThanToken, KindHashToken, KindIdentifier, KindJSDocCommentTextToken, KindJsxText, KindJsxTextAllWhiteSpaces, KindLessThanEqualsToken, KindLessThanLessThanEqualsToken, KindLessThanLessThanToken, KindLessThanSlashToken, KindLessThanToken, KindMinusEqualsToken, KindMinusMinusToken, KindMinusToken, KindMultiLineCommentTrivia, KindNewLineTrivia, KindNonTextFileMarkerTrivia, KindNoSubstitutionTemplateLiteral, KindNumericLiteral, KindOpenBraceToken, KindOpenBracketToken, KindOpenParenToken, KindPercentEqualsToken, KindPercentToken, KindPlusEqualsToken, KindPlusPlusToken, KindPlusToken, KindPrivateIdentifier, KindQuestionDotToken, KindQuestionQuestionEqualsToken, KindQuestionQuestionToken, KindQuestionToken, KindRegularExpressionLiteral, KindSemicolonToken, KindSingleLineCommentTrivia, KindSlashEqualsToken, KindSlashToken, KindStringLiteral, KindTemplateHead, KindTemplateMiddle, KindTemplateTail, KindTildeToken, KindUnknown, KindWhitespaceTrivia, } from "../ast/generated/kinds.js";
import { TokenFlagsBinaryOrOctalSpecifier, TokenFlagsBinarySpecifier, TokenFlagsContainsInvalidEscape, TokenFlagsContainsInvalidSeparator, TokenFlagsContainsLeadingZero, TokenFlagsContainsSeparator, TokenFlagsExtendedUnicodeEscape, TokenFlagsHexEscape, TokenFlagsHexSpecifier, TokenFlagsNone, TokenFlagsOctal, TokenFlagsOctalSpecifier, TokenFlagsPrecedingJSDocComment, TokenFlagsPrecedingJSDocLeadingAsterisks, TokenFlagsPrecedingJSDocWithDeprecated, TokenFlagsPrecedingJSDocWithSeeOrLink, TokenFlagsPrecedingLineBreak, TokenFlagsScientific, TokenFlagsSingleQuote, TokenFlagsUnicodeEscape, TokenFlagsUnterminated, } from "../ast/tokenflags.js";
...
import { An_extended_Unicode_escape_value_must_be_between_0x0_and_0x10FFFF_inclusive, Asterisk_Slash_expected, A_bigint_literal_cannot_use_exponential_notation, A_bigint_literal_must_be_an_integer, Binary_digit_expected, Decimal_escape_sequences_and_backreferences_are_not_allowed_in_a_character_class, Decimals_with_leading_zeros_are_not_allowed, Digit_expected, Duplicate_regular_expression_flag, Escape_sequence_0_is_not_allowed, File_appears_to_be_binary, Hexadecimal_digit_expected, Invalid_character, Merge_conflict_marker_encountered, Multiple_consecutive_numeric_separators_are_not_permitted, Numeric_separators_are_not_allowed_here, Octal_digit_expected, Octal_escape_sequences_and_backreferences_are_not_allowed_in_a_character_class_If_this_was_intended_as_an_escape_sequence_use_the_syntax_0_instead, Octal_escape_sequences_are_not_allowed_Use_the_syntax_0, Octal_literals_are_not_allowed_Use_the_syntax_0, The_Unicode_u_flag_and_the_Unicode_Sets_v_flag_cannot_be_set_simultaneously, This_character_cannot_be_escaped_in_a_regular_expression, Unexpected_end_of_text, Unexpected_token_Did_you_mean_or_gt, Unexpected_token_Did_you_mean_or_rbrace, Unicode_escape_sequences_are_only_available_when_the_Unicode_u_flag_or_the_Unicode_Sets_v_flag_is_set, Unknown_regular_expression_flag, Unterminated_regular_expression_literal, Unterminated_string_literal, Unterminated_template_literal, Unterminated_Unicode_escape_sequence, An_identifier_or_keyword_cannot_immediately_follow_a_numeric_literal, X_can_only_be_used_at_the_start_of_a_file, } from "../diagnostics/generated/messages.js";
import { FromString, Number_String } from "../jsnum/string.js";
import { ParsePseudoBigInt } from "../jsnum/pseudobigint.js";
import { EncodeJSStringRune, IsASCIILetter, IsDigit, IsHexDigit, IsHighSurrogate, IsLineBreak, IsLowSurrogate, IsOctalDigit, IsWhiteSpaceLike, IsWhiteSpaceSingleLine, SurrogatePairToCodePoint, } from "../stringutil/util.js";
import { IsUnicodeIdentifierStart, IsUnicodeIdentifierPart } from "../stringutil/identifier.js";
import { charCodeToRegExpFlag, regExpParser_run, regularExpressionFlagsAnyUnicodeMode, regularExpressionFlagsUnicodeSets, Scanner_checkRegularExpressionFlagAvailability, } from "./regexp.js";
...
function scannerByteLen(s) {
    return s.end;
}
function scannerByteAt(s, pos) {
    const view = s.sourceByteView;
    return view.ascii ? s.text.charCodeAt(pos) : view.bytes[pos];
}
function scannerByteSlice(s, start, end) {
    const view = s.sourceByteView;
    return utf8.StringByteViewSlice(s.text, view, start, end);
}
function scannerHasPrefixAt(s, start, prefix) {
    const view = s.sourceByteView;
    return utf8.StringByteViewHasPrefix(s.text, view, start, prefix);
}
function scannerDecodeRuneInStringAt(s, pos) {
    const view = s.sourceByteView;
    return utf8.DecodeRuneInStringViewAt(s.text, view, pos);
}
function scannerDecodeLastRuneInStringBefore(s, end) {
    const view = s.sourceByteView;
...
const stringFromRune = (r) => globalThis.String.fromCodePoint(r);
/**
 ...
 * )
 */
export const EscapeSequenceScanningFlagsString = 1 << 0;
export const EscapeSequenceScanningFlagsReportErrors = 1 << 1;
export const EscapeSequenceScanningFlagsRegularExpression = 1 << 2;
export const EscapeSequenceScanningFlagsAnnexB = 1 << 3;
export const EscapeSequenceScanningFlagsAnyUnicodeMode = 1 << 4;
export const EscapeSequenceScanningFlagsAtomEscape = 1 << 5;
export const EscapeSequenceScanningFlagsReportInvalidEscapeErrors = EscapeSequenceScanningFlagsRegularExpression | EscapeSequenceScanningFlagsReportErrors;
export const EscapeSequenceScanningFlagsAllowExtendedUnicodeEscape = EscapeSequenceScanningFlagsString | EscapeSequenceScanningFlagsAnyUnicodeMode;
/**
 ...
 * }
 */
export const textToKeyword = new globalThis.Map([
 ...
 * }
 */
export function defaultScanner() {
    // Using a function rather than a global is intentional; this function is
    // inlined as pure code (zeroing + moves), whereas a global requires write
    // barriers since the memory is mutable.
    return {
 ...
 * }
 */
export function Scanner_Reset(receiver) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_Text(receiver) {
 ...
 * }
 */
export function Scanner_Token(receiver) {
 ...
 * }
 */
export function Scanner_TokenFlags(receiver) {
 ...
 * }
 */
export function Scanner_TokenFullStart(receiver) {
 ...
 * }
 */
export function Scanner_TokenStart(receiver) {
 ...
 * }
 */
export function Scanner_TokenEnd(receiver) {
 ...
 * }
 */
export function Scanner_TokenText(receiver) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_TokenValue(receiver) {
 ...
 * }
 */
export function Scanner_TokenRange(receiver) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_CommentDirectives(receiver) {
 ...
 * }
 */
export function Scanner_Mark(receiver) {
 ...
 * }
 */
export function Scanner_Rewind(receiver, state) {
 ...
 * }
 */
export function Scanner_ResetPos(receiver, pos) {
    const st = receiver.__tsgoEmbedded0;
    if (pos < 0) {
 ...
 * }
 */
export function Scanner_ResetTokenState(receiver, pos) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_SetSkipJSDocLeadingAsterisks(receiver, skip) {
 ...
 * }
 */
export function Scanner_SetSkipTrivia(receiver, skip) {
 ...
 * }
 */
export function Scanner_HasUnicodeEscape(receiver) {
 ...
 * }
 */
export function Scanner_ContainsNonASCII(receiver) {
 ...
 * }
 */
export function Scanner_HasExtendedUnicodeEscape(receiver) {
 ...
 * }
 */
export function Scanner_HasPrecedingLineBreak(receiver) {
 ...
 * }
 */
export function Scanner_HasPrecedingJSDocComment(receiver) {
 ...
 * }
 */
export function Scanner_HasPrecedingJSDocLeadingAsterisks(receiver) {
 ...
 * }
 */
export function Scanner_HasPrecedingJSDocWithDeprecatedTag(receiver) {
 ...
 * }
 */
export function Scanner_HasPrecedingJSDocWithSeeOrLink(receiver) {
 ...
 * }
 */
export function Scanner_scanJSDocCommentForTags(receiver, commentText) {
...
function Scanner_scanJSDocCommentRangeForTags(receiver, text, view, start, end) {
    const s = receiver;
    let pos = start;
    for (;;) {
        ...
        pos = (i + 1);
        if ((s.__tsgoEmbedded0.tokenFlags & TokenFlagsPrecedingJSDocWithDeprecated) === 0 &&
            hasJSDocTagAt(text, view, pos, end, "deprecated")) {
            s.__tsgoEmbedded0.tokenFlags |= TokenFlagsPrecedingJSDocWithDeprecated;
        }
        if ((s.__tsgoEmbedded0.tokenFlags & TokenFlagsPrecedingJSDocWithSeeOrLink) === 0 &&
        ...
        if ((s.__tsgoEmbedded0.tokenFlags & (TokenFlagsPrecedingJSDocWithDeprecated | TokenFlagsPrecedingJSDocWithSeeOrLink)) ===
            (TokenFlagsPrecedingJSDocWithDeprecated | TokenFlagsPrecedingJSDocWithSeeOrLink)) {
            return;
        }
    }
}
function stringByteViewIndexByteInRange(text, view, start, end, b) {
    if (view.ascii) {
 ...
 * }
 */
export function Scanner_SetText(receiver, text) {
    const s = receiver;
    s.text = text;
    const view = utf8.GetStringByteView(text);
...
export function Scanner_SetTextEnd(receiver, text, end) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_SetOnError(receiver, errorCallback) {
 ...
 * }
 */
export function Scanner_SetLanguageVariant(receiver, languageVariant) {
 ...
 * }
 */
export function Scanner_SetScriptTarget(receiver, scriptTarget) {
 ...
 * }
 */
export function Scanner_languageVersion(receiver) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_error(receiver, diagnostic) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_errorAt(receiver, diagnostic, pos, length, ...args) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_char(receiver) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_charAt(receiver, offset) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_charAndSize(receiver) {
    const s = receiver;
    // Fast path: a single ASCII byte. The vast majority of source bytes are
    // ASCII; handling them here avoids constructing a string slice header and
    // calling the non-inlined utf8.DecodeRuneInString on every byte.
 ...
 * }
 */
export function Scanner_scanASCIIWhile(receiver, pred) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_Scan(receiver) {
    const s = receiver;
            ...
            case "\r".charCodeAt(0): {
                ...
                if (s.skipTrivia) {
                    ...
                    Scanner_scanASCIIWhile(s, (b) => {
                        return (b === " ".charCodeAt(0) || (b >= "\t".charCodeAt(0) && b <= "\r".charCodeAt(0)));
                    });
                    continue;
                }
            ...
            case "0".charCodeAt(0): {
                if (Scanner_charAt(s, 1) === "X".charCodeAt(0) || Scanner_charAt(s, 1) === "x".charCodeAt(0)) {
                    ...
                    if (s.hexNumberCache === undefined) {
                        s.hexNumberCache = new globalThis.Map();
                    }
 ...
 * }
 */
export function Scanner_processCommentDirective(receiver, start, end, multiline) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    // Skip starting slashes and whitespace
    let pos = start;
 ...
 * }
 */
export function Scanner_ReScanLessThanToken(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
 ...
 * }
 */
export function Scanner_ReScanGreaterThanToken(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
 ...
 * }
 */
export function Scanner_reScanGreaterThanTokenInner(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    st.pos = st.tokenStart + 1;
 ...
 * }
 */
export function Scanner_ReScanTemplateToken(receiver, isTaggedTemplate) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
 ...
 * }
 */
export function Scanner_ReScanAsteriskEqualsToken(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
 ...
 * }
 */
export function Scanner_ReScanSlashToken(receiver, ...reportErrors) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
        ...
        if ((st.tokenFlags & TokenFlagsUnterminated) !== 0) {
            ...
            if (shouldReportErrors) {
                ...
                const parser = {
                    ...
                    groupSpecifiers: new globalThis.Map(),
                    groupNameReferences: [],
                    decimalEscapes: [],
 ...
 * }
 */
export function Scanner_ReScanJsxToken(receiver, allowMultilineJsxText) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
 ...
 * }
 */
export function Scanner_ReScanHashToken(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
 ...
 * }
 */
export function Scanner_ReScanQuestionToken(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
 ...
 * }
 */
export function Scanner_ScanJsxToken(receiver) {
 ...
 * }
 */
export function Scanner_ScanJsxTokenEx(receiver, allowMultilineJsxText) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    st.fullStartPos = st.pos;
    st.tokenStart = st.pos;
 ...
 * }
 */
export function Scanner_ScanJsxIdentifier(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
 ...
 * }
 */
export function Scanner_ScanJsxAttributeValue(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    st.fullStartPos = st.pos;
    // Skip whitespace between '=' and the value so tokenStart lands on the
 ...
 * }
 */
export function Scanner_ReScanJsxAttributeValue(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    st.pos = st.fullStartPos;
    st.tokenStart = st.fullStartPos;
 ...
 * }
 */
export function Scanner_ScanJSDocCommentTextToken(receiver, inBackticks) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    st.fullStartPos = st.pos;
    st.tokenFlags = TokenFlagsNone;
    ...
    st.tokenStart = st.pos;
    for (let [ch, size] = Scanner_charAndSize(s); st.pos < scannerByteLen(s) && !IsLineBreak(ch) && ch !== "`".charCodeAt(0); [ch, size] = Scanner_charAndSize(s)) {
        if (!inBackticks) {
            if (ch === "{".charCodeAt(0)) {
                break;
            }
 ...
 * }
 */
export function Scanner_CanFollowJSDocAt(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    if (st.pos >= scannerByteLen(s)) {
        return true;
 ...
 * }
 */
export function Scanner_ScanJSDocToken(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    st.fullStartPos = st.pos;
    st.tokenFlags = TokenFlagsNone;
 ...
 * }
 */
export function Scanner_scanIdentifier(receiver, prefixLength) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    const start = st.pos;
    st.pos += prefixLength;
    ...
    if (IsASCIILetter(ch) || ch === "_".charCodeAt(0) || ch === "$".charCodeAt(0)) {
        st.pos++;
        Scanner_scanASCIIWhile(s, (b) => {
            return ((b >= "a".charCodeAt(0) && b <= "z".charCodeAt(0)) || (b >= "A".charCodeAt(0) && b <= "Z".charCodeAt(0)) || (b >= "0".charCodeAt(0) && b <= "9".charCodeAt(0)) || b === "_".charCodeAt(0) || b === "$".charCodeAt(0));
        });
        ch = Scanner_char(s);
 ...
 * }
 */
export function Scanner_scanIdentifierParts(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
 ...
 * }
 */
export function Scanner_scanString(receiver, jsxAttributeString) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    ...
    st.pos++;
    // Fast path for simple strings without escape sequences.
    const strEnd = utf8.StringByteViewIndexByte(s.text, s.sourceByteView, st.pos, quote);
    ...
    if (strLen > 0) {
        ...
        if (jsxAttributeString ||
            (strings.IndexByte(str, "\\".charCodeAt(0)) < 0 && strings.IndexByte(str, "\r".charCodeAt(0)) < 0 && strings.IndexByte(str, "\n".charCodeAt(0)) < 0)) {
            st.pos += strLen + 1;
            return str;
        }
    }
 ...
 * }
 */
export function Scanner_scanTemplateAndSetTokenValue(receiver, shouldEmitInvalidEscapeError) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    ...
    let start = st.pos;
    const parts = [];
    let token = KindUnknown;
    for (;;) {
        Scanner_scanASCIIWhile(s, (b) => {
            return (b !== "`".charCodeAt(0) && b !== "$".charCodeAt(0) && b !== "\\".charCodeAt(0) && b !== "\r".charCodeAt(0));
        });
        const ch = Scanner_char(s);
 ...
 * }
 */
export function Scanner_scanEscapeSequence(receiver, flags) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    const start = st.pos;
    st.pos++;
    ...
    switch (ch) {
        ...
        default: {
            ...
            if ((flags & EscapeSequenceScanningFlagsAnyUnicodeMode) !== 0 ||
 ...
 * }
 */
export function Scanner_scanUnicodeEscape(receiver, shouldEmitInvalidEscapeError) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    st.pos += 2;
    const start = st.pos;
 ...
 * }
 */
export function Scanner_scanLowSurrogateEscape(receiver, high) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
 ...
 * }
 */
export function Scanner_peekUnicodeEscape(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
 ...
 * }
 */
export function Scanner_scanNumber(receiver) {
    const s = receiver;
    const st = s.__tsgoEmbedded0;
    let start = st.pos;
    let fixedPart = "";
 ...
 * }
 */
export function Scanner_scanNumberFragment(receiver) {
    const s = receiver;
    ...
    for (;;) {
        ...
        Scanner_scanASCIIWhile(s, (b) => {
            return (b >= "0".charCodeAt(0) && b <= "9".charCodeAt(0));
        });
 ...
 * }
 */
export function Scanner_scanDigits(receiver) {
    const s = receiver;
 ...
 * }
 */
export function Scanner_scanHexDigits(receiver, minCount, scanAsManyAsPossible, canHaveSeparators) {
    const s = receiver;
    let digitCount = 0;
    const start = s.__tsgoEmbedded0.pos;
    let allowSeparator = false;
    ...
    if (s.hexDigitCache === undefined) {
        s.hexDigitCache = new globalThis.Map();
    }
 ...
 * }
 */
export function Scanner_scanBinaryOrOctalDigits(receiver, base) {
    const s = receiver;
    const sb = new Builder();
    let allowSeparator = false;
    let isPreviousTokenSeparator = false;
 ...
 * }
 */
export function Scanner_scanBigIntSuffix(receiver) {
    const s = receiver;
    ...
    if (s.numberCache === undefined) {
        s.numberCache = new globalThis.Map();
    }
 ...
 * }
 */
export function Scanner_scanInvalidCharacter(receiver) {
    const s = receiver;
 ...
 * }
 */
export function GetIdentifierToken(str) {
 ...
 * }
 */
export function isWordCharacter(ch) {
 ...
 * }
 */
export function IsIdentifierPartEx(ch, languageVariant) {
 ...
 * }
 */
export function GetViableKeywordSuggestions() {
    const result = [];
 ...
 * }
 */
export function SkipTriviaEx(text, pos, options) {
 ...
 * )
 */
export const mergeConflictMarkerLength = byteLen("<<<<<<<");
export const maxAsciiCharacter = 127;
/**
 ...
 * }
 */
export function isConflictMarkerTrivia(text, pos) {
    if (pos < 0) {
 ...
 * }
 */
export function scanConflictMarkerTrivia(text, pos, reportError) {
    ...
    if (ch === "<".charCodeAt(0) || ch === ">".charCodeAt(0)) {
        ...
        while (pos < length) {
            ...
            if ((currentChar === "=".charCodeAt(0) || currentChar === ">".charCodeAt(0)) &&
                currentChar !== ch &&
 ...
 * }
 */
export function isShebangTrivia(text, pos) {
    if (byteLen(text) < 2) {
        return false;
    }
    if (pos !== 0) {
 ...
 * }
 */
export function scanShebangTrivia(text, pos) {
    pos += 2;
 ...
 * }
 */
export function GetScannerForSourceFile(sourceFile, pos) {
    const s = NewScanner();
 ...
 * }
 */
export function ScanTokenAtPosition(sourceFile, pos) {
 ...
 * }
 */
export function GetRangeOfTokenAtPosition(sourceFile, pos) {
    const s = GetScannerForSourceFile(sourceFile, pos);
    return NewTextRange(s.__tsgoEmbedded0.tokenStart, s.__tsgoEmbedded0.pos);
}
/**
 ...
 * }
 */
export function getErrorRangeForArrowFunction(sourceFile, node) {
 ...
 * }
 */
export function findOriginatingJSDocSatisfiesTag(sourceFile, node) {
    ...
    for (let current = node.Parent; current !== undefined; current = current.Parent) {
        ...
        let firstSatisfiesTag = undefined;
 ...
 * }
 */
export function GetErrorRangeForNode(sourceFile, node) {
    let errorNode = node;
    ...
    if (fellThroughToDeclarationName ||
        ...
        if ((node.Flags & NodeFlagsReparsed) !== 0) {
            ...
            while (Scanner_Token(scanner) !== kinds.KindConstructorKeyword &&
 ...
 * }
 */
export function ComputeLineOfPosition(lineStarts, pos) {
    let low = 0;
 ...
 * }
 */
export function GetECMALineStarts(sourceFile) {
    return sourceFile.ECMALineMap();
}
...
const sourceFileLikeFromSourceFile = (sourceFile) => ({
    Text: () => SourceFile_Text(sourceFile),
    ECMALineMap: () => SourceFile_ECMALineMap(sourceFile),
});
/**
 ...
 * }
 */
export function GetECMALineOfPosition(sourceFile, pos) {
 ...
 * }
 */
export function GetECMALineAndUTF16CharacterOfPosition(sourceFile, pos) {
    const lineMap = GetECMALineStarts(sourceFile);
 ...
 * }
 */
export function GetECMALineAndByteOffsetOfPosition(sourceFile, pos) {
    const lineMap = GetECMALineStarts(sourceFile);
    const line = ComputeLineOfPosition(lineMap, pos);
    const byteOffset = pos - lineMap[line];
    return [line, byteOffset];
}
/**
 ...
 * }
 */
export function GetECMAEndLinePosition(sourceFile, line) {
    const like = sourceFileLikeFromSourceFile(sourceFile);
    let pos = GetECMALineStarts(like)[line];
    for (;;) {
 ...
 * }
 */
export function GetECMAPositionOfLineAndUTF16Character(sourceFile, line, character) {
 ...
 * }
 */
export function GetECMAPositionOfLineAndByteOffset(sourceFile, line, byteOffset) {
    return ComputePositionOfLineAndByteOffset(GetECMALineStarts(sourceFile), line, byteOffset);
}
/**
 ...
 * }
 */
export function ComputePositionOfLineAndByteOffset(lineStarts, line, byteOffset) {
 ...
 * }
 */
export function ComputePositionOfLineAndUTF16Character(lineStarts, line, character, text, allowEdits) {
    if (line < 0 || line >= lineStarts.length) {
        if (allowEdits) {
            // Clamp line to nearest allowable value
            if (line < 0) {
 ...
 * }
 */
export function GetLeadingCommentRanges(f, text, pos) {
    return iterateCommentRanges(f, text, pos, false);
}
/**
 ...
 * }
 */
export function GetTrailingCommentRanges(f, text, pos) {
    return iterateCommentRanges(f, text, pos, true);
}
/**
 ...
 * }
 */
export function iterateCommentRanges(f, text, pos, trailing) {
    return (yield_) => {
        const textView = utf8.GetStringByteView(text);
        const textLen = utf8.StringByteViewLen(text, textView);
        let pendingPos = 0;
        let pendingEnd = 0;
        let pendingKind = KindUnknown;
        ...
        scan: for (; pos >= 0 && pos < textLen;) {
            ...
            switch (ch) {
                ...
                case "/".charCodeAt(0): {
                    let nextChar = 0;
                    if (pos + 1 < textLen) {
                        nextChar = utf8.StringByteViewAt(text, textView, pos + 1);
                    }
