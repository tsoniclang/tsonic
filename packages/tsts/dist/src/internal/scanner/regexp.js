...
import { ScriptTargetES2018, ScriptTargetES2022, ScriptTargetES2024, } from "../core/compileroptions.js";
import { ScriptTarget_String } from "../core/scripttarget_stringer_generated.js";
import { A_character_class_must_not_contain_a_reserved_double_punctuator_Did_you_mean_to_escape_it_with_backslash, A_character_class_range_must_not_be_bounded_by_another_character_class, Anything_that_would_possibly_match_more_than_a_single_character_is_invalid_inside_a_negated_character_class, Any_Unicode_property_that_would_possibly_match_more_than_a_single_character_is_only_available_when_the_Unicode_Sets_v_flag_is_set, Did_you_mean_0, Duplicate_regular_expression_flag, Expected_a_capturing_group_name, Expected_a_class_set_operand, Expected_a_Unicode_property_name, Expected_a_Unicode_property_name_or_value, Expected_a_Unicode_property_value, Incomplete_quantifier_Digit_expected, Named_capturing_groups_are_only_available_when_targeting_ES2018_or_later, Named_capturing_groups_with_the_same_name_must_be_mutually_exclusive_to_each_other, Numbers_out_of_order_in_quantifier, Operators_must_not_be_mixed_within_a_character_class_Wrap_it_in_a_nested_class_instead, Range_out_of_order_in_character_class, Subpattern_flags_must_be_present_when_there_is_a_minus_sign, There_is_no_capturing_group_named_0_in_this_regular_expression, There_is_nothing_available_for_repetition, This_backreference_refers_to_a_group_that_does_not_exist_There_are_no_capturing_groups_in_this_regular_expression, This_backreference_refers_to_a_group_that_does_not_exist_There_are_only_0_capturing_groups_in_this_regular_expression, This_regular_expression_flag_cannot_be_toggled_within_a_subpattern, This_regular_expression_flag_is_only_available_when_targeting_0_or_later, Undetermined_character_escape, Unicode_property_value_expressions_are_only_available_when_the_Unicode_u_flag_or_the_Unicode_Sets_v_flag_is_set, Unexpected_0_Did_you_mean_to_escape_it_with_backslash, Unknown_regular_expression_flag, Unknown_Unicode_property_name, Unknown_Unicode_property_name_or_value, Unknown_Unicode_property_value, X_0_expected, X_0_must_be_followed_by_a_Unicode_property_value_expression_enclosed_in_braces, X_c_must_be_followed_by_an_ASCII_letter, X_k_must_be_followed_by_a_capturing_group_name_enclosed_in_angle_brackets, X_q_is_only_available_inside_character_class, X_q_must_be_followed_by_string_alternatives_enclosed_in_braces, } from "../diagnostics/generated/messages.js";
import * as stringutil from "../stringutil/util.js";
import { Set_Has, Set_Keys } from "../collections/set.js";
import { binaryUnicodeProperties, binaryUnicodePropertiesOfStrings, nonBinaryUnicodeProperties, valuesOfNonBinaryUnicodeProperties, } from "./unicodeproperties.js";
import { EscapeSequenceScanningFlagsAnnexB, EscapeSequenceScanningFlagsAnyUnicodeMode, EscapeSequenceScanningFlagsAtomEscape, EscapeSequenceScanningFlagsRegularExpression, IsIdentifierPart, isWordCharacter, Scanner_char, Scanner_charAt, Scanner_errorAt, Scanner_languageVersion, Scanner_scanEscapeSequence, Scanner_scanIdentifier, } from "./scanner.js";
import { decodeClassAtomRune, encodeSurrogate, surr1, surr2, surrSelf, } from "./utilities.js";
 ...
 * )
 */
export const regularExpressionFlagsNone = 0;
export const regularExpressionFlagsHasIndices = 1 << 0; // d
export const regularExpressionFlagsGlobal = 1 << 1; // g
export const regularExpressionFlagsIgnoreCase = 1 << 2; // i
export const regularExpressionFlagsMultiline = 1 << 3; // m
export const regularExpressionFlagsDotAll = 1 << 4; // s
export const regularExpressionFlagsUnicode = 1 << 5; // u
export const regularExpressionFlagsUnicodeSets = 1 << 6; // v
export const regularExpressionFlagsSticky = 1 << 7; // y
export const regularExpressionFlagsAnyUnicodeMode = regularExpressionFlagsUnicode | regularExpressionFlagsUnicodeSets;
export const regularExpressionFlagsModifiers = regularExpressionFlagsIgnoreCase | regularExpressionFlagsMultiline | regularExpressionFlagsDotAll;
/**
 ...
 * }
 */
export const charCodeToRegExpFlag = new globalThis.Map([
 ...
 * }
 */
export const regExpFlagToFirstAvailableLanguageVersion = new globalThis.Map([
 ...
 * }
 */
export function Scanner_checkRegularExpressionFlagAvailability(receiver, flag, pos, size) {
    ...
    if (ok && Scanner_languageVersion(receiver) < availableFrom) {
        Scanner_errorAt(receiver, This_regular_expression_flag_is_only_available_when_targeting_0_or_later, pos, size, strings.ToLower(ScriptTarget_String(availableFrom)));
    }
}
/**
 ...
 * )
 */
export const classSetExpressionTypeUnknown = 0;
export const classSetExpressionTypeClassUnion = 1;
export const classSetExpressionTypeClassIntersection = 2;
export const classSetExpressionTypeClassSubtraction = 3;
/**
 ...
 * }
 */
export function regExpParser_pos(receiver) {
 ...
 * }
 */
export function regExpParser_setPos(receiver, v) {
 ...
 * }
 */
export function regExpParser_incPos(receiver, n) {
 ...
 * }
 */
export function regExpParser_char(receiver) {
 ...
 * }
 */
export function regExpParser_charAt(receiver, pos) {
 ...
 * }
 */
export function regExpParser_error(receiver, msg, pos, length, ...args) {
 ...
 * }
 */
export function regExpParser_text(receiver) {
 ...
 * }
 */
export function regExpParser_scanDisjunction(receiver, isInGroup) {
    for (;;) {
        ...
        receiver.namedCapturingGroups = receiver.namedCapturingGroups.slice(0, receiver.namedCapturingGroups.length - 1);
 ...
 * }
 */
export function regExpParser_scanAlternative(receiver, isInGroup) {
    ...
    while (regExpParser_pos(receiver) < receiver.end) {
        ...
        if (ch === "^".codePointAt(0) || ch === "$".codePointAt(0)) {
                ...
                if (groupCh === "=".codePointAt(0) || groupCh === "!".codePointAt(0)) {
                    ...
                    if (lookCh === "=".codePointAt(0) || lookCh === "!".codePointAt(0)) {
                        ...
                        if (Scanner_languageVersion(receiver.scanner) < ScriptTargetES2018) {
                            regExpParser_error(receiver, Named_capturing_groups_are_only_available_when_targeting_ES2018_or_later, groupNameStart, regExpParser_pos(receiver) - groupNameStart);
                        }
                    ...
                    if (regExpParser_char(receiver) === "-".codePointAt(0)) {
                        ...
                        if (regExpParser_pos(receiver) === flagsStart + 1) {
                            regExpParser_error(receiver, Subpattern_flags_must_be_present_when_there_is_a_minus_sign, flagsStart, regExpParser_pos(receiver) - flagsStart);
                        }
                    }
                    regExpParser_scanExpectedChar(receiver, ":".codePointAt(0));
                    isPreviousTermQuantifiable = true;
            ...
            let fallsThroughToQuantifier = true;
            let quantifierContinue = false;
            if (ch === "{".codePointAt(0)) {
                regExpParser_incPos(receiver, 1);
                    ...
                    if (regExpParser_char(receiver) === ",".codePointAt(0)) {
                        ...
                        if (minStr === "") {
                            if (maxStr !== "" || regExpParser_char(receiver) === "}".codePointAt(0)) {
                                ...
                                regExpParser_error(receiver, Unexpected_0_Did_you_mean_to_escape_it_with_backslash, start, 1, stringFromRune(ch));
                                isPreviousTermQuantifiable = true;
                                quantifierContinue = true;
                            }
                        }
                            ...
                            if (compareDecimalStrings(minStr, maxStr) > 0 &&
                                ...
                                regExpParser_error(receiver, Numbers_out_of_order_in_quantifier, digitsStart, regExpParser_pos(receiver) - digitsStart);
                            }
                        }
                    }
                    else if (minStr === "") {
            ...
            if (fallsThroughToQuantifier) {
                ...
                if (!isPreviousTermQuantifiable) {
                    regExpParser_error(receiver, There_is_nothing_available_for_repetition, start, regExpParser_pos(receiver) - start);
                }
                isPreviousTermQuantifiable = false;
            }
        }
            ...
            if (receiver.anyUnicodeModeOrNonAnnexB || ch === ")".codePointAt(0)) {
                regExpParser_error(receiver, Unexpected_0_Did_you_mean_to_escape_it_with_backslash, regExpParser_pos(receiver), 1, stringFromRune(ch));
            }
            regExpParser_incPos(receiver, 1);
            isPreviousTermQuantifiable = true;
        }
 ...
 * }
 */
export function regExpParser_scanPatternModifiers(receiver, currFlags) {
    let currFlagsLocal = currFlags;
    while (regExpParser_pos(receiver) < receiver.end) {
        ...
        if (!ok) {
            ...
            regExpParser_error(receiver, This_regular_expression_flag_cannot_be_toggled_within_a_subpattern, regExpParser_pos(receiver), size);
        }
        else {
            currFlagsLocal |= flag;
 ...
 * }
 */
export function regExpParser_scanAtomEscape(receiver) {
    ...
    if (ch === "k".codePointAt(0)) {
        ...
        if (regExpParser_char(receiver) === "<".codePointAt(0)) {
            ...
            regExpParser_error(receiver, X_k_must_be_followed_by_a_capturing_group_name_enclosed_in_angle_brackets, regExpParser_pos(receiver) - 2, 2);
        }
        return;
    }
 ...
 * }
 */
export function regExpParser_scanDecimalEscape(receiver) {
    debug.Assert(regExpParser_pos(receiver) > 0 && byteAt(regExpParser_text(receiver), regExpParser_pos(receiver) - 1) === "\\".codePointAt(0));
    const ch = regExpParser_char(receiver);
 ...
 * }
 */
export function regExpParser_scanCharacterEscape(receiver, atomEscape) {
    debug.Assert(regExpParser_pos(receiver) > 0 && byteAt(regExpParser_text(receiver), regExpParser_pos(receiver) - 1) === "\\".codePointAt(0));
    const ch = regExpParser_char(receiver);
    if (ch === -1) {
    ...
    let flags = EscapeSequenceScanningFlagsRegularExpression;
    if (receiver.annexB) {
        flags |= EscapeSequenceScanningFlagsAnnexB;
    }
 ...
 * }
 */
export function regExpParser_scanGroupName(receiver, isReference) {
    debug.Assert(regExpParser_pos(receiver) > 0 && byteAt(regExpParser_text(receiver), regExpParser_pos(receiver) - 1) === "<".codePointAt(0));
    ...
    if (regExpParser_pos(receiver) === receiver.scanner.__tsgoEmbedded0.tokenStart) {
        ...
        regExpParser_error(receiver, Named_capturing_groups_with_the_same_name_must_be_mutually_exclusive_to_each_other, receiver.scanner.__tsgoEmbedded0.tokenStart, regExpParser_pos(receiver) - receiver.scanner.__tsgoEmbedded0.tokenStart);
    }
    else {
        if (receiver.namedCapturingGroups.length > 0) {
            receiver.namedCapturingGroups[receiver.namedCapturingGroups.length - 1].set(receiver.scanner.__tsgoEmbedded0.tokenValue, true);
        }
 ...
 * }
 */
export function regExpParser_namedCapturingGroupsContains(receiver, name) {
 ...
 * }
 */
export function regExpParser_isClassContentExit(receiver, ch) {
 ...
 * }
 */
export function regExpParser_scanClassRanges(receiver) {
    debug.Assert(regExpParser_pos(receiver) > 0 && byteAt(regExpParser_text(receiver), regExpParser_pos(receiver) - 1) === "[".codePointAt(0));
    receiver.pendingLowSurrogate = 0;
    if (regExpParser_char(receiver) === "^".codePointAt(0)) {
        regExpParser_incPos(receiver, 1);
    ...
    while (regExpParser_pos(receiver) < receiver.end) {
        ...
        if (regExpParser_char(receiver) === "-".codePointAt(0)) {
            ...
            if (minCharacter === "" && receiver.anyUnicodeModeOrNonAnnexB) {
                regExpParser_error(receiver, A_character_class_range_must_not_be_bounded_by_another_character_class, minStart, regExpParser_pos(receiver) - 1 - minStart);
            }
            ...
            if (maxCharacter === "" && receiver.anyUnicodeModeOrNonAnnexB) {
                regExpParser_error(receiver, A_character_class_range_must_not_be_bounded_by_another_character_class, maxStart, regExpParser_pos(receiver) - maxStart);
                continue;
            }
            if (minCharacter === "") {
                continue;
            ...
            if (byteLen(minCharacter) === minSize &&
                byteLen(maxCharacter) === maxSize &&
                minCharacterValue > maxCharacterValue) {
                regExpParser_error(receiver, Range_out_of_order_in_character_class, minStart, regExpParser_pos(receiver) - minStart);
            }
        }
    }
}
 ...
 * }
 */
export function regExpParser_scanClassSetExpression(receiver) {
    debug.Assert(regExpParser_pos(receiver) > 0 && byteAt(regExpParser_text(receiver), regExpParser_pos(receiver) - 1) === "[".codePointAt(0));
    ...
    if (firstCh === "-".codePointAt(0)) {
        if (regExpParser_pos(receiver) + 1 < receiver.end && regExpParser_charAt(receiver, regExpParser_pos(receiver) + 1) === "-".codePointAt(0)) {
            if (isCharacterComplement && receiver.mayContainStrings) {
                regExpParser_error(receiver, Anything_that_would_possibly_match_more_than_a_single_character_is_invalid_inside_a_negated_character_class, start, regExpParser_pos(receiver) - start);
            }
        ...
        if (regExpParser_pos(receiver) + 1 < receiver.end && regExpParser_charAt(receiver, regExpParser_pos(receiver) + 1) === "&".codePointAt(0)) {
            ...
            regExpParser_error(receiver, Unexpected_0_Did_you_mean_to_escape_it_with_backslash, regExpParser_pos(receiver), 1, stringFromRune(ch0));
        }
    }
    else {
        if (isCharacterComplement && receiver.mayContainStrings) {
    ...
    while (regExpParser_pos(receiver) < receiver.end) {
        ...
        if (ch === "-".codePointAt(0)) {
            ...
            if (ch === "-".codePointAt(0)) {
                regExpParser_incPos(receiver, 1);
                regExpParser_error(receiver, Operators_must_not_be_mixed_within_a_character_class_Wrap_it_in_a_nested_class_instead, regExpParser_pos(receiver) - 2, 2);
                ...
                if (operand === "") {
                    regExpParser_error(receiver, A_character_class_range_must_not_be_bounded_by_another_character_class, start, regExpParser_pos(receiver) - 1 - start);
                }
                const secondStart = regExpParser_pos(receiver);
                const secondOperand = regExpParser_scanClassSetOperand(receiver);
                if (isCharacterComplement && receiver.mayContainStrings) {
                    regExpParser_error(receiver, Anything_that_would_possibly_match_more_than_a_single_character_is_invalid_inside_a_negated_character_class, secondStart, regExpParser_pos(receiver) - secondStart);
                }
                expressionMayContainStrings = expressionMayContainStrings || receiver.mayContainStrings;
                if (secondOperand === "") {
                    regExpParser_error(receiver, A_character_class_range_must_not_be_bounded_by_another_character_class, secondStart, regExpParser_pos(receiver) - secondStart);
                }
                else if (operand !== "") {
                    ...
                    if (byteLen(operand) === minSize &&
                        byteLen(secondOperand) === maxSize &&
                        minCharacterValue > maxCharacterValue) {
                        regExpParser_error(receiver, Range_out_of_order_in_character_class, start, regExpParser_pos(receiver) - start);
                    }
                }
            }
        }
            ...
            if (regExpParser_char(receiver) === "&".codePointAt(0)) {
                ...
                regExpParser_error(receiver, Unexpected_0_Did_you_mean_to_escape_it_with_backslash, regExpParser_pos(receiver) - 1, 1, stringFromRune(ch));
            }
            operand = byteSlice(regExpParser_text(receiver), start, regExpParser_pos(receiver));
            loopContinue = true;
        }
        ...
        if (twoChars === "--" || twoChars === "&&") {
            regExpParser_error(receiver, Operators_must_not_be_mixed_within_a_character_class_Wrap_it_in_a_nested_class_instead, regExpParser_pos(receiver), 2);
 ...
 * }
 */
export function regExpParser_scanClassSetSubExpression(receiver, expressionType) {
    let expressionMayContainStrings = receiver.mayContainStrings;
    while (regExpParser_pos(receiver) < receiver.end) {
        let ch = regExpParser_char(receiver);
        if (regExpParser_isClassContentExit(receiver, ch)) {
            break;
        ...
        if (ch === "-".codePointAt(0)) {
            ...
            if (regExpParser_char(receiver) === "-".codePointAt(0)) {
                ...
                regExpParser_error(receiver, Operators_must_not_be_mixed_within_a_character_class_Wrap_it_in_a_nested_class_instead, regExpParser_pos(receiver) - 1, 1);
            }
        }
        else if (ch === "&".codePointAt(0)) {
            regExpParser_incPos(receiver, 1);
 ...
 * }
 */
export function regExpParser_scanClassSetOperand(receiver) {
    receiver.mayContainStrings = false;
    const ch = regExpParser_char(receiver);
    if (ch === "[".codePointAt(0)) {
        regExpParser_incPos(receiver, 1);
 ...
 * }
 */
export function regExpParser_scanClassStringDisjunctionContents(receiver) {
    debug.Assert(regExpParser_pos(receiver) > 0 && byteAt(regExpParser_text(receiver), regExpParser_pos(receiver) - 1) === "{".codePointAt(0));
 ...
 * }
 */
export function regExpParser_scanClassSetCharacter(receiver) {
    const ch = regExpParser_char(receiver);
    if (ch === "\\".codePointAt(0)) {
        regExpParser_incPos(receiver, 1);
        ...
        if (ch === "&".codePointAt(0) ||
            ...
            ch === "`".codePointAt(0) ||
            ch === "~".codePointAt(0)) {
            regExpParser_error(receiver, A_character_class_must_not_contain_a_reserved_double_punctuator_Did_you_mean_to_escape_it_with_backslash, regExpParser_pos(receiver), 2);
            regExpParser_incPos(receiver, 2);
 ...
 * }
 */
export function regExpParser_scanClassAtom(receiver) {
    if (regExpParser_char(receiver) === "\\".codePointAt(0)) {
        regExpParser_incPos(receiver, 1);
        const ch = regExpParser_char(receiver);
 ...
 * }
 */
export function regExpParser_scanCharacterClassEscape(receiver) {
    debug.Assert(regExpParser_pos(receiver) > 0 && byteAt(regExpParser_text(receiver), regExpParser_pos(receiver) - 1) === "\\".codePointAt(0));
    let isCharacterComplement = false;
 ...
 * }
 */
export function regExpParser_getSpellingSuggestionForUnicodePropertyName(receiver, name) {
 ...
 * }
 */
export function regExpParser_getSpellingSuggestionForUnicodePropertyValue(receiver, propertyName, value) {
    const values = valuesOfNonBinaryUnicodeProperties.get(propertyName);
    if (values === undefined) {
        return "";
    }
 ...
 * }
 */
export function regExpParser_getSpellingSuggestionForUnicodePropertyNameOrValue(receiver, name) {
    return GetSpellingSuggestionForStrings(name, ConcatenateSeq(maps.Keys(Set_Keys(valuesOfNonBinaryUnicodeProperties.get("General_Category"))), maps.Keys(Set_Keys(binaryUnicodeProperties)), maps.Keys(Set_Keys(binaryUnicodePropertiesOfStrings))));
}
/**
 ...
 * }
 */
export function regExpParser_scanWordCharacters(receiver) {
    const start = regExpParser_pos(receiver);
    while (regExpParser_pos(receiver) < receiver.end) {
        const ch = regExpParser_char(receiver);
        if (!isWordCharacter(ch)) {
 ...
 * }
 */
export function regExpParser_scanSourceCharacter(receiver) {
 ...
 * }
 */
export function regExpParser_scanExpectedChar(receiver, ch) {
 ...
 * }
 */
export function regExpParser_scanDigits(receiver) {
    const start = regExpParser_pos(receiver);
 ...
 * }
 */
export function regExpParser_run(receiver) {
    // Regular expressions are checked more strictly when either in 'u' or 'v' mode, or
    // when not using the looser interpretation of the syntax from ECMA-262 Annex B.
    ...
    for (const reference of receiver.groupNameReferences) {
        if (receiver.groupSpecifiers.get(reference.name) !== true) {
            regExpParser_error(receiver, There_is_no_capturing_group_named_0_in_this_regular_expression, reference.pos, reference.end - reference.pos, reference.name);
    ...
    for (const escape of receiver.decimalEscapes) {
        ...
        if (escape.value > receiver.numberOfCapturingGroups) {
            if (receiver.numberOfCapturingGroups > 0) {
                regExpParser_error(receiver, This_backreference_refers_to_a_group_that_does_not_exist_There_are_only_0_capturing_groups_in_this_regular_expression, escape.pos, escape.end - escape.pos, receiver.numberOfCapturingGroups);
            }
            else {
                regExpParser_error(receiver, This_backreference_refers_to_a_group_that_does_not_exist_There_are_no_capturing_groups_in_this_regular_expression, escape.pos, escape.end - escape.pos);
            }
        }
    }
}
