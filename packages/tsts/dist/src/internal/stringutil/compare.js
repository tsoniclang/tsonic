 ...
 * }
 */
export function EquateStringCaseInsensitive(a, b) {
    // !!!
    // return a == b || strings.ToUpper(a) == strings.ToUpper(b)
 ...
 * }
 */
export function EquateStringCaseSensitive(a, b) {
    return a === b;
}
/**
 ...
 * }
 */
export function GetStringEqualityComparer(ignoreCase) {
    if (ignoreCase) {
        return EquateStringCaseInsensitive;
    }
    return EquateStringCaseSensitive;
...
export const ComparisonEqual = 0;
 ...
 * }
 */
export function HasPrefix(s, prefix, caseSensitive) {
    if (caseSensitive) {
 ...
 * }
 */
export function HasSuffix(s, suffix, caseSensitive) {
    if (caseSensitive) {
 ...
 * }
 */
export function HasPrefixAndSuffixWithoutOverlap(s, prefix, suffix, caseSensitive) {
 ...
 * }
 */
export function CompareStringsCaseInsensitiveThenSensitive(a, b) {
