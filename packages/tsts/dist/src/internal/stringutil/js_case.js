...
import { specialCasingConditionFinalSigma, specialCasingMappings, unicodeCasedRanges, unicodeCaseIgnorableRanges, } from "./generated/js_case_generated.js";
...
const fromCodePoint = (r) => globalThis.String.fromCodePoint(r);
/**
 ...
 * }
 */
function isFinalSigmaContext(casedBefore, str, afterOffset) {
    return (casedBefore && !hasSigmaCasedAfter(str, afterOffset));
}
/**
 ...
 * }
 */
function hasSigmaCasedAfter(str, start) {
    let i = start;
    while (i < str.length) {
        const [r, advance] = decodeRuneAt(str, i);
        i += advance;
 ...
 * }
 */
function isUnicodeCaseIgnorable(r) {
    return Is(unicodeCaseIgnorableRanges, r);
}
//# sourceMappingURL=js_case.js.map