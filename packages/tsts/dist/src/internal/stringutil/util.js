...
import { DecodeLastRuneInString, DecodeRuneInBytesAt, DecodeRuneInString, DecodeRuneInStringAt, StringByteAt, StringByteLen, StringByteSlice, StringUtf8Bytes, } from "../../go/unicode/utf8.js";
...
const byteAt = (s, i) => StringByteAt(s, i);
 ...
 */
export const upperhex = "0123456789ABCDEF";
/**
 ...
 * }
 */
export function shouldEscapeForEncodeURI(b) {
    switch (true) {
 ...
 * }
 */
export function getByteOrderMarkLength(text) {
 ...
 * }
 */
export function RemoveByteOrderMark(text) {
 ...
 */
export const matchSlashSomething = regexp.MustCompile(`\\\\.`);
/**
 ...
 * }
 */
export function matchSlashReplacer(in_) {
 ...
 * }
 */
export function TruncateByRunes(str, maxLength) {
 ...
 * )
 */
export const SurrogateLowStart = 0xdc00;
/**
 ...
 * }
 */
export function CodePointToSurrogatePair(ch) {
    return utf16.EncodeRune(ch);
}
/**
 ...
 */
const surrogateUTF8Lead = 0xed;
const surrogateUTF8LeadBits = 0xd000;
const utf8ContMarker = 0x80;
const utf8ContMax = 0xbf;
const utf8ContMask = 0x3f;
const surrogateUTF8Byte1Min = 0xa0;
const surrogateUTF8Byte1Max = 0xbf;
/**
 ...
 * }
 */
export function EncodeJSStringRune(ch) {
 ...
 * }
 */
export function DecodeJSStringRune(s) {
 ...
 */
export function CombineSurrogatePairs(s) {
