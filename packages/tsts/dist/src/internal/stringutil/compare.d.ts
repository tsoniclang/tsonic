 ...
 * }
 */
export declare function EquateStringCaseInsensitive(a: string, b: string): bool;
/**
 ...
 * }
 */
export declare function EquateStringCaseSensitive(a: string, b: string): bool;
/**
 ...
 * }
 */
export declare function GetStringEqualityComparer(ignoreCase: bool): (a: string, b: string) => bool;
/**
 ...
 * )
 */
export declare const ComparisonLessThan: Comparison;
export declare const ComparisonEqual: Comparison;
export declare const ComparisonGreaterThan: Comparison;
/**
 ...
 * }
 */
export declare function CompareStringsCaseSensitive(a: string, b: string): Comparison;
/**
 ...
 * }
 */
export declare function GetStringComparer(ignoreCase: bool): (a: string, b: string) => Comparison;
/**
 ...
 * }
 */
export declare function HasPrefix(s: string, prefix: string, caseSensitive: bool): bool;
/**
 ...
 * }
 */
export declare function HasSuffix(s: string, suffix: string, caseSensitive: bool): bool;
/**
 ...
 * }
 */
export declare function HasPrefixAndSuffixWithoutOverlap(s: string, prefix: string, suffix: string, caseSensitive: bool): bool;
/**
 ...
 * }
 */
export declare function CompareStringsCaseInsensitiveThenSensitive(a: string, b: string): Comparison;
/**
