 ...
 */
export declare let __1046bc8a_0: ResolutionHost;
export declare function projectReferenceDtsFakingHost_as_module_ResolutionHost(receiver: GoPtr<projectReferenceDtsFakingHost>): ResolutionHost;
/**
 ...
 * }
 */
export declare function newProjectReferenceDtsFakingHost(loader: GoPtr<fileLoader>): ResolutionHost;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingHost_FS(receiver: GoPtr<projectReferenceDtsFakingHost>): FS_c26bca9d;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingHost_GetCurrentDirectory(receiver: GoPtr<projectReferenceDtsFakingHost>): string;
/**
 ...
 */
export declare let __fca3b3b1_0: FS_c26bca9d;
export declare function projectReferenceDtsFakingVfs_as_vfs_FS(receiver: GoPtr<projectReferenceDtsFakingVfs>): FS_c26bca9d;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_UseCaseSensitiveFileNames(receiver: GoPtr<projectReferenceDtsFakingVfs>): bool;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_FileExists(receiver: GoPtr<projectReferenceDtsFakingVfs>, path: string): bool;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_ReadFile(receiver: GoPtr<projectReferenceDtsFakingVfs>, path: string): [string, bool];
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_WriteFile(receiver: GoPtr<projectReferenceDtsFakingVfs>, path: string, data: string): GoError;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_AppendFile(receiver: GoPtr<projectReferenceDtsFakingVfs>, path: string, data: string): GoError;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_Remove(receiver: GoPtr<projectReferenceDtsFakingVfs>, path: string): GoError;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_Chtimes(receiver: GoPtr<projectReferenceDtsFakingVfs>, path: string, aTime: Time, mTime: Time): GoError;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_DirectoryExists(receiver: GoPtr<projectReferenceDtsFakingVfs>, path: string): bool;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_GetAccessibleEntries(receiver: GoPtr<projectReferenceDtsFakingVfs>, path: string): Entries;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_Stat(receiver: GoPtr<projectReferenceDtsFakingVfs>, path: string): FileInfo;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_WalkDir(receiver: GoPtr<projectReferenceDtsFakingVfs>, root: string, walkFn: WalkDirFunc): GoError;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_Realpath(receiver: GoPtr<projectReferenceDtsFakingVfs>, path: string): string;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_toPath(receiver: GoPtr<projectReferenceDtsFakingVfs>, path: string): Path;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_handleDirectoryCouldBeSymlink(receiver: GoPtr<projectReferenceDtsFakingVfs>, directory: string): void;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_fileOrDirectoryExistsUsingSource(receiver: GoPtr<projectReferenceDtsFakingVfs>, fileOrDirectory: string, isFile: bool): bool;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_fileExistsIfProjectReferenceDts(receiver: GoPtr<projectReferenceDtsFakingVfs>, file: string): Tristate;
/**
 ...
 * }
 */
export declare function projectReferenceDtsFakingVfs_directoryExistsIfProjectReferenceDeclDir(receiver: GoPtr<projectReferenceDtsFakingVfs>, dir: string): Tristate;
//# sourceMappingURL=projectreferencedtsfakinghost.d.ts.map