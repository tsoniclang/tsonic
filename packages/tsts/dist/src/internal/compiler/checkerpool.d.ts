 ...
 */
export declare let __34031131_0: CheckerPool;
export declare function checkerPool_as_compiler_CheckerPool(receiver: GoPtr<checkerPool>): CheckerPool;
/**
 ...
 * }
 */
export declare function newCheckerPool(program: GoPtr<Program>): GoPtr<checkerPool>;
/**
 ...
 * }
 */
export declare function newCheckerPoolWithTracing(program: GoPtr<Program>, tr: GoPtr<Tracing>): GoPtr<checkerPool>;
/**
 ...
 * }
 */
export declare function checkerPool_GetChecker(receiver: GoPtr<checkerPool>, ctx: Context, file: GoPtr<SourceFile>): [GoPtr<Checker>, () => void];
/**
 ...
 * }
 */
export declare function checkerPool_getCheckerForFileNonExclusive(receiver: GoPtr<checkerPool>, file: GoPtr<SourceFile>): [GoPtr<Checker>, () => void];
/**
 ...
 * }
 */
export declare function checkerPool_getCheckerForFileExclusive(receiver: GoPtr<checkerPool>, ctx: Context, file: GoPtr<SourceFile>): [GoPtr<Checker>, () => void];
/**
 ...
 * }
 */
export declare function checkerPool_getCheckerNonExclusive(receiver: GoPtr<checkerPool>): [GoPtr<Checker>, () => void];
/**
 ...
 * }
 */
export declare function checkerPool_createCheckers(receiver: GoPtr<checkerPool>): void;
/**
 ...
 * }
 */
export declare function checkerPool_forEachCheckerParallel(receiver: GoPtr<checkerPool>, cb: (idx: int, c: GoPtr<Checker>) => void): void;
/**
 ...
 * }
 */
export declare function checkerPool_GetGlobalDiagnostics(receiver: GoPtr<checkerPool>): GoSlice<GoPtr<Diagnostic>>;
/**
 ...
 * }
 */
export declare function checkerPool_forEachCheckerGroupDo(receiver: GoPtr<checkerPool>, ctx: Context, files: GoSlice<GoPtr<SourceFile>>, singleThreaded: bool, cb: (c: GoPtr<Checker>, fileIndex: int, file: GoPtr<SourceFile>) => void): void;
/**
...
//# sourceMappingURL=checkerpool.d.ts.map