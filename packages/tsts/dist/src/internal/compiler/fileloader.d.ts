 ...
 * }
 */
export declare function fileLoader_resolveAutomaticTypeDirectives(receiver: GoPtr<fileLoader>, containingFileName: string): [GoSlice<resolvedRef>, ModeAwareCache, GoSlice<DiagAndArgs>, GoSlice<GoPtr<processingDiagnostic>>];
/**
 ...
 * }
 */
export declare function fileLoader_getSourceFileFromReference(receiver: GoPtr<fileLoader>, fileName: string, referenceText: string, containingFile: string): [string, GoPtr<sourceFileFromReferenceDiagnostic>];
/**
 ...
 * }
 */
export declare function fileLoader_createSyntheticImport(receiver: GoPtr<fileLoader>, text: string, file: GoPtr<SourceFile>): GoPtr<GoUnresolved<"github.com/microsoft/typescript-go/internal/ast.StringLiteralNode">>;
/**
