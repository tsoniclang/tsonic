 ...
 * }
 */
export declare function includeProcessor_getCompilerOptionsObjectLiteralSyntax(receiver: GoPtr<includeProcessor>, program: GoPtr<Program>): GoPtr<GoUnresolved<"github.com/microsoft/typescript-go/internal/ast.ObjectLiteralExpression">>;
/**
