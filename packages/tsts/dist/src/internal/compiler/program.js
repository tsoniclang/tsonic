 ...
 * }
 */
export function ProgramOptions_canUseProjectReferenceSource(receiver) {
    return (receiver.UseSourceOfProjectReference === true && !Tristate_IsTrue(ParsedCommandLine_CompilerOptions(receiver.Config).DisableSourceOfProjectReferenceRedirect));
}
/**
 ...
 * }
 */
export function lazyValue_getValue(receiver, compute) {
    receiver.once.Do(() => {
        if (receiver.value === undefined) {
            receiver.value = compute();
        }
        receiver.initialized.Store(true);
    });
 ...
 * }
 */
export function lazyValue_tryReuse(receiver, from_) {
 ...
 * }
 */
export function Program_FileExists(receiver, path) {
 ...
 * }
 */
export function Program_GetCurrentDirectory(receiver) {
 ...
 * }
 */
export function Program_GetGlobalTypingsCacheLocation(receiver) {
 ...
 * }
 */
export function Program_GetNearestAncestorDirectoryWithPackageJson(receiver, dirname) {
 ...
 * }
 */
export function Program_GetPackageJsonInfo(receiver, pkgJsonPath) {
 ...
 * }
 */
export function Program_GetRedirectTargets(receiver, path) {
 ...
 * }
 */
export function Program_GetSourceOfProjectReferenceIfOutputIncluded(receiver, file) {
 ...
 * }
 */
export function Program_GetProjectReferenceFromSource(receiver, path) {
 ...
 * }
 */
export function Program_IsSourceFromProjectReference(receiver, path) {
 ...
 * }
 */
export function Program_GetProjectReferenceFromOutputDts(receiver, path) {
 ...
 * }
 */
export function Program_GetResolvedProjectReferenceFor(receiver, path) {
 ...
 * }
 */
export function Program_GetRedirectForResolution(receiver, file) {
 ...
 * }
 */
export function Program_GetParseFileRedirect(receiver, fileName) {
 ...
 * }
 */
export function Program_GetResolvedProjectReferences(receiver) {
 ...
 * }
 */
export function Program_RangeResolvedProjectReference(receiver, f) {
 ...
 * }
 */
export function Program_RangeResolvedProjectReferenceInChildConfig(receiver, childConfig, f) {
 ...
 * }
 */
export function Program_UseCaseSensitiveFileNames(receiver) {
 ...
 * }
 */
export function Program_UsesUriStyleNodeCoreModules(receiver) {
    return receiver.usesUriStyleNodeCoreModules;
}
export function Program_as_outputpaths_OutputPathsHost(receiver) {
    return {
        CommonSourceDirectory: () => Program_CommonSourceDirectory(receiver),
        GetCurrentDirectory: () => Program_GetCurrentDirectory(receiver),
        UseCaseSensitiveFileNames: () => Program_UseCaseSensitiveFileNames(receiver),
    };
}
export function Program_as_emitter_SourceFileMayBeEmittedHost(receiver) {
    return {
        Options: () => Program_Options(receiver),
        GetProjectReferenceFromSource: (path) => Program_GetProjectReferenceFromSource(receiver, path),
        IsSourceFileFromExternalLibrary: (file) => Program_IsSourceFileFromExternalLibrary(receiver, file),
        GetCurrentDirectory: () => Program_GetCurrentDirectory(receiver),
        UseCaseSensitiveFileNames: () => Program_UseCaseSensitiveFileNames(receiver),
        SourceFiles: () => Program_SourceFiles(receiver),
    };
}
export function Program_as_modulespecifiers_ModuleSpecifierGenerationHost(receiver) {
    return {
        GetSymlinkCache: () => Program_GetSymlinkCache(receiver),
        CommonSourceDirectory: () => Program_CommonSourceDirectory(receiver),
        GetGlobalTypingsCacheLocation: () => Program_GetGlobalTypingsCacheLocation(receiver),
        UseCaseSensitiveFileNames: () => Program_UseCaseSensitiveFileNames(receiver),
        GetCurrentDirectory: () => Program_GetCurrentDirectory(receiver),
        GetProjectReferenceFromSource: (path) => Program_GetProjectReferenceFromSource(receiver, path),
        GetRedirectTargets: (path) => Program_GetRedirectTargets(receiver, path),
        GetSourceOfProjectReferenceIfOutputIncluded: (file) => Program_GetSourceOfProjectReferenceIfOutputIncluded(receiver, file),
        FileExists: (path) => Program_FileExists(receiver, path),
        GetNearestAncestorDirectoryWithPackageJson: (dirname) => Program_GetNearestAncestorDirectoryWithPackageJson(receiver, dirname),
        GetPackageJsonInfo: (pkgJsonPath) => Program_GetPackageJsonInfo(receiver, pkgJsonPath),
        GetDefaultResolutionModeForFile: (file) => Program_GetDefaultResolutionModeForFile(receiver, file),
        GetResolvedModuleFromModuleSpecifier: (file, moduleSpecifier) => Program_GetResolvedModuleFromModuleSpecifier(receiver, file, moduleSpecifier),
        GetModeForUsageLocation: (file, moduleSpecifier) => Program_GetModeForUsageLocation(receiver, file, moduleSpecifier),
    };
}
export function Program_as_checker_Host(receiver) {
    return {
...
export function Program_as_checker_Program(receiver) {
    const adapter = {
        ...
        GetRedirectTargets: (path) => Program_GetRedirectTargets(receiver, path),
        GetSourceOfProjectReferenceIfOutputIncluded: (file) => Program_GetSourceOfProjectReferenceIfOutputIncluded(receiver, file),
        FileExists: (fileName) => Program_FileExists(receiver, fileName),
        GetNearestAncestorDirectoryWithPackageJson: (dirname) => Program_GetNearestAncestorDirectoryWithPackageJson(receiver, dirname),
        GetPackageJsonInfo: (pkgJsonPath) => Program_GetPackageJsonInfo(receiver, pkgJsonPath),
        GetDefaultResolutionModeForFile: (file) => Program_GetDefaultResolutionModeForFile(receiver, file),
        GetResolvedModuleFromModuleSpecifier: (file, moduleSpecifier) => Program_GetResolvedModuleFromModuleSpecifier(receiver, file, moduleSpecifier),
        ...
        Options: () => Program_Options(receiver),
        SourceFiles: () => Program_SourceFiles(receiver),
        BindSourceFiles: () => Program_BindSourceFiles(receiver),
        GetSourceFile: (fileName) => Program_GetSourceFile(receiver, fileName),
        GetSourceFileForResolvedModule: (fileName) => Program_GetSourceFileForResolvedModule(receiver, fileName),
        GetEmitModuleFormatOfFile: (sourceFile) => Program_GetEmitModuleFormatOfFile(receiver, sourceFile),
        GetEmitSyntaxForUsageLocation: (sourceFile, usageLocation) => Program_GetEmitSyntaxForUsageLocation(receiver, sourceFile, usageLocation),
        GetImpliedNodeFormatForEmit: (sourceFile) => Program_GetImpliedNodeFormatForEmit(receiver, sourceFile),
        GetResolvedModule: (currentSourceFile, moduleReference, mode) => Program_GetResolvedModule(receiver, currentSourceFile, moduleReference, mode),
        GetResolvedModules: () => Program_GetResolvedModules(receiver),
        GetPackagesMap: () => Program_GetPackagesMap(receiver),
        GetSourceFileMetaData: (path) => Program_GetSourceFileMetaData(receiver, path),
        GetJSXRuntimeImportSpecifier: (path) => Program_GetJSXRuntimeImportSpecifier(receiver, path),
        GetImportHelpersImportSpecifier: (path) => Program_GetImportHelpersImportSpecifier(receiver, path),
        SourceFileMayBeEmitted: (sourceFile, forceDtsEmit) => Program_SourceFileMayBeEmitted(receiver, sourceFile, forceDtsEmit),
        IsSourceFileDefaultLibrary: (path) => Program_IsSourceFileDefaultLibrary(receiver, path),
        GetProjectReferenceFromOutputDts: (path) => Program_GetProjectReferenceFromOutputDts(receiver, path),
        GetRedirectForResolution: (file) => Program_GetRedirectForResolution(receiver, file),
    };
 ...
 */
export let __7d754c38_0 = Program_as_checker_Program(undefined);
/**
 ...
 * }
 */
export function Program_GetSourceFileFromReference(receiver, origin, ref) {
 ...
 * }
 */
export function NewProgram(opts) {
    ...
    const p = {
        ...
        comparePathsOptions: { UseCaseSensitiveFileNames: false, CurrentDirectory: "" },
        __tsgoEmbedded0: pf,
        ...
        packagesMap: new globalThis.Map(),
    };
 ...
 * }
 */
export function Program_UpdateProgram(receiver, changedFilePath, newHost, createCheckerPool) {
    const newOpts = { ...receiver.opts, Host: newHost };
    ...
    const resultPf = { ...pf };
    const resultUnresolvedImports = { value: undefined, once: new Once(), initialized: new Bool() };
    const resultKnownSymlinks = { value: undefined, once: new Once(), initialized: new Bool() };
    const resultPackageNames = { value: undefined, once: new Once(), initialized: new Bool() };
    const result = {
        opts: newOpts,
        checkerPool: undefined,
        compilerCheckerPool: undefined,
    ...
    const index = FindIndex(resultPf.files, (file) => (SourceFile_Path(file) === SourceFile_Path(newFile)));
 ...
 * }
 */
export function Program_initCheckerPool(receiver) {
 ...
 * }
 */
export function Program_GetCheckerPool(receiver) {
 ...
 * }
 */
export function canReplaceFileInProgram(file1, file2) {
 ...
 * }
 */
export function Program_needsImportHelpersImportSpecifier(receiver, file) {
    ...
    const optionsForFile = GetCompilerOptionsWithRedirect(ParsedCommandLine_CompilerOptions(receiver.opts.Config), redirect !== undefined ? ParsedCommandLine_as_ResolvedProjectReference(redirect) : undefined);
 ...
 * }
 */
export function equalModuleSpecifiers(n1, n2) {
    return (n1.Kind === n2.Kind && (!IsStringLiteral(n1) || Node_Text(n1) === Node_Text(n2)));
}
/**
 ...
 * }
 */
export function equalModuleAugmentationNames(n1, n2) {
    return (n1.Kind === n2.Kind && Node_Text(n1) === Node_Text(n2));
}
/**
 ...
 * }
 */
export function equalFileReferences(f1, f2) {
    return (f1.FileName === f2.FileName && f1.ResolutionMode === f2.ResolutionMode && f1.Preserve === f2.Preserve);
}
/**
 ...
 * }
 */
export function equalCheckJSDirectives(d1, d2) {
    return (d1 === undefined && d2 === undefined || d1 !== undefined && d2 !== undefined && d1.Enabled === d2.Enabled);
}
/**
 ...
 */
export function Program_SourceFiles(receiver) {
 ...
 */
export function Program_DuplicateSourceFiles(receiver) {
 ...
 */
export function Program_CommandLine(receiver) {
 ...
 */
export function Program_Host(receiver) {
 ...
 */
export function Program_Tracing(receiver) {
 ...
 * }
 */
export function Program_GetUnresolvedImports(receiver) {
 ...
 * }
 */
export function Program_extractUnresolvedImports(receiver) {
    const unresolvedSet = { M: new Map() };
 ...
 * }
 */
export function Program_extractUnresolvedImportsFromSourceFile(receiver, file) {
    ...
    if (resolvedModules !== undefined) {
        for (const [cacheKey, resolution_] of resolvedModules) {
            ...
            if ((!resolved || (!ResolvedModule_IsProviderVirtual(resolution) && !ExtensionIsOneOf(resolution.Extension, SupportedTSExtensionsWithJsonFlat))) &&
 ...
 * }
 */
export function Program_SingleThreaded(receiver) {
 ...
 * }
 */
export function Program_BindSourceFiles(receiver) {
 ...
 * }
 */
export function Program_GetTypeChecker(receiver, ctx) {
 ...
 * }
 */
export function Program_ForEachCheckerParallel(receiver, cb) {
    if (receiver.compilerCheckerPool !== undefined) {
 ...
 * }
 */
export function Program_GetTypeCheckerForFile(receiver, ctx, file) {
    if (receiver.compilerCheckerPool !== undefined) {
 ...
 * }
 */
export function Program_GetTypeCheckerForFileExclusive(receiver, ctx, file) {
    if (receiver.compilerCheckerPool !== undefined) {
 ...
 * }
 */
export function Program_GetResolvedModule(receiver, file, moduleReference, mode) {
 ...
 * }
 */
export function Program_GetResolvedModuleFromModuleSpecifier(receiver, file, moduleSpecifier) {
 ...
 * }
 */
export function Program_GetResolvedModules(receiver) {
 ...
 * }
 */
export function Program_GetPackagesMap(receiver) {
    receiver.packagesMapOnce.Do(() => {
        receiver.packagesMap = new globalThis.Map();
        for (const [, resolvedModulesInFile] of receiver.__tsgoEmbedded0.resolvedModules ?? []) {
            for (const [, mod] of resolvedModulesInFile ?? []) {
                ...
                if (m !== undefined && !ResolvedModule_IsProviderVirtual(m) && m.PackageId !== undefined && m.PackageId.Name !== "") {
                    receiver.packagesMap.set(m.PackageId.Name, (receiver.packagesMap.get(m.PackageId.Name) || (m.Extension === ".d.ts")));
                }
            }
        }
    });
 ...
 * }
 */
export function Program_collectDiagnostics(receiver, ctx, sourceFile, concurrent, collect) {
    let result;
 ...
 * }
 */
export function Program_collectDiagnosticsFromFiles(receiver, ctx, sourceFiles, concurrent, collect) {
    const diagnostics = new Array(sourceFiles.length);
 ...
 * }
 */
export function Program_collectCheckerDiagnostics(receiver, ctx, sourceFile, collect) {
    if (sourceFile !== undefined) {
        if (Program_SkipTypeChecking(receiver, sourceFile, false)) {
            return undefined;
        }
 ...
 * }
 */
export function Program_collectCheckerDiagnosticsFromFiles(receiver, ctx, sourceFiles, collect) {
    const diagnostics = new Array(sourceFiles.length);
    if (receiver.compilerCheckerPool !== undefined) {
        ...
        for (let i = 0; i < sourceFiles.length; i++) {
            ...
            if (Program_SkipTypeChecking(receiver, file, false)) {
                continue;
            }
 ...
 * }
 */
export function Program_GetSyntacticDiagnostics(receiver, ctx, sourceFile) {
    return Program_collectDiagnostics(receiver, ctx, sourceFile, false, (_, file) => {
 ...
 * }
 */
export function getAdditionalJSSyntacticDiagnostics(file, options) {
 ...
 * }
 */
export function Program_GetBindDiagnostics(receiver, ctx, sourceFile) {
    if (sourceFile !== undefined) {
 ...
 * }
 */
export function Program_GetSemanticDiagnostics(receiver, ctx, sourceFile) {
 ...
 * }
 */
export function Program_GetSemanticDiagnosticsWithoutNoEmitFiltering(receiver, ctx, sourceFiles) {
 ...
 * }
 */
export function Program_GetSuggestionDiagnostics(receiver, ctx, sourceFile) {
...
export function Program_GetProgramDiagnostics(receiver) {
    return SortAndDeduplicateDiagnostics(Concatenate(receiver.programDiagnostics, DiagnosticsCollection_GetGlobalDiagnostics(includeProcessor_getDiagnostics(receiver.__tsgoEmbedded0.includeProcessor, receiver))));
}
/**
 ...
 * }
 */
export function Program_GetIncludeProcessorDiagnostics(receiver, sourceFile) {
    if (Program_SkipTypeChecking(receiver, sourceFile, false)) {
        return undefined;
    }
    const [filtered] = Program_getDiagnosticsWithPrecedingDirectives(receiver, sourceFile, DiagnosticsCollection_GetDiagnosticsForFile(includeProcessor_getDiagnostics(receiver.__tsgoEmbedded0.includeProcessor, receiver), SourceFile_FileName(sourceFile)));
    return filtered;
}
/**
 ...
 * }
 */
export function Program_SkipTypeChecking(receiver, sourceFile, ignoreNoCheck) {
    return ((!ignoreNoCheck && Tristate_IsTrue(Program_Options(receiver).NoCheck)) ||
 ...
 * }
 */
export function Program_canIncludeBindAndCheckDiagnostics(receiver, sourceFile) {
 ...
 * }
 */
export function Program_getSourceFilesToEmit(receiver, targetSourceFile, forceDtsEmit) {
    if (targetSourceFile === undefined && !forceDtsEmit) {
        receiver.sourceFilesToEmitOnce.Do(() => {
            receiver.sourceFilesToEmit = getSourceFilesToEmit(Program_as_emitter_SourceFileMayBeEmittedHost(receiver), undefined, false);
        });
 ...
 * }
 */
export function Program_verifyCompilerOptions(receiver) {
    ...
    const createOptionDiagnosticInObjectLiteralSyntax = (objectLiteral, onKey, key1, key2, message, ...args) => {
    ...
    const createCompilerOptionsDiagnostic = (message, ...args) => {
        const compilerOptionsProperty = getCompilerOptionsPropertySyntax();
        let diag;
        if (compilerOptionsProperty !== undefined) {
    ...
    const createDiagnosticForOption = (onKey, option1, option2, message, ...args) => {
    ...
    const createDiagnosticForOptionName = (message, option1, option2, ...args) => {
        createDiagnosticForOption(true, option1, option2, message, option1, option2, ...args);
    };
    const createOptionValueDiagnostic = (option1, message, ...args) => {
        createDiagnosticForOption(false, option1, "", message, ...args);
    };
    const createRemovedOptionDiagnostic = (name, value, useInstead) => {
        let message;
        let args;
        if (value === "") {
            message = diagnostics.Option_0_has_been_removed_Please_remove_it_from_your_configuration;
    ...
    if (Tristate_IsTrue(options.Composite)) {
        const rootPaths = { M: new globalThis.Map() };
        for (const fileName of ParsedCommandLine_FileNames(receiver.opts.Config)) {
            Set_Add(rootPaths, Program_toPath(receiver, fileName));
        }
        for (const file of receiver.__tsgoEmbedded0.files) {
            if (sourceFileMayBeEmitted(file, Program_as_emitter_SourceFileMayBeEmittedHost(receiver), false) && !Set_Has(rootPaths, SourceFile_Path(file))) {
    ...
    const forEachOptionPathsSyntax = (callback) => {
        return ForEachPropertyAssignment(getCompilerOptionsObjectLiteralSyntax(), "paths", callback);
    };
    const createDiagnosticForOptionPaths = (onKey, key, message, ...args) => {
    ...
    const createDiagnosticForOptionPathKeyValue = (key, valueIndex, message, ...args) => {
        let diag = forEachOptionPathsSyntax((pathProp) => {
            if (IsObjectLiteralExpression(pathProp.Initializer)) {
    ...
    OrderedMap_Entries(options.Paths)((key, value) => {
        if (!hasZeroOrOneAsteriskCharacter(key)) {
    ...
    if (Tristate_IsTrue(options.IsolatedModules) || Tristate_IsTrue(options.VerbatimModuleSyntax)) {
        if (Tristate_IsFalse(options.PreserveConstEnums)) {
            createDiagnosticForOptionName(diagnostics.Option_preserveConstEnums_cannot_be_disabled_when_0_is_enabled, Tristate_IsTrue(options.VerbatimModuleSyntax) ? "verbatimModuleSyntax" : "isolatedModules", "preserveConstEnums");
        }
    }
    if (options.OutDir !== "" ||
        options.RootDir !== "" ||
    ...
    if (!Tristate_IsTrue(options.NoEmit) &&
        ...
        const emittedFiles = [];
        for (const file of receiver.__tsgoEmbedded0.files) {
            if (!file.IsDeclarationFile && sourceFileMayBeEmitted(file, Program_as_emitter_SourceFileMayBeEmittedHost(receiver), false)) {
        ...
        if (dir59 !== "" && GetCanonicalFileName(dir, Program_UseCaseSensitiveFileNames(receiver)) !== GetCanonicalFileName(dir59, Program_UseCaseSensitiveFileNames(receiver))) {
            ...
            const diag = createDiagnosticForOption(true, option1, option2, diagnostics.The_common_source_directory_of_0_is_1_The_rootDir_setting_must_be_explicitly_set_to_this_or_another_path_to_adjust_your_output_s_file_layout, GetBaseFileName(options.ConfigFilePath), GetRelativePathFromFile(options.ConfigFilePath, dir59, receiver.comparePathsOptions));
    ...
    if (!Tristate_IsTrue(options.NoEmit) && !Tristate_IsTrue(options.SuppressOutputPathCheck)) {
        const emitFilesSeen = { M: new globalThis.Map() };
        const verifyEmitFilePath = (emitFileName) => {
            if (emitFileName !== "") {
        ...
        ForEachEmittedFile(Program_as_outputpaths_OutputPathsHost(receiver), options, (emitFileNames, _sourceFile) => {
            ...
            return false;
        }, Program_getSourceFilesToEmit(receiver, undefined, false), false);
 ...
 * }
 */
export function Program_blockEmittingOfFile(receiver, emitFileName, diag) {
 ...
 * }
 */
export function Program_IsEmitBlocked(receiver, emitFileName) {
 ...
 * }
 */
export function Program_verifyProjectReferences(receiver) {
    ...
    const createDiagnosticForReference = (config, index, message, ...args) => {
 ...
 * }
 */
export function moduleResolutionSupportsPackageJsonExportsAndImports(moduleResolution) {
 ...
 * }
 */
export function emitModuleKindIsNonNodeESM(moduleKind) {
 ...
 * }
 */
export function Program_GetDeclarationDiagnostics(receiver, ctx, sourceFile) {
    return Program_collectDiagnostics(receiver, ctx, sourceFile, true, Program_getDeclarationDiagnosticsForFile.bind(undefined, receiver));
}
/**
 ...
 * }
 */
export function FilterNoEmitSemanticDiagnostics(diags, options) {
    if (!Tristate_IsTrue(options.NoEmit)) {
        return diags;
    }
 ...
 * }
 */
export function Program_getSemanticDiagnosticsWithChecker(receiver, ctx, c, sourceFile) {
    return Concatenate(FilterNoEmitSemanticDiagnostics(Program_getBindAndCheckDiagnosticsWithChecker(receiver, ctx, c, sourceFile), Program_Options(receiver)), Program_GetIncludeProcessorDiagnostics(receiver, sourceFile));
}
/**
 ...
 * }
 */
export function Program_getBindAndCheckDiagnosticsWithChecker(receiver, ctx, fileChecker, sourceFile) {
    const compilerOptions = Program_Options(receiver);
    if (Program_SkipTypeChecking(receiver, sourceFile, false)) {
        return undefined;
    }
    recordBoundSourceFileExtensionFacts(receiver.opts, sourceFile);
    let diags = slices.Clip(SourceFile_BindDiagnostics(sourceFile)) ?? [];
    ...
    if (isPlainJS) {
        return Filter(diags, (d) => Set_Has(plainJSErrors, Diagnostic_Code(d)));
    }
    const isJS = sourceFile.ScriptKind === ScriptKindJS || sourceFile.ScriptKind === ScriptKindJSX;
 ...
 * }
 */
export function Program_getDiagnosticsWithPrecedingDirectives(receiver, sourceFile, diags) {
    if (sourceFile.CommentDirectives === undefined || sourceFile.CommentDirectives.length === 0) {
        return [diags, undefined];
    }
    const directivesByLine = new globalThis.Map();
    const sourceFileLike = { Text: () => SourceFile_Text(sourceFile), ECMALineMap: () => SourceFile_ECMALineMap(sourceFile) };
 ...
 * }
 */
export function Program_getDeclarationDiagnosticsForFile(receiver, ctx, sourceFile) {
    if (sourceFile.IsDeclarationFile) {
        return [];
    }
    ...
    return stored !== undefined ? stored : diags;
}
/**
 ...
 * }
 */
export function Program_getSuggestionDiagnosticsWithChecker(receiver, ctx, fileChecker, sourceFile) {
    if (Program_SkipTypeChecking(receiver, sourceFile, false)) {
        return undefined;
    }
    let diags = slices.Clip(sourceFile.BindSuggestionDiagnostics) ?? [];
 ...
 * }
 */
export function isCommentOrBlankLine(text, pos) {
    ...
    return (pos === n ||
        ...
        (pos + 1 < n && byteAt(text, pos) === 0x2f /* '/' */ && byteAt(text, pos + 1) === 0x2f /* '/' */));
}
/**
 ...
 * }
 */
export function SortAndDeduplicateDiagnostics(diags) {
 ...
 * }
 */
export function compactAndMergeRelatedInfos(diags) {
 ...
 * }
 */
export function Program_LineCount(receiver) {
    let count = 0;
    for (const file of receiver.__tsgoEmbedded0.files) {
 ...
 * }
 */
export function Program_IdentifierCount(receiver) {
    let count = 0;
    for (const file of receiver.__tsgoEmbedded0.files) {
        count += file.IdentifierCount;
    }
 ...
 * }
 */
export function Program_SymbolCount(receiver) {
    let count = 0;
    for (const file of receiver.__tsgoEmbedded0.files) {
        count += file.SymbolCount;
    }
 ...
 * }
 */
export function Program_TypeCount(receiver) {
    let count = 0;
    Program_ForEachCheckerParallel(receiver, (_, c) => {
        count += c.TypeCount;
    });
 ...
 * }
 */
export function Program_InstantiationCount(receiver) {
    let count = 0;
    Program_ForEachCheckerParallel(receiver, (_, c) => {
 ...
 * }
 */
export function Program_GetSourceFileMetaData(receiver, path) {
 ...
 * }
 */
function Program_getCompilerOptionsForFile(receiver, sourceFile) {
...
export function Program_GetEmitModuleFormatOfFile(receiver, sourceFile) {
    return GetEmitModuleFormatOfFileWorker(sourceFile.FileName(), Program_getCompilerOptionsForFile(receiver, sourceFile), Program_GetSourceFileMetaData(receiver, sourceFile.Path()));
}
/**
 ...
 * }
 */
export function Program_GetEmitSyntaxForUsageLocation(receiver, sourceFile, location) {
    return getEmitSyntaxForUsageLocationWorker(sourceFile.FileName(), receiver.__tsgoEmbedded0.sourceFileMetaDatas.get(sourceFile.Path()), location, Program_getCompilerOptionsForFile(receiver, sourceFile));
}
/**
 ...
 * }
 */
export function Program_GetImpliedNodeFormatForEmit(receiver, sourceFile) {
    return GetImpliedNodeFormatForEmitWorker(sourceFile.FileName(), CompilerOptions_GetEmitModuleKind(Program_getCompilerOptionsForFile(receiver, sourceFile)), Program_GetSourceFileMetaData(receiver, sourceFile.Path()));
}
/**
 ...
 * }
 */
export function Program_GetModeForUsageLocation(receiver, sourceFile, location) {
    return getModeForUsageLocation(sourceFile.FileName(), receiver.__tsgoEmbedded0.sourceFileMetaDatas.get(sourceFile.Path()), location, Program_getCompilerOptionsForFile(receiver, sourceFile));
}
/**
 ...
 * }
 */
export function Program_GetDefaultResolutionModeForFile(receiver, sourceFile) {
    return getDefaultResolutionModeForFile(sourceFile.FileName(), receiver.__tsgoEmbedded0.sourceFileMetaDatas.get(sourceFile.Path()), Program_getCompilerOptionsForFile(receiver, sourceFile));
}
/**
...
export function Program_IsSourceFileDefaultLibrary(receiver, path) {
    return receiver.__tsgoEmbedded0.libFiles.has(path);
}
/**
 ...
 * }
 */
export function Program_IsGlobalTypingsFile(receiver, fileName) {
    if (!IsDeclarationFileName(fileName)) {
        return false;
    }
    return ContainsPath(Program_GetGlobalTypingsCacheLocation(receiver), fileName, receiver.comparePathsOptions);
}
/**
 ...
 * }
 */
export function Program_GetDefaultLibFile(receiver, path) {
...
export function Program_CommonSourceDirectory(receiver) {
    receiver.commonSourceDirectoryOnce.Do(() => {
        receiver.commonSourceDirectory = GetCommonSourceDirectory(Program_Options(receiver), () => {
            const files = [];
            for (const file of receiver.__tsgoEmbedded0.files) {
                if (sourceFileMayBeEmitted(file, Program_as_emitter_SourceFileMayBeEmittedHost(receiver), false)) {
                    files.push(SourceFile_FileName(file));
                }
            }
            return files;
        }, Program_GetCurrentDirectory(receiver), Program_UseCaseSensitiveFileNames(receiver), (sourceFiles, rootDirectory) => Program_checkSourceFilesBelongToPath(receiver, sourceFiles, rootDirectory));
    });
 ...
 * }
 */
export function Program_checkSourceFilesBelongToPath(receiver, sourceFiles, rootDirectory) {
    ...
    for (const sourceFile of sourceFiles) {
        const e = {
            ...
            emitterDiagnostics: {
                ...
                fileDiagnosticsSorted: { M: new globalThis.Map() },
                nonFileDiagnostics: undefined,
                nonFileDiagnosticsSorted: false,
            },
            emitResult: { EmitSkipped: false, Diagnostics: [], EmittedFiles: [], SourceMaps: [] },
        };
        emitters.push(e);
        const [host, done] = newEmitHost(ctx, receiver, sourceFile);
 ...
 * }
 */
export function CombineEmitResults(results) {
    const result = {
        EmitSkipped: false,
        Diagnostics: [],
        EmittedFiles: [],
 ...
 * }
 */
export function HandleNoEmitOnError(ctx, program, file) {
    if (!Tristate_IsTrue(program.Options().NoEmitOnError)) {
        return undefined;
    }
    const diags = GetDiagnosticsOfAnyProgram(ctx, program, file, true, program.GetBindDiagnostics.bind(program), program.GetSemanticDiagnostics.bind(program));
    if (diags.length === 0) {
        return undefined;
    }
    return {
 ...
 * }
 */
export function GetDiagnosticsOfAnyProgram(ctx, program, file, skipNoEmitCheckForDtsDiagnostics, getBindDiagnostics, getSemanticDiagnostics) {
    let allDiagnostics = [...(slices.Clip(program.GetConfigFileParsingDiagnostics()) ?? [])];
 ...
 * }
 */
export function Program_toPath(receiver, filename) {
 ...
 * }
 */
export function Program_GetSourceFile(receiver, filename) {
 ...
 * }
 */
export function Program_GetSourceFileForResolvedModule(receiver, fileName) {
 ...
 * }
 */
export function Program_FilesByPath(receiver) {
 ...
 * }
 */
export function Program_GetSourceFileByPath(receiver, path) {
 ...
 * }
 */
export function Program_HasSameFileNames(receiver, other) {
    return (maps.EqualFunc(receiver.__tsgoEmbedded0.filesByPath, other.__tsgoEmbedded0.filesByPath, (a, b) => {
        return (SourceFile_FileName(a) === SourceFile_FileName(b));
    }) &&
 ...
 * }
 */
export function Program_GetIncludeReasons(receiver) {
 ...
 * }
 */
export function Program_IsMissingPath(receiver, path) {
    return slices.ContainsFunc(receiver.__tsgoEmbedded0.missingFiles, (missingPath) => {
        return (Program_toPath(receiver, missingPath) === path);
    });
}
/**
 ...
 * }
 */
export function Program_ExplainFiles(receiver, w, locale) {
    const encoder = new globalThis.TextEncoder();
    const writeStr = (s) => { w.Write(encoder.encode(s)); };
    const toRelativeFileName = (fileName) => {
    ...
    const explainFile = (file) => {
        writeStr(toRelativeFileName(file.FileName()) + "\n");
        const reasons = receiver.__tsgoEmbedded0.includeProcessor.fileIncludeReasons.get(file.Path());
        for (const reason of (reasons ?? [])) {
            writeStr("   " + Diagnostic_Localize(FileIncludeReason_toDiagnostic(reason, receiver, true), locale) + "\n");
        }
        for (const diag of (includeProcessor_explainRedirectAndImpliedFormat(receiver.__tsgoEmbedded0.includeProcessor, receiver, file.Path(), toRelativeFileName) ?? [])) {
    ...
    const explainSourceFiles = (endIndex) => {
 ...
 * }
 */
export function Program_GetLibFileFromReference(receiver, ref) {
    const [path, ok] = GetLibFileName(ref.FileName);
    if (!ok) {
        return undefined;
    }
    const sourceFile = receiver.__tsgoEmbedded0.filesByPath.get(path);
    if (sourceFile !== undefined) {
        return sourceFile;
    }
    return undefined;
 ...
 * }
 */
export function Program_GetResolvedTypeReferenceDirectiveFromTypeReferenceDirective(receiver, typeRef, sourceFile) {
 ...
 * }
 */
export function Program_GetResolvedTypeReferenceDirectives(receiver) {
 ...
 * }
 */
export function Program_getModeForTypeReferenceDirectiveInFile(receiver, ref, sourceFile) {
    if (ref.ResolutionMode !== ResolutionModeNone) {
        return ref.ResolutionMode;
    }
    return Program_GetDefaultResolutionModeForFile(receiver, sourceFile);
}
/**
 ...
 * }
 */
export function Program_IsSourceFileFromExternalLibrary(receiver, file) {
    return Set_Has(receiver.__tsgoEmbedded0.sourceFilesFoundSearchingNodeModules, SourceFile_Path(file));
}
/**
 ...
 * }
 */
export function Program_GetJSXRuntimeImportSpecifier(receiver, path) {
 ...
 * }
 */
export function Program_GetImportHelpersImportSpecifier(receiver, path) {
    return receiver.__tsgoEmbedded0.importHelpersImportSpecifiers.get(path);
}
/**
 ...
 * }
 */
export function Program_SourceFileMayBeEmitted(receiver, sourceFile, forceDtsEmit) {
 ...
 * }
 */
export function Program_ResolvedPackageNames(receiver) {
 ...
 * }
 */
export function Program_UnresolvedPackageNames(receiver) {
 ...
 * }
 */
export function Program_DeepImportPackageNames(receiver) {
 ...
 * }
 */
export function Program_collectPackageNames(receiver) {
    return lazyValue_getValue(receiver.packageNames, () => {
        const packageNames = {
            resolved: { M: new globalThis.Map() },
            unresolved: { M: new globalThis.Map() },
            deepImportPackages: { M: new globalThis.Map() },
        };
        for (const file of receiver.__tsgoEmbedded0.files) {
            if (Program_IsSourceFileDefaultLibrary(receiver, SourceFile_Path(file)) ||
            ...
            for (const imp of (SourceFile_Imports(file) ?? [])) {
                ...
                const resolvedModules = receiver.__tsgoEmbedded0.resolvedModules.get(SourceFile_Path(file));
                if (resolvedModules !== undefined) {
                    const mode = Program_GetModeForUsageLocation(receiver, SourceFile_as_ast_HasFileName(file), imp);
                        ...
                        if (name === "") {
                            ...
                            if (packageScope !== undefined && InfoCacheEntry_Exists(packageScope)) {
                                ...
                                if (contents !== undefined && contents.__tsgoEmbedded0 !== undefined && contents.__tsgoEmbedded0.__tsgoEmbedded0 !== undefined) {
                                    const [scopeName, ok] = Expected_GetValue(contents.__tsgoEmbedded0.__tsgoEmbedded0.Name);
                                    if (ok) {
                                        name = scopeName;
                                    }
                                }
 ...
 * }
 */
export function Program_IsLibFile(receiver, sourceFile) {
    return receiver.__tsgoEmbedded0.libFiles.has(SourceFile_Path(sourceFile));
}
/**
 ...
 * }
 */
export function Program_GetSymlinkCache(receiver) {
    return lazyValue_getValue(receiver.knownSymlinks, () => {
        ...
        if (receiver.__tsgoEmbedded0.resolvedModules.size > 0 || receiver.__tsgoEmbedded0.typeResolutionsInFile.size > 0) {
            KnownSymlinks_SetSymlinksFromResolutions(knownSymlinks, (cb, file) => Program_ForEachResolvedModule(receiver, cb, file), (cb, file) => Program_ForEachResolvedTypeReferenceDirective(receiver, cb, file));
        }
        const seenPackageJsons = { M: new globalThis.Map() };
        for (const [filePath, meta] of receiver.__tsgoEmbedded0.sourceFileMetaDatas) {
            if (meta.PackageJsonDirectory === "" ||
                !Program_SourceFileMayBeEmitted(receiver, Program_GetSourceFileByPath(receiver, filePath), false) ||
            ...
            for (const depUnknown of Set_Keys(runtimeDeps).keys()) {
                ...
                if (packageResolution !== undefined && ResolvedModule_IsResolved(packageResolution)) {
                    const resolved = packageResolution;
                    KnownSymlinks_ProcessResolution(knownSymlinks, CombinePaths(resolved.OriginalPath, "package.json"), CombinePaths(resolved.ResolvedFileName, "package.json"));
                }
            }
        }
        return knownSymlinks;
 ...
 * }
 */
export function Program_ResolveModuleName(receiver, moduleName, containingFile, resolutionMode) {
 ...
 * }
 */
export function Program_ForEachResolvedModule(receiver, callback, file) {
    forEachResolution(receiver.__tsgoEmbedded0.resolvedModules, callback, file);
}
/**
 ...
 * }
 */
export function Program_ForEachResolvedTypeReferenceDirective(receiver, callback, file) {
    forEachResolution(receiver.__tsgoEmbedded0.typeResolutionsInFile, callback, file);
}
/**
 ...
 * }
 */
const emptyResolutionCache = new globalThis.Map();
const emptyModeAwareCache = NewGoStructMap();
const goMapEntries = (map, empty) => map !== undefined ? map : empty;
const resolutionCacheEntries = (resolutionCache) => goMapEntries(resolutionCache, emptyResolutionCache);
const modeAwareCacheEntries = (modeAwareCache) => goMapEntries(modeAwareCache, emptyModeAwareCache);
export function forEachResolution(resolutionCache, callback, file) {
    if (file !== undefined) {
