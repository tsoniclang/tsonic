 ...
 */
export declare let __9ad05d82_0: CompilerHost;
export declare function compilerHost_as_compiler_CompilerHost(receiver: GoPtr<compilerHost>): CompilerHost;
/**
 ...
 * }
 */
export declare function NewCachedFSCompilerHost(currentDirectory: string, fs: FS_4e804012, defaultLibraryPath: string, extendedConfigCache: GoPtr<ExtendedConfigCache>, trace: GoPtr<(msg: GoPtr<Message>, ...args: Array<unknown>) => void>): CompilerHost;
/**
 ...
 * }
 */
export declare function NewCompilerHost(currentDirectory: string, fs: FS_4e804012, defaultLibraryPath: string, extendedConfigCache: GoPtr<ExtendedConfigCache>, trace: GoPtr<(msg: GoPtr<Message>, ...args: Array<unknown>) => void>): CompilerHost;
/**
 ...
 * }
 */
export declare function compilerHost_FS(receiver: GoPtr<compilerHost>): FS_4e804012;
/**
 ...
 * }
 */
export declare function compilerHost_DefaultLibraryPath(receiver: GoPtr<compilerHost>): string;
/**
 ...
 * }
 */
export declare function compilerHost_GetCurrentDirectory(receiver: GoPtr<compilerHost>): string;
/**
 ...
 * }
 */
export declare function compilerHost_Trace(receiver: GoPtr<compilerHost>, msg: GoPtr<Message>, ...args: Array<unknown>): void;
/**
 ...
 * }
 */
export declare function compilerHost_GetSourceFile(receiver: GoPtr<compilerHost>, opts: SourceFileParseOptions): GoPtr<SourceFile>;
/**
 ...
 * }
 */
export declare function compilerHost_GetResolvedProjectReference(receiver: GoPtr<compilerHost>, fileName: string, path: Path): GoPtr<ParsedCommandLine>;
