 ...
 * )
 */
export const processingDiagnosticKindUnknownReference = 0;
export const processingDiagnosticKindExplainingFileInclude = 1;
/**
 ...
 * }
 */
export function processingDiagnostic_asFileIncludeReason(receiver) {
 ...
 * }
 */
export function processingDiagnostic_asIncludeExplainingDiagnostic(receiver) {
    return receiver.data;
}
/**
 ...
 * }
 */
export function processingDiagnostic_toDiagnostic(receiver, program) {
        ...
        case processingDiagnosticKindUnknownReference: {
            ...
            switch (ref.kind) {
                ...
                case fileIncludeKindLibReferenceDirective: {
                    ...
                    return referenceFileLocation_diagnosticAt(loc, IfElse(suggestion !== "", Cannot_find_lib_definition_for_0_Did_you_mean_1, Cannot_find_lib_definition_for_0), libName, suggestion);
                }
                default:
 ...
 * }
 */
export function processingDiagnostic_createDiagnosticExplainingFile(receiver, program) {
    const diag = processingDiagnostic_asIncludeExplainingDiagnostic(receiver);
    let includeDetails = [];
    let relatedInfo = [];
    let redirectInfo = [];
    let preferredLocation = undefined;
    const seenReasons = { M: new globalThis.Map() };
    ...
    const processRelatedInfo = (includeReason) => {
    ...
    const processInclude = (includeReason) => {
    ...
    if (diag.file !== "") {
        ...
        redirectInfo = includeProcessor_explainRedirectAndImpliedFormat(includeProcessor, program, diag.file, (fileName) => fileName);
    }
...
//# sourceMappingURL=processingDiagnostic.js.map