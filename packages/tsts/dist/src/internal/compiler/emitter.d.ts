 ...
 * }
 */
export declare function emitter_printSourceFile(receiver: GoPtr<emitter>, jsFilePath: string, sourceMapFilePath: string, sourceFile: GoPtr<SourceFile>, printer_: GoPtr<Printer>, shouldEmitSourceMaps: bool): void;
/**
 ...
 * }
 */
export declare function shouldEmitDeclarationSourceMaps(mapOptions: GoPtr<CompilerOptions>, sourceFile: GoPtr<SourceFile>): bool;
/**
