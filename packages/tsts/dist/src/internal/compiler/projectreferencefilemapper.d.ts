 ...
 * }
 */
export declare function projectReferenceFileMapper_getParseFileRedirect(receiver: GoPtr<projectReferenceFileMapper>, file: HasFileName): string;
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_getResolvedProjectReferences(receiver: GoPtr<projectReferenceFileMapper>): GoSlice<GoPtr<ParsedCommandLine>>;
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_getProjectReferenceFromSource(receiver: GoPtr<projectReferenceFileMapper>, path: Path): GoPtr<SourceOutputAndProjectReference>;
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_getProjectReferenceFromOutputDts(receiver: GoPtr<projectReferenceFileMapper>, path: Path): GoPtr<SourceOutputAndProjectReference>;
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_isSourceFromProjectReference(receiver: GoPtr<projectReferenceFileMapper>, path: Path): bool;
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_getCompilerOptionsForFile(receiver: GoPtr<projectReferenceFileMapper>, file: HasFileName): GoPtr<CompilerOptions>;
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_getRedirectParsedCommandLineForResolution(receiver: GoPtr<projectReferenceFileMapper>, file: HasFileName): GoPtr<ParsedCommandLine>;
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_getRedirectForResolution(receiver: GoPtr<projectReferenceFileMapper>, file: HasFileName): [GoPtr<ParsedCommandLine>, string];
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_getResolvedReferenceFor(receiver: GoPtr<projectReferenceFileMapper>, path: Path): [GoPtr<ParsedCommandLine>, bool];
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_rangeResolvedProjectReference(receiver: GoPtr<projectReferenceFileMapper>, f: (path: Path, config: GoPtr<ParsedCommandLine>, parent: GoPtr<ParsedCommandLine>, index: int) => bool): bool;
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_rangeResolvedReferenceWorker(receiver: GoPtr<projectReferenceFileMapper>, references: GoSlice<Path>, f: (path: Path, config: GoPtr<ParsedCommandLine>, parent: GoPtr<ParsedCommandLine>, index: int) => bool, parent: GoPtr<ParsedCommandLine>, seenRef: GoPtr<Set<Path>>): bool;
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_rangeResolvedProjectReferenceInChildConfig(receiver: GoPtr<projectReferenceFileMapper>, childConfig: GoPtr<ParsedCommandLine>, f: (path: Path, config: GoPtr<ParsedCommandLine>, parent: GoPtr<ParsedCommandLine>, index: int) => bool): bool;
/**
 ...
 * }
 */
export declare function projectReferenceFileMapper_getSourceToDtsIfSymlink(receiver: GoPtr<projectReferenceFileMapper>, file: HasFileName): GoPtr<SourceOutputAndProjectReference>;
//# sourceMappingURL=projectreferencefilemapper.d.ts.map