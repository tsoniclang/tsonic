 ...
 */
export declare let __6e5ea12b_0: EmitHost;
export declare function EmitHost_as_printer_EmitHost(receiver: EmitHost): EmitHost_cf9bdcc7;
export declare function EmitHost_as_declarations_DeclarationEmitHost(receiver: EmitHost): DeclarationEmitHost;
export declare function emitHost_as_modulespecifiers_ModuleSpecifierGenerationHost(receiver: GoPtr<emitHost>): ModuleSpecifierGenerationHost;
export declare function emitHost_as_printer_EmitHost(receiver: GoPtr<emitHost>): EmitHost_cf9bdcc7;
export declare function emitHost_as_declarations_DeclarationEmitHost(receiver: GoPtr<emitHost>): DeclarationEmitHost;
export declare function emitHost_as_outputpaths_OutputPathsHost(receiver: GoPtr<emitHost>): OutputPathsHost;
export declare function emitHost_as_compiler_EmitHost(receiver: GoPtr<emitHost>): EmitHost;
/**
 ...
 * }
 */
export declare function newEmitHost(ctx: Context, program: GoPtr<Program>, file: GoPtr<SourceFile>): [GoPtr<emitHost>, () => void];
/**
 ...
 * }
 */
export declare function emitHost_GetModeForUsageLocation(receiver: GoPtr<emitHost>, file: HasFileName, moduleSpecifier: GoPtr<StringLiteralLike>): ResolutionMode;
/**
 ...
 * }
 */
export declare function emitHost_GetResolvedModuleFromModuleSpecifier(receiver: GoPtr<emitHost>, file: HasFileName, moduleSpecifier: GoPtr<StringLiteralLike>): GoPtr<ResolvedModule>;
/**
 ...
 * }
 */
export declare function emitHost_GetDefaultResolutionModeForFile(receiver: GoPtr<emitHost>, file: HasFileName): ResolutionMode;
/**
 ...
 * }
 */
export declare function emitHost_GetEmitModuleFormatOfFile(receiver: GoPtr<emitHost>, file: HasFileName): ModuleKind;
/**
 ...
 * }
 */
export declare function emitHost_FileExists(receiver: GoPtr<emitHost>, path: string): bool;
/**
 ...
 * }
 */
export declare function emitHost_GetGlobalTypingsCacheLocation(receiver: GoPtr<emitHost>): string;
/**
 ...
 * }
 */
export declare function emitHost_GetNearestAncestorDirectoryWithPackageJson(receiver: GoPtr<emitHost>, dirname: string): string;
/**
 ...
 * }
 */
export declare function emitHost_GetPackageJsonInfo(receiver: GoPtr<emitHost>, pkgJsonPath: string): GoPtr<InfoCacheEntry>;
/**
 ...
 * }
 */
export declare function emitHost_GetSourceOfProjectReferenceIfOutputIncluded(receiver: GoPtr<emitHost>, file: HasFileName): string;
/**
 ...
 * }
 */
export declare function emitHost_GetProjectReferenceFromSource(receiver: GoPtr<emitHost>, path: Path): GoPtr<SourceOutputAndProjectReference>;
/**
 ...
 * }
 */
export declare function emitHost_GetRedirectTargets(receiver: GoPtr<emitHost>, path: Path): GoSlice<string>;
/**
 ...
 * }
 */
export declare function emitHost_GetEffectiveDeclarationFlags(receiver: GoPtr<emitHost>, node: GoPtr<Node>, flags: ModifierFlags): ModifierFlags;
/**
 ...
 * }
 */
export declare function emitHost_GetOutputPathsFor(receiver: GoPtr<emitHost>, file: GoPtr<SourceFile>, forceDtsPaths: bool): OutputPaths;
/**
 ...
 * }
 */
export declare function emitHost_GetResolutionModeOverride(receiver: GoPtr<emitHost>, node: GoPtr<Node>): ResolutionMode;
/**
 ...
 * }
 */
export declare function emitHost_GetSourceFileFromReference(receiver: GoPtr<emitHost>, origin: GoPtr<SourceFile>, ref: GoPtr<FileReference>): GoPtr<SourceFile>;
/**
 ...
 */
export declare function emitHost_Options(receiver: GoPtr<emitHost>): GoPtr<CompilerOptions>;
/**
 ...
 */
export declare function emitHost_SourceFiles(receiver: GoPtr<emitHost>): GoSlice<GoPtr<SourceFile>>;
/**
 ...
 */
export declare function emitHost_GetCurrentDirectory(receiver: GoPtr<emitHost>): string;
/**
 ...
 */
export declare function emitHost_CommonSourceDirectory(receiver: GoPtr<emitHost>): string;
/**
 ...
 * }
 */
export declare function emitHost_UseCaseSensitiveFileNames(receiver: GoPtr<emitHost>): bool;
/**
 ...
 * }
 */
export declare function emitHost_IsEmitBlocked(receiver: GoPtr<emitHost>, file: string): bool;
/**
 ...
 * }
 */
export declare function emitHost_WriteFile(receiver: GoPtr<emitHost>, fileName: string, text: string): GoError;
/**
 ...
 * }
 */
export declare function emitHost_GetEmitResolver(receiver: GoPtr<emitHost>): EmitResolver;
/**
 ...
 * }
 */
export declare function emitHost_IsSourceFileFromExternalLibrary(receiver: GoPtr<emitHost>, file: GoPtr<SourceFile>): bool;
/**
 ...
 * }
 */
export declare function emitHost_GetSymlinkCache(receiver: GoPtr<emitHost>): GoPtr<KnownSymlinks>;
/**
 ...
 * }
 */
export declare function emitHost_ResolveModuleName(receiver: GoPtr<emitHost>, moduleName: string, containingFile: string, resolutionMode: ResolutionMode): GoPtr<ResolvedModule>;
//# sourceMappingURL=emitHost.d.ts.map