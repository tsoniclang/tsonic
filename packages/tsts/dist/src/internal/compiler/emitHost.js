...
import { GetOutputPathsFor, OutputPaths_DeclarationFilePath, OutputPaths_JsFilePath, } from "../outputpaths/outputpaths.js";
import { Program_CommonSourceDirectory, Program_FileExists, Program_GetCurrentDirectory, Program_GetDefaultResolutionModeForFile, Program_GetEmitModuleFormatOfFile, Program_GetGlobalTypingsCacheLocation, Program_GetModeForUsageLocation, Program_GetNearestAncestorDirectoryWithPackageJson, Program_GetPackageJsonInfo, Program_GetProjectReferenceFromSource, Program_GetRedirectTargets, Program_GetResolvedModuleFromModuleSpecifier, Program_GetSourceFileFromReference, Program_GetSourceOfProjectReferenceIfOutputIncluded, Program_GetSymlinkCache, Program_GetTypeCheckerForFile, Program_Host, Program_IsEmitBlocked, Program_IsSourceFileFromExternalLibrary, Program_Options, Program_ResolveModuleName, Program_SourceFiles, Program_UseCaseSensitiveFileNames, } from "./program.js";
/**
 ...
 */
export let __6e5ea12b_0 = emitHost_as_compiler_EmitHost(undefined);
export function EmitHost_as_printer_EmitHost(receiver) {
    return receiver.__tsgoEmbedded0;
}
export function EmitHost_as_declarations_DeclarationEmitHost(receiver) {
    return receiver.__tsgoEmbedded1;
}
export function emitHost_as_modulespecifiers_ModuleSpecifierGenerationHost(receiver) {
    return {
        GetSymlinkCache: () => emitHost_GetSymlinkCache(receiver),
        CommonSourceDirectory: () => emitHost_CommonSourceDirectory(receiver),
        GetGlobalTypingsCacheLocation: () => emitHost_GetGlobalTypingsCacheLocation(receiver),
        UseCaseSensitiveFileNames: () => emitHost_UseCaseSensitiveFileNames(receiver),
        GetCurrentDirectory: () => emitHost_GetCurrentDirectory(receiver),
        GetProjectReferenceFromSource: (path) => emitHost_GetProjectReferenceFromSource(receiver, path),
        GetRedirectTargets: (path) => emitHost_GetRedirectTargets(receiver, path),
        GetSourceOfProjectReferenceIfOutputIncluded: (file) => emitHost_GetSourceOfProjectReferenceIfOutputIncluded(receiver, file),
        FileExists: (path) => emitHost_FileExists(receiver, path),
        GetNearestAncestorDirectoryWithPackageJson: (dirname) => emitHost_GetNearestAncestorDirectoryWithPackageJson(receiver, dirname),
        GetPackageJsonInfo: (pkgJsonPath) => emitHost_GetPackageJsonInfo(receiver, pkgJsonPath),
        GetDefaultResolutionModeForFile: (file) => emitHost_GetDefaultResolutionModeForFile(receiver, file),
        GetResolvedModuleFromModuleSpecifier: (file, moduleSpecifier) => emitHost_GetResolvedModuleFromModuleSpecifier(receiver, file, moduleSpecifier),
        GetModeForUsageLocation: (file, moduleSpecifier) => emitHost_GetModeForUsageLocation(receiver, file, moduleSpecifier),
    };
}
export function emitHost_as_printer_EmitHost(receiver) {
    return {
        Options: () => emitHost_Options(receiver),
        SourceFiles: () => emitHost_SourceFiles(receiver),
        UseCaseSensitiveFileNames: () => emitHost_UseCaseSensitiveFileNames(receiver),
        GetCurrentDirectory: () => emitHost_GetCurrentDirectory(receiver),
        CommonSourceDirectory: () => emitHost_CommonSourceDirectory(receiver),
        IsEmitBlocked: (file) => emitHost_IsEmitBlocked(receiver, file),
        WriteFile: (fileName, text) => emitHost_WriteFile(receiver, fileName, text),
        GetEmitModuleFormatOfFile: (file) => emitHost_GetEmitModuleFormatOfFile(receiver, file),
        GetEmitResolver: () => emitHost_GetEmitResolver(receiver),
        GetProjectReferenceFromSource: (path) => emitHost_GetProjectReferenceFromSource(receiver, path),
        IsSourceFileFromExternalLibrary: (file) => emitHost_IsSourceFileFromExternalLibrary(receiver, file),
    };
}
export function emitHost_as_declarations_DeclarationEmitHost(receiver) {
    return {
        ...
        GetResolvedModuleFromModuleSpecifier: (file, moduleSpecifier) => emitHost_GetResolvedModuleFromModuleSpecifier(receiver, file, moduleSpecifier),
        GetModeForUsageLocation: (file, moduleSpecifier) => emitHost_GetModeForUsageLocation(receiver, file, moduleSpecifier),
        GetSourceFileFromReference: (origin, ref) => emitHost_GetSourceFileFromReference(receiver, origin, ref),
        GetOutputPathsFor: (file, forceDtsPaths) => emitHost_GetOutputPathsFor(receiver, file, forceDtsPaths),
        GetResolutionModeOverride: (node) => emitHost_GetResolutionModeOverride(receiver, node),
        GetEffectiveDeclarationFlags: (node, flags) => emitHost_GetEffectiveDeclarationFlags(receiver, node, flags),
        GetEmitResolver: () => emitHost_GetEmitResolver(receiver),
    };
}
export function emitHost_as_outputpaths_OutputPathsHost(receiver) {
    return {
        CommonSourceDirectory: () => emitHost_CommonSourceDirectory(receiver),
        GetCurrentDirectory: () => emitHost_GetCurrentDirectory(receiver),
        UseCaseSensitiveFileNames: () => emitHost_UseCaseSensitiveFileNames(receiver),
...
export function emitHost_as_compiler_EmitHost(receiver) {
    return {
 ...
 * }
 */
export function newEmitHost(ctx, program, file) {
 ...
 * }
 */
export function emitHost_GetModeForUsageLocation(receiver, file, moduleSpecifier) {
 ...
 * }
 */
export function emitHost_GetResolvedModuleFromModuleSpecifier(receiver, file, moduleSpecifier) {
 ...
 * }
 */
export function emitHost_GetDefaultResolutionModeForFile(receiver, file) {
 ...
 * }
 */
export function emitHost_GetEmitModuleFormatOfFile(receiver, file) {
 ...
 * }
 */
export function emitHost_FileExists(receiver, path) {
 ...
 * }
 */
export function emitHost_GetGlobalTypingsCacheLocation(receiver) {
 ...
 * }
 */
export function emitHost_GetNearestAncestorDirectoryWithPackageJson(receiver, dirname) {
 ...
 * }
 */
export function emitHost_GetPackageJsonInfo(receiver, pkgJsonPath) {
 ...
 * }
 */
export function emitHost_GetSourceOfProjectReferenceIfOutputIncluded(receiver, file) {
 ...
 * }
 */
export function emitHost_GetProjectReferenceFromSource(receiver, path) {
 ...
 * }
 */
export function emitHost_GetRedirectTargets(receiver, path) {
 ...
 * }
 */
export function emitHost_GetEffectiveDeclarationFlags(receiver, node, flags) {
 ...
 * }
 */
export function emitHost_GetOutputPathsFor(receiver, file, forceDtsPaths) {
    ...
    return {
        DeclarationFilePath: () => OutputPaths_DeclarationFilePath(result),
        JsFilePath: () => OutputPaths_JsFilePath(result),
    };
}
/**
 ...
 * }
 */
export function emitHost_GetResolutionModeOverride(receiver, node) {
 ...
 * }
 */
export function emitHost_GetSourceFileFromReference(receiver, origin, ref) {
 ...
 */
export function emitHost_Options(receiver) {
 ...
 */
export function emitHost_SourceFiles(receiver) {
 ...
 */
export function emitHost_GetCurrentDirectory(receiver) {
 ...
 */
export function emitHost_CommonSourceDirectory(receiver) {
 ...
 * }
 */
export function emitHost_UseCaseSensitiveFileNames(receiver) {
 ...
 * }
 */
export function emitHost_IsEmitBlocked(receiver, file) {
 ...
 * }
 */
export function emitHost_WriteFile(receiver, fileName, text) {
 ...
 * }
 */
export function emitHost_GetEmitResolver(receiver) {
 ...
 * }
 */
export function emitHost_IsSourceFileFromExternalLibrary(receiver, file) {
 ...
 * }
 */
export function emitHost_GetSymlinkCache(receiver) {
 ...
 * }
 */
export function emitHost_ResolveModuleName(receiver, moduleName, containingFile, resolutionMode) {
    return Program_ResolveModuleName(receiver.program, moduleName, containingFile, resolutionMode);
}
//# sourceMappingURL=emitHost.js.map