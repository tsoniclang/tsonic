 ...
 * }
 */
export function emitter_printSourceFile(receiver, jsFilePath, sourceMapFilePath, sourceFile, printer_, mapOptions, shouldEmitSourceMaps) {
    const e = receiver;
    // !!! sourceMapGenerator
    const options = e.host.Options();
    let sourceMapGenerator = undefined;
    if (shouldEmitSourceMaps) {
        sourceMapGenerator = NewGenerator(GetBaseFileName(NormalizeSlashes(jsFilePath)), getSourceRoot(mapOptions), emitter_getSourceMapDirectory(receiver, mapOptions, jsFilePath, sourceFile), {
            UseCaseSensitiveFileNames: e.host.UseCaseSensitiveFileNames(),
            CurrentDirectory: e.host.GetCurrentDirectory(),
        });
    }
    ...
    if (sourceMapGenerator !== undefined) {
        ...
        const sourceMappingURL = emitter_getSourceMappingURL(receiver, mapOptions, sourceMapGenerator, jsFilePath, sourceMapFilePath, sourceFile);
