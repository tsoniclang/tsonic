 ...
 * )
 */
export const EmitAll = 0;
export const EmitOnlyJs = 1;
export const EmitOnlyDts = 2;
export const EmitOnlyForcedDts = 3;
/**
 ...
 * }
 */
export function emitter_emit(receiver) {
    const e = receiver;
    let popTrace;
    if (e.tr !== undefined) {
 ...
 * }
 */
export function emitter_getDeclarationTransformers(receiver, emitContext, declarationFilePath, declarationMapPath) {
    const e = receiver;
 ...
 * }
 */
export function emitter_runScriptTransformers(receiver, emitContext, sourceFile) {
    const e = receiver;
    let popTrace;
    if (e.tr !== undefined) {
 ...
 * }
 */
export function emitter_runDeclarationTransformers(receiver, emitContext, sourceFile, declarationFilePath, declarationMapPath) {
    const e = receiver;
    let popTrace;
    if (e.tr !== undefined) {
        const pop = Tracing_Push(e.tr, PhaseEmit, "transformNodes", new globalThis.Map([["path", globalThis.String(SourceFile_Path(sourceFile))]]), false);
 ...
 * }
 */
export function getModuleTransformer(opts) {
 ...
 * }
 */
export function getScriptTransformers(emitContext, host, sourceFile) {
    const tx = [];
    ...
    if (importElisionEnabled || jsxTransformEnabled || !CompilerOptions_GetIsolatedModules(options) || Tristate_IsTrue(options.EmitDecoratorMetadata)) {
        ...
        referenceResolver = NewReferenceResolver(options, {});
    }
    const opts = {
        Context: emitContext,
        CompilerOptions: options,
 ...
 * }
 */
export function emitter_emitJSFile(receiver, sourceFile, jsFilePath, sourceMapFilePath) {
    const e = receiver;
    ...
    try {
        ...
        // create a printer to print the nodes
        const p = NewPrinter(printerOptions, {}, emitContext);
 ...
 * }
 */
export function emitter_emitDeclarationFile(receiver, sourceFile, declarationFilePath, declarationMapPath) {
    const e = receiver;
    const options = e.host.Options();
 ...
 * }
 */
export function emitter_printSourceFile(receiver, jsFilePath, sourceMapFilePath, sourceFile, printer_, shouldEmitSourceMaps) {
    const e = receiver;
    // !!! sourceMapGenerator
    const options = e.host.Options();
    let sourceMapGenerator = undefined;
    if (shouldEmitSourceMaps) {
        sourceMapGenerator = NewGenerator(GetBaseFileName(NormalizeSlashes(jsFilePath)), getSourceRoot(options), emitter_getSourceMapDirectory(receiver, options, jsFilePath, sourceFile), {
            UseCaseSensitiveFileNames: e.host.UseCaseSensitiveFileNames(),
            CurrentDirectory: e.host.GetCurrentDirectory(),
        });
    }
    Printer_Write(printer_, sourceFile, sourceFile, e.writer, sourceMapGenerator);
    ...
    if (sourceMapGenerator !== undefined) {
        ...
        const sourceMappingURL = emitter_getSourceMappingURL(receiver, options, sourceMapGenerator, jsFilePath, sourceMapFilePath, sourceFile);
 ...
 * }
 */
export function emitter_writeText(receiver, fileName, text, data) {
    const e = receiver;
 ...
 * }
 */
export function shouldEmitSourceMaps(mapOptions, sourceFile) {
 ...
 * }
 */
export function shouldEmitDeclarationSourceMaps(mapOptions, sourceFile) {
 ...
 * }
 */
export function emitter_getSourceMapDirectory(receiver, mapOptions, filePath, sourceFile) {
    const e = receiver;
    ...
    if (mapOptions.MapRoot.length > 0) {
        ...
        if (sourceFile !== undefined) {
            // For modules or multiple emit files the mapRoot will have directory structure like the sources
            // So if src\a.ts and src\lib\b.ts are compiled together user would be moving the maps into mapRoot\a.js.map and mapRoot\lib\b.js.map
            sourceMapDir = GetDirectoryPath(GetSourceFilePathInNewDir(SourceFile_FileName(sourceFile), sourceMapDir, e.host.GetCurrentDirectory(), e.host.CommonSourceDirectory(), e.host.UseCaseSensitiveFileNames()));
        }
 ...
 * }
 */
export function emitter_getSourceMappingURL(receiver, mapOptions, sourceMapGenerator, filePath, sourceMapFilePath, sourceFile) {
    const e = receiver;
...
export function EmitHost_as_emitter_SourceFileMayBeEmittedHost(receiver) {
    return {
        Options: () => receiver.Options(),
        GetProjectReferenceFromSource: (path) => receiver.GetProjectReferenceFromSource(path),
        IsSourceFileFromExternalLibrary: (file) => receiver.IsSourceFileFromExternalLibrary(file),
        GetCurrentDirectory: () => receiver.GetCurrentDirectory(),
        UseCaseSensitiveFileNames: () => receiver.UseCaseSensitiveFileNames(),
        SourceFiles: () => receiver.SourceFiles(),
    };
}
/**
 ...
 * }
 */
export function sourceFileMayBeEmitted(sourceFile, host, forceDtsEmit) {
    // TODO: move this to outputpaths?
    const options = host.Options();
    // Js files are emitted only if option is enabled
 ...
 * }
 */
export function getSourceFilesToEmit(host, targetSourceFile, forceDtsEmit) {
    let sourceFiles;
 ...
 * }
 */
export function isSourceFileNotJson(file) {
 ...
 * }
 */
export function getDeclarationDiagnostics(host, file) {
    // TODO: use p.getSourceFilesToEmit cache
    ...
    Transformer_TransformSourceFile(transform, file);
