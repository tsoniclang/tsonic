...
import { CompilerOptions_GetAllowJS, CompilerOptions_GetEffectiveTypeRoots, CompilerOptions_GetModuleResolutionKind, CompilerOptions_GetPathsBasePath, CompilerOptions_GetResolveJsonModule, CompilerOptions_UsesWildcardTypes, ModuleKindCommonJS, ModuleKindESNext, ModuleKindNone, ModuleResolutionKind_String, ModuleResolutionKindBundler, ModuleResolutionKindNode16, ModuleResolutionKindNodeNext, ModuleResolutionKindUnknown, ResolutionModeCommonJS, ResolutionModeESM, } from "../core/compileroptions.js";
...
import { extensions_Array, extensions_String, extensionsDeclaration, extensionsImplementationFiles, extensionsJavaScript, extensionsJson, extensionsTypeScript, NodeResolutionFeaturesAll, NodeResolutionFeaturesBundlerDefault, NodeResolutionFeaturesExports, NodeResolutionFeaturesExportsPatternTrailers, NodeResolutionFeaturesImports, NodeResolutionFeaturesImportsPatternRoot, NodeResolutionFeaturesNode16Default, NodeResolutionFeaturesNodeNextDefault, NodeResolutionFeaturesNone, NodeResolutionFeaturesSelfName, PackageId_String, ResolvedModule_IsResolved, ResolvedTypeReferenceDirective_IsResolved, } from "./types.js";
...
const packageJsonNotPresentValue = () => ({ Type: JSONValueTypeNotPresent, Value: undefined });
const packageJsonZeroExportsOrImports = () => ({
    __tsgoEmbedded0: packageJsonNotPresentValue(),
    objectKind: objectKindUnknown,
});
const packageJsonExports = (packageJson) => {
...
const packageJsonImports = (packageJson) => {
 ...
 * }
 */
export function resolved_shouldContinueSearching(receiver) {
 ...
 * }
 */
export function resolved_isResolved(receiver) {
 ...
 * }
 */
export function tracer_write(receiver, diag, ...args) {
 ...
 * }
 */
export function tracer_getTraces(receiver) {
    if (receiver !== undefined) {
 ...
 * }
 */
export function newResolutionState(name, containingDirectory, isTypeReferenceDirective, resolutionMode, compilerOptions, redirectedReference, resolver, traceBuilder) {
    const state = {
        name: name,
        containingDirectory: containingDirectory,
        compilerOptions: GetCompilerOptionsWithRedirect(compilerOptions, redirectedReference),
 ...
 * }
 */
export function GetCompilerOptionsWithRedirect(compilerOptions, redirectedReference) {
 ...
 * }
 */
export function NewResolver(host, options, typingsLocation, projectName) {
 ...
 * }
 */
export function NewResolverWithOptions(host, compilerOptions, typingsLocation, projectName, opts) {
    let embedded;
 ...
 * }
 */
export function Resolver_newTraceBuilder(receiver) {
 ...
 * }
 */
export function Resolver_GetPackageScopeForPath(receiver, directory) {
    const state = {
        resolver: receiver,
        tracer: undefined,
        name: "",
 ...
 * }
 */
export function tracer_traceResolutionUsingProjectReference(receiver, redirectedReference) {
 ...
 * }
 */
export function Resolver_ResolveTypeReferenceDirective(receiver, typeReferenceDirectiveName, containingFile, resolutionMode, redirectedReference) {
 ...
 * }
 */
export function Resolver_ResolveModuleName(receiver, moduleName, containingFile, resolutionMode, redirectedReference) {
    const containingDirectory = tspath.GetDirectoryPath(containingFile);
    const traceBuilder = Resolver_newTraceBuilder(receiver);
    const cacheKey = {
        containingDirectory: containingDirectory,
 ...
 * }
 */
export function Resolver_ResolvePackageDirectory(receiver, moduleName, containingFile, resolutionMode, redirectedReference) {
    const compilerOptions = GetCompilerOptionsWithRedirect(receiver.compilerOptions, redirectedReference);
    const containingDirectory = tspath.GetDirectoryPath(containingFile);
 ...
 * }
 */
export function Resolver_tryResolveFromTypingsLocation(receiver, moduleName, containingDirectory, originalResult, traceBuilder) {
    if (receiver.typingsLocation === "" ||
        tspath.IsExternalModuleNameRelative(moduleName) ||
        (originalResult.ResolvedFileName !== "" && extension.ExtensionIsOneOf(originalResult.Extension, extension.SupportedTSExtensionsWithJsonFlat))) {
        return originalResult;
    }
 ...
 * }
 */
export function Resolver_resolveConfig(receiver, moduleName, containingFile) {
    const containingDirectory = tspath.GetDirectoryPath(containingFile);
 ...
 * }
 */
export function tracer_traceTypeReferenceDirectiveResult(receiver, typeReferenceDirectiveName, result) {
    if (!ResolvedTypeReferenceDirective_IsResolved(result)) {
        ...
        tracer_write(receiver, diagnostics.Type_reference_directive_0_was_successfully_resolved_to_1_with_Package_ID_2_primary_Colon_3, typeReferenceDirectiveName, result.ResolvedFileName, PackageId_String(result.PackageId), result.Primary);
    }
    else {
        tracer_write(receiver, diagnostics.Type_reference_directive_0_was_successfully_resolved_to_1_primary_Colon_2, typeReferenceDirectiveName, result.ResolvedFileName, result.Primary);
    }
}
/**
 ...
 * }
 */
export function resolutionState_resolveTypeReferenceDirective(receiver, typeRoots, fromConfig, fromInferredTypesContainingFile) {
 ...
 * }
 */
export function resolutionState_getCandidateFromTypeRoot(receiver, typeRoot) {
 ...
 * }
 */
export function resolutionState_mangleScopedPackageName(receiver, name) {
 ...
 * }
 */
export function resolutionState_resolveFromTypeRoot(receiver) {
 ...
 * }
 */
export function resolutionState_getPackageScopeForPath(receiver, directory) {
    const result = tspath.ForEachAncestorDirectoryStoppingAtGlobalCache(receiver.resolver.typingsLocation, directory, (dir) => {
 ...
 * }
 */
export function resolutionState_resolveNodeLike(receiver) {
    if (receiver.tracer !== undefined) {
        const conditions = strings.Join(core.Map(receiver.conditions, (c) => `'${c}'`), ", ");
        if (receiver.esmMode) {
    ...
    if (receiver.resolvedPackageDirectory &&
 ...
 * }
 */
export function resolutionState_resolveNodeLikeWorker(receiver) {
    ...
    if (!tspath.IsExternalModuleNameRelative(receiver.name)) {
        ...
        return resolutionState_createResolvedModule(receiver, resolved2, resolved2 !== undefined && strings.Contains(resolved2.path, "/node_modules/"));
    }
    return resolutionState_createResolvedModule(receiver, undefined, false);
}
/**
 ...
 * }
 */
export function resolutionState_loadModuleFromSelfNameReference(receiver) {
    ...
    const [name, nameOk] = Expected_GetValue(packageJsonHeaderStringField(scope.Contents, "Name"));
    if (!nameOk) {
        return continueSearching();
    }
 ...
 * }
 */
export function resolutionState_loadModuleFromImports(receiver) {
 ...
 * }
 */
export function resolutionState_loadModuleFromExports(receiver, packageInfo, ext, subpath) {
    ...
    if (subpath === ".") {
        ...
        if (exportsType === JSONValueTypeString || exportsType === JSONValueTypeArray) {
            ...
            if (ExportsOrImports_IsConditions(packageExports)) {
                ...
                const [dotEntry, dotOk] = OrderedMap_Get(ExportsOrImports_AsObject(packageExports), ".");
                if (dotOk) {
                    mainExport = dotEntry;
                }
            }
        ...
        const result = resolutionState_loadModuleFromExportsOrImports(receiver, ext, subpath, ExportsOrImports_AsObject(packageExports), packageInfo, false);
        if (!resolved_shouldContinueSearching(result)) {
            return result;
        }
    }
 ...
 * }
 */
export function resolutionState_loadModuleFromExportsOrImports(receiver, extensions, moduleName, lookupTableRaw, scope, isImports) {
    const lookupTable = lookupTableRaw;
    if (!strings.HasSuffix(moduleName, "/") && !strings.Contains(moduleName, "*")) {
        const [target, targetOk] = OrderedMap_Get(lookupTable, moduleName);
        if (targetOk) {
    ...
    const expandingKeys = [];
    OrderedMap_Keys(lookupTable)((key) => {
        if (strings.Count(key, "*") === 1 || strings.HasSuffix(key, "/")) {
    ...
    for (const potentialTarget of expandingKeys) {
        if ((receiver.features & NodeResolutionFeaturesExportsPatternTrailers) !== 0 && matchesPatternWithTrailer(potentialTarget, moduleName)) {
            const [target2] = OrderedMap_Get(lookupTable, potentialTarget);
            ...
            const [target3] = OrderedMap_Get(lookupTable, potentialTarget);
            ...
            const [target4] = OrderedMap_Get(lookupTable, potentialTarget);
 ...
 * }
 */
export function resolutionState_loadModuleFromTargetExportOrImport(receiver, extensions, moduleName, scope, isImports, target, subpath, isPattern, key) {
    const targetType = target.__tsgoEmbedded0.Type;
    switch (targetType) {
        case JSONValueTypeString: {
            const targetString = target.__tsgoEmbedded0.Value;
        ...
        case JSONValueTypeObject: {
            ...
            let done = false;
            OrderedMap_Entries(ExportsOrImports_AsObject(target))((condition, subTarget) => {
 ...
 * }
 */
export function resolutionState_tryLoadInputFileForPath(receiver, finalPath, entry, packagePath, isImports) {
    if (!receiver.isConfigLookup &&
        (receiver.compilerOptions.DeclarationDir !== "" || receiver.compilerOptions.OutDir !== "") &&
        !strings.Contains(finalPath, "/node_modules/") &&
        (receiver.compilerOptions.ConfigFilePath === "" || tspath.ContainsPath(tspath.GetDirectoryPath(packagePath), receiver.compilerOptions.ConfigFilePath, {
        ...
        if (receiver.compilerOptions.RootDir !== "") {
            ...
            const diagnostic = NewDiagnostic(undefined, UndefinedTextRange(), core.IfElse(isImports, diagnostics.The_project_root_is_ambiguous_but_is_required_to_resolve_import_map_entry_0_in_file_1_Supply_the_rootDir_compiler_option_to_disambiguate, diagnostics.The_project_root_is_ambiguous_but_is_required_to_resolve_export_map_entry_0_in_file_1_Supply_the_rootDir_compiler_option_to_disambiguate), core.IfElse(entry === "", ".", entry), packagePath);
 ...
 * }
 */
export function resolutionState_getOutputDirectoriesForBaseDirectory(receiver, commonSourceDirGuess) {
 ...
 * }
 */
export function resolutionState_loadModuleFromNearestNodeModulesDirectory(receiver, typesScopeOnly) {
 ...
 * }
 */
export function resolutionState_loadModuleFromNearestNodeModulesDirectoryWorker(receiver, ext, mode, typesScopeOnly) {
    const [result] = tspath.ForEachAncestorDirectory(receiver.containingDirectory, (directory) => {
        if (tspath.GetBaseFileName(directory) !== "node_modules") {
 ...
 * }
 */
export function resolutionState_loadModuleFromImmediateNodeModulesDirectory(receiver, extensions, directory, typesScopeOnly) {
 ...
 * }
 */
export function resolutionState_loadModuleFromSpecificNodeModulesDirectory(receiver, ext, moduleName, nodeModulesDirectory) {
    ...
    const loader = (loaderExt, loaderCandidate) => {
 ...
 * }
 */
export function resolutionState_createResolvedModuleHandlingSymlink(receiver, resolved) {
 ...
 * }
 */
export function resolutionState_createResolvedModule(receiver, resolved, isExternalLibraryImport) {
 ...
 * }
 */
export function resolutionState_createResolvedTypeReferenceDirective(receiver, resolved, primary) {
 ...
 * }
 */
export function resolutionState_getOriginalAndResolvedFileName(receiver, fileName) {
 ...
 * }
 */
export function resolutionState_tryLoadModuleUsingOptionalResolutionSettings(receiver) {
 ...
 * }
 */
export function resolutionState_getParsedPatternsForPaths(receiver) {
 ...
 * }
 */
export function resolutionState_tryLoadModuleUsingPathsIfEligible(receiver) {
    ...
    return resolutionState_tryLoadModuleUsingPaths(receiver, receiver.extensions, receiver.name, baseDirectory, receiver.compilerOptions.Paths, pathPatterns, (loaderExt, loaderCandidate) => {
 ...
 * }
 */
export function resolutionState_tryLoadModuleUsingPaths(receiver, extensions, moduleName, containingDirectory, paths, pathPatterns, loader) {
    ...
    if (Pattern_IsValid(matchedPattern)) {
        ...
        for (const subst of OrderedMap_GetOrZero(paths, matchedPattern.Text)) {
 ...
 * }
 */
export function resolutionState_tryLoadModuleUsingRootDirs(receiver) {
 ...
 * }
 */
export function resolutionState_nodeLoadModuleByRelativeName(receiver, extensions, candidate, considerPackageJson) {
    if (receiver.tracer !== undefined) {
 ...
 * }
 */
export function resolutionState_loadModuleFromFile(receiver, extensions, candidate) {
 ...
 * }
 */
export function resolutionState_loadModuleFromFileNoImplicitExtensions(receiver, extensions, candidate) {
 ...
 * }
 */
export function resolutionState_tryAddingExtensions(receiver, extensionless, extensions, originalExtension) {
    ...
    switch (originalExtension) {
        ...
        case extension.ExtensionDmts: {
            if ((extensions & extensionsTypeScript) !== 0) {
                ...
                if (!resolved_shouldContinueSearching(r))
                    return r;
            }
            if ((extensions & extensionsDeclaration) !== 0) {
        ...
        case extension.ExtensionJsx: {
            if ((extensions & extensionsTypeScript) !== 0) {
                ...
                if (!resolved_shouldContinueSearching(r1))
                    return r1;
                ...
                if (!resolved_shouldContinueSearching(r2))
                    return r2;
            }
            if ((extensions & extensionsDeclaration) !== 0) {
 ...
 * }
 */
export function resolutionState_tryExtension(receiver, extension, extensionless, resolvedUsingTsExtension) {
    ...
    if (ok) {
        return {
            path: path,
            extension: extension,
            resolvedUsingTsExtension: (!receiver.candidateEndingIsFromConfig && resolvedUsingTsExtension),
            packageId: { Name: "", SubModuleName: "", Version: "", PeerDependencies: "" },
            originalPath: "",
        };
    }
 ...
 * }
 */
export function resolutionState_tryFile(receiver, fileName) {
 ...
 * }
 */
export function resolutionState_tryFileLookup(receiver, fileName) {
 ...
 * }
 */
export function resolutionState_loadNodeModuleFromDirectory(receiver, extensions, candidate, considerPackageJson) {
    const packageInfo = considerPackageJson ? resolutionState_getPackageJsonInfo(receiver, candidate) : undefined;
 ...
 * }
 */
export function resolutionState_loadNodeModuleFromDirectoryWorker(receiver, ext, candidate, packageInfo) {
    let packageFile = "";
    let versionPaths = { Version: "", pathsJSON: undefined, paths: undefined };
    if (InfoCacheEntry_Exists(packageInfo)) {
        const traceFunc = resolutionState_getTraceFunc(receiver) ?? ((_m, ..._args) => { });
        versionPaths = PackageJson_GetVersionPaths(packageInfo.Contents, traceFunc);
        const comparePaths0 = { UseCaseSensitiveFileNames: receiver.resolver.host.FS().UseCaseSensitiveFileNames(), CurrentDirectory: "" };
    ...
    const loader = (loaderExtensions, loaderCandidate) => {
        ...
        if (InfoCacheEntry_Exists(packageInfo) && packageJsonHeaderStringField(packageInfo.Contents, "Type").Value !== "module") {
            receiver.esmMode = false;
        }
        const result = resolutionState_nodeLoadModuleByRelativeName(receiver, expandedExtensions, loaderCandidate, false);
    ...
    const emptyComparePathsOptions = { UseCaseSensitiveFileNames: false, CurrentDirectory: "" };
 ...
 * }
 */
export function resolutionState_loadFileNameFromPackageJSONField(receiver, extensions, candidate, packageJSONValue) {
    if ((extensions & extensionsTypeScript) !== 0 && extension.HasImplementationTSFileExtension(candidate) ||
        ...
        if (ok) {
            ...
            const resolvedUsingTsExtension = (strings.HasSuffix(packageJSONValue, "*") && ext !== "");
            return {
                path: path,
                extension: ext,
                resolvedUsingTsExtension: resolvedUsingTsExtension,
 ...
 * }
 */
export function resolutionState_getPackageFile(receiver, extensions, packageInfo) {
    if (!InfoCacheEntry_Exists(packageInfo)) {
        return ["", false];
    }
    if (receiver.isConfigLookup) {
 ...
 * }
 */
export function resolutionState_getPackageJsonInfo(receiver, packageDirectory) {
    ...
    if (directoryExists && receiver.resolver.host.FS().FileExists(packageJsonPath)) {
        ...
        const contentsBytes = Array.from(new globalThis.TextEncoder().encode(contents));
 ...
 * }
 */
export function resolutionState_getPackageId(receiver, resolvedFileName, packageInfo) {
    if (InfoCacheEntry_Exists(packageInfo)) {
        const packageJsonContent = packageInfo.Contents;
        const [name, nameOk] = Expected_GetValue(packageJsonHeaderStringField(packageJsonContent, "Name"));
        if (nameOk) {
            const [ver, verOk] = Expected_GetValue(packageJsonHeaderStringField(packageJsonContent, "Version"));
            if (verOk) {
 ...
 * }
 */
export function resolutionState_readPackageJsonPeerDependencies(receiver, packageJsonInfo) {
    ...
    const names = [];
    maps.Keys(peerDependencies.Value)((key) => {
        names.push(key);
        return true;
    });
    slices.Sort(names);
 ...
 * }
 */
export function resolutionState_realPath(receiver, path) {
 ...
 * }
 */
function Expected_as_TypeValidatedField(field) {
    return {
        IsPresent: () => Expected_IsPresent(field),
        IsValid: () => Expected_IsValid(field),
        ExpectedJSONType: () => Expected_ExpectedJSONType(field),
        ActualJSONType: () => Expected_ActualJSONType(field),
    };
}
export function resolutionState_validatePackageJSONField(receiver, fieldName, field) {
    if (field.IsPresent()) {
        if (field.IsValid()) {
            return true;
        }
 ...
 * }
 */
export function resolutionState_getPackageJSONPathField(receiver, fieldName, field, directory) {
 ...
 * }
 */
export function resolutionState_conditionMatches(receiver, condition) {
 ...
 * }
 */
export function resolutionState_getTraceFunc(receiver) {
    if (receiver.tracer !== undefined) {
        return (m, ...args) => tracer_write(receiver.tracer, m, ...args);
    }
    return undefined;
}
/**
 ...
 * }
 */
export function moveToNextDirectorySeparatorIfAvailable(path, prevSeparatorIndex, isFolder) {
 ...
 * }
 */
export function Resolver_getParsedPatternsForPaths(receiver) {
 ...
 * }
 */
export function TryParsePatterns(pathMappings) {
    if (pathMappings === undefined) {
        return { matchableStringSet: NewSetWithSizeHint(0), patterns: [] };
    }
    const typedMappings = pathMappings;
    // Count patterns (wildcard) vs matchables (exact)
    let numPatterns = 0;
    OrderedMap_Keys(typedMappings)((p) => {
    ...
    const patterns = [];
    const matchableStringSet = NewSetWithSizeHint(numMatchables);
    OrderedMap_Keys(typedMappings)((p) => {
        const pattern = TryParsePattern(p);
 ...
 * }
 */
export function MatchPatternOrExact(patterns, candidate) {
    ...
    return FindBestPatternMatch(patterns.patterns, (v) => v, candidate) ?? { Text: "", StarIndex: 0 };
}
/**
 ...
 * }
 */
export function normalizePathForCJSResolution(containingDirectory, moduleName) {
 ...
 * }
 */
export function matchesPatternWithTrailer(target, name) {
    if (strings.HasSuffix(target, "*")) {
        return false;
    }
 ...
 * }
 */
export function extensionIsOk(extensions, ext) {
    return (((extensions & extensionsJavaScript) !== 0 && (ext === extension.ExtensionJs || ext === extension.ExtensionJsx || ext === extension.ExtensionMjs || ext === extension.ExtensionCjs)) ||
 ...
 * }
 */
export function ResolveConfig(moduleName, containingFile, host) {
    const resolver = NewResolver(host, { ModuleResolution: ModuleResolutionKindNodeNext }, "", "");
        ...
        if (host.FS().DirectoryExists(root)) {
            for (const typeDirectivePath of host.FS().GetAccessibleEntries(root).Directories) {
                ...
                if (host.FS().FileExists(packageJsonPath)) {
                    ...
                    isNotNeededPackage = packageJsonContent.__tsgoEmbedded1?.Typings.Null ?? false;
                }
                if (!isNotNeededPackage) {
 ...
 * )
 */
export const EndingFixed = 0;
export const EndingExtensionChangeable = 1;
export const EndingChangeable = 2;
/**
 ...
 * }
 */
export function ResolvedEntrypoint_SymlinkOrRealpath(receiver) {
 ...
 * }
 */
export function Resolver_GetEntrypointsFromPackageJsonInfo(receiver, packageJson, packageName, enableDirectorySearch) {
    ...
    const result = [];
    const mainResolution = resolutionState_loadNodeModuleFromDirectoryWorker(state, exts, packageJson.PackageDirectory, packageJson);
    if (resolved_isResolved(mainResolution)) {
        result.push(Resolver_createResolvedEntrypointHandlingSymlink(receiver, mainResolution.path, packageName, undefined, undefined, EndingFixed));
    }
    if (enableDirectorySearch) {
        const otherFiles = vfsmatch.ReadDirectory(receiver.host.FS(), receiver.host.GetCurrentDirectory(), packageJson.PackageDirectory, extensions_Array(exts), ["node_modules"], ["**/*"], vfsmatch.UnlimitedDepth);
        const comparePathsOptions = { UseCaseSensitiveFileNames: receiver.host.FS().UseCaseSensitiveFileNames(), CurrentDirectory: "" };
        for (const file of otherFiles) {
            if (resolved_isResolved(mainResolution) && tspath.ComparePaths(file, mainResolution.path, comparePathsOptions) === 0) {
                continue;
            }
            result.push(Resolver_createResolvedEntrypointHandlingSymlink(receiver, file, tspath.ResolvePath(packageName, tspath.GetRelativePathFromDirectory(packageJson.PackageDirectory, file, comparePathsOptions)), undefined, undefined, EndingChangeable));
        }
    }
    if (result.length > 0) {
        return result;
 ...
 * }
 */
export function Resolver_createResolvedEntrypointHandlingSymlink(receiver, fileName, moduleSpecifier, includeConditions, excludeConditions, ending) {
 ...
 * }
 */
export function resolutionState_loadEntrypointsFromExportMap(receiver, packageJson, packageName, exports) {
    const entrypoints = [];
    const loadEntrypointsFromTargetExports = (subpath, includeConditions, excludeConditions, exp) => {
        ...
        if (expType === JSONValueTypeString && strings.HasPrefix(JSONValue_AsString(exp.__tsgoEmbedded0), "./")) {
            ...
            if (strings.ContainsRune(expStr, 42)) { // '*'
                ...
                const files = vfsmatch.ReadDirectory(receiver.resolver.host.FS(), receiver.resolver.host.GetCurrentDirectory(), packageJson.PackageDirectory, extensions_Array(receiver.extensions), undefined, [extension.ChangeFullExtension(strings.Replace(expStr, "*", "**/*", 1), ".*")], vfsmatch.UnlimitedDepth);
                for (const file of files) {
                    ...
                    entrypoints.push(Resolver_createResolvedEntrypointHandlingSymlink(receiver.resolver, file, moduleSpecifier, includeConditions, excludeConditions, core.IfElse(strings.HasSuffix(expStr, "*"), EndingExtensionChangeable, EndingFixed)));
                }
            }
            else {
                ...
                if (resolved_isResolved(result)) {
                    entrypoints.push(Resolver_createResolvedEntrypointHandlingSymlink(receiver.resolver, result.path, tspath.ResolvePath(packageName, subpath), includeConditions, excludeConditions, core.IfElse(strings.HasSuffix(expStr, "*"), EndingExtensionChangeable, EndingFixed)));
                }
            }
        }
            ...
            OrderedMap_Entries(ExportsOrImports_AsObject(exp))((condition, subExport) => {
    ...
    if (exportsType === JSONValueTypeArray) {
        ...
        if (ExportsOrImports_IsSubpaths(exports)) {
            OrderedMap_Entries(ExportsOrImports_AsObject(exports))((subpath, exp) => {
 ...
 * }
 */
export function resolutionState_getMatchedStarForPatternEntrypoint(receiver, file, leadingSlice, trailingSlice, caseSensitive) {
    if (stringutil.HasPrefixAndSuffixWithoutOverlap(file, leadingSlice, trailingSlice, caseSensitive)) {
