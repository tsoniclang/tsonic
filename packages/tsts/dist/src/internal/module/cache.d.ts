 ...
 * }
 */
export declare function moduleResolutionCache_Get(receiver: GoPtr<moduleResolutionCache>, key: moduleResolutionCacheKey): [GoPtr<ResolvedModule>, bool];
/**
 ...
 * }
 */
export declare function moduleResolutionCache_Set(receiver: GoPtr<moduleResolutionCache>, key: moduleResolutionCacheKey, value: GoPtr<ResolvedModule>): void;
/**
 ...
 * }
 */
export declare function typeRefDirectiveResolutionCache_Get(receiver: GoPtr<typeRefDirectiveResolutionCache>, key: typeRefDirectiveResolutionCacheKey): [GoPtr<ResolvedTypeReferenceDirective>, bool];
/**
 ...
 * }
 */
export declare function typeRefDirectiveResolutionCache_Set(receiver: GoPtr<typeRefDirectiveResolutionCache>, key: typeRefDirectiveResolutionCacheKey, value: GoPtr<ResolvedTypeReferenceDirective>): void;
/**
 ...
 * }
 */
export declare function newCaches(currentDirectory: string, useCaseSensitiveFileNames: bool, options: GoPtr<CompilerOptions>): caches;
/**
 ...
 * }
 */
export declare function getRedirectConfigName(redirect: GoPtr<ResolvedProjectReference>): string;
