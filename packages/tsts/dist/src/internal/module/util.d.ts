 ...
 */
export declare const typeScriptVersion: Version;
/**
 ...
 */
export declare const InferredTypesContainingFile: string;
/**
 ...
 * }
 */
export declare function IsApplicableVersionedTypesKey(key: string): bool;
/**
 ...
 * }
 */
export declare function ParseNodeModuleFromPath(resolved: string, isFolder: bool): string;
/**
 ...
 * }
 */
export declare function ParsePackageName(moduleName: string): [string, string];
/**
 ...
 * }
 */
export declare function UnmangleScopedPackageName(packageName: string): string;
/**
 ...
 * }
 */
export declare function ComparePatternKeys(a: string, b: string): int;
/**
 ...
 * }
 */
export declare function GetResolutionDiagnostic(options: GoPtr<CompilerOptions>, resolvedModule: GoPtr<ResolvedModule>, file: GoPtr<SourceFileNode>): GoPtr<Message>;
/**
 ...
 * }
 */
export declare function TryGetJSExtensionForFile(fileName: string, options: GoPtr<CompilerOptions>): string;
