...
import { CompilerOptions_GetAllowJS, CompilerOptions_GetResolveJsonModule, JsxEmitNone, JsxEmitPreserve, } from "../core/compileroptions.js";
import { Tristate_DefaultIfUnknown, Tristate_IsTrue } from "../core/tristate.js";
import { Version as coreVersion } from "../core/version.js";
import { Could_not_find_a_declaration_file_for_module_0_1_implicitly_has_an_any_type, Module_0_was_resolved_to_1_but_allowArbitraryExtensions_is_not_set, Module_0_was_resolved_to_1_but_jsx_is_not_set, Module_0_was_resolved_to_1_but_resolveJsonModule_is_not_used, } from "../diagnostics/generated/messages.js";
import { MustParse } from "../semver/version.js";
import { TryParseVersionRange, VersionRange_Test } from "../semver/version_range.js";
import { ExtensionCjs, ExtensionCts, ExtensionDcts, ExtensionDmts, ExtensionDts, ExtensionJs, ExtensionJson, ExtensionJsx, ExtensionMjs, ExtensionMts, ExtensionTs, ExtensionTsx, TryGetExtensionFromPath, } from "../tspath/extension.js";
 ...
 */
export const typeScriptVersion = MustParse(coreVersion());
/**
 ...
 * }
 */
export function IsApplicableVersionedTypesKey(key) {
    if (!strings.HasPrefix(key, "types@")) {
        return false;
    }
...
export function ParseNodeModuleFromPath(resolved, isFolder) {
    ...
    const indexAfterPackageName = path.charCodeAt(indexAfterNodeModules) === CHAR_AT
 ...
 * }
 */
export function UnmangleScopedPackageName(packageName) {
 ...
 * }
 */
export function GetResolutionDiagnostic(options, resolvedModule, file) {
