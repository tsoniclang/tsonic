 ...
 * )
 */
export declare const NodeResolutionFeaturesImports: NodeResolutionFeatures;
export declare const NodeResolutionFeaturesSelfName: NodeResolutionFeatures;
export declare const NodeResolutionFeaturesExports: NodeResolutionFeatures;
export declare const NodeResolutionFeaturesExportsPatternTrailers: NodeResolutionFeatures;
export declare const NodeResolutionFeaturesImportsPatternRoot: NodeResolutionFeatures;
export declare const NodeResolutionFeaturesNone: NodeResolutionFeatures;
export declare const NodeResolutionFeaturesAll: int;
export declare const NodeResolutionFeaturesNode16Default: int;
export declare const NodeResolutionFeaturesNodeNextDefault: int;
export declare const NodeResolutionFeaturesBundlerDefault: int;
/**
 ...
 * }
 */
export declare function PackageId_String(receiver: GoPtr<PackageId>): string;
/**
 ...
 * }
 */
export declare function PackageId_PackageName(receiver: GoPtr<PackageId>): string;
 ...
 * }
 */
export declare function ResolvedModule_IsResolved(receiver: GoPtr<ResolvedModule>): bool;
export declare function ResolvedModule_IsProviderVirtual(receiver: GoPtr<ResolvedModule>): bool;
/**
 ...
 * }
 */
export declare function ResolvedTypeReferenceDirective_IsResolved(receiver: GoPtr<ResolvedTypeReferenceDirective>): bool;
/**
 ...
 * )
 */
export declare const extensionsTypeScript: extensions;
export declare const extensionsJavaScript: extensions;
export declare const extensionsDeclaration: extensions;
export declare const extensionsJson: extensions;
export declare const extensionsImplementationFiles: int;
/**
 ...
 * }
 */
export declare function extensions_String(receiver: extensions): string;
/**
 ...
 * }
 */
export declare function extensions_Array(receiver: extensions): GoSlice<string>;
