...
function singleLineStringWriter_as_EmitTextWriter(receiver) {
    const w = receiver;
    return {
        Write: (s) => singleLineStringWriter_Write(w, s),
        WriteTrailingSemicolon: (text) => singleLineStringWriter_WriteTrailingSemicolon(w, text),
        WriteComment: (text) => singleLineStringWriter_WriteComment(w, text),
        WriteKeyword: (text) => singleLineStringWriter_WriteKeyword(w, text),
        WriteOperator: (text) => singleLineStringWriter_WriteOperator(w, text),
        WritePunctuation: (text) => singleLineStringWriter_WritePunctuation(w, text),
        WriteSpace: (text) => singleLineStringWriter_WriteSpace(w, text),
        WriteStringLiteral: (text) => singleLineStringWriter_WriteStringLiteral(w, text),
        WriteParameter: (text) => singleLineStringWriter_WriteParameter(w, text),
        WriteProperty: (text) => singleLineStringWriter_WriteProperty(w, text),
        WriteSymbol: (text, symbol_) => singleLineStringWriter_WriteSymbol(w, text, symbol_),
        WriteLine: () => singleLineStringWriter_WriteLine(w),
        WriteLineForce: (force) => singleLineStringWriter_WriteLineForce(w, force),
        IncreaseIndent: () => singleLineStringWriter_IncreaseIndent(w),
        DecreaseIndent: () => singleLineStringWriter_DecreaseIndent(w),
        Clear: () => singleLineStringWriter_Clear(w),
        String: () => singleLineStringWriter_String(w),
        RawWrite: (s) => singleLineStringWriter_RawWrite(w, s),
        WriteLiteral: (s) => singleLineStringWriter_WriteLiteral(w, s),
        GetTextPos: () => singleLineStringWriter_GetTextPos(w),
        GetLine: () => singleLineStringWriter_GetLine(w),
        GetColumn: () => singleLineStringWriter_GetColumn(w),
        GetIndent: () => singleLineStringWriter_GetIndent(w),
        IsAtStartOfLine: () => singleLineStringWriter_IsAtStartOfLine(w),
        HasTrailingComment: () => singleLineStringWriter_HasTrailingComment(w),
        HasTrailingWhitespace: () => singleLineStringWriter_HasTrailingWhitespace(w),
    };
}
/**
 ...
 * }
 */
export const singleLineStringWriterPool = (() => {
    const pool = new Pool();
    pool.New = () => ({
        builder: new Builder(),
        lastWritten: "",
 ...
 */
export const __7e0fb603_0 = singleLineStringWriter_as_EmitTextWriter({
    builder: new Builder(),
    lastWritten: "",
});
/**
...
export function GetSingleLineStringWriter() {
    const w = singleLineStringWriterPool.Get();
 ...
 * }
 */
export function singleLineStringWriter_Clear(receiver) {
    const w = receiver;
    w.lastWritten = "";
    w.builder.Reset();
}
 ...
 * }
 */
export function singleLineStringWriter_DecreaseIndent(receiver) {
    // Do Nothing
}
/**
 ...
 * }
 */
export function singleLineStringWriter_GetColumn(receiver) {
    return 0;
}
/**
 ...
 * }
 */
export function singleLineStringWriter_GetIndent(receiver) {
    return 0;
}
/**
 ...
 * }
 */
export function singleLineStringWriter_GetLine(receiver) {
    return 0;
}
/**
 ...
 * }
 */
export function singleLineStringWriter_String(receiver) {
 ...
 * }
 */
export function singleLineStringWriter_GetTextPos(receiver) {
 ...
 * }
 */
export function singleLineStringWriter_HasTrailingComment(receiver) {
    return false;
}
/**
 ...
 * }
 */
export function singleLineStringWriter_HasTrailingWhitespace(receiver) {
 ...
 * }
 */
export function singleLineStringWriter_IncreaseIndent(receiver) {
    // Do Nothing
}
/**
 ...
 * }
 */
export function singleLineStringWriter_IsAtStartOfLine(receiver) {
    return false;
}
/**
 ...
 * }
 */
export function singleLineStringWriter_RawWrite(receiver, s) {
    const w = receiver;
    w.lastWritten = s;
    w.builder.WriteString(s);
}
 ...
 * }
 */
export function singleLineStringWriter_Write(receiver, s) {
    const w = receiver;
    w.lastWritten = s;
    w.builder.WriteString(s);
}
 ...
 * }
 */
export function singleLineStringWriter_WriteComment(receiver, text) {
    const w = receiver;
    w.lastWritten = text;
    w.builder.WriteString(text);
}
 ...
 * }
 */
export function singleLineStringWriter_WriteKeyword(receiver, text) {
    const w = receiver;
    w.lastWritten = text;
    w.builder.WriteString(text);
}
 ...
 * }
 */
export function singleLineStringWriter_WriteLine(receiver) {
    const w = receiver;
    w.lastWritten = " ";
    w.builder.WriteString(" ");
}
 ...
 * }
 */
export function singleLineStringWriter_WriteLineForce(receiver, force) {
    const w = receiver;
    w.lastWritten = " ";
    w.builder.WriteString(" ");
}
 ...
 * }
 */
export function singleLineStringWriter_WriteLiteral(receiver, s) {
    const w = receiver;
    w.lastWritten = s;
    w.builder.WriteString(s);
}
 ...
 * }
 */
export function singleLineStringWriter_WriteOperator(receiver, text) {
    const w = receiver;
    w.lastWritten = text;
    w.builder.WriteString(text);
}
 ...
 * }
 */
export function singleLineStringWriter_WriteParameter(receiver, text) {
    const w = receiver;
    w.lastWritten = text;
    w.builder.WriteString(text);
}
 ...
 * }
 */
export function singleLineStringWriter_WriteProperty(receiver, text) {
    const w = receiver;
    w.lastWritten = text;
    w.builder.WriteString(text);
}
 ...
 * }
 */
export function singleLineStringWriter_WritePunctuation(receiver, text) {
    const w = receiver;
    w.lastWritten = text;
    w.builder.WriteString(text);
}
 ...
 * }
 */
export function singleLineStringWriter_WriteSpace(receiver, text) {
    const w = receiver;
    w.lastWritten = text;
    w.builder.WriteString(text);
}
 ...
 * }
 */
export function singleLineStringWriter_WriteStringLiteral(receiver, text) {
    const w = receiver;
    w.lastWritten = text;
    w.builder.WriteString(text);
}
 ...
 * }
 */
export function singleLineStringWriter_WriteSymbol(receiver, text, symbol_) {
    const w = receiver;
    w.lastWritten = text;
    w.builder.WriteString(text);
}
 ...
 * }
 */
export function singleLineStringWriter_WriteTrailingSemicolon(receiver, text) {
    const w = receiver;
    w.lastWritten = text;
    w.builder.WriteString(text);
}
//# sourceMappingURL=singlelinestringwriter.js.map