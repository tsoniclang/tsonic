...
import { NewArrayLiteralExpression, NewArrowFunction, NewBinaryExpression, NewBlock, NewCallExpression, NewConditionalExpression, NewElementAccessExpression, NewExportAssignment, NewExportDeclaration, NewExportSpecifier, NewExpressionStatement, NewFunctionExpression, NewIdentifier, NewKeywordExpression, NewNamedExports, NewNumericLiteral, NewObjectLiteralExpression, NewParameterDeclaration, NewParenthesizedExpression, NewPrivateIdentifier, NewPropertyAccessExpression, NewPropertyAssignment, NewSetAccessorDeclaration, NewStringLiteral, NewToken, NewTypeOfExpression, NewVariableDeclarationList, NewVariableStatement, NewVoidExpression, } from "../ast/generated/factory.js";
...
function normalizeAutoGenerateOptions(options) {
    return {
 ...
 * }
 */
export function NodeFactory_newGeneratedIdentifier(receiver, kind, text, node, options) {
    options = normalizeAutoGenerateOptions(options);
    const id = nextAutoGenerateId.Add(1);
    if (text.length === 0) {
        if (node === undefined) {
            text = `(auto@${id})`;
        }
 ...
 * }
 */
export function NodeFactory_NewTempVariable(receiver) {
 ...
 * }
 */
export function NodeFactory_NewTempVariableEx(receiver, options) {
 ...
 * }
 */
export function NodeFactory_NewLoopVariable(receiver) {
 ...
 * }
 */
export function NodeFactory_NewLoopVariableEx(receiver, options) {
 ...
 * }
 */
export function NodeFactory_NewUniqueName(receiver, text) {
 ...
 * }
 */
export function NodeFactory_NewUniqueNameEx(receiver, text, options) {
 ...
 * }
 */
export function NodeFactory_NewGeneratedNameForNode(receiver, node) {
 ...
 * }
 */
export function NodeFactory_NewGeneratedNameForNodeEx(receiver, node, options) {
    options = normalizeAutoGenerateOptions(options);
    // Go passes `options` by value; the |= below mutates that local copy only.
    const opts = options.Prefix.length > 0 || options.Suffix.length > 0
 ...
 * }
 */
export function NodeFactory_newGeneratedPrivateIdentifier(receiver, kind, text, node, options) {
    options = normalizeAutoGenerateOptions(options);
    const id = nextAutoGenerateId.Add(1);
    if (text.length === 0) {
        if (node === undefined) {
 ...
 * }
 */
export function NodeFactory_NewUniquePrivateName(receiver, text) {
 ...
 * }
 */
export function NodeFactory_NewUniquePrivateNameEx(receiver, text, options) {
 ...
 * }
 */
export function NodeFactory_NewGeneratedPrivateNameForNode(receiver, node) {
 ...
 * }
 */
export function NodeFactory_NewGeneratedPrivateNameForNodeEx(receiver, node, options) {
    options = normalizeAutoGenerateOptions(options);
    // Go passes `options` by value; the |= below mutates that local copy only.
    const opts = options.Prefix.length > 0 || options.Suffix.length > 0
        ? { Flags: options.Flags | GeneratedIdentifierFlagsOptimistic, Prefix: options.Prefix, Suffix: options.Suffix }
 ...
 * }
 */
export function NodeFactory_NewStringLiteralFromNode(receiver, textSourceNode) {
    let text = "";
    switch (textSourceNode.Kind) {
        case KindIdentifier:
    ...
    receiver.emitContext.textSource.set(node, textSourceNode);
    return node;
}
/**
 ...
 * }
 */
export function NodeFactory_NewThisExpression(receiver) {
 ...
 * }
 */
export function NodeFactory_NewTrueExpression(receiver) {
 ...
 * }
 */
export function NodeFactory_NewFalseExpression(receiver) {
 ...
 * }
 */
export function NodeFactory_NewCommaExpression(receiver, left, right) {
 ...
 * }
 */
export function NodeFactory_NewAssignmentExpression(receiver, left, right) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function NodeFactory_NewLogicalORExpression(receiver, left, right) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function NodeFactory_NewLogicalANDExpression(receiver, left, right) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function NodeFactory_NewStrictEqualityExpression(receiver, left, right) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function NodeFactory_NewStrictInequalityExpression(receiver, left, right) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function NodeFactory_NewVoidZeroExpression(receiver) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function flattenCommaElement(node, expressions) {
 ...
 * }
 */
export function flattenCommaElements(expressions) {
    let result = [];
 ...
 * }
 */
export function NodeFactory_InlineExpressions(receiver, expressions) {
 ...
 * }
 */
export function NodeFactory_CreateExpressionFromEntityName(receiver, node) {
    const f = receiver;
 ...
 * }
 */
export function NodeFactory_RestoreEnclosingLabel(receiver, node, outermostLabeledStatement) {
    ...
    return NodeFactory_UpdateLabeledStatement(receiver.__tsgoEmbedded0, outermostLabeledStatement, outermostLabeledStatement.Label, innerLabel);
}
/**
 ...
 * }
 */
export function NodeFactory_CreateForOfBindingStatement(receiver, node, boundValue) {
    const f = receiver.__tsgoEmbedded0;
    if (IsVariableDeclarationList(node)) {
        const firstDeclaration = AsVariableDeclarationList(node).Declarations.Nodes[0];
        const updatedDeclaration = NodeFactory_UpdateVariableDeclaration(f, AsVariableDeclaration(firstDeclaration), Node_Name(firstDeclaration), undefined, /*exclamationToken*/ undefined, /*type*/ boundValue);
        const updatedList = NodeFactory_UpdateVariableDeclarationList(f, AsVariableDeclarationList(node), NodeFactory_NewNodeList(f, [updatedDeclaration]), AsVariableDeclarationList(node).Flags);
 ...
 * }
 */
export function NodeFactory_NewTypeCheck(receiver, value, tag) {
    const f = receiver.__tsgoEmbedded0;
    if (tag === "null") {
 ...
 * }
 */
export function NodeFactory_NewMethodCall(receiver, object, methodName, argumentsList) {
    const f = receiver.__tsgoEmbedded0;
    // Preserve the optionality of `object`.
    if (IsCallExpression(object) && (object.Flags & NodeFlagsOptionalChain) !== 0) {
        return NewCallExpression(f, NewPropertyAccessExpression(f, object, undefined, methodName, NodeFlagsNone), undefined, undefined, NodeFactory_NewNodeList(f, argumentsList), NodeFlagsOptionalChain);
    }
    return NewCallExpression(f, NewPropertyAccessExpression(f, object, undefined, methodName, NodeFlagsNone), undefined, undefined, NodeFactory_NewNodeList(f, argumentsList), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewGlobalMethodCall(receiver, globalObjectName, methodName, argumentsList) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function NodeFactory_NewFunctionCallCall(receiver, target, thisArg, argumentsList) {
    const f = receiver.__tsgoEmbedded0;
    if (thisArg === undefined) {
        throw new globalThis.Error("Attempted to construct function call call without this argument expression");
    }
    const args = [thisArg, ...argumentsList];
 ...
 * }
 */
export function NodeFactory_NewArraySliceCall(receiver, array, start) {
    const f = receiver.__tsgoEmbedded0;
    let args = [];
    if (start !== 0) {
 ...
 * }
 */
export function NodeFactory_isIgnorableParen(receiver, node) {
    return (IsParenthesizedExpression(node) &&
        NodeIsSynthesized(node) &&
        RangeIsSynthesized(EmitContext_SourceMapRange(receiver.emitContext, node)) &&
        RangeIsSynthesized(EmitContext_CommentRange(receiver.emitContext, node)));
    // &&
    // len(emitContext.SyntheticLeadingComments(node)) == 0 &&
    // len(emitContext.SyntheticTrailingComments(node)) == 0
}
 ...
 * }
 */
export function NodeFactory_updateOuterExpression(receiver, outerExpression, expression) {
    const f = receiver.__tsgoEmbedded0;
    switch (outerExpression.Kind) {
        ...
        case KindNonNullExpression:
            return NodeFactory_UpdateNonNullExpression(f, AsNonNullExpression(outerExpression), expression, outerExpression.Flags);
        case KindExpressionWithTypeArguments:
            return NodeFactory_UpdateExpressionWithTypeArguments(f, AsExpressionWithTypeArguments(outerExpression), expression, Node_TypeArgumentList(outerExpression));
 ...
 * }
 */
export function NodeFactory_RestoreOuterExpressions(receiver, outerExpression, innerExpression, kinds) {
    if (outerExpression !== undefined && IsOuterExpression(outerExpression, kinds) && !NodeFactory_isIgnorableParen(receiver, outerExpression)) {
        return NodeFactory_updateOuterExpression(receiver, outerExpression, NodeFactory_RestoreOuterExpressions(receiver, Node_Expression(outerExpression), innerExpression, OEKAll));
    }
    return innerExpression;
}
/**
 ...
 * }
 */
export function NodeFactory_EnsureUseStrict(receiver, statements) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function NodeFactory_SplitStandardPrologue(receiver, source) {
 ...
 * }
 */
export function NodeFactory_SplitCustomPrologue(receiver, source) {
    for (let i = 0; i < source.length; i++) {
 ...
 * }
 */
export function NodeFactory_getName(receiver, node, emitFlags, opts) {
    ...
    if (nodeName !== undefined) {
        const name = Node_Clone(nodeName, receiver.__tsgoEmbedded0);
        let flags = emitFlags;
        if (!opts.AllowComments) {
            flags = (flags | EFNoComments);
        }
        if (!opts.AllowSourceMaps) {
            flags = (flags | EFNoSourceMap);
        }
        EmitContext_AddEmitFlags(receiver.emitContext, name, flags);
        return name;
    }
    return NodeFactory_NewGeneratedNameForNode(receiver, node);
}
/**
 ...
 * }
 */
export function NodeFactory_GetLocalName(receiver, node) {
 ...
 * }
 */
export function NodeFactory_GetLocalNameEx(receiver, node, opts) {
 ...
 * }
 */
export function NodeFactory_GetExportName(receiver, node) {
 ...
 * }
 */
export function NodeFactory_GetExportNameEx(receiver, node, opts) {
 ...
 * }
 */
export function NodeFactory_GetDeclarationName(receiver, node) {
 ...
 * }
 */
export function NodeFactory_GetDeclarationNameEx(receiver, node, opts) {
 ...
 * }
 */
export function NodeFactory_GetNamespaceMemberName(receiver, ns, name, opts) {
    const f = receiver.__tsgoEmbedded0;
    if (!EmitContext_HasAutoGenerateInfo(receiver.emitContext, name)) {
        name = Node_Clone(name, f);
    }
    const qualifiedName = NewPropertyAccessExpression(f, ns, undefined, name, NodeFlagsNone);
    EmitContext_AssignCommentAndSourceMapRanges(receiver.emitContext, qualifiedName, name);
    if (!opts.AllowComments) {
 ...
 * }
 */
export function NodeFactory_GetExternalModuleOrNamespaceExportName(receiver, ns, node, allowComments, allowSourceMaps) {
    if (ns !== undefined && HasSyntacticModifier(node, ModifierFlagsExport)) {
        const nameOpts = { AllowComments: allowComments, AllowSourceMaps: allowSourceMaps };
        return NodeFactory_GetNamespaceMemberName(receiver, ns, NodeFactory_GetDeclarationNameEx(receiver, node, nameOpts), nameOpts);
    }
    return NodeFactory_GetExportNameEx(receiver, node, { AllowComments: allowComments, AllowSourceMaps: allowSourceMaps, IgnoreAssignedName: false });
}
/**
 ...
 * }
 */
export function NodeFactory_NewUnscopedHelperName(receiver, name) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function NodeFactory_NewDecorateHelper(receiver, decoratorExpressions, target, memberName, descriptor) {
    const f = receiver.__tsgoEmbedded0;
    ...
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__decorate"), undefined, undefined, NodeFactory_NewNodeList(f, argumentsArray), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewMetadataHelper(receiver, metadataKey, metadataValue) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, metadataHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__metadata"), undefined, undefined, NodeFactory_NewNodeList(f, [
 ...
 * }
 */
export function NodeFactory_NewParamHelper(receiver, expression, parameterOffset, location) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, paramHelper);
    const helper = NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__param"), undefined, undefined, NodeFactory_NewNodeList(f, [NewNumericLiteral(f, Itoa(parameterOffset), TokenFlagsNone), expression]), NodeFlagsNone);
    helper.Loc = location;
    return helper;
}
/**
 ...
 * }
 */
export function NodeFactory_NewAddDisposableResourceHelper(receiver, envBinding, value, async) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, addDisposableResourceHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__addDisposableResource"), undefined, undefined, NodeFactory_NewNodeList(f, [envBinding, value, NewKeywordExpression(f, IfElse(async, KindTrueKeyword, KindFalseKeyword))]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewDisposeResourcesHelper(receiver, envBinding) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, disposeResourcesHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__disposeResources"), undefined, undefined, NodeFactory_NewNodeList(f, [envBinding]), NodeFlagsNone);
}
/**
 ...
 * )
 */
export const PrivateIdentifierKindField = "f";
export const PrivateIdentifierKindMethod = "m";
export const PrivateIdentifierKindAccessor = "a";
export const PrivateIdentifierKindUntransformed = "untransformed";
/**
 ...
 * }
 */
export function NodeFactory_NewClassPrivateFieldGetHelper(receiver, receiver1, state, kind, fn) {
    const f = receiver.__tsgoEmbedded0;
    ...
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__classPrivateFieldGet"), undefined, undefined, NodeFactory_NewNodeList(f, args), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewClassPrivateFieldSetHelper(receiver, receiver1, state, value, kind, fn) {
    const f = receiver.__tsgoEmbedded0;
    ...
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__classPrivateFieldSet"), undefined, undefined, NodeFactory_NewNodeList(f, args), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewClassPrivateFieldInHelper(receiver, state, receiver1) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, classPrivateFieldInHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__classPrivateFieldIn"), undefined, undefined, NodeFactory_NewNodeList(f, [state, receiver1]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewObjectDefinePropertyCall(receiver, target, name, descriptor) {
    const f = receiver.__tsgoEmbedded0;
    return NewCallExpression(f, NewPropertyAccessExpression(f, NewIdentifier(f, "Object"), undefined, NewIdentifier(f, "defineProperty"), NodeFlagsNone), undefined, undefined, NodeFactory_NewNodeList(f, [target, name, descriptor]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewReflectGetCall(receiver, target, propertyKey, receiver1) {
    const f = receiver.__tsgoEmbedded0;
    return NewCallExpression(f, NewPropertyAccessExpression(f, NewIdentifier(f, "Reflect"), undefined, NewIdentifier(f, "get"), NodeFlagsNone), undefined, undefined, NodeFactory_NewNodeList(f, [target, propertyKey, receiver1]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewReflectSetCall(receiver, target, propertyKey, value, receiver1) {
    const f = receiver.__tsgoEmbedded0;
    return NewCallExpression(f, NewPropertyAccessExpression(f, NewIdentifier(f, "Reflect"), undefined, NewIdentifier(f, "set"), NodeFlagsNone), undefined, undefined, NodeFactory_NewNodeList(f, [target, propertyKey, value, receiver1]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewFunctionBindCall(receiver, target, thisArg, argumentsList) {
    const f = receiver.__tsgoEmbedded0;
    const args = [thisArg, ...argumentsList];
 ...
 * }
 */
export function NodeFactory_NewImmediatelyInvokedArrowFunction(receiver, statements) {
    const f = receiver.__tsgoEmbedded0;
    const arrow = NewArrowFunction(f, undefined, /*modifiers*/ undefined, /*typeParameters*/ NodeFactory_NewNodeList(f, []), /*parameters*/ undefined, /*returnType*/ undefined, /*fullSignature*/ NewToken(f, KindEqualsGreaterThanToken), /*equalsGreaterThanToken*/ NewBlock(f, NodeFactory_NewNodeList(f, statements), true));
    return NewCallExpression(f, NewParenthesizedExpression(f, arrow), undefined, /*questionDotToken*/ undefined, /*typeArguments*/ NodeFactory_NewNodeList(f, []), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewExportDefault(receiver, expression) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function NodeFactory_NewExternalModuleExport(receiver, name) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function NodeFactory_NewAssignHelper(receiver, attributesSegments, scriptTarget) {
    const f = receiver.__tsgoEmbedded0;
 ...
 * }
 */
export function NodeFactory_NewRestHelper(receiver, value, elements, computedTempVariables, location) {
    const f = receiver.__tsgoEmbedded0;
    ...
    for (let i = 0; i < elements.length; i++) {
        ...
        if (propertyName !== undefined) {
            if (IsComputedPropertyName(propertyName)) {
                ...
                computedTempVariableOffset++;
                // typeof _tmp === "symbol" ? _tmp : _tmp + ""
                propertyNames = [...propertyNames, NewConditionalExpression(f, NodeFactory_NewTypeCheck(receiver, temp, "symbol"), NewToken(f, KindQuestionToken), temp, NewToken(f, KindColonToken), NewBinaryExpression(f, undefined, temp, undefined, NewToken(f, KindPlusToken), NewStringLiteral(f, "", TokenFlagsNone)))];
            }
            else {
    ...
    propNames.Loc = location;
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__rest"), undefined, undefined, NodeFactory_NewNodeList(f, [
        value,
        propNames,
    ]), NodeFlagsNone);
}
 ...
 * }
 */
export function NodeFactory_NewAwaitHelper(receiver, expression) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, awaitHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__await"), undefined, undefined, NodeFactory_NewNodeList(f, [expression]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewAsyncGeneratorHelper(receiver, generatorFunc, hasLexicalThis) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, awaitHelper);
    ...
    const thisArg = hasLexicalThis
        ? NewKeywordExpression(f, KindThisKeyword)
        : NodeFactory_NewVoidZeroExpression(receiver);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__asyncGenerator"), undefined, undefined, NodeFactory_NewNodeList(f, [
        thisArg,
 ...
 * }
 */
export function NodeFactory_NewAsyncDelegatorHelper(receiver, expression) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, awaitHelper);
    EmitContext_RequestEmitHelper(receiver.emitContext, asyncDelegatorHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__asyncDelegator"), undefined, undefined, NodeFactory_NewNodeList(f, [expression]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewAsyncValuesHelper(receiver, expression) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, asyncValuesHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__asyncValues"), undefined, undefined, NodeFactory_NewNodeList(f, [expression]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewAwaiterHelper(receiver, hasLexicalThis, argumentsExpression, parameters, body) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, awaiterHelper);
    const params = parameters !== undefined ? parameters : NodeFactory_NewNodeList(f, []);
    const generatorFunc = NewFunctionExpression(f, undefined, /*modifiers*/ NewToken(f, KindAsteriskToken), undefined, /*name*/ undefined, /*typeParameters*/ params, undefined, /*returnType*/ undefined, /*fullSignature*/ body);
    // Mark this node as originally an async function body
    EmitContext_AddEmitFlags(receiver.emitContext, generatorFunc, EFAsyncFunctionBody | EFReuseTempVariableScope);
    const thisArg = hasLexicalThis
        ? NewKeywordExpression(f, KindThisKeyword)
        : NodeFactory_NewVoidZeroExpression(receiver);
    const argsArg = argumentsExpression !== undefined
        ? argumentsExpression
        : NodeFactory_NewVoidZeroExpression(receiver);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__awaiter"), undefined, /*questionDotToken*/ undefined, /*typeArguments*/ NodeFactory_NewNodeList(f, [
        thisArg,
        argsArg,
        NodeFactory_NewVoidZeroExpression(receiver),
        generatorFunc,
 ...
 * }
 */
export function NodeFactory_NewESDecorateClassContextObject(receiver, nameExpr, metadata) {
    const f = receiver.__tsgoEmbedded0;
    const props = [
 ...
 * }
 */
export function NodeFactory_NewESDecorateClassElementAccessGetMethod(receiver, nameComputed, nameExpr) {
    const f = receiver.__tsgoEmbedded0;
    const accessor = nameComputed
    ...
    const arrow = NewArrowFunction(f, undefined, undefined, NodeFactory_NewNodeList(f, [objParam]), undefined, undefined, NewToken(f, KindEqualsGreaterThanToken), accessor);
 ...
 * }
 */
export function NodeFactory_NewESDecorateClassElementAccessSetMethod(receiver, nameComputed, nameExpr) {
    const f = receiver.__tsgoEmbedded0;
    const accessor = nameComputed
        ? NewElementAccessExpression(f, NewIdentifier(f, "obj"), undefined, nameExpr, NodeFlagsNone)
        : NewPropertyAccessExpression(f, NewIdentifier(f, "obj"), undefined, nameExpr, NodeFlagsNone);
    ...
    const arrow = NewArrowFunction(f, undefined, undefined, NodeFactory_NewNodeList(f, [objParam, valueParam]), undefined, undefined, NewToken(f, KindEqualsGreaterThanToken), body);
 ...
 * }
 */
export function NodeFactory_NewESDecorateClassElementAccessHasMethod(receiver, nameComputed, nameExpr) {
    const f = receiver.__tsgoEmbedded0;
    // The property name for the "in" expression
    const propertyName = !nameComputed && nameExpr !== undefined && IsIdentifier(nameExpr)
    ...
    const arrow = NewArrowFunction(f, undefined, undefined, NodeFactory_NewNodeList(f, [objParam]), undefined, undefined, NewToken(f, KindEqualsGreaterThanToken), inExpr);
 ...
 * }
 */
export function NodeFactory_NewESDecorateClassElementAccessObject(receiver, nameComputed, nameExpr, hasGet, hasSet) {
    const f = receiver.__tsgoEmbedded0;
    let accessProps = [];
    // "has" method: obj => name in obj
 ...
 * }
 */
export function NodeFactory_NewESDecorateClassElementContextObject(receiver, kind, nameComputed, nameExpr, isStatic, isPrivate, hasGet, hasSet, metadata) {
    const f = receiver.__tsgoEmbedded0;
    // Build the name value for the context's "name" property
    const nameValue = !nameComputed && nameExpr !== undefined && (IsPrivateIdentifier(nameExpr) || IsIdentifier(nameExpr))
        ? NodeFactory_NewStringLiteralFromNode(receiver, nameExpr)
        : nameExpr;
    // Build the access object with has/get/set arrow functions
    const accessObj = NodeFactory_NewESDecorateClassElementAccessObject(receiver, nameComputed, nameExpr, hasGet, hasSet);
    const staticExpr = isStatic
        ? NodeFactory_NewTrueExpression(receiver)
        : NodeFactory_NewFalseExpression(receiver);
    const privateExpr = isPrivate
        ? NodeFactory_NewTrueExpression(receiver)
        : NodeFactory_NewFalseExpression(receiver);
    const props = [
 ...
 * }
 */
export function NodeFactory_NewESDecorateHelper(receiver, ctor, descriptorIn, decorators, contextIn, initializers, extraInitializers) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, esDecorateHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__esDecorate"), undefined, undefined, NodeFactory_NewNodeList(f, [ctor, descriptorIn, decorators, contextIn, initializers, extraInitializers]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewRunInitializersHelper(receiver, thisArg, initializers, value) {
    const f = receiver.__tsgoEmbedded0;
    ...
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__runInitializers"), undefined, undefined, NodeFactory_NewNodeList(f, args), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewTemplateObjectHelper(receiver, cookedArray, rawArray) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, makeTemplateObjectHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__makeTemplateObject"), undefined, undefined, NodeFactory_NewNodeList(f, [cookedArray, rawArray]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewPropKeyHelper(receiver, expr) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, propKeyHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__propKey"), undefined, undefined, NodeFactory_NewNodeList(f, [expr]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewSetFunctionNameHelper(receiver, fn, name, prefix) {
    const f = receiver.__tsgoEmbedded0;
    ...
    const args = prefix.length > 0
        ...
        : [fn, name];
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__setFunctionName"), undefined, undefined, NodeFactory_NewNodeList(f, args), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewImportDefaultHelper(receiver, expression) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, importDefaultHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__importDefault"), undefined, undefined, NodeFactory_NewNodeList(f, [expression]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewImportStarHelper(receiver, expression) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, importStarHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__importStar"), undefined, undefined, NodeFactory_NewNodeList(f, [expression]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewExportStarHelper(receiver, moduleExpression, exportsExpression) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, exportStarHelper);
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__exportStar"), undefined, undefined, NodeFactory_NewNodeList(f, [moduleExpression, exportsExpression]), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewAssignmentTargetWrapper(receiver, paramName, expression) {
    const f = receiver.__tsgoEmbedded0;
    const setAccessor = NewSetAccessorDeclaration(f, undefined, NewIdentifier(f, "value"), undefined, NodeFactory_NewNodeList(f, [
        NewParameterDeclaration(f, undefined, undefined, paramName, undefined, undefined, undefined),
    ]), undefined, undefined, NewBlock(f, NodeFactory_NewNodeList(f, [NewExpressionStatement(f, expression)]), false));
    const objLiteral = NewObjectLiteralExpression(f, NodeFactory_NewNodeList(f, [setAccessor]), false);
    return NewPropertyAccessExpression(f, NewParenthesizedExpression(f, objLiteral), undefined, NewIdentifier(f, "value"), NodeFlagsNone);
}
/**
 ...
 * }
 */
export function NodeFactory_NewRewriteRelativeImportExtensionsHelper(receiver, firstArgument, preserveJsx) {
    const f = receiver.__tsgoEmbedded0;
    EmitContext_RequestEmitHelper(receiver.emitContext, rewriteRelativeImportExtensionsHelper);
    const args = preserveJsx
        ? [firstArgument, NewToken(f, KindTrueKeyword)]
        : [firstArgument];
    return NewCallExpression(f, NodeFactory_NewUnscopedHelperName(receiver, "__rewriteRelativeImportExtension"), undefined, undefined, NodeFactory_NewNodeList(f, args), NodeFlagsNone);
}
