...
import { textWriter_Clear, textWriter_DecreaseIndent, textWriter_GetColumn, textWriter_GetIndent, textWriter_GetLine, textWriter_GetTextPos, textWriter_HasTrailingComment, textWriter_HasTrailingWhitespace, textWriter_IncreaseIndent, textWriter_IsAtStartOfLine, textWriter_RawWrite, textWriter_String, textWriter_Write, textWriter_WriteComment, textWriter_WriteKeyword, textWriter_WriteLine, textWriter_WriteLineForce, textWriter_WriteLiteral, textWriter_WriteOperator, textWriter_WriteParameter, textWriter_WriteProperty, textWriter_WritePunctuation, textWriter_WriteSpace, textWriter_WriteStringLiteral, textWriter_WriteSymbol, textWriter_WriteTrailingSemicolon, } from "./textwriter.js";
...
const nodeTriviaPositionKeys = new WeakMap();
const nodeListTriviaPositionKeys = new WeakMap();
function Node_as_triviaPositionKey(receiver) {
    let value = nodeTriviaPositionKeys.get(receiver);
    if (value !== undefined)
        return value;
    value = {
        [goReceiverKey]: receiver,
        Pos: () => Node_Pos(receiver),
        End: () => Node_End(receiver),
    };
    nodeTriviaPositionKeys.set(receiver, value);
    return value;
}
// `*ast.NodeList` satisfies `triviaPositionKey` as well.
function NodeList_as_triviaPositionKey(receiver) {
    let value = nodeListTriviaPositionKeys.get(receiver);
    if (value !== undefined)
        return value;
    value = {
        [goReceiverKey]: receiver,
        Pos: () => NodeList_Pos(receiver),
        End: () => NodeList_End(receiver),
    };
 ...
 * }
 */
export function NewChangeTrackerWriter(newline, indentSize) {
    // TODO: Callers passing -1 should pass actual indent options once indent-related formatting is ported.
    const resolvedIndentSize = indentSize < 0 ? defaultIndentSize : indentSize;
    ...
    const ctw = {
        ...
        lastNonTriviaPosition: 0,
        pos: new globalThis.Map(),
        end: new globalThis.Map(),
    };
 ...
 * }
 */
export function ChangeTrackerWriter_setPos(receiver, node) {
 ...
 * }
 */
export function ChangeTrackerWriter_setEnd(receiver, node) {
 ...
 * }
 */
export function ChangeTrackerWriter_getPos(receiver, node) {
 ...
 * }
 */
export function ChangeTrackerWriter_getEnd(receiver, node) {
    // Go's map read of a missing key yields the int zero value.
 ...
 * }
 */
export function ChangeTrackerWriter_setLastNonTriviaPosition(receiver, s, force) {
 ...
 * }
 */
export function ChangeTrackerWriter_AssignPositionsToNode(receiver, node, factory) {
    ...
    visitor = NewNodeVisitor((n) => ChangeTrackerWriter_assignPositionsToNodeWorker(receiver, n, visitor), factory, {
        VisitNode: (n, v) => ChangeTrackerWriter_assignPositionsToNodeWorker(receiver, n, v),
        VisitNodes: (nodes, v) => ChangeTrackerWriter_assignPositionsToNodeArray(receiver, nodes, v),
        VisitToken: (n, v) => ChangeTrackerWriter_assignPositionsToNodeWorker(receiver, n, v),
        VisitModifiers: (modifiers, v) => {
            if (modifiers !== undefined) {
                const newNodeList = ChangeTrackerWriter_assignPositionsToNodeArray(receiver, modifiers, v);
                // Return a new ModifierList so that VisitEachChild/Update detects the
                // change and creates a new node with reassigned child positions.
 ...
 * }
 */
export function ChangeTrackerWriter_assignPositionsToNodeWorker(receiver, node, v) {
    if (node === undefined) {
        return node;
    }
    ...
    if (!NodeIsSynthesized(visited)) {
        newNode = Node_Clone(visited, v.Factory);
    }
    Node_ForEachChild(newNode, (child) => {
        child.Parent = newNode;
        return true;
    });
 ...
 * }
 */
export function ChangeTrackerWriter_assignPositionsToNodeArray(receiver, nodes, v) {
    ...
    if (visited === nodes) {
        nodeArray = NodeList_Clone(visited, v.Factory);
    }
 ...
 * }
 */
export function ChangeTrackerWriter_Write(receiver, text) {
    textWriter_Write(receiver.__tsgoEmbedded0, text);
    ChangeTrackerWriter_setLastNonTriviaPosition(receiver, text, false);
}
/**
 ...
 * }
 */
export function ChangeTrackerWriter_WriteTrailingSemicolon(receiver, text) {
 ...
 */
export function ChangeTrackerWriter_WriteComment(receiver, text) {
 ...
 * }
 */
export function ChangeTrackerWriter_WriteKeyword(receiver, text) {
 ...
 * }
 */
export function ChangeTrackerWriter_WriteOperator(receiver, text) {
 ...
 * }
 */
export function ChangeTrackerWriter_WritePunctuation(receiver, text) {
 ...
 * }
 */
export function ChangeTrackerWriter_WriteSpace(receiver, text) {
 ...
 * }
 */
export function ChangeTrackerWriter_WriteStringLiteral(receiver, text) {
 ...
 * }
 */
export function ChangeTrackerWriter_WriteParameter(receiver, text) {
 ...
 * }
 */
export function ChangeTrackerWriter_WriteProperty(receiver, text) {
 ...
 * }
 */
export function ChangeTrackerWriter_WriteSymbol(receiver, text, symbol_) {
 ...
 */
export function ChangeTrackerWriter_WriteLine(receiver) {
 ...
 */
export function ChangeTrackerWriter_WriteLineForce(receiver, force) {
 ...
 */
export function ChangeTrackerWriter_IncreaseIndent(receiver) {
 ...
 */
export function ChangeTrackerWriter_DecreaseIndent(receiver) {
 ...
 */
export function ChangeTrackerWriter_Clear(receiver) {
    textWriter_Clear(receiver.__tsgoEmbedded0);
    receiver.lastNonTriviaPosition = 0;
}
/**
 ...
 */
export function ChangeTrackerWriter_String(receiver) {
 ...
 * }
 */
export function ChangeTrackerWriter_RawWrite(receiver, s) {
    textWriter_RawWrite(receiver.__tsgoEmbedded0, s);
    ChangeTrackerWriter_setLastNonTriviaPosition(receiver, s, false);
}
/**
 ...
 * }
 */
export function ChangeTrackerWriter_WriteLiteral(receiver, s) {
    textWriter_WriteLiteral(receiver.__tsgoEmbedded0, s);
    ChangeTrackerWriter_setLastNonTriviaPosition(receiver, s, true);
}
/**
 ...
 */
export function ChangeTrackerWriter_GetTextPos(receiver) {
 ...
 */
export function ChangeTrackerWriter_GetLine(receiver) {
 ...
 */
export function ChangeTrackerWriter_GetColumn(receiver) {
 ...
 */
export function ChangeTrackerWriter_GetIndent(receiver) {
 ...
 */
export function ChangeTrackerWriter_IsAtStartOfLine(receiver) {
 ...
 */
export function ChangeTrackerWriter_HasTrailingComment(receiver) {
 ...
 * }
 */
export function ChangeTrackerWriter_HasTrailingWhitespace(receiver) {
    return textWriter_HasTrailingWhitespace(receiver.__tsgoEmbedded0);
}
//# sourceMappingURL=changetrackerwriter.js.map