 ...
 * )
 */
export const environmentFlagsNone = 0;
export const environmentFlagsInParameters = 1 << 0; // currently visiting a parameter list
export const environmentFlagsVariablesHoistedInParameters = 1 << 1; // a temp variable was hoisted while visiting a parameter list
/**
 ...
 * }
 */
export function EmitContext_Reset(receiver) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_onCreate(receiver, node) {
 ...
 * }
 */
export function EmitContext_onUpdate(receiver, updated, original) {
 ...
 * }
 */
export function EmitContext_onClone(receiver, updated, original) {
    const c = receiver;
    EmitContext_SetOriginal(receiver, updated, original);
    if (IsIdentifier(updated) || IsPrivateIdentifier(updated)) {
        ...
        if (autoGenerate !== undefined) {
            const autoGenerateCopy = { ...autoGenerate };
 ...
 * }
 */
export function EmitContext_NewNodeVisitor(receiver, visit) {
    const hooks = {
        VisitParameters: (nodes, visitor) => EmitContext_VisitParameters(receiver, nodes, visitor),
        VisitFunctionBody: (node, visitor) => EmitContext_VisitFunctionBody(receiver, node, visitor),
        VisitIterationBody: (body, visitor) => EmitContext_VisitIterationBody(receiver, body, visitor),
        VisitTopLevelStatements: (nodes, visitor) => EmitContext_VisitVariableEnvironment(receiver, nodes, visitor),
        VisitEmbeddedStatement: (node, visitor) => EmitContext_VisitEmbeddedStatement(receiver, node, visitor),
    };
 ...
 * }
 */
export function EmitContext_StartVariableEnvironment(receiver) {
    const c = receiver;
    const scope = { variables: [], functions: [], flags: environmentFlagsNone, initializationStatements: [] };
 ...
 * }
 */
export function EmitContext_EndVariableEnvironment(receiver) {
    const c = receiver;
    const scope = Stack_Pop(c.varScopeStack);
    const baseFunctions = scope.functions.length > 0 ? slices.Clone(scope.functions) : [];
 ...
 * }
 */
export function EmitContext_EndAndMergeVariableEnvironmentList(receiver, statements) {
    const c = receiver;
    const nodes = statements !== undefined ? statements.Nodes : [];
 ...
 * }
 */
export function EmitContext_EndAndMergeVariableEnvironment(receiver, statements) {
 ...
 * }
 */
export function EmitContext_AddVariableDeclaration(receiver, name) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_AddHoistedFunctionDeclaration(receiver, node) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_StartLexicalEnvironment(receiver) {
    const c = receiver;
    const scope = { variables: [], functions: [], flags: environmentFlagsNone, initializationStatements: [] };
 ...
 * }
 */
export function EmitContext_EndLexicalEnvironment(receiver) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_EndAndMergeLexicalEnvironmentList(receiver, statements) {
    const c = receiver;
    const nodes = statements !== undefined ? statements.Nodes : [];
 ...
 * }
 */
export function EmitContext_EndAndMergeLexicalEnvironment(receiver, statements) {
 ...
 * }
 */
export function EmitContext_AddLexicalDeclaration(receiver, name) {
    const c = receiver;
    const varDecl = NewVariableDeclaration(c.Factory.__tsgoEmbedded0, name, undefined, undefined, undefined);
    EmitContext_SetEmitFlags(receiver, varDecl, EFNoNestedSourceMaps);
 ...
 * }
 */
export function EmitContext_MergeEnvironmentList(receiver, statements, declarations) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_MergeEnvironment(receiver, statements, declarations) {
...
export function EmitContext_mergeEnvironment(receiver, statements, declarations) {
    ...
    if (rightStandardPrologueEnd > 0) {
        if (leftStandardPrologueEnd === 0) {
            ...
            const leftPrologues = { M: new globalThis.Map() };
 ...
 * }
 */
export function EmitContext_isCustomPrologue(receiver, node) {
 ...
 * }
 */
export function EmitContext_isHoistedFunction(receiver, node) {
 ...
 * }
 */
export function isHoistedVariable(node) {
 ...
 * }
 */
export function EmitContext_isHoistedVariableStatement(receiver, node) {
 ...
 * }
 */
export function EmitContext_HasAutoGenerateInfo(receiver, node) {
    const c = receiver;
    if (node !== undefined) {
 ...
 * }
 */
export function EmitContext_GetAutoGenerateInfo(receiver, name) {
    const c = receiver;
    if (name === undefined) {
        return undefined;
    }
 ...
 * }
 */
export function EmitContext_GetNodeForGeneratedName(receiver, name) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_getNodeForGeneratedNameWorker(receiver, node, autoGenerateId) {
    const c = receiver;
 ...
 */
export const nextAutoGenerateId = new Uint32();
/**
 ...
 * }
 */
export function EmitContext_SetOriginal(receiver, node, original) {
 ...
 * }
 */
export function EmitContext_UnsetOriginal(receiver, node) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_SetOriginalEx(receiver, node, original, allowOverwrite) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_Original(receiver, node) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_MostOriginal(receiver, node) {
    if (node === undefined)
        return undefined;
 ...
 * }
 */
export function EmitContext_ParseNode(receiver, node) {
 ...
 * )
 */
export const hasCommentRange = 1 << 0;
export const hasSourceMapRange = 1 << 1;
/**
 ...
 * }
 */
export function emitNode_copyFrom(receiver, source) {
    const e = receiver;
    const src = source;
    e.flags = src.flags;
 ...
 * }
 */
export function EmitContext_EmitFlags(receiver, node) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_SetEmitFlags(receiver, node, flags) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_AddEmitFlags(receiver, node, flags) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_CommentRange(receiver, node) {
    const c = receiver;
    const emitNode = LinkStore_TryGet(c.emitNodes, node);
 ...
 * }
 */
export function EmitContext_SetCommentRange(receiver, node, loc) {
    const c = receiver;
    const emitNode = LinkStore_Get(c.emitNodes, node);
    emitNode.commentRange = loc;
 ...
 * }
 */
export function EmitContext_AssignCommentRange(receiver, to, from_) {
 ...
 * }
 */
export function EmitContext_SourceMapRange(receiver, node) {
    const c = receiver;
    const emitNode = LinkStore_TryGet(c.emitNodes, node);
 ...
 * }
 */
export function EmitContext_SetSourceMapRange(receiver, node, loc) {
    const c = receiver;
    const emitNode = LinkStore_Get(c.emitNodes, node);
    emitNode.sourceMapRange = loc;
 ...
 * }
 */
export function EmitContext_AssignSourceMapRange(receiver, to, from_) {
 ...
 * }
 */
export function EmitContext_AssignCommentAndSourceMapRanges(receiver, to, from_) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_TokenSourceMapRange(receiver, node, kind) {
    const c = receiver;
    const emitNode = LinkStore_TryGet(c.emitNodes, node);
 ...
 * }
 */
export function EmitContext_SetTokenSourceMapRange(receiver, node, kind, loc) {
    const c = receiver;
    const emitNode = LinkStore_Get(c.emitNodes, node);
    if (emitNode.tokenSourceMapRanges === undefined) {
        emitNode.tokenSourceMapRanges = new globalThis.Map();
    }
 ...
 * }
 */
export function EmitContext_AssignedName(receiver, node) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_TextSource(receiver, node) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_SetAssignedName(receiver, node, name) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_ClassThis(receiver, node) {
    const c = receiver;
    return c.classThis.get(node);
}
/**
 ...
 * }
 */
export function EmitContext_SetClassThis(receiver, node, classThis) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_RequestEmitHelper(receiver, helper) {
    const c = receiver;
    if (helper.Scoped) {
 ...
 * }
 */
export function EmitContext_ReadEmitHelpers(receiver) {
    const c = receiver;
    const helpers = [];
 ...
 * }
 */
export function EmitContext_AddEmitHelper(receiver, node, ...helper) {
    const c = receiver;
    const emitNode = LinkStore_Get(c.emitNodes, node);
    emitNode.helpers ??= [];
 ...
 * }
 */
export function EmitContext_MoveEmitHelpers(receiver, source, target, predicate) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_GetEmitHelpers(receiver, node) {
    const c = receiver;
    const emitNode = LinkStore_TryGet(c.emitNodes, node);
    if (emitNode !== undefined) {
        return emitNode.helpers ?? [];
 ...
 * }
 */
export function EmitContext_GetExternalHelpersModuleName(receiver, node) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_SetExternalHelpersModuleName(receiver, node, name) {
    const c = receiver;
    const parseNode = EmitContext_ParseNode(receiver, Node_AsNode(node));
    if (parseNode === undefined) {
 ...
 * }
 */
export function EmitContext_HasRecordedExternalHelpers(receiver, node) {
    const c = receiver;
    const parseNode = EmitContext_ParseNode(receiver, Node_AsNode(node));
    if (parseNode !== undefined) {
        const emitNode = LinkStore_TryGet(c.emitNodes, parseNode);
 ...
 * }
 */
export function EmitContext_IsCallToHelper(receiver, firstSegment, helperName) {
 ...
 * }
 */
export function EmitContext_VisitVariableEnvironment(receiver, nodes, visitor) {
    EmitContext_StartVariableEnvironment(receiver);
    return EmitContext_EndAndMergeVariableEnvironmentList(receiver, NodeVisitor_VisitNodes(visitor, nodes));
}
/**
 ...
 * }
 */
export function EmitContext_VisitParameters(receiver, nodes, visitor) {
    const c = receiver;
    EmitContext_StartVariableEnvironment(receiver);
    const scope = Stack_Peek(c.varScopeStack);
    const oldFlags = scope.flags;
    scope.flags = scope.flags | environmentFlagsInParameters;
    let visitedNodes = NodeVisitor_VisitNodes(visitor, nodes);
    // As of ES2015, any runtime execution of that occurs in for a parameter (such as evaluating an
    // initializer or a binding pattern), occurs in its own lexical scope. As a result, any expression
    // that we might transform that introduces a temporary variable would fail as the temporary variable
    // exists in a different lexical scope. To address this, we move any binding patterns and initializers
 ...
 * }
 */
export function EmitContext_addDefaultValueAssignmentsIfNeeded(receiver, nodeList) {
    ...
    for (let i = 0; i < nodes.length; i++) {
        ...
        const updated = EmitContext_addDefaultValueAssignmentIfNeeded(receiver, parameter);
        if (updated !== parameter) {
            if (result === undefined) {
                result = slices.Clone(nodes);
            }
 ...
 * }
 */
export function EmitContext_addDefaultValueAssignmentIfNeeded(receiver, parameter) {
    // A rest parameter cannot have a binding pattern or an initializer,
    // so let's just ignore it.
 ...
 * }
 */
export function EmitContext_addDefaultValueAssignmentForBindingPattern(receiver, parameter) {
    const c = receiver;
    const f = c.Factory;
    const baseF = f.__tsgoEmbedded0;
    let initNode;
    if (parameter.Initializer !== undefined) {
        initNode = NewConditionalExpression(baseF, NodeFactory_NewStrictEqualityExpression(f, NodeFactory_NewGeneratedNameForNode(f, Node_AsNode(parameter)), NodeFactory_NewVoidZeroExpression(f)), NewToken(baseF, KindQuestionToken), parameter.Initializer, NewToken(baseF, KindColonToken), NodeFactory_NewGeneratedNameForNode(f, Node_AsNode(parameter)));
    }
    else {
        initNode = NodeFactory_NewGeneratedNameForNode(f, Node_AsNode(parameter));
    }
    EmitContext_AddInitializationStatement(receiver, NewVariableStatement(baseF, undefined, NewVariableDeclarationList(baseF, NodeFactory_NewNodeList(baseF, [NewVariableDeclaration(baseF, Node_Name(parameter), undefined, parameter.Type, initNode)]), NodeFlagsNone)));
    return NodeFactory_UpdateParameterDeclaration(baseF, parameter, Node_Modifiers(Node_AsNode(parameter)), parameter.DotDotDotToken, NodeFactory_NewGeneratedNameForNode(f, Node_AsNode(parameter)), parameter.QuestionToken, parameter.Type, undefined);
}
/**
 ...
 * }
 */
export function EmitContext_addDefaultValueAssignmentForInitializer(receiver, parameter, name, initializer) {
    const c = receiver;
    const f = c.Factory;
    const baseF = f.__tsgoEmbedded0;
    EmitContext_AddEmitFlags(receiver, initializer, EFNoSourceMap | EFNoComments);
    const nameClone = Node_Clone(name, baseF);
    EmitContext_AddEmitFlags(receiver, nameClone, EFNoSourceMap);
    const initAssignment = NodeFactory_NewAssignmentExpression(f, nameClone, initializer);
    initAssignment.Loc = parameter.Loc;
    EmitContext_AddEmitFlags(receiver, initAssignment, EFNoComments);
    const initBlock = NewBlock(baseF, NodeFactory_NewNodeList(baseF, [NewExpressionStatement(baseF, initAssignment)]), false);
    initBlock.Loc = parameter.Loc;
    EmitContext_AddEmitFlags(receiver, initBlock, EFSingleLine | EFNoTrailingSourceMap | EFNoTokenSourceMaps | EFNoComments);
    EmitContext_AddInitializationStatement(receiver, NewIfStatement(baseF, NodeFactory_NewTypeCheck(f, Node_Clone(name, baseF), "undefined"), initBlock, undefined));
    return NodeFactory_UpdateParameterDeclaration(baseF, parameter, Node_Modifiers(Node_AsNode(parameter)), parameter.DotDotDotToken, Node_Name(parameter), parameter.QuestionToken, parameter.Type, undefined);
}
/**
 ...
 * }
 */
export function EmitContext_AddInitializationStatement(receiver, node) {
    const c = receiver;
    const scope = Stack_Peek(c.varScopeStack);
    if (scope === undefined) {
 ...
 * }
 */
export function EmitContext_VisitFunctionBody(receiver, node, visitor) {
    const c = receiver;
    // !!! c.resumeVariableEnvironment()
    const updated = NodeVisitor_VisitNode(visitor, node);
    ...
    if (updated === undefined) {
        return NewBlock(f, NodeFactory_NewNodeList(f, declarations), true);
    }
    if (!IsBlock(updated)) {
        const statements = EmitContext_MergeEnvironment(receiver, [NewReturnStatement(f, updated)], declarations);
        return NewBlock(f, NodeFactory_NewNodeList(f, statements), false);
    }
    return NodeFactory_UpdateBlock(f, AsBlock(updated), EmitContext_MergeEnvironmentList(receiver, Node_StatementList(updated), declarations), AsBlock(updated).MultiLine);
}
/**
 ...
 * }
 */
export function EmitContext_VisitIterationBody(receiver, body, visitor) {
    if (body === undefined) {
        return undefined;
    }
    const c = receiver;
    ...
    if (statements.length > 0) {
        const f = c.Factory.__tsgoEmbedded0;
        if (IsBlock(updated)) {
            const updatedStatements = [...statements, ...Node_Statements(updated)];
            const statementsList = NodeFactory_NewNodeList(f, updatedStatements);
            statementsList.Loc = Node_StatementList(updated).Loc;
            return NodeFactory_UpdateBlock(f, AsBlock(updated), statementsList, AsBlock(updated).MultiLine);
        }
        const combined = [...statements, updated];
        return NewBlock(f, NodeFactory_NewNodeList(f, combined), true);
    }
    return updated;
}
/**
 ...
 * }
 */
export function EmitContext_VisitEmbeddedStatement(receiver, node, visitor) {
    if (node === undefined) {
        return undefined;
    }
    const concreteVisitor = visitor;
 ...
 * }
 */
export function EmitContext_SetSyntheticLeadingComments(receiver, node, comments) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_AddSyntheticLeadingComment(receiver, node, kind, text, hasTrailingNewLine) {
    const c = receiver;
    const emitNode = LinkStore_Get(c.emitNodes, node);
    emitNode.leadingComments = [...(emitNode.leadingComments ?? []), { Kind: kind, Loc: NewTextRange(-1, -1), HasLeadingNewLine: false, HasTrailingNewLine: hasTrailingNewLine, Text: text }];
    return node;
}
/**
 ...
 * }
 */
export function EmitContext_GetSyntheticLeadingComments(receiver, node) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_SetSyntheticTrailingComments(receiver, node, comments) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_AddSyntheticTrailingComment(receiver, node, kind, text, hasTrailingNewLine) {
    const c = receiver;
    const emitNode = LinkStore_Get(c.emitNodes, node);
    emitNode.trailingComments = [...(emitNode.trailingComments ?? []), { Kind: kind, Loc: NewTextRange(-1, -1), HasLeadingNewLine: false, HasTrailingNewLine: hasTrailingNewLine, Text: text }];
    return node;
}
/**
 ...
 * }
 */
export function EmitContext_GetSyntheticTrailingComments(receiver, node) {
    const c = receiver;
    if (LinkStore_Has(c.emitNodes, node)) {
 ...
 * }
 */
export function EmitContext_SetTypeNode(receiver, node, typeNode) {
    const c = receiver;
 ...
 * }
 */
export function EmitContext_GetTypeNode(receiver, node) {
    const c = receiver;
    const emitNode = LinkStore_TryGet(c.emitNodes, node);
    if (emitNode !== undefined) {
        return emitNode.typeNode;
 ...
 * }
 */
export function EmitContext_NewNotEmittedStatement(receiver, node) {
    const c = receiver;
    const f = c.Factory.__tsgoEmbedded0;
...
//# sourceMappingURL=emitcontext.js.map