 ...
 * }
 */
export function siblingNodePositionsAreComparable(emitContext, previousNode, nextNode) {
 ...
 * }
 */
export function originalNodesHaveSameParent(emitContext, nodeA, nodeB) {
