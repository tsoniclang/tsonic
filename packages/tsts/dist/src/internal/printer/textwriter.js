...
const utf8Decoder = new globalThis.TextDecoder("utf-8", { ignoreBOM: true });
const byteLen = (s) => utf8Encoder.encode(s).length;
const byteSliceFrom = (s, start) => {
    const bytes = utf8Encoder.encode(s);
    return utf8Decoder.decode(bytes.subarray(start));
};
const currentColumnByWriter = new WeakMap();
const textWriter_getCurrentColumn = (w) => currentColumnByWriter.get(w) ?? UTF16Len(byteSliceFrom(w.builder.String(), w.linePos));
const textWriter_setCurrentColumn = (w, column) => {
    currentColumnByWriter.set(w, column);
};
const textWriter_addCurrentColumn = (w, text) => {
...
function textWriter_as_EmitTextWriter(receiver) {
    const w = receiver;
    return {
        Write: (s) => textWriter_Write(w, s),
        WriteTrailingSemicolon: (text) => textWriter_WriteTrailingSemicolon(w, text),
        WriteComment: (text) => textWriter_WriteComment(w, text),
        WriteKeyword: (text) => textWriter_WriteKeyword(w, text),
        WriteOperator: (text) => textWriter_WriteOperator(w, text),
        WritePunctuation: (text) => textWriter_WritePunctuation(w, text),
        WriteSpace: (text) => textWriter_WriteSpace(w, text),
        WriteStringLiteral: (text) => textWriter_WriteStringLiteral(w, text),
        WriteParameter: (text) => textWriter_WriteParameter(w, text),
        WriteProperty: (text) => textWriter_WriteProperty(w, text),
        WriteSymbol: (text, symbol_) => textWriter_WriteSymbol(w, text, symbol_),
        WriteLine: () => textWriter_WriteLine(w),
        WriteLineForce: (force) => textWriter_WriteLineForce(w, force),
        IncreaseIndent: () => textWriter_IncreaseIndent(w),
        DecreaseIndent: () => textWriter_DecreaseIndent(w),
        Clear: () => textWriter_Clear(w),
        String: () => textWriter_String(w),
        RawWrite: (s) => textWriter_RawWrite(w, s),
        WriteLiteral: (s) => textWriter_WriteLiteral(w, s),
        GetTextPos: () => textWriter_GetTextPos(w),
        GetLine: () => textWriter_GetLine(w),
        GetColumn: () => textWriter_GetColumn(w),
        GetIndent: () => textWriter_GetIndent(w),
        IsAtStartOfLine: () => textWriter_IsAtStartOfLine(w),
        HasTrailingComment: () => textWriter_HasTrailingComment(w),
        HasTrailingWhitespace: () => textWriter_HasTrailingWhitespace(w),
    };
}
/**
 ...
 */
export const __f8aeeddb_0 = textWriter_as_EmitTextWriter({
    newLine: "",
    indentSize: 0,
    builder: new Builder(),
    lastWritten: "",
 ...
 * }
 */
export function textWriter_Clear(receiver) {
    const w = receiver;
 ...
 * }
 */
export function textWriter_Grow(receiver, n) {
    const w = receiver;
    w.builder.Grow(n);
}
/**
 ...
 * }
 */
export function textWriter_DecreaseIndent(receiver) {
    const w = receiver;
    w.indent--;
}
/**
 ...
 * }
 */
export function textWriter_GetColumn(receiver) {
    const w = receiver;
    if (w.lineStart) {
 ...
 * }
 */
export function textWriter_GetIndent(receiver) {
    const w = receiver;
    return w.indent;
}
/**
 ...
 * }
 */
export function textWriter_GetLine(receiver) {
    const w = receiver;
    return w.lineCount;
}
/**
 ...
 * }
 */
export function textWriter_String(receiver) {
    const w = receiver;
    return w.builder.String();
}
/**
 ...
 * }
 */
export function textWriter_GetTextPos(receiver) {
    const w = receiver;
    return w.builder.Len();
}
/**
 ...
 * }
 */
export function textWriter_HasTrailingComment(receiver) {
    const w = receiver;
    return w.hasTrailingCommentState;
}
/**
 ...
 * }
 */
export function textWriter_HasTrailingWhitespace(receiver) {
    const w = receiver;
    if (w.builder.Len() === 0) {
        return false;
    }
 ...
 * }
 */
export function textWriter_IncreaseIndent(receiver) {
    const w = receiver;
    w.indent++;
}
/**
 ...
 * }
 */
export function textWriter_IsAtStartOfLine(receiver) {
    const w = receiver;
    return w.lineStart;
}
/**
 ...
 * }
 */
export function textWriter_RawWrite(receiver, s) {
    const w = receiver;
    if (s !== "") {
        w.builder.WriteString(s);
        w.lastWritten = s;
 ...
 * }
 */
export function textWriter_updateLineCountAndPosFor(receiver, s) {
    const w = receiver;
    let count = 0;
    let lastLineStart = 0;
    ComputeECMALineStartsSeq(s)((lineStart) => {
        count++;
        lastLineStart = lineStart;
        return true;
    });
 ...
 */
export const defaultIndentSize = 4;
/**
 ...
 * }
 */
export function GetDefaultIndentSize() {
    return defaultIndentSize;
}
/**
 ...
 * }
 */
export function getIndentString(indent, indentSize) {
    if (indent === 0) {
        return "";
    }
    // TODO: This is cached in tsc - should it be cached here?
 ...
 * }
 */
export function textWriter_writeText(receiver, s) {
    const w = receiver;
    if (s !== "") {
        if (w.lineStart) {
 ...
 * }
 */
export function textWriter_Write(receiver, s) {
    const w = receiver;
    if (s !== "") {
        w.hasTrailingCommentState = false;
    }
 ...
 * }
 */
export function textWriter_WriteComment(receiver, text) {
    const w = receiver;
    if (text !== "") {
        w.hasTrailingCommentState = true;
    }
 ...
 * }
 */
export function textWriter_WriteKeyword(receiver, text) {
    const w = receiver;
 ...
 * }
 */
export function textWriter_writeLineRaw(receiver) {
    const w = receiver;
    w.builder.WriteString(w.newLine);
    w.lastWritten = w.newLine;
    w.lineCount++;
 ...
 * }
 */
export function textWriter_WriteLine(receiver) {
    const w = receiver;
    if (!w.lineStart) {
 ...
 * }
 */
export function textWriter_WriteLineForce(receiver, force) {
    const w = receiver;
    if (!w.lineStart || force) {
        textWriter_writeLineRaw(w);
    }
 ...
 * }
 */
export function textWriter_WriteLiteral(receiver, s) {
    const w = receiver;
 ...
 * }
 */
export function textWriter_WriteOperator(receiver, text) {
    const w = receiver;
    textWriter_Write(w, text);
}
/**
 ...
 * }
 */
export function textWriter_WriteParameter(receiver, text) {
    const w = receiver;
    textWriter_Write(w, text);
}
/**
 ...
 * }
 */
export function textWriter_WriteProperty(receiver, text) {
    const w = receiver;
    textWriter_Write(w, text);
}
/**
 ...
 * }
 */
export function textWriter_WritePunctuation(receiver, text) {
    const w = receiver;
    textWriter_Write(w, text);
}
/**
 ...
 * }
 */
export function textWriter_WriteSpace(receiver, text) {
    const w = receiver;
    textWriter_Write(w, text);
}
/**
 ...
 * }
 */
export function textWriter_WriteStringLiteral(receiver, text) {
    const w = receiver;
    textWriter_Write(w, text);
}
/**
 ...
 * }
 */
export function textWriter_WriteSymbol(receiver, text, symbol_) {
    const w = receiver;
    textWriter_Write(w, text);
}
/**
 ...
 * }
 */
export function textWriter_WriteTrailingSemicolon(receiver, text) {
    const w = receiver;
    textWriter_Write(w, text);
}
/**
 ...
 * }
 */
export function NewTextWriter(newLine, indentSize) {
    if (indentSize <= 0) {
        indentSize = 4;
    }
