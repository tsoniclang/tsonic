...
import { StringByteLen, StringByteSlice } from "../../go/unicode/utf8.js";
...
export declare const byteLen: typeof StringByteLen;
export declare const byteSlice: typeof StringByteSlice;
/**
 ...
 * )
 */
export declare const getLiteralTextFlagsNone: getLiteralTextFlags;
export declare const getLiteralTextFlagsNeverAsciiEscape: getLiteralTextFlags;
export declare const getLiteralTextFlagsJsxAttributeEscape: getLiteralTextFlags;
export declare const getLiteralTextFlagsTerminateUnterminatedLiterals: getLiteralTextFlags;
export declare const getLiteralTextFlagsAllowNumericSeparator: getLiteralTextFlags;
/**
 ...
 * )
 */
export declare const QuoteCharSingleQuote: QuoteChar;
export declare const QuoteCharDoubleQuote: QuoteChar;
export declare const QuoteCharBacktick: QuoteChar;
/**
 ...
 * }
 */
export declare const jsxEscapedCharsMap: GoMap<GoRune, string>;
/**
 ...
 * }
 */
export declare const escapedCharsMap: GoMap<GoRune, string>;
/**
 ...
 * }
 */
export declare function encodeJsxCharacterEntity(b: GoPtr<Builder>, charCode: GoRune): void;
/**
 ...
 * }
 */
export declare function encodeUtf16EscapeSequence(b: GoPtr<Builder>, charCode: GoRune): void;
/**
 ...
 * }
 */
export declare function escapeStringWorker(s: string, quoteChar: QuoteChar, flags: getLiteralTextFlags, b: GoPtr<Builder>): void;
/**
 ...
 * }
 */
export declare function EscapeString(s: string, quoteChar: QuoteChar): string;
/**
 ...
 * }
 */
export declare function escapeNonAsciiString(s: string, quoteChar: QuoteChar): string;
/**
 ...
 * }
 */
export declare function escapeJsxAttributeString(s: string, quoteChar: QuoteChar): string;
/**
 ...
 * }
 */
export declare function canUseOriginalText(node: GoPtr<LiteralLikeNode>, flags: getLiteralTextFlags): bool;
/**
 ...
 * }
 */
export declare function getLiteralText(node: GoPtr<LiteralLikeNode>, sourceFile: GoPtr<SourceFileNode>, flags: getLiteralTextFlags): string;
/**
 ...
 * }
 */
export declare function isNotPrologueDirective(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function RangeIsOnSingleLine(r: TextRange, sourceFile: GoPtr<SourceFileNode>): bool;
/**
 ...
 * }
 */
export declare function RangeStartPositionsAreOnSameLine(range1: TextRange, range2: TextRange, sourceFile: GoPtr<SourceFileNode>): bool;
/**
 ...
 * }
 */
export declare function rangeEndPositionsAreOnSameLine(range1: TextRange, range2: TextRange, sourceFile: GoPtr<SourceFileNode>): bool;
/**
 ...
 * }
 */
export declare function rangeStartIsOnSameLineAsRangeEnd(range1: TextRange, range2: TextRange, sourceFile: GoPtr<SourceFileNode>): bool;
/**
 ...
 * }
 */
export declare function rangeEndIsOnSameLineAsRangeStart(range1: TextRange, range2: TextRange, sourceFile: GoPtr<SourceFileNode>): bool;
/**
 ...
 * }
 */
export declare function getStartPositionOfRange(r: TextRange, sourceFile: GoPtr<SourceFileNode>, includeComments: bool): int;
/**
 ...
 * }
 */
export declare function PositionsAreOnSameLine(pos1: int, pos2: int, sourceFile: GoPtr<SourceFileNode>): bool;
/**
 ...
 * }
 */
export declare function GetLinesBetweenPositions(sourceFile: GoPtr<SourceFileNode>, pos1: int, pos2: int): int;
/**
 ...
 * }
 */
export declare function getLinesBetweenRangeEndAndRangeStart(range1: TextRange, range2: TextRange, sourceFile: GoPtr<SourceFileNode>, includeSecondRangeComments: bool): int;
/**
 ...
 * }
 */
export declare function getLinesBetweenPositionAndPrecedingNonWhitespaceCharacter(pos: int, stopPos: int, sourceFile: GoPtr<SourceFileNode>, includeComments: bool): int;
/**
 ...
 * }
 */
export declare function getLinesBetweenPositionAndNextNonWhitespaceCharacter(pos: int, stopPos: int, sourceFile: GoPtr<SourceFileNode>, includeComments: bool): int;
/**
 ...
 * }
 */
export declare function getPreviousNonWhitespacePosition(pos: int, stopPos: int, sourceFile: GoPtr<SourceFileNode>): int;
/**
 ...
 * }
 */
export declare function siblingNodePositionsAreComparable(emitContext: GoPtr<EmitContext>, previousNode: GoPtr<Node>, nextNode: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function getContainingNodeArray(node: GoPtr<Node>): GoPtr<NodeList>;
/**
 ...
 * }
 */
export declare function originalNodesHaveSameParent(emitContext: GoPtr<EmitContext>, nodeA: GoPtr<Node>, nodeB: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function tryGetEnd(node: {
    End: () => int;
}): [int, bool];
/**
 ...
 * }
 */
export declare function greatestEnd(end: int, ...nodes: Array<{
    End: () => int;
}>): int;
/**
 ...
 * }
 */
export declare function skipSynthesizedParentheses(node: GoPtr<Node>): GoPtr<Node>;
/**
 ...
 * }
 */
export declare function isNewExpressionWithoutArguments(node: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function isBinaryOperation(node: GoPtr<Node>, token: Kind): bool;
/**
 ...
 * }
 */
export declare function mixingBinaryOperatorsRequiresParentheses(a: Kind, b: Kind): bool;
/**
 ...
 * }
 */
export declare function isImmediatelyInvokedFunctionExpressionOrArrowFunction(node: GoPtr<Expression>): bool;
/**
 ...
 * }
 */
export declare function IsFileLevelUniqueName(sourceFile: GoPtr<SourceFileNode>, name: string, hasGlobalName: ((arg0: string) => bool) | undefined): bool;
/**
 ...
 * }
 */
export declare function hasLeadingHash(text: string): bool;
/**
 ...
 * }
 */
export declare function removeLeadingHash(text: string): string;
/**
 ...
 * }
 */
export declare function ensureLeadingHash(text: string): string;
/**
 ...
 * }
 */
export declare function FormatGeneratedName(privateName: bool, prefix: string, base: string, suffix: string): string;
/**
 ...
 * }
 */
export declare function isASCIIWordCharacter(ch: GoRune): bool;
/**
 ...
 * }
 */
export declare function findSpanEndWithEmitContext<T>(c: GoPtr<EmitContext>, array: GoSlice<T>, test: (c: GoPtr<EmitContext>, value: T) => bool, start: int): int;
/**
 ...
 * }
 */
export declare function findSpanEnd<T>(array: GoSlice<T>, test: (value: T) => bool, start: int): int;
/**
 ...
 * }
 */
export declare function skipWhiteSpaceSingleLine(text: string, pos: GoPtr<int>): void;
/**
 ...
 * }
 */
export declare function matchWhiteSpaceSingleLine(text: string, pos: GoPtr<int>): bool;
/**
 ...
 * }
 */
export declare function matchRune(text: string, pos: GoPtr<int>, expected: GoRune): bool;
/**
 ...
 * }
 */
export declare function matchString(text: string, pos: GoPtr<int>, expected: string): bool;
/**
 ...
 * }
 */
export declare function matchQuotedString(text: string, pos: GoPtr<int>): bool;
/**
 ...
 * }
 */
export declare function IsRecognizedTripleSlashComment(text: string, commentRange: CommentRange): bool;
/**
 ...
 * }
 */
export declare function isJSDocLikeText(text: string, comment: CommentRange): bool;
/**
 ...
 * }
 */
export declare function IsPinnedComment(text: string, comment: CommentRange): bool;
/**
 ...
 * }
 */
export declare function calculateIndent(text: string, pos: int, end: int): int;
/**
 ...
 * }
 */
export declare function newLineCharacterCache(source: Source): GoPtr<lineCharacterCache>;
/**
 ...
 * }
 */
export declare function lineCharacterCache_getLineAndCharacter(receiver: GoPtr<lineCharacterCache>, pos: int): [int, UTF16Offset];
