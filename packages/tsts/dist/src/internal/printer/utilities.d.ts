 ...
 * }
 */
export declare function siblingNodePositionsAreComparable(previousNode: GoPtr<Node>, nextNode: GoPtr<Node>): bool;
/**
 ...
 * }
 */
export declare function originalNodesHaveSameParent(nodeA: GoPtr<Node>, nodeB: GoPtr<Node>): bool;
/**
 ...
 * }
 */
type EndCarrier = GoPtr<Node> | GoPtr<NodeList> | TextRange | {
    End: () => int;
};
export declare function tryGetEnd(node: EndCarrier | undefined): [int, bool];
/**
 ...
 * }
 */
export declare function greatestEnd(end: int, ...nodes: Array<EndCarrier | undefined>): int;
/**
