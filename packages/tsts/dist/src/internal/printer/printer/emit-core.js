...
import { KindArrayBindingPattern, KindArrayLiteralExpression, KindArrowFunction, KindCallExpression, KindCallSignature, KindCaseClause, KindCaseKeyword, KindClassDeclaration, KindClassExpression, KindComputedPropertyName, KindConstructor, KindConstructorType, KindConstructSignature, KindDefaultClause, KindDefaultKeyword, KindEqualsToken, KindFunctionDeclaration, KindFunctionExpression, KindFunctionType, KindGetAccessor, KindGetKeyword, KindIdentifier, KindImportAttributes, KindInterfaceDeclaration, KindJsxAttribute, KindJsxNamespacedName, KindJsxElement, KindJsxExpression, KindJsxFragment, KindJSTypeAliasDeclaration, KindJsxSelfClosingElement, KindJsxSpreadAttribute, KindJsxText, KindMethodDeclaration, KindNamedExports, KindNamedImports, KindNewExpression, KindNoSubstitutionTemplateLiteral, KindNumericLiteral, KindBigIntLiteral, KindObjectBindingPattern, KindObjectLiteralExpression, KindPrivateIdentifier, KindPropertyAccessExpression, KindQualifiedName, KindSetAccessor, KindSetKeyword, KindStringLiteral, KindTaggedTemplateExpression, KindThisKeyword, KindTypeAliasDeclaration, KindTypeOfKeyword, } from "../../ast/generated/kinds.js";
import { KindBlock, KindBindingElement, KindCaseBlock, KindCatchClause, KindClassStaticBlockDeclaration, KindDoStatement, KindEnumMember, KindExportSpecifier, KindExternalModuleReference, KindForInStatement, KindForOfStatement, KindForStatement, KindHeritageClause, KindIfStatement, KindImportAttribute, KindImportClause, KindImportDeclaration, KindImportSpecifier, KindIndexSignature, KindJSImportDeclaration, KindLabeledStatement, KindMethodSignature, KindModuleBlock, KindNamespaceExport, KindNamespaceImport, KindNotEmittedTypeElement, KindParameter, KindPropertyAssignment, KindPropertySignature, KindSemicolonClassElement, KindShorthandPropertyAssignment, KindSourceFile, KindSpreadAssignment, KindSwitchStatement, KindTemplateSpan, KindTryStatement, KindVariableDeclaration, KindVariableDeclarationList, KindVariableStatement, KindCommaToken, KindDecorator, KindPropertyDeclaration, KindJsxAttributes, KindJsxOpeningElement, KindJsxOpeningFragment, KindJsxClosingElement, KindJsxClosingFragment, KindWhileStatement, KindWithStatement, } from "../../ast/generated/kinds.js";
...
import { AsBindingElement, AsBindingPattern, AsBigIntLiteral, AsBlock, AsCaseOrDefaultClause, AsComputedPropertyName, AsDecorator, AsIdentifier, AsJsxAttribute, AsJsxAttributes, AsJsxClosingElement, AsJsxClosingFragment, AsJsxExpression, AsJsxElement, AsJsxFragment, AsJsxNamespacedName, AsJsxOpeningElement, AsJsxOpeningFragment, AsJsxSelfClosingElement, AsJsxSpreadAttribute, AsJsxText, AsKeywordExpression, AsNoSubstitutionTemplateLiteral, AsNumericLiteral, AsParameterDeclaration, AsPrivateIdentifier, AsPropertyAccessExpression, AsQualifiedName, AsStringLiteral, AsCallSignatureDeclaration, AsCaseBlock, AsCatchClause, AsClassStaticBlockDeclaration, AsConstructorDeclaration, AsConstructSignatureDeclaration, AsEnumMember, AsExportSpecifier, AsExternalModuleReference, AsFunctionDeclaration, AsGetAccessorDeclaration, AsHeritageClause, AsIfStatement, AsImportAttribute, AsImportAttributes, AsImportClause, AsImportDeclaration, AsImportSpecifier, AsIndexSignatureDeclaration, AsMethodDeclaration, AsMethodSignatureDeclaration, AsModuleBlock, AsNamedExports, AsNamedImports, AsNamespaceExport, AsNamespaceImport, AsNotEmittedTypeElement, AsPropertyAssignment, AsPropertyDeclaration, AsPropertySignatureDeclaration, AsSetAccessorDeclaration, AsSemicolonClassElement, AsShorthandPropertyAssignment, AsSpreadAssignment, AsTemplateHead, AsTemplateMiddle, AsTemplateTail, AsTemplateSpan, AsSwitchStatement, AsTryStatement, AsVariableDeclaration, AsVariableDeclarationList, AsVariableStatement, } from "../../ast/generated/casts.js";
...
import { LFDecorators, LFModifiers, LFJsxElementOrFragmentChildren, LFJsxElementAttributes, LFAsteriskDelimited, LFBarDelimited, LFAmpersandDelimited, LFCommaDelimited, LFDelimitersMask, LFIndented, LFNone, LFParameters, LFPreferNewLine, WriteKindComment, WriteKindKeyword, WriteKindLiteral, WriteKindNone, WriteKindOperator, WriteKindParameter, WriteKindProperty, WriteKindPunctuation, WriteKindStringLiteral, LFAllowTrailingComma, LFLinesMask, LFNoInterveningComments, LFSingleLine, LFSpaceAfterList, LFSpaceBetweenBraces, LFSpaceBetweenSiblings, tefNone, tefNoComments, tefNoSourceMaps, commentSeparatorAfter, } from "./state.js";
/**
 ...
 * }
 */
export function Printer_getTextOfNode(receiver, node, includeTrivia) {
    if (IsMemberName(node) && receiver.emitContext.autoGenerate.has(node)) {
        return NameGenerator_GenerateName(receiver.nameGenerator, node);
    }
    if (IsStringLiteral(node)) {
        const textSourceNode = receiver.emitContext.textSource.get(node);
    ...
    switch (node.Kind) {
        ...
        case KindTemplateTail:
            return Printer_getLiteralTextOfNode(receiver, node, undefined, getLiteralTextFlagsNone);
        default:
 ...
 * }
 */
export function Printer_writeAs(receiver, text, writeKind) {
    switch (writeKind) {
        case WriteKindNone:
 ...
 * }
 */
export function Printer_write(receiver, text) {
 ...
 * }
 */
export function Printer_setWriteKind(receiver, kind) {
 ...
 * }
 */
export function Printer_writeSymbol(receiver, text, optSymbol) {
 ...
 * }
 */
export function Printer_writePunctuation(receiver, text) {
 ...
 * }
 */
export function Printer_writeOperator(receiver, text) {
 ...
 * }
 */
export function Printer_writeKeyword(receiver, text) {
 ...
 * }
 */
export function Printer_writeProperty(receiver, text) {
 ...
 * }
 */
export function Printer_writeParameter(receiver, text) {
 ...
 * }
 */
export function Printer_writeSpace(receiver) {
 ...
 * }
 */
export function Printer_writeTrailingSemicolon(receiver) {
 ...
 * }
 */
export function Printer_increaseIndent(receiver) {
 ...
 * }
 */
export function Printer_decreaseIndent(receiver) {
 ...
 * }
 */
export function Printer_shouldEmitIndented(receiver, node) {
    return ((EmitContext_EmitFlags(receiver.emitContext, node) & EFIndented) !== 0);
}
/**
 ...
 * }
 */
export function Printer_shouldElideIndentation(receiver, node) {
    return ((EmitContext_EmitFlags(receiver.emitContext, node) & EFNoIndentation) !== 0);
}
/**
 ...
 * }
 */
export function Printer_shouldAllowTrailingComma(receiver, node, list) {
    ...
    switch (node.Kind) {
        ...
        case KindInterfaceDeclaration:
            return (list === Node_TypeParameterList(node));
 ...
 * }
 */
export function Printer_writeTokenText(receiver, token, writeKind, pos) {
    // !!! emit leading and trailing comments
    // !!! emit leading and trailing source maps
 ...
 * }
 */
export function Printer_emitToken(receiver, token, pos, writeKind, contextNode) {
 ...
 * }
 */
export function Printer_emitTokenEx(receiver, token, pos, writeKind, contextNode, flags) {
 ...
 * }
 */
export function Printer_emitKeywordNode(receiver, node) {
 ...
 * }
 */
export function Printer_emitKeywordNodeEx(receiver, node, flags) {
    if (node === undefined) {
        return;
    }
 ...
 * }
 */
export function Printer_emitPunctuationNode(receiver, node) {
 ...
 * }
 */
export function Printer_emitPunctuationNodeEx(receiver, node, flags) {
    if (node === undefined) {
        return;
    }
    const state = Printer_enterTokenNode(receiver, node, flags);
 ...
 * }
 */
export function Printer_emitTokenNode(receiver, node) {
 ...
 * }
 */
export function Printer_emitTokenNodeEx(receiver, node, flags) {
    if (node === undefined) {
        return;
    }
 ...
 * }
 */
export function Printer_emitIdentifierText(receiver, node) {
    const f = GetSourceFileOfNode(NodeDefault_AsNode(node));
    // debug.Assert(f == nil || p.currentSourceFile == nil || f.FileName() == p.currentSourceFile.FileName())
    const text = Printer_getTextOfNode(receiver, NodeDefault_AsNode(node), false);
 ...
 * }
 */
export function Printer_emitIdentifierName(receiver, node) {
 ...
 * }
 */
export function Printer_emitIdentifierNameNode(receiver, node) {
    if (node === undefined) {
        return;
    }
 ...
 * }
 */
export function Printer_getUniqueHelperName(receiver, name) {
    const helperName = receiver.uniqueHelperNames.get(name);
    if (helperName === undefined) {
        const newHelperName = NodeFactory_NewUniqueNameEx(receiver.emitContext.Factory, name, {
 ...
 * }
 */
export function Printer_emitIdentifierReference(receiver, node) {
    if ((receiver.externalHelpersModuleName !== undefined || receiver.uniqueHelperNames !== undefined) &&
        ...
        if (receiver.externalHelpersModuleName !== undefined) {
            const helper = NewPropertyAccessExpression(receiver.emitContext.Factory.AsNodeFactory(), Node_Clone(receiver.externalHelpersModuleName, receiver.emitContext.Factory), undefined, Node_Clone(NodeDefault_AsNode(node), receiver.emitContext.Factory), NodeFlagsNone);
 ...
 * }
 */
export function Printer_emitBindingIdentifier(receiver, node) {
    let n = node;
    if (receiver.uniqueHelperNames !== undefined &&
        (EmitContext_EmitFlags(receiver.emitContext, NodeDefault_AsNode(node)) & EFHelperName) !== 0) {
        // Substitute `__helper` with `__helper_1` if there is a conflict in an ES module.
 ...
 * }
 */
export function Printer_emitLabelIdentifier(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitIdentifierText(receiver, node);
    Printer_exitNode(receiver, NodeDefault_AsNode(node), state);
}
 ...
 * }
 */
export function Printer_emitPrivateIdentifier(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_write(receiver, Printer_getTextOfNode(receiver, NodeDefault_AsNode(node), false));
    Printer_exitNode(receiver, NodeDefault_AsNode(node), state);
}
/**
 ...
 * }
 */
export function Printer_emitQualifiedName(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitComputedPropertyName(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "[");
 ...
 * }
 */
export function Printer_emitEntityName(receiver, node) {
    switch (node.Kind) {
        case KindIdentifier:
 ...
 * }
 */
export function Printer_emitBindingName(receiver, node) {
    if (node === undefined) {
        return;
    }
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitPropertyName(receiver, node) {
    if (node === undefined) {
        return;
    }
 ...
 * }
 */
export function Printer_emitModifierList(receiver, parentNode, modifiers, allowDecorators) {
    if (modifiers === undefined || modifiers.Nodes.length === 0) {
        return Node_Pos(parentNode);
    }
    if (Every(modifiers.Nodes, IsModifier)) {
        // if all modifier-likes are `Modifier`, simply emit the list as modifiers.
        Printer_emitList(receiver, Printer_emitKeywordNode, parentNode, modifiers, LFModifiers);
    }
        ...
        // if all modifier-likes are `Decorator`, simply emit the list as decorators.
        Printer_emitList(receiver, Printer_emitModifierLike, parentNode, modifiers, LFDecorators);
    }
    else {
        if (receiver.__tsgoEmbedded0?.OnBeforeEmitNodeList !== undefined) {
            receiver.__tsgoEmbedded0.OnBeforeEmitNodeList(modifiers);
        }
        ...
        while (start < modifiers.Nodes.length) {
            ...
            const textRangePos = start === 0 ? NodeList_Pos(modifiers) : -1;
            const textRangeEnd = pos === modifiers.Nodes.length - 1 ? NodeList_End(modifiers) : -1;
            const textRange = NewTextRange(textRangePos, textRangeEnd);
            if (allowDecorators || lastMode === ModeModifiers) {
                Printer_emitListItems(receiver, Printer_emitModifierLike, parentNode, modifiers.Nodes.slice(start, pos), IfElse(lastMode === ModeModifiers, LFModifiers, LFDecorators), false, textRange);
            }
            start = pos;
            lastMode = mode;
            pos++;
        ...
        if (receiver.__tsgoEmbedded0?.OnAfterEmitNodeList !== undefined) {
            receiver.__tsgoEmbedded0.OnAfterEmitNodeList(modifiers);
        }
    }
    return greatestEnd(Node_Pos(parentNode), LastOrNil(modifiers.Nodes));
}
/**
 ...
 * }
 */
export function Printer_emitParameterName(receiver, node) {
    const savedWriteKind = receiver.writeKind;
 ...
 * }
 */
export function Printer_emitParameter(receiver, node) {
    ...
    Printer_emitModifierList(receiver, parameterNode, parameterModifiers, true);
    Printer_emitTokenNode(receiver, node.DotDotDotToken);
    Printer_emitParameterName(receiver, parameterName);
    Printer_emitTokenNode(receiver, node.QuestionToken);
    Printer_emitTypeAnnotation(receiver, node.Type);
    // The comment position has to fallback to any present node within the parameter declaration because as it turns
    // out, the parser can make parameter declarations with _just_ an initializer.
    Printer_emitInitializer(receiver, node.Initializer, greatestEnd(Node_Pos(parameterNode), node.Type, node.QuestionToken, parameterName, parameterModifiers), parameterNode);
 ...
 * }
 */
export function Printer_emitParameterDeclarationNode(receiver, node) {
 ...
 * }
 */
export function Printer_emitDecorator(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "@");
 ...
 * }
 */
export function Printer_emitModifierLike(receiver, node) {
    if (IsDecorator(node)) {
 ...
 * }
 */
export function Printer_emitInitializer(receiver, node, equalTokenPos, contextNode) {
    if (node === undefined) {
        return;
    }
 ...
 * }
 */
export function Printer_emitParameters(receiver, parentNode, parameters) {
 ...
 * }
 */
export function Printer_emitSignature(receiver, node) {
 ...
 * }
 */
export function Printer_emitPropertySignature(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitPropertyDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitModifierList(receiver, NodeDefault_AsNode(node), Node_Modifiers(NodeDefault_AsNode(node)), true);
    Printer_emitPropertyName(receiver, Node_Name(NodeDefault_AsNode(node)));
    Printer_emitTokenNode(receiver, node.PostfixToken);
    Printer_emitTypeAnnotation(receiver, node.Type);
    Printer_emitInitializer(receiver, node.Initializer, greatestEnd(Node_End(Node_Name(NodeDefault_AsNode(node))), node.Type, node.PostfixToken), NodeDefault_AsNode(node));
    Printer_writeTrailingSemicolon(receiver);
    Printer_exitNode(receiver, NodeDefault_AsNode(node), state);
}
/**
 ...
 * }
 */
export function Printer_emitMethodSignature(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitModifierList(receiver, NodeDefault_AsNode(node), Node_Modifiers(NodeDefault_AsNode(node)), false);
    Printer_emitPropertyName(receiver, Node_Name(NodeDefault_AsNode(node)));
    Printer_emitTokenNode(receiver, node.PostfixToken);
 ...
 * }
 */
export function Printer_emitMethodDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitModifierList(receiver, NodeDefault_AsNode(node), Node_Modifiers(NodeDefault_AsNode(node)), true);
 ...
 * }
 */
export function Printer_emitConstructor(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitModifierList(receiver, NodeDefault_AsNode(node), Node_Modifiers(NodeDefault_AsNode(node)), false);
 ...
 * }
 */
export function Printer_emitAccessorDeclaration(receiver, token, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    const pos = Printer_emitModifierList(receiver, NodeDefault_AsNode(node), Node_Modifiers(NodeDefault_AsNode(node)), true);
 ...
 * }
 */
export function Printer_emitGetAccessorDeclaration(receiver, node) {
 ...
 * }
 */
export function Printer_emitSetAccessorDeclaration(receiver, node) {
 ...
 * }
 */
export function Printer_emitConstructSignature(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitIndexSignature(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitModifierList(receiver, NodeDefault_AsNode(node), Node_Modifiers(NodeDefault_AsNode(node)), false);
    const indented = Printer_shouldEmitIndented(receiver, NodeDefault_AsNode(node));
    Printer_increaseIndentIf(receiver, indented);
 ...
 * }
 */
export function Printer_emitBindingElement(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitTokenNode(receiver, node.DotDotDotToken);
    ...
    if (name !== undefined) {
        Printer_emitBindingName(receiver, name);
        Printer_emitInitializer(receiver, node.Initializer, Node_End(name), NodeDefault_AsNode(node));
    }
    Printer_exitNode(receiver, NodeDefault_AsNode(node), state);
}
/**
 ...
 * }
 */
export function Printer_emitBindingElementNode(receiver, node) {
 ...
 * }
 */
export function Printer_emitArgument(receiver, node) {
 ...
 * }
 */
export function Printer_emitConciseBody(receiver, node) {
    if (IsBlock(node)) {
        Printer_emitFunctionBody(receiver, AsBlock(node));
    }
    else if (IsObjectLiteralExpression(GetLeftmostExpression(node, false))) {
        // Wrap in ParenthesizedExpression to ensure parens are emitted after any leading
        // PartiallyEmittedExpression comments, matching TypeScript's factory-time wrapping
        // via parenthesizeConciseBodyOfArrowFunction.
        const paren = NewParenthesizedExpression(receiver.emitContext.Factory.__tsgoEmbedded0, node);
        paren.Loc = node.Loc;
        Printer_emitExpression(receiver, paren, OperatorPrecedenceLowest);
    }
    else if (IsExpression(node)) {
        Printer_emitExpression(receiver, node, OperatorPrecedenceYield);
    }
    else {
        throw new globalThis.Error(`unexpected ConciseBody: ${node.Kind}`);
    }
}
/**
 ...
 * }
 */
export function Printer_emitMetaProperty(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitJsxElement(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitJsxOpeningElement(receiver, AsJsxOpeningElement(node.OpeningElement));
    Printer_emitList(receiver, Printer_emitJsxChild, NodeDefault_AsNode(node), node.Children, LFJsxElementOrFragmentChildren);
 ...
 * }
 */
export function Printer_emitJsxSelfClosingElement(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "<");
 ...
 * }
 */
export function Printer_emitJsxFragment(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitJsxOpeningElement(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "<");
 ...
 * }
 */
export function Printer_emitJsxClosingElement(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "</");
    Printer_emitJsxTagName(receiver, node.TagName);
    Printer_writePunctuation(receiver, ">");
 ...
 * }
 */
export function Printer_emitJsxOpeningFragment(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "<");
    Printer_writePunctuation(receiver, ">");
    Printer_exitNode(receiver, NodeDefault_AsNode(node), state);
 ...
 * }
 */
export function Printer_emitJsxClosingFragment(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "</");
    Printer_writePunctuation(receiver, ">");
    Printer_exitNode(receiver, NodeDefault_AsNode(node), state);
 ...
 * }
 */
export function Printer_emitJsxText(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitJsxAttributes(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitList(receiver, Printer_emitJsxAttributeLike, NodeDefault_AsNode(node), node.Properties, LFJsxElementAttributes);
    Printer_exitNode(receiver, NodeDefault_AsNode(node), state);
}
/**
 ...
 * }
 */
export function Printer_emitJsxAttribute(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitJsxAttributeName(receiver, Node_Name(NodeDefault_AsNode(node)));
 ...
 * }
 */
export function Printer_emitJsxAttributeLike(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitJsxChild(receiver, node) {
    switch (node.Kind) {
        case KindJsxText:
 ...
 * }
 */
export function Printer_emitJsxTagName(receiver, node) {
    switch (node.Kind) {
        case KindIdentifier:
            Printer_emitIdentifierReference(receiver, AsIdentifier(node));
            break;
 ...
 * }
 */
export function Printer_emitJsxAttributeName(receiver, node) {
    switch (node.Kind) {
        case KindIdentifier:
            Printer_emitIdentifierName(receiver, AsIdentifier(node));
            break;
 ...
 * }
 */
export function Printer_emitJsxAttributeValue(receiver, node) {
    switch (node.Kind) {
        case KindStringLiteral:
            Printer_emitStringLiteral(receiver, AsStringLiteral(node));
            break;
 ...
 * }
 */
export function Printer_emitCaseClause(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitDefaultClause(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitCaseOrDefaultClauseNode(receiver, node) {
    switch (node.Kind) {
        case KindCaseClause:
 ...
 * }
 */
export function Printer_emitPropertyAssignment(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitPropertyName(receiver, Node_Name(NodeDefault_AsNode(node)));
    Printer_writePunctuation(receiver, ":");
    Printer_writeSpace(receiver);
 ...
 * }
 */
export function Printer_emitShorthandPropertyAssignment(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitPropertyName(receiver, Node_Name(NodeDefault_AsNode(node)));
 ...
 * }
 */
export function Printer_emitHelpers(receiver, node) {
 ...
 * }
 */
export function Printer_emitList(receiver, emit, parentNode, children, format) {
    if (Printer_shouldEmitOnMultipleLines(receiver, parentNode)) {
        format = (format | LFPreferNewLine | LFIndented);
    }
 ...
 * }
 */
export function Printer_hasTrailingComma(receiver, parentNode, children) {
    ...
    switch (originalParent.Kind) {
        ...
        case KindNamedExports:
            ...
            break;
        case KindImportAttributes:
            originalList = AsImportAttributes(originalParent).Attributes;
            break;
    }
 ...
 * }
 */
export function Printer_writeDelimiter(receiver, format) {
    switch ((format & LFDelimitersMask)) {
        case LFNone:
            break;
        case LFCommaDelimited:
 ...
 * }
 */
export function Printer_emitListItems(receiver, emit, parentNode, children, format, hasTrailingComma, childrenTextRange) {
    const mayEmitInterveningComments = ((format & LFNoInterveningComments) === 0);
    ...
    const parentEnd = greatestEnd(-1, parentNode);
    ...
    for (const child of children) {
        if ((format & LFAsteriskDelimited) !== 0) {
            ...
            if ((format & LFDelimitersMask) !== 0 && Node_End(previousSibling) !== parentEnd) {
                if (!receiver.commentsDisabled && Printer_shouldEmitTrailingComments(receiver, previousSibling)) {
                    Printer_emitLeadingComments(receiver, Node_End(previousSibling), false);
                }
            }
            Printer_writeDelimiter(receiver, format);
            ...
            if (separatingLineTerminatorCount > 0) {
                ...
                if (shouldEmitInterveningComments && (format & LFDelimitersMask) !== 0 && !PositionIsSynthesized(Node_Pos(child)) && Printer_shouldEmitLeadingComments(receiver, child)) {
                    ...
                    Printer_emitTrailingCommentsOfPosition(receiver, TextRange_Pos(commentRange), ((format & LFSpaceBetweenSiblings) !== 0), true);
                }
        ...
        if (shouldEmitInterveningComments && Printer_shouldEmitLeadingComments(receiver, child)) {
            const commentRange = EmitContext_CommentRange(receiver.emitContext, child);
            Printer_emitTrailingCommentsOfPosition(receiver, TextRange_Pos(commentRange), false, false);
        }
        else {
            shouldEmitInterveningComments = mayEmitInterveningComments;
        }
    ...
    if (previousSibling !== undefined && parentEnd !== Node_End(previousSibling) && (format & LFDelimitersMask) !== 0 && !skipTrailingComments) {
        ...
        Printer_emitLeadingComments(receiver, commentsPos, false);
    }
    if ((format & LFIndented) !== 0) {
        Printer_decreaseIndent(receiver);
    }
 ...
 * }
 */
export function Printer_Emit(receiver, node, sourceFile) {
 ...
 * }
 */
export function Printer_Write(receiver, node, sourceFile, writer, sourceMapGenerator) {
    ...
    receiver.sourceMapsDisabled = (sourceMapGenerator === undefined);
    ...
    switch (node.Kind) {
        ...
        default:
            if (IsTypeNode(node)) {
                ...
                Printer_emitPunctuationNode(receiver, node);
            }
 ...
 * }
 */
export function Printer_emitPos(receiver, pos) {
 ...
 * }
 */
export function Printer_pushNameGenerationScope(receiver, node) {
 ...
 * }
 */
export function Printer_popNameGenerationScope(receiver, node) {
 ...
 * }
 */
export function Printer_generateAllNames(receiver, nodes) {
    if (nodes === undefined) {
        return;
    }
 ...
 * }
 */
export function Printer_generateNames(receiver, node) {
    if (node === undefined) {
        return;
    }
    switch (node.Kind) {
        ...
        case KindIfStatement: {
            ...
            Printer_generateNames(receiver, ifStmt.ThenStatement);
            Printer_generateNames(receiver, ifStmt.ElseStatement);
            break;
        }
        ...
        case KindSwitchStatement:
            Printer_generateNames(receiver, AsSwitchStatement(node).CaseBlock);
            break;
        case KindCaseBlock:
            Printer_generateAllNames(receiver, AsCaseBlock(node).Clauses);
            break;
        case KindTryStatement: {
            const tryStmt = AsTryStatement(node);
            Printer_generateNames(receiver, tryStmt.TryBlock);
            Printer_generateNames(receiver, tryStmt.CatchClause);
            Printer_generateNames(receiver, tryStmt.FinallyBlock);
            break;
        }
        case KindCatchClause: {
            const catchClause = AsCatchClause(node);
            Printer_generateNames(receiver, catchClause.VariableDeclaration);
            Printer_generateNames(receiver, catchClause.Block);
            break;
        }
        case KindVariableStatement:
            Printer_generateNames(receiver, AsVariableStatement(node).DeclarationList);
            break;
        case KindVariableDeclarationList:
            Printer_generateAllNames(receiver, AsVariableDeclarationList(node).Declarations);
            break;
        case KindVariableDeclaration:
        case KindParameter:
        case KindBindingElement:
        ...
        case KindFunctionDeclaration: {
            ...
            if (Printer_shouldReuseTempVariableScope(receiver, node)) {
                Printer_generateAllNames(receiver, fnDecl.Parameters);
                Printer_generateNames(receiver, fnDecl.Body);
            }
            break;
        }
        case KindObjectBindingPattern:
        ...
        case KindJSImportDeclaration:
            Printer_generateNames(receiver, AsImportDeclaration(node).ImportClause);
            break;
        case KindImportClause: {
            const importClause = AsImportClause(node);
            Printer_generateNameIfNeeded(receiver, importClause.name);
            Printer_generateNames(receiver, importClause.NamedBindings);
            break;
        }
        case KindNamespaceImport:
        case KindNamespaceExport:
        ...
        case KindImportSpecifier: {
            ...
            if (importSpecifier.PropertyName !== undefined) {
                Printer_generateNameIfNeeded(receiver, importSpecifier.PropertyName);
            }
            else {
                Printer_generateNameIfNeeded(receiver, importSpecifier.name);
            }
            break;
        }
    }
 ...
 * }
 */
export function Printer_generateName(receiver, name) {
 ...
 * }
 */
export function Printer_isFileLevelUniqueNameInCurrentFile(receiver, name, _arg) {
 ...
 * }
 */
export function Printer_enterNode(receiver, node) {
    const state = {};
 ...
 * }
 */
export function Printer_exitNode(receiver, node, previousState) {
 ...
 * }
 */
export function Printer_enterTokenNode(receiver, node, flags) {
    const state = {};
 ...
 * }
 */
export function Printer_exitTokenNode(receiver, node, previousState) {
    Printer_emitSourceMapsAfterNode(receiver, node, previousState.sourceMapState);
    Printer_emitCommentsAfterNode(receiver, node, previousState.commentState);
 ...
 * }
 */
export function Printer_enterToken(receiver, token, pos, contextNode, flags) {
    const state = {};
    let newPos = pos;
 ...
 * }
 */
export function Printer_exitToken(receiver, token, pos, contextNode, previousState) {
