 ...
 * )
 */
export declare const WriteKindNone: WriteKind;
export declare const WriteKindKeyword: WriteKind;
export declare const WriteKindOperator: WriteKind;
export declare const WriteKindPunctuation: WriteKind;
export declare const WriteKindStringLiteral: WriteKind;
export declare const WriteKindParameter: WriteKind;
export declare const WriteKindProperty: WriteKind;
export declare const WriteKindComment: WriteKind;
export declare const WriteKindLiteral: WriteKind;
/**
 ...
 * )
 */
export declare const commentSeparatorNone: commentSeparator;
export declare const commentSeparatorBefore: commentSeparator;
export declare const commentSeparatorAfter: commentSeparator;
/**
 ...
 * )
 */
export declare const tefNoComments: tokenEmitFlags;
export declare const tefIndentLeadingComments: tokenEmitFlags;
export declare const tefNoSourceMaps: tokenEmitFlags;
export declare const tefNone: tokenEmitFlags;
/**
 ...
 * )
 */
export declare const LFNone: ListFormat;
export declare const LFSingleLine: ListFormat;
export declare const LFMultiLine: ListFormat;
export declare const LFPreserveLines: ListFormat;
export declare const LFLinesMask: ListFormat;
export declare const LFNotDelimited: ListFormat;
export declare const LFBarDelimited: ListFormat;
export declare const LFAmpersandDelimited: ListFormat;
export declare const LFCommaDelimited: ListFormat;
export declare const LFAsteriskDelimited: ListFormat;
export declare const LFDelimitersMask: ListFormat;
export declare const LFAllowTrailingComma: ListFormat;
export declare const LFIndented: ListFormat;
export declare const LFSpaceBetweenBraces: ListFormat;
export declare const LFSpaceBetweenSiblings: ListFormat;
export declare const LFBraces: ListFormat;
export declare const LFParenthesis: ListFormat;
export declare const LFAngleBrackets: ListFormat;
export declare const LFSquareBrackets: ListFormat;
export declare const LFBracketsMask: ListFormat;
export declare const LFOptionalIfNil: ListFormat;
export declare const LFOptionalIfEmpty: ListFormat;
export declare const LFOptional: ListFormat;
export declare const LFPreferNewLine: ListFormat;
export declare const LFNoTrailingNewLine: ListFormat;
export declare const LFNoInterveningComments: ListFormat;
export declare const LFNoSpaceIfEmpty: ListFormat;
export declare const LFSingleElement: ListFormat;
export declare const LFSpaceAfterList: ListFormat;
export declare const LFModifiers: ListFormat;
export declare const LFHeritageClauses: ListFormat;
export declare const LFSingleLineTypeLiteralMembers: ListFormat;
export declare const LFMultiLineTypeLiteralMembers: ListFormat;
export declare const LFSingleLineTupleTypeElements: ListFormat;
export declare const LFMultiLineTupleTypeElements: ListFormat;
export declare const LFUnionTypeConstituents: ListFormat;
export declare const LFIntersectionTypeConstituents: ListFormat;
export declare const LFObjectBindingPatternElements: ListFormat;
export declare const LFArrayBindingPatternElements: ListFormat;
export declare const LFObjectLiteralExpressionProperties: ListFormat;
export declare const LFImportAttributes: ListFormat;
export declare const LFArrayLiteralExpressionElements: ListFormat;
export declare const LFCommaListElements: ListFormat;
export declare const LFCallExpressionArguments: ListFormat;
export declare const LFNewExpressionArguments: ListFormat;
export declare const LFTemplateExpressionSpans: ListFormat;
export declare const LFSingleLineBlockStatements: ListFormat;
export declare const LFMultiLineBlockStatements: ListFormat;
export declare const LFVariableDeclarationList: ListFormat;
export declare const LFSingleLineFunctionBodyStatements: ListFormat;
export declare const LFMultiLineFunctionBodyStatements: ListFormat;
export declare const LFClassHeritageClauses: ListFormat;
export declare const LFClassMembers: ListFormat;
export declare const LFInterfaceMembers: ListFormat;
export declare const LFEnumMembers: ListFormat;
export declare const LFCaseBlockClauses: ListFormat;
export declare const LFNamedImportsOrExportsElements: ListFormat;
export declare const LFJsxElementOrFragmentChildren: ListFormat;
export declare const LFJsxElementAttributes: ListFormat;
export declare const LFCaseOrDefaultClauseStatements: ListFormat;
export declare const LFHeritageClauseTypes: ListFormat;
export declare const LFSourceFileStatements: ListFormat;
export declare const LFDecorators: ListFormat;
export declare const LFTypeArguments: ListFormat;
export declare const LFTypeParameters: ListFormat;
export declare const LFParameters: ListFormat;
export declare const LFSingleArrowParameter: ListFormat;
export declare const LFIndexSignatureParameters: ListFormat;
export declare const LFJSDocComment: ListFormat;
export declare const LFImportClauseEntries: ListFormat;
