 ...
 * }
 */
export function Printer_emitTypeParameter(receiver, node) {
 ...
 * }
 */
export function Printer_emitTypeParameterDeclarationNode(receiver, node) {
    // NOTE: QuickInfo uses TypeFormatFlagsWriteTypeArgumentsOfSignature to instruct the NodeBuilder to store type arguments
    // (i.e. type nodes) instead of type parameter declarations in the type parameter list.
 ...
 * }
 */
export function Printer_emitTypeParameters(receiver, parentNode, nodes) {
    if (nodes === undefined) {
        return;
    }
 ...
 * }
 */
export function Printer_emitTypeAnnotation(receiver, node) {
    if (node === undefined) {
        return;
    }
 ...
 * }
 */
export function Printer_emitTypeElement(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitKeywordTypeNode(receiver, node) {
 ...
 * }
 */
export function Printer_emitTypePredicateParameterName(receiver, node) {
    switch (node.Kind) {
        case KindIdentifier:
 ...
 * }
 */
export function Printer_emitTypePredicate(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitTypeArgument(receiver, node) {
    Printer_emitTypeNodeOutsideExtends(receiver, node);
}
/**
 ...
 * }
 */
export function Printer_emitTypeArguments(receiver, parentNode, nodes) {
    if (nodes === undefined) {
        return;
    }
 ...
 * }
 */
export function Printer_emitTypeReference(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitReturnType(receiver, node) {
    if (node === undefined) {
        return;
    }
    Printer_writePunctuation(receiver, "=>");
    Printer_writeSpace(receiver);
    if (receiver.inExtends && node.Kind === KindInferType && AsTypeParameterDeclaration(AsInferTypeNode(node).TypeParameter).Constraint !== undefined) {
        // if the parent FunctionTypeNode or ConstructorTypeNode is in the `extends` clause of a ConditionalTypeNode,
        // we must parenthesize `infer ... extends ...` so as not to result in an ambiguous parse.
        //
        // `T extends () => infer U extends V ? W : X` would parse the `? W : X` as part of a ConditionalTypeNode in the
 ...
 * }
 */
export function Printer_emitFunctionType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitConstructorType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitModifierList(receiver, NodeDefault_AsNode(node), Node_Modifiers(NodeDefault_AsNode(node)), false);
 ...
 * }
 */
export function Printer_emitTypeQuery(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitTypeLiteral(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_pushNameGenerationScope(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitArrayType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitPostfixTypeOperand(receiver, operand, parent) {
 ...
 * }
 */
export function Printer_emitTupleElementType(receiver, node) {
    Printer_emitTypeNodeOutsideExtends(receiver, node);
}
/**
 ...
 * }
 */
export function Printer_emitTupleType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitRestType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "...");
    Printer_emitTypeNodeOutsideExtends(receiver, node.Type);
    Printer_exitNode(receiver, NodeDefault_AsNode(node), state);
 ...
 * }
 */
export function Printer_emitOptionalType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    // !!! May need extra parenthesization if we also have JSDocNullableType
 ...
 * }
 */
export function Printer_emitNamedTupleMember(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    ...
    Printer_emitToken(receiver, KindColonToken, greatestEnd(Node_End(Node_Name(NodeDefault_AsNode(node))), node.QuestionToken), WriteKindPunctuation, NodeDefault_AsNode(node));
    Printer_writeSpace(receiver);
    Printer_emitTypeNodeOutsideExtends(receiver, node.Type);
    Printer_exitNode(receiver, NodeDefault_AsNode(node), state);
}
 ...
 * }
 */
export function Printer_emitUnionTypeConstituent(receiver, node) {
 ...
 * }
 */
export function Printer_emitUnionType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitIntersectionTypeConstituent(receiver, node) {
    Printer_emitTypeNode(receiver, node, TypePrecedenceTypeOperator);
}
/**
 ...
 * }
 */
export function Printer_emitIntersectionType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitConditionalType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitInferTypeParameter(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitBindingIdentifier(receiver, AsIdentifier(Node_Name(NodeDefault_AsNode(node))));
    if (node.Constraint !== undefined) {
        Printer_writeSpace(receiver);
 ...
 * }
 */
export function Printer_emitInferType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitParenthesizedType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "(");
    Printer_emitTypeNodeOutsideExtends(receiver, node.Type);
    Printer_writePunctuation(receiver, ")");
 ...
 * }
 */
export function Printer_emitThisType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitTypeOperator(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitIndexedAccessType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitMappedTypeParameter(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitBindingIdentifier(receiver, AsIdentifier(Node_Name(NodeDefault_AsNode(node))));
    Printer_writeSpace(receiver);
 ...
 * }
 */
export function Printer_emitMappedType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitLiteralType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitTemplateType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitImportTypeNodeAttributes(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "{");
    Printer_writeSpace(receiver);
 ...
 * }
 */
export function Printer_emitImportTypeNode(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    if (node.IsTypeOf) {
        Printer_writeKeyword(receiver, "typeof");
        Printer_writeSpace(receiver);
 ...
 * }
 */
export function Printer_emitTypeNodeInExtends(receiver, node) {
    const savedInExtends = receiver.inExtends;
    receiver.inExtends = true;
    Printer_emitTypeNodePreservingExtends(receiver, node, TypePrecedenceLowest);
 ...
 * }
 */
export function Printer_emitTypeNodeOutsideExtends(receiver, node) {
    const savedInExtends = receiver.inExtends;
    receiver.inExtends = false;
    Printer_emitTypeNodePreservingExtends(receiver, node, TypePrecedenceLowest);
    receiver.inExtends = savedInExtends;
}
/**
 ...
 * }
 */
export function Printer_emitTypeNodePreservingExtends(receiver, node, precedence) {
 ...
 * }
 */
export function Printer_emitTypeNode(receiver, node, precedence) {
    ...
    switch (node.Kind) {
        ...
        case KindIntrinsicKeyword:
            Printer_emitKeywordTypeNode(receiver, AsKeywordTypeNode(node));
            break;
        // Types
        case KindTypePredicate:
            Printer_emitTypePredicate(receiver, AsTypePredicateNode(node));
            break;
        case KindTypeReference:
            Printer_emitTypeReference(receiver, AsTypeReferenceNode(node));
            break;
        case KindFunctionType:
            Printer_emitFunctionType(receiver, AsFunctionTypeNode(node));
            break;
        case KindConstructorType:
            Printer_emitConstructorType(receiver, AsConstructorTypeNode(node));
            break;
        case KindTypeQuery:
            Printer_emitTypeQuery(receiver, AsTypeQueryNode(node));
            break;
        case KindTypeLiteral:
            Printer_emitTypeLiteral(receiver, AsTypeLiteralNode(node));
            break;
        case KindArrayType:
            Printer_emitArrayType(receiver, AsArrayTypeNode(node));
            break;
        case KindTupleType:
            Printer_emitTupleType(receiver, AsTupleTypeNode(node));
            break;
        case KindOptionalType:
            Printer_emitOptionalType(receiver, AsOptionalTypeNode(node));
            break;
        case KindRestType:
            Printer_emitRestType(receiver, AsRestTypeNode(node));
            break;
        case KindUnionType:
            Printer_emitUnionType(receiver, AsUnionTypeNode(node));
            break;
        case KindIntersectionType:
            Printer_emitIntersectionType(receiver, AsIntersectionTypeNode(node));
            break;
        case KindConditionalType:
            Printer_emitConditionalType(receiver, AsConditionalTypeNode(node));
            break;
        case KindInferType:
            Printer_emitInferType(receiver, AsInferTypeNode(node));
            break;
        case KindParenthesizedType:
            Printer_emitParenthesizedType(receiver, AsParenthesizedTypeNode(node));
            break;
        case KindThisType:
            Printer_emitThisType(receiver, AsThisTypeNode(node));
            break;
        case KindTypeOperator:
            Printer_emitTypeOperator(receiver, AsTypeOperatorNode(node));
            break;
        case KindIndexedAccessType:
            Printer_emitIndexedAccessType(receiver, AsIndexedAccessTypeNode(node));
            break;
        case KindMappedType:
            Printer_emitMappedType(receiver, AsMappedTypeNode(node));
            break;
        case KindLiteralType:
            Printer_emitLiteralType(receiver, AsLiteralTypeNode(node));
            break;
        case KindNamedTupleMember:
            Printer_emitNamedTupleMember(receiver, AsNamedTupleMember(node));
            break;
        case KindTemplateLiteralType:
            Printer_emitTemplateType(receiver, AsTemplateLiteralTypeNode(node));
            break;
        case KindTemplateLiteralTypeSpan:
            Printer_emitTemplateTypeSpan(receiver, AsTemplateLiteralTypeSpan(node));
            break;
        case KindImportType:
            Printer_emitImportTypeNode(receiver, AsImportTypeNode(node));
            break;
        ...
        case KindJSDocAllType:
            Printer_emitJSDocAllType(receiver, node);
            break;
        case KindJSDocNonNullableType:
            Printer_emitJSDocNonNullableType(receiver, AsJSDocNonNullableType(node));
            break;
        case KindJSDocNullableType:
            Printer_emitJSDocNullableType(receiver, AsJSDocNullableType(node));
            break;
        case KindJSDocOptionalType:
            Printer_emitJSDocOptionalType(receiver, AsJSDocOptionalType(node));
            break;
        case KindJSDocVariadicType:
            Printer_emitJSDocVariadicType(receiver, AsJSDocVariadicType(node));
            break;
        default:
 ...
 * }
 */
export function Printer_emitJSDocAllType(receiver, node) {
 ...
 * }
 */
export function Printer_emitJSDocNonNullableType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "!");
 ...
 * }
 */
export function Printer_emitJSDocNullableType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "?");
    Printer_emitTypeNode(receiver, node.Type, TypePrecedenceNonArray);
    Printer_exitNode(receiver, NodeDefault_AsNode(node), state);
 ...
 * }
 */
export function Printer_emitJSDocOptionalType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitJSDocVariadicType(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "...");
    Printer_emitTypeNode(receiver, node.Type, TypePrecedenceJSDoc);
    Printer_exitNode(receiver, NodeDefault_AsNode(node), state);
 ...
 * }
 */
export function Printer_emitTypeAssertionExpression(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writePunctuation(receiver, "<");
    Printer_emitTypeNodeOutsideExtends(receiver, node.Type);
    Printer_writePunctuation(receiver, ">");
 ...
 * }
 */
export function Printer_emitTypeOfExpression(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitExpressionWithTypeArguments(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitExpressionWithTypeArgumentsNode(receiver, node) {
    Printer_emitExpressionWithTypeArguments(receiver, AsExpressionWithTypeArguments(node));
}
/**
 ...
 * }
 */
export function Printer_emitNotEmittedTypeElement(receiver, node) {
 ...
 * }
 */
export function Printer_emitTypeAliasDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_emitModifierList(receiver, NodeDefault_AsNode(node), Node_Modifiers(NodeDefault_AsNode(node)), false);
 ...
 * }
 */
export function Printer_emitHeritageClause(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
    Printer_writeSpace(receiver);
 ...
 * }
 */
export function Printer_emitHeritageClauseNode(receiver, node) {
