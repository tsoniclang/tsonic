...
import { KindClassKeyword, KindGetAccessor, KindIdentifier, KindMethodDeclaration, KindNoSubstitutionTemplateLiteral, KindPrivateIdentifier, KindPropertyAssignment, KindPropertyDeclaration, KindPropertySignature, KindMethodSignature, KindSetAccessor, KindShorthandPropertyAssignment, KindSpreadAssignment, KindTemplateExpression, KindTemplateMiddle, KindTemplateTail, } from "../../ast/generated/kinds.js";
...
import { Printer_decreaseIndentIf, Printer_generateNameIfNeeded, Printer_increaseIndentIf, Printer_emitStatement, } from "./statements-declarations.js";
import { Printer_emitArgument, Printer_emitBindingElementNode, Printer_emitConciseBody, Printer_emitGetAccessorDeclaration, Printer_emitIdentifierName, Printer_emitIdentifierNameNode, Printer_emitInitializer, Printer_emitKeywordNode, Printer_emitList, Printer_emitMethodDeclaration, Printer_emitModifierList, Printer_emitParameterDeclarationNode, Printer_emitParameters, Printer_emitPrivateIdentifier, Printer_emitPropertyAssignment, Printer_emitPropertyName, Printer_emitSetAccessorDeclaration, Printer_emitShorthandPropertyAssignment, Printer_emitSignature, Printer_emitToken, Printer_emitTokenNode, Printer_emitTokenNodeEx, Printer_emitPunctuationNode, Printer_enterNode, Printer_exitNode, Printer_generateAllNames, Printer_popNameGenerationScope, Printer_pushNameGenerationScope, Printer_shouldAllowTrailingComma, Printer_shouldEmitIndented, Printer_writeKeyword, Printer_writePunctuation, Printer_writeSpace, Printer_writeTrailingSemicolon, Printer_writeOperator, Printer_emitIdentifierReference, Printer_getTextOfNode, Printer_emitMetaProperty, Printer_emitJsxElement, Printer_emitJsxSelfClosingElement, Printer_emitJsxFragment, Printer_isFileLevelUniqueNameInCurrentFile, } from "./emit-core.js";
import { Printer_emitHeritageClauseNode, Printer_emitTypeAnnotation, Printer_emitTypeArguments, Printer_emitTypeParameters, Printer_emitTypeNodeOutsideExtends, Printer_emitTypeAssertionExpression, Printer_emitTypeOfExpression, Printer_emitExpressionWithTypeArguments, } from "./types.js";
import { Printer_emitClassElement, Printer_emitFunctionBodyNode, } from "./statements-declarations.js";
...
import { getLiteralTextFlagsNeverAsciiEscape, getLiteralTextFlagsNone, getLiteralTextFlagsTerminateUnterminatedLiterals, getLiteralTextFlagsAllowNumericSeparator, getLiteralTextFlagsJsxAttributeEscape, getLiteralText, EscapeString, escapeNonAsciiString, escapeJsxAttributeString, QuoteCharDoubleQuote, isNewExpressionWithoutArguments, isBinaryOperation, mixingBinaryOperatorsRequiresParentheses, isImmediatelyInvokedFunctionExpressionOrArrowFunction, GetLinesBetweenPositions, greatestEnd, } from "../utilities.js";
import { LFAllowTrailingComma, LFArrayBindingPatternElements, LFArrayLiteralExpressionElements, LFCallExpressionArguments, LFNewExpressionArguments, LFClassHeritageClauses, LFClassMembers, LFNone, LFObjectBindingPatternElements, LFObjectLiteralExpressionProperties, LFPreferNewLine, LFSingleArrowParameter, LFTemplateExpressionSpans, WriteKindKeyword, WriteKindOperator, WriteKindPunctuation, tefNoSourceMaps, } from "./state.js";
/**
 ...
 * }
 */
export function NewPrinter(options, handlers, emitContext) {
    const printer = {
    ...
    printer.nameGenerator.Context = printer.emitContext;
    printer.nameGenerator.GetTextOfNode = (node) => Printer_getTextOfNode(printer, node, false);
    printer.nameGenerator.IsFileLevelUniqueNameInCurrentFile = (name, arg) => Printer_isFileLevelUniqueNameInCurrentFile(printer, name, arg);
    printer.makeFileLevelOptimisticUniqueName = (name) => NameGenerator_MakeFileLevelOptimisticUniqueName(printer.nameGenerator, name);
    return printer;
}
/**
 ...
 * }
 */
export function Printer_getLiteralTextOfNode(receiver, node, sourceFile, flags) {
        ...
        if (textSourceNode !== undefined) {
            ...
            switch (textSourceNode.Kind) {
                ...
                case KindJsxNamespacedName:
                    text = Printer_getTextOfNode(receiver, textSourceNode, false);
                    break;
                default:
    ...
    const flags2 = (receiver.Options.Target ?? 0) >= ScriptTargetES2021
        ? (flags1 | getLiteralTextFlagsAllowNumericSeparator)
        : flags1;
    return getLiteralText(node, Coalesce(sourceFile, receiver.currentSourceFile), flags2);
}
/**
 ...
 * }
 */
export function Printer_writeLiteral(receiver, text) {
 ...
 * }
 */
export function Printer_shouldEmitIndirectCall(receiver, node) {
 ...
 * }
 */
export function Printer_emitLiteral(receiver, node, flags) {
    // Add NeverAsciiEscape flag if the printer option is set
    const flags1 = receiver.Options.NeverAsciiEscape ? (flags | getLiteralTextFlagsNeverAsciiEscape) : flags;
    const flags2 = receiver.Options.TerminateUnterminatedLiterals ? (flags1 | getLiteralTextFlagsTerminateUnterminatedLiterals) : flags1;
 ...
 * }
 */
export function Printer_emitNumericLiteral(receiver, node) {
 ...
 * }
 */
export function Printer_emitBigIntLiteral(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitStringLiteral(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_emitLiteral(receiver, node, getLiteralTextFlagsNone);
    Printer_exitNode(receiver, node, state);
}
 ...
 * }
 */
export function Printer_emitNoSubstitutionTemplateLiteral(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_emitLiteral(receiver, node, getLiteralTextFlagsNone);
    Printer_exitNode(receiver, node, state);
}
 ...
 * }
 */
export function Printer_emitRegularExpressionLiteral(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_emitLiteral(receiver, node, getLiteralTextFlagsNone);
    Printer_exitNode(receiver, node, state);
}
 ...
 * }
 */
export function Printer_emitTemplateHead(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_emitLiteral(receiver, node, getLiteralTextFlagsNone);
    Printer_exitNode(receiver, node, state);
}
 ...
 * }
 */
export function Printer_emitTemplateMiddle(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_emitLiteral(receiver, node, getLiteralTextFlagsNone);
    Printer_exitNode(receiver, node, state);
}
 ...
 * }
 */
export function Printer_emitTemplateTail(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_emitLiteral(receiver, node, getLiteralTextFlagsNone);
    Printer_exitNode(receiver, node, state);
}
 ...
 * }
 */
export function Printer_emitTemplateMiddleTail(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitMemberName(receiver, node) {
    if (node === undefined) {
        return;
    }
    switch (node.Kind) {
 ...
 * }
 */
export function canEmitSimpleArrowHead(parentNode, parameters) {
    // only arrow functions with a single parameter may have simple arrow head
 ...
 * }
 */
export function Printer_emitParametersForArrow(receiver, parentNode, parameters) {
    if (canEmitSimpleArrowHead(parentNode, parameters)) {
 ...
 * }
 */
export function Printer_emitCallSignature(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitObjectLiteralElement(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitObjectBindingPattern(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitArrayBindingPattern(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_writePunctuation(receiver, "[");
 ...
 * }
 */
export function Printer_emitKeywordExpression(receiver, node) {
 ...
 * }
 */
export function Printer_emitArrayLiteralExpressionElement(receiver, node) {
 ...
 * }
 */
export function Printer_emitArrayLiteralExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_emitList(receiver, Printer_emitArrayLiteralExpressionElement, node, node.Elements, (LFArrayLiteralExpressionElements | IfElse(node.MultiLine, LFPreferNewLine, LFNone)));
    Printer_exitNode(receiver, node, state);
}
/**
 ...
 * }
 */
export function Printer_emitObjectLiteralExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    const indented = Printer_shouldEmitIndented(receiver, node);
    Printer_increaseIndentIf(receiver, indented);
    Printer_pushNameGenerationScope(receiver, node);
    ...
    Printer_emitList(receiver, Printer_emitObjectLiteralElement, node, node.Properties, (LFObjectLiteralExpressionProperties |
        ...
        IfElse(Printer_shouldAllowTrailingComma(receiver, node, node.Properties), LFAllowTrailingComma, LFNone)));
    Printer_popNameGenerationScope(receiver, node);
    Printer_decreaseIndentIf(receiver, indented);
    Printer_exitNode(receiver, node, state);
}
 ...
 * }
 */
export function Printer_mayNeedDotDotForPropertyAccess(receiver, expression) {
    ...
    if (IsNumericLiteral(expr)) {
        ...
        // If the number will be printed verbatim and it doesn't already contain a dot or an exponent indicator, add one
        // if the expression doesn't have any comments that will be emitted.
        return ((AsNumericLiteral(expr).TokenFlags & TokenFlagsWithSpecifier) === 0 &&
 ...
 * }
 */
export function Printer_emitPropertyAccessExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    ...
    Printer_increaseIndentIf(receiver, (linesBeforeDot > 0));
    const shouldEmitDotDot = token.Kind !== KindQuestionDotToken &&
    ...
    Printer_increaseIndentIf(receiver, (linesAfterDot > 0));
    Printer_emitMemberName(receiver, node.name);
    Printer_decreaseIndentIf(receiver, (linesAfterDot > 0));
    Printer_decreaseIndentIf(receiver, (linesBeforeDot > 0));
    Printer_exitNode(receiver, node, state);
}
/**
 ...
 * }
 */
export function Printer_emitElementAccessExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_emitExpression(receiver, node.Expression, IfElse(IsOptionalChain(node), OperatorPrecedenceOptionalChain, OperatorPrecedenceMember));
    Printer_emitTokenNode(receiver, node.QuestionDotToken);
    Printer_emitToken(receiver, KindOpenBracketToken, greatestEnd(-1, node.Expression, node.QuestionDotToken), WriteKindPunctuation, node);
 ...
 * }
 */
export function Printer_emitCallee(receiver, callee, parentNode) {
 ...
 * }
 */
export function Printer_emitCallExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitNewExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitTemplateLiteral(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitTaggedTemplateExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitParenthesizedExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitFunctionExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitArrowFunction(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_emitModifierList(receiver, node, Node_Modifiers(node), false /*allowDecorators*/);
    const indented = Printer_shouldEmitIndented(receiver, node);
    Printer_increaseIndentIf(receiver, indented);
 ...
 * }
 */
export function Printer_emitDeleteExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitVoidExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitAwaitExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitPrefixUnaryExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    ...
    if (operand.Kind === KindPrefixUnaryExpression) {
        ...
        if ((operator === KindPlusToken && (inner === KindPlusToken || inner === KindPlusPlusToken)) ||
 ...
 * }
 */
export function Printer_emitPostfixUnaryExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_getLiteralKindOfBinaryPlusOperand(receiver, node) {
 ...
 * }
 */
export function Printer_getBinaryExpressionPrecedence(receiver, node) {
 ...
 * }
 */
export function Printer_emitBinaryExpression(receiver, node) {
    const pending = [];
    let current = node;
    for (;;) {
...
function Printer_emitBinaryExpressionAfterLeft(receiver, node, rightPrec, state) {
    ...
    Printer_writeLinesAndIndent(receiver, linesBeforeOperator, (node.OperatorToken.Kind !== KindCommaToken) /*writeSpaceIfNotIndenting*/);
    Printer_emitTokenNodeEx(receiver, node.OperatorToken, tefNoSourceMaps);
    Printer_writeLinesAndIndent(receiver, linesAfterOperator, true /*writeSpaceIfNotIndenting*/); // Binary operators should have a space before the comment starts
    Printer_emitExpression(receiver, node.Right, rightPrec);
    Printer_decreaseIndentIf(receiver, (linesAfterOperator > 0));
    Printer_decreaseIndentIf(receiver, (linesBeforeOperator > 0));
    Printer_exitNode(receiver, node, state);
}
/**
 ...
 * }
 */
export function Printer_emitShortCircuitExpression(receiver, node) {
 ...
 * }
 */
export function Printer_emitConditionalExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    ...
    Printer_writeLinesAndIndent(receiver, linesBeforeQuestion, true /*writeSpaceIfNotIndenting*/);
    Printer_emitPunctuationNode(receiver, node.QuestionToken);
    Printer_writeLinesAndIndent(receiver, linesAfterQuestion, true /*writeSpaceIfNotIndenting*/);
    Printer_emitExpression(receiver, node.WhenTrue, OperatorPrecedenceYield);
    Printer_decreaseIndentIf(receiver, (linesAfterQuestion > 0));
    Printer_decreaseIndentIf(receiver, (linesBeforeQuestion > 0));
    Printer_writeLinesAndIndent(receiver, linesBeforeColon, true /*writeSpaceIfNotIndenting*/);
    Printer_emitPunctuationNode(receiver, node.ColonToken);
    Printer_writeLinesAndIndent(receiver, linesAfterColon, true /*writeSpaceIfNotIndenting*/);
    Printer_emitExpression(receiver, node.WhenFalse, OperatorPrecedenceYield);
    Printer_decreaseIndentIf(receiver, (linesAfterColon > 0));
    Printer_decreaseIndentIf(receiver, (linesBeforeColon > 0));
    Printer_exitNode(receiver, node, state);
}
/**
 ...
 * }
 */
export function Printer_emitTemplateExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitYieldExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitSpreadElement(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitClassExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_generateNameIfNeeded(receiver, Node_Name(node));
 ...
 * }
 */
export function Printer_emitOmittedExpression(receiver, node) {
 ...
 * }
 */
export function Printer_emitAsExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitSatisfiesExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_emitExpression(receiver, node.Expression, OperatorPrecedenceRelational);
    Printer_writeSpace(receiver);
 ...
 * }
 */
export function Printer_emitNonNullExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_emitExpression(receiver, node.Expression, OperatorPrecedenceMember);
 ...
 * }
 */
export function Printer_emitPartiallyEmittedExpression(receiver, node) {
    const stack = [];
    let current = node;
    for (;;) {
        const state = Printer_enterNode(receiver, current);
        ...
        if ((emitFlags & EFNoLeadingComments) === 0 && Node_Pos(current) !== Node_Pos(current.Expression)) {
            Printer_emitTrailingCommentsOfPosition(receiver, Node_Pos(current.Expression), false /*prefixSpace*/, false /*forceNoNewline*/);
        }
 ...
 * }
 */
export function Printer_parenthesizeExpressionForNoAsi(receiver, node) {
        ...
        switch (node.Kind) {
            case KindPartiallyEmittedExpression: {
                if (Printer_willEmitLeadingNewLine(receiver, node)) {
                    const pee = AsPartiallyEmittedExpression(node);
                    const parseNode = EmitContext_ParseNode(receiver.emitContext, node);
                    if (parseNode !== undefined && IsParenthesizedExpression(parseNode)) {
                        // If the original node was a parenthesized expression, restore it to preserve comment and source map emit
                        const parens = NodeFactory_NewParenthesizedExpression(f, pee.Expression);
                        EmitContext_SetOriginal(receiver.emitContext, parens, node);
                        parens.Loc = parseNode.Loc;
                        return parens;
                    }
                    return NodeFactory_NewParenthesizedExpression(f, node);
                }
                const pee2 = AsPartiallyEmittedExpression(node);
                return NodeFactory_UpdatePartiallyEmittedExpression(f, pee2, Printer_parenthesizeExpressionForNoAsi(receiver, pee2.Expression));
            }
            case KindPropertyAccessExpression: {
                const pae = AsPropertyAccessExpression(node);
                return NodeFactory_UpdatePropertyAccessExpression(f, pae, Printer_parenthesizeExpressionForNoAsi(receiver, pae.Expression), pae.QuestionDotToken, pae.name, pae.Flags);
            }
            case KindElementAccessExpression: {
                const eae = AsElementAccessExpression(node);
                return NodeFactory_UpdateElementAccessExpression(f, eae, Printer_parenthesizeExpressionForNoAsi(receiver, eae.Expression), eae.QuestionDotToken, eae.ArgumentExpression, eae.Flags);
            }
            case KindCallExpression: {
                const ce = AsCallExpression(node);
                return NodeFactory_UpdateCallExpression(f, ce, Printer_parenthesizeExpressionForNoAsi(receiver, ce.Expression), ce.QuestionDotToken, ce.TypeArguments, ce.Arguments, ce.Flags);
            }
            case KindTaggedTemplateExpression: {
                const tte = AsTaggedTemplateExpression(node);
                return NodeFactory_UpdateTaggedTemplateExpression(f, tte, Printer_parenthesizeExpressionForNoAsi(receiver, tte.Tag), tte.QuestionDotToken, tte.TypeArguments, tte.Template, tte.Flags);
            }
            case KindPostfixUnaryExpression: {
                const pue = AsPostfixUnaryExpression(node);
                return NodeFactory_UpdatePostfixUnaryExpression(f, pue, Printer_parenthesizeExpressionForNoAsi(receiver, pue.Operand), pue.Operator);
            }
            case KindBinaryExpression: {
                const be = AsBinaryExpression(node);
                return NodeFactory_UpdateBinaryExpression(f, be, be.modifiers, Printer_parenthesizeExpressionForNoAsi(receiver, be.Left), be.Type, be.OperatorToken, be.Right);
            }
            case KindConditionalExpression: {
                const ce2 = AsConditionalExpression(node);
                return NodeFactory_UpdateConditionalExpression(f, ce2, Printer_parenthesizeExpressionForNoAsi(receiver, ce2.Condition), ce2.QuestionToken, ce2.WhenTrue, ce2.ColonToken, ce2.WhenFalse);
            }
            case KindAsExpression: {
                const ae = AsAsExpression(node);
                return NodeFactory_UpdateAsExpression(f, ae, Printer_parenthesizeExpressionForNoAsi(receiver, ae.Expression), ae.Type);
            }
            case KindSatisfiesExpression: {
                const se = AsSatisfiesExpression(node);
                return NodeFactory_UpdateSatisfiesExpression(f, se, Printer_parenthesizeExpressionForNoAsi(receiver, se.Expression), se.Type);
            }
            case KindNonNullExpression: {
                const nne = AsNonNullExpression(node);
                return NodeFactory_UpdateNonNullExpression(f, nne, Printer_parenthesizeExpressionForNoAsi(receiver, nne.Expression), node.Flags);
            }
        }
    }
    return node;
 ...
 * }
 */
export function Printer_emitExpressionNoASI(receiver, node, precedence) {
 ...
 * }
 */
export function Printer_emitExpression(receiver, node, precedence) {
 ...
 * }
 */
export function Printer_emitExpressionStatement(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    if (receiver.currentSourceFile !== undefined && receiver.currentSourceFile.ScriptKind === ScriptKindJSON) {
        ...
        switch (GetLeftmostExpression(node.Expression, false).Kind) {
            case KindFunctionExpression:
            case KindObjectLiteralExpression:
                Printer_emitExpression(receiver, node.Expression, OperatorPrecedenceParentheses);
                break;
 ...
 * }
 */
export function Printer_emitIIFEWithParenthesizedCallee(receiver, node) {
    // Walk through PartiallyEmittedExpression wrappers to find the call
 ...
 * }
 */
export function Printer_emitJsxSpreadAttribute(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    Printer_writePunctuation(receiver, "{...");
 ...
 * }
 */
export function Printer_emitJsxExpression(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    if (node.Expression !== undefined || (!receiver.commentsDisabled && !NodeIsSynthesized(node) && Printer_hasCommentsAtPosition(receiver, Node_Pos(node)))) {
        ...
        const indented = (receiver.currentSourceFile !== undefined && !NodeIsSynthesized(node) && GetLinesBetweenPositions(receiver.currentSourceFile, Node_Pos(node), Node_End(node)) !== 0);
        Printer_increaseIndentIf(receiver, indented);
        ...
        Printer_emitToken(receiver, KindCloseBraceToken, greatestEnd(end, node.Expression, node.DotDotDotToken), WriteKindPunctuation, node);
        Printer_decreaseIndentIf(receiver, indented);
    }
    Printer_exitNode(receiver, node, state);
}
 ...
 * }
 */
export function Printer_emitSpreadAssignment(receiver, node) {
    const state = Printer_enterNode(receiver, node);
    if (node.Expression !== undefined) {
        Printer_emitToken(receiver, KindDotDotDotToken, Node_Pos(node), WriteKindPunctuation, node);
        Printer_emitExpression(receiver, node.Expression, OperatorPrecedenceDisallowComma);
 ...
 * }
 */
export function Printer_emitEnumMember(receiver, node) {
    const state = Printer_enterNode(receiver, node);
 ...
 * }
 */
export function Printer_emitEnumMemberNode(receiver, node) {
 ...
 * }
 */
export function Printer_generateAllMemberNames(receiver, nodes) {
    if (nodes === undefined) {
        return;
    }
 ...
 * }
 */
export function Printer_generateMemberNames(receiver, node) {
    if (node === undefined) {
        return;
    }
    switch (node.Kind) {
