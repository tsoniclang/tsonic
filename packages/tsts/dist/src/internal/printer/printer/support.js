import { LFBracketsMask, LFBraces, LFParenthesis, LFAngleBrackets, LFSquareBrackets, } from "./state.js";
/**
 ...
 * }
 */
export function getOpeningBracket(format) {
    switch (format & LFBracketsMask) {
        case LFBraces:
            return "{";
        case LFParenthesis:
 ...
 * }
 */
export function getClosingBracket(format) {
    switch (format & LFBracketsMask) {
        case LFBraces:
            return "}";
        case LFParenthesis:
