...
import { Printer_emitListItems, Printer_emitPos, Printer_Emit, Printer_enterNode, Printer_exitNode, Printer_hasTrailingComma, Printer_increaseIndent, Printer_pushNameGenerationScope, Printer_popNameGenerationScope, Printer_generateAllNames, Printer_shouldElideIndentation, Printer_emitHelpers, Printer_write, Printer_writePunctuation, Printer_writeSpace, } from "./emit-core.js";
...
import { commentSeparatorBefore, LFBracketsMask, LFMultiLine, LFNoSpaceIfEmpty, LFNone, LFOptionalIfEmpty, LFOptionalIfNil, LFPreferNewLine, LFPreserveLines, LFNoTrailingNewLine, LFSpaceBetweenBraces, tefNoSourceMaps, } from "./state.js";
 ...
 * }
 */
export function Printer_writeLine(receiver) {
 ...
 * }
 */
export function Printer_writeLines(receiver, text) {
 ...
 * }
 */
export function Printer_writeLineOrSpace(receiver, parentNode, prevChildNode, nextChildNode) {
 ...
 * }
 */
export function Printer_writeLinesAndIndent(receiver, lineCount, writeSpaceIfNotIndenting) {
    if (lineCount > 0) {
 ...
 * }
 */
export function Printer_writeLineSeparatorsAndIndentBefore(receiver, node, parent) {
    if (receiver.Options.PreserveSourceNewlines) {
        ...
        if (leadingNewlines > 0) {
            Printer_writeLinesAndIndent(receiver, leadingNewlines, false);
            return true;
        }
    }
    return false;
 ...
 * }
 */
export function Printer_writeLineSeparatorsAfter(receiver, node, parent) {
    if (receiver.Options.PreserveSourceNewlines) {
 ...
 * }
 */
export function Printer_getLinesBetweenNodes(receiver, parent, node1, node2) {
    ...
    if (receiver.currentSourceFile !== undefined && !NodeIsSynthesized(parentSkipped) && !NodeIsSynthesized(node1Skipped) && !NodeIsSynthesized(node2Skipped)) {
        if (receiver.Options.PreserveSourceNewlines) {
            return Printer_getEffectiveLines(receiver, (includeComments) => getLinesBetweenRangeEndAndRangeStart(node1Skipped.Loc, node2Skipped.Loc, receiver.currentSourceFile, includeComments));
        }
        return (rangeEndIsOnSameLineAsRangeStart(node1Skipped.Loc, node2Skipped.Loc, receiver.currentSourceFile) ? 0 : 1);
    }
    return 0;
}
/**
 ...
 * }
 */
export function Printer_getEffectiveLines(receiver, getLineDifference) {
    if (!receiver.Options.PreserveSourceNewlines) {
 ...
 * }
 */
export function Printer_getLeadingLineTerminatorCount(receiver, parentNode, firstChild, format) {
    if ((format & LFPreserveLines) !== 0 || receiver.Options.PreserveSourceNewlines) {
        if ((format & LFPreferNewLine) !== 0) {
            return 1;
        }
        if (firstChild === undefined) {
            return (parentNode === undefined || (receiver.currentSourceFile !== undefined && RangeIsOnSingleLine(parentNode.Loc, receiver.currentSourceFile)) ? 0 : 1);
        }
        ...
        if (receiver.currentSourceFile !== undefined && parentNode !== undefined &&
            ...
            if (receiver.Options.PreserveSourceNewlines) {
                return Printer_getEffectiveLines(receiver, (includeComments) => getLinesBetweenPositionAndPrecedingNonWhitespaceCharacter(Node_Pos(firstChild), Node_Pos(parentNode), receiver.currentSourceFile, includeComments));
            }
            return (RangeStartPositionsAreOnSameLine(parentNode.Loc, firstChild.Loc, receiver.currentSourceFile) ? 0 : 1);
        }
 ...
 * }
 */
export function Printer_getSeparatingLineTerminatorCount(receiver, previousNode, nextNode, format) {
    if ((format & LFPreserveLines) !== 0 || receiver.Options.PreserveSourceNewlines) {
        ...
        if (nextNode.Kind === KindJsxText) {
            ...
            if (receiver.Options.PreserveSourceNewlines && siblingNodePositionsAreComparable(receiver.emitContext, previousNode, nextNode)) {
                return Printer_getEffectiveLines(receiver, (includeComments) => getLinesBetweenRangeEndAndRangeStart(previousNode.Loc, nextNode.Loc, receiver.currentSourceFile, includeComments));
            }
            else if (!receiver.Options.PreserveSourceNewlines && originalNodesHaveSameParent(receiver.emitContext, previousNode, nextNode)) {
                return (rangeEndIsOnSameLineAsRangeStart(previousNode.Loc, nextNode.Loc, receiver.currentSourceFile) ? 0 : 1);
            }
            // If the two nodes are not comparable, add a line terminator based on the format that can indicate
            // whether new lines are preferred or not.
 ...
 * }
 */
export function Printer_getClosingLineTerminatorCount(receiver, parentNode, lastChild, format, childrenTextRange) {
    if ((format & LFPreserveLines) !== 0 || receiver.Options.PreserveSourceNewlines) {
        if ((format & LFPreferNewLine) !== 0) {
            return 1;
        }
        ...
        if (receiver.currentSourceFile !== undefined && parentNode !== undefined && !PositionIsSynthesized(Node_Pos(parentNode)) && !NodeIsSynthesized(lastChild) && (lastChild.Parent === undefined || lastChild.Parent === parentNode)) {
            if (receiver.Options.PreserveSourceNewlines) {
                ...
                const end = (lastChildEnd > childrenTextRangeEnd ? lastChildEnd : childrenTextRangeEnd);
                return Printer_getEffectiveLines(receiver, (includeComments) => getLinesBetweenPositionAndNextNonWhitespaceCharacter(end, Node_End(parentNode), receiver.currentSourceFile, includeComments));
            }
            return (rangeEndPositionsAreOnSameLine(parentNode.Loc, lastChild.Loc, receiver.currentSourceFile) ? 0 : 1);
        }
 ...
 * }
 */
export function Printer_shouldEmitOnSingleLine(receiver, node) {
    return ((EmitContext_EmitFlags(receiver.emitContext, node) & EFSingleLine) !== 0);
}
/**
 ...
 * }
 */
export function Printer_shouldEmitOnMultipleLines(receiver, node) {
    return ((EmitContext_EmitFlags(receiver.emitContext, node) & EFMultiLine) !== 0);
}
/**
 ...
 * }
 */
export function Printer_shouldEmitBlockFunctionBodyOnSingleLine(receiver, body) {
    ...
    if (Printer_getLeadingLineTerminatorCount(receiver, NodeDefault_AsNode(body), FirstOrNil(body.Statements.Nodes), LFPreserveLines) > 0 ||
        Printer_getClosingLineTerminatorCount(receiver, NodeDefault_AsNode(body), LastOrNil(body.Statements.Nodes), LFPreserveLines, body.Statements.Loc) > 0) {
        return false;
    }
    let previousStatement = undefined;
    for (const statement of body.Statements.Nodes) {
        if (Printer_getSeparatingLineTerminatorCount(receiver, previousStatement, statement, LFPreserveLines) > 0) {
            return false;
        }
        previousStatement = statement;
    }
 ...
 * }
 */
export function Printer_shouldEmitOnNewLine(receiver, node, format) {
 ...
 * }
 */
export function Printer_shouldEmitSourceMaps(receiver, node) {
 ...
 * }
 */
export function Printer_shouldEmitTokenSourceMaps(receiver, token, pos, contextNode, flags) {
    return (((flags & tefNoSourceMaps) === 0) &&
        Printer_shouldEmitSourceMaps(receiver, contextNode) &&
        !receiver.Options.OmitBraceSourceMapPositions && (token === KindOpenBraceToken || token === KindCloseBraceToken));
}
/**
 ...
 * }
 */
export function Printer_emitTemplateTypeSpan(receiver, node) {
 ...
 * }
 */
export function Printer_emitTemplateTypeSpanNode(receiver, node) {
 ...
 * }
 */
export function Printer_commentWillEmitNewLine(receiver, comment) {
    return (comment.Kind === KindSingleLineCommentTrivia || comment.HasTrailingNewLine);
}
/**
 ...
 * }
 */
export function Printer_willEmitLeadingNewLine(receiver, node) {
    if (receiver.currentSourceFile === undefined) {
        return false;
    }
    let hasLeadingCommentRanges = false;
    let hasNewLineComment = false;
    GetLeadingCommentRanges(NodeFactory_AsNodeFactory(receiver.emitContext.Factory.__tsgoEmbedded0), SourceFile_Text(receiver.currentSourceFile), Node_Pos(node))((comment) => {
        hasLeadingCommentRanges = true;
    ...
    if (ContainsFunc(EmitContext_GetSyntheticLeadingComments(receiver.emitContext, node), (comment) => Printer_syntheticCommentWillEmitNewLine(receiver, comment))) {
        return true;
    }
    if (IsPartiallyEmittedExpression(node)) {
        const pee = AsPartiallyEmittedExpression(node);
        if (Node_Pos(node) !== Node_Pos(pee.Expression)) {
            let foundNewLineComment = false;
            GetTrailingCommentRanges(NodeFactory_AsNodeFactory(receiver.emitContext.Factory.__tsgoEmbedded0), SourceFile_Text(receiver.currentSourceFile), Node_Pos(pee.Expression))((comment) => {
                if (Printer_commentWillEmitNewLine(receiver, comment)) {
                    foundNewLineComment = true;
                    return false; // stop iterating (like Go's return)
                }
 ...
 * }
 */
export function Printer_emitTemplateSpan(receiver, node) {
    const state = Printer_enterNode(receiver, NodeDefault_AsNode(node));
 ...
 * }
 */
export function Printer_emitTemplateSpanNode(receiver, node) {
 ...
 * }
 */
export function Printer_emitSourceFile(receiver, node) {
    ...
    // !!! Emit triple-slash directives
    Printer_emitListRange(receiver, Printer_emitStatement, NodeDefault_AsNode(node), node.Statements, LFMultiLine, index, -1);
 ...
 * }
 */
export function Printer_emitListRange(receiver, emit, parentNode, children, format, start, count) {
    ...
    if ((format & LFBracketsMask) !== 0) {
        if (isEmpty && !isNil) {
            Printer_emitLeadingComments(receiver, NodeList_End(children), false);
        }
 ...
 * }
 */
export function Printer_EmitSourceFile(receiver, sourceFile) {
 ...
 * }
 */
export function Printer_setSourceFile(receiver, sourceFile) {
 ...
 * }
 */
export function Printer_setSourceMapSource(receiver, source) {
    ...
    if (receiver.Options.InlineSources) {
        const err = Generator_SetSourceContent(receiver.sourceMapGenerator, receiver.sourceMapSourceIndex, source.Text());
        if (err !== undefined) {
            throw err;
        }
    }
 ...
 * }
 */
export function Printer_emitSourcePos(receiver, source, pos) {
 ...
 * }
 */
export function Printer_emitSourceMapsBeforeNode(receiver, node) {
    ...
    if ((emitFlags & EFNoNestedSourceMaps) !== 0) {
        receiver.sourceMapsDisabled = true;
    }
    const state = Arena_New(receiver.sourceMapStateArena);
    state.emitFlags = emitFlags;
    state.sourceMapRange = loc;
    state.hasTokenSourceMapRange = false;
    return state;
}
/**
 ...
 * }
 */
export function Printer_emitSourceMapsAfterNode(receiver, node, previousState) {
    ...
    if ((emitFlags & EFNoNestedSourceMaps) !== 0) {
        receiver.sourceMapsDisabled = false;
    }
    if (!IsNotEmittedStatement(node) &&
        (emitFlags & EFNoTrailingSourceMap) === 0 &&
 ...
 * }
 */
export function Printer_emitSourceMapsBeforeToken(receiver, token, pos, contextNode, flags) {
    ...
    state.emitFlags = emitFlags;
    state.sourceMapRange = loc;
    state.hasTokenSourceMapRange = hasLoc;
    return state;
}
/**
 ...
 * }
 */
export function Printer_emitSourceMapsAfterToken(receiver, token, pos, contextNode, previousState) {
    if (previousState === undefined) {
        return;
    }
    const emitFlags = previousState.emitFlags;
