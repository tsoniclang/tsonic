...
import { KindAsKeyword, KindAsteriskToken, KindBreakKeyword, KindClassKeyword, KindCatchKeyword, KindCloseBraceToken, KindCloseParenToken, KindColonToken, KindCommaToken, KindContinueKeyword, KindDebuggerKeyword, KindDoKeyword, KindElseKeyword, KindEqualsToken, KindFinallyKeyword, KindForKeyword, KindFromKeyword, KindGlobalKeyword, KindTryKeyword, KindIdentifier, KindIfKeyword, KindImportKeyword, KindInKeyword, KindMissingDeclaration, KindNamespaceKeyword, KindOfKeyword, KindOpenBraceToken, KindOpenParenToken, KindReturnKeyword, KindSemicolonToken, KindStringLiteral, KindTypeKeyword, KindUnknown, KindVariableDeclarationList, KindWhileKeyword, KindWithKeyword, KindBlock, KindEmptyStatement, KindVariableStatement, KindExpressionStatement, KindIfStatement, KindDoStatement, KindWhileStatement, KindForStatement, KindForInStatement, KindForOfStatement, KindContinueStatement, KindBreakStatement, KindReturnStatement, KindSwitchStatement, KindLabeledStatement, KindThrowStatement, KindTryStatement, KindDebuggerStatement, KindNotEmittedStatement, KindFunctionDeclaration, KindClassDeclaration, KindInterfaceDeclaration, KindTypeAliasDeclaration, KindJSTypeAliasDeclaration, KindEnumDeclaration, KindModuleDeclaration, KindNamespaceExportDeclaration, KindImportEqualsDeclaration, KindImportDeclaration, KindExportAssignment, KindExportDeclaration, KindPropertyDeclaration, KindMethodDeclaration, KindClassStaticBlockDeclaration, KindConstructor, KindGetAccessor, KindSetAccessor, KindIndexSignature, KindSemicolonClassElement, KindQualifiedName, KindExternalModuleReference, KindNamespaceImport, KindNamedImports, KindNamespaceExport, KindNamedExports, KindSwitchKeyword, KindThrowKeyword, KindExportKeyword, KindDefaultKeyword, KindWithStatement, } from "../../ast/generated/kinds.js";
import { AsBlock, AsBreakStatement, AsCaseBlock, AsCatchClause, AsClassDeclaration, AsClassStaticBlockDeclaration, AsConstructorDeclaration, AsContinueStatement, AsDebuggerStatement, AsDoStatement, AsEmptyStatement, AsEnumDeclaration, AsExportAssignment, AsExportDeclaration, AsExportSpecifier, AsExternalModuleReference, AsForInOrOfStatement, AsForStatement, AsFunctionDeclaration, AsGetAccessorDeclaration, AsIdentifier, AsIfStatement, AsImportAttribute, AsImportAttributes, AsImportClause, AsImportDeclaration, AsImportEqualsDeclaration, AsImportSpecifier, AsIndexSignatureDeclaration, AsInterfaceDeclaration, AsLabeledStatement, AsMethodDeclaration, AsModuleBlock, AsModuleDeclaration, AsNamedExports, AsNamedImports, AsNamespaceExport, AsNamespaceExportDeclaration, AsNamespaceImport, AsNotEmittedStatement, AsPropertyDeclaration, AsQualifiedName, AsReturnStatement, AsSemicolonClassElement, AsSetAccessorDeclaration, AsStringLiteral, AsSwitchStatement, AsThrowStatement, AsTryStatement, AsTypeAliasDeclaration, AsExpressionStatement, AsVariableDeclaration, AsVariableDeclarationList, AsVariableStatement, AsWhileStatement, AsWithStatement, } from "../../ast/generated/casts.js";
...
import { Printer_decreaseIndent, Printer_emitBindingIdentifier, Printer_emitBindingName, Printer_emitCaseOrDefaultClauseNode, Printer_emitConstructor, Printer_emitGetAccessorDeclaration, Printer_emitIdentifierName, Printer_emitIdentifierReference, Printer_emitIndexSignature, Printer_emitInitializer, Printer_emitKeywordNode, Printer_emitLabelIdentifier, Printer_emitList, Printer_emitMethodDeclaration, Printer_emitModifierList, Printer_emitParameterDeclarationNode, Printer_emitPropertyDeclaration, Printer_emitPunctuationNode, Printer_emitQualifiedName, Printer_emitSetAccessorDeclaration, Printer_emitSignature, Printer_emitToken, Printer_emitTokenEx, Printer_emitTokenNode, Printer_enterNode, Printer_exitNode, Printer_emitHelpers, Printer_generateAllNames, Printer_generateName, Printer_generateNames, Printer_increaseIndent, Printer_popNameGenerationScope, Printer_pushNameGenerationScope, Printer_shouldEmitIndented, Printer_writeKeyword, Printer_writePunctuation, Printer_writeSpace, Printer_writeTokenText, Printer_writeTrailingSemicolon, } from "./emit-core.js";
import { Printer_getLeadingLineTerminatorCount, Printer_shouldEmitBlockFunctionBodyOnSingleLine, Printer_shouldEmitOnSingleLine, Printer_writeLine, Printer_writeLineOrSpace, } from "./source-maps.js";
...
import { LFCaseBlockClauses, LFCaseOrDefaultClauseStatements, LFClassHeritageClauses, LFClassMembers, LFEnumMembers, LFHeritageClauses, LFImportAttributes, LFIndexSignatureParameters, LFIndented, LFInterfaceMembers, LFMultiLine, LFMultiLineBlockStatements, LFMultiLineFunctionBodyStatements, LFNamedImportsOrExportsElements, LFNone, LFSingleLineBlockStatements, LFSingleLineFunctionBodyStatements, LFVariableDeclarationList, WriteKindKeyword, WriteKindOperator, WriteKindPunctuation, commentSeparatorAfter, tefIndentLeadingComments, tefNoComments, tefNone, } from "./state.js";
/**
 ...
 * }
 */
export function Printer_increaseIndentIf(receiver, indentRequested) {
    if (indentRequested) {
 ...
 * }
 */
export function Printer_decreaseIndentIf(receiver, indentRequested) {
    if (indentRequested) {
 ...
 * }
 */
export function Printer_emitModuleName(receiver, node) {
    if (node === undefined) {
        return;
    }
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitModuleExportName(receiver, node) {
    if (node === undefined) {
        return;
    }
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitImportAttributeName(receiver, node) {
    switch (node.Kind) {
        case KindIdentifier:
            Printer_emitIdentifierName(receiver, AsIdentifier(node));
            break;
 ...
 * }
 */
export function Printer_emitNestedModuleName(receiver, node) {
    if (node === undefined) {
        return;
    }
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitParametersForIndexSignature(receiver, parentNode, parameters) {
 ...
 * }
 */
export function Printer_emitFunctionBody(receiver, body) {
 ...
 * }
 */
export function Printer_emitFunctionBodyNode(receiver, node) {
    if (node === undefined) {
 ...
 * }
 */
export function Printer_emitClassStaticBlockDeclaration(receiver, node) {
 ...
 * }
 */
export function Printer_emitClassElement(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitSemicolonClassElement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_writeTrailingSemicolon(receiver);
    Printer_exitNode(receiver, Node_AsNode(node), state);
}
 ...
 * }
 */
export function Printer_isEmptyBlock(receiver, block, statements) {
    return (statements.Nodes.length === 0 &&
        (receiver.currentSourceFile === undefined || rangeEndIsOnSameLineAsRangeStart(block.Loc, block.Loc, receiver.currentSourceFile)));
}
/**
 ...
 * }
 */
export function Printer_emitBlock(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    ...
    const format = IfElse(((!node.MultiLine && Printer_isEmptyBlock(receiver, Node_AsNode(node), node.Statements)) || Printer_shouldEmitOnSingleLine(receiver, Node_AsNode(node))), LFSingleLineBlockStatements, LFMultiLineBlockStatements);
    Printer_emitList(receiver, Printer_emitStatement, Node_AsNode(node), node.Statements, format);
    Printer_emitTokenEx(receiver, KindCloseBraceToken, NodeList_End(node.Statements), WriteKindPunctuation, Node_AsNode(node), IfElse(((format & LFMultiLine) !== 0), tefIndentLeadingComments, tefNone));
    Printer_exitNode(receiver, Node_AsNode(node), state);
}
/**
 ...
 * }
 */
export function Printer_emitVariableStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_emitModifierList(receiver, Node_AsNode(node), Node_Modifiers(node), false);
 ...
 * }
 */
export function Printer_emitEmptyStatement(receiver, node, isEmbeddedStatement) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    // While most trailing semicolons are possibly insignificant, an embedded "empty"
    // statement is significant and cannot be elided by a trailing-semicolon-omitting writer.
    if (isEmbeddedStatement) {
 ...
 * }
 */
export function Printer_emitIfStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitWhileClause(receiver, node, expression, startPos) {
 ...
 * }
 */
export function Printer_emitDoStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitWhileStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitForInitializer(receiver, node) {
 ...
 * }
 */
export function Printer_emitForStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitForInStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitForOfStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitContinueStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitBreakStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitReturnStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitWithStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitSwitchStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitLabeledStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_emitLabelIdentifier(receiver, AsIdentifier(node.Label));
 ...
 * }
 */
export function Printer_emitThrowStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitTryStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitDebuggerStatement(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitNotEmittedStatement(receiver, node) {
 ...
 * }
 */
export function Printer_emitVariableDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    ...
    Printer_emitInitializer(receiver, node.Initializer, greatestEnd(Node_End(Node_Name(node)), node.Type, EmitContext_GetTypeNode(receiver.emitContext, Node_Name(node))), Node_AsNode(node));
    Printer_exitNode(receiver, Node_AsNode(node), state);
}
/**
 ...
 * }
 */
export function Printer_emitVariableDeclarationNode(receiver, node) {
 ...
 * }
 */
export function Printer_emitVariableDeclarationList(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitFunctionDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitClassDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_generateNameIfNeeded(receiver, Node_Name(node));
    const pos = Printer_emitModifierList(receiver, Node_AsNode(node), Node_Modifiers(node), true);
 ...
 * }
 */
export function Printer_emitInterfaceDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_emitModifierList(receiver, Node_AsNode(node), Node_Modifiers(node), false);
 ...
 * }
 */
export function Printer_emitEnumDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_emitModifierList(receiver, Node_AsNode(node), Node_Modifiers(node), false);
 ...
 * }
 */
export function Printer_emitModuleDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_emitModifierList(receiver, Node_AsNode(node), Node_Modifiers(node), false);
    if (node.Keyword !== KindGlobalKeyword) {
        Printer_writeKeyword(receiver, IfElse((node.Keyword === KindNamespaceKeyword), "namespace", "module"));
        Printer_writeSpace(receiver);
    }
 ...
 * }
 */
export function Printer_emitModuleBlock(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_generateNames(receiver, Node_AsNode(node));
    Printer_emitToken(receiver, KindOpenBraceToken, Node_Pos(node), WriteKindPunctuation, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitCaseBlock(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_emitToken(receiver, KindOpenBraceToken, Node_Pos(node), WriteKindPunctuation, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitImportEqualsDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_emitModifierList(receiver, Node_AsNode(node), Node_Modifiers(node), false);
    let pos = Printer_emitToken(receiver, KindImportKeyword, greatestEnd(Node_Pos(node), Node_Modifiers(node)), WriteKindKeyword, Node_AsNode(node));
    Printer_writeSpace(receiver);
    if (node.IsTypeOnly) {
 ...
 * }
 */
export function Printer_emitModuleReference(receiver, node) {
    switch (node.Kind) {
        case KindIdentifier:
 ...
 * }
 */
export function Printer_emitImportDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_emitModifierList(receiver, Node_AsNode(node), Node_Modifiers(node), false);
    Printer_emitToken(receiver, KindImportKeyword, greatestEnd(Node_Pos(node), Node_Modifiers(node)), WriteKindKeyword, Node_AsNode(node));
    Printer_writeSpace(receiver);
 ...
 * }
 */
export function Printer_emitImportClause(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitNamespaceImport(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitNamedImports(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_writePunctuation(receiver, "{");
 ...
 * }
 */
export function Printer_emitNamedImportBindings(receiver, node) {
    if (node === undefined) {
        return;
    }
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitImportSpecifier(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    if (node.IsTypeOnly) {
 ...
 * }
 */
export function Printer_emitImportSpecifierNode(receiver, node) {
 ...
 * }
 */
export function Printer_emitExportAssignment(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    ...
    if (node.IsExportEquals) {
        ...
        // parenthesize `class` and `function` expressions so as not to conflict with exported `class` and `function` declarations
        const expr = GetLeftmostExpression(node.Expression, false);
 ...
 * }
 */
export function Printer_emitExportDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_emitModifierList(receiver, Node_AsNode(node), Node_Modifiers(node), false);
    ...
    if (node.ModuleSpecifier !== undefined) {
        Printer_writeSpace(receiver);
        Printer_emitToken(receiver, KindFromKeyword, greatestEnd(pos, node.ExportClause), WriteKindKeyword, Node_AsNode(node));
        Printer_writeSpace(receiver);
        Printer_emitExpression(receiver, node.ModuleSpecifier, OperatorPrecedenceLowest);
    }
    if (node.Attributes !== undefined) {
 ...
 * }
 */
export function Printer_emitImportAttributes(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitImportAttribute(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitImportAttributeNode(receiver, node) {
 ...
 * }
 */
export function Printer_emitNamespaceExportDeclaration(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    let pos = Printer_emitToken(receiver, KindExportKeyword, Node_Pos(node), WriteKindKeyword, Node_AsNode(node));
    Printer_writeSpace(receiver);
 ...
 * }
 */
export function Printer_emitNamespaceExport(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    const pos = Printer_emitToken(receiver, KindAsteriskToken, Node_Pos(node), WriteKindPunctuation, Node_AsNode(node));
    Printer_writeSpace(receiver);
    Printer_emitToken(receiver, KindAsKeyword, pos, WriteKindKeyword, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitNamedExports(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    Printer_writePunctuation(receiver, "{");
 ...
 * }
 */
export function Printer_emitNamedExportBindings(receiver, node) {
    switch (node.Kind) {
 ...
 * }
 */
export function Printer_emitExportSpecifier(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
    if (node.IsTypeOnly) {
        Printer_writeKeyword(receiver, "type");
        Printer_writeSpace(receiver);
 ...
 * }
 */
export function Printer_emitExportSpecifierNode(receiver, node) {
 ...
 * }
 */
export function Printer_emitEmbeddedStatement(receiver, parentNode, node) {
    if (IsBlock(node) ||
        ...
        if (node.Kind === KindEmptyStatement) {
            Printer_emitEmptyStatement(receiver, AsEmptyStatement(node), true);
        }
        else {
            Printer_emitStatement(receiver, node);
        }
 ...
 * }
 */
export function Printer_emitStatement(receiver, node) {
    switch (node.Kind) {
        // Statements
        case KindBlock:
        ...
        case KindEmptyStatement:
            Printer_emitEmptyStatement(receiver, AsEmptyStatement(node), false);
            break;
 ...
 * }
 */
export function Printer_emitExternalModuleReference(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitJsxNamespacedName(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitCaseOrDefaultClauseStatements(receiver, node, colonPos) {
    const emitAsSingleStatement = node.Statements.Nodes.length === 1 &&
        // treat synthesized nodes as located on the same line for emit purposes
    ...
    let format = LFCaseOrDefaultClauseStatements;
    if (emitAsSingleStatement) {
        // When emitting as a single statement, use writeToken (no comments) for the colon
        // to avoid duplicating trailing comments that will be picked up by the statement list.
 ...
 * }
 */
export function Printer_emitCatchClause(receiver, node) {
    const state = Printer_enterNode(receiver, Node_AsNode(node));
 ...
 * }
 */
export function Printer_emitJSDocNode(receiver, node) {
    // !!!
 ...
 * }
 */
export function Printer_emitShebangIfNeeded(receiver, node) {
 ...
 * }
 */
export function Printer_shouldReuseTempVariableScope(receiver, node) {
    return (node !== undefined && (EmitContext_EmitFlags(receiver.emitContext, node) & EFReuseTempVariableScope) !== 0);
}
/**
 ...
 * }
 */
export function Printer_generateNameIfNeeded(receiver, name) {
    if (name !== undefined) {
