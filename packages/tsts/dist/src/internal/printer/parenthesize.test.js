...
import { KindAmpersandAmpersandToken, KindAmpersandToken, KindArrowFunction, KindAsteriskAsteriskToken, KindAsteriskToken, KindBarBarToken, KindBarToken, KindCaretToken, KindColonToken, KindCommaToken, KindEndOfFile, KindEqualsGreaterThanToken, KindEqualsToken, KindIdentifier, KindKeyOfKeyword, KindNonNullExpression, KindPlusToken, KindQuestionDotToken, KindQuestionQuestionToken, KindQuestionToken, KindReadonlyKeyword, KindSlashToken, KindUnknown, } from "../ast/generated/kinds.js";
import { NewArrayLiteralExpression, NewArrayTypeNode, NewArrowFunction, NewAsExpression, NewAwaitExpression, NewBinaryExpression, NewBlock, NewCallExpression, NewClassDeclaration, NewClassExpression, NewComputedPropertyName, NewConditionalExpression, NewConditionalTypeNode, NewDecorator, NewDeleteExpression, NewElementAccessExpression, NewExportAssignment, NewExpressionStatement, NewExpressionWithTypeArguments, NewFunctionDeclaration, NewFunctionExpression, NewFunctionTypeNode, NewIdentifier, NewIndexedAccessTypeNode, NewInferTypeNode, NewIntersectionTypeNode, NewNewExpression, NewNonNullExpression, NewNoSubstitutionTemplateLiteral, NewOptionalTypeNode, NewObjectLiteralExpression, NewPropertyAccessExpression, NewPropertyDeclaration, NewSatisfiesExpression, NewSpreadElement, NewTaggedTemplateExpression, NewToken, NewTupleTypeNode, NewTypeAliasDeclaration, NewTypeAssertion, NewTypeOfExpression, NewTypeOperatorNode, NewTypeParameterDeclaration, NewTypeQueryNode, NewTypeReferenceNode, NewUnionTypeNode, NewVariableDeclaration, NewVariableDeclarationList, NewVariableStatement, NewVoidExpression, NewYieldExpression, } from "../ast/generated/factory.js";
...
function markSyntheticRecursive(node) {
    let v;
    v = NewNodeVisitor((n) => NodeVisitor_VisitEachChild(v, n), NewNodeFactory({}), {
        VisitNode: (n, visitor) => {
            if (n !== undefined) {
...
function sourceFileOf(f, statements) {
    const file = NodeFactory_NewSourceFile(f, { FileName: "/file.ts", Path: "/file.ts" }, "", NodeFactory_NewNodeList(f, statements), NewToken(f, KindEndOfFile));
    markSyntheticRecursive(file);
    return file;
}
const commaOf = (f, l, r) => NewBinaryExpression(f, undefined, NewIdentifier(f, l), undefined, NewToken(f, KindCommaToken), NewIdentifier(f, r));
test("ParenthesizeDecorator", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewClassDeclaration(f, NodeFactory_NewModifierList(f, [
            NewDecorator(f, NewBinaryExpression(f, undefined, NewIdentifier(f, "a"), undefined, NewToken(f, KindPlusToken), NewIdentifier(f, "b"))),
        ]), NewIdentifier(f, "C"), undefined, undefined, NodeFactory_NewNodeList(f, [])),
    ]);
...
test("ParenthesizeComputedPropertyName", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewClassDeclaration(f, undefined, NewIdentifier(f, "C"), undefined, undefined, NodeFactory_NewNodeList(f, [
...
test("ParenthesizePropertyAccess2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewPropertyAccessExpression(f, NewPropertyAccessExpression(f, NewIdentifier(f, "a"), NewToken(f, KindQuestionDotToken), NewIdentifier(f, "b"), NodeFlagsOptionalChain), undefined, NewIdentifier(f, "c"), NodeFlagsNone)),
    ]);
    checkEmit(undefined, file, "(a?.b).c;");
});
test("ParenthesizePropertyAccess3", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewPropertyAccessExpression(f, NewNewExpression(f, NewIdentifier(f, "a"), undefined, undefined), undefined, NewIdentifier(f, "b"), NodeFlagsNone)),
    ]);
...
test("ParenthesizeElementAccess2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewElementAccessExpression(f, NewPropertyAccessExpression(f, NewIdentifier(f, "a"), NewToken(f, KindQuestionDotToken), NewIdentifier(f, "b"), NodeFlagsOptionalChain), undefined, NewIdentifier(f, "c"), NodeFlagsNone)),
    ]);
    checkEmit(undefined, file, "(a?.b)[c];");
});
test("ParenthesizeElementAccess3", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewElementAccessExpression(f, NewNewExpression(f, NewIdentifier(f, "a"), undefined, undefined), undefined, NewIdentifier(f, "b"), NodeFlagsNone)),
    ]);
    checkEmit(undefined, file, "(new a)[b];");
});
...
test("ParenthesizeCall2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewCallExpression(f, NewPropertyAccessExpression(f, NewIdentifier(f, "a"), NewToken(f, KindQuestionDotToken), NewIdentifier(f, "b"), NodeFlagsOptionalChain), undefined, undefined, NodeFactory_NewNodeList(f, []), NodeFlagsNone)),
    ]);
    checkEmit(undefined, file, "(a?.b)();");
});
test("ParenthesizeCall3", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewCallExpression(f, NewNewExpression(f, NewIdentifier(f, "C"), undefined, undefined), undefined, undefined, NodeFactory_NewNodeList(f, []), NodeFlagsNone)),
    ]);
...
test("ParenthesizeCall4", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewCallExpression(f, NewIdentifier(f, "a"), undefined, undefined, NodeFactory_NewNodeList(f, [commaOf(f, "b", "c")]), NodeFlagsNone)),
    ]);
    checkEmit(undefined, file, "a((b, c));");
});
...
test("ParenthesizeNew2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewNewExpression(f, NewCallExpression(f, NewIdentifier(f, "C"), undefined, undefined, NodeFactory_NewNodeList(f, []), NodeFlagsNone), undefined, undefined)),
    ]);
    checkEmit(undefined, file, "new (C());");
});
...
test("ParenthesizeTaggedTemplate1", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewTaggedTemplateExpression(f, commaOf(f, "a", "b"), undefined, undefined, NewNoSubstitutionTemplateLiteral(f, "", TokenFlagsNone), NodeFlagsNone)),
    ]);
    checkEmit(undefined, file, "(a, b) ``;");
});
test("ParenthesizeTaggedTemplate2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewTaggedTemplateExpression(f, NewPropertyAccessExpression(f, NewIdentifier(f, "a"), NewToken(f, KindQuestionDotToken), NewIdentifier(f, "b"), NodeFlagsOptionalChain), undefined, undefined, NewNoSubstitutionTemplateLiteral(f, "", TokenFlagsNone), NodeFlagsNone)),
    ]);
    checkEmit(undefined, file, "(a?.b) ``;");
});
test("ParenthesizeTypeAssertion1", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewTypeAssertion(f, NewTypeReferenceNode(f, NewIdentifier(f, "T"), undefined), NewBinaryExpression(f, undefined, NewIdentifier(f, "a"), undefined, NewToken(f, KindPlusToken), NewIdentifier(f, "b")))),
    ]);
...
test("ParenthesizeArrowFunction1", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewArrowFunction(f, undefined, undefined, NodeFactory_NewNodeList(f, []), undefined, undefined, NewToken(f, KindEqualsGreaterThanToken), NewObjectLiteralExpression(f, NodeFactory_NewNodeList(f, []), false))),
    ]);
...
test("ParenthesizeArrowFunction2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewArrowFunction(f, undefined, undefined, NodeFactory_NewNodeList(f, []), undefined, undefined, NewToken(f, KindEqualsGreaterThanToken), NewPropertyAccessExpression(f, NewObjectLiteralExpression(f, NodeFactory_NewNodeList(f, []), false), undefined, NewIdentifier(f, "a"), NodeFlagsNone))),
    ]);
    checkEmit(undefined, file, "() => ({}.a);");
});
const plusOf = (f) => NewBinaryExpression(f, undefined, NewIdentifier(f, "a"), undefined, NewToken(f, KindPlusToken), NewIdentifier(f, "b"));
...
function makeSide(label, kind, f) {
    if (kind === KindIdentifier || kind === KindUnknown) {
        return NewIdentifier(f, label);
    }
    if (kind === KindArrowFunction) {
        return NewArrowFunction(f, undefined, undefined, NodeFactory_NewNodeList(f, []), undefined, undefined, NewToken(f, KindEqualsGreaterThanToken), NewBlock(f, NodeFactory_NewNodeList(f, []), false));
    }
...
test("ParenthesizeBinary", () => {
    ...
    for (const rec of data) {
        const f = zeroFactory();
        const file = sourceFileOf(f, [
            NewExpressionStatement(f, NewBinaryExpression(f, undefined, makeSide("l", rec.left ?? KindUnknown, f), undefined, NewToken(f, rec.operator), makeSide("r", rec.right ?? KindUnknown, f))),
        ]);
...
test("ParenthesizeConditional1", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewConditionalExpression(f, commaOf(f, "a", "b"), NewToken(f, KindQuestionToken), NewIdentifier(f, "c"), NewToken(f, KindColonToken), NewIdentifier(f, "d"))),
    ]);
...
test("ParenthesizeConditional2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewConditionalExpression(f, NewBinaryExpression(f, undefined, NewIdentifier(f, "a"), undefined, NewToken(f, KindEqualsToken), NewIdentifier(f, "b")), NewToken(f, KindQuestionToken), NewIdentifier(f, "c"), NewToken(f, KindColonToken), NewIdentifier(f, "d"))),
    ]);
    checkEmit(undefined, file, "(a = b) ? c : d;");
});
test("ParenthesizeConditional3", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewConditionalExpression(f, NewArrowFunction(f, undefined, undefined, NodeFactory_NewNodeList(f, []), undefined, undefined, NewToken(f, KindEqualsGreaterThanToken), NewBlock(f, NodeFactory_NewNodeList(f, []), false)), NewToken(f, KindQuestionToken), NewIdentifier(f, "a"), NewToken(f, KindColonToken), NewIdentifier(f, "b"))),
    ]);
    checkEmit(undefined, file, "(() => { }) ? a : b;");
});
test("ParenthesizeConditional4", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewConditionalExpression(f, NewYieldExpression(f, undefined, undefined), NewToken(f, KindQuestionToken), NewIdentifier(f, "a"), NewToken(f, KindColonToken), NewIdentifier(f, "b"))),
    ]);
...
test("ParenthesizeConditional5", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewConditionalExpression(f, NewIdentifier(f, "a"), NewToken(f, KindQuestionToken), commaOf(f, "b", "c"), NewToken(f, KindColonToken), NewIdentifier(f, "d"))),
    ]);
    checkEmit(undefined, file, "a ? (b, c) : d;");
});
test("ParenthesizeConditional6", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewConditionalExpression(f, NewIdentifier(f, "a"), NewToken(f, KindQuestionToken), NewIdentifier(f, "b"), NewToken(f, KindColonToken), commaOf(f, "c", "d"))),
    ]);
    checkEmit(undefined, file, "a ? b : (c, d);");
});
...
test("ParenthesizeSpreadElement2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewCallExpression(f, NewIdentifier(f, "a"), undefined, undefined, NodeFactory_NewNodeList(f, [NewSpreadElement(f, commaOf(f, "b", "c"))]), NodeFlagsNone)),
    ]);
    checkEmit(undefined, file, "a(...(b, c));");
});
test("ParenthesizeSpreadElement3", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewNewExpression(f, NewIdentifier(f, "a"), undefined, NodeFactory_NewNodeList(f, [NewSpreadElement(f, commaOf(f, "b", "c"))]))),
    ]);
...
test("ParenthesizeExpressionWithTypeArguments", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewExpressionWithTypeArguments(f, commaOf(f, "a", "b"), NodeFactory_NewNodeList(f, [NewTypeReferenceNode(f, NewIdentifier(f, "c"), undefined)]))),
    ]);
    checkEmit(undefined, file, "(a, b)<c>;");
});
...
test("ParenthesizeExpressionStatement2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExpressionStatement(f, NewFunctionExpression(f, undefined, undefined, undefined, undefined, NodeFactory_NewNodeList(f, []), undefined, undefined, NewBlock(f, NodeFactory_NewNodeList(f, []), false))),
    ]);
...
test("ParenthesizeExpressionDefault2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewExportAssignment(f, undefined, false, undefined, NewFunctionExpression(f, undefined, undefined, undefined, undefined, NodeFactory_NewNodeList(f, []), undefined, undefined, NewBlock(f, NodeFactory_NewNodeList(f, []), false))),
    ]);
...
const typeRef = (f, name) => NewTypeReferenceNode(f, NewIdentifier(f, name), undefined);
test("ParenthesizeArrayType", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewArrayTypeNode(f, NewUnionTypeNode(f, NodeFactory_NewNodeList(f, [typeRef(f, "a"), typeRef(f, "b")])))),
    ]);
...
test("ParenthesizeOptionalType", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewTupleTypeNode(f, NodeFactory_NewNodeList(f, [
...
test("ParenthesizeUnionType1", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewUnionTypeNode(f, NodeFactory_NewNodeList(f, [
            typeRef(f, "a"),
...
test("ParenthesizeIntersectionType", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewIntersectionTypeNode(f, NodeFactory_NewNodeList(f, [
            typeRef(f, "a"),
...
test("ParenthesizeReadonlyTypeOperator1", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewTypeOperatorNode(f, KindReadonlyKeyword, NewUnionTypeNode(f, NodeFactory_NewNodeList(f, [typeRef(f, "a"), typeRef(f, "b")])))),
    ]);
...
test("ParenthesizeReadonlyTypeOperator2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewTypeOperatorNode(f, KindReadonlyKeyword, NewTypeOperatorNode(f, KindKeyOfKeyword, typeRef(f, "a")))),
    ]);
...
test("ParenthesizeKeyofTypeOperator", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewTypeOperatorNode(f, KindKeyOfKeyword, NewUnionTypeNode(f, NodeFactory_NewNodeList(f, [typeRef(f, "a"), typeRef(f, "b")])))),
    ]);
...
test("ParenthesizeIndexedAccessType", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewIndexedAccessTypeNode(f, NewUnionTypeNode(f, NodeFactory_NewNodeList(f, [typeRef(f, "a"), typeRef(f, "b")])), typeRef(f, "c"))),
    ]);
    checkEmit(undefined, file, "type _ = (a | b)[c];");
});
test("ParenthesizeConditionalType1", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewConditionalTypeNode(f, NewFunctionTypeNode(f, undefined, NodeFactory_NewNodeList(f, []), typeRef(f, "a")), typeRef(f, "b"), typeRef(f, "c"), typeRef(f, "d"))),
    ]);
...
test("ParenthesizeConditionalType2", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewConditionalTypeNode(f, typeRef(f, "a"), NewConditionalTypeNode(f, typeRef(f, "b"), typeRef(f, "c"), typeRef(f, "d"), typeRef(f, "e")), typeRef(f, "f"), typeRef(f, "g"))),
    ]);
...
test("ParenthesizeConditionalType3", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewConditionalTypeNode(f, typeRef(f, "a"), NewFunctionTypeNode(f, undefined, NodeFactory_NewNodeList(f, []), NewInferTypeNode(f, NewTypeParameterDeclaration(f, undefined, NewIdentifier(f, "b"), typeRef(f, "c"), undefined, undefined))), typeRef(f, "d"), typeRef(f, "e"))),
    ]);
...
test("ParenthesizeConditionalType4", () => {
    const f = zeroFactory();
    const file = sourceFileOf(f, [
        NewTypeAliasDeclaration(f, undefined, NewIdentifier(f, "_"), undefined, NewConditionalTypeNode(f, typeRef(f, "a"), NewFunctionTypeNode(f, undefined, NodeFactory_NewNodeList(f, []), NewUnionTypeNode(f, NodeFactory_NewNodeList(f, [
            NewInferTypeNode(f, NewTypeParameterDeclaration(f, undefined, NewIdentifier(f, "b"), typeRef(f, "c"), undefined, undefined)),
            typeRef(f, "d"),
        ]))), typeRef(f, "e"), typeRef(f, "f"))),
    ]);
...
test("NameGeneration", () => {
    ...
    const file = NodeFactory_NewSourceFile(f, { FileName: "/file.ts", Path: "/file.ts" }, "", NodeFactory_NewNodeList(f, [
        NewVariableStatement(f, undefined, NewVariableDeclarationList(f, NodeFactory_NewNodeList(f, [NewVariableDeclaration(f, NodeFactory_NewTempVariable(ec.Factory), undefined, undefined, undefined)]), NodeFlagsNone)),
        NewFunctionDeclaration(f, undefined, undefined, NewIdentifier(f, "f"), undefined, NodeFactory_NewNodeList(f, []), undefined, undefined, NewBlock(f, NodeFactory_NewNodeList(f, [
            NewVariableStatement(f, undefined, NewVariableDeclarationList(f, NodeFactory_NewNodeList(f, [NewVariableDeclaration(f, NodeFactory_NewTempVariable(ec.Factory), undefined, undefined, undefined)]), NodeFlagsNone)),
        ]), true)),
    ]), NewToken(f, KindEndOfFile));
    markSyntheticRecursive(file);
    checkEmit(ec, file, "var _a;\nfunction f() {\n    var _a;\n}");
});
...
test("PartiallyEmittedExpression", () => {
    ...
    .expression;`, false);
    const emitContext = NewEmitContext();
    file = Transformer_TransformSourceFile(NewTypeEraserTransformer({ CompilerOptions: compilerOptions, Context: emitContext }), file);
...
//# sourceMappingURL=parenthesize.test.js.map