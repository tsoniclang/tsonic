...
describe("Numeric Proof Contract (Behavioral)", () => {
  ...
  describe("unknown/missing accessKind (TSN5109)", () => {
    ...
    it("REGRESSION: referenceType without externalQualifiedName defaults to numericIndexer (safe)", () => {
      // This test guards against unsafe dictionary misclassification.
      // If a referenceType lacks externalQualifiedName, classification defaults to numericIndexer
      ...
      const memberAccess: IrMemberExpression = {
        ...
        object: {
          kind: "identifier",
          name: "list",
          // referenceType WITHOUT externalQualifiedName (e.g., tsbindgen type)
          inferredType: {
            kind: "referenceType",
            name: "List",
            // externalQualifiedName is MISSING - defaults to numericIndexer (safe)
          },
        },
        property: indexExpr,
        isComputed: true,
        ...
        // when externalQualifiedName is missing on a referenceType
        accessKind: "numericIndexer",
      ...
      // Should PASS because:
      // 1. accessKind is numericIndexer (default for referenceType without externalQualifiedName)
