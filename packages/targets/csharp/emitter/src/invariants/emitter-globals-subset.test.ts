 ...
 * - packages/targets/csharp/emitter/src/types/references.ts
 */
  ...
  describe("Invariant documentation", () => {
    it("documents source locations for special cases", () => {
      ...
      const sourceLocations: Record<string, string> = {
        Array: "packages/targets/csharp/emitter/src/types/references.ts:192",
        Promise:
          "packages/targets/csharp/emitter/src/types/references.ts:204,217",
        PromiseLike:
          "packages/targets/csharp/emitter/src/types/references.ts:224",
      };
