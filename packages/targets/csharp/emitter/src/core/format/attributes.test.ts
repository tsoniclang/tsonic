    ...
    it("should emit single attribute without arguments", () => {
      ...
      const attr: IrAttribute = {
        ...
        attributeType: {
          ...
          externalQualifiedName: "System.SerializableAttribute",
        },
        positionalArgs: [],
        namedArgs: new Map(),
      };
    ...
    it("should emit attribute with positional string argument", () => {
      ...
      const attr: IrAttribute = {
        ...
        attributeType: {
          ...
          externalQualifiedName: "System.ObsoleteAttribute",
        },
    ...
    it("should emit attribute with positional number argument", () => {
      ...
      const attr: IrAttribute = {
        ...
        attributeType: {
          ...
          externalQualifiedName: "MyApp.CustomAttribute",
        },
    ...
    it("should emit attribute with positional boolean argument", () => {
      ...
      const attr: IrAttribute = {
        ...
        attributeType: {
          kind: "referenceType",
          name: "DebugAttribute",
          externalQualifiedName: "Debug.DebugAttribute",
        },
    ...
    it("should respect indentation level", () => {
      ...
      const attr: IrAttribute = {
        ...
        attributeType: {
          kind: "referenceType",
          name: "TestAttribute",
          externalQualifiedName: "Test.TestAttribute",
        },
        positionalArgs: [],
        namedArgs: new Map(),
      };
    ...
    it("should emit typeof argument", () => {
      ...
      const attr: IrAttribute = {
        ...
        attributeType: {
          ...
          externalQualifiedName: "System.ComponentModel.TypeConverterAttribute",
        },
        positionalArgs: [
          {
            kind: "typeof",
            type: {
              ...
              externalQualifiedName: "MyApp.CustomConverter",
            },
          },
        ],
        namedArgs: new Map(),
    ...
    it("should emit enum argument", () => {
      ...
      const attr: IrAttribute = {
        ...
        attributeType: {
          ...
          externalQualifiedName: "Newtonsoft.Json.JsonPropertyAttribute",
        },
        positionalArgs: [
          {
            kind: "enum",
            type: {
              kind: "referenceType",
              name: "Required",
              externalQualifiedName: "Newtonsoft.Json.Required",
            },
            member: "Always",
          },
        ],
    ...
    it("should emit array argument", () => {
      ...
      const attr: IrAttribute = {
        ...
        attributeType: {
          kind: "referenceType",
          name: "IndexAttribute",
          externalQualifiedName: "Microsoft.EntityFrameworkCore.IndexAttribute",
        },
        positionalArgs: [
          {
            kind: "array",
    ...
    it("should escape special characters in string arguments", () => {
      ...
      const attr: IrAttribute = {
        ...
        attributeType: {
          ...
          externalQualifiedName: "System.ComponentModel.DescriptionAttribute",
        },
    ...
    it("should emit inline attribute target specifier when provided", () => {
      ...
      const attr: IrAttribute = {
        ...
        attributeType: {
          kind: "referenceType",
          name: "InAttribute",
          externalQualifiedName: "System.Runtime.InteropServices.InAttribute",
        },
        positionalArgs: [],
        namedArgs: new Map(),
      };
