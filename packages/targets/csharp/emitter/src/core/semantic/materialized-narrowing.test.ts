...
describe("materialized narrowing", () => {
  ...
  it("materializes broad-source JS numbers for CLR double reference targets", () => {
    const sourceAst = {
      kind: "identifierExpression" as const,
      identifier: "value",
    };
    ...
    expect(printExpression(ast)).to.equal(
      "(value switch { int __tsonic_number_int_1 => (global::System.Double)__tsonic_number_int_1, global::System.Double __tsonic_number_double_1 => __tsonic_number_double_1, var __tsonic_number_value_1 => (global::System.Double)__tsonic_number_value_1 })"
    );
    expect(nextContext.tempVarId).to.equal(1);
  });
