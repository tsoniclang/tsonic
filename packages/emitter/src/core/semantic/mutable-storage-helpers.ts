/**
 * Mutable storage detection — types, utilities, and property-owner resolution.
 *
 * Extracted from mutable-storage-detection.ts — contains type definitions,
 * scope management, class/interface map builders, and property-owner chain
 * traversal helpers used by the expression visitor and statement visitors.
 */
...
export const checkArrayMutationOnCall = (
  expr: IrExpression,
  context: EmitterContext,
  classes: ReadonlyMap<string, IrClassDeclaration>,
  interfaces: ReadonlyMap<string, IrInterfaceDeclaration>,
