/**
 * Union member matching and selection.
 *
 * Matches union members by typeof tags, predicate targets, and
 * object-literal keys for narrowing and expected-type adaptation.
 */
