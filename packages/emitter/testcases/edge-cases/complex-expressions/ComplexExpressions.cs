// Generated from: ComplexExpressions.ts
// Generated at: 2025-12-13T16:22:31.435Z
...
namespace TestCases.edgecases.complexexpressions
{
        public static class ComplexExpressions
        {
            ...
            public static double chainedCalls(global::System.Collections.Generic.List<double> arr)
                {
                return global::Tsonic.JSRuntime.Array.reduce(global::Tsonic.JSRuntime.Array.filter(global::Tsonic.JSRuntime.Array.map(arr, (double x) => x * 2), (double x) => x > 10), (double acc, double x) => acc + x, 0);
                }
        }
}