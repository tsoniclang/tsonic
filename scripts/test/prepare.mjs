...
const artifactDefinitions = Object.freeze([
  ...
  ["tsonic.tstsBundledLibs", resolve(repos.tsonic, "packages/tsts/dist/src/internal/bundled/libs"), true],
  ...
  ["csharpNodejs.tstsPeer", resolve(repos.csharpNodejs, "node_modules/@tsonic/tsts/package.json"), true],
  ["csharpNodejs.targetApiPeer", resolve(repos.csharpNodejs, "node_modules/@tsonic/target-api/package.json"), true],
  ["csharpNodejs.targetCsharpPeer", resolve(repos.csharpNodejs, "node_modules/@tsonic/target-csharp/package.json"), true],
